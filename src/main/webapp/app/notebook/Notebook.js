Ext.define('Voyant.notebook.Notebook', {
    ...
    statics: {
    	i18n: {
    		...
    		helpTip: 'Voyant Notebooks are dynamic documents that combine text, code and interactive tools, they are a form of <a href="https://en.wikipedia.org/wiki/Literate_programming" target="_blank">literate programming</a>.',
			eror: "Error",
				...
				buttons: [{
	        		...
	        		handler: function(btn) {
	        			...
	        			if (exportOption=='json') {
	                        ...
	                        myWindow.document.write('<title>Voyant Notebooks</title>');
