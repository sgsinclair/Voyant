...
"zscoreTip":"Z-score или стандардизовано одступање представља нормализовану вредност за апсолутну учесталост једног термина у односу на учесталости других термина у истом документу. <table><tbody><tr><td style=\"text-align: center; font-size: smaller; font-family: mono;\">учесталост термина - средина учесталости термина<hr>стандардна девијација учесталости термина</td></tr></tbody></table>."});
