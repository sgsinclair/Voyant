...
0;g<=c;g+=this.COARSENESS)if(e[f]&&e[f][g]&&null!=this.grid[f+a]&&null!=this.grid[f+a][g+b])return!0;return!1},f;this.grid=[];m=0;f=function(){var a,f,h,k,r=this.wordsToArrange-1,n=g.canvas.width,y=g.canvas.height,q=.5*n,s=.5*y;do{h=p[m];if(void 0!==h){for(var F=Math.random()*Math.PI,v=.25*Math.random()*h.size,t=.5*(Math.random()-.5),u=.5*h.width,K=.5*h.height;;){a=Math.floor((q+Math.cos(F)*v*this.ratio-u)/this.COARSENESS)*this.COARSENESS;f=Math.floor((s+Math.sin(F)*v-K)/this.COARSENESS)*this.COARSENESS;
k=a+u>=n||f+K>=y?!0:d(a,f,h.height,h.width,h.mask);if(!k)break;F+=t;v+=.05}c(a,f,h);if(g.useFadeEffect)for(a=h.alpha=0;a<m;a++)f=p[a],1>f.alpha&&b(f);else h.alpha=1,h.draw(g.context)}m++;if(m>=p.length){clearTimeout(l);this.doingArrange=!1;this.toggleLoadingText(!1);e();break}}while(r--)}.createDelegate(this);d=d.createDelegate(this);c=c.createDelegate(this);b=b.createDelegate(this);a=a.createDelegate(this);this.doingArrange=!0;l=setInterval(f,50)}else alert("Error: There are no words to arrange.")};
...
r=function(a){return doubletree.fieldText(a,"POS")},y=function(a){return"rgba(255,255,255,1)"},D=function(a){return"rgba(255,255,255,1)"},B=function(a){return"red"},E={node:{fill:"white",stroke:"steelblue","stroke-width":"1.5px"},branch:{stroke:"#aaa","stroke-width":"1.5px"}},F=!1,J=d3.dispatch("idsUpdated");J.on("idsUpdated",function(){this==z?(A.setIds(z.continuationIDs),A.updateContinuations()):this==A&&(z.setIds(A.continuationIDs),z.updateContinuations())});var x,C,z,A,I,G;b.init=function(a){d3.select(d3.selectAll(a)).call(this);
return b};b.redraw=function(){b.setupFromTries(x,C);return b};b.setupFromTries=function(d,k){x=d.getUniqRoot();C=k.getUniqRoot();var w=x.toTree(m.left),v=C.toTree(m.right),t=!0;0<Object.keys(v.pruned).length&&(a(v,v.pruned,t),a(w,v.pruned,t),t=!1);0<Object.keys(w.pruned).length&&(a(w,w.pruned,t),a(v,w.pruned,t));var t={},u;for(u in v.info)"continuations"!=u&&"ids"!=u&&"count"!=u&&(t[u]=v.info[u]);t["right continuations"]=v.info.continuations;t["left continuations"]=w.info.continuations;t.ids={};c(t.ids,
v.info.ids);c(t.ids,w.info.ids);t.count=Object.keys(t.ids).length;I=Object.keys(t.ids);if(v.info.origIDs||w.info.origIDs)t.origIDs={},c(t.origIDs,v.info.origIDs),c(t.origIDs,w.info.origIDs),t.origCount=Object.keys(t.origIDs).length;v.info=t;w.info=t;u=Math.max(w.maxChildren,v.maxChildren);if(isNaN(u)||0==u)return F=!1,b;q?G=d3.scale.log().range([8,14]):(G=function(){return 14},G.domain=function(){});u=Math.min(w.minCount,v.minCount);G.domain([u,w.info.count]);var K=g-20-20,L=h-20-20;f[0].forEach(function(a,
b){function c(){var a=d3.event.scale,b=d3.event.translate;d3.select(d).select("svg \x3e g").attr("transform","translate("+b+") scale("+a+")")}var d=a,e;e=d3.select(d).select("svg");null==e[0][0]?(e=d3.select(d).append("svg").attr("width",K+20+20).attr("height",L+20+20).attr("cursor","move").call(d3.behavior.zoom().scaleExtent([1,1]).on("zoom",c)),e.append("g")):(e.attr("width",K+20+20).attr("height",L+20+20),e.selectAll("g *").remove());z=new doubletree.Tree(e.select("g"),g,h,w,!0,s,J,G,n,p,r,y,D,
B,E);A=new doubletree.Tree(e.select("g"),g,h,v,!1,s,J,G,n,p,r,y,D,B,E)});z.handleAltPress=l.alt;A.handleAltPress=l.alt;z.handleShiftPress=l.shift;A.handleShiftPress=l.shift;z.handleClick=l.click;A.handleClick=l.click;F=!0;return b};b.setupFromArrays=function(a,c,d,f,g,h,m,l){void 0==g&&x&&(g=x.caseSensitive());void 0==h&&x&&(h=x.fieldNames());void 0==m&&x&&(m=x.fieldDelim());void 0==l&&x&&(l=x.distinguishingFieldsArray());x=new doubletree.Trie(g,h,m,l);C=new doubletree.Trie(g,h,m,l);g=c.length;for(h=
0;h<g;h++){m=f?f[h]:h;l=c[h];var r=a[h].slice(),n=d[h].slice();r.push(l);r.reverse();n.unshift(l);k?(C.addNgram(r,m),x.addNgram(n,m)):(x.addNgram(r,m),C.addNgram(n,m))}b.setupFromTries(x,C);return b};b.filteredIDs=function(){return I};b.search=function(a){z.search(a);A.search(a);a=d3.select(f[0][0]);var b=a.selectAll("text.foundText");if(b.empty())return 0;b=b[0].length;null!=a.selectAll("text.rtNdText.foundText")[0][0]&&b--;return b};b.clearSearch=function(){z.clearSearch();A.clearSearch();return b};
b.updateTokenExtras=function(){z.showTokenExtras(n);A.showTokenExtras(n);var a=d3.select(f[0][0]).select('.tokenExtra[display\x3d"inline"]');a.empty()||"0px"==a.style("height")&&b.redraw();return b};b.visWidth=function(a){if(!arguments.length)return g;g=a;return b};b.visHeight=function(a){if(!arguments.length)return h;h=a;return b};b.prefixesOnRight=function(a){if(!arguments.length)return k;k=a;return b};b.filters=function(a){if(!arguments.length)return m;m=a;return b};b.handlers=function(a){if(!arguments.length)return l;
l=a;return b};b.showTokenExtra=function(a){if(!arguments.length)return n;n=a;return b};b.scaleLabels=function(a){if(!arguments.length)return q;q=a;return b};b.succeeded=function(){return F};b.sortFun=function(a){if(!arguments.length)return s;s=a;return b};b.nodeText=function(a){if(!arguments.length)return p;p=a;return b};b.tokenExtraText=function(a){if(!arguments.length)return r;r=a;return b};b.rectColor=function(a){if(!arguments.length)return y;y=a;return b};b.rectBorderColor=function(a){if(!arguments.length)return D;
D=a;return b};b.continuationColor=function(a){if(!arguments.length)return B;B=a;return b};b.basicStyles=function(a){if(!arguments.length)return E;Object.keys(E).forEach(function(b){b in a&&Object.keys(E[b]).forEach(function(c){c in a[b]&&(E[b][c]=a[b][c])})});return b};return b};doubletree.Tree=function(a,b,c,d,k,m,l,n,q,s,p,r,y,D,B){function E(a){a.children&&(a._children=a.children,a._children.forEach(E),a.children=null)}function F(a){a.parent&&a.parent.children.forEach(function(b){b!=a&&E(b)})}
function J(a,b){d3.event.altKey?u.handleAltPress(a,b):d3.event.shiftKey?u.handleShiftPress(a,b):(u.handleClick(a,b),a.parent&&(u.continuationIDs!=a.info.ids&&(u.setIds(a.info.ids),u.clickedNode=a.id,l.idsUpdated.apply(u)),F(a),x(a,!0)))}function x(a,b){a.children?(a.children&&1==a.children.length&&x(a.children[0],!0),a._children=a.children,a.children=null):(a.children=a._children,a._children=null,a.children&&1==a.children.length&&x(a.children[0],!1));b&&u.update(a)}function C(a){return k?I/2-a:I/
2+a}var z=q,A=r,I=b-20-20,G=c-20-20,M=0,H,w;m||(m=doubletree.sortByStrFld("token"));var v=d3.layout.tree().nodeSize([40,40]).sort(m),t=d3.svg.diagonal().projection(function(a){return[C(a.y),a.x-w]});a=a.append("g").attr("transform","translate(20,20)");this.readJSONTree=function(a){H=a;H.x0=G/2;H.y0=I/2;H.children.forEach(E);this.update(H)};var u=this;this.update=function(b){b||(b=H);var c=v.nodes(H).reverse();w=H.x-G/2;c.forEach(function(a){for(var b=0,c=a.parent;null!=c;)b+=Ext.draw.TextMeasurer.measureText(c.name,
"arial").width,c=c.parent;a.y=25*a.depth+b});var d=a.selectAll("g.node_"+k).data(c,function(a){return a.id||(a.id=++M)}),f=d.enter().append("g").attr("class","node node_"+k).attr("cursor","pointer").attr("transform",function(a){return"translate("+C(b.y0)+","+(b.x0-w)+")"}).on("click",J);f.append("title").text(function(a){return doubletree.infoToText(a.info)});f.append("circle").attr("r",1E-6).style("fill",function(a){return a._children?"#fff":B.node.fill}).style("stroke",function(a){return B.node.stroke});
...
"tokenExtra").text(function(a){return p(a.info,1>a.depth)}).style("fill-opacity",1E-6);this.drawRects=function(){var b=z?"inline":"none";a.selectAll(".tokenExtra").attr("display",b);d.selectAll("rect").remove();d.insert("rect","text").attr("class","nodeRect").attr("height",function(){return this.parentElement.getBBox().height-6}).attr("y",function(a){return a.parent?-.5*this.parentElement.getBBox().height/2:-.5*this.parentElement.getBBox().height/2-2}).attr("width",function(){return this.parentElement.getBBox().width}).attr("x",
function(a){var b=this.parentElement.getBBox().width;return a.parent?k?-.5*b:0:-.33333*b}).style("stroke-opacity",1).style("stroke-width",1).style("stroke",function(a){return y(a.info)}).style("fill",function(a){return A(a.info)}).style("fill-opacity",function(a){return 1})};try{this.drawRects()}catch(g){}f=d.transition().duration(200).attr("transform",function(a){return"translate("+C(a.y)+","+(a.x-w)+")"});f.select("circle").attr("r",function(a){return a.children||a._children?1E-6:4.5}).style("fill",
function(a){return a._children?"#fff":B.node.fill}).style("stroke-width",B.node["stroke-width"]);f.selectAll("tspan").style("fill-opacity",1);f=d.exit().transition().duration(200).attr("transform",function(a){return"translate("+C(b.y)+","+(b.x-w)+")"}).remove();f.select("circle").attr("r",1E-6);f.selectAll("tspan").style("fill-opacity",1E-6);f=a.selectAll("path.link_"+k).data(v.links(c),function(a){return a.target.id});f.enter().insert("path","g").attr("class","link link_"+k).attr("d",function(a){a=
{x:b.x0,y:b.y0};return t({source:a,target:a})}).style("fill","none").style("stroke",B.branch.stroke).style("stroke-width",B.branch["stroke-width"]);f.transition().duration(200).attr("d",t);f.exit().transition().duration(200).attr("d",function(a){a={x:b.x,y:b.y};return t({source:a,target:a})}).remove();c.forEach(function(a){a.x0=a.x;a.y0=a.y});this.updateContinuations()};this.setIds=function(a){u.continuationIDs=a};this.updateContinuations=function(){a.selectAll("g.node_"+k+" text").classed("continuation",
function(a){var b;a:{a=a.info.ids;var c=u.continuationIDs||{};for(b in a)if(b in c){b=!0;break a}b=!1}return b}).style("fill",function(a){return d3.select(this).classed("continuation")?D(a.info):"#444"})};this.search=function(b){a.selectAll("g.node text").classed("foundText",function(a){return b.test(s(a.info))})};this.clearSearch=function(){a.selectAll("g.node text").classed("foundText",!1)};this.showTokenExtras=function(a){if(0==arguments.length)return z;z=a;this.drawRects();return this};this.setRectColor=
...
itemId:"facets",defaults:{width:250,flex:1,xtype:"facet",margin:5,border:!0,frame:!0},items:[]},{xtype:"panel",html:a.customResultsHtml||"",flex:1,itemId:"results",height:"100%",align:"stretch",scrollable:!0,margin:5,getCorpus:function(){return this.findParentByType("panel").getCorpus()},listeners:{query:function(a,c){this.findParentByType("panel").updateResults(Ext.isString(c)?[c]:c)}},bbar:[{itemId:"export",text:this.localize("export"),tooltip:this.localize("exportTip"),disabled:!0,handler:function(){this.mask(this.localize("exportInProgress"));
var a=this;Ext.Ajax.request({url:this.getApplication().getTromboneUrl(),params:{corpus:this.getCorpus().getId(),tool:"corpus.CorpusManager",keepDocuments:!0,docId:this.getMatchingDocIds()},success:function(c,d){a.unmask();var e=Ext.JSON.decode(c.responseText),e=a.getBaseUrl()+"?corpus\x3d"+e.corpus.id;if(!window.open(e)){var f=Ext.create("Ext.window.MessageBox",{makeButton:function(c){return new Ext.button.Button({handler:this.btnCallback,scope:this,text:a.localize("cancel"),ui:"default-toolbar",
minWidth:75})}}).show({title:a.localize("export"),buttons:Ext.MessageBox.CANCEL,icon:Ext.MessageBox.INFO,message:(new Ext.XTemplate(a.localize("clickToOpenCorpus"))).apply([e])}),e=f.getTargetEl().dom.querySelector("a");e.addEventListener("click",function(){f.close()});Ext.get(e).frame().frame()}},failure:function(c,d){a.unmask();me.showError(c)}})},scope:this},{xtype:"querysearchfield",width:200,flex:1},{itemId:"status",xtype:"tbtext"}]}]});this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,
arguments);this.on("loadedCorpus",function(a,c){this.setCorpus(c);this.queryById("status").update((new Ext.XTemplate(this.localize("noMatches"))).apply([c.getDocumentsCount()]));this.query("facet").forEach(function(a){a.setCorpus(c)});this.getCustomResultsHtml()||(this.setCustomResultsHtml((new Ext.XTemplate(this.localize("noMatches"))).apply([c.getDocumentsCount()])),this.updateResults(),Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"resource.StoredResource",verifyResourceId:"customhtml-"+
c.getId()},success:function(a,b){var f=Ext.util.JSON.decode(a.responseText);f&&f.storedResource&&f.storedResource.id&&Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"resource.StoredResource",retrieveResourceId:"customhtml-"+c.getId()},success:function(a,b){var c=Ext.util.JSON.decode(a.responseText);c&&c.storedResource&&c.storedResource.resource&&(this.setCustomResultsHtml(c.storedResource.resource),this.updateResults())},scope:this})},scope:this}))});this.on("afterrender",function(a){var c=
this.getApiParam("facet");Ext.isString(c)&&(c=c.split(","));var d=this.queryById("facets"),e='\x3cspan style\x3d"font-size: smaller;"\x3e(\x3cspan class\x3d"info-tip" data-qtip\x3d"'+a.localize("matchingDocuments")+'"\x3e{inDocumentsCount}\x3c/span\x3e)\x3c/span\x3e {term}\x3cspan style\x3d"font-size: smaller;"\x3e (\x3cspan class\x3d"info-tip" data-qtip\x3d"'+a.localize("rawFreqs")+'"\x3e{rawFreq}\x3c/span\x3e)\x3c/span\x3e';c.forEach(function(c){var h=a.localize(c+"Title");h=="["+c+"Title]"&&(h=
c.replace(/^facet\./,"").replace(/^extra./,""));a.localize("matchingDocuments");var k=d.add({title:h,collapsible:!0,facet:c,columns:[{renderer:function(a,b,c){return'\x3cspan style\x3d"font-size: smaller;"\x3e(\x3cspan class\x3d"info-tip" data-qtip\x3d"'+f.localize("matchingDocuments")+'"\x3e'+c.getInDocumentsCount()+"\x3c/span\x3e) \x3c/span\x3e"+c.getLabel()},flex:1}],bbar:[{xtype:"querysearchfield",width:"100%",tokenType:c.replace("facet.",""),itemTpl:e}]});k.getSelectionModel().on("selectionchange",
function(d,e){var f=[];e.forEach(function(a){f.push({facet:a.getFacet(),label:a.getLabel()})});a.getFacets()[c]=f;a.updateResults()});k.on("query",function(c,d){a.getFacets()[k.facet]=[];a.updateResults()})});var f=this;d.add({title:a.localize("lexicalTitle"),collapsible:!0,store:Ext.create("Voyant.data.store.CorpusTerms",{parentPanel:this,proxy:{extraParams:{stopList:this.getApiParam("stopList")}}}),facet:"lexical",columns:[{renderer:function(a,b,c){return'\x3cspan style\x3d"font-size: smaller;"\x3e(\x3cspan class\x3d"info-tip" data-qtip\x3d"'+
f.localize("matchingDocuments")+'"\x3e'+c.getInDocumentsCount()+"\x3c/span\x3e) \x3c/span\x3e"+c.getTerm()+'\x3cspan style\x3d"font-size: smaller;"\x3e (\x3cspan class\x3d"info-tip" data-qtip\x3d"'+f.localize("rawFreqs")+'"\x3e'+c.getRawFreq()+"\x3c/span\x3e)\x3c/span\x3e"},flex:1}],bbar:[{xtype:"querysearchfield",itemTpl:e,grow:!1,growMax:10}]}).getSelectionModel().on("selectionchange",function(c,d){var e=[];d.forEach(function(a){e.push({facet:"lexical",label:a.getTerm()})});a.getFacets().lexical=
e;a.updateResults()})})},updateResults:function(a){var b=this.getFacets();if(!a){a=[];for(facet in b)b[facet].forEach(function(b){a.push(b.facet+":"+b.label)});if(a)return this.updateResults(a)}var c=this.queryById("results").getTargetEl();c.update(this.getCustomResultsHtml()?this.getCustomResultsHtml():this.localize("noMatches",[this.getCorpus().getDocumentsCount()]));this.queryById("status").update(this.localize("noMatches",[this.getCorpus().getDocumentsCount()]));this.queryById("export").setDisabled(!0);
if(a&&0<a.length){this.mask(this.localize("loading"));var d=this.getCorpus().getDocumentQueryMatches();d.load({params:{query:a,includeDocIds:!0},callback:function(a,f,g){this.unmask();if(a&&0<a.length){this.queryById("status").setHtml(a.length);var h="\x3cul\x3e",k=[];a.forEach(function(a){a.getDocIds().forEach(function(a){k.push(a);var e=d.getCorpus().getDocument(a);a="\x3cli id\x3d'"+c.getId()+"_"+a+"' class\x3d'cataloguedoc'\x3e";a+="\x3ci\x3e"+e.getTitle()+"\x3c/i\x3e";for(facet in b)if(0!=b[facet].length){var f=
"";if("facet.title"!=facet){var g=facet.replace(/^.+?\./,""),m=e.get(g);if(m){var r=Ext.isArray(m);r?f+="\x3cli\x3e"+g+"\x3cul\x3e":m=[m];m.forEach(function(a){var c=!1;b[facet].forEach(function(b){b.label==a?c=!0:-1==b.facet.indexOf("facet")&&b.label.split(/\W+/).forEach(function(b){0<b.trim().length&&-1<a.toLowerCase().indexOf(b.toLowerCase())&&(c=!0)})});f+="\x3cli\x3e"+(r?"":g+": ")+(c?'\x3cspan class\x3d"keyword"\x3e'+a+"\x3c/span\x3e":a)+"\x3c/li\x3e"});r&&(f+="\x3c/ul\x3e\x3c/li\x3e")}}f&&
(a+="\x3cul\x3e"+f+"\x3c/ul\x3e")}h+=a+"\x3c/li\x3e"})});h+="\x3c/ul\x3e";c.update(h);this.queryById("status").update(this.localize("queryMatches",[k.length,this.getCorpus().getDocumentsCount()]));this.setMatchingDocIds(Ext.Array.clone(k));0<k.length&&this.queryById("export").setDisabled(!1);b.lexical&&(a=k.splice(0,5),this.loadSnippets(a,c.first().first()),k&&0<k.length&&this.loadSnippets(k))}},scope:this})}},loadSnippets:function(a,b){var c=this.queryById("results").getTargetEl(),d=this.getFacets();
if(d.lexical){var d=d.lexical.map(function(a){return a.facet+":"+a.label}),e=this.getCorpus().getContexts({buffered:!1});b&&b.mask(this.localize("loadingSnippets"));e.load({method:"POST",params:{stripTags:"all",query:d,docId:a,perDocLimit:3,limit:100,accurateTotalNotNeeded:!0},scope:this,callback:function(a,d,e){b&&b.unmask();if(e&&Ext.isArray(a)&&0<a.length){var k={};a.forEach(function(a){k[a.getDocIndex()]||(k[a.getDocIndex()]=[]);k[a.getDocIndex()].push(a)});for(docIndex in k)d=this.getCorpus().getDocument(docIndex).getId(),
a='\x3cli style\x3d"list-style-type: none; font-size: smaller;"\x3e'+k[docIndex].map(function(a){return a.getHighlightedContext()}).join(" \u2026 ")+"\x3c/li\x3e",d=c.down("#"+c.getId()+"_"+d),d.query("ul")&&(a="\x3cul\x3e"+a+"\x3c/ul\x3e"),d.insertHtml("beforeEnd",a)}}})}}});Ext.define("Voyant.panel.Cirrus",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.cirrus",statics:{i18n:{},api:{stopList:"auto",limit:500,visible:50,terms:void 0,docId:void 0,docIndex:void 0,cirrusForceFlash:!1,background:"0xffffff",fade:!0,smoothness:2,diagonals:"none"},glyph:"xf06e@FontAwesome"},config:{mode:void 0,options:[{xtype:"stoplistoption"},{xtype:"numberfield",name:"label",fieldLabel:"Max words",labelAlign:"right",value:500,minValue:50,step:50,listeners:{afterrender:function(a){var b=
...
config:{corpus:void 0},constructor:function(a){this.callParent(arguments);a=a||{};this.mixins["Voyant.panel.Panel"].constructor.call(this,Ext.apply(a,{includeTools:{gear:!0,help:!0}}))},initComponent:function(){var a=this;Ext.apply(a,{title:this.localize("title"),width:800,frame:!0,padding:10,style:{borderColor:"#aaa",borderStyle:"solid"},frameHeader:!0,layout:{type:"vbox",align:"middle"},dockedItems:[{xtype:"toolbar",enableOverflow:!0,dock:"bottom",buttonAlign:"right",items:[{text:"Open",glyph:"xf115@FontAwesome",
tooltip:"Select an exsting corpus",hidden:void 0!=this.getCorpus(),handler:function(){Ext.create("Ext.window.Window",{title:"Open an Existing Corpus",layout:"fit",modal:!0,items:{xtype:"form",submitEmptyText:!1,margin:"5,5,5,5",items:{xtype:"combo",labelWidth:150,fieldLabel:"Choose a corpus:",name:"corpus",queryMode:"local",store:[["shakespeare","Shakespeare's Plays"],["austen","Austen's Novels"]],forceSelection:!0},buttons:[{text:"Open",glyph:"xf00c@FontAwesome",handler:function(b){b.up("form").getForm();
var c=b.up("form").getForm().getValues().corpus;""!=c?(a.loadCorpus({corpus:c}),b.up("window").close()):Ext.Msg.show({title:"Select a Corpus",message:"Please be sure to select a corpus.",buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR})},flex:1},{text:"Cancel",glyph:"xf00d@FontAwesome",flex:1,handler:function(a){a.up("window").close()}}]}}).show()}},{xtype:"fileuploadfield",glyph:"xf093@FontAwesome",name:"upload",buttonOnly:!0,hideLabel:!0,ui:"default-toolbar",buttonText:"Upload",listeners:{render:function(a){a.fileInputEl.dom.setAttribute("multiple",
!0);Ext.tip.QuickTipManager.register({target:a.getEl(),text:"Upload one or more documents from your computer"})},change:function(b,c){if(c){var d=b.up("form").getForm();if(d.isValid()){for(var e=b.fileInputEl.dom.files,f=/\.(png|gif|jpe?g|xls|mp[234a]|mpeg|exe|wmv|avi|ppt|mpg|tif|wav|mov|psd|wma|ai|bmp|pps|aif|pub|dwg|indd|swf|asf|mbd|dmg|flv)$/i,g=/\.(txt|pdf|html?|xml|docx?|rtf|pages|odt|zip|jar|tar|gz|ar|cpio|bzip2|bz2|gzip|xlsx?)$/i,h=[],k=[],m=0,l=e.length;m<l;m++){var n=e[m].name;f.test(n)?
h.push(n.split("/").pop()):g.test(n)||k.push(n.split("/").pop())}0<h.length||0<k.length?Ext.Msg.show({title:a.localize("fileTypesWarning"),icon:Ext.MessageBox.ERROR,message:a.localize("fileTypesMessage")+"\x3cul\x3e"+(0<h.length?"\x3cli\x3e"+a.localize("badFiles")+h.slice(0,5).join(", ")+(5<h.length?"\u2026":"")+"\x3c/li\x3e":"")+(0<k.length?"\x3cli\x3e"+a.localize("unknownFiles")+k.slice(0,5).join(", ")+(5<k.length?"\u2026":"")+"\x3c/li\x3e":"")+"\x3c/ul\x3e"+a.localize("sureContinue"),buttons:Ext.Msg.YESNO,
fn:function(c){"yes"===c?a.loadForm(d):(b.reset(),b.fileInputEl.dom.setAttribute("multiple",!0))},scope:d}):a.loadForm(d)}}}}},"-\x3e",{xtype:"button",scale:"large",glyph:"xf00d@FontAwesome",text:this.localize("cancel"),hidden:void 0==this.getCorpus(),handler:function(a){(a=this.up("window"))&&a.isFloating()&&a.close()}},{xtype:"button",scale:"large",glyph:"xf00c@FontAwesome",text:this.localize("reveal"),ui:"default",width:200,handler:function(b){var c=b.up("form").down("#input").getValue();if(""!==
c){var d=a.getApiParams();delete d.view;delete d.stopList;d.inputFormat&&0!==c.trim().indexOf("\x3c")?Ext.Msg.confirm(a.localize("error"),a.localize("errorNotXmlContinue"),function(b){"yes"==b&&a.loadCorpus(Ext.apply(d,{input:c}))},a):a.loadCorpus(Ext.apply(d,{input:c}))}else Ext.Msg.show({title:"No Text Provided",message:"Please provide text in the text box (or choose open or upload).",buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR})}}]}],items:{xtype:"textareafield",width:800,height:100,itemId:"input",emptyText:this.localize("emptyInput")}});
a.callParent(arguments)},loadForm:function(a){var b={tool:this.getCorpus()?"corpus.CorpusMetadata":"corpus.CorpusCreator"};this.getCorpus()&&Ext.apply(b,{corpus:this.getCorpus().getId(),addDocuments:!0});var c=this.getApiParams();delete c.view;delete c.stopList;Ext.apply(b,c);var d=this.getApplication().getViewport();d.mask(this.localize("uploadingCorpus"));a.submit({url:this.getTromboneUrl(),params:b,failure:function(a,b){d.unmask();b.result&&(this.setCorpus(void 0),this.loadCorpus({corpus:b.result.corpus?
b.result.corpus.metadata.id:b.result.stepEnabledCorpusCreator.storedId}))},scope:this})},loadCorpus:function(a){this.getCorpus()&&Ext.apply(a,{corpus:this.getCorpus().getId(),addDocuments:!0});var b=this.up("window");b&&b.isFloating()&&b.close();this.getApplication().loadCorpusFromParams(a)},showOptionsClick:function(a){void 0===a.optionsWin&&(a.optionsWin=Ext.create("Ext.window.Window",{title:a.localize("gearWinTitle"),closeAction:"hide",layout:"fit",bodyPadding:10,items:[{xtype:"form",defaultType:"textfield",
maxHeight:a.up("viewport").getHeight()-300,scrollable:!0,fieldDefaults:{labelAlign:"right",labelWidth:110,width:350},items:[{xtype:"combo",fieldLabel:a.localize("inputFormat"),labelWidth:90,name:"inputFormat",queryMode:"local",store:[["",a.localize("inputFormatAuto")],["dtoc","DToC: Dynamic Table of Contexts"],["TEI","TEI: Text Encoding Initative"],["TEI","TEI Corpus"],["RSS","Really Simple Syndication: RSS"]],forceSelection:!0,value:""},{xtype:"container",html:"\x3cp\x3e\x3ci\x3e"+(new Ext.Template(a.localize("advancedOptionsText"))).applyTemplate([a.getBaseUrl()+
...
(this.getStore().lastOptions.params.query=void 0)},getAggregateQuery:function(){var a=[];Ext.ComponentQuery.query("field",this).forEach(function(b){console.warn(b,b.getTokenType,b.value);if(b.getTokenType&&b.getValue){var c=b.getTokenType();b=Ext.Array.from(b.getValue());0<b.length&&0<b.length&&a.push("+("+b.map(function(a){return c+":"+a}).join("|")+")")}});return a.join(" ")}});Ext.define("Voyant.panel.CollocatesSet",{extend:"Ext.panel.Panel",requires:["Voyant.panel.ScatterPlot","Voyant.panel.Documents","Voyant.panel.Trends","Voyant.panel.Contexts"],mixins:["Voyant.panel.Panel"],alias:"widget.collocatesset",statics:{i18n:{},glyph:"xf17a@FontAwesome"},constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},layout:"vbox",header:!1,items:[{layout:"hbox",align:"stretch",width:"100%",height:"100%",flex:2,defaults:{width:"100%",
...
layout:"hbox",flex:4,defaults:{width:"100%",height:"100%",flex:1,frame:!0,border:!0},items:[{xtype:"contexts"},{xtype:"reader"}]}]});Ext.define("Voyant.panel.CustomSet",{extend:"Ext.panel.Panel",requires:"Voyant.panel.VoyantTabPanel Voyant.panel.Cirrus Voyant.panel.Summary Voyant.panel.CorpusTerms Voyant.panel.Reader Voyant.panel.Documents Voyant.panel.Trends Voyant.panel.Contexts Voyant.panel.Phrases Voyant.panel.DocumentTerms Voyant.panel.CorpusCollocates Voyant.panel.CollocatesGraph Voyant.panel.StreamGraph".split(" "),mixins:["Voyant.panel.Panel"],alias:"widget.customset",statics:{i18n:{},api:{panels:void 0},glyph:"xf17a@FontAwesome"},
...
"center").replace(/n1/g,"north").replace(/e1/g,"east").replace(/s2/g,"south").replace(/w2/g,"west").replace(/"xtype":"(\w+)"/g,function(b,c){Ext.ClassManager.getByAlias("widget."+c.toLowerCase())||(c="Links"==c?"CollocatesGraph":"CorpusGrid"==c?"Documents":"CorpusSummary"==c?"Summary":"CorpusTypeFrequenciesGrid"==c?"CorpusTerms":"DocumentInputAdd"==c?"CorpusTerms":"DocumentTypeCollocateFrequenciesGrid"==c?"CorpusTerms":"DocumentTypeFrequenciesGrid"==c?"DocumentTerms":"DocumentTypeKwicsGrid"==c?"Contexts":
"TypeFrequenciesChart"==c?"Trends":"VisualCollocator"==c?"CollocatesGraph":"NoTool");return'"xtype":"'+c.toLowerCase()+'"'+("NoTool"==c?',"html":"'+(new Ext.Template(a.localize("noSuchTool"))).applyTemplate([c])+'"':"")}),c;try{c=Ext.decode(b)}catch(d){c={region:"center",html:"\x3cdiv\x3eError constructing layout:"+d+"\x3c/div\x3e"}}null==c&&(c={region:"center",html:"\x3cdiv\x3eError: no layout information found.\x3c/div\x3e"});this.addLayouts(c);this.add(c)}},addLayouts:function(a){for(var b=Ext.getBody().getSize(),
c=0;c<a.length;c++){var d=a[c];Ext.isString(d.width)?d.width=Math.round(b.width*parseInt(d.width)/100):Ext.isString(d.height)&&(d.height=Math.round(b.height*parseInt(d.height)/100));d.items&&1<d.items.length?(d.layout="border",this.addLayouts(d.items)):d.layout="fit"}}});Ext.define("Voyant.panel.WordTree",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.wordtree",statics:{i18n:{},api:{query:void 0,docId:void 0,docIndex:void 0,stopList:"auto",context:10,limit:5},glyph:"xf1cb@FontAwesome"},config:{corpus:void 0,tree:void 0,kwicStore:void 0},clickTimeout:null,doubleClickDelay:300,constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(){Ext.apply(this,{title:this.localize("title"),
dockedItems:[{dock:"bottom",xtype:"toolbar",enableOverflow:!0,items:[{xtype:"querysearchfield"}]}]});this.setKwicStore(Ext.create("Voyant.data.store.Contexts",{parentPanel:this,proxy:{extraParams:{stripTags:"all"}},listeners:{load:function(a,b,c,d){if(c){a=[];c=[];d=[];for(var e=[],f=0;f<b.length;f++){var g=b[f];a.push(g.getLeft().trim().split(/\s+/));c.push(g.getMiddle());d.push(g.getRight().trim().split(/\s+/));e.push(f)}this.getTree().setupFromArrays(a,c,d,e,!1,["token","POS"],"/",["token","POS"]);
this.getTree().succeeded()||this.toastInfo({html:this.localize("emptyText"),align:"bl"})}},scope:this}}));this.on("loadedCorpus",function(a,b){this.setCorpus(b);b.getCorpusTerms({autoLoad:!1}).load({callback:function(a,b,e){e&&0<a.length&&(this.setApiParam("query",a[0].getTerm()),this.getKwicStore().load({params:this.getApiParams()}))},scope:this,params:{limit:1,query:this.getApiParam("query"),stopList:this.getApiParam("stopList")}})},this);this.on("query",function(a,b){void 0!==b&&""!=b&&this.setRoot(b)},
this);this.on("termsClicked",function(a,b){var c=[];b.forEach(function(a){Ext.isString(a)?c.push(a):a.term?c.push(a.term):a.getTerm&&c.push(a.getTerm())});this.setRoot(c)},this);this.on("documentTermsClicked",function(a,b){var c=[];b.forEach(function(a){a.getTerm()&&c.push(a.getTerm())});this.setRoot(c)},this);this.on("resize",function(a,b,c){},this);this.on("boxready",this.initGraph,this);this.callParent(arguments)},initGraph:function(){var a=this.getLayout().getRenderTarget(),b=a.getWidth(),c=a.getHeight(),
d=new doubletree.DoubleTree;d.init("#"+a.getId()).visWidth(b).visHeight(c).handlers({click:this.clickHandler.bind(this)});this.setTree(d)},clickHandler:function(a){function b(){this.clickTimeout=null;for(var b=[],d=a;null!=d;)b.push(d.name),d=d.parent;this.getApplication().dispatchEvent("termsClicked",this,b)}null==this.clickTimeout?this.clickTimeout=window.setTimeout(b.bind(this),this.doubleClickDelay):(window.clearTimeout(this.clickTimeout),this.clickTimeout=null,this.doubleClickHandler(a))},doubleClickHandler:function(a){this.setRoot(a.name)},
setRoot:function(a){this.setApiParam("query",a);this.getKwicStore().load({params:this.getApiParams()})}});Ext.define("Voyant.VoyantApp",{extend:"Ext.app.Application",mixins:["Voyant.util.Deferrable","Voyant.util.Localization","Voyant.util.Api"],requires:["Voyant.util.ResponseError"],name:"VoyantApp",statics:{i18n:{}},config:{baseUrl:void 0,tromboneUrl:void 0},constructor:function(a){this.setBaseUrl(this.config.baseUrl);this.setTromboneUrl(this.config.baseUrl+"trombone");Voyant.application=this;this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);this.callParent(arguments)},getTools:function(){return[{type:"maximize"},
...
statics:{i18n:{}},constructor:function(){this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);this.callParent(arguments)},config:{corpus:void 0,moreTools:[{i18n:"moreToolsScaleCorpus",glyph:"xf065@FontAwesome",items:"cirrus corpusterms bubblelines corpuscollocates streamgraph phrases documents summary trends scatterplot termsradio".split(" ")},{i18n:"moreToolsScaleDocument",glyph:"xf066@FontAwesome",items:"cirrus contexts documentterms reader trends knots".split(" ")},{i18n:"moreToolsTypeViz",
glyph:"xf06e@FontAwesome",items:"cirrus bubblelines collocatesgraph knots trends streamgraph scatterplot termsradio wordtree".split(" ")},{i18n:"moreToolsTypeGrid",glyph:"xf0ce@FontAwesome",items:"corpusterms corpuscollocates phrases contexts documentterms documents".split(" ")},{i18n:"moreToolsTypeOther",glyph:"xf035@FontAwesome",items:["reader","summary"]}]},launch:function(){this.callParent(arguments);if(this.hasQueryToLoad()){var a=Ext.Object.fromQueryString(document.location.search);!a.corpus&&
this.getCorpusId&&this.getCorpusId()&&(a.corpus=this.getCorpusId());this.loadCorpusFromParams(a)}},loadCorpusFromParams:function(a){var b=this,c=b.getViewport();c.mask(this.localize("fetchingCorpus"));a.archive&&(Ext.isString(a.archive)&&(a.archive=[a.archive]),a.archive=a.archive.map(function(a){return a.replace("/blogs.sub.uni-hamburg.de/hup/lhn/","/wikis.sub.uni-hamburg.de/lhn/index.php/").replace("/hup.sub.uni-hamburg.de/","/wikis.sub.uni-hamburg.de/")}));this.validateCorpusLoadParams(a);(new Corpus(a)).then(function(a){c.unmask();
b.setCorpus(a);b.validateCorpusAccess()&&b.dispatchEvent("loadedCorpus",this,a)}).fail(function(a,b){c.unmask()})},validateCorpusLoadParams:function(a){},validateCorpusAccess:function(){var a=this,b=a.getViewport(),c=this.getCorpus();if(c&&c.requiresPassword()&&!a.getViewport().query("panel").every(function(a){return!a.isConsumptive})){var d=c.getNoPasswordAccess(),e=[{text:"Validate"}];"NONCONSUMPTIVE"==d&&e.push({text:"Limited"});var f=Ext.create("Ext.window.Window",{title:a.localize("passwordRequiredTitle"),
