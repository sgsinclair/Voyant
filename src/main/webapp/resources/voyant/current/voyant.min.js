...
this.getCategoryFeature(a,"color");if(void 0!==b){b=this.hexToRgb(b);for(var c=this.getCategoryTerms(a),d=0;d<c.length;d++)this.colorTermAssociations.replace(c[d],b)}}},getCategoryExportData:function(){return{categories:this.getCategories(),features:this.getFeatures()}},loadCategoryData:function(a){var b=new Ext.Deferred;Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"resource.StoredResource",retrieveResourceId:a,failQuietly:!1}}).then(function(a){a=Ext.decode(a.responseText).storedResource.resource;
0==a.length?b.reject():(a=Ext.decode(a),this.setCategories(a.categories),this.setFeatures(a.features),b.resolve(a))},function(){this.showError("Unable to load categories data: "+a);b.reject()},null,this);return b.promise},saveCategoryData:function(a){a=a||this.getCategoryExportData();var b=new Ext.Deferred;a=Ext.encode(a);Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"resource.StoredResource",storeResource:a}}).then(function(a){a=Ext.util.JSON.decode(a.responseText).storedResource.id;b.resolve(a)},
function(a){b.reject()});return b.promise}});Ext.define("Voyant.util.DiacriticsRemover",{diacriticsMap:{},constructor:function(){var a=[{base:"A",letters:"A\u24b6\uff21\u00c0\u00c1\u00c2\u1ea6\u1ea4\u1eaa\u1ea8\u00c3\u0100\u0102\u1eb0\u1eae\u1eb4\u1eb2\u0226\u01e0\u00c4\u01de\u1ea2\u00c5\u01fa\u01cd\u0200\u0202\u1ea0\u1eac\u1eb6\u1e00\u0104\u023a\u2c6f"},{base:"AA",letters:"\ua732"},{base:"AE",letters:"\u00c6\u01fc\u01e2"},{base:"AO",letters:"\ua734"},{base:"AU",letters:"\ua736"},{base:"AV",letters:"\ua738\ua73a"},{base:"AY",letters:"\ua73c"},
...
this.setApiParams({query:b,limit:b.length,stopList:void 0});this.loadFromCorpus()},scope:this}},"-\x3e"]}),bbar:{overflowHandler:"scroller",items:[{xtype:"querysearchfield"},{xtype:"button",text:this.localize("clearTerms"),handler:function(){this.setApiParams({query:void 0});this.loadFromRecords([])},scope:this},{xtype:"corpusdocumentselector",singleSelect:!0},{text:this.localize("freqsMode"),glyph:"xf201@FontAwesome",tooltip:this.localize("freqsModeTip"),menu:{items:[{text:this.localize("relativeFrequencies"),
...
this.loadFromCorpusTerms(this.getCorpus().getCorpusTerms())},this);this.on("resize",this.resizeGraph,this);this.on("boxready",this.initGraph,this);this.callParent(arguments)},loadFromCorpus:function(){var a=this.getCorpus();this.getApiParam("docId")||this.getApiParam("docIndex")?this.loadFromDocumentTerms():1==a.getDocumentsCount()?this.loadFromDocument(a.getDocument(0)):this.loadFromCorpusTerms(a.getCorpusTerms())},loadFromCorpusTerms:function(a){var b=this.getApiParams(["limit","stopList","query",
"withDistributions","bins"]);b.bins&&b.bins>this.getCorpus().getDocumentsCount()&&(b.bins=this.getCorpus().getDocumentsCount());a.load({callback:function(a,b,e){e?(this.setMode(this.MODE_CORPUS),this.loadFromRecords(a)):Voyant.application.showResponseError(this.localize("failedGetCorpusTerms"),b)},scope:this,params:b})},loadFromDocument:function(a){if(a.then){var b=this;a.then(function(a){b.loadFromDocument(a)})}else"Voyant.data.model.Document"==Ext.getClassName(a)&&(this.setApiParams({docIndex:void 0,
query:void 0,docId:a.getId()}),this.isVisible()&&this.loadFromDocumentTerms())},loadFromDocumentTerms:function(a){this.getCorpus()&&(a=a||this.getCorpus().getDocumentTerms({autoLoad:!1}),a.load({callback:function(a,c,d){d?(this.setMode(this.MODE_DOCUMENT),this.loadFromRecords(a)):Voyant.application.showResponseError(this.localize("failedGetDocumentTerms"),c)},scope:this,params:this.getApiParams("docId docIndex limit stopList query withDistributions bins".split(" "))}))},loadFromRecords:function(a){var b=
[],c=[];a.forEach(function(a,e){e=a.getTerm();a=a.get("distributions");for(var d=0;d<a.length;d++)void 0===c[d]&&(c[d]={}),c[d][e]=a[d];b.push({id:e,name:e,mark:this.getApplication().getColorForTerm(e,!0),active:!0})},this);this.setLayerData(c);this.down("[xtype\x3dlegend]").getStore().loadData(b);this.doLayout()},doLayout:function(a){a=this.getLayerData();if(void 0!==a){var b=this,c=[];this.down("[xtype\x3dlegend]").getStore().each(function(a){c.push(a.getId())});if(this.getMode()===this.MODE_DOCUMENT)var d=
this.getApiParam("bins");else{d=this.getApiParam("bins");var e=this.getCorpus().getDocumentsCount();d=d<e?d:e}this.getVisLayout().keys(c);e=this.getVisLayout()(a);a=this.body.down("svg").getWidth()-this.graphMargin.left-this.graphMargin.right;var f=d3.scaleLinear().domain([0,d-1]).range([0,a]),g=d3.min(e,function(a){return d3.min(a,function(a){return a[0]})}),k=d3.max(e,function(a){return d3.max(a,function(a){return a[1]})});d=this.body.down("svg").getHeight()-this.graphMargin.top-this.graphMargin.bottom;
...
function(a){return b.getApplication().getColorForTerm(a.key,!0)}).select("title").text(function(a){return a.key});e.enter().append("path").attr("d",function(a){return l(a)}).style("fill",function(a){return b.getApplication().getColorForTerm(a.key,!0)}).append("title").text(function(a){return a.key});e.exit().remove();this.getVis().selectAll("g.axis").remove();this.getVis().append("g").attr("class","axis x").attr("transform","translate(0,"+d+")").call(k);this.getMode()===this.MODE_CORPUS?(this.getVis().select("g.axis.x").selectAll("text").each(function(){d3.select(this).attr("text-anchor",
...
"middle").attr("transform","translate(-"+(this.graphMargin.left-20)+", "+d/2+") rotate(-90)").attr("fill","#000").text(a)}},getCurrentTerms:function(){var a=[];this.down("[xtype\x3dlegend]").getStore().each(function(b){b.get("active")&&a.push(b.get("name"))},this);return a},initGraph:function(){if(void 0===this.getVisLayout()){var a=this.getLayout().getRenderTarget();this.setVisLayout(d3.stack().offset(d3.stackOffsetWiggle).order(d3.stackOrderInsideOut));this.setVis(d3.select(a.dom).append("svg").attr("id",
...
this.getBaseUrl()},getRelativeUrl:function(){for(var a="",b=0,c=window.location.pathname.substring(this.getBaseUrl().length).split("/").length-1;b<c;b++)a+="../";return a},getTools:function(){return[{type:"maximize"},{type:"help"}]},launch:function(){Ext.tip.QuickTipManager.init();Ext.apply(Ext.tip.QuickTipManager.getQuickTip(),{showDelay:50});this.getApiParam("categories")&&this.loadCategoryData(this.getApiParam("categories")).then(function(){this.setColorTermAssociations()},null,null,this);this.callParent(arguments)},
tromboneCall:function(a){a=a?a:{};Ext.applyIf(a,{url:this.getTromboneUrl()});a.success||a.failure||a.callback||Ext.applyIf(a,{url:this.getTromboneUrl(),scope:this,callback:function(b,c,d){this.dispatchEvent(a.tool+"Loaded",b,c,d)}});Ext.Ajax.request(a)},getViewport:function(){return Ext.ComponentQuery.query("viewport")[0]},dispatchEvent:function(a,b){var c=this.getViewport().query("panel,chart"),d=!1;this.hasListener&&this.hasListener(a)&&(this.fireEvent.apply(this,arguments),d=!0);for(var e=0;e<
...
collapsible:!0},{xtype:"documentclusters",collapsible:!0}],flex:6}]});this.callParent(arguments)}});Ext.define("Voyant.VoyantDefaultApp",{extend:"Voyant.VoyantCorpusApp",mixins:["Voyant.util.Api"],name:"VoyantDefaultApp",constructor:function(){this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);this.callParent(arguments)},statics:{i18n:{},api:{view:"corpusset",stopList:"auto",categories:"auto",panels:void 0,rtl:void 0}},listeners:{loadedCorpus:function(a,b){this.viewport.down("voyantheader").collapse();this.viewport.down("#toolsContainer").setActiveItem(1);a=this.getCorpusId&&this.getCorpusId()?
this.getCorpusId():void 0;if(window.history.pushState&&!a){a=b.getAliasOrId();b=Ext.Object.fromQueryString(document.location.search);var c=this.getBaseUrl()+"?corpus\x3d"+a,d;for(d in b)if("corpus"!==d){var e=Ext.isString(b[d])?[b[d]]:b[d];Ext.isArray(e)&&e.forEach(function(a){c+="\x26"+d+"\x3d"+a})}window.history.pushState({corpus:a},"Corpus: "+a,c)}}},getViewComponent:function(){return this.viewport.down("#toolsContainer-main")},launch:function(){var a=Ext.Object.fromQueryString(document.location.search)||
