...
g.ctx.beginPath();g.ctx.moveTo(f,g.yIndex);g.ctx.lineTo(f+d,g.yIndex);g.ctx.stroke();g.ctx.beginPath();g.ctx.moveTo(f+d,g.yIndex-6);g.ctx.lineTo(f+d,g.yIndex+6);g.ctx.stroke()};this.DRAW_TITLES&&(f+=e,this.ctx.fillStyle="rgba(128, 128, 128, 1.0)",e=a.title,this.DRAW_SHORT_TITLES&&(e=b+1+")"),this.ctx.fillText(e,f,this.yIndex));this.yIndex+=4;var g=this;this.SEPARATE_LINES_FOR_TERMS?null!=this.termsFilter&&0!==this.termsFilter.length||c():c();var e=2*Math.PI,k=0;a.freqCounts={};var h=a.terms,l=null!=
this.lastClickedBubbles[b],m=0,n;for(n in h)if(-1!==this.termsFilter.indexOf(n)){var p=h[n];if(p){m++;this.SEPARATE_LINES_FOR_TERMS&&c();var r=0,q=p.color.join(",");this.ctx.strokeStyle="rgba("+q+", 1)";this.ctx.fillStyle="rgba("+q+", 0.35)";this.ctx.lineWidth=.25;for(var k=k+p.rawFreq,r=r+p.rawFreq,s=l&&this.lastClickedBubbles[b][n],u=0;u<p.pos.length;u++){var A=p.pos[u];if(0<A.radius){var D=!1;s&&this.lastClickedBubbles[b][n]==A.id&&(this.ctx.strokeStyle="rgba(0, 0, 0, 0.75)",this.ctx.fillStyle=
"rgba("+q+", 0.5)",this.ctx.lineWidth=1,D=!0);this.ctx.beginPath();this.ctx.arc(A.x+f,this.yIndex,A.radius,0,e,!0);this.ctx.closePath();this.ctx.fill();this.ctx.stroke();D&&(this.ctx.strokeStyle="rgba("+q+", 1)",this.ctx.fillStyle="rgba("+q+", 0.35)",this.ctx.lineWidth=.25)}}a.freqCounts[n]=r;this.SEPARATE_LINES_FOR_TERMS&&(this.ctx.fillStyle="rgba(0, 0, 0, 1.0)",this.ctx.font="10px Verdana",this.ctx.fillText(r,f+d+5,this.yIndex-4),this.yIndex+=this.maxRadius)}}this.SEPARATE_LINES_FOR_TERMS&&0==m&&
(c(),this.ctx.fillStyle="rgba(0, 0, 0, 1.0)",this.ctx.font="10px Verdana",this.ctx.fillText(0,f+d+5,this.yIndex-4),this.yIndex+=this.maxRadius);f+=d;this.SEPARATE_LINES_FOR_TERMS||(this.ctx.fillStyle="rgba(0, 0, 0, 1.0)",this.ctx.font="10px Verdana",this.ctx.fillText(k,f+5,this.yIndex-4))}this.yIndex=this.SEPARATE_LINES_FOR_TERMS?this.yIndex+.5*this.maxRadius:this.yIndex+a.height;this.yIndex-=4}},drawLegend:function(){var a=this.MAX_LABEL_WIDTH+this.maxRadius;this.ctx.textBaseline="top";this.ctx.font=
...
d.connect(e);e.connect(this.audioCtx.destination);d.frequency.value=500*Math.random()+150;d.start();e.gain.value=0;this.currentDoc.terms[c].audio={oscillator:d,gainNode:e}}this.cacheTurns(this.currentDoc.terms[c],a)}},cacheTurns:function(a,b){if(0<a.rawFreq){for(var c=this.currentDoc,d=a.term,e=[],f=a.positions,g=f[f.length-1],k=this.startAngle,h=this.angleIncrement,l=0,m=0,n=0,p=0,r=l=0;r<f.length;r++){var q=f[r],s=q/g*b,u=s-l,l=n,m=p,p=this.findEndPoint([n,p],u,k),n=p[0],p=p[1],l=this.getPolygonFromLine([l,
m],[n,p],k,this.LINE_SIZE);e.push({tokenId:q,polygon:l,over:!1});l=s;k+=h}c.terms[d].pos=e;c.terms[d].done=!1}},findEndPoint:function(a,b,c){var d=this.degreesToRadians(c);c=a[0]+b*Math.cos(d);a=a[1]+b*Math.sin(d);return[c,a]},determineGraphSizeAndPosition:function(){var a=this.findBoundingBoxForGraph(),b=a.maxX-a.minX,c=a.maxY-a.minY,d=Math.min(this.canvas.width/b,this.canvas.height/c),d=d-.05,c=c*d;this.offset.x=Math.abs(a.minX*d-(this.canvas.width/2-b*d/2));this.offset.y=Math.abs(a.minY*d-(this.canvas.height/
...
(d=90,c.ty=0):(d=-90,c.ty=c.height,c.tx=c.width));c.size=Math.max(c.height,c.width);c.rotation=Math.PI/180*d;g.context.fillStyle=g.canvas.style.backgroundColor;g.context.fillRect(0,0,g.canvas.width,g.canvas.height);c.draw(g.context);d=g.context.getImageData(c.x,c.y,c.width,c.height);for(var e=[],k=0;k<c.width;k++){var h=Math.floor(k/f.COARSENESS)*f.COARSENESS;null==e[h]&&(e[h]={});for(var l=0;l<c.height;l++){var m=Math.floor(l/f.COARSENESS)*f.COARSENESS,n;n=4*(k+l*d.width);n=[d.data[n],d.data[n+1],
d.data[n+2],d.data[n+3]];"rgb("+n[0]+", "+n[1]+", "+n[2]+")"!=g.canvas.style.backgroundColor&&(e[h][m]=!0);e[h][m]&&(l=m+f.COARSENESS)}}c.mask=e}}function e(){g.clear();for(var a=q.length;a--;){var b=q[a];b.alpha=1;b.live&&b.draw(g.context)}a=$(g.canvas);if(null!=n){a.css("cursor","pointer");g.context.save();g.context.textBaseline="alphabetic";g.context.font="12px Arial";var b=g.context.measureText(n.text).width,c=g.context.measureText(n.value).width,b=(b>c?b:c)+20,c=p+15,d=r+25,e=a.width(),a=a.height();
c+b>=e&&(c-=b);d+40>=a&&(d-=40);g.context.fillStyle="rgba(255,255,255,0.9)";g.context.strokeStyle="rgba(100,100,100,0.9)";g.context.translate(c,d);g.context.fillRect(0,0,b,40);g.context.strokeRect(0,0,b,40);g.context.fillStyle="rgba(0,0,0,0.9)";g.context.fillText(n.text+":",8,18);g.context.fillText(n.value,8,30);g.context.restore()}else a.css("cursor","default")}var f=this,g=a;this.CIRCLE=0;this.ratio=1;var k=this.CIRCLE;this.getLayout=function(){return k};this.setLayout=function(a){k=a};this.HORIZONTAL=
0;var h=this.MIXED=1;this.getWordOrientation=function(){return h};this.setWordOrientation=function(a){h=a};this.UPDATE_RATE=25;this.COARSENESS=5;this.grid=[];var l=0,m;this.doingArrange=!1;this.wordsToArrange=5;var n=null,p=0,r=0,q=[];this.getWords=function(){return q};this.setWords=function(a){q=a};this.sizeAdjustment=100;this.minFontSize=12;this.largestWordSize=0;this.smallestWordSize=1E4;var s={};this.addWords=function(a){for(var b=!1,e=0;e<a.length;e++){var k=a[e],h;h=void 0==typeof k.color||
null==k.color||""==k.color?g.colors[Math.floor(Math.random()*g.colors.length)]:k.color;var l;l=void 0==typeof k.size||null==k.size||""==k.size?Math.floor(40*Math.random()):parseFloat(k.size);var m=k.word,n=k.label,p=k.value,k=!1;null==s[m]&&(s[m]=!0,l>f.largestWordSize&&(f.largestWordSize=l,k=!0),l<f.smallestWordSize&&(f.smallestWordSize=.8*l,k=!0),m=new Word(m,l,h,n,p),q.push(m));b=k||b}c();this.setRelativeSizes();this.calculateSizeAdjustment();b?this.resizeWords():d()};this.resetWordCoordinates=
function(){g.clear();clearTimeout(m);for(var a=0;a<q.length;a++){var b=q[a];b.x=0;b.y=0;b.tx=0;b.ty=0}};this.calculateSizeAdjustment=function(){this.ratio=g.canvas.width/g.canvas.height;var a=g.canvas.width*g.canvas.height;this.minFontSize=1E5>a?8:12;for(var c=0,d=0;d<q.length;d++)var e=b(q[d]),c=c+e;this.sizeAdjustment=a/c};this.setRelativeSizes=function(){for(var a=0;a<q.length;a++){var b=q[a],c=this.smallestWordSize;b.relativeSize=.1+(b.origSize-c)/(this.largestWordSize-c)*.9}};this.resizeWords=
...
0;g<=c;g+=this.COARSENESS)if(e[f]&&e[f][g]&&null!=this.grid[f+a]&&null!=this.grid[f+a][g+b])return!0;return!1},f;this.grid=[];l=0;f=function(){var a,f,k,h,n=this.wordsToArrange-1,s=g.canvas.width,p=g.canvas.height,r=.5*s,u=.5*p;do{k=q[l];if(void 0!==k){for(var v=Math.random()*Math.PI,z=.25*Math.random()*k.size,w=.5*(Math.random()-.5),F=.5*k.width,I=.5*k.height;;){a=Math.floor((r+Math.cos(v)*z*this.ratio-F)/this.COARSENESS)*this.COARSENESS;f=Math.floor((u+Math.sin(v)*z-I)/this.COARSENESS)*this.COARSENESS;
h=a+F>=s||f+I>=p?!0:d(a,f,k.height,k.width,k.mask);if(!h)break;v+=w;z+=.05}c(a,f,k);if(g.useFadeEffect)for(a=k.alpha=0;a<l;a++)f=q[a],1>f.alpha&&b(f);else k.alpha=1,k.draw(g.context)}l++;if(l>=q.length){clearTimeout(m);this.doingArrange=!1;this.toggleLoadingText(!1);e();break}}while(n--)}.createDelegate(this);d=d.createDelegate(this);c=c.createDelegate(this);b=b.createDelegate(this);a=a.createDelegate(this);this.doingArrange=!0;m=setInterval(f,50)}else alert("Error: There are no words to arrange.")};
this.toggleLoadingText=function(a){g.context.save();g.context.fillStyle=a?"black":g.canvas.style.backgroundColor;g.context.textBaseline="top";g.context.font="10px Arial";a=g.context.measureText("Loading").width+10;g.context.fillText("Loading",g.canvas.width-a,10);g.context.restore()};this.startUpdates=function(){m=setInterval(e,f.UPDATE_RATE)};this.stopUpdates=function(){null!=n&&(n=null,e());clearTimeout(m)};this.handleMouseMove=function(a){if(!this.doingArrange){for(var b=q.length;b--;)q[b].isOver=
...
(function(){function a(d,f,g){if(d.children){g&&(d.info.origIDs?(d.info.ids={},c(d.info.ids,d.info.origIDs),d.info.count=Object.keys(d.info.ids).length):(d.info.origIDs={},c(d.info.origIDs,d.info.ids),d.info.origCount=Object.keys(d.info.origIDs).length));var k=Object.keys(f);g=0;for(var h=k.length;g<h;g++)delete d.info.ids[k[g]];d.info.count=Object.keys(d.info.ids).length;h=d.children.length;for(g=0;g<h;g++)k=d.children[g],b(k.info.ids,f)?d.children[g]=null:a(k,f,!1);d.children=d.children.filter(function(a){return null!=
...
return b};b.redraw=function(){void 0!==x&&void 0!==G&&b.setupFromTries(x,G);return b};b.setupFromTries=function(d,h){x=d.getUniqRoot();G=h.getUniqRoot();var v=x.toTree(l.left),z=G.toTree(l.right),w=!0;0<Object.keys(z.pruned).length&&(a(z,z.pruned,w),a(v,z.pruned,w),w=!1);0<Object.keys(v.pruned).length&&(a(v,v.pruned,w),a(z,v.pruned,w));var w={},F;for(F in z.info)"continuations"!=F&&"ids"!=F&&"count"!=F&&(w[F]=z.info[F]);w["right continuations"]=z.info.continuations;w["left continuations"]=v.info.continuations;
w.ids={};c(w.ids,z.info.ids);c(w.ids,v.info.ids);w.count=Object.keys(w.ids).length;K=Object.keys(w.ids);if(z.info.origIDs||v.info.origIDs)w.origIDs={},c(w.origIDs,z.info.origIDs),c(w.origIDs,v.info.origIDs),w.origCount=Object.keys(w.origIDs).length;z.info=w;v.info=w;F=Math.max(v.maxChildren,z.maxChildren);if(isNaN(F)||0==F)return I=!1,b;p?E=d3.scaleLog().range([8,14]):(E=function(){return 14},E.domain=function(){});F=Math.min(v.minCount,z.minCount);E.domain([F,v.info.count]);var L=g-20-20,M=k-20-
...
B=new doubletree.Tree(c.select("g"),g,k,v,!0,r,J,E,n,q,s,u,A,D,H);C=new doubletree.Tree(c.select("g"),g,k,z,!1,r,J,E,n,q,s,u,A,D,H)});B.handleAltPress=m.alt;C.handleAltPress=m.alt;B.handleShiftPress=m.shift;C.handleShiftPress=m.shift;B.handleClick=m.click;C.handleClick=m.click;I=!0;return b};b.setupFromArrays=function(a,c,d,f,g,k,l,m){void 0==g&&x&&(g=x.caseSensitive());void 0==k&&x&&(k=x.fieldNames());void 0==l&&x&&(l=x.fieldDelim());void 0==m&&x&&(m=x.distinguishingFieldsArray());x=new doubletree.Trie(g,
k,l,m);G=new doubletree.Trie(g,k,l,m);g=c.length;for(k=0;k<g;k++){l=f?f[k]:k;m=c[k];var n=a[k].slice(),s=d[k].slice();n.push(m);n.reverse();s.unshift(m);h?(G.addNgram(n,l),x.addNgram(s,l)):(x.addNgram(n,l),G.addNgram(s,l))}b.setupFromTries(x,G);return b};b.filteredIDs=function(){return K};b.search=function(a){B.search(a);C.search(a);a=d3.select(f[0]);var b=a.selectAll("text.foundText");if(b.empty())return 0;b=b[0].length;null!=a.selectAll("text.rtNdText.foundText").node()&&b--;return b};b.clearSearch=
function(){B.clearSearch();C.clearSearch();return b};b.updateTokenExtras=function(){B.showTokenExtras(n);C.showTokenExtras(n);var a=d3.select(f[0]).select('.tokenExtra[display\x3d"inline"]');a.empty()||"0px"==a.style("height")&&b.redraw();return b};b.visWidth=function(a){if(!arguments.length)return g;g=a;return b};b.visHeight=function(a){if(!arguments.length)return k;k=a;return b};b.prefixesOnRight=function(a){if(!arguments.length)return h;h=a;return b};b.filters=function(a){if(!arguments.length)return l;
l=a;return b};b.handlers=function(a){if(!arguments.length)return m;m=a;return b};b.showTokenExtra=function(a){if(!arguments.length)return n;n=a;return b};b.scaleLabels=function(a){if(!arguments.length)return p;p=a;return b};b.succeeded=function(){return I};b.sortFun=function(a){if(!arguments.length)return r;r=a;return b};b.nodeText=function(a){if(!arguments.length)return q;q=a;return b};b.tokenExtraText=function(a){if(!arguments.length)return s;s=a;return b};b.rectColor=function(a){if(!arguments.length)return u;
u=a;return b};b.rectBorderColor=function(a){if(!arguments.length)return A;A=a;return b};b.continuationColor=function(a){if(!arguments.length)return D;D=a;return b};b.basicStyles=function(a){if(!arguments.length)return H;Object.keys(H).forEach(function(b){b in a&&Object.keys(H[b]).forEach(function(c){c in a[b]&&(H[b][c]=a[b][c])})});return b};return b};doubletree.Tree=function(a,b,c,d,h,l,m,n,p,r,q,s,u,A,D){function H(a){a.children&&(a._children=a.children,a._children.forEach(H),a.children=null)}function I(a){a.parent&&
...
!1));b&&v.update(a)}function G(a){return h?-a:a}var B=p,C=s;b=b-20-20;c=c-20-20;var K=0,E;l||(l=doubletree.sortByStrFld("token"));var K=0,O=d3.tree().size([c,b]).nodeSize([40,40]),N=d3.linkHorizontal().x(function(a){return G(a.y)}).y(function(a){return a.x});a=a.append("g").attr("transform","translate(20,20)");this.readJSONTree=function(a){E=d3.hierarchy(a);E.x0=0;E.y0=0;E.children.forEach(H);this.update(E)};this.update=function(b){var c=O(E).descendants();c.forEach(function(a){var b=a.textSize;if(void 0==
b){for(var b=0,c=a.parent;null!=c;)var d=Ext.draw.TextMeasurer.measureText(c.data.name,"arial").width,b=b+d,c=c.parent;a.textSize=b}a.y=25*a.depth+b});var d=a.selectAll("g.node_"+h).data(c,function(a){return a.id||(a.id=++K)}),f=d.enter().append("g").attr("class","node node_"+h).attr("cursor","pointer").attr("transform",function(a){return"translate("+G(b.y0)+","+b.x0+")"}).on("click",J);f.append("title").text(function(a){return doubletree.infoToText(a.data.info)});f.append("circle").attr("r",1E-6).style("fill",
function(a){return a._children?"#fff":D.node.fill}).style("stroke",function(a){return D.node.stroke});var g=f.append("text").attr("class",function(a){return 0==a.depth?"rtNdText":""}).attr("x",function(a){return a.children||a._children?0:h?10:-10}).attr("text-anchor",function(a){return a.parent?a.children||a._children?h?"end":"start":h?"start":"end":"middle"}).style("font-size",function(a){return n(a.data.info.count)+"pt"});g.append("tspan").attr("dy",".35em").attr("class","tokenText").text(function(a){return r(a.data.info,
1>a.depth)}).style("fill-opacity",1E-6);g.append("tspan").attr("dx",".35em").attr("class","tokenExtra").text(function(a){return q(a.data.info,1>a.depth)}).style("fill-opacity",1E-6);this.drawRects();f=f.merge(d);f.transition().duration(200).attr("transform",function(a){return"translate("+G(a.y)+","+a.x+")"});f.select("circle").attr("r",function(a){return a.children||a._children?1E-6:4.5}).style("fill",function(a){return a._children?"#fff":D.node.fill}).style("stroke-width",D.node["stroke-width"]);
f.selectAll("tspan").style("fill-opacity",1);d=d.exit().transition().duration(200).attr("transform",function(a){return"translate("+G(b.y)+","+b.x+")"}).remove();d.select("circle").attr("r",1E-6);d.selectAll("tspan").style("fill-opacity",1E-6);d=a.selectAll("path.link_"+h).data(E.links(),function(a){return a.source.id+"-"+a.target.id});d.enter().insert("path","g").attr("class","link link_"+h).attr("d",function(a){a={x:b.x0,y:b.y0};return N({source:a,target:a})}).style("fill","none").style("stroke",
D.branch.stroke).style("stroke-width",D.branch["stroke-width"]).merge(d).transition().duration(200).attr("d",N);d.exit().transition().duration(200).attr("d",function(a){a={x:b.x0,y:b.y0};return N({source:a,target:a})}).remove();c.forEach(function(a){a.x0=a.x;a.y0=a.y});this.updateContinuations()};this.drawRects=function(){var b=B?"inline":"none";a.selectAll(".tokenExtra").attr("display",b);b=a.selectAll("g.node_"+h);b.selectAll("rect").remove();b.insert("rect","text").attr("class","nodeRect").attr("height",
...
(function(){doubletree.Trie=function(a,b,c,d,e){function f(a,b,c){this.id=b;this.count=c;this.info={count:c,ids:{}};if(null==a)this.item=h;else{this.item=a;this.info.ids={};this.info.ids[b]=!0;a=a.split(n);for(var d in a)this.info[m[d]]=[a[d]]}this.nodes={};this.addNgram=function(a,b,c){c||(c=1);var d,e;if(0<a.length){d=a.shift();var g=d.split(n);e=r&&this.item==h?"":g.filter(function(a,b){return-1<p.indexOf(m[b])}).map(function(a){return l?a.toLocaleLowerCase():a}).join(n)}else e=d=k;var s;if(e in
this.nodes&&this.nodes[e]instanceof f){s=this.nodes[e];s.info.count+=c;s.info.ids[b]=!0;for(var q in g)e=g[q],-1==s.info[m[q]].indexOf(e)&&s.info[m[q]].push(e)}else s=new f(d,b,c),this.nodes[e]=s;d!=k&&s.addNgram(a,b,c)};this.getUniqRoot=function(){if(this.item==h){var a=Object.keys(this.nodes);if(1==a.length)return this.nodes[a[0]]}return this};this.toTree=function(a){function b(a,c,d){var e={children:[]};e.name=d.item;e.info={};for(var f in d.info)if("Object"===typeof d.info[f]){e.info[f]={};for(var k in d.info[f])e.info[f][k]=
...
d=e.getStore().findExact("name",a);e.getStore().removeAt(d)}for(var e=this.parent.getApiParam("selectedWords"),f=0,g=e.length;f<g;f++)e[f]===c&&(e.splice(f,1),this.parent.setApiParams({selectedWords:e}));this.chartOverlayOff(c);this.overlayQueue.splice(d,1);this.isSliderVisible&&this.sliderOverlayOff(c);this.lastSticky=c},prepareFullPath:function(a){for(var b=[],c=this.absMaxFreq,d=this.absMinFreq,e=0,f=this.allData.length;e<f;e++){for(var g=foundB=0,k=this.allData[e].allDataInternal.length;g<k;g++)for(var h=
0,l=this.allData[e].allDataInternal[g].frequencyArray.length;h<l;h++)if(this.allData[e].allDataInternal[g].frequencyArray[h].wordString===a){var m=this.allData[e].allDataInternal[g].frequencyArray[h].freq;b.push({x:e,y:m});m<c&&(c=m);m>d&&(d=m);foundB=1}0===foundB&&(g=this.minFreq,b.push({x:e,y:g}),g<c&&(c=g),g>d&&(d=g))}return{path:b,min:c,max:d}},updateFullPath:function(){for(var a=this.overlayQueue.length;0<a--;){var b=this.prepareFullPath(this.overlayQueue[a].word);this.overlayQueue[a].fullPath=
...
(1+e)].allDataInternal[f].frequencyArray[g].freq),b.unshift({x:this.shiftCount-(1+e),y:c}),c=1);0===c&&(f=this.yScale(this.minFreq),b.unshift({x:this.shiftCount-(1+e),y:f}))}e=this.shiftCount;for(c=this.numVisPoints+this.shiftCount;e<c;e++){for(var f=d=0,k=this.allData[e].allDataInternal.length;f<k;f++)for(var g=0,h=this.allData[e].allDataInternal[f].frequencyArray.length;g<h;g++)this.allData[e].allDataInternal[f].frequencyArray[g].wordString===a&&(d=this.yScale(this.allData[e].allDataInternal[f].frequencyArray[g].freq),
...
g=e.surfaceZIndexes,k,h,l,m;for(h=1;h<d.length;h++){l=d[h];m=g[l.type];for(e=h-1;0<=e&&g[d[e].type]>m;)d[e+1]=d[e],e--;d[e+1]=l}var n=document.createElement("canvas"),g=Ext.getClassName(d[0]),c=d[0].devicePixelRatio*c,p=n.getContext("2d"),r;n.width=Math.ceil(f.width*c);n.height=Math.ceil(f.height*c);for(e=0;e<d.length;e++)if(l=d[e],Ext.getClassName(l)===g)for(f=l.getRect(),surfaceSize=l.el.getSize(),h=0;h<l.canvases.length;h++)r=l.canvases[h],m=r.getOffsetsTo(r.getParent()),p.drawImage(r.dom,(f[0]+
m[0])*c,(f[1]+m[1])*c,surfaceSize.width*c,surfaceSize.height*c);b&&b.isVisible()&&b.unmask();return this.exportPngData(n.toDataURL())}h=this.getTargetEl().dom;if(r=h.querySelector("canvas")){if(1==c)return c=r.toDataURL("image/png"),b&&b.isVisible()&&b.unmask(),this.exportPngData(c);n=document.createElement("canvas");p=n.getContext("2d");n.width=Math.ceil(r.width*c);n.height=Math.ceil(r.height*c);k=new Image;k.src=r.toDataURL("image/png");k.panel=this;k.onload=function(){p.drawImage(k,0,0,n.width,
n.height);q=n.toDataURL("image/png");b&&b.isVisible()&&b.unmask();this.panel.exportPngData.call(this.panel,q)}}else if(e=h.querySelector("svg")){d=h.offsetWidth*c;h=h.offsetHeight*c;e=e.cloneNode(!0);e.setAttribute("version",1.1);e.setAttribute("xmlns","http://www.w3.org/2000/svg");e.setAttribute("transform","scale("+c+")");e.setAttribute("width",d);e.setAttribute("height",h);var q="data:image/svg+xml;base64,"+btoa(unescape(encodeURIComponent(e.outerHTML)));r=Ext.DomHelper.createDom({tag:"canvas",
width:d,height:h});var s=r.getContext("2d");k=new Image;k.src=q;k.panel=this;k.onload=function(){s.drawImage(k,0,0);q=r.toDataURL("image/png");b&&b.isVisible()&&b.unmask();return this.panel.exportPngData.call(this.panel,q)}}},exportUrl:function(){this.openUrl(this.getExportUrl())},exportEmbed:function(){var a=0==this.isXType("voyantheader");console.warn(this.xtype,a);Ext.Msg.show({title:this.localize("exportViewEmbedTitle"),message:this.localize("exportViewEmbedMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,
...
c.storedResource.id&&""!=c.storedResource.id?this._doGetStored(c.storedResource.id,!1).then(function(a){for(var c="",f={},g=0;g<a.length;g++)this._doGetStored(a[g],!0).then(function(g){f[g[0]]=g[1];g=!0;for(var h=a.length-1;0<=h;h--)if(void 0===f[a[h]]){g=!1;break}if(g){for(h=0;h<a.length;h++)c+=f[a[h]];b.resolve(Ext.decode(c))}},function(){b.reject()},null,this)},function(){b.reject()},null,this):this._doGetStored(a,!1).then(function(a){b.resolve(a)},function(){b.reject()},null,this)},function(){b.reject()},
...
getText:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments);var b=Voyant.application.getDeferred(this);a=a||{};Ext.apply(a,{tool:"corpus.DocumentTokens",corpus:this.getCorpusId()});this.getTokens(a).then(function(a){b.resolve(a)});return b.promise},getPlainText:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments);a=a||{};Ext.apply(a,{outputFormat:"text",template:"docTokens2text",noOthers:!0});return this.getText()},getLemmasArray:function(a){a=
a||{};a.docId=this.getId();return this.getCorpus().getLemmasArray(a)},getEntities:function(a){a=a||{};Ext.applyIf(a,{proxy:{}});Ext.applyIf(a.proxy,{extraParams:{}});Ext.applyIf(a.proxy.extraParams,{docIndex:this.get("index")});return Ext.create("Voyant.data.store.DocumentEntities",Ext.apply(a,{corpus:this.getCorpus(),docId:this.getId()}))},loadEntities:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments);var b=Voyant.application.getDeferred(this);this.getEntities().load({params:a,
callback:function(a,d,e){e?b.resolve(a):b.reject(d.error.response)}});return b.promise},getCSS:function(){return this.get("css")}});Ext.define("Voyant.data.model.DocumentEntity",{extend:"Ext.data.Model",fields:[{name:"term"},{name:"docIndex",type:"int"},{name:"rawFreq",type:"int"},{name:"type"},{name:"positions"}],getTerm:function(){return this.get("term")},getDocIndex:function(){return this.get("docIndex")},getRawFreq:function(){return this.get("rawFreq")},getPositions:function(){return this.get("positions")}});Ext.define("Voyant.data.model.DocumentQueryMatch",{extend:"Ext.data.Model",fields:[{name:"id"},{name:"count",type:"int"},{name:"query"},{name:"distributions"}],getCount:function(){return this.get("count")},getDistributions:function(){return this.get("distributions")},getDocIds:function(){return this.get("docIds")}});Ext.define("Voyant.data.model.DocumentTerm",{extend:"Ext.data.Model",fields:[{name:"id"},{name:"term"},{name:"docIndex",type:"int"},{name:"docId"},{name:"rawFreq",type:"int"},{name:"relativeFreq",type:"float"},{name:"tfidf",type:"float"},{name:"zscore",type:"float"},{name:"zscoreRatio",type:"float"},{name:"distributions"}],getTerm:function(){return this.get("term")},getDocIndex:function(){return this.get("docIndex")},getRawFreq:function(){return this.get("rawFreq")},getRelativeFreq:function(){return this.get("relativeFreq")},
...
a.listeners||{},a.listeners.beforeload={fn:function(a,b){var c=this.getParentPanel(),g=a.getProxy();if(void 0!==c){c=c.getApiParams();b=b?1===b?{}:b:{};b.params=b.params||{};g&&this.isBufferedStore&&(Ext.Array.from(this.previouslySetExtraParams).forEach(function(a){g.setExtraParam(a,void 0)}),this.previouslySetExtraParams=[]);for(var k in c)g&&this.isBufferedStore&&(this.previouslySetExtraParams.push(k),g.setExtraParam(k,c[k])),b.params[k]=c[k]}},scope:this});Ext.apply(this,a)},setCorpus:function(a){a&&
...
direction:"desc"}},this);b.sort(function(a,b){for(var f=0,g=c.length;f<g;f++){var k=c[f].index;if(a[k]!=b[k])return"asc"==c[f].direction?a[k]>b[k]?1:-1:a[k]>b[k]?-1:1}});this.reMapRows();return this},loadCorrespondenceAnalysis:function(a){return this._doAnalysisLoad("table.CA","Voyant.data.store.CAAnalysis",a)},loadPrincipalComponentAnalysis:function(a){return this._doAnalysisLoad("table.PCA","Voyant.data.store.PCAAnalysis",a)},loadTSNEAnalysis:function(a){return this._doAnalysisLoad("table.TSNE",
...
a)}).then(function(a){0==a.getDocumentsCount()&&Voyant.application.showError(d.localize("thisCorpus")+" "+d.localize("isEmpty")+".");!("docsLimit"in b)||!1!==b.docsLimit&&0<b.docsLimit?d.getDocuments().load({params:{limit:"docsLimit"in b?b.docsLimit:d.getDocumentsCount()},callback:function(b,g,k){k?(d.setDocumentsStore(this),c.resolve(a)):c.reject(g)}}):c.resolve(a)})}else Voyant.application.showError(this.localize("badDataTypeCorpus")+": ("+typeof b+") "+b),Ext.defer(function(){c.reject(this.localize("badDataTypeCorpus")+
...
Ext.Ajax.request({url:c.getTromboneUrl(),params:{tool:"resource.StoredResource",storeResource:b,corpus:d},success:function(b,d){var g=Ext.util.JSON.decode(b.responseText).storedResource.id,k=this.down("combo");k.getStore().add({name:g,value:g});k.setValue(g);k.updateLayout();c.getApplication().addColorPalette(g,a)},scope:this})}});Ext.define("Voyant.widget.VoyantChart",{extend:"Ext.chart.CartesianChart",mixins:["Voyant.util.Localization","Voyant.util.Api","Voyant.notebook.util.Embed"],alias:"widget.voyantchart",statics:{i18n:{},api:{tableJson:void 0}},constructor:function(a){a=a||{};this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);this.callParent(arguments)},initComponent:function(a){a=a||{};this.on("afterrender",function(){if(a&&"tableJson"in a)Ext.apply(this,this.getConfigFromTableJson(a.tableJson));else if(this.getApiParam("tableJson")){var b=
...
"":"i")),c.store.each(function(a,b){var h=e.getNode(a);h&&Ext.Array.forEach(f,function(b){var e=Ext.fly(h).down(b.getCellInnerSelector(),!0),f,k,r;e&&0==b.isXType("widgetcolumn")&&(f=e.innerHTML.match(c.tagsRe),k=e.innerHTML.replace(c.tagsRe,c.tagsProtect),k=k.replace(c.searchRegExp,function(e){++d;r||(c.matches.push({record:a,column:b}),r=!0);return'\x3cspan class\x3d"'+c.matchCls+'"\x3e'+e+"\x3c/span\x3e"},c),Ext.each(f,function(a){k=k.replace(c.tagsProtect,a)}),e.innerHTML=k)})},c),d&&(c.currentIndex=
...
this.queryById("sendToVoyant").setDisabled(!0);this.queryById("export").setDisabled(!0);if(a&&0<a.length){this.mask(this.localize("loading"));var d=this.getCorpus().getDocumentQueryMatches();d.load({params:{query:a,includeDocIds:!0},callback:function(a,f,g){this.unmask();if(a&&0<a.length){this.queryById("status").setHtml(a.length);var k="\x3cul\x3e",h=[];a.forEach(function(a){a.getDocIds().forEach(function(a){h.push(a);var e=d.getCorpus().getDocument(a),f="\x3cli id\x3d'"+c.getId()+"_"+a+"' class\x3d'cataloguedoc'\x3e",
...
g+="\x3cli\x3e"+(m?"":l.replace("extra.","")+": ")+(c?'\x3cspan class\x3d"keyword"\x3e'+a+"\x3c/span\x3e":a)+"\x3c/li\x3e"});m&&(g+="\x3c/ul\x3e\x3c/li\x3e")}}g&&(f+="\x3cul\x3e"+g+"\x3c/ul\x3e")}k+=f+"\x3c/li\x3e"})});k+="\x3c/ul\x3e";c.update(k);var l=this;a=c.query(".cataloguedoctitle");a.forEach(function(a){Ext.get(a).on("click",function(a,b){this.dispatchEvent("documentSelected",l,b.getAttribute("data"))},l)});1==a.length&&this.dispatchEvent("documentSelected",l,a[0].getAttribute("data"));this.queryById("status").update((new Ext.XTemplate(this.localize("queryMatches"))).apply([h.length,
...
b&&b.mask(this.localize("loadingSnippets"));e.load({method:"POST",params:{stripTags:"all",query:d,docId:a,perDocLimit:3,limit:100,accurateTotalNotNeeded:!0},scope:this,callback:function(a,d,e){b&&b.unmask();if(e&&Ext.isArray(a)&&0<a.length){var h={};a.forEach(function(a){h[a.getDocIndex()]||(h[a.getDocIndex()]=[]);h[a.getDocIndex()].push(a)});for(docIndex in h)d=this.getCorpus().getDocument(docIndex).getId(),a='\x3cli style\x3d"list-style-type: none; font-size: smaller;"\x3e'+h[docIndex].map(function(a){return a.getHighlightedContext()}).join(" \u2026 ")+
...
2,f=d.getHeight()/2,g={};this.getNodeData().forEach(function(a){g[a.id]=!0},this);var k=[],h=[];a.forEach(function(a,d){var n=a.getTerm(),p=a.getContextTerm(),r=a.getKeywordRawFreq(),q=a.getContextTermRawFreq(),s=r,u=q;this.getNetworkMode()===this.CENTRALIZED_MODE&&(s=0,u=Math.log(q));var A=void 0,A=void 0;0==d&&(void 0===b&&(b=this.idGet(n)),void 0!==g[b]?this.updateDataForNode(b,{title:n+" ("+r+")",type:"keyword",value:s}):(g[b]=!0,A={id:b,term:n,title:n+" ("+r+")",type:"keyword",value:s,start:c,
fixed:!1,x:e,y:f},k.push(A)));if(n!=p){n=this.idGet(p);void 0===g[n]&&(g[n]=!0,A={id:n,term:p,title:p+" ("+q+")",type:"context",value:u,start:0,fixed:!1,x:e,y:f},k.push(A));p=null;q=this.getLinkData();for(u=0;u<q.length;u++)if(r=q[u],r.source.id==b&&r.target.id==n||r.source.id==n&&r.target.id==b){p=r;break}q=a.getContextTermRawFreq();null===p&&h.push({source:b,target:n,value:q,id:b+"-"+n})}},this);this.setNodeData(this.getNodeData().concat(k));this.setLinkData(this.getLinkData().concat(h));this.refresh()}},
...
a||0>b||a>c.getWidth()||b>c.getHeight()},zoomToFit:function(a,b){var c=this.getVis().node().getBBox(),d=c.width,e=c.height,f=c.x+d/2,g=c.y+e/2,c=this.getVis().node().parentElement,k=c.getBoundingClientRect(),h=k.width,k=k.height,e=(a||.8)/Math.max(d/h,e/k),f=[h/2-e*f,k/2-e*g];1>d||d3.select(c).transition().duration(b||500).call(this.getZoom().transform,d3.zoomIdentity.translate(f[0],f[1]).scale(e))},applyNodeStyle:function(a,b){var c=void 0===b?"normal":b;a.style("fill",function(a){a=a.type+"Node";
...
function(a){return{phrase:a.getTerm()}})},addSection:function(a,b,c,d,e){return this.getComponent("main").add({xtype:"container",html:'\x3cdiv class\x3d"header"\x3e'+a+"\x3c/div\x3e",cls:"section",listeners:{afterrender:function(a){a.mask(this.localize("loading"));b.load({params:c,callback:function(b,c,h){h&&b&&0<b.length&&(a.unmask(),Ext.dom.Helper.append(a.getTargetEl().first().first(),(new Ext.XTemplate('\x3cdiv class\x3d"contents"\x3e'+d+"\x3c/div\x3e")).apply(b.map(e))))}})},scope:this}})}});Ext.define("Voyant.panel.Correlations",{extend:"Ext.grid.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.correlations",statics:{i18n:{},api:{query:void 0,docId:void 0,docIndex:void 0,stopList:"auto",minInDocumentsCountRatio:100},glyph:"xf0ce@FontAwesome"},config:{},constructor:function(){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(){var a=this;Ext.apply(a,{title:this.localize("title"),emptyText:this.localize("emptyText"),
...
g=/\.(txt|pdf|html?|xml|docx?|rtf|pages|epub|odt|zip|jar|tar|gz|ar|cpio|bzip2|bz2|gzip|xlsx?)$/i,k=[],h=[],l=0,m=e.length;l<m;l++){var n=e[l].name;f.test(n)?k.push(n.split("/").pop()):g.test(n)||h.push(n.split("/").pop())}0<k.length||0<h.length?Ext.Msg.show({title:a.localize("fileTypesWarning"),icon:Ext.MessageBox.ERROR,message:a.localize("fileTypesMessage")+"\x3cul\x3e"+(0<k.length?"\x3cli\x3e"+a.localize("badFiles")+k.slice(0,5).join(", ")+(5<k.length?"\u2026":"")+"\x3c/li\x3e":"")+(0<h.length?
"\x3cli\x3e"+a.localize("unknownFiles")+h.slice(0,5).join(", ")+(5<h.length?"\u2026":"")+"\x3c/li\x3e":"")+"\x3c/ul\x3e"+a.localize("sureContinue"),buttons:Ext.Msg.YESNO,fn:function(c){"yes"===c?a.loadForm(d):(b.reset(),b.fileInputEl.dom.setAttribute("multiple",!0))},scope:d}):a.loadForm(d)}}}}},"-\x3e",{xtype:"button",scale:"large",glyph:"xf00d@FontAwesome",text:this.localize("cancel"),hidden:void 0==this.getCorpus(),handler:function(a){(a=this.up("window"))&&a.isFloating()&&a.close()}},{xtype:"button",
...
buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR})}}]}],items:[{html:this.getInitialConfig().addTextLabel,hidden:void 0==this.getInitialConfig().addTextLabel},{height:100,xtype:"textareafield",itemId:"input",emptyText:this.localize("emptyInput")}]});a.on("boxready",function(a){var c=this.getApplication();c.getAllowInput&&"false"==c.getAllowInput()&&(c.getNoAllowInputText&&0<c.getNoAllowInputText().trim().length?Ext.defer(function(){var d=a.up("container");d.removeAll();d.add({frame:!1,padding:10,style:{borderColor:"#aaa",
borderStyle:"solid"},html:c.getNoAllowInputText()})},100):(a.hide(),Ext.create("Ext.window.Window",{layout:"fit",header:!1,modal:!0,bodyPadding:10,items:{html:"\x3cp style\x3d'color: red;'\x3e"+a.localize("noAllowInputMessage")+"\x3c/p\x3e"}}).show()))});a.callParent(arguments)},loadForm:function(a){var b={tool:this.getCorpus()?"corpus.CorpusMetadata":"corpus.CorpusCreator"};this.getCorpus()&&Ext.apply(b,{corpus:this.getCorpus().getId(),addDocuments:!0});var c=this.getApiParams();delete c.view;delete c.stopList;
Ext.apply(b,c);var d=this.getApplication().getViewport();d.mask(this.localize("uploadingCorpus"));a.submit({url:this.getTromboneUrl(),params:b,failure:function(a,b){d.unmask();if(b.result&&(b.result.corpus||b.result.stepEnabledCorpusCreator)){var g={corpus:b.result.corpus?b.result.corpus.metadata.id:b.result.stepEnabledCorpusCreator.storedId};Ext.applyIf(g,c);this.setCorpus(void 0);this.loadCorpus(g)}else this.showResponseError("Unable to load corpus.",b.response)},scope:this})},loadCorpus:function(a){this.getCorpus()&&
...
g=[],k=this.getProjection();f.forEach(function(a){transformedFeature=a.clone();transformedFeature.getGeometry().transform(k?k:"EPSG:3857","EPSG:3857");g.push(transformedFeature)});e=e.writeFeatures(g);this.storeAnnotations(e)}}})},storeAnnotations:function(a){this.mask("storingAnnotations");var b=this;Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"resource.StoredResource",storeResource:JSON.stringify(a)},scope:this}).then(function(a){b.unmask();a=Ext.JSON.decode(a.responseText);b.setApiParam("annotationsId",
a.storedResource.id);b.toastInfo(b.localize("annotationsUpdated"))},function(a){b.unmask();b.showResponseError(b.localize("annotationsUpdateFailed"),a)})},travelStyleFunction:function(a,b){var c=new ol.style.Stroke({color:a.get("color"),width:a.get("width")}),d=[new ol.style.Style({stroke:c})],e=a.getGeometry(),f=e.getLastCoordinate(),e=e.getCoordinateAt(.9),e=Math.atan2(f[1]-e[1],f[0]-e[0]),g=new ol.geom.LineString([f,[f[0]-10*b,f[1]+10*b]]);g.rotate(e,f);var k=new ol.geom.LineString([f,[f[0]-10*
b,f[1]-10*b]]);k.rotate(e,f);d.push(new ol.style.Style({geometry:g,stroke:c}));d.push(new ol.style.Style({geometry:k,stroke:c}));return d},cityStyleFunction:function(a,b){if(a.get("visible")){var c=2*Math.PI*a.get("width"),d=a.get("confidence")?c*a.get("confidence"):c;return new ol.style.Style({image:new ol.style.Circle({radius:a.get("width"),fill:new ol.style.Fill({color:a.get("color")}),stroke:new ol.style.Stroke({lineDash:[d,c-d],color:"rgb(255, 255, 255)",width:2})})})}return!1},animationStyleFunction:function(a){return[new ol.style.Style({stroke:new ol.style.Stroke({color:a.get("color"),
...
if(1==b.getFilterWidgets().getCount()){var g=c.getCitiesCount(),k=c.getTotalCitiesCount(),h=c.getConnectionsCount();c=c.getTotalConnectionsCount();message=a.localize(g==k&&h==c?"loadedAll":"loadedSome")+"\x3cbr\x3e\x3cbr\x3e"+a.localize("disclaimer");b.toastInfo({autoCloseDelay:5E3,closable:!0,maxWidth:"90%",html:(new Ext.Template(a.localize("disclaimer"))).apply({currentCitiesCount:g,totalCitiesCount:k,currentConnectionsCount:h,totalConnectionsCount:c,url:b.getBaseUrl()+"docs/#!/guide/dreamscape"})})}})},
...
edges:this.getEdgesDataSet()},b);if(this.getIsNetworkBounded())c.on("beforeDrawing",function(a){var b=this.getLayout().getRenderTarget();a=b.getWidth();var b=b.getHeight(),f=c.getPositions(),g;for(g in f){var k=c.canvasToDOM(f[g]),h=Math.max(0,Math.min(a,k.x)),k=Math.max(0,Math.min(b,k.y)),h=c.DOMtoCanvas({x:h,y:k});c.body.nodes[g].x=h.x;c.body.nodes[g].y=h.y}}.bind(this));c.on("selectNode",function(a){this.doNodeSelect(a.nodes[0])}.bind(this));c.on("deselectNode",function(a){c.unselectAll();a=a.nodes[0];
...
a.getDistributions(),d=b.map(function(a){return c(a)}),e=Ext.Array.mean(d),b=b.map(function(a){a-=e;return a*a}),b=Ext.Array.mean(b),b=Math.sqrt(b);a.set("distributionsStdDev",b)}});a=a.getRange().map(function(a){return a.get("distributionsStdDev")});this.setMin(Ext.Array.min(a));this.setMax(Ext.Array.max(a))},validateRecord:function(a){var b=this.getLow(),c=this.getHigh();a=a.get("distributionsStdDev");return a>=b&&a<=c}}),distributionsStdDevPercentile:new Voyant.util.LoomControl({group:"frequencies",
...
changecomplete:function(b){a.setValues(b.getValues())}},updateFromControl:function(a){this.setMinValue(a.getMin()||0);this.setMaxValue(a.getMax());this.setValue(0,a.getLow()||0);this.setValue(1,void 0===a.getHigh()?a.getMax()||0:a.getHigh())}}}}},this)}})},this);Ext.apply(this,{title:this.localize("title"),layout:{type:"hbox",align:"stretch"},listeners:{afterrender:function(){var a=this.getComponent("terms"),b=this.getComponent("threads");a.on("termHovered",function(a,c){var d=b.getTargetEl().dom.querySelector("path[term\x3d"+
c+"]");if(d){var e=function(a,b){opacity=a.getAttribute("opacity");0<opacity&&(opacity-=.01,a.setAttribute("opacity",opacity),b/=2,Ext.defer(e,b,this,[a,b]))};d.setAttribute("opacity",1);e(d,1E3)}})}},items:[{itemId:"terms",width:100,layout:"fit",listeners:{filterchange:function(a){var b=this.getTargetEl(),c=b.getWidth(),d=b.getHeight(),h=a.getCount();b.setHtml(" ");terms=a.getRange().map(function(a,b){return{term:a.getTerm(),col:Voyant.application.getColorForTerm(a.getTerm(),!0),x:c/2,y:b*d/h}});
terms.sort(function(a,b){return a.term.localeCompare(b.term)});a=d3.select(b.dom).append("svg").attr("width",c).attr("height",d).append("g").attr("transform","translate(-.5,-.5)");var l=Math.ceil(d/terms.length),m=a.selectAll("ytext").data(terms).enter().append("text").text(function(a,b){return a.term}).attr("class","ytext").attr("text-anchor","middle").attr("x",c/2).attr("y",function(a,b){return l*b}).attr("fill",function(a){return Voyant.application.getColorForTerm(a.term,!0)}),l=Math.ceil(d/terms.length),
n=d3.fisheye.circular().radius(50).distortion(2);yFisheye=d3.fisheye.scale(d3.scaleIdentity).domain([0,d]);var p=this;a.on("mousemove",function(){var a=d3.mouse(this);currentItem=Math.round(a[1]*terms.length/d);currentItem=Math.min(currentItem,terms.length-1);n.focus(a[1]);yFisheye.focus(a[1]);var b=m.nodes();b[currentItem]&&p.fireEvent("termHovered",p,b[currentItem].textContent);var c=14,e=Math.max(a[1],c),f=1;d3.select(b[currentItem]).attr("y",function(a){return e}).attr("font-size",c).attr("fill-opacity",
f);for(var g=void 0,h=currentItem-1;-1<h;h--)8<=c?(e-=c,c-=.5):(void 0==g&&(g=e/h),e-=g),.1<f&&(f-=.05),d3.select(b[h]).attr("y",function(a){return e}).attr("font-size",c).attr("fill-opacity",f);c=14;e=Math.max(a[1],c);f=1;g=void 0;h=currentItem+1;for(a=terms.length;h<a;h++)8<=c?(e+=c,c-=.5):(void 0==g&&(g=(d-e)/(a-h)),e+=g),.1<f&&(f-=.05),d3.select(b[h]).attr("y",function(a){return e}).attr("font-size",c).attr("fill-opacity",f)})}}},{itemId:"threads",layout:"fit",flex:1,listeners:{filterchange:function(a){var b=
this.getTargetEl(),c=b.getWidth(),d=b.getHeight();b.setHtml(" ");terms=a.getRange().map(function(a){return{term:a.getTerm(),vals:a.getDistributions()}});var h=d3.select(b.dom).append("svg").attr("width",b.getWidth()).attr("height",b.getHeight());if(0==terms.length)return this.up("panel").toastInfo("No hits");var l=c/terms[0].vals.length;a=this.up("loom").getApiParam("scaling");var m=("sqrt"==a?d3.scaleSqrt():"log"==a?d3.scaleLog():d3.scaleLinear()).domain([Math.max(1E-6,Ext.Array.min(terms.map(function(a){return Ext.Array.min(a.vals)}))),
Math.max(1E-6,Ext.Array.max(terms.map(function(a){return Ext.Array.max(a.vals)})))]).range([1E-6,d-2]),n=d3.line().curve(d3.curveCardinal).x(function(a,b){return l/2+l*b}).y(function(a){return d-1-m(a)}),p=h.append("g").attr("opacity",0),r=p.append("rect").attr("fill","white").attr("text-anchor","middle").attr("alignment-baseline","middle").attr("stroke","rgba(0,0,0,.05)").attr("class","rect").attr("x",100).attr("y",100).attr("width",70).attr("height",16).attr("opacity",1),q=p.append("text").attr("text-anchor",
"middle").attr("alignment-baseline","middle").attr("x",100).attr("y",100).text("testing");terms.forEach(function(a){var b=Voyant.application.getColorForTerm(a.term,!0);h.append("path").datum(a.vals).attr("fill","none").attr("stroke",b).attr("opacity",.5).attr("stroke-linejoin","round").attr("stroke-linecap","round").attr("stroke-width",1).attr("class","line").attr("d",n);h.append("path").datum(a.vals).attr("fill","none").attr("stroke",b).attr("opacity",0).attr("stroke-width",3).attr("class","line").attr("term",
...
listeners:{afterrender:function(a){a.setChecked(a.getItemId()==this.getApiParam("scaling"))},scope:this},group:"scaling"},items:[{text:this.localize("scaleLinear"),itemId:"linear"},{text:this.localize("scaleLog"),itemId:"log"},{text:this.localize("scaleSqrt"),itemId:"sqrt"}]}}]}]});this.on("loadedCorpus",function(a,b){var c=1==b.getDocumentsCount()?b.getDocumentTerms():b.getCorpusTerms();c.on("load",function(){this.updateControlsFromStore();this.filterRecords()},this);c.on("filterchange",function(){this.getComponent("terms").fireEventArgs("filterchange",
arguments);this.getComponent("threads").fireEventArgs("filterchange",arguments)},this);this.setStore(c);params=this.getApiParams();Ext.apply(params,{withDistributions:!0});c.load({callback:function(a,b,c){this.filterRecords()},scope:this,params:params})},this);this.callParent(arguments)},filterRecords:function(){var a=this.getStore();a.clearFilter();var b=parseInt(this.getApiParam("limit")),c=0;a.filterBy(function(a){return Ext.Array.every(this.getControls().getRange(),function(b){return 0==b.getEnabled()||
...
g:-g)}else{var g=f=0,k=a.matches.map(function(a){return this.magnets[a].record.getDistributions()[c]},this),h=Ext.Array.min(k),l=Ext.Array.max(k),m=0;a.matches.forEach(function(a,b){weight=l==h?1:(k[b]-h+h)/(l-h+h);m+=weight;f+=this.magnets[a].x*weight;g+=this.magnets[a].y*weight},this);a.targetX=f/m;a.targetY=g/m}},this);a=0;for(var c=b.length;a<c;a++)Ext.apply(this.documents[a],{targetX:rad+(rad-this.gutter)*Math.cos(2*Math.PI*a/c),targetY:rad+(rad-this.gutter)*Math.sin(2*Math.PI*a/c)})}},draw:function(a,
...
b.fillStyle="rgba(0,0,0,.8)",b.arc(a.x,a.y,k,0,2*Math.PI),b.fill(),b.stroke();var g=Math.abs(a.x-a.targetX),l=Math.abs(a.y-a.targetY);if(0!=g||0!=l)1>g?a.x=a.targetX:(g/=2,a.x=a.x>a.targetX?a.x-g:a.x+g),1>l?a.y=a.targetY:(l/=2,a.y=a.y>a.targetY?a.y-l:a.y+l),e=!0},this);var l=0,h=parseInt(this.textFont)+4;b.textAlign="center";b.textBaseline="middle";for(var m in this.magnets)d||m in g||this.magnets[m].isHovering?(l=this.magnets[m].width+4,b.fillStyle=m in g||this.magnets[m].isHovering||!0===f?"white":
"rgba(255,255,255,.05)",b.fillRect(this.magnets[m].x-l/2,this.magnets[m].y-h/2,l,h),b.strokeStyle=m in g||this.magnets[m].isHovering||!0===f?"rgb("+this.magnets[m].colour.join(",")+")":"rgba(0,0,0,.05)",b.strokeRect(this.magnets[m].x-l/2,this.magnets[m].y-h/2,l,h),b.textAlign="center",b.fillStyle=m in g||this.magnets[m].isHovering||!0===f?"rgba(0,0,0,.8)":"rgba(0,0,0,.05)",b.fillText(m,this.magnets[m].x,this.magnets[m].y)):(b.beginPath(),b.fillStyle="rgb("+this.magnets[m].colour.join(",")+")",b.strokeStyle=
"rgb("+this.magnets[m].colour.join(",")+")",b.arc(this.magnets[m].x,this.magnets[m].y,12,0,2*Math.PI),b.fill(),b.stroke())}if(e){var n=this;setTimeout(function(){n.draw()},100)}else if(this.documents){c=Math.max(c/this.documents.length,50);l=0;for(m=this.documents.length;l<m;l++)for(var p=0;p<m;p++)if(l<p){var r=this.documents[l].x-this.documents[p].x,q=this.documents[l].y-this.documents[p].y;Math.sqrt(r*r+q*q)<c&&(r*=.1,q*=.1,this.documents[l].targetX+=r,this.documents[p].targetX-=r,this.documents[l].targetY+=
q,this.documents[p].targetY-=q,e=!0)}e&&(n=this,setTimeout(function(){n.draw()},100))}}});Ext.define("Voyant.panel.MicroOcp",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.microocp",statics:{i18n:{title:"MicroOCP"},api:{config:void 0,stopList:"auto"},glyph:"xf1ea@FontAwesome"},config:{},constructor:function(a){debugger;a=a||{};this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);Ext.apply(this,{title:this.localize("title"),layout:"hbox",items:[{xtype:"panel",flex:1,height:"100%",align:"stretch",header:!1,listeners:{boxready:function(){ace.edit(Ext.getDom(this.getEl()));
debugger}}}]});this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.on("loadedCorpus",function(a,c){});this.on("afterrender",function(a){})}});Ext.define("Voyant.panel.Reader",{extend:"Ext.panel.Panel",requires:["Voyant.data.store.Tokens"],mixins:["Voyant.panel.Panel"],alias:"widget.reader",isConsumptive:!0,statics:{i18n:{},api:{start:0,limit:1E3,skipToDocId:void 0,query:void 0},glyph:"xf0f6@FontAwesome"},config:{innerContainer:void 0,tokensStore:void 0,documentsStore:void 0,documentTermsStore:void 0,exportVisualization:!1,lastScrollTop:0,scrollIntoView:!1,insertWhere:"beforeEnd",locationMarker:void 0,lastLocationUpdate:new Date,isDetailedGraph:!0},
SCROLL_UP:-1,SCROLL_EQ:0,SCROLL_DOWN:1,LOCATION_UPDATE_FREQ:100,DETAILED_GRAPH_DOC_LIMIT:25,INITIAL_LIMIT:1E3,constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(a){var b=Ext.create("Voyant.data.store.Tokens",{parentTool:this,proxy:{extraParams:{forTool:"reader"}}}),c=this;b.on("beforeload",function(a){return c.hasCorpusAccess(a.getCorpus())});b.on("load",function(a,b,c){if(c){var g="",k=this.localize("documentFrequency"),
h=!1,l=-1,m=!1;b.forEach(function(a){0==a.getPosition()&&(g+="\x3ch3\x3e"+this.getDocumentsStore().getById(a.getDocId()).getFullLabel()+"\x3c/h3\x3e");a.getDocIndex()!=l&&(h=this.getDocumentsStore().getById(a.getDocId()).isPlainText(),l=a.getDocIndex());if(a.isWord())m=!1,g+="\x3cspan class\x3d'word' id\x3d'"+a.getId()+"' data-qtip\x3d'"+k+" "+a.getDocumentRawFreq()+"'\x3e"+a.getTerm()+"\x3c/span\x3e";else{a=a.getTermWithLineSpacing(h);var b=0==a.indexOf("\x3cbr /\x3e");if(!m||!b&&0!=a.trim().length)g+=
...
totalProperty:"documentTerms.total"},simpleSortMode:!0},listeners:{load:function(a,b,c,g){a.sort("docIndex","ASC");var k={},h=0,l;a.each(function(a){var b=[],c=a.get("distributions"),d=a.get("docId"),e=a.get("docIndex");l=a.get("term");for(a=0;a<c.length;a++){var f=a,g=c[a];g>h&&(h=g);b.push([d,e,f,g,l])}k[e]=b},this);this.highlightKeywords(l);if(this.getIsDetailedGraph())for(a=this.query("cartesian"),b=0;b<a.length;b++)c=a[b],g=k[b],void 0!==g?(c.getAxes()[0].setMaximum(h),c.getStore().loadData(g)):
...
k=0;k<g.length;k++)void 0===c[k]&&(c[k]={}),c[k][f]=g[k];b.push({id:f,name:f,mark:this.getApplication().getColorForTerm(f,!0),active:!0})},this);this.setLayerData(c);this.down("[xtype\x3dlegend]").getStore().loadData(b);this.doLayout()},doLayout:function(a){a=this.getLayerData();if(void 0!==a){var b=this,c=[];this.down("[xtype\x3dlegend]").getStore().each(function(a){c.push(a.getId())});var d;if(this.getMode()===this.MODE_DOCUMENT)d=this.getApiParam("bins");else{d=this.getApiParam("bins");var e=this.getCorpus().getDocumentsCount();
d=d<e?d:e}this.getVisLayout().keys(c);e=this.getVisLayout()(a);a=this.body.down("svg").getWidth()-this.graphMargin.left-this.graphMargin.right;var f=d3.scaleLinear().domain([0,d-1]).range([0,a]),g=d3.min(e,function(a){return d3.min(a,function(a){return a[0]})}),k=d3.max(e,function(a){return d3.max(a,function(a){return a[1]})});d=this.body.down("svg").getHeight()-this.graphMargin.top-this.graphMargin.bottom;var h=d3.scaleLinear().domain([g,k]).range([d,0]),l=d3.area().x(function(a,b){return f(b)}).y0(function(a){return h(a[0])}).y1(function(a){return h(a[1])}).curve(d3.curveCatmullRom);
if(this.getMode()===this.MODE_CORPUS){var m=[];this.getCorpus().getDocuments().each(function(a){m.push(a.getTinyLabel())});g=d3.scalePoint().domain(m).range([0,a]);k=d3.axisBottom(g)}else k=d3.axisBottom(f);g=d3.axisLeft(h);e=this.getVis().selectAll("path").data(e,function(a){return a});e.attr("d",function(a){return l(a)}).style("fill",function(a){return b.getApplication().getColorForTerm(a.key,!0)}).select("title").text(function(a){return a.key});e.enter().append("path").attr("d",function(a){return l(a)}).style("fill",
function(a){return b.getApplication().getColorForTerm(a.key,!0)}).append("title").text(function(a){return a.key});e.exit().remove();this.getVis().selectAll("g.axis").remove();this.getVis().append("g").attr("class","axis x").attr("transform","translate(0,"+d+")").call(k);this.getMode()===this.MODE_CORPUS?(this.getVis().select("g.axis.x").selectAll("text").each(function(){d3.select(this).attr("text-anchor","end").attr("transform","rotate(-45)")}),e=this.localize("documents")):e=this.localize("documentSegments");
...
f=this.sourceTerm.get("y"),g=this.targetTerm.get("x"),k=this.targetTerm.get("y");this.previousTerm&&this.previousTerm.get("x");this.previousTerm&&this.previousTerm.get("y");var h=Math.max(100,.5*Math.abs(e-g)),l=Math.max(100,.5*Math.abs(f-k));this.previousBeziers.unshift([e,f,e>g?e-h:e+h,k>f?f+l:f-l,g,k]);10<this.previousBeziers.length&&this.previousBeziers.pop()}for(e=0;e<this.previousBeziers.length;e++)b.strokeStyle="rgba(0,0,255,"+(1-.1*e)+")",this.drawBezierSplit.apply(this,Ext.Array.merge([b],
...
a,b)});this.on("termsClicked",function(a,b){b.forEach(function(a){var b;Ext.isString(a)?b=a:a.term?b=a.term:a.getTerm&&(b=a.getTerm());this.setApiParams({query:b});this.loadStore()},this)});this.on("loadedCorpus",function(a,b){this.documentStore.setCorpus(b);this.corpusStore.setCorpus(b);var e=this.getApiParams();e.type&&delete e.limit;var f,g=this.getCorpus().getDocumentsCount(),k=this.queryById("segments"),h=this.queryById("visibleBins");"document"==e.mode||1==g?(this.setApiParam("mode","document"),
f=this.documentStore,h.setMaxValue(k.getValue())):(this.setApiParam("mode","corpus"),delete e.bins,f=this.corpusStore,k.hide(),this.queryById("segmentsLabel").hide(),h=this.queryById("visibleBins"),h.setMaxValue(g),parseInt(this.getApiParam("visibleBins")>g)&&h.setValue(g));f.on("load",function(a,b){for(var c=0;3>c;c++){var d=b[c];d&&this.getTermsRadio().highlightRecord(d,!0)}},this,{single:!0});f.load({params:e})},this)},loadStore:function(){this.queryById("play").setPlaying(!1);var a=this.getApiParams();
...
1+")"+a}));Ext.applyIf(a,this.getApiParams());this.getCorpus().getCorpusTerms().load({params:a,callback:function(a,e,f){var g=[],k=[],h=this.getApiParam("chartType");a.forEach(function(a,d){var e=a.get("term");a.get("docIndex");var f=this.getApplication().getColorForTerm(e,!0);a.get("distributions").forEach(function(a,f){g[f]||(g[f]={index:c[f]});g[f]["_"+d]="relative"==b?a.toFixed(7):a;g[f]["term"+d]=e},this);"bar"!=h&&("barline"==h?["bar","line"]:[h]).forEach(function(a){k.push({type:"stacked"==
a?"bar":a,title:e,xField:"index",yField:"_"+d,term:e,colors:[f],label:"barline"==h&&"bar"==a?{display:"none"}:{field:"term"+d}})},this)},this);e=a.map(function(a){return a.getTerm()});f=e.map(function(a){return this.getApplication().getColorForTerm(a,!0)},this);"bar"==h&&k.push({type:"bar",title:e,colors:f,xField:"index",yField:0<g.length?Object.keys(g[0]).filter(function(a){return"_"==a.charAt(0)}):void 0,label:{field:a.map(function(a,b){return"term"+b})}});a=Ext.create("Ext.data.JsonStore",{fields:0<
g.length?Object.keys(g[0]):void 0,data:g});this.buildChart({store:a,series:k,axes:[{type:"numeric",position:"left",increment:1,title:{text:this.localize(this.getApiParam("withDistributions")+"Title")}},{type:"category",position:"bottom",title:{text:this.localize("corpusTitle")}}]})},scope:this})}else this.getCorpus().getCorpusTerms().load({params:{limit:5,stopList:this.getApiParam("stopList")},callback:function(a,b,c){0==a.length?b&&b.error?this.showError(this.localize("noResults")+"\x3cp style\x3d'color: red'\x3e"+
...
this.getCorpus().map(function(a){return a.getTinyTitle()});var c;c=1==this.getCorpus().getDocumentsCount()?this.getCorpus().getDocument(0):this.getCorpus().getDocument(this.getApiParam("docIndex"));Ext.applyIf(a,this.getApiParams());this.getCorpus().getDocumentTerms().load({params:a,callback:function(a,e,f){var g=[],k=[],h=this.getApiParam("chartType");c||a.sort(function(a,b){return a.getTerm()==b.getTerm()?a.getDocIndex()-b.getDocIndex():a.getTerm().localeCompare(b.getTerm())});a.forEach(function(a,
d){var e=a.get("term"),f=a.get("docIndex"),l=c?this.getApplication().getColorForTerm(e,!0):this.getApplication().getColor(f,!0),f=a.get("docIndex");a.get("distributions").forEach(function(a,c){g[c]||(g[c]={docIndex:f,index:c+1});g[c]["_"+d+"_"+f]="relative"==b?a.toFixed(7):a;g[c]["term"+d]=e},this);"bar"!=h&&("barline"==h?["bar","line"]:[h]).forEach(function(a){k.push({type:"stacked"==a?"bar":a,title:c?e:f+1+") "+e,xField:"index",yField:"_"+d+"_"+f,term:e,colors:[l],label:"barline"==h&&"bar"==a?{display:"none"}:
{field:"term"+d}})},this)},this);if("bar"==h){var l=Ext.Array.unique(a.map(function(a){return a.getTerm()})).length;e=a.map(function(a){return 1+a.get("docIndex")+") "+a.getTerm()});a=a.map(function(a){return l?this.getApplication().getColor(a.get("docIndex"),!0):this.getApplication().getColorForTerm(a.getTerm(),!0)},this);k.push({type:"bar",title:0<e.length?e:this.localize("noResults"),colors:a,xField:"index",yField:0<g.length?Object.keys(g[0]).filter(function(a){return"_"==a.charAt(0)}):void 0,
label:{field:e}})}a=Ext.create("Ext.data.JsonStore",{fields:0<g.length?Object.keys(g[0]):void 0,data:g});this.buildChart({store:a,series:k,axes:[{type:"numeric",position:"left",title:{text:this.localize(this.getApiParam("withDistributions")+"Title")}},{type:"category",position:"bottom",title:{text:this.localize("segmentsTitle")+(c?" ("+c.getShortTitle()+")":"")}}]})},scope:this})}else this.getCorpus().getCorpusTerms().load({params:{limit:2>this.getCorpus().getDocumentsCount()?5:2,stopList:this.getApiParam("stopList")},
...
void 0:parseInt(this.getApiParam("perDocLimit"))},success:function(b,c){this.unmask();this.mask(this.localize("parsingDocuments"));var d=b.responseText.trim().split(/(\r\n|\r|\n)/);if(1==d.length){if(d=d[0].split(": "),1<d.length)for(var e=a.getDocument(d[0]),f=d[1].split(" "),e=e.getLexicalTokensCount(),e=10>e?e:1E3>e?10:100,e=10,g=Math.floor(f.length/e),k=0;k<e;k++){var h=f.slice(k*g,k*g+g).join(" ");this.parseLine(d[0]+"-"+k+"\t"+d[0]+"-"+k+"\t"+h)}}else d.forEach(function(b){b=b.split(": ");if(1<
...
a+".json",scope:this}).then(function(c,f){var g=Ext.decode(c.responseText),k=new Ext.XTemplate("\x3ca href\x3d'../../docs/#!/api/"+a+"{0}'\x3emore\u2026\x3c/a\x3e");b.docs[a]={"!type":"fn(config) -\x3e Corpus","!url":"","!doc":g.short_doc+k.apply([])};g.members.forEach(function(c){c["private"]||"method"!=c.tagname||(b.docs[a][c.name]={"!type":"fn()","!url":"","!doc":c.short_doc+k.apply(["-"+c.id])})});b.docsLoading--},function(a,c){b.docsLoading--;console.log("server-side failure with status code "+
...
e,this.getBaseUrl()+"spyral/"+e);a="https://gist.githubusercontent.com/"+d.slice(0,2).join("/")+"/raw/"+(d[2]?d[2]:"")}else 0==a.indexOf("http")&&window.history.pushState({url:a},"Spyral Notebook: "+a,this.getBaseUrl()+"spyral/?input\x3d"+a);c.mask(this.localize("fetchingNotebook"));Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"notebook.NotebookManager",notebook:a,noCache:!0},timeout:6E4,scope:this}).then(function(d,e){c.unmask();var k=Ext.decode(d.responseText),h=c.getBlocksFromString(k.notebook.jsonData);
h.metadata=h.metadata||{};h.metadata.previousNotebook=a;Ext.applyIf(h.metadata,{originalUrl:a});if(h&&h.metadata&&h.metadata.url){var l;try{l=new URL(h.metadata.url)}catch(m){}if(l&&l.hostname!=window.location.hostname)return Ext.Msg.confirm(c.localize("differentUrlTitle"),(new Ext.XTemplate(c.localize("differentUrl"))).apply([h.metadata.url,window.location.href]),function(a){c.loadData(h,"yes"==a)},c)}c.loadData(h,b);Ext.Ajax.request({url:c.getTromboneUrl(),params:{tool:"notebook.NotebookManager",
...
return!1}return!0},hasQueryToLoad:function(a){a||(a=Ext.Object.fromQueryString(document.location.search));return a.corpus||a.input||this.getCorpusId&&this.getCorpusId()},loadColorPaletteForCorpus:function(a,b){Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"resource.StoredResource",retrieveResourceId:b,corpus:a},success:function(a,d){var e=Ext.util.JSON.decode(a.responseText).storedResource.resource,e=Ext.decode(e);this.addColorPalette(b,e)},failure:function(a){this.setApiParam("palette",
void 0)},scope:this})},listeners:{loadedCorpus:function(a,b){this.setCorpus(b);this.on("unhandledEvent",function(a,d,e){a=this.getBaseUrl()+"?corpus\x3d"+b.getAliasOrId();var f=this.getModifiedApiParams()||{};delete f.view;if("termsClicked"==d)f.query=e;else if("documentsClicked"==d){var g=[];e.forEach&&e.forEach(function(a){g.push(a.getIndex())});f.docIndex=g}else if("corpusTermsClicked"==d)e.map&&(f.query=e.map(function(a){return a.getTerm()}));else if("documentTermsClicked"==d)e.map&&(f.query=
e.map(function(a){return a.getTerm()}),f.docIndex=e.map(function(a){return a.getDocIndex()}));else{console&&console.warn("Unhandled event: "+d,e);return}f.toolFlow&&(d=Ext.Array.from(f.toolFlow.split(",")),f.view=d.shift(),0<d.length?f.toolFlow=d.join(","):delete f.toolFlow);a+="\x26"+Ext.Object.toQueryString(f);this.openUrl(a)})}}});Ext.define("Voyant.panel.DocumentClusters",{extend:"Ext.panel.Panel",alias:"widget.documentclusters",title:"Document Clusters"});Ext.define("Voyant.panel.RezoViz",{extend:"Ext.panel.Panel",alias:"widget.rezoviz",title:"RezoViz"});
