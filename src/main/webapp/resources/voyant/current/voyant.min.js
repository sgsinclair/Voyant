...
this.queryById("removeButton").enable())}else this.selectTerm()},scope:this}}},store:this.getTermStore(),listeners:{query:function(a,b){0<b.length&&-1===this.getTermStore().findExact("term",b[0])?(this.setNewTerm(b),this.loadFromApis()):this.setNewTerm(null)},scope:this}}]});this.on("loadedCorpus",function(a,b){var c=function(a){var b=this.getApiParam(a);this.queryById(a).down("#"+a+"_"+b).setChecked(!0)}.bind(this);c("analysis");this.doAnalysisChange(this.getApiParam("analysis"));c("comparisonType");
c("clusters");this.queryById("perplexity").setValue(this.getApiParam("perplexity"));this.queryById("iterations").setValue(this.getApiParam("iterations"));3==b.getDocumentsCount()&&this.setApiParam("dimensions",2);c("dimensions");this.getCaStore().setCorpus(b);this.getPcaStore().setCorpus(b);this.getDocSimStore().setCorpus(b);this.loadFromApis()},this);this.on("documentsSelected",function(a,b){this.setApiParam("docId",b);this.loadFromApis()},this);this.callParent(arguments)},doAnalysisChange:function(a){this.setApiParam("analysis",
a);this.queryById("nearbyButton").setDisabled("tsne"===a);this.queryById("reloadButton").setVisible("tsne"===a);this.queryById("perplexity").setVisible("tsne"===a);this.queryById("iterations").setVisible("tsne"===a);"ca"===a&&3==this.getCorpus().getDocumentsCount()&&(this.setApiParam("dimensions",2),this.queryById("dimensions").menu.items.get(0).setChecked(!0))},maskAndBuildChart:function(a){this.queryById("chartParent").mask(this.localize("plotting"));Ext.defer(this.buildChart,50,this,[a])},buildChart:function(a){var b=
this,c=this.queryById("chart");null!==c&&this.queryById("chartParent").remove(c);this.queryById("termsGrid").getSelectionModel().deselectAll();var c=a.getAt(0),d=this.getApiParam("dimensions");a="";if("pca"===this.getApiParam("analysis")){for(var e=c.getPrincipalComponents(),f=0,g=0;g<e.length;g++)f+=parseFloat(e[g].get("eigenValue"));if(0!=f){a=this.localize("pcTitle")+"\n";for(var h=["xAxis","yAxis","fill"],g=0;g<e.length&&!(g>=d);g++){var k=e[g].get("eigenValue")/f*100;a+=this.localize("pc")+" "+
(g+1)+" ("+this.localize(h[g])+"): "+Math.round(100*k)/100+"%\n"}}}else if("tsne"!==this.getApiParam("analysis"))for(a=this.localize("caTitle")+"\n",h=["xAxis","yAxis","fill"],e=c.getDimensions(),g=0;g<e.length&&!(g>=d);g++)k=e[g].get("percentage"),a+=this.localize("dimension")+" "+(g+1)+" ("+this.localize(h[g])+"): "+Math.round(100*k)/100+"%\n";var l=0,m=Number.MAX_VALUE,n=0,q=Number.MAX_VALUE;"docSim"!==this.getApiParam("analysis")&&this.getTermStore().removeAll();var s=[],p=[];c.getTokens().forEach(function(a){var b=
a.get("rawFreq"),c=a.get("category");void 0===c&&(c="term",a.set("category","term"));var e="term"===c;e&&(b>l&&(l=b),b<m&&(m=b));this.getTermStore().findExact("term",-1===a.get("term"))&&this.getTermStore().addSorted(a);if(3===d){var f=a.get("vector")[2];void 0!==f&&(f<q&&(q=f),f>n&&(n=f))}b={x:a.get("vector")[0],y:a.get("vector")[1],z:a.get("vector")[2],term:a.get("term"),rawFreq:b,relativeFreq:a.get("relativeFreq"),cluster:a.get("cluster"),category:c,disabled:!1};e?s.push(b):("bin"===a.get("category")?
...
this.body.removeCls("notebook-editor-wrapper-hover"))}});Ext.define("Voyant.notebook.editor.CodeEditor",{extend:"Ext.Component",alias:"widget.notebookcodeeditor",mixins:["Voyant.util.Localization"],cls:"notebook-code-editor",config:{theme:"ace/theme/chrome",mode:"ace/mode/javascript",content:"",docs:void 0,isChangeRegistered:!1},statics:{i18n:{emptyText:"// click here to edit"}},listeners:{boxready:function(){var a=this;this.editor=ace.edit(Ext.getDom(this.getEl()));this.editor.getSession().setUseWorker(!0);this.editor.setTheme(this.getTheme());this.editor.getSession().setMode(this.getMode());
this.editor.setOptions({minLines:6,maxLines:100});this.editor.setHighlightActiveLine(!1);this.editor.renderer.setShowPrintMargin(!1);this.editor.renderer.setShowGutter(!1);this.editor.setValue(this.getContent()?this.getContent():this.localize("emptyText"));this.editor.clearSelection();this.editor.on("focus",function(){a.editor.renderer.setShowGutter(!0)},this);this.editor.on("change",function(){0==a.getIsChangeRegistered()&&(a.setIsChangeRegistered(!0),a.up("notebookcodeeditorwrapper").setIsRun(!1))},
this);this.editor.on("blur",function(){a.editor.renderer.setShowGutter(!1)});this.editor.commands.addCommand({name:"run",bindKey:{win:"Shift-Enter",mac:"Shift-Enter"},exec:function(b){a.up("notebookcodeeditorwrapper").run()}});ace.config.loadModule("ace/ext/tern",function(){a.editor.setOptions({enableTern:{defs:["ecma5",a.docs],plugins:{doc_comment:{fullDocs:!0}},useWorker:!0},enableSnippets:!0,enableBasicAutocompletion:!0})})}},getValue:function(){return this.editor.getValue()}});Ext.define("Voyant.notebook.editor.CodeEditorWrapper",{extend:"Voyant.notebook.editor.EditorWrapper",requires:["Voyant.notebook.editor.CodeEditor","Voyant.notebook.editor.button.Run",,"Voyant.notebook.editor.button.RunAll"],alias:"widget.notebookcodeeditorwrapper",cls:"notebook-code-wrapper",statics:{i18n:{previousNotRunTitle:"Previous Code Blocks",previousNotRun:"There are previous blocks that have not been run (and may be needed for the code in this block). Do you wish to run all code blocks instead?"}},
config:{isRun:!1},layout:{type:"vbox",align:"stretch"},height:130,border:!1,constructor:function(a){this.results=Ext.create("Ext.Component",{align:"stretch",cls:"notebook-code-results",html:Ext.Array.from(a.output).join("")});this.editor=Ext.create("Voyant.notebook.editor.CodeEditor",{content:Ext.Array.from(a.input).join("\n"),docs:a.docs});Ext.apply(this,{dockedItems:[{xtype:"toolbar",dock:"left",items:[{xtype:"notebookwrapperadd"},{xtype:"notebookwrapperrun",listeners:{click:{fn:this.run,scope:this}}},
{xtype:"notebookwrapperrununtil",listeners:{click:{fn:function(){this.up("notebook").runAllCode(this)},scope:this}}},{xtype:"notebookwrapperrunall",listeners:{click:{fn:function(){this.up("notebook").runAllCode()},scope:this}}}]},{xtype:"toolbar",dock:"right",items:[{xtype:"notebookwrappercounter",order:a.order},{xtype:"notebookwrapperremove"},{xtype:"notebookwrappermoveup"},{xtype:"notebookwrappermovedown"}]}],items:[this.editor,this.results]});this.callParent(arguments)},initComponent:function(){var a=
this;a.on("afterrender",function(){this.getTargetEl().on("resize",function(b){var c=20;a.items.each(function(a){c+=a.getHeight()});a.setSize({height:c})})},this);a.callParent(arguments)},run:function(a){if(!0===a)this._run();else{var b=this.up("notebook");Ext.Array.each(b.query("notebookcodeeditorwrapper"),function(a){if(a==this)return this._run(),!1;0==a.getIsRun()&&Ext.Msg.confirm(this.localize("previousNotRunTitle"),this.localize("previousNotRun"),function(a){"yes"==a?b.runAllCode():this._run()},
this)},this)}},_run:function(){this.results.show();this.results.update(" ");this.results.mask("working\u2026");var a=this.editor.getValue();try{Voyant.notebook.util.Show.TARGET=this.results.getEl(),eval.call(window,a),Ext.defer(this.tryToUnmask,20,this)}catch(b){this.results.unmask(),Voyant.application.releaseAllDeferred(),Voyant.notebook.util.Show.showError(b)}this.setIsRun(!0);return!1},clearResults:function(){this.results.show();this.results.update(" ");this.getTargetEl().fireEvent("resize")},
tryToUnmask:function(){if(0==Voyant.application.getDeferredCount()){for(var a in window)"object"==typeof window[a]&&window[a]&&"opener"!=a&&window[a].isFulfilled&&window[a].isFulfilled()&&(window[a]=window[a].valueOf());this.results.unmask();this.getTargetEl().fireEvent("resize")}else Ext.defer(this.tryToUnmask,20,this)},getContent:function(){var a=this.results.getTargetEl(),b=a.dom.cloneNode(!0),c=b.innerHTML;b.style.height||(c="\x3cdiv style\x3d'height: "+a.getHeight()+"px'\x3e"+c+"\x3c/div\x3e");
return{input:this.editor.getValue(),output:c}}});Ext.define("Voyant.notebook.editor.TextEditor",{extend:"Ext.Component",mixins:["Voyant.util.Localization"],alias:"widget.notebooktexteditor",cls:"notebook-text-editor",config:{ckeditorConfig:{toolbar:[{name:"basicstyles",items:["Bold","Italic","-","RemoveFormat"]},{name:"paragraph",items:"NumberedList BulletedList - Justify Outdent Indent Blockquote JustifyLeft JustifyCenter JustifyRight".split(" ")},{name:"colors",items:["TextColor","BGColor"]},{name:"styles",items:["Styles","Format"]},{name:"links",
...
this);this.addColorPalette("extjs",b)},getRelativeUrl:function(){for(var a="",b=0,c=window.location.pathname.substring(this.getBaseUrl().length).split("/").length-1;b<c;b++)a+="../";return a},getTools:function(){return[{type:"maximize"},{type:"help"}]},launch:function(){Ext.tip.QuickTipManager.init();Ext.apply(Ext.tip.QuickTipManager.getQuickTip(),{showDelay:50});this.callParent(arguments)},tromboneCall:function(a){a=a?a:{};Ext.applyIf(a,{url:this.getTromboneUrl()});a.success||a.failure||a.callback||
Ext.applyIf(a,{url:this.getTromboneUrl(),scope:this,callback:function(b,c,d){this.dispatchEvent(a.tool+"Loaded",b,c,d)}});Ext.Ajax.request(a)},getViewport:function(){return Ext.ComponentQuery.query("viewport")[0]},dispatchEvent:function(a,b){var c=this.getViewport().query("panel,chart"),d=!1;this.hasListener&&this.hasListener(a)&&(this.fireEvent.apply(this,arguments),d=!0);for(var e=0;e<c.length;e++)!c[e].hasListener||!c[e].hasListener(a)||b&&b.getId&&c[e].getId&&b.getId()==c[e].getId()||(d=!0,c[e].fireEvent.apply(c[e],
