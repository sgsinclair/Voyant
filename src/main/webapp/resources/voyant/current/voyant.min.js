...
a.cells.length:5>a.cells.length?Math.ceil(a.cells.length/2):Math.ceil(a.cells.length/3));if(null!=a.numCols&&a.cells&&Ext.isArray(a.cells)){for(var c=[],d=0;d<a.cells.length;d++){var e=a.cells[d];if(Ext.isObject(e))delete e.width,delete e.height,c.push(e);else if(Ext.isArray(e)){var f=1,g=1;xtype=void 0;e[0]&&Ext.isNumber(e[0])&&(f=e[0],e.shift());e[0]&&Ext.isString(e[0])&&(xtype=e[0],e.shift());e[0]&&Ext.isNumber(e[0])&&(g=e[0]);xtype&&c.push({colspan:f,rowspan:g,xtype:xtype})}else Ext.isString(e)&&
c.push({xtype:e,colspan:1,rowspan:1})}Ext.apply(this,{layout:{type:"table",width:"100%",height:"100%",columns:a.numCols,tableAttrs:{style:{width:"100%",height:"100%"}},tdAttrs:{style:{padding:"0px",verticalAlign:"top"}}},defaults:{width:10,height:10,border:!0},items:c})}else this.showError("badTableLayoutDefinition");Ext.resumeLayouts()},doTableSizing:function(a,b){for(var c={},d=this.getTargetEl().down(".x-table-layout").dom.rows,e=0;e<d.length;e++)for(var f=d[e].cells,g=0;g<f.length;g++){var h=
Ext.get(f[g]),k=h.down(".x-panel"),m=k.id;void 0!==a&&void 0!==b?(h=k.getSize(!1),h.width*=a,h.height*=b):h=h.getSize(!1);c[m]=h}for(var l in c)h=c[l],Ext.getCmp(l).setSize(h);this.updateLayout()}});Ext.define("Voyant.panel.WordTree",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.wordtree",statics:{i18n:{},api:{query:void 0,docId:void 0,docIndex:void 0,stopList:"auto",context:10,limit:5},glyph:"xf0e8@FontAwesome"},config:{corpus:void 0,tree:void 0,kwicStore:void 0,options:{xtype:"stoplistoption"}},doubleClickDelay:300,lastClick:1,constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(){Ext.apply(this,
