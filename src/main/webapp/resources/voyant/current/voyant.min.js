/* This file created by JSCacher. Last modified: Mon Apr 02 21:20:55 EDT 2018 */
...
sphereMollweideProjection:"Sphere mollweide (Equal Area)",annotate:"Annotate",baseLayer:"Base Layer",baseLayerTip:"Determine map base layer",watercolor:"Stamen watercolor (Default)",osm:"Open Street Map",wms4326:"WMS 4326",arcGIS:"National Geographic World Map - ArcGIS",map:"Map",mapTip:"Define base layer and projection"},api:{stopList:"auto",hide:[],author:void 0,title:void 0,keyword:void 0,pubDate:void 0,citiesMaxCount:500,minPopulation:1E4,citiesMinFreq:1,connectionsMaxCount:2500,connectionsMinFreq:1,
millisPerAnimation:2E3},glyph:"xf124@FontAwesome"},config:{map:void 0,overlay:void 0,contentEl:void 0,isOpenLayersLoaded:!1,isArcLoaded:!1,animationDelay:25,isProj4Loaded:!1,projection:void 0,filterWidgets:new Ext.util.MixedCollection,drawInteraction:void 0,drawMode:!1,currentAnnotation:void 0,baseLayers:{}},html:'\x3cdiv class\x3d"map"\x3e\x3c/div\x3e\x3cdiv class\x3d"ticker"\x3e\x3c/div\x3e\x3cdiv class\x3d"ol-popup"\x3e\x3ca href\x3d"#" class\x3d"ol-popup-closer"\x3e\x3c/a\x3e\x3cdiv class\x3d"popup-content"\x3e\x3c/div\x3e\x3c/div\x3e',
cls:"dreamscape",constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);Ext.Loader.loadScript({url:this.getBaseUrl()+"resources/openlayers/ol.js",onLoad:function(){void 0===ol.Map.prototype.getLayer&&(ol.Map.prototype.getLayer=function(a){var c=void 0;this.getLayers().forEach(function(d){a===d.get("id")&&(c=d)});return c});this.setIsOpenLayersLoaded(!0)},scope:this});Ext.Loader.loadScript({url:this.getBaseUrl()+"resources/dreamscape/arc.js",
...
Ext.Array.contains(a,"animation"),text:this.localize("animations"),itemId:"animation",menu:{defaults:{labelWidth:170,labelAlign:"right",width:280},items:[{xtype:"sliderfield",fieldLabel:this.localize("millisPerAnimation"),value:parseInt(this.getApiParam("millisPerAnimation")),minValue:this.getAnimationDelay(),maxValue:1E4,listeners:{change:function(a,c,d){this.getFilterWidgets().each(function(a){a.setMillisPerAnimation(c);a.animate()},this)},scope:this}}]}}]}},{text:this.localize("map"),tooltip:this.localize("mapTip"),
menu:{items:[{text:this.localize("baseLayer"),tooltip:this.localize("baseLayerTip"),glyph:"xf065@FontAwesome",menu:{items:[{xtype:"radiogroup",columns:1,vertical:!0,defaults:{cls:"map-menu-item",handler:function(a,c){if(c){id=a.getItemId();var d=this.getBaseLayers()[id];d&&(d.setOpacity(1),this.getMap().getLayers().setAt(0,d));"osm"==id||"arcGIS"==id?this.getMap().getLayer("overlayLayer").setVisible(!1):this.getMap().getLayer("overlayLayer").setVisible(!0)}},listeners:{afterrender:function(a){Ext.create("Ext.tip.ToolTip",
{target:a,html:'\x3cdiv class\x3d"map-menu-item-tooltip '+a.getItemId()+'"\x3e\x3c/div\x3e',anchor:"right"})}},scope:this},items:[{boxLabel:this.localize("watercolor"),itemId:"watercolor",cls:["map-menu-item","watercolor"],checked:!0},{boxLabel:this.localize("wms4326"),cls:["map-menu-item","wms4326"],itemId:"wms4326"},{boxLabel:this.localize("osm"),cls:["map-menu-item","osm"],itemId:"osm"},{boxLabel:this.localize("arcGIS"),cls:["map-menu-item","arcGIS"],itemId:"arcGIS"}]}]}},{text:this.localize("projection"),
tooltip:this.localize("projectionTip"),glyph:"xf31e@FontAwesome",menu:{items:[{xtype:"radiogroup",columns:1,vertical:!0,defaults:{handler:function(a,c){if(c){var d=this;id=a.getItemId();if("webMercatorProjection"===id)this.setProjection(ol.proj.get("EPSG:3857"));else if("mercatorProjection"===id)this.setProjection(ol.proj.get("EPSG:4326"));else if("gallPetersProjection"===id){proj4.defs("cea","+proj\x3dcea +lon_0\x3d0 +lat_ts\x3d45 +x_0\x3d0 +y_0\x3d0 +ellps\x3dWGS84 +units\x3dm +no_defs");var e=
ol.proj.get("cea");this.setProjection(e)}else"sphereMollweideProjection"===id&&(proj4.defs("ESRI:54009","+proj\x3dmoll +lon_0\x3d0 +x_0\x3d0 +y_0\x3d0 +datum\x3dWGS84 +units\x3dm +no_defs"),e=ol.proj.get("ESRI:54009"),e.setExtent([-18E6,-9E6,18E6,9E6]),this.setProjection(e));var e=this.getProjection().getExtent(),f=this.getProjection()==ol.proj.get("EPSG:4326")?360:4.007501668557849E7,e=new ol.View({projection:this.getProjection(),center:ol.extent.getCenter(e||[0,0,0,0]),maxResolution:f/d.body.dom.offsetWidth,
zoom:0}),g=this.getMap();g.getLayers().forEach(function(a){a.getSource().getFeatures&&a.getSource().getFeatures().forEach(function(a){var b=a.getGeometry().transform(g.getView().getProjection(),d.getProjection());a.setGeometry(b)})});g.setView(e)}},listeners:{afterrender:function(a){Ext.create("Ext.tip.ToolTip",{target:a,html:'\x3cdiv class\x3d"map-menu-item-tooltip '+a.getItemId()+'"\x3e\x3c/div\x3e',anchor:"right"})}},scope:this},items:[{boxLabel:this.localize("webMercatorProjection"),itemId:"webMercatorProjection",
cls:["map-menu-item","webMercatorProjection"],checked:!0},{boxLabel:this.localize("mercatorProjection"),cls:["map-menu-item","mercatorProjection"],itemId:"mercatorProjection"},{boxLabel:this.localize("gallPetersProjection"),cls:["map-menu-item","gallPetersProjection"],itemId:"gallPetersProjection"},{boxLabel:this.localize("sphereMollweideProjection"),cls:["map-menu-item","sphereMollweideProjection"],itemId:"sphereMollweideProjection"}]}]}}]}},{text:this.localize("add"),itemId:"addFilter",handler:function(a){for(var c=
this.getApplication().getColorPalette(void 0,!0),d=c[0],e=0,f=c.length;e<f;e++){var g=!1;this.getFilterWidgets().each(function(a){if(a.getColor()==c[e])return g=!0,!1});if(0==g){d=c[e];break}}d=a.ownerCt.add({xtype:"geonamesfilter",corpus:this.getCorpus(),color:d,listeners:{removeFilterWidget:function(a){var b=this.getMap(),c=a.getItemId(),d=this.getFilterWidgets();["connections","cities","animation"].forEach(function(a){b.removeLayer(b.getLayer(c+"-"+a))});d.remove(a);0==d.getCount()&&this.getDockedComponent("bottomToolbar").getComponent("addFilter").click()},
filterUpdate:this.filterUpdate,scope:this}});this.getFilterWidgets().add(d.getId(),d);a=this.getMap();f=new ol.layer.Vector({source:new ol.source.Vector({wrapX:!1,useSpatialIndex:!0}),id:d.getId()+"-connections",visible:!0,opacity:.2,style:this.travelStyleFunction.bind(this),updateWhileAnimating:!0,updateWhileInteracting:!0});a.addLayer(f);f=new ol.layer.Vector({source:new ol.source.Vector({wrapX:!1,useSpatialIndex:!0}),id:d.getId()+"-cities",opacity:.5,style:this.cityStyleFunction.bind(this)});a.addLayer(f);
d=new ol.layer.Vector({source:new ol.source.Vector({wrapX:!1,useSpatialIndex:!0}),id:d.getId()+"-animation",style:this.animationStyleFunction.bind(this)});a.addLayer(d)},scope:this},"-",{xtype:"button",enableToggle:!0,text:this.localize("annotate"),itemId:"annotate",handler:function(a){this.getDrawMode()?(this.getMap().removeInteraction(this.getDrawInteraction()),this.setDrawMode(!1),a.toggle(!1)):(this.getMap().addInteraction(this.getDrawInteraction()),this.setDrawMode(!0),a.toggle(!0))},scope:this}]}]});
this.on("loadedCorpus",function(a,c){this.tryInit()},this);this.callParent()},tryInit:function(){if(this.getIsOpenLayersLoaded()&&this.getIsArcLoaded()&&this.getIsProj4Loaded()){var a=this.body.down(".map").setId(Ext.id()),b=this.body.down(".ol-popup"),c=new ol.Overlay({element:b.dom,autoPan:!0,autoPanAnimation:{duration:250}});this.setOverlay(c);var d=this,e=b.down(".ol-popup-closer").dom;e.onclick=function(){c.setPosition(void 0);e.blur();d.getDrawMode()&&d.getDockedComponent("bottomToolbar").getComponent("annotate").click();
return!1};var f=this.getBaseLayers();f.wms4326=new ol.layer.Tile({preload:Infinity,source:new ol.source.TileWMS({url:"https://ahocevar.com/geoserver/wms",crossOrigin:"",params:{LAYERS:"ne:NE1_HR_LC_SR_W_DR",TILED:!0},projection:"EPSG:4326"})});f.watercolor=new ol.layer.Tile({preload:Infinity,source:new ol.source.Stamen({layer:"watercolor",projection:"EPSG:3857"})});f.osm=new ol.layer.Tile({preload:Infinity,source:new ol.source.OSM({projection:"EPSG:3857"})});f.arcGIS=new ol.layer.Tile({preload:Infinity,
source:new ol.source.TileArcGISRest({url:"https://services.arcgisonline.com/ArcGIS/rest/services/NatGeo_World_Map/MapServer",projection:"EPSG:3857"})});this.setContentEl(b.down(".popup-content"));var g=new ol.Map({layers:[f.watercolor,new ol.layer.Tile({preload:Infinity,source:new ol.source.Stamen({cacheize:2048,layer:"toner-hybrid",projection:"EPSG:3857"}),id:"overlayLayer"})],overlays:[c],target:a.getId(),loadTilesWhileInteracting:!0,view:new ol.View({center:[0,0],maxResolution:4.007501668557849E7/
d.body.dom.offsetWidth,zoom:0})});g.on("singleclick",function(a){var b=g.getFeaturesAtPixel(a.pixel);if(b){var c=!1;b.forEach(function(b){"city"===b.get("type")&&b.get("selected")?(d.dispatchEvent("termsClicked",d,[b.get("forms").join("|")]),c=!0):"connection"===b.get("type")&&b.get("selected")&&!c?(d.getFilterWidgets().each(function(c){c=c.getGeonames();if(null!=c){var e="\x3cul\x3e",f=-1;c.getAllConnectionOccurrences(b.get("source"),b.get("target")).forEach(function(a){a.docIndex!=f&&(f=a.docIndex,
e+=d.getCorpus().getDocument(f).getFullLabel()+":\x3cbr\x3e");e+="\x3cli\x3e"+a.source.left+'\x3ca href\x3d"http://www.geonames.org/'+a.source.id+'" target\x3d"_blank" docIndex\x3d'+a.docIndex+" offset\x3d"+a.source.position+" location\x3d"+a.source.form+' class\x3d"termLocationLink"\x3e'+a.source.form+"\x3c/a\x3e "+a.source.right+" [...] "+a.target.left+'\x3ca href\x3d"http://www.geonames.org/'+a.target.id+'" target\x3d"_blank" docIndex\x3d'+a.docIndex+" offset\x3d"+a.target.position+" location\x3d"+
a.target.form+' class\x3d"termLocationLink"\x3e'+a.target.form+"\x3c/a\x3e "+a.target.right+"\x3c/li\x3e"});c=b.get("text");e+="\x3c/ul\x3e";d.getContentEl().setHtml("\x3ch3\x3e"+c+"\x3c/h3\x3e"+e);d.getOverlay().setPosition(a.coordinate);Ext.select(".termLocationLink").elements.forEach(function(a){a.onmouseover=function(){d.showTermInCorpus(a.getAttribute("docIndex"),a.getAttribute("offset"),a.getAttribute("location"))}})}}),c=!0):"annotation"!==b.get("type")||c||(d.setCurrentAnnotation(b),d.getContentEl().setHtml('\x3ctextarea class\x3d"annotation-text" rows\x3d"5" cols\x3d"60"\x3e'+
(b.get("text")?b.get("text"):"")+'\x3c/textarea\x3e\x3cbutton class\x3d"saveAnnotation"\x3eSave\x3c/button\x3e\x3cbutton class\x3d"deleteAnnotation"\x3eDelete\x3c/button\x3e'),d.getOverlay().setPosition(a.coordinate),d.getContentEl().down(".deleteAnnotation").dom.onclick=function(){d.deleteAnnotation()},d.getContentEl().down(".saveAnnotation").dom.onclick=function(){d.saveAnnotation()},d.getContentEl().down(".annotation-text").dom.focus())},this)}});var h=new ol.layer.Vector({map:g,source:new ol.source.Vector({wrapX:!1,
useSpatialIndex:!1}),zIndex:10,selected:!0,style:function(a){if("city"===a.get("type"))return d.cityStyleFunction(a,g.getView().getResolution());if("connection"===a.get("type"))return d.travelStyleFunction(a,g.getView().getResolution())},updateWhileAnimating:!0,updateWhileInteracting:!0});g.on("pointermove",function(a){if(!d.getDrawMode()){h.getSource().clear();var b=g.getFeaturesAtPixel(a.pixel);if(b){for(var c=0;b[c].get("selected")&&(c++,c!==b.length););if(c<b.length){var e=b[c],b={font:"12px Calibri,sans-serif",
textAlign:"center",offsetY:-15,fill:new ol.style.Fill({color:[0,0,0,1]}),stroke:new ol.style.Stroke({color:[255,255,255,.5],width:4})};b.text=e.get("text");b=new ol.style.Style({text:new ol.style.Text(b),zIndex:1});"annotation"!==e.get("type")&&(c=new ol.Feature({text:e.get("text"),geometry:e.getGeometry(),forms:e.get("forms"),selected:!0,coordinates:e.get("coordinates"),width:e.get("width"),visible:e.get("visible"),color:e.get("color"),type:e.get("type"),confidence:e.get("confidence"),source:e.get("source"),
target:e.get("target")}),h.getSource().addFeature(c));e.getGeometry();a=new ol.Feature({geometry:new ol.geom.Point(a.coordinate),selected:!0});a.setStyle(b);h.getSource().addFeature(a);"city"===e.get("type")&&d.getMap().getLayers().forEach(function(a){var b=a.get("id");b&&-1!==b.indexOf("connections")&&(connections=a.getSource().getFeatures(),connections.forEach(function(a){a.get("target")!==e.get("cityId")&&a.get("source")!==e.get("cityId")||h.getSource().addFeature(new ol.Feature({geometry:a.getGeometry(),
selected:!0,coordinates:a.get("coordinates"),width:a.get("width"),visible:a.get("visible"),color:a.get("color"),type:a.get("type")}))}))})}}}});a=new ol.source.Vector({wrapX:!1});b=new ol.layer.Vector({source:a,id:"annotations"});localStorage.annotations&&(f=JSON.parse(localStorage.annotations),f=(new ol.format.GeoJSON).readFeatures(f),a.addFeatures(f));g.addLayer(b);this.setDrawInteraction(new ol.interaction.Draw({source:a,type:"Polygon",freehand:!0,alias:"draw"}));this.getDrawInteraction().on("drawend",
function(a){a.feature.set("type","annotation");d.setCurrentAnnotation(a.feature);d.getContentEl().setHtml('\x3ctextarea class\x3d"annotation-text" rows\x3d"5" cols\x3d"60"\x3e\x3c/textarea\x3e\x3cbutton class\x3d"saveAnnotation"\x3eSave\x3c/button\x3e\x3cbutton class\x3d"deleteAnnotation"\x3eCancel\x3c/button\x3e');d.getContentEl().down(".deleteAnnotation").dom.onclick=function(){d.deleteAnnotation()};d.getContentEl().down(".saveAnnotation").dom.onclick=function(){d.saveAnnotation()};d.getOverlay().setPosition(a.feature.getGeometry().getLastCoordinate());
d.getContentEl().down(".annotation-text").dom.focus()});this.setMap(g);this.getTargetEl().down(".ol-zoom");Ext.create("Ext.Button",{glyph:"xf075@FontAwesome",cls:"annotate",renderTo:this.getTargetEl().down(".ticker").parent(),tooltip:"annotateTip",enableToggle:!0,handler:function(a){this.getDrawMode()?(this.getMap().removeInteraction(this.getDrawInteraction()),this.setDrawMode(!1),a.toggle(!1)):(this.getMap().addInteraction(this.getDrawInteraction()),this.setDrawMode(!0),a.toggle(!0))},scope:this});
this.getDockedComponent("bottomToolbar").getComponent("addFilter").click()}else Ext.defer(this.tryInit,500,this)},deleteAnnotation:function(){this.body.down(".ol-popup").down(".ol-popup-closer").dom.click();this.getMap().getLayer("annotations").getSource().removeFeature(this.getCurrentAnnotation());var a=new ol.format.GeoJSON,b=this.getMap().getLayer("annotations").getSource().getFeatures(),c=[],d=this.getProjection();b.forEach(function(a){transformedFeature=a.clone();transformedFeature.getGeometry().transform(d?
d:"EPSG:3857","EPSG:3857");c.push(transformedFeature)});a=a.writeFeatures(c);localStorage.annotations=JSON.stringify(a)},saveAnnotation:function(){this.getCurrentAnnotation().set("text",this.getContentEl().down(".annotation-text").dom.value);this.getOverlay().setPosition(void 0);this.getDrawMode()&&this.getDockedComponent("bottomToolbar").getComponent("annotate").click();var a=new ol.format.GeoJSON,b=this.getMap().getLayer("annotations").getSource().getFeatures(),c=[],d=this.getProjection();b.forEach(function(a){transformedFeature=
a.clone();transformedFeature.getGeometry().transform(d?d:"EPSG:3857","EPSG:3857");c.push(transformedFeature)});a=a.writeFeatures(c);localStorage.annotations=JSON.stringify(a)},travelStyleFunction:function(a,b){var c=new ol.style.Stroke({color:a.get("color"),width:a.get("width")}),d=[new ol.style.Style({stroke:c})],e=a.getGeometry(),f=e.getLastCoordinate(),e=e.getCoordinateAt(.9),e=Math.atan2(f[1]-e[1],f[0]-e[0]),g=new ol.geom.LineString([f,[f[0]-10*b,f[1]+10*b]]);g.rotate(e,f);var h=new ol.geom.LineString([f,
[f[0]-10*b,f[1]-10*b]]);h.rotate(e,f);d.push(new ol.style.Style({geometry:g,stroke:c}));d.push(new ol.style.Style({geometry:h,stroke:c}));return d},cityStyleFunction:function(a,b){if(a.get("visible")){var c=2*Math.PI*a.get("width"),d=a.get("confidence")?c*a.get("confidence"):c;return new ol.style.Style({image:new ol.style.Circle({radius:a.get("width"),fill:new ol.style.Fill({color:a.get("color")}),stroke:new ol.style.Stroke({lineDash:[d,c-d],color:"rgb(255, 255, 255)",width:2})})})}return!1},animationStyleFunction:function(a){return[new ol.style.Style({stroke:new ol.style.Stroke({color:a.get("color"),
