...
exportEmbed:function(){Ext.Msg.show({title:this.localize("exportViewEmbedTitle"),message:this.localize("exportViewEmbedMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:"\x3c!--\tExported from Voyant Tools (voyant-tools.org).\nThe iframe src attribute below uses a relative protocol to better function with both\nhttp and https sites, but if you're embedding this into a local web page (file protocol)\nyou should add an explicit protocol (https if you're using voyant-tools.org, otherwise\nit depends on this server.\nFeel free to change the height and width values or other styling below: --\x3e\n\x3ciframe style\x3d'width: 100%; height: 800px' src\x3d'"+
...
Ext.apply(a||{},{corpus:this}))},each:function(a,b){this.getDocuments().each(function(c,d){a.call(b||c,c)})},getCorpusCollocates:function(a){return Ext.create("Voyant.data.store.CorpusCollocates",Ext.apply(a||{},{corpus:this}))},getDocumentQueryMatches:function(a){return Ext.create("Voyant.data.store.DocumentQueryMatches",Ext.apply(a||{},{corpus:this}))},getDocumentTerms:function(a){return Ext.create("Voyant.data.store.DocumentTerms",Ext.apply(a||{},{corpus:this}))},getDocumentEntities:function(a){return Ext.create("Voyant.data.store.DocumentEntities",
...
Voyant.application.getDeferred(this);Ext.applyIf(a,{template:"docTokens2lemmas",withPosLemmas:!0,noOthers:!0});this.getWords(a).then(function(a){a=a.split(" ").map(function(a){return a.substring(0,a.indexOf("/"))});b.resolve(a)});return b.promise},getString:function(a){var b=this.getDocumentsCount(),c=this.localize("thisCorpus");if(0==b)c+=" "+this.localize("isEmpty")+".";else{var c=c+" ",c=1<b?c+(new Ext.XTemplate(this.localize("hasNdocuments"))).apply({count:Ext.util.Format.number(b,"0,000")}):
c+this.localize("has1document"),c=c+(" "+(new Ext.XTemplate(this.localize("widthNwordsAndNTypes"))).apply({words:Ext.util.Format.number(this.getWordTokensCount(),"0,000"),types:Ext.util.Format.number(this.getWordTypesCount(),"0,000")})+"."),c=c+(" "+this.localize("created")+" "),d=this.get("createdDate"),e=new Date;!0===Ext.Array.each([["year",Ext.Date.YEAR],["month",Ext.Date.MONTH],["day",Ext.Date.DAY],["hour",Ext.Date.HOUR],["minute",Ext.Date.MINUTE],["second",Ext.Date.SECOND]],function(a){if(Ext.Date.diff(d,
...
dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"querysearchfield"},{xtype:"totalpropertystatus"}]}],columns:[{xtype:"rownumberer",width:"autoSize",sortable:!1},{text:this.localize("term"),tooltip:this.localize("termTip"),dataIndex:"term",flex:1,sortable:!0},{text:this.localize("rawFreq"),tooltip:this.localize("rawFreqTip"),dataIndex:"rawFreq",width:"autoSize",sortable:!0},{text:this.localize("relativeFreq"),tooltip:this.localize("relativeFreqTip"),dataIndex:"relativeFreq",
renderer:function(a){return Ext.util.Format.number(1E6*a,"0,000")},width:"autoSize",hidden:!0,sortable:!0},{text:this.localize("relativePeakedness"),tooltip:this.localize("relativePeakednessTip"),dataIndex:"relativePeakedness",renderer:Ext.util.Format.numberRenderer("0,000.0"),width:"autoSize",hidden:!0,sortable:!0},{text:this.localize("relativeSkewness"),tooltip:this.localize("relativeSkewnessTip"),dataIndex:"relativeSkewness",renderer:Ext.util.Format.numberRenderer("0,000.0"),width:"autoSize",hidden:!0,
sortable:!0},{text:this.localize("corpusComparisonDifference"),tooltip:this.localize("corpusComparisonDifferenceTip"),dataIndex:"relativeSkewness",renderer:Ext.util.Format.numberRenderer("0,000.0"),width:"autoSize",hidden:!this.getApiParam("comparisonCorpus"),sortable:!0,listeners:{show:function(b,d,e){a.getApiParam("comparisonCorpus")||a.showError(a.localize("noCorpusComparison"))}}},{xtype:"widgetcolumn",text:this.localize("trend"),tooltip:this.localize("trendTip"),flex:1,dataIndex:"distributions",
widget:{xtype:"sparklineline",tipTpl:new Ext.XTemplate("{[this.getDocumentTitle(values.x,values.y)]}",{getDocumentTitle:function(a,b){return this.panel.store.getCorpus().getDocument(a).getTitle()+"\x3cbr\x3erelative frequency: "+Ext.util.Format.number(1E6*b,"0,000")},panel:a})}}]});a.on("loadedCorpus",function(a,b){100<b.getDocumentsCount()&&this.getStore().getProxy().setExtraParam("bins",this.getApiParam("maxBins"));this.isVisible()&&this.getStore().load()},a);a.on("activate",function(){a.getStore().getCorpus()&&
a.getStore().load({params:this.getApiParams()})},a);a.on("query",function(a,b){this.setApiParam("query",b);this.getStore().removeAll();this.getStore().load()},a);a.callParent(arguments)}});Ext.define("Voyant.panel.DocumentTerms",{extend:"Ext.grid.Panel",mixins:["Voyant.panel.Panel"],requires:["Voyant.data.store.DocumentTerms"],alias:"widget.documentterms",config:{options:{xtype:"stoplistoption"}},statics:{i18n:{},api:{stopList:"auto",query:void 0,docId:void 0,docIndex:void 0,bins:10},glyph:"xf0ce@FontAwesome"},constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.on("loadedCorpus",function(a,b){var e=this.getStore();
...
c)}},this);this.getCorpus()&&(this.load(),(a=this.getApiParam("query"))&&this.loadQueryTerms(Ext.isString(a)?[a]:a))},this);Ext.apply(this,{title:this.localize("title"),cls:"voyant-reader",layout:"fit",items:{layout:"border",items:[{bodyPadding:10,region:"center",border:!1,autoScroll:!0,html:'\x3cdiv class\x3d"readerContainer"\x3e\x3c/div\x3e'},{region:"south",height:40,split:{size:2},splitterResize:!0,border:!1,layout:{type:"hbox"}}]},dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",
items:[{glyph:"xf060@FontAwesome",handler:function(){this.fetchPrevious(!0)},scope:this},{glyph:"xf061@FontAwesome",handler:function(){this.fetchNext(!0)},scope:this},{xtype:"tbseparator"},{xtype:"querysearchfield"}]}],listeners:{loadedCorpus:function(a,b){this.getTokensStore().setCorpus(b);this.getDocumentTermsStore().getProxy().setExtraParam("corpus",b.getId());var c=b.getDocuments();this.setDocumentsStore(c);this.setIsDetailedGraph(c.getTotalCount()<this.DETAILED_GRAPH_DOC_LIMIT);c=this.down('panel[region\x3d"south"]');
void 0==this.getLocationMarker()&&this.setLocationMarker(Ext.DomHelper.append(c.el,{tag:"div",style:"background-color: #157fcc; height: 100%; width: 2px; position: absolute; top: 0; left: 0;"}));this.generateChart(b,c);this.rendered&&(this.load(),0==this.hasCorpusAccess(b)&&this.mask(this.localize("limitedAccess"),"mask-no-spinner"),(c=this.getApiParam("query"))&&this.loadQueryTerms(Ext.isString(c)?[c]:c))},termsClicked:function(a,b){var c=[];b.forEach(function(a){Ext.isString(a)?c.push(a):a.term?
c.push(a.term):a.getTerm&&c.push(a.getTerm())});0<c.length&&this.loadQueryTerms(c)},corpusTermsClicked:function(a,b){var c=[];b.forEach(function(a){a.getTerm()&&c.push(a.getTerm())});this.loadQueryTerms(c)},documentTermsClicked:function(a,b){var c=[];b.forEach(function(a){a.getTerm()&&c.push(a.getTerm())});this.loadQueryTerms(c)},documentSelected:function(a,b){var c=this.getTokensStore().getCorpus().getDocument(b);this.setApiParams({skipToDocId:c.getId(),start:0});this.load(!0)},documentsClicked:function(a,
b,c){0<b.length&&(this.setApiParams({skipToDocId:b[0].getId(),start:0}),this.load(!0))},termLocationClicked:function(a,b){if(void 0!==b[0]){var c=b[0],g=c.get("docIndex"),h=c.get("position"),k=h-this.getApiParam("limit")/2,l=this.getCorpus().getDocument(g);this.setApiParams({skipToDocId:l.getId(),start:0>k?0:k});this.load(!0,{callback:function(){var a=this.body.dom.querySelector("#_"+g+"_"+h);a&&a.scrollIntoView();this.highlightKeywords(c.get("term"),!1)},scope:this})}},documentIndexTermsClicked:function(a,
b){if(void 0!==b[0]){var c=Ext.create("Voyant.data.model.Token",b[0]);this.fireEvent("termLocationClicked",this,[c])}},scope:this}});this.callParent(arguments)},loadQueryTerms:function(a){a&&0<a.length&&this.getDocumentTermsStore().load({params:{query:a}})},updateLocationMarker:function(a,b){var c=Ext.DomQuery.select(".word",this.getInnerContainer().down(".readerContainer",!0)),d=c[0],e=c[c.length-1];if(void 0!==d&&void 0!==e){var c=this.getCorpus(),f=!1,g=Voyant.data.model.Token.getInfoFromElement(Ext.get(d)),
e=Voyant.data.model.Token.getInfoFromElement(Ext.get(e));0!==g.position&&(f=!0);for(var h={},d=0,k=g.docIndex;k<=e.docIndex;){var l=c.getDocument(k).get("tokensCount-lexical");k===e.docIndex&&(l=e.position);k===g.docIndex&&(l-=g.position);d+=l;h[k]=l;k++}for(var k=Math.round(d*a),l=d=0,m=g.docIndex;m<=e.docIndex&&!(d=m,l+=h[m],l>=k);m++);e=h[d]-(l-k);f&&d===g.docIndex&&(e+=g.position);f=e/c.getDocument(d).get("tokensCount-lexical");c=Ext.get(this.getLocationMarker());g=c.getX();this.getIsDetailedGraph()?
(e=this.query("cartesian")[d])&&(g=e.getX()+e.getWidth()*f):(e=this.down("cartesian"),g=e.getWidth()/this.getCorpus().getDocuments().getCount(),g=e.getX()+g*d+g*f);null!=b&&(f=c.getX(),b==this.SCROLL_DOWN&&f>g||b==this.SCROLL_UP&&f<g)&&(g=f);c.setX(g)}this.setLastLocationUpdate(new Date)},generateChart:function(a,b){function c(a,b){var c=this.getApplication().getColor(a);return"rgba("+c[0]+","+c[1]+","+c[2]+","+b+")"}function d(d){var e=d.index,f=d.fraction;d=d.relativeHeight;var g=c.call(this,e,
.3),e=c.call(this,e,1);b.add({xtype:"cartesian",plugins:{ptype:"chartitemevents"},flex:f,height:"100%",insetPadding:0,background:{type:"linear",degrees:90,stops:[{offset:0,color:g},{offset:d,color:g},{offset:d,color:"white"},{offset:1,color:"white"}]},axes:[{type:"numeric",position:"left",fields:"distribution",hidden:!0},{type:"category",position:"bottom",fields:"bin",hidden:!0}],series:[{type:"line",xField:"bin",yField:"distribution",style:{lineWidth:2,strokeStyle:e},tooltip:{corpus:a,trackMouse:!0,
style:"background: #fff",showDelay:0,dismissDelay:500,hideDelay:5,renderer:function(b,c,d){b.setHtml(a.getDocument(c.get("docIndex")).getTitle()+"\x3cbr\x3e"+c.get("term")+": "+c.get("distribution"))}}}],store:Ext.create("Ext.data.ArrayStore",{fields:["docId","docIndex","bin","distribution","term"],data:[]}),listeners:{itemclick:function(a,b,c){a=b.record.data;a=this.getDocumentsStore().getAt(a.docIndex);this.getApplication().dispatchEvent("documentsClicked",this,[a])},scope:this}}).body.on("click",
function(a,b){var c=Ext.get(b),d=a.getX(),e=c.getBox(),d=(d-e.x)/e.width,c=c.parent(".x-panel"),e=c.parent(),c=Ext.toArray(e.dom.children).indexOf(c.dom),c=this.getDocumentsStore().getAt(c),e=c.get("tokensCount-lexical"),d=Math.floor(e*d)-this.getApiParam("limit")/2;this.setApiParams({skipToDocId:c.getId(),start:0>d?0:d});this.load(!0)},this)}b.removeAll();for(var e=a.getDocuments(),f=a.getWordTokensCount(),g=[],h=Number.MAX_VALUE,k=-1,l=0;l<e.getCount();l++){var m=e.getAt(l),n=m.get("index"),m=m.get("tokensCount-lexical");
m<h&&(h=m);m>k&&(k=m);g.push({index:n,count:m,fraction:m/f})}if(this.getIsDetailedGraph())for(l=0;l<g.length;l++)m=g[l],m.relativeHeight=m.count==k?1:.25+(m.count-h)/(k-h)*.75,d.call(this,m);else b.add({xtype:"cartesian",plugins:{ptype:"chartitemevents"},flex:1,height:"100%",insetPadding:0,axes:[{type:"numeric",position:"left",fields:"count",hidden:!0},{type:"category",position:"bottom",fields:"index",hidden:!0}],series:[{type:"bar",xField:"index",yField:"count",style:{minGapWidth:0,minBarWidth:1,
lineWidth:0,strokeStyle:"none"},renderer:function(a,b,d,e){a=this.getChart().findParentByType("reader");return{fillStyle:c.call(a,e,.3)}}}],store:Ext.create("Ext.data.JsonStore",{fields:[{name:"index",type:"int"},{name:"count",type:"int"},{name:"fraction",type:"float"}],data:g}),listeners:{itemclick:function(a,b,c){a=Ext.get(c.getTarget());c=c.getX();a=a.getBox();var d=a.width/this.getCorpus().getDocuments().getCount();c=(c-a.x)%d/d;b=b.record.data;b=this.getDocumentsStore().getAt(b.index);a=b.get("tokensCount-lexical");
c=Math.floor(a*c)-this.getApiParam("limit")/2;this.setApiParams({skipToDocId:b.getId(),start:0>c?0:c});this.load(!0)},scope:this}})},highlightKeywords:function(a,b){Ext.isArray(a)||(a=[a]);this.getInnerContainer().first().select("span[class*\x3dkeyword]").removeCls("keyword");var c=[],d=new RegExp("^"+a[0]+"$","i");this.getInnerContainer().first().select("span.word").each(function(a,b,g){a.dom.firstChild&&a.dom.firstChild.nodeValue.match(d)&&(a.addCls("keyword"),c.push(a.dom))})},fetchPrevious:function(a){var b=
this.getInnerContainer().first(),c=b.first(".word");if(null!=c&&!1===c.hasCls("loading"))for(;c;){if(c.hasCls("word")){var b=Voyant.data.model.Token.getInfoFromElement(c),d=b.docIndex,b=b.position,e=this.getDocumentsStore().getAt(d),f=this.getApiParam("limit"),g=!1;if(0===d&&0===b){a=this.down('panel[region\x3d"center"]').body;0!=c.getScrollIntoViewXY(a,a.dom.scrollTop,a.dom.scrollLeft).y&&c.dom.scrollIntoView();c.frame("red");break}0<d&&0===b?(g=!0,d--,e=this.getDocumentsStore().getAt(d),d=e.get("tokensCount-lexical"),
b=d-f,0>b&&(b=0,this.setApiParam("limit",d))):(f--,b-=f);0>b&&(b=0);c.insertSibling("\x3cdiv class\x3d'loading'\x3e"+this.localize("loading")+"\x3c/div\x3e","before",!1).mask();g||c.destroy();c=e.getId();this.setApiParams({skipToDocId:c,start:b});this.setInsertWhere("afterBegin");this.setScrollIntoView(a);this.load();this.setApiParam("limit",this.INITIAL_LIMIT);break}c.destroy();c=b.first()}},fetchNext:function(a){var b=this.getInnerContainer().first(),c=b.last();if(!1===c.hasCls("loading"))for(;c;){if(c.hasCls("word")){var b=
Voyant.data.model.Token.getInfoFromElement(c),d=b.docIndex,e=b.position,f=this.getDocumentsStore().getAt(b.docIndex),g=f.getId(),f=f.get("tokensCount-lexical");if(e+this.getApiParam("limit")>=f&&d==this.getCorpus().getDocumentsCount()-1)if(d=f-e,1>=d){c.dom.scrollIntoView();c.frame("red");break}else this.setApiParam("limit",d);for(d=c.dom.nextSibling;d;)e=d,d=d.nextSibling,e.parentNode.removeChild(e);c.insertSibling("\x3cdiv class\x3d'loading'\x3e"+this.localize("loading")+"\x3c/div\x3e","after",
!1).mask();c.destroy();this.setApiParams({skipToDocId:g,start:b.position});this.setInsertWhere("beforeEnd");this.setScrollIntoView(a);this.load();this.setApiParam("limit",this.INITIAL_LIMIT);break}c.destroy();c=b.last()}},load:function(a,b){a&&(this.getInnerContainer().first().destroy(),this.getInnerContainer().setHtml('\x3cdiv class\x3d"readerContainer"\x3e\x3cdiv class\x3d"loading"\x3e'+this.localize("loading")+"\x3c/div\x3e\x3c/div\x3e"),this.getInnerContainer().first().first().mask());this.getTokensStore().load(Ext.apply(b||
{},{params:Ext.apply(this.getApiParams(),{stripTags:"blocksOnly"})}))},updateText:function(a){var b=this.getInnerContainer().down(".loading");b&&b.destroy();var c=this.getInnerContainer().first().insertHtml(this.getInsertWhere(),a,!0);c&&this.getScrollIntoView()&&(c.dom.scrollIntoView(),Ext.Function.defer(function(){var a=Ext.get(c.id);a&&a.frame("red")},100));a=this.down('panel[region\x3d"center"]').body.dom;this.updateLocationMarker(0==a.scrollTop?0:a.scrollHeight-a.scrollTop==a.clientHeight?1:
(a.scrollTop+.5*a.clientHeight)/a.scrollHeight)},updateChart:function(){}});Ext.define("Voyant.panel.SimpleDocReader",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.simpledocreader",isConsumptive:!0,statics:{i18n:{noNext:"No next document.",noPrevious:"No previous document."},api:{docIndex:void 0,docId:void 0},glyph:"xf0f6@FontAwesome"},config:{},constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(a){Ext.apply(this,{html:'\x3ciframe style\x3d"width: 100%; height: 100%; border: none;"\x3e\x3c/iframe\x3e',
...
""),d=d.substring(d.indexOf("/spiral/")+8);"?"==d.charAt(d.length-1)&&(d=d.substring(0,d.length-1));urlParts=d.split("/");(notebook=urlParts.shift())&&1<urlParts.length&&"/"==d.charAt(d.length-1)&&(d=d.slice(0,-1));if(notebook&&"new"!=notebook){if("gist"==notebook)return this.loadFromUrl(d,c);"alta"==d&&b&&b.all&&"true"==b.all?(this.loadFromUrl("alta-start",c),this.loadFromUrl("alta-create",c),this.loadFromUrl("alta-smaller",c),this.loadFromUrl("alta-tables",c),this.loadFromUrl("alta-scale",c)):(-1==
