...
0;g<=c;g+=this.COARSENESS)if(e[f]&&e[f][g]&&null!=this.grid[f+a]&&null!=this.grid[f+a][g+b])return!0;return!1},f;this.grid=[];l=0;f=function(){var a,f,h,k,n=this.wordsToArrange-1,s=g.canvas.width,q=g.canvas.height,x=.5*s,r=.5*q;do{h=p[l];if(void 0!==h){for(var B=Math.random()*Math.PI,v=.25*Math.random()*h.size,D=.5*(Math.random()-.5),M=.5*h.width,N=.5*h.height;;){a=Math.floor((x+Math.cos(B)*v*this.ratio-M)/this.COARSENESS)*this.COARSENESS;f=Math.floor((r+Math.sin(B)*v-N)/this.COARSENESS)*this.COARSENESS;
k=a+M>=s||f+N>=q?!0:d(a,f,h.height,h.width,h.mask);if(!k)break;B+=D;v+=.05}c(a,f,h);if(g.useFadeEffect)for(a=h.alpha=0;a<l;a++)f=p[a],1>f.alpha&&b(f);else h.alpha=1,h.draw(g.context)}l++;if(l>=p.length){clearTimeout(m);this.doingArrange=!1;this.toggleLoadingText(!1);e();break}}while(n--)}.createDelegate(this);d=d.createDelegate(this);c=c.createDelegate(this);b=b.createDelegate(this);a=a.createDelegate(this);this.doingArrange=!0;m=setInterval(f,50)}else alert("Error: There are no words to arrange.")};
...
s=function(a){return doubletree.fieldText(a,"POS")},x=function(a){return"rgba(255,255,255,1)"},u=function(a){return"rgba(255,255,255,1)"},G=function(a){return"red"},L={node:{fill:"white",stroke:"steelblue","stroke-width":"1.5px"},branch:{stroke:"#aaa","stroke-width":"1.5px"}},B=!1,E=d3.dispatch("idsUpdated");E.on("idsUpdated",function(){this==C?(A.setIds(C.continuationIDs),A.updateContinuations()):this==A&&(C.setIds(A.continuationIDs),C.updateContinuations())});var z,H,C,A,K,I;b.init=function(a){d3.select(d3.selectAll(a)).call(this);
return b};b.redraw=function(){void 0!==z&&void 0!==H&&b.setupFromTries(z,H);return b};b.setupFromTries=function(d,k){z=d.getUniqRoot();H=k.getUniqRoot();var w=z.toTree(l.left),v=H.toTree(l.right),D=!0;0<Object.keys(v.pruned).length&&(a(v,v.pruned,D),a(w,v.pruned,D),D=!1);0<Object.keys(w.pruned).length&&(a(w,w.pruned,D),a(v,w.pruned,D));var D={},M;for(M in v.info)"continuations"!=M&&"ids"!=M&&"count"!=M&&(D[M]=v.info[M]);D["right continuations"]=v.info.continuations;D["left continuations"]=w.info.continuations;
D.ids={};c(D.ids,v.info.ids);c(D.ids,w.info.ids);D.count=Object.keys(D.ids).length;K=Object.keys(D.ids);if(v.info.origIDs||w.info.origIDs)D.origIDs={},c(D.origIDs,v.info.origIDs),c(D.origIDs,w.info.origIDs),D.origCount=Object.keys(D.origIDs).length;v.info=D;w.info=D;M=Math.max(w.maxChildren,v.maxChildren);if(isNaN(M)||0==M)return B=!1,b;q?I=d3.scaleLog().range([8,14]):(I=function(){return 14},I.domain=function(){});M=Math.min(w.minCount,v.minCount);I.domain([M,w.info.count]);var N=g-20-20,O=h-20-
...
l=a;return b};b.handlers=function(a){if(!arguments.length)return m;m=a;return b};b.showTokenExtra=function(a){if(!arguments.length)return n;n=a;return b};b.scaleLabels=function(a){if(!arguments.length)return q;q=a;return b};b.succeeded=function(){return B};b.sortFun=function(a){if(!arguments.length)return r;r=a;return b};b.nodeText=function(a){if(!arguments.length)return p;p=a;return b};b.tokenExtraText=function(a){if(!arguments.length)return s;s=a;return b};b.rectColor=function(a){if(!arguments.length)return x;
x=a;return b};b.rectBorderColor=function(a){if(!arguments.length)return u;u=a;return b};b.continuationColor=function(a){if(!arguments.length)return G;G=a;return b};b.basicStyles=function(a){if(!arguments.length)return L;Object.keys(L).forEach(function(b){b in a&&Object.keys(L[b]).forEach(function(c){c in a[b]&&(L[b][c]=a[b][c])})});return b};return b};doubletree.Tree=function(a,b,c,d,k,l,m,n,q,r,p,s,x,u,G){function L(a){a.children&&(a._children=a.children,a._children.forEach(L),a.children=null)}function B(a){a.parent&&
a.parent.children.forEach(function(b){b!=a&&L(b)})}function E(a,b){d3.event.altKey?w.handleAltPress(a,b):d3.event.shiftKey?w.handleShiftPress(a,b):(w.handleClick(a,b),a.parent&&(w.continuationIDs!=a.data.info.ids&&(w.setIds(a.data.info.ids),w.clickedNode=a.id,m.call("idsUpdated",w)),B(a),z(a,!0)))}function z(a,b){a.children?(a.children&&1==a.children.length&&z(a.children[0],!0),a._children=a.children,a.children=null):(a.children=a._children,a._children=null,a.children&&1==a.children.length&&z(a.children[0],
!1));b&&w.update(a)}function H(a){return k?-a:a}var C=q,A=s;b=b-20-20;c=c-20-20;var K=0,I;l||(l=doubletree.sortByStrFld("token"));var K=0,J=d3.tree().size([c,b]).nodeSize([40,40]),F=d3.linkHorizontal().x(function(a){return H(a.y)}).y(function(a){return a.x});a=a.append("g").attr("transform","translate(20,20)");this.readJSONTree=function(a){I=d3.hierarchy(a);I.x0=0;I.y0=0;I.children.forEach(L);this.update(I)};this.update=function(b){var c=J(I).descendants();c.forEach(function(a){var b=a.textSize;if(void 0==
...
function(){var a=this.parentElement.getBBox().height;6>a&&(a=6.1);return a-6}).attr("y",function(a){return a.parent?-.5*this.parentElement.getBBox().height/2:-.5*this.parentElement.getBBox().height/2-2}).attr("width",function(){return this.parentElement.getBBox().width}).attr("x",function(a){var b=this.parentElement.getBBox().width;return a.parent?k?-.5*b:0:-.33333*b}).style("stroke-opacity",1).style("stroke-width",1).style("stroke",function(a){return x(a.data.info)}).style("fill",function(a){return A(a.data.info)}).style("fill-opacity",
function(a){return 1})};var w=this;this.setIds=function(a){w.continuationIDs=a};this.updateContinuations=function(){a.selectAll("g.node_"+k+" text").classed("continuation",function(a){var b;a:{a=a.data.info.ids;var c=w.continuationIDs||{};for(b in a)if(b in c){b=!0;break a}b=!1}return b}).style("fill",function(a){return d3.select(this).classed("continuation")?u(a.data.info):"#444"})};this.search=function(b){a.selectAll("g.node text").classed("foundText",function(a){return b.test(r(a.data.info))})};
...
l*m.length+"x15\x26amp;chd\x3dt:"+m.join(",")+"' alt\x3d'' class\x3d'chart-");1==d?h+="full":0<f&&f+1<d?h+"middle":h=0==f?h+"left":h+"right";h+="' /\x3e"}return h}});Ext.define("Voyant.util.Toolable",{requires:["Voyant.util.Localization"],statics:{i18n:{exportGridAllJson:"export all available data in JSON",exportAllTitle:"Export All",exportAllJsonWarning:"You're requesting all of the available data (in a JSON format that Voyant uses), are you sure you want to continue?",exportGridAllTsv:"export all available data as tab separated values (text)",exportAllTsvWarning:"You're requesting all of the available data, are you sure you want to continue?"}},constructor:function(a){a=
...
modal:!0,panel:a,items:{xtype:"form",items:a.getOptions(),listeners:{afterrender:function(b){var c=a.getApiParams(b.getForm().getFields().collect("name"));b.getForm().setValues(c)}},buttons:[{text:a.localize("reset"),glyph:"xf0e2@FontAwesome",flex:1,panel:a,ui:"default-toolbar",handler:function(a){this.mixins&&this.mixins["Voyant.util.Api"]&&(this.mixins["Voyant.util.Api"].constructor.apply(this),this.getCorpus&&this.getCorpus()&&this.fireEvent("loadedCorpus",this,this.getCorpus()));a.up("window").close()},
scope:a},{xtype:"tbfill"},{text:a.localize("cancelTitle"),ui:"default-toolbar",glyph:"xf00d@FontAwesome",flex:1,handler:function(a){a.up("window").close()}},{text:a.localize("confirmTitle"),glyph:"xf00c@FontAwesome",flex:1,panel:a,handler:function(a){function b(a,c){d.setApiParam&&d.setApiParam(a,c);for(var e=d.getViewport().query("panel,chart"),g=0;g<e.length;g++)e[g].setApiParam&&e[g].setApiParam(a,c);f=!0}var c=a.up("form").getValues();this.setApiParams(c);var d=this.getApplication(),e=d.getCorpus(),
f=!1;void 0!=c.stopList&&void 0!=c.stopListGlobal&&c.stopListGlobal&&b("stopList",c.stopList);void 0!=c.palette&&b("palette",c.palette);f&&(e?d.dispatchEvent("loadedCorpus",this,e):d.dispatchEvent("apiParamsUpdated",this,c));e?this.fireEvent("loadedCorpus",this,e):this.fireEvent("apiParamsUpdated",this,c);a.up("window").close()},scope:a}]},bodyPadding:5}).show()}}:void 0,help:{glyph:"xf128@FontAwesome",fn:this.helpToolClick}},c=[];if(a.includeTools)for(var f in a.includeTools)"object"==typeof a.includeTools[f]&&
c.push(a.includeTools[f]);for(f in e)a.includeTools&&!a.includeTools[f]||!e[f]||c.push({type:f,tooltip:this.localize(f+"Tip"),callback:e[f].fn,xtype:"toolmenu",glyph:e[f].glyph,items:e[f].items});Ext.apply(this,{tools:c});this.on("afterrender",function(){var a=this.getHeader();if(a&&"Desktop"==Ext.os.deviceType&&!this.isXType("corpuscreator")&&!this.isXType("notebook")){var b=a.getEl();b.on("mouseover",function(){this.getHeader().getTools().forEach(function(a){a.show()})},this);b.on("mouseout",function(){this.getHeader().getTools().forEach(function(a){var b=
a.config.type||a.type;b&&"help"!=b&&-1==b.indexOf("collapse")&&a.hide()})},this);a.getTools().forEach(function(a,b){"help"!=a.config.type&&a.hide()})}},this)},getMenuItemFromXtype:function(a){var b=this.getApplication().getToolConfigFromToolXtype(a);b&&b.tooltip&&delete b.tooltip;return Ext.apply(Ext.clone(b),{xtype:"menuitem",text:b.title,textAlign:"left",handler:function(){this.replacePanel(b.xtype)},scope:this})},maximizeToolClick:function(a){var b=Ext.getClass(a).getName().split(".");url=a.getBaseUrl()+
...
[];b.push({xtype:"radio",name:"export",inputValue:"url",boxLabel:"\x3ca href\x3d'"+a.getExportUrl.call(a)+"' target\x3d'_blank'\x3e"+a.localize("exportViewUrl")+"\x3c/a\x3e",checked:!0,listeners:{afterrender:function(){this.boxLabelEl.on("click",function(){this.up("window").close()},this)}}},{xtype:"fieldset",collapsible:!0,collapsed:!0,title:a.localize("exportViewFieldset"),items:[{xtype:"radio",name:"export",inputValue:"embed",boxLabel:a.localize("exportViewHtmlEmbed")},{xtype:"radio",name:"export",
inputValue:"biblio",boxLabel:a.localize("exportViewBiblio")}]});if(a.isXType("grid")){var c=[{xtype:"radio",name:"export",inputValue:"gridCurrentHtml",boxLabel:a.localize("exportGridCurrentHtml")},{xtype:"radio",name:"export",inputValue:"gridCurrentTsv",boxLabel:a.localize("exportGridCurrentTsv")}];a.getExportGridAll&&0==a.getExportGridAll()||c.push({xtype:"radio",name:"export",inputValue:"gridAllJson",boxLabel:a.localize("exportGridAllJson")},{xtype:"radio",name:"export",inputValue:"gridAllTsv",
boxLabel:a.localize("exportGridAllTsv")});b.push({xtype:"fieldset",collapsible:!0,collapsed:!0,title:a.localize("exportGridCurrent"),items:c})}a.getExportVisualization&&!a.getExportVisualization()||0!=a.isXType("grid")||!(a.down("chart")||a.getTargetEl().dom.querySelector("canvas")||a.getTargetEl().dom.querySelector("svg"))||(c=[{xtype:"radio",name:"export",inputValue:"png",boxLabel:a.localize("exportPng")}],a.getTargetEl().dom.querySelector("svg")&&c.push({xtype:"radio",name:"export",inputValue:"svg",
boxLabel:a.localize("exportSvg")}),b.push({xtype:"fieldset",collapsible:!0,collapsed:!0,title:a.localize("exportVizTitle"),items:c}));Ext.create("Ext.window.Window",{title:a.localize("exportTitle"),modal:!0,items:{xtype:"form",items:b,buttons:[{text:a.localize("exportTitle"),glyph:"xf08e@FontAwesome",flex:1,panel:a,handler:function(b){var c=b.up("form"),f="export"+Ext.String.capitalize(c.getValues()["export"]);Ext.isFunction(a[f])?a[f].call(a,a,c):Ext.Msg.show({title:a.localize("exportError"),message:a.localize("exportNoFunction"),
buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR});b.up("window").close()},scope:a},{text:a.localize("cancelTitle"),glyph:"xf00d@FontAwesome",flex:1,handler:function(a){a.up("window").close()}}]},bodyPadding:5}).show()},exportSvg:function(a){if(a=this.getTargetEl().dom.querySelector("svg"))a=d3.select(a).attr("version",1.1).attr("xmlns","http://www.w3.org/2000/svg").node().parentNode.innerHTML,Ext.Msg.show({title:this.localize("exportSvgTitle"),message:'\x3cimg src\x3d"data:image/svg+xml;base64,'+btoa(unescape(encodeURIComponent(a)))+
'" style\x3d"float: right; max-width: 200px; max-height: 200px; border: thin dotted #ccc;"/\x3e'+this.localize("exportSvgMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:a})},exportPngData:function(a){Ext.Msg.show({title:this.localize("exportPngTitle"),message:'\x3cimg src\x3d"'+a+'" style\x3d"float: right; max-width: 200px; max-height: 200px; border: thin dotted #ccc;"/\x3e'+this.localize("exportPngMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:'\x3cimg src\x3d"'+
a+'" /\x3e'})},exportPng:function(){var a,b=this.down("draw");if(b)return this.exportPngData(b.getImage().data);if(this.down("chart"))return this.exportPngData(this.down("chart").getImage().data);var b=this.getTargetEl().dom,c=b.querySelector("canvas");if(c)return this.exportPngData(c.toDataURL("image/png"));var d=b.querySelector("svg");if(d){d=d3.select(d).attr("version",1.1).attr("xmlns","http://www.w3.org/2000/svg").node().parentNode.innerHTML;a="data:image/svg+xml;base64,"+btoa(unescape(encodeURIComponent(d)));
var c=Ext.DomHelper.createDom({tag:"canvas",width:b.offsetWidth,height:b.offsetHeight}),e=c.getContext("2d"),f=new Image;f.src=a;f.panel=this;f.onload=function(){e.drawImage(f,0,0);a=c.toDataURL("image/png");return this.panel.exportPngData.call(this.panel,a)}}},exportUrl:function(){this.openUrl(this.getExportUrl())},exportEmbed:function(){Ext.Msg.show({title:this.localize("exportViewEmbedTitle"),message:this.localize("exportViewEmbedMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,
value:"\x3c!--\tExported from Voyant Tools (voyant-tools.org).\nThe iframe src attribute below uses a relative protocol to better function with both\nhttp and https sites, but if you're embedding this into a local web page (file protocol)\nyou should add an explicit protocol (https if you're using voyant-tools.org, otherwise\nit depends on this server.\nFeel free to change the height and width values or other styling below: --\x3e\n\x3ciframe style\x3d'width: 100%; height: 800px' src\x3d'"+this.getExportUrl()+
"'\x3e\x3c/iframe\x3e"})},exportBiblio:function(){var a=new Date;Ext.Msg.show({title:this.localize("exportBiblioTitle"),message:"\x3cfieldset\x3e\x3clegend\x3eMLA\x3c/legend\x3eSinclair, St\u00e9fan and Geoffrey Rockwell. "+(this.isXType("voyantheader")?"":'"'+this.localize("title")+'." ')+"\x3ci\x3eVoyant Tools\x3c/i\x3e. "+Ext.Date.format(a,"Y")+". Web. "+Ext.Date.format(a,"j M Y")+". \x26lt;http://voyant-tools.org\x26gt;.\x3c/fieldset\x3e\x3cbr \x3e\x3cfieldset\x3e\x3clegend\x3eChicago\x3c/legend\x3eSt\u00e9fan Sinclair and Geoffrey Rockwell, "+
...
(a.headers||a.noHeaders||!a.rows?this.setHeaders(Ext.Array.from(a.headers)):this.setHeaders(a.rows.shift()));this.setRows(Ext.Array.from(a.rows));this.setRowKey(a.rowKey?a.rowKey:this.getHeaders()[0]);0==this.getHeaders().length&&(c=this.getRow(0,!1))&&this.setHeaders(c.map(function(a,b){return b}));var f={};this.getHeaders().forEach(function(a,b){f[a]=b});this.setHeadersMap(f);this.reMapRows();this.callParent()},addRow:function(a){if(Ext.isObject(a)){var b=this.getRows().length,c;for(c in a)this.updateCell(b,
c,a[c])}else Ext.isArray(a)&&this.getRows().push(a)},eachRecord:function(a,b){for(var c,d=0,e=this.getRows().length;d<e&&(c=this.getRecord(d),!1!==a.call(b||c,c,d,e));d++);},eachRow:function(a,b,c){for(var d,e=0,f=this.getRows().length;e<f&&(d=this.getRow(e,b),!1!==a.call(c||d,d,e,f));e++);},getRow:function(a,b){if(b){var c={},d=this.getHeaders();Ext.Array.from(this.getRows()[a]).forEach(function(a,b){c[d[b]||b]=a},this);return c}return this.getRows()[a]},getRecord:function(a){if(this.model)return new this.model(this.getRow(a,
!0))},mapRows:function(a,b,c){var d=[];this.eachRow(function(b,f){d.push(a.call(c||this,b,f))},b,this);return d},updateCell:function(a,b,c,d){var e=this.getRows();a=Ext.isNumber(a)?a:this.getRowIndex(a);b=this.getColumnIndex(b);void 0===e[a]&&(e[a]=[]);e[a][b]=void 0===e[a][b]||d?c:e[a][b]+c},getRowIndex:function(a){if(Ext.isNumber(a))return a;if(Ext.isString(a)){var b=this.getRowsMap();a in b||(b[a]=this.getRows().length,this.getRows().push(Array(this.getHeaders().length)));return b[a]}},getColumnIndex:function(a){var b=
this.getHeaders();if(Ext.isNumber(a))return void 0===b[a]&&(b[a]=a,this.getRows().forEach(function(b){b.splice(a,0,void 0)})),a;if(Ext.isString(a))return a in this.getHeadersMap()||(this.getHeaders().push(a),this.getHeadersMap()[a]=this.getHeaders().length-1,this.getRows().forEach(function(a){a.push(void 0)})),this.getHeadersMap()[a]},getColumnHeader:function(a){a=this.getColumnIndex(a);return this.getHeaders()[a]},getColumnSum:function(a){return Ext.Array.sum(this.getColumnValues(a,!0))},getColumnMean:function(a){return Ext.Array.mean(this.getColumnValues(a,
!0))},getColumnMax:function(a){return Ext.Array.max(this.getColumnValues(a,!0))},getColumnMin:function(a){return Ext.Array.min(this.getColumnValues(a,!0))},getColumnValues:function(a,b){var c=this.getColumnIndex(a),d=[];this.eachRow(function(a){d.push(a[c])});return b?Ext.Array.clean(d):d},reMapRows:function(){var a=this.getRowKey(),b={};this.eachRow(function(c,d){a in c&&(b[a]=d)},!0);this.setRowsMap(b)},sortByColumn:function(a){var b=this.getRows(),c=Ext.Array.from(a).map(function(a){if(Ext.isObject(a))for(key in a)return{index:this.getColumnIndex(key),
direction:-1<a[key].indexOf("asc")?"asc":"desc"};else return{index:this.getColumnIndex(a),direction:"desc"}},this);b.sort(function(a,b){for(var f=0,g=c.length;f<g;f++){var h=c[f].index;if(a[h]!=b[h])return"asc"==c[f].direction?a[h]>b[h]?1:-1:a[h]>b[h]?-1:1}});this.reMapRows();return this},embed:function(a,b){!b&&Ext.isObject(a)&&(b=a,a=this.embeddable[0]);b=b||{};var c=Ext.Array.from(b.headers||this.getHeaders()).map(function(a){return this.getColumnHeader(a)},this),c={rowkey:this.getRowKey(),config:b,
headers:c};if("headers"in b){var d=Ext.Array.from(b.headers).map(function(a){return this.getColumnIndex(a)},this),e=[];this.getRows().forEach(function(a){e.push(d.map(function(b){return a[b]}))});Ext.apply(c,{rows:e})}else Ext.apply(c,{rows:this.getRows()});Ext.apply(b,{tableJson:JSON.stringify(c)});delete b.axes;delete b.series;embed.call(this,a,b)},toTsv:function(a){var b=this.getHeaders().join("\t");this.getRows().forEach(function(c,d){a&&Ext.isNumber(a)&&d>a||(b+="\n"+c.map(function(a){return a.replace(/(\n|\t)/g,
"")}).join("\t"))});return b},getString:function(a){a=a||{};var b="\x3ctable class\x3d'voyant-table' style\x3d'"+(a.width?" width: "+a.width:"")+"' id\x3d'"+(a.id?a.id:Ext.id())+"'\x3e",c=this.getHeaders();if(c.length){for(var b=b+"\x3cthead\x3e\x3ctr\x3e",d=0,e=c.length;d<e;d++)b+="\x3cth\x3e"+c[d]+"\x3c/th\x3e";b+="\x3c/tr\x3e\x3c/thead\x3e"}b+="\x3ctbody\x3e";d=0;for(e=Ext.isNumber(a)?a:this.getRows().length;d<e;d++)(a=this.getRow(d))&&Ext.isArray(a)&&(b+="\x3ctr\x3e",a.forEach(function(a){b+=
"\x3ctd\x3e"+a+"\x3c/td\x3e"}),b+="\x3c/tr\x3e");return b+="\x3c/tbody\x3e\x3c/table\x3e"}});Ext.define("Voyant.data.util.NetworkGraph",{alternateClassName:["NetworkGraph"],mixins:["Voyant.notebook.util.Embed","Voyant.notebook.util.Show"],embeddable:["Voyant.widget.VoyantNetworkGraph"],config:{edges:[],nodes:[]},constructor:function(a,b){a=a||{};this.setEdges(Ext.Array.from(a.edges));this.setNodes(Ext.Array.from(a.nodes));this.callParent([a])},addEdge:function(a){this.getEdges().push(a)},embed:function(a,b){!b&&Ext.isObject(a)&&(b=a,a=this.embeddable[0]);b=b||{};var c={edges:this.getEdges(),
nodes:this.getNodes(),config:b};Ext.apply(b,{jsonData:JSON.stringify(c)});embed.call(this,a,b)},getString:function(a){return this.getEdges().map(function(a){a.source+"-"+a.target}).join("; ")}});Ext.define("Voyant.data.model.Corpus",{alternateClassName:["Corpus"],mixins:["Voyant.notebook.util.Embed","Voyant.notebook.util.Show","Voyant.util.Transferable","Voyant.util.Localization","Voyant.util.Assignable"],transferable:"loadCorpusTerms loadTokens getPlainText getText getWords getString getLemmasArray".split(" "),embeddable:"Voyant.panel.Summary Voyant.panel.Cirrus Voyant.panel.Documents Voyant.panel.CorpusTerms Voyant.panel.Reader Voyant.panel.Trends Voyant.panel.TermsRadio Voyant.panel.DocumentTerms Voyant.panel.TermsBerry Voyant.panel.CollocatesGraph Voyant.panel.Contexts Voyant.panel.WordTree Voyant.panel.Veliza Voyant.panel.ScatterPlot".split(" "),
...
!b.input)return Voyant.application.showError(this.localize("noCorpusOrInput")+": "+b),Ext.defer(function(){c.reject(this.localize("noCorpusOrInput")+": "+b)},50,this),c.promise;Ext.apply(b,{tool:"corpus.CorpusMetadata"});var d=this;Ext.Ajax.request({url:Voyant.application.getTromboneUrl(),params:b}).then(function(a){d.set(Ext.JSON.decode(a.responseText).corpus.metadata);var c="titles-"+d.getId();b.title||b.subTitle?(d.set("title",b.title),d.set("subTitle",b.subTitle),Ext.Ajax.request({url:Voyant.application.getTromboneUrl(),
params:{tool:"resource.StoredResource",storeResource:Ext.encode({title:b.title,subTitle:b.subTitle}),resourceId:c}})):Ext.Ajax.request({url:Voyant.application.getTromboneUrl(),params:{tool:"resource.StoredResource",verifyResourceId:c}}).then(function(a){(a=Ext.util.JSON.decode(a.responseText))&&a.storedResource&&a.storedResource.id&&""!=a.storedResource.id&&Ext.Ajax.request({url:Voyant.application.getTromboneUrl(),params:{tool:"resource.StoredResource",retrieveResourceId:c}}).then(function(a){a=Ext.util.JSON.decode(a.responseText).storedResource.resource;
a=Ext.decode(a);d.set(a)})});return d},function(a){Voyant.application.showResponseError(d.localize("failedCreateCorpus"),a)}).then(function(a){!("docsLimit"in b)||!1!==b.docsLimit&&0<b.docsLimit?d.getDocuments().load({params:{limit:"docsLimit"in b?b.docsLimit:d.getDocumentsCount()},callback:function(b,g,h){h?(d.setDocumentsStore(this),c.resolve(a)):c.reject(g)}}):c.resolve(a)})}else Voyant.application.showError(this.localize("badDataTypeCorpus")+": ("+typeof b+") "+b),Ext.defer(function(){c.reject(this.localize("badDataTypeCorpus")+
...
Ext.apply(a||{},{corpus:this}))},getTokens:function(a){return Ext.create("Voyant.data.store.Tokens",Ext.apply(a||{},{corpus:this}))},each:function(a,b){this.getDocuments().each(function(c,d){a.call(b||c,c)})},getCorpusCollocates:function(a){return Ext.create("Voyant.data.store.CorpusCollocates",Ext.apply(a||{},{corpus:this}))},getDocumentQueryMatches:function(a){return Ext.create("Voyant.data.store.DocumentQueryMatches",Ext.apply(a||{},{corpus:this}))},getDocumentTerms:function(a){return Ext.create("Voyant.data.store.DocumentTerms",
Ext.apply(a||{},{corpus:this}))},getDocumentEntities:function(a){return Ext.create("Voyant.data.store.DocumentEntities",Ext.apply(a||{},{corpus:this}))},getContexts:function(a){return Ext.create("Voyant.data.store.Contexts",Ext.apply(a||{},{corpus:this}))},getDocuments:function(a){return this.getDocumentsStore()?this.getDocumentsStore():Ext.create("Voyant.data.store.Documents",Ext.apply(a||{},{corpus:this}))},getDocument:function(a){if(this.getDocumentsStore()){if(a instanceof Voyant.data.model.Document)return a;
if(Ext.isNumeric(a))return this.getDocumentsStore().getAt(parseInt(a));if(Ext.isString(a))return this.getDocumentsStore().getById(a)}return this.then?Voyant.application.getDeferredNestedPromise(this,arguments):this.getDocumentsStore().getDocument(a)},getDocumentsCount:function(){return this.then?Voyant.application.getDeferredNestedPromise(this,arguments):this.get("documentsCount")},getWordTokensCount:function(){return this.then?Voyant.application.getDeferredNestedPromise(this,arguments):this.get("lexicalTokensCount")},
getWordTypesCount:function(){return this.then?Voyant.application.getDeferredNestedPromise(this,arguments):this.get("lexicalTypesCount")},getCreatedTime:function(){return this.then?Voyant.application.getDeferredNestedPromise(this,arguments):this.get("createdTime")},requiresPassword:function(){var a=this.getNoPasswordAccess();return"NONE"==a||"NONCONSUMPTIVE"==a},getNoPasswordAccess:function(){return this.then?Voyant.application.getDeferredNestedPromise(this,arguments):this.get("noPasswordAccess")},
getTitle:function(){return this.then?Voyant.application.getDeferredNestedPromise(this,arguments):this.get("title")},getSubTitle:function(){return this.then?Voyant.application.getDeferredNestedPromise(this,arguments):this.get("subTitle")},getRelatedWords:function(a){return Ext.create("Voyant.data.store.RelatedTerms",Ext.apply(a||{},{corpus:this}))},loadRelatedWords:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments);var b=Voyant.application.getDeferred(this);
a=a||{};Ext.isNumber(a)&&(a={limit:a});Ext.applyIf(a,{limit:0});this.getRelatedWords().load({params:a,callback:function(a,d,e){e?b.resolve(a):b.reject(d.error.response)}});return b.promise},getText:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments,this);var b=Voyant.application.getDeferred(this);a=a||{};Ext.isNumber(a)?a={limit:a}:Ext.isString(a)&&(a={limit:parseInt(a)});Ext.applyIf(a,{limit:0,outputFormat:"text",template:"docTokens2text"});Ext.apply(a,{tool:"corpus.DocumentTokens",
corpus:this.getAliasOrId()});Ext.Ajax.request({url:Voyant.application.getTromboneUrl(),params:a,success:function(c,d){var e=c.responseText.trim();a.transformCase&&(-1<a.transformCase.indexOf("lower")?e=e.toLowerCase():-1<a.transformCase.indexOf("upper")&&(e=e.toUpperCase()));b.resolve(e)},failure:function(a,d){b.reject(a)},scope:this});return b.promise},getPlainText:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments);a=a||{};Ext.isNumber(a)?a={limit:a}:Ext.isString(a)&&
(a={limit:parseInt(a)});Ext.apply(a,{template:"docTokens2plainText"});return this.getText(a)},getWords:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments);a=a||{};Ext.isNumber(a)?a={limit:a}:Ext.isString(a)&&(a={limit:parseInt(a)});Ext.applyIf(a,{template:"docTokens2words"});return this.getText(a)},getWordsArray:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments);var b=Voyant.application.getDeferred(this);this.getWords(a).then(function(a){b.resolve(a.split(" "))});
return b.promise},getLemmasArray:function(a){a=a||{};if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments);var b=Voyant.application.getDeferred(this);Ext.applyIf(a,{template:"docTokens2lemmas",withPosLemmas:!0,noOthers:!0});this.getWords(a).then(function(a){a=a.split(" ").map(function(a){return a.substring(0,a.indexOf("/"))});b.resolve(a)});return b.promise},getString:function(a){var b=this.getDocumentsCount(),c=this.localize("thisCorpus");if(0==b)c+=" "+this.localize("isEmpty")+
".";else{var c=c+" ",c=1<b?c+(new Ext.XTemplate(this.localize("hasNdocuments"))).apply({count:Ext.util.Format.number(b,"0,000")}):c+this.localize("has1document"),c=c+(" "+(new Ext.XTemplate(this.localize("widthNwordsAndNTypes"))).apply({words:Ext.util.Format.number(this.getWordTokensCount(),"0,000"),types:Ext.util.Format.number(this.getWordTypesCount(),"0,000")})+"."),c=c+(" "+this.localize("created")+" "),d=this.get("createdDate"),e=new Date;!0===Ext.Array.each([["year",Ext.Date.YEAR],["month",Ext.Date.MONTH],
["day",Ext.Date.DAY],["hour",Ext.Date.HOUR],["minute",Ext.Date.MINUTE],["second",Ext.Date.SECOND]],function(a){if(Ext.Date.diff(d,e,a[1])>("second"==a[0]?1:0)){var b=Ext.Date.diff(d,e,a[1]);c+="\x3cspan class\x3d'info-tip' data-qtip\x3d'"+Ext.Date.format(d,"Y-m-d, H:i:s")+"'\x3e";c=1==b?c+(new Ext.XTemplate(this.localize(a[0]+"Ago"))).apply({count:b,date:d}):c+(new Ext.XTemplate(this.localize(a[0]+"sAgo"))).apply({count:b,date:d});c+="\x3c/span\x3e";return!1}},this)&&(c+=this.localize("now"));c+=
".";c+=""}!0===a&&(c+=" ("+this.getId()+")");return c}});Ext.define("Voyant.widget.CodeEditor",{extend:"Ext.panel.Panel",mixins:["Voyant.util.Localization","Voyant.util.Api","Voyant.notebook.util.Embed"],alias:"widget.codeeditor",statics:{i18n:{},api:{tableJson:void 0,content:"",mode:"ace/mode/text",width:void 0}},constructor:function(a){a=a||{};this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);this.buildFromParams();Ext.apply(this,{items:{xtype:"notebookcodeeditor",content:a.content?a.content:this.getApiParam("content"),mode:a.mode?a.mode:
this.getApiParam("mode")}});this.callParent(arguments)},initComponent:function(a){a=a||{};this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);this.callParent(arguments)},buildFromParams:function(){var a=this.getApiParam("tableJson");a&&(a=Ext.decode(a),a=a.headers.join("\t")+"\n"+a.rows.map(function(a){return a.join("\t")}).join("\n"),this.setApiParam("content",a))}});Ext.define("Voyant.widget.CorpusSelector",{extend:"Ext.form.field.ComboBox",mixins:["Voyant.util.Localization","Voyant.util.Api"],alias:"widget.corpusselector",statics:{i18n:{},api:{openMenu:void 0}},initComponent:function(a){debugger;this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);Ext.applyIf(this,{fieldLabel:this.localize("chooseCorpus"),labelWidth:150,labelAlign:"right",name:"corpus",queryMode:"local",store:[["shakespeare","Shakespeare's Plays"],["austen","Austen's Novels"]]});
this.getApiParam("openMenu")?this.replaceStoreItemsFromDefinition(this.getApiParam("openMenu")):Voyant.application&&Voyant.application.getOpenMenu&&Voyant.application.getOpenMenu()&&this.replaceStoreItemsFromDefinition(Voyant.application.getOpenMenu());this.callParent(arguments)},replaceStoreItemsFromDefinition:function(a){var b=[];a=a.split(";");debugger;for(var c=0;c<a.length;c++){var d=a[c].split(":");d[0]&&b.push([d[0],d[1]?d[1]:d[0]])}this.setStore(b)}});Ext.define("Voyant.widget.ListEditor",{extend:"Ext.container.Container",mixins:["Voyant.util.Localization"],alias:"widget.listeditor",layout:"hbox",statics:{i18n:{}},initComponent:function(a){var b=this.up("window").panel.getApiParam(this.name),c=b?[{name:b,value:b}]:[];c.splice(0,0,{name:this.localize("none"),value:""},{name:this.localize("new"),value:"new"});Ext.apply(this,{items:[{xtype:"combo",queryMode:"local",value:b,triggerAction:"all",editable:!0,fieldLabel:this.localize(this.name+"Label"),
...
0,c.gotoCurrent()));null===c.currentIndex&&c.getSelectionModel().deselectAll();a.focus()},privates:{gotoCurrent:function(){var a=this.matches[this.currentIndex];this.getNavigationModel().setPosition(a.record,a.column);this.getSelectionModel().select(a.record)}}});Ext.define("Voyant.widget.VoyantTableTransform",{extend:"Ext.panel.Panel",mixins:["Voyant.util.Localization","Voyant.util.Api","Voyant.notebook.util.Embed"],alias:"widget.voyanttabletransform",statics:{i18n:{},api:{tableHtml:void 0,tableJson:void 0,width:void 0,api:void 0}},html:"",config:{hiddenColumns:void 0},constructor:function(a){a=a||{};this.callParent(arguments)},initComponent:function(a){a=a||{};this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);this.config.api&&this.config.api.tableJson&&
this.setApiParam("tableJson",this.config.api.tableJson);this.buildFromParams();this.on("afterrender",function(){var a=this.getTargetEl().down("table");if(a){var c=a.parent(),d=new Ext.ux.grid.TransformGrid(a,{width:this.getApiParam("width")||c.getWidth(),height:this.getApiParam("height")||20+24*a.query("tr").length});d.render(c);if(this.getHiddenColumns()){var e={};Ext.Array.from(this.getHiddenColumns()).forEach(function(a){e[a]=!0});d.getColumns().forEach(function(a){a.text in e&&a.hide()});Ext.defer(function(){d.setWidth(d.getEl().dom.parentNode.offsetWidth)},
10)}}},this);this.callParent(arguments)},buildFromParams:function(){var a=this.getApiParam("tableHtml"),b=this.getApiParam("tableJson");if(a)this.setHtml(a);else if(b){var c="\x3ctable\x3e\x3cthead\x3e\x3ctr\x3e",a=JSON.parse(b);a.headers?a.headers.forEach(function(a){c+="\x3cth\x3e"+a+"\x3c/th\x3e"}):a.rows[0].forEach(function(a,b){c+="\x3cth\x3e"+(b+1)+"\x3c/th\x3e"});c+="\x3c/tr\x3e\x3c/thead\x3e\x3ctbody\x3e";a.rows.forEach(function(a){c+="\x3ctr\x3e";a.forEach(function(a){c+="\x3ctd\x3e"+a+"\x3c/td\x3e"});
...
b.removeAt(b.findExact("category",a));this.app.removeCategory(a)},addFeature:function(a){this.app.addFeature(a);this.buildFeatures()},buildFeatures:function(){this.queryById("features").getStore().removeAll();var a=["category"],b=[{sortable:!1,text:this.localize("category"),dataIndex:"category",flex:1}],c=[],d;for(d in this.app.getCategories())c.push({category:d});var e=this.app.getFeatures(),f=Ext.ClassManager.getClass(this).features,g;for(g in e){a.push(g);var e=f[g],h=Ext.applyIf({feature:g,listeners:{change:function(a,
b){if(a.rendered){var c=a.up("gridview").indexOf(a.el.up("table")),d=a.up("grid").getStore().getAt(c);d?(c=d.get("category"),this.app.setCategoryFeature(c,a.feature,b)):window.console&&console.warn("no record for",c,a)}},scope:this}},e);e.listeners&&Ext.applyIf(h.listeners,e.listeners);b.push({sortable:!1,hideable:!1,text:this.localize(g),dataIndex:g,flex:.5,xtype:"widgetcolumn",widget:h});for(d in this.app.getCategories())for(e=this.app.getCategoryFeature(d,g),h=0;h<c.length;h++)if(c[h].category==
d){c[h][g]=e;break}}a=Ext.create("Ext.data.JsonStore",{fields:a,data:c});this.queryById("features").reconfigure(a,b)},buildCategories:function(){this.queryById("categories").removeAll();var a=this.app.getCategories(),b;for(b in a)this.addCategory(b)},loadData:function(a){var b=new Ext.Deferred;Ext.Ajax.request({url:this.panel.getTromboneUrl(),params:{tool:"resource.StoredResource",retrieveResourceId:a,failQuietly:!0}}).then(function(a){a=Ext.decode(a.responseText).storedResource.resource;0==a.length?
b.reject():(a=Ext.decode(a),b.resolve(a))},function(){b.reject()},null,this);return b.promise},saveData:function(a){var b=new Ext.Deferred;a=Ext.encode(a);Ext.Ajax.request({url:this.panel.getTromboneUrl(),params:{tool:"resource.StoredResource",storeResource:a}}).then(function(a){a=Ext.util.JSON.decode(a.responseText).storedResource.id;b.resolve(a)},function(a){b.reject()});return b.promise},setColorTermAssociations:function(){for(var a in this.app.getCategories()){var b=this.app.getCategoryFeature(a,
"color");if(void 0!==b)for(var b=this.app.hexToRgb(b),c=this.app.getCategoryTerms(a),d=0;d<c.length;d++)this.app.colorTermAssociations.replace(c[d],b)}}});Ext.define("Voyant.widget.VoyantNetworkGraph",{extend:"Ext.panel.Panel",mixins:["Voyant.util.Localization","Voyant.util.Api","Voyant.notebook.util.Embed"],embeddable:["Voyant.widget.VoyantNetworkGraph"],alias:"widget.voyantnetworkgraph",statics:{i18n:{},api:{jsonData:void 0,docId:void 0,docIndex:void 0,json:void 0,api:void 0}},config:{vis:void 0,visLayout:void 0,nodeData:void 0,edgeData:void 0,nodeSelection:void 0,edgeSelection:void 0,currentNode:void 0,currentEdge:void 0,scaleExtent:[.25,8],fixOnDrag:!0,
graphStyle:{node:{normal:{fill:"#c6dbef",fillOpacity:1,stroke:"#6baed6",strokeOpacity:1,strokeWidth:1},highlight:{fill:"#9ecae1",fillOpacity:1,stroke:"#3182bd",strokeOpacity:1,strokeWidth:3}},edge:{normal:{stroke:"#000000",strokeOpacity:.25,strokeWidth:1},highlight:{stroke:"#000000",strokeOpacity:.5,strokeWidth:3}}},graphPhysics:{damping:.4,gravity:-1,springLength:10,springStrength:.5}},constructor:function(a){a=a||{};this.setNodeData([]);this.setEdgeData([]);this.mixins["Voyant.util.Api"].constructor.apply(this,
arguments);this.callParent(arguments);var b={};this.getApiParam("jsonData")?b=Ext.decode(this.getApiParam("jsonData")):this.getApiParam("json")?b=this.getApiParam("json"):a.json?b=a.json:a.edges?(b.edges=a.edges,a.nodes&&(b.nodes=a.nodes)):a&&a.jsonData&&(b=JSON.parse(a.jsonData));this.loadJson(b)},initComponent:function(a){this.on("boxready",function(a,c){this.initGraph();this.refreshGraph()},this);this.on("resize",function(a,c,d){if(a=this.body.down("svg"))d=this.body,c=d.getHeight(),d=d.getWidth(),
a.dom.setAttribute("width",d),a.dom.setAttribute("height",c),this.getVisLayout().force("center",d3.forceCenter(d/2,c/2)).alpha(.3).restart()},this);this.callParent(arguments)},processJson:function(a){a&&a.edges||(a&&a.links&&(a.edges=a.links,delete a.links),a&&a.edges||(a=a||{},a.edges=[]));a.nodes||(a.nodes=[]);if(0===a.nodes.length){var b={};a.edges.forEach(function(c){["source","target"].forEach(function(d){d=c[d];0==d in b?(b[d]=1,a.nodes.push({term:d})):b[d]++;c.value=1})},this);a.nodes.forEach(function(a){Ext.applyIf(a,
{value:b[a.term]})})}return a},loadJson:function(a){this.processJson(a);var b={};this.getNodeData().forEach(function(a){b[a.term]=!0},this);var c=[],d=[];a.nodes.forEach(function(a){void 0===b[a.term]&&(a.id=this.idGet(a.term),c.push(a))},this);a.edges.forEach(function(a){for(var b=this.idGet(a.source),c=this.idGet(a.target),h=this.getEdgeData(),k=!1,l=0;l<h.length;l++){var m=h[l];if(m.source.id==b&&m.target.id==c||m.target.id==b&&m.source.id==c){k=!0;break}}k||(a.source=b,a.target=c,a.id=b+"-"+c,
d.push(a))},this);this.setNodeData(this.getNodeData().concat(c));this.setEdgeData(this.getEdgeData().concat(d));this.refreshGraph()},idGet:function(a){return a.replace(/\W/g,"_")},updateDataForNode:function(a,b){for(var c=this.getNodeData(),d=0;d<c.length;d++)if(c[d].id===a){Ext.apply(c[d],b);break}},updateDataForEdge:function(a,b){for(var c=this.getEdgeData(),d=0;d<c.length;d++)if(c[d].id===a){Ext.apply(c[d],b);break}},addNode:function(a){Ext.isString(a)&&(a={term:a});a.term&&this.loadJson({nodes:[a]})},
removeNode:function(a,b){for(var c=this.getNodeData(),d=0;d<c.length;d++)if(c[d].id===a){c.splice(d,1);break}for(var e={},c=this.getEdgeData(),d=c.length-1;0<=d;d--){var f=!1;c[d].source.id===a&&(f=!0,e[c[d].target.id]=!0);c[d].target.id===a&&(f=!0,e[c[d].source.id]=!0);f&&c.splice(d,1)}if(b){for(d=0;d<c.length;d++)e[c[d].source.id]&&delete e[c[d].source.id],e[c[d].target.id]&&delete e[c[d].target.id];for(var g in e)this.removeNode(g,!0)}this.refreshGraph()},addEdge:function(a){Ext.isObject(a)&&a.source&&
a.target&&this.loadJson({edges:[a]})},removeEdge:function(a,b){for(var c=this.getEdgeData(),d=c.length-1;0<=d;d--)c[d].id===a&&c.splice(d,1);if(b){for(var e={},c=this.getNodeData(),d=0;d<c.length;d++)e[c[d].id]=!0;c=this.getEdgeData();for(d=0;d<c.length;d++)e[c[d].source.id]&&delete e[c[d].source.id],e[c[d].target.id]&&delete e[c[d].target.id];for(var f in e)this.removeNode(f,!0)}this.refreshGraph()},initGraph:function(){var a=this.getLayout().getRenderTarget();a.update("");var b=a.getWidth(),c=a.getHeight(),
d=this.getGraphPhysics();this.setVisLayout(d3.forceSimulation().velocityDecay(d.damping).force("center",d3.forceCenter(b/2,c/2)).force("link",d3.forceLink().id(function(a){return a.id}).distance(d.springLength).strength(d.springStrength)).force("charge",d3.forceManyBody().strength(d.gravity)).force("collide",d3.forceCollide().radius(function(a){return 2*Math.sqrt(a.bbox.width*a.bbox.height)})).on("tick",function(){this.getEdgeSelection().attr("x1",function(a){return a.source.x}).attr("y1",function(a){return a.source.y}).attr("x2",
function(a){return a.target.x}).attr("y2",function(a){return a.target.y});this.getNodeSelection().attr("transform",function(a){return"translate("+(a.x-.5*a.bbox.width)+","+(a.y-.5*a.bbox.height)+")"})}.bind(this)));var a=d3.select(a.dom).append("svg").attr("width",b).attr("height",c),e=a.append("g");a.call(d3.zoom().scaleExtent(this.getScaleExtent()).on("zoom",function(){e.attr("transform",d3.event.transform)}));this.setEdgeSelection(e.append("g").attr("class","edges").selectAll(".edge"));this.setNodeSelection(e.append("g").attr("class",
"nodes").selectAll(".node"));this.setVis(e)},resetGraph:function(){this.setNodeData([]);this.setEdgeData([]);this.refreshGraph()},refreshGraph:function(){if(void 0!==this.getVisLayout()){var a=this.getEdgeData(),b=this.getNodeData(),c=this.getEdgeSelection().data(a,function(a){return a.id});c.exit().remove();var d=c.enter().append("line").attr("class","edge").attr("id",function(a){return a.id}).style("cursor","pointer").on("mouseover",this.edgeMouseOver.bind(this)).on("mouseout",this.edgeMouseOut.bind(this)).on("click",
function(a){d3.event.stopImmediatePropagation();d3.event.preventDefault();this.setCurrentEdge(a);this.fireEvent("edgeclicked",this,a)}.bind(this));this.setEdgeSelection(d.merge(c));c=this.getNodeSelection().data(b,function(a){return a.id});c.exit().remove();d=c.enter().append("g").attr("class","node").attr("id",function(a){return a.id}).style("cursor","pointer").on("mouseover",this.nodeMouseOver.bind(this)).on("mouseout",this.nodeMouseOut.bind(this)).on("click",function(a){d3.event.stopImmediatePropagation();
d3.event.preventDefault();this.setCurrentNode(a);this.fireEvent("nodeclicked",this,a)}.bind(this)).on("dblclick",function(a){d3.event.stopImmediatePropagation();d3.event.preventDefault();this.fireEvent("nodedblclicked",this,a)}.bind(this)).call(d3.drag().on("start",function(a){d3.event.active||this.getVisLayout().alphaTarget(.3).restart();this.getFixOnDrag()&&(a.fx=a.x,a.fy=a.y);this.fireEvent("dragstart",this,a)}.bind(this)).on("drag",function(a){this.getFixOnDrag()?(a.fx=d3.event.x,a.fy=d3.event.y):
(a.x=d3.event.x,a.y=d3.event.y);this.fireEvent("drag",this,a)}.bind(this)).on("end",function(a){d3.event.active||this.getVisLayout().alphaTarget(0);this.fireEvent("dragend",this,a)}.bind(this)));d.append("rect");var e=b.map(function(a){var b=a.value;void 0==a.value&&(a.value=b=1);return b});e.sort();var f=d3.scaleLog().domain([e[0],e[e.length-1]]).range([8,36]);d.append("text").text(function(a){return a.term}).attr("font-size",function(a){return f(a.value)+"px"}).attr("alignment-baseline","middle").style("user-select",
"none").each(function(a){a.bbox=this.getBBox()});this.setNodeSelection(d.merge(c));this.getNodeSelection().selectAll("rect").attr("width",function(a){return a.bbox.width+16}).attr("height",function(a){return a.bbox.height+8}).attr("rx",function(a){return Math.max(2,.2*a.bbox.height)}).attr("ry",function(a){return Math.max(2,.2*a.bbox.height)});this.getNodeSelection().selectAll("text").attr("dx",8).attr("dy",function(a){return.5*a.bbox.height+4});this.getEdgeSelection().call(this.applyEdgeStyle.bind(this));
this.getNodeSelection().call(this.applyNodeStyle.bind(this));this.getVisLayout().nodes(b);this.getVisLayout().force("link").links(a);this.getVisLayout().alpha(1).restart()}},applyNodeStyle:function(a,b){var c=void 0===b?"normal":b,d=this.getGraphStyle().node[c];a.selectAll(":not(text)").style("fill",function(a){return d.fill}.bind(this)).style("fill-opacity",function(a){return d.fillOpacity}.bind(this)).style("stroke",function(a){return d.stroke}.bind(this)).style("stroke-opacity",function(a){return d.strokeOpacity}.bind(this)).style("stroke-width",
function(a){return d.strokeWidth}.bind(this))},applyEdgeStyle:function(a,b){var c=void 0===b?"normal":b,d=this.getGraphStyle().edge[c];a.style("stroke",function(a){return d.stroke}.bind(this)).style("stroke-opacity",function(a){return d.strokeOpacity}.bind(this)).style("stroke-width",function(a){return d.strokeWidth}.bind(this))},edgeMouseOver:function(a){this.getEdgeSelection().call(this.applyEdgeStyle.bind(this));this.getVis().select("#"+a.id).call(this.applyEdgeStyle.bind(this),"highlight")},edgeMouseOut:function(a){this.getEdgeSelection().call(this.applyEdgeStyle.bind(this))},
...
arguments);this.mixins["Voyant.util.Toolable"].constructor.apply(this,arguments);this.glyph||(this.glyph=Ext.ClassManager.getClass(this).glyph);this.on("afterrender",function(){this.getApiParam("subtitle")&&this.getTitle()&&this.setTitle(this.getTitle()+" \x3ci style\x3d'font-size: smaller;'\x3e"+this.getApiParam("subtitle")+"\x3c/i\x3e");this.isXType("grid")&&(this.getSelectionModel().on("selectionchange",function(a,c){},this),this.getStore().on("beforeload",function(){this.selectedRecordsToRemember=
...
this,a)}});Ext.define("Voyant.panel.Catalogue",{extend:"Ext.panel.Panel",requires:["Voyant.widget.Facet"],mixins:["Voyant.panel.Panel","Voyant.util.Downloadable"],alias:"widget.catalogue",statics:{i18n:{},api:{config:void 0,stopList:"auto",facet:["facet.title","facet.author","facet.language"]},glyph:"xf1ea@FontAwesome"},config:{facets:{},matchingDocIds:[],customResultsHtml:void 0},constructor:function(a){a=a||{};Ext.apply(this,{title:this.localize("title"),layout:"hbox",items:[{layout:"vbox",height:"100%",align:"stretch",
...
this.queryById("sendToVoyant").setDisabled(!0);this.queryById("export").setDisabled(!0);if(a&&0<a.length){this.mask(this.localize("loading"));var d=this.getCorpus().getDocumentQueryMatches();d.load({params:{query:a,includeDocIds:!0},callback:function(a,f,g){this.unmask();if(a&&0<a.length){this.queryById("status").setHtml(a.length);var h="\x3cul\x3e",k=[];a.forEach(function(a){a.getDocIds().forEach(function(a){k.push(a);var e=d.getCorpus().getDocument(a);a="\x3cli id\x3d'"+c.getId()+"_"+a+"' class\x3d'cataloguedoc'\x3e";
a+="\x3ci\x3e"+e.getTitle()+"\x3c/i\x3e";for(facet in b)if(0!=b[facet].length){var f="";if("facet.title"!=facet){var g=facet.replace(/^.+?\./,""),l=e.get(g);if(l){var s=Ext.isArray(l);s?f+="\x3cli\x3e"+g+"\x3cul\x3e":l=[l];l.forEach(function(a){var c=!1;b[facet].forEach(function(b){b.label==a?c=!0:-1==b.facet.indexOf("facet")&&b.label.split(/\W+/).forEach(function(b){0<b.trim().length&&-1<a.toLowerCase().indexOf(b.toLowerCase())&&(c=!0)})});f+="\x3cli\x3e"+(s?"":g.replace("extra.","")+": ")+(c?'\x3cspan class\x3d"keyword"\x3e'+
a+"\x3c/span\x3e":a)+"\x3c/li\x3e"});s&&(f+="\x3c/ul\x3e\x3c/li\x3e")}}f&&(a+="\x3cul\x3e"+f+"\x3c/ul\x3e")}h+=a+"\x3c/li\x3e"})});h+="\x3c/ul\x3e";c.update(h);this.queryById("status").update((new Ext.XTemplate(this.localize("queryMatches"))).apply([k.length,this.getCorpus().getDocumentsCount()]));this.setMatchingDocIds(Ext.Array.clone(k));0<k.length&&(this.queryById("export").setDisabled(!1),this.queryById("sendToVoyant").setDisabled(!1));b.lexical&&(a=k.splice(0,5),this.loadSnippets(a,c.first().first()),
k&&0<k.length&&this.loadSnippets(k))}},scope:this})}},loadSnippets:function(a,b){var c=this.queryById("results").getTargetEl(),d=this.getFacets();if(d.lexical){var d=d.lexical.map(function(a){return a.facet+":"+a.label}),e=this.getCorpus().getContexts({buffered:!1});b&&b.mask(this.localize("loadingSnippets"));e.load({method:"POST",params:{stripTags:"all",query:d,docId:a,perDocLimit:3,limit:100,accurateTotalNotNeeded:!0},scope:this,callback:function(a,d,e){b&&b.unmask();if(e&&Ext.isArray(a)&&0<a.length){var k=
{};a.forEach(function(a){k[a.getDocIndex()]||(k[a.getDocIndex()]=[]);k[a.getDocIndex()].push(a)});for(docIndex in k)d=this.getCorpus().getDocument(docIndex).getId(),a='\x3cli style\x3d"list-style-type: none; font-size: smaller;"\x3e'+k[docIndex].map(function(a){return a.getHighlightedContext()}).join(" \u2026 ")+"\x3c/li\x3e",d=c.down("#"+c.getId()+"_"+d),d.query("ul")&&(a="\x3cul\x3e"+a+"\x3c/ul\x3e"),d.insertHtml("beforeEnd",a)}}})}},selectFacet:function(a){if(!this.facetsSelectionStore){var b=
{};this.getCorpus().getDocuments().each(function(a){for(var c in a.getData())"corpus"!=c&&0!==c.indexOf("parent")&&"-1"==c.indexOf("-lexical")&&(b[c]=!0)});b=Object.keys(b);b.sort();this.facetsSelectionStore=Ext.create("Ext.data.ArrayStore",{fields:["text"],data:b.map(function(a){return[a]})})}var c={};this.queryById("facets").items.each(function(a){c[a.facet]=!0});this.facetsSelectionStore.filterBy(function(a){return!("facet."+a.get("text")in c)});Ext.create("Ext.window.Window",{title:this.localize("selectFacet"),
modal:!0,items:{xtype:"form",width:300,items:{xtype:"combo",store:this.facetsSelectionStore,forceSelection:!0,width:300},buttons:[{text:this.localize("cancel"),ui:"default-toolbar",glyph:"xf00d@FontAwesome",flex:1,handler:function(a){a.up("window").close()}},{text:this.localize("select"),glyph:"xf00c@FontAwesome",flex:1,handler:function(b){var c=b.up("window").down("combo").getValue();if(c)a.call(this,"facet."+c),b.up("window").close();else return this.showError(this.localize("selectValidFacet"))},
scope:this}]},bodyPadding:5}).show()}});Ext.define("Voyant.panel.Cirrus",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.cirrus",statics:{i18n:{},api:{stopList:"auto",categories:void 0,whiteList:void 0,limit:500,visible:50,terms:void 0,docId:void 0,docIndex:void 0,inlineData:void 0,fontFamily:'"Palatino Linotype", "Book Antiqua", Palatino, serif',cirrusForceFlash:!1,background:"0xffffff",fade:!0,smoothness:2,diagonals:"none"},glyph:"xf06e@FontAwesome"},config:{mode:void 0,options:[{xtype:"stoplistoption"},{xtype:"listeditor",
...
changecomplete:function(a,c){this.setApiParams({visible:c});this.loadFromTermsRecords()},scope:this}}]}]});this.callParent(arguments)},listeners:{afterrender:function(){var a=this.getApiParam("inlineData");if(void 0!==a&&(a=Ext.decode(a,!0),null!==a)){this.setApiParam("inlineData",a);var b;(new Corpus).then(function(a){b=a;a=this.getApplication();a.dispatchEvent("loadedCorpus",a,b)},null,null,this)}},resize:function(a,b,c){this.getVisLayout()&&this.getCorpus()&&(this.setAdjustedSizes(),a=this.getLayout().getRenderTarget(),
b=a.getWidth(),c=a.getHeight(),a.down("svg").set({width:b,height:c}),this.getTerms()&&this.getVisLayout().size([b,c]).stop().words(this.getTerms()).start())},loadedCorpus:function(a,b){this.initVisLayout();this.loadFromCorpus(b)},corpusSelected:function(a,b){this.loadFromCorpus(b)},documentSelected:function(a,b){if(b){var c=this.getCorpus();b=c.getDocument(b);this.setApiParam("docId",b.getId());c=b.getDocumentTerms({autoload:!1,corpus:c,pageSize:this.getApiParam("maxVisible"),parentPanel:this});this.loadFromDocumentTerms(c)}},
ensureCorpusView:function(a,b){this.getMode()!=this.MODE_CORPUS&&this.loadFromCorpus(b)},boxready:function(){this.initVisLayout()}},loadFromCorpus:function(a){var b=this.getApiParam("inlineData");if(void 0===b)this.setApiParams({docId:void 0,docIndex:void 0}),this.loadFromCorpusTerms(a.getCorpusTerms({autoload:!1,pageSize:this.getApiParam("maxVisible"),parentPanel:this}));else if(void 0!==b){a=[];for(var c=0;c<b.length;c++){var d=Ext.create("Voyant.data.model.CorpusTerm",b[c]);a.push(d)}this.setRecords(a);
this.setMode(this.MODE_CORPUS);this.loadFromTermsRecords()}},loadFromDocumentTerms:function(a){a.load({callback:function(a,c,d){this.setMode(this.MODE_DOCUMENT);this.setRecords(c.getRecords());this.loadFromTermsRecords()},scope:this,params:this.getApiParams()})},loadFromCorpusTerms:function(a){a.load({callback:function(a,c,d){this.setMode(this.MODE_CORPUS);this.setRecords(c.getRecords());this.loadFromTermsRecords()},scope:this,params:this.getApiParams()})},loadFromTermsRecords:function(){var a=this.getRecords(),
...
var d=this.getVisLayout().size()[0],e=this.getVisLayout().size()[1],f=b?Math.min(d/Math.abs(b[1].x-d/2),d/Math.abs(b[0].x-d/2),e/Math.abs(b[1].y-e/2),e/Math.abs(b[0].y-e/2))/2:1,g=d3.transition().duration(1E3),h=this.getVis().selectAll("text").data(a,function(a){return a.text});h.exit().transition(g).style("font-size","1px").remove();var k=h.enter().append("text").text(function(a){return a.text}).attr("text-anchor","middle").attr("data-freq",function(a){return a.rawFreq}).attr("transform",function(a){return"translate("+
[a.x,a.y]+")rotate("+a.rotate+")"}).style("font-family",function(a){return c.getApplication().getFeatureForTerm("font",a.text)}).style("fill",function(a){return c.getApplication().getColorForTerm(a.text,!0)}).style("font-size","1px").on("click",function(a){c.dispatchEvent("termsClicked",c,[a.text])}).on("mouseover",function(a){this.getTip().show()}.bind(this)).on("mousemove",function(a){var b=this.getTip();b.update(a.text+": "+a.rawFreq);a=Ext.get(this.getCirrusId()).dom;a=d3.mouse(a);a[1]+=30;b.setPosition(a)}.bind(this)).on("mouseout",
function(a){this.getTip().hide()}.bind(this));h.merge(k).transition(g).style("font-family",function(a){return c.getApplication().getFeatureForTerm("font",a.text)}).style("fill",function(a){return c.getApplication().getColorForTerm(a.text,!0)}).attr("transform",function(a){return"translate("+[a.x,a.y]+")rotate("+a.rotate+")"}).style("font-size",function(a){return a.fontSize+"px"});this.getVis().transition(g).attr("transform","translate("+d/2+","+e/2+")scale("+f+")")},map:function(a,b,c,d,e){return d+
(a-b)/(c-b)*(e-d)},calculateSizeAdjustment:function(){var a=this.getTerms();if(void 0!==a){var b=this.getLayout().getRenderTarget(),b=b.getWidth()*b.getHeight();1E5>b?this.setMinFontSize(8):this.setMinFontSize(12);for(var c=0,d=0;d<a.length;d++)var e=this.calculateWordArea(a[d]),c=c+e;this.setSizeAdjustment(b/c)}},calculateWordArea:function(a){for(var b=Math.log(10*a.relativeSize)*Math.LOG10E,c=(b+a.relativeSize)/2,d=0,e=0;e<a.text.length;e++)var f=a.text.charAt(e),d="f"==f||"i"==f||"j"==f||"l"==
f||"r"==f||"t"==f?d+b/3:"m"==f||"w"==f?d+b/(4/3):d+b/1.9;return c*d},setAdjustedSizes:function(){this.calculateSizeAdjustment();var a=this.getTerms();if(void 0!==a)for(var b=0;b<a.length;b++){var c=a[b],d=this.findNewRelativeSize(c);c.fontSize=d>this.getMinFontSize()?d:this.getMinFontSize()}},setRelativeSizes:function(){var a=this.getTerms();if(void 0!==a)for(var b=0;b<a.length;b++){var c=a[b];c.relativeSize=this.map(c.rawFreq,this.getSmallestWordSize(),this.getLargestWordSize(),.1,1)}},findNewRelativeSize:function(a){var b=
this.getSizeAdjustment(),b=this.calculateWordArea(a)*b;return(Math.sqrt(6)*Math.sqrt(6*Math.pow(a.text.length,2)+b*a.text.length)-6*a.text.length)/(2*a.text.length)}});Ext.define("Voyant.panel.CollocatesGraph",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.collocatesgraph",statics:{i18n:{},api:{query:void 0,mode:void 0,limit:5,stopList:"auto",terms:void 0,context:5,centralize:void 0,categories:void 0},glyph:"xf1e0@FontAwesome"},config:{options:[{xtype:"stoplistoption"},{xtype:"categoriesoption"}],nodeData:void 0,linkData:void 0,visId:void 0,vis:void 0,visLayout:void 0,nodes:void 0,links:void 0,contextMenu:void 0,currentNode:void 0,networkMode:void 0,
graphStyle:{keywordNode:{normal:{fill:"#c6dbef",stroke:"#6baed6"},highlight:{fill:"#9ecae1",stroke:"#3182bd"}},contextNode:{normal:{fill:"#fdd0a2",stroke:"#fdae6b"},highlight:{fill:"#fd9a53",stroke:"#e6550d"}},link:{normal:{stroke:"#000000",strokeOpacity:.1},highlight:{stroke:"#000000",strokeOpacity:.5}}}},DEFAULT_MODE:0,CENTRALIZED_MODE:1,constructor:function(a){this.setNodeData([]);this.setLinkData([]);this.setVisId(Ext.id(null,"links_"));this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,
arguments)},initComponent:function(){Ext.apply(this,{title:this.localize("title"),dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"querysearchfield"},{text:this.localize("clearTerms"),glyph:"xf014@FontAwesome",handler:function(){this.setNodeData([]);this.setLinkData([]);this.setNetworkMode(this.DEFAULT_MODE);this.refresh()},scope:this},this.localize("context"),{xtype:"slider",itemId:"contextSlider",minValue:3,value:5,maxValue:30,increment:2,width:50,listeners:{render:function(a){a.setValue(this.getApiParam("context"))},
changecomplete:function(a,b){this.setApiParam("context",a.getValue());if(this.getNetworkMode()===this.DEFAULT_MODE){var c=this.getNodeData().map(function(a){return a.term});0<c.length&&(this.setNodeData([]),this.setLinkData([]),this.refresh(),this.loadFromQuery(c))}},scope:this}}]}]});this.setContextMenu(Ext.create("Ext.menu.Menu",{renderTo:Ext.getBody(),items:[{xtype:"box",itemId:"label",margin:"5px 0px 5px 5px",html:""},{xtype:"menuseparator"},{xtype:"menucheckitem",text:"Fixed",itemId:"fixed",
listeners:{checkchange:function(a,b,c){a=this.getCurrentNode();void 0!==a&&(c={fixed:b},b?(c.fx=a.x,c.fy=a.y):(c.fx=null,c.fy=null),this.updateDataForNode(a.id,c))},scope:this}},{xtype:"button",text:"Fetch Collocates",style:"margin: 5px;",handler:function(a,b){var c=this.getCurrentNode();void 0!==c&&(this.getNetworkMode()===this.CENTRALIZED_MODE&&(this.resetGraph(),this.setNetworkMode(this.DEFAULT_MODE),c.start=0,c.limit=this.getApiParam("limit")),this.fetchCollocatesForNode(c))},scope:this},{xtype:"button",
text:"Centralize",style:"margin: 5px;",handler:function(a,b){var c=this.getCurrentNode();void 0!==c&&this.doCentralize(c.term);this.getContextMenu().hide()},scope:this},{xtype:"button",text:"Remove",style:"margin: 5px;",handler:function(a,b){var c=this.getCurrentNode();void 0!==c&&this.removeNode(c.id);a.up("menu").hide()},scope:this}]}));this.on("loadedCorpus",function(a,b){this.isVisible()&&this.initLoad()},this);this.on("activate",function(){this.getCorpus()&&Ext.Function.defer(this.initLoad,100,
this)},this);this.on("query",function(a,b){this.loadFromQuery(b)},this);this.on("resize",function(a,b,c){if(a=Ext.get(this.getVisId()))c=this.body,b=c.getHeight(),c=c.getWidth(),a.el.dom.setAttribute("width",c),a.el.dom.setAttribute("height",b),this.getVisLayout().force("center",d3.forceCenter(c/2,b/2)).alpha(1).restart()},this);this.callParent(arguments)},initLoad:function(){this.initGraph();this.setNetworkMode(this.DEFAULT_MODE);if(this.getApiParam("centralize")){this.setNetworkMode(this.CENTRALIZED_MODE);
var a=this.getApiParam("centralize");this.doCentralize(a)}else{var a=3,b=this.getApiParam("query");void 0!==b&&(a=b.split(",").length);this.getCorpus().getCorpusTerms({autoLoad:!1}).load({params:{limit:a,query:b,stopList:this.getApiParam("stopList")},callback:function(a,b,e){e&&this.loadFromCorpusTermRecords(a)},scope:this})}},loadFromQuery:function(a){this.setApiParams({mode:"corpus"});var b=this.getApiParams();(Ext.isString(a)?[a]:a).forEach(function(a){this.getCorpus().getCorpusCollocates({autoLoad:!1}).load({params:Ext.apply(Ext.clone(b),
{query:a}),callback:function(a,b,c){c&&this.loadFromCorpusCollocateRecords(a)},scope:this})},this)},loadFromCorpusTermRecords:function(a){if(Ext.isArray(a)&&0<a.length){var b=[];a.forEach(function(a){b.push(a.getTerm())});this.loadFromQuery(b)}},loadFromCorpusCollocateRecords:function(a,b){if(Ext.isArray(a)){var c=this.getApiParam("limit"),d={};this.getNodeData().forEach(function(a){d[a.id]=!0},this);var e=[],f=[];a.forEach(function(a,h){var k=a.getTerm(),l=a.getContextTerm(),m=a.getKeywordRawFreq(),
n=a.getContextTermRawFreq(),q=m,r=n;this.getNetworkMode()===this.CENTRALIZED_MODE&&(q=0,r=Math.log(n));var p=void 0,p=void 0;0==h&&(void 0===b&&(b=this.idGet(k)),void 0!==d[b]?this.updateDataForNode(b,{title:k+" ("+m+")",type:"keyword",value:q}):(d[b]=!0,p={id:b,term:k,title:k+" ("+m+")",type:"keyword",value:q,start:c,fixed:!1},e.push(p)));if(k!=l){k=this.idGet(l);void 0===d[k]&&(d[k]=!0,p={id:k,term:l,title:l+" ("+n+")",type:"context",value:r,start:0,fixed:!1},e.push(p));l=null;n=this.getLinkData();
for(r=0;r<n.length;r++)if(m=n[r],m.source.id==b&&m.target.id==k||m.source.id==k&&m.target.id==b){l=m;break}n=a.getContextTermRawFreq();null===l&&f.push({source:b,target:k,value:n,id:b+"-"+k})}},this);this.setNodeData(this.getNodeData().concat(e));this.setLinkData(this.getLinkData().concat(f));this.refresh()}},idGet:function(a){return a.replace(/\W/g,"_")},updateDataForNode:function(a,b){for(var c=this.getNodeData(),d=0;d<c.length;d++)if(c[d].id===a){Ext.apply(c[d],b);break}},removeNode:function(a,
...
b)},updateNetworkMode:function(a){this.getVisLayout()&&(a===this.DEFAULT_MODE?this.getVisLayout().force("link",d3.forceLink().id(function(a){return a.id}).distance(30).strength(1)).force("charge",d3.forceManyBody().strength(-100)).force("collide",d3.forceCollide(function(a){return 2*Math.sqrt(a.bbox.width*a.bbox.height)})):this.getVisLayout().force("link",d3.forceLink().id(function(a){return a.id}).distance(200)).force("charge",d3.forceManyBody().strength(function(a){return"keyword"===a.type?-1E4:
0})).force("collide",d3.forceCollide(function(a){return"keyword"===a.type?a.value:Math.sqrt(a.bbox.width*a.bbox.height)})))},initGraph:function(){var a=this.getLayout().getRenderTarget();a.update("");var b=a.getWidth(),c=a.getHeight();this.setVisLayout(d3.forceSimulation().force("center",d3.forceCenter(b/2,c/2)));var a=d3.select(a.dom).append("svg").attr("id",this.getVisId()).attr("class","linksGraph").attr("width",b).attr("height",c),d=a.append("g");a.call(d3.zoom().scaleExtent([.25,4]).on("zoom",
function(){d.attr("transform",d3.event.transform)})).on("click",function(){this.getContextMenu().hide()}.bind(this));this.setLinks(d.append("g").attr("class","links").selectAll(".link"));this.setNodes(d.append("g").attr("class","nodes").selectAll(".node"));this.setVis(d)},resetGraph:function(){this.setNodeData([]);this.setLinkData([]);this.refresh()},refresh:function(){var a=this,b=this.getNodeData(),c=this.getLinkData(),d=this.getLinks().data(c,function(a){return a.id});d.exit().remove();var e=d.enter().append("line").attr("class",
"link").attr("id",function(a){return a.id}).on("mouseover",a.linkMouseOver.bind(a)).on("mouseout",a.linkMouseOut.bind(a)).on("click",function(a){d3.event.stopImmediatePropagation();d3.event.preventDefault();this.dispatchEvent("termsClicked",this,['"'+a.source.term+" "+a.target.term+'"~'+this.getApiParam("context")])}.bind(a)).style("cursor","pointer").style("stroke-width",function(b){return a.getNetworkMode()===a.DEFAULT_MODE?Math.max(1,Math.min(15,Math.sqrt(b.value))):1});this.setLinks(e.merge(d));
d=this.getNodes().data(b,function(a){return a.id});d.exit().remove();e=d.enter().append("g").attr("class",function(a){return"node "+a.type}).attr("id",function(a){return a.id}).on("mouseover",a.nodeMouseOver.bind(a)).on("mouseout",a.nodeMouseOut.bind(a)).on("click",function(a){d3.event.stopImmediatePropagation();d3.event.preventDefault();this.dispatchEvent("termsClicked",this,[a.term])}.bind(a)).on("dblclick",function(a){d3.event.stopImmediatePropagation();d3.event.preventDefault();this.fetchCollocatesForNode(a)}.bind(a)).on("contextmenu",
function(b,c){d3.event.preventDefault();var d=a.getContextMenu();d.queryById("label").setHtml(b.term);d.queryById("fixed").setChecked(b.fixed);d.showAt(d3.event.pageX+5,d3.event.pageY-50)}).call(d3.drag().on("start",function(b){d3.event.active||a.getVisLayout().alphaTarget(.3).restart();b.fx=b.x;b.fy=b.y;b.fixed=!0}).on("drag",function(b){b.fx=d3.event.x;b.fy=d3.event.y;a.isMasked()?a.isOffCanvas(d3.event.x,d3.event.y)||a.unmask():a.isOffCanvas(d3.event.x,d3.event.y)&&a.mask(a.localize("releaseToRemove"))}).on("end",
function(b){d3.event.active||a.getVisLayout().alphaTarget(0);1!=b.fixed&&(b.fx=null,b.fy=null);a.isOffCanvas(d3.event.x,d3.event.y)&&(a.unmask(),a.mask(a.localize("cleaning")),a.removeNode(b.id),a.unmask())}));e.append("title").text(function(a){return a.title});this.getNetworkMode()===this.DEFAULT_MODE?e.append("rect").style("stroke-width",1).style("stroke-opacity",1):e.filter(function(a){return"keyword"===a.type}).append("circle").style("stroke-width",1).style("stroke-opacity",1);e.append("text").attr("font-family",
function(b){return a.getApplication().getFeatureForTerm("font",b.term)}).attr("font-size",function(a){return Math.max(10,Math.sqrt(a.value))}).text(function(a){return a.term}).each(function(a){a.bbox=this.getBBox()}).style("cursor","pointer").style("user-select","none").attr("alignment-baseline","middle");this.setNodes(e.merge(d));this.getNetworkMode()===this.DEFAULT_MODE?(this.getVis().selectAll("rect").attr("width",function(a){return a.bbox.width+16}).attr("height",function(a){return a.bbox.height+
8}).attr("rx",function(a){return Math.max(2,.2*a.bbox.height)}).attr("ry",function(a){return Math.max(2,.2*a.bbox.height)}).call(this.applyNodeStyle.bind(this)),this.getVis().selectAll("text").attr("dx",8).attr("dy",function(a){return.5*a.bbox.height+4})):(this.getVis().selectAll("circle").attr("r",function(a){return Math.min(150,a.bbox.width)}).call(this.applyNodeStyle.bind(this)),this.getVis().selectAll("text").attr("dx",function(a){return"keyword"===a.type?.5*-a.bbox.width:8}).attr("dy",function(a){return"keyword"===
a.type?0:.5*a.bbox.height+4}));this.getVis().selectAll("line").call(this.applyLinkStyle.bind(this));this.getVisLayout().nodes(b).on("tick",function(){a.getLinks().attr("x1",function(a){return a.source.x}).attr("y1",function(a){return a.source.y}).attr("x2",function(a){return a.target.x}).attr("y2",function(a){return a.target.y});a.getNodes().attr("transform",function(b){var c=b.x,d=b.y;if(a.getNetworkMode()===a.DEFAULT_MODE||"keyword"!==b.type)c-=.5*b.bbox.width,d-=.5*b.bbox.height;return"translate("+
c+","+d+")"})});this.getVisLayout().force("link").links(c);this.getVisLayout().alpha(1).restart()},isOffCanvas:function(a,b){var c=Ext.get(this.getVisId());return 0>a||0>b||a>c.getWidth()||b>c.getHeight()},applyNodeStyle:function(a,b){var c=void 0===b?"normal":b;a.style("fill",function(a){a=a.type+"Node";return this.getGraphStyle()[a][c].fill}.bind(this));a.style("stroke",function(a){a=a.type+"Node";return this.getGraphStyle()[a][c].stroke}.bind(this))},applyLinkStyle:function(a,b){var c=void 0===
b?"normal":b;a.style("stroke",function(a){return this.getGraphStyle().link[c].stroke}.bind(this));a.style("stroke-opacity",function(a){return this.getGraphStyle().link[c].strokeOpacity}.bind(this))},linkMouseOver:function(a){this.getVis().selectAll("line").call(this.applyLinkStyle.bind(this));this.getVis().select("#"+a.id).call(this.applyLinkStyle.bind(this),"highlight")},linkMouseOut:function(a){this.getVis().selectAll("line").call(this.applyLinkStyle.bind(this))},nodeMouseOver:function(a){this.setCurrentNode(a);
this.getVis().selectAll("rect").call(this.applyNodeStyle.bind(this));this.getLinks().each(function(b){var c;b.source.id==a.id?c=b.target.id:b.target.id==a.id&&(c=b.source.id);void 0!==c&&(this.getVis().select("#"+c+" rect").call(this.applyNodeStyle.bind(this),"highlight"),this.getVis().select("#"+b.id).call(this.applyLinkStyle.bind(this),"highlight"))}.bind(this));this.getVis().select("#"+a.id+" rect").style("stroke-width",3).call(this.applyNodeStyle.bind(this),"highlight")},nodeMouseOut:function(a){this.getContextMenu().isVisible()||
this.setCurrentNode(void 0);this.getVis().selectAll("rect").style("stroke-width",1).call(this.applyNodeStyle.bind(this));this.getVis().selectAll("line").call(this.applyLinkStyle.bind(this))},fetchCollocatesForNode:function(a){var b=this.getApiParam("limit");this.getCorpus().getCorpusCollocates({autoLoad:!1}).load({params:Ext.apply(this.getApiParams(),{query:a.term,start:a.start,limit:b}),callback:function(c,d,e){e&&(this.updateDataForNode(a.id,{start:a.start+b}),this.loadFromCorpusCollocateRecords(c,
a.id))},scope:this})}});Ext.define("Voyant.panel.Contexts",{extend:"Ext.grid.Panel",mixins:["Voyant.panel.Panel"],requires:["Voyant.data.store.Contexts"],alias:"widget.contexts",isConsumptive:!0,statics:{i18n:{},api:{query:void 0,docId:void 0,docIndex:void 0,stopList:"auto",context:5,expand:50},glyph:"xf0ce@FontAwesome"},constructor:function(){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(){var a=this;Ext.apply(a,{title:this.localize("title"),emptyText:this.localize("emptyText"),
...
d,e){return this.getStore().getCount()<this.getStore().getCorpus().getDocumentsCount()?(a=this.up("panel"),Ext.Msg.show({title:a.localize("error"),message:a.localize("reorderFilteredError"),buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR}),!1):!0}}}},buttons:[{text:this.localize("add"),tooltip:this.localize("addTip"),glyph:"xf067@FontAwesome",handler:function(a){a.up("window").close();Ext.create("Ext.window.Window",{header:!1,modal:!0,layout:"fit",items:{xtype:"corpuscreator",corpus:this.getStore().getCorpus()}}).show()},
...
SCROLL_UP:-1,SCROLL_EQ:0,SCROLL_DOWN:1,LOCATION_UPDATE_FREQ:100,DETAILED_GRAPH_DOC_LIMIT:25,INITIAL_LIMIT:1E3,constructor:function(){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(){var a=Ext.create("Voyant.data.store.Tokens"),b=this;a.on("beforeload",function(a){return b.hasCorpusAccess(a.getCorpus())});a.on("load",function(a,b,e){if(e){var f="",g=this.localize("documentFrequency"),h=!1,k=-1,l=!1;b.forEach(function(a){0==a.getPosition()&&
(f+="\x3ch3\x3e"+this.getDocumentsStore().getById(a.getDocId()).getFullLabel()+"\x3c/h3\x3e");a.getDocIndex()!=k&&(h=this.getDocumentsStore().getById(a.getDocId()).isPlainText(),k=a.getDocIndex());if(a.isWord())l=!1,f+="\x3cspan class\x3d'word' id\x3d'"+a.getId()+"' data-qtip\x3d'"+g+" "+a.getDocumentRawFreq()+"'\x3e"+a.getTerm()+"\x3c/span\x3e";else{a=a.getTermWithLineSpacing(h);var b=0==a.indexOf("\x3cbr /\x3e");if(!l||!b&&0!=a.trim().length)f+=a,l=b}},this);this.updateText(f);this.down("querysearchfield").getValue()}},
this);this.setTokensStore(a);this.on("query",function(a,b){this.loadQueryTerms(b)},this);this.setDocumentTermsStore(Ext.create("Ext.data.Store",{model:"Voyant.data.model.DocumentTerm",autoLoad:!1,remoteSort:!1,proxy:{type:"ajax",url:Voyant.application.getTromboneUrl(),extraParams:{tool:"corpus.DocumentTerms",withDistributions:!0,withPositions:!0,bins:25},reader:{type:"json",rootProperty:"documentTerms.terms",totalProperty:"documentTerms.total"},simpleSortMode:!0},listeners:{load:function(a,b,e,f){a.sort("docIndex",
"ASC");var g={},h=0,k;a.each(function(a){var b=[],c=a.get("distributions"),d=a.get("docId"),e=a.get("docIndex");k=a.get("term");for(a=0;a<c.length;a++){var f=a,s=c[a];s>h&&(h=s);b.push([d,e,f,s,k])}g[e]=b},this);this.highlightKeywords(k);if(this.getIsDetailedGraph())for(a=this.query("cartesian"),b=0;b<a.length;b++)e=a[b],f=g[b],void 0!==f?(e.getAxes()[0].setMaximum(h),e.getStore().loadData(f)):e.getStore().removeAll()},scope:this}}));this.on("afterrender",function(){var a=this.down('panel[region\x3d"center"]');
this.setInnerContainer(a.getLayout().getRenderTarget());a.body.on("scroll",function(a,b){var c=this.getLastScrollTop()<b.scrollTop?this.SCROLL_DOWN:this.getLastScrollTop()>b.scrollTop?this.SCROLL_UP:this.SCROLL_EQ;if(c==this.SCROLL_UP&&1>b.scrollTop)this.fetchPrevious(!0);else if(c==this.SCROLL_DOWN&&b.scrollHeight-b.scrollTop<1.5*b.offsetHeight)this.fetchNext(!1);else{var g;g=0==b.scrollTop?0:b.scrollHeight-b.scrollTop==b.clientHeight?1:(b.scrollTop+.5*b.clientHeight)/b.scrollHeight;(new Date-this.getLastLocationUpdate()>
this.LOCATION_UPDATE_FREQ||0==g||1==g)&&this.updateLocationMarker(g,c)}this.setLastScrollTop(b.scrollTop)},this);a.body.on("click",function(a,b){b=Ext.get(b);if(b.hasCls("word")){var c=Voyant.data.model.Token.getInfoFromElement(b),g=b.getHtml(),c=[{term:g,docIndex:c.docIndex}];this.loadQueryTerms([g]);this.getApplication().dispatchEvent("termsClicked",this,c)}},this);this.getCorpus()&&(this.load(),(a=this.getApiParam("query"))&&this.loadQueryTerms(Ext.isString(a)?[a]:a))},this);Ext.apply(this,{title:this.localize("title"),
cls:"voyant-reader",layout:"fit",items:{layout:"border",items:[{bodyPadding:10,region:"center",border:!1,autoScroll:!0,html:'\x3cdiv class\x3d"readerContainer"\x3e\x3c/div\x3e'},{region:"south",height:40,split:{size:2},splitterResize:!0,border:!1,layout:{type:"hbox"}}]},dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{glyph:"xf060@FontAwesome",handler:function(){this.fetchPrevious(!0)},scope:this},{glyph:"xf061@FontAwesome",handler:function(){this.fetchNext(!0)},scope:this},
{xtype:"tbseparator"},{xtype:"querysearchfield"}]}],listeners:{loadedCorpus:function(a,b){this.getTokensStore().setCorpus(b);this.getDocumentTermsStore().getProxy().setExtraParam("corpus",b.getId());var e=b.getDocuments();this.setDocumentsStore(e);this.setIsDetailedGraph(e.getTotalCount()<this.DETAILED_GRAPH_DOC_LIMIT);e=this.down('panel[region\x3d"south"]');void 0==this.getLocationMarker()&&this.setLocationMarker(Ext.DomHelper.append(e.el,{tag:"div",style:"background-color: #157fcc; height: 100%; width: 2px; position: absolute; top: 0; left: 0;"}));
this.generateChart(b,e);this.rendered&&(this.load(),0==this.hasCorpusAccess(b)&&this.mask(this.localize("limitedAccess"),"mask-no-spinner"),(e=this.getApiParam("query"))&&this.loadQueryTerms(Ext.isString(e)?[e]:e))},termsClicked:function(a,b){var e=[];b.forEach(function(a){Ext.isString(a)?e.push(a):a.term?e.push(a.term):a.getTerm&&e.push(a.getTerm())});0<e.length&&this.loadQueryTerms(e)},corpusTermsClicked:function(a,b){var e=[];b.forEach(function(a){a.getTerm()&&e.push(a.getTerm())});this.loadQueryTerms(e)},
documentTermsClicked:function(a,b){var e=[];b.forEach(function(a){a.getTerm()&&e.push(a.getTerm())});this.loadQueryTerms(e)},documentsClicked:function(a,b,e){0<b.length&&(this.setApiParams({skipToDocId:b[0].getId(),start:0}),this.load(!0))},termLocationClicked:function(a,b){if(void 0!==b[0]){var e=b[0],f=e.get("docIndex"),g=e.get("position"),h=g-this.getApiParam("limit")/2,k=this.getCorpus().getDocument(f);this.setApiParams({skipToDocId:k.getId(),start:0>h?0:h});this.load(!0,{callback:function(){var a=
this.body.dom.querySelector("#_"+f+"_"+g);a&&a.scrollIntoView();this.highlightKeywords(e.get("term"),!1)},scope:this})}},documentIndexTermsClicked:function(a,b){if(void 0!==b[0]){var e=Ext.create("Voyant.data.model.Token",b[0]);this.fireEvent("termLocationClicked",this,[e])}},scope:this}});this.callParent(arguments)},loadQueryTerms:function(a){a&&0<a.length&&this.getDocumentTermsStore().load({params:{query:a}})},updateLocationMarker:function(a,b){var c=Ext.DomQuery.select(".word",this.getInnerContainer().down(".readerContainer",
...
this.localize("loading")+"\x3c/div\x3e\x3c/div\x3e"),this.getInnerContainer().first().first().mask());this.getTokensStore().load(Ext.apply(b||{},{params:Ext.apply(this.getApiParams(),{stripTags:"blocksOnly"})}))},updateText:function(a){var b=this.getInnerContainer().down(".loading");b&&b.destroy();var c=this.getInnerContainer().first().insertHtml(this.getInsertWhere(),a,!0);c&&this.getScrollIntoView()&&(c.dom.scrollIntoView(),Ext.Function.defer(function(){var a=Ext.get(c.id);a&&a.frame("red")},100));
a=this.down('panel[region\x3d"center"]').body.dom;this.updateLocationMarker(0==a.scrollTop?0:a.scrollHeight-a.scrollTop==a.clientHeight?1:(a.scrollTop+.5*a.clientHeight)/a.scrollHeight)},updateChart:function(){}});Ext.define("Voyant.panel.ScatterPlot",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],requires:["Ext.chart.CartesianChart"],alias:"widget.scatterplot",statics:{i18n:{tsne:"t-SNE",terms:"Terms",reload:"Reload",options:"Options",input:"Input",output:"Output",perplexity:"Perplexity",iterations:"Iterations",analyzing:"Analyzing",plotting:"Plotting"},api:{docId:void 0,analysis:"ca",limit:50,dimensions:3,bins:10,clusters:3,perplexity:15,iterations:1500,comparisonType:"relative",stopList:"auto",
target:void 0,term:void 0,query:void 0,whitelist:void 0,label:["summary","docs","terms"]},glyph:"xf06e@FontAwesome"},config:{options:{xtype:"stoplistoption"},caStore:null,pcaStore:null,tsneStore:null,docSimStore:null,termStore:null,chartMenu:null,newTerm:null,termsTimeout:null,highlightData:{x:0,y:0,r:0},highlightTask:null},tokenFreqTipTemplate:null,docFreqTipTemplate:null,constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);a&&a.whitelist&&
this.setApiParam("whitelist",a.whitelist)},initComponent:function(){this.setCaStore(Ext.create("Voyant.data.store.CAAnalysis",{listeners:{load:this.maskAndBuildChart,scope:this}}));this.setPcaStore(Ext.create("Voyant.data.store.PCAAnalysis",{listeners:{load:this.maskAndBuildChart,scope:this}}));this.setTsneStore(Ext.create("Voyant.data.store.TSNEAnalysis",{listeners:{load:this.maskAndBuildChart,scope:this}}));this.setDocSimStore(Ext.create("Voyant.data.store.DocSimAnalysis",{listeners:{load:this.maskAndBuildChart,
scope:this}}));this.setTermStore(Ext.create("Ext.data.JsonStore",{fields:[{name:"term"},{name:"rawFreq",type:"int"},{name:"relativeFreq",type:"number"},{name:"coordinates",mapping:"vector"},{name:"category"}],sorters:[{property:"rawFreq",direction:"DESC"}],groupField:"category"}));this.setChartMenu(Ext.create("Ext.menu.Menu",{items:[{text:this.localize("remove"),itemId:"remove",glyph:"xf068@FontAwesome"},{text:this.localize("nearby"),itemId:"nearby",glyph:"xf0b2@FontAwesome"}],listeners:{hide:function(){var a=
this.down("#chart").getSeries();a[0].enableToolTips();a[1].enableToolTips()},scope:this}}));this.tokenFreqTipTemplate=new Ext.Template(this.localize("tokenFreqTip"));this.docFreqTipTemplate=new Ext.Template(this.localize("docFreqTip"));Ext.apply(this,{title:this.localize("title"),layout:"border",autoDestroy:!0,items:[{itemId:"chartParent",region:"center",layout:"fit",tbar:{overflowHandler:"scroller",items:[{xtype:"querysearchfield",itemId:"filterTerms",width:150},{text:this.localize("labels"),itemId:"labels",
glyph:"xf02b@FontAwesome",menu:{items:[{text:this.localize("summaryLabel"),itemId:"summary",xtype:"menucheckitem"},{text:this.localize("docsLabel"),itemId:"docs",xtype:"menucheckitem"},{text:this.localize("termsLabel"),itemId:"terms",xtype:"menucheckitem"}],listeners:{afterrender:function(a){var b=this.getApiParam("label");a.items.each(function(a){a.setChecked(-1<b.indexOf(a.getItemId()))})},click:function(a,b){var c=this.getApiParam("label"),d=b.getItemId();Ext.isString(c)&&(c=[c]);b.checked&&-1==
c.indexOf(d)?c.push(d):!b.checked&&-1<c.indexOf(d)&&(c=c.filter(function(a){return a!=d}));this.setApiParam("label",c);this.doLabels();this.queryById("chart").redraw()},scope:this}}}]},listeners:{query:function(a,b){this.getTermStore().filter([{property:"term",value:b,anyMatch:!0}]);this.filterChart(b)},scope:this}},{itemId:"optionsPanel",title:this.localize("options"),region:"west",split:!0,collapsible:!0,collapseMode:"header",width:135,scrollable:"y",layout:{type:"vbox",align:"stretch"},defaults:{xtype:"button",
margin:"5",labelAlign:"top"},items:[{xtype:"label",text:this.localize("input")},{xtype:"documentselectorbutton"},{text:this.localize("freqsMode"),itemId:"comparisonType",glyph:"xf201@FontAwesome",tooltip:this.localize("freqsModeTip"),menu:{items:[{text:this.localize("rawFrequencies"),itemId:"comparisonType_raw",group:"freqsMode",xtype:"menucheckitem"},{text:this.localize("relativeFrequencies"),itemId:"comparisonType_relative",group:"freqsMode",xtype:"menucheckitem"},{text:this.localize("tfidf"),itemId:"comparisonType_tfidf",
group:"freqsMode",xtype:"menucheckitem"}],listeners:{click:function(a,b){if(void 0!==b){var c=b.getItemId().split("_")[1];c!==this.getApiParam("comparisonType")&&(this.setApiParam("comparisonType",c),this.loadFromApis(!0))}},scope:this}}},{fieldLabel:this.localize("numTerms"),itemId:"limit",xtype:"numberfield",minValue:5,listeners:{change:function(a,b,c){function d(){this.setApiParam("limit",b);this.loadFromApis()}null!==c&&(null!==this.getTermsTimeout()&&clearTimeout(this.getTermsTimeout()),a.isValid()&&
this.setTermsTimeout(setTimeout(d.bind(this),500)))},scope:this}},{xtype:"container",html:'\x3chr style\x3d"border: none; border-top: 1px solid #cfcfcf;"/\x3e'},{xtype:"label",text:this.localize("output")},{text:this.localize("analysis"),itemId:"analysis",glyph:"xf1ec@FontAwesome",overflowHandler:"scroller",menu:{items:[{text:this.localize("pca"),itemId:"analysis_pca",group:"analysis",xtype:"menucheckitem"},{text:this.localize("ca"),itemId:"analysis_ca",group:"analysis",xtype:"menucheckitem"},{text:this.localize("tsne"),
itemId:"analysis_tsne",group:"analysis",xtype:"menucheckitem"},{text:this.localize("docSim"),itemId:"analysis_docSim",group:"analysis",xtype:"menucheckitem"}],listeners:{click:function(a,b){if(void 0!==b){var c=b.getItemId().split("_")[1];c!==this.getApiParam("analysis")&&(this.doAnalysisChange(c),this.loadFromApis(!0))}},scope:this}}},{fieldLabel:this.localize("perplexity"),itemId:"perplexity",xtype:"slider",minValue:5,maxValue:100,increment:1,listeners:{changecomplete:function(a,b){this.setApiParam("perplexity",
b);this.loadFromApis(!0)},scope:this}},{fieldLabel:this.localize("iterations"),itemId:"iterations",xtype:"slider",minValue:100,maxValue:5E3,increment:100,listeners:{changecomplete:function(a,b){this.setApiParam("iterations",b);this.loadFromApis(!0)},scope:this}},{text:this.localize("clusters"),itemId:"clusters",glyph:"xf192@FontAwesome",menu:{items:[{text:"1",itemId:"clusters_1",group:"clusters",xtype:"menucheckitem"},{text:"2",itemId:"clusters_2",group:"clusters",xtype:"menucheckitem"},{text:"3",
itemId:"clusters_3",group:"clusters",xtype:"menucheckitem"},{text:"4",itemId:"clusters_4",group:"clusters",xtype:"menucheckitem"},{text:"5",itemId:"clusters_5",group:"clusters",xtype:"menucheckitem"}],listeners:{click:function(a,b){if(void 0!==b){var c=parseInt(b.getItemId().split("_")[1]);c!==this.getApiParam("clusters")&&(this.setApiParam("clusters",c),this.loadFromApis(!0))}},scope:this}}},{text:this.localize("dimensions"),itemId:"dimensions",glyph:"xf1b2@FontAwesome",menu:{items:[{text:"2",itemId:"dimensions_2",
group:"dimensions",xtype:"menucheckitem"},{text:"3",itemId:"dimensions_3",group:"dimensions",xtype:"menucheckitem"}],listeners:{click:function(a,b){if(void 0!==b){var c=parseInt(b.getItemId().split("_")[1]);if(c!==this.getApiParam("dimensions")){if(3==c&&"ca"==this.getApiParam("analysis")&&3==this.getCorpus().getDocumentsCount())return!1;this.setApiParam("dimensions",c);this.loadFromApis(!0)}}},scope:this}}},{itemId:"reloadButton",text:this.localize("reload"),glyph:"xf021@FontAwesome",handler:function(){this.loadFromApis()},
scope:this}]},{itemId:"termsGrid",xtype:"grid",title:this.localize("terms"),region:"east",width:250,split:!0,collapsible:!0,collapseMode:"header",forceFit:!0,features:[{ftype:"grouping",hideGroupedHeader:!0,enableGroupingMenu:!1}],bbar:{overflowHandler:"scroller",items:[{itemId:"nearbyButton",xtype:"button",text:this.localize("nearby"),glyph:"xf0b2@FontAwesome",flex:1,handler:function(a){var b=a.up("panel").getSelection()[0];void 0===b?this.toastError({html:this.localize("noTermSelected"),anchor:a.up("panel").getTargetEl()}):
(a=b.get("term"),this.getNearbyForTerm(a))},scope:this},{itemId:"removeButton",xtype:"button",text:this.localize("remove"),glyph:"xf068@FontAwesome",flex:1,handler:function(a){var b=a.up("panel").getSelection()[0];void 0===b?this.toastError({html:this.localize("noTermSelected"),anchor:a.up("panel").getTargetEl()}):(a=b.get("term"),this.removeTerm(a))},scope:this}]},tbar:{overflowHandler:"scroller",items:[{xtype:"querysearchfield",itemId:"addTerms",flex:1}]},columns:[{text:this.localize("term"),dataIndex:"term",
flex:1,sortable:!0},{text:this.localize("rawFreq"),dataIndex:"rawFreq",flex:.75,minWidth:70,sortable:!0},{text:this.localize("relFreq"),dataIndex:"relativeFreq",flex:.75,minWidth:70,sortable:!0,hidden:!0}],selModel:{type:"rowmodel",mode:"SINGLE",allowDeselect:!0,toggleOnClick:!0,listeners:{selectionchange:{fn:function(a,b){var c=b[0];if(void 0!==c){var d=c.get("term"),c="doc"===c.get("category");this.selectTerm(d,c);c?(this.queryById("nearbyButton").disable(),this.queryById("removeButton").disable()):
(this.queryById("nearbyButton").enable(),this.queryById("removeButton").enable())}else this.selectTerm()},scope:this}}},store:this.getTermStore(),listeners:{expand:function(a){a.getView().refresh()},query:function(a,b){0<b.length&&-1===this.getTermStore().findExact("term",b[0])?(this.setNewTerm(b),this.loadFromApis()):this.setNewTerm(null)},scope:this}}]});this.on("boxready",function(a,b,c){400>b&&(this.queryById("optionsPanel").collapse(),this.queryById("termsGrid").collapse())},this);this.on("loadedCorpus",
...
scope:this}]}));this.on("query",function(a,b){0<b.length&&this.doLoad(b)},this);this.callParent(arguments)},listeners:{boxready:function(){this.initVisLayout()},resize:function(a,b,c){this.getVisLayout()&&this.getCorpus()&&(a=this.getLayout().getRenderTarget(),b=a.getWidth(),c=a.getHeight(),a.down("svg").set({width:b,height:c}),this.getVisLayout().size([b,c]),this.reload())},loadedCorpus:function(a,b){this.doLoad()}},doLoad:function(a){this.resetVis();void 0===a&&(this.resetMinMax(),this.setCurrentData({}));
this.getMode()===this.MODE_DISTINCT?this.getDistinctTerms(a):this.getTopTerms(a)},reload:function(){var a=this.processCollocates([]);0<a.length&&(this.resetVis(),this.buildVisFromData(a))},resetMinMax:function(){this.setMinRawFreq(void 0);this.setMaxRawFreq(void 0);this.setMaxCollocateValue(void 0);this.setMinFillValue(void 0);this.setMaxFillValue(void 0)},resetVis:function(){this.getVis().selectAll(".node").remove()},getTopTerms:function(a){var b=parseInt(this.getApiParam("numInitialTerms")),c=this.getApiParam("stopList");
void 0!==a&&(c=b=void 0);this.getCorpus().getCorpusTerms().load({params:{query:a,limit:b,stopList:c},callback:function(a,b,c){c&&this.loadFromRecords(a)},scope:this})},getDistinctTerms:function(a){var b=parseInt(this.getApiParam("numInitialTerms")),c=this.getApiParam("stopList");void 0!==a&&(c=b=void 0);var d=Math.ceil(parseInt(this.getApiParam("numInitialTerms"))/this.getCorpus().getDocumentsCount());this.getCorpus().getDocumentTerms().load({params:{query:a,limit:b,perDocLimit:d,stopList:c,sort:"TFIDF",
dir:"DESC"},callback:function(a,b,c){c&&this.loadFromRecords(a)},scope:this})},loadFromQuery:function(a){this.getCorpus().getCorpusTerms().load({params:{query:a},callback:function(a,c,d){d&&this.loadFromRecords(a)},scope:this})},loadFromRecords:function(a){if(Ext.isArray(a)&&0<a.length){var b=this.getMaxRawFreq(),c=this.getMinRawFreq(),d=this.getMinFillValue(),e=this.getMaxFillValue(),f=[];a.forEach(function(a){var h=a.getTerm();if(!this.getBlacklist()[h]){var k=a.getRawFreq(),l=this.getMode()===
this.MODE_DISTINCT?a.get("tfidf"):a.getInDocumentsCount();if(void 0===b||k>b)b=k;if(void 0===c||k<c)c=k;if(void 0===e||l>e)e=l;if(void 0===d||l<d)d=l;this.getCurrentData()[h]={term:h,rawFreq:k,relativeFreq:a.get("relativeFreq"),fillValue:l,collocates:[]};f.push(h)}},this);this.setMaxRawFreq(b);this.setMinRawFreq(c);this.setMinFillValue(d);this.setMaxFillValue(e);this.getCollocatesForQuery(f)}},getCollocatesForQuery:function(a){var b=[],c;for(c in this.getCurrentData())b.push(c);this.setApiParams({mode:"corpus"});
c=this.getApiParams();this.getCorpus().getCorpusCollocates().load({params:Ext.apply(Ext.clone(c),{query:a,collocatesWhitelist:b,limit:this.COLLOCATES_LIMIT}),callback:function(a,b,c){c&&this.buildVisFromData(this.processCollocates(a))},scope:this})},processCollocates:function(a){for(var b=this.getCurrentData(),c=this.getMaxCollocateValue(),d=0;d<a.length;d++){var e=a[d],f=e.getTerm(),g=e.getContextTerm(),e=e.getContextTermRawFreq();if(void 0===c||e>c)c=e;void 0!==b[f]&&f!=g&&b[f].collocates.push({term:g,
value:e})}this.setMaxCollocateValue(c);a=[];for(f in b)a.push(b[f]);return a},buildVisFromData:function(a){var b=this;a.push({term:"$$$root$$$",collocates:[],rawFreq:1});var c=d3.stratify().id(function(a){return a.term}).parentId(function(a){return"$$$root$$$"!==a.term?"$$$root$$$":""})(a).sort(function(a,b){return a.rawFreq<b.rawFreq?1:a.rawFreq>b.rawFreq?-1:0}).sum(function(a){return Math.pow(a.rawFreq,1/b.getScalingFactor())});this.getVisLayout()(c);c=this.getVis().selectAll(".node").data(c.descendants());
c.attr("transform",function(a){return"translate("+a.x+","+a.y+")"});c.selectAll("circle").attr("r",function(a){return a.r});var d=d3.scalePow().exponent(1/3).domain([0,this.getMaxCollocateValue()]).range(["#fff","#bd3163"]),e;e=this.getMode()===this.MODE_DISTINCT?d3.scalePow().exponent(.2).domain([this.getMinFillValue(),this.getMaxFillValue()]).range(["#dedede","#fff"]):d3.scaleLinear().domain([this.getMaxFillValue(),this.getMinFillValue()]).range(["#dedede","#fff"]);var f=this.getVisLayout().size(),
f=Math.min(f[0],f[1])/2;a=Math.sqrt(Math.PI*f*f/a.length/Math.PI)/3;var f=Math.abs(this.getScalingFactor()-(this.MAX_SCALING+1)),f=Math.max(1,f-1),f=a*f,g=d3.scaleLinear().domain([this.getMinRawFreq(),this.getMaxRawFreq()]).range([a,f]);a=c.enter().append("g").attr("class","node").style("visibility",function(a){return 0<a.depth?"visible":"hidden"}).attr("transform",function(a){return"translate("+a.x+","+a.y+")"}).on("click",function(a){b.dispatchEvent("termsClicked",b,[a.data.term])}).on("mouseover",
function(a,c){b.setCurrentNode(a);b.getVis().selectAll("circle").style("stroke-width",1).style("stroke","#111").style("fill",function(a){return e(a.data.fillValue)});d3.select(this).select("circle").style("fill","#89e1c2").style("stroke","#26926c").style("stroke-opacity",b.MAX_STROKE_OPACITY);var f;f=b.getMode()===b.MODE_DISTINCT?b.localize("tfidf"):b.localize("inDocs");if(!b.getContextMenu().isVisible()){f="\x3cb\x3e"+a.data.term+"\x3c/b\x3e ("+a.data.rawFreq+")\x3cbr/\x3e"+f+": "+a.data.fillValue;
var g=b.getTip();g.update(f);g.show()}for(c=0;c<a.data.collocates.length;c++){var n=a.data.collocates[c];f=b.getVis().selectAll(".node").filter(function(a){return a.data.term===n.term});f.select("circle").style("fill",function(a){return d(n.value)}).style("stroke","#bd3163").style("stroke-opacity",b.MAX_STROKE_OPACITY);f.select("tspan.value").text(function(a){return n.value})}}).on("mousemove",function(){b.getTip().setPosition(d3.event.pageX+5,d3.event.pageY-50)}).on("mouseout",function(){b.getContextMenu().isVisible()||
...
docIndex:Ext.Array.from(a).map(function(a){return this.getCorpus().getDocument(a).getIndex()},this)});this.isVisible()&&this.loadFromDocumentTerms(this.getApiParam("query")?void 0:this.getCorpus().getDocumentTerms({proxy:{extraParams:{limit:this.getApiParam("limit")}}}))},loadFromDocumentTerms:function(a){this.getCorpus()&&(a=a||this.getCorpus().getDocumentTerms({}),a.load({callback:function(a,c,d){d&&(this.setMode(this.MODE_DOCUMENT),this.loadFromRecords(a))},scope:this,params:this.getApiParams(["stopList",
"query","docIndex","withDistributions","bins"])}))},loadFromCorpus:function(a){a=a||this.getCorpus();this.setCorpus(a);this.getApiParam("docId")?this.loadFromDocumentTerms():1==a.getDocumentsCount()?this.loadFromDocuments([a.getDocument(0)]):this.loadFromCorpusTerms(a.getCorpusTerms({proxy:{extraParams:{limit:this.getApiParam("limit")}}}))},loadFromCorpusTerms:function(a){if(this.getCorpus())if(1==this.getCorpus().getDocumentsCount())this.loadFromDocumentTerms();else{a=a||this.getCorpus().getCorpusTerms({autoLoad:!1});
var b=this.getApiParams(["stopList","query","withDistributions","bins"]);b.bins&&b.bins>this.getCorpus().getDocumentsCount()&&(b.bins=this.getCorpus().getDocumentsCount());a.load({callback:function(a,b,e){e?(this.setMode(this.MODE_CORPUS),this.loadFromRecords(a)):Voyant.application.showResponseError(this.localize("failedGetCorpusTerms"),b)},scope:this,params:b})}},loadFromRecords:function(a){var b=this.getApiParam("mode"),c=[],d=["index"],e=[],f=0;a.forEach(function(a,g){var l=a.get("term");a.get("distributions").forEach(function(a,
b){c[b]||(c[b]={index:b});c[b]["_"+g]=a;a>f&&(f=a)},this);d.push("_"+g);e.push({type:"line",title:l,xField:"index",yField:"_"+g,colors:[this.getApplication().getColorForTerm(l,!0)],style:{lineWidth:2},marker:{radius:3},highlight:!0,smooth:!0,tooltip:{trackMouse:!0,style:"background: #fff",renderer:function(a,c,d){var e="\x3ci\x3e"+d.series.getTitle()+"\x3c/i\x3e: "+c.get(d.series.getYField());if(b==a.panel.MODE_CORPUS){var f=a.panel.getCorpus();f&&f.getDocumentsCount()==c.store.getCount()&&(e+="\x3cbr/\x3e\x3ci\x3e"+
a.panel.getCorpus().getDocument(d.index).getShortTitle()+"\x3c/i\x3e")}a.setHtml(e)},panel:this},listeners:{itemclick:{fn:this.handleClickedItem,scope:this}}})},this);a=Ext.create("Ext.data.JsonStore",{fields:d,data:c});d.shift();var g=this;this.buildChart({store:a,series:e,axes:[{type:"numeric",position:"left",majorTickSteps:"raw"==this.getApiParam("withDistributions")&&20>f?f:void 0,increment:1,title:{text:this.localize("raw"==this.getApiParam("withDistributions")?"rawFrequencies":"relativeFrequencies")}},
{type:"category",position:"bottom",increment:1,fields:["index"],title:{text:this.localize(b==this.MODE_DOCUMENT?"segments":"documents")},label:{rotate:{degrees:-30}},renderer:function(a,c){if(b==g.MODE_DOCUMENT)return parseInt(c)+1;var d=g.getCorpus().getDocument(c);if(d){var e=g.getTargetEl().getHeight();return 250>e?parseInt(c)+1:500>e?d.getTinyTitle():d.getShortTitle()}return"?"}}]})},reloadFromChart:function(){var a=this.down("chart");if(a){var b=[];a.series.forEach(function(a){b.push(a.getTitle())});
this.fireEvent("termsClicked",this,b)}},buildChart:function(a){a.axes.forEach(function(a){Ext.applyIf(a,{style:{opacity:.2},label:{opacity:.5}});Ext.applyIf(a.title,{fontSize:12})});Ext.applyIf(a,{plugins:{ptype:"chartitemevents",moveEvents:!0},legend:{docked:"top"},interactions:["itemhighlight","panzoom"],innerPadding:{top:5,right:5,bottom:5,left:5},border:!1,bodyBorder:!1});this.query("chart").forEach(function(a){this.remove(a)},this);a=Ext.create("Ext.chart.CartesianChart",a);this.add(a)},clearChart:function(){this.query("chart").forEach(function(a){this.remove(a)},
this)},handleClickedItem:function(a,b){var c=this.getApiParam("mode");if(c===this.MODE_DOCUMENT){c=this.getApiParam("docId");if(!c){var d=this.getCorpus();d&&(c=d.getDocument(0).getId())&&this.setApiParam("docId",c)}if(c){var d=this.getCorpus().getDocument(c),d=d.get("tokensCount-lexical"),e=this.getApiParam("bins"),d=b.index/e*d;this.dispatchEvent("documentIndexTermsClicked",this,[{term:b.series.getTitle(),docId:c,position:d}])}}else c==this.MODE_CORPUS&&(d=this.getCorpus().getDocument(b.index),
this.dispatchEvent("documentIndexTermsClicked",this,[{term:b.series.getTitle(),docIndex:b.index,docId:d.getId()}]))},isLastClickedItem:function(a){return this.lastClickedItem&&this.lastClickedItem.term==a.term&&this.lastClickedItem.index==a.index},setMode:function(a){this.setApiParams({mode:a});this.getApiParam("mode")},getDistributionsType:function(a){return a[0]===Math.round(a[0])?"raw":"relative"}});
Ext.override(Ext.chart.axis.sprite.Axis,{renderLabels:function(a,b,c,d){var e=this,f=e.attr,g=.5*f.lineWidth,h=f.position,k=f.matrix,l=f.textPadding,m=k.getXX(),n=k.getDX(),q=k.getYY(),r=k.getDY(),p=0,k=c.majorTicks,s=Math.max(f.majorTickSize,f.minorTickSize)+f.lineWidth,x=Ext.draw.Draw.isBBoxIntersect,u=e.getLabel(),G,L,B=null,E=0,z=0,H=c.segmenter,C=e.getRenderer(),A=e.getAxis(),K=(G=A.getTitle())&&""!==G.attr.text&&G.getBBox(),I,J=null,F,w,v;if(k&&u&&!u.attr.hidden){G=u.attr.font;b.font!==G&&(b.font=
G);u.setAttributes({translationX:0,translationY:0},!0);u.applyTransformations();I=u.attr.inverseMatrix.elements.slice(0);switch(h){case "left":b=K?K.x+K.width:0;switch(u.attr.textAlign){case "start":d=a.roundPixel(b+n)-g;break;case "end":d=a.roundPixel(d[2]-s+n)-g;break;default:d=a.roundPixel(b+(d[2]-b-s)/2+n)-g}u.setAttributes({translationX:d},!0);break;case "right":b=K?d[2]-K.x:0;switch(u.attr.textAlign){case "start":d=a.roundPixel(s+n)+g;break;case "end":d=a.roundPixel(d[2]-b+n)+g;break;default:d=
a.roundPixel(s+(d[2]-s-b)/2+n)+g}u.setAttributes({translationX:d},!0);break;case "top":b=K?K.y+K.height:0;u.setAttributes({translationY:a.roundPixel(b+(d[3]-b-s)/2)-g},!0);break;case "bottom":b=K?d[3]-K.y:0;u.setAttributes({translationY:a.roundPixel(s+(d[3]-s-b)/2)+g},!0);break;case "radial":u.setAttributes({translationX:f.centerX},!0);break;case "angular":u.setAttributes({translationY:f.centerY},!0);break;case "gauge":u.setAttributes({translationY:f.centerY},!0)}if("left"===h||"right"===h)e.iterate(k,
function(b,d,f){void 0!==d&&(v=C?Ext.callback(C,null,[A,d,c,B],0,A):H.renderer(d,c,B),B=d,u.setAttributes({text:String(v),translationY:a.roundPixel(b*q+r)},!0),u.applyTransformations(),p=Math.max(p,u.getBBox().width+s),p<=e.thickness&&(w=Ext.draw.Matrix.fly(u.attr.matrix.elements.slice(0)),F=w.prepend.apply(w,I).transformBBox(u.getBBox(!0)),!J||x(F,J,l)))&&(a.renderSprite(u),J=F,E+=F.height,z++)});else if("top"===h||"bottom"===h)e.iterate(k,function(b,d,f){void 0!==d&&(v=C?Ext.callback(C,null,[A,
d,c,B],0,A):H.renderer(d,c,B),B=d,u.setAttributes({text:String(v),translationX:a.roundPixel(b*m+n)},!0),u.applyTransformations(),p=Math.max(p,u.getBBox().height+s),p<=e.thickness&&(w=Ext.draw.Matrix.fly(u.attr.matrix.elements.slice(0)),F=w.prepend.apply(w,I).transformBBox(u.getBBox(!0)),J&&x(F,J,l),a.renderSprite(u),J=F,E+=F.width,z++))});else if("radial"===h)e.iterate(k,function(b,d,e){void 0!==d&&(v=C?Ext.callback(C,null,[A,d,c,B],0,A):H.renderer(d,c,B),B=d,"undefined"!==typeof v&&(u.setAttributes({text:String(v),
translationX:f.centerX-a.roundPixel(b)/f.max*f.length*Math.cos(f.baseRotation+Math.PI/2),translationY:f.centerY-a.roundPixel(b)/f.max*f.length*Math.sin(f.baseRotation+Math.PI/2)},!0),u.applyTransformations(),F=u.attr.matrix.transformBBox(u.getBBox(!0)),!J||x(F,J)))&&(a.renderSprite(u),J=F,E+=F.width,z++)});else if("angular"===h)L=f.majorTickSize+.5*f.lineWidth+(parseInt(u.attr.fontSize,10)||10)/2,e.iterate(k,function(b,d,e){void 0!==d&&(v=C?Ext.callback(C,null,[A,d,c,B],0,A):H.renderer(d,c,B),B=d,
p=Math.max(p,Math.max(f.majorTickSize,f.minorTickSize)+("butt"!==f.lineCap?.5*f.lineWidth:0)),"undefined"!==typeof v&&(b=b/(f.max+1)*Math.PI*2+f.baseRotation,u.setAttributes({text:String(v),translationX:f.centerX+(f.length+L)*Math.cos(b),translationY:f.centerY+(f.length+L)*Math.sin(b)},!0),u.applyTransformations(),F=u.attr.matrix.transformBBox(u.getBBox(!0)),!J||x(F,J)))&&(a.renderSprite(u),J=F,E+=F.width,z++)});else if("gauge"===h){var D=e.getGaugeAngles();e.iterate(k,function(b,d,e){void 0!==d&&
(v=C?Ext.callback(C,null,[A,d,c,B],0,A):H.renderer(d,c,B),B=d,"undefined"!==typeof v&&(b=(b-f.min)/(f.max-f.min+1)*f.totalAngle-f.totalAngle+D.start,u.setAttributes({text:String(v),translationX:f.centerX+(f.length+10)*Math.cos(b),translationY:f.centerY+(f.length+10)*Math.sin(b)},!0),u.applyTransformations(),F=u.attr.matrix.transformBBox(u.getBBox(!0)),!J||x(F,J)))&&(a.renderSprite(u),J=F,E+=F.width,z++)})}f.enlargeEstStepSizeByText&&z&&(E/=z,E+=s,E*=2,f.estStepSize<E&&(f.estStepSize=E));if(1<Math.abs(e.thickness-
...
single:!0},render:function(a){a.getTargetEl().dom.className=""}}}))},loadedCorpus:function(a,b){if(0==this.hasCorpusAccess(b)&&!this.getApiParam("panels")){var c=this.query("voyanttabpanel");c[1].add({xtype:"termsradio"});c[1].setActiveTab(1);c[1].getActiveTab().fireEvent("loadedCorpus",a,b);c[4].setActiveTab(1)}30<b.getDocumentsCount()&&(c=this.down("bubblelines"))&&c.up("voyanttabpanel").remove(c)},panelChange:function(a){var b=[];this.query("voyanttabpanel").forEach(function(a){b.push(a.getActiveTab().xtype)});
this.getApplication().setApiParam("panels",b.join(","))}}});Ext.define("Voyant.panel.ScatterSet",{extend:"Ext.panel.Panel",requires:["Voyant.panel.ScatterPlot","Voyant.panel.Documents","Voyant.panel.Trends","Voyant.panel.Contexts"],mixins:["Voyant.panel.Panel"],alias:"widget.scatterset",statics:{i18n:{},glyph:"xf17a@FontAwesome"},constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},layout:"hbox",header:!1,items:[{flex:3,height:"100%",xtype:"scatterplot"},{split:{width:5},flex:1,height:"100%",
...
this.sendApiParamMessage()})},sendApiParamMessage:function(){this.getApiParam("message")&&(this.getCorpus()?this.handleUserSentence(this.getApiParam("message")):Ext.defer(this.sendApiParamMessage,100,this))},handleUserSentence:function(a,b){if((a=a.trim())||b){a&&this.addSentence("myMessage",a);this.mask();var c=this,d=this.getComponent("script").down("textarea");Ext.Ajax.request({url:this.getApplication().getTromboneUrl(),params:{corpus:c.getCorpus()?c.getCorpus().getId():void 0,tool:"corpus.Veliza",
sentence:a,fromCorpus:b?!0:!1,script:d.isDirty()?d.getValue():this.getApiParam("script"),noCache:Ext.id()},success:function(a,f){c.unmask();a=Ext.decode(a.responseText);a.veliza.id&&(c.setApiParam("script",a.veliza.id),d.resetOriginalValue());var g=a.veliza.response,h=g.match(/<\!-- (.+?) --\x3e/);if(h){h=Ext.decode(h[1]);for(key in h.params)h.params[key]=h.params[key].trim();g+="\x3cbr/\x3e\x3ciframe width\x3d'"+(h.width?h.width:"100%")+"' height\x3d'"+(h.height?h.height:"250px")+"' src\x3d'"+c.getApplication().getBaseUrl()+
"tool/"+h.tool+"/?corpus\x3d"+c.getCorpus().getId()+"\x26minimal\x3dtrue\x26"+Ext.Object.toQueryString(h.params)+"'\x3e\x3c/iframe\x3e"}h=a.veliza.sentence;c.setPrevious(a.veliza.previous);b?(meta=-1<a.veliza.docIndex?c.getCorpus().getDocument(a.veliza.docIndex).getShortLabel():void 0,c.addSentence("myMessage",h,meta),Ext.Function.defer(function(){this.addSentence("fromThem",g);this.body.scroll("b",Infinity)},500,c)):(c.addSentence("fromThem",g),c.body.scroll("b",Infinity))},failure:function(a,b){c.showResponseError("Unable to get response from Veliza.",
a)}})}},addSentence:function(a,b,c){var d=this.getComponent("chat").body;d.down("form").insertHtml("beforeEnd",'\x3cdiv class\x3d"message"\x3e\x3cdiv class\x3d"'+a+'"\x3e\x3cp\x3e'+b+"\x3c/p\x3e"+(c?"\x3cdate\x3e"+c+"\x3c/date\x3e":"")+"\x3c/div\x3e\x3c/div\x3e",!0);d.scroll("b",Infinity)}});Ext.define("Voyant.panel.WordTree",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.wordtree",statics:{i18n:{},api:{query:void 0,docId:void 0,docIndex:void 0,stopList:"auto",context:10,limit:100},glyph:"xf0e8@FontAwesome"},config:{tree:void 0,kwicStore:void 0,options:{xtype:"stoplistoption"},numBranches:5,lastClick:1},doubleClickDelay:300,constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(){Ext.apply(this,
...
layout:{type:"hbox",pack:"start",align:"stretch"},store:{fields:["topic","scores"],data:[]},columns:[{text:this.localize("topic"),tooltip:this.localize("topicTip"),flex:3,dataIndex:"topic",sortable:!1},{xtype:"widgetcolumn",text:this.localize("scores"),tooltip:this.localize("scoresTip"),flex:1,dataIndex:"scores",widget:{xtype:"sparklineline",tipTpl:new Ext.XTemplate("{[this.getDocumentTitle(values.x,values.y)]}",{getDocumentTitle:function(a,b){return this.panel.getCorpus().getDocument(a).getTitle()+
"\x3cbr\x3ecoverage: "+Ext.util.Format.number(100*b,"0,000.0")+"%"},panel:this})}}],dockedItems:{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:['\x3cspan class\x3d"info-tip" data-qtip\x3d"'+this.localize("searchTip")+'"\x3e'+this.localize("search")+"\x3c/span\x3e",{xtype:"textfield",name:"searchField",hideLabel:!0,width:80,listeners:{change:{fn:this.onTextFieldChange,scope:this,buffer:500}}},'\x3cspan class\x3d"info-tip" data-qtip\x3d"'+this.localize("limitTermsTip")+'"\x3e'+this.localize("limitTerms")+
"\x3c/span\x3e",{width:80,hideLabel:!0,xtype:"slider",increment:1,minValue:1,maxValue:100,listeners:{afterrender:function(a){a.setValue(parseInt(this.getApiParam("limit")))},changecomplete:function(a,b){this.setApiParams({limit:b});this.postSweep()},scope:this}},'\x3cspan class\x3d"info-tip" data-qtip\x3d"'+this.localize("numTopicsTip")+'"\x3e'+this.localize("numTopics")+"\x3c/span\x3e",{width:80,hideLabel:!0,xtype:"slider",increment:1,minValue:1,maxValue:200,listeners:{afterrender:function(a){a.setValue(parseInt(this.getApiParam("numTopics")))},
changecomplete:function(a,b){this.setApiParams({numTopics:b});this.loadFromExistingDocuments()},scope:this}},{text:(new Ext.Template(this.localize("runIterations"))).apply([100]),itemId:"iterations",glyph:"xf04b@FontAwesome",tooltip:this.localize("runIterationsTip"),handler:this.runIterations,scope:this},{xtype:"tbtext",itemId:"done"},{xtype:"tbfill"},{xtype:"tbtext",html:this.localize("adaptation")}]}});this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);
this.resetData();var b=parseInt(this.getApiParam("numTopics"));this.setTokensPerTopic(this.zeros(b));this.setTopicWeights(this.zeros(b));this.on("loadedCorpus",function(a,b){this.setCorpus(b);if(this.rendered)this.initialize();else this.on("afterrender",function(){this.initialize()},this)});this.on("query",function(a,b){this.setApiParam("query",b);this.updateSearchResults()})},loadStopwords:function(){this.mask(this.localize("loadingStopWords"));Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"resource.KeywordsManager",
stopList:this.getApiParam("stopList"),corpus:this.getCorpus()?this.getCorpus().getAliasOrId():void 0},success:function(a,b){this.unmask();var c={};Ext.util.JSON.decode(a.responseText).keywords.keywords.forEach(function(a){c[a]=1});this.setStopwords(c);this.loadDocuments()},scope:this})},loadDocuments:function(){this.mask(this.localize("loadingDocuments"));var a=this.getCorpus();a&&Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"corpus.DocumentTokens",corpus:a.getAliasOrId(),outputFormat:"text",
template:"docTokens2idsAndText",limit:0,noOthers:!0,perDocLimit:1==a.getDocumentsCount()?void 0:parseInt(this.getApiParam("perDocLimit"))},success:function(b,c){this.unmask();this.mask(this.localize("parsingDocuments"));var d=b.responseText.trim().split(/(\r\n|\r|\n)/);if(1==d.length){if(d=d[0].split(": "),1<d.length)for(var e=a.getDocument(d[0]),f=d[1].split(" "),e=e.getLexicalTokensCount(),e=10>e?e:1E3>e?10:100,e=10,g=Math.floor(f.length/e),h=0;h<e;h++){var k=f.slice(h*g,h*g+g).join(" ");this.parseLine(d[0]+
"-"+h+"\t"+d[0]+"-"+h+"\t"+k)}}else d.forEach(function(b){b=b.split(": ");if(1<b.length){var c=a.getDocument(b[0]);this.parseLine(b[0]+"\t"+c.getTinyLabel()+"\t"+b[1])}},this);this.unmask();this.runIterations()},scope:this})},resetData:function(){var a=parseInt(this.getApiParam("numTopics"));this.setVocabularyCounts({});this.setSumDocSortSmoothing(this.getDocSortSmoothing()*a);this.setRequestedSweeps(0);this.setWordTopicCounts({});this.setTopicWordCounts([]);this.setTokensPerTopic([]);this.setTopicWeights(Array(a));
this.setDocuments([]);this.setTotalIterations(0)},loadFromExistingDocuments:function(){var a=this.getDocuments().map(function(a){return a.id+"\t"+a.date+"\t"+a.originalText});this.resetData();a.forEach(function(a){this.parseLine(a)},this);this.runIterations()},runIterations:function(){var a=this.getRequestedSweeps(),b=parseInt(this.getApiParam("iterations")),a=a+parseInt(b);this.setTotalIterations(this.getTotalIterations()+b);this.setRequestedSweeps(a);this.getProgress()||(b=Ext.MessageBox.show({title:this.localize("runningIterations"),
message:(new Ext.Template(this.localize("runningIterationsCount"))).apply([a]),progress:!0,progressText:"",target:a,customUpdateProgress:function(a){this.updateProgress((this.config.target-a)*this.config.target," iterations")}}),this.setProgress(b),this.updateProgress(a));this.sweep()},updateProgress:function(a){var b=this.getProgress();a=this.getRequestedSweeps();if(b){var c=b.cfg.target;a=(c-a)/c;b.updateProgress(a,100*parseInt(a)+"% done")}},sweep:function(){Date.now();for(var a=parseInt(this.getApiParam("numTopics")),
b=this.getVocabularySize(),c=this.getTopicWordSmoothing(),d=this.getTokensPerTopic(),e=this.getDocuments(),f=this.getWordTopicCounts(),g=this.getTopicWeights(),h=this.getDocumentTopicSmoothing(),k=this.zeros(a),l=0;l<a;l++)k[l]=1/(b*c+d[l]);for(var m=0;m<e.length;m++)for(var n=e[m],q=n.topicCounts,r=0;r<n.tokens.length;r++){var p=n.tokens[r];if(!p.isStopword){d[p.topic]--;var s=f[p.word];s[p.topic]--;q[p.topic]--;k[p.topic]=1/(b*c+d[p.topic]);for(var x=0,l=0;l<a;l++)g[l]=s[l]?(h+q[l])*(c+s[l])*k[l]:
(h+q[l])*c*k[l],x+=g[l];l=x*Math.random();x=0;for(l-=g[x];0<l;)x++,l-=g[x];p.topic=x;d[p.topic]++;s[p.topic]=s[p.topic]?s[p.topic]+1:1;q[p.topic]++;k[p.topic]=1/(b*c+d[p.topic])}}a=this.getRequestedSweeps()-1;this.setRequestedSweeps(a);b=this.getProgress();0<a?(this.updateProgress(a),Ext.defer(this.sweep,0,this)):(b.close(),this.setProgress(void 0),this.postSweep())},postSweep:function(){this.sortTopicWords();var a=this.getStore(),b=(new Ext.Template(this.localize("totalDone"))).apply([Ext.util.Format.number(parseInt(this.getTotalIterations()),
"0,000")]);this.down("#done").setHtml(b);for(var b=parseInt(this.getApiParam("numTopics")),c=this.getTopicWordCounts(),d=[],e=this.getDocuments(),f=this.getDocSortSmoothing(),g=this.getSumDocSortSmoothing(),h=parseInt(this.getApiParam("limit")),k=0;k<b;k++){var l=e.map(function(a,b){return(a.topicCounts[k]+f)/(a.tokens.length+g)});d.push({topic:this.topNWords(c[k],h),scores:l})}a.loadData(d)},topNWords:function(a,b){return a.slice(0,b).map(function(a){return a.word}).join(" ")},sortTopicWords:function(){for(var a=
...
originalJson:"Original JSON string",exportJson:"Spiral Notebook data format (JSON)",exportHtml:"HTML (suitable for saving or printing)",editsAndLeaving:"It looks like you've been editing content and you will lose any content if you follow this link. Continue?",fetchingNotebook:"Fetching notebook\u2026",openTip:"Open a Spiral Notebook (by pasting in JSON code).",newTip:"Create a new Spiral Notebook in a new window.",runallTip:"Run all code blocks in this notebook",differentUrlTitle:"Notebook from Different URL",
...
""),d=d.substring(d.indexOf("/spiral/")+8),e=d.split("/"),f=e.shift();f&&1<e.length&&"/"==d.charAt(d.length-1)&&(d=d.slice(0,-1));if(f&&"new"!=f){if("gist"==f)return this.loadFromUrl(d,c);"alta/"==d&&b&&b.all&&"true"==b.all?(this.loadFromUrl("alta/Start",c),this.loadFromUrl("alta/Create",c),this.loadFromUrl("alta/SmallerCorpus",c),this.loadFromUrl("alta/Tables",c)):(-1==d.indexOf("/")&&this.getSaveItTool()&&this.getSaveItTool().setVisible(!0),this.loadFromUrl(d,c))}else this.getSaveItTool()&&this.getSaveItTool().setVisible(!0),
this.loadData(void 0,c)}a=this;window.addEventListener("beforeunload",function(b){if(a.getIsEdited()){var c=a.localize("editsAndLeaving");return(b||window.event).returnValue=c}})},setIsEdited:function(a){if(this.getSaveItTool()&&(this.getSaveItTool().setDisabled(0==a),!this.getAutoSaveTimer()&&this.getMetadata().previousNotebook)){var b=this;this.setAutoSaveTimer(setTimeout(function(){Ext.Ajax.request({url:b.getTromboneUrl(),params:{tool:"notebook.NotebookManager",jsonData:Ext.encode(b.getExportAllJson()),
notebook:b.getMetadata().previousNotebook,autosave:!0},scope:this}).then(function(a,d){var e=Ext.decode(a.responseText);b.toastInfo({html:e&&e.notebook&&e.notebook.notebook?b.localize("autoSaved"):b.localize("autoSavedFailed"),anchor:"br"})},function(a,d){b.showResponseError(b.localize("autoSavedFailed"),a)})},3E4))}this.callParent(arguments)},listeners:{boxready:function(){this.init()},notebookWrapperMoveUp:function(a){a=this.items.findIndex("id",a.id);0==a?Ext.Msg.show({title:this.localize("error"),
msg:this.localize("cannotMoveHigher"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.WARNING}):(this.move(a,a-1),this.redoOrder())},notebookWrapperMoveDown:function(a){a=this.items.findIndex("id",a.id);a==this.items.getCount()-1?Ext.Msg.show({title:this.localize("error"),msg:this.localize("cannotMoveLower"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.WARNING}):(this.move(a,a+1),this.redoOrder())},notebookWrapperRemove:function(a){this.remove(a);this.redoOrder()},notebookWrapperRun:function(a){},
notebookWrapperAdd:function(a,b){var c=this.items.findIndex("id",a.id),d=a.getXType(a);("notebooktexteditorwrapper"==d&&!b.hasModifier()||"notebookcodeeditorwrapper"==d&&b.hasModifier()?this.addCode("",c+1):this.addText("",c+1)).getTargetEl().scrollIntoView(this.getTargetEl(),null,!0,!0);this.redoOrder()}},redoOrder:function(){this.query("notebookwrappercounter").forEach(function(a,b){a.setOrder(b)})},loadFromUrl:function(a,b){var c=this;if(0==a.indexOf("https://gist.github.com/")||0==a.indexOf("https://gist.githubusercontent.com/"))a=
"gist:"+a.substring(a.indexOf(".com")+5,a.length-("/"==a.charAt(a.length-1)?1:0)).replace(/\//g,":");if(0==a.indexOf("gist:")){var d=a.substring(5).split(":");if(2>d.length)return this.showError(this.localize("invalidGistUrl"));d[2]&&"raw"==d[2]&&d.splice(2,1);var e="gist:"+d.slice(0,3).join(":");window.history.pushState({url:a},"Spiral Notebook: "+e,this.getBaseUrl()+"spiral/"+e);a="https://gist.githubusercontent.com/"+d.slice(0,2).join("/")+"/raw/"+(d[2]?d[2]:"")}else 0==a.indexOf("http")&&window.history.pushState({url:a},
"Spiral Notebook: "+a,this.getBaseUrl()+"spiral/?input\x3d"+a);c.mask(this.localize("fetchingNotebook"));Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"notebook.NotebookManager",notebook:a},scope:this}).then(function(d,e){c.unmask();var h=Ext.decode(d.responseText),k=c.getBlocksFromString(h.notebook.jsonData);k.metadata=k.metadata||{};k.metadata.previousNotebook=a;Ext.applyIf(k.metadata,{originalUrl:a});if(k&&k.metadata&&k.metadata.url){var l;try{l=new URL(k.metadata.url)}catch(m){}if(l&&
l.hostname!=window.location.hostname)return Ext.Msg.confirm(c.localize("differentUrlTitle"),(new Ext.XTemplate(c.localize("differentUrl"))).apply([k.metadata.url,window.location.href]),function(a){c.loadData(k,"yes"==a)},c)}c.loadData(k,b);Ext.Ajax.request({url:c.getTromboneUrl(),params:{tool:"notebook.NotebookManager",notebook:a,autosave:!0,noCache:!0,failQuietly:!0},scope:c}).then(function(a,d){var e=Ext.decode(a.responseText),f=c.getBlocksFromString(e.notebook.jsonData);f.metadata=f.metadata||
{};if(f.metadata.modified>c.getMetadata().modified)return Ext.Msg.confirm(c.localize("autoSaveAvailableTitle"),c.localize("autoSaveAvailable"),function(a){"yes"==a&&(c.removeAll(),c.loadData(f,b))},c)},function(a,b){})},function(b,d){c.showResponseError("Unable to load specified notebook: "+a,b);c.unmask();c.loadData()})},loadData:function(a,b){a||(a={blocks:[{type:"text",input:"\x3ch1 style\x3d'text-align: center;'\x3eSpiral Notebook Template (title)\x3c/h1\x3e\x3cp\x3eThis is a Spiral Notebook, a dynamic document that combines writing, code and data in service of reading, analyzing and interpreting digital texts.\x3c/p\x3e\x3cp\x3eSpiral Notebooks are composed of text blocks (like this one) and code blocks (like the one below). You can \x3cspan class\x3d'marker'\x3eclick on the blocks to edit\x3c/span\x3e them and add new blocks by clicking add icon that appears in the left column when hovering over a block.\x3c/p\x3e"},
{input:'new Corpus("Hello Spiral!").show();',output:' \x3cdiv class\x3d"info"\x3eThis corpus has 1 document with 2 \x3cspan class\x3d"info-tip" data{-qtip\x3d"every occurrence of every word (like multiple occurrences of \x26quot;the\x26qu{ot;) is counted"\x3etotal words\x3c/span\x3e and 2 \x3cspan class\x3d"info-tip" data-qtip\x3d"mult{iple occurrences of words (like \x26quot;the\x26quot;) are counted once"\x3eunique word f{orms\x3c/span\x3e. Created \x3cspan class\x3d"info-tip" data-qtip\x3d"2016-05-07, 15:51:18"\x3eabo{ut 26 days ago\x3c/span\x3e.\x3c/div\x3e'.split("{")}]});
...
input:this.wrap(d)};a.push(b)},this);var e=this.getMetadata();Ext.applyIf(e,{created:(new Date).getTime(),modified:(new Date).getTime(),version:this.getVersion(),url:window.location.href});Ext.apply(e,{modified:(new Date).getTime()});return{metadata:e,blocks:a}},exportAll:function(){var a=this.getExportAllJson();1==a.blocks.length&&"code"==a.blocks[0].type&&(a.blocks=blocks[0].input);Ext.Msg.prompt("Export Notebook","Currently only copying and pasting the notebook is available. You can select all the contents of the box below and copy to the clipboard.",
...
1;b<c;b++)a+="../";return a},getTools:function(){return[{type:"maximize"},{type:"help"}]},launch:function(){Ext.tip.QuickTipManager.init();Ext.apply(Ext.tip.QuickTipManager.getQuickTip(),{showDelay:50});this.callParent(arguments)},tromboneCall:function(a){a=a?a:{};Ext.applyIf(a,{url:this.getTromboneUrl()});a.success||a.failure||a.callback||Ext.applyIf(a,{url:this.getTromboneUrl(),scope:this,callback:function(b,c,d){this.dispatchEvent(a.tool+"Loaded",b,c,d)}});Ext.Ajax.request(a)},getViewport:function(){return Ext.ComponentQuery.query("viewport")[0]},
dispatchEvent:function(a,b){var c=this.getViewport().query("panel,chart"),d=!1;this.hasListener&&this.hasListener(a)&&(this.fireEvent.apply(this,arguments),d=!0);for(var e=0;e<c.length;e++)!c[e].hasListener||!c[e].hasListener(a)||b&&b.getId&&c[e].getId&&b.getId()==c[e].getId()||(d=!0,c[e].fireEvent.apply(c[e],arguments));if(!d){c=["unhandledEvent",b,a];for(e=2;e<arguments.length;e++)c.push(arguments[e]);this.fireEvent.apply(this,c)}},showResponseError:function(a,b){this.showError(Ext.create("Voyant.util.ResponseError",
{msg:Ext.isString(a)?a:a.msg,response:b}))},showError:function(a,b){if(a instanceof Voyant.util.ResponseError)a={message:a.getMsg()+"\x3cp class\x3d'error'\x3e\n"+a.getError()+" \u2026 \x3ca href\x3d'#' onclick\x3d\"window.open('').document.write(unescape('\x3cpre\x3e"+escape(a.getDetails())+"\x3c/pre\x3e')); return false;\"\x3emore\x3c/a\x3e\x3c/p\x3e"};else if(Ext.isString(a))a={message:a};else if(Ext.isObject(a)&&(a.responseText||a.statusText))return this.showResponseError(a.statusText,a);Ext.applyIf(a,
{title:this.localize("error"),buttons:Ext.Msg.OK,icon:Ext.MessageBox.ERROR,autoScroll:!0});Ext.Msg.show(a)},getToolConfigFromToolXtype:function(a){cls=Ext.ClassManager.getByAlias("widget."+a);return{xtype:a,title:this._localizeClass(cls,"title"),tooltip:{text:this._localizeClass(cls,"helpTip")},glyph:cls&&cls.glyph?cls.glyph:"xf12e@FontAwesome"}},palettes:{"default":[[0,0,255],[51,197,51],[255,0,255],[121,51,255],[28,255,255],[255,174,0],[30,177,255],[182,242,58],[255,0,164],[51,102,153],[34,111,
52],[155,20,104],[109,43,157],[128,130,33],[111,76,10],[119,115,165],[61,177,169],[202,135,115],[194,169,204],[181,212,228],[182,197,174],[255,197,197],[228,200,124],[197,179,159]]},rgbToHex:function(a){return"#"+(16777216+(a[0]<<16)+(a[1]<<8)+a[2]).toString(16).slice(1)},hexToRgb:function(a){a=a.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i,function(a,c,d,e){return c+c+d+d+e+e});return(a=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(a))?[parseInt(a[1],16),parseInt(a[2],16),parseInt(a[3],16)]:null},
addColorPalette:function(a,b){this.palettes[a]=b},getColorPalette:function(a,b){var c=a||this.getApiParam("palette")||"default",c=this.palettes[c];void 0===c&&(c=[]);if(b){for(var d=[],e=0;e<c.length;e++)d.push(this.rgbToHex(c[e]));return d}return c},getColor:function(a,b){var c=this.getApiParam("palette")||"default",c=this.palettes[c];a>=c.length&&(a%=c.length);return b?this.rgbToHex(c[a]):c[a]},colorTermAssociations:new Ext.util.MixedCollection,getColorForTerm:function(a,b){-1!=a.indexOf(":")&&
(a=a.split(":")[1]);var c=this.colorTermAssociations.get(a);if(null==c){var c=this.getApiParam("palette")||"default",c=this.palettes[c],d=this.colorTermAssociations.getCount()%c.length,c=c[d];this.colorTermAssociations.add(a,c)}b&&(c=this.rgbToHex(c));return c},openUrl:function(a){window.open(a)||Ext.Msg.show({title:"Popup Blocked",buttonText:{ok:"Close"},icon:Ext.MessageBox.INFO,message:"A popup window was blocked. \x3ca href\x3d'"+a+"' target\x3d'_blank' class\x3d'link'\x3eClick here\x3c/a\x3e to open the new window.",
...
Ext.Ajax.request({url:b.getTromboneUrl(),params:{tool:"resource.StoredResource",retrieveResourceId:this.getApiParam("embeddedApiId")}}).then(function(e){d.resolve();e=Ext.util.JSON.decode(e.responseText);e=decodeURIComponent(e.storedResource.resource);e=Ext.decode(e);e.xtype=b.getTool();var f=Ext.create(e);f.setApiParams(e);a.unmask();a.remove(a.down("container"));a.add(f);e.corpus&&b.loadCorpusFromParams(e)}).otherwise(function(a){b.getTargetEl&&(Voyant.notebook.util.Show.TARGET=b.getTargetEl(),
showError(a));Voyant.application.showError(a);d.reject()})}},scope:this}});Ext.create("Ext.container.Viewport",{layout:"border",items:a});this.callParent(arguments)}});