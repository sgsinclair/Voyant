...
c.charAt(0)?c.substring(1):c,k;for(k in d.getApplication().getCategoriesManager().getCategories())-1<k.toLowerCase().indexOf(g)&&(a.query="@"+k+("@"==c.charAt(0)?"":","+a.query))}}},this);b.on("change",function(a,c){b.isClearing?b.isClearing=!1:(c=c.map(function(a){return a.replace(/^(\^?)\*/,"$1.*")}),b.up("panel").fireEvent("query",b,c),b.getClearOnQuery()&&(b.isClearing=!0,b.removeValue(b.getValueRecords())),b.triggers.count&&(b.triggers.count.show(),b.triggers.count.getEl().setHtml("0"),0<c.length?
b.getCorpus().getCorpusTerms().load({params:{query:c.map(function(a){return"("+a+")"}).join("|"),tokenType:b.getTokenType(),stopList:b.getStopList(),inDocumentsCountOnly:!0},callback:function(a,c,d){d&&a&&1==a.length&&b.triggers.count.getEl().setHtml(a[0].getInDocumentsCount())}}):b.triggers.count.hide()))});var c=b.findParentBy(function(a){return a.mixins["Voyant.panel.Panel"]});if(null!=c){this.setParentPanel(c);if(c.getCorpus&&c.getCorpus())b.on("afterrender",function(a){this.doSetCorpus(c.getCorpus())});
else c.on("loadedCorpus",function(a,c){b.doSetCorpus(c)},b);b.hasCorpusLoadedListener=!0}b.on("afterrender",function(a){!1!==b.hasCorpusLoadedListener||b.getCorpus()||(c=b.findParentBy(function(a){return a.mixins["Voyant.panel.Panel"]}),null==c&&(c=b.up("window").panel),a=c.getApplication().getCorpus(),void 0!==a?b.doSetCorpus(a):(c.on("loadedCorpus",function(a,c){b.doSetCorpus(c)},b),b.hasCorpusLoadedListener=!0));b.triggers&&b.triggers.help&&Ext.tip.QuickTipManager.register({target:b.triggers.help.getEl(),
...
"value"],data:[{name:"Horizontal",value:0},{name:"Vertical",value:90}]}}}},config:{corpus:void 0,builderWin:void 0,addCategoryWin:void 0,categoriesId:void 0},closeAction:"hide",modal:!0,height:250,width:500,constructor:function(a){a=a||{};a.panel?(this.panel=a.panel,this.app=this.panel.getApplication(),this.categoriesManager=this.app.getCategoriesManager()):window.console&&console.warn("can't find panel!");this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);this.callParent(arguments)},
initComponent:function(){Ext.apply(this,{header:!1,layout:"fit",onEsc:Ext.emptyFn,items:{xtype:"tabpanel",title:this.localize("title"),tabBarHeaderPosition:1,items:[{layout:"border",title:this.localize("categories"),items:[{title:this.localize("terms"),split:!0,width:250,region:"west",layout:"fit",items:{itemId:"terms",xtype:"grid",store:Ext.create("Voyant.data.store.CorpusTermsBuffered",{parentPanel:this}),viewConfig:{plugins:{ptype:"gridviewdragdrop",ddGroup:"terms",copy:!0,enableDrop:!1,dragZone:{getDragText:function(){var a=
"";this.dragData.records.forEach(function(b){a+=b.get("term")+", "});a=a.substr(0,a.length-2);20<a.length&&(a=a.substr(0,20)+"...");return a}}}},selModel:{mode:"MULTI"},columns:[{text:this.localize("term"),dataIndex:"term",flex:1,sortable:!0},{text:this.localize("rawFreq"),dataIndex:"rawFreq",width:"autoSize",sortable:!0},{text:this.localize("relativeFreq"),dataIndex:"relativeFreq",renderer:function(a){return Ext.util.Format.number(1E6*a,"0,000")},width:"autoSize",hidden:!0,sortable:!0}],dockedItems:[{dock:"bottom",
xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"querysearchfield"}]}],listeners:{query:function(a,b){this.setApiParam("query",b);a=this.queryById("terms").getStore();a.removeAll();a.load()},scope:this}}},{title:this.localize("categories"),itemId:"categories",region:"center",xtype:"panel",layout:{type:"hbox",align:"stretch"},scrollable:"x",dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{text:this.localize("addCategory"),handler:function(){this.getAddCategoryWin().show()},
scope:this},{text:this.localize("removeTerms"),handler:function(){this.queryById("categories").query("grid").forEach(function(a){a.getStore().remove(a.getSelection())},this)},scope:this}]}],items:[]}]},{layout:"fit",itemId:"features",title:this.localize("features"),xtype:"grid",scrollable:"y",store:Ext.create("Ext.data.JsonStore",{fields:["category"]}),columns:[{text:this.localize("category"),dataIndex:"category",sortable:!1,hideable:!1,flex:1}]}]},buttons:[{text:this.localize("cancel"),handler:function(a){this.setCategoriesId(void 0);
a.up("window").close()},scope:this},{text:this.localize("save"),handler:function(a){this.processFeatures();this.setColorTermsFromCategoryFeatures();this.app.saveCategoryData(this.categoriesManager.getCategoryExportData()).then(function(b){this.setCategoriesId(b);a.up("window").close()},function(){this.setCategoriesId(void 0);a.up("window").close()},null,this)},scope:this}],listeners:{show:function(){this.getCategoriesId()&&this.getCategoriesId()!=this.getApiParam("categories")?this.categoriesManager.loadCategoryData(this.getCategoriesId()).then(function(a){this.setColorTermsFromCategoryFeatures();
...
this.localize("confirmRemove"),function(b){"yes"===b&&this.removeCategory(a)},this)},scope:this}],store:Ext.create("Ext.data.JsonStore",{data:b,fields:["term"]}),viewConfig:{plugins:{ptype:"gridviewdragdrop",ddGroup:"terms",dragZone:{getDragText:function(){var a="";this.dragData.records.forEach(function(b){a+=b.get("term")+", "});return a.substr(0,a.length-2)}}}},selModel:{mode:"MULTI"},columns:[{dataIndex:"term",flex:1,sortable:!0}],listeners:{beforedrop:function(a,b){a=this.up("categoriesbuilder").categoriesManager;
for(var c=b.records.length-1;0<=c;c--){var d=b.records[c].get("term");void 0!==a.getCategoryForTerm(d)&&b.records.splice(c,1)}},drop:function(b,c){c.view.getSelectionModel().deselectAll();this.getSelectionModel().deselectAll();b=this.up("categoriesbuilder").categoriesManager;for(var d=[],e=0;e<c.records.length;e++){var f=c.records[e].get("term");void 0===b.getCategoryForTerm(f)&&d.push(f)}b.addTerms(a,d);c=c.view.up("grid");c.category&&b.removeTerms(c.category,d)}}}),f=new Ext.Editor({updateEl:!0,
alignment:"l-l",autoSize:{width:"boundEl"},field:{xtype:"textfield",allowBlank:!1,validator:function(a){return void 0===this.categoriesManager.getCategoryTerms(a)||a===e.getTitle()?!0:this.localize("exists")}.bind(this)},listeners:{complete:function(a,b,c){this.categoriesManager.renameCategory(c,b);this.buildFeatures()},scope:this}});e.header.getTitle().textEl.on("dblclick",function(a,b){f.startEdit(b)})},removeCategory:function(a){var b=this.queryById("categories"),c=b.queryBy(function(b){return b.category&&
b.category==a?!0:!1});b.remove(c[0]);b=this.queryById("features").getStore();b.removeAt(b.findExact("category",a));this.categoriesManager.removeCategory(a)},addFeature:function(a){this.categoriesManager.addFeature(a);this.buildFeatures()},buildFeatures:function(){this.queryById("features").getStore().removeAll();var a=["category"],b=[{sortable:!1,text:this.localize("category"),dataIndex:"category",flex:1}],c=[],d;for(d in this.categoriesManager.getCategories())c.push({category:d});var e=this.categoriesManager.getFeatures(),
f=Ext.ClassManager.getClass(this).features,g;for(g in e){a.push(g);e=f[g];var k=Ext.applyIf({feature:g,listeners:{change:function(a,b){if(a.rendered){var c=a.up("gridview").indexOf(a.el.up("table")),d=a.up("grid").getStore().getAt(c);d?d.set(a.feature,b):window.console&&console.warn("no record for",c,a)}},scope:this}},e);e.listeners&&Ext.applyIf(k.listeners,e.listeners);b.push({sortable:!1,hideable:!1,text:this.localize(g),dataIndex:g,flex:.5,xtype:"widgetcolumn",widget:k});for(d in this.categoriesManager.getCategories())for(e=
this.categoriesManager.getCategoryFeature(d,g),k=0;k<c.length;k++)if(c[k].category==d){c[k][g]=e;break}}a=Ext.create("Ext.data.JsonStore",{fields:a,data:c});this.queryById("features").reconfigure(a,b)},processFeatures:function(){var a=this.queryById("features").getStore(),b=Object.keys(this.categoriesManager.getFeatures());a.each(function(a){var c=a.get("category");b.forEach(function(b){var d=a.get(b);void 0!==d&&this.categoriesManager.setCategoryFeature(c,b,d)},this)},this)},setColorTermsFromCategoryFeatures:function(){for(var a in this.categoriesManager.getCategories()){var b=
...
50);a.setValue(this.getApiParam("visible"))},changecomplete:function(a,c){this.setApiParams({visible:c});this.loadFromTermsRecords()},scope:this}}]}]});this.callParent(arguments)},listeners:{boxready:function(){this.initVisLayout();var a=this.getApiParam("inlineData");if(void 0!==a){if("["==a.charAt(0))var b=Ext.decode(a,!0);else if(-1<a.indexOf(":"))b=[],a.split(",").forEach(function(a){parts=a.split(":");b.push({text:parts[0],rawFreq:parseInt(parts[1])})});else{var c={};b=[];a.split(",").forEach(function(a){a in
c?c[a]++:c[a]=1});for(term in c)b.push({text:term,rawFreq:c[term]})}null!==b&&0<b.length&&(this.setApiParam("inlineData",b),this.setTerms(b),this.buildFromTerms())}},resize:function(a,b,c){this.getVisLayout()&&this.getCorpus()&&(this.setAdjustedSizes(),a=this.getLayout().getRenderTarget(),b=a.getWidth(),c=a.getHeight(),a.down("svg").set({width:b,height:c}),this.getTerms()&&this.getVisLayout().size([b,c]).stop().words(this.getTerms()).start())},loadedCorpus:function(a,b){this.getApplication().getCategoriesManager().addFeature("font",
...
b){var c=this;this.getLayout().getRenderTarget();var d=this.getVisLayout().size()[0],e=this.getVisLayout().size()[1];b=b?Math.min(d/Math.abs(b[1].x-d/2),d/Math.abs(b[0].x-d/2),e/Math.abs(b[1].y-e/2),e/Math.abs(b[0].y-e/2))/2:1;var f=d3.transition().duration(1E3);a=this.getVis().selectAll("text").data(a,function(a){return a.text});a.exit().transition(f).style("font-size","1px").remove();var g=a.enter().append("text").text(function(a){return a.text}).attr("text-anchor","middle").attr("data-freq",function(a){return a.rawFreq}).attr("transform",
function(a){return"translate("+[a.x,a.y]+")rotate("+a.rotate+")"}).style("font-family",function(a){return c.getApplication().getCategoriesManager().getFeatureForTerm("font",a.text)}).style("fill",function(a){return c.getApplication().getColorForTerm(a.text,!0)}).style("font-size","1px").on("click",function(a){c.dispatchEvent("termsClicked",c,[a.text])}).on("mouseover",function(a){this.getTip().show()}.bind(this)).on("mousemove",function(a){var b=this.getTip();b.update(a.text+": "+a.rawFreq);a=Ext.get(this.getCirrusId()).dom;
a=d3.mouse(a);a[1]+=30;b.setPosition(a)}.bind(this)).on("mouseout",function(a){this.getTip().hide()}.bind(this));a.merge(g).transition(f).style("font-family",function(a){return c.getApplication().getCategoriesManager().getFeatureForTerm("font",a.text)}).style("fill",function(a){return c.getApplication().getColorForTerm(a.text,!0)}).attr("transform",function(a){return"translate("+[a.x,a.y]+")rotate("+a.rotate+")"}).style("font-size",function(a){return a.fontSize+"px"});this.getVis().transition(f).attr("transform",
...
this.DEFAULT_MODE?e.append("rect").style("stroke-width",1).style("stroke-opacity",1):e.filter(function(a){return"keyword"===a.type}).append("circle").style("stroke-width",1).style("stroke-opacity",1);e.append("text").attr("font-family",function(b){return a.getApplication().getCategoriesManager().getFeatureForTerm("font",b.term)}).attr("font-size",function(a){return Math.max(10,Math.sqrt(a.value))}).text(function(a){return a.term}).each(function(a){a.bbox=this.getBBox()}).style("cursor","pointer").style("user-select",
...
"_")}).attr("r",function(a){return a.r}).style("fill",function(a){return e(a.data.fillValue)}).style("stroke","#111").style("stroke-opacity",b.MIN_STROKE_OPACITY).style("stroke-width",1);a.append("clipPath").attr("id",function(a){return"clip-"+a.data.term.replace(/\W/g,"_")}).append("use").attr("xlink:href",function(a){return"#"+a.data.term.replace(/\W/g,"_")});a=a.append("text").attr("clip-path",function(a){return"url(#clip-"+a.data.term.replace(/\W/g,"_")+")"}).style("font-family",function(a){return b.getApplication().getCategoriesManager().getFeatureForTerm("font",
...
function(a){return this.getApplication().getCategoriesManager().getFeatureForTerm("color",a.term)}.bind(this)).style("cursor","pointer").style("user-select","none").attr("alignment-baseline","middle").text(function(a){return a.term});b.transition().duration(this.getTransitionTime()).attr("fill-opacity",1);b=b.merge(a);b.select("text").transition().duration(this.getTransitionTime()).attr("font-size",function(a){return a.fontSize});a.exit().transition().duration(this.getTransitionTime()).attr("fill-opacity",
...
b.commands.addCommand({name:"run",bindKey:{win:"Shift-Enter",mac:"Shift-Enter"},exec:function(b){(b=a.up("notebookcodeeditorwrapper"))&&b.run()}});b.commands.addCommand({name:"rununtil",bindKey:{win:"Command-Shift-Enter",mac:"Command-Shift-Enter"},exec:function(b){b=a.up("notebookcodeeditorwrapper");b.up("notebook").runUntil(b)}});this.setEditor(b);ace.config.loadModule("ace/ext/tern",function(b){a.getEditor().setOptions({enableTern:{defs:a.docs?["browser","ecma5",a.docs]:["ecma5","browser"],plugins:{doc_comment:{fullDocs:!0}},
...
items:[{xtype:"radiofield",boxLabel:a.localize("modeJavascript"),name:"codeMode",inputValue:"javascript",flex:1,listeners:{change:function(a,b,e){a=a.up().queryById("autoExecute");a.setHidden(!b);b||a.setValue(!1)}}},{xtype:"checkbox",boxLabel:a.localize("autoExecuteOnLoad"),name:"autoExecute",itemId:"autoExecute"}]},{xtype:"fieldset",title:a.localize("modeData"),items:[{items:{xtype:"radiofield",boxLabel:a.localize("modeJson"),name:"codeMode",inputValue:"json",flex:1}},{items:{xtype:"radiofield",
boxLabel:a.localize("modeText"),name:"codeMode",inputValue:"text",flex:1}},{items:{xtype:"radiofield",boxLabel:a.localize("modeHtml"),name:"codeMode",inputValue:"html",flex:1}},{items:{xtype:"radiofield",boxLabel:a.localize("modeXml"),name:"codeMode",inputValue:"xml",flex:1}}]}]}],buttons:[{text:a.localize("ok"),itemId:"ok"},{text:a.localize("cancel"),handler:function(a){a.up("window").close()},scope:this}]}));var b=a.getMode();this.configWin.down('radiofield[name\x3dcodeMode][inputValue\x3d"'+b+
'"]').setValue(!0);this.configWin.down("checkbox#autoExecute").setValue(a.getAutoExecute());this.configWin.down("button#ok").setHandler(function(b){b=b.up("window");var c=b.down("form");c.isDirty()&&(c=c.getValues(),a.switchModes(c.codeMode),a.setAutoExecute("on"===c.autoExecute),a.down("button#config").toggleCls("autoExecute","on"===c.autoExecute),a.up("notebook").setIsEdited(!0));b.close()});return this.configWin}},config:{isRun:!1,autoExecute:!1,mode:"javascript",isWarnedAboutPreviousCells:!1,
expandResults:!0,emptyResultsHeight:40,minimumResultsHeight:120},layout:{type:"vbox",align:"stretch"},height:150,border:!1,EMPTY_RESULTS_TEXT:" ",constructor:function(a){a.mode=void 0!==a.mode?a.mode:this.config.mode;var b=-1<a.mode.indexOf("javascript");this.editor=Ext.create("Voyant.notebook.editor.CodeEditor",{content:Ext.Array.from(a.input).join("\n"),docs:a.docs,mode:"ace/mode/"+a.mode});Ext.apply(this,{dockedItems:[{xtype:"toolbar",dock:"left",defaults:{textAlign:"left"},items:[{xtype:"notebookwrapperadd"},
{xtype:"notebookwrapperrun",hidden:!b,listeners:{click:{fn:this.run,scope:this}}},{glyph:"xf050@FontAwesome",tooltip:this.localize("runMultiple"),itemId:"runMultiple",hidden:!b,listeners:{click:{fn:function(a,b){Ext.create("Ext.menu.Menu",{items:[{text:this.localize("runUntil"),tooltip:this.localize("runUntilTip"),glyph:"xf049@FontAwesome",handler:function(){this.up("notebook").runUntil(this)},scope:this},{text:this.localize("runFrom"),tooltip:this.localize("runFromTip"),glyph:"xf050@FontAwesome",
handler:function(){this.up("notebook").runFrom(this)},scope:this}]}).showAt(b.pageX,b.pageY)},scope:this}}},{xtype:"button",itemId:"config",glyph:"xf013@FontAwesome",tooltip:this.localize("configureTip"),cls:a.autoExecute?"autoExecute":"",handler:function(a,b){Voyant.notebook.editor.CodeEditorWrapper.getConfigWindow(this).show()},scope:this},{xtype:"notebookwrapperexport",hidden:b}]},{xtype:"toolbar",dock:"right",items:[{xtype:"notebookwrappercounter",order:a.order,name:a.cellId},{xtype:"notebookwrapperremove"},
{xtype:"notebookwrappermoveup"},{xtype:"notebookwrappermovedown"}]}],items:[this.editor]});void 0!==a.uiHtml&&this.items.push(this._getUIComponent(a.uiHtml));this.results=this._getResultsComponent(Ext.Array.from(a.output).join(""),a);this.results.setVisible(b);this.items.push(this.results);this.callParent(arguments)},initComponent:function(a){var b=this;b.on("afterrender",function(){this.getTargetEl().on("resize",function(a){b._setResultsHeight();var c=20;b.items.each(function(a){c+=a.getHeight()});
b.setSize({height:c})})},this);b.callParent(arguments)},switchModes:function(a){this.setMode(a);this.editor.switchModes(a);a=-1<a.indexOf("javascript");this.down("notebookwrapperrun").setVisible(a);this.down("notebookwrapperexport").setVisible(!a);this.queryById("runMultiple").setVisible(a);this.results.setVisible(a)},run:function(a){if("ace/mode/javascript"===this.editor.getMode()){if(!0===a||this.getIsWarnedAboutPreviousCells())return this._run();var b=this.up("notebook");Ext.Array.each(b.query("notebookcodeeditorwrapper"),
function(a){if(a===this)return this._run(),!1;if(a.editor&&"ace/mode/javascript"===a.editor.getMode()&&!1===a.getIsRun())return Ext.Msg.confirm(this.localize("previousNotRunTitle"),this.localize("previousNotRun"),function(a){"yes"===a?b.runUntil(this):this._run()},this),this.setIsWarnedAboutPreviousCells(!0),!1},this)}},_run:function(){this.results.show();this.results.update(this.EMPTY_RESULTS_TEXT);this.results.mask("working\u2026");var a=this.editor.getValue();Voyant.notebook.util.Show.TARGET=this.results.getResultsEl();
Voyant.notebook.Notebook.currentBlock=this;Voyant.notebook.Notebook.currentNotebook.setCurrentBlock(this);try{var b=eval.call(window,a)}catch(d){return this.results.unmask(),Voyant.notebook.util.Show.showError(d),this.getTargetEl().fireEvent("resize"),d}this.setIsRun(!0);if(void 0!==b)if(b.then&&b.catch&&b.finally){var c=this;b.then(function(a){c.results.unmask();void 0!==a&&c._showResult(a)}).catch(function(a){c.results.unmask();Voyant.notebook.util.Show.showError(a)}).finally(function(){Ext.defer(function(){this.getTargetEl().fireEvent("resize")},
50,c)})}else this.results.unmask(),this._showResult(b),this.getTargetEl().fireEvent("resize");else this.results.unmask(),this.getTargetEl().fireEvent("resize");return b},_getResultsComponent:function(a,b){var c=this;b=void 0===b.expandResults?c.config.expandResults:b.expandResults;return Ext.create("Ext.Container",{itemId:"parent",cls:"notebook-code-results",height:c.config.emptyResultsHeight,layout:{type:"vbox",align:"stretch"},items:[{xtype:"container",flex:1,layout:{type:"absolute"},items:[{xtype:"component",
itemId:"results",x:0,y:0,anchor:"100%",height:"100%",html:a},{xtype:"toolbar",itemId:"buttons",hidden:!0,x:0,y:0,style:{background:"none",paddingTop:"0px",pointerEvents:"none"},defaults:{style:{pointerEvents:"auto"}},items:["-\x3e",{itemId:"expandButton",glyph:b?"xf066@FontAwesome":"xf065@FontAwesome",tooltip:b?"Contract Results":"Expand Results",handler:function(){c.results.doExpandContract()}},{xtype:"notebookwrapperexport",exportType:"output"},{glyph:"xf014@FontAwesome",tooltip:"Remove Results",
handler:function(){c.clearResults()}}]}]},{xtype:"component",itemId:"expandWidget",height:20,hidden:b?!0:!1,style:{textAlign:"center",fontSize:"26px",cursor:"pointer",borderTop:"1px solid #DDD"},html:"\x26#8943;",listeners:{afterrender:function(a){a.getEl().on("click",function(){c.results.doExpandContract()})}}}],getValue:function(){return this.getResultsEl().dom.cloneNode(!0).innerHTML},getResultsEl:function(){return this.down("#results").getEl()},doExpandContract:function(){var a=c.results.down("#expandButton");
c.getExpandResults()?(c.setExpandResults(!1),a.setTooltip("Expand Results"),a.setGlyph("xf065@FontAwesome")):(c.setExpandResults(!0),a.setTooltip("Contract Results"),a.setGlyph("xf066@FontAwesome"));c.getTargetEl().fireEvent("resize")},update:function(){var a=this.down("#results");a.update.apply(a,arguments)},listeners:{afterrender:function(a){a.getEl().on("mouseover",function(b,c){a.down("#buttons").setVisible(!0)});a.getEl().on("mouseout",function(b,c){a.down("#buttons").setVisible(!1)})}}})},_getUIComponent:function(a){return Ext.create("Ext.Component",
{align:"stretch",cls:"notebook-code-ui",padding:"20 10",html:a,getValue:function(){return this.getTargetEl().dom.cloneNode(!0).innerHTML}})},_showResult:function(a){if(this.results.getResultsEl().dom.innerHTML===this.EMPTY_RESULTS_TEXT)if(a.toString&&(a=a.toString()),a&&a.then){var b=this;a.then(function(a){b.results.update(a);return a})}else this.results.update(a)},_setResultsHeight:function(){var a=this._measureResultsHeight(),b=this.results.getResultsEl(),c=this.results.down("#expandWidget");this.getExpandResults()?
...
a,b)):(void 0===this.octokitWrapper&&this.initOctokitWrapper(),this.octokitWrapper.loadFile(a,b).then(function(a){c.setCurrentFile(a);c.fireEvent("fileLoaded",c,a)}))}});Ext.define("Voyant.notebook.StorageDialogs",{extend:"Ext.Component",requires:[],alias:"",config:{accessCode:void 0},constructor:function(a){a=a||{};this.callParent(arguments)},initComponent:function(){this.callParent(arguments)},showSave:function(a,b,c){c=void 0===c?"":c;var d=this,e=""===c;Ext.create("Ext.window.Window",{title:e?"Save New Notebook":"Overwrite Existing Notebook",items:[{xtype:"form",width:450,bodyPadding:5,plugins:["datatip"],listeners:{beforeshowtip:function(a,b,c){return!b.currentTarget.el.hasCls("x-form-invalid")}},
layout:"anchor",defaults:{labelAlign:"right",labelWidth:160,width:360,inputAttrTpl:'spellcheck\x3d"false"',xtype:"textfield"},items:[{fieldLabel:"Notebook ID"+(e?" (optional)":""),name:"notebookId",value:c,allowBlank:!0,readOnly:!e,tooltip:"An ID used to identify this notebook. If left blank, one will be generated for you.",validator:function(a){return""==a?!0:null===a.match(/^[\w-]{4,16}$/)?"The ID must be between 4 and 16 alphanumeric characters.":!0}},{fieldLabel:"Access Code",name:"accessCode",
allowBlank:!1,value:e?this.generateAccessCode():this.getAccessCode(),tooltip:"The Access Code is required to overwrite this notebook.",validator:function(a){return null===a.match(/^[\w-]{4,16}$/)?"The access code must be between 4 and 16 alphanumeric characters.":!0}},{fieldLabel:"Email (optional)",name:"email",allowBlank:!0,vtype:"email",hidden:!e,tooltip:"An email will be sent to this address with the Notebook URL and Access Code."}]}],buttons:[{text:"Cancel",ui:"default-toolbar",handler:function(){this.up("window").close();
d.fireEvent("saveCancelled",d)}}," ",{text:"Save",handler:function(c){var f=c.up("window"),k=f.down("form").getForm();if(k.isValid()){var h=k.getValues();h.data=a;h.metadata=b;e&&""!==h.notebookId?d.doesNotebookIdExist(h.notebookId).then(function(a){a?k.findField("notebookId").markInvalid("That Notebook ID already exists."):(d.doSave(h),f.close())}):(c.setDisabled(!0),d.doSave(h).then(function(a){c.setDisabled(!1);a?f.close():k.findField("accessCode").markInvalid("Invalid access code.")}))}}}],listeners:{close:function(){d.fireEvent("close",
d)}}}).show()},doesNotebookIdExist:function(a){var b=new Ext.Deferred;Spyral.Load.trombone({tool:"notebook.GitNotebookManager",action:"exists",id:a,noCache:1}).then(function(a){b.resolve("true"===a.notebook.data)}).catch(function(a){console.log(a)});return b.promise},doSave:function(a){var b=a.notebookId,c=a.accessCode,d=a.email,e=a.data;a=a.metadata;var f=this;a.id=b;return Spyral.Load.trombone({tool:"notebook.GitNotebookManager",action:"save",id:b,accessCode:c,email:d,data:e,metadata:JSON.stringify(a)}).then(function(a){if("true"!==
a.notebook.data)return!1;f.setAccessCode(c);f.fireEvent("fileSaved",f,a.notebook.id);return!0}).catch(function(a){f.fireEvent("fileSaved",f,null);return!1})},generateAccessCode:function(){for(var a="abcdefghijklmnopqrstuvwxyz".split(""),b="";6>b.length;)if(.3>Math.random())b+=Math.floor(9*Math.random());else{var c=a[Math.floor(Math.random()*a.length)];.5>Math.random()&&(c=c.toUpperCase());b+=c}return b}});Ext.define("Voyant.notebook.Catalogue",{extend:"Ext.Component",requires:[],alias:"widget.notebookcatalogue",statics:{i18n:{}},window:void 0,store:void 0,template:void 0,config:{},constructor:function(){this.store=Ext.create("Ext.data.JsonStore",{fields:[{name:"id"},{name:"author"},{name:"title"},{name:"description"},{name:"keywords"},{name:"language"},{name:"license"},{name:"created",type:"date"},{name:"modified",type:"date"},{name:"version"}]});this.template=new Ext.XTemplate('\x3ctpl for\x3d"."\x3e',
'\x3cdiv class\x3d"catalogue-notebook"\x3e','\x3cdiv class\x3d"id"\x3e{id}\x3c/div\x3e','\x3cdiv class\x3d"title"\x3e{title}\x3c/div\x3e','\x3cdiv class\x3d"author"\x3e{author}\x3c/div\x3e','\x3cdiv class\x3d"dates"\x3e\x3cspan class\x3d"date"\x3e{[Ext.Date.format(values.created, "M j Y")]}\x3c/span\x3e | \x3cspan class\x3d"date"\x3e{[Ext.Date.format(values.modified, "M j Y")]}\x3c/span\x3e\x3c/div\x3e',"\x3c/div\x3e","\x3c/tpl\x3e");this.callParent(arguments)},initComponent:function(a){this.callParent(arguments)},
showWindow:function(){void 0===this.window&&(this.window=Ext.create("Ext.window.Window",{title:"Notebooks Catalogue",width:700,height:550,layout:{type:"vbox"},closeAction:"hide",items:[{xtype:"toolbar",height:30,items:[{xtype:"splitbutton",text:"Sort",glyph:"xf161@FontAwesome",menu:{defaults:{xtype:"menucheckitem",group:"sortfield"},items:[{itemId:"id",text:"ID"},{itemId:"created",text:"Created"},{itemId:"modified",text:"Modified",checked:!0},{itemId:"title",text:"Title"},{itemId:"author",text:"Author"}],
listeners:{click:function(a,b){a="xf161@FontAwesome"===a.up().getGlyph().glyphConfig?"DESC":"ASC";this.store.sort(b.itemId,a);this.window.down("#catalogue").refresh()},scope:this}},handler:function(a){if("xf161@FontAwesome"===a.getGlyph().glyphConfig){a.setGlyph("xf160@FontAwesome");var b="ASC"}else a.setGlyph("xf161@FontAwesome"),b="DESC";a=a.menu.down("[checked\x3dtrue]").itemId;this.store.sort(a,b);this.window.down("#catalogue").refresh()},scope:this}]},{xtype:"dataview",flex:1,width:"100%",padding:10,
scrollable:"vertical",itemId:"catalogue",store:this.store,tpl:this.template,itemSelector:"div.catalogue-notebook",overItemCls:"catalogue-notebook-over",selectedItemCls:"catalogue-notebook-selected"}],buttons:[{text:"Load Selected Notebook",handler:function(a){a=this.window.down("#catalogue").getSelection()[0];void 0!==a&&this.fireEvent("notebookSelected",this,a.get("id"))},scope:this}]}));this.window.show();this.getNotebooks()},hideWindow:function(){void 0!==this.window&&this.window.close()},getNotebooks:function(a,
b){this.window.mask("Loading");this.window.down("#catalogue").getSelectionModel().deselectAll();var c=this;Spyral.Load.trombone({tool:"notebook.GitNotebookManager",action:"catalogue",noCache:1}).then(function(a){c.window.unmask();a=JSON.parse(a.notebook.data);c.store.loadRawData(a)}).catch(function(a){c.window.unmask()})}});Ext.define("Voyant.notebook.Notebook",{alternateClassName:["Notebook"],extend:"Ext.panel.Panel",requires:"Voyant.notebook.editor.CodeEditorWrapper Voyant.notebook.editor.TextEditorWrapper Voyant.notebook.util.Show Voyant.panel.Cirrus Voyant.panel.Summary Voyant.notebook.StorageDialogs Voyant.notebook.github.GitHubDialogs".split(" "),mixins:["Voyant.panel.Panel"],alias:"widget.notebook",statics:{i18n:{title:"Spyral",metadataEditor:"Edit Metadata",metadataTitle:"Title",metadataTip:"Edit notebook metadata.",
...
openMsg:"Paste in Notebook ID, a URL or a Spyral data file (in HTML).",exportHtmlDownload:"HTML (download)",errorParsingDomInput:"An error occurred while parsing the input of the document. The results might still work, except if the code contained HTML tags."},api:{input:void 0,inputEncodedBase64Json:void 0,run:void 0},currentNotebook:void 0},config:{notebookId:void 0,metadata:void 0,isEdited:!1,version:"3.0",currentBlock:void 0,storageSolution:"voyant"},voyantStorageDialogs:void 0,githubDialogs:void 0,
catalogueWindow:void 0,spyralTernDocs:void 0,constructor:function(a){Voyant.notebook.Notebook.currentNotebook=this;Ext.apply(a,{title:this.localize("title"),autoScroll:!0,includeTools:{help:!0,gear:!0,save:!0,saveIt:{tooltip:this.localize("saveItTip"),itemId:"saveItTool",xtype:"toolmenu",glyph:"xf0c2@FontAwesome",disabled:!0,items:[{text:"Save",xtype:"menuitem",glyph:"xf0c2@FontAwesome",handler:this.showSaveDialog.bind(this,!1),scope:this},{text:"Save As...",xtype:"menuitem",glyph:"xf0c2@FontAwesome",
handler:this.showSaveDialog.bind(this,!0),scope:this},"-",{text:"Storage",xtype:"menuitem",menu:{items:[{text:"Voyant",xtype:"menucheckitem",group:"storageSolution",checked:!0,handler:this.setStorageSolution.bind(this,"voyant"),scope:this},{text:"GitHub",xtype:"menucheckitem",group:"storageSolution",checked:!1,handler:this.setStorageSolution.bind(this,"github"),scope:this}]}}]},"new":{tooltip:this.localize("newTip"),callback:function(){var a=this.getBaseUrl()+"spyral/";this.getApplication().openUrl(a)},
...
this.addNew();if(b){var e=this;Ext.defer(function(){e.runAll()},100)}},scope:this})},setBlock:function(a,b,c,d){a=a||"";b=b||1;d=d||{};var e=this.query("notebookeditorwrapper"),f=this.getCurrentBlock().id,g=e.findIndex(function(a){return a.id==f});if(0>g+b||g+b>e.length)Ext.Msg.show({title:this.localize("error"),msg:this.localize("blockDoesNotExist"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR});else return e[g+b]&&this.getComponent("cells").remove(e[g+b]),this.addCode(Object.assign({},{input:a,
mode:c||"text"},d),g+b)},getBlock:function(a,b){a=a||0;b=b||{};var c=this.query("notebookcodeeditorwrapper"),d=this.getCurrentBlock().id,e=c.findIndex(function(a){return a.id==d});if(0>e+a||e+a>c.length-1)"failQuietly"in b&&b.failQuietly||Ext.Msg.show({title:this.localize("error"),msg:this.localize("blockDoesNotExist"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR});else return content=c[e+a].getContent(),content.input},addNew:function(){this.setMetadata(new Spyral.Metadata({title:"\x3ch1\x3eSpyral Notebook\x3c/h1\x3e"}));
...
Ext.defer(function(){a.run()},100,this)},clear:function(){this.setMetadata(new Spyral.Metadata);this.getComponent("cells").removeAll()},showSaveDialog:function(a){this.mask(this.localize("saving"));this.getMetadata().setDateNow("modified");var b=this.generateExportHtml(),c=this.getMetadata().clone(),d=document.createElement("div");c.title=d.textContent;d.innerHTML=c.description;c.description=d.textContent;d.remove();d=this.getStorageSolution();a||"voyant"!==d||void 0===this.getNotebookId()||void 0===
this.voyantStorageDialogs.getAccessCode()?"github"===d?this.githubDialogs.showSave(b):this.voyantStorageDialogs.showSave(b,c,a?void 0:this.getNotebookId()):this.voyantStorageDialogs.doSave({notebookId:this.getNotebookId(),data:b,metadata:c,accessCode:this.voyantStorageDialogs.getAccessCode()})},loadFromString:function(a){a=a.trim();if(0==a.indexOf("http"))this.loadFromUrl(a);else if(0==a.indexOf("{")){try{var b=JSON.parse(a)}catch(c){return Ext.Msg.show({title:this.localize("error"),msg:this.localize("cannotLoadJson")+
"\x3cbr\x3e\x3cpre style\x3d'color: red'\x3e"+c+"\x3c/pre\x3e",buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR})}if(!b.metadata||!b.blocks)return Ext.Msg.show({title:this.localize("error"),msg:this.localize("cannotLoadJsonUnrecognized"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR});b.blocks.forEach(function(a){Ext.isString(a)&&""!=a?this.addCode({input:a}):a.input&&("text"==a.type?this.addText(a):this.addCode(a))},this)}else if(/^[\w-_]+$/.test(a))this.loadFromId(a);else{if(0!==a.indexOf("\x3c")||
-1==a.indexOf("spyral"))return Ext.Msg.show({title:this.localize("error"),msg:this.localize("cannotLoadUnrecognized"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR});this.loadFromHtmlString(a)}return!0},loadFromId:function(a){this.mask(this.localize("loading"));var b=this;Spyral.Load.trombone({tool:"notebook.GitNotebookManager",action:"load",id:a,noCache:1}).then(function(a){b.unmask();b.loadFromString(a.notebook.data);a.notebook.id&&a.notebook.id!=b.getNotebookId()&&b.setNotebookId(a.notebook.id);
b.setIsEdited(!1)}).catch(function(a){b.unmask()})},loadFromHtmlString:function(a){var b=(new DOMParser).parseFromString(a,"text/html");this.setMetadata(new Spyral.Metadata(b));var c=!1;b.querySelectorAll("section.notebook-editor-wrapper").forEach(function(b){var d=b.classList;if(d.contains("notebooktexteditorwrapper"))d=b.querySelector(".notebook-text-editor").innerHTML,this.addText(d,void 0,b.id);else if(d.contains("notebookcodeeditorwrapper")){var f=b.querySelector(".notebook-code-editor-raw");
d=/\beditor-mode-(\w+)\b/.exec(f.className)[1];var g=a.indexOf("\x3csection id\x3d'"+b.id+"' class\x3d'notebook-editor-wrapper notebookcodeeditorwrapper'\x3e"),k=a.indexOf("\x3cpre class\x3d'notebook-code-editor-raw editor-mode-",g);k=a.indexOf("\x3e",k)+1;var h=a.indexOf("\x3c/pre\x3e\n\x3cdiv class\x3d'notebook-code-results",k);if(-1===g||-1===k||-1===h){c=!0;input="javascript"===d?f.innerText:f.innerHTML;debugger}else input=a.substring(k,h);f=null!==/\bautoexec\b/.exec(f.className);g=b.querySelector(".notebook-code-results").innerHTML;
k=!1===b.querySelector(".notebook-code-results").classList.contains("collapsed");h=b.querySelector(".notebook-code-ui");h=null!==h?h.innerHTML:void 0;this.addCode({input:input,output:g,expandResults:k,uiHtml:h,mode:d,autoExecute:f},void 0,b.id)}},this);c&&this.showError(this.localize("errorParsingDomInput"));this.fireEvent("notebookLoaded")},runUntil:function(a){var b=[];Ext.Array.each(this.query("notebookcodeeditorwrapper"),function(c){b.push(c);c.clearResults();if(a&&a==c)return!1},this);this._run(b)},
...
[a])}},autoExecuteCells:function(){var a=[];Ext.Array.each(this.query("notebookcodeeditorwrapper"),function(b){b.getAutoExecute()&&a.push(b)});this._run(a)},loadFromUrl:function(a,b){var c=this;Spyral.Load.text(a).then(function(a){c.loadFromString(a)})},addText:function(a,b,c){return this._add(a,b,"notebooktexteditorwrapper",c)},addCode:function(a,b,c,d){return this._add(a,b,"notebookcodeeditorwrapper",c,{docs:this.spyralTernDocs})},_add:function(a,b,c,d,e){Ext.isString(a)&&(a={input:a});var f=this.getComponent("cells");
...
this.redoOrder()},notebookWrapperAdd:function(a,b){var c=this.getComponent("cells").items.findIndex("id",a.id);a=a.getXType(a);("notebooktexteditorwrapper"==a&&!b.hasModifier()||"notebookcodeeditorwrapper"==a&&b.hasModifier()?this.addCode("",c+1):this.addText("",c+1)).getTargetEl().scrollIntoView(this.getTargetEl(),null,!0,!0);this.redoOrder()},redoOrder:function(){this.query("notebookwrappercounter").forEach(function(a,b){a.setOrder(b)});this.setIsEdited(!0)},setIsEdited:function(a){this.getHeader()&&
(this.getHeader().down("#saveItTool").setDisabled(0==a),a||(this.query("notebookcodeeditor").forEach(function(a){a.setIsChangeRegistered(!1)}),this.query("notebooktexteditor").forEach(function(a){a.setIsEditRegistered(!1)})));this.callParent(arguments)},setNotebookId:function(a){if(a&&-1===location.pathname.indexOf("/spyral/"+a)){var b=this.getBaseUrl()+"spyral/"+a+"/";window.history.pushState({url:b},"Spyral Notebook: "+a,b)}this.callParent(arguments)},generateExportHtml:function(){var a="\x3c!DOCTYPE HTML\x3e\n\x3chtml\x3e\n\x3chead\x3e\n\t\x3cmeta charset\x3d'UTF-8'\x3e\n"+
...
this.getHeaderHtml()+"\x3carticle class\x3d'spyralArticle'\x3e";this.getComponent("cells").items.each(function(b,d){var c=b.isXType("notebookcodeeditorwrapper")?"code":"text";d=b.getContent();var f=b.down("notebookwrappercounter");a+="\x3csection id\x3d'"+f.name+"' class\x3d'notebook-editor-wrapper "+b.xtype+"'\x3e\n\x3cdiv class\x3d'notebookwrappercounter'\x3e"+f.getTargetEl().dom.innerHTML+"\x3c/div\x3e";if("code"===c){c=b.down("notebookcodeeditor").getMode();c=c.substring(c.lastIndexOf("/")+1);
f=b.getExpandResults();var g=b.getAutoExecute()?"autoexec":"";b=b.getTargetEl().query(".ace_text-layer")[0].cloneNode(!0);b.style.setProperty("height","auto");a+="\x3cdiv class\x3d'notebook-code-editor ace-chrome'\x3e\n"+b.outerHTML+"\n\x3c/div\x3e\n\x3cpre class\x3d'notebook-code-editor-raw editor-mode-"+c+" "+g+"'\x3e"+d.input+"\x3c/pre\x3e\n\x3cdiv class\x3d'notebook-code-results"+(f?"":" collapsed")+"'\x3e\n"+d.output+"\n\x3c/div\x3e\n";void 0!==d.ui&&(a+="\x3cdiv class\x3d'notebook-code-ui'\x3e\n"+
d.ui+"\n\x3c/div\x3e\n")}else a+="\x3cdiv class\x3d'notebook-text-editor'\x3e"+d+"\x3c/div\x3e\n";a+="\x3c/section\x3e\n"});return a+="\x3c/article\x3e\n\x3cfooter class\x3d'spyral-footer'\x3e"+this.getInnerFooterHtml()+"\x3c/footer\x3e\x3c/body\x3e\n\x3c/html\x3e"},getHeaderHtml:function(){return"\x3cheader class\x3d'spyral-header'\x3e"+this.getInnerHeaderHtml()+"\x3c/header\x3e\n"},getInnerHeaderHtml:function(){var a="";this.getMetadata().title&&(a+="\x3cdiv class\x3d'title'\x3e"+this.getMetadata().title+
"\x3c/div\x3e");this.getMetadata().author&&(a+="\x3cdiv class\x3d'author'\x3e"+this.getMetadata().author+"\x3c/div\x3e");return a},getInnerFooterHtml:function(){var a="",b=this.getMetadata();if(b.author||b.license)a="\x26copy;",b.author&&(a+=" "+b.author),b.license&&(a+=" ("+b.license+")"),a+=". ";if(b.created||b.modified){var c=b.shortDate("created");b=b.shortDate("modified");c&&(a+=this.localize("created")+" "+c+".");b&&c!=b&&(a+=this.localize("modified")+" "+b+".")}return a},getExtraExportItems:function(){return[{inputValue:"html",
boxLabel:this.localize("exportHtml")},{inputValue:"htmlDownload",boxLabel:'\x3ca href\x3d"#"\x3e'+this.localize("exportHtmlDownload")+"\x3c/a\x3e",listeners:{afterrender:function(a){var b=(this.getNotebookId()||"spyral")+".html",c=this.generateExportHtml(),d={type:"text/html"};try{var e=new File([c],b,d)}catch(f){e=new Blob([c],d)}e=URL.createObjectURL(e);a=a.boxLabelEl.dom.querySelector("a");a.setAttribute("download",b);a.setAttribute("href",e)},scope:this},handler:function(a){a.boxLabelEl.dom.querySelector("a").click();
a.up("window").close()}}]},exportHtml:function(){var a=this.generateExportHtml(),b=window.open();b.document.write(a);b.document.close();b.focus()},exportHtmlDownload:function(){var a=this.generateExportHtml(),b={type:"text/plain"};try{var c=new File([a],"files.txt",b)}catch(d){c=new Blob([a],b)}c=URL.createObjectURL(c);this.getApplication().openUrl(c)},getExportUrl:function(a){return location.href},showMetadataEditor:function(){var a=this,b=this.getMetadata();Ext.create("Ext.window.Window",{title:this.localize("metadataEditor"),
autoScroll:!0,items:[{xtype:"form",items:{bodyPadding:5,width:600,layout:"anchor",defaults:{anchor:"100%",labelAlign:"right"},defaultType:"textfield",items:[{fieldLabel:this.localize("metadataTitle"),xtype:"htmleditor",name:"title",value:b.title,height:100,enableAlignments:!1,enableColors:!1,enableFont:!1,enableFontSize:!1,enableLinks:!1,enableLists:!1},{fieldLabel:this.localize("metadataAuthor"),name:"author",value:b.author},{fieldLabel:this.localize("metadataKeywords"),name:"keywords",value:b.keywords},
...
autoScroll:!0});Ext.Msg.show(a)},getToolConfigFromToolXtype:function(a){cls=Ext.ClassManager.getByAlias("widget."+a);return{xtype:a,title:this._localizeClass(cls,"title"),tooltip:{text:this._localizeClass(cls,"helpTip")},glyph:cls&&cls.glyph?cls.glyph:"xf12e@FontAwesome"}},openUrl:function(a){window.open(a)||Ext.Msg.show({title:"Popup Blocked",buttonText:{ok:"Close"},icon:Ext.MessageBox.INFO,message:"A popup window was blocked. \x3ca href\x3d'"+a+"' target\x3d'_blank' class\x3d'link'\x3eClick here\x3c/a\x3e to open the new window.",
...
scope:this})},loadCategoryData:function(a){var b=new Ext.Deferred;Ext.Ajax.request({url:Voyant.application.getTromboneUrl(),params:{tool:"resource.StoredCategories",retrieveResourceId:a,failQuietly:!1,corpus:this.getCorpus()?this.getCorpus().getId():void 0}}).then(function(a){a=Ext.decode(a.responseText).storedCategories.resource;0===a.length?b.reject():(a=Ext.decode(a),this.getCategoriesManager()._categories=a.categories,this.getCategoriesManager()._features=a.features,b.resolve(a))},function(){this.showError("Unable to load categories data: "+
a);b.reject()},null,this);return b.promise},saveCategoryData:function(a){var b=new Ext.Deferred;a=Ext.encode(a);Ext.Ajax.request({url:Voyant.application.getTromboneUrl(),params:{tool:"resource.StoredResource",storeResource:a}}).then(function(a){a=Ext.util.JSON.decode(a.responseText).storedResource.id;b.resolve(a)},function(a){b.reject()});return b.promise},listeners:{loadedCorpus:function(a,b){this.setCorpus(b);this.getApiParam("categories")&&this.loadCategoryData(this.getApiParam("categories")).then(function(a,
b,e){for(var c in this.getCategoriesManager().getCategories())if(a=this.getCategoriesManager().getCategoryFeature(c,"color"),void 0!==a)for(a=this.hexToRgb(a),b=this.getCategoriesManager().getCategoryTerms(c),e=0;e<b.length;e++)this.setColorForTerm(b[e],a)},null,null,this);this.on("unhandledEvent",function(a,d,e){a=this.getBaseUrl()+"?corpus\x3d"+b.getAliasOrId();var c=this.getModifiedApiParams()||{};delete c.view;if("termsClicked"==d)if(Ext.isArray(e)&&"term"in e[0]&&"docIndex"in e[0]){var g={},
k={};e.forEach(function(a){g[a.term]=!0;k[a.docIndex]=!0});c.query=Object.keys(g);c.docIndex=Object.keys(k)}else c.query=e;else if("documentsClicked"==d){var h=[];e.forEach&&e.forEach(function(a){h.push(a.getIndex())});c.docIndex=h}else if("corpusTermsClicked"==d)e.map&&(c.query=e.map(function(a){return a.getTerm()}));else if("documentTermsClicked"==d)e.map&&(c.query=e.map(function(a){return a.getTerm()}),c.docIndex=e.map(function(a){return a.getDocIndex()}));else{console&&console.warn("Unhandled event: "+
d,e);return}c.toolFlow&&(d=Ext.Array.from(c.toolFlow.split(",")),c.view=d.shift(),0<d.length?c.toolFlow=d.join(","):delete c.toolFlow);a+="\x26"+Ext.Object.toQueryString(c);this.openUrl(a)})}}});Ext.define("Voyant.panel.DocumentClusters",{extend:"Ext.panel.Panel",alias:"widget.documentclusters",title:"Document Clusters"});
