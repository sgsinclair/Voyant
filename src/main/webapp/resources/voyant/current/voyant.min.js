...
a)}}}});this.callParent(arguments)},updateStatus:function(a){this.update({count:a})}});Ext.define("Voyant.widget.DocumentSelector",{extend:"Ext.button.Button",mixins:["Voyant.util.Localization"],alias:"widget.documentselector",statics:{i18n:{documents:{en:"Documents"},selectAll:{en:"Select All"},selectNone:{en:"Select None"},ok:{en:"Ok"}}},config:{docs:void 0},initComponent:function(){Ext.apply(this,{text:this.localize("documents"),menu:[],listeners:{}});this.callParent(arguments)},populate:function(a,b){this.setDocs(a);var c=this.getMenu();b&&c.removeAll();c.add([{xtype:"button",style:"margin: 5px;",
itemId:"selectAll",text:this.localize("selectAll"),handler:function(a,b){c.query("menucheckitem").forEach(function(a){a.setChecked(!0)})},scope:this},{xtype:"button",style:"margin: 5px;",itemId:"selectNone",text:this.localize("selectNone"),handler:function(a,b){c.query("menucheckitem").forEach(function(a){a.setChecked(!1)})},scope:this},{xtype:"menuseparator"}]);a.forEach(function(a){c.add({xtype:"menucheckitem",text:a.getShortTitle(),docId:a.get("id"),checked:!0})},this);c.add([{xtype:"menuseparator"},
{xtype:"button",style:"margin: 5px;",text:this.localize("ok"),handler:function(a,b){var f=[];c.query("menucheckitem").forEach(function(a){a.checked&&f.push(a.docId)},this);this.hideMenu();this.findParentByType("panel").fireEvent("documentsSelected",this,f)},scope:this}])}});Ext.define("Voyant.panel.Panel",{mixins:"Voyant.util.Localization Voyant.util.Api Voyant.util.Toolable Voyant.util.DetailedError Voyant.widget.QuerySearchField Voyant.widget.StopListOption Voyant.widget.TotalPropertyStatus".split(" "),statics:{i18n:{term:{en:"Term"},rawFreq:{en:"Count"},relativeFreq:{en:"Relative"},trend:{en:"Trend"},colon:{en:": "},loading:{en:"Loading"}}},constructor:function(a){this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);this.mixins["Voyant.util.Toolable"].constructor.apply(this,
