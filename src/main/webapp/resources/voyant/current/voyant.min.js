...
0==a.length?b.reject():(a=Ext.decode(a),this.setCategories(a.categories),this.setFeatures(a.features),b.resolve(a))},function(){b.reject()},null,this);return b.promise},saveCategoryData:function(a){a=a||this.getCategoryExportData();var b=new Ext.Deferred;a=Ext.encode(a);Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"resource.StoredResource",storeResource:a}}).then(function(a){a=Ext.util.JSON.decode(a.responseText).storedResource.id;b.resolve(a)},function(a){b.reject()});return b.promise}});Ext.define("Voyant.notebook.util.Show",{transferable:["show"],show:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments);show.call(this,this.getString?this.getString(a):this.toString(),!this.getString&&Ext.isNumber(a)?a:void 0)},statics:{show:function(a,b){var c=a;if(this.then)this.then(function(a){show.call(a,a,c)});else{if(Ext.isArray(a)){var d="";a.forEach(function(a){d+=a.getString?a.getString():a.toString()});a=d}else if(Ext.isString(this)||this instanceof
