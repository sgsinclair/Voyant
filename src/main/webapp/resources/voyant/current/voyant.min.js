...
constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.setCirrusId(Ext.id(null,"cirrus_"))},initComponent:function(a){Ext.apply(this,{title:this.localize("title"),dockedItems:[{dock:"bottom",xtype:"toolbar",enableOverflow:!0,items:[{xtype:"corpusdocumentselector",singleSelect:!0},{fieldLabel:this.localize("visibleTerms"),labelWidth:40,width:120,xtype:"slider",increment:25,minValue:25,maxValue:500,listeners:{afterrender:function(a){a.maxValue=
...
buttonAlign:"right",items:[{text:a.localize("Open"),glyph:"xf115@FontAwesome",tooltip:a.localize("SelectExisting"),hidden:void 0!=this.getCorpus(),handler:function(){Ext.create("Ext.window.Window",{title:a.localize("Open"),layout:"fit",modal:!0,items:{xtype:"form",submitEmptyText:!1,margin:"5,5,5,5",items:{xtype:"corpusselector"},buttons:[{text:a.localize("Open"),glyph:"xf00c@FontAwesome",handler:function(b){b.up("form").getForm();var c=b.up("form").getForm().getValues().corpus;""!=c?(a.loadCorpus({corpus:c}),
...
Ext.tip.QuickTipManager.register({target:b.getEl(),text:a.localize("UploadLocal")})},change:function(b,c){if(c){var d=b.up("form").getForm();if(d.isValid()){for(var e=b.fileInputEl.dom.files,f=/\.(png|gif|jpe?g|xls|mp[234a]|mpeg|exe|wmv|avi|ppt|mpg|tif|wav|mov|psd|wma|ai|bmp|pps|aif|pub|dwg|indd|swf|asf|mbd|dmg|flv)$/i,g=/\.(txt|pdf|html?|xml|docx?|rtf|pages|odt|zip|jar|tar|gz|ar|cpio|bzip2|bz2|gzip|xlsx?)$/i,h=[],k=[],m=0,l=e.length;m<l;m++){var n=e[m].name;f.test(n)?h.push(n.split("/").pop()):g.test(n)||
k.push(n.split("/").pop())}0<h.length||0<k.length?Ext.Msg.show({title:a.localize("fileTypesWarning"),icon:Ext.MessageBox.ERROR,message:a.localize("fileTypesMessage")+"\x3cul\x3e"+(0<h.length?"\x3cli\x3e"+a.localize("badFiles")+h.slice(0,5).join(", ")+(5<h.length?"\u2026":"")+"\x3c/li\x3e":"")+(0<k.length?"\x3cli\x3e"+a.localize("unknownFiles")+k.slice(0,5).join(", ")+(5<k.length?"\u2026":"")+"\x3c/li\x3e":"")+"\x3c/ul\x3e"+a.localize("sureContinue"),buttons:Ext.Msg.YESNO,fn:function(c){"yes"===c?
...
delete d.view;delete d.stopList;d.inputFormat&&0!==c.trim().indexOf("\x3c")?Ext.Msg.confirm(a.localize("error"),a.localize("errorNotXmlContinue"),function(b){"yes"==b&&a.loadCorpus(Ext.apply(d,{input:c}))},a):a.loadCorpus(Ext.apply(d,{input:c}))}else Ext.Msg.show({title:a.localize("noTextProvided"),message:a.localize("pleaseProvideText"),buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR})}}]}],items:{xtype:"textareafield",width:800,height:100,itemId:"input",emptyText:this.localize("emptyInput")}});a.callParent(arguments)},
loadForm:function(a){var b={tool:this.getCorpus()?"corpus.CorpusMetadata":"corpus.CorpusCreator"};this.getCorpus()&&Ext.apply(b,{corpus:this.getCorpus().getId(),addDocuments:!0});var c=this.getApiParams();delete c.view;delete c.stopList;Ext.apply(b,c);var d=this.getApplication().getViewport();d.mask(this.localize("uploadingCorpus"));a.submit({url:this.getTromboneUrl(),params:b,failure:function(a,b){d.unmask();if(b.result){var g={corpus:b.result.corpus?b.result.corpus.metadata.id:b.result.stepEnabledCorpusCreator.storedId};
Ext.apply(g,c);this.setCorpus(void 0);this.loadCorpus(g)}},scope:this})},loadCorpus:function(a){this.getCorpus()&&Ext.apply(a,{corpus:this.getCorpus().getId(),addDocuments:!0});var b=this.up("window");b&&b.isFloating()&&b.close();this.getApplication().loadCorpusFromParams(a)},showOptionsClick:function(a){void 0===a.optionsWin&&(a.optionsWin=Ext.create("Ext.window.Window",{title:a.localize("gearWinTitle"),closeAction:"hide",layout:"fit",bodyPadding:10,items:[{xtype:"form",defaultType:"textfield",maxHeight:a.getApplication().getViewport().getHeight()-
...
enableOverflow:!0,items:[{glyph:"xf060@FontAwesome",handler:function(){this.fetchPrevious(!0)},scope:this},{glyph:"xf061@FontAwesome",handler:function(){this.fetchNext(!0)},scope:this},{xtype:"tbseparator"},{xtype:"querysearchfield"}]}],listeners:{loadedCorpus:function(a,c){this.getTokensStore().setCorpus(c);this.getDocumentTermsStore().getProxy().setExtraParam("corpus",c.getId());var d=c.getDocuments();this.setDocumentsStore(d);d=this.down('panel[region\x3d"south"]');this.setLocationMarker(Ext.DomHelper.append(d.el,
...
this.updateLocationMarker(a)},updateChart:function(){}});Ext.define("Voyant.panel.ScatterPlot",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],requires:["Ext.chart.CartesianChart"],alias:"widget.scatterplot",config:{options:{xtype:"stoplistoption"}},statics:{i18n:{},api:{docId:void 0,analysis:"ca",limit:50,dimensions:3,bins:10,clusters:3,comparisonType:"relative",stopList:"auto",target:void 0,term:void 0,query:void 0,label:["summary","docs","terms"]},glyph:"xf06e@FontAwesome"},tokenFreqTipTemplate:null,docFreqTipTemplate:null,caStore:null,pcaStore:null,
docSimStore:null,termStore:Ext.create("Ext.data.JsonStore",{fields:[{name:"term"},{name:"rawFreq",type:"int"},{name:"relativeFreq",type:"number"},{name:"coordinates",mapping:"vector"},{name:"category"}],sorters:[{property:"rawFreq",direction:"DESC"}],groupField:"category"}),newTerm:null,termsTimeout:null,chartMenu:null,labelsMode:0,highlightData:{x:0,y:0,r:0},highlightTask:null,constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},
initComponent:function(){Ext.apply(this,{title:this.localize("title"),caStore:Ext.create("Voyant.data.store.CAAnalysis"),pcaStore:Ext.create("Voyant.data.store.PCAAnalysis"),docSimStore:Ext.create("Voyant.data.store.DocSimAnalysis"),termStore:this.termStore,chartMenu:Ext.create("Ext.menu.Menu",{items:[{text:this.localize("remove"),itemId:"remove",glyph:"xf068@FontAwesome"},{text:this.localize("nearby"),itemId:"nearby",glyph:"xf0b2@FontAwesome"}],listeners:{hide:function(){var a=this.down("#chart").getSeries();
a[0].enableToolTips();a[1].enableToolTips()},scope:this}}),layout:"border",autoDestroy:!0,items:[{itemId:"chartParent",region:"center",layout:"fit",tbar:{enableOverflow:!0,items:[{xtype:"querysearchfield",itemId:"filterTerms",width:150},{xtype:"documentselectorbutton",flex:1},{text:this.localize("analysis"),itemId:"analysis",glyph:"xf1ec@FontAwesome",enableOverflow:!0,flex:1,menu:{items:[{text:this.localize("pca"),itemId:"analysis_pca",group:"analysis",xtype:"menucheckitem"},{text:this.localize("ca"),
itemId:"analysis_ca",group:"analysis",xtype:"menucheckitem"},{text:this.localize("docSim"),itemId:"analysis_docSim",group:"analysis",xtype:"menucheckitem"}],listeners:{click:function(a,b){if(void 0!==b){var c=b.getItemId().split("_")[1];c!==this.getApiParam("analysis")&&(this.setApiParam("analysis",c),"ca"===c&&3==this.getCorpus().getDocumentsCount()&&(this.setApiParam("dimensions",2),this.queryById("dimensions").menu.items.get(0).setChecked(!0)),this.loadFromApis(!0))}},scope:this}}},{text:this.localize("freqsMode"),
itemId:"comparisonType",glyph:"xf201@FontAwesome",tooltip:this.localize("freqsModeTip"),flex:1,menu:{items:[{text:this.localize("rawFrequencies"),itemId:"comparisonType_raw",group:"freqsMode",xtype:"menucheckitem"},{text:this.localize("relativeFrequencies"),itemId:"comparisonType_relative",group:"freqsMode",xtype:"menucheckitem"},{text:this.localize("tfidf"),itemId:"comparisonType_tfidf",group:"freqsMode",xtype:"menucheckitem"}],listeners:{click:function(a,b){if(void 0!==b){var c=b.getItemId().split("_")[1];
c!==this.getApiParam("comparisonType")&&(this.setApiParam("comparisonType",c),this.loadFromApis(!0))}},scope:this}}},{text:this.localize("clusters"),itemId:"clusters",glyph:"xf192@FontAwesome",flex:1,menu:{items:[{text:"1",itemId:"clusters_1",group:"clusters",xtype:"menucheckitem"},{text:"2",itemId:"clusters_2",group:"clusters",xtype:"menucheckitem"},{text:"3",itemId:"clusters_3",group:"clusters",xtype:"menucheckitem"},{text:"4",itemId:"clusters_4",group:"clusters",xtype:"menucheckitem"},{text:"5",
itemId:"clusters_5",group:"clusters",xtype:"menucheckitem"}],listeners:{click:function(a,b){if(void 0!==b){var c=parseInt(b.getItemId().split("_")[1]);c!==this.getApiParam("clusters")&&(this.setApiParam("clusters",c),this.loadFromApis(!0))}},scope:this}}},{text:this.localize("dimensions"),itemId:"dimensions",glyph:"xf1b2@FontAwesome",flex:1,menu:{items:[{text:"2",itemId:"dimensions_2",group:"dimensions",xtype:"menucheckitem"},{text:"3",itemId:"dimensions_3",group:"dimensions",xtype:"menucheckitem"}],
listeners:{click:function(a,b){if(void 0!==b){var c=parseInt(b.getItemId().split("_")[1]);if(c!==this.getApiParam("dimensions")){if(3==c&&"ca"==this.getApiParam("analysis")&&3==this.getCorpus().getDocumentsCount())return!1;this.setApiParam("dimensions",c);this.loadFromApis(!0)}}},scope:this}}},{text:this.localize("labels"),itemId:"labels",glyph:"xf02b@FontAwesome",flex:1,menu:{items:[{text:this.localize("summaryLabel"),itemId:"summary",xtype:"menucheckitem"},{text:this.localize("docsLabel"),itemId:"docs",
xtype:"menucheckitem"},{text:this.localize("termsLabel"),itemId:"terms",xtype:"menucheckitem"}],listeners:{afterrender:function(a){var b=this.getApiParam("label");a.items.each(function(a){a.setChecked(-1<b.indexOf(a.getItemId()))})},click:function(a,b){var c=this.getApiParam("label"),d=b.getItemId();Ext.isString(c)&&(c=[c]);b.checked&&-1==c.indexOf(d)?c.push(d):!b.checked&&-1<c.indexOf(d)&&(c=c.filter(function(a){return a!=d}));this.setApiParam("label",c);this.doLabels();this.queryById("chart").redraw()},
scope:this}}}]},listeners:{query:function(a,b){void 0!==b&&(this.termStore.filter([{property:"term",value:b,anyMatch:!0}]),this.filterChart(b))},scope:this}},{itemId:"termsGrid",xtype:"grid",region:"east",width:250,split:!0,forceFit:!0,features:[{ftype:"grouping",hideGroupedHeader:!0,enableGroupingMenu:!1}],bbar:{enableOverflow:!0,items:[{itemId:"nearbyButton",xtype:"button",text:this.localize("nearby"),glyph:"xf0b2@FontAwesome",flex:1,handler:function(a){var b=a.up("panel").getSelection()[0];void 0===
...
this,{single:!0}),this.chartMenu.showAt(c))},this)},scope:this}};a=Ext.create("Ext.chart.CartesianChart",a);this.queryById("chartParent").insert(0,a);this.doLabels();null!==this.newTerm&&(this.selectTerm(this.newTerm),this.newTerm=null)},getDefaultDocColor:function(a){return this.getApplication().getColor(6,a)},doLabels:function(){var a=this.queryById("chart"),b=a.getSeries(),a=a.getSurface("chart").getItems()[0],c=this.getApiParam("label");-1<c.indexOf("summary")?a.show():a.hide();-1<c.indexOf("terms")?
b[0].getLabel().show():b[0].getLabel().hide();-1<c.indexOf("docs")?b[1].getLabel().show():b[1].getLabel().hide()},selectTerm:function(a,b){var c=this.down("#chart");if(null!==c)if(void 0===a)c.getSeries()[0].setHighlightItem(null),c.getSeries()[1].setHighlightItem(null);else{var d,e;!0===b?(d=c.getSeries()[1],e=d.getStore().findExact("title",a)):(d=c.getSeries()[0],e=d.getStore().findExact("term",a));if(-1!==e){var f=d.getStore().getAt(e),g=d.getSprites()[0],f={series:d,category:d.getItemInstancing()?
"items":"markers",index:e,record:f,field:d.getYField(),sprite:g};d.setHighlightItem(f);b?c.getSeries()[0].setHighlightItem(null):c.getSeries()[1].setHighlightItem(null);c=this.getPointFromIndex(d,e);this.highlightData={x:c[0],y:c[1],r:50};null==this.highlightTask&&(this.highlightTask=Ext.TaskManager.newTask({run:this.doHighlight,scope:this,interval:25,repeat:this.highlightData.r}));this.highlightTask.restart()}}},getPointFromIndex:function(a,b){var c=a.getSprites()[0];return c.attr.matrix.clone().prependMatrix(c.surfaceMatrix).transformPoint([c.attr.dataX[b],
c.attr.dataY[b]])},doHighlight:function(){var a=this.down("#chart");if(0<this.highlightData.r){for(var b=a.getSurface(),c=null,d=b.getItems(),e=0;e<d.length;e++){var f=d[e];if("customHighlight"==f.id){c=f;break}}null==c?b.add({id:"customHighlight",type:"circle",strokeStyle:"red",fillStyle:"none",radius:this.highlightData.r,x:this.highlightData.x,y:this.highlightData.y}):(c.setAttributes({x:this.highlightData.x,y:this.highlightData.y,radius:this.highlightData.r}),this.highlightData.r-=1.5,0>=this.highlightData.r&&
(this.highlightData.r=0,b.remove(c,!0)));a.redraw()}},filterChart:function(a){Ext.isString(a)&&(a=[a]);for(var b=[],c=0;c<a.length;c++)b.push(new RegExp(a[c]));a=this.queryById("chart");var c=a.getSeries()[0],d=c.getLabel();c.getStore().each(function(a){var c=!1;if(0==b.length)c=!0;else for(var g=0;g<b.length&&!(c=c||b[g].test(a.get("term")));g++);a.set("disabled",!c);a=a.store.indexOf(a);d.setAttributesFor(a,{hidden:!c})},this);a.redraw()},getCurrentTerms:function(){var a=[];this.termStore.each(function(b){"term"===
b.get("category")&&a.push(b.get("term"))});return a},getNearbyForTerm:function(a){var b=Math.max(2E3,Math.round(this.getCorpus().getWordTokensCount()/100));this.setApiParams({limit:b,target:a});this.loadFromApis();this.setApiParam("target",void 0)},removeTerm:function(a){var b=this.down("#chart").getSeries()[0],c=b.getStore().findExact("term",a);b.getStore().removeAt(c);c=this.termStore.findExact("term",a);this.termStore.removeAt(c);a=this.termStore.getCount();this.queryById("limit").setRawValue(a)},
loadFromApis:function(a){var b=this.down("#chart");null!==b&&b.mask(this.localize("loading"));var b={},c=this.getCurrentTerms();null!==this.newTerm&&(c.push(this.newTerm),this.setApiParam("limit",c.length));0<c.length&&(null!==this.newTerm||a)&&(b.query=c.join(","));Ext.apply(b,this.getApiParams());null!=b.target&&(b.term=c);"pca"===b.analysis?this.pcaStore.load({params:b}):"docSim"===b.analysis?this.docSimStore.load({params:b}):this.caStore.load({params:b})},interpolate:function(a,b,c,d,e){return d+
...
if(b>d-15&&b<d+15&&c>e-15&&c<e+15)return f[a.getTerm()]=!0,!1});if(0!=Object.keys(a.currentTerms||{}).length||0!=Object.keys(f).length)a.currentTerms=f,a.draw(g)}},!1)});this.on("loadedCorpus",function(a,b){this.loadDocument()},this);this.on("documentselected",function(a,b){this.setApiParam("docIndex",this.getCorpus().getDocument(b).getIndex());this.loadDocument()});this.on("resize",function(){})},draw:function(a,b){a=a||this.getTargetEl().dom.querySelector("canvas");b=b||a.getContext("2d");b.clearRect(0,
0,a.width,a.height);b.fillStyle="rgba(0,0,0,.1)";this.perim.forEach(function(a,c){0==c%3&&b.fillRect(a.x-5,a.y,10,1)});if(this.documentTerms&&(this.drawTerms(a,b),this.drawReading(a,b),this.isReading)){var c=this;setTimeout(function(){c.draw()},10)}},drawReading:function(a,b){b=b||this.getTargetEl().dom.querySelector("canvas").getContext("2d");var c=2E3-1999*parseInt(this.getApiParam("speed"))/100;if(this.isReading&&this.documentTerms){var d=parseInt(this.readingIndex*this.perim.length/this.lastToken);
b.fillStyle="purple";b.fillRect(this.perim[d].x,this.perim[d].y,5,5);var e=void 0==this.readingStartTime;this.readingStartTime=this.readingStartTime||(new Date).getTime();d=this.readingStartTime+c-(new Date).getTime();if(this.sourceTerm&&this.targetTerm){if(e||0>=d){this.previousBeziers=this.previousBeziers||[];var e=this.sourceTerm.get("x"),f=this.sourceTerm.get("y"),g=this.targetTerm.get("x"),h=this.targetTerm.get("y");this.previousTerm&&this.previousTerm.get("x");this.previousTerm&&this.previousTerm.get("y");
var k=Math.max(100,.5*Math.abs(e-g)),m=Math.max(100,.5*Math.abs(f-h));this.previousBeziers.unshift([e,f,e>g?e-k:e+k,h>f?f+m:f-m,g,h]);10<this.previousBeziers.length&&this.previousBeziers.pop()}for(e=0;e<this.previousBeziers.length;e++)b.strokeStyle="rgba(0,0,255,"+(1-.1*e)+")",this.drawBezierSplit.apply(this,Ext.Array.merge([b],this.previousBeziers[e],[e+1==this.previousBeziers.length?1-d/c:0],[0==e?1-d/c:1]));0>=d&&(this.readingStartTime=void 0,this.read())}e=this.readingIndex+1;for(f=this.tokens.getCount();e<
f&&this.tokens.getAt(e).getTerm().toLowerCase()!=this.targetTerm.getTerm();e++);c=e-parseInt(d*(e-this.readingIndex)/c);for(d=this.tokens.getCount();c<e&&!(c<d&&this.tokens.getAt(c).isWord());c++);c=this.tokens.getRange(c,f=Math.min(this.readingIndex+50,this.tokens.getCount())).map(function(a){return a.getTerm()});b.font="14px sans-serif";b.fillStyle="rgba(0,0,0,.5)";b.textAlign="left";b.fillText(c.join(""),a.width/4,a.height-5);b.clearRect(.75*a.width,a.height-20,a.width,30)}else this.documentTerms&&
this.documentTerms.getCount()<this.documentTerms.getTotalCount()&&(c=a.width/4,b.strokeStyle="rgba(0,0,0,.5)",b.fillStyle="rgba(0,0,0,.2)",b.strokeRect(c,a.height-12,2*c,10),b.fillRect(c,a.height-12,this.documentTerms.getCount()*c*2/this.documentTerms.getTotalCount(),10))},drawTerms:function(a,b){a=a||this.getTargetEl().dom.querySelector("canvas");b=b||a.getContext("2d");b.textAlign="center";this.documentTerms&&this.perim&&this.documentTerms.each(function(c){var d=c.getRawFreq(),e=c.getTerm(),f=c.get("x"),
g=c.get("y");isCurrentTerm=this.currentTerms&&e in this.currentTerms;isReadingTerm=this.sourceTerm&&this.sourceTerm.getTerm()==e;b.font=Math.log(d)*(10*a.width/800)/Math.log(this.maxRawFreq)+(isCurrentTerm||isReadingTerm?10:5)+"px sans-serif";b.fillStyle=isCurrentTerm?"red":isReadingTerm?"blue":"rgba(0,0,0,"+(.9*d/this.maxRawFreq+.1)+")";if(isCurrentTerm||isReadingTerm)b.strokeStyle=isCurrentTerm?"rgba(255,0,0,.2)":"rgba(0,255,0,.4)",c.getDistributions().forEach(function(a,c){0<a&&this.perim[c]&&
(b.beginPath(),b.moveTo(f,g),b.lineTo(this.perim[c].x,this.perim[c].y),b.stroke())},this);b.fillText(e,f,g)},this)},read:function(a){Ext.isNumber(a)?this.readingIndex=a:this.readingIndex++;this.sourceTerm&&(this.previousTerm=this.sourceTerm);a=this.readingIndex;for(var b=this.tokens.getCount();a<b;a++){var c=this.tokens.getAt(a),c=c.getTerm().toLowerCase();if(c in this.termsMap&&(this.sourceTerm=this.termsMap[c],1<=this.sourceTerm.getRawFreq())){this.readingIndex=a;break}}a=this.readingIndex+1;for(b=
this.tokens.getCount();a<b&&!(c=this.tokens.getAt(a),c=c.getTerm().toLowerCase(),c in this.termsMap&&(this.targetTerm=this.termsMap[c],1<=this.targetTerm.getRawFreq()));a++);!this.tokensLoading&&this.tokens.getCount()-this.readingIndex<this.tokensFetch&&this.fetchMoreTokens();this.draw()},loadDocument:function(){this.documentTerms&&(this.documentTerms.destroy(),this.documentTerms=void 0);this.termsMap={};this.draw();var a=this.getCorpus().getDocument(parseInt(this.getApiParam("docIndex")));this.setTitle(this.localize("title")+
" \x3cspan class\x3d'subtitle'\x3e"+a.getFullLabel()+"\x3c/span\x3e");this.lastToken=parseInt(a.get("lastTokenStartOffset-lexical"));this.documentTerms=a.getDocumentTerms({proxy:{extraParams:{stopList:this.getApiParam("stopList"),bins:this.diam,withDistributions:"raw",minRawFreq:parseInt(this.getApiParam("minRawFreq"))}}});a=this.queryById("search");a.setDisabled(!0);a.setStore(this.documentTerms);this.fetchMoreDocumentTerms()},fetchMoreDocumentTerms:function(){this.documentTerms?this.documentTerms.load({params:{start:this.documentTerms.getCount(),
limit:0==this.documentTerms.getCount()?10:250},callback:function(a){0<a.length?(this.maxRawFreq=this.documentTerms.max("rawFreq"),a.forEach(function(a){var c=y=0;a.get("distributions").forEach(function(a,b){c+=this.perim[b].x*a;y+=this.perim[b].y*a},this);a.set("x",c/a.getRawFreq());a.set("y",y/a.getRawFreq())},this),Ext.Function.defer(this.fetchMoreDocumentTerms,0,this),this.draw()):(this.queryById("search").setDisabled(!1),this.termsMap={},this.documentTerms.each(function(a){this.termsMap[a.getTerm()]=
a},this),this.tokens&&this.tokens.removeAll(!0),this.fetchMoreTokens())},addRecords:!0,scope:this}):this.loadDocument()},fetchMoreTokens:function(){if(!this.tokens)this.tokens=this.getCorpus().getDocument(parseInt(this.getApiParam("docIndex"))).getTokens({proxy:{extraParams:{stripTags:"all"}}}),this.noMoreTokens=!1;else if(this.noMoreTokens)return;var a=0==this.tokens.getCount();this.tokensLoading=!0;var b=parseInt(this.getApiParam("speed"));this.tokens.load({params:{start:this.tokens.getCount(),
limit:50==b&&a?200:Math.pow(110-b,2)},callback:function(b){this.tokensLoading=!1;0<b.length?(b.forEach(function(a){"other"==a.getTokenType()&&a.set("term",a.getTerm().replace(/\s+/g," "))}),a&&(this.previousBeziers=[],this.isReading=!0,this.read(0))):this.noMoreTokens=!0},addRecords:!0,scope:this})},animatePathDrawing:function(a,b,c,d,e,f,g,h){var k=null,m=function(l){null===k&&(k=l);l=Math.min((l-k)/h,1);a.clearRect(0,0,a.canvas.width,a.canvas.height);drawBezierSplit(a,b,c,d,e,f,g,0,l);1>l&&window.requestAnimationFrame(m)};
...
"px"}).style("fill-opacity",function(b){return a.opacityScale(b.freq)}).text(function(a){return a.wordString}).on("mouseover",function(b){d3.select(this).style("cursor","pointer").style("font-size",function(b){return a.fontScale(b.freq)*a.maxFont/a.fontScale(b.freq)+"px"});b=a.buildParamsBundle(b);a.manageOverlaySlippery(b)}).on("mouseout",function(b){d3.select(this).style("cursor","auto").style("font-size",function(b){return a.fontScale(b.freq)+"px"});b=a.buildParamsBundle(b);a.manageOverlaySlippery(b)}).on("click",
function(b){b=a.buildParamsBundle(b);a.manageOverlaySticky(b)}).append("title").text(function(a){return a.wordString})},redrawChart:function(){this.chart.selectAll("g[class\x3dsection]").remove();this.drawChart()},drawVerticalSlider:function(){},redrawVerticalSlider:function(){this.chart.selectAll("rect[class\x3dminimap]").remove();this.drawVerticalSlider()},drawSlider:function(){this.body.getHeight();var a=this.body.getWidth()-(this.rPadding+this.lPadding),b=this.lPadding,c=this.lPadding+(this.numVisPoints-
1)/(this.numDataPoints-1)*a;this.chart.append("line").attr("class","sliderAxis").attr("x1",this.lPadding).attr("x2",this.body.getWidth()-this.rPadding).attr("y1",this.tPadding+this.navigationHeight).attr("y2",this.tPadding+this.navigationHeight).style("shape-rendering","crispEdges").style("stroke","black").style("stroke-width","1");this.chart.append("line").attr("class","sliderAxis").attr("x1",this.lPadding).attr("x2",this.lPadding).attr("y1",this.tPadding+this.navigationHeight).attr("y2",this.tPadding).style("shape-rendering",
"crispEdges").style("stroke","black").style("stroke-width","1");this.chart.append("line").attr("class","slider").attr("id","before").attr("x1",a*(this.shiftCount-this.callOffset())/(this.numDataPoints-1)+b).attr("x2",a*(this.shiftCount-this.callOffset())/(this.numDataPoints-1)+b).attr("y1",this.tPadding+this.navigationHeight).attr("y2",this.tPadding).style("stroke","black").style("stroke-width","1");this.chart.append("line").attr("class","slider").attr("id","after").attr("x1",a*(this.shiftCount-this.callOffset())/
(this.numDataPoints-1)+c).attr("x2",a*(this.shiftCount-this.callOffset())/(this.numDataPoints-1)+c).attr("y1",this.tPadding+this.navigationHeight).attr("y2",this.tPadding).style("stroke","black").style("stroke-width","1");var b=this.chart.append("rect").attr("class","slider").attr("id","boxBefore").attr("x",this.lPadding).attr("y",this.tPadding).attr("height",this.navigationHeight).attr("width",a*(this.shiftCount-this.callOffset())/(this.numDataPoints-1)).style("fill","silver").style("fill-opacity",
.25).style("cursor","move"),a=this.chart.append("rect").attr("class","slider").attr("id","boxAfter").attr("x",a*(this.shiftCount-this.callOffset())/(this.numDataPoints-1)+c).attr("y",this.tPadding).attr("height",this.navigationHeight).attr("width",a*(this.numDataPoints-this.numVisPoints-this.shiftCount+this.callOffset())/(this.numDataPoints-1)).style("fill","silver").style("fill-opacity",.25).style("cursor","move"),d=this,c=d3.behavior.drag().origin(Object).on("drag",function(a){if(!d.isTransitioning){this.drag=
...
1)+d).attr("x2",b*this.shiftCount/(this.numDataPoints-1)+d).attr("y1",this.tPadding+this.navigationHeight).attr("y2",this.tPadding).each("end",function(){a.isMasked()&&a.unmask();a.continueTransition?setTimeout(function(){a.callTransition()},50):(a.isTransitioning=!1,a.manageMvtButtons())});this.chart.select("#after").transition().duration(c).ease("linear").attr("x1",b*this.shiftCount/(this.numDataPoints-1)+e).attr("x2",b*this.shiftCount/(this.numDataPoints-1)+e).attr("y1",this.tPadding+this.navigationHeight).attr("y2",
this.tPadding);this.chart.select("#boxBefore").transition().duration(c).ease("linear").attr("x",this.lPadding).attr("y",this.tPadding).attr("height",this.navigationHeight).attr("width",b*this.shiftCount/(this.numDataPoints-1));this.chart.select("#boxAfter").transition().duration(c).ease("linear").attr("x",b*this.shiftCount/(this.numDataPoints-1)+e).attr("y",this.tPadding).attr("height",this.navigationHeight).attr("width",b*(this.numDataPoints-this.numVisPoints-this.shiftCount)/(this.numDataPoints-
1))}this.redrawChartOverlay()},callTransition:function(){"left"===this.transitionCall&&this.toggleLeftCheck();"right"===this.transitionCall&&this.toggleRightCheck()},buildParamsBundle:function(a){var b=a.wordString,c={},d={};"document"===this.getApiParam("mode")&&(a=a.docId,d=this.getCorpus().getDocument(a).get("totalTokens")-1,c.tokenIdStart=parseInt(this.category*d/this.numDataPoints),c.docIdType=a+":"+b);return d={params:c,type:b}},manageOverlaySlippery:function(a){for(var b=a.type,c=this.removeFilteredCharacters(a.type),
d="on",e=this.overlayQueue.length;0<=--e;)c===this.overlayQueue[e].selector&&(d="off");c===this.lastSticky&&(d="off",this.lastSticky=null);"on"===d&&(c!==this.lastSlippery?(d=this.prepareFullPath(b),a={word:b,selector:c,params:a,fullPath:d.path,pathMin:d.min,pathMax:d.max,colour:"red"},null!==this.lastSlippery&&(this.chartOverlayOff(this.lastSlippery),this.sliderOverlayOff(this.lastSlippery),this.lastSlippery=null),this.chartOverlayOn(a),this.sliderOverlayOn(a),this.lastSlippery=c):(this.chartOverlayOff(c),
this.sliderOverlayOff(this.lastSlippery),this.lastSlippery=null))},manageOverlaySticky:function(a){a=a.type;this.transitionCall="draw";this.isTermSelected(a)?this.doTermDeselect(a,!0):this.doTermSelect(a,!0)},getTermIndex:function(a){var b=-1;a=a=this.removeFilteredCharacters(a);for(var c=this.overlayQueue.length;0<=--c;)a===this.overlayQueue[c].selector&&(b=c);return b},isTermSelected:function(a){return-1!==this.getTermIndex(a)},doTermSelect:function(a,b){var c=c=this.removeFilteredCharacters(a),
d=this.getApiParam("selectedWords");d.push(a);this.setApiParams({selectedWords:d});d=this.colorIndex[0];this.colorIndex.shift();if(!0===b){var e=this.query("[xtype\x3dlegend]")[0];e.getStore().add({name:a,mark:d})}else{var e=this.query("[xtype\x3dlegend]")[0],f=e.getStore().findRecord("name",a);null!==f&&(f.set("mark",d),e.refresh())}if(0===this.colorIndex.length)for(e=0;e<this.colorMasterList.length;e++)this.colorIndex.push(this.colorMasterList[e]);e=this.prepareFullPath(a);d={word:a,selector:c,
params:{params:{},type:a},fullPath:e.path,pathMin:e.min,pathMax:e.max,colour:d};c===this.lastSlippery&&(this.sliderOverlayOff(c),this.lastSlippery=null);this.chart.select("g[class\x3dfrequency-line-"+c+"]").remove();this.overlayQueue.push(d);this.chartOverlayOn(d);this.sliderOverlayOn(d)},doTermDeselect:function(a,b){var c=this.removeFilteredCharacters(a),d=this.getTermIndex(a);if(!0===b){var e=this.query("[xtype\x3dlegend]")[0],d=e.getStore().findExact("name",a);e.getStore().removeAt(d)}for(var e=
this.getApiParam("selectedWords"),f=0,g=e.length;f<g;f++)e[f]===c&&(e.splice(f,1),this.setApiParams({selectedWords:e}));this.chartOverlayOff(c);this.colorIndex.push(this.overlayQueue[d].colour);this.overlayQueue.splice(d,1);this.sliderOverlayOff(c);this.lastSticky=c},prepareFullPath:function(a){for(var b=[],c=this.absMaxFreq,d=this.absMinFreq,e=0,f=this.allData.length;e<f;e++){for(var g=foundB=0,h=this.allData[e].allDataInternal.length;g<h;g++)for(var k=0,m=this.allData[e].allDataInternal[g].frequencyArray.length;k<
m;k++)if(this.allData[e].allDataInternal[g].frequencyArray[k].wordString===a){var l=this.allData[e].allDataInternal[g].frequencyArray[k].freq;b.push({x:e,y:l});l<c&&(c=l);l>d&&(d=l);foundB=1}0===foundB&&(g=this.minFreq,b.push({x:e,y:g}),g<c&&(c=g),g>d&&(d=g))}return{path:b,min:c,max:d}},updateFullPath:function(){for(var a=this.overlayQueue.length;0<a--;){var b=this.prepareFullPath(this.overlayQueue[a].word);this.overlayQueue[a].fullPath=b.path;this.overlayQueue[a].pathMin=b.min;this.overlayQueue[a].pathMax=
b.max}},buildSliderPath:function(a){var b=this;return d3.svg.line().x(function(a){return b.xSliderScale(a.x)}).y(function(a){return b.ySliderScale(a.y)}).interpolate("monotone")(a)},sliderOverlayOn:function(a){this.transitionSliderOverlay(a);this.chart.append("g").attr("id","slider-line-"+a.word).append("path").attr("d",this.buildSliderPath(a.fullPath)).style("stroke",a.colour).style("stroke-width",2).style("fill","none");this.redrawSlider()},sliderOverlayOff:function(a){this.chart.selectAll("g[id\x3dslider-line-"+
...
this)},handleClickedItem:function(a,b){var c=this.getApiParam("mode");if(c===this.MODE_DOCUMENT){if(c=this.getApiParam("docId")){var d=this.getCorpus().getDocument(c),d=d.get("tokensCount-lexical"),e=this.getApiParam("bins"),d=b.index/e*d;this.dispatchEvent("documentIndexTermsClicked",this,[{term:b.series.getTitle(),docId:c,position:d}])}}else c==this.MODE_CORPUS&&(d=this.getCorpus().getDocument(b.index),this.dispatchEvent("documentIndexTermsClicked",this,[{term:b.series.getTitle(),docIndex:b.index,
docId:d.getId()}]))},isLastClickedItem:function(a){return this.lastClickedItem&&this.lastClickedItem.term==a.term&&this.lastClickedItem.index==a.index},setMode:function(a){this.setApiParams({mode:a});this.getApiParam("mode")},getDistributionsType:function(a){return a[0]===Math.round(a[0])?"raw":"relative"}});
...
{msg:Ext.isString(a)?a:a.msg,response:b}))},showError:function(a,b){Ext.isString(a)&&(a={message:a});!b&&(a.error||a.responseText||a instanceof Voyant.util.ResponseError)&&(b=a);if(b){a=a||{};a.message=a.message||"";if(b.error){var c=b.error.split(/(\r\n|\r|\n)/);0<c.length&&(a.message=this.localize("serverResponseError"),a.message+="\x3cpre class\x3d'error'\x3e\n"+c[0]+"\x3c/p\x3e",1<c.length&&(a.message+="\u2026  \x3ca href\x3d'#' onclick\x3d\"window.open('').document.write(unescape('\x3cpre\x3e"+
escape(b.error)+"\x3c/pre\x3e')); return false;\"\x3emore\x3c/a\x3e\x3c/pre\x3e"),a.message+="\x3c/pre\x3e")}b.responseText&&(a.message+="\x3cpre class\x3d'error'\x3e\n"+b.responseText.substring(0,b.responseText.indexOf("\n\t"))+"\u2026 \x3ca href\x3d'#' onclick\x3d\"window.open('').document.write(unescape('\x3cpre\x3e"+escape(b.responseText)+"\x3c/pre\x3e')); return false;\"\x3emore\x3c/a\x3e\x3c/pre\x3e")}Ext.applyIf(a,{title:this.localize("error"),buttons:Ext.Msg.OK,icon:Ext.MessageBox.ERROR,autoScroll:!0});
Ext.Msg.show(a)},getToolConfigFromToolXtype:function(a){cls=Ext.ClassManager.getByAlias("widget."+a);return{xtype:a,title:this._localizeClass(cls,"title"),tooltip:{text:this._localizeClass(cls,"helpTip")},glyph:cls&&cls.glyph?cls.glyph:"xf12e@FontAwesome"}},palettes:{"default":[[0,0,255],[51,197,51],[255,0,255],[121,51,255],[28,255,255],[255,174,0],[30,177,255],[182,242,58],[255,0,164],[51,102,153],[34,111,52],[155,20,104],[109,43,157],[128,130,33],[111,76,10],[119,115,165],[61,177,169],[202,135,
115],[194,169,204],[181,212,228],[182,197,174],[255,197,197],[228,200,124],[197,179,159]]},rgbToHex:function(a){return"#"+(16777216+(a[0]<<16)+(a[1]<<8)+a[2]).toString(16).slice(1)},hexToRgb:function(a){a=a.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i,function(a,c,d,e){return c+c+d+d+e+e});return(a=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(a))?[parseInt(a[1],16),parseInt(a[2],16),parseInt(a[3],16)]:null},addColorPalette:function(a,b){this.palettes[a]=b},getColorPalette:function(a,b){var c=a||
this.getApiParam("palette")||"default",c=this.palettes[c];void 0===c&&(c=[]);if(b){for(var d=[],e=0;e<c.length;e++)d.push(this.rgbToHex(c[e]));return d}return c},getColor:function(a,b){var c=this.getApiParam("palette")||"default",c=this.palettes[c];return b?this.rgbToHex(c[a]):c[a]},colorTermAssociations:new Ext.util.MixedCollection,getColorForTerm:function(a,b){-1!=a.indexOf(":")&&(a=a.split(":")[1]);var c=this.colorTermAssociations.get(a);if(null==c){var c=this.getApiParam("palette")||"default",
