...
reset:{en:"reset"}},api:{stopList:"auto",limit:100,terms:void 0,docId:void 0,docIndex:void 0},glyph:"xf06e@FontAwesome"},config:{mode:void 0,options:{xtype:"stoplistoption"},corpus:void 0,terms:void 0,visLayout:void 0,vis:void 0,sizeAdjustment:100,minFontSize:12,largestWordSize:0,smallestWordSize:1E6},MODE_CORPUS:"corpus",MODE_DOCUMENT:"mode_document",layout:"fit",constructor:function(a){Ext.apply(this,{title:this.localize("title"),dockedItems:[{dock:"bottom",xtype:"toolbar",items:["-\x3e",{text:this.localize("reset"),
hidden:!0,itemId:"reset",handler:function(a){a.hide();(a=this.getCorpus())&&this.loadFromCorpus(a)},scope:this}]}]});this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);if(a.embedded){var b=Ext.getClass(a.embedded).getName();"Voyant.data.store.CorpusTerms"==b&&this.loadFromCorpusTerms(a.embedded);"Voyant.data.model.Corpus"==b&&this.loadFromCorpusTerms(a.embedded.getCorpusTerms())}},listeners:{resize:function(a,b,c){this.getVisLayout()&&this.getCorpus()&&
...
e>c&&(c=e)}this.setSmallestWordSize(b);this.setLargestWordSize(c);this.setRelativeSizes();this.setAdjustedSizes();this.getVisLayout().words(a).start()}else Ext.defer(this.buidlFromTerms,50,this)},draw:function(a,b){var c=this,d=d3.scale.category20b();this.getLayout().getRenderTarget();var e=this.getVisLayout().size()[0],f=this.getVisLayout().size()[1],g=b?Math.min(e/Math.abs(b[1].x-e/2),e/Math.abs(b[0].x-e/2),f/Math.abs(b[1].y-f/2),f/Math.abs(b[0].y-f/2))/2:1,h=this.getVis().selectAll("text").data(a,
function(a){return a.text});h.transition().duration(1E3).attr("transform",function(a){return"translate("+[a.x,a.y]+")rotate("+a.rotate+")"}).style("font-size",function(a){return a.fontSize+"px"});h.enter().append("text").attr("text-anchor","middle").attr("data-freq",function(a){return a.rawFreq}).attr("transform",function(a){return"translate("+[a.x,a.y]+")rotate("+a.rotate+")"}).style("font-size","1px").transition().duration(1E3).style("font-size",function(a){return a.fontSize+"px"});h.style("font-family",
function(a){return a.font}).style("fill",function(a){return d(a.text)}).text(function(a){return a.text}).on("click",function(a){c.dispatchEvent("termsClicked",c,[a.text])});h.exit().remove();this.getVis().transition().duration(1E3).attr("transform","translate("+e/2+","+f/2+")scale("+g+")")},map:function(a,b,c,d,e){return d+(a-b)/(c-b)*(e-d)},calculateSizeAdjustment:function(){var a=this.getTerms();if(void 0!==a){var b=this.getLayout().getRenderTarget(),b=b.getWidth()*b.getHeight();1E5>b?this.setMinFontSize(8):
