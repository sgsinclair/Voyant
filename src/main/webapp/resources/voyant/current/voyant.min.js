...
visible:{en:"Show"},maxTerms:{en:"Max terms"},options:{en:"Options"},visibleTerms:{en:"Terms"}},api:{stopList:"auto",limit:500,visible:50,terms:void 0,docId:void 0,docIndex:void 0},glyph:"xf06e@FontAwesome"},config:{mode:void 0,options:[{xtype:"stoplistoption"},{xtype:"numberfield",name:"label",fieldLabel:"Max words",labelAlign:"right",value:500,minValue:50,step:50,listeners:{afterrender:function(a){var b=a.up("window");b&&b.panel&&a.setFieldLabel(b.panel.localize("maxTerms"))}}}],corpus:void 0,records:void 0,
terms:void 0,visLayout:void 0,vis:void 0,sizeAdjustment:100,minFontSize:12,largestWordSize:0,smallestWordSize:1E6},MODE_CORPUS:"corpus",MODE_DOCUMENT:"mode_document",layout:"fit",constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(a){Ext.apply(this,{title:this.localize("title"),dockedItems:[{dock:"bottom",xtype:"toolbar",enableOverflow:!0,items:[{xtype:"corpusdocumentselector",singleSelect:!0},{fieldLabel:this.localize("visibleTerms"),
labelWidth:40,width:120,xtype:"slider",increment:25,minValue:25,maxValue:500,listeners:{afterrender:function(a){a.maxValue=this.getApiParam("limit");a.increment=parseInt(a.maxValue/50);a.setValue(this.getApiParam("visible"))},changecomplete:function(a,c){this.setApiParams({visible:c});this.loadFromTermsRecords()},scope:this}}]}]});this.callParent(arguments)},listeners:{resize:function(a,b,c){this.getVisLayout()&&this.getCorpus()&&(this.setAdjustedSizes(),a=this.getLayout().getRenderTarget(),b=a.getWidth(),
...
b){this.getMode()!=this.MODE_CORPUS&&this.loadFromCorpus(b)},boxready:function(){this.initVisLayout()}},loadFromCorpus:function(a){this.setCorpus(a);this.setApiParams({docId:void 0,docIndex:void 0});this.loadFromCorpusTerms(a.getCorpusTerms({autoload:!1,pageSize:this.getApiParam("maxVisible"),parentPanel:this}))},loadFromDocumentTerms:function(a){a.load({callback:function(a,c,d){this.setMode(this.MODE_DOCUMENT);this.setRecords(c.getRecords());this.loadFromTermsRecords()},scope:this,params:this.getApiParams()})},
loadFromCorpusTerms:function(a){a.load({callback:function(a,c,d){this.setMode(this.MODE_CORPUS);this.setRecords(c.getRecords());this.loadFromTermsRecords()},scope:this,params:this.getApiParams()})},loadFromTermsRecords:function(){var a=this.getRecords(),b=this.getApiParam("visible");b>a.length&&(b=a.length);for(var c=[],d=0;d<b;d++)c.push({text:a[d].get("term"),rawFreq:a[d].get("rawFreq")});this.setTerms(c);this.buildFromTerms()},initVisLayout:function(){if(void 0==this.getVisLayout()){var a=this.getLayout().getRenderTarget(),
b=a.getWidth(),c=a.getHeight();this.setVisLayout(d3.layout.cloud().size([b,c]).padding(1).rotate(function(){return 90*~~(2*Math.random())}).spiral("archimedean").font("Impact").fontSize(function(a){return a.fontSize}.bind(this)).text(function(a){return a.text}).on("end",this.draw.bind(this)));a=d3.select(a.dom).append("svg").attr("id","cirrusGraph").attr("width",b).attr("height",c);this.setVis(a.append("g").attr("transform","translate("+b/2+","+c/2+")"));Ext.create("Ext.tip.ToolTip",{target:a.node(),
delegate:"text",trackMouse:!0,listeners:{beforeshow:function(a){var b=a.triggerElement.getAttribute("data-freq");a.update(b)}}})}},buildFromTerms:function(){var a=this.getTerms();if(this.rendered&&a){for(var b=1E3,c=-1,d=0;d<a.length;d++){var e=a[d].rawFreq;e<b&&(b=e);e>c&&(c=e)}this.setSmallestWordSize(b);this.setLargestWordSize(c);this.setRelativeSizes();this.setAdjustedSizes();this.getVisLayout().words(a).start()}else Ext.defer(this.buidlFromTerms,50,this)},draw:function(a,b){var c=this;this.getLayout().getRenderTarget();
...
tokenFreqTip:{en:"\x3cb\x3e{0}\x3c/b\x3e\x3cbr/\x3e\x3cb\x3eRaw Frequency\x3c/b\x3e\x3cbr/\x3e{1}\x3c/b\x3e\x3cbr/\x3e\x3cb\x3eRelative Frequency\x3c/b\x3e\x3cbr/\x3e{2}\x3c/b\x3e"},docFreqTip:{en:"\x3cb\x3e{0}\x3c/b\x3e\x3cbr/\x3e\x3cb\x3eWord Count\x3c/b\x3e\x3cbr/\x3e{1}\x3c/b\x3e"},noTermSelected:{en:"No term selected."}},api:{docId:void 0,analysis:"ca",limit:50,dimensions:3,bins:10,clusters:3,comparisonType:"relative",stopList:"auto",target:void 0,term:void 0,query:void 0},glyph:"xf06e@FontAwesome"},
tokenFreqTipTemplate:null,docFreqTipTemplate:null,caStore:null,pcaStore:null,docSimStore:null,termStore:Ext.create("Ext.data.JsonStore",{fields:[{name:"term"},{name:"rawFreq",type:"int"},{name:"relativeFreq",type:"number"},{name:"coordinates",mapping:"vector"}],sorters:[{property:"rawFreq",direction:"DESC"}]}),newTerm:null,termsTimeout:null,chartMenu:null,labelsMode:0,highlightData:{x:0,y:0,r:0},highlightTask:null,constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,
arguments)},initComponent:function(){Ext.apply(this,{title:this.localize("title"),caStore:Ext.create("Voyant.data.store.CAAnalysis"),pcaStore:Ext.create("Voyant.data.store.PCAAnalysis"),docSimStore:Ext.create("Voyant.data.store.DocSimAnalysis"),termStore:this.termStore,chartMenu:Ext.create("Ext.menu.Menu",{items:[{text:this.localize("remove"),itemId:"remove",glyph:"xf068@FontAwesome"},{text:this.localize("nearby"),itemId:"nearby",glyph:"xf0b2@FontAwesome"}],listeners:{hide:function(){var a=this.down("#chart").getSeries();
a[0].enableToolTips();a[1].enableToolTips()},scope:this}}),layout:"border",autoDestroy:!0,items:[{itemId:"chartParent",region:"center",layout:"fit",tbar:{enableOverflow:!0,items:[{xtype:"documentselectorbutton"},{text:this.localize("analysis"),itemId:"analysis",glyph:"xf1ec@FontAwesome",enableOverflow:!0,menu:{items:[{text:this.localize("pca"),itemId:"analysis_pca",group:"analysis",xtype:"menucheckitem"},{text:this.localize("ca"),itemId:"analysis_ca",group:"analysis",xtype:"menucheckitem"},{text:this.localize("docSim"),
itemId:"analysis_docSim",group:"analysis",xtype:"menucheckitem"}],listeners:{click:function(a,b){void 0!==b&&(b.text===this.localize("pca")?this.setApiParam("analysis","pca"):b.text===this.localize("docSim")?this.setApiParam("analysis","docSim"):(this.setApiParam("analysis","ca"),this.getCorpus().getDocumentsCount()),this.loadFromApis(!0))},scope:this}}},{text:this.localize("freqsMode"),glyph:"xf201@FontAwesome",tooltip:this.localize("freqsModeTip"),menu:{items:[{text:this.localize("rawFrequencies"),
checked:!1,itemId:"raw",group:"freqsMode",checkHandler:function(a,b){b&&(this.setApiParam("comparisonType","raw"),this.loadFromApis())},scope:this},{text:this.localize("relativeFrequencies"),checked:!0,itemId:"relative",group:"freqsMode",checkHandler:function(a,b){b&&(this.setApiParam("comparisonType","relative"),this.loadFromApis())},scope:this},{text:this.localize("tfidf"),checked:!1,itemId:"tfidf",group:"freqsMode",checkHandler:function(a,b){b&&(this.setApiParam("comparisonType","tfidf"),this.loadFromApis())},
scope:this}]}},{text:this.localize("clusters"),itemId:"clusters",glyph:"xf192@FontAwesome",menu:{items:[{text:"1",itemId:"clusters_1",group:"clusters",xtype:"menucheckitem"},{text:"2",itemId:"clusters_2",group:"clusters",xtype:"menucheckitem"},{text:"3",itemId:"clusters_3",group:"clusters",xtype:"menucheckitem"},{text:"4",itemId:"clusters_4",group:"clusters",xtype:"menucheckitem"},{text:"5",itemId:"clusters_5",group:"clusters",xtype:"menucheckitem"}],listeners:{click:function(a,b){void 0!==b&&(this.setApiParam("clusters",
...
this);this.pcaStore.on("load",function(a,b){this.buildChart(a)},this);this.docSimStore.on("load",function(a,b){this.buildChart(a)},this);this.tokenFreqTipTemplate=new Ext.Template(this.localize("tokenFreqTip"));this.docFreqTipTemplate=new Ext.Template(this.localize("docFreqTip"));this.callParent(arguments)},buildChart:function(a){var b=this,c=this.queryById("chart");null!==c&&this.queryById("chartParent").remove(c);var c=a.getAt(0),d=this.getApiParam("dimensions");a="";if("pca"===this.getApiParam("analysis")){for(var e=
c.getPrincipalComponents(),f=0,g=0;g<e.length;g++)var h=e[g],f=f+parseFloat(h.get("eigenValue"));a=this.localize("pcTitle")+"\n";for(var k=["xAxis","yAxis","fill"],g=0;g<e.length&&!(g>=d);g++)h=e[g],h=parseFloat(h.get("eigenValue"))/f*100,a+=this.localize("pc")+" "+(g+1)+" ("+this.localize(k[g])+"): "+Math.round(100*h)/100+"%\n"}else for(a=this.localize("caTitle")+"\n",k=["xAxis","yAxis","fill"],e=c.getDimensions(),g=0;g<e.length&&!(g>=d);g++)h=parseFloat(e[g].data),a+=this.localize("dimension")+
" "+(g+1)+" ("+this.localize(k[g])+"): "+Math.round(100*h)/100+"%\n";var l=0,m=Number.MAX_VALUE,n=0,q=Number.MAX_VALUE;"docSim"!==this.getApiParam("analysis")&&this.termStore.removeAll();var s=[],p=[];c.getTokens().forEach(function(a){var b=a.get("rawFreq"),c=a.get("category");void 0===c&&(c="term");var e="term"===c;e&&(b>l&&(l=b),b<m&&(m=b),this.termStore.findExact("term",-1===a.get("term"))&&this.termStore.addSorted(a));if(3===d){var f=a.get("vector")[2];f<q&&(q=f);f>n&&(n=f)}b={x:a.get("vector")[0],
y:a.get("vector")[1],z:a.get("vector")[2],term:a.get("term"),rawFreq:b,relativeFreq:a.get("relativeFreq"),cluster:a.get("cluster"),category:c};e?s.push(b):("bin"===a.get("category")?b.term=b.title="Bin "+a.get("docIndex"):(b.docIndex=a.get("docIndex"),a=this.getCorpus().getDocument(b.docIndex),null!==a&&(b.term=a.getTinyTitle(),b.title=a.getTitle())),p.push(b))},this);c=this.termStore.getCount();this.queryById("limit").setRawValue(c);this.setApiParam("limit",c);c=Ext.create("Ext.data.JsonStore",{fields:"term x y z rawFreq relativeFreq cluster category docIndex".split(" "),
data:s});g=Ext.create("Ext.data.JsonStore",{fields:"term x y z rawFreq relativeFreq cluster category docIndex".split(" "),data:p});a={itemId:"chart",xtype:"cartesian",interactions:["crosszoom","panzoom","itemhighlight"],plugins:{ptype:"chartitemevents"},axes:[{type:"numeric",position:"bottom",fields:["x"]},{type:"numeric",position:"left",fields:["y"]}],sprites:[{type:"text",text:a,hidden:0<this.labelsMode,x:70,y:70}],innerPadding:{top:25,right:25,bottom:25,left:25},series:[{type:"customScatter",xField:"x",
yField:"y",store:c,tooltip:{trackMouse:!0,style:"background: #fff",renderer:function(a,c){this.setHtml(b.tokenFreqTipTemplate.apply([a.get("term"),a.get("rawFreq"),a.get("relativeFreq")]))}},marker:{type:"circle"},highlight:{fillStyle:"yellow",strokeStyle:"black"},renderer:function(a,b,c,e){c=c.store.getAt(e);if(null!==c){var f=c.get("cluster");a=this.getParent().up("scatterplot");-1===f&&(f=0);e=.65;3===d&&(e=a.interpolate(c.get("z"),q,n,0,1));f=a.getApplication().getColor(f);b.fillStyle="rgba("+
f.join(",")+","+e+")";b.strokeStyle="rgba("+f.join(",")+",1)";c=c.get("rawFreq");a=a.interpolate(c,m,l,2,20);b.radius=a}}},{type:"customScatter",xField:"x",yField:"y",store:g,tooltip:{trackMouse:!0,style:"background: #fff",renderer:function(a,c){this.setHtml(b.docFreqTipTemplate.apply([a.get("title"),a.get("rawFreq")]))}},marker:{type:"diamond"},highlight:{fillStyle:"yellow",strokeStyle:"black"},renderer:function(a,b,c,e){c=c.store.getAt(e);if(null!==c){e=c.get("cluster");var f=this.getParent().up("scatterplot");
if(-1===e||"docSim"!==f.getApiParam("analysis"))e=6;a=.65;3===d&&(a=f.interpolate(c.get("z"),q,n,0,1));c=f.getApplication().getColor(e);b.fillStyle="rgba("+c.join(",")+","+a+")";b.strokeStyle="rgba("+c.join(",")+",1)";b.radius=5}}}],listeners:{itemclick:function(a,b,c){a=b.record.data;"doc"===a.category?(a=this.getCorpus().getDocument(a.docIndex),this.getApplication().dispatchEvent("documentsClicked",this,[a])):"term"===a.category&&(a=Ext.create("Voyant.data.model.CorpusTerm",a),this.getApplication().dispatchEvent("corpusTermsClicked",
this,[a]))},render:function(a){a.body.on("contextmenu",function(a,b){a.preventDefault();var c=a.getXY(),d=Ext.fly(b).getXY(),e=c[0]-d[0],d=c[1]-d[1],f=this.down("#chart").getItemForPoint(e,d);null!=f&&"term"===f.record.get("category")&&(e=this.down("#chart").getSeries(),e[0].disableToolTips(),e[1].disableToolTips(),e=f.record.get("term"),d=(new Ext.Template(this.localize("removeTerm"))).apply([e]),this.chartMenu.queryById("remove").setText(d),d=(new Ext.Template(this.localize("nearbyTerm"))).apply([e]),
this.chartMenu.queryById("nearby").setText(d),this.chartMenu.on("click",function(a,b){if(void 0!==b){var c=f.record.get("term");b.text===this.localize("remove")?this.removeTerm(c):this.getNearbyForTerm(c)}},this,{single:!0}),this.chartMenu.showAt(c))},this)},scope:this}};3>this.labelsMode&&(a.series[0].label={field:"term",display:"over"},a.series[1].label={field:"term",display:"over"});a=Ext.create("Ext.chart.CartesianChart",a);this.queryById("chartParent").insert(0,a);null!==this.newTerm&&(this.selectTerm(this.newTerm),
this.newTerm=null)},doLabels:function(){var a=this.queryById("chart"),b=a.getSeries(),c=a.getSurface("chart").getItems()[0];debugger;switch(this.labelsMode){case 0:b[0].getLabel().show();b[1].getLabel().show();c.show();break;case 1:b[0].getLabel().show();b[1].getLabel().hide();c.hide();break;case 2:b[0].getLabel().hide();b[1].getLabel().show();c.hide();break;case 3:b[0].getLabel().hide(),b[1].getLabel().hide(),c.hide()}a.redraw()},selectTerm:function(a){var b=this.down("#chart").getSeries()[0];a=
b.getStore().findExact("term",a);if(-1!==a){var c=b.getStore().getAt(a),d=b.getSprites()[0],c={series:b,category:b.getItemInstancing()?"items":"markers",index:a,record:c,field:b.getYField(),sprite:d};b.setHighlightItem(c);b=this.getPointFromIndex(b,a);this.highlightData={x:b[0],y:b[1],r:50};null==this.highlightTask&&(this.highlightTask=Ext.TaskManager.newTask({run:this.doHighlight,scope:this,interval:25,repeat:this.highlightData.r}));this.highlightTask.restart()}},getPointFromIndex:function(a,b){var c=
