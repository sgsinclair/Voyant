...
triggers:{help:{weight:2,cls:"fa-trigger form-fa-help-trigger",handler:"onHelpClick",scope:"this"}},initComponent:function(a){var b=this;Ext.applyIf(b,{width:120});Ext.apply(b,{enableKeyEvents:!0,listeners:{render:function(a){a.triggers&&a.triggers.help&&Ext.QuickTips.register({target:a.triggers.help.getEl(),text:a.localize("querySearchTip"),enabled:!0,showDelay:20,trackMouse:!0,autoShow:!0});this.suggest=Ext.create("Ext.tip.ToolTip",{target:this.inputEl,autoShow:!1,hidden:!0,html:""})},keyup:function(a,
b,e){if((!this.store||Ext.isString(this.store))&&this.findParentByType){b=this.findParentByType("panel");var f;b.getCorpus?f=b.getCorpus():b.getStore&&b.getStore().getCorpus&&(f=b.getStore().getCorpus());f&&(this.store=f.getCorpusTerms())}this.store&&(a=a.getValue().trim().replace(/^\^/,""),0==/[,|^~" ]/.test(a)&&0<a.length?this.store.load({params:{query:[a+"*","^"+a+"*"],limit:5},scope:this,callback:function(a,b,c){suggest="";a.forEach(function(a){suggest+="\x3cdiv\x3e"+a.getTerm()+" ("+a.getRawFreq()+
")\x3c/div\x3e"});this.suggest.show();this.suggest.update(suggest)}}):(this.suggest.update(""),this.suggest.hide()))},scope:b},emptyText:b.localize("querySearch")});b.callParent(arguments);b.on("specialkey",function(a,d){d.getKey()==d.ENTER&&b.doSearch()})},onClearClick:function(){this.setValue("");this.findParentByType("panel").fireEvent("query",this,void 0);this.updateLayout()},onHelpClick:function(){Ext.Msg.show({title:this.localize("querySearch"),message:this.localize("querySearchTip"),buttons:Ext.Msg.OK,
...
Ext.define("Ext.chart.series.CustomScatter",{extend:"Ext.chart.series.Scatter",alias:"series.customScatter",type:"customScatter",seriesType:"scatterSeries",tipsDisabled:!1,enableToolTips:function(){this.tipsDisabled=!1},disableToolTips:function(){this.tipsDisabled=!0},showTip:function(a,b){this.tipsDisabled||this.callParent(arguments)}});Ext.define("Voyant.panel.DocumentSimilarity",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],requires:["Ext.chart.CartesianChart"],alias:"widget.documentsimilarity",config:{corpus:void 0,options:{xtype:"stoplistoption"}},statics:{i18n:{title:{en:"Document Similarity"},loading:{en:"Loading"},helpTip:{en:""},tokenFreqTip:{en:"\x3cb\x3e{0}\x3c/b\x3e\x3cbr/\x3e\x3cb\x3eRaw Frequency\x3c/b\x3e\x3cbr/\x3e{1}\x3c/b\x3e\x3cbr/\x3e\x3cb\x3eRelative Frequency\x3c/b\x3e\x3cbr/\x3e{2}\x3c/b\x3e"},docFreqTip:{en:"\x3cb\x3e{0}\x3c/b\x3e\x3cbr/\x3e\x3cb\x3eWord Count\x3c/b\x3e\x3cbr/\x3e{1}\x3c/b\x3e"},
noTermSelected:{en:"No term selected."}},api:{limit:50,dimensions:3,clusters:3,stopList:"auto",docId:void 0},glyph:"xf06e@FontAwesome"},tokenFreqTipTemplate:null,docFreqTipTemplate:null,chartMenu:null,labelsMode:0,constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(){Ext.apply(this,{title:this.localize("title"),docSimStore:Ext.create("Voyant.data.store.DocSimAnalysis"),autoDestroy:!0,layout:"fit",items:{layout:"fit",
...
z:a.get("vector")[2],isDoc:c};c?(b.docIndex=a.get("docIndex"),a=this.getCorpus().getDocument(b.docIndex),b.term=a.getTinyTitle(),b.title=a.getTitle(),k.push(b)):h.push(b)},this);a=Ext.create("Ext.data.JsonStore",{fields:"term x y z rawFreq relativeFreq cluster isDoc docIndex".split(" "),data:h});c=Ext.create("Ext.data.JsonStore",{fields:"term x y z rawFreq relativeFreq cluster isDoc docIndex".split(" "),data:k});a={itemId:"chart",xtype:"cartesian",interactions:["crosszoom","panzoom","itemhighlight"],
plugins:{ptype:"chartitemevents"},axes:[{type:"numeric",position:"bottom",fields:["x"]},{type:"numeric",position:"left",fields:["y"]}],innerPadding:{top:25,right:25,bottom:25,left:25},series:[{type:"customScatter",xField:"x",yField:"y",store:a,tooltip:{trackMouse:!0,style:"background: #fff",renderer:function(a,c){this.setHtml(b.tokenFreqTipTemplate.apply([a.get("term"),a.get("rawFreq"),a.get("relativeFreq")]))}},marker:{type:"circle"},highlight:{fillStyle:"yellow",strokeStyle:"black"},renderer:function(a,
b,c,h){c=c.store.getAt(h);if(null!==c){var k=c.get("cluster");a=this.getParent().up("documentsimilarity");-1===k&&(k=0);h=.65;h=a.interpolate(c.get("z"),g,f,0,1);k=a.getApplication().getColor(k);b.fillStyle="rgba("+k.join(",")+","+h+")";b.strokeStyle="rgba("+k.join(",")+",1)";c=c.get("rawFreq");a=a.interpolate(c,e,d,2,20);b.radius=a}}},{type:"customScatter",xField:"x",yField:"y",store:c,tooltip:{trackMouse:!0,style:"background: #fff",renderer:function(a,c){this.setHtml(b.docFreqTipTemplate.apply([a.get("title"),
a.get("rawFreq")]))}},marker:{type:"diamond"},highlight:{fillStyle:"yellow",strokeStyle:"black"},renderer:function(a,b,c,d){c=c.store.getAt(d);null!==c&&(c.get("cluster"),d=this.getParent().up("documentsimilarity"),a=.65,a=d.interpolate(c.get("z"),g,f,0,1),c=d.getApplication().getColor(6),b.fillStyle="rgba("+c.join(",")+","+a+")",b.strokeStyle="rgba("+c.join(",")+",1)",b.radius=5)}}],listeners:{itemclick:function(a,b,c){a=b.record.data;a.isDoc?(a=this.getCorpus().getDocument(a.docIndex),this.getApplication().dispatchEvent("documentsClicked",
this,[a])):(a=Ext.create("Voyant.data.model.CorpusTerm",a),this.getApplication().dispatchEvent("corpusTermsClicked",this,[a]))},scope:this}};a.series[0].label={field:"term",display:"over"};a.series[1].label={field:"term",display:"over"};a=Ext.create("Ext.chart.CartesianChart",a);this.queryById("chartParent").insert(0,a)},loadFromApis:function(a){a=this.down("#chart");null!==a&&a.mask(this.localize("loading"));a={};Ext.apply(a,this.getApiParams());this.docSimStore.load({params:a})},interpolate:function(a,
...
this.getApiParam("docId")||this.getApiParam("docIndex")?this.loadFromDocumentTerms():this.loadFromCorpusTerms()},scope:this}}]}]});this.callParent(arguments)},loadFromDocument:function(a){if(a.then){var b=this;a.then(function(a){b.loadFromDocument(a)})}else{var c={docIndex:void 0,query:void 0,docId:void 0};Ext.isNumber(a)?c.docIndex=a:Ext.isString(a)?c.docId=a:"Voyant.data.model.Document"==Ext.getClassName(a)&&(c.docId=a.getId());this.setMode(this.MODE_DOCUMENT);this.setApiParams(c);this.isVisible()&&
...
1==a.getDocumentsCount()?this.loadFromDocument(a.getDocument(0)):this.loadFromCorpusTerms(a.getCorpusTerms())},loadFromCorpusTerms:function(a){this.getCorpus()&&(a=a||this.getCorpus().getCorpusTerms({autoLoad:!1}),a.load({callback:function(a,c,d){d?(this.setMode(this.MODE_CORPUS),this.loadFromRecords(a)):Voyant.application.showResponseError(this.localize("failedGetCorpusTerms"),c)},scope:this,params:this.getApiParams(["limit","stopList","query","withDistributions","bins"])}))},loadFromRecords:function(a){var b=
this.getApiParam("mode"),c=[],d=["index"],e=[],f=0;a.forEach(function(a,g){var l=a.get("term");a.get("distributions").forEach(function(a,b){c[b]||(c[b]={index:b});c[b]["_"+g]=a;a>f&&(f=a)},this);d.push("_"+g);e.push({type:"line",title:l,xField:"index",yField:"_"+g,style:{lineWidth:2},marker:{radius:3},highlight:!0,smooth:!0,tooltip:{trackMouse:!0,style:"background: #fff",renderer:function(a,c){var d="\x3ci\x3e"+c.series.getTitle()+"\x3c/i\x3e: "+a.get(c.series.getYField());if(b==this.panel.MODE_CORPUS){var e=
this.panel.getCorpus();e&&e.getDocumentsCount()==a.store.getCount()&&(d+="\x3cbr/\x3e\x3ci\x3e"+this.panel.getCorpus().getDocument(c.index).getShortTitle()+"\x3c/i\x3e")}this.setHtml(d)},panel:this},listeners:{itemclick:{fn:this.handleClickedItem,scope:this}}})},this);a=Ext.create("Ext.data.JsonStore",{fields:d,data:c});d.shift();var g=this;this.buildChart({store:a,series:e,axes:[{type:"numeric",position:"left",majorTickSteps:"raw"==this.getApiParam("withDistributions")&&20>f?f:void 0,increment:1,
title:{text:this.localize("raw"==this.getApiParam("withDistributions")?"rawFrequencies":"relativeFrequencies")}},{type:"category",position:"bottom",fields:["index"],title:{text:this.localize(b==this.MODE_DOCUMENT?"segments":"documents")},label:{rotate:{degrees:-30},textAlign:"end"},renderer:function(a,c){return b==g.MODE_DOCUMENT?parseInt(a)+1:g.getCorpus().getDocument(a).getTinyTitle()}}]})},reloadFromChart:function(){var a=this.down("chart");if(a){var b=[];a.series.forEach(function(a){b.push(a.getTitle())});
