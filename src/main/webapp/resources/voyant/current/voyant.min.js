...
a.openUrl(url)},exportToolClick:function(a){a.isXType("voyanttabpanel")&&(a=a.getActiveTab());var b="beta.voyant-tools.org"==window.location.hostname?[{html:"\x3cp class\x3d'keyword' style\x3d'text-align: center; font-weight: bold; padding: 4px;'\x3ePlease note that this is the beta server and you should not count on corpora persisting (for bookmarks, embedding, etc.)."}]:[],c=[{xtype:"radio",name:"export",inputValue:"embed",boxLabel:a.localize("exportViewHtmlEmbed")},{xtype:"radio",name:"export",
inputValue:"biblio",boxLabel:a.localize("exportViewBiblio")}];a.getExtraExportItems&&a.getExtraExportItems().forEach(function(a){Ext.applyIf(a,{xtype:"radio",name:"export"});c.push(a)});b.push({xtype:"radio",name:"export",inputValue:"url",boxLabel:"\x3ca href\x3d'"+a.getExportUrl.call(a)+"' target\x3d'_blank'\x3e"+a.localize("exportViewUrl")+"\x3c/a\x3e",checked:!0,listeners:{afterrender:function(){this.boxLabelEl.on("click",function(){this.up("window").close()},this)}}},{xtype:"fieldset",collapsible:!0,
collapsed:!0,title:a.localize("exportViewFieldset"),items:c});if(a.isXType("grid")){var d=[{xtype:"radio",name:"export",inputValue:"gridCurrentHtml",boxLabel:a.localize("exportGridCurrentHtml")},{xtype:"radio",name:"export",inputValue:"gridCurrentTsv",boxLabel:a.localize("exportGridCurrentTsv")}];a.getExportGridAll&&0==a.getExportGridAll()||d.push({xtype:"radio",name:"export",inputValue:"gridAllJson",boxLabel:a.localize("exportGridAllJson")},{xtype:"radio",name:"export",inputValue:"gridAllTsv",boxLabel:a.localize("exportGridAllTsv")});
b.push({xtype:"fieldset",collapsible:!0,collapsed:!0,title:a.localize("exportGridCurrent"),items:d})}a.getExportVisualization&&!a.getExportVisualization()||0!=a.isXType("grid")||!(a.down("chart")||a.getTargetEl().dom.querySelector("canvas")||a.getTargetEl().dom.querySelector("svg"))||(d=[{xtype:"radio",name:"export",inputValue:"png",boxLabel:a.localize("exportPng")},{xtype:"slider",width:200,value:1,minValue:.5,maxValue:10,increment:.5,labelAlign:"right",decimalPrecision:1,itemId:"scale",fieldLabel:(new Ext.Template(a.localize("scaleLabel"))).apply([1]),
listeners:{change:function(b,c){this.setFieldLabel((new Ext.Template(a.localize("scaleLabel"))).apply([c]))},changecomplete:function(a){a.previousSibling().setValue(!0)}}}],a.getTargetEl().dom.querySelector("svg")&&d.push({xtype:"radio",name:"export",inputValue:"svg",boxLabel:a.localize("exportSvg")}),b.push({xtype:"fieldset",collapsible:!0,collapsed:!0,title:a.localize("exportVizTitle"),items:d}));Ext.create("Ext.window.Window",{title:a.localize("exportTitle"),modal:!0,items:{xtype:"form",items:b,
...
flex:1,checked:"xml"==c}}]}]}],buttons:[{text:this.localize("ok"),handler:function(){var c=this.up("window");values=c.down("form").getForm().getValues();a.switchModes(values.codeMode);c.close()}},{text:this.localize("cancel"),handler:function(){this.up("window").close()}}]})).show()},scope:this}}]},{xtype:"toolbar",dock:"right",items:[{xtype:"notebookwrappercounter",order:a.order,name:a.name},{xtype:"notebookwrapperremove"},{xtype:"notebookwrappermoveup"},{xtype:"notebookwrappermovedown"}]}],items:[this.editor,
this.results]});this.callParent(arguments)},initComponent:function(a){var b=this;b.on("afterrender",function(){this.editor&&"ace/mode/javavscript"!=this.editor.getMode()&&this.switchModes(this.editor.getMode(),!0);this.getTargetEl().on("resize",function(a){var d=20;b.items.each(function(a){d+=a.getHeight()});b.setSize({height:d})})},this);b.callParent(arguments)},switchModes:function(a,b){var c=-1<a.indexOf("javascript");this.down("notebookwrapperrun").setVisible(c);this.down("notebookwrapperrununtil").setVisible(c);
this.results.setVisible(c);b||this.editor.switchModes(a)},run:function(a){if("ace/mode/javascript"==this.editor.getMode()){if(!0===a)return this._run();var b=this.up("notebook");Ext.Array.each(b.query("notebookcodeeditorwrapper"),function(a){if(a==this)return this._run(),!1;a.editor&&"ace/mode/javascript"==a.editor.getMode()&&0==a.getIsRun()&&Ext.Msg.confirm(this.localize("previousNotRunTitle"),this.localize("previousNotRun"),function(a){if("yes"==a)b.runAllCode();else return this._run()},this)},
this)}},_run:function(){this.results.show();this.results.update(" ");this.results.mask("working\u2026");var a=this.editor.getValue();Voyant.notebook.util.Show.TARGET=this.results.getEl();Voyant.notebook.Notebook.currentBlock=this;Voyant.notebook.Notebook.currentNotebook.setCurrentBlock(this);var b;try{b=eval.call(window,a)}catch(c){return this.results.unmask(),Voyant.notebook.util.Show.showError(c),this.getTargetEl().fireEvent("resize"),c}this.setIsRun(!0);if(void 0!==b)if(b.then&&b["catch"]&&b["finally"]){var d=
this;b.then(function(a){void 0!==a&&Spyral.Notebook.show(a)})["catch"](function(a){Voyant.notebook.util.Show.showError(a)})["finally"](function(){d.results.unmask();Ext.defer(function(){this.getTargetEl().fireEvent("resize")},50,d)})}else this.results.unmask(),Spyral.Notebook.show(b);this.setIsRun(!0);return b},clearResults:function(){this.results.show();var a=this.results.el.down(".x-panel");if(a){var b=Ext.getCmp(a.id);b?b.destroy():a.destroy()}else this.results.update(" ");this.getTargetEl().fireEvent("resize")},
tryToUnmask:function(){Spyral&&Spyral.promises&&Ext.defer(this.tryToUnmask,20,this);if(0==Voyant.application.getDeferredCount()){for(var a in window)"object"==typeof window[a]&&window[a]&&"opener"!=a&&window[a].isFulfilled&&window[a].isFulfilled()&&(window[a]=window[a].valueOf());this.results.unmask();0==this.results.getTargetEl().getHtml().trim().length&&this.results.hide();this.getTargetEl().fireEvent("resize")}else Ext.defer(this.tryToUnmask,20,this)},getContent:function(){var a={input:this.editor.getValue(),
mode:this.editor.getMode().split("/").pop()};if("javascript"==a.mode){var b=this.results.getTargetEl(),c=b.dom.cloneNode(!0);a.output=c.innerHTML;c.style.height||(a.output="\x3cdiv style\x3d'height: "+b.getHeight()+"px'\x3e"+a.output+"\x3c/div\x3e")}return a}});Ext.define("Voyant.notebook.editor.TextEditor",{extend:"Ext.Component",mixins:["Voyant.util.Localization"],alias:"widget.notebooktexteditor",cls:"notebook-text-editor",config:{ckeditorConfig:{toolbar:[{name:"basicstyles",items:["Bold","Italic","-","RemoveFormat"]},{name:"paragraph",items:"NumberedList BulletedList - Justify Outdent Indent Blockquote JustifyLeft JustifyCenter JustifyRight".split(" ")},{name:"colors",items:["TextColor","BGColor"]},{name:"styles",items:["Styles","Format"]},{name:"links",
...
dock:"right",items:[{xtype:"notebookwrappercounter",order:a.order,name:a.name},{xtype:"notebookwrapperremove"},{xtype:"notebookwrappermoveup"},{xtype:"notebookwrappermovedown"}]}]});this.callParent(arguments)},getContent:function(){return this.items.get(0).getContent()}});Ext.define("Voyant.notebook.Notebook",{alternateClassName:["Notebook"],extend:"Ext.panel.Panel",requires:["Voyant.notebook.editor.CodeEditorWrapper","Voyant.notebook.editor.TextEditorWrapper","Voyant.notebook.util.Show","Voyant.panel.Cirrus","Voyant.panel.Summary"],mixins:["Voyant.panel.Panel"],alias:"widget.notebook",statics:{i18n:{title:"Spyral",metadataEditor:"Edit Metadata",metadataTitle:"Title",metadataTip:"Edit notebook metadata.",metadataAuthor:"Author(s)",metadataKeywords:"Keywords",metadataDescription:"Description",
metadataLicense:"Licence",metadataLanguage:"Language",metadataReset:"Reset",metadataSave:"Save",metadataCancel:"Cancel",created:"Created",modified:"Modified",clickToEdit:"Click to edit",cantLoadNotebook:"Unable to load Spyral notebook:",cannotLoadJson:"Unable to parse JSON input.",cannotLoadJsonUnrecognized:"Unable to recognize JSON input.",cannotLoadUnrecognized:"Unable to recognize input.",openTitle:"Open",openMsg:"Paste in Notebook ID, a URL or a Spyral data file (in HTML).",exportHtmlDownload:"HTML (download)"},
api:{input:void 0},currentNotebook:void 0},config:{notebookId:void 0,metadata:void 0,isEdited:!1,version:"3.0",currentBlock:void 0},constructor:function(a){Voyant.notebook.Notebook.currentNotebook=this;Ext.apply(a,{title:this.localize("title"),autoScroll:!0,includeTools:{help:!0,save:!0,saveIt:{tooltip:this.localize("saveItTip"),itemId:"saveItTool",callback:function(){this.mask(this.localize("saving"));this.getMetadata().setDateNow("modified");var a=this;Spyral.Load.trombone({tool:"notebook.NotebookManager",
action:"save",id:this.getNotebookId(),data:this.generateExportHtml()}).then(function(c){a.unmask();var d=a.getNotebookId();d&&c.notebook.id==d||a.setNotebookId(c.notebook.id);a.toastInfo({html:a.localize("saved"),anchor:"tr"});a.setIsEdited(!1)})["catch"](function(c){a.unmask()})},xtype:"toolmenu",glyph:"xf0c2@FontAwesome",disabled:!0,scope:this},"new":{tooltip:this.localize("newTip"),callback:function(){this.clear();this.addNew();url=this.getBaseUrl()+"spyral/";window.history.pushState({url:url},
"Spyral Notebook",url)},xtype:"toolmenu",glyph:"xf067@FontAwesome",scope:this},open:{tooltip:this.localize("openTip"),callback:function(){Ext.Msg.prompt(this.localize("openTitle"),this.localize("openMsg"),function(a,c){c=c.trim();"ok"==a&&(this.clear(),this.loadFromString(c))},this,!0)},xtype:"toolmenu",glyph:"xf115@FontAwesome",scope:this},runall:{tooltip:this.localize("runallTip"),callback:this.runAll,xtype:"toolmenu",glyph:"xf04e@FontAwesome",scope:this},metadata:{tooltip:this.localize("metadataTip"),
callback:this.showMetadataEditor,xtype:"toolmenu",glyph:"xf02c@FontAwesome",scope:this}},items:[{itemId:"spyralHeader",cls:"spyral-header",listeners:{afterrender:function(a){Ext.tip.QuickTipManager.register({target:a.getId(),text:this.localize("clickToEdit")});a.getTargetEl().on("click",function(c){this.showMetadataEditor();a.removeCls("editable")},this);a.mon(a.getEl(),"mouseover",function(){a.addCls("editable")});a.mon(a.getEl(),"mouseout",function(){a.removeCls("editable")})},scope:this}},{xtype:"container",
itemId:"cells"},{itemId:"spyralFooter",cls:"spyral-footer",listeners:{afterrender:function(a){Ext.tip.QuickTipManager.register({target:a.getId(),text:this.localize("clickToEdit")});a.getTargetEl().on("click",function(c){this.showMetadataEditor();a.removeCls("editable")},this);a.mon(a.getEl(),"mouseover",function(){a.addCls("editable")});a.mon(a.getEl(),"mouseout",function(){a.removeCls("editable")})},scope:this}}],listeners:{afterrender:this.init,notebookWrapperMoveUp:this.notebookWrapperMoveUp,notebookWrapperMoveDown:this.notebookWrapperMoveDown,
notebookWrapperRemove:this.notebookWrapperRemove,notebookWrapperAdd:this.notebookWrapperAdd,scope:this}});this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},init:function(){var a=Ext.Object.fromQueryString(document.location.search,!0),b=Ext.isDefined(a.run),c=/\/spyral\/([\w-]+)\/?$/.exec(location.pathname);a.input?0===a.input.indexOf("http")&&this.loadFromUrl(a.input,b):c?this.loadFromId(c[1]):this.addNew()},getBlock:function(a){a=a||0;var b=this.query("notebookcodeeditorwrapper"),
c=this.getCurrentBlock().id,d=b.findIndex(function(a){return a.id==c});if(0>d+a||d+a>b.length-1)Ext.Msg.show({title:this.localize("error"),msg:this.localize("blockDoesNotExist"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR});else return content=b[d+a].getContent(),content.input},addNew:function(){this.setMetadata(new Spyral.Metadata({title:"\x3ch1\x3eSpyral Notebook\x3c/h1\x3e"}));this.addText("\x3cp\x3eThis is a Spyral Notebook, a dynamic document that combines writing, code and data in service of reading, analyzing and interpreting digital texts.\x3c/p\x3e\x3cp\x3eSpyral Notebooks are composed of text blocks (like this one) and code blocks (like the one below). You can \x3cspan class\x3d'marker'\x3eclick on the blocks to edit\x3c/span\x3e them and add new blocks by clicking add icon that appears in the left column when hovering over a block.\x3c/p\x3e");
var a=this.addCode('loadCorpus("austen")');Ext.defer(function(){a.run()},100,this)},clear:function(){this.setMetadata(new Spyral.Metadata);this.getComponent("cells").removeAll()},loadFromString:function(a){a=a.trim();if(0==a.indexOf("http"))this.loadFromUrl(a);else if(0==a.indexOf("{")){var b;try{b=JSON.parse(a)}catch(c){return Ext.Msg.show({title:this.localize("error"),msg:this.localize("cannotLoadJson")+"\x3cbr\x3e\x3cpre style\x3d'color: red'\x3e"+c+"\x3c/pre\x3e",buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR})}if(!b.metadata||
...
icon:Ext.MessageBox.ERROR});this.loadFromHtmlString(a)}return!0},loadFromId:function(a){this.mask(this.localize("loading"));var b=this;Spyral.Load.trombone({tool:"notebook.NotebookManager",action:"load",id:a,noCache:1}).then(function(a){b.unmask();b.loadFromString(a.notebook.data);a.notebook.id&&a.notebook.id!=b.getNotebookId()&&b.setNotebookId(a.notebook.id);b.setIsEdited(!1)})["catch"](function(a){b.unmask()})},loadFromHtmlString:function(a){a=(new DOMParser).parseFromString(a,"text/html");this.loadFromDom(a)},
loadFromDom:function(a){this.setMetadata(new Spyral.Metadata(a));a.querySelectorAll("section.notebook-editor-wrapper").forEach(function(a){var c=a.classList;if(c.contains("notebooktexteditorwrapper"))c=a.querySelector(".notebook-text-editor").innerHTML,this.addText(c,void 0,a.id);else if(c.contains("notebookcodeeditorwrapper")){var d=a.querySelector(".notebook-code-editor-raw"),c=/\beditor-mode-(\w+)\b/.exec(d.className)[1],d="javascript"==c?d.innerText:d.innerHTML,e=a.querySelector(".notebook-code-results").innerHTML;
this.addCode({input:d,output:e,mode:c},void 0,a.id)}},this)},runUntil:function(a){var b=[];Ext.Array.each(this.query("notebookcodeeditorwrapper"),function(c){b.push(c);c.clearResults();if(a&&a==c)return!1},this);this._run(b)},runFrom:function(a){var b=[],c=!1;Ext.Array.each(this.query("notebookcodeeditorwrapper"),function(d){a&&a==d&&(c=!0);c&&(b.push(d),d.clearResults())},this);this._run(b)},runAll:function(){var a=[];Ext.Array.each(this.query("notebookcodeeditorwrapper"),function(b){a.push(b);b.clearResults()},
this);this._run(a)},_run:function(a){if(0<a.length){var b=a.shift().run(!0);if(void 0!==b&&b.then&&b["catch"]&&b["finally"]){var c=this;b.then(function(){Ext.defer(c._run,100,c,[a])})}else Ext.defer(this._run,100,this,[a])}},loadFromUrl:function(a,b){var c=this;Spyral.Load.text(a).then(function(a){c.loadFromString(a)})},addText:function(a,b,c){return this._add(a,b,"notebooktexteditorwrapper",c)},addCode:function(a,b,c){return this._add(a,b,"notebookcodeeditorwrapper",c)},_add:function(a,b,c,d){Ext.isString(a)&&
(a={input:a});d=this.getComponent("cells");b="undefined"===typeof b?d.items.length:b;return d.insert(b,Ext.apply(a,{xtype:c,order:b,name:Spyral.Util.id()}))},updateMetadata:function(){var a=this.getMetadata();this.getComponent("spyralHeader").update(a.title);this.getComponent("spyralFooter").update(this.getInnerFooterHtml())},notebookWrapperMoveUp:function(a){var b=this.getComponent("cells");a=b.items.findIndex("id",a.id);0==a?Ext.Msg.show({title:this.localize("error"),msg:this.localize("cannotMoveHigher"),
buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.WARNING}):(b.move(a,a-1),this.redoOrder())},notebookWrapperMoveDown:function(a){var b=this.getComponent("cells");a=b.items.findIndex("id",a.id);a==b.items.getCount()-1?Ext.Msg.show({title:this.localize("error"),msg:this.localize("cannotMoveLower"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.WARNING}):(b.move(a,a+1),this.redoOrder())},notebookWrapperRemove:function(a){var b=this.getComponent("cells");b.remove(a);0==b.items.length&&this.addText("(Click to edit).");
this.redoOrder()},notebookWrapperAdd:function(a,b){var c=this.getComponent("cells").items.findIndex("id",a.id),d=a.getXType(a);("notebooktexteditorwrapper"==d&&!b.hasModifier()||"notebookcodeeditorwrapper"==d&&b.hasModifier()?this.addCode("",c+1):this.addText("",c+1)).getTargetEl().scrollIntoView(this.getTargetEl(),null,!0,!0);this.redoOrder()},redoOrder:function(){this.query("notebookwrappercounter").forEach(function(a,b){a.setOrder(b)})},setIsEdited:function(a){this.getHeader()&&(this.getHeader().down("#saveItTool").setDisabled(0==
a),a||(this.query("notebookcodeeditor").forEach(function(a){a.setIsChangeRegistered(!1)}),this.query("notebooktexteditor").forEach(function(a){a.setIsEditRegistered(!1)})));this.callParent(arguments)},setNotebookId:function(a){a&&-1==location.pathname.indexOf("/spyral/"+a)&&(url=this.getBaseUrl()+"spyral/"+a+"/",window.history.pushState({url:url},"Spyral Notebook: "+a,url));this.callParent(arguments)},generateExportHtml:function(){var a="\x3c!DOCTYPE HTML\x3e\n\x3chtml\x3e\n\x3chead\x3e\n\t\x3cmeta charset\x3d'UTF-8'\x3e\n"+
...
this.getHeaderHtml()+"\x3carticle class\x3d'spyralArticle'\x3e";this.getComponent("cells").items.each(function(b,d){type=b.isXType("notebookcodeeditorwrapper")?"code":"text";content=b.getContent();var e=b.down("notebookwrappercounter");a+="\x3csection id\x3d'"+e.name+"' class\x3d'notebook-editor-wrapper "+b.xtype+"'\x3e\n\x3cdiv class\x3d'notebookwrappercounter'\x3e"+e.getTargetEl().dom.innerHTML+"\x3c/div\x3e";"code"==type?(e=b.down("notebookcodeeditor").getMode(),e=e.substring(e.lastIndexOf("/")+
1),a+="\x3cdiv class\x3d'notebook-code-editor ace-chrome'\x3e\n"+b.getTargetEl().query(".ace_text-layer")[0].outerHTML+"\n\x3c/div\x3e\n\x3cpre class\x3d'notebook-code-editor-raw editor-mode-"+e+"'\x3e\n"+content.input+"\x3c/pre\x3e\n\x3cdiv class\x3d'notebook-code-results'\x3e\n"+content.output+"\n\x3c/div\x3e\n"):a+="\x3cdiv class\x3d'notebook-text-editor'\x3e"+content+"\x3c/div\x3e\n";a+="\x3c/section\x3e\n"});return a+="\x3c/article\x3e\n\x3cfooter class\x3d'spyral-footer'\x3e"+this.getInnerFooterHtml()+
"\x3c/footer\x3e\x3c/body\x3e\n\x3c/html\x3e"},getHeaderHtml:function(){return"\x3cheader class\x3d'spyral-header'\x3e"+this.getMetadata().title+"\x3c/header\x3e\n"},getInnerFooterHtml:function(){var a="",b=this.getMetadata();if(b.author||b.license)a="\x26copy;",b.author&&(a+=" "+b.author),b.license&&(a+=" ("+b.license+")"),a+=". ";if(b.created||b.modified){var c=b.shortDate("created"),b=b.shortDate("modified");c&&(a+=this.localize("created")+" "+c+".");b&&c!=b&&(a+=this.localize("modified")+" "+
b+".")}return a},getExtraExportItems:function(){return[{inputValue:"html",boxLabel:this.localize("exportHtml")},{inputValue:"htmlDownload",boxLabel:'\x3ca href\x3d"#"\x3e'+this.localize("exportHtmlDownload")+"\x3c/a\x3e",listeners:{afterrender:function(a){var b,c=(this.getNotebookId()||"spyral")+".html",d=this.generateExportHtml().split("\n"),e={type:"text/html"};try{b=new File(d,c,e)}catch(f){b=new Blob(d,e)}b=URL.createObjectURL(b);a=a.boxLabelEl.dom.querySelector("a");a.setAttribute("download",
c);a.setAttribute("href",b)},scope:this},handler:function(a){a.boxLabelEl.dom.querySelector("a").click();a.up("window").close()}}]},exportHtml:function(){var a=this.generateExportHtml(),b=window.open();b.document.write(a);b.document.close();b.focus()},exportHtmlDownload:function(){var a,b=this.generateExportHtml().split("\n"),c={type:"text/plain"};try{a=new File(b,"files.txt",c)}catch(d){a=new Blob(b,c)}a=URL.createObjectURL(a);this.getApplication().openUrl(a)},getExportUrl:function(a){return location.href},
showMetadataEditor:function(){var a=this,b=this.getMetadata();Ext.create("Ext.window.Window",{title:this.localize("metadataEditor"),autoScroll:!0,items:[{xtype:"form",items:{bodyPadding:5,width:600,layout:"anchor",defaults:{anchor:"100%",labelAlign:"right"},defaultType:"textfield",items:[{fieldLabel:this.localize("metadataTitle"),xtype:"htmleditor",name:"title",value:b.title,height:100,enableAlignments:!1,enableColors:!1,enableFont:!1,enableFontSize:!1,enableLinks:!1,enableLists:!1},{fieldLabel:this.localize("metadataAuthor"),
name:"author",value:b.author},{fieldLabel:this.localize("metadataKeywords"),name:"keywords",value:b.keywords},{xtype:"htmleditor",fieldLabel:this.localize("metadataDescription"),name:"description",height:100,value:b.description,enableAlignments:!1,enableColors:!1,enableFont:!1},{xtype:"combo",fieldLabel:this.localize("metadataLicense"),name:"license",value:b.license||"Creative Commons Attribution (CC BY)",store:{fields:["text"],data:[{text:"Apache License 2.0"},{text:'BSD 3-Clause "New" or "Revised" license'},
{text:'BSD 2-Clause "Simplified" or "FreeBSD" license'},{text:"Creative Commons Attribution (CC BY)"},{text:"Creative Commons Attribution-ShareAlike (CC BY-SA)"},{text:"Creative Commons Zero (CC0)"},{text:"GNU General Public License (GPL)"},{text:'GNU Library or "Lesser" General Public License (LGPL)'},{text:"MIT license"},{text:"Mozilla Public License 2.0"},{text:"Common Development and Distribution License"},{text:"Eclipse Public License"}]}},{xtype:"combo",name:"language",value:b.language||"English",
fieldLabel:this.localize("metadataLanguage"),store:{fields:["text"],data:[{text:"Bengali"},{text:"Bhojpuri"},{text:"Egyptian Arabic"},{text:"English"},{text:"French"},{text:"German"},{text:"Gujarati"},{text:"Hausa"},{text:"Hindi"},{text:"Indonesian"},{text:"Italian"},{text:"Japanese"},{text:"Javanese"},{text:"Kannada"},{text:"Korean"},{text:"Mandarin"},{text:"Marathi"},{text:"Persian"},{text:"Portuguese"},{text:"Russian"},{text:"Southern Min"},{text:"Spanish"},{text:"Standard Arabic"},{text:"Swahili"},
{text:"Tamil"},{text:"Telugu"},{text:"Thai"},{text:"Turkish"},{text:"Urdu"},{text:"Vietnamese"},{text:"Western Punjabi"},{text:"Wu Chinese"},{text:"Yue Chinese"}]}}]}}],buttons:[{text:this.localize("metadataCancel"),ui:"default-toolbar",handler:function(){this.up("window").close()}},{text:this.localize("metadataReset"),ui:"default-toolbar",handler:function(){this.up("window").down("form").getForm().reset()}}," ",{text:this.localize("metadataSave"),handler:function(){var c=this.up("window").down("form").getForm();
b.set(c.getValues());a.updateMetadata();this.up("window").close()}}]}).show()}});Ext.define("Voyant.VoyantApp",{extend:"Ext.app.Application",mixins:["Voyant.util.Deferrable","Voyant.util.Localization","Voyant.util.Api","Voyant.util.CategoriesManager"],requires:["Voyant.util.ResponseError"],name:"VoyantApp",statics:{i18n:{},api:{palette:"default",lang:void 0,debug:void 0}},config:{baseUrl:void 0,tromboneUrl:void 0},constructor:function(a){this.setBaseUrl(this.config.baseUrl);this.setTromboneUrl(this.config.baseUrl+"trombone");Voyant.application=this;this.mixins["Voyant.util.Api"].constructor.apply(this,
