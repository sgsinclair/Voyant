...
e=a.getBaseUrl()+"?corpus\x3d"+e.corpus.id,f=window.open(e);f||(e=Ext.create("Ext.window.MessageBox",{makeButton:function(c){return new Ext.button.Button({handler:this.btnCallback,scope:this,text:a.localize("cancel"),ui:"default-toolbar",minWidth:75})}}).show({title:a.localize("export"),buttons:Ext.MessageBox.CANCEL,icon:Ext.MessageBox.INFO,message:a.localize("clickToOpenCorpus",[e])}).getTargetEl().dom.querySelector("a"),e.addEventListener("click",function(){f.close()}),Ext.get(e).frame().frame())},
