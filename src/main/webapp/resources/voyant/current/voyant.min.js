...
{};d[a]=b;this.bubblelines.addTermsToDoc(d,c)},this);this.bubblelines.doLayout()},scope:this}});this.setDocTermStore(a);Ext.apply(this,{dockedItems:[{dock:"top",xtype:"toolbar",items:[{xtype:"querysearchfield"},{xtype:"button",text:this.localize("clearTerms"),handler:function(){this.down("#termsView").getSelectionModel().deselectAll(!0);this.termStore.removeAll();this.setApiParams({query:null});this.bubblelines.removeAllTerms();this.bubblelines.drawGraph()},scope:this},,"-",{xtype:"slider",itemId:"granularity",
