/* This file created by JSCacher. Last modified: Mon May 15 09:37:39 EDT 2017 */
...
this.lastClickedBubbles[b],m=0,n;for(n in k)if(-1!==this.termsFilter.indexOf(n)){var q=k[n];if(q){m++;this.SEPARATE_LINES_FOR_TERMS&&c();var s=0,p=q.color.join(",");this.ctx.strokeStyle="rgba("+p+", 1)";this.ctx.fillStyle="rgba("+p+", 0.35)";this.ctx.lineWidth=.25;for(var h=h+q.rawFreq,s=s+q.rawFreq,r=l&&this.lastClickedBubbles[b][n],w=0;w<q.pos.length;w++){var u=q.pos[w];if(0<u.radius){var H=!1;r&&this.lastClickedBubbles[b][n]==u.id&&(this.ctx.strokeStyle="rgba(0, 0, 0, 0.75)",this.ctx.fillStyle=
"rgba("+p+", 0.5)",this.ctx.lineWidth=1,H=!0);this.ctx.beginPath();this.ctx.arc(u.x+f,this.yIndex,u.radius,0,e,!0);this.ctx.closePath();this.ctx.fill();this.ctx.stroke();H&&(this.ctx.strokeStyle="rgba("+p+", 1)",this.ctx.fillStyle="rgba("+p+", 0.35)",this.ctx.lineWidth=.25)}}a.freqCounts[n]=s;this.SEPARATE_LINES_FOR_TERMS&&(this.ctx.fillStyle="rgba(0, 0, 0, 1.0)",this.ctx.font="10px Verdana",this.ctx.fillText(s,f+d+5,this.yIndex-4),this.yIndex+=this.maxRadius)}}this.SEPARATE_LINES_FOR_TERMS&&0==m&&
...
(d=90,c.ty=0):(d=-90,c.ty=c.height,c.tx=c.width));c.size=Math.max(c.height,c.width);c.rotation=Math.PI/180*d;g.context.fillStyle=g.canvas.style.backgroundColor;g.context.fillRect(0,0,g.canvas.width,g.canvas.height);c.draw(g.context);d=g.context.getImageData(c.x,c.y,c.width,c.height);for(var e=[],h=0;h<c.width;h++){var k=Math.floor(h/f.COARSENESS)*f.COARSENESS;null==e[k]&&(e[k]={});for(var l=0;l<c.height;l++){var m=Math.floor(l/f.COARSENESS)*f.COARSENESS,r;r=4*(h+l*d.width);r=[d.data[r],d.data[r+1],
d.data[r+2],d.data[r+3]];"rgb("+r[0]+", "+r[1]+", "+r[2]+")"!=g.canvas.style.backgroundColor&&(e[k][m]=!0);e[k][m]&&(l=m+f.COARSENESS)}}c.mask=e}}function e(){g.clear();for(var a=p.length;a--;){var b=p[a];b.alpha=1;b.live&&b.draw(g.context)}a=$(g.canvas);if(null!=n){a.css("cursor","pointer");g.context.save();g.context.textBaseline="alphabetic";g.context.font="12px Arial";var b=g.context.measureText(n.text).width,c=g.context.measureText(n.value).width,b=(b>c?b:c)+20,c=q+15,d=s+25,e=a.width(),a=a.height();
...
0;var k=this.MIXED=1;this.getWordOrientation=function(){return k};this.setWordOrientation=function(a){k=a};this.UPDATE_RATE=25;this.COARSENESS=5;this.grid=[];var l=0,m;this.doingArrange=!1;this.wordsToArrange=5;var n=null,q=0,s=0,p=[];this.getWords=function(){return p};this.setWords=function(a){p=a};this.sizeAdjustment=100;this.minFontSize=12;this.largestWordSize=0;this.smallestWordSize=1E4;var r={};this.addWords=function(a){for(var b=!1,e=0;e<a.length;e++){var h=a[e],k;k=void 0==typeof h.color||
null==h.color||""==h.color?g.colors[Math.floor(Math.random()*g.colors.length)]:h.color;var l;l=void 0==typeof h.size||null==h.size||""==h.size?Math.floor(40*Math.random()):parseFloat(h.size);var m=h.word,n=h.label,q=h.value,h=!1;null==r[m]&&(r[m]=!0,l>f.largestWordSize&&(f.largestWordSize=l,h=!0),l<f.smallestWordSize&&(f.smallestWordSize=.8*l,h=!0),m=new Word(m,l,k,n,q),p.push(m));b=h||b}c();this.setRelativeSizes();this.calculateSizeAdjustment();b?this.resizeWords():d()};this.resetWordCoordinates=
...
0;g<=c;g+=this.COARSENESS)if(e[f]&&e[f][g]&&null!=this.grid[f+a]&&null!=this.grid[f+a][g+b])return!0;return!1},f;this.grid=[];l=0;f=function(){var a,f,h,k,r=this.wordsToArrange-1,n=g.canvas.width,q=g.canvas.height,w=.5*n,s=.5*q;do{h=p[l];if(void 0!==h){for(var D=Math.random()*Math.PI,v=.25*Math.random()*h.size,x=.5*(Math.random()-.5),F=.5*h.width,N=.5*h.height;;){a=Math.floor((w+Math.cos(D)*v*this.ratio-F)/this.COARSENESS)*this.COARSENESS;f=Math.floor((s+Math.sin(D)*v-N)/this.COARSENESS)*this.COARSENESS;
k=a+F>=n||f+N>=q?!0:d(a,f,h.height,h.width,h.mask);if(!k)break;D+=x;v+=.05}c(a,f,h);if(g.useFadeEffect)for(a=h.alpha=0;a<l;a++)f=p[a],1>f.alpha&&b(f);else h.alpha=1,h.draw(g.context)}l++;if(l>=p.length){clearTimeout(m);this.doingArrange=!1;this.toggleLoadingText(!1);e();break}}while(r--)}.createDelegate(this);d=d.createDelegate(this);c=c.createDelegate(this);b=b.createDelegate(this);a=a.createDelegate(this);this.doingArrange=!0;m=setInterval(f,50)}else alert("Error: There are no words to arrange.")};
...
a});d.info.continuations=d.children.length;f=d3.max(d.children.map(function(a){return a.maxChildren}));d.maxChildren=Math.max(d.children.length,f)}}function b(a,b){if(!a||!b)return!1;for(var c in a)if(!(c in b))return!1;return!0}function c(a,b){for(var c in b)a[c]=b[c]}function d(){}doubletree.DoubleTree=function(){function b(a){a.each(function(a,b){f.push(this[b])})}var f=[],g=600,h=400,k=!1,l={left:[],right:[]},m={alt:d,shift:d,click:d},n=!0,q=!0,s=doubletree.sortByStrFld("token"),p=doubletree.tokenText,
r=function(a){return doubletree.fieldText(a,"POS")},w=function(a){return"rgba(255,255,255,1)"},u=function(a){return"rgba(255,255,255,1)"},H=function(a){return"red"},L={node:{fill:"white",stroke:"steelblue","stroke-width":"1.5px"},branch:{stroke:"#aaa","stroke-width":"1.5px"}},D=!1,G=d3.dispatch("idsUpdated");G.on("idsUpdated",function(){this==E?(B.setIds(E.continuationIDs),B.updateContinuations()):this==B&&(E.setIds(B.continuationIDs),E.updateContinuations())});var A,I,E,B,J,M;b.init=function(a){d3.select(d3.selectAll(a)).call(this);
return b};b.redraw=function(){void 0!==A&&void 0!==I&&b.setupFromTries(A,I);return b};b.setupFromTries=function(d,k){A=d.getUniqRoot();I=k.getUniqRoot();var C=A.toTree(l.left),v=I.toTree(l.right),x=!0;0<Object.keys(v.pruned).length&&(a(v,v.pruned,x),a(C,v.pruned,x),x=!1);0<Object.keys(C.pruned).length&&(a(C,C.pruned,x),a(v,C.pruned,x));var x={},F;for(F in v.info)"continuations"!=F&&"ids"!=F&&"count"!=F&&(x[F]=v.info[F]);x["right continuations"]=v.info.continuations;x["left continuations"]=C.info.continuations;
x.ids={};c(x.ids,v.info.ids);c(x.ids,C.info.ids);x.count=Object.keys(x.ids).length;J=Object.keys(x.ids);if(v.info.origIDs||C.info.origIDs)x.origIDs={},c(x.origIDs,v.info.origIDs),c(x.origIDs,C.info.origIDs),x.origCount=Object.keys(x.origIDs).length;v.info=x;C.info=x;F=Math.max(C.maxChildren,v.maxChildren);if(isNaN(F)||0==F)return D=!1,b;q?M=d3.scale.log().range([8,14]):(M=function(){return 14},M.domain=function(){});F=Math.min(C.minCount,v.minCount);M.domain([F,C.info.count]);var N=g-20-20,O=h-20-
...
g,h,C,!0,s,G,M,n,p,r,w,u,H,L);B=new doubletree.Tree(e.select("g"),g,h,v,!1,s,G,M,n,p,r,w,u,H,L)});E.handleAltPress=m.alt;B.handleAltPress=m.alt;E.handleShiftPress=m.shift;B.handleShiftPress=m.shift;E.handleClick=m.click;B.handleClick=m.click;D=!0;return b};b.setupFromArrays=function(a,c,d,f,g,h,l,m){void 0==g&&A&&(g=A.caseSensitive());void 0==h&&A&&(h=A.fieldNames());void 0==l&&A&&(l=A.fieldDelim());void 0==m&&A&&(m=A.distinguishingFieldsArray());A=new doubletree.Trie(g,h,l,m);I=new doubletree.Trie(g,
h,l,m);g=c.length;for(h=0;h<g;h++){l=f?f[h]:h;m=c[h];var r=a[h].slice(),n=d[h].slice();r.push(m);r.reverse();n.unshift(m);k?(I.addNgram(r,l),A.addNgram(n,l)):(A.addNgram(r,l),I.addNgram(n,l))}b.setupFromTries(A,I);return b};b.filteredIDs=function(){return J};b.search=function(a){E.search(a);B.search(a);a=d3.select(f[0][0]);var b=a.selectAll("text.foundText");if(b.empty())return 0;b=b[0].length;null!=a.selectAll("text.rtNdText.foundText")[0][0]&&b--;return b};b.clearSearch=function(){E.clearSearch();
...
1E-6).style("fill",function(a){return a._children?"#fff":H.node.fill}).style("stroke",function(a){return H.node.stroke});f=f.append("text").attr("class",function(a){return 0==a.depth?"rtNdText":""}).attr("x",function(a){return a.children||a._children?0:k?10:-10}).attr("text-anchor",function(a){return a.parent?a.children||a._children?k?"end":"start":k?"start":"end":"middle"}).style("font-size",function(a){return n(a.info.count)+"pt"});f.append("tspan").attr("dy",".35em").attr("class","tokenText").text(function(a){return s(a.info,
...
function(a){return a.target.id});f.enter().insert("path","g").attr("class","link link_"+k).attr("d",function(a){a={x:b.x0,y:b.y0};return x({source:a,target:a})}).style("fill","none").style("stroke",H.branch.stroke).style("stroke-width",H.branch["stroke-width"]);f.transition().duration(200).attr("d",x);f.exit().transition().duration(200).attr("d",function(a){a={x:b.x,y:b.y};return x({source:a,target:a})}).remove();c.forEach(function(a){a.x0=a.x;a.y0=a.y});this.updateContinuations()};this.setIds=function(a){F.continuationIDs=
a};this.updateContinuations=function(){a.selectAll("g.node_"+k+" text").classed("continuation",function(a){var b;a:{a=a.info.ids;var c=F.continuationIDs||{};for(b in a)if(b in c){b=!0;break a}b=!1}return b}).style("fill",function(a){return d3.select(this).classed("continuation")?u(a.info):"#444"})};this.search=function(b){a.selectAll("g.node text").classed("foundText",function(a){return b.test(s(a.info))})};this.clearSearch=function(){a.selectAll("g.node text").classed("foundText",!1)};this.showTokenExtras=
...
(function(){doubletree.Trie=function(a,b,c,d,e){function f(a,b,c){this.id=b;this.count=c;this.info={count:c,ids:{}};if(null==a)this.item=k;else{this.item=a;this.info.ids={};this.info.ids[b]=!0;a=a.split(n);for(var d in a)this.info[m[d]]=[a[d]]}this.nodes={};this.addNgram=function(a,b,c){c||(c=1);var d,e;if(0<a.length){d=a.shift();var g=d.split(n);e=s&&this.item==k?"":g.filter(function(a,b){return-1<q.indexOf(m[b])}).map(function(a){return l?a.toLocaleLowerCase():a}).join(n)}else e=d=h;var r;if(e in
this.nodes&&this.nodes[e]instanceof f){r=this.nodes[e];r.info.count+=c;r.info.ids[b]=!0;for(var p in g)e=g[p],-1==r.info[m[p]].indexOf(e)&&r.info[m[p]].push(e)}else r=new f(d,b,c),this.nodes[e]=r;d!=h&&r.addNgram(a,b,c)};this.getUniqRoot=function(){if(this.item==k){var a=Object.keys(this.nodes);if(1==a.length)return this.nodes[a[0]]}return this};this.toTree=function(a){function b(a,c,d){var e={children:[]};e.name=d.item;e.info={};for(var f in d.info)if("Object"===typeof d.info[f]){e.info[f]={};for(var h in d.info[f])e.info[f][h]=
...
e.maxLen=Math.max(a,e.name.length),e.minCount=d3.min(e.children.map(function(a){return a.minCount})));return e}a||(a=[]);var c=JSON.parse(JSON.stringify(this));return b(a,0,c)}}function g(a,b){for(var c in b)a[c]=b[c]}var h=" ",k="_root_",l=!a&&!0;b||(b=["item"]);var m=b;n||(n="\t");var n=c;q||(q=[m[0]]);var q=d,s=e;void 0==s&&(s=!0);var p=new f(k,-1,0);this.addNgram=function(a,b,c){p.addNgram(a,b,c)};this.getUniqRoot=function(){var a=new doubletree.Trie(!l,m,n,q);a.trie(p.getUniqRoot());return a};
...
"":"i")),c.store.each(function(a,b){var k=e.getNode(a);k&&Ext.Array.forEach(f,function(b){var e=Ext.fly(k).down(b.getCellInnerSelector(),!0),f,h,s;e&&0==b.isXType("widgetcolumn")&&(f=e.innerHTML.match(c.tagsRe),h=e.innerHTML.replace(c.tagsRe,c.tagsProtect),h=h.replace(c.searchRegExp,function(e){++d;s||(c.matches.push({record:a,column:b}),s=!0);return'\x3cspan class\x3d"'+c.matchCls+'"\x3e'+e+"\x3c/span\x3e"},c),Ext.each(f,function(a){h=h.replace(c.tagsProtect,a)}),e.innerHTML=h)})},c),d&&(c.currentIndex=
...
var d=this.getVisLayout().size()[0],e=this.getVisLayout().size()[1],f=b?Math.min(d/Math.abs(b[1].x-d/2),d/Math.abs(b[0].x-d/2),e/Math.abs(b[1].y-e/2),e/Math.abs(b[0].y-e/2))/2:1,g=this.getVis().selectAll("text").data(a,function(a){return a.text});g.transition().duration(1E3).attr("transform",function(a){return"translate("+[a.x,a.y]+")rotate("+a.rotate+")"}).style("font-size",function(a){return a.fontSize+"px"});g.enter().append("text").attr("text-anchor","middle").attr("data-freq",function(a){return a.rawFreq}).attr("transform",
function(a){return"translate("+[a.x,a.y]+")rotate("+a.rotate+")"}).style("font-size","1px").transition().duration(1E3).style("font-size",function(a){return a.fontSize+"px"});g.style("font-family",function(a){return c.getApplication().getFeatureForTerm("font",a.text)}).style("fill",function(a){return c.getApplication().getColorForTerm(a.text,!0)}).text(function(a){return a.text}).on("click",function(a){c.dispatchEvent("termsClicked",c,[a.text])}).on("mouseover",function(a){this.getTip().show()}.bind(this)).on("mousemove",
function(a){var b=this.getTip();b.update(a.text+": "+a.rawFreq);a=Ext.get(this.getCirrusId()).dom;a=d3.mouse(a);a[1]+=30;b.setPosition(a)}.bind(this)).on("mouseout",function(a){this.getTip().hide()}.bind(this));g.exit().remove();this.getVis().transition().duration(1E3).attr("transform","translate("+d/2+","+e/2+")scale("+f+")")},map:function(a,b,c,d,e){return d+(a-b)/(c-b)*(e-d)},calculateSizeAdjustment:function(){var a=this.getTerms();if(void 0!==a){var b=this.getLayout().getRenderTarget(),b=b.getWidth()*
b.getHeight();1E5>b?this.setMinFontSize(8):this.setMinFontSize(12);for(var c=0,d=0;d<a.length;d++)var e=this.calculateWordArea(a[d]),c=c+e;this.setSizeAdjustment(b/c)}},calculateWordArea:function(a){for(var b=Math.log(10*a.relativeSize)*Math.LOG10E,c=(b+a.relativeSize)/2,d=0,e=0;e<a.text.length;e++)var f=a.text.charAt(e),d="f"==f||"i"==f||"j"==f||"l"==f||"r"==f||"t"==f?d+b/3:"m"==f||"w"==f?d+b/(4/3):d+b/1.9;return c*d},setAdjustedSizes:function(){this.calculateSizeAdjustment();var a=this.getTerms();
if(void 0!==a)for(var b=0;b<a.length;b++){var c=a[b],d=this.findNewRelativeSize(c);c.fontSize=d>this.getMinFontSize()?d:this.getMinFontSize()}},setRelativeSizes:function(){var a=this.getTerms();if(void 0!==a)for(var b=0;b<a.length;b++){var c=a[b];c.relativeSize=this.map(c.rawFreq,this.getSmallestWordSize(),this.getLargestWordSize(),.1,1)}},findNewRelativeSize:function(a){var b=this.getSizeAdjustment(),b=this.calculateWordArea(a)*b;return(Math.sqrt(6)*Math.sqrt(6*Math.pow(a.text.length,2)+b*a.text.length)-
6*a.text.length)/(2*a.text.length)}});Ext.define("Voyant.panel.CollocatesGraph",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.collocatesgraph",statics:{i18n:{},api:{query:void 0,mode:void 0,limit:5,stopList:"auto",terms:void 0,context:5,centralize:void 0},glyph:"xf1e0@FontAwesome"},config:{node:void 0,link:void 0,nodeDataSet:void 0,edgeDataSet:void 0,network:void 0,contextMenu:void 0,force:void 0,graphHeight:void 0,graphWidth:void 0,corpusColours:d3.scale.category10(),graphMode:void 0,stabilizationTask:void 0},
DEFAULT_MODE:0,CENTRALIZED_MODE:1,nodeOptions:{defaultNode:{shape:"box",color:{border:"rgba(0,0,0,0.1)",background:"rgba(255,255,255,1)"},scaling:{label:{min:10,max:30,maxVisible:50,drawThreshold:6}}},centralizedNode:{shape:"text",scaling:{label:{min:6,max:30,maxVisible:50,drawThreshold:1}}}},edgeOptions:{defaultEdge:{color:{color:"rgba(0,0,0,0.1)",highlight:"black",hover:"red"},labelHighlightBold:!1,scaling:{min:1,max:15},length:void 0},centralizedEdge:{scaling:{min:1,max:1},length:150}},highlightOptions:{font:{color:"white"},
color:{background:"black",hover:{border:"#CB157F",background:"#EB42A5"}}},physicsOptions:{defaultPhysics:{barnesHut:{gravitationalConstant:-1500,centralGravity:6,damping:.5,avoidOverlap:.5,springConstant:.04}},centralizedPhysics:{barnesHut:{gravitationalConstant:-1500,centralGravity:1,damping:1,avoidOverlap:.01,springConstant:.2}}},stablizationMaxTime:5E3,keywordColor:"green",contextColor:"maroon",constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,
arguments);this.setNodeDataSet(new vis.DataSet);this.setEdgeDataSet(new vis.DataSet);this.setGraphMode(this.DEFAULT_MODE);this.setStabilizationTask(Ext.TaskManager.newTask({run:function(){this.getNetwork().stopSimulation()},scope:this,interval:this.stablizationMaxTime,repeat:1,fireOnStart:!1}))},initComponent:function(){var a=this;Ext.apply(a,{title:this.localize("title"),dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"querysearchfield"},{text:a.localize("clearTerms"),
glyph:"xf014@FontAwesome",handler:function(){this.getNodeDataSet().clear();this.getEdgeDataSet().clear();this.setGraphMode(this.DEFAULT_MODE)},scope:a},this.localize("context"),{xtype:"slider",itemId:"contextSlider",minValue:3,value:5,maxValue:30,increment:2,width:50,listeners:{render:function(b){b.setValue(a.getApiParam("context"))},changecomplete:{fn:function(a,c){this.setApiParam("context",a.getValue());if(this.getGraphMode()===this.DEFAULT_MODE){var d=this.getNodeDataSet().map(function(a){return a.label});
0<d.length&&(this.getNodeDataSet().clear(),this.loadFromQuery(d))}},scope:a}}}]}]});this.setContextMenu(Ext.create("Ext.menu.Menu",{renderTo:Ext.getBody(),items:[{xtype:"box",itemId:"label",margin:"5px 0px 5px 5px",html:""},{xtype:"menuseparator"},{xtype:"menucheckitem",text:"Fixed",itemId:"fixed",listeners:{checkchange:function(a,c,d){a=this.getNetwork().getSelectedNodes();null!=a[0]&&this.getNodeDataSet().update({id:a[0],fixed:c})},scope:this}},{xtype:"button",text:"Fetch Collocates",style:"margin: 5px;",
handler:function(a,c){var d=this.getNetwork().getSelectedNodes();null!=d[0]&&(d=this.getNodeDataSet().get(d[0]),this.itemdblclick(d))},scope:this},{xtype:"button",text:"Centralize",style:"margin: 5px;",handler:function(a,c){var d=this.getNetwork().getSelectedNodes();null!=d[0]&&(this.doCentralize(d[0]),this.getContextMenu().hide())},scope:this},{xtype:"button",text:"Remove",style:"margin: 5px;",handler:function(a,c){var d=this.getNetwork().getSelectedNodes();null!=d[0]&&(this.getNodeDataSet().remove(d[0]),
a.up("menu").hide(),this.forceUpdate())},scope:this}]}));this.on("loadedCorpus",function(a,c){this.isVisible()&&this.initLoad()},this);this.on("activate",function(){this.getCorpus()&&Ext.Function.defer(this.initLoad,100,this)},this);this.on("query",function(a,c){this.loadFromQuery(c)},this);this.on("resize",function(a,c,d){a=this.getLayout().getRenderTarget();c=this.getDockedItems();for(var e=0,f=0;f<c.length;f++)e+=c[f].getHeight();a.setHeight(d-e);a.setWidth(a.getWidth());this.setGraphHeight(a.getHeight());
this.setGraphWidth(a.getWidth())},this);a.callParent(arguments)},initLoad:function(){this.initGraph();if(this.getApiParam("centralize")){this.setGraphMode(this.CENTRALIZED_MODE);var a=this.getApiParam("centralize");this.getNodeDataSet().update({id:a,label:a,title:a+" (1)",type:"keyword",value:1,start:0,font:{color:this.keywordColor}});this.doCentralize(a)}else{var a=3,b=this.getApiParam("query");void 0!==b&&(a=b.split(",").length);this.getCorpus().getCorpusTerms({autoLoad:!1}).load({params:{limit:a,
query:b,stopList:this.getApiParam("stopList")},callback:function(a,b,e){e&&this.loadFromCorpusTermRecords(a)},scope:this})}},loadFromQuery:function(a){this.setApiParams({mode:"corpus"});var b=this.getApiParams();(Ext.isString(a)?[a]:a).forEach(function(a){this.getCorpus().getCorpusCollocates({autoLoad:!1}).load({params:Ext.apply(Ext.clone(b),{query:a}),callback:function(a,b,c){c&&this.loadFromCorpusCollocateRecords(a)},scope:this})},this)},loadFromCorpusTermRecords:function(a){if(Ext.isArray(a)&&
0<a.length){var b=[];a.forEach(function(a){b.push(a.getTerm())});this.loadFromQuery(b)}},loadFromCorpusCollocateRecords:function(a,b){if(Ext.isArray(a)){var c=this.getApiParam("limit"),d=this.getNodeDataSet(),e=this.getEdgeDataSet(),f={};d.forEach(function(a){f[a.id]=!0});var g=[],h=[];a.forEach(function(a,l){var m=a.getTerm(),n=a.getContextTerm(),q=a.getKeywordRawFreq(),s=a.getContextTermRawFreq(),p=q,r=s;this.getGraphMode()===this.CENTRALIZED_MODE&&(p=0,r=Math.log(s));0==l&&(void 0===b&&(b=m),void 0!==
f[b]?d.update({id:b,value:p,title:m+" ("+q+")",type:"keyword",font:{color:this.keywordColor}}):(f[b]=!0,g.push({id:m,label:m,title:m+" ("+q+")",type:"keyword",value:p,start:c,font:{color:this.keywordColor}})));if(m!=n){void 0===f[n]&&(f[n]=!0,g.push({id:n,label:n,title:n+" ("+s+")",type:"context",value:r,start:0,font:{color:this.contextColor}}));var w=null;e.forEach(function(a){if(a.from==b&&a.to==n||a.from==n&&a.to==b)w=a});m=a.getContextTermRawFreq();null===w?h.push({from:b,to:n,value:m}):w.value<
m&&e.update({id:w.id,value:m})}},this);d.add(g);e.add(h);this.forceUpdate();this.getNetwork().fit()}},doCentralize:function(a){a=this.getNodeDataSet().get(a);a.fixed=!0;a.shape="circle";a.scaling={min:75,max:75,label:{min:75,max:75}};this.getNodeDataSet().clear();this.getEdgeDataSet().clear();this.getNodeDataSet().add(a);this.setGraphMode(this.CENTRALIZED_MODE);var b=this.getApiParam("limit");this.setApiParam("limit",150);this.itemdblclick(a);this.setApiParam("limit",b)},applyGraphMode:function(a){a=
void 0===a?this.DEFAULT_MODE:a;var b=this.getNetwork();void 0!==b&&(a===this.DEFAULT_MODE?b.setOptions({physics:this.physicsOptions.defaultPhysics,nodes:this.nodeOptions.defaultNode,edges:this.edgeOptions.defaultEdge}):a===this.CENTRALIZED_MODE&&b.setOptions({physics:this.physicsOptions.centralizedPhysics,nodes:this.nodeOptions.centralizedNode,edges:this.edgeOptions.centralizedEdge}));return a},initGraph:function(){var a=this.getLayout().getRenderTarget();a.setWidth(a.getWidth());a.setHeight(a.getHeight());
this.setGraphHeight(a.getHeight());this.setGraphWidth(a.getWidth());void 0===this.getNetwork()&&(a=new vis.Network(a.dom,{nodes:this.getNodeDataSet(),edges:this.getEdgeDataSet()},{autoResize:!0,interaction:{hover:!0,hoverConnectedEdges:!0,multiselect:!1}}),this.setNetwork(a),this.setGraphMode(),this.getNodeDataSet().on("remove",function(a,c,d){var e=c.items[0];a=this.getEdgeDataSet().get({filter:function(a){return a.from==e||a.to==e}});this.getEdgeDataSet().remove(a);var f=[];this.getNodeDataSet().forEach(function(a){0==
this.getEdgeDataSet().get({filter:function(b){return b.from==a.id||b.to==a.id}}).length&&f.push(a.id)}.bind(this));this.getNodeDataSet().remove(f)}.bind(this)),a.on("dragStart",function(a){a=a.nodes[0];null!=a&&this.getNodeDataSet().update({id:a,fixed:!1})}.bind(this)),a.on("dragging",function(a){null!=a.nodes[0]&&(this.isMasked()?this.isOffCanvas(a.pointer.DOM)||this.unmask():this.isOffCanvas(a.pointer.DOM)&&this.mask(this.localize("releaseToRemove")))}.bind(this)),a.on("dragEnd",function(a){var c=
a.nodes[0];null!=c&&(this.isOffCanvas(a.pointer.DOM)?(this.unmask(),this.mask("cleaning"),this.getNodeDataSet().remove(c),this.forceUpdate(),this.unmask()):this.getNodeDataSet().update({id:c,fixed:!0}))}.bind(this)),a.on("click",function(a){this.getContextMenu().hide();if(a){var c=this.getNodeDataSet();a.nodes&&0<a.nodes.length?this.dispatchEvent("termsClicked",this,[c.get(a.nodes[0]).label]):a.edges&&0<a.edges.length&&(a=this.getEdgeDataSet().get(a.edges[0]),this.dispatchEvent("termsClicked",this,
['"'+c.get(a.from).label+" "+c.get(a.to).label+'"~'+this.getApiParam("context")]))}}.bind(this)),a.on("doubleClick",function(a){a=a.nodes[0];null!=a&&(a=this.getNodeDataSet().get(a),this.itemdblclick(a))}.bind(this)),a.on("oncontext",function(a){a.event.preventDefault();var c=this.getNetwork().getNodeAt(a.pointer.DOM);if(null!=c){this.getNetwork().selectNodes([c]);var c=this.getNodeDataSet().get(c),d=this.getContextMenu();d.queryById("label").setHtml(c.label);d.queryById("fixed").setChecked(c.fixed);
d.showAt(a.event.pageX,a.event.pageY)}}.bind(this)),a.on("startStabilizing",function(){this.getStabilizationTask().restart()}.bind(this)),a.on("stabilized",function(){this.getStabilizationTask().stop();this.getNetwork().fit({animation:{duration:500,easing:"linear"}})}.bind(this)),a.on("resize",function(a){this.getNetwork().fit({animation:{duration:500,easing:"linear"}})}.bind(this)))},forceUpdate:function(){var a=this.getNodeDataSet().map(function(a){return{id:a.id}});this.getNodeDataSet().update(a);
a=this.getEdgeDataSet().map(function(a){return{id:a.id}});this.getEdgeDataSet().update(a)},isOffCanvas:function(a){return 0>a.x||0>a.y||a.x>this.getGraphWidth()||a.y>this.getGraphHeight()},itemdblclick:function(a){var b=this.getApiParam("limit");this.getCorpus().getCorpusCollocates({autoLoad:!1}).load({params:Ext.apply(this.getApiParams(),{query:a.id,start:a.start,limit:b}),callback:function(c,d,e){e&&(this.getNodeDataSet().update({id:a.id,start:a.start+b}),this.loadFromCorpusCollocateRecords(c,a.id))},
scope:this})}});Ext.define("Voyant.panel.Contexts",{extend:"Ext.grid.Panel",mixins:["Voyant.panel.Panel"],requires:["Voyant.data.store.Contexts"],alias:"widget.contexts",isConsumptive:!0,statics:{i18n:{},api:{query:void 0,docId:void 0,docIndex:void 0,stopList:"auto",context:5,expand:50},glyph:"xf0ce@FontAwesome"},constructor:function(){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(){var a=this;Ext.apply(a,{title:this.localize("title"),emptyText:this.localize("emptyText"),
...
"rgb("+this.magnets[m].colour.join(",")+")",b.arc(this.magnets[m].x,this.magnets[m].y,12,0,2*Math.PI),b.fill(),b.stroke())}if(e){var n=this;setTimeout(function(){n.draw()},100)}else if(this.documents){c=Math.max(c/this.documents.length,50);l=0;for(m=this.documents.length;l<m;l++)for(var q=0;q<m;q++)if(l<q){var s=this.documents[l].x-this.documents[q].x,p=this.documents[l].y-this.documents[q].y;Math.sqrt(s*s+p*p)<c&&(s*=.1,p*=.1,this.documents[l].targetX+=s,this.documents[q].targetX-=s,this.documents[l].targetY+=
...
(a=a||this.getCorpus().getDocumentTerms({autoLoad:!1}),a.load({callback:function(a,c,d){d?(this.setMode(this.MODE_DOCUMENT),this.loadFromRecords(a)):Voyant.application.showResponseError(this.localize("failedGetDocumentTerms"),c)},scope:this,params:this.getApiParams("docId docIndex limit stopList query withDistributions bins".split(" "))}))},loadFromRecords:function(a){var b=this.getApplication(),c=this.down("[xtype\x3dlegend]").getStore(),d=[],e=[];a.forEach(function(a,c){var f=[],g=a.getTerm();a.get("distributions").forEach(function(a,
b){f.push({x:b,y:a})},this);e.push({name:g,values:f});d.push({id:g,name:g,mark:b.getColorForTerm(g,!0),active:!0})},this);c.loadData(d);var c=this.getVisLayout()(e),f;if(this.getMode()===this.MODE_DOCUMENT)f=this.getApiParam("bins");else{a=this.getApiParam("bins");var g=this.getCorpus().getDocumentsCount();f=a<g?a:g}f--;var g=this.body.down("svg").getWidth()-this.graphMargin.left-this.graphMargin.right,h=d3.scale.linear().domain([0,f]).range([0,g]),k=d3.max(c,function(a){return d3.max(a.values,function(a){return a.y0+
a.y})});a=this.body.down("svg").dom.clientHeight-this.graphMargin.top-this.graphMargin.bottom;var l=d3.scale.linear().domain([0,k]).range([a,0]),m=d3.svg.area().x(function(a){return h(a.x)}).y0(function(a){return l(a.y0)}).y1(function(a){return l(a.y0+a.y)}),k=d3.svg.axis().scale(h).orient("bottom");if(this.getMode()===this.MODE_CORPUS){for(var n=[],q=0;q<=f;q++)n.push(q);k.tickValues(n);k.tickFormat("")}n=d3.svg.axis().scale(l).orient("left");c=this.getVis().selectAll("path").data(c,function(a){return a.name});
c.attr("d",function(a){return m(a.values)}).style("fill",function(a,c){return b.getColorForTerm(a.name,!0)});c.enter().append("path").attr("d",function(a){return m(a.values)}).style("fill",function(a,c){return b.getColorForTerm(a.name,!0)}).append("title").text(function(a){return a.name});c.exit().remove();this.getVis().selectAll("g.axis").remove();this.getVis().append("g").attr("class","axis x").attr("transform","translate(0,"+a+")").call(k);if(this.getMode()===this.MODE_CORPUS){var s=g/f,p=0;this.getCorpus().getDocuments().each(function(a){this.getVis().select("g.x").append("text").attr("text-anchor",
...
(this.MAX_SCALING+1));this.setScalingFactor(c);this.getVisLayout().value(function(a){return Math.pow(a.rawFreq,1/c)});this.reload()},scope:this}}]}]});this.setContextMenu(Ext.create("Ext.menu.Menu",{renderTo:Ext.getBody(),items:[{xtype:"box",itemId:"label",margin:"5px 0px 5px 5px",html:""},{xtype:"menuseparator"},{xtype:"button",text:"Remove",style:"margin: 5px;",handler:function(a,b){var c=this.getCurrentNode();void 0!==c&&(delete this.getCurrentData()[c.term],this.getBlacklist()[c.term]=!0,this.setCurrentNode(void 0));
this.getContextMenu().hide();this.reload()},scope:this}]}));this.on("query",function(a,b){0<b.length&&this.doLoad(b)},this);this.callParent(arguments)},listeners:{boxready:function(){this.initVisLayout()},resize:function(a,b,c){this.getVisLayout()&&this.getCorpus()&&(a=this.getLayout().getRenderTarget(),b=a.getWidth(),c=a.getHeight(),a.down("svg").set({width:b,height:c}),this.getVisLayout().size([b,c]),this.reload())},loadedCorpus:function(a,b){this.doLoad()}},doLoad:function(a){this.resetVis();void 0===
a&&(this.resetMinMax(),this.setCurrentData({}));this.getMode()===this.MODE_DISTINCT?this.getDistinctTerms(a):this.getTopTerms(a)},reload:function(){var a=this.processCollocates([]);0<a.length&&(this.resetVis(),this.buildVisFromData(a))},resetMinMax:function(){this.setMinRawFreq(void 0);this.setMaxRawFreq(void 0);this.setMaxCollocateValue(void 0);this.setMinFillValue(void 0);this.setMaxFillValue(void 0)},resetVis:function(){this.getVis().selectAll(".node").remove()},getTopTerms:function(a){var b=parseInt(this.getApiParam("numInitialTerms")),
c=this.getApiParam("stopList");void 0!==a&&(c=b=void 0);this.getCorpus().getCorpusTerms().load({params:{query:a,limit:b,stopList:c},callback:function(a,b,c){c&&this.loadFromRecords(a)},scope:this})},getDistinctTerms:function(a){var b=parseInt(this.getApiParam("numInitialTerms")),c=this.getApiParam("stopList");void 0!==a&&(c=b=void 0);var d=Math.ceil(parseInt(this.getApiParam("numInitialTerms"))/this.getCorpus().getDocumentsCount());this.getCorpus().getDocumentTerms().load({params:{query:a,limit:b,
perDocLimit:d,stopList:c,sort:"TFIDF",dir:"DESC"},callback:function(a,b,c){c&&this.loadFromRecords(a)},scope:this})},loadFromQuery:function(a){this.getCorpus().getCorpusTerms().load({params:{query:a},callback:function(a,c,d){d&&this.loadFromRecords(a)},scope:this})},loadFromRecords:function(a){if(Ext.isArray(a)&&0<a.length){var b=this.getMaxRawFreq(),c=this.getMinRawFreq(),d=this.getMinFillValue(),e=this.getMaxFillValue(),f=[];a.forEach(function(a){var h=a.getTerm();if(!this.getBlacklist()[h]){var k=
...
b[f]&&f!=g&&b[f].collocates.push({term:g,value:e})}this.setMaxCollocateValue(c);a=[];for(f in b)a.push(b[f]);return a},buildVisFromData:function(a){a=this.getVisLayout().nodes({children:a,collocates:[],term:"",rawFreq:1});a=this.getVis().selectAll(".node").data(a,function(a){return a.term});a.attr("transform",function(a){return"translate("+a.x+","+a.y+")"});a.selectAll("circle").attr("r",function(a){return a.r});var b=this,c=d3.scale.pow().exponent(1/3).domain([0,this.getMaxCollocateValue()]).range(["#fff",
"#bd3163"]),d;d=this.getMode()===this.MODE_DISTINCT?d3.scale.pow().exponent(.2).domain([this.getMinFillValue(),this.getMaxFillValue()]).range(["#dedede","#fff"]):d3.scale.linear().domain([this.getMaxFillValue(),this.getMinFillValue()]).range(["#dedede","#fff"]);var e=this.getVisLayout().size(),e=Math.min(e[0],e[1])/2,e=Math.sqrt(Math.PI*e*e/(a[0].length-1)/Math.PI)/3,f=Math.abs(this.getScalingFactor()-(this.MAX_SCALING+1)),f=Math.max(1,f-1),f=e*f,g=d3.scale.linear().domain([this.getMinRawFreq(),this.getMaxRawFreq()]).range([e,
f]),e=a.enter().append("g").attr("class","node").style("visibility",function(a){return 0<a.depth?"visible":"hidden"}).attr("transform",function(a){return"translate("+a.x+","+a.y+")"}).on("click",function(a){b.dispatchEvent("termsClicked",b,[a.term])}).on("mouseover",function(a,e){b.setCurrentNode(a);b.getVis().selectAll("circle").style("stroke-width",1).style("stroke","#111").style("fill",function(a){return d(a.inDocumentsCount)});d3.select(this).select("circle").style("fill","#89e1c2").style("stroke",
"#26926c").style("stroke-opacity",b.MAX_STROKE_OPACITY);var f;f=b.getMode()===b.MODE_DISTINCT?b.localize("tfidf"):b.localize("inDocs");if(!b.getContextMenu().isVisible()){f="\x3cb\x3e"+a.term+"\x3c/b\x3e ("+a.rawFreq+")\x3cbr/\x3e"+f+": "+a.fillValue;var g=b.getTip();g.update(f);g.show()}for(e=0;e<a.collocates.length;e++){var n=a.collocates[e];f=b.getVis().selectAll(".node").filter(function(a){return a.term===n.term});f.select("circle").style("fill",function(a){return c(n.value)}).style("stroke",
"#bd3163").style("stroke-opacity",b.MAX_STROKE_OPACITY);f.select("tspan.value").text(function(a){return n.value})}}).on("mousemove",function(){b.getTip().setPosition(d3.event.pageX+5,d3.event.pageY-50)}).on("mouseout",function(){b.getContextMenu().isVisible()||b.setCurrentNode(void 0);b.getVis().selectAll("circle").style("stroke-opacity",b.MIN_STROKE_OPACITY).style("stroke","#111").style("fill",function(a){return d(a.fillValue)});b.getVis().selectAll("tspan.value").text("");b.getTip().hide()}).on("contextmenu",
function(a,c){d3.event.preventDefault();b.getTip().hide();var d=b.getContextMenu();d.queryById("label").setHtml(a.term);d.showAt(d3.event.pageX+5,d3.event.pageY-50)});e.append("circle").attr("id",function(a){return a.term.replace(/\W/g,"_")}).attr("r",function(a){return a.r}).style("fill",function(a){return d(a.fillValue)}).style("stroke","#111").style("stroke-opacity",b.MIN_STROKE_OPACITY).style("stroke-width",1);e.append("clipPath").attr("id",function(a){return"clip-"+a.term.replace(/\W/g,"_")}).append("use").attr("xlink:href",
function(a){return"#"+a.term.replace(/\W/g,"_")});e=e.append("text").attr("clip-path",function(a){return"url(#clip-"+a.term.replace(/\W/g,"_")+")"}).style("font-family",function(a){return b.getApplication().getFeatureForTerm("font",a.term)}).style("text-anchor","middle").style("cursor","default");e.append("tspan").attr("class","term").style("font-size",function(a){return g(a.rawFreq)}).attr("x",0).attr("y",function(a){return g(a.rawFreq)/4}).text(function(a){return a.term});e.append("tspan").attr("class",
"value").style("font-size",function(a){return.75*g(a.rawFreq)}).attr("x",0).attr("y",function(a){return g(a.rawFreq)+1});a.exit().remove()},initVisLayout:function(){var a=this.getLayout().getRenderTarget();a.update("");var b=a.getWidth(),c=a.getHeight(),d=this;this.setVisLayout(d3.layout.pack().sort(function(a,b){return a.rawFreq<b.rawFreq?1:a.rawFreq>b.rawFreq?-1:0}).value(function(a){return Math.pow(a.rawFreq,1/d.getScalingFactor())}).size([b,c]).padding(1.5));a=d3.select(a.dom).append("svg").attr("id",
this.getVisId()).attr("width",b).attr("height",c);this.setVis(a.append("g"));this.setVisInfo(a.append("text").attr("x",10).attr("y",10));void 0===this.getTip()&&this.setTip(Ext.create("Ext.tip.Tip",{}))}});Ext.define("Voyant.panel.TermsRadio",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.termsradio",config:{options:[{xtype:"stoplistoption"}],speed:50,termsRadio:void 0},statics:{i18n:{},api:{withDistributions:!0,bins:5,visibleBins:5,docIdType:null,limit:50,mode:null,position:0,selectedWords:[],stopList:"auto",query:null,yAxisScale:"log",speed:50,slider:void 0},glyph:"xf201@FontAwesome"},constructor:function(a){var b=function(a,b,e,f,g){this.setApiParams({mode:a});this.getTermsRadio().loadRecords(e);
...
Ext.override(Ext.chart.axis.sprite.Axis,{renderLabels:function(a,b,c,d){var e=this,f=e.attr,g=.5*f.lineWidth,h=f.position,k=f.matrix,l=f.textPadding,m=k.getXX(),n=k.getDX(),q=k.getYY(),s=k.getDY(),p=0,k=c.majorTicks,r=Math.max(f.majorTickSize,f.minorTickSize)+f.lineWidth,w=Ext.draw.Draw.isBBoxIntersect,u=e.getLabel(),H,L,D=null,G=0,A=0,I=c.segmenter,E=e.getRenderer(),B=e.getAxis(),J=(H=B.getTitle())&&""!==H.attr.text&&H.getBBox(),M,K=null,z,C,v;if(k&&u&&!u.attr.hidden){H=u.attr.font;b.font!==H&&(b.font=
H);u.setAttributes({translationX:0,translationY:0},!0);u.applyTransformations();M=u.attr.inverseMatrix.elements.slice(0);switch(h){case "left":b=J?J.x+J.width:0;switch(u.attr.textAlign){case "start":d=a.roundPixel(b+n)-g;break;case "end":d=a.roundPixel(d[2]-r+n)-g;break;default:d=a.roundPixel(b+(d[2]-b-r)/2+n)-g}u.setAttributes({translationX:d},!0);break;case "right":b=J?d[2]-J.x:0;switch(u.attr.textAlign){case "start":d=a.roundPixel(r+n)+g;break;case "end":d=a.roundPixel(d[2]-b+n)+g;break;default:d=
a.roundPixel(r+(d[2]-r-b)/2+n)+g}u.setAttributes({translationX:d},!0);break;case "top":b=J?J.y+J.height:0;u.setAttributes({translationY:a.roundPixel(b+(d[3]-b-r)/2)-g},!0);break;case "bottom":b=J?d[3]-J.y:0;u.setAttributes({translationY:a.roundPixel(r+(d[3]-r-b)/2)+g},!0);break;case "radial":u.setAttributes({translationX:f.centerX},!0);break;case "angular":u.setAttributes({translationY:f.centerY},!0);break;case "gauge":u.setAttributes({translationY:f.centerY},!0)}if("left"===h||"right"===h)e.iterate(k,
function(b,d,f){void 0!==d&&(v=E?Ext.callback(E,null,[B,d,c,D],0,B):I.renderer(d,c,D),D=d,u.setAttributes({text:String(v),translationY:a.roundPixel(b*q+s)},!0),u.applyTransformations(),p=Math.max(p,u.getBBox().width+r),p<=e.thickness&&(C=Ext.draw.Matrix.fly(u.attr.matrix.elements.slice(0)),z=C.prepend.apply(C,M).transformBBox(u.getBBox(!0)),!K||w(z,K,l)))&&(a.renderSprite(u),K=z,G+=z.height,A++)});else if("top"===h||"bottom"===h)e.iterate(k,function(b,d,f){void 0!==d&&(v=E?Ext.callback(E,null,[B,
d,c,D],0,B):I.renderer(d,c,D),D=d,u.setAttributes({text:String(v),translationX:a.roundPixel(b*m+n)},!0),u.applyTransformations(),p=Math.max(p,u.getBBox().height+r),p<=e.thickness&&(C=Ext.draw.Matrix.fly(u.attr.matrix.elements.slice(0)),z=C.prepend.apply(C,M).transformBBox(u.getBBox(!0)),K&&w(z,K,l),a.renderSprite(u),K=z,G+=z.width,A++))});else if("radial"===h)e.iterate(k,function(b,d,e){void 0!==d&&(v=E?Ext.callback(E,null,[B,d,c,D],0,B):I.renderer(d,c,D),D=d,"undefined"!==typeof v&&(u.setAttributes({text:String(v),
translationX:f.centerX-a.roundPixel(b)/f.max*f.length*Math.cos(f.baseRotation+Math.PI/2),translationY:f.centerY-a.roundPixel(b)/f.max*f.length*Math.sin(f.baseRotation+Math.PI/2)},!0),u.applyTransformations(),z=u.attr.matrix.transformBBox(u.getBBox(!0)),!K||w(z,K)))&&(a.renderSprite(u),K=z,G+=z.width,A++)});else if("angular"===h)L=f.majorTickSize+.5*f.lineWidth+(parseInt(u.attr.fontSize,10)||10)/2,e.iterate(k,function(b,d,e){void 0!==d&&(v=E?Ext.callback(E,null,[B,d,c,D],0,B):I.renderer(d,c,D),D=d,
p=Math.max(p,Math.max(f.majorTickSize,f.minorTickSize)+("butt"!==f.lineCap?.5*f.lineWidth:0)),"undefined"!==typeof v&&(b=b/(f.max+1)*Math.PI*2+f.baseRotation,u.setAttributes({text:String(v),translationX:f.centerX+(f.length+L)*Math.cos(b),translationY:f.centerY+(f.length+L)*Math.sin(b)},!0),u.applyTransformations(),z=u.attr.matrix.transformBBox(u.getBBox(!0)),!K||w(z,K)))&&(a.renderSprite(u),K=z,G+=z.width,A++)});else if("gauge"===h){var x=e.getGaugeAngles();e.iterate(k,function(b,d,e){void 0!==d&&
(v=E?Ext.callback(E,null,[B,d,c,D],0,B):I.renderer(d,c,D),D=d,"undefined"!==typeof v&&(b=(b-f.min)/(f.max-f.min+1)*f.totalAngle-f.totalAngle+x.start,u.setAttributes({text:String(v),translationX:f.centerX+(f.length+10)*Math.cos(b),translationY:f.centerY+(f.length+10)*Math.sin(b)},!0),u.applyTransformations(),z=u.attr.matrix.transformBBox(u.getBBox(!0)),!K||w(z,K)))&&(a.renderSprite(u),K=z,G+=z.width,A++)})}f.enlargeEstStepSizeByText&&A&&(G/=A,G+=r,G*=2,f.estStepSize<G&&(f.estStepSize=G));if(1<Math.abs(e.thickness-
...
arguments);this.mixins["Voyant.util.CategoriesManager"].constructor.apply(this,arguments);this.addFeature("color");this.addFeature("font",'"Palatino Linotype", "Book Antiqua", Palatino, serif');this.callParent(arguments);var b=d3.scale.category10().range().map(function(a){return this.hexToRgb(a)},this),c=d3.scale.category20().range().map(function(a){return this.hexToRgb(a)},this),d=d3.scale.category20b().range().map(function(a){return this.hexToRgb(a)},this),e=d3.scale.category20c().range().map(function(a){return this.hexToRgb(a)},
this);this.addColorPalette("d3_cat10",b);this.addColorPalette("d3_cat20a",c);this.addColorPalette("d3_cat20b",d);this.addColorPalette("d3_cat20c",e);b=Ext.create("Ext.chart.theme.Base").getColors().map(function(a){return this.hexToRgb(a)},this);this.addColorPalette("extjs",b)},getRelativeUrl:function(){for(var a="",b=0,c=window.location.pathname.substring(this.getBaseUrl().length).split("/").length-1;b<c;b++)a+="../";return a},getTools:function(){return[{type:"maximize"},{type:"help"}]},launch:function(){Ext.tip.QuickTipManager.init();
