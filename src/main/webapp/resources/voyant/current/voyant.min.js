...
try{var b=eval.call(window,a)}catch(d){return this.results.unmask(),Voyant.notebook.util.Show.showError(d),this.getTargetEl().fireEvent("resize"),d}this.setIsRun(!0);if(void 0!==b)if(b.then&&b.catch&&b.finally){var c=this;b.then(function(a){c.results.unmask();void 0!==a&&c._showResult(a)}).catch(function(a){c.results.unmask();Voyant.notebook.util.Show.showError(a)}).finally(function(){Ext.defer(function(){this.getTargetEl().fireEvent("resize")},50,c)})}else this.results.unmask(),this._showResult(b),
this.getTargetEl().fireEvent("resize");else this.results.unmask(),this.getTargetEl().fireEvent("resize");return b},_getResultsComponent:function(a){var b=this;return Ext.create("Ext.Container",{align:"stretch",cls:"notebook-code-results",layout:{type:"absolute"},items:[{xtype:"component",itemId:"results",x:0,y:0,anchor:"99%",height:b.getMinimumResultsHeight(),html:a},{xtype:"container",itemId:"buttons",hidden:!0,x:0,y:0,items:[{xtype:"toolbar",style:{background:"none",paddingTop:"0px"},items:["-\x3e",
{glyph:"xf066@FontAwesome",tooltip:"Contract Results",handler:function(a){b.getExpandResults()?(b.setExpandResults(!1),a.setTooltip("Expand Results"),a.setGlyph("xf065@FontAwesome")):(b.setExpandResults(!0),a.setTooltip("Contract Results"),a.setGlyph("xf066@FontAwesome"));b._setResultsHeight()}},{xtype:"notebookwrapperexport",exportType:"output"},{glyph:"xf014@FontAwesome",tooltip:"Remove Results",handler:function(a){b.clearResults()}}]}]}],getValue:function(){var a=this.getResultsEl().dom.cloneNode(!0),
b=a.innerHTML;a.style.height||(b="\x3cdiv style\x3d'height: "+this.getResultsEl().getHeight()+"px'\x3e"+b+"\x3c/div\x3e");return b},getResultsEl:function(){return this.down("#results").getEl()},update:function(){var a=this.down("#results");a.update.apply(a,arguments)},listeners:{afterrender:function(a){a.getEl().on("mouseover",function(b,c){a.down("#buttons").setVisible(!0)});a.getEl().on("mouseout",function(b,c){a.down("#buttons").setVisible(!1)})}}})},_getUIComponent:function(a){return Ext.create("Ext.Component",
{align:"stretch",cls:"notebook-code-ui",padding:"20 10",html:a,getValue:function(){return this.getTargetEl().dom.cloneNode(!0).innerHTML}})},_showResult:function(a){if(this.results.getResultsEl().dom.innerHTML===this.EMPTY_RESULTS_TEXT)if(a.toString&&(a=a.toString()),a&&a.then){var b=this;a.then(function(a){b.results.update(a);b._setResultsHeight();return a})}else this.results.update(a);this._setResultsHeight()},_setResultsHeight:function(a){var b=this.results.getResultsEl();if(!a&&this.getExpandResults()){a=
b.getHeight();if(0<b.dom.childElementCount){var c=b.getFirstChild().getHeight();c>a&&(a=c,b.setHeight(a))}c=window.getComputedStyle(this.results.getEl().dom);c=parseFloat(c.getPropertyValue("padding-top"))+parseFloat(c.getPropertyValue("padding-bottom"));this.results.setHeight(Math.max(a,this.getMinimumResultsHeight())+c);b.removeCls("collapsed")}else this.results.setHeight(this.getMinimumResultsHeight()),this.results.getResultsEl().setHeight(this.getMinimumResultsHeight()),b.addCls("collapsed");
this.getTargetEl().fireEvent("resize")},clearResults:function(){this.results.show();var a=this.results.el.down(".x-panel");if(a){var b=Ext.getCmp(a.id);b?b.destroy():a.destroy()}else this.results.update(" ");this._setResultsHeight(!0)},tryToUnmask:function(){Spyral&&Spyral.promises&&Ext.defer(this.tryToUnmask,20,this);if(0===Voyant.application.getDeferredCount()){for(var a in window)"object"==typeof window[a]&&window[a]&&"opener"!=a&&window[a].isFulfilled&&window[a].isFulfilled()&&(window[a]=window[a].valueOf());
this.results.unmask();0===this.results.getTargetEl().getHtml().trim().length&&this.results.hide();this.getTargetEl().fireEvent("resize")}else Ext.defer(this.tryToUnmask,20,this)},getContent:function(){var a={input:this.editor.getValue(),mode:this.getMode()};if("javascript"===a.mode){a.output=this.results.getValue();var b=this.down('component[cls\x3d"notebook-code-ui"]');null!==b&&(a.ui=b.getValue())}return a},setContentAndMode:function(a,b,c){debugger;this.editor.setContent(a);this.switchModes(b||
"javascript")}});Ext.define("Voyant.notebook.editor.TextEditor",{extend:"Ext.Component",mixins:["Voyant.util.Localization"],alias:"widget.notebooktexteditor",cls:"notebook-text-editor",config:{ckeditorConfig:{toolbar:[{name:"basicstyles",items:["Bold","Italic","-","RemoveFormat"]},{name:"paragraph",items:"NumberedList BulletedList - Justify Outdent Indent Blockquote JustifyLeft JustifyCenter JustifyRight".split(" ")},{name:"colors",items:["TextColor","BGColor"]},{name:"styles",items:["Styles","Format"]},{name:"links",
...
scope:this}});this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.voyantStorageDialogs=new Voyant.notebook.StorageDialogs({listeners:{fileLoaded:function(a){},fileSaved:function(a,c){this.unmask();null!==c&&((a=this.getNotebookId())&&c==a||this.setNotebookId(c),this.toastInfo({html:this.localize("saved"),anchor:"tr"}),this.setIsEdited(!1))},saveCancelled:function(){},close:function(){this.unmask()},scope:this}});this.githubDialogs=new Voyant.notebook.github.GitHubDialogs({listeners:{fileLoaded:function(a,
c){a=c.owner;var b=c.repo,e=c.path;c=c.file;this.githubDialogs.close();this.clear();this.loadFromString(c);c=encodeURIComponent(a+"/"+b+"/"+e);-1===location.search.indexOf(c)&&(a=this.getBaseUrl()+"spyral/?githubId\x3d"+c,window.history.pushState({url:a},"Spyral Notebook: "+c,a))},fileSaved:function(a,c){a=c.owner;var b=c.repo;c=c.path;this.githubDialogs.close();this.unmask();this.toastInfo({html:this.localize("saved"),anchor:"tr"});this.setIsEdited(!1);c=encodeURIComponent(a+"/"+b+"/"+c);-1===location.search.indexOf(c)&&
(a=this.getBaseUrl()+"spyral/?githubId\x3d"+c,window.history.pushState({url:a},"Spyral Notebook: "+c,a))},saveCancelled:function(a){this.unmask()},scope:this}})},init:function(){window.Corpus=Spyral.Corpus;window.Table=Spyral.Table;window.loadCorpus=function(){return Spyral.Corpus.load.apply(Spyral.Corpus.load,arguments)};window.createTable=function(){return Spyral.Table.create.apply(Spyral.Table,arguments)};window.onbeforeunload=function(){if(this.getIsEdited())return""}.bind(this);Ext.Ajax.request({url:this.getApplication().getBaseUrlFull()+
"resources/spyral/docs/spyral.json",callback:function(a,b,c){b&&(this.spyralTernDocs=Ext.JSON.decode(c.responseText),this.spyralTernDocs.Corpus=this.spyralTernDocs.Spyral.Corpus,this.spyralTernDocs.Table=this.spyralTernDocs.Spyral.Table,this.spyralTernDocs.loadCorpus=this.spyralTernDocs.Spyral.Corpus.load,this.spyralTernDocs.createTable=this.spyralTernDocs.Spyral.Table.create);a=Ext.Object.fromQueryString(document.location.search,!0);b=Ext.isDefined(a.run);c=/\/spyral\/([\w-]+)\/?$/.exec(location.pathname);
var d=Ext.isDefined(a.githubId);"inputJsonArrayOfEncodedBase64"in a?Ext.decode(a.inputJsonArrayOfEncodedBase64).forEach(function(a){a=decodeURIComponent(atob(a));0==a.trim().indexOf("\x3c")?this.addText(a):this.addCode(a)},this):a.input?0===a.input.indexOf("http")&&this.loadFromUrl(a.input,b):c?(this.loadFromId(c[1]),this.setStorageSolution("voyant")):d?(this.githubDialogs.loadFileFromId(a.githubId),this.setStorageSolution("github")):this.addNew();if(b){var e=this;Ext.defer(function(){e.runAll()},
100)}},scope:this})},setBlock:function(a,b,c,d){a=a||"";b=b||1;d=d||{};var e=this.query("notebookeditorwrapper"),f=this.getCurrentBlock().id,g=e.findIndex(function(a){return a.id==f});if(0>g+b||g+b>e.length)Ext.Msg.show({title:this.localize("error"),msg:this.localize("blockDoesNotExist"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR});else return e[g+b]&&this.getComponent("cells").remove(e[g+b]),this.addCode(Object.assign({},{input:a,mode:c||"text"},d),g+b)},getBlock:function(a,b){a=a||0;b=
b||{};var c=this.query("notebookcodeeditorwrapper"),d=this.getCurrentBlock().id,e=c.findIndex(function(a){return a.id==d});if(0>e+a||e+a>c.length-1)"failQuietly"in b&&b.failQuietly||Ext.Msg.show({title:this.localize("error"),msg:this.localize("blockDoesNotExist"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR});else return content=c[e+a].getContent(),content.input},addNew:function(){this.setMetadata(new Spyral.Metadata({title:"\x3ch1\x3eSpyral Notebook\x3c/h1\x3e"}));this.addText("\x3cp\x3eThis is a Spyral Notebook, a dynamic document that combines writing, code and data in service of reading, analyzing and interpreting digital texts.\x3c/p\x3e\x3cp\x3eSpyral Notebooks are composed of text blocks (like this one) and code blocks (like the one below). You can \x3cspan class\x3d'marker'\x3eclick on the blocks to edit\x3c/span\x3e them and add new blocks by clicking add icon that appears in the left column when hovering over a block.\x3c/p\x3e");
var a=this.addCode("");Ext.defer(function(){a.run()},100,this)},clear:function(){this.setMetadata(new Spyral.Metadata);this.getComponent("cells").removeAll()},showSaveDialog:function(a){this.mask(this.localize("saving"));this.getMetadata().setDateNow("modified");var b=this.generateExportHtml(),c=this.getStorageSolution();"voyant"===c&&void 0!==this.getNotebookId()&&void 0!==this.voyantStorageDialogs.getAccessCode()?this.voyantStorageDialogs.doSave({notebookId:this.getNotebookId(),data:b,accessCode:this.voyantStorageDialogs.getAccessCode()}):
...
loadFromId:function(a){this.mask(this.localize("loading"));var b=this;Spyral.Load.trombone({tool:"notebook.NotebookManager",action:"load",id:a,noCache:1}).then(function(a){b.unmask();b.loadFromString(a.notebook.data);a.notebook.id&&a.notebook.id!=b.getNotebookId()&&b.setNotebookId(a.notebook.id);b.setIsEdited(!1)}).catch(function(a){b.unmask()})},loadFromHtmlString:function(a){var b=(new DOMParser).parseFromString(a,"text/html");this.setMetadata(new Spyral.Metadata(b));var c=!1;b.querySelectorAll("section.notebook-editor-wrapper").forEach(function(b){var d=
b.classList;if(d.contains("notebooktexteditorwrapper"))d=b.querySelector(".notebook-text-editor").innerHTML,this.addText(d,void 0,b.id);else if(d.contains("notebookcodeeditorwrapper")){var f=b.querySelector(".notebook-code-editor-raw");d=/\beditor-mode-(\w+)\b/.exec(f.className)[1];var g=a.indexOf("\x3csection id\x3d'"+b.id+"' class\x3d'notebook-editor-wrapper notebookcodeeditorwrapper'\x3e"),k=a.indexOf("\x3cpre class\x3d'notebook-code-editor-raw editor-mode-",g);k=a.indexOf("\x3e",k)+1;var h=a.indexOf("\x3c/pre\x3e\n\x3cdiv class\x3d'notebook-code-results'\x3e",
k);if(-1===g||-1===k||-1===h){c=!0;input="javascript"===d?f.innerText:f.innerHTML;debugger}else input=a.substring(k,h);f=null!==/\bautoexec\b/.exec(f.className);g=b.querySelector(".notebook-code-results").innerHTML;k=b.querySelector(".notebook-code-ui");k=null!==k?k.innerHTML:void 0;this.addCode({input:input,output:g,uiHtml:k,mode:d,autoExecute:f},void 0,b.id)}},this);c&&this.showError(this.localize("errorParsingDomInput"));this.fireEvent("notebookLoaded")},runUntil:function(a){var b=[];Ext.Array.each(this.query("notebookcodeeditorwrapper"),
function(c){b.push(c);c.clearResults();if(a&&a==c)return!1},this);this._run(b)},runFrom:function(a){var b=[],c=!1;Ext.Array.each(this.query("notebookcodeeditorwrapper"),function(d){a&&a==d&&(c=!0);c&&(b.push(d),d.clearResults())},this);this._run(b)},runAll:function(){var a=[];Ext.Array.each(this.query("notebookcodeeditorwrapper"),function(b){a.push(b);b.clearResults()},this);this._run(a)},_run:function(a){if(0<a.length){var b=a.shift().run(!0);if(void 0!==b&&b.then&&b.catch&&b.finally){var c=this;
b.then(function(){Ext.defer(c._run,100,c,[a])})}else Ext.defer(this._run,100,this,[a])}},autoExecuteCells:function(){var a=[];Ext.Array.each(this.query("notebookcodeeditorwrapper"),function(b){b.getAutoExecute()&&a.push(b)});this._run(a)},loadFromUrl:function(a,b){var c=this;Spyral.Load.text(a).then(function(a){c.loadFromString(a)})},addText:function(a,b,c){return this._add(a,b,"notebooktexteditorwrapper",c)},addCode:function(a,b,c,d){return this._add(a,b,"notebookcodeeditorwrapper",c,{docs:this.spyralTernDocs})},
...
a.id);0==a?Ext.Msg.show({title:this.localize("error"),msg:this.localize("cannotMoveHigher"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.WARNING}):(b.move(a,a-1),this.redoOrder())},notebookWrapperMoveDown:function(a){var b=this.getComponent("cells");a=b.items.findIndex("id",a.id);a==b.items.getCount()-1?Ext.Msg.show({title:this.localize("error"),msg:this.localize("cannotMoveLower"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.WARNING}):(b.move(a,a+1),this.redoOrder())},notebookWrapperRemove:function(a){var b=
this.getComponent("cells");b.remove(a);0==b.items.length&&this.addText("(Click to edit).");this.redoOrder()},notebookWrapperAdd:function(a,b){var c=this.getComponent("cells").items.findIndex("id",a.id);a=a.getXType(a);("notebooktexteditorwrapper"==a&&!b.hasModifier()||"notebookcodeeditorwrapper"==a&&b.hasModifier()?this.addCode("",c+1):this.addText("",c+1)).getTargetEl().scrollIntoView(this.getTargetEl(),null,!0,!0);this.redoOrder()},redoOrder:function(){this.query("notebookwrappercounter").forEach(function(a,
b){a.setOrder(b)});this.setIsEdited(!0)},setIsEdited:function(a){this.getHeader()&&(this.getHeader().down("#saveItTool").setDisabled(0==a),a||(this.query("notebookcodeeditor").forEach(function(a){a.setIsChangeRegistered(!1)}),this.query("notebooktexteditor").forEach(function(a){a.setIsEditRegistered(!1)})));this.callParent(arguments)},setNotebookId:function(a){if(a&&-1===location.pathname.indexOf("/spyral/"+a)){var b=this.getBaseUrl()+"spyral/"+a+"/";window.history.pushState({url:b},"Spyral Notebook: "+
a,b)}this.callParent(arguments)},generateExportHtml:function(){var a="\x3c!DOCTYPE HTML\x3e\n\x3chtml\x3e\n\x3chead\x3e\n\t\x3cmeta charset\x3d'UTF-8'\x3e\n"+this.getMetadata().getHeaders(),b=document.getElementById("ace-chrome");b&&(a+=b.outerHTML+"\n");a+=document.getElementById("voyant-notebooks-styles").outerHTML+"\n\x3cscript\x3e // this script checks to see if embedded tools seem to be available\nwindow.addEventListener('load', function() {\nvar hostnames \x3d {}, warned \x3d false;\ndocument.querySelectorAll('iframe').forEach(function(iframeEl) {\nlet url \x3d new URL(iframeEl.src);\nif (!(url.hostname in hostnames) \x26\x26 !warned) {\nhostnames[url.hostname] \x3d true; // mark as fetched\nfetch(url).catch(response \x3d\x3e {\nwarned \x3d true;\nalert('This notebook seems to contain one ore more tools that may not be able to load. Possible reasons include a server no longer being accessible (especially if the notebook was generated from a local server), or because of security restrictions.'+url)\n})\n}\n})\n})\n\x3c/script\x3e\n\x3c/head\x3e\n\x3cbody class\x3d'exported-notebook'\x3e"+
this.getHeaderHtml()+"\x3carticle class\x3d'spyralArticle'\x3e";this.getComponent("cells").items.each(function(b,d){var c=b.isXType("notebookcodeeditorwrapper")?"code":"text";d=b.getContent();var f=b.down("notebookwrappercounter");a+="\x3csection id\x3d'"+f.name+"' class\x3d'notebook-editor-wrapper "+b.xtype+"'\x3e\n\x3cdiv class\x3d'notebookwrappercounter'\x3e"+f.getTargetEl().dom.innerHTML+"\x3c/div\x3e";"code"===c?(c=b.down("notebookcodeeditor").getMode(),c=c.substring(c.lastIndexOf("/")+1),f=
b.getAutoExecute()?"autoexec":"",b=b.getTargetEl().query(".ace_text-layer")[0].cloneNode(!0),b.style.setProperty("height","auto"),a+="\x3cdiv class\x3d'notebook-code-editor ace-chrome'\x3e\n"+b.outerHTML+"\n\x3c/div\x3e\n\x3cpre class\x3d'notebook-code-editor-raw editor-mode-"+c+" "+f+"'\x3e"+d.input+"\x3c/pre\x3e\n\x3cdiv class\x3d'notebook-code-results'\x3e\n"+d.output+"\n\x3c/div\x3e\n",void 0!==d.ui&&(a+="\x3cdiv class\x3d'notebook-code-ui'\x3e\n"+d.ui+"\n\x3c/div\x3e\n")):a+="\x3cdiv class\x3d'notebook-text-editor'\x3e"+
d+"\x3c/div\x3e\n";a+="\x3c/section\x3e\n"});return a+="\x3c/article\x3e\n\x3cfooter class\x3d'spyral-footer'\x3e"+this.getInnerFooterHtml()+"\x3c/footer\x3e\x3c/body\x3e\n\x3c/html\x3e"},getHeaderHtml:function(){return"\x3cheader class\x3d'spyral-header'\x3e"+this.getInnerHeaderHtml()+"\x3c/header\x3e\n"},getInnerHeaderHtml:function(){var a="";this.getMetadata().title&&(a+="\x3cdiv class\x3d'title'\x3e"+this.getMetadata().title+"\x3c/div\x3e");this.getMetadata().author&&(a+="\x3cdiv class\x3d'author'\x3e"+
this.getMetadata().author+"\x3c/div\x3e");return a},getInnerFooterHtml:function(){var a="",b=this.getMetadata();if(b.author||b.license)a="\x26copy;",b.author&&(a+=" "+b.author),b.license&&(a+=" ("+b.license+")"),a+=". ";if(b.created||b.modified){var c=b.shortDate("created");b=b.shortDate("modified");c&&(a+=this.localize("created")+" "+c+".");b&&c!=b&&(a+=this.localize("modified")+" "+b+".")}return a},getExtraExportItems:function(){return[{inputValue:"html",boxLabel:this.localize("exportHtml")},{inputValue:"htmlDownload",
boxLabel:'\x3ca href\x3d"#"\x3e'+this.localize("exportHtmlDownload")+"\x3c/a\x3e",listeners:{afterrender:function(a){var b=(this.getNotebookId()||"spyral")+".html",c=this.generateExportHtml(),d={type:"text/html"};try{var e=new File([c],b,d)}catch(f){e=new Blob([c],d)}e=URL.createObjectURL(e);a=a.boxLabelEl.dom.querySelector("a");a.setAttribute("download",b);a.setAttribute("href",e)},scope:this},handler:function(a){a.boxLabelEl.dom.querySelector("a").click();a.up("window").close()}}]},exportHtml:function(){var a=
this.generateExportHtml(),b=window.open();b.document.write(a);b.document.close();b.focus()},exportHtmlDownload:function(){var a=this.generateExportHtml(),b={type:"text/plain"};try{var c=new File([a],"files.txt",b)}catch(d){c=new Blob([a],b)}c=URL.createObjectURL(c);this.getApplication().openUrl(c)},getExportUrl:function(a){return location.href},showMetadataEditor:function(){var a=this,b=this.getMetadata();Ext.create("Ext.window.Window",{title:this.localize("metadataEditor"),autoScroll:!0,items:[{xtype:"form",
items:{bodyPadding:5,width:600,layout:"anchor",defaults:{anchor:"100%",labelAlign:"right"},defaultType:"textfield",items:[{fieldLabel:this.localize("metadataTitle"),xtype:"htmleditor",name:"title",value:b.title,height:100,enableAlignments:!1,enableColors:!1,enableFont:!1,enableFontSize:!1,enableLinks:!1,enableLists:!1},{fieldLabel:this.localize("metadataAuthor"),name:"author",value:b.author},{fieldLabel:this.localize("metadataKeywords"),name:"keywords",value:b.keywords},{xtype:"htmleditor",fieldLabel:this.localize("metadataDescription"),
name:"description",height:100,value:b.description,enableAlignments:!1,enableColors:!1,enableFont:!1},{xtype:"combo",fieldLabel:this.localize("metadataLicense"),name:"license",value:b.license||"Creative Commons Attribution (CC BY)",store:{fields:["text"],data:[{text:"Apache License 2.0"},{text:'BSD 3-Clause "New" or "Revised" license'},{text:'BSD 2-Clause "Simplified" or "FreeBSD" license'},{text:"Creative Commons Attribution (CC BY)"},{text:"Creative Commons Attribution-ShareAlike (CC BY-SA)"},{text:"Creative Commons Zero (CC0)"},
{text:"GNU General Public License (GPL)"},{text:'GNU Library or "Lesser" General Public License (LGPL)'},{text:"MIT license"},{text:"Mozilla Public License 2.0"},{text:"Common Development and Distribution License"},{text:"Eclipse Public License"}]}},{xtype:"combo",name:"language",value:b.language||"English",fieldLabel:this.localize("metadataLanguage"),store:{fields:["text"],data:[{text:"Bengali"},{text:"Bhojpuri"},{text:"Egyptian Arabic"},{text:"English"},{text:"French"},{text:"German"},{text:"Gujarati"},
{text:"Hausa"},{text:"Hindi"},{text:"Indonesian"},{text:"Italian"},{text:"Japanese"},{text:"Javanese"},{text:"Kannada"},{text:"Korean"},{text:"Mandarin"},{text:"Marathi"},{text:"Persian"},{text:"Portuguese"},{text:"Russian"},{text:"Southern Min"},{text:"Spanish"},{text:"Standard Arabic"},{text:"Swahili"},{text:"Tamil"},{text:"Telugu"},{text:"Thai"},{text:"Turkish"},{text:"Urdu"},{text:"Vietnamese"},{text:"Western Punjabi"},{text:"Wu Chinese"},{text:"Yue Chinese"}]}}]}}],buttons:[{text:this.localize("metadataCancel"),
