...
setCorpus:function(a){a&&this.getProxy().setExtraParam("corpus",Ext.isString(a)?a:a.getId());this.callParent(arguments)}});Ext.define("Voyant.data.store.Contexts",{extend:"Voyant.data.store.VoyantStore",model:"Voyant.data.model.Context",config:{corpus:void 0},constructor:function(a){a=a||{};Ext.apply(a,{pagePurgeCount:0,pageSize:100,leadingBufferZone:100,trailingBufferZone:100,remoteSort:!0,proxy:{type:"ajax",url:Voyant.application.getTromboneUrl(),actionMethods:{read:"POST"},extraParams:{tool:"corpus.DocumentContexts",corpus:a&&a.corpus?Ext.isString(a.corpus)?a.corpus:a.corpus.getId():void 0,stripTags:a.stripTags},reader:{type:"json",
rootProperty:"documentContexts.contexts",totalProperty:"documentContexts.total"},simpleSortMode:!0},listeners:{beforeload:function(a){return"NONCONSUMPTIVE"!=a.getCorpus().getNoPasswordAccess()},beforeprefetch:function(a,c){var d=this.getParentPanel();if(void 0!==d){var d=d.getApiParams(),e=a.getProxy(),f;for(f in d)e.extraParams[f]=d[f]}},scope:this}});this.callParent([a])},setCorpus:function(a){a&&this.getProxy().setExtraParam("corpus",Ext.isString(a)?a:a.getId());this.callParent(arguments)}});Ext.define("Voyant.data.store.CorpusCollocates",{extend:"Voyant.data.store.VoyantStore",model:"Voyant.data.model.CorpusCollocate",config:{corpus:void 0},constructor:function(a){a=a||{};Ext.apply(a,{pagePurgeCount:0,pageSize:100,leadingBufferZone:100,remoteSort:!0,autoLoad:!1,proxy:{type:"ajax",url:Voyant.application.getTromboneUrl(),extraParams:{tool:"corpus.CorpusCollocates",corpus:a&&a.corpus?Ext.isString(a.corpus)?a.corpus:a.corpus.getId():void 0},reader:{type:"json",rootProperty:"corpusCollocates.collocates",
totalProperty:"corpusCollocates.total"},simpleSortMode:!0}});this.callParent([a])},setCorpus:function(a){a&&this.getProxy().setExtraParam("corpus",Ext.isString(a)?a:a.getId());this.callParent(arguments)}});Ext.define("Voyant.data.proxy.CorpusFacets",{extend:"Ext.data.proxy.Ajax",constructor:function(a){a=a||{};Ext.apply(a,{extraParams:Ext.apply(a.extraParams||{},{tool:"corpus.CorpusFacets"})});Ext.applyIf(a,{url:Voyant.application.getTromboneUrl()});this.callParent([a])},reader:{type:"json",rootProperty:"corpusFacets.facets",totalProperty:"corpusFacets.total"},simpleSortMode:!0});
Ext.define("Voyant.data.store.CorpusFacets",{extend:"Voyant.data.store.VoyantStore",model:"Voyant.data.model.CorpusFacet",transferable:["setCorpus"],config:{corpus:void 0},constructor:function(a){a=a||{};Ext.applyIf(a,{pagePurgeCount:0,pageSize:100,leadingBufferZone:100,remoteSort:!0,autoLoad:!1,proxy:Ext.create("Voyant.data.proxy.CorpusFacets",{extraParams:{facet:a.facet}})});this.callParent([a]);a&&a.corpus&&this.setCorpus(a.corpus)},setCorpus:function(a){a&&this.getProxy().setExtraParam("corpus",
Ext.isString(a)?a:a.getId());this.callParent(arguments)}});Ext.define("Voyant.data.proxy.CorpusTerms",{extend:"Ext.data.proxy.Ajax",constructor:function(a){a=a||{};Ext.apply(a,{extraParams:Ext.apply(a.extraParams||{},{tool:"corpus.CorpusTerms"})});Ext.applyIf(a,{url:Voyant.application.getTromboneUrl()});this.callParent([a])},reader:{type:"json",rootProperty:"corpusTerms.terms",totalProperty:"corpusTerms.total"},simpleSortMode:!0});
...
this.getProxy().setExtraParam("corpus",Ext.isString(a)?a:a.getId());this.callParent(arguments)}});Ext.define("Voyant.data.store.DocSimAnalysis",{extend:"Ext.data.Store",model:"Voyant.data.model.StatisticalAnalysis",config:{corpus:void 0},constructor:function(a){a=a||{};Ext.apply(a,{proxy:{type:"ajax",url:Voyant.application.getTromboneUrl(),extraParams:{tool:"corpus.DocumentSimilarity",corpus:a&&a.corpus?Ext.isString(a.corpus)?a.corpus:a.corpus.getId():void 0,withDistributions:!0},reader:{type:"json",rootProperty:"documentSimilarity",totalProperty:"documentSimilarity.totalDocs"},simpleSortMode:!0}});
this.callParent([a])},setCorpus:function(a){a&&this.getProxy().setExtraParam("corpus",Ext.isString(a)?a:a.getId());this.callParent(arguments)}});Ext.define("Voyant.data.store.CorpusNgrams",{extend:"Ext.data.BufferedStore",model:"Voyant.data.model.CorpusNgram",config:{corpus:void 0},constructor:function(a){a=a||{};Ext.applyIf(a,{pagePurgeCount:0,pageSize:100,leadingBufferZone:100,remoteSort:!0,proxy:{type:"ajax",url:Voyant.application.getTromboneUrl(),extraParams:{tool:"corpus.CorpusNgrams",corpus:a&&a.corpus?Ext.isString(a.corpus)?a.corpus:a.corpus.getId():void 0},reader:{type:"json",rootProperty:"corpusNgrams.ngrams",totalProperty:"corpusNgrams.total"},
...
config:{tokenType:"lexical",inDocumentsCountOnly:void 0},triggers:{help:{weight:2,cls:"fa-trigger form-fa-help-trigger",handler:"onHelpClick",scope:"this"}},initComponent:function(a){var b=this;Ext.applyIf(b,{width:120});Ext.apply(b,{enableKeyEvents:!0,listeners:{render:function(a){a.triggers&&a.triggers.help&&Ext.QuickTips.register({target:a.triggers.help.getEl(),text:a.localize("querySearchTip"),enabled:!0,showDelay:20,trackMouse:!0,autoShow:!0});this.suggest=Ext.create("Ext.tip.ToolTip",{target:this.inputEl,
autoShow:!1,hidden:!0,html:""})},keyup:function(a,b,e){if((!this.store||Ext.isString(this.store))&&this.findParentByType){b=this.findParentByType("panel");var f;b.getCorpus?f=b.getCorpus():b.getStore&&b.getStore().getCorpus&&(f=b.getStore().getCorpus());f&&(this.store=f.getCorpusTerms())}this.store&&(a=a.getValue().trim().replace(/^\^/,""),0==/[,|^~" ]/.test(a)&&0<a.length?this.store.load({params:{query:[a+"*","^"+a+"*"],limit:5,tokenType:this.tokenType,inDocumentsCountOnly:this.inDocumentsCountOnly},
scope:this,callback:function(a,b,c){suggest="";a.forEach(function(a){suggest+="\x3cdiv\x3e"+a.getTerm()+" ("+(this.inDocumentsCountOnly?a.getInDocumentsCount():a.getRawFreq())+")\x3c/div\x3e"},this);this.suggest.show();this.suggest.update(suggest)}}):(this.suggest.update(""),this.suggest.hide()))},scope:b},emptyText:b.localize("querySearch")});b.callParent(arguments);b.on("specialkey",function(a,d){d.getKey()==d.ENTER&&b.doSearch()})},onClearClick:function(){this.setValue("");this.findParentByType("panel").fireEvent("query",
this,void 0);this.updateLayout()},onHelpClick:function(){Ext.Msg.show({title:this.localize("querySearch"),message:this.localize("querySearchTip"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO})},doSearch:function(){var a=this.getValue();this.findParentByType("panel").fireEvent("query",this,0==a.length?void 0:a);this.updateLayout()}});Ext.define("Voyant.widget.TotalPropertyStatus",{extend:"Ext.Component",mixins:["Voyant.util.Localization"],alias:"widget.totalpropertystatus",statics:{i18n:{totalPropertyStatus:{en:'{count:number("0,000")}'}}},initComponent:function(){Ext.applyIf(this,{tpl:this.localize("totalPropertyStatus"),itemId:"totalpropertystatus",style:"margin-right:5px",listeners:{afterrender:function(a){var b=a.up("grid");if(b){var c=b.getStore();a.updateStatus(c.getTotalCount());b.getStore().on("totalcountchange",a.updateStatus,
...
a);var b=a.findParentBy(function(a){return a.mixins["Voyant.panel.Panel"]});b&&(b.on("loadedCorpus",function(b,d){a.fireEvent("loadedCorpus",b,d)},a),b.getCorpus&&b.getCorpus()?a.fireEvent("loadedCorpus",a,b.getCorpus()):b.getStore&&b.getStore().getCorpus&&b.getStore().getCorpus()&&a.fireEvent("loadedCorpus",a,b.getStore().getCorpus()))}}})},populate:function(a,b){this.setDocs(a);var c=this.getMenu();b&&c.removeAll();var d=this.getSingleSelect(),e="docGroup"+Ext.id();a.forEach(function(a,b){c.add({xtype:"menucheckitem",
text:a.getShortTitle(),docId:a.get("id"),checked:d&&0==b||!d,group:d?e:void 0,checkHandler:function(b,c){if(this.getSingleSelect()&&c){var d=this.findParentBy(function(a){return a.mixins["Voyant.panel.Panel"]});d&&d.fireEvent("documentSelected",this,a)}},scope:this})},this)}});
...
rawFreq:a[d].get("rawFreq")});this.setTerms(c);this.buildFromTerms()},initVisLayout:function(){if(void 0==this.getVisLayout()){var a=this.getLayout().getRenderTarget(),b=a.getWidth(),c=a.getHeight();this.setVisLayout(d3.layout.cloud().size([b,c]).padding(1).rotate(function(){return 90*~~(2*Math.random())}).spiral("archimedean").font("Impact").fontSize(function(a){return a.fontSize}.bind(this)).text(function(a){return a.text}).on("end",this.draw.bind(this)));a=d3.select(a.dom).append("svg").attr("id",
"cirrusGraph").attr("width",b).attr("height",c);this.setVis(a.append("g").attr("transform","translate("+b/2+","+c/2+")"));Ext.create("Ext.tip.ToolTip",{target:a.node(),delegate:"text",trackMouse:!0,listeners:{beforeshow:function(a){var b=a.triggerElement.getAttribute("data-freq");a.update(b)}}})}},buildFromTerms:function(){var a=this.getTerms();if(this.rendered&&a){for(var b=1E3,c=-1,d=0;d<a.length;d++){var e=a[d].rawFreq;e<b&&(b=e);e>c&&(c=e)}this.setSmallestWordSize(b);this.setLargestWordSize(c);
this.setRelativeSizes();this.setAdjustedSizes();this.getVisLayout().words(a).start()}else Ext.defer(this.buidlFromTerms,50,this)},draw:function(a,b){var c=this;this.getLayout().getRenderTarget();var d=this.getVisLayout().size()[0],e=this.getVisLayout().size()[1],f=b?Math.min(d/Math.abs(b[1].x-d/2),d/Math.abs(b[0].x-d/2),e/Math.abs(b[1].y-e/2),e/Math.abs(b[0].y-e/2))/2:1,g=this.getVis().selectAll("text").data(a,function(a){return a.text});g.transition().duration(1E3).attr("transform",function(a){return"translate("+
[a.x,a.y]+")rotate("+a.rotate+")"}).style("font-size",function(a){return a.fontSize+"px"});g.enter().append("text").attr("text-anchor","middle").attr("data-freq",function(a){return a.rawFreq}).attr("transform",function(a){return"translate("+[a.x,a.y]+")rotate("+a.rotate+")"}).style("font-size","1px").transition().duration(1E3).style("font-size",function(a){return a.fontSize+"px"});g.style("font-family",function(a){return a.font}).style("fill",function(a){return c.getApplication().getColorForTerm(a.text,
...
g.left+" \x3cspan class\x3d'word keyword'\x3e"+g.middle+"\x3c/span\x3e "+g.right)},expandRow:e})}})}}});a.on("loadedCorpus",function(b,c){this.getStore().setCorpus(c);"NONCONSUMPTIVE"==c.getNoPasswordAccess()?this.mask(this.localize("limitedAccess"),"mask-no-spinner"):Ext.create("Voyant.data.store.CorpusTerms",{corpus:c}).load({callback:function(a,b,c){c&&0<a.length&&(this.setApiParam("query",a[0].getTerm()),this.getStore().load({params:this.getApiParams()}))},scope:a,params:{limit:1,query:this.getApiParam("query"),
stopList:this.getApiParam("stopList")}})});a.on("query",function(a,c){this.setApiParam("query",c);this.getStore().loadPage(1,{params:this.getApiParams()})},a);a.on("documentTermsClicked",function(a,c){var d=[];c.forEach(function(a){d.push({term:a.getTerm(),docIndex:a.getDocIndex()})});this.fireEvent("documentIndexTermsClicked",this,d)});a.on("termsClicked",function(a,c){var d=[];Ext.isString(c)&&(c=[c]);c.forEach(function(a){void 0!==a.docIndex&&d.push({term:a.term,docIndex:a.docIndex})});0<d.length&&
this.fireEvent("documentIndexTermsClicked",this,d)});a.callParent(arguments)}});Ext.define("Voyant.panel.CorpusCollocates",{extend:"Ext.grid.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.corpuscollocates",config:{corpus:void 0},statics:{i18n:{title:{en:"Collocates"},emptyText:{en:"No matching results."},helpTip:{en:"\x3cp\x3eCorpus Collocates is a table view of which terms appear more frequently in proximity to keywords across the entire corpus. Features include:\x3c/p\x3e\x3cul\x3e\x3cli\x3ereordering by keyword, collocate word, collocate word count\x3c/li\x3e\x3cli\x3ea search box for queries (hover over the magnifying icon for help with the syntax)\x3c/li\x3e\x3c/ul\x3e"},
...
"'\x3e"+a.getTerm()+"\x3c/span\x3e";else{a=a.getTermWithLineSpacing(g);var b=0==a.indexOf("\x3cbr /\x3e");if(!k||!b&&0!=a.trim().length)e+=a,k=b}},this);this.updateText(e,!0);a=this.down("querysearchfield").getValue();""!=a&&this.highlightKeywords(a)}},this);this.setTokensStore(a);this.on("query",function(a,c){this.loadQueryTerms([c])},this);this.setDocumentTermsStore(Ext.create("Ext.data.Store",{model:"Voyant.data.model.DocumentTerm",autoLoad:!1,remoteSort:!1,proxy:{type:"ajax",url:Voyant.application.getTromboneUrl(),
extraParams:{tool:"corpus.DocumentTerms",withDistributions:!0,withPositions:!0,bins:25},reader:{type:"json",rootProperty:"documentTerms.terms",totalProperty:"documentTerms.total"},simpleSortMode:!0},listeners:{load:function(a,c,d,e){a.sort("docIndex","ASC");var f={},g=0,h;a.each(function(a){var b=[],c=a.get("distributions"),d=a.get("docId"),e=a.get("docIndex");h=a.get("term");for(a=0;a<c.length;a++){var s=a,p=c[a];p>g&&(g=p);b.push([d,e,s,p,h])}f[e]=b},this);this.highlightKeywords(h);this.down("querysearchfield").setValue(h);
a=this.query("cartesian");for(c=0;c<a.length;c++)d=a[c],e=f[c],void 0!==e?(d.getAxes()[0].setMaximum(g),d.getStore().loadData(e)):d.getStore().removeAll()},scope:this}}));this.on("afterrender",function(){var a=this.down('panel[region\x3d"center"]');this.innerContainer=a.getLayout().getRenderTarget();a.body.on("scroll",function(a,b){this.innerContainer.first();var e=this.getLastScrollTop()<b.scrollTop;!e&&1>b.scrollTop?this.fetchPrevious(!0):e&&b.scrollHeight-b.scrollTop<1.5*b.offsetHeight?this.fetchNext(!1):
250<new Date-this.getLastLocationUpdate()&&this.updateLocationMarker(b);this.setLastScrollTop(b.scrollTop)},this);a.body.on("click",function(a,b){b=Ext.get(b);if(b.hasCls("word")){var e=Voyant.data.model.Token.getInfoFromElement(b),f=b.getHtml(),e=[{term:f,docIndex:e.docIndex}];this.loadQueryTerms([f]);this.getApplication().dispatchEvent("termsClicked",this,e)}},this);this.getCorpus()&&(this.load(),(a=this.getApiParam("query"))&&this.loadQueryTerms(Ext.isString(a)?[a]:a))},this);Ext.apply(this,{dockedItems:[{dock:"bottom",
xtype:"toolbar",enableOverflow:!0,items:[{glyph:"xf060@FontAwesome",handler:function(){this.fetchPrevious(!0)},scope:this},{glyph:"xf061@FontAwesome",handler:function(){this.fetchNext(!0)},scope:this},{xtype:"tbseparator"},{xtype:"querysearchfield"}]}],listeners:{loadedCorpus:function(a,c){this.setCorpus(c);this.getTokensStore().setCorpus(c);this.getDocumentTermsStore().getProxy().setExtraParam("corpus",c.getId());var d=c.getDocuments();this.setDocumentsStore(d);d=this.down('panel[region\x3d"south"]');
this.setLocationMarker(Ext.DomHelper.append(d.el,{tag:"div",style:"background-color: #157fcc; height: 100%; width: 2px; position: absolute; top: 0; left: 0;"}));this.generateChart(c,d);this.rendered&&(this.load(),"NONCONSUMPTIVE"==c.getNoPasswordAccess()&&this.mask(this.localize("limitedAccess"),"mask-no-spinner"),(d=this.getApiParam("query"))&&this.loadQueryTerms(Ext.isString(d)?[d]:d))},termsClicked:function(a,c){var d=[];c.forEach(function(a){Ext.isString(a)?d.push(a):a.term?d.push(a.term):a.getTerm&&
d.push(a.getTerm())});0<d.length&&this.loadQueryTerms(d)},corpusTermsClicked:function(a,c){var d=[];c.forEach(function(a){a.getTerm()&&d.push(a.getTerm())});this.loadQueryTerms(d)},documentTermsClicked:function(a,c){var d=[];c.forEach(function(a){a.getTerm()&&d.push(a.getTerm())});this.loadQueryTerms(d)},documentsClicked:function(a,c,d){0<c.length&&(this.setApiParams({skipToDocId:c[0].getId(),start:0}),this.load(!0))},termLocationClicked:function(a,c){if(void 0!==c[0]){var d=c[0],e=d.get("docIndex"),
f=d.get("position"),g=f-this.getApiParam("limit")/2,h=this.getCorpus().getDocument(e);this.setApiParams({skipToDocId:h.getId(),start:0>g?0:g});this.load(!0,{callback:function(){var a=this.body.dom.querySelector("#_"+e+"_"+f);a&&a.scrollIntoView();this.highlightKeywords(d.get("term"),!1)},scope:this})}},documentIndexTermsClicked:function(a,c){if(void 0!==c[0]){var d=Ext.create("Voyant.data.model.Token",c[0]);this.fireEvent("termLocationClicked",this,[d])}},scope:this}});this.callParent(arguments)},
loadQueryTerms:function(a){a&&0<a.length&&this.getDocumentTermsStore().load({params:{query:a,docIndex:void 0,docId:void 0,page:void 0,start:void 0,limit:void 0}})},updateLocationMarker:function(a){var b;b=0==a.scrollTop?0:a.scrollHeight-a.scrollTop==a.clientHeight?1:(a.scrollTop+.5*a.clientHeight)/a.scrollHeight;a=$(a).find(".readerContainer").find(".word");var c=a.first()[0],d=a.last()[0];if(void 0!==c&&void 0!==d){a=this.getCorpus();var e=!1,c=Voyant.data.model.Token.getInfoFromElement(Ext.get(c)),
d=Voyant.data.model.Token.getInfoFromElement(Ext.get(d));0!==c.position&&(e=!0);for(var f={},g=0,h=c.docIndex;h<=d.docIndex;){var k=a.getDocument(h).get("tokensCount-lexical");h===d.docIndex&&(k=d.position);h===c.docIndex&&(k-=c.position);g+=k;f[h]=k;h++}g=Math.round(g*b);h=b=0;for(k=c.docIndex;k<=d.docIndex&&!(b=k,h+=f[k],h>=g);k++);d=f[b]-(h-g);e&&b===c.docIndex&&(d+=c.position);a=d/a.getDocument(b).get("tokensCount-lexical");e=this.query("cartesian")[b];a=e.getX()+e.getWidth()*a;Ext.get(this.getLocationMarker()).setX(a)}this.setLastLocationUpdate(new Date)},
generateChart:function(a,b){function c(a,b){var c=[[116,116,181],[139,163,83],[189,157,60],[171,75,75],[174,61,155]],c=c[a%c.length];return"rgba("+c[0]+","+c[1]+","+c[2]+","+b+")"}function d(d,e){var f=d.index,g=d.fraction,h=d.relativeHeight,k=c(f,.3),f=c(f,1);b.add({xtype:"cartesian",plugins:{ptype:"chartitemevents"},flex:g,height:"100%",insetPadding:0,background:{type:"linear",degrees:90,stops:[{offset:0,color:k},{offset:h,color:k},{offset:h,color:"white"},{offset:1,color:"white"}]},axes:[{type:"numeric",
position:"left",fields:"distribution",hidden:!0},{type:"category",position:"bottom",fields:"bin",hidden:!0}],series:[{type:"line",xField:"bin",yField:"distribution",style:{lineWidth:2,strokeStyle:f},tooltip:{corpus:a,trackMouse:!0,style:"background: #fff",showDelay:0,dismissDelay:500,hideDelay:5,renderer:function(b,c){this.setHtml(a.getDocument(b.get("docIndex")).getTitle()+"\x3cbr\x3e"+b.get("term")+": "+b.get("distribution"))}}}],store:Ext.create("Ext.data.ArrayStore",{fields:["docId","docIndex",
"bin","distribution","term"],data:[]}),listeners:{itemclick:function(a,b,c){a=b.record.data;a=this.getDocumentsStore().getAt(a.docIndex);this.getApplication().dispatchEvent("documentsClicked",this,[a])},scope:e}}).body.on("click",function(a,b){var c=Ext.get(b),d=a.getX(),e=c.getBox(),d=(d-e.x)/e.width,c=c.parent(".x-panel"),e=c.parent(),c=Ext.toArray(e.dom.children).indexOf(c.dom),c=this.getDocumentsStore().getAt(c),e=c.get("tokensCount-lexical"),d=Math.floor(e*d)-this.getApiParam("limit")/2;this.setApiParams({skipToDocId:c.getId(),
...
simpleSortMode:!0},listeners:{load:function(a,b,c,g){var h=this.getCorpus();b.forEach(function(a){a.set("corpus",h)})},scope:this}});this.documentTermsStore=Ext.create("Ext.data.Store",{model:"Voyant.data.model.DocumentTerm",autoLoad:!1,remoteSort:!1,corpus:this.getCorpus(),proxy:{type:"ajax",url:Voyant.application.getTromboneUrl(),extraParams:{tool:"corpus.DocumentTerms",corpus:this.getCorpus().getId()},reader:{type:"json",rootProperty:"documentTerms.terms",totalProperty:"documentTerms.total"},simpleSortMode:!0}});
this.rendered?this.loadSummary():Ext.defer(this.fireEvent,100,this)});this.on("activate",function(){this.getCorpus()&&this.dispatchEvent("ensureCorpusView",this,this.getCorpus())},this);a.embedded&&"Voyant.data.model.Corpus"==Ext.getClass(a.embedded).getName()&&(a.corpus=a.embedded);a&&a.corpus&&this.fireEvent("loadedCorpus",this,a.corpus)},loadSummary:function(){var a=this.getLayout().getRenderTarget();a.update("");this.summaryListParent=Ext.dom.Helper.append(a,"\x3cul\x3e\x3c/ul\x3e");Ext.dom.Helper.append(this.summaryListParent,
"\x3cli\x3e"+this.getCorpus().getShow()+"\x3c/li\x3e");a=this.getCorpus().getDocumentsCount();1<a&&this.showLongestDocuments();1<a&&this.showMostDenseDocuments();this.showMostFrequentWords();1<a&&this.showDistinctiveWords();a=Ext.apply({},{limit:null},this.getApiParams());this.docStore.load({params:a});this.addLinksHandler()},showLongestDocuments:function(){var a=Ext.dom.Helper.append(this.summaryListParent,"\x3cli\x3e\x3c/li\x3e");this.docStore.on("load",function(b,c,d){c=b.getTotalCount();if(1<
c){b.sort("index","ASC");var e=[];b.each(function(a){e.push(a.get("tokensCount-lexical"))});b.sort("tokensCount-lexical","DESC");d=parseInt(this.getApiParam("limit"));b={shortest:b.getRange(c-d,c).reverse(),longest:b.getRange(0,d),all:b.getRange(0,c)};for(var f in b)if(f)for(c=b[f],d=0;d<c.length;d++){var g=c[d];b[f][d]={title:g.getShortTitle(),id:g.get("id"),totalWordTokens:Ext.util.Format.number(g.get("tokensCount-lexical"),"0,000"),docsLen:c.length}}out=(new Ext.XTemplate(this.localize("docsLength"))).apply({spark:this.getSparkLine(e),
longestDocs:b.longest,shortestDocs:b.shortest});Ext.dom.Helper.append(a,out)}},this)},showMostDenseDocuments:function(){var a=Ext.dom.Helper.append(this.summaryListParent,"\x3cli\x3e\x3c/li\x3e");this.docStore.on("load",function(b,c,d){c=b.getTotalCount();if(1<c){b.sort("index","ASC");var e=[];b.each(function(a){e.push(a.get("typeTokenRatio-lexical"))});b.sort("typeTokenRatio-lexical","DESC");d=parseInt(this.getApiParam("limit"));b={lowest:b.getRange(c-d,c).reverse(),highest:b.getRange(0,d),all:b.getRange(0,
c)};for(var f in b)if(f)for(c=b[f],d=0;d<c.length;d++){var g=c[d];b[f][d]={title:g.getShortTitle(),id:g.get("id"),wordDensity:Ext.util.Format.number(g.get("typeTokenRatio-lexical"),"0.000"),docsLen:c.length}}out=(new Ext.XTemplate(this.localize("docsDensity"))).apply({spark:this.getSparkLine(e),highestDocs:b.highest,lowestDocs:b.lowest});Ext.dom.Helper.append(a,out)}},this)},showMostFrequentWords:function(){var a=Ext.dom.Helper.append(this.summaryListParent,"\x3cli\x3e\x3c/li\x3e"),b=this.getApiParams();
this.corpusTermsStore.load({params:b,scope:this,callback:function(b){var d=this.localize("mostFrequentWords"),e=[],f=b.length;b.forEach(function(a,b,c){e.push({id:a.getId(),type:a.getTerm(),val:Ext.util.Format.number(a.get("rawFreq"),"0,000"),len:f})});d+=(new Ext.XTemplate(this.localize("corpusType"))).applyTemplate({types:e})+".";Ext.dom.Helper.append(a,d)}})},showDistinctiveWords:function(){Ext.dom.Helper.append(this.summaryListParent,'\x3cli id\x3d"distinctiveWords"\x3e'+this.localize("distinctiveWords")+
"\x3col\x3e\x3c/ol\x3e\x3c/li\x3e",!0);this.showMoreDistinctiveWords()},showMoreDistinctiveWords:function(){var a=Ext.dom.Query.selectNode("#distinctiveWords \x3e ol",this.summaryListParent),b=Ext.dom.Query.select("li:not(.more)",a).length,c=parseInt(this.getApiParam("numberOfDocumentsForDistinctiveWords")),d=this.getCorpus().getDocumentsStore().getRange(b,b+c-1);if(d&&Ext.isArray(d)){var e=[];d.forEach(function(a){e.push(a.getIndex())});0<e.length&&this.documentTermsStore.load({addRecords:!0,params:{docIndex:e,
perDocLimit:parseInt(this.getApiParam("limit")),limit:c*parseInt(this.getApiParam("limit")),sort:"TFIDF",dir:"DESC"},scope:this,callback:function(d,g,h){var k={};if(h&&d&&Ext.isArray(d)&&(d.forEach(function(a,b,c){b=a.getDocIndex();b in k||(k[b]=[]);k[b].push({id:a.getId(),type:a.getTerm(),val:Ext.util.Format.number(a.get("rawFreq"),"0,000"),docId:a.get("docId")})}),e.forEach(function(b){var c=this.getCorpus().getDocument(b);len=k[b].length;Ext.dom.Helper.append(a,{tag:"li","voyant:index":String(b),
html:'\x3ca href\x3d"#" onclick\x3d"return false" class\x3d"document-id document-id-distinctive" voyant:val\x3d"'+c.get("id")+'"\x3e'+c.getShortTitle()+"\x3c/a\x3e"+this.localize("colon")+(new Ext.XTemplate(this.localize("documentType"))).apply({types:k[b]})+"."})},this),len=c,remaining=this.getCorpus().getDocumentsStore().getTotalCount()-b-e.length,0<remaining)){d=new Ext.Template(this.localize("moreDistinctiveWords"));var l=Ext.dom.Helper.append(a,{tag:"li",cls:"more",html:d.apply([len>remaining?
remaining:len,remaining])},!0);l.on("click",function(){l.remove();this.showMoreDistinctiveWords()},this)}}})}},addLinksHandler:function(){this.body.addListener("click",function(a){if((a=a.getTarget(null,null,!0))&&"A"==a.dom.tagName){var b={};a.hasCls("corpus-documents")?(a.hasCls("corpus-documents-length")?b.sortBy="totalWordTokens":a.hasCls("corpus-documents-density")&&(b.sortBy="wordDensity"),b.sortDirection="DESC"):a.hasCls("document-id")?(a=a.getAttribute("val","voyant"),a=this.docStore.getById(a),
this.dispatchEvent("documentsClicked",this,[a])):a.hasCls("corpus-type")?(a=a.getAttribute("recordId","voyant"),a=this.corpusTermsStore.getById(a),this.dispatchEvent("corpusTermsClicked",this,[a])):a.hasCls("corpus-types")?(b.query="",a.hasCls("corpus-types-peaks")?Ext.apply(b,{sortBy:"RELATIVEDISTRIBUTIONKURTOSIS",sortDirection:"DESC",extendedSortZscoreMinimum:1}):Ext.apply(b,{sortBy:"rawFreq",sortDirection:"DESC",extendedSortZscoreMinimum:null})):a.hasCls("document-type")&&(a=a.getAttribute("recordId",
"voyant"),a=this.documentTermsStore.getById(a),this.dispatchEvent("documentTermsClicked",this,[a]))}},this)}});Ext.define("Voyant.panel.TopicContexts",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.topiccontexts",statics:{i18n:{title:{en:"Topic Contexts"},helpTip:{en:"Topic Contexts"},reset:{en:"reset"}},api:{},glyph:"xf06e@FontAwesome"},constructor:function(a){Ext.apply(this,{title:this.localize("title"),cls:"twic_body"});this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},listeners:{loadedCorpus:function(a,b){this.loadFromCorpus(b)}},loadFromCorpus:function(a){a=
...
frequencyArray:this.allData[this.shiftCount].allDataInternal[b].frequencyArray,dotObject:[{counter:this.shiftCount,freq:this.allData[this.shiftCount].allDataInternal[b].freq}]});this.displayData.unshift({displayInternal:a,outerCounter:this.shiftCount})},startScroll:function(){var a=this;a.numDataPoints>a.numVisPoints&&0===a.shiftCount&&(a.isTransitioning=!0,this.manageMvtButtons(),setTimeout(function(){a.toggleRightCheck()},3E3))},initializeChart:function(){this.initChart();this.drawXAxis();this.drawYAxis();
this.drawChart();this.drawSlider();this.drawVerticalSlider();this.transitionCall="draw"},redraw:function(){this.transitionCall="redraw";this.updateFullPath();this.redrawXAxis();this.redrawYAxis();this.redrawChart();this.redrawSlider();this.redrawVerticalSlider();this.redrawChartOverlay()},initChart:function(){var a=this.body.query("div[class$\x3dinnerCt]",!1)[0],b=a.getHeight(),c=a.getWidth(),a=a.appendChild(Ext.DomHelper.createDom('\x3csvg class\x3d"chart" width\x3d"'+c+'" height\x3d"'+b+'"\x3e\x3c/svg\x3e'),
!0);this.chart=d3.select(a);this.largestW=c;this.largestH=b-this.navigationHeight;this.chart.append("clipPath").attr("id","clip1").append("rect").attr("class","clipping-rectangle").attr("x",0).attr("y",this.navigationHeight+2*this.tPadding).attr("width",c).attr("height",b-this.navigationHeight);this.chart.append("g").attr("class","overlay").attr("clip-path","url(#clip1)");this.setTitleLength()},xAxis:{},xAxisScale:d3.svg.axis(),drawXAxis:function(){var a=this,b=this.body.getHeight();this.body.getWidth();
this.manageAllXScales();this.xAxisScale.scale(a.xScale).orient("bottom").ticks(Math.round(a.numVisPoints)).tickFormat(function(b){var d;"document"===a.getApiParam("mode")&&(d="Segment "+(parseInt(b)+1));"corpus"===a.getApiParam("mode")&&(d=b+1+". "+a.titlesArray[b]);return d});this.xAxis=this.chart.append("g").attr("class","axisX").attr("transform","translate(0,"+(b-this.bPadding)+")").call(this.xAxisScale);this.styleXAxis()},styleXAxis:function(){this.xAxis.selectAll("text").style("font-family",
"sans-serif").style("font-size","11px");this.xAxis.selectAll("line").style("fill","none").style("stroke","black").style("shape-rendering","crispEdges");this.xAxis.selectAll("path").style("fill","none").style("stroke","black").style("shape-rendering","crispEdges")},redrawXAxis:function(){this.chart.selectAll("g[class\x3daxisX]").remove();this.drawXAxis()},yAxis:{},yAxisScale:d3.svg.axis(),drawYAxis:function(){this.body.getHeight();var a=this.body.getWidth();this.manageAllYScales();var b=d3.scale.linear().domain([200,
700]).range([5,15]),c=d3.format(".2r");this.yAxisScale.scale(this.yScale).orient("left").ticks(b(this.body.getHeight())).tickFormat(function(a){var b=Math.log(a)/Math.log(10)+1E-6;return.7>Math.abs(b-Math.floor(b))?c(a):""}).tickSize(-a+this.rPadding+this.lPadding);this.yAxis=this.chart.append("g").attr("class","axisY").attr("transform","translate("+this.lPadding+",0)").call(this.yAxisScale);this.yAxis.selectAll("text").style("font-family","sans-serif").style("font-size","11px");this.yAxis.selectAll("line").style("fill",
"none").style("stroke","black").style("shape-rendering","crispEdges").style("stroke-opacity",.05);this.yAxis.selectAll("path").style("fill","none").style("stroke","black").style("shape-rendering","crispEdges")},redrawYAxis:function(){this.chart.selectAll("g[class\x3daxisY]").remove();this.drawYAxis()},drawChart:function(){var a=this;this.chart.selectAll("g[class\x3dsection]").data(a.displayData,function(a){return a.outerCounter}).enter().append("g").attr("class","section").attr("clip-path","url(#clip1)").selectAll("g").data(function(a){return a.displayInternal}).enter().append("g").attr("class",
"frequencies").on("mouseover",function(){d3.select(this).style("fill","red")}).on("mouseout",function(){d3.select(this).style("fill","black")}).selectAll("text").data(function(a){return a.frequencyArray}).enter().append("text").attr("class",function(b){return a.removeFilteredCharacters(b.wordString)}).attr("x",function(b){var c=.5/b.numInSeries-.5,d=b.posInSeries/b.numInSeries*.8;b=b.counter+a.callOffset()+c+d;return a.xScale(b)}).attr("y",function(b){return a.yScale(b.freq)}).attr("text-anchor",
"middle").attr("transform",function(b){var c=.5/b.numInSeries-.5,d=b.posInSeries/b.numInSeries*.8,c=b.counter+a.callOffset()+c+d;b=b.freq;return"translate(0, 0) rotate(-20 "+a.xScale(c)+" "+a.yScale(b)+")"}).style("font-size",function(b){return a.fontScale(b.freq)+"px"}).style("fill-opacity",function(b){return a.opacityScale(b.freq)}).text(function(a){return a.wordString}).on("mouseover",function(b){d3.select(this).style("cursor","pointer").style("font-size",function(b){return a.fontScale(b.freq)*
a.maxFont/a.fontScale(b.freq)+"px"});b=a.buildParamsBundle(b);a.manageOverlaySlippery(b)}).on("mouseout",function(b){d3.select(this).style("cursor","auto").style("font-size",function(b){return a.fontScale(b.freq)+"px"});b=a.buildParamsBundle(b);a.manageOverlaySlippery(b)}).on("click",function(b){b=a.buildParamsBundle(b);a.manageOverlaySticky(b)}).append("title").text(function(a){return a.wordString})},redrawChart:function(){this.chart.selectAll("g[class\x3dsection]").remove();this.drawChart()},drawVerticalSlider:function(){},
redrawVerticalSlider:function(){this.chart.selectAll("rect[class\x3dminimap]").remove();this.drawVerticalSlider()},drawSlider:function(){this.body.getHeight();var a=this.body.getWidth()-(this.rPadding+this.lPadding),b=this.lPadding,c=this.lPadding+(this.numVisPoints-1)/(this.numDataPoints-1)*a;this.chart.append("line").attr("class","sliderAxis").attr("x1",this.lPadding).attr("x2",this.body.getWidth()-this.rPadding).attr("y1",this.tPadding+this.navigationHeight).attr("y2",this.tPadding+this.navigationHeight).style("shape-rendering",
"crispEdges").style("stroke","black").style("stroke-width","1");this.chart.append("line").attr("class","sliderAxis").attr("x1",this.lPadding).attr("x2",this.lPadding).attr("y1",this.tPadding+this.navigationHeight).attr("y2",this.tPadding).style("shape-rendering","crispEdges").style("stroke","black").style("stroke-width","1");this.chart.append("line").attr("class","slider").attr("id","before").attr("x1",a*(this.shiftCount-this.callOffset())/(this.numDataPoints-1)+b).attr("x2",a*(this.shiftCount-this.callOffset())/
(this.numDataPoints-1)+b).attr("y1",this.tPadding+this.navigationHeight).attr("y2",this.tPadding).style("stroke","black").style("stroke-width","1");this.chart.append("line").attr("class","slider").attr("id","after").attr("x1",a*(this.shiftCount-this.callOffset())/(this.numDataPoints-1)+c).attr("x2",a*(this.shiftCount-this.callOffset())/(this.numDataPoints-1)+c).attr("y1",this.tPadding+this.navigationHeight).attr("y2",this.tPadding).style("stroke","black").style("stroke-width","1");var b=this.chart.append("rect").attr("class",
"slider").attr("id","boxBefore").attr("x",this.lPadding).attr("y",this.tPadding).attr("height",this.navigationHeight).attr("width",a*(this.shiftCount-this.callOffset())/(this.numDataPoints-1)).style("fill","silver").style("fill-opacity",.25).style("cursor","move"),a=this.chart.append("rect").attr("class","slider").attr("id","boxAfter").attr("x",a*(this.shiftCount-this.callOffset())/(this.numDataPoints-1)+c).attr("y",this.tPadding).attr("height",this.navigationHeight).attr("width",a*(this.numDataPoints-
this.numVisPoints-this.shiftCount+this.callOffset())/(this.numDataPoints-1)).style("fill","silver").style("fill-opacity",.25).style("cursor","move"),d=this,c=d3.behavior.drag().origin(Object).on("drag",function(a){if(!d.isTransitioning){this.drag=!0;a=d.getWidth();var b=parseInt(d3.event.dx),c,h;d.sliderDragSum+=d3.event.dx;d.chart.selectAll("#before").attr("x1",function(){c=parseInt(this.getAttribute("x1"));parseInt(this.getAttribute("x1"));return parseInt(this.getAttribute("x1"))});d.chart.selectAll("#after").attr("x1",
