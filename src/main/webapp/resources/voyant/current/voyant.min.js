...
api:{stopList:"auto",author:void 0,title:void 0,keyword:void 0,pubDate:void 0},glyph:"xf124@FontAwesome"},config:{map:void 0,overlay:void 0,contentEl:void 0,isOpenLayersLoaded:!1,isArcLoaded:!1,maxResults:50,zoomTreshold:80,sizeRatio:5E4,totalEntries:0,nbOfEntries:[],pointsPerMs:.3,pointsPerArc:100,delayBetweenVectors:100/.3,filterCount:0,timedEvents:[[]],cities:[],coordinatesSequence:[],travels:[],colors:"rgb(230, 25, 75);rgb(0,92,49);rgb(145, 30, 180);rgb(128, 0, 0);rgb(0, 0, 128);rgb(60, 180, 75);rgb(143,124,0);rgb(157,204,0)".split(";")},
html:'\x3cdiv class\x3d"map"\x3e\x3c/div\x3e\x3cdiv class\x3d"ol-popup"\x3e\x3ca href\x3d"#" class\x3d"ol-popup-closer"\x3e\x3c/a\x3e\x3cdiv class\x3d"popup-content"\x3e\x3c/div\x3e\x3c/div\x3e',cls:"dreamscape",constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);Ext.Loader.loadScript({url:this.getBaseUrl()+"resources/openlayers/ol.js",onLoad:function(){void 0===ol.Map.prototype.getLayer&&(ol.Map.prototype.getLayer=function(a){var c=
void 0;this.getLayers().forEach(function(d){a===d.get("id")&&(c=d)});return c});this.setIsOpenLayersLoaded(!0)},scope:this});Ext.Loader.loadScript({url:this.getBaseUrl()+"resources/dreamscape/arc.js",onLoad:function(){this.setIsArcLoaded(!0)},scope:this})},initComponent:function(){Ext.apply(this,{title:this.localize("title"),dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{text:this.localize("show"),tooltip:this.localize("showTip"),menu:{defaults:{xtype:"menucheckitem",
checkHandler:function(a,b){this.getMap().getLayer(a.getItemId()+"0").setVisible(b)},scope:this,checked:!0},items:[{text:this.localize("cities"),itemId:"cities"},{text:this.localize("connections"),itemId:"layer"}]}},{text:this.localize("filter"),tooltip:this.localize("filterTip"),menu:{defaults:{xtype:"querysearchfield",labelWidth:60,labelAlign:"right",width:250,maxWidth:250,listeners:{change:function(a,b){console.warn(a,b)}}},items:[{fieldLabel:this.localize("authorLabel"),tokenType:"author",itemId:"author",
hidden:!0},{fieldLabel:this.localize("titleLabel"),tokenType:"title"},{fieldLabel:this.localize("keywordLabel")},{xtype:"multislider",fieldLabel:this.localize("pubDateLabel"),itemId:"pubDate",hidden:!0}]}}]}]});this.on("loadedCorpus",function(a,b){(new Voyant.data.store.CorpusTerms({corpus:b})).load({params:{tokenType:"author",limit:1},callback:function(a,b,e){e&&a&&1==a.length?this.down("toolbar").getComponent("author").show():this.toastInfo(this.localize("noauthor"))},scope:this});(new Voyant.data.store.CorpusTerms({corpus:b})).load({params:{tokenType:"pubDate",
sort:"TERMASC",limit:1},callback:function(a,d,e){if(e&&!a&&1==a.length){var f=parseInt(a[0].getTerm());(new Voyant.data.store.CorpusTerms({corpus:b})).load({params:{tokenType:"pubDate",sort:"TERMDESC",limit:1},callback:function(a,b,c){c&&!a&&1==a.length&&(a=parseInt(a[0].getTerm()),b=this.down("toolbar").getComponent("pubDate"),b.setMinValue(f),b.setMaxValue(a),b.show())},scope:this})}else this.toastInfo(this.localize("nopubDate"))},scope:this});this.tryInit()},this);this.callParent()},tryInit:function(){if(this.getIsOpenLayersLoaded()&&
this.getIsArcLoaded()){var a=this.body.down(".map").setId(Ext.id()),b=this.body.down(".ol-popup"),c=new ol.Overlay({element:b.dom,autoPan:!0,autoPanAnimation:{duration:250}});this.setOverlay(c);var d=b.down(".ol-popup-closer").dom;d.onclick=function(){c.setPosition(void 0);d.blur();return!1};this.setContentEl(b.down(".popup-content"));var e=new ol.Map({layers:[new ol.layer.Tile({preload:Infinity,source:new ol.source.Stamen({layer:"watercolor"})}),new ol.layer.Tile({preload:Infinity,source:new ol.source.Stamen({cacheize:2048,
layer:"toner-hybrid"})})],target:a.getId(),loadTilesWhileInteracting:!0,overlays:[c],view:new ol.View({center:[15E5,6E6],zoom:2})}),f=this;e.on("singleclick",function(a){var b=e.getFeaturesAtPixel(a.pixel);if(b){var c="\x3cul\x3e";b.forEach(function(b){if("Circle"===b.getGeometry().getType()&&b.get("selected")){var d=b.get("occurences");d.forEach(function(a){c+="\x3cli\x3e"+a.description+" : "+a.infos.author+', \x3ca href\x3d"'+a.infos.url+'" target\x3d"_blank"\x3e'+a.infos.title+"\x3c/a\x3e, "+a.infos.year+
" "+a.order+"\x3c/li\x3e"});d=b.get("text");c+="\x3c/ul\x3e";0<b.get("alternates").length&&(d+=" ("+b.get("alternates")+")");b=a.coordinate;f.getContentEl().setHtml("\x3ch3\x3e"+d+"\x3c/h3\x3e"+c);f.getOverlay().setPosition(b)}else b.get("selected")&&(d=b.get("occurences"),d.forEach(function(a){c+="\x3cli\x3efrom : "+a.from.description+" : "+a.from.infos.author+', \x3ca href\x3d"'+a.from.infos.url+'" target\x3d"_blank"\x3e'+a.from.infos.title+"\x3c/a\x3e, "+a.from.infos.year+" "+a.from.order+", to: "+
a.to.description+" : "+a.to.infos.author+' , \x3ca href\x3d"'+a.to.infos.url+'" target\x3d"_blank"\x3e'+a.to.infos.title+"\x3c/a\x3e, "+a.to.infos.year+" "+a.to.order+"\x3c/li\x3e"}),d=b.get("text"),c+="\x3c/ul\x3e",b=a.coordinate,f.getContentEl().setHtml("\x3ch3\x3e"+d+"\x3c/h3\x3e"+c),f.getOverlay().setPosition(b))})}});var g=new ol.layer.Vector({map:e,source:new ol.source.Vector({wrapX:!1,useSpatialIndex:!1}),zIndex:10,selected:!0,style:function(a){return"Circle"===a.getGeometry().getType()?f.cityStyleFunction(a,
e.getView().getResolution()):f.travelStyleFunction(a,e.getView().getResolution())},updateWhileAnimating:!0,updateWhileInteracting:!0});e.on("pointermove",function(a){g.getSource().clear();var b=a.coordinate;if(a=e.getFeaturesAtPixel(a.pixel)){for(var c=0;a[c].get("selected")&&(c++,c!==a.length););if(c<a.length){c=a[c];a={font:"12px Calibri,sans-serif",textAlign:"center",offsetY:-15,fill:new ol.style.Fill({color:[0,0,0,1]}),stroke:new ol.style.Stroke({color:[255,255,255,.5],width:4})};a.text=c.get("text");
a=new ol.style.Style({text:new ol.style.Text(a),zIndex:1});var d=new ol.Feature({text:c.get("text"),geometry:c.getGeometry(),occurences:c.get("occurences"),alternates:c.get("alternates"),selected:!0,filterId:c.get("filterId"),coordinates:c.get("coordinates"),width:c.get("width"),visible:c.get("visible")});g.getSource().addFeature(d);b=c.getGeometry().getClosestPoint(b);b=new ol.Feature({geometry:new ol.geom.Point(b),selected:!0});b.setStyle(a);g.getSource().addFeature(b)}}});this.setMap(e);this.addFilter()}else Ext.defer(this.tryInit,
500,this)},travelStyleFunction:function(a,b){var c="rgb(255, 0, 0)";a.get("selected")?c="rgb(0, 0, 255)":a.get("color")&&(c=a.get("color"));var d=.5+Math.sqrt(a.get("occurences").length/parseFloat(this.getTotalEntries())*this.getSizeRatio()*.2),c=new ol.style.Stroke({color:c,width:d}),d=[new ol.style.Style({stroke:c})],e=a.getGeometry(),f=e.getLastCoordinate(),e=e.getCoordinateAt(.9),e=Math.atan2(f[1]-e[1],f[0]-e[0]),g=new ol.geom.LineString([f,[f[0]-10*b,f[1]+10*b]]);g.rotate(e,f);var h=new ol.geom.LineString([f,
[f[0]-10*b,f[1]-10*b]]);h.rotate(e,f);d.push(new ol.style.Style({geometry:g,stroke:c}));d.push(new ol.style.Style({geometry:h,stroke:c}));return d},cityStyleFunction:function(a,b){var c="rgb(255, 0, 0)";a.get("selected")?c="rgb(0, 0, 255)":a.get("color")&&(c=a.get("color"));return a.get("visible")?new ol.style.Style({stroke:new ol.style.Stroke({color:c,width:a.get("width")})}):!1},animationStyleFunction:function(a){var b="rgb(255, 0, 0)";a.get("color")&&(b=a.get("color"));return new ol.style.Style({stroke:new ol.style.Stroke({color:b,
width:6})})},addLater:function(a,b,c){var d=this.getMap();b=window.setTimeout(function(){a.set("start",(new Date).getTime());d.getLayer("animation"+c).getSource().addFeature(a)},b);this.getTimedEvents()[c].push(b)},animateTravels:function(a,b){var c=this.getMap(),d=this,e=a.vectorContext,f=a.frameState;c.getLayer("animation"+b).getSource().getFeatures().forEach(function(a){if(!a.get("finished"))if("Circle"===a.getGeometry().getType())a.set("finished",!0);else{var b=a.getGeometry().getCoordinates(),
c=(f.time-a.get("start"))*d.getPointsPerMs();c>=b.length&&a.set("finished",!0);c=Math.min(c,b.length);b=new ol.geom.LineString(b.slice(0,c));e.setStyle(this.animationStyleFunction(a));e.drawGeometry(b)}},this);c.render()},serverSideFiltering:function(a,b,c,d,e){var f=this.getBaseUrl()+"resources/dreamscape/cities4.json";return fetch(f).then(function(a){return a.json()}).then(function(f){var h=[],k=[],l=0;f.cities.forEach(function(e){if(e.infos.author.toLowerCase().includes(a)&&e.infos.title.toLowerCase().includes(b)&&
(""===c||e.infos.year>=c)&&(""===d||e.infos.year<=d))if(h[e.coordinates]){var f=h[e.coordinates];f.occurences.push({infos:e.infos,description:e.description,order:l});e.description!==f.description&&0>f.alternates.indexOf(e.description)&&f.alternates.push(e.description)}else h[e.coordinates]={description:e.description,alternates:[],occurences:[{infos:e.infos,description:e.description,order:l}],coordinates:e.coordinates};l++});f=[];for(coords in h)f.push(h[coords]);f.sort(function(a,b){return b.occurences.length-
a.occurences.length});f=f.splice(0,e);f.forEach(function(a){a.occurences.forEach(function(b){b.coordinates=a.coordinates;k.push(b)})});k.sort(function(a,b){return a.order-b.order});return resultsJson=JSON.stringify({cities:f,entries:k})})},filter:function(a){var b=this.getTimedEvents(),c=this.getCities(),d=this.getMap(),e=this.getColors();b[a].forEach(function(a){window.clearTimeout(a)});c[a]=[];var f=d.getLayer("cities"+a);f.getSource().clear();b=d.getLayer("layer"+a);b.setVisible(!0);b.getSource().clear();
var g=this;d.getView().on("change:resolution",function(){f.getSource().getFeatures().forEach(function(a){var b=d.getView().getZoom(),c=5+Math.sqrt(a.get("occurences").length/parseFloat(g.getTotalEntries())*g.getSizeRatio());a.set("width",c);a.set("visible",c*b>g.getZoomTreshold())});g.generateTravels(a)});this.serverSideFiltering("","","","",this.getMaxResults()).then(function(a){return JSON.parse(a)}).then(function(b){nbOfEntries=g.getNbOfEntries();nbOfEntries[a]=b.entries.length;var d=0;nbOfEntries.forEach(function(a){d+=
a});g.setTotalEntries(d);coordinatesSequence=g.getCoordinatesSequence();coordinatesSequence[a]=b.entries;b.cities.forEach(function(b){var d=[parseFloat(b.coordinates[1]),parseFloat(b.coordinates[0])],g=new ol.geom.Circle(d);g.transform(ol.proj.get("EPSG:4326"),ol.proj.get("EPSG:3857"));b=new ol.Feature({geometry:g,description:b.description,alternates:b.alternates,text:b.description+"("+b.occurences.length+")",finished:!0,occurences:b.occurences,color:e[a],filterId:a,coordinates:d});f.getSource().addFeature(b);
c[a][d]=b})}).then(function(){var b=d.getView().getResolution()+1;d.getView().setResolution(b);g.animateLayer(a)})},addFilter:function(){var a=this.getTimedEvents(),b=this.getFilterCount();map=this.getMap();a[b]=[];a=new ol.layer.Vector({source:new ol.source.Vector({wrapX:!1,useSpatialIndex:!1}),id:"layer"+b,visible:!1,opacity:.4,style:this.travelStyleFunction.bind(this),updateWhileAnimating:!1,updateWhileInteracting:!1});map.addLayer(a);a=new ol.layer.Vector({source:new ol.source.Vector({wrapX:!1,
useSpatialIndex:!1}),id:"cities"+b,opacity:.7,style:this.cityStyleFunction.bind(this)});map.addLayer(a);a=new ol.layer.Vector({source:new ol.source.Vector({wrapX:!1,useSpatialIndex:!1}),id:"animation"+b,style:null});map.addLayer(a);this.setFilterCount(b+1);this.filter(b)},generateTravels:function(a){var b=this.getCities();if(0<Object.keys(b[a]).length){var c=map.getLayer("layer"+a);c.getSource().clear();var d=this.getTravels();d[a]=[];for(var e=void 0,f=!1,g=void 0,h=0;h<coordinatesSequence[a].length;h++){var k=
coordinatesSequence[a][h];if(f){var l=[k.coordinates[1],k.coordinates[0]],m=[e,l];if((e[0]!==l[0]||e[1]!==l[1])&&b[a][l].get("visible"))if(d[a][m]){var n=d[a][m].get("occurences");n.push({from:g,to:k});n=d[a][m].get("description")+"("+n.length+")";d[a][m].set("text",n)}else{var n=b[a][e].get("description"),q=b[a][l].get("description"),r=n+"-"+q;(new arc.GreatCircle({x:e[0],y:e[1]},{x:l[0],y:l[1]})).Arc(this.getPointsPerArc(),{offset:100}).geometries.forEach(function(b){b=new ol.geom.LineString(b.coords);
b.transform(ol.proj.get("EPSG:4326"),ol.proj.get("EPSG:3857"));var f=this.getColors()[a];b=new ol.Feature({geometry:b,description:r,text:r+"(1)",finished:!0,occurences:[{from:g,to:k}],color:f,filterId:a,start:e,end:l});c.getSource().addFeature(b);d[a][m]=b},this);e=l;g=k}}else e=[k.coordinates[1],k.coordinates[0]],b[a][e].get("visible")&&(g=k,f=!0)}}},animateLayer:function(a){var b=this.getTimedEvents(),c=this.getMap();b[a].forEach(function(a){window.clearTimeout(a)});var d=0,e=!1,f=0;c.getLayer("layer"+
...
b){this.store.setCorpus(b);this.isVisible()&&this.store.load({params:this.getApiParams()});0==this.hasCorpusAccess(b)&&(this.queryById("modifyButton").hide(),this.queryById("downloadButton").hide())});this.on("activate",function(){this.getStore().getCorpus()&&this.getStore().load({params:this.getApiParams()})},this);this.on("query",function(a,b){this.setApiParam("query",b);this.store.load({params:this.getApiParams()})});a.embedded&&("Voyant.data.model.Corpus"==Ext.getClass(a.embedded).getName()?a.corpus=
a.embedded:"Voyant.data.store.Documents"==Ext.getClass(a.embedded).getName()&&(this.store.setRecords(a.embedded.getData()),a.corpus=a.embedded.getCorpus()));a.corpus&&this.fireEvent("loadedCorpus",this,a.corpus)},keepRemoveReorderHandler:function(a){var b=a.up("window").down("documents"),c=b.getSelection(),d=b.getStore().getCorpus().getDocumentsCount(),e=a.getItemId();if("reorder"==e){if(b.getStore().getCount()<d)return Ext.Msg.show({title:this.localize("error"),message:this.localize("reorderFilteredError"),
buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR});docIndex=[];b.getStore().each(function(a){docIndex.push(a.getIndex())},this);for(a=1;a<docIndex.length;a++)if(docIndex[a-1]>docIndex[a])return Ext.Msg.confirm(b.localize("newCorpus"),(new Ext.Template(b.localize(e+"Documents"))).applyTemplate([c.length]),function(a){"yes"===a&&(docIndex=[],this.getStore().each(function(a){docIndex.push(a.getIndex())},this),a={docIndex:docIndex},a[e+"Documents"]=!0,this.editCorpus(a))},b);return Ext.Msg.show({title:this.localize("error"),
message:this.localize("reorderOriginalError"),buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR})}return 0<c.length?c.length==d?1==d?Ext.Msg.show({title:this.localize("error"),message:this.localize("onlyOneError"),buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR}):Ext.Msg.show({title:this.localize("error"),message:this.localize("allSelectedError"),buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR}):Ext.Msg.confirm(this.localize("newCorpus"),(new Ext.Template(this.localize(e+"SelectedDocuments"))).applyTemplate([c.length]),function(a){"yes"===
a&&(docIndex=[],c.forEach(function(a){docIndex.push(a.getIndex())}),a={docIndex:docIndex},a[e+"Documents"]=!0,this.editCorpus(a))},b):b.getApiParam("query")&&b.getStore().getCount()<d?Ext.Msg.confirm(this.localize("newCorpus"),(new Ext.Template(this.localize(e+"FilteredDocuments"))).applyTemplate([c.length]),function(a){"yes"===a&&(docIndex=[],this.getStore().each(function(a){docIndex.push(a.getIndex())},this),a={docIndex:docIndex},a[e+"Documents"]=!0,this.editCorpus(a))},b):Ext.Msg.show({title:this.localize("error"),
