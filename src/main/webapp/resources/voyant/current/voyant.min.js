...
{title:a.localize("optionsTitle"),modal:!0,panel:a,items:{xtype:"form",items:a.getOptions(),buttons:[{text:a.localize("reset"),glyph:"xf0e2@FontAwesome",flex:1,panel:a,handler:function(a){this.mixins&&this.mixins["Voyant.util.Api"]&&(this.mixins["Voyant.util.Api"].constructor.apply(this),this.getCorpus&&this.getCorpus()&&this.fireEvent("loadedCorpus",this,this.getCorpus()));a.up("window").close()},scope:a},{xtype:"tbfill"},{text:a.localize("confirmTitle"),glyph:"xf00c@FontAwesome",flex:1,panel:a,
handler:function(a){var b=a.up("form").getValues();this.setApiParams(b);var c=this.getApplication(),d=c.getCorpus();if(void 0!=b.stopList&&void 0!=b.stopListGlobal&&b.stopListGlobal){c.setApiParams&&c.setApiParams({stopList:b.stopList});for(var e=c.getViewport().query("panel,chart"),f=0;f<e.length;f++)e[f].setApiParams&&e[f].setApiParams({stopList:b.stopList});d&&(c.dispatchEvent("loadedCorpus",this,d),this.fireEvent("loadedCorpus",this,d))}d&&this.fireEvent("loadedCorpus",this,d);a.up("window").close()},
scope:a},{text:a.localize("cancelTitle"),glyph:"xf00d@FontAwesome",flex:1,handler:function(a){a.up("window").close()}}]},bodyPadding:5}).show()}}:void 0,help:{glyph:"xf128@FontAwesome",fn:this.helpToolClick}},c=[];if(a.includeTools)for(var f in a.includeTools)"object"==typeof a.includeTools[f]&&c.push(a.includeTools[f]);for(f in e)a.includeTools&&!a.includeTools[f]||!e[f]||c.push({type:f,tooltip:this.localize(f+"Tip"),callback:e[f].fn,xtype:"toolmenu",glyph:e[f].glyph,items:e[f].items});Ext.apply(this,
{tools:c});this.on("afterrender",function(){var a=this.getHeader();if(a&&"Desktop"==Ext.os.deviceType){var b=a.getEl();b.on("mouseover",function(){this.getHeader().getTools().forEach(function(a){a.show()})},this);b.on("mouseout",function(){this.getHeader().getTools().forEach(function(a){"help"!=a.type&&-1==a.type.indexOf("collapse")&&a.hide()})},this);a.getTools().forEach(function(a,b){"help"!=a.type&&a.hide()})}},this)},getMenuItemFromXtype:function(a){var b=this.getApplication().getToolConfigFromToolXtype(a);
...
function(){this.up("window").close()},this)}}},{xtype:"fieldset",collapsible:!0,collapsed:!0,title:a.localize("exportViewFieldset"),items:[{xtype:"radio",name:"export",inputValue:"embed",boxLabel:a.localize("exportViewHtmlEmbed")},{xtype:"radio",name:"export",inputValue:"biblio",boxLabel:a.localize("exportViewBiblio")}]});a.isXType("grid")&&b.push({xtype:"fieldset",collapsible:!0,collapsed:!0,title:a.localize("exportGridCurrent"),items:[{xtype:"radio",name:"export",inputValue:"gridCurrentHtml",boxLabel:a.localize("exportGridCurrentHtml")},
{xtype:"radio",name:"export",inputValue:"gridCurrentTsv",boxLabel:a.localize("exportGridCurrentTsv")},{xtype:"radio",name:"export",inputValue:"gridCurrentJson",boxLabel:a.localize("exportGridCurrentJson")}]});if((!a.getExportVisualization||a.getExportVisualization())&&(a.down("chart")||a.getTargetEl().dom.querySelector("canvas")||a.getTargetEl().dom.querySelector("svg"))){var c=[{xtype:"radio",name:"export",inputValue:"png",boxLabel:a.localize("exportPng")}];a.getTargetEl().dom.querySelector("svg")&&
...
message:'\x3cimg src\x3d"data:image/svg+xml;base64,'+btoa(a)+'" style\x3d"float: right; max-width: 200px; max-height: 200px; border: thin dotted #ccc;"/\x3e'+this.localize("exportSvgMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:a})},exportPngData:function(a){Ext.Msg.show({title:this.localize("exportPngTitle"),message:'\x3cimg src\x3d"'+a+'" style\x3d"float: right; max-width: 200px; max-height: 200px; border: thin dotted #ccc;"/\x3e'+this.localize("exportPngMessage"),
buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:'\x3cimg src\x3d"'+a+'" /\x3e'})},exportPng:function(){var a;if(this.down("chart"))return this.exportPngData(this.down("chart").getImage().data);var b=this.getTargetEl().dom.querySelector("canvas");if(b)return this.exportPngData(b.toDataURL("image/png"));var c=this.getTargetEl().dom.querySelector("svg");if(c){var d=d3.select(c).attr("version",1.1).attr("xmlns","http://www.w3.org/2000/svg").node().parentNode.innerHTML;a="data:image/svg+xml;base64,"+
btoa(d);var b=Ext.DomHelper.createDom({tag:"canvas",width:c.offsetWidth,height:c.offsetHeight}),e=b.getContext("2d"),f=new Image;f.src=a;f.panel=this;f.onload=function(){e.drawImage(f,0,0);a=b.toDataURL("image/png");return this.panel.exportPngData.call(this.panel,a)}}},exportUrl:function(){this.openUrl(this.getExportUrl())},exportEmbed:function(){Ext.Msg.show({title:this.localize("exportViewEmbedTitle"),message:this.localize("exportViewEmbedMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,
multiline:!0,value:"\x3c!--\tExported from Voyant Tools: http://voyant-tools.org/.\nPlease note that this is an early version and the API may change.\nFeel free to change the height and width values below: --\x3e\n\x3ciframe style\x3d'width: 100%; height: 800px' src\x3d'"+this.getExportUrl()+"'\x3e\x3c/iframe\x3e"})},exportBiblio:function(){var a=new Date;Ext.Msg.show({title:this.localize("exportBiblioTitle"),message:"\x3cfieldset\x3e\x3clegend\x3eMLA\x3c/legend\x3eSinclair, St\u00e9fan and Geoffrey Rockwell. "+
(this.isXType("voyantheader")?"":'"'+this.localize("title")+'." ')+"\x3ci\x3eVoyant Tools\x3c/i\x3e. "+Ext.Date.format(a,"Y")+". Web. "+Ext.Date.format(a,"j M Y")+". \x26lt;http://voyant-tools.org\x26gt;.\x3c/fieldset\x3e\x3cbr \x3e\x3cfieldset\x3e\x3clegend\x3eChicago\x3c/legend\x3eSt\u00e9fan Sinclair and Geoffrey Rockwell, "+(this.isXType("voyantheader")?"":'"'+this.localize("title")+'", ')+"\x3ci\x3eVoyant Tools\x3c/i\x3e, accessed "+Ext.Date.format(a,"F j, Y")+", http://voyant-tools.org.\x3c/fieldset\x3e\x3cbr \x3e\x3cfieldset\x3e\x3clegend\x3eAPA\x3c/legend\x3eSinclair, S. \x26amp; G. Rockwell. ("+
Ext.Date.format(a,"Y")+"). "+(this.isXType("voyantheader")?"":this.localize("title")+". ")+"\x3ci\x3eVoyant Tools\x3c/i\x3e. Retrieved "+Ext.Date.format(a,"F j, Y")+", from http://voyant-tools.org\x3c/fieldset\x3e",buttons:Ext.Msg.OK,icon:Ext.Msg.INFO})},exportGridCurrentJson:function(a,b){function c(a){var b={};e.forEach(function(c){b[c.text]=a.get(c.dataIndex)});values.push(b)}var d=a.getStore();d.getFields();var e=a.getColumnManager().headerCt.getVisibleGridColumns();values=[];d.buffered?d.data.forEach(c):
d.each(c);Ext.Msg.show({title:this.localize("exportDataTitle"),message:this.localize("exportDataJsonMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:Ext.encode(values)})},exportGridCurrentTsv:function(a,b){function c(a){cells=[];f.forEach(function(b){b=a.get(b.dataIndex);Ext.isString(b)&&(b=b.replace(/\s+/g," "));cells.push(b)});g+=cells.join("\t")+"\n"}var d=a.getStore(),e=d.getFields(),f=a.getColumnManager().headerCt.getVisibleGridColumns(),e=[];f.forEach(function(a){e.push(a.text)});
var g=e.join("\t")+"\n";d.buffered?d.data.forEach(c):d.each(c);Ext.Msg.show({title:this.localize("exportDataTitle"),message:this.localize("exportDataTsvMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:g})},exportGridCurrentHtml:function(a,b){function c(a){e+="\t\t\x3ctr\x3e\n";f.forEach(function(b){b=a.get(b.dataIndex);Ext.isString(b)&&(b=b.replace(/&/g,"\x26amp;").replace(/</g,"\x26lt;").replace(/>/g,"\x26lg;"));e+="\t\t\t\x3ctd\x3e"+b+"\x3c/td\x3e\n"});e+="\t\t\x3c/tr\x3e\n"}
var d=a.getStore();d.getFields();var e="\x3ctable\x3e\n\t\x3cthead\x3e\n\t\t\x3ctr\x3e\n",f=a.getColumnManager().headerCt.getVisibleGridColumns();f.forEach(function(a){e+="\t\t\t\x3ctd\x3e"+a.text+"\x3c/td\x3e\n"});e+="\t\t\x3c/tr\x3e\n\t\x3c/thead\x3e\n\t\x3ctbody\x3e\n";d.buffered?d.data.forEach(c):d.each(c);e+="\t\x3c/tbody\x3e\n\x3c/table\x3e";Ext.Msg.show({title:this.localize("exportDataTitle"),message:this.localize("exportDataHtmlMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,
value:e})},getExportUrl:function(){var a=this.isXType("voyantheader")?this.getApplication().getModifiedApiParams():this.getModifiedApiParams();this.isXType("voyantheader")||(a.view=Ext.getClassName(this).split(".").pop());return this.getApplication().getBaseUrl()+"?corpus\x3d"+this.getApplication().getCorpus().getId()+"\x26"+Ext.Object.toQueryString(a)},helpToolClick:function(a){a.isXType("voyanttabpanel")&&(a=a.getActiveTab());var b=a.localize("help",{"default":!1})||a.localize("helpTip");b==a._localizeClass(Ext.ClassManager.get("Voyant.util.Toolable"),
"helpTip")?a.openUrl(a.getBaseUrl()+"docs/#!/guide/"+a.getXType()):Ext.Msg.alert(a.localize("title"),b+"\x3cp\x3e\x3ca href\x3d'"+a.getBaseUrl()+"docs/"+(a.isXType("voyantheader")?"":"#!/guide/"+a.getXType())+"' target\x3d'voyantdocs'\x3e"+a.localize("moreHelp")+"\x3c/a\x3e\x3c/p\x3e")},replacePanel:function(a){var b=this.getApplication().getCorpus();this.getInitialConfig();var c;if(this.isXType("voyantheader")&&this.getApplication().getViewComponent){c=this.getApplication().getViewComponent();c.removeAll(!0);
var d=c.add({xtype:a});b&&this.getApplication().dispatchEvent("loadedCorpus",c,b);c=Ext.Object.fromQueryString(document.location.search);var d=this.getApplication().getBaseUrl(),d=d+("?corpus\x3d"+b.getId()),d=d+("\x26view\x3d"+a),e;for(e in c)"corpus"!==e&&"view"!==e&&(d+="\x26"+e+"\x3d"+c[e]);window.history.pushState({corpus:b.getId(),view:a},"",d)}else c=this.isXType("voyantheader")&&this.getApplication().getViewComponent?this.getApplication().getViewComponent():this.up("component"),c.remove(this,
!0),d=c.add({xtype:a}),c.isXType("voyanttabpanel")&&c.setActiveTab(d),b&&d.fireEvent("loadedCorpus",d,b);this.getApplication().dispatchEvent("panelChange",this)}});
...
tokenType:b.tokenType,stopList:b.getStopList(),inDocumentsCountOnly:b.getInDocumentsCountOnly()}}}))});b.on("afterrender",function(a){a.triggers&&a.triggers.help&&Ext.QuickTips.register({target:a.triggers.help.getEl(),text:a.getIsDocsMode()?a.localize("querySearchDocsModeTip"):a.localize("querySearchTip"),enabled:!0,showDelay:20,autoShow:!0});a.triggers&&a.triggers.count&&Ext.QuickTips.register({target:a.triggers.count.getEl(),text:a.localize("aggregateInDocumentsCount"),enabled:!0,showDelay:20,autoShow:!0});
this.suggest=Ext.create("Ext.tip.ToolTip",{target:this.inputEl,autoShow:!1,hidden:!0,html:""})},b);b.callParent(arguments)}});Ext.define("Voyant.widget.TotalPropertyStatus",{extend:"Ext.Component",mixins:["Voyant.util.Localization"],alias:"widget.totalpropertystatus",statics:{i18n:{totalPropertyStatus:{en:'{count:number("0,000")}'}}},initComponent:function(){Ext.applyIf(this,{tpl:this.localize("totalPropertyStatus"),itemId:"totalpropertystatus",style:"margin-right:5px",listeners:{afterrender:function(a){var b=a.up("grid");if(b){var c=b.getStore();a.updateStatus(c.getTotalCount());b.getStore().on("totalcountchange",a.updateStatus,
...
api:{stopList:"auto",documentFilename:void 0,documentFormat:void 0},glyph:"xf0ce@FontAwesome"},config:{options:{xtype:"stoplistoption"},inDocumentsCountOnly:!1,stopList:"auto",store:void 0},constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(a){var b=this;Ext.applyIf(b,{introHtml:"",fieldItems:[{xtype:"querysearchfield",fieldLabel:this.localize("titleLabel"),tokenType:"title"},{xtype:"querysearchfield",fieldLabel:this.localize("authorLabel"),
tokenType:"author"},{xtype:"querysearchfield",fieldLabel:this.localize("termsLabel")}],fieldColumns:2});Ext.applyIf(b,{intro:{margin:"5 0 5 0",layout:"center",items:{itemId:"intro",html:b.introHtml}},fields:{xtype:"container",layout:"center",items:{xtype:"container",maxWidth:1200,layout:{type:"table",columns:b.fieldColumns},items:b.fieldItems.map(function(a){return{xtype:"container",defaults:{margin:"5 10 5 10",inDocumentsCountOnly:b.getInDocumentsCountOnly(),stopList:b.getStopList(),showAggregateInDocumentsCount:!0,
isDocsMode:!0,flex:1,maxWidth:800,labelAlign:"right"},items:Ext.applyIf(a,{fieldLabel:b.localize((a.tokenType?a.tokenType:"lexical")+"Label")})}},this)}},foot:{layout:"center",margin:"20 0 0 0",items:{xtype:"container",layout:{type:"hbox",align:"middle"},defaults:{margin:"0 5 0 5",width:200},items:[{xtype:"button",itemId:"export",glyph:"xf08e@FontAwesome",text:this.localize("sendToVoyantButton"),handler:b.handleSendToVoyant,scope:b},{xtype:"button",glyph:"xf019@FontAwesome",itemId:"download",text:this.localize("downloadButton"),
handler:b.handleExport,scope:b},{xtype:"container",hidden:!0,itemId:"statuscontainer",layout:"vbox",items:[{itemId:"status",bodyStyle:"text-align: center",width:200},{xtype:"container",width:200,items:{xtype:"sparklineline",chartRangeMin:0,itemId:"sparkline",margin:"0 0 0 10",values:[1,1],height:20,width:200}}]}]}}});Ext.applyIf(b,{items:[b.intro,b.fields,b.foot]});b.on("loadedCorpus",function(a,d){b.getStore().setCorpus(d);void 0==b.getInitialConfig("introHtml")&&void 0==b.getInitialConfig("intro")&&
b.queryById("intro").setHtml(d.getShow())},b);b.on("query",function(a,b){this.performAggregateQuery(this.getAggregateQuery())});b.setStore(Ext.create("Voyant.data.store.DocumentQueryMatches"));b.callParent([a])},handleSendToVoyant:function(){if(this.getStore().lastOptions&&this.getStore().lastOptions.params.query){var a=this;this.mask("Creating corpus\u2026");this.getStore().load({params:{query:this.getStore().lastOptions.params.query,createNewCorpus:!0},callback:function(b,c,d){a.unmask();d&&b&&
1==b.length&&(b=c.getProxy().getReader().metaData,b=a.getBaseUrl()+"?corpus\x3d"+b,a.openUrl(b))}})}else Ext.Msg.alert(this.localize("sendToVoyantButton"),(new Ext.XTemplate(this.localize("sendToVoyantNoQuery"))).apply([this.getBaseUrl()+"?corpus\x3d"+this.getStore().getCorpus().getId()]))},handleExport:function(){this.getStore().lastOptions&&this.getStore().lastOptions.params.query?this.getStore().load({params:{query:this.getStore().lastOptions.params.query,createNewCorpus:!0,temporaryCorpus:!0},
callback:function(a,b,c){c&&a&&1==a.length&&this.openDownloadCorpus(b.getProxy().getReader().metaData)},scope:this}):this.openDownloadCorpus(this.getStore().getCorpus().getId())},openDownloadCorpus:function(a){a=this.getTromboneUrl()+"?corpus\x3d"+a+"\x26tool\x3dcorpus.CorpusExporter\x26outputFormat\x3dzip\x26zipFilename\x3dDownloadedVoyantCorpus-"+a+".zip"+(this.getApiParam("documentFormat")?"\x26documentFormat\x3d"+this.getApiParam("documentFormat"):"")+(this.getApiParam("documentFilename")?"\x26documentFilename\x3d"+
this.getApiParam("documentFilename"):"");console.warn(a)},handleEhxport:function(){var a=this;Ext.create("Ext.window.Window",{title:"Export DREaM Corpus",modal:!0,width:500,items:[{xtype:"container",layout:"hbox",defaults:{flex:1,margin:5,xtype:"button"},items:[{text:"Send to Voyant Tools",glyph:"xf08e@FontAwesome",cls:"send-voyant",handler:function(a){var c=a.findParentByType("window");c.mask("Creating corpus\u2026");container.getAggregateSearchDocumentQueryMatches({params:{createNewCorpus:!0},callback:function(a,
b,f){if(f){a=b.getProxy().getReader().rawData.documentsFinder.corpus;a=this.getBaseUrl()+"?corpus\x3d"+a;var g=window.open(a);g||(g=Ext.Msg.show({buttons:Ext.MessageBox.OK,buttonText:{ok:"Close"},icon:Ext.MessageBox.INFO,message:"\x3ca href\x3d'"+a+"' target\x3d'_blank' class\x3d'link'\x3eClick here\x3c/a\x3e to access your new corpus.",buttonText:"Close"}),Ext.Msg.getEl().dom.querySelector("a").addEventListener("click",function(){g.close()}));c.destroy()}}})}},{text:"Download a ZIP Archive",glyph:"xf019@FontAwesome",
handler:function(b){b.findParentByType("window").mask("Creating corpus\u2026");a.getStore().load({params:{query:a.getStore().lastOptions.params.query,createNewCorpus:!0,temporaryCorpus:!0},callback:function(b,d,e){b=d.getProxy().getReader().metaData;d=a.getTromboneUrl()+"?corpus\x3d"+b+"\x26tool\x3dcorpus.CorpusExporter\x26outputFormat\x3dzip\x26zipFilename\x3dDownloadedVoyantCorpus-"+d.getParams().query.replace(/\W+/g,"_")+".zip\x26documentFormat\x3d"+a.getApiParam("documentFormat")+"\x26documentFilename\x3d"+
a.getApiParam("documentFilename");a.openUrl(d)}})}}]},{xtype:"fieldset",title:"Download Details",collapsible:!0,collapsed:!0,items:[{xtype:"radiogroup",fieldLabel:"file format",cls:"x-check-group-alt",width:500,labelWidth:80,items:[{boxLabel:"DREaM XML",name:"export-format",inputValue:"SOURCE",checked:!0},{boxLabel:"Voyant XML",name:"export-format",inputValue:"ORIGINAL",checked:!1},{boxLabel:"plain text",name:"export-format",inputValue:"TXT",checked:!1}],listeners:{change:function(a,c){debugger;container.setApiParam("documentFormat",
c["export-format"])}}},{xtype:"fieldset",title:"File Name",cls:"filename",html:"[filename html]",listeners:{afterrender:{fn:function(){$("#filename-use, #filename-ignore").sortable({connectWith:".filenamegroup",update:function(a,c){if("filename-use"==this.id){for(var d=this.querySelectorAll("li"),e=[],f=0,g=d.length;f<g;f++)e.push(d[f].getAttribute("data-field"));container.setApiParam("documentFilename",0<e.length?e.join(","):void 0)}}}).disableSelection()}}}}]}]}).show()},performAggregateQuery:function(a){var b=
this,c=b.queryById("statuscontainer"),d=b.queryById("status"),e=b.queryById("sparkline");c&&c.show();d&&d.setHtml((new Ext.XTemplate('{0:plural("documents")} matching.')).apply([0]));e&&e.setValues([0,0]);a?(c=this.getStore().getCorpus().getDocumentsCount(),this.getStore().load({params:{query:a,withDistributions:!0,bins:100<c?100:c},callback:function(a,c,e){b.queryById("export");c=b.queryById("sparkline");e&&a&&1==a.length&&(d&&d.setHtml((new Ext.XTemplate('{0:plural("document")} matching.')).apply([a[0].getCount()])),
c&&c.setValues(a[0].getDistributions()))}})):this.getStore().lastOptions&&(this.getStore().lastOptions.params.query=void 0)},getAggregateQuery:function(){var a=[];Ext.ComponentQuery.query("field",this).forEach(function(b){if(b.getTokenType&&b.getValue){var c=b.getTokenType();b=Ext.Array.from(b.getValue());0<b.length&&0<b.length&&a.push("+("+b.map(function(a){return c+":"+a}).join("|")+")")}});return a.join(" ")}});Ext.define("Voyant.panel.CollocatesGraph",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.collocatesgraph",statics:{i18n:{title:{en:"Links"},helpTip:{en:"\x3cp\x3eCollocates graph shows a network graph of higher frequency terms that appear in proximity. Keywords are shown in blue and collocates (words in proximity) are showing in orange. Features include:\x3cul\x3e\x3cli\x3ehovering over keywords shows their frequency in the corpus\x3c/li\x3e\x3cli\x3ehovering over collocates shows their frequency in proximity (not their total frequency)\x3c/li\x3e\x3cli\x3edouble-clicking on any word fetches more results\x3c/li\x3e\x3cli\x3ea search box for queries (hover over the magnifying icon for help with the syntax)\x3c/li\x3e\x3c/ul\x3e"},
