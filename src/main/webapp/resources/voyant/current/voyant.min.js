...
else{b=b||{};var d={};for(key in Ext.ClassManager.get(Ext.getClassName(a)).api)key in b&&(d[key]=b[key]);d.corpus||("Voyant.data.model.Corpus"==Ext.getClassName(this)?d.corpus=this.getId():this.getCorpus&&(d.corpus=this.getCorpus().getId()));Ext.applyIf(b,{style:"width: "+(b.width||"90%")+(Ext.isNumber(b.width)?"px":"")+"; height: "+(b.height||"400px")+(Ext.isNumber(b.height)?"px":"")});delete b.width;delete b.height;-1<document.location.search.indexOf("debug\x3dtrue")&&(d.debug=!0);var d=Ext.Object.toQueryString(d),
e=new Ext.XTemplate('\x3ciframe style\x3d"'+b.style+'" src\x3d"'+Voyant.application.getBaseUrl()+"tool/"+c.substring(c.lastIndexOf(".")+1)+'/?{0}"\x3e\x3c/iframe\x3e');1950>d.length?show(e.apply(["minimal\x3dtrue\x26"+d])):Ext.Ajax.request({url:Voyant.application.getTromboneUrl(),params:{tool:"resource.StoredResource",storeResource:d}}).then(function(a){a=Ext.util.JSON.decode(a.responseText);show(e.apply(["minimal\x3dtrue\x26embeddedConfig\x3d"+a.storedResource.id]))}).otherwise(function(a){showError(a)})}}else Voyant.notebook.util.Embed.showWidgetNotRecognized.call(this)},
showWidgetNotRecognized:function(){var a=Voyant.notebook.util.Embed.i18n.widgetNotRecognized;this.embeddable&&(a+=Voyant.notebook.util.Embed.i18n.tryWidget+"\x3cul\x3e"+this.embeddable.map(function(a){a=a.substring(a.lastIndexOf(".")+1).toLowerCase();return"\"\x3ca href\x3d'"+Voyant.application.getBaseUrl()+"/docs/#!/guide/"+a+"' target\x3d'voyantdocs'\x3e"+a+'\x3c/a\x3e"'}).join(", ")+"\x3c/ul\x3e");showError(a)}}});embed=Voyant.notebook.util.Embed.embed;Ext.define("Voyant.data.model.AnalysisToken",{extend:"Ext.data.Model",idProperty:"term",fields:[{name:"term"},{name:"rawFreq",type:"int"},{name:"relativeFreq",type:"number"},{name:"cluster",type:"int"},{name:"clusterCenter",type:"boolean"},{name:"vector"}]});Ext.define("Voyant.data.model.Context",{extend:"Ext.data.Model",fields:[{name:"id"},{name:"docIndex",type:"int"},{name:"docId"},{name:"left"},{name:"keyword"},{name:"term"},{name:"right"}],getDocIndex:function(){return this.get("docIndex")},getLeft:function(){return this.get("left")},getMiddle:function(){return this.get("middle")},getHighlightedMiddle:function(){return"\x3cspan class\x3d'keyword'\x3e"+this.getMiddle()+"\x3c/span\x3e"},getRight:function(){return this.get("right")},getHighlightedContext:function(){return this.getLeft()+
...
Ext.define("Voyant.data.store.CorpusFacets",{extend:"Ext.data.Store",mixins:["Voyant.data.store.CorpusFacetsMixin"],constructor:function(a){a=a||{};this.mixins["Voyant.data.store.CorpusFacetsMixin"].constructor.apply(this,[a]);this.callParent([a])}});Ext.define("Voyant.data.store.CorpusFacetsBuffered",{extend:"Ext.data.BufferedStore",mixins:["Voyant.data.store.CorpusFacetsMixin"],constructor:function(a){a=a||{};this.mixins["Voyant.data.store.CorpusFacetsMixin"].constructor.apply(this,[a]);this.callParent([a])}});Ext.define("Voyant.data.store.CorpusTermsMixin",{mixins:["Voyant.data.store.VoyantStore"],model:Voyant.data.model.CorpusTerm,statics:{i18n:{toString:"This store has {0} terms with a total of {1} occurrences."}},constructor:function(a){this.mixins["Voyant.data.store.VoyantStore"].constructor.apply(this,[a,{"proxy.extraParams.tool":"corpus.CorpusTerms","proxy.reader.rootProperty":"corpusTerms.terms","proxy.reader.totalProperty":"corpusTerms.total"}])},show:function(a){show(this.toString(a))}});
Ext.define("Voyant.data.store.CorpusTerms",{extend:"Ext.data.Store",mixins:["Voyant.data.store.CorpusTermsMixin"],constructor:function(a){a=a||{};this.mixins["Voyant.data.store.CorpusTermsMixin"].constructor.apply(this,[a]);this.callParent([a])},toString:function(a){return(new Ext.XTemplate(this.localize("toString"))).apply([this.getCount(),this.sum("rawFreq")])}});
...
arguments):this.get("id")},loadCorpusTerms:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments);var b=Voyant.application.getDeferred(this);a=a||{};Ext.isNumber(a)&&(a={limit:a});Ext.applyIf(a,{limit:0});var c=this.getCorpusTerms();c.load({params:a,callback:function(a,e,f){f?b.resolve(c):b.reject(e)}});return b.promise},getCorpusTerms:function(a){return Ext.create("Voyant.data.store.CorpusTerms",Ext.apply(a||{},{corpus:this}))},getCorpusCollocates:function(a){return Ext.create("Voyant.data.store.CorpusCollocates",
...
getNoPasswordAccess:function(){return this.then?Voyant.application.getDeferredNestedPromise(this,arguments):this.get("noPasswordAccess")},show:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments);show(this.toString(a))},toString:function(a){var b=this.getDocumentsCount(),c=this.localize("thisCorpus");if(0==b)c+=" "+this.localize("isEmpty")+".";else{var c=c+" ",c=1<b?c+(new Ext.XTemplate(this.localize("hasNdocuments"))).apply({count:Ext.util.Format.number(b,"0,000")}):
