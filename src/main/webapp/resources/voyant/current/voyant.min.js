...
[];a.items.forEach(function(a){c.push(this.getMenuItemFromXtype(a))},this);b.push({text:d.localize(a.i18n),glyph:a.glyph,menu:{items:c}})},this)}var e={save:{glyph:"xf08e@FontAwesome",fn:this.exportToolClick,items:void 0},plus:b?{glyph:"xf17a@FontAwesome",items:b}:void 0,gear:this.showOptionsClick||this.getOptions?{glyph:"xf205@FontAwesome",fn:this.showOptionsClick?this.showOptionsClick:function(a){a.isXType("voyanttabpanel")&&(a=a.getActiveTab());Ext.create("Ext.window.Window",{title:a.localize("exportTitle"),
...
this.processTerms(a),c=a.get("docId");a=a.get("term");var d={};d[a]=b;this.bubblelines.addTermsToDoc(d,c)},this);this.bubblelines.doBubblelinesLayout()},scope:this}});this.setDocTermStore(a);Ext.apply(this,{dockedItems:[{dock:"bottom",xtype:"toolbar",items:[{xtype:"querysearchfield"},{xtype:"button",text:this.localize("clearTerms"),handler:function(){this.down("#termsView").getSelectionModel().deselectAll(!0);this.termStore.removeAll();this.setApiParams({query:null});this.bubblelines.removeAllTerms();
this.bubblelines.drawGraph()},scope:this},,"-",{xtype:"slider",itemId:"granularity",fieldLabel:this.localize("granularity"),labelAlign:"right",labelWidth:70,width:120,increment:10,minValue:10,maxValue:300,listeners:{changecomplete:function(a,c){this.setApiParams({bins:c});this.reloadTermsData()},scope:this}},"-",{xtype:"checkbox",boxLabel:this.localize("separateLines"),boxLabelAlign:"before",checked:!1,handler:function(a,c){this.bubblelines.SEPARATE_LINES_FOR_TERMS=c;this.bubblelines.lastClickedBubbles=
{};this.bubblelines.setCanvasHeight();this.bubblelines.drawGraph()},scope:this}]}],border:!1,layout:"fit",items:{layout:{type:"vbox",align:"stretch"},defaults:{border:!1},items:[{height:30,itemId:"termsView",xtype:"dataview",store:this.termStore,tpl:this.termTpl,itemSelector:"div.term",overItemCls:"over",selectedItemCls:"selected",focusCls:"",listeners:{beforeitemclick:function(a,c,d,e,f,g){f.preventDefault();f.stopPropagation();a.fireEvent("itemcontextmenu",a,c,d,e,f,g);return!1},selectionchange:function(a,
c){for(var d=this.down("#termsView"),e=[],f=d.el.query("div[class*\x3dterm]"),g=0;g<f.length;g++)Ext.fly(f[g]).addCls("unselected");var g;for(g=0;g<c.length;g++)f=c[g],e.push(f.get("term")),Ext.fly(d.getNode(f)).removeCls("unselected");for(g in this.lastClickedBubbles)for(term in d=this.lastClickedBubbles[g],d)-1==e.indexOf(type)&&delete this.lastClickedBubbles[g][term];this.setApiParams({typeFilter:e});this.bubblelines.setCanvasHeight();this.bubblelines.drawGraph()},itemcontextmenu:function(a,c,
d,e,f){f.preventDefault();f.stopPropagation();a.isSelected(d);(new Ext.menu.Menu({floating:!0,items:[{text:this.localize("removeTerm"),handler:function(){a.deselect(e);var c=this.termStore.getAt(e).get("term");this.termStore.removeAt(e);a.refresh();this.bubblelines.removeTerm(c);this.bubblelines.setCanvasHeight();this.bubblelines.drawGraph()},scope:this}]})).showAt(f.getXY())},scope:this}},{flex:1,xtype:"container",autoEl:"div",itemId:"canvasParent",layout:"fit",overflowY:"auto",overflowX:"hidden"}],
listeners:{render:function(a){a=this.down("#canvasParent");this.bubblelines=new Bubblelines({container:a,clickHandler:this.bubbleClickHandler.bind(this)})},afterlayout:function(a){!1===this.bubblelines.initialized&&this.bubblelines.initializeCanvas()},resize:function(a,c,d){this.bubblelines.doBubblelinesLayout()},scope:this}}});this.callParent(arguments)},loadFromCorpusTerms:function(a){a.load({callback:function(a,c,d){var e=this.getApiParam("query")||[];"string"==typeof e&&(e=[e]);a.forEach(function(a,
b){e.push(a.get("term"))},this);this.getDocTermsFromQuery(e)},scope:this,params:{limit:5,stopList:"auto"}})},getDocTermsFromQuery:function(a){a&&this.setApiParam("query",a);if(this.getCorpus()&&this.isVisible())for(var b=this.getCorpus().getDocuments(),c=b.getCount(),d=0;d<c;d++){var e=b.getAt(d);this.setApiParams({query:a,docIndex:void 0,docId:e.getId()});this.getDocTermStore().load({params:this.getApiParams()})}},reloadTermsData:function(){var a=[],b;for(b in this.bubblelines.currentTerms)a.push(b);
...
constructor:function(a){this.callParent(arguments);a=a||{};this.mixins["Voyant.panel.Panel"].constructor.call(this,Ext.apply(a,{includeTools:{gear:!0,help:!0}}))},initComponent:function(){var a=this;Ext.apply(a,{title:this.localize("title"),width:800,frame:!0,padding:10,style:{borderColor:"#aaa",borderStyle:"solid"},frameHeader:!0,layout:{type:"vbox",align:"middle"},dockedItems:[{xtype:"toolbar",dock:"bottom",buttonAlign:"right",defaultButtonUI:"default",items:[{text:"Open",glyph:"xf115@FontAwesome",
tooltip:"Select an exsting corpus",hidden:void 0!=this.getCorpus(),handler:function(){Ext.create("Ext.window.Window",{title:"Open an Existing Corpus",layout:"fit",modal:!0,items:{xtype:"form",margin:"5,5,5,5",items:{xtype:"combo",labelWidth:150,fieldLabel:"Choose a corpus:",name:"corpus",queryMode:"local",store:[["shakespeare","Shakespeare's Plays"],["austen","Austen's Novels"]],forceSelection:!0},buttons:[{text:"Open",glyph:"xf00c@FontAwesome",handler:function(b){b.up("form").getForm();var c=b.up("form").getForm().getValues().corpus;
...
b.result.stepEnabledCorpusCreator.storedId}))},scope:this})},loadCorpus:function(a){this.getCorpus()&&Ext.apply(a,{corpus:this.getCorpus().getId(),addDocuments:!0});var b=this.up("window");b&&b.isFloating()&&b.close();var c=this.getApplication(),d=c.getViewport();d.mask();(new Corpus(a)).then(function(a){d.unmask();c.dispatchEvent("loadedCorpus",c,a)}).fail(function(a,b){d.unmask();c.showErrorResponse({message:a},b)})},showOptionsClick:function(a){void 0===a.optionsWin&&(a.optionsWin=Ext.create("Ext.window.Window",
{title:a.localize("gearWinTitle"),closeAction:"hide",height:225,width:500,layout:"fit",bodyPadding:10,items:[{xtype:"form",defaultType:"textfield",fieldDefaults:{labelAlign:"right",labelWidth:160},defaults:{width:400},items:[{xtype:"combo",width:400,fieldLabel:a.localize("inputFormat"),name:"inputFormat",queryMode:"local",store:[["",a.localize("inputFormatAuto")],["TEI","TEI"],["RSS","RSS"]],forceSelection:!0,value:""},{fieldLabel:a.localize("xpathDocuments"),name:"xmlDocumentsXpath"},{fieldLabel:a.localize("xpathContent"),
name:"xmlContentXpath"},{fieldLabel:a.localize("xpathAuthor"),name:"xmlAuthorXpath"},{fieldLabel:a.localize("xpathTitle"),name:"xmlTitleXpath"}]}],buttons:[{text:a.localize("ok"),handler:function(b,c){var d=b.findParentByType("window"),e=d.down("form").getValues();a.setApiParams(e);d.hide()}},{text:a.localize("cancel"),handler:function(a,c){a.findParentByType("window").hide()}}]}));a.optionsWin.show()}});Ext.define("Voyant.panel.Phrases",{extend:"Ext.grid.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.phrases",config:{corpus:void 0},statics:{i18n:{title:{en:"Phrases"},emptyText:{en:"No matching results."},helpTip:{en:"\x3cp\x3eCorpus Phrases is a table view of repeating phrases in the entire corpus.\x3c!-- Features include:\x3c/p\x3e\x3cul\x3e\x3cli\x3ereordering by keyword, collocate word, collocate word count\x3c/li\x3e\x3cli\x3ea search box for queries (hover over the magnifying icon for help with the syntax)\x3c/li\x3e\x3c/ul\x3e--\x3e"},
...
renderer:Ext.util.Format.numberRenderer("0,000"),sortable:!0,width:"autoSize"},{text:this.localize("typesCountLexical"),dataIndex:"typesCount-lexical",renderer:Ext.util.Format.numberRenderer("0,000"),width:"autoSize"},{text:this.localize("typeTokenRatioLexical"),dataIndex:"typeTokenRatio-lexical",renderer:function(a){return Ext.util.Format.percent(a)},width:"autoSize"},{text:this.localize("language"),dataIndex:"language",hidden:!0,renderer:function(a,b,c,g,h,k,m){return m.ownerCt.getLanguage(a)},
...
glyph:"xf065@FontAwesome",items:"cirrus corpusterms corpuscollocates phrases documents summary trends scatterplot termsradio".split(" ")},{i18n:"moreToolsScaleDocument",glyph:"xf066@FontAwesome",items:["cirrus","contexts","documentterms","reader","trends"]},{i18n:"moreToolsTypeViz",glyph:"xf06e@FontAwesome",items:["cirrus","collocatesgraph","trends","scatterplot","termsradio"]},{i18n:"moreToolsTypeGrid",glyph:"xf0ce@FontAwesome",items:"corpusterms corpuscollocates phrases contexts documentterms documents".split(" ")},
