...
Math.sqrt(this.canvas.width*this.canvas.width+this.canvas.height*this.canvas.height);this.cacheCurrentDocument();this.determineGraphSizeAndPosition()},cacheCurrentDocument:function(){var a=this.MAX_LINE_LENGTH;this.currentDoc.lineLength=a;if(this.audio&&null==this.audioCtx)try{this.audioCtx=new (window.AudioContext||window.webkitAudioContext)}catch(b){}for(var c in this.currentDoc.terms){if(this.audio&&this.audioCtx&&!this.currentDoc.terms[c].audio){var d=this.audioCtx.createOscillator(),e=this.audioCtx.createGain();
d.connect(e);e.connect(this.audioCtx.destination);d.frequency.value=500*Math.random()+150;d.start();e.gain.value=0;this.currentDoc.terms[c].audio={oscillator:d,gainNode:e}}this.cacheTurns(this.currentDoc.terms[c],a)}},cacheTurns:function(a,b){if(0<a.rawFreq){for(var c=this.currentDoc,d=a.term,e=[],f=a.positions,g=f[f.length-1],h=this.startAngle,k=this.angleIncrement,l=0,m=0,n=0,q=0,r=l=0;r<f.length;r++){var p=f[r],u=p/g*b,v=u-l,l=n,m=q,q=this.findEndPoint([n,q],v,h),n=q[0],q=q[1],l=this.getPolygonFromLine([l,
m],[n,q],h,this.LINE_SIZE);e.push({tokenId:p,polygon:l,over:!1});l=u;h+=k}c.terms[d].pos=e;c.terms[d].done=!1}},findEndPoint:function(a,b,c){var d=this.degreesToRadians(c);c=a[0]+b*Math.cos(d);a=a[1]+b*Math.sin(d);return[c,a]},determineGraphSizeAndPosition:function(){var a=this.findBoundingBoxForGraph(),b=a.maxX-a.minX,c=a.maxY-a.minY,d=Math.min(this.canvas.width/b,this.canvas.height/c),d=d-.05,c=c*d;this.offset.x=Math.abs(a.minX*d-(this.canvas.width/2-b*d/2));this.offset.y=Math.abs(a.minY*d-(this.canvas.height/
2-c/2));this.MAX_LINE_LENGTH=Math.sqrt(this.canvas.width*this.canvas.width+this.canvas.height*this.canvas.height)*d;this.cacheCurrentDocument()},findBoundingBoxForGraph:function(){var a=null,b=null,c=null,d=null,e;for(e in this.currentDoc.terms)for(var f=this.currentDoc.terms[e].pos,g=0;g<f.length;g++){var h=f[g].polygon,h=this.getBoundingBox(h[0],h[1]);if(null==a||h[0]<a)a=h[0];if(null==b||h[2]>b)b=h[2];if(null==c||h[1]<c)c=h[1];if(null==d||h[3]>d)d=h[3]}return{minX:a,minY:c,maxX:b,maxY:d}},getBoundingBox:function(a,
b){var c=Math.min(a[0],a[2]),d=Math.max(a[0],a[2]),e=Math.min(b[0],b[2]),f=Math.max(b[0],b[2]);return[c,e,d,f]},degreesToRadians:function(a){return Math.PI/180*a},clickHandler:function(a){var b=a.layerX-this.offset.x;a=a.layerY-this.offset.y;var c=null,d=0,e;for(e in this.currentDoc.terms)if(-1!=this.termsFilter.indexOf(e))for(var f=this.currentDoc.terms[e].pos,g=0;g<f.length;g++){var h=f[g].polygon;if(this.isPointInPolygon(h[0],h[1],b,a)){c=e;d=f[g].tokenId;break}}c&&void 0!==this.externalClickHandler&&
this.externalClickHandler({term:c,tokenId:d})},moveHandler:function(a){var b=a.layerX-this.offset.x,c=a.layerY-this.offset.y;if(null!=this.dragInfo)document.body.style.cursor="move",this.dragInfo.lastX=this.dragInfo.x,this.dragInfo.lastY=this.dragInfo.y,this.dragInfo.x=a.layerX,this.dragInfo.y=a.layerY,b=this.dragInfo.y-this.dragInfo.lastY,this.offset.x+=this.dragInfo.x-this.dragInfo.lastX,this.offset.y+=b;else{this.mouseOver=!1;for(var d in this.currentDoc.terms)if(-1!=this.termsFilter.indexOf(d)){a=
this.currentDoc.terms[d].pos;for(var e=0;e<a.length;e++)if(this.mouseOver)this.currentDoc.terms[d].pos[e].over=!1;else{var f=a[e].polygon;this.isPointInPolygon(f[0],f[1],b,c)?this.mouseOver=this.currentDoc.terms[d].pos[e].over=!0:this.currentDoc.terms[d].pos[e].over=!1}}if(this.mouseOver){if(document.body.style.cursor="pointer",!this.progressiveDraw||this.progressiveDraw&&this.progDrawDone)clearInterval(this.intervalId),this.intervalId=setInterval(this.doDraw.createDelegate(this,[!1]),50)}else if(document.body.style.cursor=
...
0;var k=this.MIXED=1;this.getWordOrientation=function(){return k};this.setWordOrientation=function(a){k=a};this.UPDATE_RATE=25;this.COARSENESS=5;this.grid=[];var l=0,m;this.doingArrange=!1;this.wordsToArrange=5;var n=null,q=0,r=0,p=[];this.getWords=function(){return p};this.setWords=function(a){p=a};this.sizeAdjustment=100;this.minFontSize=12;this.largestWordSize=0;this.smallestWordSize=1E4;var u={};this.addWords=function(a){for(var b=!1,e=0;e<a.length;e++){var h=a[e],k;k=void 0==typeof h.color||
null==h.color||""==h.color?g.colors[Math.floor(Math.random()*g.colors.length)]:h.color;var l;l=void 0==typeof h.size||null==h.size||""==h.size?Math.floor(40*Math.random()):parseFloat(h.size);var m=h.word,n=h.label,q=h.value,h=!1;null==u[m]&&(u[m]=!0,l>f.largestWordSize&&(f.largestWordSize=l,h=!0),l<f.smallestWordSize&&(f.smallestWordSize=.8*l,h=!0),m=new Word(m,l,k,n,q),p.push(m));b=h||b}c();this.setRelativeSizes();this.calculateSizeAdjustment();b?this.resizeWords():d()};this.resetWordCoordinates=
...
0;g<=c;g+=this.COARSENESS)if(e[f]&&e[f][g]&&null!=this.grid[f+a]&&null!=this.grid[f+a][g+b])return!0;return!1},f;this.grid=[];l=0;f=function(){var a,f,h,k,n=this.wordsToArrange-1,u=g.canvas.width,q=g.canvas.height,v=.5*u,r=.5*q;do{h=p[l];if(void 0!==h){for(var B=Math.random()*Math.PI,w=.25*Math.random()*h.size,D=.5*(Math.random()-.5),M=.5*h.width,N=.5*h.height;;){a=Math.floor((v+Math.cos(B)*w*this.ratio-M)/this.COARSENESS)*this.COARSENESS;f=Math.floor((r+Math.sin(B)*w-N)/this.COARSENESS)*this.COARSENESS;
k=a+M>=u||f+N>=q?!0:d(a,f,h.height,h.width,h.mask);if(!k)break;B+=D;w+=.05}c(a,f,h);if(g.useFadeEffect)for(a=h.alpha=0;a<l;a++)f=p[a],1>f.alpha&&b(f);else h.alpha=1,h.draw(g.context)}l++;if(l>=p.length){clearTimeout(m);this.doingArrange=!1;this.toggleLoadingText(!1);e();break}}while(n--)}.createDelegate(this);d=d.createDelegate(this);c=c.createDelegate(this);b=b.createDelegate(this);a=a.createDelegate(this);this.doingArrange=!0;m=setInterval(f,50)}else alert("Error: There are no words to arrange.")};
...
a});d.info.continuations=d.children.length;f=d3.max(d.children.map(function(a){return a.maxChildren}));d.maxChildren=Math.max(d.children.length,f)}}function b(a,b){if(!a||!b)return!1;for(var c in a)if(!(c in b))return!1;return!0}function c(a,b){for(var c in b)a[c]=b[c]}function d(){}doubletree.DoubleTree=function(){function b(a){a.each(function(a,b){f.push(this.node())})}var f=[],g=600,h=400,k=!1,l={left:[],right:[]},m={alt:d,shift:d,click:d},n=!0,q=!0,r=doubletree.sortByStrFld("token"),p=doubletree.tokenText,
u=function(a){return doubletree.fieldText(a,"POS")},v=function(a){return"rgba(255,255,255,1)"},s=function(a){return"rgba(255,255,255,1)"},G=function(a){return"red"},L={node:{fill:"white",stroke:"steelblue","stroke-width":"1.5px"},branch:{stroke:"#aaa","stroke-width":"1.5px"}},B=!1,E=d3.dispatch("idsUpdated");E.on("idsUpdated",function(){this==C?(A.setIds(C.continuationIDs),A.updateContinuations()):this==A&&(C.setIds(A.continuationIDs),C.updateContinuations())});var z,H,C,A,K,I;b.init=function(a){d3.select(d3.selectAll(a)).call(this);
return b};b.redraw=function(){void 0!==z&&void 0!==H&&b.setupFromTries(z,H);return b};b.setupFromTries=function(d,k){z=d.getUniqRoot();H=k.getUniqRoot();var x=z.toTree(l.left),w=H.toTree(l.right),D=!0;0<Object.keys(w.pruned).length&&(a(w,w.pruned,D),a(x,w.pruned,D),D=!1);0<Object.keys(x.pruned).length&&(a(x,x.pruned,D),a(w,x.pruned,D));var D={},M;for(M in w.info)"continuations"!=M&&"ids"!=M&&"count"!=M&&(D[M]=w.info[M]);D["right continuations"]=w.info.continuations;D["left continuations"]=x.info.continuations;
D.ids={};c(D.ids,w.info.ids);c(D.ids,x.info.ids);D.count=Object.keys(D.ids).length;K=Object.keys(D.ids);if(w.info.origIDs||x.info.origIDs)D.origIDs={},c(D.origIDs,w.info.origIDs),c(D.origIDs,x.info.origIDs),D.origCount=Object.keys(D.origIDs).length;w.info=D;x.info=D;M=Math.max(x.maxChildren,w.maxChildren);if(isNaN(M)||0==M)return B=!1,b;q?I=d3.scaleLog().range([8,14]):(I=function(){return 14},I.domain=function(){});M=Math.min(x.minCount,w.minCount);I.domain([M,x.info.count]);var N=g-20-20,O=h-20-
20;f.forEach(function(a,b){var c;c=d3.select(a).select("svg");null==c.node()?(c=d3.select(a).append("svg").attr("width",N+20+20).attr("height",O+20+20).attr("cursor","move").call(d3.zoom().scaleExtent([1,1]).on("zoom",function(){var b=d3.event.transform.x+N/2,c=d3.event.transform.y+O/2;d3.select(a).select("svg \x3e g").attr("transform","translate("+b+","+c+")")})),c.append("g").attr("transform","translate("+N/2+","+O/2+")")):(c.attr("width",N+20+20).attr("height",O+20+20),c.selectAll("g *").remove());
C=new doubletree.Tree(c.select("g"),g,h,x,!0,r,E,I,n,p,u,v,s,G,L);A=new doubletree.Tree(c.select("g"),g,h,w,!1,r,E,I,n,p,u,v,s,G,L)});C.handleAltPress=m.alt;A.handleAltPress=m.alt;C.handleShiftPress=m.shift;A.handleShiftPress=m.shift;C.handleClick=m.click;A.handleClick=m.click;B=!0;return b};b.setupFromArrays=function(a,c,d,f,g,h,l,m){void 0==g&&z&&(g=z.caseSensitive());void 0==h&&z&&(h=z.fieldNames());void 0==l&&z&&(l=z.fieldDelim());void 0==m&&z&&(m=z.distinguishingFieldsArray());z=new doubletree.Trie(g,
h,l,m);H=new doubletree.Trie(g,h,l,m);g=c.length;for(h=0;h<g;h++){l=f?f[h]:h;m=c[h];var n=a[h].slice(),p=d[h].slice();n.push(m);n.reverse();p.unshift(m);k?(H.addNgram(n,l),z.addNgram(p,l)):(z.addNgram(n,l),H.addNgram(p,l))}b.setupFromTries(z,H);return b};b.filteredIDs=function(){return K};b.search=function(a){C.search(a);A.search(a);a=d3.select(f[0]);var b=a.selectAll("text.foundText");if(b.empty())return 0;b=b[0].length;null!=a.selectAll("text.rtNdText.foundText").node()&&b--;return b};b.clearSearch=
function(){C.clearSearch();A.clearSearch();return b};b.updateTokenExtras=function(){C.showTokenExtras(n);A.showTokenExtras(n);var a=d3.select(f[0]).select('.tokenExtra[display\x3d"inline"]');a.empty()||"0px"==a.style("height")&&b.redraw();return b};b.visWidth=function(a){if(!arguments.length)return g;g=a;return b};b.visHeight=function(a){if(!arguments.length)return h;h=a;return b};b.prefixesOnRight=function(a){if(!arguments.length)return k;k=a;return b};b.filters=function(a){if(!arguments.length)return l;
l=a;return b};b.handlers=function(a){if(!arguments.length)return m;m=a;return b};b.showTokenExtra=function(a){if(!arguments.length)return n;n=a;return b};b.scaleLabels=function(a){if(!arguments.length)return q;q=a;return b};b.succeeded=function(){return B};b.sortFun=function(a){if(!arguments.length)return r;r=a;return b};b.nodeText=function(a){if(!arguments.length)return p;p=a;return b};b.tokenExtraText=function(a){if(!arguments.length)return u;u=a;return b};b.rectColor=function(a){if(!arguments.length)return v;
v=a;return b};b.rectBorderColor=function(a){if(!arguments.length)return s;s=a;return b};b.continuationColor=function(a){if(!arguments.length)return G;G=a;return b};b.basicStyles=function(a){if(!arguments.length)return L;Object.keys(L).forEach(function(b){b in a&&Object.keys(L[b]).forEach(function(c){c in a[b]&&(L[b][c]=a[b][c])})});return b};return b};doubletree.Tree=function(a,b,c,d,k,l,m,n,q,r,p,u,v,s,G){function L(a){a.children&&(a._children=a.children,a._children.forEach(L),a.children=null)}function B(a){a.parent&&
a.parent.children.forEach(function(b){b!=a&&L(b)})}function E(a,b){d3.event.altKey?x.handleAltPress(a,b):d3.event.shiftKey?x.handleShiftPress(a,b):(x.handleClick(a,b),a.parent&&(x.continuationIDs!=a.data.info.ids&&(x.setIds(a.data.info.ids),x.clickedNode=a.id,m.call("idsUpdated",x)),B(a),z(a,!0)))}function z(a,b){a.children?(a.children&&1==a.children.length&&z(a.children[0],!0),a._children=a.children,a.children=null):(a.children=a._children,a._children=null,a.children&&1==a.children.length&&z(a.children[0],
!1));b&&x.update(a)}function H(a){return k?-a:a}var C=q,A=u;b=b-20-20;c=c-20-20;var K=0,I;l||(l=doubletree.sortByStrFld("token"));var K=0,J=d3.tree().size([c,b]).nodeSize([40,40]),F=d3.linkHorizontal().x(function(a){return H(a.y)}).y(function(a){return a.x});a=a.append("g").attr("transform","translate(20,20)");this.readJSONTree=function(a){I=d3.hierarchy(a);I.x0=0;I.y0=0;I.children.forEach(L);this.update(I)};this.update=function(b){var c=J(I).descendants();c.forEach(function(a){var b=a.textSize;if(void 0==
b){for(var b=0,c=a.parent;null!=c;)var d=Ext.draw.TextMeasurer.measureText(c.data.name,"arial").width,b=b+d,c=c.parent;a.textSize=b}a.y=25*a.depth+b});var d=a.selectAll("g.node_"+k).data(c,function(a){return a.id||(a.id=++K)}),f=d.enter().append("g").attr("class","node node_"+k).attr("cursor","pointer").attr("transform",function(a){return"translate("+H(b.y0)+","+b.x0+")"}).on("click",E);f.append("title").text(function(a){return doubletree.infoToText(a.data.info)});f.append("circle").attr("r",1E-6).style("fill",
function(a){return a._children?"#fff":G.node.fill}).style("stroke",function(a){return G.node.stroke});var g=f.append("text").attr("class",function(a){return 0==a.depth?"rtNdText":""}).attr("x",function(a){return a.children||a._children?0:k?10:-10}).attr("text-anchor",function(a){return a.parent?a.children||a._children?k?"end":"start":k?"start":"end":"middle"}).style("font-size",function(a){return n(a.data.info.count)+"pt"});g.append("tspan").attr("dy",".35em").attr("class","tokenText").text(function(a){return r(a.data.info,
1>a.depth)}).style("fill-opacity",1E-6);g.append("tspan").attr("dx",".35em").attr("class","tokenExtra").text(function(a){return p(a.data.info,1>a.depth)}).style("fill-opacity",1E-6);this.drawRects();f=f.merge(d);f.transition().duration(200).attr("transform",function(a){return"translate("+H(a.y)+","+a.x+")"});f.select("circle").attr("r",function(a){return a.children||a._children?1E-6:4.5}).style("fill",function(a){return a._children?"#fff":G.node.fill}).style("stroke-width",G.node["stroke-width"]);
f.selectAll("tspan").style("fill-opacity",1);d=d.exit().transition().duration(200).attr("transform",function(a){return"translate("+H(b.y)+","+b.x+")"}).remove();d.select("circle").attr("r",1E-6);d.selectAll("tspan").style("fill-opacity",1E-6);d=a.selectAll("path.link_"+k).data(I.links(),function(a){return a.source.id+"-"+a.target.id});d.enter().insert("path","g").attr("class","link link_"+k).attr("d",function(a){a={x:b.x0,y:b.y0};return F({source:a,target:a})}).style("fill","none").style("stroke",
G.branch.stroke).style("stroke-width",G.branch["stroke-width"]).merge(d).transition().duration(200).attr("d",F);d.exit().transition().duration(200).attr("d",function(a){a={x:b.x0,y:b.y0};return F({source:a,target:a})}).remove();c.forEach(function(a){a.x0=a.x;a.y0=a.y});this.updateContinuations()};this.drawRects=function(){var b=C?"inline":"none";a.selectAll(".tokenExtra").attr("display",b);b=a.selectAll("g.node_"+k);b.selectAll("rect").remove();b.insert("rect","text").attr("class","nodeRect").attr("height",
function(){var a=this.parentElement.getBBox().height;6>a&&(a=6.1);return a-6}).attr("y",function(a){return a.parent?-.5*this.parentElement.getBBox().height/2:-.5*this.parentElement.getBBox().height/2-2}).attr("width",function(){return this.parentElement.getBBox().width}).attr("x",function(a){var b=this.parentElement.getBBox().width;return a.parent?k?-.5*b:0:-.33333*b}).style("stroke-opacity",1).style("stroke-width",1).style("stroke",function(a){return v(a.data.info)}).style("fill",function(a){return A(a.data.info)}).style("fill-opacity",
function(a){return 1})};var x=this;this.setIds=function(a){x.continuationIDs=a};this.updateContinuations=function(){a.selectAll("g.node_"+k+" text").classed("continuation",function(a){var b;a:{a=a.data.info.ids;var c=x.continuationIDs||{};for(b in a)if(b in c){b=!0;break a}b=!1}return b}).style("fill",function(a){return d3.select(this).classed("continuation")?s(a.data.info):"#444"})};this.search=function(b){a.selectAll("g.node text").classed("foundText",function(a){return b.test(r(a.data.info))})};
this.clearSearch=function(){a.selectAll("g.node text").classed("foundText",!1)};this.showTokenExtras=function(a){if(0==arguments.length)return C;C=a;this.drawRects();return this};this.setRectColor=function(a){if(0==arguments.length)return A;A=a;this.drawRects();return this};this.handleAltPress=function(){};this.handleShifttPress=function(){};this.handleClick=function(){};this.readJSONTree(d);return this};doubletree.sortByStrFld=function(a){return function(b,c){var d=void 0==b.data.info[a],k=void 0==
c.data.info[a];if(d&&k)return 0;if(d)return-1;if(k)return 1;d=b.data.info[a].join(" ").toLowerCase();k=c.data.info[a].join(" ").toLowerCase();return d<k?-1:d>k?1:0}};doubletree.sortByCount=function(){return function(a,b){return b.data.info.count-a.data.info.count}};doubletree.sortByContinuations=function(){return function(a,b){return b.data.info.continuations-a.data.info.continuations}};doubletree.filterByMinCount=function(a){return function(b){return b.count>=a}};doubletree.filterByMaxCount=function(a){return function(b){return b.count<=
...
(function(){doubletree.Trie=function(a,b,c,d,e){function f(a,b,c){this.id=b;this.count=c;this.info={count:c,ids:{}};if(null==a)this.item=k;else{this.item=a;this.info.ids={};this.info.ids[b]=!0;a=a.split(n);for(var d in a)this.info[m[d]]=[a[d]]}this.nodes={};this.addNgram=function(a,b,c){c||(c=1);var d,e;if(0<a.length){d=a.shift();var g=d.split(n);e=r&&this.item==k?"":g.filter(function(a,b){return-1<q.indexOf(m[b])}).map(function(a){return l?a.toLocaleLowerCase():a}).join(n)}else e=d=h;var p;if(e in
this.nodes&&this.nodes[e]instanceof f){p=this.nodes[e];p.info.count+=c;p.info.ids[b]=!0;for(var u in g)e=g[u],-1==p.info[m[u]].indexOf(e)&&p.info[m[u]].push(e)}else p=new f(d,b,c),this.nodes[e]=p;d!=h&&p.addNgram(a,b,c)};this.getUniqRoot=function(){if(this.item==k){var a=Object.keys(this.nodes);if(1==a.length)return this.nodes[a[0]]}return this};this.toTree=function(a){function b(a,c,d){var e={children:[]};e.name=d.item;e.info={};for(var f in d.info)if("Object"===typeof d.info[f]){e.info[f]={};for(var h in d.info[f])e.info[f][h]=
...
e.maxLen=Math.max(a,e.name.length),e.minCount=d3.min(e.children.map(function(a){return a.minCount})));return e}a||(a=[]);var c=JSON.parse(JSON.stringify(this));return b(a,0,c)}}function g(a,b){for(var c in b)a[c]=b[c]}var h=" ",k="_root_",l=!a&&!0;b||(b=["item"]);var m=b;n||(n="\t");var n=c;q||(q=[m[0]]);var q=d,r=e;void 0==r&&(r=!0);var p=new f(k,-1,0);this.addNgram=function(a,b,c){p.addNgram(a,b,c)};this.getUniqRoot=function(){var a=new doubletree.Trie(!l,m,n,q);a.trie(p.getUniqRoot());return a};
this.toTree=function(a,b){return p.toTree(a,b)};this.serialize=function(){return JSON.stringify(this)};this.deserialize=function(a){a=JSON.parse(a);h=a.endNG();k=a.rootName();l=a.caseSensitive();m=a.fieldNames();n=a.fieldDelim();q=a.distinguishingFieldsArray();p=a.trie()};this.endNG=function(){return h};this.rootName=function(){return k};this.trie=function(a){0<arguments.length&&(p=a);return p};this.caseSensitive=function(){return!l};this.fieldNames=function(){return m};this.fieldDelim=function(){return n};
this.distinguishingFieldsArray=function(){return q}}})();function TermsRadio(a){this.parent=a.parent;this.container=a.container;this.isSliderVisible=void 0==a.showSlider?!0:a.showSlider;this.chart=null;this.absMinFreq=this.absMaxFreq=0;this.allData=[];this.continueTransition=!0;this.counterSeries=[];this.displayData=[];this.isTransitioning=this.dragged=!1;this.lastSticky=this.lastSlippery=null;this.maxFont=30;this.numDataPoints=this.minFreq=0;this.numVisPoints=5;this.overlayQueue=[];this.recordsLength=this.records=0;this.reselectTop=!1;this.sliderDragSum=
...
TermsRadio.prototype={constructor:TermsRadio,loadRecords:function(a){this.initData(a);this.prepareData();for(a=this.shiftCount;0<a--;)this.displayData.shift();null!=this.chart?this.redraw():this.initializeChart()},highlightQuery:function(a,b){var c=null;"document"===this.parent.getApiParam("mode")&&(c=this.parent.getCorpus().getDocument(0).getId());c=this.buildParamsBundle({wordString:a,docId:c});b?this.manageOverlaySticky(c):this.manageOverlaySlippery(c)},highlightRecord:function(a,b){var c={wordString:a.get("term"),
docId:a.get("docId")},c=this.buildParamsBundle(c);b?this.manageOverlaySticky(c):this.manageOverlaySlippery(c)},initData:function(a){this.records=a;this.recordsLength=this.records.length;this.numVisPoints=parseInt(this.parent.getApiParam("visibleBins"));this.shiftCount=parseInt(this.parent.getApiParam("position"));"document"===this.parent.getApiParam("mode")?(this.numDataPoints=this.records[0].get("distributions").length,a=parseInt(this.parent.getApiParam("bins")),this.numDataPoints!==a&&(this.numDataPoints=
...
(this.numVisPoints=this.numDataPoints);this.shiftCount+this.numVisPoints>this.numDataPoints&&(this.shiftCount=this.numDataPoints-this.numVisPoints);for(var e=0;e<this.numDataPoints;e++){for(var f=0,g=0;g<this.counterSeries[e].length;g++){var h=0;0===f&&(b.push(this.counterSeries[e][g]),c.push({freq:this.counterSeries[e][g].freq,frequencyArray:b,numInSeries:0}),a.push(c),b=[],c=[],h=f=1);for(var k=0;k<a[e].length&&0===h;k++)this.counterSeries[e][g].freq===a[e][k].freq&&(h=0,h=a[e][k].numInSeries,this.counterSeries[e][g].posInSeries=
...
"1");this.chart.append("line").attr("class","slider").attr("id","after").attr("x1",a*(this.shiftCount-this.callOffset())/(this.numDataPoints-1)+c).attr("x2",a*(this.shiftCount-this.callOffset())/(this.numDataPoints-1)+c).attr("y1",this.tPadding+this.sliderHeight).attr("y2",this.tPadding).style("stroke","black").style("stroke-width","1");var b=this.chart.append("rect").attr("class","slider").attr("id","boxBefore").attr("x",this.lPadding).attr("y",this.tPadding).attr("height",this.sliderHeight).attr("width",
...
function(b){return a.xScale(b.counter+(.5/b.numInSeries-.5)+b.posInSeries/b.numInSeries*.8)}).attr("transform",function(b){var c=b.freq;return"translate(0, 0) rotate(-20 "+a.xScale(b.counter+(.5/b.numInSeries-.5)+b.posInSeries/b.numInSeries*.8)+" "+a.yScale(c)+")"});var b=b-(this.rPadding+this.lPadding),d=this.lPadding,e=this.lPadding+(this.numVisPoints-1)/(this.numDataPoints-1)*b;this.chart.select("#before").transition().duration(c).ease(d3.easeLinear).attr("x1",b*this.shiftCount/(this.numDataPoints-
...
this.shiftCount)/(this.numDataPoints-1))}this.redrawChartOverlay()},callTransition:function(){"left"===this.transitionCall&&this.toggleLeftCheck();"right"===this.transitionCall&&this.toggleRightCheck()},buildParamsBundle:function(a){var b=a.wordString,c={},d={};"document"===this.parent.getApiParam("mode")&&(a=a.docId,d=this.parent.getCorpus().getDocument(a).get("totalTokens")-1,c.tokenIdStart=parseInt(this.category*d/this.numDataPoints),c.docIdType=a+":"+b);return d={params:c,type:b}},manageOverlaySlippery:function(a){for(var b=
...
this.getTermIndex(a)},doTermSelect:function(a,b){var c=c=this.removeFilteredCharacters(a),d=this.parent.getApiParam("selectedWords");d.push(a);this.parent.setApiParams({selectedWords:d});d=this.parent.getApplication().getColorForTerm(a,!0);if(!0===b){var e=this.parent.query("[xtype\x3dlegend]")[0];e.getStore().add({name:a,mark:d})}else{var e=this.parent.query("[xtype\x3dlegend]")[0],f=e.getStore().findRecord("name",a);null!==f&&(f.set("mark",d),e.refresh())}e=this.prepareFullPath(a);d={word:a,selector:c,
params:{params:{},type:a},fullPath:e.path,pathMin:e.min,pathMax:e.max,colour:d};c===this.lastSlippery&&(this.isSliderVisible&&this.sliderOverlayOff(c),this.lastSlippery=null);this.chart.select("g[class\x3dfrequency-line-"+c.replace(/'/g,"\\'")+"]").remove();this.overlayQueue.push(d);this.chartOverlayOn(d);this.isSliderVisible&&this.sliderOverlayOn(d)},doTermDeselect:function(a,b){var c=this.removeFilteredCharacters(a),d=this.getTermIndex(a);if(!0===b){var e=this.parent.query("[xtype\x3dlegend]")[0],
d=e.getStore().findExact("name",a);e.getStore().removeAt(d)}for(var e=this.parent.getApiParam("selectedWords"),f=0,g=e.length;f<g;f++)e[f]===c&&(e.splice(f,1),this.parent.setApiParams({selectedWords:e}));this.chartOverlayOff(c);this.overlayQueue.splice(d,1);this.isSliderVisible&&this.sliderOverlayOff(c);this.lastSticky=c},prepareFullPath:function(a){for(var b=[],c=this.absMaxFreq,d=this.absMinFreq,e=0,f=this.allData.length;e<f;e++){for(var g=foundB=0,h=this.allData[e].allDataInternal.length;g<h;g++)for(var k=
0,l=this.allData[e].allDataInternal[g].frequencyArray.length;k<l;k++)if(this.allData[e].allDataInternal[g].frequencyArray[k].wordString===a){var m=this.allData[e].allDataInternal[g].frequencyArray[k].freq;b.push({x:e,y:m});m<c&&(c=m);m>d&&(d=m);foundB=1}0===foundB&&(g=this.minFreq,b.push({x:e,y:g}),g<c&&(c=g),g>d&&(d=g))}return{path:b,min:c,max:d}},updateFullPath:function(){for(var a=this.overlayQueue.length;0<a--;){var b=this.prepareFullPath(this.overlayQueue[a].word);this.overlayQueue[a].fullPath=
b.path;this.overlayQueue[a].pathMin=b.min;this.overlayQueue[a].pathMax=b.max}},buildSliderPath:function(a){var b=this;return d3.line().x(function(a){return b.xSliderScale(a.x)}).y(function(a){return b.ySliderScale(a.y)}).curve(d3.curveNatural)(a)},sliderOverlayOn:function(a){this.transitionSliderOverlay(a);this.chart.append("g").attr("class","slider").attr("id","slider-line-"+a.word).append("path").attr("d",this.buildSliderPath(a.fullPath)).style("stroke",a.colour).style("stroke-width",2).style("fill",
"none");this.redrawSlider()},sliderOverlayOff:function(a){this.chart.selectAll("g[id\x3dslider-line-"+a.replace(/'/g,"\\'")+"]").remove();this.transitionSliderOverlay()},redrawSliderOverlay:function(){for(var a=0;a<this.overlayQueue.length;a++)this.sliderOverlayOff(this.overlayQueue[a].selector),this.sliderOverlayOn(this.overlayQueue[a])},transitionSliderOverlay:function(a){this.updateYSliderScale(a||0);for(a=this.overlayQueue.length;0<a--;)this.chart.selectAll("g#slider-line-"+this.overlayQueue[a].selector.replace(/'/g,
...
l*m.length+"x15\x26amp;chd\x3dt:"+m.join(",")+"' alt\x3d'' class\x3d'chart-");1==d?h+="full":0<f&&f+1<d?h+"middle":h=0==f?h+"left":h+"right";h+="' /\x3e"}return h}});Ext.define("Voyant.util.Toolable",{requires:["Voyant.util.Localization","Voyant.util.Api"],statics:{i18n:{exportGridAllJson:"export all available data in JSON",exportAllTitle:"Export All",exportAllJsonWarning:"You're requesting all of the available data (in a JSON format that Voyant uses), are you sure you want to continue?",exportGridAllTsv:"export all available data as tab separated values (text)",exportAllTsvWarning:"You're requesting all of the available data, are you sure you want to continue?",
scaleLabel:"scaling ({0})",loading:"Loading\u2026"},api:{suppressTools:!1}},constructor:function(a){a=a||{};if(!(this.getApiParam&&"true"==this.getApiParam("suppressTools")||"header"in a&&!1===a.header)){var b=void 0,c=this.up("component");a.moreTools?(b=[],a.moreTools.forEach(function(a){a&&a!=this.xtype&&b.push(this.getMenuItemFromXtype(a))},this)):c&&c.getInitialConfig("moreTools")&&(b=[],c.getInitialConfig("moreTools").forEach(function(a){a&&a!=this.xtype&&b.push(this.getMenuItemFromXtype(a))},
this));b&&this.getApplication().getMoreTools&&b.push({xtype:"menuseparator"});if(this.getApplication().getMoreTools){var b=b||[],d=this.getApplication(),c=d.getMoreTools();c.forEach(function(a){var c=[];a.items.forEach(function(a){c.push(this.getMenuItemFromXtype(a))},this);b.push({text:d.localize(a.i18n),glyph:a.glyph,menu:{items:c}})},this)}var e={save:{glyph:"xf08e@FontAwesome",fn:this.exportToolClick,items:void 0},plus:b?{glyph:"xf17a@FontAwesome",items:b}:void 0,gear:this.showOptionsClick||this.getOptions?
{glyph:"xf205@FontAwesome",fn:this.showOptionsClick?this.showOptionsClick:function(a){a.isXType("voyanttabpanel")&&(a=a.getActiveTab());Ext.create("Ext.window.Window",{title:a.localize("optionsTitle"),modal:!0,panel:a,items:{xtype:"form",items:a.getOptions(),listeners:{afterrender:function(b){var c=a.getApiParams(b.getForm().getFields().collect("name"));b.getForm().setValues(c)}},buttons:[{text:a.localize("reset"),glyph:"xf0e2@FontAwesome",flex:1,panel:a,ui:"default-toolbar",handler:function(a){this.mixins&&
this.mixins["Voyant.util.Api"]&&(this.mixins["Voyant.util.Api"].constructor.apply(this),this.getCorpus&&this.getCorpus()&&this.fireEvent("loadedCorpus",this,this.getCorpus()));a.up("window").close()},scope:a},{xtype:"tbfill"},{text:a.localize("cancelTitle"),ui:"default-toolbar",glyph:"xf00d@FontAwesome",flex:1,handler:function(a){a.up("window").close()}},{text:a.localize("confirmTitle"),glyph:"xf00c@FontAwesome",flex:1,panel:a,handler:function(a){function b(a,c){d.setApiParam&&d.setApiParam(a,c);
for(var e=d.getViewport().query("panel,chart"),g=0;g<e.length;g++)e[g].setApiParam&&e[g].setApiParam(a,c);f=!0}var c=a.up("form").getValues();this.setApiParams(c);var d=this.getApplication(),e=d.getCorpus(),f=!1;void 0!=c.stopList&&void 0!=c.stopListGlobal&&c.stopListGlobal&&b("stopList",c.stopList);void 0!=c.palette&&b("palette",c.palette);f&&(e?d.dispatchEvent("loadedCorpus",this,e):d.dispatchEvent("apiParamsUpdated",this,c));e?this.fireEvent("loadedCorpus",this,e):this.fireEvent("apiParamsUpdated",
this,c);a.up("window").close()},scope:a}]},bodyPadding:5}).show()}}:void 0,help:{glyph:"xf128@FontAwesome",fn:this.helpToolClick}},c=[];if(a.includeTools)for(var f in a.includeTools)"object"==typeof a.includeTools[f]&&c.push(a.includeTools[f]);for(f in e)a.includeTools&&!a.includeTools[f]||!e[f]||c.push({type:f,tooltip:this.localize(f+"Tip"),callback:e[f].fn,xtype:"toolmenu",glyph:e[f].glyph,items:e[f].items});Ext.apply(this,{tools:c});this.on("afterrender",function(){var a=this.getHeader();if(a&&
"Desktop"==Ext.os.deviceType&&!this.isXType("corpuscreator")&&!this.isXType("notebook")){var b=a.getEl();b.on("mouseover",function(){this.getHeader().getTools().forEach(function(a){a.show()})},this);b.on("mouseout",function(){this.getHeader().getTools().forEach(function(a){var b=a.config.type||a.type;b&&"help"!=b&&-1==b.indexOf("collapse")&&a.hide()})},this);a.getTools().forEach(function(a,b){"help"!=a.config.type&&a.hide()})}},this)}},getMenuItemFromXtype:function(a){var b=this.getApplication().getToolConfigFromToolXtype(a);
b&&b.tooltip&&delete b.tooltip;return Ext.apply(Ext.clone(b),{xtype:"menuitem",text:b.title,textAlign:"left",handler:function(){this.replacePanel(b.xtype)},scope:this})},maximizeToolClick:function(a){var b=Ext.getClass(a).getName().split(".");url=a.getBaseUrl()+"tool/"+b[b.length-1]+"/";params=a.getModifiedApiParams();!params.corpus&&a.getCorpus&&a.getCorpus()&&(params.corpus=a.getCorpus().getId());params&&(url+="?"+Ext.Object.toQueryString(params));a.openUrl(url)},exportToolClick:function(a){a.isXType("voyanttabpanel")&&
(a=a.getActiveTab());var b="beta.voyant-tools.org"==window.location.hostname?[{html:"\x3cp class\x3d'keyword' style\x3d'text-align: center; font-weight: bold; padding: 4px;'\x3ePlease note that this is the beta server and you should not count on corpora persisting (for bookmarks, embedding, etc.)."}]:[];b.push({xtype:"radio",name:"export",inputValue:"url",boxLabel:"\x3ca href\x3d'"+a.getExportUrl.call(a)+"' target\x3d'_blank'\x3e"+a.localize("exportViewUrl")+"\x3c/a\x3e",checked:!0,listeners:{afterrender:function(){this.boxLabelEl.on("click",
function(){this.up("window").close()},this)}}},{xtype:"fieldset",collapsible:!0,collapsed:!0,title:a.localize("exportViewFieldset"),items:[{xtype:"radio",name:"export",inputValue:"embed",boxLabel:a.localize("exportViewHtmlEmbed")},{xtype:"radio",name:"export",inputValue:"biblio",boxLabel:a.localize("exportViewBiblio")}]});if(a.isXType("grid")){var c=[{xtype:"radio",name:"export",inputValue:"gridCurrentHtml",boxLabel:a.localize("exportGridCurrentHtml")},{xtype:"radio",name:"export",inputValue:"gridCurrentTsv",
boxLabel:a.localize("exportGridCurrentTsv")}];a.getExportGridAll&&0==a.getExportGridAll()||c.push({xtype:"radio",name:"export",inputValue:"gridAllJson",boxLabel:a.localize("exportGridAllJson")},{xtype:"radio",name:"export",inputValue:"gridAllTsv",boxLabel:a.localize("exportGridAllTsv")});b.push({xtype:"fieldset",collapsible:!0,collapsed:!0,title:a.localize("exportGridCurrent"),items:c})}a.getExportVisualization&&!a.getExportVisualization()||0!=a.isXType("grid")||!(a.down("chart")||a.getTargetEl().dom.querySelector("canvas")||
a.getTargetEl().dom.querySelector("svg"))||(c=[{xtype:"radio",name:"export",inputValue:"png",boxLabel:a.localize("exportPng")},{xtype:"slider",width:200,value:1,minValue:.5,maxValue:10,increment:.5,labelAlign:"right",decimalPrecision:1,itemId:"scale",fieldLabel:(new Ext.Template(a.localize("scaleLabel"))).apply([1]),listeners:{change:function(b,c){this.setFieldLabel((new Ext.Template(a.localize("scaleLabel"))).apply([c]))},changecomplete:function(a){a.previousSibling().setValue(!0)}}}],a.getTargetEl().dom.querySelector("svg")&&
c.push({xtype:"radio",name:"export",inputValue:"svg",boxLabel:a.localize("exportSvg")}),b.push({xtype:"fieldset",collapsible:!0,collapsed:!0,title:a.localize("exportVizTitle"),items:c}));Ext.create("Ext.window.Window",{title:a.localize("exportTitle"),modal:!0,items:{xtype:"form",items:b,buttons:[{text:a.localize("exportTitle"),glyph:"xf08e@FontAwesome",flex:1,panel:a,handler:function(b){var c=b.up("form"),f="export"+Ext.String.capitalize(c.getValues()["export"]);Ext.isFunction(a[f])?a[f].call(a,a,
c):Ext.Msg.show({title:a.localize("exportError"),message:a.localize("exportNoFunction"),buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR});b.up("window").close()},scope:a},{text:a.localize("cancelTitle"),glyph:"xf00d@FontAwesome",flex:1,handler:function(a){a.up("window").close()}}]},bodyPadding:5}).show()},exportSvg:function(a){if(a=this.getTargetEl().dom.querySelector("svg"))a=d3.select(a).attr("version",1.1).attr("xmlns","http://www.w3.org/2000/svg").node().parentNode.innerHTML,Ext.Msg.show({title:this.localize("exportSvgTitle"),
message:'\x3cimg src\x3d"data:image/svg+xml;base64,'+btoa(unescape(encodeURIComponent(a)))+'" style\x3d"float: right; max-width: 200px; max-height: 200px; border: thin dotted #ccc;"/\x3e'+this.localize("exportSvgMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:a})},exportPngData:function(a){Ext.Msg.show({title:this.localize("exportPngTitle"),message:'\x3cimg class\x3d"thumb" src\x3d"'+a+'" style\x3d"float: right; max-width: 200px; max-height: 200px; border: thin dotted #ccc;"/\x3e'+
this.localize("exportPngMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:'\x3cimg src\x3d"'+a+'" /\x3e'})},exportPng:function(a,b){var c=1;if(b){b.mask(a.localize("loading"));var d=b.queryById("scale");d&&d.getValue&&(c=d.getValue())}var e=this.down("draw")||this.down("chart");if(e&&(e.isChart||e.isCanvas)){var f=e.innerElement.getSize(),d=Array.prototype.slice.call(e.items.items),g=e.surfaceZIndexes,h,k,l,m;for(k=1;k<d.length;k++){l=d[k];m=g[l.type];for(e=k-1;0<=e&&g[d[e].type]>
m;)d[e+1]=d[e],e--;d[e+1]=l}var n=document.createElement("canvas"),g=Ext.getClassName(d[0]),c=d[0].devicePixelRatio*c,q=n.getContext("2d"),r;n.width=Math.ceil(f.width*c);n.height=Math.ceil(f.height*c);for(e=0;e<d.length;e++)if(l=d[e],Ext.getClassName(l)===g)for(f=l.getRect(),surfaceSize=l.el.getSize(),k=0;k<l.canvases.length;k++)r=l.canvases[k],m=r.getOffsetsTo(r.getParent()),q.drawImage(r.dom,(f[0]+m[0])*c,(f[1]+m[1])*c,surfaceSize.width*c,surfaceSize.height*c);b&&b.isVisible()&&b.unmask();return this.exportPngData(n.toDataURL())}k=
this.getTargetEl().dom;if(r=k.querySelector("canvas")){if(1==c)return c=r.toDataURL("image/png"),b&&b.isVisible()&&b.unmask(),this.exportPngData(c);n=document.createElement("canvas");q=n.getContext("2d");n.width=Math.ceil(r.width*c);n.height=Math.ceil(r.height*c);h=new Image;h.src=r.toDataURL("image/png");h.panel=this;h.onload=function(){q.drawImage(h,0,0,n.width,n.height);p=n.toDataURL("image/png");b&&b.isVisible()&&b.unmask();this.panel.exportPngData.call(this.panel,p)}}else if(e=k.querySelector("svg")){d=
k.offsetWidth*c;k=k.offsetHeight*c;e=e.cloneNode(!0);e.setAttribute("version",1.1);e.setAttribute("xmlns","http://www.w3.org/2000/svg");e.setAttribute("transform","scale("+c+")");e.setAttribute("width",d);e.setAttribute("height",k);var p="data:image/svg+xml;base64,"+btoa(unescape(encodeURIComponent(e.outerHTML)));r=Ext.DomHelper.createDom({tag:"canvas",width:d,height:k});var u=r.getContext("2d");h=new Image;h.src=p;h.panel=this;h.onload=function(){u.drawImage(h,0,0);p=r.toDataURL("image/png");b&&
b.isVisible()&&b.unmask();return this.panel.exportPngData.call(this.panel,p)}}},exportUrl:function(){this.openUrl(this.getExportUrl())},exportEmbed:function(){var a=0==this.isXType("voyantheader");console.warn(this.xtype,a);Ext.Msg.show({title:this.localize("exportViewEmbedTitle"),message:this.localize("exportViewEmbedMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:"\x3c!--\tExported from Voyant Tools (voyant-tools.org).\nThe iframe src attribute below uses a relative protocol to better function with both\nhttp and https sites, but if you're embedding this into a local web page (file protocol)\nyou should add an explicit protocol (https if you're using voyant-tools.org, otherwise\nit depends on this server.\nFeel free to change the height and width values or other styling below: --\x3e\n\x3ciframe style\x3d'width: "+
(a?this.getWidth()+"px":"100%")+"; height: "+(a?this.getHeight()+"px":"800px")+";' src\x3d'"+this.getExportUrl(a)+"'\x3e\x3c/iframe\x3e"})},exportBiblio:function(){var a=new Date;Ext.Msg.show({title:this.localize("exportBiblioTitle"),message:"\x3cfieldset\x3e\x3clegend\x3eMLA\x3c/legend\x3eSinclair, St\u00e9fan and Geoffrey Rockwell. "+(this.isXType("voyantheader")?"":'"'+this.localize("title")+'." ')+"\x3ci\x3eVoyant Tools\x3c/i\x3e. "+Ext.Date.format(a,"Y")+". Web. "+Ext.Date.format(a,"j M Y")+
". \x26lt;http://voyant-tools.org\x26gt;.\x3c/fieldset\x3e\x3cbr \x3e\x3cfieldset\x3e\x3clegend\x3eChicago\x3c/legend\x3eSt\u00e9fan Sinclair and Geoffrey Rockwell, "+(this.isXType("voyantheader")?"":'"'+this.localize("title")+'", ')+"\x3ci\x3eVoyant Tools\x3c/i\x3e, accessed "+Ext.Date.format(a,"F j, Y")+", http://voyant-tools.org.\x3c/fieldset\x3e\x3cbr \x3e\x3cfieldset\x3e\x3clegend\x3eAPA\x3c/legend\x3eSinclair, S. \x26amp; G. Rockwell. ("+Ext.Date.format(a,"Y")+"). "+(this.isXType("voyantheader")?
"":this.localize("title")+". ")+"\x3ci\x3eVoyant Tools\x3c/i\x3e. Retrieved "+Ext.Date.format(a,"F j, Y")+", from http://voyant-tools.org\x3c/fieldset\x3e",buttons:Ext.Msg.OK,icon:Ext.Msg.INFO})},exportGridCurrentJson:function(a,b){function c(a){var b={};e.forEach(function(c){b[c.text]=a.get(c.dataIndex)});values.push(b)}var d=a.getStore();d.getFields();var e=a.getColumnManager().headerCt.getVisibleGridColumns();values=[];d.buffered?d.data.forEach(c):d.each(c);Ext.Msg.show({title:this.localize("exportDataTitle"),
message:this.localize("exportDataJsonMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:Ext.encode(values)})},exportGridCurrentTsv:function(a,b){function c(a){cells=[];f.forEach(function(b){b=a.get(b.dataIndex);Ext.isString(b)&&(b=b.replace(/\s+/g," "));cells.push(b)});g+=cells.join("\t")+"\n"}var d=a.getStore(),e=d.getFields(),f=a.getColumnManager().headerCt.getVisibleGridColumns(),e=[];f.forEach(function(a){e.push(a.text)});var g=e.join("\t")+"\n";d.buffered?d.data.forEach(c):
d.each(c);Ext.Msg.show({title:this.localize("exportDataTitle"),message:this.localize("exportDataTsvMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:g})},exportGridCurrentHtml:function(a,b){function c(a){e+="\t\t\x3ctr\x3e\n";f.forEach(function(b){b=a.get(b.dataIndex);Ext.isString(b)&&(b=b.replace(/&/g,"\x26amp;").replace(/</g,"\x26lt;").replace(/>/g,"\x26lg;"));e+="\t\t\t\x3ctd\x3e"+b+"\x3c/td\x3e\n"});e+="\t\t\x3c/tr\x3e\n"}var d=a.getStore();d.getFields();var e="\x3ctable\x3e\n\t\x3cthead\x3e\n\t\t\x3ctr\x3e\n",
f=a.getColumnManager().headerCt.getVisibleGridColumns();f.forEach(function(a){e+="\t\t\t\x3ctd\x3e"+a.text+"\x3c/td\x3e\n"});e+="\t\t\x3c/tr\x3e\n\t\x3c/thead\x3e\n\t\x3ctbody\x3e\n";d.buffered?d.data.forEach(c):d.each(c);e+="\t\x3c/tbody\x3e\n\x3c/table\x3e";Ext.Msg.show({title:this.localize("exportDataTitle"),message:this.localize("exportDataHtmlMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:e})},exportGridAllJson:function(a,b){Ext.Msg.confirm(this.localize("exportAllTitle"),
this.localize("exportAllJsonWarning"),function(b){"yes"==b&&(b={limit:0,start:0},Ext.applyIf(b,a.getStore().getProxy().getExtraParams()),this.openUrl(this.getTromboneUrl()+"?"+Ext.Object.toQueryString(b)))},this)},exportGridAllTsv:function(a,b){Ext.Msg.confirm(this.localize("exportAllTitle"),this.localize("exportAllTsvWarning"),function(b){"yes"==b&&(b={limit:0,start:0,template:this.getXType()+"2tsv"},Ext.applyIf(b,a.getStore().getProxy().getExtraParams()),this.openUrl(this.getTromboneUrl()+"?"+Ext.Object.toQueryString(b)))},
this)},getExportUrl:function(a){var b=this.getApplication().getModifiedApiParams(),c=Ext.getClassName(this).split(".").pop();0==this.isXType("voyantheader")&&(delete b.panels,Ext.apply(b,this.getModifiedApiParams()),a||(b.view=c));b.corpus||(b.corpus=this.getApplication().getCorpus().getAliasOrId());return this.getApplication().getBaseUrl()+(a?"tool/"+c+"/":"")+"?"+Ext.Object.toQueryString(b)},helpToolClick:function(a){a.isXType("voyanttabpanel")&&(a=a.getActiveTab());var b=a.localize("help",{"default":!1})||
a.localize("helpTip");b==a._localizeClass(Ext.ClassManager.get("Voyant.util.Toolable"),"helpTip")?a.openUrl(a.getBaseUrl()+"docs/#!/guide/"+a.getXType()):Ext.Msg.alert(a.localize("title"),b+"\x3cp\x3e\x3ca href\x3d'"+a.getBaseUrl()+"docs/"+(a.isXType("voyantheader")?"":"#!/guide/"+a.getXType())+"' target\x3d'voyantdocs'\x3e"+a.localize("moreHelp")+"\x3c/a\x3e\x3c/p\x3e")},replacePanel:function(a){var b=this.getApplication().getCorpus();this.getInitialConfig();var c;if(this.isXType("voyantheader")&&
this.getApplication().getViewComponent){c=this.getApplication().getViewComponent();c.removeAll(!0);var d=c.add({xtype:a});b&&this.getApplication().dispatchEvent("loadedCorpus",c,b);c=Ext.Object.fromQueryString(document.location.search);var d=this.getApplication().getBaseUrl(),d=d+("?corpus\x3d"+b.getAliasOrId()),d=d+("\x26view\x3d"+a),e;for(e in c)"corpus"!==e&&"view"!==e&&(d+="\x26"+e+"\x3d"+c[e]);window.history.pushState({corpus:b.getAliasOrId(),view:a},"",d)}else c=this.isXType("voyantheader")&&
this.getApplication().getViewComponent?this.getApplication().getViewComponent():this.up("component"),c.remove(this,!0),d=c.add({xtype:a}),c.isXType("voyanttabpanel")&&c.setActiveTab(d),b&&d.fireEvent("loadedCorpus",d,b);this.getApplication().dispatchEvent("panelChange",this)}});
...
"")+(this.getApiParam("documentFilename")?"\x26documentFilename\x3d"+this.getApiParam("documentFilename"):"");this.openUrl(a)}});Ext.define("Voyant.util.Storage",{MAX_LENGTH:95E4,storeResource:function(a,b){var c=Ext.encode(b);if(c.length>this.MAX_LENGTH){for(var d=new Ext.Deferred,e=Math.ceil(c.length/this.MAX_LENGTH),f=[],g=0;g<e;g++)f.push(a+"-chunk"+g);this._doStore(a+"-hasChunks",Ext.encode(f)).then(function(){for(var a=0,b=0,g=0;g<e;g++){var m=c.substr(b,this.MAX_LENGTH);this._doStore(f[g],m).then(function(){a++;a==e&&d.resolve()},function(){d.reject()},null,this);b+=this.MAX_LENGTH}},function(){d.reject()},null,this);
...
c.storedResource.id&&""!=c.storedResource.id?this._doGetStored(c.storedResource.id,!1).then(function(a){for(var c="",f={},g=0;g<a.length;g++)this._doGetStored(a[g],!0).then(function(g){f[g[0]]=g[1];g=!0;for(var k=a.length-1;0<=k;k--)if(void 0===f[a[k]]){g=!1;break}if(g){for(k=0;k<a.length;k++)c+=f[a[k]];b.resolve(Ext.decode(c))}},function(){b.reject()},null,this)},function(){b.reject()},null,this):this._doGetStored(a,!1).then(function(a){b.resolve(a)},function(){b.reject()},null,this)},function(){b.reject()},
null,this);return b.promise},_doGetStored:function(a,b){var c=new Ext.Deferred;Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"resource.StoredResource",retrieveResourceId:a,failQuietly:!0}}).then(function(a){var e=Ext.decode(a.responseText);a=e.storedResource.id;e=e.storedResource.resource;0==e.length?c.reject():1!=b?(e=Ext.decode(e),c.resolve(e)):c.resolve([a,e])},function(){c.reject()},null,this);return c.promise}});Ext.define("Voyant.util.CategoriesManager",{config:{categories:void 0,features:void 0,featureDefaults:void 0},constructor:function(a){this.setCategories({});this.setFeatures({});this.setFeatureDefaults({});a=a||{};if(void 0!==a.categories)for(var b in a.categories)this.addTerms(b,a.categories[b])},getCategoryTerms:function(a){return this.getCategories()[a]},addCategory:function(a){void 0===this.getCategories()[a]&&(this.getCategories()[a]=[])},renameCategory:function(a,b){var c=this.getCategoryTerms(a);
this.addTerms(b,c);for(var d in this.getFeatures())c=this.getFeatures()[d][a],this.setCategoryFeature(b,d,c);this.removeCategory(a)},removeCategory:function(a){delete this.getCategories()[a];for(var b in this.getFeatures())delete this.getFeatures()[b][a]},addTerm:function(a,b){this.addTerms(a,[b])},addTerms:function(a,b){Ext.isArray(b)||(b=[b]);void 0===this.getCategories()[a]&&this.addCategory(a);for(var c=0;c<b.length;c++){var d=b[c];-1===this.getCategories()[a].indexOf(d)&&this.getCategories()[a].push(d)}},
removeTerm:function(a,b){this.removeTerms(a,[b])},removeTerms:function(a,b){Ext.isArray(b)||(b=[b]);if(void 0!==this.getCategories()[a])for(var c=0;c<b.length;c++){var d=b[c],d=this.getCategories()[a].indexOf(d);-1!==d&&this.getCategories()[a].splice(d,1)}},getCategoryForTerm:function(a){for(var b in this.getCategories())if(-1!=this.getCategories()[b].indexOf(a))return b},getFeatureForTerm:function(a,b){return this.getCategoryFeature(this.getCategoryForTerm(b),a)},addFeature:function(a,b){void 0===
this.getFeatures()[a]&&(this.getFeatures()[a]={});void 0!==b&&(this.getFeatureDefaults()[a]=b)},removeFeature:function(a){delete this.getFeatures()[a];delete this.getFeatureDefaults()[a]},setCategoryFeature:function(a,b,c){void 0===this.getFeatures()[b]&&this.addFeature(b);this.getFeatures()[b][a]=c},getCategoryFeature:function(a,b){var c=void 0;void 0!==this.getFeatures()[b]&&(c=this.getFeatures()[b][a],void 0===c&&(c=this.getFeatureDefaults()[b],Ext.isFunction(c)&&(c=c())));return c},setColorTermAssociations:function(){for(var a in this.getCategories()){var b=
this.getCategoryFeature(a,"color");if(void 0!==b)for(var b=this.hexToRgb(b),c=this.getCategoryTerms(a),d=0;d<c.length;d++)this.colorTermAssociations.replace(c[d],b)}},getCategoryExportData:function(){return{categories:this.getCategories(),features:this.getFeatures()}},loadCategoryData:function(a){var b=new Ext.Deferred;Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"resource.StoredResource",retrieveResourceId:a,failQuietly:!0}}).then(function(a){a=Ext.decode(a.responseText).storedResource.resource;
0==a.length?b.reject():(a=Ext.decode(a),this.setCategories(a.categories),this.setFeatures(a.features),b.resolve(a))},function(){b.reject()},null,this);return b.promise},saveCategoryData:function(a){a=a||this.getCategoryExportData();var b=new Ext.Deferred;a=Ext.encode(a);Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"resource.StoredResource",storeResource:a}}).then(function(a){a=Ext.util.JSON.decode(a.responseText).storedResource.id;b.resolve(a)},function(a){b.reject()});return b.promise}});Ext.define("Voyant.util.DiacriticsRemover",{diacriticsMap:{},constructor:function(){var a=[{base:"A",letters:"A\u24b6\uff21\u00c0\u00c1\u00c2\u1ea6\u1ea4\u1eaa\u1ea8\u00c3\u0100\u0102\u1eb0\u1eae\u1eb4\u1eb2\u0226\u01e0\u00c4\u01de\u1ea2\u00c5\u01fa\u01cd\u0200\u0202\u1ea0\u1eac\u1eb6\u1e00\u0104\u023a\u2c6f"},{base:"AA",letters:"\ua732"},{base:"AE",letters:"\u00c6\u01fc\u01e2"},{base:"AO",letters:"\ua734"},{base:"AU",letters:"\ua736"},{base:"AV",letters:"\ua738\ua73a"},{base:"AY",letters:"\ua73c"},
...
Ext.id(),h=Voyant.application.getBaseUrlFull()+"tool/"+d.substring(d.lastIndexOf(".")+1)+"/?";show('\x3ciframe style\x3d"'+b.style+'" id\x3d"'+g+'" name\x3d"'+g+'"\x3e\x3c/iframe\x3e');var k=Voyant.application.getDeferred(this);Ext.Ajax.request({url:Voyant.application.getTromboneUrl(),params:{tool:"resource.StoredResource",storeResource:e}}).then(function(a){a={minimal:!0,embeddedApiId:Ext.util.JSON.decode(a.responseText).storedResource.id};f&&(a.corpus=f);Ext.applyIf(a,Voyant.application.getModifiedApiParams());
document.getElementById(g).setAttribute("src",h+Ext.Object.toQueryString(a));k.resolve()}).otherwise(function(a){showError(a);k.reject()});c=!0;return!1}},this)&&Voyant.notebook.util.Embed.showWidgetNotRecognized.call(this);c||(Ext.create(a,b).embed(b),c=!0)}c||Voyant.notebook.util.Embed.showWidgetNotRecognized.call(this)}},showWidgetNotRecognized:function(){var a=Voyant.notebook.util.Embed.i18n.widgetNotRecognized;this.embeddable&&(a+=Voyant.notebook.util.Embed.i18n.tryWidget+"\x3cul\x3e"+this.embeddable.map(function(a){a=
...
a.listeners||{},a.listeners.beforeload={fn:function(a,b){var c=this.getParentPanel(),g=a.getProxy();if(void 0!==c){c=c.getApiParams();b=b?1===b?{}:b:{};b.params=b.params||{};g&&this.isBufferedStore&&(Ext.Array.from(this.previouslySetExtraParams).forEach(function(a){g.setExtraParam(a,void 0)}),this.previouslySetExtraParams=[]);for(var h in c)g&&this.isBufferedStore&&(this.previouslySetExtraParams.push(h),g.setExtraParam(h,c[h])),b.params[h]=c[h]}},scope:this});Ext.apply(this,a)},setCorpus:function(a){a&&
...
Ext.define("Voyant.data.store.DocumentsBuffered",{extend:"Ext.data.BufferedStore",mixins:["Voyant.data.store.DocumentsMixin"],constructor:function(a){a=a||{};this.mixins["Voyant.data.store.DocumentsMixin"].constructor.apply(this,[a]);this.callParent([a])}});Ext.define("Voyant.data.store.PCAAnalysisMixin",{mixins:["Voyant.data.store.VoyantStore"],embeddable:["Voyant.panel.ScatterPlot"],model:"Voyant.data.model.StatisticalAnalysis",constructor:function(a){this.mixins["Voyant.data.store.VoyantStore"].constructor.apply(this,[a,{"proxy.extraParams.tool":"corpus.PCA","proxy.reader.rootProperty":"pcaAnalysis","proxy.reader.totalProperty":"pcaAnalysis.totalTerms"}]);a.proxy.extraParams.withDistributions=!0}});
...
a.setRowKey(Ext.clone(this.getRowKey()));return a},constructor:function(a,b){a=a||{};if(a.fromBlock){var c=Voyant.notebook.Notebook.getDataFromBlock(a.fromBlock);c&&(c=c.trim(),a.rows=[],c.split(/\n+/).forEach(function(b,c){var d=b.split("\t");0!=c||a.noHeaders?a.rows.push(d):a.headers=d}))}else if(a.count&&Ext.isArray(a.count)){var d={};a.count.forEach(function(a){d[a]=d[a]?d[a]+1:1});var c=[],e;for(e in d)c.push([e,d[e]]);c.sort(function(a,b){return b[1]-a[1]});a.limit&&c.length>a.limit&&c.splice(a.limit);
a.orientation&&"horizontal"==a.orientation?(a.headers=c.map(function(a){return a[0]}),a.rows=[c.map(function(a){return a[1]})]):(a.headers=a.headers?a.headers:["Item","Count"],a.rows=c)}else if(a.isStore||a.store){c=a.store?a.store:a;if(b&&b.headers)a.headers=b.headers;else if(e=c.getAt(0))a.headers=e.getFields().map(function(a){return a.getName()});a.rows=[];c.each(function(b){var c=b.getData();b=a.headers.map(function(a){return c[a]});a.rows.push(b)},this)}!a.rows&&Ext.isArray(a)&&(a.rows=a);this.getHeaders()||
(a.headers||a.noHeaders||!a.rows?this.setHeaders(Ext.Array.from(a.headers)):this.setHeaders(a.rows.shift()));this.setRows(Ext.Array.from(a.rows));this.setRowKey(a.rowKey?a.rowKey:this.getHeaders()[0]);0==this.getHeaders().length&&(c=this.getRow(0,!1))&&this.setHeaders(c.map(function(a,b){return b}));var f={};this.getHeaders().forEach(function(a,b){f[a]=b});this.setHeadersMap(f);this.reMapRows();this.callParent()},addRow:function(a){if(Ext.isArray(a))if(Ext.isObject(a)){var b=this.getRows().length,
c;for(c in a)this.updateCell(b,c,a[c])}else Ext.isArray(a)&&(this.getRows().push(a),b=this.getColumnIndex(this.getRowKey()),void 0!==b&&void 0!==a[b]&&(this.getRowsMap()[a[b]]=this.getRows().length-1))},eachRecord:function(a,b){for(var c,d=0,e=this.getRows().length;d<e&&(c=this.getRecord(d),!1!==a.call(b||c,c,d,e));d++);},eachRow:function(a,b,c){for(var d,e=0,f=this.getRows().length;e<f&&(d=this.getRow(e,b),!1!==a.call(c||d,d,e,f));e++);},getRow:function(a,b){var c=this.getRowIndex(a);if(b){var d=
{},e=this.getHeaders();Ext.Array.from(this.getRows()[c]).forEach(function(a,b){d[e[b]||b]=a},this);return d}return this.getRows()[c]},getRecord:function(a){if(this.model)return new this.model(this.getRow(a,!0))},mapRows:function(a,b,c){var d=[];this.eachRow(function(b,f){d.push(a.call(c||this,b,f))},b,this);return d},updateCell:function(a,b,c,d){var e=this.getRows();a=Ext.isNumber(a)?a:this.getRowIndex(a);var f=this.getColumnIndex(b);void 0===e[a]&&(e[a]=[]);e[a][f]=void 0===e[a][f]||d?c:e[a][f]+
c;this.getHeaders()[f]===this.getRowKey()&&(this.getRowsMap()[b]=a)},getRowIndex:function(a){if(Ext.isNumber(a))return a;if(Ext.isString(a)){var b=this.getRowsMap();a in b||(b[a]=this.getRows().length,this.getRows().push(Array(this.getHeaders().length)));return b[a]}},getColumnIndex:function(a){var b=this.getHeaders();if(Ext.isNumber(a))return void 0===b[a]&&(b[a]=a,this.getRows().forEach(function(b){b.splice(a,0,void 0)})),a;if(Ext.isString(a))return a in this.getHeadersMap()||(this.getHeaders().push(a),
this.getHeadersMap()[a]=this.getHeaders().length-1,this.getRows().forEach(function(a){a.push(void 0)})),this.getHeadersMap()[a]},getColumnHeader:function(a){a=this.getColumnIndex(a);return this.getHeaders()[a]},getColumnSum:function(a){return Ext.Array.sum(this.getColumnValues(a,!0))},getColumnMean:function(a){return Ext.Array.mean(this.getColumnValues(a,!0))},getColumnMax:function(a){return Ext.Array.max(this.getColumnValues(a,!0))},getColumnMin:function(a){return Ext.Array.min(this.getColumnValues(a,
!0))},getColumnValues:function(a,b){var c=this.getColumnIndex(a),d=[];this.eachRow(function(a){d.push(a[c])});return b?Ext.Array.clean(d):d},reMapRows:function(){var a=this.getRowKey(),b={};this.eachRow(function(c,d){a in c&&(b[c[a]]=d)},!0);this.setRowsMap(b)},sortByColumn:function(a){var b=this.getRows(),c=Ext.Array.from(a).map(function(a){if(Ext.isObject(a))for(key in a)return{index:this.getColumnIndex(key),direction:-1<a[key].indexOf("asc")?"asc":"desc"};else return{index:this.getColumnIndex(a),
direction:"desc"}},this);b.sort(function(a,b){for(var f=0,g=c.length;f<g;f++){var h=c[f].index;if(a[h]!=b[h])return"asc"==c[f].direction?a[h]>b[h]?1:-1:a[h]>b[h]?-1:1}});this.reMapRows();return this},loadCorrespondenceAnalysis:function(a){return this._doAnalysisLoad("table.CA","Voyant.data.store.CAAnalysis",a)},loadPrincipalComponentAnalysis:function(a){return this._doAnalysisLoad("table.PCA","Voyant.data.store.PCAAnalysis",a)},loadTSNEAnalysis:function(a){return this._doAnalysisLoad("table.TSNE",
"Voyant.data.store.TSNEAnalysis",a)},_doAnalysisLoad:function(a,b,c){if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments);c=c||{};var d=Voyant.application.getDeferred(this);Ext.apply(c,{columnHeaders:!0,rowHeaders:!0,tool:a,analysisInput:this.toTsv(),inputFormat:"tsv"});var e=Ext.create(b,{noCorpus:!0});e.load({params:c,callback:function(a,b,c){c?d.resolve(e,a):d.reject(b.error.response)}});return d.promise},embed:function(a,b){!b&&Ext.isObject(a)&&(b=a,a=this.embeddable[0]);
b=b||{};var c=Ext.Array.from(b.headers||this.getHeaders()).map(function(a){return this.getColumnHeader(a)},this),c={rowkey:this.getRowKey(),config:b,headers:c};if("headers"in b){var d=Ext.Array.from(b.headers).map(function(a){return this.getColumnIndex(a)},this),e=[];this.getRows().forEach(function(a){e.push(d.map(function(b){return a[b]}))});Ext.apply(c,{rows:e})}else Ext.apply(c,{rows:this.getRows()});Ext.apply(b,{tableJson:JSON.stringify(c)});delete b.axes;delete b.series;embed.call(this,a,b)},
toTsv:function(a){var b=this.getHeaders().join("\t");this.getRows().forEach(function(c,d){a&&Ext.isNumber(a)&&d>a||(b+="\n"+c.map(function(a){return Ext.isString(a)?a.replace(/(\n|\t)/g,""):a}).join("\t"))});return b},getString:function(a){a=a||{};var b="\x3ctable class\x3d'voyant-table' style\x3d'"+(a.width?" width: "+a.width:"")+"' id\x3d'"+(a.id?a.id:Ext.id())+"'\x3e",c=this.getHeaders();if(c.length){for(var b=b+"\x3cthead\x3e\x3ctr\x3e",d=0,e=c.length;d<e;d++)b+="\x3cth\x3e"+c[d]+"\x3c/th\x3e";
b+="\x3c/tr\x3e\x3c/thead\x3e"}b+="\x3ctbody\x3e";d=0;for(e=Ext.isNumber(a)?a:this.getRows().length;d<e;d++)(a=this.getRow(d))&&Ext.isArray(a)&&(b+="\x3ctr\x3e",a.forEach(function(a){b+="\x3ctd\x3e"+a+"\x3c/td\x3e"}),b+="\x3c/tr\x3e");return b+="\x3c/tbody\x3e\x3c/table\x3e"}});Ext.define("Voyant.data.util.NetworkGraph",{alternateClassName:["NetworkGraph"],mixins:["Voyant.notebook.util.Embed","Voyant.notebook.util.Show"],embeddable:["Voyant.widget.VoyantNetworkGraph"],config:{edges:[],nodes:[]},constructor:function(a,b){a=a||{};this.setEdges(Ext.Array.from(a.edges));this.setNodes(Ext.Array.from(a.nodes));this.callParent([a])},addEdge:function(a,b,c){this.getEdges().push(Ext.isObject(a)?a:{source:a,target:b,value:c})},getNode:function(a){return Ext.Array.binarySearch(this.getNodes(),
...
"-"+a.target}).join("; ")}});Ext.define("Voyant.data.util.Geonames",{mixins:["Voyant.util.Localization"],statics:{i18n:{failedToFetchGeonames:"Failed to load location information."}},config:{data:{},queries:void 0,corpus:void 0,isIncrementalLoadingOccurrences:!1,previousParams:{}},constructor:function(a,b){a=a||{};this.callParent([a]);this.setCorpus(a.corpus)},load:function(a,b){this.setPreviousParams(a);b=b||Voyant.application.getDeferred(this);var c=this,d={corpus:this.getCorpus().getAliasOrId(),queries:this.getQueries(),tool:"corpus.Dreamscape",
limit:200};Ext.apply(d,a||{});a.noOverwrite||c.setData({});Ext.Ajax.request({url:Voyant.application.getTromboneUrl(),params:d,scope:this}).then(function(d){(d=Ext.JSON.decode(d.responseText))&&d.dreamscape&&d.dreamscape.progress&&new Voyant.widget.ProgressMonitor({progress:d.dreamscape.progress,tool:"corpus.Dreamscape",success:function(){c.load.call(c,a,b)},failure:function(a){Voyant.application.showResponseError(c.localize("failedToFetchGeonames"),a)},scope:c});d&&d.dreamscape&&!d.dreamscape.progress&&
(a.noOverwrite||c.setData(d.dreamscape),b.resolve(d))},function(a){Voyant.application.showResponseError(c.localize("failedToFetchGeonames"),a)});return b.promise},getCitiesCount:function(){return Object.keys(this.getData().locations.locations).length},getTotalCitiesCount:function(){return this.getData().locations.total},hasMoreCities:function(){return this.getCitiesCount()<this.getTotalCitiesCount()},eachCity:function(a,b,c){var d=this.getData().locations.locations,e=[],f;for(f in d)e.push(Ext.apply(d[f],
...
a)}).then(function(a){0==a.getDocumentsCount()&&Voyant.application.showError(d.localize("thisCorpus")+" "+d.localize("isEmpty")+".");!("docsLimit"in b)||!1!==b.docsLimit&&0<b.docsLimit?d.getDocuments().load({params:{limit:"docsLimit"in b?b.docsLimit:d.getDocumentsCount()},callback:function(b,g,h){h?(d.setDocumentsStore(this),c.resolve(a)):c.reject(g)}}):c.resolve(a)})}else Voyant.application.showError(this.localize("badDataTypeCorpus")+": ("+typeof b+") "+b),Ext.defer(function(){c.reject(this.localize("badDataTypeCorpus")+
...
Ext.apply(a||{},{corpus:this}))},getTokens:function(a){return Ext.create("Voyant.data.store.Tokens",Ext.apply(a||{},{corpus:this}))},each:function(a,b){this.getDocuments().each(function(c,d){a.call(b||c,c,d)})},getCorpusCollocates:function(a){return Ext.create("Voyant.data.store.CorpusCollocates",Ext.apply(a||{},{corpus:this}))},getDocumentQueryMatches:function(a){return Ext.create("Voyant.data.store.DocumentQueryMatches",Ext.apply(a||{},{corpus:this}))},getDocumentTerms:function(a){return Ext.create("Voyant.data.store.DocumentTerms",
Ext.apply(a||{},{corpus:this}))},getDocumentEntities:function(a){return Ext.create("Voyant.data.store.DocumentEntities",Ext.apply(a||{},{corpus:this}))},loadContexts:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments);var b=Voyant.application.getDeferred(this);a=a||{};Ext.isNumber(a)&&(a={limit:a});Ext.applyIf(a,{limit:0});var c=this.getContexts();c.load({params:a,callback:function(a,e,f){f?b.resolve(c):b.reject(e)}});return b.promise},getContexts:function(a){return Ext.create("Voyant.data.store.Contexts",
Ext.apply(a||{},{corpus:this}))},getDocuments:function(a){return this.getDocumentsStore()?this.getDocumentsStore():Ext.create("Voyant.data.store.Documents",Ext.apply(a||{},{corpus:this}))},getDocument:function(a){if(this.getDocumentsStore()){if(a instanceof Voyant.data.model.Document)return a;if(Ext.isNumeric(a))return this.getDocumentsStore().getAt(parseInt(a));if(Ext.isString(a))return this.getDocumentsStore().getById(a)}return this.then?Voyant.application.getDeferredNestedPromise(this,arguments):
this.getDocumentsStore().getDocument(a)},getDocumentsCount:function(){return this.then?Voyant.application.getDeferredNestedPromise(this,arguments):this.get("documentsCount")},getWordTokensCount:function(){return this.then?Voyant.application.getDeferredNestedPromise(this,arguments):this.get("lexicalTokensCount")},getWordTypesCount:function(){return this.then?Voyant.application.getDeferredNestedPromise(this,arguments):this.get("lexicalTypesCount")},getCreatedTime:function(){return this.then?Voyant.application.getDeferredNestedPromise(this,
arguments):this.get("createdTime")},requiresPassword:function(){var a=this.getNoPasswordAccess();return"NONE"==a||"NONCONSUMPTIVE"==a},getNoPasswordAccess:function(){return this.then?Voyant.application.getDeferredNestedPromise(this,arguments):this.get("noPasswordAccess")},getTitle:function(){return this.then?Voyant.application.getDeferredNestedPromise(this,arguments):this.get("title")},getSubTitle:function(){return this.then?Voyant.application.getDeferredNestedPromise(this,arguments):this.get("subTitle")},
getRelatedWords:function(a){return Ext.create("Voyant.data.store.RelatedTerms",Ext.apply(a||{},{corpus:this}))},loadRelatedWords:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments);var b=Voyant.application.getDeferred(this);a=a||{};Ext.isNumber(a)&&(a={limit:a});Ext.applyIf(a,{limit:0});this.getRelatedWords().load({params:a,callback:function(a,d,e){e?b.resolve(a):b.reject(d.error.response)}});return b.promise},getText:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,
arguments,this);var b=Voyant.application.getDeferred(this);a=a||{};Ext.isNumber(a)?a={limit:a}:Ext.isString(a)&&(a={limit:parseInt(a)});Ext.applyIf(a,{limit:0,outputFormat:"text",template:"docTokens2text"});Ext.apply(a,{tool:"corpus.DocumentTokens",corpus:this.getAliasOrId()});Ext.Ajax.request({url:Voyant.application.getTromboneUrl(),params:a,success:function(c,d){var e=c.responseText.trim();a.transformCase&&(-1<a.transformCase.indexOf("lower")?e=e.toLowerCase():-1<a.transformCase.indexOf("upper")&&
(e=e.toUpperCase()));b.resolve(e)},failure:function(a,d){b.reject(a)},scope:this});return b.promise},getPlainText:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments);a=a||{};Ext.isNumber(a)?a={limit:a}:Ext.isString(a)&&(a={limit:parseInt(a)});Ext.apply(a,{template:"docTokens2plainText"});return this.getText(a)},getWords:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments);a=a||{};Ext.isNumber(a)?a={limit:a}:Ext.isString(a)&&
(a={limit:parseInt(a)});Ext.applyIf(a,{template:"docTokens2words"});return this.getText(a)},getWordsArray:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments);var b=Voyant.application.getDeferred(this);this.getWords(a).then(function(a){b.resolve(a.split(" "))});return b.promise},getLemmasArray:function(a){a=a||{};if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments);var b=Voyant.application.getDeferred(this);Ext.applyIf(a,{template:"docTokens2lemmas",
withPosLemmas:!0,noOthers:!0});this.getWords(a).then(function(a){a=a.split(" ").map(function(a){return a.substring(0,a.indexOf("/"))});b.resolve(a)});return b.promise},getString:function(a){var b=this.getDocumentsCount(),c=this.localize("thisCorpus");if(0==b)c+=" "+this.localize("isEmpty")+".";else{var c=c+" ",c=1<b?c+(new Ext.XTemplate(this.localize("hasNdocuments"))).apply({count:Ext.util.Format.number(b,"0,000")}):c+this.localize("has1document"),c=c+(" "+(new Ext.XTemplate(this.localize("widthNwordsAndNTypes"))).apply({words:Ext.util.Format.number(this.getWordTokensCount(),
"0,000"),types:Ext.util.Format.number(this.getWordTypesCount(),"0,000")})+"."),c=c+(" "+this.localize("created")+" "),d=this.get("createdDate"),e=new Date;!0===Ext.Array.each([["year",Ext.Date.YEAR],["month",Ext.Date.MONTH],["day",Ext.Date.DAY],["hour",Ext.Date.HOUR],["minute",Ext.Date.MINUTE],["second",Ext.Date.SECOND]],function(a){if(Ext.Date.diff(d,e,a[1])>("second"==a[0]?1:0)){var b=Ext.Date.diff(d,e,a[1]);c+="\x3cspan class\x3d'info-tip' data-qtip\x3d'"+Ext.Date.format(d,"Y-m-d, H:i:s")+"'\x3e";
c=1==b?c+(new Ext.XTemplate(this.localize(a[0]+"Ago"))).apply({count:b,date:d}):c+(new Ext.XTemplate(this.localize(a[0]+"sAgo"))).apply({count:b,date:d});c+="\x3c/span\x3e";return!1}},this)&&(c+=this.localize("now"));c+=".";c+=""}!0===a&&(c+=" ("+this.getId()+")");return c}});Ext.define("Voyant.widget.CodeEditor",{extend:"Ext.panel.Panel",mixins:["Voyant.util.Localization","Voyant.util.Api","Voyant.notebook.util.Embed"],alias:"widget.codeeditor",statics:{i18n:{},api:{tableJson:void 0,content:"",mode:"ace/mode/text",width:void 0}},constructor:function(a){a=a||{};this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);this.buildFromParams();Ext.apply(this,{items:{xtype:"notebookcodeeditor",content:a.content?a.content:this.getApiParam("content"),mode:a.mode?a.mode:
...
no:"stop.no.norwegian.txt",ro:"stop.ro.romanian-lucene.txt",se:"stop.se.swedish-long.txt",th:"stop.th.thai-lucene.txt",tr:"stop.tr.turkish-lucene.txt"},i18n:{}},initComponent:function(a){var b=this.up("window").panel.getApiParam("stopList"),c=[];for(id in Voyant.widget.StopListOption.stoplists)c.push({name:this.localize(id),value:Voyant.widget.StopListOption.stoplists[id]});c.sort(function(a,b){return a.name<b.name?-1:1});c.splice(0,0,{name:this.localize("auto"),value:"auto"},{name:this.localize("none"),
value:""},{name:this.localize("new"),value:"new"});Ext.apply(this,{items:[{xtype:"combo",queryMode:"local",value:b,triggerAction:"all",editable:!0,fieldLabel:this.localize("label"),labelAlign:"right",name:"stopList",displayField:"name",valueField:"value",store:{fields:["name","value"],data:c}},{width:10},{xtype:"tbspacer"},{xtype:"button",text:this.localize("editList"),ui:"default-toolbar",handler:this.editList,scope:this},{width:10},{xtype:"checkbox",name:"stopListGlobal",checked:!0,boxLabel:this.localize("applyGlobally")}]});
this.callParent(arguments)},editList:function(){var a=this.up("window").panel,b=this.down("combo").getValue(),c=a.getApplication&&a.getApplication().getCorpus?a.getApplication().getCorpus().getId():void 0;"auto"!=b||c?Ext.Ajax.request({url:a.getTromboneUrl(),params:{tool:"resource.KeywordsManager",stopList:b,corpus:c},success:function(b){b=Ext.util.JSON.decode(b.responseText).keywords.keywords.sort().join("\n");Ext.Msg.show({title:this.localize("editStopListTitle"),message:this.localize("editStopListMessage"),
buttons:Ext.Msg.OKCANCEL,buttonText:{ok:this.localize("ok"),cancel:this.localize("cancel")},icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:b,original:b,fn:function(b,d,g){"ok"==b&&g.original!=d&&(b=this.down("combo"),0==Ext.String.trim(d).length?b.setValue("empty"):Ext.Ajax.request({url:a.getTromboneUrl(),params:{tool:"resource.StoredResource",storeResource:d,corpus:c},combo:b,success:function(a,b){var c=Ext.util.JSON.decode(a.responseText),d=b.combo.getStore(),c="keywords-"+c.storedResource.id;d.add({name:c,
value:c});b.combo.setValue(c);b.combo.updateLayout()},scope:this}))},scope:this})},scope:this}):Ext.Msg.show({title:this.localize("noEditAutoTitle"),message:this.localize("noEditAutoMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR})}});Ext.define("Voyant.widget.QuerySearchField",{extend:"Ext.form.field.Tag",mixins:["Voyant.util.Localization"],alias:"widget.querysearchfield",statics:{i18n:{}},config:{corpus:void 0,tokenType:"lexical",isDocsMode:!1,inDocumentsCountOnly:void 0,stopList:void 0,showAggregateInDocumentsCount:!1,clearOnQuery:!1},hasCorpusLoadedListener:!1,isClearing:!1,constructor:function(a){a=a||{};Ext.applyIf(a,{minWidth:100,maxWidth:200,matchFieldWidth:!1,minChars:2,displayField:"term",valueField:"term",filterPickList:!0,
createNewOnEnter:!0,createNewOnBlur:!1,autoSelect:!1,tpl:['\x3cul class\x3d"x-list-plain"\x3e\x3ctpl for\x3d"."\x3e','\x3cli role\x3d"option" class\x3d"x-boundlist-item" style\x3d"white-space: nowrap;"\x3e'+(a.itemTpl?a.itemTpl:"{term} ({"+(a.inDocumentsCountOnly?"inDocumentsCount":"rawFreq")+"})")+"\x3c/li\x3e","\x3c/tpl\x3e\x3c/ul\x3e"],triggers:{help:{weight:2,cls:"fa-trigger form-fa-help-trigger",handler:function(){Ext.Msg.show({title:this.localize("querySearch"),message:this.getIsDocsMode()?
this.localize("querySearchDocsModeTip"):this.localize("querySearchTip"),buttons:Ext.OK,icon:Ext.Msg.INFO})},scope:"this"}}});a.showAggregateInDocumentsCount&&(a.triggers.count={cls:"fa-trigger",handler:"onHelpClick",scope:"this",hidden:!0});a.clearOnQuery&&this.setClearOnQuery(a.clearOnQuery);this.callParent(arguments)},initComponent:function(a){var b=this;b.on("beforequery",function(a){if(a.query){a.query=a.query.trim();"^"==a.query.charAt(0)&&(a.query=a.query.substring(1),a.cancel=0==a.query.length);
"*"==a.query.charAt(0)&&(a.query="."+a.query);"*"==a.query.charAt(a.query.length-1)&&(a.query=a.query.substring(0,a.query.length-1),a.cancel=0==a.query.length);"."==a.query.charAt(0)&&(a.cancel=a.query.length<(/\W/.test(a.query.charAt(1))?5:4));try{new RegExp(a.query)}catch(b){a.cancel=!0}-1<a.query.indexOf('"')&&(-1==a.query.indexOf(" ")&&(a.cancel=!0),2!=(a.query.match(/"/)||[]).length&&(a.cancel=!0));-1<a.query.indexOf("*")?-1==a.query.indexOf(" ")&&(a.query+=",^"+a.query):a.query=a.query+"*"+
(-1==a.query.indexOf(" ")?",^"+a.query+"*":"")}});b.on("change",function(a,c){b.isClearing?b.isClearing=!1:(c=c.map(function(a){return a.replace(/^(\^?)\*/,"$1.*")}),b.up("panel").fireEvent("query",b,c),b.getClearOnQuery()&&(b.isClearing=!0,b.removeValue(b.getValueRecords())),b.triggers.count&&(b.triggers.count.show(),b.triggers.count.getEl().setHtml("0"),0<c.length?b.getCorpus().getCorpusTerms().load({params:{query:c.map(function(a){return"("+a+")"}).join("|"),tokenType:b.getTokenType(),stopList:b.getStopList(),
inDocumentsCountOnly:!0},callback:function(a,c,d){debugger;d&&a&&1==a.length&&b.triggers.count.getEl().setHtml(a[0].getInDocumentsCount())}}):b.triggers.count.hide()))});var c=b.findParentBy(function(a){return a.mixins["Voyant.panel.Panel"]});if(null!=c){if(c.getCorpus&&c.getCorpus())b.on("afterrender",function(a){this.doSetCorpus(c.getCorpus())});else c.on("loadedCorpus",function(a,c){b.doSetCorpus(c)},b);b.hasCorpusLoadedListener=!0}b.on("afterrender",function(a){!1!==b.hasCorpusLoadedListener||
b.getCorpus()||(c=b.findParentBy(function(a){return a.mixins["Voyant.panel.Panel"]}),null==c&&(c=b.up("window").panel),a=c.getApplication().getCorpus(),void 0!==a?b.doSetCorpus(a):(c.on("loadedCorpus",function(a,c){b.doSetCorpus(c)},b),b.hasCorpusLoadedListener=!0));b.triggers&&b.triggers.help&&Ext.tip.QuickTipManager.register({target:b.triggers.help.getEl(),text:b.getIsDocsMode()?b.localize("querySearchDocsModeTip"):b.localize("querySearchTip")});b.triggers&&b.triggers.count&&Ext.tip.QuickTipManager.register({target:b.triggers.count.getEl(),
text:b.localize("aggregateInDocumentsCount")})});b.on("beforedestroy",function(a){b.triggers&&b.triggers.help&&Ext.tip.QuickTipManager.unregister(b.triggers.help.getEl());b.triggers&&b.triggers.count&&Ext.tip.QuickTipManager.unregister(b.triggers.count.getEl())});b.callParent(arguments)},doSetCorpus:function(a){if(null!=a){this.setCorpus(a);if(void 0==this.getStopList())if(this.getApiParam)this.setStopList(this.getApiParam("stopList"));else for(var b=this.up("panel");b;){if(b&&b.getApiParam){this.setStopList(b.getApiParam("stopList"));
break}b=b.up("panel")}a=a.getCorpusTerms({corpus:a.getAliasOrId(),proxy:{extraParams:{limit:10,tokenType:this.tokenType,stopList:this.getStopList(),inDocumentsCountOnly:this.getInDocumentsCountOnly()}}});a.on("load",function(){this.fireEvent.apply(this,["load"].concat(Array.prototype.slice.call(arguments)))},this);this.setStore(a)}}});Ext.define("Voyant.widget.TotalPropertyStatus",{extend:"Ext.Component",mixins:["Voyant.util.Localization"],alias:"widget.totalpropertystatus",statics:{i18n:{}},initComponent:function(){Ext.applyIf(this,{tpl:this.localize("totalPropertyStatus"),itemId:"totalpropertystatus",style:"margin-right:5px",listeners:{afterrender:function(a){var b=a.up("grid");if(b){var c=b.getStore();a.updateStatus(c.getTotalCount());b.getStore().on("totalcountchange",a.updateStatus,a)}}}});this.callParent(arguments)},updateStatus:function(a){this.update({count:a})}});Ext.define("Voyant.widget.DocumentSelector",{mixins:["Voyant.util.Localization"],alias:"widget.documentselector",glyph:"xf10c@FontAwesome",statics:{i18n:{}},config:{docs:void 0,corpus:void 0,singleSelect:!1},initComponent:function(){this.setSingleSelect(void 0==this.config.singleSelect?this.getSingleSelect():this.config.singleSelect);Ext.apply(this,{text:this.localize("documents"),menu:{width:250,fbar:[{xtype:"checkbox",hidden:this.getSingleSelect(),boxLabel:this.localize("all"),listeners:{change:{fn:function(a,
...
Ext.Ajax.request({url:c.getTromboneUrl(),params:{tool:"resource.StoredResource",storeResource:b,corpus:d},success:function(b,d){var g=Ext.util.JSON.decode(b.responseText).storedResource.id,h=this.down("combo");h.getStore().add({name:g,value:g});h.setValue(g);h.updateLayout();c.getApplication().addColorPalette(g,a)},scope:this})}});Ext.define("Voyant.widget.VoyantChart",{extend:"Ext.chart.CartesianChart",mixins:["Voyant.util.Localization","Voyant.util.Api","Voyant.notebook.util.Embed"],alias:"widget.voyantchart",statics:{i18n:{},api:{tableJson:void 0}},constructor:function(a){a=a||{};this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);this.callParent(arguments)},initComponent:function(a){a=a||{};this.on("afterrender",function(){if(a&&"tableJson"in a)Ext.apply(this,this.getConfigFromTableJson(a.tableJson));else if(this.getApiParam("tableJson")){var b=
...
"":"i")),c.store.each(function(a,b){var k=e.getNode(a);k&&Ext.Array.forEach(f,function(b){var e=Ext.fly(k).down(b.getCellInnerSelector(),!0),f,h,r;e&&0==b.isXType("widgetcolumn")&&(f=e.innerHTML.match(c.tagsRe),h=e.innerHTML.replace(c.tagsRe,c.tagsProtect),h=h.replace(c.searchRegExp,function(e){++d;r||(c.matches.push({record:a,column:b}),r=!0);return'\x3cspan class\x3d"'+c.matchCls+'"\x3e'+e+"\x3c/span\x3e"},c),Ext.each(f,function(a){h=h.replace(c.tagsProtect,a)}),e.innerHTML=h)})},c),d&&(c.currentIndex=
0,c.gotoCurrent()));null===c.currentIndex&&c.getSelectionModel().deselectAll();a.focus()},privates:{gotoCurrent:function(){var a=this.matches[this.currentIndex];this.getNavigationModel().setPosition(a.record,a.column);this.getSelectionModel().select(a.record)}}});Ext.define("Voyant.widget.ProgressMonitor",{extend:"Ext.Base",mixins:["Voyant.util.Localization"],msgbox:void 0,statics:{i18n:{noProgress:"This progress monitor was incorrectly initialized.",progress:"Progress",badProgress:"Unable to understand the progress report from the server"}},config:{progress:void 0,scope:void 0,success:void 0,failure:void 0,args:void 0,tool:void 0,delay:1E3},constructor:function(a){this.mixins["Voyant.util.Localization"].constructor.apply(this,arguments);if(!a||!a.progress||
!a.progress.id)return Voyant.application.showError(this.localize("noProgress"));this.initConfig(a);this.callParent(arguments);this.msgbox=Ext.Msg.wait("\x26nbsp;",this.localize("progress"));this.update()},update:function(){var a=this.getProgress(),b=this.getScope(),b=b.localize?b.localize(a.code):this.localize(a.code);b=="["+a.code+"]"&&(b=a.message);this.msgbox.updateProgress(a.completion,parseInt(100*a.completion)+"%",b);if("LAUNCH"==a.status||"RUNNING"==a.status){var c=this;Ext.defer(function(){Ext.Ajax.request({url:Voyant.application.getTromboneUrl(),
params:{tool:"progress.ProgressMonitor",id:a.id}}).then(function(a,b){var f=Ext.decode(a.responseText);f&&f.progress.progress?(c.setProgress(f.progress.progress),c.update()):c.finish(!1,c.localize("badProgress"))},function(a,b){c.finish(!1,a)})},this.getDelay(),this)}else this.finish("FINISHED"==a.status,b)},finish:function(a,b){var c=a?this.getSuccess():this.getFailure(),d=this.getArgs(),e=this.getProgress(),f=this.getScope();this.close();c&&c.apply?c.apply(f,[a?d:b||e]):Voyant.application.showError(b)},
close:function(){this.msgbox.close();this.destroy()}});Ext.define("Voyant.widget.VoyantTableTransform",{extend:"Ext.panel.Panel",mixins:["Voyant.util.Localization","Voyant.util.Api","Voyant.notebook.util.Embed"],alias:"widget.voyanttabletransform",statics:{i18n:{},api:{tableHtml:void 0,tableJson:void 0,width:void 0,api:void 0}},html:"",config:{hiddenColumns:void 0},constructor:function(a){a=a||{};this.callParent(arguments)},initComponent:function(a){var b=this;a=a||{};b.mixins["Voyant.util.Api"].constructor.apply(this,arguments);this.config.api&&this.config.api.tableJson&&
...
Ext.define("Ext.ux.grid.TransformGrid",{extend:"Ext.grid.Panel",constructor:function(a,b){b=Ext.apply({},b);this.table=Ext.get(a);for(var c=b.fields||[],d=b.columns||[],e=[],f=[],g=a.query("thead th"),h=0,k=g.length,l=a.dom,m,n,q,r;h<k;++h)n=g[h],q=n.innerHTML,r="tcol-"+h,e.push(Ext.applyIf(c[h]||{},{name:r,mapping:"td:nth("+(h+1)+")/@innerHTML"})),f.push(Ext.applyIf(d[h]||{},{text:q,dataIndex:r,flex:1,tooltip:n.title,sortable:!0}));c=b.width?b.width:a.getWidth()+1;b.height&&(m=b.height);Ext.applyIf(b,
{store:{data:l,fields:e,proxy:{type:"memory",reader:{record:"tbody tr",type:"xml"}}},columns:f,width:c,height:m});this.callParent([b]);!1!==b.remove&&l.parentNode.removeChild(l)},doDestroy:function(){this.table.remove();this.tabl=null;this.callParent()}});Ext.define("Voyant.widget.CategoriesOption",{extend:"Ext.container.Container",mixins:["Voyant.util.Localization"],alias:"widget.categoriesoption",statics:{i18n:{categories:"Categories",edit:"Edit"}},config:{builderWin:void 0},initComponent:function(){var a=this.up("window").panel.getApiParam("categories"),a=a?[{name:"categories-"+a,value:a}]:[];Ext.apply(this,{layout:"hbox",items:[{xtype:"combo",queryMode:"local",triggerAction:"all",fieldLabel:this.localize("categories"),labelAlign:"right",displayField:"name",
valueField:"value",store:{fields:["name","value"],data:a},name:"category"},{width:10},{xtype:"tbspacer"},{xtype:"button",text:this.localize("edit"),ui:"default-toolbar",handler:function(){if(void 0===this.getBuilderWin()){var a=this.up("window").panel,a=Ext.create("Voyant.widget.CategoriesBuilder",{panel:a,height:.75*a.getApplication().getViewport().getHeight(),width:.75*a.getApplication().getViewport().getWidth()});a.on("close",function(a){a=a.getCategoriesId();if(void 0!==a){var b=this.down("combo"),
e="categories-"+a;b.getStore().add({name:e,value:a});b.setValue(a);this.up("window").panel.setApiParam("categories",a)}},this);this.setBuilderWin(a)}a=this.down("combo").getValue();this.getBuilderWin().setCategoriesId(a);this.getBuilderWin().show()},scope:this}]});this.callParent(arguments)}});
Ext.define("Voyant.widget.CategoriesBuilder",{extend:"Ext.window.Window",requires:["Voyant.widget.FontFamilyOption"],mixins:["Voyant.util.Localization","Voyant.util.Api","Voyant.util.CategoriesManager"],alias:"widget.categoriesbuilder",statics:{i18n:{title:"Categories Builder",terms:"Terms",term:"Term",rawFreq:"Count",relativeFreq:"Relative",categories:"Categories",addCategory:"Add Category",removeCategory:"Remove Category",removeTerms:"Remove Selected Terms",categoryName:"Category Name",add:"Add",
cancel:"Cancel",exists:"Category already exists",confirmRemove:"Are you sure you want to remove the category?",save:"Save",cancel:"Cancel",features:"Features",category:"Category",color:"Color",font:"Font",orientation:"Orientation"},api:{stopList:"auto",query:void 0},features:{color:{xtype:"colorfield",format:"#hex6"},font:{xtype:"combobox",queryMode:"local",displayField:"name",valueField:"value",store:{fields:["name","value"],data:Voyant.widget.FontFamilyOption.fonts}},orientation:{xtype:"combobox",
...
arguments);this.callParent(arguments)},initComponent:function(){Ext.apply(this,{header:!1,layout:"fit",onEsc:Ext.emptyFn,items:{xtype:"tabpanel",title:this.localize("title"),tabBarHeaderPosition:1,items:[{layout:"border",title:this.localize("categories"),items:[{title:this.localize("terms"),split:!0,width:250,region:"west",layout:"fit",items:{itemId:"terms",xtype:"grid",store:Ext.create("Voyant.data.store.CorpusTermsBuffered",{parentPanel:this}),viewConfig:{plugins:{ptype:"gridviewdragdrop",ddGroup:"terms",
copy:!0,enableDrop:!1,dragZone:{getDragText:function(){var a="";this.dragData.records.forEach(function(b){a+=b.get("term")+", "});a=a.substr(0,a.length-2);20<a.length&&(a=a.substr(0,20)+"...");return a}}}},selModel:{mode:"MULTI"},columns:[{text:this.localize("term"),dataIndex:"term",flex:1,sortable:!0},{text:this.localize("rawFreq"),dataIndex:"rawFreq",width:"autoSize",sortable:!0},{text:this.localize("relativeFreq"),dataIndex:"relativeFreq",renderer:function(a){return Ext.util.Format.number(1E6*
a,"0,000")},width:"autoSize",hidden:!0,sortable:!0}],dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"querysearchfield"}]}],listeners:{query:function(a,b){this.setApiParam("query",b);var c=this.queryById("terms").getStore();c.removeAll();c.load()},scope:this}}},{title:this.localize("categories"),itemId:"categories",region:"center",xtype:"panel",layout:{type:"hbox",align:"stretch"},scrollable:"x",dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",
items:[{text:this.localize("addCategory"),handler:function(){this.getAddCategoryWin().show()},scope:this},{text:this.localize("removeTerms"),handler:function(){this.queryById("categories").query("grid").forEach(function(a){a.getStore().remove(a.getSelection())},this)},scope:this}]}],items:[]}]},{layout:"fit",itemId:"features",title:this.localize("features"),xtype:"grid",scrollable:"y",store:Ext.create("Ext.data.JsonStore",{fields:["category"]}),columns:[{text:this.localize("category"),dataIndex:"category",
sortable:!1,hideable:!1,flex:1}]}]},buttons:[{text:this.localize("cancel"),handler:function(a){this.setCategoriesId(void 0);a.up("window").close()},scope:this},{text:this.localize("save"),handler:function(a){this.app.setColorTermAssociations();this.app.saveCategoryData().then(function(b){this.setCategoriesId(b);a.up("window").close()},function(){this.setCategoriesId(void 0);a.up("window").close()},null,this)},scope:this}],listeners:{show:function(){this.getCategoriesId()?this.app.loadCategoryData(this.getCategoriesId()).then(function(a){this.buildCategories();
this.buildFeatures()},null,null,this):(this.buildCategories(),this.buildFeatures());this.down("tabpanel").setActiveTab(0)},afterrender:function(a){a.on("loadedCorpus",function(a,c){this.setCorpus(c);this.queryById("terms").getStore().load()},a);this.panel.on("loadedCorpus",function(b,c){a.fireEvent("loadedCorpus",b,c)},a);this.panel.getCorpus&&this.panel.getCorpus()?a.fireEvent("loadedCorpus",a,this.panel.getCorpus()):this.panel.getStore&&this.panel.getStore()&&this.panel.getStore().getCorpus&&this.panel.getStore().getCorpus()&&
a.fireEvent("loadedCorpus",a,this.panel.getStore().getCorpus())},scope:this}});this.setAddCategoryWin(Ext.create("Ext.window.Window",{title:this.localize("addCategory"),modal:!0,closeAction:"hide",layout:"fit",items:{xtype:"form",width:300,defaults:{labelAlign:"right"},items:[{xtype:"textfield",fieldLabel:this.localize("categoryName"),name:"categoryName",allowBlank:!1,validator:function(a){return void 0===this.app.getCategoryTerms(a)?!0:this.localize("exists")}.bind(this),enableKeyEvents:!0,listeners:{keypress:function(a,
b){b.getKey()===Ext.event.Event.ENTER&&a.up("form").queryById("addCategoryButton").click()},scope:this}}],buttons:[{text:this.localize("cancel"),handler:function(a){a.up("window").close()}},{itemId:"addCategoryButton",text:this.localize("add"),handler:function(a){var b=a.up("form");b.isValid()&&(b=b.getValues().categoryName,this.addCategory(b),a.up("window").close())},scope:this}]},listeners:{show:function(a){a=a.down("form").getForm();a.reset();a.clearInvalid()}}}));this.callParent(arguments)},addCategory:function(a){this.app.addCategory(a);
this.queryById("features").getStore().add({category:a});var b=[],c=this.app.getCategoryTerms(a);if(void 0!==c)for(var d=0;d<c.length;d++)b.push({term:c[d]});var e=this.queryById("categories").add({xtype:"grid",category:a,title:a,frame:!0,width:150,margin:"10 0 10 10",layout:"fit",tools:[{type:"close",tooltip:this.localize("removeCategory"),callback:function(b){Ext.Msg.confirm(this.localize("removeCategory"),this.localize("confirmRemove"),function(b){"yes"===b&&this.removeCategory(a)},this)},scope:this}],
store:Ext.create("Ext.data.JsonStore",{data:b,fields:["term"]}),viewConfig:{plugins:{ptype:"gridviewdragdrop",ddGroup:"terms",dragZone:{getDragText:function(){var a="";this.dragData.records.forEach(function(b){a+=b.get("term")+", "});return a.substr(0,a.length-2)}}}},selModel:{mode:"MULTI"},columns:[{dataIndex:"term",flex:1,sortable:!0}],listeners:{beforedrop:function(a,b){for(var c=this.up("categoriesbuilder").app,d=b.records.length-1;0<=d;d--){var e=b.records[d].get("term");void 0!==c.getCategoryForTerm(e)&&
b.records.splice(d,1)}},drop:function(b,c){c.view.getSelectionModel().deselectAll();this.getSelectionModel().deselectAll();for(var d=this.up("categoriesbuilder").app,e=[],f=0;f<c.records.length;f++){var n=c.records[f].get("term");void 0===d.getCategoryForTerm(n)&&e.push(n)}d.addTerms(a,e);f=c.view.up("grid");f.category&&d.removeTerms(f.category,e)}}}),f=new Ext.Editor({updateEl:!0,alignment:"l-l",autoSize:{width:"boundEl"},field:{xtype:"textfield",allowBlank:!1,validator:function(a){return void 0===
this.app.getCategoryTerms(a)||a===e.getTitle()?!0:this.localize("exists")}.bind(this)},listeners:{complete:function(a,b,c){this.app.renameCategory(c,b);this.buildFeatures()},scope:this}});e.header.getTitle().textEl.on("dblclick",function(a,b){f.startEdit(b)})},removeCategory:function(a){var b=this.queryById("categories"),c=b.queryBy(function(b){return b.category&&b.category==a?!0:!1});b.remove(c[0]);b=this.queryById("features").getStore();b.removeAt(b.findExact("category",a));this.app.removeCategory(a)},
addFeature:function(a){this.app.addFeature(a);this.buildFeatures()},buildFeatures:function(){this.queryById("features").getStore().removeAll();var a=["category"],b=[{sortable:!1,text:this.localize("category"),dataIndex:"category",flex:1}],c=[],d;for(d in this.app.getCategories())c.push({category:d});var e=this.app.getFeatures(),f=Ext.ClassManager.getClass(this).features,g;for(g in e){a.push(g);var e=f[g],h=Ext.applyIf({feature:g,listeners:{change:function(a,b){if(a.rendered){var c=a.up("gridview").indexOf(a.el.up("table")),
d=a.up("grid").getStore().getAt(c);d?(c=d.get("category"),this.app.setCategoryFeature(c,a.feature,b)):window.console&&console.warn("no record for",c,a)}},scope:this}},e);e.listeners&&Ext.applyIf(h.listeners,e.listeners);b.push({sortable:!1,hideable:!1,text:this.localize(g),dataIndex:g,flex:.5,xtype:"widgetcolumn",widget:h});for(d in this.app.getCategories())for(e=this.app.getCategoryFeature(d,g),h=0;h<c.length;h++)if(c[h].category==d){c[h][g]=e;break}}a=Ext.create("Ext.data.JsonStore",{fields:a,data:c});
this.queryById("features").reconfigure(a,b)},buildCategories:function(){this.queryById("categories").removeAll();var a=this.app.getCategories(),b;for(b in a)this.addCategory(b)}});Ext.define("Voyant.widget.VoyantNetworkGraph",{extend:"Ext.panel.Panel",mixins:["Voyant.util.Localization","Voyant.util.Api","Voyant.notebook.util.Embed"],embeddable:["Voyant.widget.VoyantNetworkGraph"],alias:"widget.voyantnetworkgraph",statics:{i18n:{},api:{jsonData:void 0,docId:void 0,docIndex:void 0,json:void 0,api:void 0}},config:{vis:void 0,visLayout:void 0,nodeData:void 0,edgeData:void 0,nodeSelection:void 0,edgeSelection:void 0,currentNode:void 0,currentEdge:void 0,zoom:void 0,zoomExtent:[.25,
...
4});this.getEdgeSelection().call(this.applyEdgeStyle.bind(this));this.getNodeSelection().call(this.applyNodeStyle.bind(this));this.getVisLayout().nodes(b);this.getVisLayout().force("link").links(a);this.getVisLayout().alpha(1).restart()}},zoomToFit:function(a,b){var c=this.getVis().node().getBBox(),d=c.width,e=c.height,f=c.x+d/2,g=c.y+e/2,c=this.getVis().node().parentElement,h=c.getBoundingClientRect(),k=h.width,h=h.height,d=(a||.8)/Math.max(d/k,e/h),f=[k/2-d*f,h/2-d*g];d3.select(c).transition().duration(b||
500).call(this.getZoom().transform,d3.zoomIdentity.translate(f[0],f[1]).scale(d))},nodeScaling:function(a,b,c,d){return a===b?.5:Math.max(0,1/(b-a)*(d-a))},applyNodeStyle:function(a,b){var c=void 0===b?"normal":b,d=this.getGraphStyle().node[c];a.selectAll(":not(text)").style("fill",function(a){return d.fill}.bind(this)).style("fill-opacity",function(a){return d.fillOpacity}.bind(this)).style("stroke",function(a){return d.stroke}.bind(this)).style("stroke-opacity",function(a){return d.strokeOpacity}.bind(this)).style("stroke-width",
function(a){return d.strokeWidth}.bind(this))},applyEdgeStyle:function(a,b){var c=void 0===b?"normal":b,d=this.getGraphStyle().edge[c];a.style("stroke",function(a){return d.stroke}.bind(this)).style("stroke-opacity",function(a){return d.strokeOpacity}.bind(this))},edgeMouseOver:function(a){this.getEdgeSelection().call(this.applyEdgeStyle.bind(this));this.getVis().select("#"+a.id).call(this.applyEdgeStyle.bind(this),"highlight")},edgeMouseOut:function(a){this.getEdgeSelection().call(this.applyEdgeStyle.bind(this))},
nodeMouseOver:function(a){this.setCurrentNode(a);this.getNodeSelection().call(this.applyNodeStyle.bind(this));this.getEdgeSelection().each(function(b){var c;b.source.id==a.id?c=b.target.id:b.target.id==a.id&&(c=b.source.id);void 0!==c&&(this.getVis().select("#"+c).call(this.applyNodeStyle.bind(this),"highlight"),this.getVis().select("#"+b.id).call(this.applyEdgeStyle.bind(this),"highlight"))}.bind(this));this.getVis().select("#"+a.id).call(this.applyNodeStyle.bind(this),"highlight")},nodeMouseOut:function(a){this.getNodeSelection().call(this.applyNodeStyle.bind(this));
this.getEdgeSelection().call(this.applyEdgeStyle.bind(this))}});Ext.define("Voyant.panel.Panel",{mixins:["Voyant.util.Localization","Voyant.util.Api","Voyant.util.Toolable","Voyant.util.DetailedError"],requires:["Voyant.widget.QuerySearchField","Voyant.widget.StopListOption","Voyant.widget.CategoriesOption","Voyant.widget.TotalPropertyStatus"],alias:"widget.voyantpanel",statics:{i18n:{},config:{corpusValidated:!1},api:{corpus:void 0,input:void 0,inputFormat:void 0,subtitle:void 0}},config:{corpus:void 0},constructor:function(a){this.mixins["Voyant.util.Api"].constructor.apply(this,
...
" \x3cspan class\x3d'subtitle'\x3e"+b.getFullLabel()+"\x3c/span\x3e");b.loadDocumentTerms(Ext.apply(this.getApiParams(["stopList"]),{limit:100})).then(function(c){a.terms={};c.each(function(b){a.terms[b.getTerm()]=b.getRawFreq()});c=Object.keys(a.terms).map(function(b){return a.terms[b]});a.minFreq=Ext.Array.min(c);a.maxFreq=Ext.Array.max(c);a.getCorpus().loadTokens({whitelist:Object.keys(a.terms),noOthers:!0,limit:0,docIndex:a.getApiParam("docIndex")}).then(function(c){var e=[];c.each(function(a){e.push(a.getTerm().toLowerCase())});
...
c,d){var e=[];a.forEach(function(a,b){e.push(a.get("term"))},this);this.getDocTermsFromQuery(e)},scope:this,params:{limit:this.getApiParam("query")?void 0:5,stopList:this.getApiParams("stopList"),query:this.getApiParam("query")}})},getDocTermsFromQuery:function(a){a&&this.setApiParam("query",a);this.getCorpus()&&this.isVisible()&&this.getDocTermStore().load({params:this.getApiParams()})},reloadTermsData:function(){var a=[],b;for(b in this.getBubblelines().currentTerms)a.push(b);this.getDocTermsFromQuery(a)},
...
c){return-1!=a.indexOf(c)},this))},processTerms:function(a){var b,c=a.get("term");b=a.get("rawFreq");var d=a.get("positions");if(0<b){var e=this.getApplication().getColorForTerm(c);-1===this.getTermStore().find("term",c)&&(this.getTermStore().loadData([[c,e]],!0),c=this.getTermStore().find("term",c),this.down("#termsView").select(c,!0));a=a.get("distributions");b={positions:d,distributions:a,rawFreq:b,color:e}}else b=!1;return b},bubbleClickHandler:function(a){this.getApplication().dispatchEvent("termsClicked",
...
this.queryById("sendToVoyant").setDisabled(!0);this.queryById("export").setDisabled(!0);if(a&&0<a.length){this.mask(this.localize("loading"));var d=this.getCorpus().getDocumentQueryMatches();d.load({params:{query:a,includeDocIds:!0},callback:function(a,f,g){this.unmask();if(a&&0<a.length){this.queryById("status").setHtml(a.length);var h="\x3cul\x3e",k=[];a.forEach(function(a){a.getDocIds().forEach(function(a){k.push(a);var e=d.getCorpus().getDocument(a),f="\x3cli id\x3d'"+c.getId()+"_"+a+"' class\x3d'cataloguedoc'\x3e",
f=f+("\x3ca href\x3d'#' class\x3d'cataloguedoctitle' data\x3d'"+a+"'\x3e"+e.getTitle()+"\x3c/a\x3e");for(facet in b)if(0!=b[facet].length){var g="";if("facet.title"!=facet){var l=facet.replace(/^.+?\./,"");if(a=e.get(l)){var m=Ext.isArray(a);m?g+="\x3cli\x3e"+l+"\x3cul\x3e":a=[a];a.forEach(function(a){var c=!1;b[facet].forEach(function(b){b.label==a?c=!0:-1==b.facet.indexOf("facet")&&b.label.split(/\W+/).forEach(function(b){0<b.trim().length&&-1<a.toLowerCase().indexOf(b.toLowerCase())&&(c=!0)})});
g+="\x3cli\x3e"+(m?"":l.replace("extra.","")+": ")+(c?'\x3cspan class\x3d"keyword"\x3e'+a+"\x3c/span\x3e":a)+"\x3c/li\x3e"});m&&(g+="\x3c/ul\x3e\x3c/li\x3e")}}g&&(f+="\x3cul\x3e"+g+"\x3c/ul\x3e")}h+=f+"\x3c/li\x3e"})});h+="\x3c/ul\x3e";c.update(h);var l=this;a=c.query(".cataloguedoctitle");a.forEach(function(a){Ext.get(a).on("click",function(a,b){this.dispatchEvent("documentSelected",l,b.getAttribute("data"))},l)});1==a.length&&this.dispatchEvent("documentSelected",l,a[0].getAttribute("data"));this.queryById("status").update((new Ext.XTemplate(this.localize("queryMatches"))).apply([k.length,
this.getCorpus().getDocumentsCount()]));this.setMatchingDocIds(Ext.Array.clone(k));0<k.length&&(this.queryById("export").setDisabled(!1),this.queryById("sendToVoyant").setDisabled(!1));b.lexical&&(a=k.splice(0,5),this.loadSnippets(a,c.first().first()),k&&0<k.length&&this.loadSnippets(k))}},scope:this})}},loadSnippets:function(a,b){var c=this.queryById("results").getTargetEl(),d=this.getFacets();if(d.lexical){var d=d.lexical.map(function(a){return a.facet+":"+a.label}),e=this.getCorpus().getContexts({buffered:!1});
b&&b.mask(this.localize("loadingSnippets"));e.load({method:"POST",params:{stripTags:"all",query:d,docId:a,perDocLimit:3,limit:100,accurateTotalNotNeeded:!0},scope:this,callback:function(a,d,e){b&&b.unmask();if(e&&Ext.isArray(a)&&0<a.length){var k={};a.forEach(function(a){k[a.getDocIndex()]||(k[a.getDocIndex()]=[]);k[a.getDocIndex()].push(a)});for(docIndex in k)d=this.getCorpus().getDocument(docIndex).getId(),a='\x3cli style\x3d"list-style-type: none; font-size: smaller;"\x3e'+k[docIndex].map(function(a){return a.getHighlightedContext()}).join(" \u2026 ")+
...
changecomplete:function(a,c){this.setApiParams({visible:c});this.loadFromTermsRecords()},scope:this}}]}]});this.callParent(arguments)},listeners:{boxready:function(){this.initVisLayout();var a=this.getApiParam("inlineData");void 0!==a&&(a=Ext.decode(a,!0),null!==a&&(this.setApiParam("inlineData",a),this.setTerms(a),this.buildFromTerms()))},resize:function(a,b,c){this.getVisLayout()&&this.getCorpus()&&(this.setAdjustedSizes(),a=this.getLayout().getRenderTarget(),b=a.getWidth(),c=a.getHeight(),a.down("svg").set({width:b,
height:c}),this.getTerms()&&this.getVisLayout().size([b,c]).stop().words(this.getTerms()).start())},loadedCorpus:function(a,b){this.initVisLayout();this.getApiParam("docIndex")?this.fireEvent("documentSelected",this,b.getDocument(this.getApiParam("docIndex"))):this.getApiParam("docId")?this.fireEvent("documentSelected",this,b.getDocument(this.getApiParam("docId"))):this.loadFromCorpus(b)},corpusSelected:function(a,b){this.loadFromCorpus(b)},documentSelected:function(a,b){if(b){var c=this.getCorpus();
b=c.getDocument(b);this.setApiParam("docId",b.getId());c=b.getDocumentTerms({autoload:!1,corpus:c,pageSize:this.getApiParam("maxVisible"),parentPanel:this});this.loadFromDocumentTerms(c)}},ensureCorpusView:function(a,b){this.getMode()!=this.MODE_CORPUS&&this.loadFromCorpus(b)}},loadFromCorpus:function(a){void 0===this.getApiParam("inlineData")&&(this.setApiParams({docId:void 0,docIndex:void 0}),this.loadFromCorpusTerms(a.getCorpusTerms({autoload:!1,pageSize:this.getApiParam("maxVisible"),parentPanel:this})))},
loadFromDocumentTerms:function(a){a.load({callback:function(a,c,d){this.setMode(this.MODE_DOCUMENT);this.setRecords(c.getRecords());this.loadFromTermsRecords()},scope:this,params:this.getApiParams()})},loadFromCorpusTerms:function(a){a.load({callback:function(a,c,d){this.setMode(this.MODE_CORPUS);this.setRecords(c.getRecords());this.loadFromTermsRecords()},scope:this,params:this.getApiParams()})},loadFromTermsRecords:function(){var a=this.getRecords(),b=this.getApiParam("visible");b>a.length&&(b=
a.length);for(var c=[],d=0;d<b;d++)c.push({text:a[d].get("term").replace(/"/g,""),rawFreq:a[d].get("rawFreq")});this.setTerms(c);this.buildFromTerms()},initVisLayout:function(a){if(a||void 0==this.getVisLayout())if(a=this.getApiParam("cirrusForceFlash"),"true"==a||!0===a){this.setApiParam("cirrusForceFlash",!0);a=this.getCirrusId();for(var b={id:a},c=["background","fade","smoothness","diagonals"],d=0;d<c.length;d++)b[c[d]]=this.getApiParam(c[d]);c='\x3cscript type\x3d"text/javascript" src\x3d"'+this.getApplication().getBaseUrl()+
'resources/swfobject/swfobject.js"\x3e\x3c/script\x3e';this.update(c+('\x3cscript type\x3d"text/javascript"\x3ecirrusClickHandler'+a+' \x3d function(word, value) {\n\tif (window.console \x26\x26 console.info) console.info(word, value);\n\tvar cirrusTool \x3d Ext.getCmp("'+this.id+'");\n\tcirrusTool.dispatchEvent("termsClicked", cirrusTool, [word]);\n}\ncirrusLoaded'+a+' \x3d function() {\n\tif (window.console \x26\x26 console.info) console.info("cirrus flash loaded");\n}\ncirrusPNGHandler'+a+' \x3d function(base64String) {\n\tvar cirrusTool \x3d Ext.getCmp("'+
this.id+'");\n\tcirrusTool.cirrusPNGHandler(base64String);\n}\x3c/script\x3e'),!0,function(){function a(c){if("undefined"!==typeof swfobject){var d=c.getLayout().getRenderTarget(),h=d.getWidth(),d=d.getHeight(),k=c.getApplication().getBaseUrl()+"resources/cirrus/flash/Cirrus.swf";c.add({xtype:"flash",id:b.id,url:k,width:h,height:d,flashVars:b,flashParams:{menu:"false",scale:"showall",allowScriptAccess:"always",bgcolor:"#222222",wmode:"opaque"}});c.cirrusFlashApp=Ext.get(b.id).first().dom}else setTimeout(a,
50,c)}a(this)},this)}else d=this.getLayout().getRenderTarget(),d.update(""),a=d.getWidth(),c=d.getHeight(),this.setVisLayout(d3.layoutCloud().size([a,c]).overflow(!0).padding(1).rotate(function(a){return this.getApplication().getFeatureForTerm("orientation",a.text)}.bind(this)).spiral("archimedean").font(function(a){return this.getApplication().getFeatureForTerm("font",a.text)}.bind(this)).fontSize(function(a){return a.fontSize}.bind(this)).text(function(a){return a.text}).on("end",this.draw.bind(this))),
d=d3.select(d.dom).append("svg").attr("id",this.getCirrusId()).attr("class","cirrusGraph").attr("width",a).attr("height",c),this.setVis(d.append("g").attr("transform","translate("+a/2+","+c/2+")")),void 0===this.getTip()&&this.setTip(Ext.create("Ext.tip.Tip",{}))},buildFromTerms:function(){var a=this.getTerms();if(this.rendered&&a)if(!0===this.getApiParam("cirrusForceFlash"))if(void 0!==this.cirrusFlashApp&&void 0!==this.cirrusFlashApp.clearAll){for(var b=[],c=0;c<a.length;c++){var d=a[c];!d.text&&
d.term&&(d.text=d.term);b.push({word:d.text,size:d.rawFreq,label:d.rawFreq})}this.cirrusFlashApp.clearAll();this.cirrusFlashApp.addWords(b);this.cirrusFlashApp.arrangeWords()}else Ext.defer(this.buildFromTerms,50,this);else{b=1E3;d=-1;for(c=0;c<a.length;c++){var e=a[c].rawFreq;e<b&&(b=e);e>d&&(d=e)}this.setSmallestWordSize(b);this.setLargestWordSize(d);this.setRelativeSizes();this.setAdjustedSizes();this.getVisLayout().words(a).start()}else Ext.defer(this.buildFromTerms,50,this)},draw:function(a,
b){var c=this;this.getLayout().getRenderTarget();var d=this.getVisLayout().size()[0],e=this.getVisLayout().size()[1],f=b?Math.min(d/Math.abs(b[1].x-d/2),d/Math.abs(b[0].x-d/2),e/Math.abs(b[1].y-e/2),e/Math.abs(b[0].y-e/2))/2:1,g=d3.transition().duration(1E3),h=this.getVis().selectAll("text").data(a,function(a){return a.text});h.exit().transition(g).style("font-size","1px").remove();var k=h.enter().append("text").text(function(a){return a.text}).attr("text-anchor","middle").attr("data-freq",function(a){return a.rawFreq}).attr("transform",
function(a){return"translate("+[a.x,a.y]+")rotate("+a.rotate+")"}).style("font-family",function(a){return c.getApplication().getFeatureForTerm("font",a.text)}).style("fill",function(a){return c.getApplication().getColorForTerm(a.text,!0)}).style("font-size","1px").on("click",function(a){c.dispatchEvent("termsClicked",c,[a.text])}).on("mouseover",function(a){this.getTip().show()}.bind(this)).on("mousemove",function(a){var b=this.getTip();b.update(a.text+": "+a.rawFreq);a=Ext.get(this.getCirrusId()).dom;
a=d3.mouse(a);a[1]+=30;b.setPosition(a)}.bind(this)).on("mouseout",function(a){this.getTip().hide()}.bind(this));h.merge(k).transition(g).style("font-family",function(a){return c.getApplication().getFeatureForTerm("font",a.text)}).style("fill",function(a){return c.getApplication().getColorForTerm(a.text,!0)}).attr("transform",function(a){return"translate("+[a.x,a.y]+")rotate("+a.rotate+")"}).style("font-size",function(a){return a.fontSize+"px"});this.getVis().transition(g).attr("transform","translate("+
d/2+","+e/2+")scale("+f+")")},map:function(a,b,c,d,e){return d+(a-b)/(c-b)*(e-d)},calculateSizeAdjustment:function(){var a=this.getTerms();if(void 0!==a){var b=this.getLayout().getRenderTarget(),b=b.getWidth()*b.getHeight();1E5>b?this.setMinFontSize(8):this.setMinFontSize(12);for(var c=0,d=0;d<a.length;d++)var e=this.calculateWordArea(a[d]),c=c+e;this.setSizeAdjustment(b/c)}},calculateWordArea:function(a){for(var b=Math.log(10*a.relativeSize)*Math.LOG10E,c=(b+a.relativeSize)/2,d=0,e=0;e<a.text.length;e++)var f=
a.text.charAt(e),d="f"==f||"i"==f||"j"==f||"l"==f||"r"==f||"t"==f?d+b/3:"m"==f||"w"==f?d+b/(4/3):d+b/1.9;return c*d},setAdjustedSizes:function(){this.calculateSizeAdjustment();var a=this.getTerms();if(void 0!==a)for(var b=0;b<a.length;b++){var c=a[b],d=this.findNewRelativeSize(c);c.fontSize=d>this.getMinFontSize()?d:this.getMinFontSize()}},setRelativeSizes:function(){var a=this.getTerms();if(void 0!==a)for(var b=0;b<a.length;b++){var c=a[b];c.relativeSize=this.map(c.rawFreq,this.getSmallestWordSize(),
this.getLargestWordSize(),.1,1)}},findNewRelativeSize:function(a){var b=this.getSizeAdjustment(),b=this.calculateWordArea(a)*b;return(Math.sqrt(6)*Math.sqrt(6*Math.pow(a.text.length,2)+b*a.text.length)-6*a.text.length)/(2*a.text.length)}});Ext.define("Voyant.panel.CollocatesGraph",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.collocatesgraph",statics:{i18n:{},api:{query:void 0,mode:void 0,limit:5,stopList:"auto",terms:void 0,context:5,centralize:void 0,categories:void 0},glyph:"xf1e0@FontAwesome"},config:{options:[{xtype:"stoplistoption"},{xtype:"categoriesoption"}],nodeData:void 0,linkData:void 0,visId:void 0,vis:void 0,visLayout:void 0,nodes:void 0,links:void 0,zoom:void 0,dragging:!1,contextMenu:void 0,currentNode:void 0,
networkMode:void 0,graphStyle:{keywordNode:{normal:{fill:"#c6dbef",stroke:"#6baed6"},highlight:{fill:"#9ecae1",stroke:"#3182bd"}},contextNode:{normal:{fill:"#fdd0a2",stroke:"#fdae6b"},highlight:{fill:"#fd9a53",stroke:"#e6550d"}},link:{normal:{stroke:"#000000",strokeOpacity:.1},highlight:{stroke:"#000000",strokeOpacity:.5}}},graphPhysics:{defaultMode:{damping:.4,centralGravity:.1,nodeGravity:-50,springLength:100,springStrength:.25,collisionScale:1.25},centralizedMode:{damping:.4,centralGravity:.1,
nodeGravity:-1,springLength:200,springStrength:1,collisionScale:1}}},DEFAULT_MODE:0,CENTRALIZED_MODE:1,constructor:function(a){this.setNodeData([]);this.setLinkData([]);this.setVisId(Ext.id(null,"links_"));this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(){Ext.apply(this,{title:this.localize("title"),dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"querysearchfield"},{text:this.localize("clearTerms"),
glyph:"xf014@FontAwesome",handler:function(){this.setNodeData([]);this.setLinkData([]);this.setNetworkMode(this.DEFAULT_MODE);this.refresh()},scope:this},this.localize("context"),{xtype:"slider",itemId:"contextSlider",minValue:3,value:5,maxValue:30,increment:2,width:50,listeners:{render:function(a){a.setValue(this.getApiParam("context"))},changecomplete:function(a,b){this.setApiParam("context",a.getValue());if(this.getNetworkMode()===this.DEFAULT_MODE){var c=this.getNodeData().map(function(a){return a.term});
0<c.length&&(this.setNodeData([]),this.setLinkData([]),this.refresh(),this.loadFromQuery(c))}},scope:this}}]}]});this.setContextMenu(Ext.create("Ext.menu.Menu",{renderTo:Ext.getBody(),items:[{xtype:"box",itemId:"label",margin:"5px 0px 5px 5px",html:""},{xtype:"menuseparator"},{xtype:"menucheckitem",text:"Fixed",itemId:"fixed",listeners:{checkchange:function(a,b,c){a=this.getCurrentNode();void 0!==a&&(c={fixed:b},b?(c.fx=a.x,c.fy=a.y):(c.fx=null,c.fy=null),this.updateDataForNode(a.id,c))},scope:this}},
{xtype:"button",text:"Fetch Collocates",style:"margin: 5px;",handler:function(a,b){var c=this.getCurrentNode();void 0!==c&&(this.getNetworkMode()===this.CENTRALIZED_MODE&&(this.resetGraph(),this.setNetworkMode(this.DEFAULT_MODE),c.start=0,c.limit=this.getApiParam("limit")),this.fetchCollocatesForNode(c))},scope:this},{xtype:"button",text:"Centralize",style:"margin: 5px;",handler:function(a,b){var c=this.getCurrentNode();void 0!==c&&this.doCentralize(c.term);this.getContextMenu().hide()},scope:this},
{xtype:"button",text:"Remove",style:"margin: 5px;",handler:function(a,b){var c=this.getCurrentNode();void 0!==c&&this.removeNode(c.id);a.up("menu").hide()},scope:this}]}));this.on("loadedCorpus",function(a,b){this.isVisible()&&this.initLoad()},this);this.on("activate",function(){this.getCorpus()&&0===this.getNodeData().length&&Ext.Function.defer(this.initLoad,100,this)},this);this.on("query",function(a,b){this.loadFromQuery(b)},this);this.on("resize",function(a,b,c){if(a=Ext.get(this.getVisId()))c=
this.body,b=c.getHeight(),c=c.getWidth(),a.el.dom.setAttribute("width",c),a.el.dom.setAttribute("height",b),this.getVisLayout().force("x",d3.forceX(c/2)).force("y",d3.forceY(b/2)),Ext.Function.defer(this.zoomToFit,100,this)},this);this.callParent(arguments)},initLoad:function(){this.initGraph();this.setNetworkMode(this.DEFAULT_MODE);if(this.getApiParam("centralize")){this.setNetworkMode(this.CENTRALIZED_MODE);var a=this.getApiParam("centralize");this.doCentralize(a)}else{var a=3,b=this.getApiParam("query");
void 0!==b&&(a=b.split(",").length);this.getCorpus().getCorpusTerms({autoLoad:!1}).load({params:{limit:a,query:b,stopList:this.getApiParam("stopList")},callback:function(a,b,e){e&&this.loadFromCorpusTermRecords(a)},scope:this})}},loadFromQuery:function(a){this.setApiParams({mode:"corpus"});var b=this.getApiParams();(Ext.isString(a)?[a]:a).forEach(function(a){this.getCorpus().getCorpusCollocates({autoLoad:!1}).load({params:Ext.apply(Ext.clone(b),{query:a}),callback:function(a,b,c){c&&this.loadFromCorpusCollocateRecords(a)},
scope:this})},this)},loadFromCorpusTermRecords:function(a){if(Ext.isArray(a)&&0<a.length){var b=[];a.forEach(function(a){b.push(a.getTerm())});this.loadFromQuery(b)}},loadFromCorpusCollocateRecords:function(a,b){if(Ext.isArray(a)){var c=this.getApiParam("limit"),d=this.getLayout().getRenderTarget(),e=d.getWidth()/2,f=d.getHeight()/2,g={};this.getNodeData().forEach(function(a){g[a.id]=!0},this);var h=[],k=[];a.forEach(function(a,d){var n=a.getTerm(),q=a.getContextTerm(),r=a.getKeywordRawFreq(),p=a.getContextTermRawFreq(),
u=r,v=p;this.getNetworkMode()===this.CENTRALIZED_MODE&&(u=0,v=Math.log(p));var s=void 0,s=void 0;0==d&&(void 0===b&&(b=this.idGet(n)),void 0!==g[b]?this.updateDataForNode(b,{title:n+" ("+r+")",type:"keyword",value:u}):(g[b]=!0,s={id:b,term:n,title:n+" ("+r+")",type:"keyword",value:u,start:c,fixed:!1,x:e,y:f},h.push(s)));if(n!=q){n=this.idGet(q);void 0===g[n]&&(g[n]=!0,s={id:n,term:q,title:q+" ("+p+")",type:"context",value:v,start:0,fixed:!1,x:e,y:f},h.push(s));q=null;p=this.getLinkData();for(v=0;v<
p.length;v++)if(r=p[v],r.source.id==b&&r.target.id==n||r.source.id==n&&r.target.id==b){q=r;break}p=a.getContextTermRawFreq();null===q&&k.push({source:b,target:n,value:p,id:b+"-"+n})}},this);this.setNodeData(this.getNodeData().concat(h));this.setLinkData(this.getLinkData().concat(k));this.refresh()}},idGet:function(a){return a.replace(/\W/g,"_")},updateDataForNode:function(a,b){for(var c=this.getNodeData(),d=0;d<c.length;d++)if(c[d].id===a){Ext.apply(c[d],b);break}},removeNode:function(a,b){for(var c=
this.getNodeData(),d=0;d<c.length;d++)if(c[d].id===a){c.splice(d,1);break}c=this.getLinkData();for(d=c.length-1;0<=d;d--)c[d].source.id!==a&&c[d].target.id!==a||c.splice(d,1);this.refresh()},doCentralize:function(a){this.resetGraph();this.setNetworkMode(this.CENTRALIZED_MODE);a={id:this.idGet(a),term:a,title:a+" (1)",type:"keyword",value:1E3,start:0};this.setNodeData([a]);this.refresh();var b=this.getApiParam("limit");this.setApiParam("limit",150);this.fetchCollocatesForNode(a);this.setApiParam("limit",
b)},applyNetworkMode:function(a){if(this.getVisLayout()){if(a===this.DEFAULT_MODE){var b=this.getGraphPhysics().defaultMode;this.getVisLayout().velocityDecay(b.damping).force("link",d3.forceLink().id(function(a){return a.id}).distance(b.springLength).strength(b.springStrength)).force("charge",d3.forceManyBody().strength(b.nodeGravity)).force("collide",d3.forceCollide(function(a){return Math.sqrt(a.bbox.width*a.bbox.height)*b.collisionScale}))}else b=this.getGraphPhysics().centralizedMode,this.getVisLayout().velocityDecay(b.damping).force("link",
d3.forceLink().id(function(a){return a.id}).distance(b.springLength).strength(b.springStrength)).force("charge",d3.forceManyBody().strength(function(a){return"keyword"===a.type?-1E4:0})).force("collide",d3.forceCollide(function(a){return"keyword"===a.type?a.value:Math.sqrt(a.bbox.width*a.bbox.height)*b.collisionScale}));this.getVisLayout().force("x").strength(b.centralGravity);this.getVisLayout().force("y").strength(b.centralGravity)}return a},initGraph:function(){var a=this.getLayout().getRenderTarget();
a.update("");var b=a.getWidth(),c=a.getHeight();this.setVisLayout(d3.forceSimulation().force("x",d3.forceX(b/2)).force("y",d3.forceY(c/2)).on("tick",function(){this.getLinks().attr("x1",function(a){return a.source.x}).attr("y1",function(a){return a.source.y}).attr("x2",function(a){return a.target.x}).attr("y2",function(a){return a.target.y});this.getNodes().attr("transform",function(a){var b=a.x,c=a.y;if(this.getNetworkMode()===this.DEFAULT_MODE||"keyword"!==a.type)b-=.5*a.bbox.width,c-=.5*a.bbox.height;
return"translate("+b+","+c+")"}.bind(this));!this.getDragging()&&.075>this.getVisLayout().alpha()&&this.getVisLayout().alpha(-1)}.bind(this)).on("end",function(){Ext.Function.defer(this.zoomToFit,100,this)}.bind(this)));var a=d3.select(a.dom).append("svg").attr("id",this.getVisId()).attr("class","linksGraph").attr("width",b).attr("height",c),d=a.append("g"),b=d3.zoom().scaleExtent([.25,4]).on("zoom",function(){d.attr("transform",d3.event.transform)});this.setZoom(b);a.call(b);a.on("click",function(){this.getContextMenu().hide()}.bind(this));
this.setLinks(d.append("g").attr("class","links").selectAll(".link"));this.setNodes(d.append("g").attr("class","nodes").selectAll(".node"));this.setVis(d)},resetGraph:function(){this.setNodeData([]);this.setLinkData([]);this.refresh()},refresh:function(){var a=this,b=this.getNodeData(),c=this.getLinkData(),d=this.getLinks().data(c,function(a){return a.id});d.exit().remove();var e=d.enter().append("line").attr("class","link").attr("id",function(a){return a.id}).on("mouseover",a.linkMouseOver.bind(a)).on("mouseout",
a.linkMouseOut.bind(a)).on("click",function(a){d3.event.stopImmediatePropagation();d3.event.preventDefault();this.dispatchEvent("termsClicked",this,['"'+a.source.term+" "+a.target.term+'"~'+this.getApiParam("context")])}.bind(a)).style("cursor","pointer").style("stroke-width",function(b){return a.getNetworkMode()===a.DEFAULT_MODE?Math.max(1,Math.min(15,Math.sqrt(b.value))):1});this.setLinks(e.merge(d));d=this.getNodes().data(b,function(a){return a.id});d.exit().remove();e=d.enter().append("g").attr("class",
function(a){return"node "+a.type}).attr("id",function(a){return a.id}).on("mouseover",a.nodeMouseOver.bind(a)).on("mouseout",a.nodeMouseOut.bind(a)).on("click",function(a){d3.event.stopImmediatePropagation();d3.event.preventDefault();this.dispatchEvent("termsClicked",this,[a.term])}.bind(a)).on("dblclick",function(a){d3.event.stopImmediatePropagation();d3.event.preventDefault();this.fetchCollocatesForNode(a)}.bind(a)).on("contextmenu",function(b,c){d3.event.preventDefault();var d=a.getContextMenu();
d.queryById("label").setHtml(b.term);d.queryById("fixed").setChecked(b.fixed);d.showAt(d3.event.pageX+10,d3.event.pageY-50)}).call(d3.drag().on("start",function(b){a.setDragging(!0);d3.event.active||a.getVisLayout().alpha(.3).restart();b.fx=b.x;b.fy=b.y;b.fixed=!0}).on("drag",function(b){a.getVisLayout().alpha(.3);b.fx=d3.event.x;b.fy=d3.event.y;a.isMasked()?a.isOffCanvas(d3.event.x,d3.event.y)||a.unmask():a.isOffCanvas(d3.event.x,d3.event.y)&&a.mask(a.localize("releaseToRemove"))}).on("end",function(b){a.setDragging(!1);
1!=b.fixed&&(b.fx=null,b.fy=null);a.isOffCanvas(d3.event.x,d3.event.y)&&(a.unmask(),a.mask(a.localize("cleaning")),a.removeNode(b.id),a.unmask())}));e.append("title").text(function(a){return a.title});this.getNetworkMode()===this.DEFAULT_MODE?e.append("rect").style("stroke-width",1).style("stroke-opacity",1):e.filter(function(a){return"keyword"===a.type}).append("circle").style("stroke-width",1).style("stroke-opacity",1);e.append("text").attr("font-family",function(b){return a.getApplication().getFeatureForTerm("font",
b.term)}).attr("font-size",function(a){return Math.max(10,Math.sqrt(a.value))}).text(function(a){return a.term}).each(function(a){a.bbox=this.getBBox()}).style("cursor","pointer").style("user-select","none").attr("dominant-baseline","middle");this.setNodes(e.merge(d));this.getNetworkMode()===this.DEFAULT_MODE?(this.getVis().selectAll("rect").attr("width",function(a){return a.bbox.width+16}).attr("height",function(a){return a.bbox.height+8}).attr("rx",function(a){return Math.max(2,.2*a.bbox.height)}).attr("ry",
function(a){return Math.max(2,.2*a.bbox.height)}).call(this.applyNodeStyle.bind(this)),this.getVis().selectAll("text").attr("dx",8).attr("dy",function(a){return.5*a.bbox.height+4})):(this.getVis().selectAll("circle").attr("r",function(a){return Math.min(150,a.bbox.width)}).call(this.applyNodeStyle.bind(this)),this.getVis().selectAll("text").attr("dx",function(a){return"keyword"===a.type?.5*-a.bbox.width:8}).attr("dy",function(a){return"keyword"===a.type?0:.5*a.bbox.height+4}));this.getVis().selectAll("line").call(this.applyLinkStyle.bind(this));
this.getVisLayout().nodes(b);this.getVisLayout().force("link").links(c);this.getVisLayout().alpha(1).restart()},isOffCanvas:function(a,b){var c=Ext.get(this.getVisId());return 0>a||0>b||a>c.getWidth()||b>c.getHeight()},zoomToFit:function(a,b){var c=this.getVis().node().getBBox(),d=c.width,e=c.height,f=c.x+d/2,g=c.y+e/2,c=this.getVis().node().parentElement,h=c.getBoundingClientRect(),k=h.width,h=h.height,e=(a||.8)/Math.max(d/k,e/h),f=[k/2-e*f,h/2-e*g];1>d||d3.select(c).transition().duration(b||500).call(this.getZoom().transform,
d3.zoomIdentity.translate(f[0],f[1]).scale(e))},applyNodeStyle:function(a,b){var c=void 0===b?"normal":b;a.style("fill",function(a){a=a.type+"Node";return this.getGraphStyle()[a][c].fill}.bind(this));a.style("stroke",function(a){a=a.type+"Node";return this.getGraphStyle()[a][c].stroke}.bind(this))},applyLinkStyle:function(a,b){var c=void 0===b?"normal":b;a.style("stroke",function(a){return this.getGraphStyle().link[c].stroke}.bind(this));a.style("stroke-opacity",function(a){return this.getGraphStyle().link[c].strokeOpacity}.bind(this))},
linkMouseOver:function(a){this.getVis().selectAll("line").call(this.applyLinkStyle.bind(this));this.getVis().select("#"+a.id).call(this.applyLinkStyle.bind(this),"highlight")},linkMouseOut:function(a){this.getVis().selectAll("line").call(this.applyLinkStyle.bind(this))},nodeMouseOver:function(a){this.setCurrentNode(a);this.getVis().selectAll("rect").call(this.applyNodeStyle.bind(this));this.getLinks().each(function(b){var c;b.source.id==a.id?c=b.target.id:b.target.id==a.id&&(c=b.source.id);void 0!==
c&&(this.getVis().select("#"+c+" rect").call(this.applyNodeStyle.bind(this),"highlight"),this.getVis().select("#"+b.id).call(this.applyLinkStyle.bind(this),"highlight"))}.bind(this));this.getVis().select("#"+a.id+" rect").style("stroke-width",3).call(this.applyNodeStyle.bind(this),"highlight")},nodeMouseOut:function(a){this.getContextMenu().isVisible()||this.setCurrentNode(void 0);this.getVis().selectAll("rect").style("stroke-width",1).call(this.applyNodeStyle.bind(this));this.getVis().selectAll("line").call(this.applyLinkStyle.bind(this))},
fetchCollocatesForNode:function(a){var b=this.getApiParam("limit");this.getCorpus().getCorpusCollocates({autoLoad:!1}).load({params:Ext.apply(this.getApiParams(),{query:a.term,start:a.start,limit:b}),callback:function(c,d,e){e&&(this.updateDataForNode(a.id,{start:a.start+b}),this.loadFromCorpusCollocateRecords(c,a.id))},scope:this})}});Ext.define("Voyant.panel.Contexts",{extend:"Ext.grid.Panel",mixins:["Voyant.panel.Panel"],requires:["Voyant.data.store.Contexts"],alias:"widget.contexts",isConsumptive:!0,statics:{i18n:{},api:{query:void 0,docId:void 0,docIndex:void 0,stopList:"auto",context:5,expand:50},glyph:"xf0ce@FontAwesome"},constructor:function(){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(){var a=this;Ext.apply(a,{title:this.localize("title"),emptyText:this.localize("emptyText"),
store:Ext.create("Voyant.data.store.ContextsBuffered",{parentPanel:this,proxy:{extraParams:{stripTags:"all"}}}),selModel:{type:"rowmodel",listeners:{selectionchange:{fn:function(a,c){this.getApplication().dispatchEvent("termLocationClicked",this,c)},scope:this}}},plugins:[{ptype:"rowexpander",rowBodyTpl:new Ext.XTemplate("")}],dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"querysearchfield"},{xtype:"totalpropertystatus"},this.localize("context"),{xtype:"slider",
minValue:5,value:5,maxValue:50,increment:5,width:50,listeners:{render:function(b){b.setValue(a.getApiParam("context"))},changecomplete:function(b,c){a.setApiParam("context",b.getValue());a.getStore().clearAndLoad({params:a.getApiParams()})}}},this.localize("expand"),{xtype:"slider",minValue:5,value:5,maxValue:500,increment:10,width:50,listeners:{render:function(b){b.setValue(a.getApiParam("expand"))},changecomplete:function(b,c){a.setApiParam("expand",c);var d=a.getView(),e=a.plugins[0].recordsExpanded,
f=d.getStore(),g;for(g in e){var h=f.getByInternalId(g),k=d.getRow(h),l=k.parentNode.childNodes[1];e[g]?d.fireEvent("expandbody",k,h,l,{force:!0}):Ext.fly(l).down(".x-grid-rowbody").setHtml("")}}}},{xtype:"corpusdocumentselector"}]}],columns:[{text:this.localize("document"),toolTip:this.localize("documentTip"),width:"autoSize",dataIndex:"docIndex",sortable:!0,renderer:function(a,c,d,e,f,g){return g.getCorpus().getDocument(a).getTinyLabel()}},{text:this.localize("left"),tooltip:this.localize("leftTip"),
...
this.getStore().clearAndLoad())},documentsSelected:function(a,c){var d=[],e=this.getStore().getCorpus();c.forEach(function(a){d.push(e.getDocument(a).getId())},this);this.setApiParams({docId:d,docIndex:void 0});this.getStore().clearAndLoad()},documentSegmentTermClicked:{fn:function(a,c){c.term&&(params={query:c.term},c.docId?params.docId=c.docId:params.docIndex=c.docIndex?c.docIndex:0,this.setApiParams(params),this.isVisible()&&this.getStore().clearAndLoad())},scope:this},documentIndexTermsClicked:{fn:function(a,
c){var d={},e=[],f={},g=[];c.forEach(function(a){d[a.term]||(e.push(a.term),d[a.term]=!0);f[a.docIndex]||(g.push(a.docIndex),f[a.docIndex]=!0)});this.setApiParams({docId:void 0,docIndex:g,query:e});this.isVisible()&&this.getStore().clearAndLoad({params:this.getApiParams()})},scope:this},afterrender:function(a){a.getView().on("expandbody",function(c,d,e,f){if(""===e.innerText||f&&f.force){c=Ext.create("Voyant.data.store.Contexts",{stripTags:"all",corpus:a.getStore().getCorpus()});var g=d.getData();
c.load({params:{query:g.query,docIndex:g.docIndex,position:g.position,limit:1,context:a.getApiParam("expand")},callback:function(a,b,c){c&&1==a.length&&(g=a[0].getData(),Ext.fly(b.expandRow).down(".x-grid-rowbody").setHtml(g.left+" \x3cspan class\x3d'word keyword'\x3e"+g.middle+"\x3c/span\x3e "+g.right))},expandRow:e})}})}}});a.on("loadedCorpus",function(b,c){0==this.hasCorpusAccess(c)?this.mask(this.localize("limitedAccess"),"mask-no-spinner"):c.getCorpusTerms({autoLoad:!1}).load({callback:function(a,
b,c){c&&0<a.length&&(this.setApiParam("query",[a[0].getTerm()]),this.getStore().clearAndLoad({params:this.getApiParams()}))},scope:a,params:{limit:1,query:this.getApiParam("query"),stopList:this.getApiParam("stopList"),forTool:"contexts"}})});a.on("query",function(a,c){this.setApiParam("query",c);this.getStore().clearAndLoad({params:this.getApiParams()})},a);a.on("documentTermsClicked",function(a,c){var d=[];c.forEach(function(a){d.push({term:a.getTerm(),docIndex:a.getDocIndex()})});this.fireEvent("documentIndexTermsClicked",
...
a.embedded||a.corpus&&this.fireEvent("loadedCorpus",this,a.corpus);this.on("corpusTermsClicked",function(a,c){if(this.getStore().getCorpus()){var d=[];c.forEach(function(a){d.push(a.get("term"))});this.setApiParams({query:d,docId:void 0,docIndex:void 0});this.isVisible()&&this.loadFromApis()}});this.on("documentsClicked",function(a,c){var d=[];c.forEach(function(a){d.push(a.get("id"))});this.setApiParams({docId:d,docid:void 0,query:void 0});this.isVisible()&&this.loadFromApis()});this.on("activate",
...
dataIndex:"contextTermRawFreq",width:"autoSize",sortable:!0}],listeners:{scope:this,termsClicked:function(a,b){if(this.getStore().getCorpus()){var e=[];b.forEach(function(a){Ext.isString(a)?e.push(a):a.term?e.push(a.term):a.getTerm&&e.push(a.getTerm())});0<e.length&&(this.setApiParams({docIndex:void 0,docId:void 0,query:e}),this.isVisible()&&this.loadFromApis())}},corpusSelected:function(){this.getStore().getCorpus()&&(this.setApiParams({docId:void 0,docIndex:void 0}),this.loadFromApis())},documentsSelected:function(a,
b){var e=[],f=this.getStore().getCorpus();b.forEach(function(a){e.push(f.getDocument(a).getId())},this);this.setApiParams({docId:e,docIndex:void 0});this.loadFromApis()}}});a.callParent(arguments);a.getStore().getProxy().setExtraParam("withDistributions",!0)}});Ext.define("Voyant.widget.CorpusTermSummary",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.corpustermsummary",statics:{i18n:{title:"Corpus Term Summary: ",items:"Items",loading:"Loading...",distribution:"Distribution: ",collocates:"Collocates: ",correlations:"Correlations: ",phrases:"Phrases: "},api:{stopList:"auto",query:void 0,limit:5}},config:{corpus:void 0,record:void 0,collocatesStore:void 0,correlationsStore:void 0,phrasesStore:void 0,documentTermsStore:void 0},cls:"corpus-term-summary",
constructor:function(a){if(void 0===a.record)return console.warn("CorpusTermSummary: no config.record!"),!1;Ext.apply(this,{items:{itemId:"main",minHeight:200,scrollable:!0,margin:5},dockedItems:{dock:"bottom",xtype:"toolbar",items:{fieldLabel:this.localize("items"),labelWidth:40,width:120,xtype:"slider",increment:5,minValue:5,maxValue:59,listeners:{boxready:function(a){a.setValue(this.getApiParam("limit"))},changecomplete:function(a,b){this.setApiParam("limit",b);this.loadStuff()},scope:this}}},
listeners:{boxready:function(){this.body.on("click",function(a){(a=a.getTarget(null,null,!0))&&"A"==a.dom.tagName&&a.hasCls("corpus-type")&&this.dispatchEvent("termsClicked",this,[a.getHtml()])},this,{stopPropagation:!0});this.getDockedItems().forEach(function(a){a.getEl().on("click",null,this,{stopPropagation:!0})});this.loadStuff()},scope:this}});Ext.applyIf(a,{title:this.localize("title")+a.record.getTerm()});this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);
var b=this.getRecord().store.getCorpus();this.setCorpus(b);this.setApiParam("query",this.getRecord().getTerm());this.setCollocatesStore(Ext.create("Voyant.data.store.CorpusCollocates",{corpus:b}));this.setCorrelationsStore(Ext.create("Voyant.data.store.TermCorrelations",{corpus:b}));this.setPhrasesStore(Ext.create("Voyant.data.store.CorpusNgrams",{corpus:b}));this.setDocumentTermsStore(Ext.create("Voyant.data.store.DocumentTerms",{corpus:b}))},loadStuff:function(){this.getComponent("main").removeAll();
for(var a=[],b=0;b<this.getCorpus().getDocumentsCount();b++)a[b]=b;this.getComponent("main").add({xtype:"container",cls:"section",layout:"hbox",align:"bottom",items:[{xtype:"container",html:'\x3cdiv class\x3d"header"\x3e'+this.localize("distribution")+"\x3c/div\x3e"},{itemId:"distLine",xtype:"sparklineline",values:[],height:20,width:200}],listeners:{afterrender:function(b){b.mask(this.localize("loading"));this.getDocumentTermsStore().load({params:{query:this.getApiParam("query"),docIndex:a,withDistributions:!0,
bins:2*parseInt(this.getApiParam("limit"))},callback:function(a,e,f){f&&a&&0<a.length&&(a=a.map(function(a){return a.getDistributions()}).reduce(function(a,b){return a.concat(b)}),this.down("#distLine").setValues(a),b.unmask())},scope:this})},scope:this}});this.addSection(this.localize("collocates"),this.getCollocatesStore(),this.getApiParams(),'\x3ctpl for\x3d"." between\x3d"; "\x3e\x3ca href\x3d"#" onclick\x3d"return false" class\x3d"corpus-type keyword" voyant:recordId\x3d"{term}"\x3e{term}\x3c/a\x3e\x3cspan style\x3d"font-size: smaller"\x3e ({val})\x3c/span\x3e\x3c/tpl\x3e',
function(a){return{term:a.getContextTerm(),val:a.getContextTermRawFreq()}});this.addSection(this.localize("correlations"),this.getCorrelationsStore(),this.getApiParams(),'\x3ctpl for\x3d"." between\x3d"; "\x3e\x3ca href\x3d"#" onclick\x3d"return false" class\x3d"corpus-type keyword" voyant:recordId\x3d"{term}"\x3e{term}\x3c/a\x3e\x3cspan style\x3d"font-size: smaller"\x3e ({val})\x3c/span\x3e\x3c/tpl\x3e',function(a){return{term:a.get("source-term"),val:a.get("source").rawFreq}});this.addSection(this.localize("phrases"),
this.getPhrasesStore(),Ext.apply({minLength:3,sort:"length"},this.getApiParams()),'\x3ctpl for\x3d"."\x3e\x3cdiv\x3e\x26ldquo;{phrase}\x26rdquo;\x3c/div\x3e\x3c/tpl\x3e',function(a){return{phrase:a.getTerm()}})},addSection:function(a,b,c,d,e){return this.getComponent("main").add({xtype:"container",html:'\x3cdiv class\x3d"header"\x3e'+a+"\x3c/div\x3e",cls:"section",listeners:{afterrender:function(a){a.mask(this.localize("loading"));b.load({params:c,callback:function(b,c,k){k&&b&&0<b.length&&(a.unmask(),
Ext.dom.Helper.append(a.getTargetEl().first().first(),(new Ext.XTemplate('\x3cdiv class\x3d"contents"\x3e'+d+"\x3c/div\x3e")).apply(b.map(e))))}})},scope:this}})}});Ext.define("Voyant.panel.Correlations",{extend:"Ext.grid.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.correlations",statics:{i18n:{title:"Correlations",helpTip:"The Correlations tool enables an exploration of the extent to which term frequencies vary in sync (terms whose frequencies rise and fall together or inversely).",sourceTip:"Term 1 (the pairing is what matters, not the column)",targetTip:"Term 2 (the pairing is what matters, not the column)",trendTip:"This represents the relative frequencies of the term.",
minInDocumentsCountRatioLabel:"minimum coverage (%{0})",source:"Term 1",target:"Term 2",correlation:"Correlation (r)",correlationTip:"This is a measure of how closely term frequencies correlate (using Pearson's correlation coefficient or a simple regression). Scores approaching 1 mean that term frequencies vary in sync (they rise and drop together), scores approaching -1 mean that term frequencies vary inversely (one rises as the other dropx), scores approaching 0 indicate little or no meaningful corrlation.",
significance:"Significance (p)",significanceTip:"This is a measure of the signifiance of the correlation value. Often a significance of .05 or less indicates a strong correlation (which allows us to reject the null hypothesis that values are randomly distributed). The validity of this measure depends on assumptions about a normal distribution of the data. Also, don't forget that we typically have a relatively small number of values (frequencies from segments in a texts or from texts in a document), so these values should be used with care.",
emptyText:"(No results.)"},api:{query:void 0,docId:void 0,docIndex:void 0,stopList:"auto",minInDocumentsCountRatio:100},glyph:"xf0ce@FontAwesome"},config:{},constructor:function(){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(){var a=this;Ext.apply(a,{title:this.localize("title"),emptyText:this.localize("emptyText"),store:Ext.create("Voyant.data.store.TermCorrelationsBuffered",{parentPanel:this}),columns:[{text:this.localize("source"),
tooltip:this.localize("sourceTip"),dataIndex:"source-term",sortable:!1},{xtype:"widgetcolumn",tooltip:this.localize("trendTip"),width:100,dataIndex:"source-distributions",widget:{xtype:"sparklineline"},text:"\u2190"},{xtype:"widgetcolumn",tooltip:this.localize("trendTip"),width:100,dataIndex:"target-distributions",widget:{xtype:"sparklineline"},text:"\u2192",align:"right"},{text:this.localize("target"),tooltip:this.localize("targetTip"),dataIndex:"target-term",sortable:!1},{text:this.localize("correlation"),
tooltip:this.localize("correlationTip"),dataIndex:"correlation"},{text:this.localize("significance"),tooltip:this.localize("significanceTip"),dataIndex:"significance"}],listeners:{scope:this,corpusSelected:function(){this.setApiParams({docIndex:void 0,docId:void 0});this.getStore().getProxy().setExtraParam("tool","corpus.CorpusTermCorrelations");this.getStore().load()},documentsSelected:function(a,c){var d=[],e=this.getStore().getCorpus();c.forEach(function(a){d.push(e.getDocument(a).getId())},this);
this.setApiParams({docId:d,docIndex:void 0});this.getStore().getProxy().setExtraParam("tool","corpus.DocumentTermCorrelations");this.getStore().load()}},dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"querysearchfield"},{xtype:"totalpropertystatus"},{xtype:"tbspacer"},{xtype:"tbtext",itemId:"minInDocumentsCountRatioLabel",text:a.localize("minInDocumentsCountRatioLabel")},{xtype:"slider",increment:5,minValue:0,maxValue:100,width:75,listeners:{afterrender:function(b){b.setValue(this.getApiParam("minInDocumentsCountRatio"));
b.up("toolbar").getComponent("minInDocumentsCountRatioLabel").setText((new Ext.XTemplate(a.localize("minInDocumentsCountRatioLabel"))).apply([this.getApiParam("minInDocumentsCountRatio")]))},changecomplete:function(b,c){this.setApiParams({minInDocumentsCountRatio:c});b.up("toolbar").getComponent("minInDocumentsCountRatioLabel").setText((new Ext.XTemplate(a.localize("minInDocumentsCountRatioLabel"))).apply([c]));this.getStore().load()},scope:this}},{xtype:"corpusdocumentselector"}]}]});a.on("loadedCorpus",
function(a,c){1==c.getDocumentsCount()&&this.getStore().getProxy().setExtraParam("tool","corpus.DocumentTermCorrelations");this.isVisible()&&this.getStore().load()});a.on("activate",function(){this.getStore().getCorpus()&&this.getStore().load()},this);a.on("query",function(a,c){this.setApiParam("query",c);this.getStore().load()},a);a.callParent(arguments)}});Ext.define("Voyant.panel.CorpusCreator",{extend:"Ext.form.Panel",requires:["Ext.form.field.File"],requires:["Voyant.data.model.Corpus"],mixins:["Voyant.panel.Panel"],alias:"widget.corpuscreator",isConsumptive:!0,statics:{i18n:{},api:{inputFormat:void 0,language:void 0,xmlDocumentsXpath:void 0,xmlContentXpath:void 0,xmlTitleXpath:void 0,xmlAuthorXpath:void 0,tokenization:void 0,adminPassword:void 0,accessPassword:void 0,noPasswordAccess:void 0,tableDocuments:void 0,tableContent:void 0,tableTitle:void 0,
tableAuthor:void 0,title:void 0,subTitle:void 0,inputRemoveFrom:void 0,inputRemoveFromAfter:void 0,inputRemoveUntil:void 0,inputRemoveUntilAfter:void 0}},constructor:function(a){this.callParent(arguments);a=a||{};this.mixins["Voyant.panel.Panel"].constructor.call(this,Ext.apply(a,{includeTools:{gear:!0,help:!0,language:this.getLanguageToolMenu()}}))},initComponent:function(){var a=this;Ext.apply(a,{title:this.localize("title"),width:800,frame:!0,padding:10,style:{borderColor:"#aaa",borderStyle:"solid"},
frameHeader:!0,layout:{type:"vbox",align:"middle"},dockedItems:[{xtype:"toolbar",overflowHandler:"scroller",dock:"bottom",buttonAlign:"right",items:[{text:a.localize("Open"),glyph:"xf115@FontAwesome",tooltip:a.localize("SelectExisting"),hidden:void 0!=this.getCorpus(),handler:function(){Ext.create("Ext.window.Window",{title:a.localize("Open"),layout:"fit",modal:!0,items:{xtype:"form",submitEmptyText:!1,margin:"5,5,5,5",items:{xtype:"corpusselector"},buttons:[{text:a.localize("Open"),glyph:"xf00c@FontAwesome",
handler:function(b){b.up("form").getForm();var c=b.up("form").getForm().getValues().corpus;""!=c?(a.loadCorpus({corpus:c}),b.up("window").close()):Ext.Msg.show({title:a.localize("SelectExisting"),message:a.localize("PleaseSelectExisting"),buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR})},flex:1},{text:a.localize("cancel"),glyph:"xf00d@FontAwesome",flex:1,handler:function(a){a.up("window").close()}}]}}).show()}},{xtype:"fileuploadfield",glyph:"xf093@FontAwesome",name:"upload",buttonOnly:!0,hideLabel:!0,ui:"default-toolbar",
buttonText:a.localize("Upload"),listeners:{render:function(b){b.fileInputEl.dom.setAttribute("multiple",!0);Ext.tip.QuickTipManager.register({target:b.getEl(),text:a.localize("UploadLocal")})},beforedestroy:function(a){Ext.tip.QuickTipManager.unregister(a.getEl())},change:function(b,c){if(c){var d=b.up("form").getForm();if(d.isValid()){for(var e=b.fileInputEl.dom.files,f=/\.(png|gif|jpe?g|xls|mp[234a]|mpeg|exe|wmv|avi|ppt|mpg|tif|wav|mov|psd|wma|ai|bmp|pps|aif|pub|dwg|indd|swf|asf|mbd|dmg|flv)$/i,
g=/\.(txt|pdf|html?|xml|docx?|rtf|pages|epub|odt|zip|jar|tar|gz|ar|cpio|bzip2|bz2|gzip|xlsx?)$/i,h=[],k=[],l=0,m=e.length;l<m;l++){var n=e[l].name;f.test(n)?h.push(n.split("/").pop()):g.test(n)||k.push(n.split("/").pop())}0<h.length||0<k.length?Ext.Msg.show({title:a.localize("fileTypesWarning"),icon:Ext.MessageBox.ERROR,message:a.localize("fileTypesMessage")+"\x3cul\x3e"+(0<h.length?"\x3cli\x3e"+a.localize("badFiles")+h.slice(0,5).join(", ")+(5<h.length?"\u2026":"")+"\x3c/li\x3e":"")+(0<k.length?
"\x3cli\x3e"+a.localize("unknownFiles")+k.slice(0,5).join(", ")+(5<k.length?"\u2026":"")+"\x3c/li\x3e":"")+"\x3c/ul\x3e"+a.localize("sureContinue"),buttons:Ext.Msg.YESNO,fn:function(c){"yes"===c?a.loadForm(d):(b.reset(),b.fileInputEl.dom.setAttribute("multiple",!0))},scope:d}):a.loadForm(d)}}}}},"-\x3e",{xtype:"button",scale:"large",glyph:"xf00d@FontAwesome",text:this.localize("cancel"),hidden:void 0==this.getCorpus(),handler:function(a){(a=this.up("window"))&&a.isFloating()&&a.close()}},{xtype:"button",
scale:"large",glyph:"xf00c@FontAwesome",text:this.localize("reveal"),ui:"default",width:200,handler:function(b){var c=b.up("form").down("#input").getValue();if(""!==c){var d=a.getApiParams();delete d.view;delete d.stopList;d.inputFormat&&0!==c.trim().indexOf("\x3c")?Ext.Msg.confirm(a.localize("error"),a.localize("errorNotXmlContinue"),function(b){"yes"==b&&a.loadCorpus(Ext.apply(d,{input:c}))},a):a.loadCorpus(Ext.apply(d,{input:c}))}else Ext.Msg.show({title:a.localize("noTextProvided"),message:a.localize("pleaseProvideText"),
buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR})}}]}],items:{xtype:"textareafield",width:800,height:100,itemId:"input",emptyText:this.localize("emptyInput")}});a.on("boxready",function(a){var c=this.getApplication();c.getAllowInput&&"false"==c.getAllowInput()&&(a.hide(),Ext.create("Ext.window.Window",{layout:"fit",header:!1,modal:!0,bodyPadding:10,items:{html:"\x3cp style\x3d'color: red;'\x3e"+a.localize("noAllowInputMessage")+"\x3c/p\x3e"}}).show())});a.callParent(arguments)},loadForm:function(a){var b={tool:this.getCorpus()?
"corpus.CorpusMetadata":"corpus.CorpusCreator"};this.getCorpus()&&Ext.apply(b,{corpus:this.getCorpus().getId(),addDocuments:!0});var c=this.getApiParams();delete c.view;delete c.stopList;Ext.apply(b,c);var d=this.getApplication().getViewport();d.mask(this.localize("uploadingCorpus"));a.submit({url:this.getTromboneUrl(),params:b,failure:function(a,b){d.unmask();if(b.result&&(b.result.corpus||b.result.stepEnabledCorpusCreator)){var g={corpus:b.result.corpus?b.result.corpus.metadata.id:b.result.stepEnabledCorpusCreator.storedId};
Ext.apply(g,c);this.setCorpus(void 0);this.loadCorpus(g)}else this.showResponseError("Unable to load corpus.",b.response)},scope:this})},loadCorpus:function(a){this.getCorpus()&&Ext.apply(a,{corpus:this.getCorpus().getId(),addDocuments:!0});var b=this.up("window");b&&b.isFloating()&&b.close();this.getApplication().loadCorpusFromParams(a)},showOptionsClick:function(a){void 0===a.optionsWin&&(a.optionsWin=Ext.create("Ext.window.Window",{title:a.localize("gearWinTitle"),closeAction:"hide",layout:"fit",
bodyPadding:10,items:[{xtype:"form",defaultType:"textfield",maxHeight:a.getApplication().getViewport().getHeight()-300,scrollable:!0,fieldDefaults:{labelAlign:"right",labelWidth:110,width:350},items:[{xtype:"combo",fieldLabel:a.localize("inputFormat"),labelWidth:90,name:"inputFormat",queryMode:"local",store:[["",a.localize("inputFormatAuto")],["dtoc","DToC: Dynamic Table of Contexts"],["TEI","TEI: Text Encoding Initative"],["TEI","TEI Corpus"],["RSS","Really Simple Syndication: RSS"]],value:"",listeners:{afterrender:{fn:function(a){var c=
this.getApiParam("inputFormat");c&&a.setValue(c)},scope:a}}},{xtype:"container",html:"\x3cp\x3e\x3ci\x3e"+(new Ext.Template(a.localize("advancedOptionsText"))).applyTemplate([a.getBaseUrl()+"docs/#!/guide/corpuscreator-section-xml"])+"\x3c/i\x3e\x3c/p\x3e",width:375},{xtype:"fieldset",title:"\x3ca href\x3d'"+a.getBaseUrl()+"docs/#!/guide/corpuscreator-section-titles' target\x3d'voyantdocs'\x3e"+a.localize("corpusOptions")+"\x3c/a\x3e",collapsible:!0,collapsed:!0,defaultType:"textfield",items:[{xtype:"container",
html:"\x3cp\x3e\x3ci\x3e\x3c/i\x3e\x3c/p\x3e",width:375},{fieldLabel:a.localize("corpusTitle"),name:"title"},{fieldLabel:a.localize("corpusSubTitle"),name:"subTitle"}]},{xtype:"fieldset",title:"\x3ca href\x3d'"+a.getBaseUrl()+"docs/#!/guide/corpuscreator-section-text' target\x3d'voyantdocs'\x3e"+a.localize("textOptions")+"\x3c/a\x3e",collapsible:!0,collapsed:!0,defaultType:"textfield",items:[{xtype:"container",html:"\x3cp\x3e\x3ci\x3e"+a.localize("textOptionsText")+"\x3c/i\x3e\x3c/p\x3e",width:375},
{fieldLabel:a.localize("inputRemoveUntil"),name:"inputRemoveUntil"},{fieldLabel:a.localize("inputRemoveUntilAfter"),name:"inputRemoveUntilAfter"},{fieldLabel:a.localize("inputRemoveFrom"),name:"inputRemoveFrom"},{fieldLabel:a.localize("inputRemoveFromAfter"),name:"inputRemoveFromAfter"}]},{xtype:"fieldset",title:"\x3ca href\x3d'"+a.getBaseUrl()+"docs/#!/guide/corpuscreator-section-xml' target\x3d'voyantdocs'\x3e"+a.localize("xmlOptions")+"\x3c/a\x3e",collapsible:!0,collapsed:!0,defaultType:"textfield",
items:[{xtype:"container",html:"\x3cp\x3e\x3ci\x3e"+a.localize("xmlOptionsText")+"\x3c/i\x3e\x3c/p\x3e",width:375},{fieldLabel:a.localize("xpathContent"),name:"xmlContentXpath"},{fieldLabel:a.localize("xpathTitle"),name:"xmlTitleXpath"},{fieldLabel:a.localize("xpathAuthor"),name:"xmlAuthorXpath"},{fieldLabel:a.localize("xpathDocuments"),name:"xmlDocumentsXpath"},{fieldLabel:a.localize("xpathGroupBy"),name:"xmlGroupByXpath"}]},{xtype:"fieldset",title:"\x3ca href\x3d'"+a.getBaseUrl()+"docs/#!/guide/corpuscreator-section-tables' target\x3d'voyantdocs'\x3e"+
a.localize("tableOptions")+"\x3c/a\x3e",collapsible:!0,collapsed:!0,defaultType:"textfield",items:[{xtype:"container",html:"\x3cp\x3e\x3ci\x3e"+(new Ext.Template(a.localize("tableOptionsText"))).applyTemplate([a.getBaseUrl()+"docs/#!/guide/corpuscreator-section-tables"])+"\x3c/i\x3e\x3c/p\x3e",width:375},{xtype:"combo",fieldLabel:a.localize("tableDocuments"),name:"tableDocuments",queryMode:"local",store:[["",a.localize("tableDocumentsTable")],["rows",a.localize("tableDocumentsRows")],["columns",a.localize("tableDocumentsColumns")]],
forceSelection:!0,value:""},{xtype:"container",html:"\x3cp\x3e\x3ci\x3e"+a.localize("tableNoHeadersRowText")+"\x3c/i\x3e\x3c/p\x3e",width:375},{fieldLabel:a.localize("tableNoHeadersRow"),xtype:"checkboxfield",name:"tableNoHeadersRow",inputValue:"true"},{xtype:"container",html:"\x3cp\x3e\x3ci\x3e"+a.localize("tableContentText")+"\x3c/i\x3e\x3c/p\x3e",width:375},{fieldLabel:a.localize("tableContent"),validator:function(b){return a.validatePositiveNumbersCsv.call(a,b)},name:"tableContent"},{xtype:"container",
html:"\x3cp\x3e\x3ci\x3e"+a.localize("tableMetadataText")+"\x3c/i\x3e\x3c/p\x3e",width:375},{fieldLabel:a.localize("tableAuthor"),validator:function(b){return a.validatePositiveNumbersCsv.call(a,b)},name:"tableAuthor"},{fieldLabel:a.localize("tableTitle"),validator:function(b){return a.validatePositiveNumbersCsv.call(a,b)},name:"tableTitle"}]},{xtype:"fieldset",title:"\x3ca href\x3d'"+a.getBaseUrl()+"docs/#!/guide/corpuscreator-section-processing' target\x3d'voyantdocs'\x3e"+a.localize("processingOptions")+
...
a.localize("tokenizationAuto")],["wordBoundaries",a.localize("tokenizationWordBoundaries")],["whitespace",a.localize("tokenizationWhitespace")]],forceSelection:!0,value:""}]},{xtype:"fieldset",title:"\x3ca href\x3d'"+a.getBaseUrl()+"docs/#!/guide/corpuscreator-section-access-management' target\x3d'voyantdocs'\x3e"+a.localize("accessOptions")+"\x3c/a\x3e",collapsible:!0,collapsed:!0,defaultType:"textfield",items:[{xtype:"container",html:"\x3cp\x3e\x3ci\x3e"+a.localize("accessOptionsText")+"\x3c/i\x3e\x3c/p\x3e",
width:375},{fieldLabel:a.localize("adminPassword"),name:"adminPassword"},{fieldLabel:a.localize("accessPassword"),name:"accessPassword"},{xtype:"container",html:"\x3cp\x3e\x3ci\x3e"+a.localize("accessModeWithoutPasswordText")+"\x3c/i\x3e\x3c/p\x3e",width:375},{xtype:"combo",fieldLabel:a.localize("accessModeWithoutPassword"),name:"noPasswordAccess",queryMode:"local",store:[["",a.localize("accessModeNonConsumptive")],["none",a.localize("accessModeNone")]],forceSelection:!0,value:""}]}]}],buttons:[{text:a.localize("ok"),
handler:function(b,c){var d=b.findParentByType("window"),e=d.down("form");e.isValid()?(e=e.getValues(),a.setApiParams(e),d.hide()):a.showError({message:a.localize("invalidForm")})}},{text:a.localize("cancel"),handler:function(a,c){a.findParentByType("window").hide()}}]}));a.optionsWin.show()},validatePositiveNumbersCsv:function(a){a=a.trim();if(0<a.length){if(/[^\d,+ ]/.test(a))return this.localize("numbersCommasOnly");if(/\d\s+\d/.test(a))return this.localize("numbersNeedCommas");a=a.split(/\s*[,+]\s*/);
for(var b,c=0,d=a.length;c<d;c++){b=a[c];if(0==b.length)return this.localize("numberEmpty");if(0==parseInt(b))return this.localize("numberZero")}}return!0}});Ext.define("Voyant.panel.DreamScape",{extend:"Ext.Panel",xtype:"dreamscape",mixins:["Voyant.panel.Panel"],statics:{i18n:{title:"DreamScape",display:"Display",displayTip:"Configure various aspects of the display.",filter:"Filter",filterTip:"Determine any filters to use.",authorLabel:"authors",noauthor:"No authors defined in this corpus.",titleLabel:"titles",keywordLabel:"keywords",pubDateLabel:"years",nopubDate:"No publication years defined in this corpus.",animationSpeed:"Speed",cities:"Cities",connections:"Connections",
animations:"Animations",animate:"Animate",add:"Add Filter",allNCitiesShown:"All {0} available cities shown.",citiesMaxCount:"maximum count",citiesMinPopulation:"minimum population",citiesMinFreq:"minimum occurrences",connectionsMaxCount:"maximum count",connectionsMinFreq:"minimum occurrences",millisPerAnimation:"milliseconds per animation",projection:"Projection",projectionTip:"Determine map projection",webMercatorProjection:"Web Mercator (Default)",mercatorProjection:"Mercator (WGS84)",gallPetersProjection:"Gall Peters (Equal Area)",
sphereMollweideProjection:"Sphere mollweide (Equal Area)",annotate:"Annotate",annotateTip:"To annotate, click this icon, select a region and enter text in the box that will appear. If you don't select a region you can click again to exit annotation mode. If you do select a region please click this icon again if you wish to add another annotation.",baseLayer:"Base Layer",baseLayerTip:"Determine map base layer",watercolor:"Stamen watercolor (Default)",osm:"Open Street Map",wms4326:"WMS 4326",arcGIS:"National Geographic World Map - ArcGIS",
map:"Map",mapTip:"Define base layer and projection",annotationsUpdated:"Annotations have been stored. Please export new URL if you would like to reference it.",annotationsUpdateFailed:"An error occured while trying to store the anntoations.",annotationsLoadFailed:"An error occured while trying to load the anntoations."},api:{stopList:"auto",hide:[],author:void 0,title:void 0,keyword:void 0,pubDate:void 0,citiesMaxCount:500,minPopulation:1E4,citiesMinFreq:1,connectionsMaxCount:2500,connectionsMinFreq:1,
millisPerAnimation:2E3,annotationsId:void 0},glyph:"xf124@FontAwesome"},config:{map:void 0,overlay:void 0,contentEl:void 0,isOpenLayersLoaded:!1,isArcLoaded:!1,animationDelay:25,isProj4Loaded:!1,projection:void 0,filterWidgets:new Ext.util.MixedCollection,drawInteraction:void 0,drawMode:!1,currentAnnotation:void 0,baseLayers:{},annotations:void 0,annotationsLoadedIfAvailable:!1,overrides:{}},html:'\x3cdiv class\x3d"map"\x3e\x3c/div\x3e\x3cdiv class\x3d"ticker"\x3e\x3c/div\x3e\x3cdiv class\x3d"ol-popup"\x3e\x3ca href\x3d"#" class\x3d"ol-popup-closer"\x3e\x3c/a\x3e\x3cdiv class\x3d"popup-content"\x3e\x3c/div\x3e\x3c/div\x3e',
cls:"dreamscape",constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);Ext.Loader.loadScript({url:this.getBaseUrl()+"resources/openlayers/ol.js",onLoad:function(){void 0===ol.Map.prototype.getLayer&&(ol.Map.prototype.getLayer=function(a){var b=void 0;this.getLayers().forEach(function(c){a===c.get("id")&&(b=c)});return b});this.setIsOpenLayersLoaded(!0)},scope:this});Ext.Loader.loadScript({url:this.getBaseUrl()+"resources/dreamscape/arc.js",
onLoad:function(){this.setIsArcLoaded(!0)},scope:this});Ext.Loader.loadScript({url:"https://cdnjs.cloudflare.com/ajax/libs/proj4js/2.4.4/proj4.js",onLoad:function(){this.setIsProj4Loaded(!0)},scope:this});var b=this.getApiParam("annotationsId");if(b){var c=this;Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"resource.StoredResource",retrieveResourceId:b},scope:this}).then(function(a){a=Ext.JSON.decode(a.responseText);a.storedResource.resource&&(a=Ext.JSON.decode(a.storedResource.resource),
Ext.isString(a)&&(a=Ext.JSON.decode(a),c.setAnnotations(a)));c.getAnnotations()||c.showError(c.localize("annotationsLoadFailed"));c.setAnnotationsLoadedIfAvailable(!0)},function(a){c.showResponseError(c.localize("annotationsLoadFailed"),a);c.setAnnotationsLoadedIfAvailable(!0)})}else this.setAnnotationsLoadedIfAvailable(!0)},initComponent:function(){this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);var a=this.getApiParam("hide");Ext.isString(a)&&(a=a.split(","),this.setApiParam("hide"));
this.getApplication().getBaseUrl();Ext.apply(this,{title:this.localize("title"),bodyBorder:!0,dockedItems:[{dock:"bottom",xtype:"toolbar",itemId:"bottomToolbar",overflowHandler:"scroller",items:[{text:this.localize("display"),tooltip:this.localize("displayTip"),glyph:"xf013@FontAwesome",menu:{defaults:{xtype:"menucheckitem",checkHandler:function(a,c){var d=this.getMap(),e=a.getItemId();this.getFilterWidgets().each(function(a){d.getLayer(a.getId()+"-"+e).setVisible(c)});var f=Ext.Array.from(this.getApiParam("hide"));
c?f=Ext.Array.remove(f,e):(f.push(e),f=Ext.Array.unique(f));this.setApiParam("hide",f);a.getMenu().setDisabled(0==c)},scope:this,checked:!0},items:[{xtype:"menuitem",text:this.localize("baseLayer"),tooltip:this.localize("baseLayerTip"),glyph:"xf279@FontAwesome",menu:{items:[{xtype:"radiogroup",columns:1,vertical:!0,defaults:{cls:"map-menu-item",handler:function(a,c){if(c){id=a.getItemId();var d=this.getBaseLayers()[id];d&&(d.setOpacity(1),this.getMap().getLayers().setAt(0,d));"osm"==id||"arcGIS"==
id?this.getMap().getLayer("overlayLayer").setVisible(!1):this.getMap().getLayer("overlayLayer").setVisible(!0)}},listeners:{afterrender:function(a){Ext.create("Ext.tip.ToolTip",{target:a,html:'\x3cdiv class\x3d"map-menu-item-tooltip '+a.getItemId()+'"\x3e\x3c/div\x3e',anchor:"right"})}},scope:this},items:[{boxLabel:this.localize("watercolor"),itemId:"watercolor",cls:["map-menu-item","watercolor"],checked:!0},{boxLabel:this.localize("wms4326"),cls:["map-menu-item","wms4326"],itemId:"wms4326"},{boxLabel:this.localize("osm"),
cls:["map-menu-item","osm"],itemId:"osm"},{boxLabel:this.localize("arcGIS"),cls:["map-menu-item","arcGIS"],itemId:"arcGIS"}]}]}},{xtype:"menuitem",text:this.localize("projection"),tooltip:this.localize("projectionTip"),glyph:"xf0ac@FontAwesome",menu:{items:[{xtype:"radiogroup",columns:1,vertical:!0,defaults:{handler:function(a,c){if(c){var d=this;id=a.getItemId();if("webMercatorProjection"===id)this.setProjection(ol.proj.get("EPSG:3857"));else if("mercatorProjection"===id)this.setProjection(ol.proj.get("EPSG:4326"));
else if("gallPetersProjection"===id){proj4.defs("cea","+proj\x3dcea +lon_0\x3d0 +lat_ts\x3d45 +x_0\x3d0 +y_0\x3d0 +ellps\x3dWGS84 +units\x3dm +no_defs");var e=ol.proj.get("cea");this.setProjection(e)}else"sphereMollweideProjection"===id&&(proj4.defs("ESRI:54009","+proj\x3dmoll +lon_0\x3d0 +x_0\x3d0 +y_0\x3d0 +datum\x3dWGS84 +units\x3dm +no_defs"),e=ol.proj.get("ESRI:54009"),e.setExtent([-18E6,-9E6,18E6,9E6]),this.setProjection(e));var e=this.getProjection().getExtent(),f=this.getProjection()==ol.proj.get("EPSG:4326")?
360:4.007501668557849E7,e=new ol.View({projection:this.getProjection(),center:ol.extent.getCenter(e||[0,0,0,0]),maxResolution:f/d.body.dom.offsetWidth,zoom:0}),g=this.getMap();g.getLayers().forEach(function(a){a.getSource().getFeatures&&a.getSource().getFeatures().forEach(function(a){var b=a.getGeometry().transform(g.getView().getProjection(),d.getProjection());a.setGeometry(b)})});g.setView(e)}},listeners:{afterrender:function(a){Ext.create("Ext.tip.ToolTip",{target:a,html:'\x3cdiv class\x3d"map-menu-item-tooltip '+
a.getItemId()+'"\x3e\x3c/div\x3e',anchor:"right"})}},scope:this},items:[{boxLabel:this.localize("webMercatorProjection"),itemId:"webMercatorProjection",cls:["map-menu-item","webMercatorProjection"],checked:!0},{boxLabel:this.localize("mercatorProjection"),cls:["map-menu-item","mercatorProjection"],itemId:"mercatorProjection"},{boxLabel:this.localize("gallPetersProjection"),cls:["map-menu-item","gallPetersProjection"],itemId:"gallPetersProjection"},{boxLabel:this.localize("sphereMollweideProjection"),
cls:["map-menu-item","sphereMollweideProjection"],itemId:"sphereMollweideProjection"}]}]}},"-",{text:this.localize("cities"),checked:0==Ext.Array.contains(a,"cities"),itemId:"cities",menu:{defaults:{labelAlign:"right",labelWidth:140},items:[{xtype:"numberfield",fieldLabel:this.localize("citiesMaxCount"),minValue:1,value:parseInt(this.getApiParam("citiesMaxCount")),listeners:{change:function(a,c,d){this.getFilterWidgets().each(function(e){this.setApiParam("citiesMaxCount",c);var f=e.getGeonames().getCitiesCount();
c<d||c<=f?this.filterUpdate(e):e.getGeonames().hasMoreCities()?e.loadGeonames():(a.setValue(f),this.toastInfo((new Ext.XTemplate(this.localize("allNCitiesShown"))).apply([f])))},this)},scope:this}},{xtype:"numberfield",fieldLabel:this.localize("citiesMinPopulation"),minValue:1,value:parseInt(this.getApiParam("minPopulation")),listeners:{change:function(a,c,d){this.getFilterWidgets().each(function(a){this.setApiParam("minPopulation",c);c>d?this.filterUpdate(a):a.loadGeonames()},this)},scope:this}},
{xtype:"numberfield",fieldLabel:this.localize("citiesMinFreq"),minValue:1,value:parseInt(this.getApiParam("citiesMinFreq")),listeners:{change:function(a,c,d){this.getFilterWidgets().each(function(a){this.setApiParam("citiesMinFreq",c);c>d?this.filterUpdate(a):a.loadGeonames()},this)},scope:this}}]}},{text:this.localize("connections"),checked:0==Ext.Array.contains(a,"connections"),itemId:"connections",menu:{defaults:{labelWidth:140,labelAlign:"right"},items:[{xtype:"numberfield",fieldLabel:this.localize("connectionsMaxCount"),
minValue:1,value:parseInt(this.getApiParam("connectionsMaxCount")),listeners:{change:function(a,c,d){this.getFilterWidgets().each(function(a){this.setApiParam("connectionsMaxCount",c);c>d?this.filterUpdate(a):a.loadGeonames()},this)},scope:this}},{xtype:"numberfield",fieldLabel:this.localize("connectionsMinFreq"),minValue:1,value:parseInt(this.getApiParam("connectionsMinFreq")),listeners:{change:function(a,c,d){this.getFilterWidgets().each(function(a){this.setApiParam("connectionsMinFreq",c);c>d?
this.filterUpdate(a):a.loadGeonames()},this)},scope:this}}]}},{xtype:"menucheckitem",checked:0==Ext.Array.contains(a,"animation"),text:this.localize("animations"),itemId:"animation",menu:{defaults:{labelWidth:170,labelAlign:"right",width:280},items:[{xtype:"sliderfield",fieldLabel:this.localize("millisPerAnimation"),value:parseInt(this.getApiParam("millisPerAnimation")),minValue:this.getAnimationDelay(),maxValue:1E4,listeners:{change:function(a,c,d){this.getFilterWidgets().each(function(a){a.setMillisPerAnimation(c);
a.animate()},this)},scope:this}}]}}]}},"-",{text:this.localize("add"),itemId:"addFilter",glyph:"xf067@FontAwesome",handler:function(a){for(var c=this.getApplication().getColorPalette(void 0,!0),d=c[0],e=0,f=c.length;e<f;e++){var g=!1;this.getFilterWidgets().each(function(a){if(a.getColor()==c[e])return g=!0,!1});if(0==g){d=c[e];break}}d=a.ownerCt.add({xtype:"geonamesfilter",corpus:this.getCorpus(),color:d,listeners:{removeFilterWidget:function(a){var b=this.getMap(),c=a.getItemId(),d=this.getFilterWidgets();
["connections","cities","animation"].forEach(function(a){b.removeLayer(b.getLayer(c+"-"+a))});d.remove(a);0==d.getCount()&&this.getDockedComponent("bottomToolbar").getComponent("addFilter").click()},filterUpdate:this.filterUpdate,scope:this}});this.getFilterWidgets().add(d.getId(),d);a=this.getMap();f=new ol.layer.Vector({source:new ol.source.Vector({wrapX:!1,useSpatialIndex:!0}),id:d.getId()+"-connections",visible:!0,opacity:.2,style:this.travelStyleFunction.bind(this),updateWhileAnimating:!0,updateWhileInteracting:!0});
a.addLayer(f);f=new ol.layer.Vector({source:new ol.source.Vector({wrapX:!1,useSpatialIndex:!0}),id:d.getId()+"-cities",opacity:.5,style:this.cityStyleFunction.bind(this)});a.addLayer(f);d=new ol.layer.Vector({source:new ol.source.Vector({wrapX:!1,useSpatialIndex:!0}),id:d.getId()+"-animation",style:this.animationStyleFunction.bind(this)});a.addLayer(d)},scope:this}]}]});this.on("loadedCorpus",function(a,c){this.tryInit()},this);this.callParent()},tryInit:function(){if(this.getIsOpenLayersLoaded()&&
this.getIsArcLoaded()&&this.getIsProj4Loaded()&&this.getAnnotationsLoadedIfAvailable()){var a=this.body.down(".map").setId(Ext.id()),b=this.body.down(".ol-popup"),c=new ol.Overlay({element:b.dom,autoPan:!0,autoPanAnimation:{duration:250}});this.setOverlay(c);var d=this,e=b.down(".ol-popup-closer").dom;e.onclick=function(){c.setPosition(void 0);e.blur();d.getMap().getLayer("preview").getSource().clear();return!1};var f=this.getBaseLayers();f.wms4326=new ol.layer.Tile({preload:Infinity,source:new ol.source.TileWMS({url:"https://ahocevar.com/geoserver/wms",
crossOrigin:"",params:{LAYERS:"ne:NE1_HR_LC_SR_W_DR",TILED:!0},projection:"EPSG:4326"})});f.watercolor=new ol.layer.Tile({preload:Infinity,source:new ol.source.Stamen({layer:"watercolor",projection:"EPSG:3857"})});f.osm=new ol.layer.Tile({preload:Infinity,source:new ol.source.OSM({projection:"EPSG:3857"})});f.arcGIS=new ol.layer.Tile({preload:Infinity,source:new ol.source.TileArcGISRest({url:"https://services.arcgisonline.com/ArcGIS/rest/services/NatGeo_World_Map/MapServer",projection:"EPSG:3857"})});
this.setContentEl(b.down(".popup-content"));var g=new ol.Map({layers:[f.watercolor,new ol.layer.Tile({preload:Infinity,source:new ol.source.Stamen({cacheize:2048,layer:"toner-hybrid",projection:"EPSG:3857"}),id:"overlayLayer"})],overlays:[c],target:a.getId(),loadTilesWhileInteracting:!0,view:new ol.View({center:[0,0],maxResolution:4.007501668557849E7/d.body.dom.offsetWidth,zoom:0})});g.on("singleclick",function(a){var b=g.getFeaturesAtPixel(a.pixel);if(b){var c=!1;b.forEach(function(b){"city"===b.get("type")&&
b.get("selected")?(d.dispatchEvent("termsClicked",d,[b.get("forms").join("|")]),c=!0):"connection"===b.get("type")&&b.get("selected")&&!c?(d.getFilterWidgets().each(function(c){c=c.getGeonames();if(null!=c){var e=function(a){a.addEventListener("contextmenu",function(b){b.preventDefault();d.openContextMenu(b.layerX,b.layerY,a);return!1},!1)},f="\x3cul\x3e",g=-1;c.getAllConnectionOccurrences(b.get("source"),b.get("target")).forEach(function(a){a.docIndex!=g&&(g=a.docIndex,f+="\x3ch4\x3e"+d.getCorpus().getDocument(g).getFullLabel()+
":\x3c/h4\x3e");f+="\x3cli\x3e"+a.source.left+'\x3ca href\x3d"http://www.geonames.org/'+a.source.id+'" target\x3d"_blank" docIndex\x3d'+a.docIndex+" offset\x3d"+a.source.position+" location\x3d"+a.source.form+" cityId\x3d"+a.source.id+" coordinates\x3d"+JSON.stringify([-10,10])+" alternates\x3d"+JSON.stringify({6077243:[-73.58781,45.50884],524901:[37.61556,55.75222]})+' class\x3d"termLocationLink"\x3e'+a.source.form+"\x3c/a\x3e "+a.source.right+" [...] "+a.target.left+'\x3ca href\x3d"http://www.geonames.org/'+
a.target.id+'" target\x3d"_blank" docIndex\x3d'+a.docIndex+" offset\x3d"+a.target.position+" location\x3d"+a.target.form+" cityId\x3d"+a.target.id+" coordinates\x3d"+JSON.stringify([-10,10])+" alternates\x3d"+JSON.stringify({6077243:[-73.58781,45.50884],524901:[37.61556,55.75222]})+' class\x3d"termLocationLink"\x3e'+a.target.form+"\x3c/a\x3e "+a.target.right+"\x3c/li\x3e"});c=b.get("text");f+="\x3c/ul\x3e";d.getContentEl().setHtml("\x3ch3\x3e"+c+"\x3c/h3\x3e"+f);d.getOverlay().setPosition(a.coordinate);
Ext.select(".termLocationLink").elements.forEach(function(a){e(a);a.onmouseover=function(){d.showTermInCorpus(a.getAttribute("docIndex"),a.getAttribute("offset"),a.getAttribute("location"))}})}}),c=!0):"annotation"!==b.get("type")||c||(d.setCurrentAnnotation(b),d.getContentEl().setHtml('\x3ctextarea class\x3d"annotation-text" rows\x3d"5" cols\x3d"60"\x3e'+(b.get("text")?b.get("text"):"")+'\x3c/textarea\x3e\x3cbutton class\x3d"saveAnnotation"\x3eSave\x3c/button\x3e\x3cbutton class\x3d"deleteAnnotation"\x3eDelete\x3c/button\x3e'),
d.getOverlay().setPosition(a.coordinate),d.getContentEl().down(".deleteAnnotation").dom.onclick=function(){d.deleteAnnotation()},d.getContentEl().down(".saveAnnotation").dom.onclick=function(){d.saveAnnotation()},d.getContentEl().down(".annotation-text").dom.focus())},this)}});var h=new ol.layer.Vector({map:g,source:new ol.source.Vector({wrapX:!1,useSpatialIndex:!1}),zIndex:10,selected:!0,style:function(a){if("city"===a.get("type"))return d.cityStyleFunction(a,g.getView().getResolution());if("connection"===
a.get("type"))return d.travelStyleFunction(a,g.getView().getResolution())},updateWhileAnimating:!0,updateWhileInteracting:!0}),a=new ol.layer.Vector({map:g,source:new ol.source.Vector({wrapX:!1,useSpatialIndex:!1}),preview:!0,zIndex:15,id:"preview",style:function(a){if("city"===a.get("type"))return d.cityStyleFunction(a,g.getView().getResolution());if("connection"===a.get("type"))return d.travelStyleFunction(a,g.getView().getResolution())},updateWhileAnimating:!0,updateWhileInteracting:!0});g.addLayer(a);
g.on("pointermove",function(a){if(!d.getDrawMode()){h.getSource().clear();var b=g.getFeaturesAtPixel(a.pixel);if(b){for(var c=0;b[c].get("selected")&&(c++,c!==b.length););if(c<b.length){var e=b[c],b={font:"12px Calibri,sans-serif",textAlign:"center",offsetY:-15,fill:new ol.style.Fill({color:[0,0,0,1]}),stroke:new ol.style.Stroke({color:[255,255,255,.5],width:4})};b.text=e.get("text");b=new ol.style.Style({text:new ol.style.Text(b),zIndex:1});"annotation"!==e.get("type")&&(c=new ol.Feature({text:e.get("text"),
geometry:e.getGeometry(),forms:e.get("forms"),selected:!0,coordinates:e.get("coordinates"),width:e.get("width"),visible:e.get("visible"),color:e.get("color"),type:e.get("type"),alternates:e.get("alternates"),confidence:e.get("confidence"),source:e.get("source"),target:e.get("target"),cityId:e.get("cityId")}),h.getSource().addFeature(c));e.getGeometry();a=new ol.Feature({geometry:new ol.geom.Point(a.coordinate),selected:!0});a.setStyle(b);h.getSource().addFeature(a);"city"===e.get("type")&&d.getMap().getLayers().forEach(function(a){var b=
a.get("id");b&&-1!==b.indexOf("connections")&&(connections=a.getSource().getFeatures(),connections.forEach(function(a){a.get("target")!==e.get("cityId")&&a.get("source")!==e.get("cityId")||h.getSource().addFeature(new ol.Feature({geometry:a.getGeometry(),selected:!0,coordinates:a.get("coordinates"),width:a.get("width"),visible:a.get("visible"),color:a.get("color"),type:a.get("type")}))}))})}}}});a=new ol.source.Vector({wrapX:!1});b=new ol.layer.Vector({source:a,id:"annotations"});if(f=this.getAnnotations())f=
(new ol.format.GeoJSON).readFeatures(f),a.addFeatures(f);g.addLayer(b);this.setDrawInteraction(new ol.interaction.Draw({source:a,type:"Polygon",freehand:!0,alias:"draw"}));this.getDrawInteraction().on("drawend",function(a){a.feature.set("type","annotation");d.setCurrentAnnotation(a.feature);d.getContentEl().setHtml('\x3ctextarea class\x3d"annotation-text" rows\x3d"5" cols\x3d"60"\x3e\x3c/textarea\x3e\x3cbutton class\x3d"saveAnnotation"\x3eSave\x3c/button\x3e\x3cbutton class\x3d"deleteAnnotation"\x3eCancel\x3c/button\x3e');
d.getContentEl().down(".deleteAnnotation").dom.onclick=function(){d.deleteAnnotation()};d.getContentEl().down(".saveAnnotation").dom.onclick=function(){d.saveAnnotation()};d.getOverlay().setPosition(a.feature.getGeometry().getLastCoordinate());d.getContentEl().down(".annotation-text").dom.focus()});g.getViewport().addEventListener("contextmenu",function(a){a.preventDefault();d.openContextMenu(a.layerX,a.layerY);return!1},!1);this.setMap(g);this.getTargetEl().down(".ol-zoom");Ext.create("Ext.Button",
{glyph:"xf075@FontAwesome",cls:"annotate",renderTo:this.getTargetEl().down(".ticker").parent(),tooltip:this.localize("annotateTip"),enableToggle:!0,toggleHandler:function(a,b){b?this.getMap().addInteraction(this.getDrawInteraction()):this.getMap().removeInteraction(this.getDrawInteraction())},scope:this});this.getDockedComponent("bottomToolbar").getComponent("addFilter").click()}else Ext.defer(this.tryInit,500,this)},deleteAnnotation:function(){this.body.down(".ol-popup").down(".ol-popup-closer").dom.click();
this.getMap().getLayer("annotations").getSource().removeFeature(this.getCurrentAnnotation());var a=new ol.format.GeoJSON,b=this.getMap().getLayer("annotations").getSource().getFeatures(),c=[],d=this.getProjection();b.forEach(function(a){transformedFeature=a.clone();transformedFeature.getGeometry().transform(d?d:"EPSG:3857","EPSG:3857");c.push(transformedFeature)});a=a.writeFeatures(c);this.storeAnnotations(a)},storeAnnotations:function(a){this.mask("storingAnnotations");var b=this;Ext.Ajax.request({url:this.getTromboneUrl(),
params:{tool:"resource.StoredResource",storeResource:JSON.stringify(a)},scope:this}).then(function(a){b.unmask();a=Ext.JSON.decode(a.responseText);b.setApiParam("annotationsId",a.storedResource.id);b.toastInfo(b.localize("annotationsUpdated"))},function(a){b.unmask();b.showResponseError(b.localize("annotationsUpdateFailed"),a)})},saveAnnotation:function(){this.getCurrentAnnotation().set("text",this.getContentEl().down(".annotation-text").dom.value);this.getOverlay().setPosition(void 0);var a=new ol.format.GeoJSON,
b=this.getMap().getLayer("annotations").getSource().getFeatures(),c=[],d=this.getProjection();b.forEach(function(a){transformedFeature=a.clone();transformedFeature.getGeometry().transform(d?d:"EPSG:3857","EPSG:3857");c.push(transformedFeature)});a=a.writeFeatures(c);this.storeAnnotations(a)},travelStyleFunction:function(a,b){var c=new ol.style.Stroke({color:a.get("color"),width:a.get("width")}),d=[new ol.style.Style({stroke:c})],e=a.getGeometry(),f=e.getLastCoordinate(),e=e.getCoordinateAt(.9),e=
Math.atan2(f[1]-e[1],f[0]-e[0]),g=new ol.geom.LineString([f,[f[0]-10*b,f[1]+10*b]]);g.rotate(e,f);var h=new ol.geom.LineString([f,[f[0]-10*b,f[1]-10*b]]);h.rotate(e,f);d.push(new ol.style.Style({geometry:g,stroke:c}));d.push(new ol.style.Style({geometry:h,stroke:c}));return d},cityStyleFunction:function(a,b){if(a.get("visible")){var c=2*Math.PI*a.get("width"),d=a.get("confidence")?c*a.get("confidence"):c;return new ol.style.Style({image:new ol.style.Circle({radius:a.get("width"),fill:new ol.style.Fill({color:a.get("color")}),
stroke:new ol.style.Stroke({lineDash:[d,c-d],color:"rgb(255, 255, 255)",width:2})})})}return!1},animationStyleFunction:function(a){return[new ol.style.Style({stroke:new ol.style.Stroke({color:a.get("color"),width:5})}),new ol.style.Style({geometry:new ol.geom.Circle(a.getGeometry().getFirstCoordinate()),stroke:new ol.style.Stroke({color:"white",width:10})}),new ol.style.Style({geometry:new ol.geom.Circle(a.getGeometry().getLastCoordinate()),stroke:new ol.style.Stroke({color:"white",width:10})})]},
showTermInCorpus:function(a,b,c){a=Ext.create("Voyant.data.model.Context",{docIndex:a,position:b,term:c});this.getApplication().dispatchEvent("termLocationClicked",this,[a])},filterUpdate:function(a){var b=this;a.clearAnimation();var c=this.getMap(),d=a.getColor(),e=parseInt(this.getApiParam("citiesMaxCount")),f=0;a.getGeonames().eachCity(function(a){a.rawFreq>f&&(f=a.rawFreq)},this,e);var g=c.getLayer(a.getId()+"-cities").getSource(),h=Ext.Array.from(this.getApiParam("hide"));g.clear();var k=parseInt(this.getApiParam("minPopulation")),
l=parseInt(this.getApiParam("citiesMinFreq")),m={};a.getGeonames().eachCity(function(a){if((!k||a.population>=k)&&(!l||a.rawFreq>=l)){m[a.id]=!0;var c=[parseFloat(a.lng),parseFloat(a.lat)];a=new ol.Feature({geometry:(new ol.geom.Point(c)).transform(ol.proj.get("EPSG:4326"),b.getProjection()?b.getProjection():ol.proj.get("EPSG:3857")),text:a.label+" ("+a.rawFreq+")",description:a.label,color:d,selected:!1,width:3+20*Math.sqrt(a.rawFreq/f),visible:!0,coordinates:c,forms:a.forms,cityId:a.id,alternates:{6077243:[-73.58781,
45.50884],524901:[37.61556,55.75222]},type:"city",confidence:a.confidence?100*a.confidence:void 0});g.addFeature(a)}},this,e);0<g.getFeatures().length&&c.getView().fit(g.getExtent());c.getLayer(a.getId()+"-cities").setVisible(0==Ext.Array.contains(h,"cities"));g=c.getLayer(a.getId()+"-connections").getSource();g.clear();0==Object.keys(m).length&&this.toastInfo("No cities available for current criteria.");f=0;a.getGeonames().eachConnection(function(a){a.rawFreq>f&&(f=a.rawFreq)},this);var n=0,q=parseInt(this.getApiParam("connectionsMaxCount")),
r=parseInt(this.getApiParam("connectionsMinFreq"));a.getGeonames().eachConnection(function(a){if((!r||a.rawFreq>=r)&&(!q||n<q)&&a.source.id in m&&a.target.id in m&&(!k||a.source.population>=k&&a.target.population>=k)){var c=(new arc.GreatCircle({x:a.source.lng,y:a.source.lat},{x:a.target.lng,y:a.target.lat})).Arc(100,{offset:100}),e=a.source.label+" -\x3e "+a.target.label+" ("+a.rawFreq+")";c.geometries.forEach(function(c){c=new ol.geom.LineString(c.coords);c.transform(ol.proj.get("EPSG:4326"),b.getProjection()?
b.getProjection():ol.proj.get("EPSG:3857"));c=new ol.Feature({geometry:c,text:e,color:d,width:3+10*Math.sqrt(a.rawFreq/f),source:a.source.id,target:a.target.id,type:"connection"});g.addFeature(c)},this);n++}},this);c.getLayer(a.getId()+"-connections").setVisible(0==Ext.Array.contains(h,"connections"));a.animate()},openContextMenu:function(a,b,c){var d=this;if(void 0===c){if(c=d.getMap().getFeaturesAtPixel([a,b]),(c=null!=c?c[0]:void 0)&&"city"===c.get("type")){var e="Edit "+c.get("text");d.getContentEl().setHtml('\x3cdiv class\x3d"contextMenu"\x3e'+
(void 0!=c?"\x3ch3\x3e"+e+"\x3c/h3\x3e":"")+'\x3cdiv class\x3d"menuItem removeLocation"\x3eRemove (not a location)\x3c/div\x3e\x3cdiv class\x3d"menuItem editLocation"\x3eEdit (move location)\x3c/div\x3e\x3c/div\x3e');var f=c.get("alternates");f[c.get("cityId")]=c.get("coordinates");var g=d.getMap().getCoordinateFromPixel([a,b]),h=c.get("cityId");d.getContentEl().down(".removeLocation").dom.onclick=function(){d.handleContextMenuEvent("remove",e,h,f,a,b)};d.getContentEl().down(".editLocation").dom.onclick=
function(){d.handleContextMenuEvent("edit",e,h,f,a,b)};d.getOverlay().setPosition(g)}}else{var k=c.getAttribute("docIndex"),l=c.getAttribute("offset"),h=c.getAttribute("cityId"),f=JSON.parse(c.getAttribute("alternates"));f[h]=JSON.parse(c.getAttribute("coordinates"));e="Edit "+c.getAttribute("location")+" (document: "+k+", position: "+l+")";d.getContentEl().setHtml('\x3cdiv class\x3d"contextMenu"\x3e\x3ch3\x3e'+e+'\x3c/h3\x3e\x3cdiv class\x3d"menuItem removeLocation"\x3e Remove (not a location) \x3c/div\x3e\x3cdiv class\x3d"menuItem editLocation"\x3e Edit (move location) \x3c/div\x3e\x3c/div\x3e');
d.getContentEl().down(".removeLocation").dom.onclick=function(){d.handleContextMenuEvent("remove",e,h,f,a,b,k,l)};d.getContentEl().down(".editLocation").dom.onclick=function(){d.handleContextMenuEvent("edit",e,h,f,a,b,k,l)}}},handleContextMenuEvent:function(a,b,c,d,e,f,g,h){var k=this;if("remove"===a)this.removeLocation(c,g,h),this.getOverlay().setPosition(void 0);else if("edit"===a){a='\x3cselect class\x3d"locationSelect"\x3e';for(altId in d)a=altId===c?a+('\x3coption value\x3d"'+altId+'" selected\x3e'+
altId+" (current)\x3c/option\x3e"):a+('\x3coption value\x3d"'+altId+'"\x3e'+altId+" ("+d[altId]+")\x3c/option\x3e");a+='\x3c/select\x3e\x3cbutton class\x3d"saveLocationEditionButton"\x3eSave\x3c/button\x3e';this.getContentEl().setHtml("\x3ch3\x3e"+b+"\x3c/h3\x3e"+a);var l=k.getContentEl().down(".locationSelect").dom;b=l.value;a=d[b];this.getContentEl().down(".saveLocationEditionButton").dom.onclick=function(){k.getMap().getLayer("preview").getSource().clear();var a=l.value;c!=a&&k.editLocation(c,
a,d[a],g,h);k.getOverlay().setPosition(void 0)};k.previewEditLocation(c,b,a,g);l.onchange=function(){var a=l.value;k.previewEditLocation(c,a,d[a],g)}}},removeLocation:function(a,b,c){this.getOverrides()[a]=this.getOverrides()[a]?this.getOverrides()[a]:{};void 0===b?(this.getOverrides()[a].general=!1,this.getMap().getLayers().forEach(function(b){b.getSource().getFeatures&&b.getSource().getFeatures().forEach(function(c){c.get("cityId")!==a&&c.get("source")!==a&&c.get("target")!==a||b.getSource().removeFeature(c)})})):
this.getOverrides()[a][[b,c]]=!1;localStorage.overrides=JSON.stringify(this.getOverrides())},previewEditLocation:function(a,b,c,d){var e=this,f=e.getMap().getLayer("preview");f.getSource().clear();this.getMap().getLayers().forEach(function(b){b.getSource().getFeatures&&b.getSource().getFeatures().forEach(function(b){if(b.get("cityId")===a){var g=(new ol.geom.Point(c)).transform(ol.proj.get("EPSG:4326"),e.getProjection()?e.getProjection():ol.proj.get("EPSG:3857")),g=new ol.Feature({width:b.get("width"),
color:"rgb(255,0,0)",geometry:g,type:"city",visible:!0});f.getSource().addFeature(g);var l=e.getMap(),m=e.getMap().getView().calculateExtent(l.getSize());ol.extent.containsExtent(m,g.getGeometry().getExtent())||(newExtent=ol.extent.extend(m,g.getGeometry().getExtent()),l.getView().fit(newExtent))}else b.get("source")===a&&void 0===d?(g=new ol.geom.Point(b.get("geometry").getLastCoordinate()),g.transform(e.getProjection()?e.getProjection():ol.proj.get("EPSG:3857"),ol.proj.get("EPSG:4326")),g=new arc.GreatCircle({x:c[0],
y:c[1]},{x:g.getCoordinates()[0],y:g.getCoordinates()[1]}),g=g.Arc(100,{offset:100}),g.geometries.forEach(function(a){a=new ol.geom.LineString(a.coords);a.transform(ol.proj.get("EPSG:4326"),e.getProjection()?e.getProjection():ol.proj.get("EPSG:3857"));a=new ol.Feature({geometry:a,text:b.get("text"),color:"rgb(255,0,0)",width:b.get("width"),visible:!0,type:"connection"});f.getSource().addFeature(a)})):b.get("target")===a&&void 0===d&&(g=new ol.geom.Point(b.get("geometry").getFirstCoordinate()),g.transform(e.getProjection()?
e.getProjection():ol.proj.get("EPSG:3857"),ol.proj.get("EPSG:4326")),g=new arc.GreatCircle({x:g.getCoordinates()[0],y:g.getCoordinates()[1]},{x:c[0],y:c[1]}),g=g.Arc(100,{offset:100}),g.geometries.forEach(function(a){a=new ol.geom.LineString(a.coords);a.transform(ol.proj.get("EPSG:4326"),e.getProjection()?e.getProjection():ol.proj.get("EPSG:3857"));a=new ol.Feature({geometry:a,text:b.get("text"),color:"rgb(255,0,0)",width:b.get("width"),visible:!0,type:"connection"});f.getSource().addFeature(a)}))})})},
editLocation:function(a,b,c,d,e){this.getOverrides()[a]=this.getOverrides()[a]?this.getOverrides()[a]:{};if(void 0===d){var f=this;this.getOverrides()[a].general=b;this.getMap().getLayers().forEach(function(d){d.getSource().getFeatures&&d.getSource().getFeatures().forEach(function(e){if(e.get("cityId")===a)e.set("cityId",b),e.set("coordinates",c),e.set("geometry",(new ol.geom.Point(c)).transform(ol.proj.get("EPSG:4326"),f.getProjection()?f.getProjection():ol.proj.get("EPSG:3857")));else if(e.get("source")===
a){var k=e.get("geometry");k.transform(f.getProjection()?f.getProjection():ol.proj.get("EPSG:3857"),ol.proj.get("EPSG:4326"));k=new arc.GreatCircle({x:c[0],y:c[1]},{x:k.getLastCoordinate()[0],y:k.getLastCoordinate()[1]});k=k.Arc(100,{offset:100});k.geometries.forEach(function(a){a=new ol.geom.LineString(a.coords);a.transform(ol.proj.get("EPSG:4326"),f.getProjection()?f.getProjection():ol.proj.get("EPSG:3857"));a=new ol.Feature({geometry:a,text:e.get("text"),color:e.get("color"),width:e.get("width"),
source:b,target:e.get("target"),type:"connection"});d.getSource().addFeature(a);d.getSource().removeFeature(e)})}else e.get("target")===a&&(k=e.get("geometry"),k.transform(f.getProjection()?f.getProjection():ol.proj.get("EPSG:3857"),ol.proj.get("EPSG:4326")),k=new arc.GreatCircle({x:k.getFirstCoordinate()[0],y:k.getFirstCoordinate()[1]},{x:c[0],y:c[1]}),k=k.Arc(100,{offset:100}),k.geometries.forEach(function(a){a=new ol.geom.LineString(a.coords);a.transform(ol.proj.get("EPSG:4326"),f.getProjection()?
f.getProjection():ol.proj.get("EPSG:3857"));a=new ol.Feature({geometry:a,text:e.get("text"),color:e.get("color"),width:e.get("width"),source:e.get("source"),target:b,type:"connection"});d.getSource().addFeature(a);d.getSource().removeFeature(e)}))})})}else this.getOverrides()[a][[d,e]]=b;localStorage.overrides=JSON.stringify(this.getOverrides())}});
...
if(1==b.getFilterWidgets().getCount()){var g=c.getCitiesCount(),h=c.getTotalCitiesCount(),k=c.getConnectionsCount();c=c.getTotalConnectionsCount();message=a.localize(g==h&&k==c?"loadedAll":"loadedSome")+"\x3cbr\x3e\x3cbr\x3e"+a.localize("disclaimer");b.toastInfo({autoCloseDelay:5E3,closable:!0,maxWidth:"90%",html:(new Ext.Template(a.localize("disclaimer"))).apply({currentCitiesCount:g,totalCitiesCount:h,currentConnectionsCount:k,totalConnectionsCount:c,url:b.getBaseUrl()+"docs/#!/guide/dreamscape"})})}})},
this)},loadGeonames:function(a){var b=this;a=a||{};var c=[];this.query("querysearchfield").forEach(function(a){var b=a.getItemId();a.getValue().forEach(function(a){c.push(b+":"+a)})});var d=this.down("multislider");if(d&&d.isVisible()){var e=d.getValue();c.push(d.tokenType+":["+e[0]+"-"+e[1]+"]")}0<c.length&&!("query"in a)&&(a.query=c);(d=this.up("panel"))&&d.getApiParams&&Ext.applyIf(a,d.getApiParams(["minPopulation","connectionsMaxCount","connectionsMinFreq"]));this.mask("\u2026");var f=this.getGeonames();
return f.load(a).then(function(){b.unmask();b.fireEvent("filterUpdate",b,f);return f})},clearAnimation:function(){this.getTimeout()&&clearTimeout(this.getTimeout())},animate:function(){var a=this.up("panel");if(a){this.clearAnimation();var b=this.getCurrentConnectionOccurrence();if(b){var c=this.getAnimationLayer();c||(c=this.up("panel").getMap().getLayer(this.getId()+"-animation"),this.setAnimationLayer(c));if(c){var d=c.getSource().getFeatures();if(0==d.length){if(a){for(var e=a.getMap().getLayer(this.getId()+
"-connections").getSource().getFeatures(),d=!1,f=0,g=e.length;f<g;f++)if(b.source.id==e[f].get("source")&&b.target.id==e[f].get("target")){d=e[f];break}if(d){this.getKeepAnimationInFrame()&&(g=a.getMap(),e=a.getMap().getView().calculateExtent(g.getSize()),ol.extent.containsExtent(e,d.getGeometry().getExtent())||(newExtent=ol.extent.extend(e,d.getGeometry().getExtent()),g.getView().fit(newExtent)));var d=(new arc.GreatCircle({x:b.source.lng,y:b.source.lat},{x:b.target.lng,y:b.target.lat})).Arc(100,
{offset:100}),h=b.source.label+" -\x3e "+b.target.label;d.geometries.forEach(function(b){var d=new ol.geom.LineString([]);d.transform(ol.proj.get("EPSG:4326"),a.getProjection()?a.getProjection():ol.proj.get("EPSG:3857"));b=new ol.Feature({geometry:d,allcoords:b.coords,text:h,color:this.getColor(),width:5,start:(new Date).getTime()});c.getSource().addFeature(b)},this);a.body.down(".ticker");a.body.down(".ticker").setHtml(b.source.left+" \x3cspan class\x3d'keyword'\x3e"+b.source.middle+"\x3c/span\x3e "+
b.source.right+" \u2026 "+b.target.left+" \x3cspan class\x3d'keyword'\x3e"+b.target.middle+"\x3c/span\x3e "+b.target.right);return this.setTimeout(setTimeout(this.animate.bind(this),1))}if(this.getGeonames())return b=this.getGeonames().getConnectionOccurrence(b.index+1),this.setCurrentConnectionOccurrence(b),c.getSource().clear(),this.setTimeout(setTimeout(this.animate.bind(this),1))}}else if(0<d.length){g=d[0].getGeometry().getCoordinates();e=d[0].get("allcoords");if(g.length<e.length)return g=((new Date).getTime()-
d[0].get("start"))*e.length/this.getMillisPerAnimation(),line=new ol.geom.LineString(e.slice(0,g)),line.transform(ol.proj.get("EPSG:4326"),a.getProjection()?a.getProjection():ol.proj.get("EPSG:3857")),d[0].set("geometry",line),this.setTimeout(setTimeout(this.animate.bind(this),25));b=this.getGeonames().getConnectionOccurrence(b.index+1);if(!this.getStepByStepMode())return this.setCurrentConnectionOccurrence(b),c.getSource().clear(),this.setTimeout(setTimeout(this.animate.bind(this),1))}}}else if(this.getGeonames()&&
(b=this.getGeonames().getConnectionOccurrence(0)))return this.setCurrentConnectionOccurrence(b),this.setTimeout(setTimeout(this.animate.bind(this),1))}}});Ext.define("Voyant.panel.Knots",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.knots",statics:{i18n:{},api:{query:null,stopList:"auto",docId:void 0,audio:!1},glyph:"xf06e@FontAwesome"},config:{knots:void 0,termStore:void 0,docTermStore:void 0,tokensStore:void 0,options:[{xtype:"stoplistoption"},{xtype:"colorpaletteoption"}],refreshInterval:100,startAngle:315,angleIncrement:15,currentTerm:void 0},termTpl:new Ext.XTemplate('\x3ctpl for\x3d"."\x3e','\x3cdiv class\x3d"term" style\x3d"color: rgb({color});float: left;padding: 3px;margin: 2px;"\x3e{term}\x3c/div\x3e',
"\x3c/tpl\x3e"),constructor:function(){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.on("loadedCorpus",function(a,b){var c=b.getDocument(0),d=this.processDocument(c);this.getKnots().setCurrentDoc(d);this.setApiParams({docId:c.getId()});this.getDocTermStore().getProxy().setExtraParam("corpus",b.getId());this.getTokensStore().setCorpus(b);this.getDocTermStore().load({params:{limit:5,stopList:this.getApiParams("stopList")}})},this);this.on("activate",
function(){this.getCorpus()&&Ext.Function.defer(function(){this.getDocTermStore().load({params:{limit:5,stopList:this.getApiParams("stopList")}})},100,this)},this);this.on("query",function(a,b){void 0!==b&&""!=b&&this.getDocTermsFromQuery(b)},this);this.on("documentSelected",function(a,b){var c=this.getCorpus().getDocument(b);this.setApiParam("docId",c.getId());var d=this.getKnots().currentDoc.terms,e=[],f;for(f in d)e.push(f);this.setApiParams({query:e});d=e.length;0===d&&(d=5);this.getKnots().setCurrentDoc(this.processDocument(c));
this.getDocTermStore().load({params:{query:e,limit:d,stopList:this.getApiParams("stopList")}})},this);this.on("termsClicked",function(a,b){var c=[];b.forEach(function(a){Ext.isString(a)?c.push(a):a.term?c.push(a.term):a.getTerm&&c.push(a.getTerm())});0<c.length&&this.getDocTermsFromQuery(c)},this);this.on("corpusTermsClicked",function(a,b){var c=[];b.forEach(function(a){a.getTerm()&&c.push(a.getTerm())});this.getDocTermsFromQuery(c)},this);this.on("documentTermsClicked",function(a,b){var c=[];b.forEach(function(a){a.getTerm()&&
...
b);this.down("#termsView").select(f,!0)}a=a.get("distributions");b={term:b,positions:d,distributions:a,rawFreq:c,color:e}}else b=!1;return b},knotClickHandler:function(a){this.setCurrentTerm(a);var b=a.tokenId-10;0>b&&(b=0);this.getTokensStore().load({start:b,limit:21});a=[a].map(function(a){return a.term});this.getApplication().dispatchEvent("termsClicked",this,a)}});Ext.define("Voyant.panel.Phrases",{extend:"Ext.grid.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.phrases",isConsumptive:!0,statics:{i18n:{},api:{stopList:"auto",query:void 0,docId:void 0,docIndex:void 0,sort:"length",dir:"desc",minLength:2,maxLength:50,overlapFilter:"length"},glyph:"xf0ce@FontAwesome"},constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.on("loadedCorpus",function(a,c){this.isVisible()&&(0==this.hasCorpusAccess(c)?
this.mask(this.localize("limitedAccess"),"mask-no-spinner"):this.loadFromApis())});a.embedded||a.corpus&&this.fireEvent("loadedCorpus",this,a.corpus);this.on("corpusTermsClicked",function(a,c){if(this.getStore().getCorpus()){var d=[];c.forEach(function(a){d.push(a.get("term"))});this.setApiParams({query:d,docId:void 0,docIndex:void 0});this.isVisible()&&this.getStore().load({params:this.getApiParams()})}});this.on("activate",function(){this.getStore().getCorpus()&&this.loadFromApis()},this);this.on("query",
function(a,c){this.setApiParam("query",c);this.getStore().getProxy().setExtraParam("query",c);this.loadFromApis()},this)},loadFromApis:function(){this.getStore().getCorpus()&&this.getStore().load({params:this.getApiParams()})},initComponent:function(){var a=this,b=Ext.create("Voyant.data.store.CorpusNgramsBuffered",{parentPanel:a});b.on("beforeload",function(b){return a.hasCorpusAccess(b.getCorpus())});a.on("sortchange",function(a,b,e,f){this.setApiParam("sort",b.dataIndex);this.setApiParam("dir",
e);a=this.getApiParams("stopList query docId docIndex sort dir minLength maxLength overlapFilter".split(" "));b=this.getStore().getProxy();for(var g in a)b.setExtraParam(g,a[g])},a);Ext.apply(a,{title:this.localize("title"),emptyText:this.localize("emptyText"),store:b,selModel:Ext.create("Ext.selection.CheckboxModel",{listeners:{selectionchange:{fn:function(a,b){var e=[];this.getApiParam("context");b.forEach(function(a){e.push('"'+a.getTerm()+'"')});this.getApplication().dispatchEvent("termsClicked",
...
scope:a},changecomplete:{fn:function(a,b){var e=a.getValues();this.setApiParam("minLength",parseInt(e[0]));this.setApiParam("maxLength",parseInt(e[1]));this.getStore().load({params:this.getApiParams()})},scope:a}}},"-",{xtype:"button",text:this.localize("overlap"),tooltip:this.localize("overlapTip"),menu:{items:[{xtype:"menucheckitem",text:this.localize("overlapNone"),group:"overlap",inputValue:"none",checkHandler:function(){this.setApiParam("overlapFilter","none");this.getStore().load({params:this.getApiParams()})},
...
Ext.create("Voyant.data.store.DocumentTermsBuffered",{parentPanel:this});Ext.apply(this,{title:this.localize("title"),emptyText:this.localize("emptyText"),store:a,selModel:Ext.create("Ext.selection.CheckboxModel",{listeners:{selectionchange:{fn:function(a,c){this.getApplication().dispatchEvent("documentTermsClicked",this,c)},scope:this}},pruneRemoved:!1,mode:"SIMPLE"}),dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"querysearchfield"},{xtype:"totalpropertystatus"}]}],
...
b,c,d,e){return this.getStore().getCount()<this.getStore().getCorpus().getDocumentsCount()?(a=this.up("panel"),Ext.Msg.show({title:a.localize("error"),message:a.localize("reorderFilteredError"),buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR}),!1):!0}}}},buttons:[{text:this.localize("add"),tooltip:this.localize("addTip"),glyph:"xf067@FontAwesome",handler:function(a){a.up("window").close();Ext.create("Ext.window.Window",{header:!1,modal:!0,layout:"fit",items:{xtype:"corpuscreator",corpus:this.getStore().getCorpus()}}).show()},
scope:this},{text:this.localize("remove"),tooltip:this.localize("removeTip"),glyph:"xf05e@FontAwesome",hidden:1==this.getStore().getCorpus().getDocumentsCount(),handler:this.keepRemoveReorderHandler,itemId:"remove",scope:this},{text:this.localize("keep"),tooltip:this.localize("keepTip"),glyph:"xf00c@FontAwesome",hidden:1==this.getStore().getCorpus().getDocumentsCount(),handler:this.keepRemoveReorderHandler,itemId:"keep",scope:this},{text:this.localize("reorder"),tooltip:this.localize("reorderTip"),
glyph:"xf0dc@FontAwesome",hidden:1==this.getStore().getCorpus().getDocumentsCount(),handler:this.keepRemoveReorderHandler,itemId:"reorder",scope:this},{text:"Cancel",glyph:"xf00d@FontAwesome",handler:function(a){a.up("window").close()}}]}).show()}},{text:this.localize("downloadButton"),glyph:"xf019@FontAwesome",itemId:"downloadButton",handler:function(){d.downloadFromCorpusId(d.getStore().getCorpus().getId())}});Ext.apply(this,{title:this.localize("title"),emptyText:this.localize("emptyText"),columns:[{xtype:"rownumberer",
renderer:function(a,b,c){return c.getIndex()+1},sortable:!1},{text:this.localize("documentTitle"),dataIndex:"title",sortable:!0,renderer:function(a,b,c){return c.getTitle()},flex:3},{text:this.localize("documentAuthor"),dataIndex:"author",sortable:!0,hidden:!0,renderer:function(a,b,c){return c.getAuthor()},flex:2},{text:this.localize("tokensCountLexical"),dataIndex:"tokensCount-lexical",renderer:Ext.util.Format.numberRenderer("0,000"),sortable:!0,width:"autoSize"},{text:this.localize("typesCountLexical"),
dataIndex:"typesCount-lexical",renderer:Ext.util.Format.numberRenderer("0,000"),width:"autoSize"},{text:this.localize("typeTokenRatioLexical"),dataIndex:"typeTokenRatio-lexical",renderer:function(a){return Ext.util.Format.percent(a)},width:"autoSize"},{text:this.localize("averageWordsPerSentence"),dataIndex:"averageWordsPerSentence",renderer:Ext.util.Format.numberRenderer("0,000.0"),tooltip:this.localize("averageWordsPerSentenceTip"),width:"autoSize"},{text:this.localize("language"),dataIndex:"language",
hidden:!0,renderer:function(a,b,c,d,k,l,m){return m.ownerCt.getLanguage(a)},width:"autoSize"}],store:b,selModel:{type:"rowmodel",mode:"MULTI",listeners:{selectionchange:{fn:function(a,b){this.getApplication().dispatchEvent("documentsClicked",this,b,this.getStore().getCorpus())},scope:this}}},dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:c}]});this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.on("loadedCorpus",function(a,
b){this.store.setCorpus(b);if(this.isVisible())this.store.load({params:this.getApiParams()});else this.on("afterrender",function(){this.store.load({params:this.getApiParams()})},this);0==this.hasCorpusAccess(b)&&(this.queryById("modifyButton").hide(),this.queryById("downloadButton").hide())});this.on("activate",function(){this.getStore().getCorpus()&&this.getStore().load({params:this.getApiParams()})},this);this.on("query",function(a,b){this.setApiParam("query",b);this.store.load({params:this.getApiParams()})});
...
message:this.localize("reorderFilteredError"),buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR});docIndex=[];b.getStore().each(function(a){docIndex.push(a.getIndex())},this);for(a=1;a<docIndex.length;a++)if(docIndex[a-1]>docIndex[a])return Ext.Msg.confirm(b.localize("newCorpus"),(new Ext.Template(b.localize(e+"Documents"))).applyTemplate([c.length]),function(a){"yes"===a&&(docIndex=[],this.getStore().each(function(a){docIndex.push(a.getIndex())},this),a={docIndex:docIndex},a[e+"Documents"]=!0,this.editCorpus(a))},
...
function(a){"yes"===a&&(docIndex=[],c.forEach(function(a){docIndex.push(a.getIndex())}),a={docIndex:docIndex},a[e+"Documents"]=!0,this.editCorpus(a))},b):b.getApiParam("query")&&b.getStore().getCount()<d?Ext.Msg.confirm(this.localize("newCorpus"),(new Ext.Template(this.localize(e+"FilteredDocuments"))).applyTemplate([c.length]),function(a){"yes"===a&&(docIndex=[],this.getStore().each(function(a){docIndex.push(a.getIndex())},this),a={docIndex:docIndex},a[e+"Documents"]=!0,this.editCorpus(a))},b):Ext.Msg.show({title:this.localize("error"),
...
sortable:!1,menuDisabled:!0,width:25,getGlyph:"xf014@FontAwesome",tooltip:this.localize("deleteQueryTip"),menuDisabled:!0,sortable:!1,handler:this.removeRow,scope:this}],store:new Ext.data.Store({autoDestroy:!0,fields:["id","operator","field","query","count"],data:[["","","","",0]]})});this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.on("loadedCorpus",function(a,b){var e=b.getDocuments();if(e&&0<e.getCount()){var f=e.getDocument(0),g=[];["title",
"author","pubDate","publisher","pubPlace"].forEach(function(a){Ext.isEmpty(f.get(a))||g.push([this.localize(a+"Field"),a])},this);g&&(e=this.getColumnManager().getHeaderByDataIndex("field").getEditor(),e.getStore().each(function(a){g.push([a.get("text"),a.get("value")])},this),e.setStore(Ext.create("Ext.data.Store",{fields:["text","value"],data:g})));this.updateStatus(0);this.setLoading(!1)}})},removeRow:function(a,b){this.getStore().removeAt(b);0==this.getStore().getCount()&&this.addRow();this.updateAggregate()},
...
this.getCorpus().getDocumentsCount()]));this.exportBtn.setDisabled(0==a)}});Ext.define("Voyant.panel.Dummy",{extend:"Ext.Panel",xtype:"dummy",autoScroll:!0,initComponent:function(){Ext.apply(this,{xtype:"tabpanel",items:[{title:"Tab 1",icon:null,glyph:42,html:"one"},{title:"Tab 2",icon:null,glyph:70,html:"two"}]});this.callParent()}});Ext.define("Voyant.panel.RezoViz",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.rezoviz",statics:{i18n:{},api:{query:void 0,limit:25,stopList:"auto",type:["organization","location","person"],minEdgeCount:2},glyph:"xf1cb@FontAwesome"},config:{network:void 0,nodesStore:void 0,nodesDataSet:void 0,edgesDataSet:void 0,isNetworkBounded:!0},categorizedNodeOptions:{location:{font:{color:"green"}},person:{font:{color:"maroon"}},organization:{font:{color:"purple"}}},nodeOptions:{shape:"box",
...
!1);b.redraw()},categoriesHandler:function(a){var b=[];a.up("menu").items.each(function(a){a.checked&&b.push(a.itemId)});this.setApiParam("type",b);this.getEntities()},map:function(a,b,c,d,e){return d+(a-b)/(c-b)*(e-d)}});Ext.define("Voyant.panel.MicroSearch",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.microsearch",statics:{i18n:{},api:{stopList:"auto",query:void 0},glyph:"xf1ea@FontAwesome"},config:{options:{xtype:"stoplistoption"},maxTokens:0,tokensPerSegment:0,maxVerticalLines:0,maxSegments:0},constructor:function(a){Ext.apply(this,{title:this.localize("title"),dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"querysearchfield"}]}]});this.callParent(arguments);
this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.on("loadedCorpus",function(a,c){if(this.rendered)this.initialize();else this.on("afterrender",function(){this.initialize()},this)});this.on("query",function(a,c){this.setApiParam("query",c);this.updateSearchResults()})},initialize:function(){var a=this.getTargetEl(),b=this.getCorpus();this.setMaxVerticalLines(Math.floor((a.getHeight()-10)/5));var c=b.getDocumentsCount(),d=10*c,e=Math.floor((a.getWidth()-d-10)/c);200<e&&(e=200);
d=Math.floor(e/3);1>d&&(d=1);this.setMaxSegments(d*this.getMaxVerticalLines());b=b.getDocuments();this.setMaxTokens(b.max("tokensCount-lexical"));this.setTokensPerSegment(this.getMaxTokens()<this.getMaxSegments()?1:Math.ceil(this.getMaxTokens()/this.getMaxSegments()));var f="\x3ctable cellpadding\x3d'0' cellspacing\x3d'0' style\x3d'height: 100%'\x3e\x3ctr\x3e";this.segments=[];b.each(function(b){docIndex=b.getIndex();f+='\x3ctd style\x3d"overflow: hidden; vertical-align: top; width: '+e+'px;"\x3e\x3cdiv class\x3d"docLabel" style\x3d"white-space: nowrap; width: '+
e+'px;" data-qtip\x3d"'+b.getFullLabel()+'"\x3e'+b.getFullLabel()+'\x3c/div\x3e\x3ccanvas style\x3d"display: block;" width\x3d"'+e+'" height\x3d"'+a.getHeight()+'" id\x3d"'+this.body.id+"-"+docIndex+'"\x3e\x3c/td\x3e';docIndex+1<c&&(f+='\x3ctd style\x3d"width: 10px;"\x3e\x26nbsp;\x3c/td\x3e')},this);f+="\x3c/tr\x3e\x3c/table\x3e";a.update(f);this.updateSearchResults();if(!this.getApiParam("query")){var g=this;return this.getCorpus().loadCorpusTerms({limit:1,stopList:this.getApiParam("stopList")}).then(function(a){a=
...
10);var c=Ext.Array.from(this.getApiParam("query"));(!a||0<c.length)&&this.getCorpus().getCorpusTerms().load({params:Ext.apply(b,{withDistributions:!0}),callback:function(a){var b=this.getTargetEl().dom.querySelector("canvas"),f=b.getContext("2d");diam=b.width;rad=diam/2;f.font=this.textFont;for(var g={},b=0,h=a.length;b<h;b++){var k=a[b].getTerm();a[b].getDistributions().forEach(function(a,b){0<a&&this.documents[b].matches.push(k)},this);g[k]={record:a[b],colour:this.getApplication().getColor(b),
width:f.measureText(k).width,isHovering:!1}}this.magnets={};c.forEach(function(a){g[a]&&(this.magnets[a]=g[a],delete g[a])},this);for(k in g)this.magnets[k]=g[k];this.setApiParam("query",Object.keys(this.magnets));this.updateMagnets();this.updateDocs();this.draw()},scope:this})}},updateMagnets:function(a){a=this.getTargetEl().dom.querySelector("canvas");a=a.width/2;var b=Object.keys(this.magnets||{}).length,c=0,d;for(d in this.magnets)Ext.apply(this.magnets[d],{x:a+(a-this.gutter-50)*Math.cos(2*Math.PI*
c/b),y:a+(a-this.gutter-50)*Math.sin(2*Math.PI*c/b)}),c++},updateDocs:function(a){a=a||this.getTargetEl().dom.querySelector("canvas");diam=a.width;rad=diam/2;var b=[];if(this.documents){this.documents.forEach(function(a,c){if(0==Ext.Array.from(a.matches).length)b.push(c);else if(1==Ext.Array.from(a.matches).length){var f=15*Math.random()+15,g=15*Math.random()+15;a.targetX=this.magnets[a.matches[0]].x+(0==Math.round(Math.random())?f:-f);a.targetY=this.magnets[a.matches[0]].y+(0==Math.round(Math.random())?
g:-g)}else{var g=f=0,h=a.matches.map(function(a){return this.magnets[a].record.getDistributions()[c]},this),k=Ext.Array.min(h),l=Ext.Array.max(h),m=0;a.matches.forEach(function(a,b){weight=l==k?1:(h[b]-k+k)/(l-k+k);m+=weight;f+=this.magnets[a].x*weight;g+=this.magnets[a].y*weight},this);a.targetX=f/m;a.targetY=g/m}},this);a=0;for(var c=b.length;a<c;a++)Ext.apply(this.documents[a],{targetX:rad+(rad-this.gutter)*Math.cos(2*Math.PI*a/c),targetY:rad+(rad-this.gutter)*Math.sin(2*Math.PI*a/c)})}},draw:function(a,
...
2,k=parseInt(this.textFont)+4;this.documents.forEach(function(a,c){if(d||a.isHovering||1==hoveringDocs[c]){var g=a.width+4;b.fillStyle=a.isHovering||1==hoveringDocs[c]||!0===f?"white":"rgba(255,255,255,.05)";b.fillRect(a.x-g/2,a.y-k/2,g,k);b.strokeStyle=a.isHovering||1==hoveringDocs[c]||!0===f?"rgba(0,0,0,.2)":"rgba(0,0,0,.05)";b.strokeRect(a.x-g/2,a.y-k/2,g,k);b.textAlign="center";b.fillStyle=a.isHovering||1==hoveringDocs[c]||!0===f?"rgba(0,0,0,.8)":"rgba(0,0,0,.05)";b.fillText(a.label,a.x,a.y)}else b.beginPath(),
b.fillStyle="rgba(0,0,0,.8)",b.arc(a.x,a.y,h,0,2*Math.PI),b.fill(),b.stroke();var g=Math.abs(a.x-a.targetX),l=Math.abs(a.y-a.targetY);if(0!=g||0!=l)1>g?a.x=a.targetX:(g/=2,a.x=a.x>a.targetX?a.x-g:a.x+g),1>l?a.y=a.targetY:(l/=2,a.y=a.y>a.targetY?a.y-l:a.y+l),e=!0},this);var l=0,k=parseInt(this.textFont)+4;b.textAlign="center";b.textBaseline="middle";for(var m in this.magnets)d||m in g||this.magnets[m].isHovering?(l=this.magnets[m].width+4,b.fillStyle=m in g||this.magnets[m].isHovering||!0===f?"white":
"rgba(255,255,255,.05)",b.fillRect(this.magnets[m].x-l/2,this.magnets[m].y-k/2,l,k),b.strokeStyle=m in g||this.magnets[m].isHovering||!0===f?"rgb("+this.magnets[m].colour.join(",")+")":"rgba(0,0,0,.05)",b.strokeRect(this.magnets[m].x-l/2,this.magnets[m].y-k/2,l,k),b.textAlign="center",b.fillStyle=m in g||this.magnets[m].isHovering||!0===f?"rgba(0,0,0,.8)":"rgba(0,0,0,.05)",b.fillText(m,this.magnets[m].x,this.magnets[m].y)):(b.beginPath(),b.fillStyle="rgb("+this.magnets[m].colour.join(",")+")",b.strokeStyle=
"rgb("+this.magnets[m].colour.join(",")+")",b.arc(this.magnets[m].x,this.magnets[m].y,12,0,2*Math.PI),b.fill(),b.stroke())}if(e){var n=this;setTimeout(function(){n.draw()},100)}else if(this.documents){c=Math.max(c/this.documents.length,50);l=0;for(m=this.documents.length;l<m;l++)for(var q=0;q<m;q++)if(l<q){var r=this.documents[l].x-this.documents[q].x,p=this.documents[l].y-this.documents[q].y;Math.sqrt(r*r+p*p)<c&&(r*=.1,p*=.1,this.documents[l].targetX+=r,this.documents[q].targetX-=r,this.documents[l].targetY+=
p,this.documents[q].targetY-=p,e=!0)}e&&(n=this,setTimeout(function(){n.draw()},100))}}});Ext.define("Voyant.panel.Reader",{extend:"Ext.panel.Panel",requires:["Voyant.data.store.Tokens"],mixins:["Voyant.panel.Panel"],alias:"widget.reader",isConsumptive:!0,statics:{i18n:{},api:{start:0,limit:1E3,skipToDocId:void 0,query:void 0},glyph:"xf0f6@FontAwesome"},config:{innerContainer:void 0,tokensStore:void 0,documentsStore:void 0,documentTermsStore:void 0,exportVisualization:!1,lastScrollTop:0,scrollIntoView:!1,insertWhere:"beforeEnd",locationMarker:void 0,lastLocationUpdate:new Date,isDetailedGraph:!0},
SCROLL_UP:-1,SCROLL_EQ:0,SCROLL_DOWN:1,LOCATION_UPDATE_FREQ:100,DETAILED_GRAPH_DOC_LIMIT:25,INITIAL_LIMIT:1E3,constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(a){var b=Ext.create("Voyant.data.store.Tokens",{parentTool:this,proxy:{extraParams:{forTool:"reader"}}}),c=this;b.on("beforeload",function(a){return c.hasCorpusAccess(a.getCorpus())});b.on("load",function(a,b,c){if(c){var g="",h=this.localize("documentFrequency"),
k=!1,l=-1,m=!1;b.forEach(function(a){0==a.getPosition()&&(g+="\x3ch3\x3e"+this.getDocumentsStore().getById(a.getDocId()).getFullLabel()+"\x3c/h3\x3e");a.getDocIndex()!=l&&(k=this.getDocumentsStore().getById(a.getDocId()).isPlainText(),l=a.getDocIndex());if(a.isWord())m=!1,g+="\x3cspan class\x3d'word' id\x3d'"+a.getId()+"' data-qtip\x3d'"+h+" "+a.getDocumentRawFreq()+"'\x3e"+a.getTerm()+"\x3c/span\x3e";else{a=a.getTermWithLineSpacing(k);var b=0==a.indexOf("\x3cbr /\x3e");if(!m||!b&&0!=a.trim().length)g+=
a,m=b}},this);this.updateText(g);this.down("querysearchfield").getValue()}},this);this.setTokensStore(b);this.on("query",function(a,b){this.loadQueryTerms(b)},this);this.setDocumentTermsStore(Ext.create("Ext.data.Store",{model:"Voyant.data.model.DocumentTerm",autoLoad:!1,remoteSort:!1,proxy:{type:"ajax",url:Voyant.application.getTromboneUrl(),extraParams:{tool:"corpus.DocumentTerms",withDistributions:!0,withPositions:!0,bins:25,forTool:"reader"},reader:{type:"json",rootProperty:"documentTerms.terms",
totalProperty:"documentTerms.total"},simpleSortMode:!0},listeners:{load:function(a,b,c,g){a.sort("docIndex","ASC");var h={},k=0,l;a.each(function(a){var b=[],c=a.get("distributions"),d=a.get("docId"),e=a.get("docIndex");l=a.get("term");for(a=0;a<c.length;a++){var f=a,g=c[a];g>k&&(k=g);b.push([d,e,f,g,l])}h[e]=b},this);this.highlightKeywords(l);if(this.getIsDetailedGraph())for(a=this.query("cartesian"),b=0;b<a.length;b++)c=a[b],g=h[b],void 0!==g?(c.getAxes()[0].setMaximum(k),c.getStore().loadData(g)):
c.getStore().removeAll()},scope:this}}));this.on("afterrender",function(){var a=this.down('panel[region\x3d"center"]');this.setInnerContainer(a.getLayout().getRenderTarget());a.body.on("scroll",function(a,b){var c=this.getLastScrollTop()<b.scrollTop?this.SCROLL_DOWN:this.getLastScrollTop()>b.scrollTop?this.SCROLL_UP:this.SCROLL_EQ;if(c==this.SCROLL_UP&&1>b.scrollTop)this.fetchPrevious(!0);else if(c==this.SCROLL_DOWN&&b.scrollHeight-b.scrollTop<1.5*b.offsetHeight)this.fetchNext(!1);else{var d;d=0==
b.scrollTop?0:b.scrollHeight-b.scrollTop==b.clientHeight?1:(b.scrollTop+.5*b.clientHeight)/b.scrollHeight;(new Date-this.getLastLocationUpdate()>this.LOCATION_UPDATE_FREQ||0==d||1==d)&&this.updateLocationMarker(d,c)}this.setLastScrollTop(b.scrollTop)},this);a.body.on("click",function(a,b){b=Ext.get(b);if(b.hasCls("word")){var c=Voyant.data.model.Token.getInfoFromElement(b),d=b.getHtml(),c=[{term:d,docIndex:c.docIndex}];this.loadQueryTerms([d]);this.getApplication().dispatchEvent("termsClicked",this,
c)}},this);if(this.getCorpus())this.load(),(a=this.getApiParam("query"))&&this.loadQueryTerms(Ext.isString(a)?[a]:a);else this.on("loadedCorpus",function(){this.load();var a=this.getApiParam("query");a&&this.loadQueryTerms(Ext.isString(a)?[a]:a)},this)},this);Ext.apply(this,{title:this.localize("title"),cls:"voyant-reader",layout:"fit",items:{layout:"border",items:[{bodyPadding:10,region:"center",border:!1,autoScroll:!0,html:'\x3cdiv class\x3d"readerContainer"\x3e\x3c/div\x3e'},{region:"south",height:40,
split:{size:2},splitterResize:!0,border:!1,layout:{type:"hbox"}}]},dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{glyph:"xf060@FontAwesome",handler:function(){this.fetchPrevious(!0)},scope:this},{glyph:"xf061@FontAwesome",handler:function(){this.fetchNext(!0)},scope:this},{xtype:"tbseparator"},{xtype:"querysearchfield"}]}],listeners:{loadedCorpus:function(a,b){this.getTokensStore().setCorpus(b);this.getDocumentTermsStore().getProxy().setExtraParam("corpus",b.getId());
var c=b.getDocuments();this.setDocumentsStore(c);this.setIsDetailedGraph(c.getTotalCount()<this.DETAILED_GRAPH_DOC_LIMIT);c=this.down('panel[region\x3d"south"]');void 0==this.getLocationMarker()&&this.setLocationMarker(Ext.DomHelper.append(c.el,{tag:"div",style:"background-color: #157fcc; height: 100%; width: 2px; position: absolute; top: 0; left: 0;"}));this.generateChart(b,c);this.rendered&&(this.load(),0==this.hasCorpusAccess(b)&&this.mask(this.localize("limitedAccess"),"mask-no-spinner"),(c=this.getApiParam("query"))&&
this.loadQueryTerms(Ext.isString(c)?[c]:c))},termsClicked:function(a,b){var c=[];b.forEach(function(a){Ext.isString(a)?c.push(a):a.term?c.push(a.term):a.getTerm&&c.push(a.getTerm())});0<c.length&&this.loadQueryTerms(c)},corpusTermsClicked:function(a,b){var c=[];b.forEach(function(a){a.getTerm()&&c.push(a.getTerm())});this.loadQueryTerms(c)},documentTermsClicked:function(a,b){var c=[];b.forEach(function(a){a.getTerm()&&c.push(a.getTerm())});this.loadQueryTerms(c)},documentSelected:function(a,b){var c=
this.getTokensStore().getCorpus().getDocument(b);this.setApiParams({skipToDocId:c.getId(),start:0});this.load(!0)},documentsClicked:function(a,b,c){0<b.length&&(this.setApiParams({skipToDocId:b[0].getId(),start:0}),this.load(!0))},termLocationClicked:function(a,b){if(void 0!==b[0]){var c=b[0],g=c.get("docIndex"),h=c.get("position"),k=h-this.getApiParam("limit")/2,l=this.getCorpus().getDocument(g);this.setApiParams({skipToDocId:l.getId(),start:0>k?0:k});this.load(!0,{callback:function(){var a=this.body.dom.querySelector("#_"+
g+"_"+h);a&&a.scrollIntoView();this.highlightKeywords(c.get("term"),!1)},scope:this})}},documentIndexTermsClicked:function(a,b){if(void 0!==b[0]){var c=Ext.create("Voyant.data.model.Token",b[0]);this.fireEvent("termLocationClicked",this,[c])}},scope:this}});this.callParent(arguments)},loadQueryTerms:function(a){a&&0<a.length&&this.getDocumentTermsStore().load({params:{query:a}})},updateLocationMarker:function(a,b){var c=Ext.DomQuery.select(".word",this.getInnerContainer().down(".readerContainer",
!0)),d=c[0],e=c[c.length-1];if(void 0!==d&&void 0!==e){var c=this.getCorpus(),f=!1,g=Voyant.data.model.Token.getInfoFromElement(Ext.get(d)),e=Voyant.data.model.Token.getInfoFromElement(Ext.get(e));0!==g.position&&(f=!0);for(var h={},d=0,k=g.docIndex;k<=e.docIndex;){var l=c.getDocument(k).get("tokensCount-lexical");k===e.docIndex&&(l=e.position);k===g.docIndex&&(l-=g.position);d+=l;h[k]=l;k++}for(var k=Math.round(d*a),l=d=0,m=g.docIndex;m<=e.docIndex&&!(d=m,l+=h[m],l>=k);m++);e=h[d]-(l-k);f&&d===g.docIndex&&
(e+=g.position);f=e/c.getDocument(d).get("tokensCount-lexical");c=Ext.get(this.getLocationMarker());g=c.getX();this.getIsDetailedGraph()?(e=this.query("cartesian")[d])&&(g=e.getX()+e.getWidth()*f):(e=this.down("cartesian"),g=e.getWidth()/this.getCorpus().getDocuments().getCount(),g=e.getX()+g*d+g*f);null!=b&&(f=c.getX(),b==this.SCROLL_DOWN&&f>g||b==this.SCROLL_UP&&f<g)&&(g=f);c.setX(g)}this.setLastLocationUpdate(new Date)},generateChart:function(a,b){function c(a,b){var c=this.getApplication().getColor(a);
return"rgba("+c[0]+","+c[1]+","+c[2]+","+b+")"}function d(d){var e=d.index,f=d.fraction;d=d.relativeHeight;var g=c.call(this,e,.3),e=c.call(this,e,1);b.add({xtype:"cartesian",plugins:{ptype:"chartitemevents"},flex:f,height:"100%",insetPadding:0,background:{type:"linear",degrees:90,stops:[{offset:0,color:g},{offset:d,color:g},{offset:d,color:"white"},{offset:1,color:"white"}]},axes:[{type:"numeric",position:"left",fields:"distribution",hidden:!0},{type:"category",position:"bottom",fields:"bin",hidden:!0}],
series:[{type:"line",xField:"bin",yField:"distribution",style:{lineWidth:2,strokeStyle:e},tooltip:{corpus:a,trackMouse:!0,style:"background: #fff",showDelay:0,dismissDelay:500,hideDelay:5,renderer:function(b,c,d){b.setHtml(a.getDocument(c.get("docIndex")).getTitle()+"\x3cbr\x3e"+c.get("term")+": "+c.get("distribution"))}}}],store:Ext.create("Ext.data.ArrayStore",{fields:["docId","docIndex","bin","distribution","term"],data:[]}),listeners:{itemclick:function(a,b,c){a=b.record.data;a=this.getDocumentsStore().getAt(a.docIndex);
this.getApplication().dispatchEvent("documentsClicked",this,[a])},scope:this}}).body.on("click",function(a,b){var c=Ext.get(b),d=a.getX(),e=c.getBox(),d=(d-e.x)/e.width,c=c.parent(".x-panel"),e=c.parent(),c=Ext.toArray(e.dom.children).indexOf(c.dom),c=this.getDocumentsStore().getAt(c),e=c.get("tokensCount-lexical"),d=Math.floor(e*d)-this.getApiParam("limit")/2;this.setApiParams({skipToDocId:c.getId(),start:0>d?0:d});this.load(!0)},this)}b.removeAll();for(var e=a.getDocuments(),f=a.getWordTokensCount(),
g=[],h=Number.MAX_VALUE,k=-1,l=0;l<e.getCount();l++){var m=e.getAt(l),n=m.get("index"),m=m.get("tokensCount-lexical");m<h&&(h=m);m>k&&(k=m);g.push({index:n,count:m,fraction:m/f})}if(this.getIsDetailedGraph())for(l=0;l<g.length;l++)m=g[l],m.relativeHeight=m.count==k?1:.25+(m.count-h)/(k-h)*.75,d.call(this,m);else b.add({xtype:"cartesian",plugins:{ptype:"chartitemevents"},flex:1,height:"100%",insetPadding:0,axes:[{type:"numeric",position:"left",fields:"count",hidden:!0},{type:"category",position:"bottom",
fields:"index",hidden:!0}],series:[{type:"bar",xField:"index",yField:"count",style:{minGapWidth:0,minBarWidth:1,lineWidth:0,strokeStyle:"none"},renderer:function(a,b,d,e){a=this.getChart().findParentByType("reader");return{fillStyle:c.call(a,e,.3)}}}],store:Ext.create("Ext.data.JsonStore",{fields:[{name:"index",type:"int"},{name:"count",type:"int"},{name:"fraction",type:"float"}],data:g}),listeners:{itemclick:function(a,b,c){a=Ext.get(c.getTarget());c=c.getX();a=a.getBox();var d=a.width/this.getCorpus().getDocuments().getCount();
c=(c-a.x)%d/d;b=b.record.data;b=this.getDocumentsStore().getAt(b.index);a=b.get("tokensCount-lexical");c=Math.floor(a*c)-this.getApiParam("limit")/2;this.setApiParams({skipToDocId:b.getId(),start:0>c?0:c});this.load(!0)},scope:this}})},highlightKeywords:function(a,b){Ext.isArray(a)||(a=[a]);this.getInnerContainer().first().select("span[class*\x3dkeyword]").removeCls("keyword");var c=[],d=new RegExp("^"+a[0]+"$","i");this.getInnerContainer().first().select("span.word").each(function(a,b,g){a.dom.firstChild&&
a.dom.firstChild.nodeValue.match(d)&&(a.addCls("keyword"),c.push(a.dom))})},fetchPrevious:function(a){var b=this.getInnerContainer().first(),c=b.first(".word");if(null!=c&&!1===c.hasCls("loading"))for(;c;){if(c.hasCls("word")){var b=Voyant.data.model.Token.getInfoFromElement(c),d=b.docIndex,b=b.position,e=this.getDocumentsStore().getAt(d),f=this.getApiParam("limit"),g=!1;if(0===d&&0===b){a=this.down('panel[region\x3d"center"]').body;0!=c.getScrollIntoViewXY(a,a.dom.scrollTop,a.dom.scrollLeft).y&&
...
c=b.first()}},fetchNext:function(a){var b=this.getInnerContainer().first(),c=b.last();if(!1===c.hasCls("loading"))for(;c;){if(c.hasCls("word")){var b=Voyant.data.model.Token.getInfoFromElement(c),d=b.docIndex,e=b.position,f=this.getDocumentsStore().getAt(b.docIndex),g=f.getId(),f=f.get("tokensCount-lexical");if(e+this.getApiParam("limit")>=f&&d==this.getCorpus().getDocumentsCount()-1)if(d=f-e,1>=d){c.dom.scrollIntoView();c.frame("red");break}else this.setApiParam("limit",d);for(d=c.dom.nextSibling;d;)e=
...
this.localize("loading")+"\x3c/div\x3e\x3c/div\x3e"),this.getInnerContainer().first().first().mask());this.getTokensStore().load(Ext.apply(b||{},{params:Ext.apply(this.getApiParams(),{stripTags:"blocksOnly",stopList:""})}))},updateText:function(a){var b=this.getInnerContainer().down(".loading");b&&b.destroy();var c=this.getInnerContainer().first().insertHtml(this.getInsertWhere(),a,!0);c&&this.getScrollIntoView()&&(c.dom.scrollIntoView(),Ext.Function.defer(function(){var a=Ext.get(c.id);a&&a.frame("red")},
100));a=this.down('panel[region\x3d"center"]').body.dom;this.updateLocationMarker(0==a.scrollTop?0:a.scrollHeight-a.scrollTop==a.clientHeight?1:(a.scrollTop+.5*a.clientHeight)/a.scrollHeight)},updateChart:function(){}});Ext.define("Voyant.panel.SimpleDocReader",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.simpledocreader",isConsumptive:!0,statics:{i18n:{noNext:"No next document.",noPrevious:"No previous document."},api:{docIndex:void 0,docId:void 0},glyph:"xf0f6@FontAwesome"},config:{},constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(a){Ext.apply(this,{html:'\x3ciframe style\x3d"width: 100%; height: 100%; border: none;"\x3e\x3c/iframe\x3e',
dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{glyph:"xf060@FontAwesome",handler:this.fetchPrevious,scope:this},{glyph:"xf061@FontAwesome",handler:this.fetchNext,scope:this}]}],listeners:{loadedCorpus:function(a,c){"true"!==this.getApiParam("autoLoadOnLoadedCorpus","false")&&this.fireEvent("documentSelected",this,0)},documentSelected:function(a,c){this.setApiParams({docIndex:this.getCorpus().getDocument(c).getIndex(),docId:void 0});this.fetch()},scope:this}});this.callParent(arguments)},
fetchPrevious:function(){var a;a=void 0!==this.getApiParam("docIndex")?this.getCorpus().getDocument(this.getApiParam("docIndex")):void 0!==this.getApiParam("docId")?this.getCorpus().getDocument(this.getApiParam("docId")):this.getCorpus().getDocument(1);0<a.getIndex()?(this.setApiParams({docIndex:a.getIndex()-1,docId:void 0}),this.fetch()):this.toastInfo(this.localize("noPrevious"))},fetchNext:function(){var a;if(void 0!==this.getApiParam("docIndex"))a=this.getCorpus().getDocument(this.getApiParam("docIndex"));
else if(void 0!==this.getApiParam("docId"))a=this.getCorpus().getDocument(this.getApiParam("docId"));else return this.setApiParams({docIndex:0,docId:void 0}),this.fetch();a.getIndex()<this.getCorpus().getDocumentsCount()-1?(this.setApiParams({docIndex:a.getIndex()+1,docId:void 0}),this.fetch()):this.toastInfo(this.localize("noNext"))},fetch:function(){var a;a=void 0!==this.getApiParam("docIndex")?this.getCorpus().getDocument(this.getApiParam("docIndex")):void 0!==this.getApiParam("docId")?this.getCorpus().getDocument(this.getApiParam("docId")):
this.getCorpus().getDocument(0);var b=this.getTargetEl().down("iframe",!0);b.setAttribute("src","about:blank");if(this.getApiParam("originalUrlMetadataKey")){var c=a.get(this.getApiParam("originalUrlMetadataKey"));if(c){b.setAttribute("src",c);return}}a={corpus:this.getCorpus().getId(),docIndex:a.getIndex(),tool:"corpus.DocumentTokens",template:"docTokensPlusStructure2html",outputFormat:"html",limit:0};c=this.getTromboneUrl()+"?"+Ext.Object.toQueryString(a);b.setAttribute("src",c)}});Ext.define("Voyant.panel.ScatterPlot",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],requires:["Ext.chart.CartesianChart"],alias:"widget.scatterplot",statics:{i18n:{tsne:"t-SNE",terms:"Terms",reload:"Reload",options:"Options",input:"Input",output:"Output",perplexity:"Perplexity",iterations:"Iterations",analyzing:"Analyzing",plotting:"Plotting"},api:{docId:void 0,analysis:"ca",limit:50,dimensions:3,bins:10,clusters:3,perplexity:15,iterations:1500,comparisonType:"relative",stopList:"auto",
target:void 0,term:void 0,query:void 0,whitelist:void 0,label:["summary","docs","terms"],storeJson:void 0},glyph:"xf06e@FontAwesome"},config:{options:{xtype:"stoplistoption"},caStore:null,pcaStore:null,tsneStore:null,docSimStore:null,termStore:null,chartMenu:null,newTerm:null,termsTimeout:null,highlightData:{x:0,y:0,r:0},highlightTask:null},tokenFreqTipTemplate:null,docFreqTipTemplate:null,constructor:function(a){this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);if("storeJson"in a){var b=
JSON.parse(a.storeJson);Ext.apply(a,b)}this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(){this.setCaStore(Ext.create("Voyant.data.store.CAAnalysis",{listeners:{load:this.maskAndBuildChart,scope:this}}));this.setPcaStore(Ext.create("Voyant.data.store.PCAAnalysis",{listeners:{load:this.maskAndBuildChart,scope:this}}));this.setTsneStore(Ext.create("Voyant.data.store.TSNEAnalysis",{listeners:{load:this.maskAndBuildChart,scope:this}}));
this.setDocSimStore(Ext.create("Voyant.data.store.DocSimAnalysis",{listeners:{load:this.maskAndBuildChart,scope:this}}));this.setTermStore(Ext.create("Ext.data.JsonStore",{fields:[{name:"term"},{name:"rawFreq",type:"int"},{name:"relativeFreq",type:"number"},{name:"coordinates",mapping:"vector"},{name:"category"}],sorters:[{property:"rawFreq",direction:"DESC"}],groupField:"category"}));this.setChartMenu(Ext.create("Ext.menu.Menu",{items:[{text:this.localize("remove"),itemId:"remove",glyph:"xf068@FontAwesome"},
{text:this.localize("nearby"),itemId:"nearby",glyph:"xf0b2@FontAwesome"}],listeners:{hide:function(){var a=this.down("#chart").getSeries();a[0].enableToolTips();a[1].enableToolTips()},scope:this}}));this.tokenFreqTipTemplate=new Ext.Template(this.localize("tokenFreqTip"));this.docFreqTipTemplate=new Ext.Template(this.localize("docFreqTip"));Ext.apply(this,{title:this.localize("title"),layout:"border",autoDestroy:!0,items:[{itemId:"chartParent",region:"center",layout:"fit",tbar:{overflowHandler:"scroller",
items:[{xtype:"querysearchfield",itemId:"filterTerms",width:150},{text:this.localize("labels"),itemId:"labels",glyph:"xf02b@FontAwesome",menu:{items:[{text:this.localize("summaryLabel"),itemId:"summary",xtype:"menucheckitem"},{text:this.localize("docsLabel"),itemId:"docs",xtype:"menucheckitem"},{text:this.localize("termsLabel"),itemId:"terms",xtype:"menucheckitem"}],listeners:{afterrender:function(a){var b=this.getApiParam("label");a.items.each(function(a){a.setChecked(-1<b.indexOf(a.getItemId()))})},
click:function(a,b){var c=this.getApiParam("label"),d=b.getItemId();Ext.isString(c)&&(c=[c]);b.checked&&-1==c.indexOf(d)?c.push(d):!b.checked&&-1<c.indexOf(d)&&(c=c.filter(function(a){return a!=d}));this.setApiParam("label",c);this.doLabels();this.queryById("chart").redraw()},scope:this}}}]},listeners:{query:function(a,b){this.getTermStore().filter([{property:"term",value:b,anyMatch:!0}]);this.filterChart(b)},scope:this}},{itemId:"optionsPanel",title:this.localize("options"),region:"west",split:!0,
collapsible:!0,collapseMode:"header",width:135,scrollable:"y",layout:{type:"vbox",align:"stretch"},defaults:{xtype:"button",margin:"5",labelAlign:"top"},items:[{xtype:"label",text:this.localize("input")},{xtype:"documentselectorbutton"},{text:this.localize("freqsMode"),itemId:"comparisonType",glyph:"xf201@FontAwesome",tooltip:this.localize("freqsModeTip"),menu:{items:[{text:this.localize("rawFrequencies"),itemId:"comparisonType_raw",group:"freqsMode",xtype:"menucheckitem"},{text:this.localize("relativeFrequencies"),
itemId:"comparisonType_relative",group:"freqsMode",xtype:"menucheckitem"},{text:this.localize("tfidf"),itemId:"comparisonType_tfidf",group:"freqsMode",xtype:"menucheckitem"}],listeners:{click:function(a,b){if(void 0!==b){var c=b.getItemId().split("_")[1];c!==this.getApiParam("comparisonType")&&(this.setApiParam("comparisonType",c),this.loadFromApis(!0))}},scope:this}}},{fieldLabel:this.localize("numTerms"),itemId:"limit",xtype:"numberfield",minValue:5,listeners:{change:function(a,b,c){function d(){this.setApiParam("limit",
b);this.loadFromApis()}null!==c&&(null!==this.getTermsTimeout()&&clearTimeout(this.getTermsTimeout()),a.isValid()&&this.setTermsTimeout(setTimeout(d.bind(this),500)))},scope:this}},{xtype:"container",html:'\x3chr style\x3d"border: none; border-top: 1px solid #cfcfcf;"/\x3e'},{xtype:"label",text:this.localize("output")},{text:this.localize("analysis"),itemId:"analysis",glyph:"xf1ec@FontAwesome",overflowHandler:"scroller",menu:{items:[{text:this.localize("pca"),itemId:"analysis_pca",group:"analysis",
xtype:"menucheckitem"},{text:this.localize("ca"),itemId:"analysis_ca",group:"analysis",xtype:"menucheckitem"},{text:this.localize("tsne"),itemId:"analysis_tsne",group:"analysis",xtype:"menucheckitem"},{text:this.localize("docSim"),itemId:"analysis_docSim",group:"analysis",xtype:"menucheckitem"}],listeners:{click:function(a,b){if(void 0!==b){var c=b.getItemId().split("_")[1];c!==this.getApiParam("analysis")&&(this.doAnalysisChange(c),this.loadFromApis(!0))}},scope:this}}},{fieldLabel:this.localize("perplexity"),
itemId:"perplexity",xtype:"slider",minValue:5,maxValue:100,increment:1,listeners:{changecomplete:function(a,b){this.setApiParam("perplexity",b);this.loadFromApis(!0)},scope:this}},{fieldLabel:this.localize("iterations"),itemId:"iterations",xtype:"slider",minValue:100,maxValue:5E3,increment:100,listeners:{changecomplete:function(a,b){this.setApiParam("iterations",b);this.loadFromApis(!0)},scope:this}},{text:this.localize("clusters"),itemId:"clusters",glyph:"xf192@FontAwesome",menu:{items:[{text:"1",
itemId:"clusters_1",group:"clusters",xtype:"menucheckitem"},{text:"2",itemId:"clusters_2",group:"clusters",xtype:"menucheckitem"},{text:"3",itemId:"clusters_3",group:"clusters",xtype:"menucheckitem"},{text:"4",itemId:"clusters_4",group:"clusters",xtype:"menucheckitem"},{text:"5",itemId:"clusters_5",group:"clusters",xtype:"menucheckitem"}],listeners:{click:function(a,b){if(void 0!==b){var c=parseInt(b.getItemId().split("_")[1]);c!==this.getApiParam("clusters")&&(this.setApiParam("clusters",c),this.loadFromApis(!0))}},
scope:this}}},{text:this.localize("dimensions"),itemId:"dimensions",glyph:"xf1b2@FontAwesome",menu:{items:[{text:"2",itemId:"dimensions_2",group:"dimensions",xtype:"menucheckitem"},{text:"3",itemId:"dimensions_3",group:"dimensions",xtype:"menucheckitem"}],listeners:{click:function(a,b){if(void 0!==b){var c=parseInt(b.getItemId().split("_")[1]);if(c!==this.getApiParam("dimensions")){if(3==c&&"ca"==this.getApiParam("analysis")&&3==this.getCorpus().getDocumentsCount())return!1;this.setApiParam("dimensions",
c);this.loadFromApis(!0)}}},scope:this}}},{itemId:"reloadButton",text:this.localize("reload"),glyph:"xf021@FontAwesome",handler:function(){this.loadFromApis()},scope:this}]},{itemId:"termsGrid",xtype:"grid",title:this.localize("terms"),region:"east",width:250,split:!0,collapsible:!0,collapseMode:"header",forceFit:!0,features:[{ftype:"grouping",hideGroupedHeader:!0,enableGroupingMenu:!1}],bbar:{overflowHandler:"scroller",items:[{itemId:"nearbyButton",xtype:"button",text:this.localize("nearby"),glyph:"xf0b2@FontAwesome",
flex:1,handler:function(a){var b=a.up("panel").getSelection()[0];void 0===b?this.toastError({html:this.localize("noTermSelected"),anchor:a.up("panel").getTargetEl()}):(a=b.get("term"),this.getNearbyForTerm(a))},scope:this},{itemId:"removeButton",xtype:"button",text:this.localize("remove"),glyph:"xf068@FontAwesome",flex:1,handler:function(a){var b=a.up("panel").getSelection()[0];void 0===b?this.toastError({html:this.localize("noTermSelected"),anchor:a.up("panel").getTargetEl()}):(a=b.get("term"),this.removeTerm(a))},
scope:this}]},tbar:{overflowHandler:"scroller",items:[{xtype:"querysearchfield",itemId:"addTerms",flex:1}]},columns:[{text:this.localize("term"),dataIndex:"term",flex:1,sortable:!0},{text:this.localize("rawFreq"),dataIndex:"rawFreq",flex:.75,minWidth:70,sortable:!0},{text:this.localize("relFreq"),dataIndex:"relativeFreq",flex:.75,minWidth:70,sortable:!0,hidden:!0}],selModel:{type:"rowmodel",mode:"SINGLE",allowDeselect:!0,toggleOnClick:!0,listeners:{selectionchange:{fn:function(a,b){var c=b[0];if(void 0!==
c){var d=c.get("term"),c="document"===c.get("category");this.selectTerm(d,c);c?(this.queryById("nearbyButton").disable(),this.queryById("removeButton").disable()):(this.queryById("nearbyButton").enable(),this.queryById("removeButton").enable())}else this.selectTerm()},scope:this}}},store:this.getTermStore(),listeners:{expand:function(a){a.getView().refresh()},query:function(a,b){0<b.length&&-1===this.getTermStore().findExact("term",b[0])?(this.setNewTerm(b),this.loadFromApis()):this.setNewTerm(null)},
scope:this}}]});this.on("boxready",function(a,b,c){400>b&&(this.queryById("optionsPanel").collapse(),this.queryById("termsGrid").collapse());this.config.storeClass&&this.config.storeData&&this.loadStoreFromJson(this.config.storeClass,this.config.storeData)},this);this.on("beforedestroy",function(a){a=this.queryById("chart");null!==a&&this.queryById("chartParent").remove(a)},this);this.on("loadedCorpus",function(a,b){var c=function(a){var b=this.getApiParam(a);this.queryById(a).down("#"+a+"_"+b).setChecked(!0)}.bind(this);
c("analysis");this.doAnalysisChange(this.getApiParam("analysis"));c("comparisonType");c("clusters");this.queryById("perplexity").setValue(this.getApiParam("perplexity"));this.queryById("iterations").setValue(this.getApiParam("iterations"));3==b.getDocumentsCount()&&this.setApiParam("dimensions",2);c("dimensions");this.getCaStore().setCorpus(b);this.getPcaStore().setCorpus(b);this.getDocSimStore().setCorpus(b);this.loadFromApis()},this);this.on("documentsSelected",function(a,b){this.setApiParam("docId",
b);this.loadFromApis()},this);this.callParent(arguments)},doAnalysisChange:function(a){this.setApiParam("analysis",a);this.queryById("nearbyButton").setDisabled("tsne"===a);this.queryById("reloadButton").setVisible("tsne"===a);this.queryById("perplexity").setVisible("tsne"===a);this.queryById("iterations").setVisible("tsne"===a);"ca"===a&&3==this.getCorpus().getDocumentsCount()&&(this.setApiParam("dimensions",2),this.queryById("dimensions").menu.items.get(0).setChecked(!0))},loadStoreFromJson:function(a,
b){"Voyant.data.store.CAAnalysis"==a?(this.getCaStore().loadRawData(b),this.doAnalysisChange("ca"),this.maskAndBuildChart.call(this,this.getCaStore())):"Voyant.data.store.PCAAnalysis"==a?(this.getPcaStore().loadRawData(b),this.doAnalysisChange("pca"),this.maskAndBuildChart.call(this,this.getPcaStore())):"Voyant.data.store.TSNEAnalysis"==a?(this.getTsneStore().loadRawData(b),this.doAnalysisChange("tsne"),this.maskAndBuildChart.call(this,this.getTsneStore())):"Voyant.data.store.DocSimAnalysis"==a&&
(this.getDocSimStore().loadRawData(b),this.doAnalysisChange("docSim"),this.maskAndBuildChart.call(this,this.getDocSimStore()))},maskAndBuildChart:function(a){this.queryById("chartParent").mask(this.localize("plotting"));Ext.defer(this.buildChart,50,this,[a])},buildChart:function(a){var b=this,c=this.queryById("chart");null!==c&&this.queryById("chartParent").remove(c);this.queryById("termsGrid").getSelectionModel().deselectAll();var c=a.getAt(0),d=this.getApiParam("dimensions");a="";if("pca"===this.getApiParam("analysis")){for(var e=
c.getPrincipalComponents(),f=0,g=0;g<e.length;g++)f+=parseFloat(e[g].get("eigenValue"));if(0!=f){a=this.localize("pcTitle")+"\n";for(var h=["xAxis","yAxis","fill"],g=0;g<e.length&&!(g>=d);g++){var k=e[g].get("eigenValue")/f*100;a+=this.localize("pc")+" "+(g+1)+" ("+this.localize(h[g])+"): "+Math.round(100*k)/100+"%\n"}}}else if("tsne"!==this.getApiParam("analysis"))for(a=this.localize("caTitle")+"\n",h=["xAxis","yAxis","fill"],e=c.getDimensions(),g=0;g<e.length&&!(g>=d);g++)k=e[g].get("percentage"),
a+=this.localize("dimension")+" "+(g+1)+" ("+this.localize(h[g])+"): "+Math.round(100*k)/100+"%\n";var l=0,m=Number.MAX_VALUE,n=0,q=Number.MAX_VALUE;"docSim"!==this.getApiParam("analysis")&&this.getTermStore().removeAll();var r=[],p=[];c.getTokens().forEach(function(a){var b=a.get("rawFreq"),c=a.get("category");void 0===c&&(c="term",a.set("category","term"));var e="term"===c;e&&(b>l&&(l=b),b<m&&(m=b));this.getTermStore().findExact("term",-1===a.get("term"))&&this.getTermStore().addSorted(a);if(3===
d){var f=a.get("vector")[2];void 0!==f&&(f<q&&(q=f),f>n&&(n=f))}b={x:a.get("vector")[0],y:a.get("vector")[1],z:a.get("vector")[2],term:a.get("term"),rawFreq:b,relativeFreq:a.get("relativeFreq"),cluster:a.get("cluster"),category:c,disabled:!1};e?r.push(b):("bin"===a.get("category")?b.term=b.title="Bin "+a.get("docIndex"):(b.docIndex=a.get("docIndex"),a=this.getCorpus().getDocument(b.docIndex),null!==a&&(b.term=a.getShortTitle(),b.title=a.getTitle())),p.push(b))},this);c=this.getTermStore().getCount();
this.queryById("limit").setRawValue(c);this.setApiParam("limit",c);c=Ext.create("Ext.data.JsonStore",{fields:"term x y z rawFreq relativeFreq cluster category docIndex disabled".split(" "),data:r});g=Ext.create("Ext.data.JsonStore",{fields:"term x y z rawFreq relativeFreq cluster category docIndex disabled".split(" "),data:p});a={itemId:"chart",xtype:"cartesian",interactions:["crosszoom","panzoom","itemhighlight"],plugins:{ptype:"chartitemevents"},axes:[{type:"numeric",position:"bottom",fields:["x"],
label:{rotate:{degrees:-30}}},{type:"numeric",position:"left",fields:["y"]}],sprites:[{type:"text",text:a,x:70,y:70}],innerPadding:{top:25,right:25,bottom:25,left:25},series:[{type:"customScatter",xField:"x",yField:"y",store:c,label:{font:"14px Helvetica",field:"term",display:"over"},tooltip:{trackMouse:!0,style:"background: #fff",renderer:function(a,c,d){a.setHtml(b.tokenFreqTipTemplate.apply([c.get("term"),c.get("rawFreq"),c.get("relativeFreq")]))}},marker:{type:"circle"},highlight:{fillStyle:"yellow",
strokeStyle:"black"},renderer:function(a,c,e,f){a=e.store.getAt(f);if(null!==a){var g=a.get("cluster");-1===g&&(g=0);e=.65;f=1;!0===a.get("disabled")?f=e=.1:3===d&&a.get("z")&&(e=b.interpolate(a.get("z"),q,n,0,1));g=b.getApplication().getColor(g);c.fillStyle="rgba("+g.join(",")+","+e+")";c.strokeStyle="rgba("+g.join(",")+","+f+")";a=a.get("rawFreq");a=b.interpolate(a,m,l,2,20);c.radius=a}},scope:this},{type:"customScatter",xField:"x",yField:"y",store:g,label:{font:"14px Helvetica",field:"term",display:"over",
color:this.getDefaultDocColor(!0)},tooltip:{trackMouse:!0,style:"background: #fff",renderer:function(a,c,d){a.setHtml(b.docFreqTipTemplate.apply([c.get("title"),c.get("rawFreq")]))}},marker:{type:"diamond"},highlight:{fillStyle:"yellow",strokeStyle:"black"},renderer:function(a,c,e,f){a=e.store.getAt(f);null!==a&&(e=a.get("cluster"),e=-1===e||"docSim"!==b.getApiParam("analysis")?b.getDefaultDocColor():b.getApplication().getColor(e),f=.65,3===d&&a.get("z")&&(f=b.interpolate(a.get("z"),q,n,0,1)),c.fillStyle=
"rgba("+e.join(",")+","+f+")",c.strokeStyle="rgba("+e.join(",")+",1)",c.radius=5)},scope:this}],listeners:{itemclick:function(a,b,c){a=b.record.data;"doc"===a.category?(a=this.getCorpus().getDocument(a.docIndex),this.getApplication().dispatchEvent("documentsClicked",this,[a])):"term"===a.category&&(a=Ext.create("Voyant.data.model.CorpusTerm",a),this.getApplication().dispatchEvent("corpusTermsClicked",this,[a]))},render:function(a){a.body.on("contextmenu",function(a,b){a.preventDefault();var c=a.getXY(),
d=Ext.fly(b).getXY(),e=c[0]-d[0],d=c[1]-d[1],f=this.down("#chart").getItemForPoint(e,d);null!=f&&"term"===f.record.get("category")&&(e=this.down("#chart").getSeries(),e[0].disableToolTips(),e[1].disableToolTips(),d=f.record.get("term"),e=(new Ext.Template(this.localize("removeTerm"))).apply([d]),this.getChartMenu().queryById("remove").setText(e),e=(new Ext.Template(this.localize("nearbyTerm"))).apply([d]),d=this.getChartMenu().queryById("nearby"),d.setText(e),d.setDisabled("tsne"===this.getApiParam("analysis")),
this.getChartMenu().on("click",function(a,b){if(void 0!==b){var c=f.record.get("term");"nearby"===b.getItemId()?this.getNearbyForTerm(c):this.removeTerm(c)}},this,{single:!0}),this.getChartMenu().showAt(c))},this)},scope:this}};a=Ext.create("Ext.chart.CartesianChart",a);this.queryById("chartParent").insert(0,a);this.queryById("chartParent").unmask();this.doLabels();null!==this.getNewTerm()&&(this.selectTerm(this.getNewTerm()[0]),this.setNewTerm(null))},getDefaultDocColor:function(a){return this.getApplication().getColor(6,
a)},doLabels:function(){var a=this.queryById("chart"),b=a.getSeries(),a=a.getSurface("chart").getItems()[0],c=this.getApiParam("label");-1<c.indexOf("summary")?a.show():a.hide();-1<c.indexOf("terms")?b[0].getLabel().show():b[0].getLabel().hide();-1<c.indexOf("docs")?b[1].getLabel().show():b[1].getLabel().hide()},selectTerm:function(a,b){var c=this.down("#chart");if(null!==c)if(void 0===a)c.getSeries()[0].setHighlightItem(null),c.getSeries()[1].setHighlightItem(null);else{var d,e;!0===b?(d=c.getSeries()[1],
e=d.getStore().findExact("title",a)):(d=c.getSeries()[0],e=d.getStore().findExact("term",a));if(-1!==e){var f=d.getStore().getAt(e),g=d.getSprites()[0],f={series:d,category:d.getItemInstancing()?"items":"markers",index:e,record:f,field:d.getYField(),sprite:g};d.setHighlightItem(f);b?c.getSeries()[0].setHighlightItem(null):c.getSeries()[1].setHighlightItem(null);c=this.getPointFromIndex(d,e);this.setHighlightData({x:c[0],y:c[1],r:50});null==this.getHighlightTask()&&this.setHighlightTask(Ext.TaskManager.newTask({run:this.doHighlight,
scope:this,interval:25,repeat:this.getHighlightData().r}));this.getHighlightTask().restart()}}},getPointFromIndex:function(a,b){var c=a.getSprites()[0];return null!==c.surfaceMatrix?c.attr.matrix.clone().prependMatrix(c.surfaceMatrix).transformPoint([c.attr.dataX[b],c.attr.dataY[b]]):[0,0]},doHighlight:function(){var a=this.down("#chart");if(0<this.getHighlightData().r){for(var b=a.getSurface(),c=null,d=b.getItems(),e=0;e<d.length;e++){var f=d[e];if("customHighlight"==f.id){c=f;break}}null==c?b.add({id:"customHighlight",
type:"circle",strokeStyle:"red",fillStyle:"none",radius:this.getHighlightData().r,x:this.getHighlightData().x,y:this.getHighlightData().y}):(c.setAttributes({x:this.getHighlightData().x,y:this.getHighlightData().y,radius:this.getHighlightData().r}),this.getHighlightData().r-=1.5,0>=this.getHighlightData().r&&(this.getHighlightData().r=0,b.remove(c,!0)));a.redraw()}},filterChart:function(a){Ext.isString(a)&&(a=[a]);for(var b=[],c=0;c<a.length;c++)b.push(new RegExp(a[c]));a=this.queryById("chart");
var c=a.getSeries()[0],d=c.getLabel();c.getStore().each(function(a){var c=!1;if(0==b.length)c=!0;else for(var g=0;g<b.length&&!(c=c||b[g].test(a.get("term")));g++);a.set("disabled",!c);a=a.store.indexOf(a);d.setAttributesFor(a,{hidden:!c})},this);a.redraw()},getCurrentTerms:function(){var a=[];this.getTermStore().each(function(b){"term"===b.get("category")&&a.push(b.get("term"))});return a},getNearbyForTerm:function(a){var b=Math.max(2E3,Math.round(this.getCorpus().getWordTokensCount()/100));this.setApiParams({limit:b,
target:a});this.loadFromApis();this.setApiParam("target",void 0)},removeTerm:function(a){var b=this.down("#chart").getSeries()[0],c=b.getStore().findExact("term",a);b.getStore().removeAt(c);c=this.getTermStore().findExact("term",a);this.getTermStore().removeAt(c);a=this.getTermStore().getCount();this.queryById("limit").setRawValue(a)},loadFromApis:function(a){this.queryById("chartParent").mask(this.localize("analyzing"));var b={},c=this.getCurrentTerms();null!==this.getNewTerm()&&(c=c.concat(this.getNewTerm()),
this.setApiParam("limit",c.length));0<c.length&&(null!==this.getNewTerm()||a)&&(b.query=c.join(","));Ext.apply(b,this.getApiParams());null!=b.target&&(b.term=c);"pca"===b.analysis?this.getPcaStore().load({params:b}):"tsne"===b.analysis?this.getTsneStore().load({params:b}):"docSim"===b.analysis?this.getDocSimStore().load({params:b}):this.getCaStore().load({params:b})},interpolate:function(a,b,c,d,e){return d+(e-d)*Math.max(0,Math.min(1,(a-b)/(c-b)))}});
Ext.define("Ext.chart.series.CustomScatter",{extend:"Ext.chart.series.Scatter",alias:"series.customScatter",type:"customScatter",seriesType:"scatterSeries",tipsDisabled:!1,enableToolTips:function(){this.tipsDisabled=!1},disableToolTips:function(){this.tipsDisabled=!0},showTip:function(a,b){this.tipsDisabled||this.callParent(arguments)}});Ext.define("Voyant.panel.StreamGraph",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.streamgraph",statics:{i18n:{},api:{limit:5,stopList:"auto",query:void 0,withDistributions:"relative",bins:50,docIndex:void 0,docId:void 0},glyph:"xf1fe@FontAwesome"},config:{visLayout:void 0,vis:void 0,mode:"corpus",layerData:void 0,graphId:void 0},graphMargin:{top:20,right:60,bottom:110,left:80},MODE_CORPUS:"corpus",MODE_DOCUMENT:"document",constructor:function(a){this.callParent(arguments);
this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.setGraphId(Ext.id(null,"streamgraph_"))},initComponent:function(){Ext.apply(this,{title:this.localize("title"),tbar:new Ext.Toolbar({overflowHandler:"scroller",items:["-\x3e",{xtype:"legend",store:new Ext.data.JsonStore({fields:["name","mark","active"]}),listeners:{itemclick:function(a,b,c,d){a=Ext.fly(c.firstElementChild).hasCls("x-legend-inactive");b.set("active",a);b=this.getCurrentTerms();this.setApiParams({query:b,limit:b.length,
stopList:void 0});this.loadFromCorpus()},scope:this}},"-\x3e"]}),bbar:{overflowHandler:"scroller",items:[{xtype:"querysearchfield"},{xtype:"button",text:this.localize("clearTerms"),handler:function(){this.setApiParams({query:void 0});this.loadFromRecords([])},scope:this},{xtype:"corpusdocumentselector",singleSelect:!0},{text:this.localize("freqsMode"),glyph:"xf201@FontAwesome",tooltip:this.localize("freqsModeTip"),menu:{items:[{text:this.localize("relativeFrequencies"),checked:!0,itemId:"relative",
group:"freqsMode",checkHandler:function(a,b){b&&(this.setApiParam("withDistributions","relative"),this.loadFromCorpus())},scope:this},{text:this.localize("rawFrequencies"),checked:!1,itemId:"raw",group:"freqsMode",checkHandler:function(a,b){b&&(this.setApiParam("withDistributions","raw"),this.loadFromCorpus())},scope:this}]}},{xtype:"slider",itemId:"segmentsSlider",fieldLabel:this.localize("segments"),labelAlign:"right",labelWidth:70,width:150,increment:10,minValue:10,maxValue:300,listeners:{afterrender:function(a){a.setValue(this.getApiParam("bins"))},
changecomplete:function(a,b){this.setApiParams({bins:b});this.loadFromCorpus()},scope:this}}]}});this.on("loadedCorpus",function(a,b){1==this.getCorpus().getDocumentsCount()&&this.getMode()!=this.MODE_DOCUMENT&&this.setMode(this.MODE_DOCUMENT);if(!("bins"in this.getModifiedApiParams())&&this.getMode()==this.MODE_CORPUS){var c=b.getDocumentsCount();this.setApiParam("bins",100<c?100:c)}this.isVisible()&&this.loadFromCorpus()},this);this.on("corpusSelected",function(a,b){a.isXType("corpusdocumentselector")&&
(this.setMode(this.MODE_CORPUS),this.setApiParams({docId:void 0,docIndex:void 0}),this.setCorpus(b),this.loadFromCorpus())});this.on("documentSelected",function(a,b){var c=b.getId();this.setApiParam("docId",c);this.loadFromDocumentTerms()},this);this.on("query",function(a,b){var c=this.getCurrentTerms();c.push(b);this.setApiParams({query:c,limit:c.length,stopList:void 0});this.getMode()===this.MODE_DOCUMENT?this.loadFromDocumentTerms():this.loadFromCorpusTerms(this.getCorpus().getCorpusTerms())},
this);this.on("resize",this.resizeGraph,this);this.on("boxready",this.initGraph,this);this.callParent(arguments)},loadFromCorpus:function(){var a=this.getCorpus();this.getApiParam("docId")||this.getApiParam("docIndex")?this.loadFromDocumentTerms():1==a.getDocumentsCount()?this.loadFromDocument(a.getDocument(0)):this.loadFromCorpusTerms(a.getCorpusTerms())},loadFromCorpusTerms:function(a){var b=this.getApiParams(["limit","stopList","query","withDistributions","bins"]);b.bins&&b.bins>this.getCorpus().getDocumentsCount()&&
(b.bins=this.getCorpus().getDocumentsCount());a.load({callback:function(a,b,e){e?(this.setMode(this.MODE_CORPUS),this.loadFromRecords(a)):Voyant.application.showResponseError(this.localize("failedGetCorpusTerms"),b)},scope:this,params:b})},loadFromDocument:function(a){if(a.then){var b=this;a.then(function(a){b.loadFromDocument(a)})}else"Voyant.data.model.Document"==Ext.getClassName(a)&&(this.setApiParams({docIndex:void 0,query:void 0,docId:a.getId()}),this.isVisible()&&this.loadFromDocumentTerms())},
loadFromDocumentTerms:function(a){this.getCorpus()&&(a=a||this.getCorpus().getDocumentTerms({autoLoad:!1}),a.load({callback:function(a,c,d){d?(this.setMode(this.MODE_DOCUMENT),this.loadFromRecords(a)):Voyant.application.showResponseError(this.localize("failedGetDocumentTerms"),c)},scope:this,params:this.getApiParams("docId docIndex limit stopList query withDistributions bins".split(" "))}))},loadFromRecords:function(a){var b=[],c=[];a.forEach(function(a,e){for(var f=a.getTerm(),g=a.get("distributions"),
h=0;h<g.length;h++)void 0===c[h]&&(c[h]={}),c[h][f]=g[h];b.push({id:f,name:f,mark:this.getApplication().getColorForTerm(f,!0),active:!0})},this);this.setLayerData(c);this.down("[xtype\x3dlegend]").getStore().loadData(b);this.doLayout()},doLayout:function(a){a=this.getLayerData();if(void 0!==a){var b=this,c=[];this.down("[xtype\x3dlegend]").getStore().each(function(a){c.push(a.getId())});var d;if(this.getMode()===this.MODE_DOCUMENT)d=this.getApiParam("bins");else{d=this.getApiParam("bins");var e=this.getCorpus().getDocumentsCount();
d=d<e?d:e}this.getVisLayout().keys(c);e=this.getVisLayout()(a);a=this.body.down("svg").getWidth()-this.graphMargin.left-this.graphMargin.right;var f=d3.scaleLinear().domain([0,d-1]).range([0,a]),g=d3.min(e,function(a){return d3.min(a,function(a){return a[0]})}),h=d3.max(e,function(a){return d3.max(a,function(a){return a[1]})});d=this.body.down("svg").getHeight()-this.graphMargin.top-this.graphMargin.bottom;var k=d3.scaleLinear().domain([g,h]).range([d,0]),l=d3.area().x(function(a,b){return f(b)}).y0(function(a){return k(a[0])}).y1(function(a){return k(a[1])}).curve(d3.curveCatmullRom);
if(this.getMode()===this.MODE_CORPUS){var m=[];this.getCorpus().getDocuments().each(function(a){m.push(a.getTinyLabel())});g=d3.scalePoint().domain(m).range([0,a]);h=d3.axisBottom(g)}else h=d3.axisBottom(f);g=d3.axisLeft(k);e=this.getVis().selectAll("path").data(e,function(a){return a});e.attr("d",function(a){return l(a)}).style("fill",function(a){return b.getApplication().getColorForTerm(a.key,!0)}).select("title").text(function(a){return a.key});e.enter().append("path").attr("d",function(a){return l(a)}).style("fill",
function(a){return b.getApplication().getColorForTerm(a.key,!0)}).append("title").text(function(a){return a.key});e.exit().remove();this.getVis().selectAll("g.axis").remove();this.getVis().append("g").attr("class","axis x").attr("transform","translate(0,"+d+")").call(h);this.getMode()===this.MODE_CORPUS?(this.getVis().select("g.axis.x").selectAll("text").each(function(){d3.select(this).attr("text-anchor","end").attr("transform","rotate(-45)")}),e=this.localize("documents")):e=this.localize("documentSegments");
this.getVis().select("g.axis.x").append("text").attr("text-anchor","middle").attr("transform","translate("+a/2+", "+(this.graphMargin.bottom-30)+")").attr("fill","#000").text(e);this.getVis().append("g").attr("class","axis y").attr("transform","translate(0,0)").call(g);a="raw"===this.getApiParam("withDistributions")?this.localize("rawFrequencies"):this.localize("relativeFrequencies");this.getVis().select("g.axis.y").append("text").attr("text-anchor","middle").attr("transform","translate(-"+(this.graphMargin.left-
20)+", "+d/2+") rotate(-90)").attr("fill","#000").text(a)}},getCurrentTerms:function(){var a=[];this.down("[xtype\x3dlegend]").getStore().each(function(b){b.get("active")&&a.push(b.get("name"))},this);return a},initGraph:function(){if(void 0===this.getVisLayout()){var a=this.getLayout().getRenderTarget();this.setVisLayout(d3.stack().offset(d3.stackOffsetWiggle).order(d3.stackOrderInsideOut));this.setVis(d3.select(a.dom).append("svg").attr("id",this.getGraphId()).append("g").attr("transform","translate("+
this.graphMargin.left+","+this.graphMargin.top+")"));this.resizeGraph()}},resizeGraph:function(){var a=this.body,b=a.getWidth(),c=a.getHeight();d3.select(a.dom).select("svg").attr("width",b).attr("height",c);this.doLayout()}});Ext.define("Voyant.panel.Summary",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.summary",statics:{i18n:{},api:{stopList:"auto",start:0,limit:5,numberOfDocumentsForDistinctiveWords:10},glyph:"xf1ea@FontAwesome"},config:{options:{xtype:"stoplistoption"}},autoScroll:!0,cls:"corpus-summary",constructor:function(a){Ext.apply(this,{title:this.localize("title"),items:{itemId:"main",cls:"main",margin:10},dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{fieldLabel:this.localize("items"),
labelWidth:40,width:120,xtype:"slider",increment:5,minValue:5,maxValue:59,listeners:{afterrender:function(a){a.setValue(this.getApiParam("limit"))},changecomplete:function(a,c){this.setApiParams({limit:c});this.loadSummary()},scope:this}}]}]});this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.on("afterrender",function(){this.body.addListener("click",function(a){(a=a.getTarget(null,null,!0))&&"A"==a.dom.tagName&&(a.hasCls("document-id")?(a=a.getAttribute("val",
"voyant"),a=this.getCorpus().getDocuments().getById(a),this.dispatchEvent("documentsClicked",this,[a])):a.hasCls("corpus-type")?this.dispatchEvent("termsClicked",this,[a.getHtml()]):a.hasCls("document-type")&&this.dispatchEvent("documentIndexTermsClicked",this,[{term:a.getHtml(),docIndex:a.getAttribute("docIndex","voyant")}]))},this)});this.on("loadedCorpus",function(a,c){if(this.rendered)this.loadSummary();else this.on("afterrender",function(){this.loadSummary()},this)});a&&a.corpus&&this.fireEvent("loadedCorpus",
this,a.corpus);this.on("resize",function(){var a=this.getWidth()-200;this.query("sparklineline").forEach(function(c){c.getWidth()>a&&c.setWidth(a)})},this)},loadSummary:function(){var a=this,b=this.queryById("main");b.removeAll();b.add({html:this.getCorpus().getString()});var c=this.getCorpus().getDocuments().getRange(),d=this.getApiParam("limit");if(1<c.length){c.sort(function(a,b){return b.getLexicalTokensCount()-a.getLexicalTokensCount()});var e=new Ext.XTemplate('\x3ctpl for\x3d"." between\x3d"; "\x3e\x3ca href\x3d"#" onclick\x3d"return false" class\x3d"document-id" voyant:val\x3d"{id}" data-qtip\x3d"{title}"\x3e{shortTitle}\x3c/a\x3e\x3cspan style\x3d"font-size: smaller"\x3e (\x3cspan class\x3d"info-tip" data-qtip\x3d"{valTip}"\x3e{val}\x3c/span\x3e)\x3c/span\x3e\x3c/a\x3e\x3c/tpl\x3e'),
f;25>c.length?f=4*c.length:50>c.length?f=2*c.length:100<c.length&&(f=b.getWidth()-200,f=f<c.length?c.length:f);var g=this.localize("numberOfTerms");b.add({cls:"section",items:[{layout:"hbox",align:"bottom",items:[{html:this.localize("docsLength"),cls:"header"},{xtype:"sparklineline",values:this.getCorpus().getDocuments().getRange().map(function(a){return a.getLexicalTokensCount()}),tipTpl:new Ext.XTemplate("{[this.getDocumentTitle(values.x,values.y)]}",{getDocumentTitle:function(a,b){return"("+b+
") "+this.panel.getCorpus().getDocument(a).getTitle()},panel:a}),height:16,width:f}]},{html:"\x3cul\x3e\x3cli\x3e"+this.localize("longest")+" "+e.apply(c.slice(0,c.length>d?d:parseInt(c.length/2)).map(function(a){return{id:a.getId(),shortTitle:a.getShortTitle(),title:a.getTitle(),val:a.getLexicalTokensCount(),valTip:g}}))+"\x3c/li\x3e\x3cli\x3e"+this.localize("shortest")+" "+e.apply(c.slice(-(c.length>d?d:parseInt(c.length/2))).reverse().map(function(a){return{id:a.getId(),shortTitle:a.getShortTitle(),
title:a.getTitle(),val:a.getLexicalTokensCount(),valTip:g}}))+"\x3c/li\x3e"}]});c.sort(function(a,b){return b.getLexicalTypeTokenRatio()-a.getLexicalTypeTokenRatio()});b.add({cls:"section",items:[{layout:"hbox",align:"bottom",cls:"section",items:[{html:this.localize("docsDensity"),cls:"header"},{xtype:"sparklineline",values:this.getCorpus().getDocuments().getRange().map(function(a){return Ext.util.Format.number(a.getLexicalTypeTokenRatio(),"0.000")}),tipTpl:new Ext.XTemplate("{[this.getDocumentTitle(values.x,values.y)]}",
{getDocumentTitle:function(a,b){return"("+b+") "+this.panel.getCorpus().getDocument(a).getTitle()},panel:a}),height:16,width:f}]},{html:"\x3cul\x3e\x3cli\x3e"+this.localize("highest")+e.apply(c.slice(0,c.length>d?d:parseInt(c.length/2)).map(function(a){return{id:a.getId(),shortTitle:a.getShortTitle(),title:a.getTitle(),val:Ext.util.Format.number(a.getLexicalTypeTokenRatio(),"0.000"),valTip:g}}))+"\x3c/li\x3e\x3cli\x3e"+this.localize("lowest")+e.apply(c.slice(-(c.length>d?d:parseInt(c.length/2))).reverse().map(function(a){return{id:a.getId(),
shortTitle:a.getShortTitle(),title:a.getTitle(),val:Ext.util.Format.number(a.getLexicalTypeTokenRatio(),"0.000"),valTip:g}}))+"\x3c/li\x3e"}]});c.sort(function(a,b){return b.getAverageWordsPerSentence()-a.getAverageWordsPerSentence()});b.add({cls:"section",items:[{layout:"hbox",align:"bottom",cls:"section",items:[{html:this.localize("averageWordsPerSentence"),cls:"header"},{xtype:"sparklineline",values:this.getCorpus().getDocuments().getRange().map(function(a){return Ext.util.Format.number(a.getAverageWordsPerSentence(),
"0.0")}),tipTpl:new Ext.XTemplate("{[this.getDocumentTitle(values.x,values.y)]}",{getDocumentTitle:function(a,b){return"("+b+") "+this.panel.getCorpus().getDocument(a).getTitle()},panel:a}),height:16,width:f}]},{html:"\x3cul\x3e\x3cli\x3e"+this.localize("highest")+e.apply(c.slice(0,c.length>d?d:parseInt(c.length/2)).map(function(a){return{id:a.getId(),shortTitle:a.getShortTitle(),title:a.getTitle(),val:Ext.util.Format.number(a.getAverageWordsPerSentence(),"0.0"),valTip:g}}))+"\x3c/li\x3e\x3cli\x3e"+
this.localize("lowest")+e.apply(c.slice(-(c.length>d?d:parseInt(c.length/2))).reverse().map(function(a){return{id:a.getId(),shortTitle:a.getShortTitle(),title:a.getTitle(),val:Ext.util.Format.number(a.getAverageWordsPerSentence(),"0.0"),valTip:g}}))+"\x3c/li\x3e"}]})}else if(d=c[0])b.add({cls:"section",html:"\x3cb\x3e"+this.localize("docsDensity")+"\x3c/b\x3e "+Ext.util.Format.number(d.getLexicalTypeTokenRatio(),"0.000")}),b.add({cls:"section",html:"\x3cb\x3e"+this.localize("averageWordsPerSentence")+
"\x3c/b\x3e "+Ext.util.Format.number(d.getAverageWordsPerSentence(),"0.0")});b.add({html:this.localize("mostFrequentWords"),cls:"section",listeners:{afterrender:function(b){b.mask(a.localize("loading"));a.getCorpus().getCorpusTerms().load({params:{limit:a.getApiParam("limit"),stopList:a.getApiParam("stopList"),forTool:"summary"},callback:function(a,c,d){d&&a&&0<a.length&&(b.unmask(),Ext.dom.Helper.append(b.getTargetEl().first().first(),(new Ext.XTemplate('\x3ctpl for\x3d"." between\x3d"; "\x3e\x3ca href\x3d"#" onclick\x3d"return false" class\x3d"corpus-type keyword" voyant:recordId\x3d"{id}"\x3e{term}\x3c/a\x3e\x3cspan style\x3d"font-size: smaller"\x3e ({val})\x3c/span\x3e\x3c/tpl\x3e')).apply(a.map(function(a){return{id:a.getId(),
...
c+d-1);if(e&&Ext.isArray(e)){var f=[];e.forEach(function(a){f.push(a.getIndex())});0<f.length&&this.getCorpus().getDocumentTerms().load({addRecords:!0,params:{docIndex:f,perDocLimit:parseInt(this.getApiParam("limit")),limit:d*parseInt(this.getApiParam("limit")),stopList:this.getApiParam("stopList"),sort:"TFIDF",dir:"DESC",forTool:"summary"},scope:this,callback:function(e,h,k){var l={};if(k&&e&&Ext.isArray(e)){e.forEach(function(a,b,c){b=a.getDocIndex();b in l||(l[b]=[]);l[b].push({id:a.getId(),docIndex:a.getDocIndex(),
type:a.getTerm(),val:Ext.util.Format.number(a.get("rawFreq"),"0,000"),docId:a.get("docId")})});var m;f.forEach(function(a){if(l[a]){var c=this.getCorpus().getDocument(a);m=l[a].length;Ext.dom.Helper.append(b,{tag:"li","voyant:index":String(a),html:'\x3ca href\x3d"#" onclick\x3d"return false" class\x3d"document-id document-id-distinctive" voyant:val\x3d"'+c.get("id")+'"\x3e'+c.getShortTitle()+"\x3c/a\x3e"+this.localize("colon")+" "+(new Ext.XTemplate(this.localize("documentType"))).apply({types:l[a]})+
"."})}},this);a.updateLayout();m=d;remaining=this.getCorpus().getDocuments().getTotalCount()-c-f.length;if(0<remaining){e=new Ext.Template(this.localize("moreDistinctiveWords"));var n=Ext.dom.Helper.append(b,{tag:"li",cls:"more",html:e.apply([m>remaining?remaining:m,remaining])},!0);n.on("click",function(){n.remove();this.showMoreDistinctiveWords()},this)}}}})}}});Ext.define("Voyant.panel.TextualArc",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.textualarc",statics:{i18n:{},api:{stopList:"auto",docIndex:0,speed:50,minRawFreq:2},glyph:"xf06e@FontAwesome"},config:{options:[{xtype:"stoplistoption"},{xtype:"container",items:{xtype:"numberfield",name:"minRawFreq",minValue:1,maxValue:10,value:2,labelWidth:150,labelAlign:"right",initComponent:function(){var a=this.up("window").panel;this.fieldLabel=a.localize(this.fieldLabel);this.on("afterrender",
...
var c=2E3-1999*parseInt(this.getApiParam("speed"))/100;if(this.isReading&&this.documentTerms){var d=parseInt(this.readingIndex*this.getPerim().length/this.lastToken);b.fillStyle="purple";b.fillRect(this.getPerim()[d].x,this.getPerim()[d].y,5,5);var e=void 0==this.readingStartTime;this.readingStartTime=this.readingStartTime||(new Date).getTime();d=this.readingStartTime+c-(new Date).getTime();if(this.sourceTerm&&this.targetTerm){if(e||0>=d){this.previousBeziers=this.previousBeziers||[];var e=this.sourceTerm.get("x"),
f=this.sourceTerm.get("y"),g=this.targetTerm.get("x"),h=this.targetTerm.get("y");this.previousTerm&&this.previousTerm.get("x");this.previousTerm&&this.previousTerm.get("y");var k=Math.max(100,.5*Math.abs(e-g)),l=Math.max(100,.5*Math.abs(f-h));this.previousBeziers.unshift([e,f,e>g?e-k:e+k,h>f?f+l:f-l,g,h]);10<this.previousBeziers.length&&this.previousBeziers.pop()}for(e=0;e<this.previousBeziers.length;e++)b.strokeStyle="rgba(0,0,255,"+(1-.1*e)+")",this.drawBezierSplit.apply(this,Ext.Array.merge([b],
...
height:f.getHeight()},"dickinson",a,e,"#"+f.getId());b.Start()}.bind(b))}});Ext.define("Voyant.panel.TermsBerry",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.termsberry",statics:{i18n:{tfidf:"tf-idf",inDocs:"In Docs",reset:"Reset"},api:{stopList:"auto",context:2,numInitialTerms:75,query:void 0,docIndex:void 0,docId:void 0,categories:void 0},glyph:"xf1db@FontAwesome"},config:{options:[{xtype:"stoplistoption"},{xtype:"categoriesoption"}],mode:void 0,scalingFactor:3,minRawFreq:void 0,maxRawFreq:void 0,maxCollocateValue:void 0,minFillValue:void 0,maxFillValue:void 0,
currentData:{},blacklist:{},visLayout:void 0,vis:void 0,visInfo:void 0,visId:void 0,currentNode:void 0,tip:void 0,contextMenu:void 0},MODE_TOP:"top",MODE_DISTINCT:"distinct",MIN_TERMS:5,MAX_TERMS:500,COLLOCATES_LIMIT:1E6,MIN_SCALING:1,MAX_SCALING:5,MIN_STROKE_OPACITY:.1,MAX_STROKE_OPACITY:.3,layout:"fit",constructor:function(a){this.setMode(this.MODE_TOP);this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.setVisId(Ext.id(null,"termspack_"))},initComponent:function(){Ext.apply(this,
...
width:120,xtype:"slider",increment:1,minValue:1,maxValue:30,listeners:{afterrender:function(a){a.setValue(this.getApiParam("context"))},changecomplete:function(a,b){this.setApiParams({context:b});this.doLoad()},scope:this}},{fieldLabel:this.localize("scaling"),labelWidth:50,labelAlign:"right",width:120,xtype:"slider",increment:1,minValue:this.MIN_SCALING,maxValue:this.MAX_SCALING,listeners:{afterrender:function(a){a.setValue(this.getScalingFactor())},changecomplete:function(a,b){var c=Math.abs(b-
(this.MAX_SCALING+1));this.setScalingFactor(c);this.reload()},scope:this}}]}]});this.setContextMenu(Ext.create("Ext.menu.Menu",{renderTo:Ext.getBody(),items:[{xtype:"box",itemId:"label",margin:"5px 0px 5px 5px",html:""},{xtype:"menuseparator"},{xtype:"button",text:"Remove",style:"margin: 5px;",handler:function(a,b){var c=this.getCurrentNode();void 0!==c&&(delete this.getCurrentData()[c.data.term],this.getBlacklist()[c.data.term]=!0,this.setCurrentNode(void 0));this.getContextMenu().hide();this.reload()},
scope:this}]}));this.on("query",function(a,b){0<b.length&&this.doLoad(b)},this);this.callParent(arguments)},listeners:{boxready:function(){this.initVisLayout()},resize:function(a,b,c){this.getVisLayout()&&this.getCorpus()&&(a=this.getLayout().getRenderTarget(),b=a.getWidth(),c=a.getHeight(),a.down("svg").set({width:b,height:c}),this.getVisLayout().size([b,c]),this.reload())},loadedCorpus:function(a,b){this.isVisible()&&this.doLoad()},activate:function(){this.getCorpus()&&this.doLoad()}},doLoad:function(a){this.resetVis();
void 0===a&&(this.resetMinMax(),this.setCurrentData({}));this.getMode()===this.MODE_DISTINCT?this.getDistinctTerms(a):this.getTopTerms(a)},reload:function(){var a=this.processCollocates([]);0<a.length&&(this.resetVis(),this.buildVisFromData(a))},resetMinMax:function(){this.setMinRawFreq(void 0);this.setMaxRawFreq(void 0);this.setMaxCollocateValue(void 0);this.setMinFillValue(void 0);this.setMaxFillValue(void 0)},resetVis:function(){var a=this.getVis();a&&a.selectAll(".node").remove()},getTopTerms:function(a){var b=
...
limit:b,perDocLimit:d,stopList:c,sort:"TFIDF",dir:"DESC"},callback:function(a,b,c){c&&this.loadFromRecords(a)},scope:this})},loadFromQuery:function(a){this.getCorpus().getCorpusTerms().load({params:{query:a},callback:function(a,c,d){d&&this.loadFromRecords(a)},scope:this})},loadFromRecords:function(a){if(Ext.isArray(a)&&0<a.length){var b=this.getMaxRawFreq(),c=this.getMinRawFreq(),d=this.getMinFillValue(),e=this.getMaxFillValue(),f=[];a.forEach(function(a){var h=a.getTerm();if(!this.getBlacklist()[h]){var k=
a.getRawFreq(),l=this.getMode()===this.MODE_DISTINCT?a.get("tfidf"):a.getInDocumentsCount();if(void 0===b||k>b)b=k;if(void 0===c||k<c)c=k;if(void 0===e||l>e)e=l;if(void 0===d||l<d)d=l;this.getCurrentData()[h]={term:h,rawFreq:k,relativeFreq:a.get("relativeFreq"),fillValue:l,collocates:[]};f.push(h)}},this);this.setMaxRawFreq(b);this.setMinRawFreq(c);this.setMinFillValue(d);this.setMaxFillValue(e);this.getCollocatesForQuery(f)}},getCollocatesForQuery:function(a){var b=[],c;for(c in this.getCurrentData())b.push(c);
this.setApiParams({mode:"corpus"});c=this.getApiParams();this.getCorpus().getCorpusCollocates().load({params:Ext.apply(Ext.clone(c),{query:a,collocatesWhitelist:b,limit:this.COLLOCATES_LIMIT}),callback:function(a,b,c){c&&this.buildVisFromData(this.processCollocates(a))},scope:this})},processCollocates:function(a){for(var b=this.getCurrentData(),c=this.getMaxCollocateValue(),d=0;d<a.length;d++){var e=a[d],f=e.getTerm(),g=e.getContextTerm(),e=e.getContextTermRawFreq();if(void 0===c||e>c)c=e;void 0!==
...
c=this.getVis().selectAll(".node").data(c.descendants());c.attr("transform",function(a){return"translate("+a.x+","+a.y+")"});c.selectAll("circle").attr("r",function(a){return a.r});var d=d3.scalePow().exponent(1/3).domain([0,this.getMaxCollocateValue()]).range(["#fff","#bd3163"]),e;e=this.getMode()===this.MODE_DISTINCT?d3.scalePow().exponent(.2).domain([this.getMinFillValue(),this.getMaxFillValue()]).range(["#dedede","#fff"]):d3.scaleLinear().domain([this.getMaxFillValue(),this.getMinFillValue()]).range(["#dedede",
"#fff"]);var f=this.getVisLayout().size(),f=Math.min(f[0],f[1])/2;a=Math.sqrt(Math.PI*f*f/a.length/Math.PI)/3;var f=Math.abs(this.getScalingFactor()-(this.MAX_SCALING+1)),f=Math.max(1,f-1),f=a*f,g=d3.scaleLinear().domain([this.getMinRawFreq(),this.getMaxRawFreq()]).range([a,f]);a=c.enter().append("g").attr("class","node").style("visibility",function(a){return 0<a.depth?"visible":"hidden"}).attr("transform",function(a){return"translate("+a.x+","+a.y+")"}).on("click",function(a){b.dispatchEvent("termsClicked",
b,[a.data.term])}).on("mouseover",function(a,c){b.setCurrentNode(a);b.getVis().selectAll("circle").style("stroke-width",1).style("stroke","#111").style("fill",function(a){return e(a.data.fillValue)});d3.select(this).select("circle").style("fill","#89e1c2").style("stroke","#26926c").style("stroke-opacity",b.MAX_STROKE_OPACITY);var f;f=b.getMode()===b.MODE_DISTINCT?b.localize("tfidf"):b.localize("inDocs");if(!b.getContextMenu().isVisible()){f="\x3cb\x3e"+a.data.term+"\x3c/b\x3e ("+a.data.rawFreq+")\x3cbr/\x3e"+
f+": "+a.data.fillValue;var g=b.getTip();g.update(f);g.show()}for(c=0;c<a.data.collocates.length;c++){var n=a.data.collocates[c];f=b.getVis().selectAll(".node").filter(function(a){return a.data.term===n.term});f.select("circle").style("fill",function(a){return d(n.value)}).style("stroke","#bd3163").style("stroke-opacity",b.MAX_STROKE_OPACITY);f.select("tspan.value").text(function(a){return n.value})}}).on("mousemove",function(){b.getTip().setPosition(d3.event.pageX+5,d3.event.pageY-50)}).on("mouseout",
function(){b.getContextMenu().isVisible()||b.setCurrentNode(void 0);b.getVis().selectAll("circle").style("stroke-opacity",b.MIN_STROKE_OPACITY).style("stroke","#111").style("fill",function(a){return e(a.data.fillValue)});b.getVis().selectAll("tspan.value").text("");b.getTip().hide()}).on("contextmenu",function(a,c){d3.event.preventDefault();b.getTip().hide();var d=b.getContextMenu();d.queryById("label").setHtml(a.data.term);d.showAt(d3.event.pageX+5,d3.event.pageY-50)});a.append("circle").attr("id",
function(a){return a.data.term.replace(/\W/g,"_")}).attr("r",function(a){return a.r}).style("fill",function(a){return e(a.data.fillValue)}).style("stroke","#111").style("stroke-opacity",b.MIN_STROKE_OPACITY).style("stroke-width",1);a.append("clipPath").attr("id",function(a){return"clip-"+a.data.term.replace(/\W/g,"_")}).append("use").attr("xlink:href",function(a){return"#"+a.data.term.replace(/\W/g,"_")});a=a.append("text").attr("clip-path",function(a){return"url(#clip-"+a.data.term.replace(/\W/g,
"_")+")"}).style("font-family",function(a){return b.getApplication().getFeatureForTerm("font",a.data.term)}).style("text-anchor","middle").style("cursor","default");a.append("tspan").attr("class","term").style("font-size",function(a){return g(a.data.rawFreq)}).attr("x",0).attr("y",function(a){return g(a.data.rawFreq)/4}).text(function(a){return a.data.term});a.append("tspan").attr("class","value").style("font-size",function(a){return.75*g(a.data.rawFreq)}).attr("x",0).attr("y",function(a){return g(a.data.rawFreq)+
1});c.exit().remove()}},initVisLayout:function(){var a=this.getLayout().getRenderTarget();a.update("");var b=a.getWidth(),c=a.getHeight();this.setVisLayout(d3.pack().size([b,c]).padding(1.5));a=d3.select(a.dom).append("svg").attr("id",this.getVisId()).attr("width",b).attr("height",c);this.setVis(a.append("g"));this.setVisInfo(a.append("text").attr("x",10).attr("y",10));void 0===this.getTip()&&this.setTip(Ext.create("Ext.tip.Tip",{}))}});Ext.define("Voyant.panel.TermsRadio",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.termsradio",config:{options:[{xtype:"stoplistoption"}],speed:50,termsRadio:void 0},statics:{i18n:{},api:{withDistributions:!0,bins:5,visibleBins:5,docIdType:null,limit:50,mode:null,position:0,selectedWords:[],stopList:"auto",query:null,yAxisScale:"log",speed:50,slider:void 0},glyph:"xf201@FontAwesome"},constructor:function(a){var b=function(a,b,e,f,g){this.setApiParams({mode:a});this.getTermsRadio().loadRecords(e);
(a=this.getApiParam("query"))&&(0==e.length||1==e.length&&0==e[0].getRawFreq()?this.toastInfo({html:this.localize("termNotFound"),align:"bl"}):this.getTermsRadio().highlightQuery(a,!0))};this.corpusStore=Ext.create("Voyant.data.store.CorpusTerms",{listeners:{load:{fn:b.bind(this,"corpus"),scope:this}}});this.documentStore=Ext.create("Voyant.data.store.DocumentTerms",{listeners:{load:{fn:b.bind(this,"document"),scope:this}}});Ext.apply(a,{title:this.localize("title"),legendMenu:Ext.create("Ext.menu.Menu",
{items:[{text:"",itemId:"remove",glyph:"xf068@FontAwesome"}]}),tbar:new Ext.Toolbar({overflowHandler:"scroller",items:{xtype:"legend",store:new Ext.data.JsonStore({fields:["name","mark"]}),listeners:{itemclick:function(a,b,e,f){a=b.get("name");this.getTermsRadio().isTermSelected(a)?this.getTermsRadio().doTermDeselect(a):this.getTermsRadio().doTermSelect(a)},itemcontextmenu:function(a,b,e,f,g){g.preventDefault();a=g.getXY();var h=b.get("name");b=(new Ext.Template(this.localize("removeTerm"))).apply([h]);
this.legendMenu.queryById("remove").setText(b);this.legendMenu.on("click",function(a,b){void 0!==b&&this.doTermDeselect(h,!0)},this,{single:!0});this.legendMenu.showAt(a)},scope:this}}}),bbar:{overflowHandler:"scroller",items:[{xtype:"querysearchfield"},{glyph:"xf04b@FontAwesome",itemId:"play",handler:function(a){"xf04c@FontAwesome"==a.glyph?(this.getTermsRadio().continueTransition=!1,this.mask(this.localize("completingTransition")),a.setPlaying(!1)):(this.getTermsRadio().toggleRightCheck(),a.setPlaying(!0))},
...
f=this.documentStore,k.setMaxValue(h.getValue())):(this.setApiParam("mode","corpus"),delete e.bins,f=this.corpusStore,h.hide(),this.queryById("segmentsLabel").hide(),k=this.queryById("visibleBins"),k.setMaxValue(g),parseInt(this.getApiParam("visibleBins")>g)&&k.setValue(g));f.on("load",function(a,b){for(var c=0;3>c;c++){var d=b[c];d&&this.getTermsRadio().highlightRecord(d,!0)}},this,{single:!0});f.load({params:e})},this)},loadStore:function(){this.queryById("play").setPlaying(!1);var a=this.getApiParams();
"document"===this.getApiParam("mode")&&this.documentStore.load({params:a});"corpus"===this.getApiParam("mode")&&(delete a.bins,this.corpusStore.load({params:a}))}});Ext.define("Voyant.panel.Trends",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],requires:["Ext.chart.CartesianChart","Voyant.data.store.Documents"],alias:"widget.trends",config:{options:[{xtype:"stoplistoption"},{xtype:"colorpaletteoption"}]},statics:{i18n:{},api:{limit:5,stopList:"auto",query:void 0,withDistributions:"relative",bins:10,docIndex:void 0,docId:void 0,mode:"corpus"},glyph:"xf201@FontAwesome"},MODE_CORPUS:"corpus",MODE_DOCUMENT:"document",layout:"fit",constructor:function(a){this.callParent(arguments);
this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);if(a.embedded){var b=Ext.getClass(a.embedded).getName();"Voyant.data.store.CorpusTerms"==b&&this.loadFromCorpusTerms(a.embedded);"Voyant.data.model.Corpus"==b&&this.loadFromCorpusTerms(a.embedded.getCorpusTerms())}this.on("loadedCorpus",function(a,b){1==b.getDocumentsCount()&&this.getApiParam("mode")!=this.MODE_DOCUMENT&&(this.setMode(this.MODE_DOCUMENT),this.setApiParams({withDistributions:"raw"}),this.down("#raw").setChecked(!0));
...
this.loadFromCorpus()))}});this.on("documentTermsClicked",function(a,b){this.getCorpus()&&(this.setMode(this.MODE_DOCUMENT),b[0]&&void 0!==b[0].get("distributions")&&this.getDistributionsType(b[0].get("distributions"))===this.getApiParam("withDistributions")?this.loadFromRecords(b):this.fireEvent("termsClicked",a,b))});this.on("corpusTermsClicked",function(a,b){this.getCorpus()&&(b[0]&&void 0!==b[0].get("distributions")&&this.getDistributionsType(b[0].get("distributions"))===this.getApiParam("withDistributions")&&
1<this.getCorpus().getDocumentsCount()?this.loadFromRecords(b):this.fireEvent("termsClicked",a,b))});this.on("activate",function(){this.getCorpus()&&this.loadFromCorpus()},this);this.on("ensureCorpusView",function(a,b){this.getApiParam("mode")!=this.MODE_CORPUS&&1<b.getDocumentsCount()&&(this.setApiParam("docId",void 0),this.loadFromCorpus())},this)},initComponent:function(){Ext.apply(this,{title:this.localize("title"),dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"querysearchfield"},
{xtype:"corpusdocumentselector",singleSelect:!0},{text:this.localize("freqsMode"),glyph:"xf201@FontAwesome",tooltip:this.localize("freqsModeTip"),menu:{items:[{text:this.localize("relativeFrequencies"),checked:!0,itemId:"relative",group:"freqsMode",checkHandler:function(a,b){b&&(this.setApiParam("withDistributions","relative"),this.reloadFromChart())},scope:this},{text:this.localize("rawFrequencies"),checked:!1,itemId:"raw",group:"freqsMode",checkHandler:function(a,b){b&&(this.setApiParam("withDistributions",
"raw"),this.reloadFromChart())},scope:this}]}},{itemId:"segmentsSlider",xtype:"slider",fieldLabel:this.localize("segmentsSlider"),fieldAlign:"right",labelWidth:70,width:150,minValue:2,maxValue:100,listeners:{afterrender:function(a){a.setValue(parseInt(this.getApiParam("bins")))},changecomplete:function(a,b){this.setApiParams({bins:b});this.getApiParam("docId")||this.getApiParam("docIndex")?this.loadFromDocumentTerms():this.loadFromCorpusTerms()},scope:this}}]}]});this.callParent(arguments)},loadFromDocuments:function(a){this.setApiParams({docId:void 0,
docIndex:Ext.Array.from(a).map(function(a){return this.getCorpus().getDocument(a).getIndex()},this)});this.isVisible()&&this.loadFromDocumentTerms(this.getApiParam("query")?void 0:this.getCorpus().getDocumentTerms({proxy:{extraParams:{limit:this.getApiParam("limit"),forTool:"trends"}}}))},loadFromDocumentTerms:function(a){this.getCorpus()&&(a=a||this.getCorpus().getDocumentTerms({proxy:{extraParams:{forTool:"trends"}}}),a.load({callback:function(a,c,d){d&&(this.setMode(this.MODE_DOCUMENT),this.loadFromRecords(a))},
scope:this,params:this.getApiParams(["stopList","query","docIndex","withDistributions","bins"])}))},loadFromCorpus:function(a){a=a||this.getCorpus();this.setCorpus(a);this.getApiParam("docId")?this.loadFromDocumentTerms():1==a.getDocumentsCount()?this.loadFromDocuments([a.getDocument(0)]):this.loadFromCorpusTerms(a.getCorpusTerms({proxy:{extraParams:{limit:this.getApiParam("limit"),forTool:"trends"}}}))},loadFromCorpusTerms:function(a){if(this.getCorpus())if(1==this.getCorpus().getDocumentsCount())this.loadFromDocumentTerms();
else{a=a||this.getCorpus().getCorpusTerms({autoLoad:!1,proxy:{extraParams:{forTool:"trends"}}});var b=this.getApiParams(["stopList","query","withDistributions","bins"]);b.bins&&b.bins>this.getCorpus().getDocumentsCount()&&(b.bins=this.getCorpus().getDocumentsCount());a.load({callback:function(a,b,e){e?(this.setMode(this.MODE_CORPUS),this.loadFromRecords(a)):Voyant.application.showResponseError(this.localize("failedGetCorpusTerms"),b)},scope:this,params:b})}},loadFromRecords:function(a){var b=this.getApiParam("mode"),
c=[],d=["index"],e=[],f=0;a.forEach(function(a,g){var l=a.get("term");a.get("distributions").forEach(function(a,b){c[b]||(c[b]={index:b});c[b]["_"+g]=a;a>f&&(f=a)},this);d.push("_"+g);e.push({type:"line",title:l,xField:"index",yField:"_"+g,colors:[this.getApplication().getColorForTerm(l,!0)],style:{lineWidth:2},marker:{radius:3},highlight:!0,smooth:!0,tooltip:{trackMouse:!0,style:"background: #fff",renderer:function(a,c,d){var e="\x3ci\x3e"+d.series.getTitle()+"\x3c/i\x3e: "+c.get(d.series.getYField());
if(b==a.panel.MODE_CORPUS){var f=a.panel.getCorpus();f&&f.getDocumentsCount()==c.store.getCount()&&(e+="\x3cbr/\x3e\x3ci\x3e"+a.panel.getCorpus().getDocument(d.index).getShortTitle()+"\x3c/i\x3e")}a.setHtml(e)},panel:this},listeners:{itemclick:{fn:this.handleClickedItem,scope:this}}})},this);a=Ext.create("Ext.data.JsonStore",{fields:d,data:c});d.shift();var g=this;this.buildChart({store:a,series:e,axes:[{type:"numeric",position:"left",majorTickSteps:"raw"==this.getApiParam("withDistributions")&&20>
f?f:void 0,increment:1,title:{text:this.localize("raw"==this.getApiParam("withDistributions")?"rawFrequencies":"relativeFrequencies")}},{type:"category",position:"bottom",increment:1,fields:["index"],title:{text:this.localize(b==this.MODE_DOCUMENT?"segments":"documents")},label:{rotate:{degrees:-30}},renderer:function(a,c){if(b==g.MODE_DOCUMENT)return parseInt(c)+1;var d=g.getCorpus().getDocument(c);if(d){var e=g.getTargetEl().getHeight();return 250>e?parseInt(c)+1:500>e?d.getTinyTitle():d.getShortTitle()}return"?"}}]})},
reloadFromChart:function(){var a=this.down("chart");if(a){var b=[];a.series.forEach(function(a){b.push(a.getTitle())});this.fireEvent("termsClicked",this,b)}},buildChart:function(a){a.axes.forEach(function(a){Ext.applyIf(a,{style:{opacity:.2},label:{opacity:.5}});Ext.applyIf(a.title,{fontSize:12})});Ext.applyIf(a,{plugins:{ptype:"chartitemevents",moveEvents:!0},legend:{docked:"top"},interactions:["itemhighlight","panzoom"],innerPadding:{top:5,right:5,bottom:5,left:5},border:!1,bodyBorder:!1});this.query("chart").forEach(function(a){this.remove(a)},
this);a=Ext.create("Ext.chart.CartesianChart",a);this.add(a)},clearChart:function(){this.query("chart").forEach(function(a){this.remove(a)},this)},handleClickedItem:function(a,b){var c=this.getApiParam("mode");if(c===this.MODE_DOCUMENT){c=this.getApiParam("docId");if(!c){var d=this.getCorpus();d&&(c=d.getDocument(0).getId())&&this.setApiParam("docId",c)}if(c){var d=this.getCorpus().getDocument(c),d=d.get("tokensCount-lexical"),e=this.getApiParam("bins"),d=b.index/e*d;this.dispatchEvent("documentIndexTermsClicked",
this,[{term:b.series.getTitle(),docId:c,position:d}])}}else c==this.MODE_CORPUS&&(d=this.getCorpus().getDocument(b.index),this.dispatchEvent("documentIndexTermsClicked",this,[{term:b.series.getTitle(),docIndex:b.index,docId:d.getId()}]))},isLastClickedItem:function(a){return this.lastClickedItem&&this.lastClickedItem.term==a.term&&this.lastClickedItem.index==a.index},setMode:function(a){this.setApiParams({mode:a});this.getApiParam("mode")},getDistributionsType:function(a){return a[0]===Math.round(a[0])?
"raw":"relative"}});
Ext.override(Ext.chart.axis.sprite.Axis,{renderLabels:function(a,b,c,d){var e=this,f=e.attr,g=.5*f.lineWidth,h=f.position,k=f.matrix,l=f.textPadding,m=k.getXX(),n=k.getDX(),q=k.getYY(),r=k.getDY(),p=0,k=c.majorTicks,u=Math.max(f.majorTickSize,f.minorTickSize)+f.lineWidth,v=Ext.draw.Draw.isBBoxIntersect,s=e.getLabel(),G,L,B=null,E=0,z=0,H=c.segmenter,C=e.getRenderer(),A=e.getAxis(),K=(G=A.getTitle())&&""!==G.attr.text&&G.getBBox(),I,J=null,F,x,w;if(k&&s&&!s.attr.hidden){G=s.attr.font;b.font!==G&&(b.font=
G);s.setAttributes({translationX:0,translationY:0},!0);s.applyTransformations();I=s.attr.inverseMatrix.elements.slice(0);switch(h){case "left":b=K?K.x+K.width:0;switch(s.attr.textAlign){case "start":d=a.roundPixel(b+n)-g;break;case "end":d=a.roundPixel(d[2]-u+n)-g;break;default:d=a.roundPixel(b+(d[2]-b-u)/2+n)-g}s.setAttributes({translationX:d},!0);break;case "right":b=K?d[2]-K.x:0;switch(s.attr.textAlign){case "start":d=a.roundPixel(u+n)+g;break;case "end":d=a.roundPixel(d[2]-b+n)+g;break;default:d=
a.roundPixel(u+(d[2]-u-b)/2+n)+g}s.setAttributes({translationX:d},!0);break;case "top":b=K?K.y+K.height:0;s.setAttributes({translationY:a.roundPixel(b+(d[3]-b-u)/2)-g},!0);break;case "bottom":b=K?d[3]-K.y:0;s.setAttributes({translationY:a.roundPixel(u+(d[3]-u-b)/2)+g},!0);break;case "radial":s.setAttributes({translationX:f.centerX},!0);break;case "angular":s.setAttributes({translationY:f.centerY},!0);break;case "gauge":s.setAttributes({translationY:f.centerY},!0)}if("left"===h||"right"===h)e.iterate(k,
function(b,d,f){void 0!==d&&(w=C?Ext.callback(C,null,[A,d,c,B],0,A):H.renderer(d,c,B),B=d,s.setAttributes({text:String(w),translationY:a.roundPixel(b*q+r)},!0),s.applyTransformations(),p=Math.max(p,s.getBBox().width+u),p<=e.thickness&&(x=Ext.draw.Matrix.fly(s.attr.matrix.elements.slice(0)),F=x.prepend.apply(x,I).transformBBox(s.getBBox(!0)),!J||v(F,J,l)))&&(a.renderSprite(s),J=F,E+=F.height,z++)});else if("top"===h||"bottom"===h)e.iterate(k,function(b,d,f){void 0!==d&&(w=C?Ext.callback(C,null,[A,
d,c,B],0,A):H.renderer(d,c,B),B=d,s.setAttributes({text:String(w),translationX:a.roundPixel(b*m+n)},!0),s.applyTransformations(),p=Math.max(p,s.getBBox().height+u),p<=e.thickness&&(x=Ext.draw.Matrix.fly(s.attr.matrix.elements.slice(0)),F=x.prepend.apply(x,I).transformBBox(s.getBBox(!0)),J&&v(F,J,l),a.renderSprite(s),J=F,E+=F.width,z++))});else if("radial"===h)e.iterate(k,function(b,d,e){void 0!==d&&(w=C?Ext.callback(C,null,[A,d,c,B],0,A):H.renderer(d,c,B),B=d,"undefined"!==typeof w&&(s.setAttributes({text:String(w),
translationX:f.centerX-a.roundPixel(b)/f.max*f.length*Math.cos(f.baseRotation+Math.PI/2),translationY:f.centerY-a.roundPixel(b)/f.max*f.length*Math.sin(f.baseRotation+Math.PI/2)},!0),s.applyTransformations(),F=s.attr.matrix.transformBBox(s.getBBox(!0)),!J||v(F,J)))&&(a.renderSprite(s),J=F,E+=F.width,z++)});else if("angular"===h)L=f.majorTickSize+.5*f.lineWidth+(parseInt(s.attr.fontSize,10)||10)/2,e.iterate(k,function(b,d,e){void 0!==d&&(w=C?Ext.callback(C,null,[A,d,c,B],0,A):H.renderer(d,c,B),B=d,
p=Math.max(p,Math.max(f.majorTickSize,f.minorTickSize)+("butt"!==f.lineCap?.5*f.lineWidth:0)),"undefined"!==typeof w&&(b=b/(f.max+1)*Math.PI*2+f.baseRotation,s.setAttributes({text:String(w),translationX:f.centerX+(f.length+L)*Math.cos(b),translationY:f.centerY+(f.length+L)*Math.sin(b)},!0),s.applyTransformations(),F=s.attr.matrix.transformBBox(s.getBBox(!0)),!J||v(F,J)))&&(a.renderSprite(s),J=F,E+=F.width,z++)});else if("gauge"===h){var D=e.getGaugeAngles();e.iterate(k,function(b,d,e){void 0!==d&&
(w=C?Ext.callback(C,null,[A,d,c,B],0,A):H.renderer(d,c,B),B=d,"undefined"!==typeof w&&(b=(b-f.min)/(f.max-f.min+1)*f.totalAngle-f.totalAngle+D.start,s.setAttributes({text:String(w),translationX:f.centerX+(f.length+10)*Math.cos(b),translationY:f.centerY+(f.length+10)*Math.sin(b)},!0),s.applyTransformations(),F=s.attr.matrix.transformBBox(s.getBBox(!0)),!J||v(F,J)))&&(a.renderSprite(s),J=F,E+=F.width,z++)})}f.enlargeEstStepSizeByText&&z&&(E/=z,E+=u,E*=2,f.estStepSize<E&&(f.estStepSize=E));if(1<Math.abs(e.thickness-
p))return e.thickness=p,f.bbox.plain.dirty=!0,f.bbox.transform.dirty=!0,e.doThicknessChanged(),!1}}});Ext.define("Voyant.panel.NoTool",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.notool",statics:{i18n:{},api:{tool:void 0}},config:{html:void 0,notYetImplemented:"Centroid DocumentInputAdd DocumentTypeCollocateFrequenciesGrid EntitiesBrowser Equalizer FeatureClusters Flowerbed KwicsTagger Lava Mandala MicroSearch NetVizApplet PaperDrill RezoViz Sunburst Termometer Ticker TokensViz ToolBrowser ToolBrowserLarge VoyeurTagline WordCloud VoyeurTagline WordCountFountain".split(" ")},
...
!1},f),f.getActiveTab().isXType(e)||f.getActiveTab().replacePanel(e))}}var a=this.down("cirrus"),g=this;a&&(a=a.down("toolbar"),a.add({xtype:"tbfill"}),a.add({text:" ",listeners:{click:{fn:function(){g.add({region:"north",width:"100%",html:'\x3cdiv align\x3d"center"\x3e\x3ctable\x3e\x3ctr\x3e\x3ctd\x3e\x3cimg src\x3d"http://stefansinclair.name/wordpress/wp-content/uploads/2011/07/Sinclair_Stefan_small.jpg" style\x3d"height: 60px"\x3e\x3c/td\x3e\x3ctd style\x3d"text-align: center; padding-left: 2em; padding-right: 2em;"\x3eBy Athena, you found us hidden\x3cbr\x3eup here between the panels!\x3c/td\x3e\x3ctd\x3e\x3cimg src\x3d"http://geoffreyrockwell.com/images/home_09.jpg" style\x3d"height: 60px"\x3e\x3c/td\x3e\x3c/tr\x3e\x3c/table\x3e\x3c/div\x3e'})},
single:!0},render:function(a){a.getTargetEl().dom.className=""}}}))},loadedCorpus:function(a,b){if(0==this.hasCorpusAccess(b)&&!this.getApiParam("panels")){var c=this.query("voyanttabpanel");c[1].setActiveTab(1);c[1].getActiveTab().fireEvent("loadedCorpus",a,b);c[4].setActiveTab(1)}30<b.getDocumentsCount()&&(c=this.down("bubblelines"))&&c.up("voyanttabpanel").remove(c)},panelChange:function(a){var b=[];this.query("voyanttabpanel").forEach(function(a){b.push(a.getActiveTab().xtype)});this.getApplication().setApiParam("panels",
...
(d.height=Math.round(b.height*parseInt(d.height)/100));d.items&&1<d.items.length?(d.layout="border",this.addBorderLayouts(d.items)):d.layout="fit"}},initTableLayout:function(){Ext.suspendLayouts();var a=decodeURI(this.getApiParam("tableLayout"));if(a&&"{"!=a.charAt(0)&&"["!=a.charAt(0)){var b=[];a.split(/,\s*/).forEach(function(a){b.push(/^"'/.test(a)?a:'"'+a+'"')});a="["+b.join(",")+"]"}a=Ext.decode(a);Ext.isArray(a)&&(a={cells:a});!a.numCols&&a.cells&&Ext.isArray(a.cells)&&(a.numCols=3>a.cells.length?
a.cells.length:5>a.cells.length?Math.ceil(a.cells.length/2):Math.ceil(a.cells.length/3));if(null!=a.numCols&&a.cells&&Ext.isArray(a.cells)){for(var c=[],d=0;d<a.cells.length;d++){var e=a.cells[d];if(Ext.isObject(e))e.cellWidth=parseFloat(e.width)||void 0,e.cellHeight=parseFloat(e.height)||void 0,delete e.width,delete e.height,c.push(e);else if(Ext.isArray(e)){var f=1,g=1;xtype=void 0;e[0]&&Ext.isNumber(e[0])&&(f=e[0],e.shift());e[0]&&Ext.isString(e[0])&&(xtype=e[0],e.shift());e[0]&&Ext.isNumber(e[0])&&
(g=e[0]);xtype&&c.push({colspan:f,rowspan:g,xtype:xtype})}else Ext.isString(e)&&c.push({xtype:e,colspan:1,rowspan:1})}Ext.apply(this,{layout:{type:"table",width:"100%",height:"100%",columns:a.numCols,tableAttrs:{style:{width:"100%",height:"100%"}},tdAttrs:{style:{padding:"0px",verticalAlign:"top"}}},defaults:{width:10,height:10,border:!0},items:c})}else this.showError("badTableLayoutDefinition");Ext.resumeLayouts()},doTableSizing:function(a,b){for(var c={},d=this.getTargetEl().down(".x-table-layout"),
e=d.getSize(!1),d=d.dom.rows,f=0;f<d.length;f++)for(var g=d[f].cells,h=0;h<g.length;h++){var k=Ext.get(g[h]),l=k.down(".x-panel"),m=l.id;if(void 0!==a&&void 0!==b)k=l.getSize(!1),k.width*=a,k.height*=b;else{var l=k.getSize(!1),n=Ext.getCmp(m),q=n.initialConfig.cellWidth,n=n.initialConfig.cellHeight;void 0!==q&&(l.width=q/100*e.width,k.setWidth(l.width));void 0!==n&&(l.height=n/100*e.height,k.setHeight(l.height));k=l}c[m]=k}for(var r in c)k=c[r],Ext.getCmp(r).setSize(k);this.updateLayout()}});Ext.define("Voyant.panel.Veliza",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],xtype:"veliza",autoScroll:!0,statics:{i18n:{title:"Veliza",typeAndEnter:"Type text and hit enter.",send:"send",fromCorpus:"from text",scriptEditor:"Script Editor",scriptIntro:"This is an advanced feature that allows you see and edit the script used by Veliza. For more information on the syntax, see the \x3ca href\x3d'{0}' target\x3d'_blank'\x3edocumentation\x3c/a\x3e."},api:{script:"",message:void 0},glyph:"xf0e6@FontAwesome"},
config:{previous:[]},constructor:function(){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);var a=this;Ext.apply(this,{title:this.localize("title"),glyph:"xf0e6@FontAwesome",layout:{type:"border",align:"stretch"},items:[{itemId:"chat",html:"\x3cform class\x3d'chat'\x3e\x3c/form\x3e",region:"center",flex:2,autoScroll:!0},{itemId:"script",xtype:"form",region:"east",split:!0,title:this.localize("scriptEditor"),layout:{type:"vbox",align:"stretch"},items:[{html:(new Ext.XTemplate(this.localize("scriptIntro"))).apply([a.getBaseUrl()+
"docs/#!/guide/veliza"])},{xtype:"textarea",name:"editor",fieldStyle:"white-space: pre",value:a.getApiParam("script"),flex:1,listeners:{afterrender:function(b){b.mask(a.localize("loadingScript"));Ext.Ajax.request({url:a.getTromboneUrl(),params:{tool:"corpus.Veliza",script:a.getApiParam("script")}}).then(function(c){(c=Ext.decode(c.responseText))&&c.veliza&&c.veliza.script?(b.setValue(c.veliza.script),b.resetOriginalValue()):c&&c.veliza&&c.veliza.id?a.setApiParam("script",c.veliza.id):a.showError(a.localize("unableFetchScript"));
b.unmask()},function(b){a.showError(b)})},scope:this}}],collapsed:!0,collapsible:!0,flex:1}],dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"textfield",itemId:"chatfield",emptyText:this.localize("typeAndEnter"),flex:1,listeners:{specialkey:function(b,c){c.getKey()==c.ENTER&&(a.handleUserSentence(b.getValue()),b.setValue(""))}}},{xtype:"button",text:this.localize("send"),handler:function(){var b=this.up("toolbar").down("textfield");a.handleUserSentence(b.getValue(),
!1);b.setValue("")}},{xtype:"button",text:this.localize("fromCorpus"),handler:function(){a.handleUserSentence("",!0)}}]}]});this.callParent();this.on("boxready",function(a){a.addSentence("fromThem","Hello, I'm Veliza, and I'm here to talk to you about your texts (you may know my sister \x3ca href\x3d'https://en.wikipedia.org/wiki/ELIZA' target\x3d'_blank'\x3eEliza\x3c/a\x3e she's a famous psychotherapist). I'm just learning to talk about text documents, but please, let me know about any anxieties you're feeling about your texts. Type a message in the box below and hit enter. Or, if you're feeling playful, hit the \x3ci\x3efrom text\x3c/i\x3e bottom in the lower right-hand corner to fetch a sentence from the corpus.");
...
params:{corpus:d.getCorpus()?d.getCorpus().getId():void 0,tool:"corpus.Veliza",sentence:a,fromCorpus:b?!0:!1,script:e.isDirty()?e.getValue():this.getApiParam("script"),noCache:Ext.id()},success:function(a,g){d.unmask();a=Ext.decode(a.responseText);a.veliza.id&&(d.setApiParam("script",a.veliza.id),e.resetOriginalValue());var h=a.veliza.response,k=h.match(/<\!-- (.+?) --\x3e/);if(k){k=Ext.decode(k[1]);for(key in k.params)k.params[key]=k.params[key].trim();h+="\x3cbr/\x3e\x3ciframe width\x3d'"+(k.width?
k.width:"100%")+"' height\x3d'"+(k.height?k.height:"250px")+"' src\x3d'"+d.getApplication().getBaseUrl()+"tool/"+k.tool+"/?corpus\x3d"+d.getCorpus().getId()+"\x26minimal\x3dtrue\x26"+Ext.Object.toQueryString(k.params)+"'\x3e\x3c/iframe\x3e"}k=a.veliza.sentence;d.setPrevious(a.veliza.previous);b?(meta=-1<a.veliza.docIndex?d.getCorpus().getDocument(a.veliza.docIndex).getShortLabel():void 0,d.addSentence("myMessage",k,meta),Ext.Function.defer(function(){this.addSentence("fromThem",h);c||this.body.scroll("b",
Infinity)},500,d)):(d.addSentence("fromThem",h),c||d.body.scroll("b",Infinity));d.getApiParam("message")&&d.sendApiParamMessage()},failure:function(a,b){d.showResponseError("Unable to get response from Veliza.",a)}})}},addSentence:function(a,b,c){var d=this.getComponent("chat").body;d.down("form").insertHtml("beforeEnd",'\x3cdiv class\x3d"message"\x3e\x3cdiv class\x3d"'+a+'"\x3e\x3cp\x3e'+b+"\x3c/p\x3e"+(c?"\x3cdate\x3e"+c+"\x3c/date\x3e":"")+"\x3c/div\x3e\x3c/div\x3e",!0);d.scroll("b",Infinity)}});Ext.define("Voyant.panel.WordTree",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.wordtree",statics:{i18n:{},api:{query:void 0,docId:void 0,docIndex:void 0,stopList:"auto",context:10,limit:100},glyph:"xf0e8@FontAwesome"},config:{tree:void 0,kwicStore:void 0,options:{xtype:"stoplistoption"},numBranches:5,lastClick:1},doubleClickDelay:300,constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(){Ext.apply(this,
{title:this.localize("title"),dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"querysearchfield"},this.localize("pool"),{xtype:"slider",itemId:"poolSlider",minValue:10,value:100,maxValue:1E3,increment:5,width:50,listeners:{render:function(a){a.setValue(this.getApiParam("limit"))},changecomplete:function(a,b){this.setApiParam("limit",a.getValue());this.reload()},scope:this}},this.localize("branches"),{xtype:"slider",itemId:"branchesSlider",minValue:2,value:5,maxValue:15,
increment:1,width:50,listeners:{render:function(a){a.setValue(this.getNumBranches())},changecomplete:function(a,b){this.setNumBranches(a.getValue());this.reload()},scope:this}},this.localize("context"),{xtype:"slider",itemId:"contextSlider",minValue:3,value:10,maxValue:20,increment:2,width:50,listeners:{render:function(a){a.setValue(this.getApiParam("context"))},changecomplete:function(a,b){this.setApiParam("context",a.getValue());this.reload()},scope:this}}]}]});this.setKwicStore(Ext.create("Voyant.data.store.Contexts",
{parentPanel:this,proxy:{extraParams:{stripTags:"all"}},listeners:{load:function(a,b,c,d){c&&this.parseRecords(b)},scope:this}}));this.on("loadedCorpus",function(a,b){b.getCorpusTerms({autoLoad:!1}).load({callback:function(a,b,e){e&&0<a.length&&(a=a[0].getTerm(),this.setRoot(a))},scope:this,params:{limit:1,query:this.getApiParam("query"),stopList:this.getApiParam("stopList")}})},this);this.on("query",function(a,b){void 0!==b&&""!=b&&this.setRoot(b)},this);this.on("termsClicked",function(a,b){var c=
[];b.forEach(function(a){Ext.isString(a)?c.push(a):a.term?c.push(a.term):a.getTerm&&c.push(a.getTerm())});this.setRoot(c)},this);this.on("documentTermsClicked",function(a,b){var c=[];b.forEach(function(a){a.getTerm()&&c.push(a.getTerm())});this.setRoot(c)},this);this.on("resize",function(a,b,c){a=this.getTree();void 0!==a&&(a.visWidth(b).visHeight(c),a.redraw())},this);this.on("boxready",this.initGraph,this);this.callParent(arguments)},parseRecords:function(a){for(var b=[],c=0;c<a.length;c++){var d=
a[c],d={id:c,prefix:d.getLeft().trim().split(/\s+/),hit:d.getMiddle(),suffix:d.getRight().trim().split(/\s+/)};b.push(d)}for(var e={},f={},c=0;c<b.length;c++){var d=b[c],g=d.prefix[d.prefix.length-1],d=d.suffix[0];e[g]?e[g]++:e[g]=1;f[d]?f[d]++:f[d]=1}a=[];for(c=0;c<b.length;c++)d=b[c],g=d.prefix[d.prefix.length-1],d=d.suffix[0],a.push({suffix:d,suffixCount:f[d],prefix:g,prefixCount:e[g]});a.sort(function(a,b){var c=a.suffixCount,d=b.suffixCount,e=a.prefixCount,f=b.prefixCount;return e>f?-1:e<f?1:
c>d?-1:c<d?1:0});f=Math.min(this.getNumBranches(),a.length);d=[];e=[];for(c=0;c<f;c++)d.push(a[c].suffix),e.push(a[c].prefix);a=[];for(var f=[],g=[],h=[],c=0;c<b.length;c++){var k=b[c];if(-1!=d.indexOf(k.suffix[0])||-1!=e.indexOf(k.suffix[0]))a.push(k.prefix),f.push(k.hit),g.push(k.suffix),h.push(k.id)}this.getTree().setupFromArrays(a,f,g,h,!1,["token","POS"],"/",["token","POS"]);this.getTree().succeeded()||this.toastInfo({html:this.localize("emptyText"),align:"bl"})},initGraph:function(){var a=this.getLayout().getRenderTarget(),
b=a.getWidth(),c=a.getHeight(),d=new doubletree.DoubleTree;d.init("#"+a.getId()).visWidth(b).visHeight(c).handlers({click:this.clickHandler.bind(this)});this.setTree(d)},clickHandler:function(a){var b=(new Date).getTime();if(this.getLastClick()&&b-this.getLastClick()<this.doubleClickDelay){this.setLastClick(1);for(b=[];null!=a;)b.push(a.name),a=a.parent;this.getApplication().dispatchEvent("termsClicked",this,[b.reverse().join(" ")])}else this.setLastClick(b)},setRoot:function(a){this.setApiParam("query",
this.stripPunctuation(a));this.getKwicStore().load({params:this.getApiParams()})},reload:function(){var a=this.getApiParam("query");void 0!==a&&this.setRoot(a)},stripPunctuation:function(a){if(Ext.isString(a))return a.replace(/[.,\/#!$%\^&\*;:{}=\-_`~()]/g,"");var b=[];a.forEach(function(a){b.push(a.replace(/[.,\/#!$%\^&\*;:{}=\-_`~()]/g,""))});return b}});Ext.define("Voyant.panel.WordWall",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel","Voyant.util.DiacriticsRemover"],alias:"widget.wordwall",statics:{i18n:{title:"Wall of Words",terms:"Terms",scaling:"Scaling",xStrength:"X Strength",yStrength:"Y Strength",chargeStrength:"Charge Strength",chargeDistance:"Charge Distance",delay:"Fetch Delay",transition:"Transition Speed",stop:"Stop",start:"Start"},api:{limit:500,stopList:"auto"},glyph:"xf1e0@FontAwesome"},config:{visId:void 0,vis:void 0,simulation:void 0,
nodes:void 0,tempNodes:void 0,zoom:void 0,terms:void 0,segments:void 0,filterOutUniqueTerms:!0,currentSegment:void 0,segmentTerms:void 0,segmentTermsQueue:[],segmentDelay:5E3,segmentDelayTimer:void 0,webWorker:void 0,isSimulating:!1,transitionTime:2E3,isTransitioning:!1,minFreq:void 0,maxFreq:void 0,letterDistribution:void 0,frequencyScale:void 0,xForceStrength:.2,yForceStrength:.1,chargeStrength:-75,chargeDistance:100,minFontSize:7,maxFontSize:60},count:0,MIN_TERMS:10,MAX_TERMS:2E3,MIN_SCALING:1,
MAX_SCALING:20,debugMsg:!1,constructor:function(a){this.mixins["Voyant.util.DiacriticsRemover"].constructor.apply(this,arguments);this.setVisId(Ext.id(null,"wordwall_"));this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(){Ext.apply(this,{title:this.localize("title"),dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[this.localize("terms"),{width:50,xtype:"slider",minValue:this.MIN_TERMS,maxValue:this.MAX_TERMS,
increment:10,listeners:{render:function(a){a.setValue(this.getApiParam("limit"))},changecomplete:function(a,b){this.setApiParam("limit",a.getValue());this.initLoad()},scope:this}},this.localize("delay"),{width:50,xtype:"slider",minValue:1,maxValue:60,increment:1,listeners:{render:function(a){a.setValue(this.getSegmentDelay()/1E3)},changecomplete:function(a,b){this.setSegmentDelay(1E3*a.getValue());this.restartSegmentTimer()},scope:this}},this.localize("transition"),{width:50,xtype:"slider",minValue:100,
maxValue:5E3,increment:1,listeners:{render:function(a){a.setValue(this.getTransitionTime())},changecomplete:function(a,b){this.setTransitionTime(a.getValue())},scope:this}},this.localize("xStrength"),{width:50,xtype:"slider",minValue:0,maxValue:1E3,increment:10,listeners:{render:function(a){a.setValue(1E3*this.getXForceStrength())},changecomplete:function(a,b){this.setXForceStrength(a.getValue()/1E3)},scope:this}},this.localize("yStrength"),{width:50,xtype:"slider",minValue:0,maxValue:1E3,increment:10,
listeners:{render:function(a){a.setValue(1E3*this.getYForceStrength())},changecomplete:function(a,b){this.setYForceStrength(a.getValue()/1E3)},scope:this}},this.localize("chargeStrength"),{width:50,xtype:"slider",minValue:-1E3,maxValue:0,increment:10,listeners:{render:function(a){a.setValue(this.getChargeStrength())},changecomplete:function(a,b){this.setChargeStrength(a.getValue())},scope:this}},this.localize("chargeDistance"),{width:50,xtype:"slider",minValue:0,maxValue:1E3,increment:10,listeners:{render:function(a){a.setValue(this.getChargeDistance())},
changecomplete:function(a,b){this.setChargeDistance(a.getValue())},scope:this}},{xtype:"button",text:this.localize("stop"),handler:function(a){a.getText()===this.localize("stop")?(clearInterval(this.getSegmentDelayTimer()),a.setText(this.localize("start"))):(this.restartSegmentTimer(),a.setText(this.localize("stop")))},scope:this},{itemId:"status",xtype:"tbtext",text:""}]}]});this.on("loadedCorpus",function(a,b){this.isVisible()&&this.initLoad()},this);this.on("resize",function(a,b,c){if(a=Ext.get(this.getVisId()))c=
this.body,b=c.getHeight(),c=c.getWidth(),a.el.dom.setAttribute("width",c),a.el.dom.setAttribute("height",b)},this);this.callParent(arguments)},initVis:function(){var a=this.getLayout().getRenderTarget();a.update("");var b=a.getWidth(),c=a.getHeight(),a=d3.select(a.dom).append("svg").attr("id",this.getVisId()).attr("class","wordWall").attr("width",b).attr("height",c).append("g");this.setVis(a);this.setNodes(a.append("g").attr("class","nodes").selectAll(".node"));this.setTempNodes(a.append("g").attr("class",
"tempNodes").selectAll("text"));void 0===this.getWebWorker()&&(this.setWebWorker(new Worker(this.getBaseUrl()+"resources/d3/WordWallWorker.js")),this.getWebWorker().onmessage=this.handleWebWorkerMessage.bind(this))},initLoad:function(){this.initVis();this.count=0;var a=this.getApiParams();a.tool="corpus.CorpusSegmentTerms";Ext.Ajax.request({url:this.getTromboneUrl(),params:a,success:function(a){a=Ext.decode(a.responseText);this.setSegments(a.corpusSegmentTerms.segments);a=a.corpusSegmentTerms.terms;
this.getFilterOutUniqueTerms()&&(a=a.filter(function(a,b){return-1==a.rawFreqs.indexOf(0)}));this.setTerms(a);this.setCurrentSegment(this.getSegments().length);this.getNextSegment();this.restartSegmentTimer()},failure:function(a){this.debugMsg&&console.log("failed",a)},scope:this})},restartSegmentTimer:function(){clearInterval(this.getSegmentDelayTimer());this.setSegmentDelayTimer(setInterval(function(){this.updateNodePositions()}.bind(this),this.getSegmentDelay()))},getNextSegment:function(){var a=
this.getCurrentSegment();a++;a>=this.getSegments().length&&(a=0);this.setCurrentSegment(a);this.debugMsg&&console.log("getNextSegment",a);this.processTermsForSegment(this.getCurrentSegment())},processTermsForSegment:function(a){var b=Number.MAX_VALUE,c=Number.MIN_VALUE,d={a:0,b:0,c:0,d:0,e:0,f:0,g:0,h:0,i:0,j:0,k:0,l:0,m:0,n:0,o:0,p:0,q:0,r:0,s:0,t:0,u:0,v:0,w:0,x:0,y:0,z:0};this.getTerms().forEach(function(e){e.id=this.idGet(e.term);e.value=e.rawFreqs[a];if(0<e.value){e.value<b&&(b=e.value);e.value>
c&&(c=e.value);e.title=e.term+" ("+e.value+")";var f=this.removeDiacritics(e.term.charAt(0)).toLowerCase();e.letter=f;void 0===d[f]&&(d[f]=0);d[f]++}},this);this.setSegmentTerms(this.getTerms().filter(function(a){return 0<a.value}));this.setMinFreq(b);this.setMaxFreq(c);var e=[],f;for(f in d){var g=d[f]/this.getTerms().length;e.push({letter:f,percent:g})}e.sort(function(a,b){return a.letter<b.letter?-1:a.letter>b.letter?1:0});this.setLetterDistribution(e);this.calculateNodeSizes(this.getSegmentTerms());
this.runSimulation(this.getSegmentTerms())},calculateNodeSizes:function(a){var b=this.getTempNodes().data(a,function(a){return a.id}),c=function(b){var c=2*Math.min(1,a.length/this.MAX_TERMS)+1;b=this.getFrequencyScale()(b);return d3.scalePow().exponent(c).domain([0,1]).range([this.getMinFontSize(),this.getMaxFontSize()])(b)}.bind(this),d=0;b.enter().append("text").attr("fill-opacity",0).attr("font-family",function(a){return"Arial"}).attr("font-size",function(a){var b=c(a.value);return a.fontSize=
b}).text(function(a){return a.term}).each(function(a){var b=this.getBBox();a.bbox={};a.bbox.x=b.x;a.bbox.y=b.y;a.bbox.width=b.width;a.bbox.height=b.height;d+=b.width*b.height}).remove();var e=this.getLayout().getRenderTarget(),b=e.getWidth(),e=e.getHeight(),b=b*e;d>.6*b?(this.setMaxFontSize(.9*this.getMaxFontSize()),this.setMinFontSize(.9*this.getMinFontSize()),this.calculateNodeSizes(a)):d<.5*b&&(this.setMaxFontSize(1.1*this.getMaxFontSize()),this.setMinFontSize(1.1*this.getMinFontSize()),this.calculateNodeSizes(a))},
runSimulation:function(a){this.setIsSimulating(!0);var b=this.getLayout().getRenderTarget(),c=b.getWidth(),b=b.getHeight();this.debugMsg&&console.time("runSim");this.getWebWorker().postMessage({terms:a,width:c,height:b,minFreq:this.getMinFreq(),maxFreq:this.getMaxFreq(),xForceStrength:this.getXForceStrength(),yForceStrength:this.getYForceStrength(),chargeDistance:this.getChargeDistance(),chargeStrength:this.getChargeStrength(),letterDistribution:this.getLetterDistribution()})},handleWebWorkerMessage:function(a){switch(a.data.type){case "progress":a=
parseInt(100*a.data.progress);this.getDockedItems()[1].getComponent("status").update(a+"%");break;case "msg":this.debugMsg&&console.log(a.data.msg);break;case "end":this.debugMsg&&console.timeEnd("runSim"),this.getDockedItems()[1].getComponent("status").update(""),this.setIsSimulating(!1),this.getSegmentTermsQueue().push(a.data.nodes)}},updateNodePositions:function(){if(this.getIsTransitioning())Ext.Function.defer(this.updateNodePositions,100,this);else{this.count++;var a=this.getSegmentTermsQueue().shift();
this.debugMsg&&console.log("queue length",this.getSegmentTermsQueue().length);if(void 0===a)this.debugMsg&&console.log("no nodes",this.count),!1===this.getIsSimulating()&&this.getNextSegment();else{this.setIsTransitioning(!0);0==this.getSegmentTermsQueue().length&&this.getNextSegment();a=this.getNodes().data(a,function(a){return a.id});a.transition().duration(this.getTransitionTime()).attr("transform",function(a){return"translate("+a.x+","+a.y+")"});var b=a.enter().append("g").attr("class","node").attr("id",
function(a){return a.id}).attr("transform",function(a){return"translate("+a.x+","+a.y+")"}).attr("fill-opacity",0);b.append("title").text(function(a){return a.title});b.append("text").attr("font-family",function(a){return"Arial"}).attr("font-size",function(a){return a.fontSize}).attr("fill",function(a){return this.getApplication().getFeatureForTerm("color",a.term)}.bind(this)).style("cursor","pointer").style("user-select","none").attr("alignment-baseline","middle").text(function(a){return a.term});
b.transition().duration(this.getTransitionTime()).attr("fill-opacity",1);b=b.merge(a);b.select("text").transition().duration(this.getTransitionTime()).attr("font-size",function(a){return a.fontSize});a.exit().transition().duration(this.getTransitionTime()).attr("fill-opacity",0).remove();setTimeout(function(){this.setIsTransitioning(!1)}.bind(this),this.getTransitionTime());this.setNodes(b)}}},updateMinFreq:function(){this.setFrequencyScale(d3.scaleLog().domain([this.getMinFreq(),this.getMaxFreq()]).range([0,
1]))},updateMaxFreq:function(){this.setFrequencyScale(d3.scaleLog().domain([this.getMinFreq(),this.getMaxFreq()]).range([0,1]))},zoomToFit:function(a,b){var c=this.getVis().node().getBBox(),d=c.width,e=c.height,f=c.x+d/2,g=c.y+e/2,c=this.getVis().node().parentElement,h=c.clientWidth,k=c.clientHeight,d=(a||.8)/Math.max(d/h,e/k),f=[h/2-d*f,k/2-d*g];d3.select(c).transition().duration(b||500).call(this.getZoom().transform,d3.zoomIdentity.translate(f[0],f[1]).scale(d))},idGet:function(a){return a.replace(/\W/g,
"_")}});Ext.define("Voyant.panel.Topics",{extend:"Ext.grid.Panel",mixins:["Voyant.panel.Panel","Voyant.widget.LiveSearchGrid"],alias:"widget.topics",statics:{i18n:{},api:{stopList:"auto",numTopics:25,limit:10,iterations:100,perDocLimit:1E3,query:void 0},glyph:"xf1ea@FontAwesome"},config:{options:[{xtype:"stoplistoption"},{xtype:"numberfield",name:"perDocLimit",fieldLabel:"maximum words per document",labelAlign:"right",value:1E3,minValue:1,step:100,listeners:{afterrender:function(a){var b=a.up("window");b&&
b.panel&&(a.setValue(parseInt(b.panel.getApiParam("perDocLimit"))),a.setFieldLabel(b.panel.localize("perDocLimit")))},change:function(a,b){var c=a.up("window");5E3<b&&c&&c.panel&&c.panel.toastInfo({html:c.panel.localize("perDocLimitHigh"),anchor:c.getTargetEl(),align:"tr",maxWidth:400})}}},{xtype:"numberfield",name:"iterations",fieldLabel:"iterations per run",labelAlign:"right",value:100,minValue:1,maxValue:1E4,step:50,listeners:{afterrender:function(a){var b=a.up("window");b&&b.panel&&(a.setValue(parseInt(b.panel.getApiParam("iterations"))),
...
void 0:parseInt(this.getApiParam("perDocLimit"))},success:function(b,c){this.unmask();this.mask(this.localize("parsingDocuments"));var d=b.responseText.trim().split(/(\r\n|\r|\n)/);if(1==d.length){if(d=d[0].split(": "),1<d.length)for(var e=a.getDocument(d[0]),f=d[1].split(" "),e=e.getLexicalTokensCount(),e=10>e?e:1E3>e?10:100,e=10,g=Math.floor(f.length/e),h=0;h<e;h++){var k=f.slice(h*g,h*g+g).join(" ");this.parseLine(d[0]+"-"+h+"\t"+d[0]+"-"+h+"\t"+k)}}else d.forEach(function(b){b=b.split(": ");if(1<
b.length){var c=a.getDocument(b[0]);this.parseLine(b[0]+"\t"+c.getTinyLabel()+"\t"+b[1])}},this);this.unmask();this.runIterations()},scope:this})},resetData:function(){var a=parseInt(this.getApiParam("numTopics"));this.setVocabularyCounts({});this.setSumDocSortSmoothing(this.getDocSortSmoothing()*a);this.setRequestedSweeps(0);this.setWordTopicCounts({});this.setTopicWordCounts([]);this.setTokensPerTopic(this.zeros(a));this.setTopicWeights(this.zeros(a));this.setDocuments([]);this.setTotalIterations(0)},
loadFromExistingDocuments:function(){var a=this.getDocuments().map(function(a){return a.id+"\t"+a.date+"\t"+a.originalText});this.resetData();a.forEach(function(a){this.parseLine(a)},this);this.runIterations()},runIterations:function(){var a=this.getRequestedSweeps(),b=parseInt(this.getApiParam("iterations")),a=a+parseInt(b);this.setTotalIterations(this.getTotalIterations()+b);this.setRequestedSweeps(a);this.getProgress()||(b=Ext.MessageBox.show({title:this.localize("runningIterations"),message:(new Ext.Template(this.localize("runningIterationsCount"))).apply([a]),
...
d=this.getTokensPerTopic(),e=this.getDocuments(),f=this.getWordTopicCounts(),g=this.getTopicWeights(),h=this.getDocumentTopicSmoothing(),k=this.zeros(a),l=0;l<a;l++)k[l]=1/(b*c+d[l]);for(var m=0;m<e.length;m++)for(var n=e[m],q=n.topicCounts,r=0;r<n.tokens.length;r++){var p=n.tokens[r];if(!p.isStopword){d[p.topic]--;var u=f[p.word];u[p.topic]--;q[p.topic]--;k[p.topic]=1/(b*c+d[p.topic]);for(var v=0,l=0;l<a;l++)g[l]=u[l]?(h+q[l])*(c+u[l])*k[l]:(h+q[l])*c*k[l],v+=g[l];l=v*Math.random();v=0;for(l-=g[v];0<
l;)v++,l-=g[v];p.topic=v;d[p.topic]++;u[p.topic]=u[p.topic]?u[p.topic]+1:1;q[p.topic]++;k[p.topic]=1/(b*c+d[p.topic])}}a=this.getRequestedSweeps()-1;this.setRequestedSweeps(a);b=this.getProgress();0<a?(this.updateProgress(a),Ext.defer(this.sweep,0,this)):(b.close(),this.setProgress(void 0),this.postSweep())},postSweep:function(){this.sortTopicWords();var a=this.getStore(),b=(new Ext.Template(this.localize("totalDone"))).apply([Ext.util.Format.number(parseInt(this.getTotalIterations()),"0,000")]);
this.down("#done").setHtml(b);for(var b=parseInt(this.getApiParam("numTopics")),c=this.getTopicWordCounts(),d=[],e=this.getDocuments(),f=this.getDocSortSmoothing(),g=this.getSumDocSortSmoothing(),h=parseInt(this.getApiParam("limit")),k=0;k<b;k++){var l=e.map(function(a,b){return(a.topicCounts[k]+f)/(a.tokens.length+g)});d.push({topic:this.topNWords(c[k],h),scores:l})}a.loadData(d)},topNWords:function(a,b){return a.slice(0,b).map(function(a){return a.word}).join(" ")},sortTopicWords:function(){for(var a=
this.getTopicWordCounts(),b=parseInt(this.getApiParam("numTopics")),c=this.getWordTopicCounts(),a=[],d=0;d<b;d++)a[d]=[];for(var e in c)for(d in c[e])a[d].push({word:e,count:c[e][d]});for(d=0;d<b;d++)a[d].sort(this.byCountDescending);this.setTopicWordCounts(a)},byCountDescending:function(a,b){return b.count-a.count},initialize:function(){var a=(new Ext.Template(this.localize("runIterations"))).apply([Ext.util.Format.number(parseInt(this.getApiParam("iterations")),"0,000")]);this.down("#iterations").setText(a);
this.loadStopwords()},parseLine:function(a){var b=this.getStopwords(),c=this.getVocabularyCounts(),d=this.getTokensPerTopic(),e=this.getVocabularySize(),c=this.getVocabularyCounts(),f=this.getDocuments(),g=parseInt(this.getApiParam("numTopics")),h=this.getWordTopicCounts();if(""!=a){var k=f.length,l="",m=a.split("\t");a=m[0];3==m.length&&(k=m[0],l=m[1],a=m[2]);var n=[],m=a.toLowerCase().split(" ");if(null!=m){var q=this.zeros(g);m.forEach(function(a){if(""!==a){var f=Math.floor(Math.random()*g);2>=
a.length&&(b[a]=1);var k=b[a];k?c[a]=c[a]?c[a]+1:1:(d[f]++,h[a]||(h[a]={},e++,c[a]=0),h[a][f]||(h[a][f]=0),h[a][f]+=1,c[a]+=1,q[f]+=1);n.push({word:a,topic:f,isStopword:k})}});this.setVocabularySize(e);f.push({originalOrder:f.length,id:k,date:l,originalText:a,tokens:n,topicCounts:q})}}}});Ext.define("Voyant.panel.Via",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.via",statics:{i18n:{title:"Via",helpTip:"Via is a tool intended to help you explore the semantic clusters of English texts.",visible:"Visible",timedout:"An attempt was made to fetch data but the request took too long. The process may be still ongoing and you could try again in a couple of minutes.",englishOnly:"You seem to have a text in a language other than English. Unfortunately, at the moment, Via only supports texts in English (because of the current way the lemmatization and synonym operations are programmed)."},
api:{stopList:"auto",limit:100,docIndex:void 0},glyph:"xf06e@FontAwesome"},config:{mode:void 0,options:[{xtype:"stoplistoption"},{xtype:"listeditor",name:"whiteList"},{xtype:"categoriesoption"}]},layout:"fit",constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(a){Ext.apply(this,{title:this.localize("title"),dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"corpusdocumentselector",
singleSelect:!0},{fieldLabel:this.localize("visible"),labelWidth:40,width:120,xtype:"slider",increment:10,minValue:10,maxValue:1E3,listeners:{afterrender:function(a){a.setValue(this.getApiParam("limit"))},changecomplete:function(a,c){this.setApiParams({limit:c});this.loadFromCorpus(this.getCorpus())},scope:this}}]}]});this.callParent(arguments)},listeners:{resize:function(a,b,c){},loadedCorpus:function(a,b){var c=b.get("languageCodes");Ext.Array.each(c,function(a){if("en"!=a)return this.showError(this.localize("englishOnly")),
!1},this);1E5<b.getWordTokensCount()&&!this.getApiParam("docIndex")&&this.setApiParam("docIndex",0);this.loadFromCorpus(b)},corpusSelected:function(a,b){this.setApiParam("docIndex","");this.loadFromCorpus(b)},documentSelected:function(a,b){this.setApiParam("docIndex",b.getIndex());this.loadFromCorpus(this.getCorpus())}},loadFromCorpus:function(a){var b=this;this.mask(this.localize("loading"));var c=this.getApiParams();a.loadRelatedWords(c).then(function(a){b.unmask();a=a.map(function(a){return{source:a.getSource(),
target:a.getTarget()}});var c=b.down("voyantnetworkgraph");c?c.loadJson({edges:a}):(c=Ext.create("Voyant.widget.VoyantNetworkGraph",{edges:a,listeners:{nodeclicked:function(a,c){b.dispatchEvent("termsClicked",b,[c.term])}}}),b.add(c))},function(a){b.unmask();a.timedout?b.showError(b.localize("timedout")):b.showError(a)})}});Ext.define("Voyant.notebook.editor.button.Add",{extend:"Ext.button.Button",mixins:["Voyant.util.Localization"],alias:"widget.notebookwrapperadd",statics:{i18n:{tip:{en:"Add New Block"}}},constructor:function(a){Ext.apply(this,{tooltip:this.localize("tip")});this.callParent(arguments)},glyph:"xf067@FontAwesome",textAlign:"left",listeners:{click:function(a,b){this.findParentByType("notebook").fireEvent("notebookWrapperAdd",this.findParentByType("notebookeditorwrapper"),b)}}});Ext.define("Voyant.notebook.editor.button.Edit",{extend:"Ext.button.Button",mixins:["Voyant.util.Localization"],alias:"widget.notebookwrapperedit",statics:{i18n:{tip:{en:"Edit"}}},constructor:function(a){Ext.apply(this,{toolTip:this.localize("tip")});this.callParent(arguments)},glyph:"xf040@FontAwesome",listeners:{click:function(){this.findParentByType("notebook").fireEvent("notebookWrapperEdit",this.findParentByType("notebookeditorwrapper"))}}});Ext.define("Voyant.notebook.editor.button.Counter",{extend:"Ext.toolbar.TextItem",mixins:["Voyant.util.Localization"],alias:"widget.notebookwrappercounter",statics:{i18n:{tip:{en:"Edit"}}},config:{order:0},cls:"notebookwrappercounter",constructor:function(a){Ext.apply(this,{toolTip:this.localize("tip")});this.callParent(arguments)},setOrder:function(a){this.callParent(arguments);this.updateHtml()},updateHtml:function(){var a=this.getOrder()+1,b="spyralcounter_"+a;this.setHtml('\x3ca name\x3d"'+b+
'" id\x3d"'+b+'" href\x3d"#'+b+'"\x3e'+a+"\x3c/a\x3e")}});Ext.define("Voyant.notebook.editor.button.MoveDown",{extend:"Ext.button.Button",mixins:["Voyant.util.Localization"],alias:"widget.notebookwrappermovedown",statics:{i18n:{tip:"move this block down"}},constructor:function(a){Ext.apply(this,{tooltip:this.localize("tip")});this.callParent(arguments)},glyph:"xf063@FontAwesome",textAlign:"left",listeners:{click:function(){this.findParentByType("notebook").fireEvent("notebookWrapperMoveDown",this.findParentByType("notebookeditorwrapper"))}}});Ext.define("Voyant.notebook.editor.button.MoveUp",{extend:"Ext.button.Button",mixins:["Voyant.util.Localization"],alias:"widget.notebookwrappermoveup",statics:{i18n:{tip:"move this block up"}},constructor:function(a){Ext.apply(this,{tooltip:this.localize("tip")});this.callParent(arguments)},glyph:"xf062@FontAwesome",textAlign:"left",listeners:{click:function(){this.findParentByType("notebook").fireEvent("notebookWrapperMoveUp",this.findParentByType("notebookeditorwrapper"))}}});Ext.define("Voyant.notebook.editor.button.Remove",{extend:"Ext.button.Button",mixins:["Voyant.util.Localization"],alias:"widget.notebookwrapperremove",statics:{i18n:{tip:"remove this block",confirmRemoveTitle:"Confirm Remove",confirmRemove:"Are you sure you want to remove this block (and lose any content in the editor)?"}},constructor:function(a){Ext.apply(this,{tooltip:this.localize("tip")});this.callParent(arguments)},glyph:"xf014@FontAwesome",textAlign:"left",listeners:{click:function(){Ext.Msg.show({buttons:Ext.Msg.OKCANCEL,
icon:Ext.MessageBox.QUESTION,msg:this.localize("confirmRemove"),title:this.localize("confirmRemoveTitle"),fn:function(a){"ok"==a&&this.findParentByType("notebook").fireEvent("notebookWrapperRemove",this.findParentByType("notebookeditorwrapper"))},scope:this})}}});Ext.define("Voyant.notebook.editor.button.Movement",{extend:"Ext.button.Button",mixins:["Voyant.util.Localization"],requires:["Voyant.notebook.editor.button.MoveUp","Voyant.notebook.editor.button.MoveDown","Voyant.notebook.editor.button.Remove"],alias:"widget.notebookwrappermovement",statics:{i18n:{tip:{en:"Move / Remove Controls"}}},constructor:function(a){Ext.apply(this,{tooltip:this.localize("tip")});this.callParent(arguments)},glyph:"xf07d@FontAwesome",menu:[{xtype:"notebookwrappermoveup"},{xtype:"notebookwrappermovedown"},
{xtype:"notebookwrapperremove"}]});Ext.define("Voyant.notebook.editor.button.Run",{extend:"Ext.button.Button",mixins:["Voyant.util.Localization"],alias:"widget.notebookwrapperrun",statics:{i18n:{tip:{en:"Run the script in this block (Shift-Enter)"}}},glyph:"xf04b@FontAwesome"});Ext.define("Voyant.notebook.editor.button.RunAll",{extend:"Ext.button.Button",mixins:["Voyant.util.Localization"],alias:"widget.notebookwrapperrunall",statics:{i18n:{tip:"Run all code blocks below."}},glyph:"xf04e@FontAwesome",constructor:function(a){a=a||{};a.tooltip=this.localize("tip");this.callParent(arguments)}});Ext.define("Voyant.notebook.editor.button.RunUntil",{extend:"Ext.button.Button",mixins:["Voyant.util.Localization"],alias:"widget.notebookwrapperrununtil",statics:{i18n:{tip:"Run all code blocks up to and including this one."}},glyph:"xf050@FontAwesome",constructor:function(a){a=a||{};a.tooltip=this.localize("tip");this.callParent(arguments)}});Ext.define("Voyant.notebook.editor.EditorWrapper",{extend:"Ext.panel.Panel",mixins:["Voyant.util.Localization"],requires:["Voyant.notebook.editor.button.Movement","Voyant.notebook.editor.button.Add"],alias:"widget.notebookeditorwrapper",cls:"notebook-editor-wrapper",config:{content:"",isEditing:!1},border:!1,bodyBorder:!1,initComponent:function(){this.on("afterrender",function(){this.getDockedItems().forEach(function(a){a.getTargetEl().setVisibilityMode(Ext.dom.Element.VISIBILITY)});this.body.on("click",
function(){this.removeCls("notebook-editor-wrapper-hover");this.setActiveMode(!0)},this);this.mon(this.getEl(),"mouseover",function(){this.setActiveMode(!0)},this);this.mon(this.getEl(),"mouseout",function(){this.setActiveMode(!1)},this)},this);this.callParent(arguments)},setActiveMode:function(a){this.getDockedItems().forEach(function(b){"right"==b.dock?b.items.each(function(b){0==b.hasCls("notebookwrappercounter")&&b.getTargetEl().setVisibility(a)}):b.getTargetEl().setVisibility(a)},this);this.getIsEditing()||
(a?this.body.addCls("notebook-editor-wrapper-hover"):this.body.removeCls("notebook-editor-wrapper-hover"))}});Ext.define("Voyant.notebook.editor.CodeEditor",{extend:"Ext.Component",alias:"widget.notebookcodeeditor",mixins:["Voyant.util.Localization","Voyant.notebook.util.Embed"],embeddable:["Voyant.notebook.editor.CodeEditor"],cls:"notebook-code-editor",config:{theme:"ace/theme/chrome",mode:"ace/mode/javascript",content:"",docs:void 0,isChangeRegistered:!1,editor:void 0,editedTimeout:void 0,lines:0},statics:{i18n:{emptyText:"// click here to edit"},api:{content:void 0}},constructor:function(a){this.callParent(arguments)},
listeners:{boxready:function(){var a=this,b=ace.edit(Ext.getDom(this.getEl()));b.$blockScrolling=Infinity;b.getSession().setUseWorker(!0);b.setTheme(this.getTheme());b.getSession().setMode(this.getMode());b.setOptions({minLines:6,maxLines:-1<this.getMode().indexOf("javascript")?Infinity:10,autoScrollEditorIntoView:!0,scrollPastEnd:!0});b.setHighlightActiveLine(!1);b.renderer.setShowPrintMargin(!1);b.renderer.setShowGutter(!1);b.setValue(this.getContent()?this.getContent():this.localize("emptyText"));
b.clearSelection();b.on("focus",function(){a.getEditor().renderer.setShowGutter(!0)},this);b.on("change",function(b,d){var e=d.getSession().getScreenLength();e!=a.getLines()&&(a.up("notebookcodeeditorwrapper").setSize({height:e*d.renderer.lineHeight+d.renderer.scrollBar.getWidth()}),a.setLines(e));if(0==a.getIsChangeRegistered()){if(a.setIsChangeRegistered(!0),e=a.up("notebookcodeeditorwrapper")){e.setIsRun(!1);var f=e.up(f);f&&f.setIsEdited(!0)}}else a.getEditedTimeout()||a.setEditedTimeout(setTimeout(function(){a.setIsChangeRegistered(!1)},
3E4))},this);b.on("blur",function(){a.getEditor().renderer.setShowGutter(!1)});b.commands.addCommand({name:"run",bindKey:{win:"Shift-Enter",mac:"Shift-Enter"},exec:function(b){(b=a.up("notebookcodeeditorwrapper"))&&b.run()}});this.setEditor(b);ace.config.loadModule("ace/ext/tern",function(){a.getEditor().setOptions({enableTern:{defs:a.docs?["ecma5",a.docs]:[],plugins:{doc_comment:{fullDocs:!0}},useWorker:!0},enableSnippets:!0,enableBasicAutocompletion:!0})})},removed:function(a,b){a.getEditor()&&
a.getEditor().destroy()}},switchModes:function(a){this.setMode("ace/mode/"+a);this.getEditor().getSession().setMode(this.getMode());this.getEditor().setOptions({maxLines:-1<this.getMode().indexOf("javascript")?Infinity:10})},getValue:function(){return this.getEditor().getValue()}});Ext.define("Voyant.notebook.editor.CodeEditorWrapper",{extend:"Voyant.notebook.editor.EditorWrapper",requires:["Voyant.notebook.editor.CodeEditor","Voyant.notebook.editor.button.Run",,"Voyant.notebook.editor.button.RunAll"],alias:"widget.notebookcodeeditorwrapper",cls:"notebook-code-wrapper",statics:{i18n:{previousNotRunTitle:"Previous Code Blocks",previousNotRun:"There are previous blocks that have not been run (and may be needed for the code in this block). Do you wish to run all code blocks instead?",
modeCode:"Code",modeData:"Data",modeJavascript:"Javascript (default)",modeJson:"JSON",modeText:"Text",modeCsv:"CSV (comma-separated values)",modeTsv:"TSV (tab-separated values)",modeHtml:"HTML",modeXml:"XML"}},config:{isRun:!1},layout:{type:"vbox",align:"stretch"},height:130,border:!1,constructor:function(a){this.results=Ext.create("Ext.Component",{align:"stretch",cls:"notebook-code-results",html:Ext.Array.from(a.output).join("")});this.editor=Ext.create("Voyant.notebook.editor.CodeEditor",{content:Ext.Array.from(a.input).join("\n"),
docs:a.docs,mode:"ace/mode/"+(a.mode?a.mode:"javascript")});Ext.apply(this,{dockedItems:[{xtype:"toolbar",dock:"left",defaults:{textAlign:"left"},items:[{xtype:"notebookwrapperadd"},{xtype:"notebookwrapperrun",listeners:{click:{fn:this.run,scope:this}}},{xtype:"notebookwrapperrununtil",listeners:{click:{fn:function(){this.up("notebook").runAllCode(this)},scope:this}}},{xtype:"button",glyph:"xf1c9@FontAwesome",tooltip:this.localize("codeModeTip"),listeners:{click:function(){var a=this;(new Ext.Window({title:"Resize Me",
layout:"fit",width:200,items:[{xtype:"form",layout:{type:"vbox",align:"stretch"},bodyPadding:10,items:[{xtype:"fieldset",title:this.localize("modeCode"),items:{xtype:"radiofield",boxLabel:this.localize("modeJavascript"),name:"codeMode",inputValue:"javascript",flex:1}},{xtype:"fieldset",title:this.localize("modeData"),items:[{items:{xtype:"radiofield",boxLabel:this.localize("modeJson"),name:"codeMode",inputValue:"javascript",flex:1}},{items:{xtype:"radiofield",boxLabel:this.localize("modeText"),name:"codeMode",
inputValue:"text",flex:1}},{items:{xtype:"radiofield",boxLabel:this.localize("modeHtml"),name:"codeMode",inputValue:"html",flex:1}},{items:{xtype:"radiofield",boxLabel:this.localize("modeXml"),name:"codeMode",inputValue:"xml",flex:1}}]}]}],buttons:[{text:this.localize("ok"),handler:function(){var c=this.up("window");values=c.down("form").getForm().getValues();a.switchModes(values.codeMode);c.close()}},{text:this.localize("cancel"),handler:function(){this.up("window").close()}}]})).show()},scope:this}}]},
{xtype:"toolbar",dock:"right",items:[{xtype:"notebookwrappercounter",order:a.order},{xtype:"notebookwrapperremove"},{xtype:"notebookwrappermoveup"},{xtype:"notebookwrappermovedown"}]}],items:[this.editor,this.results]});this.callParent(arguments)},initComponent:function(a){var b=this;b.on("afterrender",function(){this.editor&&"ace/mode/javavscript"!=this.editor.getMode()&&this.switchModes(this.editor.getMode(),!0);this.getTargetEl().on("resize",function(a){var d=20;b.items.each(function(a){d+=a.getHeight()});
b.setSize({height:d})})},this);b.callParent(arguments)},switchModes:function(a,b){var c=-1<a.indexOf("javascript");this.down("notebookwrapperrun").setVisible(c);this.down("notebookwrapperrununtil").setVisible(c);this.results.setVisible(c);b||this.editor.switchModes(a)},run:function(a){if("ace/mode/javascript"==this.editor.getMode())if(!0===a)this._run();else{var b=this.up("notebook");Ext.Array.each(b.query("notebookcodeeditorwrapper"),function(a){if(a==this)return this._run(),!1;a.editor&&"ace/mode/javascript"==
a.editor.getMode()&&0==a.getIsRun()&&Ext.Msg.confirm(this.localize("previousNotRunTitle"),this.localize("previousNotRun"),function(a){"yes"==a?b.runAllCode():this._run()},this)},this)}},_run:function(){this.results.show();this.results.update(" ");this.results.mask("working\u2026");var a=this.editor.getValue();try{Voyant.notebook.util.Show.TARGET=this.results.getEl(),Voyant.notebook.Notebook.currentBlock=this,eval.call(window,a),Ext.defer(this.tryToUnmask,20,this)}catch(b){this.results.unmask(),Voyant.application.releaseAllDeferred(),
Voyant.notebook.util.Show.showError(b)}this.setIsRun(!0);return!1},clearResults:function(){this.results.show();var a=this.results.el.down(".x-panel");if(a){var b=Ext.getCmp(a.id);b?b.destroy():a.destroy()}else this.results.update(" ");this.getTargetEl().fireEvent("resize")},tryToUnmask:function(){if(0==Voyant.application.getDeferredCount()){for(var a in window)"object"==typeof window[a]&&window[a]&&"opener"!=a&&window[a].isFulfilled&&window[a].isFulfilled()&&(window[a]=window[a].valueOf());this.results.unmask();
0==this.results.getTargetEl().getHtml().trim().length&&this.results.hide();this.getTargetEl().fireEvent("resize")}else Ext.defer(this.tryToUnmask,20,this)},getContent:function(){var a={input:this.editor.getValue(),mode:this.editor.getMode().split("/").pop()};if("javascript"==a.mode){var b=this.results.getTargetEl(),c=b.dom.cloneNode(!0);a.output=c.innerHTML;c.style.height||(a.output="\x3cdiv style\x3d'height: "+b.getHeight()+"px'\x3e"+a.output+"\x3c/div\x3e")}return a}});Ext.define("Voyant.notebook.editor.TextEditor",{extend:"Ext.Component",mixins:["Voyant.util.Localization"],alias:"widget.notebooktexteditor",cls:"notebook-text-editor",config:{ckeditorConfig:{toolbar:[{name:"basicstyles",items:["Bold","Italic","-","RemoveFormat"]},{name:"paragraph",items:"NumberedList BulletedList - Justify Outdent Indent Blockquote JustifyLeft JustifyCenter JustifyRight".split(" ")},{name:"colors",items:["TextColor","BGColor"]},{name:"styles",items:["Styles","Format"]},{name:"links",
items:["Link","Unlink","Anchor"]},{name:"insert",items:["Image","Table"]},{name:"document",items:["Sourcedialog","Stopediting"]}],extraPlugins:"stopediting,sourcedialog,justify,colorbutton",removePlugins:"iframe",allowedContent:!0,toolbarCanCollapse:!0,startupFocus:!0},editor:void 0,isEditRegistered:!1,currentHeight:0},statics:{i18n:{emptyText:"(Click here to edit.)",enableEditingTitle:"Enable Editing?",enableEditing:"By default editing is disable, do you wish to enable editing now?"}},border:!1,
constructor:function(a){Ext.apply(this,{html:a.content?a.content:this.localize("emptyText")});this.callParent(arguments)},listeners:{boxready:function(a){this.getTargetEl().on("click",function(b,c){"A"!=c.tagName&&this.handleClick(a)},this)},removed:function(a,b){a.getEditor()&&(a.getEditor().focusManager.blur(!0),a.getEditor().destroy())}},handleClick:function(a){if(!a.getEditor()||a.getEditor()&&a.getEditor().readOnly){var b=this.getTargetEl();b.set({contenteditable:!0});this.findParentByType("notebookeditorwrapper").setIsEditing(!0);
if(a.getEditor())a.getEditor().setReadOnly(!1);else{var c=CKEDITOR.inline(b.dom,this.getCkeditorConfig());c.on("blur",function(b){a.findParentByType("notebookeditorwrapper").setIsEditing(!1).getEl().fireEvent("mouseout");c.setReadOnly(!0)});c.on("change",function(){var a=c.container.$.clientHeight;a!=this.getCurrentHeight()&&(this.findParentByType("notebookeditorwrapper").setHeight(a),this.setCurrentHeight(c.container.$.clientHeight));if(this.getIsEditRegistered()){var b=this;setTimeout(function(){b.setIsEditRegistered(!1)},
...
"helpTip")},glyph:cls&&cls.glyph?cls.glyph:"xf12e@FontAwesome"}},palettes:{"default":[[0,0,255],[51,197,51],[255,0,255],[121,51,255],[28,255,255],[255,174,0],[30,177,255],[182,242,58],[255,0,164],[51,102,153],[34,111,52],[155,20,104],[109,43,157],[128,130,33],[111,76,10],[119,115,165],[61,177,169],[202,135,115],[194,169,204],[181,212,228],[182,197,174],[255,197,197],[228,200,124],[197,179,159]]},rgbToHex:function(a){return"#"+(16777216+(a[0]<<16)+(a[1]<<8)+a[2]).toString(16).slice(1)},hexToRgb:function(a){a=
a.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i,function(a,c,d,e){return c+c+d+d+e+e});return(a=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(a))?[parseInt(a[1],16),parseInt(a[2],16),parseInt(a[3],16)]:null},addColorPalette:function(a,b){this.palettes[a]=b},getColorPalette:function(a,b){var c=a||this.getApiParam("palette")||"default",c=this.palettes[c];void 0===c&&(c=[]);if(b){for(var d=[],e=0;e<c.length;e++)d.push(this.rgbToHex(c[e]));return d}return c},getColor:function(a,b){var c=this.getApiParam("palette")||
"default",c=this.palettes[c];a>=c.length&&(a%=c.length);return b?this.rgbToHex(c[a]):c[a]},colorTermAssociations:new Ext.util.MixedCollection,getColorForTerm:function(a,b){-1!=a.indexOf(":")&&(a=a.split(":")[1]);var c=this.colorTermAssociations.get(a);if(null==c){var c=this.getApiParam("palette")||"default",c=this.palettes[c],d=this.colorTermAssociations.getCount()%c.length,c=c[d];this.colorTermAssociations.add(a,c)}b&&(c=this.rgbToHex(c));return c},openUrl:function(a){window.open(a)||Ext.Msg.show({title:"Popup Blocked",
buttonText:{ok:"Close"},icon:Ext.MessageBox.INFO,message:"A popup window was blocked. \x3ca href\x3d'"+a+"' target\x3d'_blank' class\x3d'link'\x3eClick here\x3c/a\x3e to open the new window.",buttons:Ext.Msg.OK})}});Ext.define("Voyant.VoyantCorpusApp",{extend:"Voyant.VoyantApp",name:"VoyantCorpusApp",requires:"Voyant.panel.CorpusSet Voyant.data.model.Corpus Voyant.panel.VoyantHeader Voyant.panel.VoyantFooter Voyant.panel.CorpusCreator Voyant.panel.Cirrus Voyant.panel.Summary Voyant.panel.DreamScape Voyant.panel.CorpusTerms Voyant.panel.Reader Voyant.panel.Documents Voyant.panel.Trends Voyant.panel.Contexts Voyant.panel.DocumentTerms Voyant.panel.CorpusCollocates Voyant.panel.CollocatesGraph Voyant.panel.Phrases Voyant.panel.ScatterPlot Voyant.panel.TopicContexts Voyant.panel.TermsRadio Voyant.panel.TermsBerry".split(" "),
statics:{i18n:{},api:{toolFlow:void 0}},constructor:function(){this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);this.callParent(arguments)},config:{corpus:void 0,corpusAccess:void 0,moreTools:[{i18n:"moreToolsScaleCorpus",glyph:"xf065@FontAwesome",items:"cirrus corpusterms bubblelines correlations corpuscollocates mandala microsearch streamgraph phrases documents summary trends scatterplot termsradio topics veliza wordtree".split(" ")},{i18n:"moreToolsScaleDocument",glyph:"xf066@FontAwesome",
items:"bubbles cirrus contexts documentterms reader textualarc trends knots topics".split(" ")},{i18n:"moreToolsTypeViz",glyph:"xf06e@FontAwesome",items:"cirrus bubblelines bubbles collocatesgraph knots mandala microsearch streamgraph scatterplot textualarc trends termsberry termsradio wordtree".split(" ")},{i18n:"moreToolsTypeGrid",glyph:"xf0ce@FontAwesome",items:"corpusterms corpuscollocates correlations phrases contexts documentterms documents topics".split(" ")},{i18n:"moreToolsTypeOther",glyph:"xf035@FontAwesome",
items:["reader","summary","veliza"]}]},launch:function(a){this.callParent(arguments);if(this.hasQueryToLoad()){var b=Ext.Object.fromQueryString(document.location.search);!b.corpus&&this.getCorpusId&&this.getCorpusId()&&(b.corpus=this.getCorpusId());a&&a.useCache&&(b.useCache=a.useCache);this.loadCorpusFromParams(b);if(b.palette)if(-1<b.palette.indexOf(",")){var c=Ext.decode(b.palette);this.addColorPalette(b.palette,c)}else this.loadColorPaletteForCorpus(b.corpus,b.palette)}else(b=this.getViewport())&&
(b=b.down("corpuscreator"))&&b.toastInfo({html:this.localize("didYouKnowText"),title:this.localize("didYouKnow"),anchor:b.down("textareafield"),align:"tr",listeners:{beforeclose:{fn:function(){this.getHeader().getTools().forEach(function(a){"gear"!=a.type&&"help"!=a.type||a.getEl().frame("#ff0000",1,{duration:3E3})})},scope:b}}})},loadCorpusFromParams:function(a){var b=this,c=b.getViewport();c.mask(this.localize("fetchingCorpus"));a.archive&&(Ext.isString(a.archive)&&(a.archive=[a.archive]),a.archive=
a.archive.map(function(a){return a.replace("/blogs.sub.uni-hamburg.de/hup/lhn/","/wikis.sub.uni-hamburg.de/lhn/index.php/").replace("/hup.sub.uni-hamburg.de/","/wikis.sub.uni-hamburg.de/")}));this.validateCorpusLoadParams(a);(new Voyant.data.model.Corpus(a)).then(function(a){c.unmask();b.setCorpus(a);b.validateCorpusAccess()&&b.dispatchEvent("loadedCorpus",this,a)}).otherwise(function(){c.unmask()})},validateCorpusLoadParams:function(a){},validateCorpusAccess:function(){var a=this,b=a.getViewport(),
c=this.getCorpus();if(c&&c.requiresPassword()&&!a.getViewport().query("panel").every(function(a){return!a.isConsumptive})){var d=c.getNoPasswordAccess(),e=Ext.create("Ext.window.Window",{title:a.localize("passwordRequiredTitle"),layout:"fit",items:{padding:10,flex:1,width:300,layout:{type:"vbox",align:"stretch"},items:[{html:"\x3cp\x3e"+a.localize("passwordRequiredMessage")+"\x3c/p\x3e"+("NONCONSUMPTIVE"==d?"\x3cp\x3e"+a.localize("nonConsumptiveMessage")+"\x3c/p\x3e":"")+"\x3c/p\x3e"},{xtype:"textfield",
fieldLabel:a.localize("password")}],bbar:{layout:{pack:"center"},items:[{text:a.localize("passwordValidateButton"),ui:"default",handler:function(){var d=e.query("textfield")[0].getValue().trim();0==d.length?a.showError({message:a.localize("noPasswordGiven")}):(e.mask(),Ext.Ajax.request({url:a.getTromboneUrl(),params:{corpus:c.getId(),passwordForSession:d},method:"POST",success:function(d,f){e.unmask();var k=d.responseText;"ADMIN"==k||"ACCESS"==k?(e.close(),b.unmask(),a.setCorpusAccess(k),a.dispatchEvent("loadedCorpus",
this,c)):a.showError({message:a.localize("badPassword")})},failure:function(b,c){e.unmask();a.showError({message:a.localize("passwordValidationError")})}}))}},{text:a.localize("nonConsumptiveButton"),hidden:"NONE"==c.getNoPasswordAccess(),handler:function(){e.mask();Ext.Ajax.request({url:a.getTromboneUrl(),params:{corpus:c.getId(),passwordForSessionRemove:!0},method:"POST",callback:function(d,g){e.unmask();e.close();b.unmask();a.dispatchEvent("loadedCorpus",a,c)}})}}]}}}).show();return!1}return!0},
hasQueryToLoad:function(a){a||(a=Ext.Object.fromQueryString(document.location.search));return a.corpus||a.input||this.getCorpusId&&this.getCorpusId()},loadColorPaletteForCorpus:function(a,b){Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"resource.StoredResource",retrieveResourceId:b,corpus:a},success:function(a,d){var e=Ext.util.JSON.decode(a.responseText).storedResource.resource,e=Ext.decode(e);this.addColorPalette(b,e)},failure:function(a){this.setApiParam("palette",void 0)},scope:this})},
listeners:{loadedCorpus:function(a,b){this.setCorpus(b);this.on("unhandledEvent",function(a,d,e){a=this.getBaseUrl()+"?corpus\x3d"+b.getAliasOrId();var f=this.getModifiedApiParams()||{};delete f.view;if("termsClicked"==d)f.query=e;else if("documentsClicked"==d){var g=[];e.forEach&&e.forEach(function(a){g.push(a.getIndex())});f.docIndex=g}else if("corpusTermsClicked"==d)e.map&&(f.query=e.map(function(a){return a.getTerm()}));else if("documentTermsClicked"==d)e.map&&(f.query=e.map(function(a){return a.getTerm()}),
f.docIndex=e.map(function(a){return a.getDocIndex()}));else{console&&console.warn("Unhandled event: "+d,e);return}f.toolFlow&&(d=Ext.Array.from(f.toolFlow.split(",")),f.view=d.shift(),0<d.length?f.toolFlow=d.join(","):delete f.toolFlow);a+="\x26"+Ext.Object.toQueryString(f);this.openUrl(a)})}}});Ext.define("Voyant.panel.DocumentClusters",{extend:"Ext.panel.Panel",alias:"widget.documentclusters",title:"Document Clusters"});Ext.define("Voyant.panel.RezoViz",{extend:"Ext.panel.Panel",alias:"widget.rezoviz",title:"RezoViz"});
...
this.getApiParam("rtl")||"ar"==Voyant.util.Localization.LANGUAGE||"he"==Voyant.util.Localization.LANGUAGE,items:[{xtype:"voyantheader",region:"north"},{region:"south",xtype:"voyantfooter"},{region:"center",layout:"card",itemId:"toolsContainer",activeItem:0,items:[{xtype:"container",layout:{type:"vbox",pack:"center",align:"center"},items:[{xtype:"corpuscreator"},{xtype:"container",width:800,html:"\x3cdiv style\x3d'font-style: italic; text-align: center; margin-top: 10px;'\x3e\x3cdiv\x3e"+this.localize("voyantIs")+
"\x3c/div\x3e"+(-1==this.localize("translatedBy").indexOf("English")?"\x3cdiv\x3e"+this.localize("translatedBy")+"\x3c/div\x3e":"")}]},{layout:"fit",itemId:"toolsContainer-main",items:{xtype:c}}]}]});this.callParent(arguments)}});Ext.define("Voyant.panel.MoreLikeThis",{extend:"Ext.panel.Panel",alias:"widget.morelikethis",title:"More Like this"});
...
{xtype:"trends",collapsible:!0},{xtype:"morelikethis",collapsible:!0}],flex:6}]});this.callParent(arguments)}});Ext.define("Voyant.VoyantNotebookApp",{extend:"Voyant.VoyantApp",requires:["Voyant.panel.VoyantFooter","Voyant.notebook.Notebook","Voyant.data.model.Corpus","Voyant.notebook.util.Show"],name:"VoyantNotebookApp",launch:function(){Ext.create("Ext.container.Viewport",{layout:"border",items:[{xtype:"notebook",region:"center"},{xtype:"voyantfooter",region:"south"}]});this.callParent(arguments)}});Ext.define("Voyant.VoyantToolApp",{extend:"Voyant.VoyantCorpusApp",name:"VoyantToolApp",statics:{api:{minimal:void 0,embeddedApiId:void 0}},launch:function(){var a=[],b=this;this.getApiParam("minimal")||a.push({region:"south",xtype:"voyantfooter"});a.push({region:"center",layout:"fit",itemId:"toolcontainer",items:{xtype:this.getApiParam("embeddedApiId")?"container":this.getTool()},listeners:{afterrender:function(a){if(b.getApiParam("embeddedApiId")){var d=b.getDeferred(this);a.mask(this.localize("loadingConfiguration"));
Ext.Ajax.request({url:b.getTromboneUrl(),params:{tool:"resource.StoredResource",retrieveResourceId:this.getApiParam("embeddedApiId")}}).then(function(e){d.resolve();e=Ext.util.JSON.decode(e.responseText);e=decodeURIComponent(e.storedResource.resource);e=Ext.decode(e);var f=Ext.create({xtype:b.getTool()});f.setApiParams(e);a.unmask();a.remove(a.down("container"));a.add(f);e.corpus&&b.loadCorpusFromParams(e)}).otherwise(function(a){b.getTargetEl&&(Voyant.notebook.util.Show.TARGET=b.getTargetEl(),showError(a));
Voyant.application.showError(a);d.reject()})}},scope:this}});Ext.create("Ext.container.Viewport",{layout:"border",items:a});this.callParent(arguments)}});