...
this.down("chart");if(d&&(d.isChart||d.isCanvas)){var e=d.innerElement.getSize();a=Array.prototype.slice.call(d.items.items);var f=d.surfaceZIndexes,g;for(g=1;g<a.length;g++){var k=a[g];var h=f[k.type];for(d=g-1;0<=d&&f[a[d].type]>h;)a[d+1]=a[d],d--;a[d+1]=k}var l=document.createElement("canvas");f=Ext.getClassName(a[0]);c*=a[0].devicePixelRatio;var m=l.getContext("2d");l.width=Math.ceil(e.width*c);l.height=Math.ceil(e.height*c);for(d=0;d<a.length;d++)if(k=a[d],Ext.getClassName(k)===f)for(e=k.getRect(),
...
"":this.localize("title")+". ")+"\x3ci\x3eVoyant Tools\x3c/i\x3e. Retrieved "+Ext.Date.format(a,"F j, Y")+", from http://voyant-tools.org\x3c/fieldset\x3e",buttons:Ext.Msg.OK,icon:Ext.Msg.INFO})},exportGridCurrentJson:function(a,b){function c(a){var b={};d.forEach(function(c){b[c.text]=a.get(c.dataIndex)});values.push(b)}b=a.getStore();b.getFields();var d=a.getColumnManager().headerCt.getVisibleGridColumns();values=[];b.buffered?b.data.forEach(c):b.each(c);Ext.Msg.show({title:this.localize("exportDataTitle"),
message:this.localize("exportDataJsonMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:Ext.encode(values)})},exportGridCurrentTsv:function(a,b){function c(a){cells=[];e.forEach(function(b){b=a.get(b.dataIndex);Ext.isString(b)&&(b=b.replace(/\s+/g," "));cells.push(b)});f+=cells.join("\t")+"\n"}b=a.getStore();var d=b.getFields(),e=a.getColumnManager().headerCt.getVisibleGridColumns();d=[];e.forEach(function(a){d.push(a.text)});var f=d.join("\t")+"\n";b.buffered?b.data.forEach(c):
b.each(c);Ext.Msg.show({title:this.localize("exportDataTitle"),message:this.localize("exportDataTsvMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:f})},exportGridCurrentHtml:function(a,b){function c(a){d+="\t\t\x3ctr\x3e\n";e.forEach(function(b){b=a.get(b.dataIndex);Ext.isString(b)&&(b=b.replace(/&/g,"\x26amp;").replace(/</g,"\x26lt;").replace(/>/g,"\x26lg;"));d+="\t\t\t\x3ctd\x3e"+b+"\x3c/td\x3e\n"});d+="\t\t\x3c/tr\x3e\n"}b=a.getStore();b.getFields();var d="\x3ctable\x3e\n\t\x3cthead\x3e\n\t\t\x3ctr\x3e\n",
e=a.getColumnManager().headerCt.getVisibleGridColumns();e.forEach(function(a){d+="\t\t\t\x3ctd\x3e"+a.text+"\x3c/td\x3e\n"});d+="\t\t\x3c/tr\x3e\n\t\x3c/thead\x3e\n\t\x3ctbody\x3e\n";b.buffered?b.data.forEach(c):b.each(c);d+="\t\x3c/tbody\x3e\n\x3c/table\x3e";Ext.Msg.show({title:this.localize("exportDataTitle"),message:this.localize("exportDataHtmlMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:d})},exportGridAllJson:function(a,b){Ext.Msg.confirm(this.localize("exportAllTitle"),
...
(g=e[0]);xtype&&c.push({colspan:f,rowspan:g,xtype:xtype})}else Ext.isString(e)&&c.push({xtype:e,colspan:1,rowspan:1})}Ext.apply(this,{layout:{type:"table",width:"100%",height:"100%",columns:a.numCols,tableAttrs:{style:{width:"100%",height:"100%"}},tdAttrs:{style:{padding:"0px",verticalAlign:"top"}}},defaults:{width:10,height:10,border:!0},items:c})}else this.showError("badTableLayoutDefinition");Ext.resumeLayouts()},doTableSizing:function(a,b){var c={},d=this.getTargetEl().down(".x-table-layout"),
...
openMsg:"Paste in Notebook ID, a URL or a Spyral data file (in HTML).",exportHtmlDownload:"HTML (download)"},api:{input:void 0},currentNotebook:void 0,voyantStorageDialogs:void 0,githubDialogs:void 0},config:{notebookId:void 0,metadata:void 0,isEdited:!1,version:"3.0",currentBlock:void 0,storageSolution:"voyant"},constructor:function(a){Voyant.notebook.Notebook.currentNotebook=this;Ext.apply(a,{title:this.localize("title"),autoScroll:!0,includeTools:{help:!0,gear:!0,save:!0,saveIt:{tooltip:this.localize("saveItTip"),
itemId:"saveItTool",xtype:"toolmenu",glyph:"xf0c2@FontAwesome",disabled:!0,scope:this,items:[{text:"Save",xtype:"menuitem",glyph:"xf0c2@FontAwesome",handler:this.showSaveDialog.bind(this,!1),scope:this},{text:"Save As...",xtype:"menuitem",glyph:"xf0c2@FontAwesome",handler:this.showSaveDialog.bind(this,!0),scope:this}]},"new":{tooltip:this.localize("newTip"),callback:function(){this.clear();this.addNew();var a=this.getBaseUrl()+"spyral/";window.history.pushState({url:a},"Spyral Notebook",a)},xtype:"toolmenu",
glyph:"xf067@FontAwesome",scope:this},open:{tooltip:this.localize("openTip"),xtype:"toolmenu",glyph:"xf115@FontAwesome",callback:function(a,c){a=this.getStorageSolution();void 0!==a&&(setTimeout(function(){c.toolMenu.hide()}),"github"===a?this.githubDialogs.showLoad():Ext.Msg.prompt(this.localize("openTitle"),this.localize("openMsg"),function(a,b){b=b.trim();"ok"==a&&(this.clear(),this.loadFromString(b))},this,!0))},scope:this,items:[{text:"Load",xtype:"menuitem",glyph:"xf115@FontAwesome",handler:function(){Ext.Msg.prompt(this.localize("openTitle"),
this.localize("openMsg"),function(a,c){c=c.trim();"ok"==a&&(this.clear(),this.loadFromString(c))},this,!0)},scope:this},{text:"Load from GitHub",xtype:"menuitem",glyph:"xf115@FontAwesome",handler:function(){this.githubDialogs.showLoad()},scope:this}]},runall:{tooltip:this.localize("runallTip"),callback:this.runAll,xtype:"toolmenu",glyph:"xf04e@FontAwesome",scope:this},metadata:{tooltip:this.localize("metadataTip"),callback:this.showMetadataEditor,xtype:"toolmenu",glyph:"xf02c@FontAwesome",scope:this}},
items:[{itemId:"spyralHeader",cls:"spyral-header",listeners:{afterrender:function(a){Ext.tip.QuickTipManager.register({target:a.getId(),text:this.localize("clickToEdit")});a.getTargetEl().on("click",function(b){this.showMetadataEditor();a.removeCls("editable")},this);a.mon(a.getEl(),"mouseover",function(){a.addCls("editable")});a.mon(a.getEl(),"mouseout",function(){a.removeCls("editable")})},scope:this}},{xtype:"container",itemId:"cells"},{itemId:"spyralFooter",cls:"spyral-footer",listeners:{afterrender:function(a){Ext.tip.QuickTipManager.register({target:a.getId(),
text:this.localize("clickToEdit")});a.getTargetEl().on("click",function(b){this.showMetadataEditor();a.removeCls("editable")},this);a.mon(a.getEl(),"mouseover",function(){a.addCls("editable")});a.mon(a.getEl(),"mouseout",function(){a.removeCls("editable")})},scope:this}}],listeners:{afterrender:this.init,notebookWrapperMoveUp:this.notebookWrapperMoveUp,notebookWrapperMoveDown:this.notebookWrapperMoveDown,notebookWrapperRemove:this.notebookWrapperRemove,notebookWrapperAdd:this.notebookWrapperAdd,scope:this}});
this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);window.Corpus=Spyral.Corpus;window.Table=Spyral.Table;window.loadCorpus=function(){return Spyral.Corpus.load.apply(Spyral.Corpus.load,arguments)};window.createTable=function(){return Spyral.Table.create(arguments)};this.voyantStorageDialogs=new Voyant.notebook.StorageDialogs({listeners:{fileLoaded:function(a){},fileSaved:function(a,c){this.unmask();null!==c&&((a=this.getNotebookId())&&c==a||this.setNotebookId(c),
this.toastInfo({html:this.localize("saved"),anchor:"tr"}),this.setIsEdited(!1))},saveCancelled:function(){this.unmask()},scope:this}});this.githubDialogs=new Voyant.notebook.github.GitHubDialogs({listeners:{fileLoaded:function(a,c){a=c.owner;var b=c.repo,e=c.path;c=c.file;this.githubDialogs.close();this.clear();this.loadFromString(c);c=encodeURIComponent(a+"/"+b+"/"+e);-1===location.search.indexOf(c)&&(a=this.getBaseUrl()+"spyral/?githubId\x3d"+c,window.history.pushState({url:a},"Spyral Notebook: "+
c,a))},fileSaved:function(a,c){a=c.owner;var b=c.repo;c=c.path;this.githubDialogs.close();this.unmask();this.toastInfo({html:this.localize("saved"),anchor:"tr"});this.setIsEdited(!1);c=encodeURIComponent(a+"/"+b+"/"+c);-1===location.search.indexOf(c)&&(a=this.getBaseUrl()+"spyral/?githubId\x3d"+c,window.history.pushState({url:a},"Spyral Notebook: "+c,a))},saveCancelled:function(a){this.unmask()},scope:this}})},init:function(){var a=Ext.Object.fromQueryString(document.location.search,!0),b=Ext.isDefined(a.run),
c=/\/spyral\/([\w-]+)\/?$/.exec(location.pathname),d=Ext.isDefined(a.githubId);a.input?0===a.input.indexOf("http")&&this.loadFromUrl(a.input,b):c?(this.loadFromId(c[1]),this.setStorageSolution("voyant")):d?(this.githubDialogs.loadFileFromId(a.githubId),this.setStorageSolution("github")):this.addNew()},getBlock:function(a){a=a||0;var b=this.query("notebookcodeeditorwrapper"),c=this.getCurrentBlock().id,d=b.findIndex(function(a){return a.id==c});if(0>d+a||d+a>b.length-1)Ext.Msg.show({title:this.localize("error"),
msg:this.localize("blockDoesNotExist"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR});else return content=b[d+a].getContent(),content.input},addNew:function(){this.setMetadata(new Spyral.Metadata({title:"\x3ch1\x3eSpyral Notebook\x3c/h1\x3e"}));this.addText("\x3cp\x3eThis is a Spyral Notebook, a dynamic document that combines writing, code and data in service of reading, analyzing and interpreting digital texts.\x3c/p\x3e\x3cp\x3eSpyral Notebooks are composed of text blocks (like this one) and code blocks (like the one below). You can \x3cspan class\x3d'marker'\x3eclick on the blocks to edit\x3c/span\x3e them and add new blocks by clicking add icon that appears in the left column when hovering over a block.\x3c/p\x3e");
