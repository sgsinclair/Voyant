...
{xtype:"fieldset",title:"\x3ca href\x3d'"+a.getBaseUrl()+"docs/#!/guide/corpuscreator-section-tables' target\x3d'voyantdocs'\x3e"+a.localize("tableOptions")+"\x3c/a\x3e",collapsible:!0,collapsed:!0,defaultType:"textfield",items:[{xtype:"container",html:"\x3cp\x3e\x3ci\x3e"+(new Ext.Template(a.localize("tableOptionsText"))).applyTemplate([a.getBaseUrl()+"docs/#!/guide/corpuscreator-section-tables"])+"\x3c/i\x3e\x3c/p\x3e",width:375},{xtype:"combo",fieldLabel:a.localize("tableDocuments"),name:"tableDocuments",
...
width:375},{fieldLabel:a.localize("tableContent"),validator:function(b){return a.validatePositiveNumbersCsv.call(a,b)},name:"tableContent"},{xtype:"container",html:"\x3cp\x3e\x3ci\x3e"+a.localize("tableMetadataText")+"\x3c/i\x3e\x3c/p\x3e",width:375},{fieldLabel:a.localize("tableAuthor"),validator:function(b){return a.validatePositiveNumbersCsv.call(a,b)},name:"tableAuthor"},{fieldLabel:a.localize("tableTitle"),validator:function(b){return a.validatePositiveNumbersCsv.call(a,b)},name:"tableTitle"}]},
