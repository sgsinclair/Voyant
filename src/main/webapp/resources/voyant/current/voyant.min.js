...
Ext.define("Voyant.data.store.CorpusTerms",{extend:"Ext.data.Store",mixins:["Voyant.data.store.CorpusTermsMixin"],constructor:function(a){a=a||{};this.mixins["Voyant.data.store.CorpusTermsMixin"].constructor.apply(this,[a]);this.callParent([a])}});Ext.define("Voyant.data.store.CorpusTermsBuffered",{extend:"Ext.data.BufferedStore",mixins:["Voyant.data.store.CorpusTermsMixin"],constructor:function(a){a=a||{};this.mixins["Voyant.data.store.CorpusTermsMixin"].constructor.apply(this,[a]);this.callParent([a])}});Ext.define("Voyant.data.store.DocumentQueryMatchesMixin",{mixins:["Voyant.data.store.VoyantStore"],model:"Voyant.data.model.CorpusTerm",constructor:function(a){this.mixins["Voyant.data.store.VoyantStore"].constructor.apply(this,[a,{"proxy.extraParams.tool":"corpus.DocumentsFinder","proxy.reader.rootProperty":"documentsFinder.queries","proxy.reader.totalProperty":void 0}])}});
...
config:{tokenType:"lexical",inDocumentsCountOnly:void 0},triggers:{help:{weight:2,cls:"fa-trigger form-fa-help-trigger",handler:"onHelpClick",scope:"this"}},constructor:function(a){a=a||{};Ext.applyIf(a,{minWidth:100,matchFieldWidth:!1,displayField:"term",valueField:"term",filterPickList:!0,createNewOnEnter:!0,createNewOnBlur:!1,tpl:Ext.create("Ext.XTemplate",'\x3cul class\x3d"x-list-plain"\x3e\x3ctpl for\x3d"."\x3e','\x3cli role\x3d"option" class\x3d"x-boundlist-item" style\x3d"white-space: nowrap;"\x3e{term} ({rawFreq})\x3c/li\x3e',
"\x3c/tpl\x3e\x3c/ul\x3e")});this.callParent(arguments)},initComponent:function(a){var b=this;b.on("beforequery",function(a){if(a.query){a.query=a.query.trim();"^"==a.query.charAt(0)&&(a.query=a.query.substring(1),a.cancel=0==a.query.length);"*"==a.query.charAt(a.query.length-1)&&(a.query=a.query.substring(0,a.query.length-1),a.cancel=0==a.query.length);try{new RegExp(a.query)}catch(b){a.cancel=!0}-1<a.query.indexOf('"')&&(-1==a.query.indexOf(" ")&&(a.cancel=!0),2!=(a.query.match(/"/)||[]).length&&
(a.cancel=!0));a.query=a.query+"*,^"+a.query+"*"}},b);b.on("change",function(a,d){b.up("panel").fireEvent("query",b,d)});b.up("panel").on("loadedCorpus",function(a,d){var e=void 0;if(this.getApiParam)e=this.getApiParam("stopList");else{var f=this.up("panel");f&&f.getApiParam&&(e=f.getApiParam("stopList"))}b.setStore(d.getCorpusTerms({corpus:d,proxy:{extraParams:{limit:10,tokenType:b.tokenType,inDocumentsCountOnly:b.inDocumentsCountOnly,stopList:e}}}))});b.on("afterrender",function(a){a.triggers&&
a.triggers.help&&Ext.QuickTips.register({target:a.triggers.help.getEl(),text:a.localize("querySearchTip"),enabled:!0,showDelay:20,trackMouse:!0,autoShow:!0});this.suggest=Ext.create("Ext.tip.ToolTip",{target:this.inputEl,autoShow:!1,hidden:!0,html:""})});b.callParent(arguments)}});Ext.define("Voyant.widget.TotalPropertyStatus",{extend:"Ext.Component",mixins:["Voyant.util.Localization"],alias:"widget.totalpropertystatus",statics:{i18n:{totalPropertyStatus:{en:'{count:number("0,000")}'}}},initComponent:function(){Ext.applyIf(this,{tpl:this.localize("totalPropertyStatus"),itemId:"totalpropertystatus",style:"margin-right:5px",listeners:{afterrender:function(a){var b=a.up("grid");if(b){var c=b.getStore();a.updateStatus(c.getTotalCount());b.getStore().on("totalcountchange",a.updateStatus,
...
Ext.isString(c)&&(c=c.split(","));var d=this.queryById("facets");c.forEach(function(c){var g=a.localize(c+"Title");g=="["+c+"Title]"&&(g=c.replace(/^facet\./,"").replace(/^extra./,""));var h=d.add({title:g,facet:c,columns:[{renderer:function(a,b,c){return'\x3cspan style\x3d"font-size: smaller;"\x3e(\x3cspan class\x3d"info-tip" data-qtip\x3d"'+e.localize("matchingDocuments")+'"\x3e'+c.getInDocumentsCount()+"\x3c/span\x3e) \x3c/span\x3e"+c.getLabel()},flex:1}],bbar:[{xtype:"querysearchfield",tokenType:c.replace("facet.",
""),inDocumentsCountOnly:!0}]});h.getSelectionModel().on("selectionchange",function(d,e){var g=[];e.forEach(function(a){g.push({facet:a.getFacet(),label:a.getLabel()})});a.getFacets()[c]=g;a.updateResults()});h.on("query",function(c,d){a.getFacets()[h.facet]=[];a.updateResults()})});var e=this;d.add({title:a.localize("lexicalTitle"),store:Ext.create("Voyant.data.store.CorpusTerms",{parentPanel:this}),facet:"lexical",columns:[{renderer:function(a,b,c){return'\x3cspan style\x3d"font-size: smaller;"\x3e(\x3cspan class\x3d"info-tip" data-qtip\x3d"'+
e.localize("matchingDocuments")+'"\x3e'+c.getInDocumentsCount()+"\x3c/span\x3e) \x3c/span\x3e"+c.getTerm()+'\x3cspan style\x3d"font-size: smaller;"\x3e (\x3cspan class\x3d"info-tip" data-qtip\x3d"'+e.localize("rawFreqs")+'"\x3e'+c.getRawFreq()+"\x3c/span\x3e)\x3c/span\x3e"},flex:1}],bbar:[{xtype:"querysearchfield"}]}).getSelectionModel().on("selectionchange",function(c,d){var e=[];d.forEach(function(a){e.push({facet:"lexical",label:a.getTerm()})});a.getFacets().lexical=e;a.updateResults()})})},updateResults:function(a){var b=
