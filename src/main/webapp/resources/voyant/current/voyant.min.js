...
Ext.define("Voyant.data.store.Tokens",{extend:"Ext.data.Store",mixins:["Voyant.data.store.TokensMixin"],constructor:function(a){a=a||{};this.mixins["Voyant.data.store.TokensMixin"].constructor.apply(this,[a]);this.callParent([a])}});Ext.define("Voyant.data.store.TokensBuffered",{extend:"Ext.data.BufferedStore",mixins:["Voyant.data.store.TokensMixin"],constructor:function(a){a=a||{};this.mixins["Voyant.data.store.TokensMixin"].constructor.apply(this,[a]);this.callParent([a])}});Ext.define("Voyant.data.table.Table",{alternateClassName:["VoyantTable"],mixins:["Voyant.notebook.util.Embed","Voyant.notebook.util.Show"],embeddable:["Voyant.widget.VoyantChart"],config:{rows:[],headers:[],rowKey:void 0,model:void 0},constructor:function(a){a=a||{};this.rows=Ext.Array.from(Ext.isArray(a)?a:a.rows);this.setHeaders(Ext.Array.from(a.headers));this.rowKey=a.rowKey;if(a.count){var b={};a.count.forEach(function(a){b[a]=b[a]?b[a]+1:1});var c=[],d;for(d in b)c.push([d,b[d]]);c.sort(function(a,
b){return b[1]-a[1]});this.setHeaders(c.map(function(a){return a[0]}));this.rows=[c.map(function(a){return a[1]})]}a.isStore&&(this.model=a.getModel(),0<a.getCount()&&this.setHeaders(Object.keys(a.getAt(0).data)),a.each(function(a){this.addRow(a.data)},this));this.callParent()},addRow:function(a){Ext.isObject(a)?this.rows.push(this.getHeaders().map(function(b){return a[b]})):Ext.isArray(a)&&this.rows.push(a)},eachRecord:function(a,b){for(var c,d=0,e=this.rows.length;d<e&&(c=this.getRecord(d),!1!==
a.call(b||c,c,d,e));d++);},eachRow:function(a,b,c){for(var d,e=0,f=this.rows.length;e<f&&(d=this.getRow(e,b),!1!==a.call(c||d,d,e,f));e++);},getRow:function(a,b){if(b){var c={},d=this.getHeaders();Ext.Array.from(this.rows[a]).forEach(function(a,b){c[d[b]||b]=a},this);return c}return this.rows[a]},getRecord:function(a){if(this.model)return new this.model(this.getRow(a,!0))},mapRows:function(a,b,c){var d=[];this.eachRow(function(b,f){d.push(a.call(c||this,b,f))},b,this);return d},updateCell:function(a,
b,c,d){void 0===this.rows[a]&&(this.rows[a]=[]);this.rows[a][b]=void 0===this.rows[a][b]||d?c:this.rows[a][b]+c},embed:function(a,b){if((Ext.isObject(a)||!a)&&!b){b=a;var c=Ext.id(),d={id:c};Ext.isObject(a)&&Ext.apply(d,a);d=this.getString(d);show(d);d=new Ext.ux.grid.TransformGrid(c,{remove:!1,width:"100%"});document.getElementById(c).outerHTML="\x3cdiv id\x3d'"+c+"'\x3e\x3c/div\x3e";d.render(Ext.get(c));return this}b=b||{};chart={};debugger;var e=this.mapRows(function(a,b){return void 0===this.rowKey?
Ext.apply(a,{"row-index":b}):a},!0,this),d=this.getHeaders(),c=Ext.Array.merge(void 0===this.rowKey?["row-index"]:[],d);if(0==d.length)for(var f=Ext.Array.max(this.mapRows(function(a){return a?a.length:0})),d=0;d<f;d++)c.push(c.length);Ext.apply(chart,{store:{fields:c,data:e}});if(b.axes){Ext.apply(chart,{axes:b.axes});var g=["left","bottom"];chart.axes.forEach(function(a,b){Ext.applyIf(a,{type:"numeric",position:g[b]})});delete b.axes}else Ext.apply(chart,{axes:[{type:"numeric",position:"left"},
{type:"category",position:"bottom"}]});if(b.series)Ext.apply(chart,{series:b.series}),chart.series.forEach(function(a,b){Ext.applyIf(a,{type:"line",xField:void 0===this.rowKey?"row-index":this.rowKey,yField:b})}),delete b.series;else{e=[];d=0;for(c=c.length;d<c;d++)d===this.rowKey||void 0==this.rowKey&&d+1==c||e.push({type:"line",xField:void 0===this.rowKey?"row-index":this.rowKey,yField:d});Ext.apply(chart,{series:e})}b.title&&(chart.title=b.title);Ext.apply(b,{chartJson:JSON.stringify(chart)});
embed.call(this,a,b)},getString:function(a){a=a||{};var b="\x3ctable class\x3d'voyant-table' style\x3d'"+(a.width?" width: "+a.width:"")+"' id\x3d'"+(a.id?a.id:Ext.id())+"'\x3e";a=this.getHeaders();if(a.length){for(var b=b+"\x3cthead\x3e\x3ctr\x3e",c=0,d=a.length;c<d;c++)b+="\x3cth\x3e"+a[c]+"\x3c/th\x3e";b+="\x3c/tr\x3e\x3c/thead\x3e"}b+="\x3ctbody\x3e";c=0;for(d=this.rows.length;c<d;c++)b+="\x3ctr\x3e",this.getRow(c).forEach(function(a){b+="\x3ctd\x3e"+a+"\x3c/td\x3e"}),b+="\x3c/tr\x3e";return b+=
"\x3c/tbody\x3e\x3c/table\x3e"}});
Ext.define("Ext.ux.grid.TransformGrid",{extend:"Ext.grid.Panel",constructor:function(a,b){b=Ext.apply({},b);a=this.table=Ext.get(a);for(var c=b.fields||[],d=b.columns||[],e=[],f=[],g=a.query("thead th"),h=0,k=g.length,l=a.dom,m,n,q,s;h<k;++h)n=g[h],q=n.innerHTML,s="tcol-"+h,e.push(Ext.applyIf(c[h]||{},{name:s,mapping:"td:nth("+(h+1)+")/@innerHTML"})),f.push(Ext.applyIf(d[h]||{},{text:q,dataIndex:s,width:n.offsetWidth,tooltip:n.title,sortable:!0}));c=b.width?b.width:a.getWidth()+1;b.height&&(m=b.height);
Ext.applyIf(b,{store:{data:l,fields:e,proxy:{type:"memory",reader:{record:"tbody tr",type:"xml"}}},columns:f,width:c,height:m});this.callParent([b]);!1!==b.remove&&l.parentNode.removeChild(l)},doDestroy:function(){this.table.remove();this.tabl=null;this.callParent()}});Ext.define("Voyant.data.table.CorpusTerms",{extend:"Voyant.data.table.Table",eachCorpusTerm:function(){this.eachRecord.apply(this,arguments)}});Ext.define("Voyant.data.model.Corpus",{alternateClassName:["Corpus"],mixins:["Voyant.notebook.util.Embed","Voyant.notebook.util.Show","Voyant.util.Transferable","Voyant.util.Localization","Voyant.util.Assignable"],transferable:["loadCorpusTerms","loadTokens","getPlainText","getText","getWords"],embeddable:"Voyant.panel.Summary Voyant.panel.Cirrus Voyant.panel.Documents Voyant.panel.CorpusTerms Voyant.panel.Reader Voyant.panel.Trends Voyant.panel.TermsRadio Voyant.panel.DocumentTerms Voyant.panel.TermsBerry Voyant.panel.CollocatesGraph Voyant.panel.Contexts Voyant.panel.WordTree".split(" "),
...
a[b],d=this.findNewRelativeSize(c);c.fontSize=d>this.getMinFontSize()?d:this.getMinFontSize()}},setRelativeSizes:function(){var a=this.getTerms();if(void 0!==a)for(var b=0;b<a.length;b++){var c=a[b];c.relativeSize=this.map(c.rawFreq,this.getSmallestWordSize(),this.getLargestWordSize(),.1,1)}},findNewRelativeSize:function(a){var b=this.getSizeAdjustment(),b=this.calculateWordArea(a)*b;return(Math.sqrt(6)*Math.sqrt(6*Math.pow(a.text.length,2)+b*a.text.length)-6*a.text.length)/(2*a.text.length)}});Ext.define("Voyant.panel.CollocatesGraph",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.collocatesgraph",statics:{i18n:{},api:{query:void 0,mode:void 0,limit:5,stopList:"auto",terms:void 0,context:5},glyph:"xf1e0@FontAwesome"},config:{node:void 0,link:void 0,nodeDataSet:void 0,edgeDataSet:void 0,network:void 0,contextMenu:void 0,force:void 0,graphHeight:void 0,graphWidth:void 0,corpusColours:d3.scale.category10(),graphMode:void 0,stabilizationTask:void 0},DEFAULT_MODE:0,CENTRALIZED_MODE:1,
nodeOptions:{defaultNode:{shape:"box",color:{border:"rgba(0,0,0,0.1)",background:"rgba(255,255,255,1)"},scaling:{label:{min:10,max:30,maxVisible:50,drawThreshold:6}}},centralizedNode:{shape:"text",scaling:{label:{min:6,max:30,maxVisible:50,drawThreshold:1}}}},edgeOptions:{defaultEdge:{color:{color:"rgba(0,0,0,0.1)",highlight:"black",hover:"red"},labelHighlightBold:!1,scaling:{min:1,max:15},length:void 0},centralizedEdge:{scaling:{min:1,max:1},length:150}},highlightOptions:{font:{color:"white"},color:{background:"black",
hover:{border:"#CB157F",background:"#EB42A5"}}},physicsOptions:{defaultPhysics:{barnesHut:{gravitationalConstant:-1500,centralGravity:6,damping:.5,avoidOverlap:.5,springConstant:.04}},centralizedPhysics:{barnesHut:{gravitationalConstant:-1500,centralGravity:1,damping:1,avoidOverlap:.01,springConstant:.2}}},stablizationMaxTime:5E3,keywordColor:"green",contextColor:"maroon",constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.setNodeDataSet(new vis.DataSet);
this.setEdgeDataSet(new vis.DataSet);this.setGraphMode(this.DEFAULT_MODE);this.setStabilizationTask(Ext.TaskManager.newTask({run:function(){this.getNetwork().stopSimulation()},scope:this,interval:this.stablizationMaxTime,repeat:1,fireOnStart:!1}))},initComponent:function(){var a=this;Ext.apply(a,{title:this.localize("title"),dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"querysearchfield"},{text:a.localize("clearTerms"),glyph:"xf014@FontAwesome",handler:function(){this.getNodeDataSet().clear();
this.getEdgeDataSet().clear();this.setGraphMode(this.DEFAULT_MODE)},scope:a},this.localize("context"),{xtype:"slider",itemId:"contextSlider",minValue:3,value:5,maxValue:30,increment:2,width:50,listeners:{render:function(b){b.setValue(a.getApiParam("context"))},changecomplete:{fn:function(a,c){this.setApiParam("context",a.getValue());if(this.getGraphMode()===this.DEFAULT_MODE){var d=this.getNodeDataSet().map(function(a){return a.label});0<d.length&&(this.getNodeDataSet().clear(),this.loadFromQuery(d))}},
scope:a}}}]}]});this.setContextMenu(Ext.create("Ext.menu.Menu",{renderTo:Ext.getBody(),items:[{text:"",itemId:"label",disabled:!0},{xtype:"menuseparator"},{xtype:"menucheckitem",text:"Fixed",itemId:"fixed",listeners:{checkchange:function(a,c,d){a=this.getNetwork().getSelectedNodes();null!=a[0]&&this.getNodeDataSet().update({id:a[0],fixed:c})},scope:this}},{xtype:"button",text:"Fetch Collocates",style:"margin: 5px;",handler:function(a,c){var d=this.getNetwork().getSelectedNodes();null!=d[0]&&(d=this.getNodeDataSet().get(d[0]),
this.itemdblclick(d))},scope:this},{xtype:"button",text:"Centralize",style:"margin: 5px;",handler:function(a,c){var d=this.getNetwork().getSelectedNodes();null!=d[0]&&(this.doCentralize(d[0]),this.getContextMenu().hide())},scope:this},{xtype:"button",text:"Remove",style:"margin: 5px;",handler:function(a,c){var d=this.getNetwork().getSelectedNodes();null!=d[0]&&(this.getNodeDataSet().remove(d[0]),a.up("menu").hide(),this.forceUpdate())},scope:this}]}));this.on("loadedCorpus",function(a,c){this.isVisible()&&
this.initLoad()},this);this.on("activate",function(){this.getCorpus()&&Ext.Function.defer(this.initLoad,100,this)},this);this.on("query",function(a,c){this.loadFromQuery(c)},this);this.on("resize",function(a,c,d){a=this.getLayout().getRenderTarget();c=this.getDockedItems();for(var e=0,f=0;f<c.length;f++)e+=c[f].getHeight();a.setHeight(d-e);a.setWidth(a.getWidth());this.setGraphHeight(a.getHeight());this.setGraphWidth(a.getWidth())},this);a.callParent(arguments)},initLoad:function(){this.getCorpus()&&
...
scope:this})},this)},loadFromCorpusTermRecords:function(a){if(Ext.isArray(a)&&0<a.length){var b=[];a.forEach(function(a){b.push(a.getTerm())});this.loadFromQuery(b)}},loadFromCorpusCollocateRecords:function(a,b){if(Ext.isArray(a)){var c=this.getApiParam("limit"),d=this.getNodeDataSet(),e=this.getEdgeDataSet(),f={};d.forEach(function(a){f[a.id]=!0});var g=[],h=[];a.forEach(function(a,l){var m=a.getTerm(),n=a.getContextTerm(),q=a.getKeywordRawFreq(),s=a.getContextTermRawFreq(),p=q,r=s;this.getGraphMode()===
this.CENTRALIZED_MODE&&(p=0,r=Math.log(s));0==l&&(void 0===b&&(b=m),void 0!==f[b]?d.update({id:b,value:p,title:m+" ("+q+")",type:"keyword",font:{color:this.keywordColor}}):(f[b]=!0,g.push({id:m,label:m,title:m+" ("+q+")",type:"keyword",value:p,start:c,font:{color:this.keywordColor}})));if(m!=n){void 0===f[n]&&(f[n]=!0,g.push({id:n,label:n,title:n+" ("+s+")",type:"context",value:r,start:0,font:{color:this.contextColor}}));var w=null;e.forEach(function(a){if(a.from==b&&a.to==n||a.from==n&&a.to==b)w=
a});m=a.getContextTermRawFreq();null===w?h.push({from:b,to:n,value:m}):w.value<m&&e.update({id:w.id,value:m})}},this);d.add(g);e.add(h);this.forceUpdate();this.getNetwork().fit()}},doCentralize:function(a){a=this.getNodeDataSet().get(a);a.fixed=!0;a.shape="circle";a.scaling={min:75,max:75,label:{min:75,max:75}};this.getNodeDataSet().clear();this.getEdgeDataSet().clear();this.getNodeDataSet().add(a);this.setGraphMode(this.CENTRALIZED_MODE);var b=this.getApiParam("limit");this.setApiParam("limit",150);
this.itemdblclick(a);this.setApiParam("limit",b)},applyGraphMode:function(a){a=void 0===a?this.DEFAULT_MODE:a;var b=this.getNetwork();void 0!==b&&(a===this.DEFAULT_MODE?b.setOptions({physics:this.physicsOptions.defaultPhysics,nodes:this.nodeOptions.defaultNode,edges:this.edgeOptions.defaultEdge}):a===this.CENTRALIZED_MODE&&b.setOptions({physics:this.physicsOptions.centralizedPhysics,nodes:this.nodeOptions.centralizedNode,edges:this.edgeOptions.centralizedEdge}));return a},initGraph:function(){var a=
this.getLayout().getRenderTarget();a.setWidth(a.getWidth());a.setHeight(a.getHeight());this.setGraphHeight(a.getHeight());this.setGraphWidth(a.getWidth());void 0===this.getNetwork()&&(a=new vis.Network(a.dom,{nodes:this.getNodeDataSet(),edges:this.getEdgeDataSet()},{autoResize:!0,interaction:{hover:!0,hoverConnectedEdges:!0,multiselect:!1}}),this.setNetwork(a),this.setGraphMode(),this.getNodeDataSet().on("remove",function(a,c,d){var e=c.items[0];a=this.getEdgeDataSet().get({filter:function(a){return a.from==
e||a.to==e}});this.getEdgeDataSet().remove(a);var f=[];this.getNodeDataSet().forEach(function(a){0==this.getEdgeDataSet().get({filter:function(b){return b.from==a.id||b.to==a.id}}).length&&f.push(a.id)}.bind(this));this.getNodeDataSet().remove(f)}.bind(this)),a.on("dragStart",function(a){a=a.nodes[0];null!=a&&this.getNodeDataSet().update({id:a,fixed:!1})}.bind(this)),a.on("dragging",function(a){null!=a.nodes[0]&&(this.isMasked()?this.isOffCanvas(a.pointer.DOM)||this.unmask():this.isOffCanvas(a.pointer.DOM)&&
this.mask(this.localize("releaseToRemove")))}.bind(this)),a.on("dragEnd",function(a){var c=a.nodes[0];null!=c&&(this.isOffCanvas(a.pointer.DOM)?(this.unmask(),this.mask("cleaning"),this.getNodeDataSet().remove(c),this.forceUpdate(),this.unmask()):this.getNodeDataSet().update({id:c,fixed:!0}))}.bind(this)),a.on("click",function(a){this.getContextMenu().hide();if(a){var c=this.getNodeDataSet();a.nodes&&0<a.nodes.length?this.dispatchEvent("termsClicked",this,[c.get(a.nodes[0]).label]):a.edges&&0<a.edges.length&&
(a=this.getEdgeDataSet().get(a.edges[0]),this.dispatchEvent("termsClicked",this,['"'+c.get(a.from).label+" "+c.get(a.to).label+'"~'+this.getApiParam("context")]))}}.bind(this)),a.on("doubleClick",function(a){a=a.nodes[0];null!=a&&(a=this.getNodeDataSet().get(a),this.itemdblclick(a))}.bind(this)),a.on("oncontext",function(a){a.event.preventDefault();var c=this.getNetwork().getNodeAt(a.pointer.DOM);if(null!=c){this.getNetwork().selectNodes([c]);var c=this.getNodeDataSet().get(c),d=this.getContextMenu();
d.queryById("label").setText(c.label);d.queryById("fixed").setChecked(c.fixed);d.showAt(a.event.pageX,a.event.pageY)}}.bind(this)),a.on("startStabilizing",function(){this.getStabilizationTask().restart()}.bind(this)),a.on("stabilized",function(){this.getStabilizationTask().stop();this.getNetwork().fit({animation:{duration:500,easing:"linear"}})}.bind(this)),a.on("resize",function(a){this.getNetwork().fit({animation:{duration:500,easing:"linear"}})}.bind(this)))},forceUpdate:function(){var a=this.getNodeDataSet().map(function(a){return{id:a.id}});
this.getNodeDataSet().update(a);a=this.getEdgeDataSet().map(function(a){return{id:a.id}});this.getEdgeDataSet().update(a)},isOffCanvas:function(a){return 0>a.x||0>a.y||a.x>this.getGraphWidth()||a.y>this.getGraphHeight()},itemdblclick:function(a){var b=this.getApiParam("limit");this.getCorpus().getCorpusCollocates({autoLoad:!1}).load({params:Ext.apply(this.getApiParams(),{query:a.id,start:a.start,limit:b}),callback:function(c,d,e){e&&(this.getNodeDataSet().update({id:a.id,start:a.start+b}),this.loadFromCorpusCollocateRecords(c,
...
height:f.getHeight()},"dickinson",a,e,"#"+f.getId());b.Start()}.bind(b))}});Ext.define("Voyant.panel.TermsBerry",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.termsberry",statics:{i18n:{},api:{stopList:"auto",context:5,numInitialTerms:75,query:void 0,docIndex:void 0,docId:void 0},glyph:"xf201@FontAwesome"},config:{options:[{xtype:"stoplistoption"}],mode:void 0,collocatesLimit:1E6,scalingFactor:3,minRawFreq:void 0,maxRawFreq:void 0,maxCollocateValue:void 0,minFillValue:void 0,maxFillValue:void 0,currentData:{},visLayout:void 0,vis:void 0,visInfo:void 0,
visId:void 0,tip:void 0},MODE_TOP:"top",MODE_DISTINCT:"distinct",MIN_TERMS:5,MAX_TERMS:500,MIN_SCALING:1,MAX_SCALING:5,MIN_STROKE_OPACITY:.1,MAX_STROKE_OPACITY:.3,layout:"fit",constructor:function(a){this.setMode(this.MODE_TOP);this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.setVisId(Ext.id(null,"termspack_"))},initComponent:function(){Ext.apply(this,{title:this.localize("title"),dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",
items:[{xtype:"button",text:this.localize("strategy"),menu:{items:[{xtype:"menucheckitem",group:"strategy",checked:this.getMode()===this.MODE_TOP,text:this.localize("topTerms"),checkHandler:function(a,b){b&&(this.setMode(this.MODE_TOP),this.doLoad())},scope:this},{xtype:"menucheckitem",group:"strategy",checked:this.getMode()===this.MODE_DISTINCT,text:this.localize("distinctTerms"),checkHandler:function(a,b){b&&(this.setMode(this.MODE_DISTINCT),this.doLoad())},scope:this}]}},{fieldLabel:this.localize("numTerms"),
...
function(a){return a.r});var b=this,c=d3.scale.pow().exponent(1/3).domain([0,this.getMaxCollocateValue()]).range(["#fff","#bd3163"]),d;d=this.getMode()===this.MODE_DISTINCT?d3.scale.pow().exponent(1/3).domain([this.getMinFillValue(),this.getMaxFillValue()]).range(["#fff","#eee"]):d3.scale.linear().domain([this.getMinFillValue(),this.getMaxFillValue()]).range(["#fff","#eee"]);var e=this.getVisLayout().size(),e=Math.min(e[0],e[1])/2,e=Math.sqrt(Math.PI*e*e/(a[0].length-1)/Math.PI)/3,f=Math.abs(this.getScalingFactor()-
...
d3.select(this).select("circle").style("fill","#89e1c2").style("stroke","#26926c").style("stroke-opacity",b.MAX_STROKE_OPACITY);var f="\x3cb\x3e"+a.term+"\x3c/b\x3e ("+a.rawFreq+")\x3cbr/\x3e"+a.fillValue,g=b.getTip();g.update(f);g.show();for(e=0;e<a.collocates.length;e++){var n=a.collocates[e],f=b.getVis().selectAll(".node").filter(function(a){return a.term===n.term});f.select("circle").style("fill",function(a){return c(n.value)}).style("stroke","#bd3163").style("stroke-opacity",b.MAX_STROKE_OPACITY);
f.select("tspan.value").text(function(a){return n.value})}}).on("mousemove",function(){var a=Ext.get(b.getVisId()).dom,a=d3.mouse(a);a[1]+=20;b.getTip().setPosition(a)}).on("mouseout",function(){b.getVis().selectAll("circle").style("stroke-opacity",b.MIN_STROKE_OPACITY).style("stroke","#111").style("fill",function(a){return d(a.fillValue)});b.getVis().selectAll("tspan.value").text("");b.getTip().hide()});e.append("circle").attr("id",function(a){return a.term.replace(/\W/g,"_")}).attr("r",function(a){return a.r}).style("fill",
function(a){return d(a.fillValue)}).style("stroke","#111").style("stroke-opacity",b.MIN_STROKE_OPACITY).style("stroke-width",1);e.append("clipPath").attr("id",function(a){return"clip-"+a.term.replace(/\W/g,"_")}).append("use").attr("xlink:href",function(a){return"#"+a.term.replace(/\W/g,"_")});e=e.append("text").attr("clip-path",function(a){return"url(#clip-"+a.term.replace(/\W/g,"_")+")"}).style("text-anchor","middle").style("cursor","default");e.append("tspan").attr("class","term").style("font-size",
function(a){return g(a.rawFreq)}).attr("x",0).attr("y",function(a){return g(a.rawFreq)/4}).text(function(a){return a.term});e.append("tspan").attr("class","value").style("font-size",function(a){return.75*g(a.rawFreq)}).attr("x",0).attr("y",function(a){return g(a.rawFreq)+1});a.exit().remove()},initVisLayout:function(){var a=this.getLayout().getRenderTarget();a.update("");var b=a.getWidth(),c=a.getHeight(),d=this;this.setVisLayout(d3.layout.pack().sort(function(a,b){return a.rawFreq<b.rawFreq?1:a.rawFreq>
b.rawFreq?-1:0}).value(function(a){return Math.pow(a.rawFreq,1/d.getScalingFactor())}).size([b,c]).padding(1.5));a=d3.select(a.dom).append("svg").attr("id",this.getVisId()).attr("width",b).attr("height",c);this.setVis(a.append("g"));this.setVisInfo(a.append("text").attr("x",10).attr("y",10));void 0===this.getTip()&&this.setTip(Ext.create("Ext.tip.Tip",{}))}});Ext.define("Voyant.panel.TermsRadio",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.termsradio",config:{options:[{xtype:"stoplistoption"}],speed:50},statics:{i18n:{},api:{withDistributions:!0,bins:10,visibleBins:5,docIdType:null,limit:50,mode:null,position:0,selectedWords:[],stopList:"auto",query:null,yAxisScale:"log",speed:50},glyph:"xf201@FontAwesome"},absMaxFreq:0,absMinFreq:0,allData:[],chart:null,theme:Ext.create("Ext.chart.theme.Base"),colorIndex:[],colorMasterList:[],
...
d=this.absMinFreq,e=0,f=this.allData.length;e<f;e++){for(var g=foundB=0,h=this.allData[e].allDataInternal.length;g<h;g++)for(var k=0,l=this.allData[e].allDataInternal[g].frequencyArray.length;k<l;k++)if(this.allData[e].allDataInternal[g].frequencyArray[k].wordString===a){var m=this.allData[e].allDataInternal[g].frequencyArray[k].freq;b.push({x:e,y:m});m<c&&(c=m);m>d&&(d=m);foundB=1}0===foundB&&(g=this.minFreq,b.push({x:e,y:g}),g<c&&(c=g),g>d&&(d=g))}return{path:b,min:c,max:d}},updateFullPath:function(){for(var a=
