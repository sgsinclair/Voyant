...
calculateNodeSizes:function(a){var b=this.getTempNodes().data(a,function(a){return a.id}),c=function(b){var c=2*Math.min(1,a.length/this.MAX_TERMS)+1;b=this.getFrequencyScale()(b);return d3.scalePow().exponent(c).domain([0,1]).range([this.getMinFontSize(),this.getMaxFontSize()])(b)}.bind(this);b.enter().append("text").attr("fill-opacity",0).attr("font-family",function(a){return"Arial"}).attr("font-size",function(a){var b=c(a.value);return a.fontSize=b}).text(function(a){return a.term}).each(function(a){var b=
this.getBBox();a.bbox={};a.bbox.x=b.x;a.bbox.y=b.y;a.bbox.width=b.width;a.bbox.height=b.height}).remove()},runSimulation:function(a){this.setIsSimulating(!0);var b=this.getLayout().getRenderTarget(),c=b.getWidth(),b=b.getHeight();window.console&&console.time("runSim");this.getWebWorker().postMessage({terms:a,width:c,height:b,minFreq:this.getMinFreq(),maxFreq:this.getMaxFreq(),xForceStrength:this.getXForceStrength(),yForceStrength:this.getYForceStrength(),chargeDistance:this.getChargeDistance(),chargeStrength:this.getChargeStrength(),
letterDistribution:this.getLetterDistribution()})},handleWebWorkerMessage:function(a){switch(a.data.type){case "progress":a=parseInt(100*a.data.progress);this.getDockedItems()[1].getComponent("status").update(a+"%");break;case "msg":window.console&&console.log(a.data.msg);break;case "end":window.console&&console.timeEnd("runSim"),this.getDockedItems()[1].getComponent("status").update(""),this.setIsSimulating(!1),this.getSegmentTermsQueue().push(a.data.nodes)}},updateNodePositions:function(){if(this.getIsTransitioning())Ext.Function.defer(this.updateNodePositions,
100,this);else{this.setIsTransitioning(!0);var a=this.getSegmentTermsQueue().shift();0==this.getSegmentTermsQueue().length&&this.getNextSegment();a=this.getNodes().data(a,function(a){return a.id});a.transition().duration(this.getTransitionTime()).attr("transform",function(a){return"translate("+a.x+","+a.y+")"});var b=a.enter().append("g").attr("class","node").attr("id",function(a){return a.id}).attr("transform",function(a){return"translate("+a.x+","+a.y+")"}).attr("fill-opacity",0);b.append("title").text(function(a){return a.title});
b.append("text").attr("font-family",function(a){return"Arial"}).attr("font-size",function(a){return a.fontSize}).attr("fill",function(a){return this.getApplication().getFeatureForTerm("color",a.term)}.bind(this)).style("cursor","pointer").style("user-select","none").attr("alignment-baseline","middle").text(function(a){return a.term});b.transition().duration(this.getTransitionTime()).attr("fill-opacity",1);b=b.merge(a);b.select("text").transition().duration(this.getTransitionTime()).attr("font-size",
function(a){return a.fontSize});a.exit().transition().duration(this.getTransitionTime()).attr("fill-opacity",0).remove();setTimeout(function(){this.setIsTransitioning(!1)}.bind(this),this.getTransitionTime());this.setNodes(b)}},updateMinFreq:function(){this.setFrequencyScale(d3.scaleLog().domain([this.getMinFreq(),this.getMaxFreq()]).range([0,1]))},updateMaxFreq:function(){this.setFrequencyScale(d3.scaleLog().domain([this.getMinFreq(),this.getMaxFreq()]).range([0,1]))},zoomToFit:function(a,b){var c=
this.getVis().node().getBBox(),d=c.width,e=c.height,f=c.x+d/2,g=c.y+e/2,c=this.getVis().node().parentElement,h=c.clientWidth,k=c.clientHeight,d=(a||.8)/Math.max(d/h,e/k),f=[h/2-d*f,k/2-d*g];d3.select(c).transition().duration(b||500).call(this.getZoom().transform,d3.zoomIdentity.translate(f[0],f[1]).scale(d))},idGet:function(a){return a.replace(/\W/g,"_")}});Ext.define("Voyant.panel.Topics",{extend:"Ext.grid.Panel",mixins:["Voyant.panel.Panel","Voyant.widget.LiveSearchGrid"],alias:"widget.topics",statics:{i18n:{},api:{stopList:"auto",numTopics:25,limit:10,iterations:100,perDocLimit:1E3,query:void 0},glyph:"xf1ea@FontAwesome"},config:{options:[{xtype:"stoplistoption"},{xtype:"numberfield",name:"perDocLimit",fieldLabel:"maximum words per document",labelAlign:"right",value:1E3,minValue:1,step:100,listeners:{afterrender:function(a){var b=a.up("window");b&&
...
(a?this.body.addCls("notebook-editor-wrapper-hover"):this.body.removeCls("notebook-editor-wrapper-hover"))}});Ext.define("Voyant.notebook.editor.CodeEditor",{extend:"Ext.Component",alias:"widget.notebookcodeeditor",mixins:["Voyant.util.Localization","Voyant.notebook.util.Embed"],embeddable:["Voyant.notebook.editor.CodeEditor"],cls:"notebook-code-editor",config:{theme:"ace/theme/chrome",mode:"ace/mode/javascript",content:"",docs:void 0,isChangeRegistered:!1,editor:void 0,editedTimeout:void 0},statics:{i18n:{emptyText:"// click here to edit"},api:{content:void 0}},constructor:function(a){this.callParent(arguments)},
...
config:{metadata:{},version:2,isEdited:!1,saveItTool:void 0,autoSaveTimer:void 0,initialAutoSaveChecked:!1},docs:{"!name":"Voyant"},constructor:function(a){a=a||{};var b=this,c=["Corpus","Notebook","NetworkGraph","VoyantTable"];this.docsLoading=c.length;c.forEach(function(a){Ext.Ajax.request({url:this.getBaseUrl()+"docs/ace/"+a+".json",scope:this}).then(function(c,f){var g=Ext.decode(c.responseText),h=new Ext.XTemplate("\x3ca href\x3d'../../docs/#!/api/"+a+"{0}'\x3emore\u2026\x3c/a\x3e");b.docs[a]=
{"!type":"fn(config) -\x3e Corpus","!url":"","!doc":g.short_doc+h.apply([])};g.members.forEach(function(c){c["private"]||"method"!=c.tagname||(b.docs[a][c.name]={"!type":"fn()","!url":"","!doc":c.short_doc+h.apply(["-"+c.id])})});b.docsLoading--},function(a,c){b.docsLoading--;console.log("server-side failure with status code "+a.status)})},this);Ext.apply(a,{title:this.localize("title"),includeTools:{help:!0,save:!0,saveIt:{tooltip:this.localize("saveItTip"),callback:function(){b.mask(b.localize("saving"));
Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"notebook.NotebookManager",jsonData:Ext.encode(b.getExportAllJson())},scope:this}).then(function(a,c){b.unmask();var f=Ext.decode(a.responseText);if(f&&f.notebook&&f.notebook.notebook){var g=b.getBaseUrl()+"spyral/"+f.notebook.notebook,h=b.getApplication().getModifiedApiParams();0<Object.keys(h).length&&(g+="?"+Ext.Object.toQueryString(h));window.history.pushState({url:g},"Spyral Notebook: "+f.notebook.notebook,g);b.toastInfo({html:b.localize("savedUrlChanged"),
anchor:"tr"})}else b.showError(b.localize("savedFailed"))},function(a,c){b.unmask();b.showResponseError("Unable to save this notebook.",a)})},xtype:"toolmenu",glyph:"xf0c2@FontAwesome",listeners:{afterrender:function(a){a.setVisible(!0);b.setSaveItTool(a)}},disabled:!0,scope:this},open:{tooltip:this.localize("openTip"),callback:function(){Ext.Msg.prompt(this.localize("openTitle"),this.localize("openMsg"),function(a,b){b=b.trim();"ok"==a&&(this.removeAll(),0==b.indexOf("http")?this.loadFromUrl(b):
