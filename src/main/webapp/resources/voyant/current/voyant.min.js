...
c){d.setApiParam&&d.setApiParam(a,c);for(var e=d.getViewport().query("panel,chart"),g=0;g<e.length;g++)e[g].setApiParam&&e[g].setApiParam(a,c);f=!0}var c=a.up("form").getValues();this.setApiParams(c);var d=this.getApplication(),e=d.getCorpus(),f=!1;void 0!=c.stopList&&void 0!=c.stopListGlobal&&c.stopListGlobal&&b("stopList",c.stopList);void 0!=c.palette&&b("palette",c.palette);f&&(e?d.dispatchEvent("loadedCorpus",this,e):d.dispatchEvent("apiParamsUpdated",this,c));e?this.fireEvent("loadedCorpus",
this,e):this.fireEvent("apiParamsUpdated",this,c);a.up("window").close()},scope:a}]},bodyPadding:5}).show()}}:void 0,help:{glyph:"xf128@FontAwesome",fn:this.helpToolClick}},c=[];if(a.includeTools)for(var f in a.includeTools)"object"==typeof a.includeTools[f]&&c.push(a.includeTools[f]);for(f in e)a.includeTools&&!a.includeTools[f]||!e[f]||c.push({type:f,tooltip:this.localize(f+"Tip"),callback:e[f].fn,xtype:"toolmenu",glyph:e[f].glyph,items:e[f].items});Ext.apply(this,{tools:c});this.on("afterrender",
function(){var a=this.getHeader();if(a&&"Desktop"==Ext.os.deviceType&&!this.isXType("corpuscreator")&&!this.isXType("notebook")){var b=a.getEl();b.on("mouseover",function(){this.getHeader().getTools().forEach(function(a){a.show()})},this);b.on("mouseout",function(){this.getHeader().getTools().forEach(function(a){var b=a.config.type||a.type;b&&"help"!=b&&-1==b.indexOf("collapse")&&a.hide()})},this);a.getTools().forEach(function(a,b){"help"!=a.config.type&&a.hide()})}},this)}},getMenuItemFromXtype:function(a){var b=
this.getApplication().getToolConfigFromToolXtype(a);b&&b.tooltip&&delete b.tooltip;return Ext.apply(Ext.clone(b),{xtype:"menuitem",text:b.title,textAlign:"left",handler:function(){this.replacePanel(b.xtype)},scope:this})},maximizeToolClick:function(a){var b=Ext.getClass(a).getName().split(".");url=a.getBaseUrl()+"tool/"+b[b.length-1]+"/";params=a.getModifiedApiParams();!params.corpus&&a.getCorpus&&a.getCorpus()&&(params.corpus=a.getCorpus().getId());params&&(url+="?"+Ext.Object.toQueryString(params));
a.openUrl(url)},exportToolClick:function(a){a.isXType("voyanttabpanel")&&(a=a.getActiveTab());var b="beta.voyant-tools.org"==window.location.hostname?[{html:"\x3cp class\x3d'keyword' style\x3d'text-align: center; font-weight: bold; padding: 4px;'\x3ePlease note that this is the beta server and you should not count on corpora persisting (for bookmarks, embedding, etc.)."}]:[];b.push({xtype:"radio",name:"export",inputValue:"url",boxLabel:"\x3ca href\x3d'"+a.getExportUrl.call(a)+"' target\x3d'_blank'\x3e"+
a.localize("exportViewUrl")+"\x3c/a\x3e",checked:!0,listeners:{afterrender:function(){this.boxLabelEl.on("click",function(){this.up("window").close()},this)}}},{xtype:"fieldset",collapsible:!0,collapsed:!0,title:a.localize("exportViewFieldset"),items:[{xtype:"radio",name:"export",inputValue:"embed",boxLabel:a.localize("exportViewHtmlEmbed")},{xtype:"radio",name:"export",inputValue:"biblio",boxLabel:a.localize("exportViewBiblio")}]});if(a.isXType("grid")){var c=[{xtype:"radio",name:"export",inputValue:"gridCurrentHtml",
boxLabel:a.localize("exportGridCurrentHtml")},{xtype:"radio",name:"export",inputValue:"gridCurrentTsv",boxLabel:a.localize("exportGridCurrentTsv")}];a.getExportGridAll&&0==a.getExportGridAll()||c.push({xtype:"radio",name:"export",inputValue:"gridAllJson",boxLabel:a.localize("exportGridAllJson")},{xtype:"radio",name:"export",inputValue:"gridAllTsv",boxLabel:a.localize("exportGridAllTsv")});b.push({xtype:"fieldset",collapsible:!0,collapsed:!0,title:a.localize("exportGridCurrent"),items:c})}a.getExportVisualization&&
!a.getExportVisualization()||0!=a.isXType("grid")||!(a.down("chart")||a.getTargetEl().dom.querySelector("canvas")||a.getTargetEl().dom.querySelector("svg"))||(c=[{xtype:"radio",name:"export",inputValue:"png",boxLabel:a.localize("exportPng")},{xtype:"slider",width:200,value:1,minValue:.5,maxValue:10,increment:.5,labelAlign:"right",decimalPrecision:1,itemId:"scale",fieldLabel:(new Ext.Template(a.localize("scaleLabel"))).apply([1]),listeners:{change:function(b,c){this.setFieldLabel((new Ext.Template(a.localize("scaleLabel"))).apply([c]))},
changecomplete:function(a){a.previousSibling().setValue(!0)}}}],a.getTargetEl().dom.querySelector("svg")&&c.push({xtype:"radio",name:"export",inputValue:"svg",boxLabel:a.localize("exportSvg")}),b.push({xtype:"fieldset",collapsible:!0,collapsed:!0,title:a.localize("exportVizTitle"),items:c}));Ext.create("Ext.window.Window",{title:a.localize("exportTitle"),modal:!0,items:{xtype:"form",items:b,buttons:[{text:a.localize("exportTitle"),glyph:"xf08e@FontAwesome",flex:1,panel:a,handler:function(b){var c=
...
1.1).attr("xmlns","http://www.w3.org/2000/svg").node().parentNode.innerHTML,Ext.Msg.show({title:this.localize("exportSvgTitle"),message:'\x3cimg src\x3d"data:image/svg+xml;base64,'+btoa(unescape(encodeURIComponent(a)))+'" style\x3d"float: right; max-width: 200px; max-height: 200px; border: thin dotted #ccc;"/\x3e'+this.localize("exportSvgMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:a})},exportPngData:function(a){Ext.Msg.show({title:this.localize("exportPngTitle"),message:'\x3cimg class\x3d"thumb" src\x3d"'+
a+'" style\x3d"float: right; max-width: 200px; max-height: 200px; border: thin dotted #ccc;"/\x3e'+this.localize("exportPngMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:'\x3cimg src\x3d"'+a+'" /\x3e'})},exportPng:function(a,b){var c=1;if(b){b.mask(a.localize("loading"));var d=b.queryById("scale");d&&d.getValue&&(c=d.getValue())}var e=this.down("draw")||this.down("chart");if(e&&(e.isChart||e.isCanvas)){var f=e.innerElement.getSize(),d=Array.prototype.slice.call(e.items.items),
g=e.surfaceZIndexes,h,k,l,m;for(k=1;k<d.length;k++){l=d[k];m=g[l.type];for(e=k-1;0<=e&&g[d[e].type]>m;)d[e+1]=d[e],e--;d[e+1]=l}var n=document.createElement("canvas"),g=Ext.getClassName(d[0]),c=d[0].devicePixelRatio*c,q=n.getContext("2d"),r;n.width=Math.ceil(f.width*c);n.height=Math.ceil(f.height*c);for(e=0;e<d.length;e++)if(l=d[e],Ext.getClassName(l)===g)for(f=l.getRect(),surfaceSize=l.el.getSize(),k=0;k<l.canvases.length;k++)r=l.canvases[k],m=r.getOffsetsTo(r.getParent()),q.drawImage(r.dom,(f[0]+
m[0])*c,(f[1]+m[1])*c,surfaceSize.width*c,surfaceSize.height*c);b&&b.isVisible()&&b.unmask();return this.exportPngData(n.toDataURL())}k=this.getTargetEl().dom;if(r=k.querySelector("canvas")){if(1==c)return c=r.toDataURL("image/png"),b&&b.isVisible()&&b.unmask(),this.exportPngData(c);n=document.createElement("canvas");q=n.getContext("2d");n.width=Math.ceil(r.width*c);n.height=Math.ceil(r.height*c);h=new Image;h.src=r.toDataURL("image/png");h.panel=this;h.onload=function(){q.drawImage(h,0,0,n.width,
n.height);p=n.toDataURL("image/png");b&&b.isVisible()&&b.unmask();this.panel.exportPngData.call(this.panel,p)}}else if(e=k.querySelector("svg")){d=k.offsetWidth*c;k=k.offsetHeight*c;e=e.cloneNode(!0);e.setAttribute("version",1.1);e.setAttribute("xmlns","http://www.w3.org/2000/svg");e.setAttribute("transform","scale("+c+")");e.setAttribute("width",d);e.setAttribute("height",k);var p="data:image/svg+xml;base64,"+btoa(unescape(encodeURIComponent(e.outerHTML)));r=Ext.DomHelper.createDom({tag:"canvas",
width:d,height:k});var s=r.getContext("2d");h=new Image;h.src=p;h.panel=this;h.onload=function(){s.drawImage(h,0,0);p=r.toDataURL("image/png");b&&b.isVisible()&&b.unmask();return this.panel.exportPngData.call(this.panel,p)}}},exportUrl:function(){this.openUrl(this.getExportUrl())},exportEmbed:function(){var a=0==this.isXType("voyantheader");console.warn(this.xtype,a);Ext.Msg.show({title:this.localize("exportViewEmbedTitle"),message:this.localize("exportViewEmbedMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,
prompt:!0,multiline:!0,value:"\x3c!--\tExported from Voyant Tools (voyant-tools.org).\nThe iframe src attribute below uses a relative protocol to better function with both\nhttp and https sites, but if you're embedding this into a local web page (file protocol)\nyou should add an explicit protocol (https if you're using voyant-tools.org, otherwise\nit depends on this server.\nFeel free to change the height and width values or other styling below: --\x3e\n\x3ciframe style\x3d'width: "+(a?this.getWidth()+
"px":"100%")+"; height: "+(a?this.getHeight()+"px":"800px")+";' src\x3d'"+this.getExportUrl(a)+"'\x3e\x3c/iframe\x3e"})},exportBiblio:function(){var a=new Date;Ext.Msg.show({title:this.localize("exportBiblioTitle"),message:"\x3cfieldset\x3e\x3clegend\x3eMLA\x3c/legend\x3eSinclair, St\u00e9fan and Geoffrey Rockwell. "+(this.isXType("voyantheader")?"":'"'+this.localize("title")+'." ')+"\x3ci\x3eVoyant Tools\x3c/i\x3e. "+Ext.Date.format(a,"Y")+". Web. "+Ext.Date.format(a,"j M Y")+". \x26lt;http://voyant-tools.org\x26gt;.\x3c/fieldset\x3e\x3cbr \x3e\x3cfieldset\x3e\x3clegend\x3eChicago\x3c/legend\x3eSt\u00e9fan Sinclair and Geoffrey Rockwell, "+
...
e+="\t\t\x3c/tr\x3e\n\t\x3c/thead\x3e\n\t\x3ctbody\x3e\n";d.buffered?d.data.forEach(c):d.each(c);e+="\t\x3c/tbody\x3e\n\x3c/table\x3e";Ext.Msg.show({title:this.localize("exportDataTitle"),message:this.localize("exportDataHtmlMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:e})},exportGridAllJson:function(a,b){Ext.Msg.confirm(this.localize("exportAllTitle"),this.localize("exportAllJsonWarning"),function(b){"yes"==b&&(b={limit:0,start:0},Ext.applyIf(b,a.getStore().getProxy().getExtraParams()),
...
html:'\x3cdiv class\x3d"header"\x3e'+this.localize("distribution")+"\x3c/div\x3e"},{itemId:"distLine",xtype:"sparklineline",values:[],height:20,width:200}],listeners:{afterrender:function(b){b.mask(this.localize("loading"));this.getDocumentTermsStore().load({params:{query:this.getApiParam("query"),docIndex:a,withDistributions:!0,bins:2*parseInt(this.getApiParam("limit"))},callback:function(a,e,f){f&&a&&0<a.length&&(a=a.map(function(a){return a.getDistributions()}).reduce(function(a,b){return a.concat(b)}),
...
function(a){return{phrase:a.getTerm()}})},addSection:function(a,b,c,d,e){return this.getComponent("main").add({xtype:"container",html:'\x3cdiv class\x3d"header"\x3e'+a+"\x3c/div\x3e",cls:"section",listeners:{afterrender:function(a){a.mask(this.localize("loading"));b.load({params:c,callback:function(b,c,k){k&&b&&0<b.length&&(a.unmask(),Ext.dom.Helper.append(a.getTargetEl().first().first(),(new Ext.XTemplate('\x3cdiv class\x3d"contents"\x3e'+d+"\x3c/div\x3e")).apply(b.map(e))))}})},scope:this}})}});Ext.define("Voyant.panel.Correlations",{extend:"Ext.grid.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.correlations",statics:{i18n:{},api:{query:void 0,docId:void 0,docIndex:void 0,stopList:"auto",minInDocumentsCountRatio:100},glyph:"xf0ce@FontAwesome"},config:{},constructor:function(){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(){var a=this;Ext.apply(a,{title:this.localize("title"),emptyText:this.localize("emptyText"),
store:Ext.create("Voyant.data.store.TermCorrelationsBuffered",{parentPanel:this}),columns:[{text:this.localize("source"),tooltip:this.localize("sourceTip"),dataIndex:"source-term",sortable:!1},{xtype:"widgetcolumn",tooltip:this.localize("trendTip"),width:100,dataIndex:"source-distributions",widget:{xtype:"sparklineline"},text:"\u2190"},{xtype:"widgetcolumn",tooltip:this.localize("trendTip"),width:100,dataIndex:"target-distributions",widget:{xtype:"sparklineline"},text:"\u2192",align:"right"},{text:this.localize("target"),
tooltip:this.localize("targetTip"),dataIndex:"target-term",sortable:!1},{text:this.localize("correlation"),tooltip:this.localize("correlationTip"),dataIndex:"correlation"},{text:this.localize("significance"),tooltip:this.localize("significanceTip"),dataIndex:"significance"}],listeners:{scope:this,corpusSelected:function(){this.setApiParams({docIndex:void 0,docId:void 0});this.getStore().getProxy().setExtraParam("tool","corpus.CorpusTermCorrelations");this.getStore().load()},documentsSelected:function(a,
c){var d=[],e=this.getStore().getCorpus();c.forEach(function(a){d.push(e.getDocument(a).getId())},this);this.setApiParams({docId:d,docIndex:void 0});this.getStore().getProxy().setExtraParam("tool","corpus.DocumentTermCorrelations");this.getStore().load()}},dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"querysearchfield"},{xtype:"totalpropertystatus"},{xtype:"tbspacer"},{xtype:"tbtext",itemId:"minInDocumentsCountRatioLabel",text:a.localize("minInDocumentsCountRatioLabel")},
...
this.getStore().load()},scope:this}},{xtype:"corpusdocumentselector"}]}]});a.on("loadedCorpus",function(a,c){1==c.getDocumentsCount()&&this.getStore().getProxy().setExtraParam("tool","corpus.DocumentTermCorrelations");this.isVisible()&&this.getStore().load()});a.on("activate",function(){this.getStore().getCorpus()&&this.getStore().load()},this);a.on("query",function(a,c){this.setApiParam("query",c);this.getStore().load()},a);a.callParent(arguments)}});Ext.define("Voyant.panel.CorpusCreator",{extend:"Ext.form.Panel",requires:["Ext.form.field.File"],requires:["Voyant.data.model.Corpus"],mixins:["Voyant.panel.Panel"],alias:"widget.corpuscreator",isConsumptive:!0,statics:{i18n:{},api:{inputFormat:void 0,language:void 0,xmlDocumentsXpath:void 0,xmlGroupByXpath:void 0,xmlContentXpath:void 0,xmlTitleXpath:void 0,xmlAuthorXpath:void 0,htmlGroupByQuery:void 0,htmlDocumentsQuery:void 0,htmlContentQuery:void 0,htmlTitleQuery:void 0,htmlAuthorQuery:void 0,
tokenization:void 0,adminPassword:void 0,accessPassword:void 0,noPasswordAccess:void 0,tableDocuments:void 0,tableContent:void 0,tableTitle:void 0,tableAuthor:void 0,title:void 0,subTitle:void 0,inputRemoveFrom:void 0,inputRemoveFromAfter:void 0,inputRemoveUntil:void 0,inputRemoveUntilAfter:void 0}},constructor:function(a){this.callParent(arguments);a=a||{};this.mixins["Voyant.panel.Panel"].constructor.call(this,Ext.apply(a,{includeTools:{gear:!0,help:!0,language:this.getLanguageToolMenu()}}))},initComponent:function(){var a=
this;Ext.apply(a,{title:this.localize("title"),width:800,frame:!0,padding:10,style:{borderColor:"#aaa",borderStyle:"solid"},frameHeader:!0,layout:{type:"vbox",align:"middle"},dockedItems:[{xtype:"toolbar",overflowHandler:"scroller",dock:"bottom",buttonAlign:"right",items:[{text:a.localize("Open"),glyph:"xf115@FontAwesome",tooltip:a.localize("SelectExisting"),hidden:void 0!=this.getCorpus(),handler:function(){Ext.create("Ext.window.Window",{title:a.localize("Open"),layout:"fit",modal:!0,items:{xtype:"form",
submitEmptyText:!1,margin:"5,5,5,5",items:{xtype:"corpusselector"},buttons:[{text:a.localize("Open"),glyph:"xf00c@FontAwesome",handler:function(b){b.up("form").getForm();var c=b.up("form").getForm().getValues().corpus;""!=c?(a.loadCorpus({corpus:c}),b.up("window").close()):Ext.Msg.show({title:a.localize("SelectExisting"),message:a.localize("PleaseSelectExisting"),buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR})},flex:1},{text:a.localize("cancel"),glyph:"xf00d@FontAwesome",flex:1,handler:function(a){a.up("window").close()}}]}}).show()}},
{xtype:"fileuploadfield",glyph:"xf093@FontAwesome",name:"upload",buttonOnly:!0,hideLabel:!0,ui:"default-toolbar",buttonText:a.localize("Upload"),listeners:{render:function(b){b.fileInputEl.dom.setAttribute("multiple",!0);Ext.tip.QuickTipManager.register({target:b.getEl(),text:a.localize("UploadLocal")})},beforedestroy:function(a){Ext.tip.QuickTipManager.unregister(a.getEl())},change:function(b,c){if(c){var d=b.up("form").getForm();if(d.isValid()){for(var e=b.fileInputEl.dom.files,f=/\.(png|gif|jpe?g|xls|mp[234a]|mpeg|exe|wmv|avi|ppt|mpg|tif|wav|mov|psd|wma|ai|bmp|pps|aif|pub|dwg|indd|swf|asf|mbd|dmg|flv)$/i,
...
buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR})}}]}],items:{xtype:"textareafield",width:800,height:100,itemId:"input",emptyText:this.localize("emptyInput")}});a.on("boxready",function(a){var c=this.getApplication();c.getAllowInput&&"false"==c.getAllowInput()&&(c.getNoAllowInputText&&0<c.getNoAllowInputText().trim().length?Ext.defer(function(){var d=a.up("container");d.removeAll();d.add({frame:!1,padding:10,style:{borderColor:"#aaa",borderStyle:"solid"},html:c.getNoAllowInputText()})},100):(a.hide(),Ext.create("Ext.window.Window",
{layout:"fit",header:!1,modal:!0,bodyPadding:10,items:{html:"\x3cp style\x3d'color: red;'\x3e"+a.localize("noAllowInputMessage")+"\x3c/p\x3e"}}).show()))});a.callParent(arguments)},loadForm:function(a){var b={tool:this.getCorpus()?"corpus.CorpusMetadata":"corpus.CorpusCreator"};this.getCorpus()&&Ext.apply(b,{corpus:this.getCorpus().getId(),addDocuments:!0});var c=this.getApiParams();delete c.view;delete c.stopList;Ext.apply(b,c);var d=this.getApplication().getViewport();d.mask(this.localize("uploadingCorpus"));
a.submit({url:this.getTromboneUrl(),params:b,failure:function(a,b){d.unmask();if(b.result&&(b.result.corpus||b.result.stepEnabledCorpusCreator)){var g={corpus:b.result.corpus?b.result.corpus.metadata.id:b.result.stepEnabledCorpusCreator.storedId};Ext.applyIf(g,c);this.setCorpus(void 0);this.loadCorpus(g)}else this.showResponseError("Unable to load corpus.",b.response)},scope:this})},loadCorpus:function(a){this.getCorpus()&&Ext.apply(a,{corpus:this.getCorpus().getId(),addDocuments:!0});var b=this.up("window");
b&&b.isFloating()&&b.close();this.getApplication().loadCorpusFromParams(a)},showOptionsClick:function(a){void 0===a.optionsWin&&(a.optionsWin=Ext.create("Ext.window.Window",{title:a.localize("gearWinTitle"),closeAction:"hide",layout:"fit",bodyPadding:10,items:[{xtype:"form",defaultType:"textfield",maxHeight:a.getApplication().getViewport().getHeight()-300,scrollable:!0,fieldDefaults:{labelAlign:"right",labelWidth:110,width:350},items:[{xtype:"combo",fieldLabel:a.localize("inputFormat"),labelWidth:90,
name:"inputFormat",queryMode:"local",store:[["",a.localize("inputFormatAuto")],["dtoc","DToC: Dynamic Table of Contexts"],["TEI","TEI: Text Encoding Initative"],["TEI","TEI Corpus"],["RSS","Really Simple Syndication: RSS"]],value:"",listeners:{afterrender:{fn:function(a){var c=this.getApiParam("inputFormat");c&&a.setValue(c)},scope:a}}},{xtype:"container",html:"\x3cp\x3e\x3ci\x3e"+(new Ext.Template(a.localize("advancedOptionsText"))).applyTemplate([a.getBaseUrl()+"docs/#!/guide/corpuscreator-section-xml"])+
"\x3c/i\x3e\x3c/p\x3e",width:375},{xtype:"fieldset",title:"\x3ca href\x3d'"+a.getBaseUrl()+"docs/#!/guide/corpuscreator-section-titles' target\x3d'voyantdocs'\x3e"+a.localize("corpusOptions")+"\x3c/a\x3e",collapsible:!0,collapsed:!0,defaultType:"textfield",items:[{xtype:"container",html:"\x3cp\x3e\x3ci\x3e\x3c/i\x3e\x3c/p\x3e",width:375},{fieldLabel:a.localize("corpusTitle"),name:"title"},{fieldLabel:a.localize("corpusSubTitle"),name:"subTitle"}]},{xtype:"fieldset",title:"\x3ca href\x3d'"+a.getBaseUrl()+
"docs/#!/guide/corpuscreator-section-text' target\x3d'voyantdocs'\x3e"+a.localize("textOptions")+"\x3c/a\x3e",collapsible:!0,collapsed:!0,defaultType:"textfield",items:[{xtype:"container",html:"\x3cp\x3e\x3ci\x3e"+a.localize("textOptionsText")+"\x3c/i\x3e\x3c/p\x3e",width:375},{fieldLabel:a.localize("inputRemoveUntil"),name:"inputRemoveUntil"},{fieldLabel:a.localize("inputRemoveUntilAfter"),name:"inputRemoveUntilAfter"},{fieldLabel:a.localize("inputRemoveFrom"),name:"inputRemoveFrom"},{fieldLabel:a.localize("inputRemoveFromAfter"),
...
"docs/#!/guide/corpuscreator-section-html"])+"\x3c/i\x3e\x3c/p\x3e",width:375},{fieldLabel:a.localize("xpathContent"),name:"htmlContentQuery"},{fieldLabel:a.localize("xpathTitle"),name:"htmlTitleQuery"},{fieldLabel:a.localize("xpathAuthor"),name:"htmlAuthorQuery"},{fieldLabel:a.localize("xpathDocuments"),name:"htmlDocumentsQuery"},{fieldLabel:a.localize("xpathGroupBy"),name:"htmlGroupByQuery"}]},{xtype:"fieldset",title:"\x3ca href\x3d'"+a.getBaseUrl()+"docs/#!/guide/corpuscreator-section-tables' target\x3d'voyantdocs'\x3e"+
...
items:[{text:this.localize("display"),tooltip:this.localize("displayTip"),glyph:"xf013@FontAwesome",menu:{defaults:{xtype:"menucheckitem",checkHandler:function(a,c){var d=this.getMap(),e=a.getItemId();this.getFilterWidgets().each(function(a){d.getLayer(a.getId()+"-"+e).setVisible(c)});var f=Ext.Array.from(this.getApiParam("hide"));c?f=Ext.Array.remove(f,e):(f.push(e),f=Ext.Array.unique(f));this.setApiParam("hide",f);a.getMenu().setDisabled(0==c)},scope:this,checked:!0},items:[{xtype:"menuitem",text:this.localize("baseLayer"),
tooltip:this.localize("baseLayerTip"),glyph:"xf279@FontAwesome",menu:{items:[{xtype:"radiogroup",columns:1,vertical:!0,defaults:{cls:"map-menu-item",handler:function(a,c){if(c){id=a.getItemId();var d=this.getBaseLayers()[id];d&&(d.setOpacity(1),this.getMap().getLayers().setAt(0,d));"osm"==id||"arcGIS"==id?this.getMap().getLayer("overlayLayer").setVisible(!1):this.getMap().getLayer("overlayLayer").setVisible(!0)}},listeners:{afterrender:function(a){Ext.create("Ext.tip.ToolTip",{target:a,html:'\x3cdiv class\x3d"map-menu-item-tooltip '+
...
a.getSource().getFeatures().forEach(function(a){var b=a.getGeometry().transform(g.getView().getProjection(),d.getProjection());a.setGeometry(b)})});g.setView(e)}},listeners:{afterrender:function(a){Ext.create("Ext.tip.ToolTip",{target:a,html:'\x3cdiv class\x3d"map-menu-item-tooltip '+a.getItemId()+'"\x3e\x3c/div\x3e',anchor:"right"})}},scope:this},items:[{boxLabel:this.localize("webMercatorProjection"),itemId:"webMercatorProjection",cls:["map-menu-item","webMercatorProjection"],checked:!0},{boxLabel:this.localize("mercatorProjection"),
...
f.get("type")&&this.handleLocationClick(f)}f=c[0];debugger}if(c){var m=!1;c.forEach(function(c){"city"===c.get("type")&&c.get("selected")?(b.dispatchEvent("termsClicked",b,[c.get("forms").join("|")]),m=!0):"connection"===c.get("type")&&c.get("selected")&&!m&&(b.getFilterWidgets().each(function(d){d=d.getGeonames();if(null!=d){var e="\x3cul\x3e",f=-1;d.getAllConnectionOccurrences(c.get("source"),c.get("target")).forEach(function(a){a.docIndex!=f&&(f=a.docIndex,e+="\x3ch4\x3e"+b.getCorpus().getDocument(f).getFullLabel()+
...
0;c[f].get("selected")&&(f++,f!==c.length););if(f<c.length){var l=c[f],c={font:"12px Calibri,sans-serif",textAlign:"center",offsetY:-15,fill:new ol.style.Fill({color:[0,0,0,1]}),stroke:new ol.style.Stroke({color:[255,255,255,.5],width:4})};c.text=l.get("text");c=new ol.style.Style({text:new ol.style.Text(c),zIndex:1});"annotation"!==l.get("type")&&(f=new ol.Feature({text:l.get("text"),geometry:l.getGeometry(),forms:l.get("forms"),selected:!0,coordinates:l.get("coordinates"),width:l.get("width"),visible:l.get("visible"),
color:l.get("color"),type:l.get("type"),confidence:l.get("confidence"),source:l.get("source"),target:l.get("target"),cityId:l.get("cityId")}),e.getSource().addFeature(f));l.getGeometry();a=new ol.Feature({geometry:new ol.geom.Point(a.coordinate),selected:!0});a.setStyle(c);e.getSource().addFeature(a);"city"===l.get("type")&&b.getMap().getLayers().forEach(function(a){var b=a.get("id");b&&-1!==b.indexOf("connections")&&(connections=a.getSource().getFeatures(),connections.forEach(function(a){a.get("target")!==
l.get("cityId")&&a.get("source")!==l.get("cityId")||e.getSource().addFeature(new ol.Feature({geometry:a.getGeometry(),selected:!0,coordinates:a.get("coordinates"),width:a.get("width"),visible:a.get("visible"),color:a.get("color"),type:a.get("type")}))}))})}}});var a=new ol.source.Vector({wrapX:!1}),c=new ol.layer.Vector({source:a,id:"annotations"}),f=this.getAnnotations();f&&(f=(new ol.format.GeoJSON).readFeatures(f),a.addFeatures(f));d.addLayer(c);this.setDrawInteraction(new ol.interaction.Draw({source:a,
...
this)},filterUpdate:function(a){var b=this;a.clearAnimation();var c=this.getMap(),d=a.getColor(),e=parseInt(this.getApiParam("citiesMaxCount")),f=0;a.getGeonames().eachCity(function(a){a.rawFreq>f&&(f=a.rawFreq)},this,e);var g=c.getLayer(a.getId()+"-cities").getSource(),h=Ext.Array.from(this.getApiParam("hide"));g.clear();var k=parseInt(this.getApiParam("minPopulation")),l=parseInt(this.getApiParam("citiesMinFreq")),m={};a.getGeonames().eachCity(function(a){if((!k||a.population>=k)&&(!l||a.rawFreq>=
...
scope:a},changecomplete:{fn:function(a,b){var e=a.getValues();this.setApiParam("minLength",parseInt(e[0]));this.setApiParam("maxLength",parseInt(e[1]));this.getStore().load({params:this.getApiParams()})},scope:a}}},{xtype:"corpusdocumentselector"},"-",{xtype:"button",text:this.localize("overlap"),tooltip:this.localize("overlapTip"),menu:{items:[{xtype:"menucheckitem",text:this.localize("overlapNone"),group:"overlap",inputValue:"none",checkHandler:function(){this.setApiParam("overlapFilter","none");
this.getStore().load({params:this.getApiParams()})},scope:this},{xtype:"menucheckitem",text:this.localize("overlapLength"),group:"overlap",inputValue:"length",checkHandler:function(){this.setApiParam("overlapFilter","length");this.getStore().load({params:this.getApiParams()})},scope:this},{xtype:"menucheckitem",text:this.localize("overlapFreq"),group:"overlap",inputValue:"rawFreq",checkHandler:function(){this.setApiParam("overlapFilter","rawfreq");this.getStore().load({params:this.getApiParams()})},
scope:this}],listeners:{afterrender:{fn:function(a){var b=this.getApiParam("overlapFilter");a.items.each(function(a){a.group&&a.setChecked(a.inputValue==b)},this)},scope:this}}}}]}],columns:[{text:this.localize("term"),dataIndex:"term",tooltip:this.localize("termTip"),sortable:!0,flex:1},{text:this.localize("rawFreq"),dataIndex:"rawFreq",tooltip:this.localize("termRawFreqTip"),sortable:!0,width:"autoSize"},{text:this.localize("length"),dataIndex:"length",tooltip:this.localize("lengthTip"),sortable:!0,
width:"autoSize"},{xtype:"widgetcolumn",text:this.localize("trend"),tooltip:this.localize("trendTip"),width:120,dataIndex:"distributions",widget:{xtype:"sparklineline"}}],listeners:{corpusSelected:function(){this.setApiParams({docIndex:void 0,docId:void 0});this.loadFromApis()},documentsSelected:function(a,b){var e=[],f=this.getStore().getCorpus();b.forEach(function(a){e.push(f.getDocument(a).getId())},this);this.setApiParams({docId:e,docIndex:void 0});this.loadFromApis()},termsClicked:{fn:function(a,
...
!1);b.redraw()},categoriesHandler:function(a){var b=[];a.up("menu").items.each(function(a){a.checked&&b.push(a.itemId)});this.setApiParam("type",b);this.getEntities()},map:function(a,b,c,d,e){return d+(a-b)/(c-b)*(e-d)}});Ext.define("Voyant.panel.Loom",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.loom",statics:{i18n:{title:"Loom",controls:"Controls",frequenciesGroup:"Frequencies",coverageGroup:"Coverage",distributionsGroup:"Distribution",termsGroup:"Terms",rawFreqLabel:"raw frequency",rawFreqLabelTip:"raw term frequencies for the term must be between these values (inclusively)",rawFreqPercentileLabel:"raw frequency percentile",rawFreqPercentileLabelTip:"raw term frequencies for the term must be between these percentile values (inclusively), this is useful for saying something like terms in the top 90th percentile which will provide 10% of words regardless of the variation in values."},
api:{limit:500,stopList:"auto",inDocuments:void 0,spanSome:void 0,spanAll:void 0,spanOnly:void 0,termLength:void 0,rawFreq:void 0,rawFreqPercentile:void 0,distributionIncreases:void 0,distributionDecreases:void 0,distributionConsecutiveIncreases:void 0,distributionConsecutiveDecreases:void 0},glyph:"xf1e0@FontAwesome"},config:{store:void 0,terms:void 0,controls:void 0},constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(){this.mixins["Voyant.util.Api"].constructor.apply(this,
arguments);var a=new Ext.util.MixedCollection({allowFunctions:!0});a.addAll({inDocuments:new Voyant.util.LoomControl({group:"coverage",name:"inDocuments",initControl:function(a){this.setMin(1);this.setMax(a.getAt(0).getDistributions().length)},validateRecord:function(a){a=a.getDistributions().filter(function(a){return 0<a}).length;return a>=this.getLow()&&a<=this.getHigh()}}),spanSome:new Voyant.util.LoomControl({group:"coverage",name:"spanSome",offsetTipText:!0,initControl:function(a){this.setMax(a.getAt(0).getDistributions().length-
1)},validateRecord:function(a){var b=this.getLow(),e=this.getHigh();for(a=a.getDistributions();b<e+1;b++)if(0<a[b])return!0;return!1}}),spanAll:new Voyant.util.LoomControl({group:"coverage",name:"spanAll",offsetTipText:!0,initControl:function(a){this.setMax(a.getAt(0).getDistributions().length-1)},validateRecord:function(a){var b=this.getLow(),e=this.getHigh();for(a=a.getDistributions();b<e+1;b++)if(0==a[b])return!1;return!0}}),spanOnly:new Voyant.util.LoomControl({group:"coverage",name:"spanOnly",
offsetTipText:!0,initControl:function(a){this.setMax(a.getAt(0).getDistributions().length-1)},validateRecord:function(a){var b=this.getLow(),e=this.getHigh();a=a.getDistributions();for(var f=0;f<a.length;f++)if(f<b||f>e){if(0<a[f])return!1}else if(0==a[f])return!1;return!0}}),rawFreq:new Voyant.util.LoomControl({group:"frequencies",name:"rawFreq",offsetTipText:!0,initControl:function(a){a=a.getRange().map(function(a){return a.get("rawFreq")});this.setMin(Ext.Array.min(a));this.setMax(Ext.Array.max(a))},
validateRecord:function(a){var b=this.getLow(),e=this.getHigh();a=a.get("rawFreq");return a>=b&&a<=e}}),rawFreqPercentile:new Voyant.util.LoomControl({group:"frequencies",name:"rawFreqPercentile",min:0,max:100,initControl:function(a){this.vals=a.getRange().map(function(a){return a.get("rawFreq")});this.vals.sort(function(a,b){return a-b})},validateRecord:function(a){var b=this.getLow(),e=this.getHigh();a=Ext.Array.indexOf(this.vals,a.get("rawFreq"));a=Math.round(100*a/this.vals.length);return a>=
b&&a<=e}}),distributionsStdDev:new Voyant.util.LoomControl({group:"frequencies",name:"distributionsStdDev",initControl:function(a){var b=Ext.Array.flatten(a.getRange().map(function(a){return a.getDistributions()})),e=d3.scaleLinear().domain([d3.min(b),d3.max(b)]).range([0,100]);a.each(function(a){if(void 0===a.get("distributionsStdDev")){var b=a.getDistributions(),c=b.map(function(a){return e(a)}),d=Ext.Array.mean(c),b=b.map(function(a){a-=d;return a*a}),b=Ext.Array.mean(b),b=Math.sqrt(b);a.set("distributionsStdDev",
b)}});a=a.getRange().map(function(a){return a.get("distributionsStdDev")});this.setMin(Ext.Array.min(a));this.setMax(Ext.Array.max(a))},validateRecord:function(a){var b=this.getLow(),e=this.getHigh();a=a.get("distributionsStdDev");return a>=b&&a<=e}}),distributionsStdDevPercentile:new Voyant.util.LoomControl({group:"frequencies",name:"distributionsStdDevPercentile",min:0,max:100,initControl:function(a){this.vals=a.getRange().map(function(a){return a.get("distributionsStdDev")});this.vals.sort(function(a,
b){return a-b})},validateRecord:function(a){var b=this.getLow(),e=this.getHigh();a=Ext.Array.indexOf(this.vals,a.get("distributionsStdDev"));a=Math.round(100*a/this.vals.length);return a>=b&&a<=e}}),termsLength:new Voyant.util.LoomControl({group:"terms",name:"termsLength",offsetTipText:!0,initControl:function(a){a=a.getRange().map(function(a){return a.get("term").length});this.setMin(Ext.Array.min(a));this.setMax(Ext.Array.max(a))},validateRecord:function(a){var b=this.getLow(),e=this.getHigh();a=
a.get("term").length;return a>=b&&a<=e}}),distributionIncreases:new Voyant.util.LoomControl({group:"distributions",name:"distributionIncreases",initControl:function(a){this.setMax(a.getAt(0).getDistributions().length)},validateRecord:function(a){var b=this.getLow(),e=this.getHigh();a=a.getDistributions();for(var f=0,g=1;g<a.length;g++)if(a[g]>a[g-1]&&(f++,f>e))return!1;return f>=b}}),distributionConsecutiveIncreases:new Voyant.util.LoomControl({group:"distributions",name:"distributionConsecutiveIncreases",
initControl:function(a){this.setMax(a.getAt(0).getDistributions().length)},validateRecord:function(a){var b=this.getLow(),e=this.getHigh();a=a.getDistributions();for(var f=0,g=1;g<a.length;g++)if(a[g]>a[g-1]){if(f++,f>e)return!1}else f=0;return f>=b}}),distributionDecreases:new Voyant.util.LoomControl({group:"distributions",name:"distributionDecreases",initControl:function(a){this.setMax(a.getAt(0).getDistributions().length)},validateRecord:function(a){var b=this.getLow(),e=this.getHigh();a=a.getDistributions();
for(var f=0,g=1;g<a.length;g++)if(a[g]<a[g-1]&&(f++,f>e))return!1;return f>=b}}),distributionConsecutiveDecreases:new Voyant.util.LoomControl({group:"distributions",name:"distributionConsecutiveDecreases",initControl:function(a){this.setMax(a.getAt(0).getDistributions().length)},validateRecord:function(a){var b=this.getLow(),e=this.getHigh();a=a.getDistributions();for(var f=0,g=1;g<a.length;g++)if(a[g]<a[g-1]){if(f++,f>e)return!1}else f=0;return f>=b}})});a.each(function(a){var b=this.getApiParam(a.getName()),
e=(b||"").split(",");a.setEnabled(void 0!==b);2==e.length&&(a.setLow(parseInt(e[0])),a.setHigh(parseInt(e[1])));a.on("change",function(a){a.getEnabled()?this.setApiParam(a.getName(),a.getLow()+","+a.getHigh()):this.setApiParam(a.getName(),void 0);this.filterRecords()},this)},this);this.setControls(a);var b=["frequencies","coverage","distributions","terms"].map(function(b){return{text:this.localize(b+"Group"),menu:{items:a.filterBy(function(a){return a.getGroup()==b}).getRange().map(function(a){return{xtype:"menucheckitem",
checked:a.getEnabled(),text:this.localize(a.getName()+"Label"),tooltip:this.localize(a.getName()+"LabelTip"),listeners:{beforerender:function(b){b.setChecked(a.getEnabled());a.on("change",function(){b.setChecked(a.getEnabled())})},click:function(b){a.setEnabled(b.checked);b.getMenu().setDisabled(!b.checked);b.checked?b.getMenu().show():b.getMenu().hide()}},menu:{disabled:!a.getEnabled(),items:{xtype:"multislider",width:100,minValue:a.getMin()||0,maxValue:a.getMax()||0,values:[a.getLow()||0,a.getHigh()||
0],tipText:function(b){return a.getOffsetTipText()?b.value+1:b.value},listeners:{beforerender:function(b){b.updateFromControl(a);a.on("change",function(){b.updateFromControl(a)})},changecomplete:function(b){a.setValues(b.getValues())}},updateFromControl:function(a){this.setMinValue(a.getMin()||0);this.setMaxValue(a.getMax());this.setValue(0,a.getLow()||0);this.setValue(1,void 0===a.getHigh()?a.getMax()||0:a.getHigh())}}}}},this)}}},this);Ext.apply(this,{title:this.localize("title"),layout:{type:"hbox",
align:"stretch"},listeners:{afterrender:function(){var a=this.getComponent("terms"),b=this.getComponent("threads");a.on("termHovered",function(a,c){var g=b.getTargetEl().dom.querySelector("path[term\x3d"+c+"]");if(g){var h=function(a,b){opacity=a.getAttribute("opacity");0<opacity&&(opacity-=.01,a.setAttribute("opacity",opacity),b/=2,Ext.defer(h,b,this,[a,b]))};g.setAttribute("opacity",1);h(g,1E3)}})}},items:[{itemId:"terms",width:100,layout:"fit",listeners:{filterchange:function(a){var b=this.getTargetEl(),
e=b.getWidth(),f=b.getHeight(),g=a.getCount();terms=a.getRange().map(function(a,b){return{term:a.getTerm(),col:Voyant.application.getColorForTerm(a.getTerm(),!0),x:e/2,y:b*f/g}});terms.sort(function(a,b){return a.term.localeCompare(b.term)});a=d3.select(b.dom).append("svg").attr("width",e).attr("height",f).append("g").attr("transform","translate(-.5,-.5)");var h=Math.ceil(f/terms.length),k=a.selectAll("ytext").data(terms).enter().append("text").text(function(a,b){return a.term}).attr("class","ytext").attr("text-anchor",
"middle").attr("x",e/2).attr("y",function(a,b){return h*b}).attr("fill",function(a){return Voyant.application.getColorForTerm(a.term,!0)}),h=Math.ceil(f/terms.length),l=d3.fisheye.circular().radius(50).distortion(2);yFisheye=d3.fisheye.scale(d3.scaleIdentity).domain([0,f]);var m=this;a.on("mousemove",function(){var a=d3.mouse(this);currentItem=Math.round(a[1]*terms.length/f);currentItem=Math.min(currentItem,terms.length-1);l.focus(a[1]);yFisheye.focus(a[1]);var b=k.nodes();b[currentItem]&&m.fireEvent("termHovered",
m,b[currentItem].textContent);var c=14,d=Math.max(a[1],c),e=1;d3.select(b[currentItem]).attr("y",function(a){return d}).attr("font-size",c).attr("fill-opacity",e);for(var g=void 0,h=currentItem-1;-1<h;h--)8<=c?(d-=c,c-=.5):(void 0==g&&(g=d/h),d-=g),.1<e&&(e-=.05),d3.select(b[h]).attr("y",function(a){return d}).attr("font-size",c).attr("fill-opacity",e);c=14;d=Math.max(a[1],c);e=1;g=void 0;h=currentItem+1;for(a=terms.length;h<a;h++)8<=c?(d+=c,c-=.5):(void 0==g&&(g=(f-d)/(a-h)),d+=g),.1<e&&(e-=.05),
d3.select(b[h]).attr("y",function(a){return d}).attr("font-size",c).attr("fill-opacity",e)})}}},{itemId:"threads",layout:"fit",flex:1,listeners:{filterchange:function(a){var b=this.getTargetEl(),e=b.getWidth(),f=b.getHeight();b.setHtml(" ");terms=a.getRange().map(function(a){return{term:a.getTerm(),vals:a.getDistributions()}});var g=d3.select(b.dom).append("svg").attr("width",b.getWidth()).attr("height",b.getHeight());if(0==terms.length)return this.up("panel").toastInfo("No hits");var h=e/terms[0].vals.length,
k=d3.scaleLinear().domain([Ext.Array.min(terms.map(function(a){return Ext.Array.min(a.vals)})),Ext.Array.max(terms.map(function(a){return Ext.Array.max(a.vals)}))]).range([0,f-2]),l=d3.line().curve(d3.curveCardinal).x(function(a,b){return h/2+h*b}).y(function(a){return f-1-k(a)}),m=g.append("g").attr("opacity",0),n=m.append("rect").attr("fill","white").attr("text-anchor","middle").attr("alignment-baseline","middle").attr("stroke","rgba(0,0,0,.05)").attr("class","rect").attr("x",100).attr("y",100).attr("width",
70).attr("height",16).attr("opacity",1),q=m.append("text").attr("text-anchor","middle").attr("alignment-baseline","middle").attr("x",100).attr("y",100).text("testing");terms.forEach(function(a){var b=Voyant.application.getColorForTerm(a.term,!0);g.append("path").datum(a.vals).attr("fill","none").attr("stroke",b).attr("opacity",.5).attr("stroke-linejoin","round").attr("stroke-linecap","round").attr("stroke-width",1).attr("class","line").attr("d",l);g.append("path").datum(a.vals).attr("fill","none").attr("stroke",
b).attr("opacity",0).attr("stroke-width",3).attr("class","line").attr("term",a.term).attr("d",l).on("mouseover",function(){d3.select(this).attr("opacity",1);var c=d3.mouse(this);m.attr("opacity",1);n.attr("x",c[0]-35).attr("y",c[1]-8+(c[1]>f/2?-18:18));q.text(a.term).attr("fill",b).attr("x",c[0]).attr("y",c[1]+(c[1]>f/2?-18:18))}).on("mouseout",function(){d3.select(this).attr("opacity",0);m.attr("opacity",0)});m.raise()},this)}}}],dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",
items:[{text:this.localize("controls"),tooltip:this.localize("controlsTip"),menu:{items:b}}]}]});this.on("loadedCorpus",function(a,b){var e=1==b.getDocumentsCount()?b.getDocumentTerms():b.getCorpusTerms();e.on("load",function(){this.updateControlsFromStore();this.filterRecords()},this);e.on("filterchange",function(){this.getComponent("terms").fireEventArgs("filterchange",arguments);this.getComponent("threads").fireEventArgs("filterchange",arguments)},this);this.setStore(e);params=this.getApiParams();
Ext.apply(params,{withDistributions:!0});e.load({callback:function(a,b,c){this.filterRecords()},scope:this,params:params})},this);this.callParent(arguments)},filterRecords:function(){var a=this.getStore();a.clearFilter();a.filterBy(function(a){return Ext.Array.every(this.getControls().getRange(),function(c){return 0==c.getEnabled()||c.getValidateRecord().call(c,a)},this)},this)},updateControlsFromStore:function(){var a=this.getStore();this.getControls().each(function(b){b.suspendEvent("change");b.initControl.call(this,
a);void 0===b.getMin()&&b.setMin(0);void 0==b.getLow()&&b.setLow(b.getMin());void 0===b.getMax()&&b.setMax(1);void 0==b.getHigh()&&b.setHigh(b.getMax());b.resumeEvent("change");b.fireEvent("change",b)})},revalidate:function(){var a=this.body.down("canvas").dom,b=a.getContext("2d");b.clearRect(0,0,a.width,a.height);var c=this.query("loomcontrol"),d=new Voyant.panel.LoomTermRecords;this.getStore().each(function(a){var b=a.getDistributions().map(function(a){return!0});Ext.Array.each(c,function(c){if(c.getChecked()&&
c.validateRecord){c=c.validateRecord.call(this,c.getField(),a,a.getDistributions());if(Ext.isBoolean(c)&&!c)return b=!1;if(Ext.isArray(c)){for(var d=0;d<b.length;d++)b[d]=b[d]&&c[d];return Ext.Array.some(b,function(a){return a})}}});Ext.isArray(b)&&Ext.Array.some(b,function(a){return a})&&d.add(a)});d.update(a,b)}});
...
{text:this.localize("docsLabel"),itemId:"docs",xtype:"menucheckitem"},{text:this.localize("termsLabel"),itemId:"terms",xtype:"menucheckitem"}],listeners:{afterrender:function(a){var b=this.getApiParam("label");a.items.each(function(a){a.setChecked(-1<b.indexOf(a.getItemId()))})},click:function(a,b){var c=this.getApiParam("label"),d=b.getItemId();Ext.isString(c)&&(c=[c]);b.checked&&-1==c.indexOf(d)?c.push(d):!b.checked&&-1<c.indexOf(d)&&(c=c.filter(function(a){return a!=d}));this.setApiParam("label",
c);this.doLabels();this.queryById("chart").redraw()},scope:this}}}]},listeners:{query:function(a,b){this.getTermStore().filter([{property:"term",value:b,anyMatch:!0}]);this.filterChart(b)},scope:this}},{itemId:"optionsPanel",title:this.localize("options"),region:"west",split:!0,collapsible:!0,collapseMode:"header",width:135,scrollable:"y",layout:{type:"vbox",align:"stretch"},defaults:{xtype:"button",margin:"5",labelAlign:"top"},items:[{xtype:"label",text:this.localize("input")},{xtype:"documentselectorbutton"},
{text:this.localize("freqsMode"),itemId:"comparisonType",glyph:"xf201@FontAwesome",tooltip:this.localize("freqsModeTip"),menu:{items:[{text:this.localize("rawFrequencies"),itemId:"comparisonType_raw",group:"freqsMode",xtype:"menucheckitem"},{text:this.localize("relativeFrequencies"),itemId:"comparisonType_relative",group:"freqsMode",xtype:"menucheckitem"},{text:this.localize("tfidf"),itemId:"comparisonType_tfidf",group:"freqsMode",xtype:"menucheckitem"}],listeners:{click:function(a,b){if(void 0!==
b){var c=b.getItemId().split("_")[1];c!==this.getApiParam("comparisonType")&&(this.setApiParam("comparisonType",c),this.loadFromApis(!0))}},scope:this}}},{fieldLabel:this.localize("numTerms"),itemId:"limit",xtype:"numberfield",minValue:5,listeners:{change:function(a,b,c){function d(){this.setApiParam("limit",b);this.loadFromApis()}null!==c&&(null!==this.getTermsTimeout()&&clearTimeout(this.getTermsTimeout()),a.isValid()&&this.setTermsTimeout(setTimeout(d.bind(this),500)))},scope:this}},{xtype:"container",
...
{text:this.localize("docSim"),itemId:"analysis_docSim",group:"analysis",xtype:"menucheckitem"}],listeners:{click:function(a,b){if(void 0!==b){var c=b.getItemId().split("_")[1];c!==this.getApiParam("analysis")&&(this.doAnalysisChange(c),this.loadFromApis(!0))}},scope:this}}},{fieldLabel:this.localize("perplexity"),itemId:"perplexity",xtype:"slider",minValue:5,maxValue:100,increment:1,listeners:{changecomplete:function(a,b){this.setApiParam("perplexity",b);this.loadFromApis(!0)},scope:this}},{fieldLabel:this.localize("iterations"),
...
group:"clusters",xtype:"menucheckitem"},{text:"5",itemId:"clusters_5",group:"clusters",xtype:"menucheckitem"}],listeners:{click:function(a,b){if(void 0!==b){var c=parseInt(b.getItemId().split("_")[1]);c!==this.getApiParam("clusters")&&(this.setApiParam("clusters",c),this.loadFromApis(!0))}},scope:this}}},{text:this.localize("dimensions"),itemId:"dimensions",glyph:"xf1b2@FontAwesome",menu:{items:[{text:"2",itemId:"dimensions_2",group:"dimensions",xtype:"menucheckitem"},{text:"3",itemId:"dimensions_3",
group:"dimensions",xtype:"menucheckitem"}],listeners:{click:function(a,b){if(void 0!==b){var c=parseInt(b.getItemId().split("_")[1]);if(c!==this.getApiParam("dimensions")){if(3==c&&"ca"==this.getApiParam("analysis")&&3==this.getCorpus().getDocumentsCount())return!1;this.setApiParam("dimensions",c);this.loadFromApis(!0)}}},scope:this}}},{itemId:"reloadButton",text:this.localize("reload"),glyph:"xf021@FontAwesome",handler:function(){this.loadFromApis()},scope:this}]},{itemId:"termsGrid",xtype:"grid",
title:this.localize("terms"),region:"east",width:250,split:!0,collapsible:!0,collapseMode:"header",forceFit:!0,features:[{ftype:"grouping",hideGroupedHeader:!0,enableGroupingMenu:!1}],bbar:{overflowHandler:"scroller",items:[{itemId:"nearbyButton",xtype:"button",text:this.localize("nearby"),glyph:"xf0b2@FontAwesome",flex:1,handler:function(a){var b=a.up("panel").getSelection()[0];void 0===b?this.toastError({html:this.localize("noTermSelected"),anchor:a.up("panel").getTargetEl()}):(a=b.get("term"),
this.getNearbyForTerm(a))},scope:this},{itemId:"removeButton",xtype:"button",text:this.localize("remove"),glyph:"xf068@FontAwesome",flex:1,handler:function(a){var b=a.up("panel").getSelection()[0];void 0===b?this.toastError({html:this.localize("noTermSelected"),anchor:a.up("panel").getTargetEl()}):(a=b.get("term"),this.removeTerm(a))},scope:this}]},tbar:{overflowHandler:"scroller",items:[{xtype:"querysearchfield",itemId:"addTerms",flex:1}]},columns:[{text:this.localize("term"),dataIndex:"term",flex:1,
sortable:!0},{text:this.localize("rawFreq"),dataIndex:"rawFreq",flex:.75,minWidth:70,sortable:!0},{text:this.localize("relFreq"),dataIndex:"relativeFreq",flex:.75,minWidth:70,sortable:!0,hidden:!0}],selModel:{type:"rowmodel",mode:"SINGLE",allowDeselect:!0,toggleOnClick:!0,listeners:{selectionchange:{fn:function(a,b){var c=b[0];if(void 0!==c){var d=c.get("term"),c="document"===c.get("category");this.selectTerm(d,c);c?(this.queryById("nearbyButton").disable(),this.queryById("removeButton").disable()):
(this.queryById("nearbyButton").enable(),this.queryById("removeButton").enable())}else this.selectTerm()},scope:this}}},store:this.getTermStore(),listeners:{expand:function(a){a.getView().refresh()},query:function(a,b){0<b.length&&-1===this.getTermStore().findExact("term",b[0])?(this.setNewTerm(b),this.loadFromApis()):this.setNewTerm(null)},scope:this}}]});this.on("boxready",function(a,b,c){400>b&&(this.queryById("optionsPanel").collapse(),this.queryById("termsGrid").collapse());this.config.storeClass&&
this.config.storeData&&this.loadStoreFromJson(this.config.storeClass,this.config.storeData)},this);this.on("beforedestroy",function(a){a=this.queryById("chart");null!==a&&this.queryById("chartParent").remove(a)},this);this.on("loadedCorpus",function(a,b){var c=function(a){var b=this.getApiParam(a);this.queryById(a).down("#"+a+"_"+b).setChecked(!0)}.bind(this);c("analysis");this.doAnalysisChange(this.getApiParam("analysis"));c("comparisonType");c("clusters");this.queryById("perplexity").setValue(this.getApiParam("perplexity"));
this.queryById("iterations").setValue(this.getApiParam("iterations"));3==b.getDocumentsCount()&&this.setApiParam("dimensions",2);c("dimensions");this.getCaStore().setCorpus(b);this.getPcaStore().setCorpus(b);this.getDocSimStore().setCorpus(b);this.loadFromApis()},this);this.on("documentsSelected",function(a,b){this.setApiParam("docId",b);this.loadFromApis()},this);this.callParent(arguments)},doAnalysisChange:function(a){this.setApiParam("analysis",a);this.queryById("nearbyButton").setDisabled("tsne"===
a);this.queryById("reloadButton").setVisible("tsne"===a);this.queryById("perplexity").setVisible("tsne"===a);this.queryById("iterations").setVisible("tsne"===a);"ca"===a&&3==this.getCorpus().getDocumentsCount()&&(this.setApiParam("dimensions",2),this.queryById("dimensions").menu.items.get(0).setChecked(!0))},loadStoreFromJson:function(a,b){"Voyant.data.store.CAAnalysis"==a?(this.getCaStore().loadRawData(b),this.doAnalysisChange("ca"),this.maskAndBuildChart.call(this,this.getCaStore())):"Voyant.data.store.PCAAnalysis"==
a?(this.getPcaStore().loadRawData(b),this.doAnalysisChange("pca"),this.maskAndBuildChart.call(this,this.getPcaStore())):"Voyant.data.store.TSNEAnalysis"==a?(this.getTsneStore().loadRawData(b),this.doAnalysisChange("tsne"),this.maskAndBuildChart.call(this,this.getTsneStore())):"Voyant.data.store.DocSimAnalysis"==a&&(this.getDocSimStore().loadRawData(b),this.doAnalysisChange("docSim"),this.maskAndBuildChart.call(this,this.getDocSimStore()))},maskAndBuildChart:function(a){this.queryById("chartParent").mask(this.localize("plotting"));
Ext.defer(this.buildChart,50,this,[a])},buildChart:function(a){var b=this,c=this.queryById("chart");null!==c&&this.queryById("chartParent").remove(c);this.queryById("termsGrid").getSelectionModel().deselectAll();var c=a.getAt(0),d=this.getApiParam("dimensions");a="";if("pca"===this.getApiParam("analysis")){for(var e=c.getPrincipalComponents(),f=0,g=0;g<e.length;g++)f+=parseFloat(e[g].get("eigenValue"));if(0!=f){a=this.localize("pcTitle")+"\n";for(var h=["xAxis","yAxis","fill"],g=0;g<e.length&&!(g>=
d);g++){var k=e[g].get("eigenValue")/f*100;a+=this.localize("pc")+" "+(g+1)+" ("+this.localize(h[g])+"): "+Math.round(100*k)/100+"%\n"}}}else if("tsne"!==this.getApiParam("analysis"))for(a=this.localize("caTitle")+"\n",h=["xAxis","yAxis","fill"],e=c.getDimensions(),g=0;g<e.length&&!(g>=d);g++)k=e[g].get("percentage"),a+=this.localize("dimension")+" "+(g+1)+" ("+this.localize(h[g])+"): "+Math.round(100*k)/100+"%\n";var l=0,m=Number.MAX_VALUE,n=0,q=Number.MAX_VALUE;"docSim"!==this.getApiParam("analysis")&&
this.getTermStore().removeAll();var r=[],p=[];c.getTokens().forEach(function(a){var b=a.get("rawFreq"),c=a.get("category");void 0===c&&(c="term",a.set("category","term"));var e="term"===c;e&&(b>l&&(l=b),b<m&&(m=b));this.getTermStore().findExact("term",-1===a.get("term"))&&this.getTermStore().addSorted(a);if(3===d){var f=a.get("vector")[2];void 0!==f&&(f<q&&(q=f),f>n&&(n=f))}b={x:a.get("vector")[0],y:a.get("vector")[1],z:a.get("vector")[2],term:a.get("term"),rawFreq:b,relativeFreq:a.get("relativeFreq"),
cluster:a.get("cluster"),category:c,disabled:!1};e?r.push(b):("bin"===a.get("category")?b.term=b.title="Bin "+a.get("docIndex"):(b.docIndex=a.get("docIndex"),a=this.getCorpus().getDocument(b.docIndex),null!==a&&(b.term=a.getShortTitle(),b.title=a.getTitle())),p.push(b))},this);c=this.getTermStore().getCount();this.queryById("limit").setRawValue(c);this.setApiParam("limit",c);c=Ext.create("Ext.data.JsonStore",{fields:"term x y z rawFreq relativeFreq cluster category docIndex disabled".split(" "),data:r});
g=Ext.create("Ext.data.JsonStore",{fields:"term x y z rawFreq relativeFreq cluster category docIndex disabled".split(" "),data:p});a={itemId:"chart",xtype:"cartesian",interactions:["crosszoom","panzoom","itemhighlight"],plugins:{ptype:"chartitemevents"},axes:[{type:"numeric",position:"bottom",fields:["x"],label:{rotate:{degrees:-30}}},{type:"numeric",position:"left",fields:["y"]}],sprites:[{type:"text",text:a,x:70,y:70}],innerPadding:{top:25,right:25,bottom:25,left:25},series:[{type:"customScatter",
xField:"x",yField:"y",store:c,label:{font:"14px Helvetica",field:"term",display:"over"},tooltip:{trackMouse:!0,style:"background: #fff",renderer:function(a,c,d){a.setHtml(b.tokenFreqTipTemplate.apply([c.get("term"),c.get("rawFreq"),c.get("relativeFreq")]))}},marker:{type:"circle"},highlight:{fillStyle:"yellow",strokeStyle:"black"},renderer:function(a,c,e,f){a=e.store.getAt(f);if(null!==a){var g=a.get("cluster");-1===g&&(g=0);e=.65;f=1;!0===a.get("disabled")?f=e=.1:3===d&&a.get("z")&&(e=b.interpolate(a.get("z"),
q,n,0,1));g=b.getApplication().getColor(g);c.fillStyle="rgba("+g.join(",")+","+e+")";c.strokeStyle="rgba("+g.join(",")+","+f+")";a=a.get("rawFreq");a=b.interpolate(a,m,l,2,20);c.radius=a}},scope:this},{type:"customScatter",xField:"x",yField:"y",store:g,label:{font:"14px Helvetica",field:"term",display:"over",color:this.getDefaultDocColor(!0)},tooltip:{trackMouse:!0,style:"background: #fff",renderer:function(a,c,d){a.setHtml(b.docFreqTipTemplate.apply([c.get("title"),c.get("rawFreq")]))}},marker:{type:"diamond"},
highlight:{fillStyle:"yellow",strokeStyle:"black"},renderer:function(a,c,e,f){a=e.store.getAt(f);null!==a&&(e=a.get("cluster"),e=-1===e||"docSim"!==b.getApiParam("analysis")?b.getDefaultDocColor():b.getApplication().getColor(e),f=.65,3===d&&a.get("z")&&(f=b.interpolate(a.get("z"),q,n,0,1)),c.fillStyle="rgba("+e.join(",")+","+f+")",c.strokeStyle="rgba("+e.join(",")+",1)",c.radius=5)},scope:this}],listeners:{itemclick:function(a,b,c){a=b.record.data;"doc"===a.category?(a=this.getCorpus().getDocument(a.docIndex),
this.getApplication().dispatchEvent("documentsClicked",this,[a])):"term"===a.category&&(a=Ext.create("Voyant.data.model.CorpusTerm",a),this.getApplication().dispatchEvent("corpusTermsClicked",this,[a]))},render:function(a){a.body.on("contextmenu",function(a,b){a.preventDefault();var c=a.getXY(),d=Ext.fly(b).getXY(),e=c[0]-d[0],d=c[1]-d[1],f=this.down("#chart").getItemForPoint(e,d);null!=f&&"term"===f.record.get("category")&&(e=this.down("#chart").getSeries(),e[0].disableToolTips(),e[1].disableToolTips(),
d=f.record.get("term"),e=(new Ext.Template(this.localize("removeTerm"))).apply([d]),this.getChartMenu().queryById("remove").setText(e),e=(new Ext.Template(this.localize("nearbyTerm"))).apply([d]),d=this.getChartMenu().queryById("nearby"),d.setText(e),d.setDisabled("tsne"===this.getApiParam("analysis")),this.getChartMenu().on("click",function(a,b){if(void 0!==b){var c=f.record.get("term");"nearby"===b.getItemId()?this.getNearbyForTerm(c):this.removeTerm(c)}},this,{single:!0}),this.getChartMenu().showAt(c))},
this)},scope:this}};a=Ext.create("Ext.chart.CartesianChart",a);this.queryById("chartParent").insert(0,a);this.queryById("chartParent").unmask();this.doLabels();null!==this.getNewTerm()&&(this.selectTerm(this.getNewTerm()[0]),this.setNewTerm(null))},getDefaultDocColor:function(a){return this.getApplication().getColor(6,a)},doLabels:function(){var a=this.queryById("chart"),b=a.getSeries(),a=a.getSurface("chart").getItems()[0],c=this.getApiParam("label");-1<c.indexOf("summary")?a.show():a.hide();-1<
c.indexOf("terms")?b[0].getLabel().show():b[0].getLabel().hide();-1<c.indexOf("docs")?b[1].getLabel().show():b[1].getLabel().hide()},selectTerm:function(a,b){var c=this.down("#chart");if(null!==c)if(void 0===a)c.getSeries()[0].setHighlightItem(null),c.getSeries()[1].setHighlightItem(null);else{var d,e;!0===b?(d=c.getSeries()[1],e=d.getStore().findExact("title",a)):(d=c.getSeries()[0],e=d.getStore().findExact("term",a));if(-1!==e){var f=d.getStore().getAt(e),g=d.getSprites()[0],f={series:d,category:d.getItemInstancing()?
"items":"markers",index:e,record:f,field:d.getYField(),sprite:g};d.setHighlightItem(f);b?c.getSeries()[0].setHighlightItem(null):c.getSeries()[1].setHighlightItem(null);c=this.getPointFromIndex(d,e);this.setHighlightData({x:c[0],y:c[1],r:50});null==this.getHighlightTask()&&this.setHighlightTask(Ext.TaskManager.newTask({run:this.doHighlight,scope:this,interval:25,repeat:this.getHighlightData().r}));this.getHighlightTask().restart()}}},getPointFromIndex:function(a,b){var c=a.getSprites()[0];return null!==
c.surfaceMatrix?c.attr.matrix.clone().prependMatrix(c.surfaceMatrix).transformPoint([c.attr.dataX[b],c.attr.dataY[b]]):[0,0]},doHighlight:function(){var a=this.down("#chart");if(0<this.getHighlightData().r){for(var b=a.getSurface(),c=null,d=b.getItems(),e=0;e<d.length;e++){var f=d[e];if("customHighlight"==f.id){c=f;break}}null==c?b.add({id:"customHighlight",type:"circle",strokeStyle:"red",fillStyle:"none",radius:this.getHighlightData().r,x:this.getHighlightData().x,y:this.getHighlightData().y}):(c.setAttributes({x:this.getHighlightData().x,
y:this.getHighlightData().y,radius:this.getHighlightData().r}),this.getHighlightData().r-=1.5,0>=this.getHighlightData().r&&(this.getHighlightData().r=0,b.remove(c,!0)));a.redraw()}},filterChart:function(a){Ext.isString(a)&&(a=[a]);for(var b=[],c=0;c<a.length;c++)b.push(new RegExp(a[c]));a=this.queryById("chart");var c=a.getSeries()[0],d=c.getLabel();c.getStore().each(function(a){var c=!1;if(0==b.length)c=!0;else for(var g=0;g<b.length&&!(c=c||b[g].test(a.get("term")));g++);a.set("disabled",!c);a=
a.store.indexOf(a);d.setAttributesFor(a,{hidden:!c})},this);a.redraw()},getCurrentTerms:function(){var a=[];this.getTermStore().each(function(b){"term"===b.get("category")&&a.push(b.get("term"))});return a},getNearbyForTerm:function(a){var b=Math.max(2E3,Math.round(this.getCorpus().getWordTokensCount()/100));this.setApiParams({limit:b,target:a});this.loadFromApis();this.setApiParam("target",void 0)},removeTerm:function(a){var b=this.down("#chart").getSeries()[0],c=b.getStore().findExact("term",a);
b.getStore().removeAt(c);c=this.getTermStore().findExact("term",a);this.getTermStore().removeAt(c);a=this.getTermStore().getCount();this.queryById("limit").setRawValue(a)},loadFromApis:function(a){this.queryById("chartParent").mask(this.localize("analyzing"));var b={},c=this.getCurrentTerms();null!==this.getNewTerm()&&(c=c.concat(this.getNewTerm()),this.setApiParam("limit",c.length));0<c.length&&(null!==this.getNewTerm()||a)&&(b.query=c.join(","));Ext.apply(b,this.getApiParams());null!=b.target&&
(b.term=c);"pca"===b.analysis?this.getPcaStore().load({params:b}):"tsne"===b.analysis?this.getTsneStore().load({params:b}):"docSim"===b.analysis?this.getDocSimStore().load({params:b}):this.getCaStore().load({params:b})},interpolate:function(a,b,c,d,e){return d+(e-d)*Math.max(0,Math.min(1,(a-b)/(c-b)))}});
...
"_")+")"}).style("font-family",function(a){return b.getApplication().getFeatureForTerm("font",a.data.term)}).style("text-anchor","middle").style("cursor","default");a.append("tspan").attr("class","term").attr("font-size",function(a){return g(a.data.rawFreq)}).attr("x",0).attr("y",function(a){return g(a.data.rawFreq)/4}).text(function(a){return a.data.term});a.append("tspan").attr("class","value").attr("font-size",function(a){return.75*g(a.data.rawFreq)}).attr("x",0).attr("y",function(a){return g(a.data.rawFreq)+
...
inputValue:"raw"},{boxLabel:"relative",name:"withDistributions",inputValue:"relative",style:"margin-left: 1em;"}],listeners:{afterrender:function(a){var b=this.up("window").panel;this.setFieldLabel("frequencies");var c=b.getApiParam("withDistributions");a.getBoxes().forEach(function(a){a.setBoxLabel(b.localize(a.inputValue));a.checked=a.inputValue==c});this.setValue({withDistributions:c})}}},{xtype:"colorpaletteoption"}]},statics:{i18n:{},api:{limit:5,stopList:"auto",query:void 0,withDistributions:"relative",
bins:10,docIndex:void 0,docId:void 0,mode:"corpus",chartType:"barline",labels:!1},glyph:"xf201@FontAwesome"},layout:"fit",documentTermsStore:void 0,constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(){this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);Ext.apply(this,{title:this.localize("title"),dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"querysearchfield"},
{itemId:"reset",text:this.localize("reset"),tooltip:this.localize("resetTip"),handler:function(a){this.setApiParams({docIndex:void 0,mode:void 0,query:void 0});this.loadCorpusTerms()},scope:this},{text:this.localize("display"),tooltip:this.localize("displayTip"),glyph:"xf013@FontAwesome",menu:{listeners:{afterrender:function(a){var b=this.getApiParam("chartType");a.items.each(function(a){a.getItemId()==b&&a.addCls(a.activeCls)})},scope:this},defaults:{xtype:"menuitem",handler:function(a,b){"menucheckitem"==
a.xtype?this.setApiParam("labels",a.checked):this.setApiParam("chartType",a.getItemId());this.loadCorpusTerms()},scope:this},items:[{xtype:"menucheckitem",text:this.localize("labels"),tooltip:this.localize("labelsTip"),checked:!0===this.getApiParam("labels")||"true"==this.getApiParam("labels")},"-",{itemId:"area",text:this.localize("area"),tooltip:this.localize("areaTip"),glyph:"xe76b@Sencha-Examples"},{itemId:"bar",text:this.localize("bar"),tooltip:this.localize("barTip"),glyph:"xe768@Sencha-Examples"},
{itemId:"line",text:this.localize("line"),tooltip:this.localize("lineTip"),glyph:"xe773@Sencha-Examples"},{itemId:"stacked",text:this.localize("stacked"),tooltip:this.localize("stackedTip"),glyph:"xe6c8@Sencha-Examples"},{itemId:"barline",text:this.localize("barline"),tooltip:this.localize("barlineTip"),glyph:"xe779@Sencha-Examples"}]}}]}]});this.callParent(arguments)},listeners:{loadedCorpus:function(a,b){this.loadCorpusTerms()},termsClicked:function(a,b){var c=[];b.forEach(function(a){Ext.isString(a)?
c.push(a):a.term?c.push(a.term):a.getTerm&&c.push(a.getTerm())});this.setApiParam("query",c&&0<c.length?c:void 0);this.loadCorpusTerms()},corpusTermsClicked:function(a,b){this.setApiParam("query",b.map(function(a){return a.getTerm()}));this.loadCorpusTerms()},documentSelected:function(a,b){this.setApiParam("docIndex",this.getCorpus().getDocument(b).getIndex());this.loadDocumentTerms()},documentsClicked:function(a,b){1==b.length&&this.fireEvent("documentSelected",this,b[0])},query:function(a,b){this.fireEvent("termsClicked",
this,b)}},loadCorpusTerms:function(a){if(2>this.getCorpus().getDocumentsCount()||"document"==this.getApiParam("mode")||0<Array.from(this.getApiParam("docIndex")||"").length)return this.loadDocumentTerms();if(this.getApiParam("query")){a=a||{};var b=this.getApiParam("withDistributions");Ext.applyIf(a,{bins:this.getCorpus().getDocumentsCount(),limit:1E3,stopList:""});var c=this.getCorpus().map(function(a){return a.getTinyTitle()});Ext.applyIf(a,this.getApiParams());this.getCorpus().getCorpusTerms().load({params:a,
callback:function(a,e,f){var g=[],h=[],k=this.getApiParam("chartType");a.forEach(function(a,d){var e=a.get("term");a.get("docIndex");var f=this.getApplication().getColorForTerm(e,!0);a.get("distributions").forEach(function(a,f){g[f]||(g[f]={index:c[f]});g[f]["_"+d]="relative"==b?a.toFixed(7):a;g[f]["term"+d]=e},this);"bar"!=k&&("barline"==k?["bar","line"]:[k]).forEach(function(a){h.push({type:"stacked"==a?"bar":a,title:e,xField:"index",yField:"_"+d,term:e,colors:[f],label:"barline"==k&&"bar"==a?{display:"none"}:
{field:"term"+d}})},this)},this);e=a.map(function(a){return a.getTerm()});f=e.map(function(a){return this.getApplication().getColorForTerm(a,!0)},this);"bar"==k&&h.push({type:"bar",title:e,colors:f,xField:"index",yField:0<g.length?Object.keys(g[0]).filter(function(a){return"_"==a.charAt(0)}):void 0,label:{field:a.map(function(a,b){return"term"+b})}});a=Ext.create("Ext.data.JsonStore",{fields:0<g.length?Object.keys(g[0]):void 0,data:g});this.buildChart({store:a,series:h,axes:[{type:"numeric",position:"left",
increment:1,title:{text:this.localize(this.getApiParam("withDistributions")+"Title")}},{type:"category",position:"bottom",title:{text:this.localize("corpusTitle")}}]})},scope:this})}else this.getCorpus().getCorpusTerms().load({params:{limit:5,stopList:this.getApiParam("stopList")},callback:function(a,b,c){this.setApiParam("query",a.map(function(a){return a.getTerm()}));this.loadCorpusTerms()},scope:this})},getItemToolTip:function(a,b,c){var d=c.field.split("_"),e=2==d.length?c.index:d[2],d=parseInt(d[1]),
f=c.series.getTitle(),f=Ext.isArray(f)?f[d]:f,g=c.series.getColors();b="\x3cspan class\x3d'x-legend-item-marker' style\x3d'background:"+(1==g.length?g[0]:g[d])+"; left: 2px;'\x3e\x3c/span\x3e \x3cspan style\x3d'padding-left: 1.2em; font-weight: bold;'\x3e"+f+"\x3c/span\x3e: "+b.get(c.field)+"\x3cbr/\x3e\x3ci\x3e"+this.getCorpus().getDocument(e).getShortTitle()+"\x3c/i\x3e";b="corpus"==this.getApiParam("mode")?b+("\x3cdiv style\x3d'font-size: smaller'\x3e"+this.localize("dblClickItem")):b+("\x3cbr/\x3e"+
this.localize("segment")+" "+(c.index+1));a.setHtml(b)},loadDocumentTerms:function(a){if(this.getApiParam("query")){this.setApiParam("mode","document");a=a||{};var b=this.getApiParam("withDistributions");Ext.applyIf(a,{limit:0,sort:"termasc",stopList:void 0});this.getCorpus().map(function(a){return a.getTinyTitle()});var c;c=1==this.getCorpus().getDocumentsCount()?this.getCorpus().getDocument(0):this.getCorpus().getDocument(this.getApiParam("docIndex"));Ext.applyIf(a,this.getApiParams());this.getCorpus().getDocumentTerms().load({params:a,
callback:function(a,e,f){var g=[],h=[],k=this.getApiParam("chartType");c||a.sort(function(a,b){return a.getTerm()==b.getTerm()?a.getDocIndex()-b.getDocIndex():a.getTerm().localeCompare(b.getTerm())});a.forEach(function(a,d){var e=a.get("term"),f=a.get("docIndex"),l=c?this.getApplication().getColorForTerm(e,!0):this.getApplication().getColor(f,!0),f=a.get("docIndex");a.get("distributions").forEach(function(a,c){g[c]||(g[c]={docIndex:f,index:c+1});g[c]["_"+d+"_"+f]="relative"==b?a.toFixed(7):a;g[c]["term"+
d]=e},this);"bar"!=k&&("barline"==k?["bar","line"]:[k]).forEach(function(a){h.push({type:"stacked"==a?"bar":a,title:c?e:f+1+") "+e,xField:"index",yField:"_"+d+"_"+f,term:e,colors:[l],label:"barline"==k&&"bar"==a?{display:"none"}:{field:"term"+d}})},this)},this);if("bar"==k){var l=Ext.Array.unique(a.map(function(a){return a.getTerm()})).length;e=a.map(function(a){return 1+a.get("docIndex")+") "+a.getTerm()});a=a.map(function(a){return l?this.getApplication().getColor(a.get("docIndex"),!0):this.getApplication().getColorForTerm(a.getTerm(),
!0)},this);h.push({type:"bar",title:0<e.length?e:this.localize("noResults"),colors:a,xField:"index",yField:0<g.length?Object.keys(g[0]).filter(function(a){return"_"==a.charAt(0)}):void 0,label:{field:e}})}a=Ext.create("Ext.data.JsonStore",{fields:0<g.length?Object.keys(g[0]):void 0,data:g});this.buildChart({store:a,series:h,axes:[{type:"numeric",position:"left",title:{text:this.localize(this.getApiParam("withDistributions")+"Title")}},{type:"category",position:"bottom",title:{text:this.localize("segmentsTitle")+
(c?" ("+c.getShortTitle()+")":"")}}]})},scope:this})}else this.getCorpus().getCorpusTerms().load({params:{limit:2>this.getCorpus().getDocumentsCount()?5:2,stopList:this.getApiParam("stopList")},callback:function(a,b,c){this.setApiParam("query",a.map(function(a){return a.getTerm()}));this.loadDocumentTerms()},scope:this})},buildChart:function(a){var b=this.getApiParam("chartType"),c=!1;if(!0===this.getApiParam("labels")||"true"==this.getApiParam("labels"))c=!0;Ext.applyIf(a,{cls:this.getApiParam("mode")});
a.series.forEach(function(a){Ext.applyIf(a,{stacked:"bar"==a.type?!1:!0,showInLegend:"barline"==b&&"line"==a.type?!1:!0,smooth:!0,showMarkers:"bar"==a.type?!1:!0,marker:"barline"==b&&"line"==a.type?null:{type:"circle",radius:2},style:{lineWidth:1,fillOpacity:"barline"==b&&"bar"==a.type?.01:1,strokeOpacity:"barline"==b&&"bar"==a.type?.1:1},highlight:!0,highlightCfg:{scaling:"bar"==a.type?1.1:2},label:{},tooltip:{trackMouse:!0,renderer:this.getItemToolTip,scope:this},listeners:{itemclick:function(a,
b,c,d){this.clickTimer&&clearTimeout(this.clickTimer);if(!this.blockClick)if(this.blockClick=!0,Ext.defer(function(){this.blockClick=!1},1E3,this),"document"==this.getApiParam("mode"))a=b.field.split("_"),c=a[2],c=this.getCorpus().getDocument(c).get("tokensCount-lexical"),c=parseInt(b.index*c/parseInt(this.getApiParam("bins"))),this.dispatchEvent("documentIndexTermsClicked",this,[{term:b.series.term,docIndex:a[2],position:c}]);else{this.clickTimer&&clearTimeout(this.clickTimer);var e=this;this.clickTimer=
setTimeout(function(){e.dispatchEvent("documentIndexTermsClicked",e,[{term:b.series.term,docIndex:b.index}])},300)}},itemdblclick:function(a,b,c,d){this.clickTimer&&clearTimeout(this.clickTimer);this.blockClick=!0;Ext.defer(function(){this.blockClick=!1},1E3,this);"document"!=this.getApiParam("mode")&&Ext.create("Ext.menu.Menu",{items:[{text:this.localize("drillTerm"),tooltip:this.localize("drillTermTip"),handler:function(){this.setApiParams({mode:"document",query:b.series.term});this.loadDocumentTerms()},
scope:this},{text:this.localize("drillDocument"),tooltip:this.localize("drillDocumentTip"),handler:function(){this.setApiParams({mode:"document",docIndex:b.index});this.loadDocumentTerms()},scope:this}],listeners:{hide:function(a){Ext.defer(function(){this.destroy()},200,a)},scope:this}}).showAt(c.pageX,c.pageY)},scope:this}});Ext.applyIf(a.label,{display:"over",field:"index",fontSize:11,translateY:"line"==b?9:void 0});c||(a.label.display="none")},this);Ext.applyIf(a,{animation:!0,plugins:{ptype:"chartitemevents",
moveEvents:!0},legend:{docked:"top",listeners:{itemclick:function(a,b,c,d){if(a.getStore().getCount()<a.chart.series.length&&"barline"==this.getApiParam("chartType")){var k=b.get("name"),l=b.get("disabled");a.chart.series.forEach(function(a){a.getTitle()==k&&a.setHidden(l)});a.chart.redraw()}},scope:this}},interactions:["itemhighlight","crosszoom"],listeners:{}});Ext.applyIf(a.listeners,{itemhighlightchange:function(a,b){a.el.dom.style.cursor=b?"pointer":""},afterrender:function(){},scope:this});
a.axes.forEach(function(b){Ext.applyIf(b,{title:{},label:{}});Ext.applyIf(b.title,{scaling:.75});Ext.applyIf(b.label,{scaling:.75});if("category"==b.type){var c="";a.store.each(function(a){c+=a.get("index")});c.length>this.getTargetEl().getWidth()/9&&Ext.applyIf(b.label,{rotate:{degrees:-30}});Ext.applyIf(b,{labelInSpan:!0})}},this);this.query("chart").forEach(function(a){this.remove(a,!0)},this);var d=Ext.create("Ext.chart.CartesianChart",a);this.add(d)},reloadFromChart:function(){var a=this.down("chart");
if(a){var b=[];a.series.forEach(function(a){b.push(a.getTitle())});this.fireEvent("termsClicked",this,b)}}});Ext.define("Voyant.panel.NoTool",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.notool",statics:{i18n:{},api:{tool:void 0}},config:{html:void 0,notYetImplemented:"Centroid DocumentInputAdd DocumentTypeCollocateFrequenciesGrid EntitiesBrowser Equalizer FeatureClusters Flowerbed KwicsTagger Lava Mandala MicroSearch NetVizApplet PaperDrill RezoViz Sunburst Termometer Ticker TokensViz ToolBrowser ToolBrowserLarge VoyeurTagline WordCloud VoyeurTagline WordCountFountain".split(" ")},
...
this);this._runCodeContainers(b)},_runCodeContainers:function(a){0<a.length&&(0==Voyant.application.getDeferredCount()&&a.shift().run(!0),Ext.defer(this._runCodeContainers,100,this,[a]))},getExportHtml:function(){var a="";this.items.each(function(b,d){type=b.isXType("notebookcodeeditorwrapper")?"code":"text";content=b.getContent();a+="\x3cdiv class\x3d'notebook-editor-wrapper "+b.xtype+"'\x3e\n\x3cdiv class\x3d'notebookwrappercounter'\x3e\x3ca href\x3d'#_"+d+"' name\x3d'"+d+"'\x3e"+(d+1)+"\x3c/a\x3e\x3c/div\x3e";
a="code"==type?a+("\x3cdiv class\x3d'notebook-code-editor ace-chrome'\x3e\n"+b.getTargetEl().query(".ace_text-layer")[0].outerHTML+"\n\x3c/div\x3e\n\x3cdiv class\x3d'notebook-code-results'\x3e\n"+content.output+"\n\x3c/div\x3e\n"):a+(content+"\n");a+="\x3c/div\x3e\n"});var b=window.open();b.document.write("\x3chtml\x3e\x3chead\x3e");b.document.write("\x3ctitle\x3eSpyral Notebooks\x3c/title\x3e");b.document.write(document.getElementById("ace-chrome").outerHTML);b.document.write(document.getElementById("voyant-notebooks-styles").outerHTML);
b.document.write('\x3c/head\x3e\x3cbody class\x3d"exported-notebook"\x3e');b.document.write(a);b.document.write("\x3c/body\x3e\x3c/html\x3e");b.document.close();b.focus()},getExportAllJson:function(){var a=[],b,c,d;this.items.each(function(e){c=e.isXType("notebookcodeeditorwrapper")?"code":"text";d=e.getContent();"code"==c?(/[\r\n]/.test(d.input)&&(d.input=d.input.replace(/\r\n?/,"\n").split(/\n/)),b={type:"code",input:d.input,mode:d.mode,output:this.wrap(d.output)}):b={type:"text",input:this.wrap(d)};
...
this.localize("voyantIs")+"\x3c/div\x3e"+(-1==this.localize("translatedBy").indexOf("English")?"\x3cdiv\x3e"+this.localize("translatedBy")+"\x3c/div\x3e":"")+(this.getCorpusCreatorText&&0<this.getCorpusCreatorText().trim().length?"\x3cdiv id\x3d'corpusCreatorText'\x3e"+this.getCorpusCreatorText()+"\x3c/div\x3e":"")}]},{layout:"fit",itemId:"toolsContainer-main",items:{xtype:c}}]}]});this.callParent(arguments)}});Ext.define("Voyant.panel.MoreLikeThis",{extend:"Ext.panel.Panel",alias:"widget.morelikethis",title:"More Like this"});
