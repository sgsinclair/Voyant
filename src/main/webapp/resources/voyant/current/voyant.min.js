...
this.getApiParam("rtl"),items:[{xtype:"voyantheader",region:"north"},{region:"south",xtype:"voyantfooter"},{region:"center",layout:"card",itemId:"toolsContainer",activeItem:0,items:[{xtype:"container",layout:{type:"vbox",pack:"center",align:"center"},items:[{xtype:"corpuscreator"},{xtype:"container",width:800,html:"\x3cdiv style\x3d'font-style: italic; text-align: center; margin-top: 10px;'\x3e\x3cdiv\x3e"+this.localize("voyantIs")+"\x3c/div\x3e"+(-1==this.localize("translatedBy").indexOf("English")?
"\x3cdiv\x3e"+this.localize("translatedBy")+"\x3c/div\x3e":"")}]},{layout:"fit",itemId:"toolsContainer-main",items:{xtype:c}}]}]});this.callParent(arguments)}});