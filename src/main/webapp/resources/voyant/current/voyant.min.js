...
scope:this})},listeners:{loadedCorpus:function(a,b){this.setCorpus(b);this.on("unhandledEvent",function(a,d,e){a=this.getBaseUrl()+"?corpus\x3d"+b.getAliasOrId();var c=this.getModifiedApiParams()||{};delete c.view;if("termsClicked"==d)c.query=e;else if("documentsClicked"==d){var g=[];e.forEach&&e.forEach(function(a){g.push(a.getIndex())});c.docIndex=g}else if("corpusTermsClicked"==d)e.map&&(c.query=e.map(function(a){return a.getTerm()}));else if("documentTermsClicked"==d)e.map&&(c.query=e.map(function(a){return a.getTerm()}),
