...
"\x3c/i\x3e";for(facet in b)if(0!=b[facet].length){var f="";if("facet.title"!=facet){var g=facet.replace(/^.+?\./,""),m=e.get(g);if(m){var s=Ext.isArray(m);s?f+="\x3cli\x3e"+g+"\x3cul\x3e":m=[m];m.forEach(function(a){var c=!1;b[facet].forEach(function(b){b.label==a?c=!0:-1==b.facet.indexOf("facet")&&b.label.split(/\W+/).forEach(function(b){0<b.trim().length&&-1<a.toLowerCase().indexOf(b.toLowerCase())&&(c=!0)})});f+="\x3cli\x3e"+(s?"":g.replace("extra.","")+": ")+(c?'\x3cspan class\x3d"keyword"\x3e'+
