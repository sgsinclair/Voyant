...
{};this.bubblelines.setCanvasHeight();this.bubblelines.drawGraph()},scope:this}]}],border:!1,layout:"fit",items:{layout:{type:"vbox",align:"stretch"},defaults:{border:!1},items:[{height:30,itemId:"termsView",xtype:"dataview",store:this.termStore,tpl:this.termTpl,itemSelector:"div.term",overItemCls:"over",selectedItemCls:"selected",cls:"selected",focusCls:"",listeners:{beforeitemclick:function(a,c,d,e,f,g){f.preventDefault();f.stopPropagation();a.fireEvent("itemcontextmenu",a,c,d,e,f,g);return!1},
selectionchange:function(a,c){debugger;for(var d=this.down("#termsView"),e=[],f=d.el.query("div[class*\x3dterm]"),g=0;g<f.length;g++)Ext.fly(f[g]).addCls("unselected");var g;for(g=0;g<c.length;g++)f=c[g],e.push(f.get("term")),Ext.fly(d.getNode(f)).removeCls("unselected");for(g in this.lastClickedBubbles)for(term in d=this.lastClickedBubbles[g],d)-1==e.indexOf(type)&&delete this.lastClickedBubbles[g][term];this.setApiParams({typeFilter:e});this.bubblelines.setCanvasHeight();this.bubblelines.drawGraph()},
itemcontextmenu:function(a,c,d,e,f){f.preventDefault();f.stopPropagation();a.getEl().hasCls("selected");(new Ext.menu.Menu({floating:!0,items:[{text:this.localize("removeTerm"),handler:function(){a.deselect(e);var c=this.termStore.getAt(e).get("term");this.termStore.removeAt(e);a.refresh();this.bubblelines.removeTerm(c);this.bubblelines.setCanvasHeight();this.bubblelines.drawGraph()},scope:this}]})).showAt(f.getXY())},scope:this}},{flex:1,xtype:"container",autoEl:"div",itemId:"canvasParent",layout:"fit",
overflowY:"auto",overflowX:"hidden"}],listeners:{render:function(a){a=this.down("#canvasParent");this.bubblelines=new Bubblelines({container:a,clickHandler:this.bubbleClickHandler.bind(this)})},afterlayout:function(a){!1===this.bubblelines.initialized&&this.bubblelines.initializeCanvas()},resize:function(a,c,d){this.bubblelines.doBubblelinesLayout()},scope:this}}});this.callParent(arguments)},loadFromCorpusTerms:function(a){this.bubblelines&&(this.bubblelines.removeAllTerms(),this.termStore.removeAll(!0));
...
glyph:"xf065@FontAwesome",items:"cirrus corpusterms bubblelines corpuscollocates phrases documents summary trends scatterplot termsradio".split(" ")},{i18n:"moreToolsScaleDocument",glyph:"xf066@FontAwesome",items:["cirrus","contexts","documentterms","reader","trends"]},{i18n:"moreToolsTypeViz",glyph:"xf06e@FontAwesome",items:"cirrus bubblelines collocatesgraph trends scatterplot termsradio".split(" ")},{i18n:"moreToolsTypeGrid",glyph:"xf0ce@FontAwesome",items:"corpusterms corpuscollocates phrases contexts documentterms documents".split(" ")},
