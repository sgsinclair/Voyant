...
if(b)return this.exportPngData(b.toDataURL("image/png"));var c=this.getTargetEl().dom.querySelector("svg");if(c){var d=d3.select(c).attr("version",1.1).attr("xmlns","http://www.w3.org/2000/svg").node().parentNode.innerHTML;a="data:image/svg+xml;base64,"+btoa(d);var b=Ext.DomHelper.createDom({tag:"canvas",width:c.offsetWidth,height:c.offsetHeight}),e=b.getContext("2d"),f=new Image;f.src=a;f.panel=this;f.onload=function(){e.drawImage(f,0,0);a=b.toDataURL("image/png");return this.panel.exportPngData.call(this.panel,
a)}}},exportUrl:function(){this.openUrl(this.getExportUrl())},exportEmbed:function(){Ext.Msg.show({title:this.localize("exportViewEmbedTitle"),message:this.localize("exportViewEmbedMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:"\x3c!--\tExported from Voyant Tools: http://voyant-tools.org/.\nPlease note that this is an early version and the API may change.\nFeel free to change the height and width values below: --\x3e\n\x3ciframe style\x3d'width: 100%; height: 800px' src\x3d'"+
...
Ext.define("Voyant.widget.DocumentSelectorButton",{extend:"Ext.button.Button",alias:"widget.documentselectorbutton",mixins:["Voyant.widget.DocumentSelector"],initComponent:function(){this.mixins["Voyant.widget.DocumentSelectorBase"].initComponent.apply(this,arguments);this.callParent()}});
...
layout:{type:"vbox",align:"middle"},dockedItems:[{xtype:"toolbar",enableOverflow:!0,dock:"bottom",buttonAlign:"right",items:[{text:"Open",glyph:"xf115@FontAwesome",tooltip:"Select an exsting corpus",hidden:void 0!=this.getCorpus(),handler:function(){Ext.create("Ext.window.Window",{title:"Open an Existing Corpus",layout:"fit",modal:!0,items:{xtype:"form",submitEmptyText:!1,margin:"5,5,5,5",items:{xtype:"combo",labelWidth:150,fieldLabel:"Choose a corpus:",name:"corpus",queryMode:"local",store:[["shakespeare",
...
{xtype:"fileuploadfield",glyph:"xf093@FontAwesome",name:"upload",buttonOnly:!0,hideLabel:!0,ui:"default-toolbar",buttonText:"Upload",listeners:{render:function(a){a.fileInputEl.dom.setAttribute("multiple",!0);Ext.tip.QuickTipManager.register({target:a.getEl(),text:"Upload one or more documents from your computer"})},change:function(b,c){if(c){var d=b.up("form").getForm();if(d.isValid()){for(var e=b.fileInputEl.dom.files,f=/\.(png|gif|jpe?g|xls|mp[234a]|mpeg|exe|wmv|avi|ppt|mpg|tif|wav|mov|psd|wma|ai|bmp|pps|aif|pub|dwg|indd|swf|asf|mbd|dmg|flv)$/i,
...
{text:this.localize("freqsMode"),glyph:"xf201@FontAwesome",tooltip:this.localize("freqsModeTip"),flex:1,menu:{items:[{text:this.localize("rawFrequencies"),checked:!1,itemId:"raw",group:"freqsMode",checkHandler:function(a,b){b&&(this.setApiParam("comparisonType","raw"),this.loadFromApis())},scope:this},{text:this.localize("relativeFrequencies"),checked:!0,itemId:"relative",group:"freqsMode",checkHandler:function(a,b){b&&(this.setApiParam("comparisonType","relative"),this.loadFromApis())},scope:this},
{text:this.localize("tfidf"),checked:!1,itemId:"tfidf",group:"freqsMode",checkHandler:function(a,b){b&&(this.setApiParam("comparisonType","tfidf"),this.loadFromApis())},scope:this}]}},{text:this.localize("clusters"),itemId:"clusters",glyph:"xf192@FontAwesome",flex:1,menu:{items:[{text:"1",itemId:"clusters_1",group:"clusters",xtype:"menucheckitem"},{text:"2",itemId:"clusters_2",group:"clusters",xtype:"menucheckitem"},{text:"3",itemId:"clusters_3",group:"clusters",xtype:"menucheckitem"},{text:"4",itemId:"clusters_4",
group:"clusters",xtype:"menucheckitem"},{text:"5",itemId:"clusters_5",group:"clusters",xtype:"menucheckitem"}],listeners:{click:function(a,b){void 0!==b&&(this.setApiParam("clusters",parseInt(b.text)),this.loadFromApis(!0))},scope:this}}},{text:this.localize("dimensions"),itemId:"dimensions",glyph:"xf1b2@FontAwesome",flex:1,menu:{items:[{text:"2",itemId:"dimensions_2",group:"dimensions",xtype:"menucheckitem"},{text:"3",itemId:"dimensions_3",group:"dimensions",xtype:"menucheckitem"}],listeners:{click:function(a,
...
a=this.getCorpus().getDocument(b.docIndex),null!==a&&(b.term=a.getShortTitle(),b.title=a.getTitle())),p.push(b))},this);c=this.termStore.getCount();this.queryById("limit").setRawValue(c);this.setApiParam("limit",c);c=Ext.create("Ext.data.JsonStore",{fields:"term x y z rawFreq relativeFreq cluster category docIndex".split(" "),data:s});g=Ext.create("Ext.data.JsonStore",{fields:"term x y z rawFreq relativeFreq cluster category docIndex".split(" "),data:p});a={itemId:"chart",xtype:"cartesian",interactions:["crosszoom",
"panzoom","itemhighlight"],plugins:{ptype:"chartitemevents"},axes:[{type:"numeric",position:"bottom",fields:["x"]},{type:"numeric",position:"left",fields:["y"]}],sprites:[{type:"text",text:a,hidden:0<this.labelsMode,x:70,y:70}],innerPadding:{top:25,right:25,bottom:25,left:25},series:[{type:"customScatter",xField:"x",yField:"y",store:c,tooltip:{trackMouse:!0,style:"background: #fff",renderer:function(a,c,d){a.setHtml(b.tokenFreqTipTemplate.apply([c.get("term"),c.get("rawFreq"),c.get("relativeFreq")]))}},
marker:{type:"circle"},highlight:{fillStyle:"yellow",strokeStyle:"black"},renderer:function(a,c,e,f){a=e.store.getAt(f);null!==a&&(f=a.get("cluster"),-1===f&&(f=0),e=.65,3===d&&(e=b.interpolate(a.get("z"),q,n,0,1)),f=b.getApplication().getColor(f),c.fillStyle="rgba("+f.join(",")+","+e+")",c.strokeStyle="rgba("+f.join(",")+",1)",a=a.get("rawFreq"),a=b.interpolate(a,m,l,2,20),c.radius=a)},scope:this},{type:"customScatter",xField:"x",yField:"y",store:g,tooltip:{trackMouse:!0,style:"background: #fff",
...
a.noskin:b,additional:a.noskin&&"convert"==a.noskin?this.localize(a.noskin+"SkinMsg"):""}),buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR}),c="corpusset";this.viewport=Ext.create("Ext.container.Viewport",{layout:"border",rtl:void 0!==this.getApiParam("rtl"),items:[{xtype:"voyantheader",region:"north"},{region:"south",xtype:"voyantfooter"},{region:"center",layout:"card",itemId:"toolsContainer",activeItem:0,items:[{xtype:"container",layout:{type:"vbox",pack:"center",align:"center"},items:[{xtype:"corpuscreator"},
{xtype:"container",html:this.localize("voyantIs")}]},{layout:"fit",itemId:"toolsContainer-main",items:{xtype:c}}]}]});this.callParent(arguments)}});