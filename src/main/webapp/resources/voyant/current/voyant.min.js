...
0;g<=c;g+=this.COARSENESS)if(e[f]&&e[f][g]&&null!=this.grid[f+a]&&null!=this.grid[f+a][g+b])return!0;return!1},f;this.grid=[];l=0;f=function(){var a,f,h,k,n=this.wordsToArrange-1,s=g.canvas.width,q=g.canvas.height,x=.5*s,r=.5*q;do{h=p[l];if(void 0!==h){for(var D=Math.random()*Math.PI,v=.25*Math.random()*h.size,w=.5*(Math.random()-.5),F=.5*h.width,N=.5*h.height;;){a=Math.floor((x+Math.cos(D)*v*this.ratio-F)/this.COARSENESS)*this.COARSENESS;f=Math.floor((r+Math.sin(D)*v-N)/this.COARSENESS)*this.COARSENESS;
...
!0)}});Ext.define("Voyant.panel.Correlations",{extend:"Ext.grid.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.correlations",statics:{i18n:{title:"Correlations",trendTip:"This represents the relative frequencies of the term.",minInDocumentsCountRatioLabel:"minimum coverage (%{0})",source:"Term 1",target:"Term 2",correlation:"Correlation",emptyText:"(No results.)"},api:{query:void 0,docId:void 0,docIndex:void 0,stopList:"auto",minInDocumentsCountRatio:100},glyph:"xf0ce@FontAwesome"},config:{},constructor:function(){this.callParent(arguments);
this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(){var a=this;Ext.apply(a,{title:this.localize("title"),emptyText:this.localize("emptyText"),store:Ext.create("Voyant.data.store.TermCorrelationsBuffered",{parentPanel:this}),columns:[{text:this.localize("source"),toolTip:this.localize("sourceTip"),dataIndex:"source-term",sortable:!1},{xtype:"widgetcolumn",tooltip:this.localize("trendTip"),width:100,dataIndex:"source-distributions",widget:{xtype:"sparklineline"},
text:"\u2190"},{xtype:"widgetcolumn",tooltip:this.localize("trendTip"),width:100,dataIndex:"target-distributions",widget:{xtype:"sparklineline"},text:"\u2192",align:"right"},{text:this.localize("target"),toolTip:this.localize("targetTip"),dataIndex:"target-term",sortable:!1},{text:this.localize("correlation"),toolTip:this.localize("correlationTip"),dataIndex:"correlation"}],listeners:{scope:this,corpusSelected:function(){this.setApiParams({docIndex:void 0,docId:void 0});this.getStore().getProxy().setExtraParam("tool",
"corpus.CorpusTermCorrelations");this.getStore().load()},documentsSelected:function(a,c){var d=[],e=this.getStore().getCorpus();c.forEach(function(a){d.push(e.getDocument(a).getId())},this);this.setApiParams({docId:d,docIndex:void 0});this.getStore().getProxy().setExtraParam("tool","corpus.DocumentTermCorrelations");this.getStore().load()}},dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"querysearchfield"},{xtype:"totalpropertystatus"},{xtype:"tbspacer"},{xtype:"tbtext",
itemId:"minInDocumentsCountRatioLabel",text:a.localize("minInDocumentsCountRatioLabel")},{xtype:"slider",increment:5,minValue:0,maxValue:100,width:75,listeners:{afterrender:function(b){b.setValue(this.getApiParam("minInDocumentsCountRatio"));b.up("toolbar").getComponent("minInDocumentsCountRatioLabel").setText((new Ext.XTemplate(a.localize("minInDocumentsCountRatioLabel"))).apply([this.getApiParam("minInDocumentsCountRatio")]))},changecomplete:function(b,c){this.setApiParams({minInDocumentsCountRatio:c});
b.up("toolbar").getComponent("minInDocumentsCountRatioLabel").setText((new Ext.XTemplate(a.localize("minInDocumentsCountRatioLabel"))).apply([c]));this.getStore().load()},scope:this}},{xtype:"corpusdocumentselector"}]}]});a.on("loadedCorpus",function(a,c){1==c.getDocumentsCount()&&this.getStore().getProxy().setExtraParam("tool","corpus.DocumentTermCorrelations");this.getStore().load()});a.on("query",function(a,c){this.setApiParam("query",c);this.getStore().load()},a);a.callParent(arguments)}});Ext.define("Voyant.panel.CorpusCreator",{extend:"Ext.form.Panel",requires:["Ext.form.field.File"],requires:["Voyant.data.model.Corpus"],mixins:["Voyant.panel.Panel"],alias:"widget.corpuscreator",isConsumptive:!0,statics:{i18n:{},api:{inputFormat:void 0,xmlDocumentsXpath:void 0,xmlContentXpath:void 0,xmlTitleXpath:void 0,xmlAuthorXpath:void 0,tokenization:void 0,adminPassword:void 0,accessPassword:void 0,noPasswordAccess:void 0,tableDocuments:void 0,tableContent:void 0,tableTitle:void 0,tableAuthor:void 0,
