...
null,this);return b.promise},_doGetStored:function(a,b){var c=new Ext.Deferred;Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"resource.StoredResource",retrieveResourceId:a,failQuietly:!0}}).then(function(a){var e=Ext.decode(a.responseText);a=e.storedResource.id;e=e.storedResource.resource;0==e.length?c.reject():1!=b?(e=Ext.decode(e),c.resolve(e)):c.resolve([a,e])},function(){c.reject()},null,this);return c.promise}});Ext.define("Voyant.util.CategoriesManager",{categories:void 0,attributes:void 0,constructor:function(a){a=a||{};this.categories={};this.attributes={};if(void 0!==a.categories)for(var b in a.categories)this.addTerms(b,a.categories[b])},getCategories:function(){return this.categories},getCategoryTerms:function(a){return this.categories[a]},addCategory:function(a){void 0===this.categories[a]&&(this.categories[a]=[])},removeCategory:function(a){delete this.categories[a]},addTerm:function(a,b){this.addTerms(a,
[b])},addTerms:function(a,b){Ext.isArray(b)||(b=[b]);void 0===this.categories[a]&&this.addCategory(a);for(var c=0;c<b.length;c++){var d=b[c];-1===this.categories[a].indexOf(d)&&this.categories[a].push(d)}},removeTerm:function(a,b){this.removeTerms(a,[b])},removeTerms:function(a,b){Ext.isArray(b)||(b=[b]);if(void 0!==this.categories[a])for(var c=0;c<b.length;c++){var d=this.categories[a].indexOf(b[c]);-1!==d&&this.categories[a].splice(d,1)}},getCategoryForTerm:function(a){for(var b in this.categories)if(-1!=
this.categories[b].indexOf(a))return b},addAttribute:function(a,b){if(void 0===this.attributes[a]&&(this.attributes[a]={},void 0!==b))for(var c in this.categories)this.setAttributeForCategory(c,a,b)},removeAttribute:function(a){delete this.attributes[a]},setCategoryAttribute:function(a,b,c){void 0===this.attributes[b]&&this.addAttribute(b);this.attributes[b][a]=c},getCategoryAttribute:function(a,b){if(void 0!==this.attributes[b])return this.attributes[b][a]}});Ext.define("Voyant.notebook.util.Show",{transferable:["show"],show:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments);show.call(this,this.getString?this.getString(a):this.toString(),!this.getString&&Ext.isNumber(a)?a:void 0)},statics:{show:function(a,b){var c=a;if(this.then)this.then(function(a){show.call(a,a,c)});else{if(Ext.isArray(a)){var d="";a.forEach(function(a){d+=a.getString?a.getString():a.toString()});a=d}else if(Ext.isString(this)||this instanceof
...
params:{tool:"resource.StoredResource",storeResource:d,corpus:c},combo:b,success:function(a,b){var c=Ext.util.JSON.decode(a.responseText),d=b.combo.getStore(),c="keywords-"+c.storedResource.id;d.add({name:c,value:c});b.combo.setValue(c);b.combo.updateLayout()},scope:this}))},scope:this})},scope:this}):Ext.Msg.show({title:this.localize("noEditAutoTitle"),message:this.localize("noEditAutoMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR})}});Ext.define("Voyant.widget.QuerySearchField",{extend:"Ext.form.field.Tag",mixins:["Voyant.util.Localization"],alias:"widget.querysearchfield",statics:{i18n:{}},config:{corpus:void 0,tokenType:"lexical",isDocsMode:!1,inDocumentsCountOnly:void 0,stopList:void 0,showAggregateInDocumentsCount:!1,clearOnQuery:!1},hasCorpusLoadedListener:!1,constructor:function(a){a=a||{};Ext.applyIf(a,{minWidth:100,maxWidth:200,matchFieldWidth:!1,minChars:2,displayField:"term",valueField:"term",filterPickList:!0,createNewOnEnter:!0,
createNewOnBlur:!1,autoSelect:!1,tpl:['\x3cul class\x3d"x-list-plain"\x3e\x3ctpl for\x3d"."\x3e','\x3cli role\x3d"option" class\x3d"x-boundlist-item" style\x3d"white-space: nowrap;"\x3e'+(a.itemTpl?a.itemTpl:"{term} ({"+(a.inDocumentsCountOnly?"inDocumentsCount":"rawFreq")+"})")+"\x3c/li\x3e","\x3c/tpl\x3e\x3c/ul\x3e"],triggers:{help:{weight:2,cls:"fa-trigger form-fa-help-trigger",handler:function(){Ext.Msg.show({title:this.localize("querySearch"),message:this.getIsDocsMode()?this.localize("querySearchDocsModeTip"):
this.localize("querySearchTip"),buttons:Ext.OK,icon:Ext.Msg.INFO})},scope:"this"}}});a.showAggregateInDocumentsCount&&(a.triggers.count={cls:"fa-trigger",handler:"onHelpClick",scope:"this",hidden:!0});a.clearOnQuery&&this.setClearOnQuery(a.clearOnQuery);this.callParent(arguments)},initComponent:function(a){var b=this;b.on("beforequery",function(a){if(a.query){a.query=a.query.trim();"^"==a.query.charAt(0)&&(a.query=a.query.substring(1),a.cancel=0==a.query.length);"*"==a.query.charAt(0)&&(a.query="."+
a.query);"*"==a.query.charAt(a.query.length-1)&&(a.query=a.query.substring(0,a.query.length-1),a.cancel=0==a.query.length);"."==a.query.charAt(0)&&(a.cancel=a.query.length<(/\W/.test(a.query.charAt(1))?5:4));try{new RegExp(a.query)}catch(b){a.cancel=!0}-1<a.query.indexOf('"')&&(-1==a.query.indexOf(" ")&&(a.cancel=!0),2!=(a.query.match(/"/)||[]).length&&(a.cancel=!0));-1<a.query.indexOf("*")?-1==a.query.indexOf(" ")&&(a.query+=",^"+a.query):a.query=a.query+"*"+(-1==a.query.indexOf(" ")?",^"+a.query+
"*":"")}});b.on("change",function(a,c){c=c.map(function(a){return a.replace(/^(\^?)\*/,"$1.*")});b.up("panel").fireEvent("query",b,c);b.getClearOnQuery()&&b.removeValue(b.getValueRecords());b.triggers.count&&(b.triggers.count.show(),b.triggers.count.getEl().setHtml("0"),0<c.length?b.getCorpus().getCorpusTerms().load({params:{query:c.map(function(a){return"("+a+")"}).join("|"),tokenType:b.getTokenType(),stopList:b.getStopList(),inDocumentsCountOnly:!0},callback:function(a,c,d){d&&a&&1==a.length&&b.triggers.count.getEl().setHtml(a[0].getInDocumentsCount())}}):
b.triggers.count.hide())});var c=b.findParentBy(function(a){return a.mixins["Voyant.panel.Panel"]});null!=c&&(c.on("loadedCorpus",function(a,c){b.doSetCorpus(c)},b),b.hasCorpusLoadedListener=!0);b.on("afterrender",function(a){!1!==b.hasCorpusLoadedListener||b.getCorpus()||(c=b.findParentBy(function(a){return a.mixins["Voyant.panel.Panel"]}),a=c.getApplication().getCorpus(),void 0!==a?b.doSetCorpus(a):(c.on("loadedCorpus",function(a,c){b.doSetCorpus(c)},b),b.hasCorpusLoadedListener=!0));b.triggers&&
b.triggers.help&&Ext.tip.QuickTipManager.register({target:b.triggers.help.getEl(),text:b.getIsDocsMode()?b.localize("querySearchDocsModeTip"):b.localize("querySearchTip")});b.triggers&&b.triggers.count&&Ext.tip.QuickTipManager.register({target:b.triggers.count.getEl(),text:b.localize("aggregateInDocumentsCount")})});b.on("beforedestroy",function(a){b.triggers&&b.triggers.help&&Ext.tip.QuickTipManager.unregister(b.triggers.help.getEl());b.triggers&&b.triggers.count&&Ext.tip.QuickTipManager.unregister(b.triggers.count.getEl())});
b.callParent(arguments)},doSetCorpus:function(a){if(null!=a){this.setCorpus(a);if(void 0==this.getStopList())if(this.getApiParam)this.setStopList(this.getApiParam("stopList"));else{var b=this.up("panel");b&&b.getApiParam&&this.setStopList(b.getApiParam("stopList"))}this.setStore(a.getCorpusTerms({corpus:a,proxy:{extraParams:{limit:10,tokenType:this.tokenType,stopList:this.getStopList(),inDocumentsCountOnly:this.getInDocumentsCountOnly()}}}))}}});Ext.define("Voyant.widget.TotalPropertyStatus",{extend:"Ext.Component",mixins:["Voyant.util.Localization"],alias:"widget.totalpropertystatus",statics:{i18n:{}},initComponent:function(){Ext.applyIf(this,{tpl:this.localize("totalPropertyStatus"),itemId:"totalpropertystatus",style:"margin-right:5px",listeners:{afterrender:function(a){var b=a.up("grid");if(b){var c=b.getStore();a.updateStatus(c.getTotalCount());b.getStore().on("totalcountchange",a.updateStatus,a)}}}});this.callParent(arguments)},updateStatus:function(a){this.update({count:a})}});Ext.define("Voyant.widget.DocumentSelector",{mixins:["Voyant.util.Localization"],alias:"widget.documentselector",glyph:"xf10c@FontAwesome",statics:{i18n:{}},config:{docs:void 0,corpus:void 0,singleSelect:!1},initComponent:function(){this.setSingleSelect(void 0==this.config.singleSelect?this.getSingleSelect():this.config.singleSelect);Ext.apply(this,{text:this.localize("documents"),menu:{width:250,fbar:[{xtype:"checkbox",hidden:this.getSingleSelect(),boxLabel:this.localize("all"),listeners:{change:{fn:function(a,
...
{store:{data:l,fields:e,proxy:{type:"memory",reader:{record:"tbody tr",type:"xml"}}},columns:f,width:c,height:m});this.callParent([b]);!1!==b.remove&&l.parentNode.removeChild(l)},doDestroy:function(){this.table.remove();this.tabl=null;this.callParent()}});Ext.define("Voyant.widget.CategoriesBuilder",{extend:"Ext.container.Container",mixins:["Voyant.util.Localization","Voyant.util.Api","Voyant.util.CategoriesManager"],alias:"widget.categoriesbuilder",statics:{i18n:{title:"Categories Builder",terms:"Terms",term:"Term",rawFreq:"Count",relativeFreq:"Relative",categories:"Categories",addCategory:"Add Category",removeCategory:"Remove Category",removeTerms:"Remove Selected Terms",categoryName:"Category Name",add:"Add",cancel:"Cancel",exists:"Category already exists",
confirmRemove:"Are you sure you want to remove the category?"},api:{stopList:"auto",query:void 0}},config:{corpus:void 0,categoriesManager:void 0,categoryWin:void 0,parentPanel:void 0},constructor:function(a){a=a||{};var b=a.categoriesManager?a.categoriesManager:Ext.create("Voyant.util.CategoriesManager");this.setCategoriesManager(b);this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);this.callParent(arguments)},initComponent:function(){Ext.apply(this,{title:this.localize("title"),layout:"border",
items:[{title:this.localize("terms"),split:!0,width:250,region:"west",layout:"fit",items:{itemId:"terms",xtype:"grid",store:Ext.create("Voyant.data.store.CorpusTermsBuffered",{parentPanel:this}),viewConfig:{plugins:{ptype:"gridviewdragdrop",ddGroup:"terms",copy:!0,enableDrop:!1,dragZone:{getDragText:function(){var a="";this.dragData.records.forEach(function(b){a+=b.get("term")+", "});return a.substr(0,a.length-2)}}}},selModel:{mode:"MULTI"},columns:[{text:this.localize("term"),dataIndex:"term",flex:1,
sortable:!0},{text:this.localize("rawFreq"),dataIndex:"rawFreq",width:"autoSize",sortable:!0},{text:this.localize("relativeFreq"),dataIndex:"relativeFreq",renderer:function(a){return Ext.util.Format.number(1E6*a,"0,000")},width:"autoSize",hidden:!0,sortable:!0}],dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"querysearchfield"}]}],listeners:{query:function(a,b){this.setApiParam("query",b);var c=this.queryById("terms").getStore();c.removeAll();c.load()},scope:this}}},
{title:this.localize("categories"),itemId:"categories",region:"center",xtype:"panel",layout:{type:"hbox",align:"stretch"},scrollable:"x",dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{text:this.localize("addCategory"),handler:function(){this.getCategoryWin().show()},scope:this},{text:this.localize("removeTerms"),handler:function(){this.queryById("categories").query("grid").forEach(function(a){a.getStore().remove(a.getSelection())},this)},scope:this}]}],items:[]}]});
this.setCategoryWin(Ext.create("Ext.window.Window",{title:this.localize("addCategory"),modal:!0,closeAction:"hide",layout:"fit",items:{xtype:"form",width:300,defaults:{labelAlign:"right"},items:[{xtype:"textfield",fieldLabel:this.localize("categoryName"),name:"categoryName",allowBlank:!1,validator:function(a){return void 0===this.getCategoriesManager().getCategoryTerms(a)?!0:this.localize("exists")}.bind(this),enableKeyEvents:!0,listeners:{keypress:function(a,b){b.getKeyName()},scope:this}}],buttons:[{text:this.localize("cancel"),
handler:function(a){a.up("window").close()}},{text:this.localize("add"),handler:function(a){var b=a.up("form");b.isValid()&&(b=b.getValues().categoryName,this.addCategory(b),a.up("window").close())},scope:this}]},listeners:{show:function(a){a=a.down("form").getForm();a.reset();a.clearInvalid()}}}));this.on("afterrender",function(a){a.on("loadedCorpus",function(a,b){this.setCorpus(b);this.queryById("terms").getStore().load()},a);var b=a.findParentBy(function(a){return a.mixins["Voyant.panel.Panel"]});
null==b&&(b=a.up("window").panel);b?(this.setParentPanel(b),b.on("loadedCorpus",function(b,d){a.fireEvent("loadedCorpus",b,d)},a),b.getCorpus&&b.getCorpus()?a.fireEvent("loadedCorpus",a,b.getCorpus()):b.getStore&&b.getStore()&&b.getStore().getCorpus&&b.getStore().getCorpus()&&a.fireEvent("loadedCorpus",a,b.getStore().getCorpus())):window.console&&console.warn("couldn't find parent panel for CategoriesBuilder");this.buildCategories()},this);this.callParent(arguments)},addCategory:function(a){var b=
this.queryById("categories"),c,d=[],e=this.getCategoriesManager();c=e.getCategoryTerms(a);if(void 0===c)e.addCategory(a),e.addAttribute("color"),c=b.query("grid").length,c=this.getParentPanel().getApplication().getColor(c,!0),e.setCategoryAttribute(a,"color",c);else{for(var f=0;f<c.length;f++)d.push({term:c[f]});c=e.getCategoryAttribute(a,"color")}return b.add({title:a,header:{items:[{xtype:"colorbutton",format:"#hex6",value:c,width:30,height:15,listeners:{change:function(b,c,d){this.getCategoriesManager().setCategoryAttribute(a,
"color",c)},afterrender:function(a){a.getPopup().listeners={focusleave:function(a,b){a.close()}}},scope:this}}]},xtype:"panel",frame:!0,width:150,margin:"10 0 10 10",layout:"fit",tools:[{type:"close",tooltip:this.localize("removeCategory"),callback:function(b){Ext.Msg.confirm(this.localize("removeCategory"),this.localize("confirmRemove"),function(c){"yes"===c&&(this.queryById("categories").remove(b),this.getCategoriesManager().removeCategory(a))},this)},scope:this}],items:[{xtype:"grid",category:a,
store:Ext.create("Ext.data.JsonStore",{data:d,fields:["term"]}),viewConfig:{plugins:{ptype:"gridviewdragdrop",ddGroup:"terms",dragZone:{getDragText:function(){var a="";this.dragData.records.forEach(function(b){a+=b.get("term")+", "});return a.substr(0,a.length-2)}}}},selModel:{mode:"MULTI"},columns:[{dataIndex:"term",flex:1,sortable:!0}],listeners:{drop:function(b,c){c.view.getSelectionModel().deselectAll();this.getSelectionModel().deselectAll();for(var d=this.up("categoriesbuilder").getCategoriesManager(),
e=[],f=0;f<c.records.length;f++)e.push(c.records[f].get("term"));d.addTerms(a,e);f=c.view.up("grid");f.category&&d.removeTerms(f.category,e)}}}]})},buildCategories:function(){var a=this.getCategoriesManager().getCategories(),b;for(b in a)this.addCategory(b)}});Ext.define("Voyant.panel.Panel",{mixins:["Voyant.util.Localization","Voyant.util.Api","Voyant.util.Toolable","Voyant.util.DetailedError"],requires:["Voyant.widget.QuerySearchField","Voyant.widget.StopListOption","Voyant.widget.TotalPropertyStatus"],alias:"widget.voyantpanel",statics:{i18n:{},config:{corpusValidated:!1},api:{corpus:void 0,input:void 0,inputFormat:void 0,subtitle:void 0}},config:{corpus:void 0},constructor:function(a){this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);
...
handler:function(a){Ext.create("Ext.window.Window",{title:this.localize("categoriesBuilder"),modal:!0,layout:"fit",height:.5*this.getApplication().getViewport().getHeight(),width:.75*this.getApplication().getViewport().getWidth(),panel:this,items:{xtype:"categoriesbuilder",categoriesManager:this.getApplication().getCategoriesManager()},buttons:[{text:this.localize("done"),handler:function(a){a.up("window").close()}}],listeners:{beforedestroy:function(a){a=this.getApplication().getCategoriesManager();
for(var b in a.getCategories()){var e=a.getCategoryAttribute(b,"color");if(void 0!==e)for(var e=this.getApplication().hexToRgb(e),f=a.getCategoryTerms(b),g=0;g<f.length;g++)this.getApplication().colorTermAssociations.replace(f[g],e)}},scope:this}}).show()},scope:this}}});this.mixins["Voyant.panel.Panel"].constructor.call(this,a)},onCollapse:function(a){Ext.defer(function(){this.setTitle("\x3cimg src\x3d'"+this.getBaseUrl()+"resources/images/voyant-logo-tiny.png' style\x3d'vertical-align: middle' alt\x3d'Voyant Tools' /\x3e "+
...
config:{previous:[]},initComponent:function(a){var b=this;Ext.apply(this,{title:this.localize("title"),glyph:"xf0e6@FontAwesome",layout:{type:"border",align:"stretch"},items:[{itemId:"chat",html:"\x3cform class\x3d'chat'\x3e\x3c/form\x3e",region:"center",flex:2},{itemId:"script",xtype:"form",region:"east",split:!0,title:this.localize("scriptEditor"),layout:{type:"vbox",align:"stretch"},items:[{html:(new Ext.XTemplate(this.localize("scriptIntro"))).apply([b.getBaseUrl()+"docs/#!/guide/veliza"])},{xtype:"textarea",
name:"editor",fieldStyle:"white-space: pre",flex:1,listeners:{afterrender:function(a){a.mask(b.localize("loadingScript"));Ext.Ajax.request({url:b.getTromboneUrl(),params:{tool:"corpus.Veliza",script:b.getApiParam("script")}}).then(function(d){(d=Ext.decode(d.responseText))&&d.veliza&&d.veliza.script?(a.setValue(d.veliza.script),a.resetOriginalValue()):b.showError(b.localize("unableFetchScript"));a.unmask()},function(a){b.showError(a)})},scope:this}}],collapsed:!0,collapsible:!0,flex:1}],dockedItems:[{dock:"bottom",
xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"textfield",itemId:"chatfield",emptyText:this.localize("typeAndEnter"),flex:1,listeners:{specialkey:function(a,d){d.getKey()==d.ENTER&&(b.handleUserSentence(a.getValue()),a.setValue(""))}}},{xtype:"button",text:this.localize("send"),handler:function(){var a=this.up("toolbar").down("textfield");b.handleUserSentence(a.getValue(),!1);a.setValue("")}},{xtype:"button",text:this.localize("fromCorpus"),handler:function(){b.handleUserSentence("",!0)}}]}]});
this.callParent();this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.on("boxready",function(a){a.addSentence("fromThem","Hello, I'm Veliza, and I'm here to talk to you about your texts (you may know my sister \x3ca href\x3d'https://en.wikipedia.org/wiki/ELIZA' target\x3d'_blank'\x3eEliza\x3c/a\x3e she's a famous psychotherapist). I'm just learning to talk about text documents, but please, let me know about any anxieties you're feeling about your texts. Type a message in the box below and hit enter. Or, if you're feeling playful, hit the \x3ci\x3efrom text\x3c/i\x3e bottom in the lower right-hand corner to fetch a sentence from the corpus.");
this.sendApiParamMessage()})},sendApiParamMessage:function(){this.getApiParam("message")&&(this.getCorpus()?this.handleUserSentence(this.getApiParam("message")):(console.warn(new Date),Ext.defer(this.sendApiParamMessage,100,this)))},handleUserSentence:function(a,b){if((a=a.trim())||b){a&&this.addSentence("myMessage",a);this.mask();var c=this,d=this.getComponent("script").down("textarea");Ext.Ajax.request({url:this.getApplication().getTromboneUrl(),params:{corpus:c.getCorpus()?c.getCorpus().getId():
void 0,tool:"corpus.Veliza",sentence:a,fromCorpus:b?!0:!1,script:d.isDirty()?d.getValue():this.getApiParam("script"),noCache:Ext.id()},success:function(a,f){c.unmask();a=Ext.decode(a.responseText);a.veliza.id&&(c.setApiParam("script",a.veliza.id),d.resetOriginalValue());var g=a.veliza.response,h=g.match(/<\!-- (.+?) --\x3e/);if(h){h=Ext.decode(h[1]);for(key in h.params)h.params[key]=h.params[key].trim();g+="\x3cbr/\x3e\x3ciframe width\x3d'"+(h.width?h.width:"100%")+"' height\x3d'"+(h.height?h.height:
"350px")+"' src\x3d'"+c.getApplication().getBaseUrl()+"tool/"+h.tool+"/?corpus\x3d"+c.getCorpus().getId()+"\x26minimal\x3dtrue\x26"+Ext.Object.toQueryString(h.params)+"'\x3e\x3c/iframe\x3e"}h=a.veliza.sentence;c.setPrevious(a.veliza.previous);b?(meta=-1<a.veliza.docIndex?c.getCorpus().getDocument(a.veliza.docIndex).getShortLabel():void 0,c.addSentence("myMessage",h,meta),Ext.Function.defer(function(){this.addSentence("fromThem",g);this.body.scroll("b",Infinity)},500,c)):(c.addSentence("fromThem",
g),c.body.scroll("b",Infinity))},failure:function(a,b){c.showResponseError("Unable to get response from Veliza.",a)}})}},addSentence:function(a,b,c){var d=this.getComponent("chat").body;d.down("form").insertHtml("beforeEnd",'\x3cdiv class\x3d"message"\x3e\x3cdiv class\x3d"'+a+'"\x3e\x3cp\x3e'+b+"\x3c/p\x3e"+(c?"\x3cdate\x3e"+c+"\x3c/date\x3e":"")+"\x3c/div\x3e\x3c/div\x3e",!0);d.scroll("b",Infinity)}});Ext.define("Voyant.panel.WordTree",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.wordtree",statics:{i18n:{},api:{query:void 0,docId:void 0,docIndex:void 0,stopList:"auto",context:10,limit:100},glyph:"xf0e8@FontAwesome"},config:{tree:void 0,kwicStore:void 0,options:{xtype:"stoplistoption"},numBranches:5,lastClick:1},doubleClickDelay:300,constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(){Ext.apply(this,
...
{xtype:"toolbar",dock:"right",items:[{xtype:"notebookwrappercounter",order:a.order},{xtype:"notebookwrapperremove"},{xtype:"notebookwrappermoveup"},{xtype:"notebookwrappermovedown"}]}],items:[this.editor,this.results]});this.callParent(arguments)},initComponent:function(){var a=this;a.on("afterrender",function(){this.getTargetEl().on("resize",function(b){var c=20;a.items.each(function(a){c+=a.getHeight()});a.setSize({height:c})})},this);a.callParent(arguments)},switchModes:function(a){var b="javascript"==
a;this.down("notebookwrapperrun").setVisible(b);this.down("notebookwrapperrununtil").setVisible(b);this.results.setVisible(b);this.editor.switchModes(a)},run:function(a){if("ace/mode/javascript"==this.editor.getMode())if(!0===a)this._run();else{var b=this.up("notebook");Ext.Array.each(b.query("notebookcodeeditorwrapper"),function(a){if(a==this)return this._run(),!1;a.editor&&"ace/mode/javascript"==a.editor.getMode()&&0==a.getIsRun()&&Ext.Msg.confirm(this.localize("previousNotRunTitle"),this.localize("previousNotRun"),
function(a){"yes"==a?b.runAllCode():this._run()},this)},this)}},_run:function(){this.results.show();this.results.update(" ");this.results.mask("working\u2026");var a=this.editor.getValue();try{Voyant.notebook.util.Show.TARGET=this.results.getEl(),Voyant.notebook.Notebook.currentBlock=this,eval.call(window,a),Ext.defer(this.tryToUnmask,20,this)}catch(b){this.results.unmask(),Voyant.application.releaseAllDeferred(),Voyant.notebook.util.Show.showError(b)}this.setIsRun(!0);return!1},clearResults:function(){this.results.show();
this.results.update(" ");this.getTargetEl().fireEvent("resize")},tryToUnmask:function(){if(0==Voyant.application.getDeferredCount()){for(var a in window)"object"==typeof window[a]&&window[a]&&"opener"!=a&&window[a].isFulfilled&&window[a].isFulfilled()&&(window[a]=window[a].valueOf());this.results.unmask();this.getTargetEl().fireEvent("resize")}else Ext.defer(this.tryToUnmask,20,this)},getContent:function(){var a={input:this.editor.getValue(),mode:this.editor.getMode().split("/").pop()};if("javascript"==
...
""),d=d.substring(d.indexOf("/spiral/")+8),e=d.split("/"),f=e.shift();f&&1<e.length&&"/"==d.charAt(d.length-1)&&(d=d.slice(0,-1));if(f&&"new"!=f){if("gist"==f)return this.loadFromUrl(d,c);"alta/"==d&&b&&b.all&&"true"==b.all?(this.loadFromUrl("alta/Start",c),this.loadFromUrl("alta/Create",c),this.loadFromUrl("alta/SmallerCorpus",c),this.loadFromUrl("alta/Tables",c)):this.loadFromUrl(d,c)}else this.loadData(void 0,c)}a=this;window.addEventListener("beforeunload",function(b){if(a.getIsEdited()){var c=
a.localize("editsAndLeaving");return(b||window.event).returnValue=c}})},listeners:{boxready:function(){this.init()},notebookWrapperMoveUp:function(a){a=this.items.findIndex("id",a.id);0==a?Ext.Msg.show({title:this.localize("error"),msg:this.localize("cannotMoveHigher"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.WARNING}):(this.move(a,a-1),this.redoOrder())},notebookWrapperMoveDown:function(a){a=this.items.findIndex("id",a.id);a==this.items.getCount()-1?Ext.Msg.show({title:this.localize("error"),
msg:this.localize("cannotMoveLower"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.WARNING}):(this.move(a,a+1),this.redoOrder())},notebookWrapperRemove:function(a){this.remove(a);this.redoOrder()},notebookWrapperRun:function(a){},notebookWrapperAdd:function(a,b){var c=this.items.findIndex("id",a.id),d=a.getXType(a);("notebooktexteditorwrapper"==d&&!b.hasModifier()||"notebookcodeeditorwrapper"==d&&b.hasModifier()?this.addCode("",c+1):this.addText("",c+1)).getTargetEl().scrollIntoView(this.getTargetEl(),
null,!0,!0);this.redoOrder()}},redoOrder:function(){this.query("notebookwrappercounter").forEach(function(a,b){a.setOrder(b)})},loadFromUrl:function(a,b){var c=this;if(0==a.indexOf("https://gist.github.com/")||0==a.indexOf("https://gist.githubusercontent.com/"))a="gist"+a.substring(a.indexOf(".com")+4,a.length-("/"==a.charAt(a.length-1)?1:0));if(0==a.indexOf("gist/")){var d=a.substring(5).split("/");if(2>d.length)return this.showError(this.localize("invalidGistUrl"));d[2]&&"raw"==d[2]&&d.splice(2,
1);var e="gist/"+d.slice(0,3).join("/");window.history.pushState({url:a},"Spiral Notebook: "+e,this.getBaseUrl()+"spiral/"+e);a="https://gist.githubusercontent.com/"+d.slice(0,2).join("/")+"/raw/"+(d[2]?d[2]:"")}else 0==a.indexOf("http")&&window.history.pushState({url:a},"Spiral Notebook: "+a,this.getBaseUrl()+"spiral/?input\x3d"+a);c.mask(this.localize("fetchingNotebook"));Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"notebook.NotebookManager",notebook:a},scope:this}).then(function(a,
d){c.unmask();var e=Ext.decode(a.responseText);c.loadBlocksFromString(e.notebook.jsonData,b)},function(b,d){c.showResponseError("Unable to load specified notebook: "+a,b);c.unmask();c.loadData()})},loadData:function(a,b){a||(a={blocks:[{type:"text",input:"\x3ch1 style\x3d'text-align: center;'\x3eSpiral Notebook Template (title)\x3c/h1\x3e\x3cp\x3eThis is a Spiral Notebook, a dynamic document that combines writing, code and data in service of reading, analyzing and interpreting digital texts.\x3c/p\x3e\x3cp\x3eSpiral Notebooks are composed of text blocks (like this one) and code blocks (like the one below). You can \x3cspan class\x3d'marker'\x3eclick on the blocks to edit\x3c/span\x3e them and add new blocks by clicking add icon that appears in the left column when hovering over a block.\x3c/p\x3e"},
...
200))},200)):(this.showError("Unable to load Notebooks data."),console.warn(a));b&&this.runAllCode()},loadBlocksFromString:function(a,b){if(/^\s*[\[\{]/m.test(a)){var c=void 0;try{c=jQuery.parseJSON(a)}catch(d){Ext.create("Voyant.util.DetailedError",{msg:this.localize("failedNotebookParse"),error:d.message,details:d.stack+"\n\n"+this.localize("originalJson")+": "+a}).showMsg()}this.loadData(c,b)}else this.loadData(a,b)},addText:function(a,b){return this._add(a,b,"notebooktexteditorwrapper")},addCode:function(a,
b){return this._add(a,b,"notebookcodeeditorwrapper")},_add:function(a,b,c){Ext.isString(a)&&(a={input:a});b="undefined"===typeof b?this.items.getCount():b;return this.insert(b,Ext.apply(a,{xtype:c,order:b,docs:"notebookcodeeditorwrapper"==c?this.docs:void 0}))},runAllCode:function(a){var b=[];Ext.Array.each(this.query("notebookcodeeditorwrapper"),function(c){b.push(c);c.clearResults();if(a&&a==c)return!1},this);this._runCodeContainers(b)},_runCodeContainers:function(a){0<a.length&&(0==Voyant.application.getDeferredCount()&&
a.shift().run(!0),Ext.defer(this._runCodeContainers,100,this,[a]))},exportAll:function(){var a=[],b,c,d;this.items.each(function(e){c=e.isXType("notebookcodeeditorwrapper")?"code":"text";d=e.getContent();"code"==c?(/[\r\n]/.test(d.input)&&(d.input=d.input.replace(/\r\n?/,"\n").split(/\n/)),b={type:"code",input:d.input,mode:d.mode,output:this.wrap(d.output)}):b={type:"text",input:this.wrap(d)};a.push(b)},this);1==a.length&&"code"==a[0].type&&(a=a[0].input);var e=this.getMetadata();Ext.applyIf(e,{created:(new Date).getTime(),
modified:(new Date).getTime(),version:this.getVersion()});e={metadata:e,blocks:a};Ext.Msg.prompt("Export Notebook","Currently only copying and pasting the notebook is available. You can select all the contents of the box below and copy to the clipboard.",void 0,void 0,!0,JSON&&JSON.stringify?JSON.stringify(e,void 0,4):Ext.encode(e))},wrap:function(a){if((a=a||"")&&80<a.length){for(var b=[],c=0,d=Math.ceil(a.length/80);c<d;c++)b.push(a.substr(80*c,80));a=b}return a}});Ext.define("Voyant.VoyantApp",{extend:"Ext.app.Application",mixins:["Voyant.util.Deferrable","Voyant.util.Localization","Voyant.util.Api","Voyant.util.CategoriesManager"],requires:["Voyant.util.ResponseError"],name:"VoyantApp",statics:{i18n:{},api:{palette:"default",lang:void 0,debug:void 0}},config:{baseUrl:void 0,tromboneUrl:void 0,categoriesManager:void 0},constructor:function(a){this.setBaseUrl(this.config.baseUrl);this.setTromboneUrl(this.config.baseUrl+"trombone");this.setCategoriesManager(new Ext.create("Voyant.util.CategoriesManager"));
...
Ext.Ajax.request({url:b.getTromboneUrl(),params:{tool:"resource.StoredResource",retrieveResourceId:this.getApiParam("embeddedApiId")}}).then(function(e){d.resolve();e=Ext.util.JSON.decode(e.responseText);e=Ext.urlDecode(e.storedResource.resource);debugger;var f=Ext.create({xtype:b.getTool(),api:e});debugger;f.setApiParams(e);a.unmask();a.remove(a.down("container"));a.add(f)}).otherwise(function(a){b.getTargetEl&&(Voyant.notebook.util.Show.TARGET=b.getTargetEl(),showError(a));Voyant.application.showError(a);
