...
this.getShortTitle()+"\x3c/i\x3e"+(a?" ("+a+")":"")},getTinyLabel:function(){return parseInt(this.getIndex())+1+") "+this.getTinyTitle()},getPubDate:function(){return this.get("pubDate")},getPublisher:function(){return this.get("publisher")},getPubPlace:function(){return this.get("pubPlace")},getKeyword:function(){return this.getMultiple("keyword")},getCollection:function(){return this.getMultiple("collection")},getAuthor:function(a){this.getMultiple("author")},getMuliple:function(a,b){var c=this.get(a)||
"",c=Ext.isArray(c)?c.join("; "):c,c=c.trim().replace(/\s+/g," ");return b?this.getTruncated(author,b):c},getCorpusId:function(){return this.get("corpus").getAliasOrId()},isPlainText:function(){return this.get("extra.Content-Type")&&/plain/i.test(this.get("extra.Content-Type"))?!0:!1},getAverageWordsPerSentence:function(){return this.get("averageWordsPerSentence")},show:function(){show(this.getFullLabel())},getCorpus:function(){return this.get("corpus")},getText:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,
...
this.getStore().load()},scope:this}},{xtype:"corpusdocumentselector"}]}]});a.on("loadedCorpus",function(a,c){1==c.getDocumentsCount()&&this.getStore().getProxy().setExtraParam("tool","corpus.DocumentTermCorrelations");this.isVisible()&&this.getStore().load()});a.on("activate",function(){this.getStore().getCorpus()&&this.getStore().load()},this);a.on("query",function(a,c){this.setApiParam("query",c);this.getStore().load()},a);a.callParent(arguments)}});Ext.define("Voyant.panel.CorpusCreator",{extend:"Ext.form.Panel",requires:["Ext.form.field.File"],requires:["Voyant.data.model.Corpus"],mixins:["Voyant.panel.Panel"],alias:"widget.corpuscreator",isConsumptive:!0,statics:{i18n:{},api:{inputFormat:void 0,language:void 0,xmlDocumentsXpath:void 0,xmlGroupByXpath:void 0,xmlContentXpath:void 0,xmlTitleXpath:void 0,xmlAuthorXpath:void 0,xmlPubDateXpath:void 0,xmlPublisherXpath:void 0,xmlPubPlaceXpath:void 0,xmlKeywordsXpath:void 0,xmlCollectionXpath:void 0,
xmlExtraMetadataXpath:void 0,htmlGroupByQuery:void 0,htmlDocumentsQuery:void 0,htmlContentQuery:void 0,htmlTitleQuery:void 0,htmlAuthorQuery:void 0,htmlPubDateQuery:void 0,htmlPublisherQuery:void 0,htmlPubPlaceQuery:void 0,htmlKeywordsQuery:void 0,htmlCollectionQuery:void 0,htmlExtraMetadataQuery:void 0,jsonGroupByPointer:void 0,jsonDocumentsPointer:void 0,jsonContentPointer:void 0,jsonTitlePointer:void 0,jsonAuthorPointer:void 0,jsonPubDatePointer:void 0,jsonPublisherPointer:void 0,jsonPubPlacePointer:void 0,
jsonKeywordsPointer:void 0,jsonCollectionPointer:void 0,jsonExtraMetadataPointer:void 0,tokenization:void 0,adminPassword:void 0,accessPassword:void 0,noPasswordAccess:void 0,tableDocuments:void 0,tableContent:void 0,tableTitle:void 0,tableAuthor:void 0,title:void 0,subTitle:void 0,inputRemoveFrom:void 0,inputRemoveFromAfter:void 0,inputRemoveUntil:void 0,inputRemoveUntilAfter:void 0,sort:void 0}},constructor:function(a){this.callParent(arguments);a=a||{};this.mixins["Voyant.panel.Panel"].constructor.call(this,
Ext.apply(a,{includeTools:{gear:!0,help:!0,language:this.getLanguageToolMenu()}}))},initComponent:function(){var a=this;Ext.apply(a,{title:this.localize("title"),width:800,frame:!0,padding:10,style:{borderColor:"#aaa",borderStyle:"solid"},frameHeader:!0,layout:{type:"vbox",align:"stretch"},dockedItems:[{xtype:"toolbar",overflowHandler:"scroller",dock:"bottom",buttonAlign:"right",items:[{text:a.localize("Open"),glyph:"xf115@FontAwesome",tooltip:a.localize("SelectExisting"),hidden:void 0!=this.getCorpus(),
handler:function(){Ext.create("Ext.window.Window",{title:a.localize("Open"),layout:"fit",modal:!0,items:{xtype:"form",submitEmptyText:!1,margin:"5,5,5,5",items:{xtype:"corpusselector"},buttons:[{text:a.localize("Open"),glyph:"xf00c@FontAwesome",handler:function(b){b.up("form").getForm();var c=b.up("form").getForm().getValues().corpus;""!=c?(a.loadCorpus({corpus:c}),b.up("window").close()):Ext.Msg.show({title:a.localize("SelectExisting"),message:a.localize("PleaseSelectExisting"),buttons:Ext.Msg.OK,
icon:Ext.Msg.ERROR})},flex:1},{text:a.localize("cancel"),glyph:"xf00d@FontAwesome",flex:1,handler:function(a){a.up("window").close()}}]}}).show()}},{xtype:"fileuploadfield",glyph:"xf093@FontAwesome",name:"upload",buttonOnly:!0,hideLabel:!0,ui:"default-toolbar",buttonText:a.localize("Upload"),listeners:{render:function(b){b.fileInputEl.dom.setAttribute("multiple",!0);Ext.tip.QuickTipManager.register({target:b.getEl(),text:a.localize("UploadLocal")})},beforedestroy:function(a){Ext.tip.QuickTipManager.unregister(a.getEl())},
change:function(b,c){if(c){var d=b.up("form").getForm();if(d.isValid()){for(var e=b.fileInputEl.dom.files,f=/\.(png|gif|jpe?g|xls|mp[234a]|mpeg|exe|wmv|avi|ppt|mpg|tif|wav|mov|psd|wma|ai|bmp|pps|aif|pub|dwg|indd|swf|asf|mbd|dmg|flv)$/i,g=/\.(txt|pdf|html?|xml|docx?|rtf|pages|epub|odt|zip|jar|tar|gz|ar|cpio|bzip2|bz2|gzip|xlsx?)$/i,k=[],h=[],l=0,m=e.length;l<m;l++){var n=e[l].name;f.test(n)?k.push(n.split("/").pop()):g.test(n)||h.push(n.split("/").pop())}0<k.length||0<h.length?Ext.Msg.show({title:a.localize("fileTypesWarning"),
icon:Ext.MessageBox.ERROR,message:a.localize("fileTypesMessage")+"\x3cul\x3e"+(0<k.length?"\x3cli\x3e"+a.localize("badFiles")+k.slice(0,5).join(", ")+(5<k.length?"\u2026":"")+"\x3c/li\x3e":"")+(0<h.length?"\x3cli\x3e"+a.localize("unknownFiles")+h.slice(0,5).join(", ")+(5<h.length?"\u2026":"")+"\x3c/li\x3e":"")+"\x3c/ul\x3e"+a.localize("sureContinue"),buttons:Ext.Msg.YESNO,fn:function(c){"yes"===c?a.loadForm(d):(b.reset(),b.fileInputEl.dom.setAttribute("multiple",!0))},scope:d}):a.loadForm(d)}}}}},
...
a.localize("errorNotXmlContinue"),function(b){"yes"==b&&a.loadCorpus(Ext.apply(d,{input:c}))},a):a.loadCorpus(Ext.apply(d,{input:c}))}else Ext.Msg.show({title:a.localize("noTextProvided"),message:a.localize("pleaseProvideText"),buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR})}}]}],items:[{html:this.getInitialConfig().addTextLabel,hidden:void 0==this.getInitialConfig().addTextLabel},{height:100,xtype:"textareafield",itemId:"input",emptyText:this.localize("emptyInput")}]});a.on("boxready",function(a){var c=
this.getApplication();c.getAllowInput&&"false"==c.getAllowInput()&&(c.getNoAllowInputText&&0<c.getNoAllowInputText().trim().length?Ext.defer(function(){var d=a.up("container");d.removeAll();d.add({frame:!1,padding:10,style:{borderColor:"#aaa",borderStyle:"solid"},html:c.getNoAllowInputText()})},100):(a.hide(),Ext.create("Ext.window.Window",{layout:"fit",header:!1,modal:!0,bodyPadding:10,items:{html:"\x3cp style\x3d'color: red;'\x3e"+a.localize("noAllowInputMessage")+"\x3c/p\x3e"}}).show()))});a.callParent(arguments)},
loadForm:function(a){var b={tool:this.getCorpus()?"corpus.CorpusMetadata":"corpus.CorpusCreator"};this.getCorpus()&&Ext.apply(b,{corpus:this.getCorpus().getId(),addDocuments:!0});var c=this.getApiParams();delete c.view;delete c.stopList;Ext.apply(b,c);var d=this.getApplication().getViewport();d.mask(this.localize("uploadingCorpus"));a.submit({url:this.getTromboneUrl(),params:b,failure:function(a,b){d.unmask();if(b.result&&(b.result.corpus||b.result.stepEnabledCorpusCreator)){var g={corpus:b.result.corpus?
b.result.corpus.metadata.id:b.result.stepEnabledCorpusCreator.storedId};Ext.applyIf(g,c);this.setCorpus(void 0);this.loadCorpus(g)}else this.showResponseError("Unable to load corpus.",b.response)},scope:this})},loadCorpus:function(a){this.getCorpus()&&Ext.apply(a,{corpus:this.getCorpus().getId(),addDocuments:!0});var b=this.up("window");b&&b.isFloating()&&b.close();this.getApplication().loadCorpusFromParams(a)},showOptionsClick:function(a){void 0===a.optionsWin&&(a.optionsWin=Ext.create("Ext.window.Window",
{title:a.localize("gearWinTitle"),closeAction:"hide",layout:"fit",bodyPadding:10,items:[{xtype:"form",defaultType:"textfield",maxHeight:a.getApplication().getViewport().getHeight()-300,scrollable:!0,fieldDefaults:{labelAlign:"right",labelWidth:110,width:350},items:[{xtype:"combo",fieldLabel:a.localize("inputFormat"),labelWidth:90,name:"inputFormat",queryMode:"local",store:[["",a.localize("inputFormatAuto")],["dtoc","DToC: Dynamic Table of Contexts"],["TEI","TEI: Text Encoding Initative"],["TEI","TEI Corpus"],
["RSS","Really Simple Syndication: RSS"]],value:"",listeners:{afterrender:{fn:function(a){var c=this.getApiParam("inputFormat");c&&a.setValue(c)},scope:a}}},{xtype:"container",html:"\x3cp\x3e\x3ci\x3e"+(new Ext.Template(a.localize("advancedOptionsText"))).applyTemplate([a.getBaseUrl()+"docs/#!/guide/corpuscreator-section-xml"])+"\x3c/i\x3e\x3c/p\x3e",width:375},{xtype:"fieldset",title:"\x3ca href\x3d'"+a.getBaseUrl()+"docs/#!/guide/corpuscreator-section-titles' target\x3d'voyantdocs'\x3e"+a.localize("corpusOptions")+
...
value:"",listeners:{afterrender:{fn:function(a){var c=this.getApiParam("sort");c&&a.setValue(c)},scope:a}}}]},{xtype:"fieldset",title:"\x3ca href\x3d'"+a.getBaseUrl()+"docs/#!/guide/corpuscreator-section-text' target\x3d'voyantdocs'\x3e"+a.localize("textOptions")+"\x3c/a\x3e",collapsible:!0,collapsed:!0,defaultType:"textfield",items:[{xtype:"container",html:"\x3cp\x3e\x3ci\x3e"+a.localize("textOptionsText")+"\x3c/i\x3e\x3c/p\x3e",width:375},{fieldLabel:a.localize("inputRemoveUntil"),name:"inputRemoveUntil"},
{fieldLabel:a.localize("inputRemoveUntilAfter"),name:"inputRemoveUntilAfter"},{fieldLabel:a.localize("inputRemoveFrom"),name:"inputRemoveFrom"},{fieldLabel:a.localize("inputRemoveFromAfter"),name:"inputRemoveFromAfter"}]},{xtype:"fieldset",title:"\x3ca href\x3d'"+a.getBaseUrl()+"docs/#!/guide/corpuscreator-section-xml' target\x3d'voyantdocs'\x3e"+a.localize("xmlOptions")+"\x3c/a\x3e",collapsible:!0,collapsed:!0,defaultType:"textfield",items:[{xtype:"container",html:"\x3cp\x3e\x3ci\x3e"+a.localize("xmlOptionsText")+
"\x3c/i\x3e\x3c/p\x3e",width:375},{fieldLabel:a.localize("xpathContent"),name:"xmlContentXpath"},{fieldLabel:a.localize("xpathTitle"),name:"xmlTitleXpath"},{fieldLabel:a.localize("xpathAuthor"),name:"xmlAuthorXpath"},{fieldLabel:a.localize("xpathDocuments"),name:"xmlDocumentsXpath"},{fieldLabel:a.localize("xpathGroupBy"),name:"xmlGroupByXpath"},{xtype:"fieldset",title:a.localize("xmlAdditionalOptions"),collapsible:!0,collapsed:!0,defaultType:"textfield",items:[{fieldLabel:a.localize("xpathPubDate"),
name:"xmlPubDateXpath"},{fieldLabel:a.localize("xpathPublisher"),name:"xmlPublisherXpath"},{fieldLabel:a.localize("xpathPubPlace"),name:"xmlPubPlaceXpath"},{fieldLabel:a.localize("xpathKeywords"),name:"xmlKeywordsXpath"},{fieldLabel:a.localize("xpathCollection"),name:"xmlCollectionXpath"},{xtype:"textareafield",grow:!0,fieldLabel:a.localize("xpathExtra"),name:"xmlExtraMetadataXpath"}]}]},{xtype:"fieldset",title:"\x3ca href\x3d'"+a.getBaseUrl()+"docs/#!/guide/corpuscreator-section-html' target\x3d'voyantdocs'\x3e"+
a.localize("htmlOptions")+"\x3c/a\x3e",collapsible:!0,collapsed:!0,defaultType:"textfield",items:[{xtype:"container",html:"\x3cp\x3e\x3ci\x3e"+(new Ext.Template(a.localize("htmlOptionsText"))).applyTemplate([a.getBaseUrl()+"docs/#!/guide/corpuscreator-section-html"])+"\x3c/i\x3e\x3c/p\x3e",width:375},{fieldLabel:a.localize("xpathContent"),name:"htmlContentQuery"},{fieldLabel:a.localize("xpathTitle"),name:"htmlTitleQuery"},{fieldLabel:a.localize("xpathAuthor"),name:"htmlAuthorQuery"},{fieldLabel:a.localize("xpathDocuments"),
name:"htmlDocumentsQuery"},{fieldLabel:a.localize("xpathGroupBy"),name:"htmlGroupByQuery"},{xtype:"fieldset",title:a.localize("xmlAdditionalOptions"),collapsible:!0,collapsed:!0,defaultType:"textfield",items:[{fieldLabel:a.localize("xpathPubDate"),name:"htmlPubDateQuery"},{fieldLabel:a.localize("xpathPublisher"),name:"htmlPublisherQuery"},{fieldLabel:a.localize("xpathPubPlace"),name:"htmlPubPlaceQuery"},{fieldLabel:a.localize("xpathKeywords"),name:"htmlKeywordsQuery"},{fieldLabel:a.localize("xpathCollection"),
name:"htmlCollectionQuery"},{xtype:"textareafield",grow:!0,fieldLabel:a.localize("xpathExtra"),name:"htmlExtraMetadataQuery"}]}]},{xtype:"fieldset",title:"\x3ca href\x3d'"+a.getBaseUrl()+"docs/#!/guide/corpuscreator-section-json' target\x3d'voyantdocs'\x3e"+a.localize("jsonOptions")+"\x3c/a\x3e",collapsible:!0,collapsed:!0,defaultType:"textfield",items:[{xtype:"container",html:"\x3cp\x3e\x3ci\x3e"+(new Ext.Template(a.localize("jsonOptionsText"))).applyTemplate([a.getBaseUrl()+"docs/#!/guide/corpuscreator-section-json"])+
"\x3c/i\x3e\x3c/p\x3e",width:375},{fieldLabel:a.localize("xpathContent"),name:"jsonContentPointer"},{fieldLabel:a.localize("xpathTitle"),name:"jsonTitlePointer"},{fieldLabel:a.localize("xpathAuthor"),name:"jsonAuthorPointer"},{fieldLabel:a.localize("xpathDocuments"),name:"jsonDocumentsPointer"},{fieldLabel:a.localize("xpathGroupBy"),name:"jsonGroupByPointer"},{xtype:"fieldset",title:a.localize("xmlAdditionalOptions"),collapsible:!0,collapsed:!0,defaultType:"textfield",items:[{fieldLabel:a.localize("xpathPubDate"),
name:"jsonPubDatePointer"},{fieldLabel:a.localize("xpathPublisher"),name:"jsonPublisherPointer"},{fieldLabel:a.localize("xpathPubPlace"),name:"jsonPubPlacePointer"},{fieldLabel:a.localize("xpathKeywords"),name:"jsonKeywordsPointer"},{fieldLabel:a.localize("xpathCollection"),name:"jsonCollectionPointer"},{xtype:"textareafield",grow:!0,fieldLabel:a.localize("xpathExtra"),name:"jsonExtraMetadataPointer"}]}]},{xtype:"fieldset",title:"\x3ca href\x3d'"+a.getBaseUrl()+"docs/#!/guide/corpuscreator-section-tables' target\x3d'voyantdocs'\x3e"+
...
renderer:function(a,b,c){return c.getIndex()+1},sortable:!1},{text:this.localize("documentTitle"),dataIndex:"title",sortable:!0,renderer:function(a,b,c){return c.getTitle()},flex:3},{text:this.localize("documentAuthor"),dataIndex:"author",sortable:!0,hidden:!0,renderer:function(a,b,c){return c.getAuthor()},flex:2},{text:this.localize("documentPubDate"),dataIndex:"pubDate",sortable:!0,hidden:!0,renderer:function(a,b,c){return c.getPubDate()},flex:2},{text:this.localize("documentPublisher"),dataIndex:"publisher",
sortable:!1,hidden:!0,renderer:function(a,b,c){return c.getPublisher()},flex:2},{text:this.localize("documentPubPlace"),dataIndex:"pubPlace",sortable:!1,hidden:!0,renderer:function(a,b,c){return c.getPubPlace()},flex:2},{text:this.localize("documentKeyword"),dataIndex:"keyword",sortable:!1,hidden:!0,renderer:function(a,b,c){return c.getKeyword()},flex:2},{text:this.localize("documentCollection"),dataIndex:"collection",sortable:!1,hidden:!0,renderer:function(a,b,c){return c.getCollection()},flex:2},
{text:this.localize("tokensCountLexical"),dataIndex:"tokensCount-lexical",renderer:Ext.util.Format.numberRenderer("0,000"),sortable:!0,width:"autoSize"},{text:this.localize("typesCountLexical"),dataIndex:"typesCount-lexical",renderer:Ext.util.Format.numberRenderer("0,000"),width:"autoSize"},{text:this.localize("typeTokenRatioLexical"),dataIndex:"typeTokenRatio-lexical",renderer:function(a){return Ext.util.Format.percent(a)},width:"autoSize"},{text:this.localize("averageWordsPerSentence"),dataIndex:"averageWordsPerSentence",
renderer:Ext.util.Format.numberRenderer("0,000.0"),tooltip:this.localize("averageWordsPerSentenceTip"),width:"autoSize"},{text:this.localize("language"),dataIndex:"language",hidden:!0,renderer:function(a,b,c,d,h,l,m){return m.ownerCt.getLanguage(a)},width:"autoSize"}],store:b,selModel:{type:"rowmodel",mode:"MULTI",listeners:{selectionchange:{fn:function(a,b){this.getApplication().dispatchEvent("documentsClicked",this,b,this.getStore().getCorpus())},scope:this}}},dockedItems:[{dock:"bottom",xtype:"toolbar",
overflowHandler:"scroller",items:c}]});this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.on("loadedCorpus",function(a,b){this.store.setCorpus(b);if(this.isVisible())this.store.load({params:this.getApiParams()});else this.on("afterrender",function(){this.store.load({params:this.getApiParams()})},this);0==this.hasCorpusAccess(b)&&(this.queryById("modifyButton").hide(),this.queryById("downloadButton").hide())});this.on("activate",function(){this.getStore().getCorpus()&&
this.getStore().load({params:this.getApiParams()})},this);this.on("query",function(a,b){this.setApiParam("query",b);this.store.load({params:this.getApiParams()})});a.embedded&&("Voyant.data.model.Corpus"==Ext.getClass(a.embedded).getName()?a.corpus=a.embedded:"Voyant.data.store.Documents"==Ext.getClass(a.embedded).getName()&&(this.store.setRecords(a.embedded.getData()),a.corpus=a.embedded.getCorpus()));a.corpus&&this.fireEvent("loadedCorpus",this,a.corpus)},keepRemoveReorderHandler:function(a){var b=
a.up("window").down("documents"),c=b.getSelection(),d=b.getStore().getCorpus().getDocumentsCount(),e=a.getItemId();if("reorder"==e){if(b.getStore().getCount()<d)return Ext.Msg.show({title:this.localize("error"),message:this.localize("reorderFilteredError"),buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR});docIndex=[];b.getStore().each(function(a){docIndex.push(a.getIndex())},this);for(a=1;a<docIndex.length;a++)if(docIndex[a-1]>docIndex[a])return Ext.Msg.confirm(b.localize("newCorpus"),(new Ext.Template(b.localize(e+
"Documents"))).applyTemplate([c.length]),function(a){"yes"===a&&(docIndex=[],this.getStore().each(function(a){docIndex.push(a.getIndex())},this),a={docIndex:docIndex},a[e+"Documents"]=!0,this.editCorpus(a))},b);return Ext.Msg.show({title:this.localize("error"),message:this.localize("reorderOriginalError"),buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR})}return 0<c.length?c.length==d?1==d?Ext.Msg.show({title:this.localize("error"),message:this.localize("onlyOneError"),buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR}):
Ext.Msg.show({title:this.localize("error"),message:this.localize("allSelectedError"),buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR}):Ext.Msg.confirm(this.localize("newCorpus"),(new Ext.Template(this.localize(e+"SelectedDocuments"))).applyTemplate([c.length]),function(a){"yes"===a&&(docIndex=[],c.forEach(function(a){docIndex.push(a.getIndex())}),a={docIndex:docIndex},a[e+"Documents"]=!0,this.editCorpus(a))},b):b.getApiParam("query")&&b.getStore().getCount()<d?Ext.Msg.confirm(this.localize("newCorpus"),(new Ext.Template(this.localize(e+
"FilteredDocuments"))).applyTemplate([c.length]),function(a){"yes"===a&&(docIndex=[],this.getStore().each(function(a){docIndex.push(a.getIndex())},this),a={docIndex:docIndex},a[e+"Documents"]=!0,this.editCorpus(a))},b):Ext.Msg.show({title:this.localize("error"),message:this.localize("selectOrFilterError"),buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR})},editCorpus:function(a){Ext.apply(a,{tool:"corpus.CorpusManager",corpus:this.getStore().getCorpus().getId()});var b=this.getApplication(),c=b.getViewport();
c.mask(this.localize("Creating new corpus\u2026"));Ext.Ajax.request({url:this.getApplication().getTromboneUrl(),method:"POST",params:a,success:function(a){c.unmask();a=Ext.decode(a.responseText);b.openUrl(b.getBaseUrl()+"?corpus\x3d"+a.corpus.id)}});(a=this.up("window"))&&a.isFloating()&&a.close()}});Ext.define("Voyant.panel.DocumentsFinder",{extend:"Ext.grid.Panel",require:["Voyant.data.store.DocumentQueryMatches","Ext.grid.plugin.CellEditing"],mixins:["Voyant.panel.Panel"],alias:"widget.documentsfinder",statics:{i18n:{}},config:{exportGridAll:!1},constructor:function(a){this.cellEditing=Ext.create("Ext.grid.plugin.CellEditing",{clicksToEdit:1});this.cellEditing.on("edit",this.onEditComplete,this);var b=this;Ext.apply(this,{title:this.localize("title"),emptyText:this.localize("emptyText"),plugins:[this.cellEditing],
...
arguments);this.on("loadedCorpus",function(a,b){this.loadDocument()},this)},loadDocument:function(){var a=this,b=parseInt(this.getApiParam("docIndex"))||0;this.getCorpus().getWordsArray({docIndex:b,stopList:"auto"}).then(function(b){var d=b.map(function(a){return a.toLowerCase()});if(void 0==a.getApiParam("groups")){var e={};d.forEach(function(a){5<a.length&&!(a in e)&&(e[a]=a.length)});var d=Math.max.apply(this,Object.values(e)),d=d3.scaleLinear().domain([4,d]).range([.5,1]),f;for(f in e)e[f]=d(e[f]);
...
debugger}}}]});this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.on("loadedCorpus",function(a,c){});this.on("afterrender",function(a){})}});Ext.define("Voyant.panel.Reader",{extend:"Ext.panel.Panel",requires:["Voyant.data.store.Tokens"],mixins:["Voyant.panel.Panel"],alias:"widget.reader",isConsumptive:!0,statics:{i18n:{},api:{start:0,limit:1E3,skipToDocId:void 0,query:void 0},glyph:"xf0f6@FontAwesome"},config:{innerContainer:void 0,tokensStore:void 0,documentsStore:void 0,documentTermsStore:void 0,exportVisualization:!1,lastScrollTop:0,scrollIntoView:!1,insertWhere:"beforeEnd",lastLocationUpdate:new Date},SCROLL_UP:-1,SCROLL_EQ:0,SCROLL_DOWN:1,
LOCATION_UPDATE_FREQ:100,INITIAL_LIMIT:1E3,constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(a){var b=Ext.create("Voyant.data.store.Tokens",{parentTool:this,proxy:{extraParams:{forTool:"reader"}}}),c=this;b.on("beforeload",function(a){return c.hasCorpusAccess(a.getCorpus())});b.on("load",function(a,b,c){if(c){var g="",k=this.localize("documentFrequency"),h=!1,l=-1,m=!1;b.forEach(function(a){0==a.getPosition()&&
(g+="\x3ch3\x3e"+this.getDocumentsStore().getById(a.getDocId()).getFullLabel()+"\x3c/h3\x3e");a.getDocIndex()!=l&&(h=this.getDocumentsStore().getById(a.getDocId()).isPlainText(),l=a.getDocIndex());if(a.isWord())m=!1,g+="\x3cspan class\x3d'word' id\x3d'"+a.getId()+"' data-qtip\x3d'"+k+" "+a.getDocumentRawFreq()+"'\x3e"+a.getTerm()+"\x3c/span\x3e";else{a=a.getTermWithLineSpacing(h);var b=0==a.indexOf("\x3cbr /\x3e");if(!m||!b&&0!=a.trim().length)g+=a,m=b}},this);this.updateText(g);this.down("querysearchfield").getValue()}},
this);this.setTokensStore(b);this.on("query",function(a,b){this.loadQueryTerms(b)},this);this.setDocumentTermsStore(Ext.create("Ext.data.Store",{model:"Voyant.data.model.DocumentTerm",autoLoad:!1,remoteSort:!1,proxy:{type:"ajax",url:Voyant.application.getTromboneUrl(),extraParams:{tool:"corpus.DocumentTerms",withDistributions:!0,withPositions:!0,bins:25,forTool:"reader"},reader:{type:"json",rootProperty:"documentTerms.terms",totalProperty:"documentTerms.total"},simpleSortMode:!0},listeners:{load:function(a,
b,c,g){a.sort("docIndex","ASC");var k;a.each(function(a){k=a.get("term")},this);this.highlightKeywords(k)},scope:this}}));this.on("afterrender",function(){var a=this.down('panel[region\x3d"center"]');this.setInnerContainer(a.getLayout().getRenderTarget());a.body.on("scroll",function(a,b){var c=this.getLastScrollTop()<b.scrollTop?this.SCROLL_DOWN:this.getLastScrollTop()>b.scrollTop?this.SCROLL_UP:this.SCROLL_EQ;if(c==this.SCROLL_UP&&1>b.scrollTop)this.fetchPrevious(!0);else if(c==this.SCROLL_DOWN&&
b.scrollHeight-b.scrollTop<1.5*b.offsetHeight)this.fetchNext(!1);else{var d;d=0==b.scrollTop?0:b.scrollHeight-b.scrollTop==b.clientHeight?1:(b.scrollTop+.5*b.clientHeight)/b.scrollHeight;(new Date-this.getLastLocationUpdate()>this.LOCATION_UPDATE_FREQ||0==d||1==d)&&this.updateLocationMarker(d,c)}this.setLastScrollTop(b.scrollTop)},this);a.body.on("click",function(a,b){b=Ext.get(b);if(b.hasCls("word")){var c=Voyant.data.model.Token.getInfoFromElement(b),d=b.getHtml(),c=[{term:d,docIndex:c.docIndex}];
this.loadQueryTerms([d]);this.getApplication().dispatchEvent("termsClicked",this,c)}},this);this.getCorpus()&&(this.load(),(a=this.getApiParam("query"))&&this.loadQueryTerms(Ext.isString(a)?[a]:a));this.on("loadedCorpus",function(){this.load(!0);var a=this.getApiParam("query");a&&this.loadQueryTerms(Ext.isString(a)?[a]:a)},this)},this);Ext.apply(this,{title:this.localize("title"),cls:"voyant-reader",layout:"fit",items:{layout:"border",items:[{bodyPadding:10,region:"center",border:!1,autoScroll:!0,
html:'\x3cdiv class\x3d"readerContainer"\x3e\x3c/div\x3e'},{xtype:"readergraph",region:"south",height:40,split:{size:2},splitterResize:!0,border:!1,listeners:{documentRelativePositionSelected:function(a,b){var c=this.getDocumentsStore().getAt(b.docIndex),g=c.get("tokensCount-lexical"),g=Math.floor(g*b.fraction)-this.getApiParam("limit")/2;this.setApiParams({skipToDocId:c.getId(),start:0>g?0:g});this.load(!0)},scope:this}}]},dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{glyph:"xf060@FontAwesome",
handler:function(){this.fetchPrevious(!0)},scope:this},{glyph:"xf061@FontAwesome",handler:function(){this.fetchNext(!0)},scope:this},{xtype:"tbseparator"},{xtype:"querysearchfield"}]}],listeners:{loadedCorpus:function(a,b){this.getTokensStore().setCorpus(b);this.getDocumentTermsStore().getProxy().setExtraParam("corpus",b.getId());var c=b.getDocuments();this.setDocumentsStore(c);this.rendered&&(this.load(),0==this.hasCorpusAccess(b)&&this.mask(this.localize("limitedAccess"),"mask-no-spinner"),(c=this.getApiParam("query"))&&
...
g+"_"+k);a&&a.scrollIntoView();this.highlightKeywords(c.get("term"),!1)},scope:this})}},documentIndexTermsClicked:function(a,b){if(void 0!==b[0]){var c=Ext.create("Voyant.data.model.Token",b[0]);this.fireEvent("termLocationClicked",this,[c])}},scope:this}});this.callParent(arguments)},loadQueryTerms:function(a){a&&0<a.length&&(this.getDocumentTermsStore().load({params:{query:a}}),this.down("readergraph").loadQueryTerms(a))},highlightKeywords:function(a,b){Ext.isArray(a)||(a=[a]);this.getInnerContainer().first().select("span[class*\x3dkeyword]").removeCls("keyword");
...
b){a&&(this.getInnerContainer().first().destroy(),this.getInnerContainer().setHtml('\x3cdiv class\x3d"readerContainer"\x3e\x3cdiv class\x3d"loading"\x3e'+this.localize("loading")+"\x3c/div\x3e\x3c/div\x3e"),this.getInnerContainer().first().first().mask());this.getTokensStore().load(Ext.apply(b||{},{params:Ext.apply(this.getApiParams(),{stripTags:"blocksOnly",stopList:""})}))},updateText:function(a){var b=this.getInnerContainer().down(".loading");b&&b.destroy();var c=this.getInnerContainer().first().insertHtml(this.getInsertWhere(),
a,!0);c&&this.getScrollIntoView()&&(c.dom.scrollIntoView(),Ext.Function.defer(function(){var a=Ext.get(c.id);a&&a.frame("red")},100));a=this.down('panel[region\x3d"center"]').body.dom;this.updateLocationMarker(0==a.scrollTop?0:a.scrollHeight-a.scrollTop==a.clientHeight?1:(a.scrollTop+.5*a.clientHeight)/a.scrollHeight)},updateLocationMarker:function(a,b){var c=Ext.DomQuery.select(".word",this.getInnerContainer().down(".readerContainer",!0)),d=c[0],e=c[c.length-1];if(void 0!==d&&void 0!==e){var c=this.getCorpus(),
f=!1,d=Voyant.data.model.Token.getInfoFromElement(Ext.get(d)),e=Voyant.data.model.Token.getInfoFromElement(Ext.get(e));0!==d.position&&(f=!0);for(var g={},k=0,h=d.docIndex;h<=e.docIndex;){var l=c.getDocument(h).get("tokensCount-lexical");h===e.docIndex&&(l=e.position);h===d.docIndex&&(l-=d.position);k+=l;g[h]=l;h++}for(var h=Math.round(k*a),l=k=0,m=d.docIndex;m<=e.docIndex&&!(k=m,l+=g[m],l>=h);m++);e=g[k]-(l-h);f&&k===d.docIndex&&(e+=d.position);c=e/c.getDocument(k).get("tokensCount-lexical");this.down("readergraph").moveLocationMarker(k,
c,b)}},updateChart:function(){}});Ext.define("Voyant.panel.SimpleDocReader",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.simpledocreader",isConsumptive:!0,statics:{i18n:{},api:{docIndex:void 0,docId:void 0},glyph:"xf0f6@FontAwesome"},config:{},constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(a){Ext.apply(this,{html:'\x3ciframe style\x3d"width: 100%; height: 100%; border: none;"\x3e\x3c/iframe\x3e',dockedItems:[{dock:"bottom",
