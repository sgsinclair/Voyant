...
a.getCorpus().getId());params&&(url+="?"+Ext.Object.toQueryString(params));a.openUrl(url)},exportToolClick:function(a){a.isXType("voyanttabpanel")&&(a=a.getActiveTab());var b=[{xtype:"radio",name:"export",inputValue:"url",boxLabel:"\x3ca href\x3d'"+a.getExportUrl.call(a)+"' target\x3d'_blank'\x3e"+a.localize("exportViewUrl")+"\x3c/a\x3e",checked:!0,listeners:{afterrender:function(){this.boxLabelEl.on("click",function(){this.up("window").close()},this)}}},{xtype:"fieldset",collapsible:!0,collapsed:!0,
title:a.localize("exportViewFieldset"),items:[{xtype:"radio",name:"export",inputValue:"embed",boxLabel:a.localize("exportViewHtmlEmbed")},{xtype:"radio",name:"export",inputValue:"biblio",boxLabel:a.localize("exportViewBiblio")}]}];a.isXType("grid")&&b.push({xtype:"fieldset",collapsible:!0,collapsed:!0,title:a.localize("exportGridCurrent"),items:[{xtype:"radio",name:"export",inputValue:"gridCurrentHtml",boxLabel:a.localize("exportGridCurrentHtml")},{xtype:"radio",name:"export",inputValue:"gridCurrentTsv",
boxLabel:a.localize("exportGridCurrentTsv")},{xtype:"radio",name:"export",inputValue:"gridCurrentJson",boxLabel:a.localize("exportGridCurrentJson")}]});if((!a.getExportVisualization||a.getExportVisualization())&&(a.down("chart")||a.getTargetEl().dom.querySelector("canvas")||a.getTargetEl().dom.querySelector("svg"))){var c=[{xtype:"radio",name:"export",inputValue:"png",boxLabel:a.localize("exportPng")}];a.getTargetEl().dom.querySelector("svg")&&c.push({xtype:"radio",name:"export",inputValue:"svg",
...
a)}}}});this.callParent(arguments)},updateStatus:function(a){this.update({count:a})}});Ext.define("Voyant.widget.DocumentSelector",{extend:"Ext.menu.Item",mixins:["Voyant.util.Localization"],alias:"widget.documentselector",glyph:"xf10c@FontAwesome",statics:{i18n:{documents:{en:"Documents"},selectAll:{en:"All"},selectNone:{en:"None"},ok:{en:"Ok"},cancel:{en:"Cancel"},all:{en:"all"}}},config:{docs:void 0,corpus:void 0,docStore:void 0,singleSelect:!1},initComponent:function(){this.setSingleSelect(void 0==this.config.singleSelect?this.getSingleSelect():this.config.singleSelect);Ext.apply(this,
{text:this.localize("documents"),menu:{width:250,fbar:[{xtype:"checkbox",hidden:this.getSingleSelect(),boxLabel:this.localize("all"),listeners:{change:{fn:function(a,b){this.getMenu().items.each(function(a){a.setChecked(b)})},scope:this}}},{xtype:"tbfill"},{xtype:"button",text:this.localize("ok"),hidden:this.getSingleSelect(),scale:"small",handler:function(a,b){var c=[];this.getMenu().items.each(function(a){a.checked&&c.push(a.docId)},this);var d=a.findParentBy(function(a){return a.mixins["Voyant.panel.Panel"]});
d&&d.fireEvent("documentsSelected",a,c);a.findParentBy(function(a){return a.isXType("button")&&a.hasVisibleMenu()?(a.hideMenu(),!0):!1})},scope:this},{xtype:"button",text:this.localize("cancel"),scale:"small",handler:function(a,b){this.findParentBy(function(a){return a.isXType("button")&&a.hasVisibleMenu()?(a.hideMenu(),!0):!1})},scope:this}],items:[]},listeners:{afterrender:function(a){var b=a.findParentBy(function(a){return a.mixins["Voyant.panel.Panel"]});b.getCorpus&&this.setCorpus(b.getCorpus());
a.on("loadedCorpus",function(a,b){this.setCorpus(b)},a)}}});this.callParent(arguments);this.setDocStore(Ext.create("Ext.data.Store",{model:"Voyant.data.model.Document",autoLoad:!1,remoteSort:!1,proxy:{type:"ajax",url:Voyant.application.getTromboneUrl(),extraParams:{tool:"corpus.DocumentsMetadata"},reader:{type:"json",rootProperty:"documentsMetadata.documents",totalProperty:"documentsMetadata.total"},simpleSortMode:!0},listeners:{load:function(a,b,c,d){this.populate(b)},scope:this}}))},setCorpus:function(a){a&&
(this.getDocStore().getProxy().setExtraParam("corpus",a.getId()),this.getDocStore().load());this.callParent(arguments)},populate:function(a,b){this.setDocs(a);var c=this.getMenu();b&&c.removeAll();var d=this.getSingleSelect(),e="docGroup"+Ext.id();a.forEach(function(a,b){c.add({xtype:"menucheckitem",text:a.getShortTitle(),docId:a.get("id"),checked:d&&0==b||!d,group:d?e:void 0,checkHandler:function(a,b){if(this.getSingleSelect()&&b){var c=this.findParentBy(function(a){return a.mixins["Voyant.panel.Panel"]});
c&&c.fireEvent("documentsClicked",this,[a.docId])}},scope:this})},this)}});Ext.define("Voyant.widget.CorpusDocumentSelector",{extend:"Ext.menu.Item",mixins:["Voyant.util.Localization"],alias:"widget.corpusdocumentselector",statics:{i18n:{corpus:{en:"Corpus"},scale:{en:"Scale"}}},config:{corpus:void 0,singleSelect:!1},initComponent:function(){this.setSingleSelect(void 0==this.config.singleSelect?this.getSingleSelect():this.config.singleSelect);Ext.apply(this,{text:this.localize("scale"),glyph:"xf059@FontAwesome",menu:{items:[{text:this.localize("corpus"),glyph:"xf111@FontAwesome",
handler:function(){var a=this.findParentBy(function(a){return a.mixins["Voyant.panel.Panel"]});a&&a.fireEvent("corpusSelected",this,this.getCorpus())},scope:this},{xtype:"documentselector",singleSelect:this.getSingleSelect()}]},listeners:{afterrender:function(a){var b=a.findParentBy(function(a){return a.mixins["Voyant.panel.Panel"]});b.getCorpus&&this.setCorpus(b.getCorpus());a.on("loadedCorpus",function(a,b){this.setCorpus(b)},a)}}});this.callParent(arguments)}});Ext.define("Voyant.panel.Panel",{mixins:"Voyant.util.Localization Voyant.util.Api Voyant.util.Toolable Voyant.util.DetailedError Voyant.widget.QuerySearchField Voyant.widget.StopListOption Voyant.widget.TotalPropertyStatus".split(" "),alias:"widget.voyantpanel",statics:{i18n:{term:{en:"Term"},rawFreq:{en:"Count"},relativeFreq:{en:"Relative"},trend:{en:"Trend"},colon:{en:": "},loading:{en:"Loading"}}},constructor:function(a){this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);this.mixins["Voyant.util.Toolable"].constructor.apply(this,
...
this.setDocTermStore(a);Ext.apply(this,{dockedItems:[{dock:"bottom",xtype:"toolbar",items:[{xtype:"querysearchfield"},{xtype:"button",text:this.localize("options"),menu:{items:[{text:this.localize("clearTerms"),glyph:"xf014@FontAwesome",handler:function(){this.down("#termsView").getSelectionModel().deselectAll(!0);this.termStore.removeAll();this.setApiParams({query:null});this.bubblelines.removeAllTerms();this.bubblelines.drawGraph()},scope:this},{xtype:"documentselector",listeners:{afterrender:function(a){this.getCorpus()&&
a.setHidden(1==this.getCorpus().getDocumentsCount());this.on("loadedCorpus",function(a,b){this.setHidden(1==b.getDocumentsCount())},a)},scope:this}}]},scope:this},"-",{xtype:"slider",itemId:"granularity",fieldLabel:this.localize("granularity"),labelAlign:"right",labelWidth:70,width:150,increment:10,minValue:10,maxValue:300,listeners:{changecomplete:function(a,c){this.setApiParams({bins:c});this.bubblelines.bubbleSpacing=c;this.reloadTermsData()},scope:this}},"-",{xtype:"checkbox",boxLabel:this.localize("separateLines"),
boxLabelAlign:"before",checked:!1,handler:function(a,c){this.bubblelines.SEPARATE_LINES_FOR_TERMS=c;this.bubblelines.lastClickedBubbles={};this.bubblelines.setCanvasHeight();this.bubblelines.drawGraph()},scope:this}]}],border:!1,layout:"fit",items:{layout:{type:"vbox",align:"stretch"},defaults:{border:!1},items:[{height:30,itemId:"termsView",xtype:"dataview",store:this.termStore,tpl:this.termTpl,itemSelector:"div.term",overItemCls:"over",selectedItemCls:"selected",selectionModel:{mode:"SIMPLE"},focusCls:"",
listeners:{beforeitemclick:function(a,c,d,e,f,g){f.preventDefault();f.stopPropagation();a.fireEvent("itemcontextmenu",a,c,d,e,f,g);return!1},beforecontainerclick:function(){event.preventDefault();event.stopPropagation();return!1},selectionchange:function(a,c){var d=this.down("#termsView"),e=[];d.getStore().each(function(a){-1!==c.indexOf(a)?(e.push(a.get("term")),Ext.fly(d.getNodeByRecord(a)).removeCls("unselected").addCls("selected")):Ext.fly(d.getNodeByRecord(a)).removeCls("selected").addCls("unselected")});
for(var f in this.bubblelines.lastClickedBubbles){var g=this.bubblelines.lastClickedBubbles[f],h;for(h in g)-1==e.indexOf(h)&&delete this.bubblelines.lastClickedBubbles[f][h]}this.bubblelines.termsFilter=e;this.bubblelines.setCanvasHeight();this.bubblelines.drawGraph()},itemcontextmenu:function(a,c,d,e,f){f.preventDefault();f.stopPropagation();var g=a.isSelected(d);(new Ext.menu.Menu({floating:!0,items:[{text:g?this.localize("hideTerm"):this.localize("showTerm"),handler:function(){g?a.deselect(e):
a.select(e,!0)},scope:this},{text:this.localize("removeTerm"),handler:function(){a.deselect(e);var c=this.termStore.getAt(e).get("term");this.termStore.removeAt(e);a.refresh();this.bubblelines.removeTerm(c);this.bubblelines.setCanvasHeight();this.bubblelines.drawGraph()},scope:this}]})).showAt(f.getXY())},scope:this}},{flex:1,xtype:"container",autoEl:"div",itemId:"canvasParent",layout:"fit",overflowY:"auto",overflowX:"hidden"}],listeners:{render:function(a){a=this.down("#canvasParent");this.bubblelines=
new Bubblelines({container:a,clickHandler:this.bubbleClickHandler.bind(this)});this.bubblelines.bubbleSpacing=parseInt(this.getApiParam("bins"))},afterlayout:function(a){!1===this.bubblelines.initialized&&this.bubblelines.initializeCanvas()},resize:function(a,c,d){this.bubblelines.doBubblelinesLayout()},scope:this}}});this.callParent(arguments)},loadFromCorpusTerms:function(a){this.bubblelines&&(this.bubblelines.removeAllTerms(),this.termStore.removeAll(!0));a.load({callback:function(a,c,d){var e=
[];"string"==typeof e&&(e=[e]);a.forEach(function(a,b){e.push(a.get("term"))},this);this.getDocTermsFromQuery(e)},scope:this,params:{limit:5,stopList:this.getApiParams("stopList")}})},getDocTermsFromQuery:function(a){a&&this.setApiParam("query",a);if(this.getCorpus()&&this.isVisible())for(var b=this.getCorpus().getDocuments(),c=b.getCount(),d=0;d<c;d++){var e=b.getAt(d);this.setApiParams({query:a,docIndex:void 0,docId:e.getId()});this.getDocTermStore().load({params:this.getApiParams()})}},reloadTermsData:function(){var a=
[],b;for(b in this.bubblelines.currentTerms)a.push(b);this.getDocTermsFromQuery(a)},filterDocuments:function(){var a=this.getApiParam("docId");""==a&&(a=[],this.getCorpus().getDocuments().each(function(b,c){a.push(b.getId())}),this.setApiParams({docId:a}));"string"==typeof a&&(a=[a]);if(null==a){this.selectedDocs=this.getCorpus().getDocuments().clone();var b=this.selectedDocs.getCount();if(10<b)for(var c=10;c<b;c++)this.selectedDocs.removeAt(10);a=[];this.selectedDocs.eachKey(function(b,c){a.push(b)},
this);this.setApiParams({docId:a})}else this.selectedDocs=this.getCorpus().getDocuments().filterBy(function(b,c){return-1!=a.indexOf(c)},this)},processDocuments:function(a){a.forEach(this.processDocument,this)},processDocument:function(a){var b=a.getId();if(!this.processedDocs.containsKey(b)){var c=a.getShortTitle(),c=c.replace("\x26hellip;","..."),d=a.get("index");a=a.get("tokensCount-lexical");this.processedDocs.add(b,{id:b,index:d,title:c,totalTokens:a,terms:{}})}},processTerms:function(a){var b,
...
e=d.down("form").getValues();a.setApiParams(e);d.hide()}},{text:a.localize("cancel"),handler:function(a,c){a.findParentByType("window").hide()}}]}));a.optionsWin.show()}});Ext.define("Voyant.panel.Knots",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.knots",statics:{i18n:{title:{en:"Knots"},type:{en:"Visualization"},findTerm:{en:"Find Term"},clearTerms:{en:"Clear Terms"},removeTerm:{en:"Remove Term"},showTerm:{en:"Show Term"},hideTerm:{en:"Hide Term"},options:{en:"Options"},speed:{en:"Speed"},startAngle:{en:"Start Angle"},tangles:{en:"Turn Angle"},context:{en:"Context"}},api:{query:null,stopList:"auto",docId:void 0},glyph:"xf06e@FontAwesome"},
config:{corpus:void 0,docTermStore:void 0,tokensStore:void 0,options:{xtype:"stoplistoption"},refreshInterval:100,startAngle:315,angleIncrement:15,currentTerm:void 0},knots:null,termTpl:new Ext.XTemplate('\x3ctpl for\x3d"."\x3e','\x3cdiv class\x3d"term" style\x3d"color: rgb({color});float: left;padding: 3px;margin: 2px;"\x3e{term}\x3c/div\x3e',"\x3c/tpl\x3e"),termStore:new Ext.data.ArrayStore({fields:["term","color"]}),constructor:function(){Ext.apply(this,{title:this.localize("title")});this.callParent(arguments);
...
Ext.Function.defer(function(){this.getDocTermStore().load({params:{limit:5,stopList:this.getApiParams("stopList")}})},100,this)},this);this.on("query",function(a,b){void 0!==b&&""!=b&&this.getDocTermsFromQuery(b)},this);this.on("documentsSelected",function(a,b){var c=b[0];this.setApiParam("docId",c);var d=this.knots.currentDoc.terms,e=[],f;for(f in d)e.push(f);this.termStore.removeAll();this.setApiParams({query:e});d=e.length;0===d&&(d=5);c=this.processDocument(this.getCorpus().getDocument(c));this.knots.setCurrentDoc(c);
...
this.getApiParam("docId"))},load:function(a,b,c,d){var e={};b.forEach(function(a){var b=this.processTerms(a);a.get("docId");a=a.get("term");e[a]=b},this);this.knots.addTerms(e);this.knots.buildGraph()},scope:this}}));this.setTokensStore(Ext.create("Voyant.data.store.Tokens",{stripTags:"all",listeners:{beforeload:function(a){a.getProxy().setExtraParam("docId",this.getApiParam("docId"))},load:function(a,b,c,d){var e="",f=this.getCurrentTerm();b.forEach(function(a){e=a.getPosition()==f.tokenId?e+("\x3cstrong\x3e"+
a.getTerm()+"\x3c/strong\x3e"):e+a.getTerm()});Ext.Msg.show({title:this.localize("context"),message:e,buttons:Ext.Msg.OK,icon:Ext.Msg.INFO})},scope:this}}));Ext.apply(this,{dockedItems:[{dock:"bottom",xtype:"toolbar",items:[{xtype:"querysearchfield"},"-",{xtype:"documentselector",itemId:"docSelector",singleSelect:!0},"-",{xtype:"button",text:this.localize("options"),menu:{width:200,items:[{xtype:"slider",itemId:"speed",fieldLabel:this.localize("speed"),labelAlign:"right",labelWidth:70,increment:50,
minValue:0,maxValue:500,value:500-this.getRefreshInterval(),listeners:{changecomplete:function(a,b){this.setRefreshInterval(500-b);this.knots&&this.knots.buildGraph()},scope:this}},{xtype:"slider",itemId:"startAngle",fieldLabel:this.localize("startAngle"),labelAlign:"right",labelWidth:70,increment:15,minValue:0,maxValue:360,value:this.getStartAngle(),listeners:{changecomplete:function(a,b){this.setStartAngle(b);this.knots&&this.knots.buildGraph()},scope:this}},{xtype:"slider",itemId:"tangles",fieldLabel:this.localize("tangles"),
labelAlign:"right",labelWidth:70,increment:5,minValue:5,maxValue:90,value:this.getAngleIncrement(),listeners:{changecomplete:function(a,b){this.setAngleIncrement(b);this.knots&&this.knots.buildGraph()},scope:this}}]}}]}],border:!1,layout:"fit",items:{layout:{type:"vbox",align:"stretch"},defaults:{border:!1},items:[{height:30,itemId:"termsView",xtype:"dataview",store:this.termStore,tpl:this.termTpl,itemSelector:"div.term",overItemCls:"over",selectedItemCls:"selected",selectionModel:{mode:"SIMPLE"},
...
this.knots.termsFilter=d;this.knots.drawGraph()},itemcontextmenu:function(a,b,c,d,e){e.preventDefault();e.stopPropagation();var f=a.isSelected(c);(new Ext.menu.Menu({floating:!0,items:[{text:f?this.localize("hideTerm"):this.localize("showTerm"),handler:function(){f?a.deselect(d):a.select(d,!0)},scope:this},{text:this.localize("removeTerm"),handler:function(){a.deselect(d);var b=this.termStore.getAt(d).get("term");this.termStore.removeAt(d);a.refresh();this.knots.removeTerm(b);this.knots.drawGraph()},
scope:this}]})).showAt(e.getXY())},scope:this}},{flex:1,xtype:"container",autoEl:"div",itemId:"canvasParent",layout:"fit",overflowY:"auto",overflowX:"hidden"}],listeners:{render:function(a){a=this.down("#canvasParent");this.knots=new Knots({container:a,clickHandler:this.knotClickHandler.bind(this)})},afterlayout:function(a){!1===this.knots.initialized&&this.knots.initializeCanvas()},resize:function(a,b,c){this.knots.doLayout()},scope:this}}});this.callParent(arguments)},updateRefreshInterval:function(a){this.knots&&
(50>a?(a=50,this.knots.progressiveDraw=!1):this.knots.progressiveDraw=!0,this.knots.refreshInterval=a,this.knots.buildGraph(this.knots.drawStep))},updateStartAngle:function(a){this.knots&&(this.knots.startAngle=a,this.knots.recache(),this.knots.buildGraph())},updateAngleIncrement:function(a){this.knots&&(this.knots.angleIncrement=a,this.knots.recache(),this.knots.buildGraph())},loadFromCorpusTerms:function(a){this.knots&&(this.knots.removeAllTerms(),this.termStore.removeAll(!0));a.load({callback:function(a,
