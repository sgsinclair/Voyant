...
"color");if(void 0!==b)for(var b=this.app.hexToRgb(b),c=this.app.getCategoryTerms(a),d=0;d<c.length;d++)this.app.colorTermAssociations.replace(c[d],b)}}});Ext.define("Voyant.widget.VoyantNetworkGraph",{extend:"Ext.panel.Panel",mixins:["Voyant.util.Localization","Voyant.util.Api","Voyant.notebook.util.Embed"],embeddable:["Voyant.widget.VoyantNetworkGraph"],alias:"widget.voyantnetworkgraph",statics:{i18n:{},api:{jsonData:void 0,docId:void 0,docIndex:void 0,json:void 0}},config:{json:void 0},constructor:function(a){a=a||{};this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);this.callParent(arguments);this.on("boxready",function(a,c){this.buildGraph()},
this)},initComponent:function(a){this.callParent(arguments)},getJsonResourcefully:function(){return this.getApiParam("jsonData")?Ext.decode(this.getApiParam("jsonData")):this.getApiParam("json")?this.getApiParam("json"):this.getJson()},buildGraph:function(a){a=a||this.getJsonResourcefully();a&&a.links||(a&&a.edges&&(a.links=a.edges,delete a.edges),a&&a.links||(a=a||{},a.links=[]));if(!a.nodes){var b={},c={};a.nodes=[];a.links.forEach(function(d){["source","target"].forEach(function(e){0==d[e]in b?
(b[d[e]]=a.nodes.length,c[d[e]]=1,a.nodes.push({name:d[e]})):c[d[e]]++;d[e]=b[d[e]];d.value=1})});a.nodes.forEach(function(a){Ext.applyIf(a,{value:c[a.name]})})}var d=this.getWidth(),e=this.getHeight(),f=this.getTargetEl().dom.firstChild.firstChild;f.innerHTML="";var g=function(){h.attr("transform","translate("+d3.event.translate+")scale("+d3.event.scale+")")};d3.behavior.zoom().scaleExtent([1,10]).on("zoom",g);var h=d3.select(f).append("svg").attr("width",d).attr("height",e).append("g").attr("transform",
"translate(-5,-5)").call(d3.behavior.zoom().scaleExtent([.5,10]).on("zoom",g)),d=d3.layout.force().gravity(.1).distance(50).charge(-100).size([d,e]);d.nodes(a.nodes).links(a.links).start();var k=h.selectAll(".link").data(a.links).enter().append("line").attr("class","link").attr("stroke","#eee"),l=h.selectAll(".node").data(a.nodes).enter().append("g").attr("class","node").call(d.drag);l.append("circle").attr("r",5).attr("fill","#ddd");e=a.nodes.map(function(a){return a.value});e.sort();var m=d3.scale.log().domain([e[0],
e[e.length-1]]).range([8,36]);l.append("text").attr("dx",12).attr("dy",".35em").text(function(a){return a.name}).attr("font-size",function(a){return m(a.value)+"px"});d.on("tick",function(){k.attr("x1",function(a){return a.source.x}).attr("y1",function(a){return a.source.y}).attr("x2",function(a){return a.target.x}).attr("y2",function(a){return a.target.y});l.attr("transform",function(a){return"translate("+a.x+","+a.y+")"})})}});Ext.define("Voyant.panel.Panel",{mixins:["Voyant.util.Localization","Voyant.util.Api","Voyant.util.Toolable","Voyant.util.DetailedError"],requires:["Voyant.widget.QuerySearchField","Voyant.widget.StopListOption","Voyant.widget.CategoriesOption","Voyant.widget.TotalPropertyStatus"],alias:"widget.voyantpanel",statics:{i18n:{},config:{corpusValidated:!1},api:{corpus:void 0,input:void 0,inputFormat:void 0,subtitle:void 0}},config:{corpus:void 0},constructor:function(a){this.mixins["Voyant.util.Api"].constructor.apply(this,
