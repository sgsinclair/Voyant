...
this;b.then(function(a){void 0!==a&&Spyral.Notebook.show(a)}).catch(function(a){Voyant.notebook.util.Show.showError(a)}).finally(function(){c.results.unmask();Ext.defer(function(){this.getTargetEl().fireEvent("resize")},50,c)})}else this.results.unmask(),Spyral.Notebook.show(b);this.setIsRun(!0);return b},clearResults:function(){this.results.show();var a=this.results.el.down(".x-panel");if(a){var b=Ext.getCmp(a.id);b?b.destroy():a.destroy()}else this.results.update(" ");this.getTargetEl().fireEvent("resize")},
