...
2;this.maxFreq={term:null,value:0};this.maxRadius=0;this.selectedDocs=new Ext.util.MixedCollection;this.cache=new Ext.util.MixedCollection;this.currentTerms={};this.termsFilter=[];this.bubbleSpacing=50;this.initialized=!1}
