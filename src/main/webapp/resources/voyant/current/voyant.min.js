...
config:{tokenType:"lexical",inDocumentsCountOnly:void 0},constructor:function(a){a=a||{};Ext.applyIf(a,{minWidth:100,maxGrow:300,matchFieldWidth:!1,minChars:2,displayField:"term",valueField:"term",filterPickList:!0,createNewOnEnter:!0,createNewOnBlur:!1,tpl:Ext.create("Ext.XTemplate",'\x3cul class\x3d"x-list-plain"\x3e\x3ctpl for\x3d"."\x3e','\x3cli role\x3d"option" class\x3d"x-boundlist-item" style\x3d"white-space: nowrap;"\x3e'+(a.itemTpl?a.itemTpl:"{term} ({rawFreq})")+"\x3c/li\x3e","\x3c/tpl\x3e\x3c/ul\x3e"),
...
a.query.indexOf(" ")&&(a.cancel=!0),2!=(a.query.match(/"/)||[]).length&&(a.cancel=!0));a.query=a.query+"*,^"+a.query+"*"}},b);b.on("change",function(a,d){b.up("panel").fireEvent("query",b,d)});b.up("panel").on("loadedCorpus",function(a,d){var e=void 0;if(this.getApiParam)e=this.getApiParam("stopList");else{var f=this.up("panel");f&&f.getApiParam&&(e=f.getApiParam("stopList"))}b.setStore(d.getCorpusTerms({corpus:d,proxy:{extraParams:{limit:10,tokenType:b.tokenType,inDocumentsCountOnly:b.inDocumentsCountOnly,
stopList:e}}}))});b.on("afterrender",function(a){a.triggers&&a.triggers.help&&Ext.QuickTips.register({target:a.triggers.help.getEl(),text:a.localize("querySearchTip"),enabled:!0,showDelay:20,trackMouse:!0,autoShow:!0});this.suggest=Ext.create("Ext.tip.ToolTip",{target:this.inputEl,autoShow:!1,hidden:!0,html:""})});b.callParent(arguments)}});Ext.define("Voyant.widget.TotalPropertyStatus",{extend:"Ext.Component",mixins:["Voyant.util.Localization"],alias:"widget.totalpropertystatus",statics:{i18n:{totalPropertyStatus:{en:'{count:number("0,000")}'}}},initComponent:function(){Ext.applyIf(this,{tpl:this.localize("totalPropertyStatus"),itemId:"totalpropertystatus",style:"margin-right:5px",listeners:{afterrender:function(a){var b=a.up("grid");if(b){var c=b.getStore();a.updateStatus(c.getTotalCount());b.getStore().on("totalcountchange",a.updateStatus,
