...
0;g<=c;g+=this.COARSENESS)if(e[f]&&e[f][g]&&null!=this.grid[f+a]&&null!=this.grid[f+a][g+b])return!0;return!1},f;this.grid=[];l=0;f=function(){var a,f,h,k,n=this.wordsToArrange-1,s=g.canvas.width,q=g.canvas.height,r=.5*s,x=.5*q;do{h=p[l];if(void 0!==h){for(var D=Math.random()*Math.PI,v=.25*Math.random()*h.size,w=.5*(Math.random()-.5),F=.5*h.width,N=.5*h.height;;){a=Math.floor((r+Math.cos(D)*v*this.ratio-F)/this.COARSENESS)*this.COARSENESS;f=Math.floor((x+Math.sin(D)*v-N)/this.COARSENESS)*this.COARSENESS;
k=a+F>=s||f+N>=q?!0:d(a,f,h.height,h.width,h.mask);if(!k)break;D+=w;v+=.05}c(a,f,h);if(g.useFadeEffect)for(a=h.alpha=0;a<l;a++)f=p[a],1>f.alpha&&b(f);else h.alpha=1,h.draw(g.context)}l++;if(l>=p.length){clearTimeout(m);this.doingArrange=!1;this.toggleLoadingText(!1);e();break}}while(n--)}.createDelegate(this);d=d.createDelegate(this);c=c.createDelegate(this);b=b.createDelegate(this);a=a.createDelegate(this);this.doingArrange=!0;m=setInterval(f,50)}else alert("Error: There are no words to arrange.")};
...
a});d.info.continuations=d.children.length;f=d3.max(d.children.map(function(a){return a.maxChildren}));d.maxChildren=Math.max(d.children.length,f)}}function b(a,b){if(!a||!b)return!1;for(var c in a)if(!(c in b))return!1;return!0}function c(a,b){for(var c in b)a[c]=b[c]}function d(){}doubletree.DoubleTree=function(){function b(a){a.each(function(a,b){f.push(this[b])})}var f=[],g=600,h=400,k=!1,l={left:[],right:[]},m={alt:d,shift:d,click:d},n=!0,q=!0,r=doubletree.sortByStrFld("token"),p=doubletree.tokenText,
s=function(a){return doubletree.fieldText(a,"POS")},x=function(a){return"rgba(255,255,255,1)"},u=function(a){return"rgba(255,255,255,1)"},H=function(a){return"red"},L={node:{fill:"white",stroke:"steelblue","stroke-width":"1.5px"},branch:{stroke:"#aaa","stroke-width":"1.5px"}},D=!1,G=d3.dispatch("idsUpdated");G.on("idsUpdated",function(){this==E?(B.setIds(E.continuationIDs),B.updateContinuations()):this==B&&(E.setIds(B.continuationIDs),E.updateContinuations())});var A,I,E,B,J,M;b.init=function(a){d3.select(d3.selectAll(a)).call(this);
return b};b.redraw=function(){void 0!==A&&void 0!==I&&b.setupFromTries(A,I);return b};b.setupFromTries=function(d,k){A=d.getUniqRoot();I=k.getUniqRoot();var C=A.toTree(l.left),v=I.toTree(l.right),w=!0;0<Object.keys(v.pruned).length&&(a(v,v.pruned,w),a(C,v.pruned,w),w=!1);0<Object.keys(C.pruned).length&&(a(C,C.pruned,w),a(v,C.pruned,w));var w={},F;for(F in v.info)"continuations"!=F&&"ids"!=F&&"count"!=F&&(w[F]=v.info[F]);w["right continuations"]=v.info.continuations;w["left continuations"]=C.info.continuations;
w.ids={};c(w.ids,v.info.ids);c(w.ids,C.info.ids);w.count=Object.keys(w.ids).length;J=Object.keys(w.ids);if(v.info.origIDs||C.info.origIDs)w.origIDs={},c(w.origIDs,v.info.origIDs),c(w.origIDs,C.info.origIDs),w.origCount=Object.keys(w.origIDs).length;v.info=w;C.info=w;F=Math.max(C.maxChildren,v.maxChildren);if(isNaN(F)||0==F)return D=!1,b;q?M=d3.scale.log().range([8,14]):(M=function(){return 14},M.domain=function(){});F=Math.min(C.minCount,v.minCount);M.domain([F,C.info.count]);var N=g-20-20,O=h-20-
20;f[0].forEach(function(a,b){function c(){var a=d3.event.scale,b=d3.event.translate;d3.select(d).select("svg \x3e g").attr("transform","translate("+b+") scale("+a+")")}var d=a,e;e=d3.select(d).select("svg");null==e[0][0]?(e=d3.select(d).append("svg").attr("width",N+20+20).attr("height",O+20+20).attr("cursor","move").call(d3.behavior.zoom().scaleExtent([1,1]).on("zoom",c)),e.append("g")):(e.attr("width",N+20+20).attr("height",O+20+20),e.selectAll("g *").remove());E=new doubletree.Tree(e.select("g"),
g,h,C,!0,r,G,M,n,p,s,x,u,H,L);B=new doubletree.Tree(e.select("g"),g,h,v,!1,r,G,M,n,p,s,x,u,H,L)});E.handleAltPress=m.alt;B.handleAltPress=m.alt;E.handleShiftPress=m.shift;B.handleShiftPress=m.shift;E.handleClick=m.click;B.handleClick=m.click;D=!0;return b};b.setupFromArrays=function(a,c,d,f,g,h,l,m){void 0==g&&A&&(g=A.caseSensitive());void 0==h&&A&&(h=A.fieldNames());void 0==l&&A&&(l=A.fieldDelim());void 0==m&&A&&(m=A.distinguishingFieldsArray());A=new doubletree.Trie(g,h,l,m);I=new doubletree.Trie(g,
h,l,m);g=c.length;for(h=0;h<g;h++){l=f?f[h]:h;m=c[h];var n=a[h].slice(),s=d[h].slice();n.push(m);n.reverse();s.unshift(m);k?(I.addNgram(n,l),A.addNgram(s,l)):(A.addNgram(n,l),I.addNgram(s,l))}b.setupFromTries(A,I);return b};b.filteredIDs=function(){return J};b.search=function(a){E.search(a);B.search(a);a=d3.select(f[0][0]);var b=a.selectAll("text.foundText");if(b.empty())return 0;b=b[0].length;null!=a.selectAll("text.rtNdText.foundText")[0][0]&&b--;return b};b.clearSearch=function(){E.clearSearch();
B.clearSearch();return b};b.updateTokenExtras=function(){E.showTokenExtras(n);B.showTokenExtras(n);var a=d3.select(f[0][0]).select('.tokenExtra[display\x3d"inline"]');a.empty()||"0px"==a.style("height")&&b.redraw();return b};b.visWidth=function(a){if(!arguments.length)return g;g=a;return b};b.visHeight=function(a){if(!arguments.length)return h;h=a;return b};b.prefixesOnRight=function(a){if(!arguments.length)return k;k=a;return b};b.filters=function(a){if(!arguments.length)return l;l=a;return b};b.handlers=
function(a){if(!arguments.length)return m;m=a;return b};b.showTokenExtra=function(a){if(!arguments.length)return n;n=a;return b};b.scaleLabels=function(a){if(!arguments.length)return q;q=a;return b};b.succeeded=function(){return D};b.sortFun=function(a){if(!arguments.length)return r;r=a;return b};b.nodeText=function(a){if(!arguments.length)return p;p=a;return b};b.tokenExtraText=function(a){if(!arguments.length)return s;s=a;return b};b.rectColor=function(a){if(!arguments.length)return x;x=a;return b};
b.rectBorderColor=function(a){if(!arguments.length)return u;u=a;return b};b.continuationColor=function(a){if(!arguments.length)return H;H=a;return b};b.basicStyles=function(a){if(!arguments.length)return L;Object.keys(L).forEach(function(b){b in a&&Object.keys(L[b]).forEach(function(c){c in a[b]&&(L[b][c]=a[b][c])})});return b};return b};doubletree.Tree=function(a,b,c,d,k,l,m,n,q,r,p,s,x,u,H){function L(a){a.children&&(a._children=a.children,a._children.forEach(L),a.children=null)}function D(a){a.parent&&
a.parent.children.forEach(function(b){b!=a&&L(b)})}function G(a,b){d3.event.altKey?F.handleAltPress(a,b):d3.event.shiftKey?F.handleShiftPress(a,b):(F.handleClick(a,b),a.parent&&(F.continuationIDs!=a.info.ids&&(F.setIds(a.info.ids),F.clickedNode=a.id,m.idsUpdated.apply(F)),D(a),A(a,!0)))}function A(a,b){a.children?(a.children&&1==a.children.length&&A(a.children[0],!0),a._children=a.children,a.children=null):(a.children=a._children,a._children=null,a.children&&1==a.children.length&&A(a.children[0],
!1));b&&F.update(a)}function I(a){return k?J/2-a:J/2+a}var E=q,B=s,J=b-20-20,M=c-20-20,K=0,z,C;l||(l=doubletree.sortByStrFld("token"));var v=d3.layout.tree().nodeSize([40,40]).sort(l),w=d3.svg.diagonal().projection(function(a){return[I(a.y),a.x-C]});a=a.append("g").attr("transform","translate(20,20)");this.readJSONTree=function(a){z=a;z.x0=M/2;z.y0=J/2;z.children.forEach(L);this.update(z)};var F=this;this.update=function(b){b||(b=z);var c=v.nodes(z).reverse();C=z.x-M/2;c.forEach(function(a){var b=
a.textSize;if(void 0==b){for(var b=0,c=a.parent;null!=c;)b+=c.textSize||Ext.draw.TextMeasurer.measureText(c.name,"arial").width,c=c.parent;a.textSize=b}a.y=50*a.depth+b});var d=a.selectAll("g.node_"+k).data(c,function(a){return a.id||(a.id=++K)}),f=d.enter().append("g").attr("class","node node_"+k).attr("cursor","pointer").attr("transform",function(a){return"translate("+I(b.y0)+","+(b.x0-C)+")"}).on("click",G);f.append("title").text(function(a){return doubletree.infoToText(a.info)});f.append("circle").attr("r",
1E-6).style("fill",function(a){return a._children?"#fff":H.node.fill}).style("stroke",function(a){return H.node.stroke});f=f.append("text").attr("class",function(a){return 0==a.depth?"rtNdText":""}).attr("x",function(a){return a.children||a._children?0:k?10:-10}).attr("text-anchor",function(a){return a.parent?a.children||a._children?k?"end":"start":k?"start":"end":"middle"}).style("font-size",function(a){return n(a.info.count)+"pt"});f.append("tspan").attr("dy",".35em").attr("class","tokenText").text(function(a){return r(a.info,
1>a.depth)}).style("fill-opacity",1E-6);f.append("tspan").attr("dx",".35em").attr("class","tokenExtra").text(function(a){return p(a.info,1>a.depth)}).style("fill-opacity",1E-6);this.drawRects=function(){var b=E?"inline":"none";a.selectAll(".tokenExtra").attr("display",b);d.selectAll("rect").remove();d.insert("rect","text").attr("class","nodeRect").attr("height",function(){var a=this.parentElement.getBBox().height;6>a&&(a=6.1);return a-6}).attr("y",function(a){return a.parent?-.5*this.parentElement.getBBox().height/
2:-.5*this.parentElement.getBBox().height/2-2}).attr("width",function(){return this.parentElement.getBBox().width}).attr("x",function(a){var b=this.parentElement.getBBox().width;return a.parent?k?-.5*b:0:-.33333*b}).style("stroke-opacity",1).style("stroke-width",1).style("stroke",function(a){return x(a.info)}).style("fill",function(a){return B(a.info)}).style("fill-opacity",function(a){return 1})};try{this.drawRects()}catch(g){}f=d.transition().duration(200).attr("transform",function(a){return"translate("+
I(a.y)+","+(a.x-C)+")"});f.select("circle").attr("r",function(a){return a.children||a._children?1E-6:4.5}).style("fill",function(a){return a._children?"#fff":H.node.fill}).style("stroke-width",H.node["stroke-width"]);f.selectAll("tspan").style("fill-opacity",1);f=d.exit().transition().duration(200).attr("transform",function(a){return"translate("+I(b.y)+","+(b.x-C)+")"}).remove();f.select("circle").attr("r",1E-6);f.selectAll("tspan").style("fill-opacity",1E-6);f=a.selectAll("path.link_"+k).data(v.links(c),
function(a){return a.target.id});f.enter().insert("path","g").attr("class","link link_"+k).attr("d",function(a){a={x:b.x0,y:b.y0};return w({source:a,target:a})}).style("fill","none").style("stroke",H.branch.stroke).style("stroke-width",H.branch["stroke-width"]);f.transition().duration(200).attr("d",w);f.exit().transition().duration(200).attr("d",function(a){a={x:b.x,y:b.y};return w({source:a,target:a})}).remove();c.forEach(function(a){a.x0=a.x;a.y0=a.y});this.updateContinuations()};this.setIds=function(a){F.continuationIDs=
a};this.updateContinuations=function(){a.selectAll("g.node_"+k+" text").classed("continuation",function(a){var b;a:{a=a.info.ids;var c=F.continuationIDs||{};for(b in a)if(b in c){b=!0;break a}b=!1}return b}).style("fill",function(a){return d3.select(this).classed("continuation")?u(a.info):"#444"})};this.search=function(b){a.selectAll("g.node text").classed("foundText",function(a){return b.test(r(a.info))})};this.clearSearch=function(){a.selectAll("g.node text").classed("foundText",!1)};this.showTokenExtras=
function(a){if(0==arguments.length)return E;E=a;this.drawRects();return this};this.setRectColor=function(a){if(0==arguments.length)return B;B=a;this.drawRects();return this};this.handleAltPress=function(){};this.handleShifttPress=function(){};this.handleClick=function(){};this.readJSONTree(d);return this};doubletree.sortByStrFld=function(a){return function(b,c){var d=void 0==b.info[a],k=void 0==c.info[a];if(d&&k)return 0;if(d)return-1;if(k)return 1;d=b.info[a].join(" ").toLowerCase();k=c.info[a].join(" ").toLowerCase();
return d<k?-1:d>k?1:0}};doubletree.sortByCount=function(){return function(a,b){return b.info.count-a.info.count}};doubletree.sortByContinuations=function(){return function(a,b){return b.info.continuations-a.info.continuations}};doubletree.filterByMinCount=function(a){return function(b){return b.count>=a}};doubletree.filterByMaxCount=function(a){return function(b){return b.count<=a}};doubletree.filterByPOS=function(a){var b=new RegExp(a);return function(a){return a.POS&&0<a.POS.filter(function(a){return-1<
a.search(b)}).length}};doubletree.fieldText=function(a,b){return a[b]};doubletree.tokenText=function(a){var b="";void 0!==a.token&&(b=a.token);return b};doubletree.infoToText=function(a){var b="",c;for(c in a)b="ids"==c||"origIDs"==c?b+(c+"\t:\t"+Object.keys(a[c]).join(",")+"\n"):b+(c+"\t:\t"+a[c]+"\n");return b}})();doubletree=doubletree||{};
...
this.distinguishingFieldsArray=function(){return q}}})();function TermsRadio(a){this.parent=a.parent;this.container=a.container;this.isSliderVisible=void 0==a.showSlider?!0:a.showSlider;this.chart=null;this.absMinFreq=this.absMaxFreq=0;this.allData=[];this.theme=Ext.create("Ext.chart.theme.Base");this.colorIndex=[];this.colorMasterList=[];this.colorMasterList=this.theme.getColors();for(a=0;a<this.colorMasterList.length;a++)this.colorIndex.push(this.colorMasterList[a]);this.continueTransition=!0;this.counterSeries=[];this.displayData=[];this.isTransitioning=
this.dragged=!1;this.lastSticky=this.lastSlippery=null;this.maxFont=30;this.numDataPoints=this.minFreq=0;this.numVisPoints=5;this.overlayQueue=[];this.recordsLength=this.records=0;this.reselectTop=!1;this.sliderDragSum=this.shiftCount=0;this.titlesArray=[];this.transitionCall="draw";this.valFraction=1;this.win=0;this.bPadding=25;this.lPadding=40;this.rPadding=20;this.tPadding=10;this.sliderHeightRatio=.1;this.sliderHeight=0;this.sliderBPadding=10;this.largestH=this.largestW=0;this.xAxis={};this.xAxisScale=
d3.svg.axis();this.yAxis={};this.yAxisScale=d3.svg.axis();this.fontScale=d3.scale.linear();this.opacityScale=d3.scale.linear();this.ySliderScale=this.yScale=null;this.xScale=d3.scale.linear();this.xSliderScale=d3.scale.linear();this.container.on("resize",this.doResize,this)}
...
-1;a=a=this.removeFilteredCharacters(a);for(var c=this.overlayQueue.length;0<=--c;)a===this.overlayQueue[c].selector&&(b=c);return b},isTermSelected:function(a){return-1!==this.getTermIndex(a)},doTermSelect:function(a,b){var c=c=this.removeFilteredCharacters(a),d=this.parent.getApiParam("selectedWords");d.push(a);this.parent.setApiParams({selectedWords:d});d=this.colorIndex[0];this.colorIndex.shift();if(!0===b){var e=this.parent.query("[xtype\x3dlegend]")[0];e.getStore().add({name:a,mark:d})}else{var e=
this.parent.query("[xtype\x3dlegend]")[0],f=e.getStore().findRecord("name",a);null!==f&&(f.set("mark",d),e.refresh())}if(0===this.colorIndex.length)for(e=0;e<this.colorMasterList.length;e++)this.colorIndex.push(this.colorMasterList[e]);e=this.prepareFullPath(a);d={word:a,selector:c,params:{params:{},type:a},fullPath:e.path,pathMin:e.min,pathMax:e.max,colour:d};c===this.lastSlippery&&(this.isSliderVisible&&this.sliderOverlayOff(c),this.lastSlippery=null);this.chart.select("g[class\x3dfrequency-line-"+
c+"]").remove();this.overlayQueue.push(d);this.chartOverlayOn(d);this.isSliderVisible&&this.sliderOverlayOn(d)},doTermDeselect:function(a,b){var c=this.removeFilteredCharacters(a),d=this.getTermIndex(a);if(!0===b){var e=this.parent.query("[xtype\x3dlegend]")[0],d=e.getStore().findExact("name",a);e.getStore().removeAt(d)}for(var e=this.parent.getApiParam("selectedWords"),f=0,g=e.length;f<g;f++)e[f]===c&&(e.splice(f,1),this.parent.setApiParams({selectedWords:e}));this.chartOverlayOff(c);this.colorIndex.push(this.overlayQueue[d].colour);
this.overlayQueue.splice(d,1);this.isSliderVisible&&this.sliderOverlayOff(c);this.lastSticky=c},prepareFullPath:function(a){for(var b=[],c=this.absMaxFreq,d=this.absMinFreq,e=0,f=this.allData.length;e<f;e++){for(var g=foundB=0,h=this.allData[e].allDataInternal.length;g<h;g++)for(var k=0,l=this.allData[e].allDataInternal[g].frequencyArray.length;k<l;k++)if(this.allData[e].allDataInternal[g].frequencyArray[k].wordString===a){var m=this.allData[e].allDataInternal[g].frequencyArray[k].freq;b.push({x:e,
y:m});m<c&&(c=m);m>d&&(d=m);foundB=1}0===foundB&&(g=this.minFreq,b.push({x:e,y:g}),g<c&&(c=g),g>d&&(d=g))}return{path:b,min:c,max:d}},updateFullPath:function(){for(var a=this.overlayQueue.length;0<a--;){var b=this.prepareFullPath(this.overlayQueue[a].word);this.overlayQueue[a].fullPath=b.path;this.overlayQueue[a].pathMin=b.min;this.overlayQueue[a].pathMax=b.max}},buildSliderPath:function(a){var b=this;return d3.svg.line().x(function(a){return b.xSliderScale(a.x)}).y(function(a){return b.ySliderScale(a.y)}).interpolate("monotone")(a)},
sliderOverlayOn:function(a){this.transitionSliderOverlay(a);this.chart.append("g").attr("class","slider").attr("id","slider-line-"+a.word).append("path").attr("d",this.buildSliderPath(a.fullPath)).style("stroke",a.colour).style("stroke-width",2).style("fill","none");this.redrawSlider()},sliderOverlayOff:function(a){this.chart.selectAll("g[id\x3dslider-line-"+a+"]").remove();this.transitionSliderOverlay()},redrawSliderOverlay:function(){for(var a=0;a<this.overlayQueue.length;a++)this.sliderOverlayOff(this.overlayQueue[a].selector),
this.sliderOverlayOn(this.overlayQueue[a])},transitionSliderOverlay:function(a){this.updateYSliderScale(a||0);for(a=this.overlayQueue.length;0<a--;)this.chart.selectAll("g#slider-line-"+this.overlayQueue[a].selector).select("path").transition().duration(300).ease("linear").attr("d",this.buildSliderPath(this.overlayQueue[a].fullPath))},preparePath:function(a){for(var b=[],c,d,e=0;3>e&&0<this.shiftCount-e;e++){for(var f=c=0;f<this.allData[this.shiftCount-(1+e)].allDataInternal.length;f++)for(var g=
0;g<this.allData[this.shiftCount-(1+e)].allDataInternal[f].frequencyArray.length;g++)this.allData[this.shiftCount-(1+e)].allDataInternal[f].frequencyArray[g].wordString===a&&(c=this.yScale(this.allData[this.shiftCount-(1+e)].allDataInternal[f].frequencyArray[g].freq),b.unshift({x:this.shiftCount-(1+e),y:c}),c=1);0===c&&(f=this.yScale(this.minFreq),b.unshift({x:this.shiftCount-(1+e),y:f}))}e=this.shiftCount;for(c=this.numVisPoints+this.shiftCount;e<c;e++){for(var f=d=0,h=this.allData[e].allDataInternal.length;f<
h;f++)for(var g=0,k=this.allData[e].allDataInternal[f].frequencyArray.length;g<k;g++)this.allData[e].allDataInternal[f].frequencyArray[g].wordString===a&&(d=this.yScale(this.allData[e].allDataInternal[f].frequencyArray[g].freq),b.push({x:e,y:d}),d=1);0===d&&(f=this.yScale(this.minFreq),b.push({x:e,y:f}))}for(e=0;3>e&&this.numVisPoints+this.shiftCount+e<this.numDataPoints;e++){for(f=c=0;f<this.allData[this.numVisPoints+this.shiftCount+e].allDataInternal.length;f++)for(g=0;g<this.allData[this.numVisPoints+
this.shiftCount+e].allDataInternal[f].frequencyArray.length;g++)this.allData[this.numVisPoints+this.shiftCount+e].allDataInternal[f].frequencyArray[g].wordString===a&&(d=this.yScale(this.allData[this.numVisPoints+this.shiftCount+e].allDataInternal[f].frequencyArray[g].freq),b.push({x:this.numVisPoints+this.shiftCount+e,y:d}),c=1);0===c&&(f=this.yScale(this.minFreq),b.push({x:this.numVisPoints+this.shiftCount+e,y:f}))}return b},chartOverlayOn:function(a){var b=this;this.chart.selectAll("g[class\x3dsection]").selectAll("g[class\x3dfrequencies]").selectAll("text[class\x3d"+
a.selector+"]").style("fill",a.colour).style("fill-opacity",1);var c=this.preparePath(a.word),d,e=d3.svg.line().x(function(a){d=a.x;return b.xScale(a.x+b.callOffset())}).y(function(a){return a.y}).interpolate("monotone");a=this.chart.select(".overlay").append("g").attr("class","frequency-line-"+a.selector).append("path").attr("d",e(c)).style("stroke",a.colour).style("stroke-width",2).style("fill","none");c=this.xScale(d)-this.xScale(d+this.callOffset());"left"!==this.transitionCall&&"right"!==this.transitionCall||
a.transition().duration(b.getDuration()).ease("linear").attr("transform","translate("+c+")")},chartOverlayOff:function(a){var b=this;this.chart.selectAll("text."+a).style("fill","black").style("fill-opacity",function(a){return b.opacityScale(a.freq)});this.chart.select("g.frequency-line-"+a).remove()},redrawChartOverlay:function(){for(var a=0;a<this.overlayQueue.length;a++)this.chartOverlayOff(this.overlayQueue[a].selector),this.chartOverlayOn(this.overlayQueue[a])},manageAllYScales:function(){this.manageFontScale();
this.manageOpacityScale();this.manageYScale();this.manageYSliderScale()},manageFontScale:function(){this.fontScale.domain([this.minFreq,this.absMaxFreq*this.valFraction]).range([10,this.maxFont])},manageOpacityScale:function(){this.opacityScale.domain([0,this.absMaxFreq*this.valFraction]).range([.4,.8])},manageYScale:function(){"linear"==this.parent.getApiParam("yAxisScale")&&(this.yScale=d3.scale.linear());"log"==this.parent.getApiParam("yAxisScale")&&(this.yScale=d3.scale.log());this.yScale.domain([this.minFreq,
this.absMaxFreq*this.valFraction*1.25]).rangeRound([this.container.getHeight()-this.bPadding,this.tPadding+this.getSliderHeight()])},manageYSliderScale:function(){var a=this.tPadding,b=this.tPadding+this.getSliderHeight();"linear"==this.parent.getApiParam("yAxisScale")&&(this.ySliderScale=d3.scale.linear());"log"==this.parent.getApiParam("yAxisScale")&&(this.ySliderScale=d3.scale.log());this.ySliderScale.domain([this.minFreq,this.absMaxFreq]).rangeRound([b,a])},updateYSliderScale:function(a){a=a||
...
this.getCorpus()&&this.fireEvent("loadedCorpus",this,this.getCorpus()));a.up("window").close()},scope:a},{xtype:"tbfill"},{text:a.localize("cancelTitle"),ui:"default-toolbar",glyph:"xf00d@FontAwesome",flex:1,handler:function(a){a.up("window").close()}},{text:a.localize("confirmTitle"),glyph:"xf00c@FontAwesome",flex:1,panel:a,handler:function(a){function b(a,c){d.setApiParam&&d.setApiParam(a,c);for(var e=d.getViewport().query("panel,chart"),g=0;g<e.length;g++)e[g].setApiParam&&e[g].setApiParam(a,c);
f=!0}var c=a.up("form").getValues();this.setApiParams(c);var d=this.getApplication(),e=d.getCorpus(),f=!1;void 0!=c.stopList&&void 0!=c.stopListGlobal&&c.stopListGlobal&&b("stopList",c.stopList);void 0!=c.palette&&b("palette",c.palette);f&&(e?d.dispatchEvent("loadedCorpus",this,e):d.dispatchEvent("apiParamsUpdated",this,c));e?this.fireEvent("loadedCorpus",this,e):this.fireEvent("apiParamsUpdated",this,c);a.up("window").close()},scope:a}]},bodyPadding:5}).show()}}:void 0,help:{glyph:"xf128@FontAwesome",
...
bodyPadding:5}).show()},exportSvg:function(a){if(a=this.getTargetEl().dom.querySelector("svg"))a=d3.select(a).attr("version",1.1).attr("xmlns","http://www.w3.org/2000/svg").node().parentNode.innerHTML,Ext.Msg.show({title:this.localize("exportSvgTitle"),message:'\x3cimg src\x3d"data:image/svg+xml;base64,'+btoa(unescape(encodeURIComponent(a)))+'" style\x3d"float: right; max-width: 200px; max-height: 200px; border: thin dotted #ccc;"/\x3e'+this.localize("exportSvgMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,
prompt:!0,multiline:!0,value:a})},exportPngData:function(a){Ext.Msg.show({title:this.localize("exportPngTitle"),message:'\x3cimg src\x3d"'+a+'" style\x3d"float: right; max-width: 200px; max-height: 200px; border: thin dotted #ccc;"/\x3e'+this.localize("exportPngMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:'\x3cimg src\x3d"'+a+'" /\x3e'})},exportPng:function(){var a,b=this.down("draw");if(b)return this.exportPngData(b.getImage().data);if(this.down("chart"))return this.exportPngData(this.down("chart").getImage().data);
var b=this.getTargetEl().dom,c=b.querySelector("canvas");if(c)return this.exportPngData(c.toDataURL("image/png"));var d=b.querySelector("svg");if(d){d=d3.select(d).attr("version",1.1).attr("xmlns","http://www.w3.org/2000/svg").node().parentNode.innerHTML;a="data:image/svg+xml;base64,"+btoa(unescape(encodeURIComponent(d)));var c=Ext.DomHelper.createDom({tag:"canvas",width:b.offsetWidth,height:b.offsetHeight}),e=c.getContext("2d"),f=new Image;f.src=a;f.panel=this;f.onload=function(){e.drawImage(f,0,
0);a=c.toDataURL("image/png");return this.panel.exportPngData.call(this.panel,a)}}},exportUrl:function(){this.openUrl(this.getExportUrl())},exportEmbed:function(){Ext.Msg.show({title:this.localize("exportViewEmbedTitle"),message:this.localize("exportViewEmbedMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:"\x3c!--\tExported from Voyant Tools (voyant-tools.org).\nThe iframe src attribute below uses a relative protocol to better function with both\nhttp and https sites, but if you're embedding this into a local web page (file protocol)\nyou should add an explicit protocol (https if you're using voyant-tools.org, otherwise\nit depends on this server.\nFeel free to change the height and width values or other styling below: --\x3e\n\x3ciframe style\x3d'width: 100%; height: 800px' src\x3d'"+
...
b&&(e[key]=b[key]);e.corpus||("Voyant.data.model.Corpus"==Ext.getClassName(this)?e.corpus=this.getId():this.getCorpus&&(e.corpus=this.getCorpus().getId()));Ext.applyIf(b,{style:"width: "+(b.width||"90%")+(Ext.isNumber(b.width)?"px":"")+"; height: "+(b.height||"400px")+(Ext.isNumber(b.height)?"px":"")});delete b.width;delete b.height;Ext.applyIf(e,Voyant.application.getModifiedApiParams());e=Ext.encode(e);e=encodeURIComponent(e);var f=Ext.id(),g=Voyant.application.getRelativeUrl()+"tool/"+d.substring(d.lastIndexOf(".")+
...
Ext.define("Voyant.data.store.RelatedTerms",{extend:"Ext.data.Store",mixins:["Voyant.data.store.RelatedTermsMixin"],constructor:function(a){a=a||{};this.mixins["Voyant.data.store.RelatedTermsMixin"].constructor.apply(this,[a]);this.callParent([a])}});Ext.define("Voyant.data.store.RelatedTermsBuffered",{extend:"Ext.data.BufferedStore",mixins:["Voyant.data.store.RelatedTermsMixin"],constructor:function(a){a=a||{};this.mixins["Voyant.data.store.RelatedTermsMixin"].constructor.apply(this,[a]);this.callParent([a])}});Ext.define("Voyant.data.store.TokensMixin",{mixins:["Voyant.data.store.VoyantStore"],model:"Voyant.data.model.Token",constructor:function(a){this.mixins["Voyant.data.store.VoyantStore"].constructor.apply(this,[a,{"proxy.extraParams.tool":"corpus.DocumentTokens","proxy.reader.rootProperty":"documentTokens.tokens","proxy.reader.totalProperty":"documentTokens.total"}])}});
...
Ext.define("Voyant.data.store.TSNEAnalysis",{extend:"Ext.data.Store",mixins:["Voyant.data.store.TSNEAnalysisMixin"],constructor:function(a){a=a||{};this.mixins["Voyant.data.store.TSNEAnalysisMixin"].constructor.apply(this,[a]);this.callParent([a])}});Ext.define("Voyant.data.store.TSNEAnalysisBuffered",{extend:"Ext.data.BufferedStore",mixins:["Voyant.data.store.TSNEAnalysisMixin"],constructor:function(a){a=a||{};this.mixins["Voyant.data.store.TSNEAnalysisMixin"].constructor.apply(this,[a]);this.callParent([a])}});Ext.define("Voyant.data.table.Table",{alternateClassName:["VoyantTable"],mixins:["Voyant.notebook.util.Embed","Voyant.notebook.util.Show"],embeddable:["Voyant.widget.VoyantTableTransform","Voyant.widget.VoyantChart","Voyant.widget.CodeEditor"],config:{rows:[],headers:[],headersMap:{},rowKey:void 0,model:void 0},constructor:function(a,b){a=a||{};if(a.fromBlock){var c=Voyant.notebook.Notebook.getDataFromBlock(a.fromBlock);c&&(a.rows=[],c.split(/\n+/).forEach(function(b,c){var d=b.split("\t");0!=c||
a.noHeaders?a.rows.push(d):a.headers=d}))}else if(a.count&&Ext.isArray(a.count)){var d={};a.count.forEach(function(a){d[a]=d[a]?d[a]+1:1});var c=[],e;for(e in d)c.push([e,d[e]]);c.sort(function(a,b){return b[1]-a[1]});a.limit&&c.length>a.limit&&c.splice(a.limit);a.orientation&&"horizontal"==a.orientation?(a.headers=c.map(function(a){return a[0]}),a.rows=[c.map(function(a){return a[1]})]):(a.headers=a.headers?a.headers:["Item","Count"],a.rows=c)}else if(a.isStore||a.store){c=a.store?a.store:a;if(b&&
b.headers)a.headers=b.headers;else if(e=c.getAt(0))a.headers=e.getFields().map(function(a){return a.getName()});a.rows=[];c.each(function(b){var c=b.getData();b=a.headers.map(function(a){return c[a]});a.rows.push(b)},this)}this.setRows(Ext.Array.from(Ext.isArray(a)?a:a.rows));this.setHeaders(Ext.Array.from(a.headers));this.setRowKey(a.rowKey?a.rowKey:this.getHeaders()[0]);0==this.getHeaders().length&&(c=this.getRow(0,!1))&&this.setHeaders(c.map(function(a,b){return b}));var f={};this.getHeaders().forEach(function(a,
b){f[a]=b});this.setHeadersMap(f);this.callParent()},addRow:function(a){debugger;if(Ext.isObject(a)){var b=this.getRows().length,c;for(c in a)this.updateCell(b,c,a[c])}else Ext.isArray(a)&&this.getRows().push(a)},eachRecord:function(a,b){for(var c,d=0,e=this.getRows().length;d<e&&(c=this.getRecord(d),!1!==a.call(b||c,c,d,e));d++);},eachRow:function(a,b,c){for(var d,e=0,f=this.getRows().length;e<f&&(d=this.getRow(e,b),!1!==a.call(c||d,d,e,f));e++);},getRow:function(a,b){if(b){var c={},d=this.getHeaders();
Ext.Array.from(this.getRows()[a]).forEach(function(a,b){c[d[b]||b]=a},this);return c}return this.getRows()[a]},getRecord:function(a){if(this.model)return new this.model(this.getRow(a,!0))},mapRows:function(a,b,c){var d=[];this.eachRow(function(b,f){d.push(a.call(c||this,b,f))},b,this);return d},updateCell:function(a,b,c,d){var e=this.getRows();Ext.isNumber(a)||this.getRowIndex(a);b=this.getColumnIndex(b);void 0===e[a]&&(e[a]=[]);e[a][b]=void 0===e[a][b]||d?c:e[a][b]+c},getRowIndex:function(a){Ext.isString(a)&&
(console.error("Implement this"),alert("Unimplemented method: VoyantTable.getRowIndex()"))},getColumnIndex:function(a){var b=this.getHeaders();if(Ext.isNumber(a))return void 0===b[a]&&(b[a]=a,this.getRows().forEach(function(b){b.splice(a,0,"")})),a;if(Ext.isString(a))return this.getHeadersMap()[a]||(this.getHeaders().push(a),this.getHeadersMap()[a]=this.getHeaders().length-1,this.getRows().forEach(function(a){a.push("")})),this.getHeadersMap()[a]},embed:function(a,b){!b&&Ext.isObject(a)&&(b=a,a=this.embeddable[0]);
b=b||{};Ext.apply(b,{tableJson:JSON.stringify({rowkey:this.getRowKey(),headers:this.getHeaders(),rows:this.getRows(),config:b})});delete b.axes;delete b.series;embed.call(this,a,b)},toTsv:function(a){var b=this.getHeaders().join("\t");this.getRows().forEach(function(c,d){a&&Ext.isNumber(a)&&d>a||(b+="\n"+c.map(function(a){return a.replace(/(\n|\t)/g,"")}).join("\t"))});return b},getString:function(a){a=a||{};var b="\x3ctable class\x3d'voyant-table' style\x3d'"+(a.width?" width: "+a.width:"")+"' id\x3d'"+
(a.id?a.id:Ext.id())+"'\x3e",c=this.getHeaders();if(c.length){for(var b=b+"\x3cthead\x3e\x3ctr\x3e",d=0,e=c.length;d<e;d++)b+="\x3cth\x3e"+c[d]+"\x3c/th\x3e";b+="\x3c/tr\x3e\x3c/thead\x3e"}b+="\x3ctbody\x3e";d=0;for(e=Ext.isNumber(a)?a:this.getRows().length;d<e;d++)b+="\x3ctr\x3e",this.getRow(d).forEach(function(a){b+="\x3ctd\x3e"+a+"\x3c/td\x3e"}),b+="\x3c/tr\x3e";return b+="\x3c/tbody\x3e\x3c/table\x3e"}});Ext.define("Voyant.data.util.NetworkGraph",{alternateClassName:["NetworkGraph"],mixins:["Voyant.notebook.util.Embed","Voyant.notebook.util.Show"],embeddable:[],config:{edges:[],nodes:[]},constructor:function(a,b){a=a||{};this.setEdges(Ext.Array.from(a.edges));this.setNodes(Ext.Array.from(a.nodes));this.callParent([a])},addEdge:function(a){this.edges.push(a)},embed:function(a,b){!b&&Ext.isObject(a)&&(b=a,a=this.embeddable[0]);b=b||{};Ext.apply(b,{tableJson:JSON.stringify({rowkey:this.getRowKey(),headers:this.getHeaders(),
rows:this.getRows(),config:b})});delete b.axes;delete b.series;embed.call(this,a,b)},getString:function(a){a=a||{};var b="\x3ctable class\x3d'voyant-table' style\x3d'"+(a.width?" width: "+a.width:"")+"' id\x3d'"+(a.id?a.id:Ext.id())+"'\x3e",c=this.getHeaders();if(c.length){for(var b=b+"\x3cthead\x3e\x3ctr\x3e",d=0,e=c.length;d<e;d++)b+="\x3cth\x3e"+c[d]+"\x3c/th\x3e";b+="\x3c/tr\x3e\x3c/thead\x3e"}b+="\x3ctbody\x3e";d=0;for(e=Ext.isNumber(a)?a:this.getRows().length;d<e;d++)b+="\x3ctr\x3e",this.getRow(d).forEach(function(a){b+=
"\x3ctd\x3e"+a+"\x3c/td\x3e"}),b+="\x3c/tr\x3e";return b+="\x3c/tbody\x3e\x3c/table\x3e"}});Ext.define("Voyant.data.model.Corpus",{alternateClassName:["Corpus"],mixins:["Voyant.notebook.util.Embed","Voyant.notebook.util.Show","Voyant.util.Transferable","Voyant.util.Localization","Voyant.util.Assignable"],transferable:"loadCorpusTerms loadTokens getPlainText getText getWords getString getLemmasArray".split(" "),embeddable:"Voyant.panel.Summary Voyant.panel.Cirrus Voyant.panel.Documents Voyant.panel.CorpusTerms Voyant.panel.Reader Voyant.panel.Trends Voyant.panel.TermsRadio Voyant.panel.DocumentTerms Voyant.panel.TermsBerry Voyant.panel.CollocatesGraph Voyant.panel.Contexts Voyant.panel.WordTree Voyant.panel.Veliza".split(" "),
...
Ext.apply(a||{},{corpus:this}))},getContexts:function(a){return Ext.create("Voyant.data.store.Contexts",Ext.apply(a||{},{corpus:this}))},getDocuments:function(a){return this.getDocumentsStore()?this.getDocumentsStore():Ext.create("Voyant.data.store.Documents",Ext.apply(a||{},{corpus:this}))},getDocument:function(a){if(this.getDocumentsStore()){if(a instanceof Voyant.data.model.Document)return a;if(Ext.isNumeric(a))return this.getDocumentsStore().getAt(parseInt(a));if(Ext.isString(a))return this.getDocumentsStore().getById(a)}return this.then?
Voyant.application.getDeferredNestedPromise(this,arguments):this.getDocumentsStore().getDocument(a)},getDocumentsCount:function(){return this.then?Voyant.application.getDeferredNestedPromise(this,arguments):this.get("documentsCount")},getWordTokensCount:function(){return this.then?Voyant.application.getDeferredNestedPromise(this,arguments):this.get("lexicalTokensCount")},getWordTypesCount:function(){return this.then?Voyant.application.getDeferredNestedPromise(this,arguments):this.get("lexicalTypesCount")},
getCreatedTime:function(){return this.then?Voyant.application.getDeferredNestedPromise(this,arguments):this.get("createdTime")},requiresPassword:function(){var a=this.getNoPasswordAccess();return"NONE"==a||"NONCONSUMPTIVE"==a},getNoPasswordAccess:function(){return this.then?Voyant.application.getDeferredNestedPromise(this,arguments):this.get("noPasswordAccess")},getTitle:function(){return this.then?Voyant.application.getDeferredNestedPromise(this,arguments):this.get("title")},getSubTitle:function(){return this.then?
Voyant.application.getDeferredNestedPromise(this,arguments):this.get("subTitle")},getRelatedWords:function(a){return Ext.create("Voyant.data.store.RelatedTerms",Ext.apply(a||{},{corpus:this}))},loadRelatedWords:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments);var b=Voyant.application.getDeferred(this);a=a||{};Ext.isNumber(a)&&(a={limit:a});Ext.applyIf(a,{limit:0});this.getRelatedWords().load({params:a,callback:function(a,d,e){e?b.resolve(a):b.reject(d.error.response)}});
return b.promise},getText:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments,this);var b=Voyant.application.getDeferred(this);a=a||{};Ext.isNumber(a)?a={limit:a}:Ext.isString(a)&&(a={limit:parseInt(a)});Ext.applyIf(a,{limit:0,outputFormat:"text",template:"docTokens2text"});Ext.apply(a,{tool:"corpus.DocumentTokens",corpus:this.getAliasOrId()});Ext.Ajax.request({url:Voyant.application.getTromboneUrl(),params:a,success:function(c,d){var e=c.responseText.trim();
a.transformCase&&(-1<a.transformCase.indexOf("lower")?e=e.toLowerCase():-1<a.transformCase.indexOf("upper")&&(e=e.toUpperCase()));b.resolve(e)},failure:function(a,d){b.reject(a)},scope:this});return b.promise},getPlainText:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments);a=a||{};Ext.isNumber(a)?a={limit:a}:Ext.isString(a)&&(a={limit:parseInt(a)});Ext.apply(a,{template:"docTokens2plainText"});return this.getText(a)},getWords:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,
arguments);a=a||{};Ext.isNumber(a)?a={limit:a}:Ext.isString(a)&&(a={limit:parseInt(a)});Ext.applyIf(a,{template:"docTokens2words"});return this.getText(a)},getWordsArray:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments);var b=Voyant.application.getDeferred(this);this.getWords(a).then(function(a){b.resolve(a.split(" "))});return b.promise},getLemmasArray:function(a){a=a||{};if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments);var b=
Voyant.application.getDeferred(this);Ext.applyIf(a,{template:"docTokens2lemmas",withPosLemmas:!0});this.getWords(a).then(function(a){a=a.split(" ").map(function(a){return a.substring(0,a.indexOf("/"))});b.resolve(a)});return b.promise},getString:function(a){var b=this.getDocumentsCount(),c=this.localize("thisCorpus");if(0==b)c+=" "+this.localize("isEmpty")+".";else{var c=c+" ",c=1<b?c+(new Ext.XTemplate(this.localize("hasNdocuments"))).apply({count:Ext.util.Format.number(b,"0,000")}):c+this.localize("has1document"),
c=c+(" "+(new Ext.XTemplate(this.localize("widthNwordsAndNTypes"))).apply({words:Ext.util.Format.number(this.getWordTokensCount(),"0,000"),types:Ext.util.Format.number(this.getWordTypesCount(),"0,000")})+"."),c=c+(" "+this.localize("created")+" "),d=this.get("createdDate"),e=new Date;!0===Ext.Array.each([["year",Ext.Date.YEAR],["month",Ext.Date.MONTH],["day",Ext.Date.DAY],["hour",Ext.Date.HOUR],["minute",Ext.Date.MINUTE],["second",Ext.Date.SECOND]],function(a){if(Ext.Date.diff(d,e,a[1])>("second"==
a[0]?1:0)){var b=Ext.Date.diff(d,e,a[1]);c+="\x3cspan class\x3d'info-tip' data-qtip\x3d'"+Ext.Date.format(d,"Y-m-d, H:i:s")+"'\x3e";c=1==b?c+(new Ext.XTemplate(this.localize(a[0]+"Ago"))).apply({count:b,date:d}):c+(new Ext.XTemplate(this.localize(a[0]+"sAgo"))).apply({count:b,date:d});c+="\x3c/span\x3e";return!1}},this)&&(c+=this.localize("now"));c+=".";c+=""}!0===a&&(c+=" ("+this.getId()+")");return c}});Ext.define("Voyant.widget.CodeEditor",{extend:"Ext.panel.Panel",mixins:["Voyant.util.Localization","Voyant.util.Api","Voyant.notebook.util.Embed"],alias:"widget.codeeditor",statics:{i18n:{},api:{tableJson:void 0,content:"",mode:"ace/mode/text",width:void 0}},constructor:function(a){a=a||{};this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);this.buildFromParams();Ext.apply(this,{items:{xtype:"notebookcodeeditor",content:a.content?a.content:this.getApiParam("content"),mode:a.mode?a.mode:
...
0,c.gotoCurrent()));null===c.currentIndex&&c.getSelectionModel().deselectAll();a.focus()},privates:{gotoCurrent:function(){var a=this.matches[this.currentIndex];this.getNavigationModel().setPosition(a.record,a.column);this.getSelectionModel().select(a.record)}}});Ext.define("Voyant.widget.VoyantTableTransform",{extend:"Ext.panel.Panel",mixins:["Voyant.util.Localization","Voyant.util.Api","Voyant.notebook.util.Embed"],alias:"widget.voyanttabletransform",statics:{i18n:{},api:{tableHtml:void 0,tableJson:void 0,width:void 0}},html:"",constructor:function(a){a=a||{};this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);this.callParent(arguments)},initComponent:function(a){a=a||{};this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);this.buildFromParams();
this.on("afterrender",function(){var a=this.getTargetEl().down("table");if(a){var c=a.parent();(new Ext.ux.grid.TransformGrid(a,{width:this.getApiParam("width")||c.getWidth(),height:this.getApiParam("height")||20+24*a.query("tr").length})).render(c)}},this);this.callParent(arguments)},buildFromParams:function(){var a=this.getApiParam("tableHtml"),b=this.getApiParam("tableJson");if(a)this.setHtml(a);else if(b){var c="\x3ctable\x3e\x3cthead\x3e\x3ctr\x3e",a=JSON.parse(b);a.headers?a.headers.forEach(function(a){c+=
"\x3cth\x3e"+a+"\x3c/th\x3e"}):a.rows[0].forEach(function(a,b){c+="\x3cth\x3e"+(b+1)+"\x3c/th\x3e"});c+="\x3c/tr\x3e\x3c/thead\x3e\x3ctbody\x3e";a.rows.forEach(function(a){c+="\x3ctr\x3e";a.forEach(function(a){c+="\x3ctd\x3e"+a+"\x3c/td\x3e"});c+="\x3c/tr\x3e"});c+="\x3c/tbody\x3e\x3c/table\x3e";this.setHtml(c)}}});
...
"color");if(void 0!==b)for(var b=this.app.hexToRgb(b),c=this.app.getCategoryTerms(a),d=0;d<c.length;d++)this.app.colorTermAssociations.replace(c[d],b)}}});Ext.define("Voyant.widget.VoyantNetworkGraph",{extend:"Ext.panel.Panel",mixins:["Voyant.util.Localization","Voyant.util.Api","Voyant.notebook.util.Embed"],embeddable:["Voyant.widget.VoyantNetworkGraph"],alias:"widget.voyantnetworkgraph",statics:{i18n:{},api:{jsonData:void 0,docId:void 0,docIndex:void 0,json:void 0}},config:{edges:void 0,nodes:void 0,json:void 0},constructor:function(a){a=a||{};this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);this.callParent(arguments);this.on("boxready",
function(a,c){this.buildGraph()},this)},initComponent:function(a){this.callParent(arguments)},getJsonResourcefully:function(){return this.getEdges()?{edges:this.getEdges(),nodes:this.getNodes()}:this.getApiParam("jsonData")?Ext.decode(this.getApiParam("jsonData")):this.getApiParam("json")?this.getApiParam("json"):{edges:this.getEdges(),nodes:this.getNodes()}},buildGraph:function(a){a=a||this.getJsonResourcefully();a&&a.links||(a&&a.edges&&(a.links=a.edges,delete a.edges),a&&a.links||(a=a||{},a.links=
[]));if(!a.nodes){var b={},c={};a.nodes=[];a.links.forEach(function(d){["source","target"].forEach(function(e){0==d[e]in b?(b[d[e]]=a.nodes.length,c[d[e]]=1,a.nodes.push({name:d[e]})):c[d[e]]++;d[e]=b[d[e]];d.value=1})});a.nodes.forEach(function(a){Ext.applyIf(a,{value:c[a.name]})})}var d=this.getWidth(),e=this.getHeight(),f=this.getTargetEl().dom.firstChild.firstChild;f.innerHTML="";var g=function(){h.attr("transform","translate("+d3.event.translate+")scale("+d3.event.scale+")")};d3.behavior.zoom().scaleExtent([1,
10]).on("zoom",g);var h=d3.select(f).append("svg").attr("width",d).attr("height",e).append("g").attr("transform","translate(-5,-5)").call(d3.behavior.zoom().scaleExtent([.5,10]).on("zoom",g)),d=d3.layout.force().gravity(.2).distance(50).charge(-100).size([d,e]);d.nodes(a.nodes).links(a.links).start();var k=h.selectAll(".link").data(a.links).enter().append("line").attr("class","link").attr("stroke","#eee"),l=h.selectAll(".node").data(a.nodes).enter().append("g").attr("class","node").call(d.drag);l.append("circle").attr("r",
5).attr("fill","rgba(0,0,0,.05)");e=a.nodes.map(function(a){return a.value});e.sort();var m=d3.scale.log().domain([e[0],e[e.length-1]]).range([8,36]);l.append("text").attr("dx",0).attr("dy",0).text(function(a){return a.name}).attr("font-size",function(a){return m(a.value)+"px"}).attr("text-anchor","middle");d.on("tick",function(){k.attr("x1",function(a){return a.source.x}).attr("y1",function(a){return a.source.y}).attr("x2",function(a){return a.target.x}).attr("y2",function(a){return a.target.y});
l.attr("transform",function(a){return"translate("+a.x+","+a.y+")"})})}});Ext.define("Voyant.panel.Panel",{mixins:["Voyant.util.Localization","Voyant.util.Api","Voyant.util.Toolable","Voyant.util.DetailedError"],requires:["Voyant.widget.QuerySearchField","Voyant.widget.StopListOption","Voyant.widget.CategoriesOption","Voyant.widget.TotalPropertyStatus"],alias:"widget.voyantpanel",statics:{i18n:{},config:{corpusValidated:!1},api:{corpus:void 0,input:void 0,inputFormat:void 0,subtitle:void 0}},config:{corpus:void 0},constructor:function(a){this.mixins["Voyant.util.Api"].constructor.apply(this,
...
var d=this.getVisLayout().size()[0],e=this.getVisLayout().size()[1],f=b?Math.min(d/Math.abs(b[1].x-d/2),d/Math.abs(b[0].x-d/2),e/Math.abs(b[1].y-e/2),e/Math.abs(b[0].y-e/2))/2:1,g=d3.transition().duration(1E3),h=this.getVis().selectAll("text").data(a,function(a){return a.text});h.exit().remove();h.transition(g).attr("transform",function(a){return"translate("+[a.x,a.y]+")rotate("+a.rotate+")"}).style("font-size",function(a){return a.fontSize+"px"});h.enter().append("text").text(function(a){return a.text}).attr("text-anchor",
"middle").attr("data-freq",function(a){return a.rawFreq}).attr("transform",function(a){return"translate("+[a.x,a.y]+")rotate("+a.rotate+")"}).style("font-family",function(a){return c.getApplication().getFeatureForTerm("font",a.text)}).style("fill",function(a){return c.getApplication().getColorForTerm(a.text,!0)}).style("font-size","1px").transition(g).style("font-size",function(a){return a.fontSize+"px"});h.on("click",function(a){c.dispatchEvent("termsClicked",c,[a.text])}).on("mouseover",function(a){this.getTip().show()}.bind(this)).on("mousemove",
function(a){var b=this.getTip();b.update(a.text+": "+a.rawFreq);a=Ext.get(this.getCirrusId()).dom;a=d3.mouse(a);a[1]+=30;b.setPosition(a)}.bind(this)).on("mouseout",function(a){this.getTip().hide()}.bind(this));this.getVis().transition(g).attr("transform","translate("+d/2+","+e/2+")scale("+f+")")},map:function(a,b,c,d,e){return d+(a-b)/(c-b)*(e-d)},calculateSizeAdjustment:function(){var a=this.getTerms();if(void 0!==a){var b=this.getLayout().getRenderTarget(),b=b.getWidth()*b.getHeight();1E5>b?this.setMinFontSize(8):
...
b)},updateNetworkMode:function(a){this.getVisLayout()?a===this.DEFAULT_MODE?this.getVisLayout().force("link",d3.forceLink().id(function(a){return a.id}).distance(30).strength(1)).force("charge",d3.forceManyBody().strength(-100)).force("collide",d3.forceCollide(function(a){return 2*Math.sqrt(a.bbox.width*a.bbox.height)})):this.getVisLayout().force("link",d3.forceLink().id(function(a){return a.id}).distance(200)).force("charge",d3.forceManyBody().strength(function(a){return"keyword"===a.type?-1E4:0})).force("collide",
d3.forceCollide(function(a){return"keyword"===a.type?a.value:Math.sqrt(a.bbox.width*a.bbox.height)})):console.log("no viz yet")},initGraph:function(){var a=this.getLayout().getRenderTarget();a.update("");var b=a.getWidth(),c=a.getHeight();this.setVisLayout(d3.forceSimulation().force("center",d3.forceCenter(b/2,c/2)));var a=d3.select(a.dom).append("svg").attr("id",this.getVisId()).attr("class","linksGraph").attr("width",b).attr("height",c),d=a.append("g");a.call(d3.zoom().scaleExtent([.25,4]).on("zoom",
...
{corpus:this.getCorpus().getId(),addDocuments:!0});var c=this.getApiParams();delete c.view;delete c.stopList;Ext.apply(b,c);var d=this.getApplication().getViewport();d.mask(this.localize("uploadingCorpus"));a.submit({url:this.getTromboneUrl(),params:b,failure:function(a,b){d.unmask();if(b.result){var g={corpus:b.result.corpus?b.result.corpus.metadata.id:b.result.stepEnabledCorpusCreator.storedId};Ext.apply(g,c);this.setCorpus(void 0);this.loadCorpus(g)}},scope:this})},loadCorpus:function(a){this.getCorpus()&&
...
c=b.getViewport();c.mask(this.localize("Creating new corpus\u2026"));Ext.Ajax.request({url:this.getApplication().getTromboneUrl(),method:"POST",params:a,success:function(a){c.unmask();a=Ext.decode(a.responseText);b.openUrl(b.getBaseUrl()+"?corpus\x3d"+a.corpus.id)}});(a=this.up("window"))&&a.isFloating()&&a.close()}});Ext.define("Voyant.panel.DocumentsFinder",{extend:"Ext.grid.Panel",require:["Voyant.data.store.DocumentQueryMatches","Ext.grid.plugin.CellEditing"],mixins:["Voyant.panel.Panel"],alias:"widget.documentsfinder",statics:{i18n:{}},constructor:function(a){this.cellEditing=Ext.create("Ext.grid.plugin.CellEditing",{clicksToEdit:1});this.cellEditing.on("edit",this.onEditComplete,this);var b=this;Ext.apply(this,{title:this.localize("title"),emptyText:this.localize("emptyText"),plugins:[this.cellEditing],bbar:[{text:this.localize("addRow"),
glyph:"xf055@FontAwesome",handler:this.addRow,scope:this},{text:this.localize("exportNewCorpus"),disabled:!0,glyph:"xf08e@FontAwesome",tooltip:this.localize("exportNewCorpusTip"),handler:function(){var a=this.getQueryFromStore();a?(this.setLoading(!0),this.getCorpus().getDocumentQueryMatches().load({params:{query:a,createNewCorpus:!0},callback:function(a,b,c){this.setLoading(!1);c?(a=b.getProxy().getReader().rawData.documentsFinder.corpus,a=this.getBaseUrl()+"?corpus\x3d"+a,Ext.Msg.alert({title:this.localize("title"),
message:"\x3ca href\x3d'"+a+"' target\x3d'_blank'\x3eNew Corpus\x3c/a\x3e"})):Ext.create("Voyant.util.ResponseError",{msg:this.localize("unsuccessfulQuery"),response:b.getError().response}).show()},scope:this})):Ext.Msg.alert({title:this.localize("title"),message:this.localize("noMatches")})},scope:this,cls:"exportBtn"},{xtype:"tbtext",name:"status",cls:"status"}],columns:[{text:this.localize("query"),dataIndex:"query",renderer:function(a){return Ext.isEmpty(a)?'\x3cspan class\x3d"placeholder"\x3e'+
b.localize("emptyQuery")+"\x3c/span\x3e":a},editor:!0,minWidth:150,maxWidth:300},{text:this.localize("field"),dataIndex:"field",editor:{xtype:"combo",typeAhead:!0,triggerAction:"all",forceSelection:!0,value:"",valueField:"value",listeners:{change:function(){Ext.isEmpty(this.getValue())&&this.reset()}},store:new Ext.data.Store({fields:["text","value"],data:[[this.localize("textField"),"text"],[this.localize("advancedField"),"advanced"]]})},width:150,renderer:function(a){return Ext.isEmpty(a)?"":b.localize(a+
"Field")}},{text:this.localize("operator"),dataIndex:"operator",editor:{xtype:"combo",forceSelection:!0,store:new Ext.data.Store({autoDestroy:!0,fields:["text","value"],displayField:"text",valueField:"value",data:[{text:"AND",value:"+"},{text:"OR",value:""}]})},minWidth:75,maxWidth:75},{text:this.localize("count"),dataIndex:"count",renderer:function(a,b,e){return Ext.isEmpty(e.get("query"))?"":Ext.util.Format.number(a,"0,000")},minWidth:100,maxWidth:100},{xtype:"actioncolumn",width:25,sortable:!1,
menuDisabled:!0,width:25,getGlyph:"xf014@FontAwesome",tooltip:this.localize("deleteQueryTip"),menuDisabled:!0,sortable:!1,handler:this.removeRow,scope:this}],store:new Ext.data.Store({autoDestroy:!0,fields:["id","operator","field","query","count"],data:[["","","","",0]]})});this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.on("loadedCorpus",function(a,b){var e=b.getDocuments();if(e&&0<e.getCount()){var f=e.getDocument(0),g=[];["title","author","pubDate",
"publisher","pubPlace"].forEach(function(a){Ext.isEmpty(f.get(a))||g.push([this.localize(a+"Field"),a])},this);g&&(e=this.getColumnManager().getHeaderByDataIndex("field").getEditor(),e.getStore().each(function(a){g.push([a.get("text"),a.get("value")])},this),e.setStore(Ext.create("Ext.data.Store",{fields:["text","value"],data:g})));this.updateStatus(0);this.setLoading(!1)}})},removeRow:function(a,b){this.getStore().removeAt(b);0==this.getStore().getCount()&&this.addRow();this.updateAggregate()},addRow:function(){this.store.loadData([["",
"","","",0]],!0)},onEditComplete:function(a,b){var c=this.getQueryFromRecord(b.record);if(Ext.isEmpty(c))b.record.set("count",""),this.updateAggregate();else{var d=b.view.getCell(b.record,this.getColumnManager().getHeaderByDataIndex("count"));d.mask("loading");this.getCorpus().getDocumentQueryMatches().load({params:{query:c},callback:function(a,c,g){d.unmask();g?b.record.set("count",0==a.length?0:a[0].get("count")):(Ext.create("Voyant.util.ResponseError",{msg:this.localize("unsuccessfulQuery"),response:c.getError().response}).show(),
b.record.set("count",0));this.updateAggregate()},scope:this})}},getQueryFromRecord:function(a){if(Ext.isEmpty(a)||Ext.isEmpty(a.get("query")))return"";var b=a.get("query").trim();if(Ext.isEmpty(b))return"";a=a.get("field");return Ext.isEmpty(a?a.trim():a)?b:a+":"+b},getQueryFromStore:function(){var a="";this.getStore().each(function(b){var c=this.getQueryFromRecord(b);Ext.isEmpty(c)||(Ext.isEmpty(a)||(b=b.get("operator"),a+="AND"==b?" + ":" | "),a+=c)},this);console.warn(a);return a},updateAggregate:function(){var a=
...
(a=a||this.getCorpus().getDocumentTerms({autoLoad:!1}),a.load({callback:function(a,c,d){d?(this.setMode(this.MODE_DOCUMENT),this.loadFromRecords(a)):Voyant.application.showResponseError(this.localize("failedGetDocumentTerms"),c)},scope:this,params:this.getApiParams("docId docIndex limit stopList query withDistributions bins".split(" "))}))},loadFromRecords:function(a){var b=this.getApplication(),c;if(this.getMode()===this.MODE_DOCUMENT)c=this.getApiParam("bins");else{c=this.getApiParam("bins");var d=
this.getCorpus().getDocumentsCount();c=c<d?c:d}var e=[],f=[],g=[];a.forEach(function(a,c){var d=a.getTerm();f.push(d);for(var h=a.get("distributions"),k=0;k<h.length;k++)void 0===g[k]&&(g[k]={}),g[k][d]=h[k];e.push({id:d,name:d,mark:b.getColorForTerm(d,!0),active:!0})},this);this.down("[xtype\x3dlegend]").getStore().loadData(e);this.getVisLayout().keys(f);d=this.getVisLayout()(g);a=this.body.down("svg").getWidth()-this.graphMargin.left-this.graphMargin.right;var h=d3.scaleLinear().domain([0,c-1]).range([0,
a]),k=d3.min(d,function(a){return d3.min(a,function(a){return a[0]})}),l=d3.max(d,function(a){return d3.max(a,function(a){return a[1]})});c=this.body.down("svg").dom.clientHeight-this.graphMargin.top-this.graphMargin.bottom;var m=d3.scaleLinear().domain([k,l]).range([c,0]),n=d3.area().x(function(a,b){return h(b)}).y0(function(a){return m(a[0])}).y1(function(a){return m(a[1])}).curve(d3.curveCatmullRom);if(this.getMode()===this.MODE_CORPUS){var q=[];this.getCorpus().getDocuments().each(function(a){q.push(a.getTinyLabel())});
k=d3.scalePoint().domain(q).range([0,a]);l=d3.axisBottom(k)}else l=d3.axisBottom(h);k=d3.axisLeft(m);d=this.getVis().selectAll("path").data(d,function(a){return a});d.attr("d",function(a){return n(a)}).style("fill",function(a,c){return b.getColorForTerm(a.key,!0)}).select("title").text(function(a){return a.key});d.enter().append("path").attr("d",function(a){return n(a)}).style("fill",function(a,c){return b.getColorForTerm(a.key,!0)}).append("title").text(function(a){return a.key});d.exit().remove();
this.getVis().selectAll("g.axis").remove();this.getVis().append("g").attr("class","axis x").attr("transform","translate(0,"+c+")").call(l);this.getMode()===this.MODE_CORPUS?(this.getVis().select("g.axis.x").selectAll("text").each(function(){d3.select(this).attr("text-anchor","end").attr("transform","rotate(-45)")}),d=this.localize("documents")):d=this.localize("documentSegments");this.getVis().select("g.axis.x").append("text").attr("text-anchor","middle").attr("transform","translate("+a/2+", "+(this.graphMargin.bottom-
30)+")").attr("fill","#000").text(d);this.getVis().append("g").attr("class","axis y").attr("transform","translate(0,0)").call(k);a="raw"===this.getApiParam("withDistributions")?this.localize("rawFrequencies"):this.localize("relativeFrequencies");this.getVis().select("g.axis.y").append("text").attr("text-anchor","middle").attr("transform","translate(-"+(this.graphMargin.left-20)+", "+c/2+") rotate(-90)").attr("fill","#000").text(a)},getCurrentTerms:function(){var a=[];this.down("[xtype\x3dlegend]").getStore().each(function(b){b.get("active")&&
a.push(b.get("name"))},this);return a},initGraph:function(){if(void 0===this.getVisLayout()){var a=this.getLayout().getRenderTarget();this.setVisLayout(d3.stack().offset(d3.stackOffsetWiggle).order(d3.stackOrderInsideOut));this.setVis(d3.select(a.dom).append("svg").attr("id",this.getGraphId()).append("g").attr("transform","translate("+this.graphMargin.left+","+this.graphMargin.top+")"));this.resizeGraph()}},resizeGraph:function(){var a=this.body,b=a.getWidth(),c=a.getHeight();d3.select(a.dom).select("svg").attr("width",
b).attr("height",c)}});Ext.define("Voyant.panel.Summary",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel","Voyant.util.SparkLine"],alias:"widget.summary",statics:{i18n:{},api:{stopList:"auto",start:0,limit:5,numberOfDocumentsForDistinctiveWords:10},glyph:"xf1ea@FontAwesome"},config:{options:{xtype:"stoplistoption"}},autoScroll:!0,cls:"corpus-summary",constructor:function(a){Ext.apply(this,{title:this.localize("title"),items:{itemId:"main",cls:"main",margin:10},dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",
...
Ext.override(Ext.chart.axis.sprite.Axis,{renderLabels:function(a,b,c,d){var e=this,f=e.attr,g=.5*f.lineWidth,h=f.position,k=f.matrix,l=f.textPadding,m=k.getXX(),n=k.getDX(),q=k.getYY(),r=k.getDY(),p=0,k=c.majorTicks,s=Math.max(f.majorTickSize,f.minorTickSize)+f.lineWidth,x=Ext.draw.Draw.isBBoxIntersect,u=e.getLabel(),H,L,D=null,G=0,A=0,I=c.segmenter,E=e.getRenderer(),B=e.getAxis(),J=(H=B.getTitle())&&""!==H.attr.text&&H.getBBox(),M,K=null,z,C,v;if(k&&u&&!u.attr.hidden){H=u.attr.font;b.font!==H&&(b.font=
H);u.setAttributes({translationX:0,translationY:0},!0);u.applyTransformations();M=u.attr.inverseMatrix.elements.slice(0);switch(h){case "left":b=J?J.x+J.width:0;switch(u.attr.textAlign){case "start":d=a.roundPixel(b+n)-g;break;case "end":d=a.roundPixel(d[2]-s+n)-g;break;default:d=a.roundPixel(b+(d[2]-b-s)/2+n)-g}u.setAttributes({translationX:d},!0);break;case "right":b=J?d[2]-J.x:0;switch(u.attr.textAlign){case "start":d=a.roundPixel(s+n)+g;break;case "end":d=a.roundPixel(d[2]-b+n)+g;break;default:d=
a.roundPixel(s+(d[2]-s-b)/2+n)+g}u.setAttributes({translationX:d},!0);break;case "top":b=J?J.y+J.height:0;u.setAttributes({translationY:a.roundPixel(b+(d[3]-b-s)/2)-g},!0);break;case "bottom":b=J?d[3]-J.y:0;u.setAttributes({translationY:a.roundPixel(s+(d[3]-s-b)/2)+g},!0);break;case "radial":u.setAttributes({translationX:f.centerX},!0);break;case "angular":u.setAttributes({translationY:f.centerY},!0);break;case "gauge":u.setAttributes({translationY:f.centerY},!0)}if("left"===h||"right"===h)e.iterate(k,
function(b,d,f){void 0!==d&&(v=E?Ext.callback(E,null,[B,d,c,D],0,B):I.renderer(d,c,D),D=d,u.setAttributes({text:String(v),translationY:a.roundPixel(b*q+r)},!0),u.applyTransformations(),p=Math.max(p,u.getBBox().width+s),p<=e.thickness&&(C=Ext.draw.Matrix.fly(u.attr.matrix.elements.slice(0)),z=C.prepend.apply(C,M).transformBBox(u.getBBox(!0)),!K||x(z,K,l)))&&(a.renderSprite(u),K=z,G+=z.height,A++)});else if("top"===h||"bottom"===h)e.iterate(k,function(b,d,f){void 0!==d&&(v=E?Ext.callback(E,null,[B,
d,c,D],0,B):I.renderer(d,c,D),D=d,u.setAttributes({text:String(v),translationX:a.roundPixel(b*m+n)},!0),u.applyTransformations(),p=Math.max(p,u.getBBox().height+s),p<=e.thickness&&(C=Ext.draw.Matrix.fly(u.attr.matrix.elements.slice(0)),z=C.prepend.apply(C,M).transformBBox(u.getBBox(!0)),K&&x(z,K,l),a.renderSprite(u),K=z,G+=z.width,A++))});else if("radial"===h)e.iterate(k,function(b,d,e){void 0!==d&&(v=E?Ext.callback(E,null,[B,d,c,D],0,B):I.renderer(d,c,D),D=d,"undefined"!==typeof v&&(u.setAttributes({text:String(v),
translationX:f.centerX-a.roundPixel(b)/f.max*f.length*Math.cos(f.baseRotation+Math.PI/2),translationY:f.centerY-a.roundPixel(b)/f.max*f.length*Math.sin(f.baseRotation+Math.PI/2)},!0),u.applyTransformations(),z=u.attr.matrix.transformBBox(u.getBBox(!0)),!K||x(z,K)))&&(a.renderSprite(u),K=z,G+=z.width,A++)});else if("angular"===h)L=f.majorTickSize+.5*f.lineWidth+(parseInt(u.attr.fontSize,10)||10)/2,e.iterate(k,function(b,d,e){void 0!==d&&(v=E?Ext.callback(E,null,[B,d,c,D],0,B):I.renderer(d,c,D),D=d,
p=Math.max(p,Math.max(f.majorTickSize,f.minorTickSize)+("butt"!==f.lineCap?.5*f.lineWidth:0)),"undefined"!==typeof v&&(b=b/(f.max+1)*Math.PI*2+f.baseRotation,u.setAttributes({text:String(v),translationX:f.centerX+(f.length+L)*Math.cos(b),translationY:f.centerY+(f.length+L)*Math.sin(b)},!0),u.applyTransformations(),z=u.attr.matrix.transformBBox(u.getBBox(!0)),!K||x(z,K)))&&(a.renderSprite(u),K=z,G+=z.width,A++)});else if("gauge"===h){var w=e.getGaugeAngles();e.iterate(k,function(b,d,e){void 0!==d&&
(v=E?Ext.callback(E,null,[B,d,c,D],0,B):I.renderer(d,c,D),D=d,"undefined"!==typeof v&&(b=(b-f.min)/(f.max-f.min+1)*f.totalAngle-f.totalAngle+w.start,u.setAttributes({text:String(v),translationX:f.centerX+(f.length+10)*Math.cos(b),translationY:f.centerY+(f.length+10)*Math.sin(b)},!0),u.applyTransformations(),z=u.attr.matrix.transformBBox(u.getBBox(!0)),!K||x(z,K)))&&(a.renderSprite(u),K=z,G+=z.width,A++)})}f.enlargeEstStepSizeByText&&A&&(G/=A,G+=s,G*=2,f.estStepSize<G&&(f.estStepSize=G));if(1<Math.abs(e.thickness-
...
"0,000")]);this.down("#done").setHtml(b);for(var b=parseInt(this.getApiParam("numTopics")),c=this.getTopicWordCounts(),d=[],e=this.getDocuments(),f=this.getDocSortSmoothing(),g=this.getSumDocSortSmoothing(),h=parseInt(this.getApiParam("limit")),k=0;k<b;k++){var l=e.map(function(a,b){console.warn(a,a.topicCounts[k],f,a.tokens.length,g);return(a.topicCounts[k]+f)/(a.tokens.length+g)});d.push({topic:this.topNWords(c[k],h),scores:l})}a.loadData(d)},topNWords:function(a,b){return a.slice(0,b).map(function(a){return a.word}).join(" ")},
sortTopicWords:function(){for(var a=this.getTopicWordCounts(),b=parseInt(this.getApiParam("numTopics")),c=this.getWordTopicCounts(),a=[],d=0;d<b;d++)a[d]=[];for(var e in c)for(d in c[e])a[d].push({word:e,count:c[e][d]});for(d=0;d<b;d++)a[d].sort(this.byCountDescending);this.setTopicWordCounts(a)},byCountDescending:function(a,b){return b.count-a.count},initialize:function(){var a=(new Ext.Template(this.localize("runIterations"))).apply([Ext.util.Format.number(parseInt(this.getApiParam("iterations")),
"0,000")]);this.down("#iterations").setText(a);this.loadStopwords()},parseLine:function(a){var b=this.getStopwords(),c=this.getVocabularyCounts(),d=this.getTokensPerTopic(),e=this.getVocabularySize(),c=this.getVocabularyCounts(),f=this.getDocuments(),g=parseInt(this.getApiParam("numTopics")),h=this.getWordTopicCounts();if(""!=a){var k=f.length,l="",m=a.split("\t");a=m[0];3==m.length&&(k=m[0],l=m[1],a=m[2]);var n=[],m=a.toLowerCase().split(" ");if(null!=m){var q=this.zeros(g);m.forEach(function(a){if(""!==
a){var f=Math.floor(Math.random()*g);2>=a.length&&(b[a]=1);var k=b[a];k?c[a]=c[a]?c[a]+1:1:(d[f]++,h[a]||(h[a]={},e++,c[a]=0),h[a][f]||(h[a][f]=0),h[a][f]+=1,c[a]+=1,q[f]+=1);n.push({word:a,topic:f,isStopword:k})}});this.setVocabularySize(e);f.push({originalOrder:f.length,id:k,date:l,originalText:a,tokens:n,topicCounts:q})}}}});Ext.define("Voyant.panel.Via",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.via",statics:{i18n:{title:"Via",helpTip:"Via is a tool intended to help you explore the semantic clusters of English texts.",visible:"Visible",timedout:"An attempt was made to fetch data but the request took too long. The process may be still ongoing and you could try again in a couple of minutes.",englishOnly:"You seem to have a text in a language other than English. Unfortunately, at the moment, Via only supports texts in English (because of the current way the lemmatization and synonym operations are programmed)."},
...
(a?this.body.addCls("notebook-editor-wrapper-hover"):this.body.removeCls("notebook-editor-wrapper-hover"))}});Ext.define("Voyant.notebook.editor.CodeEditor",{extend:"Ext.Component",alias:"widget.notebookcodeeditor",mixins:["Voyant.util.Localization","Voyant.notebook.util.Embed"],cls:"notebook-code-editor",config:{theme:"ace/theme/chrome",mode:"ace/mode/javascript",content:"",docs:void 0,isChangeRegistered:!1,editedTimeout:void 0},statics:{i18n:{emptyText:"// click here to edit"}},listeners:{boxready:function(){var a=this;this.editor=ace.edit(Ext.getDom(this.getEl()));this.editor.$blockScrolling=Infinity;
this.editor.getSession().setUseWorker(!0);this.editor.setTheme(this.getTheme());this.editor.getSession().setMode(this.getMode());this.editor.setOptions({minLines:6,maxLines:Infinity,autoScrollEditorIntoView:!0,scrollPastEnd:!0});this.editor.setHighlightActiveLine(!1);this.editor.renderer.setShowPrintMargin(!1);this.editor.renderer.setShowGutter(!1);this.editor.setValue(this.getContent()?this.getContent():this.localize("emptyText"));this.editor.clearSelection();this.editor.on("focus",function(){a.editor.renderer.setShowGutter(!0)},
this);this.editor.on("change",function(){if(0==a.getIsChangeRegistered()){a.setIsChangeRegistered(!0);var b=a.up("notebookcodeeditorwrapper");if(b){b.setIsRun(!1);var c=b.up(c);c&&c.setIsEdited(!0)}}else a.getEditedTimeout()||a.setEditedTimeout(setTimeout(function(){a.setIsChangeRegistered(!1)},3E4))},this);this.editor.on("blur",function(){a.editor.renderer.setShowGutter(!1)});this.editor.commands.addCommand({name:"run",bindKey:{win:"Shift-Enter",mac:"Shift-Enter"},exec:function(b){(b=a.up("notebookcodeeditorwrapper"))&&
b.run()}});ace.config.loadModule("ace/ext/tern",function(){a.editor.setOptions({enableTern:{defs:a.docs?["ecma5",a.docs]:[],plugins:{doc_comment:{fullDocs:!0}},useWorker:!0},enableSnippets:!0,enableBasicAutocompletion:!0})})}},switchModes:function(a){this.setMode("ace/mode/"+a);this.editor.getSession().setMode(this.getMode())},getValue:function(){return this.editor.getValue()}});Ext.define("Voyant.notebook.editor.CodeEditorWrapper",{extend:"Voyant.notebook.editor.EditorWrapper",requires:["Voyant.notebook.editor.CodeEditor","Voyant.notebook.editor.button.Run",,"Voyant.notebook.editor.button.RunAll"],alias:"widget.notebookcodeeditorwrapper",cls:"notebook-code-wrapper",statics:{i18n:{previousNotRunTitle:"Previous Code Blocks",previousNotRun:"There are previous blocks that have not been run (and may be needed for the code in this block). Do you wish to run all code blocks instead?",
...
api:{input:void 0},currentBlock:void 0,getDeferred:function(){return Voyant.application.getDeferred()},getDataFromBlock:function(a){if(Voyant.notebook.Notebook.currentBlock)for(a=Voyant.notebook.Notebook.currentBlock;a;)if(a=a.previousSibling(),a.isXType("notebookcodeeditorwrapper")&&"ace/mode/javascript"!=a.editor.getMode())return a.getContent().input;showError("Unable to find data to load")},loadDataFromUrl:function(a,b){var c=Voyant.application.getDeferred(),d={url:Voyant.application.getTromboneUrl(),
params:{fetchData:a}};b&&b.format&&(d.format=b.format);Ext.Ajax.request(d).then(function(a,d){if(b&&b.format){if("json"==b.format.toLowerCase())return c.resolve(Ext.decode(a.responseText));if("xml"==b.format.toLowerCase())return parser=new DOMParser,xmlDoc=parser.parseFromString(a.responseText,"text/xml"),c.resolve(xmlDoc)}c.resolve(a.responseText)},function(a,b){c.reject(a.responseText);console.log("server-side failure with status code "+a.status)});return c.promise}},config:{metadata:{},version:2,
isEdited:!1,saveItTool:void 0,autoSaveTimer:void 0,initialAutoSaveChecked:!1},docs:{"!name":"Voyant"},constructor:function(a){a=a||{};var b=this,c=["Corpus"];this.docsLoading=c.length;c.forEach(function(a){Ext.Ajax.request({url:this.getBaseUrl()+"docs/ace/"+a+".json",scope:this}).then(function(c,f){var g=Ext.decode(c.responseText),h=new Ext.XTemplate("\x3ca href\x3d'../../docs/#!/api/"+a+"{0}'\x3emore\u2026\x3c/a\x3e");b.docs[a]={"!type":"fn(config) -\x3e Corpus","!url":"","!doc":g.short_doc+h.apply([])};
g.members.forEach(function(c){c["private"]||"method"!=c.tagname||(b.docs[a][c.name]={"!type":"fn()","!url":"","!doc":c.short_doc+h.apply(["-"+c.id])})});b.docsLoading--},function(a,b){console.log("server-side failure with status code "+a.status)})},this);Ext.apply(a,{title:this.localize("title"),includeTools:{help:!0,save:!0,saveIt:{tooltip:this.localize("saveItTip"),callback:function(){b.mask(b.localize("saving"));Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"notebook.NotebookManager",
jsonData:Ext.encode(b.getExportAllJson())},scope:this}).then(function(a,c){b.unmask();var f=Ext.decode(a.responseText);if(f&&f.notebook&&f.notebook.notebook){var g=b.getBaseUrl()+"spiral/"+f.notebook.notebook,h=b.getApplication().getModifiedApiParams();h&&(g+="?"+Ext.Object.toQueryString(h));window.history.pushState({url:g},"Spiral Notebook: "+f.notebook.notebook,g);b.toastInfo({html:b.localize("savedUrlChanged"),anchor:"tr"})}else b.showError(b.localize("savedFailed"))},function(a,c){b.unmask();
b.showResponseError("Unable to save this notebook.",a)})},xtype:"toolmenu",glyph:"xf0c2@FontAwesome",listeners:{afterrender:function(a){a.setVisible("localhost"==window.location.hostname);b.setSaveItTool(a)}},disabled:!0,scope:this},open:{tooltip:this.localize("openTip"),callback:function(){Ext.Msg.prompt(this.localize("openTitle"),this.localize("openMsg"),function(a,b){b=b.trim();"ok"==a&&(this.removeAll(),0==b.indexOf("http")?this.loadFromUrl(b):this.loadBlocksFromString(b))},this,!0)},xtype:"toolmenu",
glyph:"xf115@FontAwesome",scope:this},"new":{tooltip:this.localize("newTip"),callback:function(){this.openUrl(this.getBaseUrl()+"spiral/")},xtype:"toolmenu",glyph:"xf067@FontAwesome",scope:this},runall:{tooltip:this.localize("runallTip"),callback:function(){this.runAllCode()},xtype:"toolmenu",glyph:"xf04e@FontAwesome",scope:this}}});this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},autoScroll:!0,exportToolClick:function(){var a=this.up("panel");Ext.create("Ext.window.Window",
{title:a.localize("exportTitle"),modal:!0,items:{xtype:"form",items:[{xtype:"radio",name:"export",inputValue:"html",checked:!0,boxLabel:a.localize("exportHtml")},{xtype:"radio",name:"export",inputValue:"json",boxLabel:a.localize("exportJson")}],buttons:[{text:a.localize("cancelTitle"),ui:"default-toolbar",glyph:"xf00d@FontAwesome",flex:1,handler:function(a){a.up("window").close()}},{text:a.localize("exportTitle"),glyph:"xf08e@FontAwesome",flex:1,handler:function(b){var c=b.up("form").getValues()["export"];
if("json"==c)a.exportAll();else if("html"==c){var d="",e,f;this.items.each(function(a,b){e=a.isXType("notebookcodeeditorwrapper")?"code":"text";f=a.getContent();d+="\x3cdiv id\x3d'vn-section-"+b+"'\x3e\x3ca name\x3d'vn-section-"+b+"'\x3e\x3c/a\x3e";"code"==e?(d+="\x3cdiv class\x3d'notebook-code-editor ace-chrome'\x3e"+a.getTargetEl().query(".ace_text-layer")[0].outerHTML+"\x3c/div\x3e","javascript"==f.mode&&(d+="\x3cdiv class\x3d'notebook-code-results'\x3e"+f.output+"\x3c/div\x3e")):d+="\x3cdiv class\x3d'notebook-text-editor'\x3e"+
...
statics:{i18n:{},api:{toolFlow:void 0}},constructor:function(){this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);this.callParent(arguments)},config:{corpus:void 0,corpusAccess:void 0,moreTools:[{i18n:"moreToolsScaleCorpus",glyph:"xf065@FontAwesome",items:"cirrus corpusterms bubblelines corpuscollocates mandala microsearch streamgraph phrases documents summary trends scatterplot termsradio topics veliza wordtree".split(" ")},{i18n:"moreToolsScaleDocument",glyph:"xf066@FontAwesome",items:"bubbles cirrus contexts documentterms reader textualarc trends knots topics".split(" ")},
{i18n:"moreToolsTypeViz",glyph:"xf06e@FontAwesome",items:"cirrus bubblelines bubbles collocatesgraph knots mandala microsearch streamgraph scatterplot textualarc trends termsberry termsradio wordtree".split(" ")},{i18n:"moreToolsTypeGrid",glyph:"xf0ce@FontAwesome",items:"corpusterms corpuscollocates phrases contexts documentterms documents topics".split(" ")},{i18n:"moreToolsTypeOther",glyph:"xf035@FontAwesome",items:["reader","summary","veliza"]}]},launch:function(){this.callParent(arguments);if(this.hasQueryToLoad()){var a=
Ext.Object.fromQueryString(document.location.search);!a.corpus&&this.getCorpusId&&this.getCorpusId()&&(a.corpus=this.getCorpusId());this.loadCorpusFromParams(a);if(a.palette)if(-1<a.palette.indexOf(",")){var b=Ext.decode(a.palette);this.addColorPalette(a.palette,b)}else this.loadColorPaletteForCorpus(a.corpus,a.palette)}else(a=this.getViewport())&&(a=a.down("corpuscreator"))&&a.toastInfo({html:this.localize("didYouKnowText"),title:this.localize("didYouKnow"),anchor:a.down("textareafield"),align:"tr",
listeners:{beforeclose:{fn:function(){this.getHeader().getTools().forEach(function(a){"gear"!=a.type&&"help"!=a.type||a.getEl().frame("#ff0000",1,{duration:3E3})})},scope:a}}})},loadCorpusFromParams:function(a){var b=this,c=b.getViewport();c.mask(this.localize("fetchingCorpus"));a.archive&&(Ext.isString(a.archive)&&(a.archive=[a.archive]),a.archive=a.archive.map(function(a){return a.replace("/blogs.sub.uni-hamburg.de/hup/lhn/","/wikis.sub.uni-hamburg.de/lhn/index.php/").replace("/hup.sub.uni-hamburg.de/",
"/wikis.sub.uni-hamburg.de/")}));this.validateCorpusLoadParams(a);(new Voyant.data.model.Corpus(a)).then(function(a){c.unmask();b.setCorpus(a);b.validateCorpusAccess()&&b.dispatchEvent("loadedCorpus",this,a)}).otherwise(function(){c.unmask()})},validateCorpusLoadParams:function(a){},validateCorpusAccess:function(){var a=this,b=a.getViewport(),c=this.getCorpus();if(c&&c.requiresPassword()&&!a.getViewport().query("panel").every(function(a){return!a.isConsumptive})){var d=c.getNoPasswordAccess(),e=Ext.create("Ext.window.Window",
{title:a.localize("passwordRequiredTitle"),layout:"fit",items:{padding:10,flex:1,width:300,layout:{type:"vbox",align:"stretch"},items:[{html:"\x3cp\x3e"+a.localize("passwordRequiredMessage")+"\x3c/p\x3e"+("NONCONSUMPTIVE"==d?"\x3cp\x3e"+a.localize("nonConsumptiveMessage")+"\x3c/p\x3e":"")+"\x3c/p\x3e"},{xtype:"textfield",fieldLabel:a.localize("password")}],bbar:{layout:{pack:"center"},items:[{text:a.localize("passwordValidateButton"),ui:"default",handler:function(){var d=e.query("textfield")[0].getValue().trim();
0==d.length?a.showError({message:a.localize("noPasswordGiven")}):(e.mask(),Ext.Ajax.request({url:a.getTromboneUrl(),params:{corpus:c.getId(),passwordForSession:d},method:"POST",success:function(d,f){e.unmask();var k=d.responseText;"ADMIN"==k||"ACCESS"==k?(e.close(),b.unmask(),a.setCorpusAccess(k),a.dispatchEvent("loadedCorpus",this,c)):a.showError({message:a.localize("badPassword")})},failure:function(b,c){e.unmask();a.showError({message:a.localize("passwordValidationError")})}}))}},{text:a.localize("nonConsumptiveButton"),
hidden:"NONE"==c.getNoPasswordAccess(),handler:function(){e.mask();Ext.Ajax.request({url:a.getTromboneUrl(),params:{corpus:c.getId(),passwordForSessionRemove:!0},method:"POST",callback:function(d,g){e.unmask();e.close();b.unmask();a.dispatchEvent("loadedCorpus",a,c)}})}}]}}}).show();return!1}return!0},hasQueryToLoad:function(a){a||(a=Ext.Object.fromQueryString(document.location.search));return a.corpus||a.input||this.getCorpusId&&this.getCorpusId()},loadColorPaletteForCorpus:function(a,b){Ext.Ajax.request({url:this.getTromboneUrl(),
params:{tool:"resource.StoredResource",retrieveResourceId:b,corpus:a},success:function(a,d){var e=Ext.util.JSON.decode(a.responseText).storedResource.resource,e=Ext.decode(e);this.addColorPalette(b,e)},failure:function(a){this.setApiParam("palette",void 0)},scope:this})},listeners:{loadedCorpus:function(a,b){this.setCorpus(b);this.on("unhandledEvent",function(a,d,e){a=this.getBaseUrl()+"?corpus\x3d"+b.getAliasOrId();var f=this.getModifiedApiParams()||{};delete f.view;if("termsClicked"==d)f.query=
e;else if("documentsClicked"==d){var g=[];e.forEach&&e.forEach(function(a){g.push(a.getIndex())});f.docIndex=g}else if("corpusTermsClicked"==d)e.map&&(f.query=e.map(function(a){return a.getTerm()}));else if("documentTermsClicked"==d)e.map&&(f.query=e.map(function(a){return a.getTerm()}),f.docIndex=e.map(function(a){return a.getDocIndex()}));else{console&&console.warn("Unhandled event: "+d,e);return}f.toolFlow&&(d=Ext.Array.from(f.toolFlow.split(",")),f.view=d.shift(),0<d.length?f.toolFlow=d.join(","):
delete f.toolFlow);a+="\x26"+Ext.Object.toQueryString(f);this.openUrl(a)})}}});Ext.define("Voyant.panel.DocumentClusters",{extend:"Ext.panel.Panel",alias:"widget.documentclusters",title:"Document Clusters"});Ext.define("Voyant.panel.RezoViz",{extend:"Ext.panel.Panel",alias:"widget.rezoviz",title:"RezoViz"});
...
Ext.Ajax.request({url:b.getTromboneUrl(),params:{tool:"resource.StoredResource",retrieveResourceId:this.getApiParam("embeddedApiId")}}).then(function(e){d.resolve();e=Ext.util.JSON.decode(e.responseText);e=decodeURIComponent(e.storedResource.resource);e=Ext.decode(e);var f=Ext.create({xtype:b.getTool(),api:e});f.setApiParams(e);a.unmask();a.remove(a.down("container"));a.add(f);e.corpus&&b.loadCorpusFromParams(e)}).otherwise(function(a){b.getTargetEl&&(Voyant.notebook.util.Show.TARGET=b.getTargetEl(),
