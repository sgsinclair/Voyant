...
config:{tokenType:"lexical",inDocumentsCountOnly:void 0},constructor:function(a){a=a||{};Ext.applyIf(a,{minWidth:100,matchFieldWidth:!1,displayField:"term",valueField:"term",filterPickList:!0,createNewOnEnter:!0,createNewOnBlur:!1,tpl:Ext.create("Ext.XTemplate",'\x3cul class\x3d"x-list-plain"\x3e\x3ctpl for\x3d"."\x3e','\x3cli role\x3d"option" class\x3d"x-boundlist-item" style\x3d"white-space: nowrap;"\x3e{term} ({rawFreq})\x3c/li\x3e',"\x3c/tpl\x3e\x3c/ul\x3e"),triggers:{help:{weight:2,cls:"fa-trigger form-fa-help-trigger",
handler:"onHelpClick",scope:"this"}}});this.callParent(arguments)},initComponent:function(a){var b=this;b.on("beforequery",function(a){if(a.query){a.query=a.query.trim();"^"==a.query.charAt(0)&&(a.query=a.query.substring(1),a.cancel=0==a.query.length);"*"==a.query.charAt(a.query.length-1)&&(a.query=a.query.substring(0,a.query.length-1),a.cancel=0==a.query.length);try{new RegExp(a.query)}catch(b){a.cancel=!0}-1<a.query.indexOf('"')&&(-1==a.query.indexOf(" ")&&(a.cancel=!0),2!=(a.query.match(/"/)||
[]).length&&(a.cancel=!0));a.query=a.query+"*,^"+a.query+"*"}},b);b.on("change",function(a,d){b.up("panel").fireEvent("query",b,d)});b.up("panel").on("loadedCorpus",function(a,d){var e=void 0;if(this.getApiParam)e=this.getApiParam("stopList");else{var f=this.up("panel");f&&f.getApiParam&&(e=f.getApiParam("stopList"))}b.setStore(d.getCorpusTerms({corpus:d,proxy:{extraParams:{limit:10,tokenType:b.tokenType,inDocumentsCountOnly:b.inDocumentsCountOnly,stopList:e}}}))});b.on("afterrender",function(a){a.triggers&&
