...
reset:{en:"reset"}},api:{limit:50,terms:void 0,docId:void 0,docIndex:void 0},glyph:"xf06e@FontAwesome"},config:{mode:void 0,options:{xtype:"stoplistoption"},filesLoaded:!1,corpus:void 0},MODE_CORPUS:"corpus",MODE_DOCUMENT:"mode_document",layout:"fit",constructor:function(a){this.loadFiles();Ext.apply(this,{title:this.localize("title"),dockedItems:[{dock:"bottom",xtype:"toolbar",items:["-\x3e",{text:this.localize("reset"),hidden:!0,itemId:"reset",handler:function(a){a.hide();(a=this.getCorpus())&&
this.loadFromCorpus(a)},scope:this}]}]});this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);if(a.embedded){var b=Ext.getClass(a.embedded).getName();"Voyant.data.store.CorpusTerms"==b&&this.loadFromCorpusTerms(a.embedded);"Voyant.data.model.Corpus"==b&&this.loadFromCorpusTerms(a.embedded.getCorpusTerms())}},listeners:{resize:function(a,b,c){this.cirrus&&this.cirrus.resizeWords()},loadedCorpus:function(a,b){this.loadFromCorpus(b)},documentsClicked:function(a,
b,c){b&&(this.setApiParam("docId",b[0].getId()),this.loadFromDocumentTerms(b[0].getDocumentTerms({autoload:!1,corpus:c})))},ensureCorpusView:function(a,b){this.getMode()!=this.MODE_CORPUS&&this.loadFromCorpus(b)}},loadFromCorpus:function(a){this.setCorpus(a);this.setApiParams({docId:void 0,docIndex:void 0});this.loadFromCorpusTerms(a.getCorpusTerms({autoload:!1}))},loadFromDocumentTerms:function(a){a.load({callback:function(a,c,d){this.setMode(this.MODE_DOCUMENT);this.loadFromTermsRecords(a)},scope:this,
params:this.getApiParams()});this.down("#reset").show()},loadFromCorpusTerms:function(a){a.load({callback:function(a,c,d){this.setMode(this.MODE_CORPUS);this.loadFromTermsRecords(a)},scope:this,params:this.getApiParams()})},loadFromTermsRecords:function(a){var b=[];a.forEach(function(a){b.push({word:a.get("term"),size:a.get("rawFreq"),value:a.get("rawFreq")})});this.buildFromTerms(b)},loadFiles:function(){"undefined"==typeof Cirrus||"undefined"==typeof WordController||"undefined"==typeof Word?Ext.Loader.loadScript({url:[this.getBaseUrl()+
"resources/cirrus/html5/Cirrus.js",this.getBaseUrl()+"resources/cirrus/html5/WordController.js",this.getBaseUrl()+"resources/cirrus/html5/Word.js"],scope:this,onLoad:function(){this.setFilesLoaded(!0)}}):this.setFilesLoaded(!0)},buildFromTerms:function(a){if(this.rendered&&a){var b=this,c=this.getLayout().getRenderTarget();this.cirrus&&c.update("");this.cirrus=new Cirrus({containerId:this.getLayout().getRenderTarget().dom.id,clickHandler:function(a){b.getApplication().dispatchEvent("termsClicked",
