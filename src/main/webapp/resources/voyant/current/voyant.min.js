...
arguments);this.glyph||(this.glyph=Ext.ClassManager.getClass(this).glyph);this.on("afterrender",function(){this.getApiParam("subtitle")&&this.getTitle()&&this.setTitle(this.getTitle()+" \x3ci style\x3d'font-size: smaller;'\x3e"+this.getApiParam("subtitle")+"\x3c/i\x3e");this.isXType("grid")&&(this.getSelectionModel().on("selectionchange",function(a,c){},this),this.getStore().on("beforeload",function(){this.selectedRecordsToRemember=this.getSelection()},this),this.getStore().on("load",function(a,c){if(0<
Ext.Array.from(this.selectedRecordsToRemember).length){var d={},e=Ext.Array.merge(this.selectedRecordsToRemember,c).filter(function(a){return a.getId()in d?!1:d[a.getId()]=!0});a.isBufferedStore?1==a.currentPage&&(a.data.addAll(e),a.totalCount=e.length,a.fireEvent("refresh",a)):(a.loadRecords(e),this.getSelectionModel().select(this.selectedRecordsToRemember),a.fireEvent("refresh",a),this.selectedRecordsToRemember=[])}},this))},this)},getApplication:function(){return Voyant.application},getBaseUrl:function(){return this.getApplication().getBaseUrl()},
openUrl:function(a){this.getApplication().openUrl.apply(this,arguments)},getTromboneUrl:function(){return this.getApplication().getTromboneUrl()},dispatchEvent:function(){var a=this.getApplication();a.dispatchEvent.apply(a,arguments)},showError:function(a,b){Ext.applyIf(a,{title:this.localize("error")+" ("+this.localize("title")+")"});this.getApplication().showError(a,b)},toastError:function(a){Ext.isString(a)&&(a={html:a});Ext.applyIf(a,{glyph:"xf071@FontAwesome",title:this.localize("error")});this.toast(a)},
toastInfo:function(a){Ext.isString(a)&&(a={html:a});Ext.applyIf(a,{glyph:"xf05a@FontAwesome",title:this.localize("info")});this.toast(a)},toast:function(a){Ext.isString(a)&&(a={html:a});Ext.applyIf(a,{slideInDuration:500,shadow:!0,align:"b",anchor:this.getTargetEl()});Ext.toast(a)}});Ext.define("Voyant.panel.VoyantTabPanel",{extend:"Ext.tab.Panel",alias:"widget.voyanttabpanel",mixins:["Voyant.panel.Panel"],statics:{i18n:{}},constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(){this.callParent(arguments)},listeners:{tabchange:function(a,b){this.tools=[];this.getHeader().tools=[];this.query("toolmenu").forEach(function(a){a.destroy()});this.addTool(b.tools);this.getApplication().dispatchEvent("panelChange",
...
success:function(c,d){a.unmask();var e=Ext.JSON.decode(c.responseText);a.downloadFromCorpusId(e.corpus.id)},failure:function(c,d){a.unmask();me.showError(c)}})},scope:this},{xtype:"querysearchfield",width:200,flex:1},{itemId:"status",xtype:"tbtext"}]}]});this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.on("loadedCorpus",function(a,c){this.setCorpus(c);this.queryById("status").update((new Ext.XTemplate(this.localize("noMatches"))).apply([c.getDocumentsCount()]));
this.query("facet").forEach(function(a){a.setCorpus(c)});this.getCustomResultsHtml()||(this.setCustomResultsHtml((new Ext.XTemplate(this.localize("noMatches"))).apply([c.getDocumentsCount()])),this.updateResults(),Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"resource.StoredResource",verifyResourceId:"customhtml-"+c.getAliasOrId()},success:function(a,b){var f=Ext.util.JSON.decode(a.responseText);f&&f.storedResource&&f.storedResource.id&&Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"resource.StoredResource",
retrieveResourceId:"customhtml-"+c.getAliasOrId()},success:function(a,b){var c=Ext.util.JSON.decode(a.responseText);c&&c.storedResource&&c.storedResource.resource&&(this.setCustomResultsHtml(c.storedResource.resource),this.updateResults())},scope:this})},scope:this}))});this.on("afterrender",function(a){var c=this.queryById("facets");this.addFacet({facet:"lexical",includeTools:{add:{type:"plus",tooltip:this.localize("plusFacetTip"),callback:function(){this.addFacet()},scope:this}},store:new Voyant.data.store.CorpusTerms({parentPanel:this,
...
d.queryById("label").setText(c.label);d.queryById("fixed").setChecked(c.fixed);d.showAt(a.event.pageX,a.event.pageY)}}.bind(this)),a.on("startStabilizing",function(){this.stabilizationTask.restart()}.bind(this)),a.on("stabilized",function(){this.stabilizationTask.stop();this.getNetwork().fit({animation:{duration:500,easing:"linear"}})}.bind(this)),a.on("resize",function(a){this.getNetwork().fit({animation:{duration:500,easing:"linear"}})}.bind(this)))},forceUpdate:function(){var a=this.getNodeDataSet().map(function(a){return{id:a.id}});
...
dataIndex:"left",sortable:!0,flex:1},{text:this.localize("term"),tooltip:this.localize("termTip"),dataIndex:"term",sortable:!0,width:"autoSize"},{text:this.localize("right"),tooltip:this.localize("rightTip"),dataIndex:"right",sortable:!0,flex:1},{text:this.localize("position"),tooltip:this.localize("positionTip"),dataIndex:"position",sortable:!0,hidden:!0,flex:1}],listeners:{scope:this,corpusSelected:function(){this.getStore().getCorpus()&&(this.setApiParams({docId:void 0,docIndex:void 0}),this.getStore().loadPage(1))},
documentsSelected:function(a,c){var d=[],e=this.getStore().getCorpus();c.forEach(function(a){d.push(e.getDocument(a).getId())},this);this.setApiParams({docId:d,docIndex:void 0});this.getStore().loadPage(1)},documentSegmentTermClicked:{fn:function(a,c){c.term&&(params={query:c.term},c.docId?params.docId=c.docId:params.docIndex=c.docIndex?c.docIndex:0,this.setApiParams(params),this.isVisible()&&this.getStore().loadPage(1))},scope:this},documentIndexTermsClicked:{fn:function(a,c){var d={},e=[],f={},
g=[];c.forEach(function(a){d[a.term]||(e.push(a.term),d[a.term]=!0);f[a.docIndex]||(g.push(a.docIndex),f[a.docIndex]=!0)});this.setApiParams({docId:void 0,docIndex:g,query:e});this.isVisible()&&this.getStore().loadPage(1,{params:this.getApiParams()})},scope:this},afterrender:function(a){a.getView().on("expandbody",function(c,d,e,f){if(""===e.innerText||f&&f.force){c=Ext.create("Voyant.data.store.Contexts",{stripTags:"all",corpus:a.getStore().getCorpus()});var g=d.getData();c.load({params:{query:g.query,
...
corpusTitle:void 0,corpusSubTitle:void 0}},config:{corpus:void 0},constructor:function(a){this.callParent(arguments);a=a||{};this.mixins["Voyant.panel.Panel"].constructor.call(this,Ext.apply(a,{includeTools:{gear:!0,help:!0,language:this.getLanguageToolMenu()}}))},initComponent:function(){var a=this;Ext.apply(a,{title:this.localize("title"),width:800,frame:!0,padding:10,style:{borderColor:"#aaa",borderStyle:"solid"},frameHeader:!0,layout:{type:"vbox",align:"middle"},dockedItems:[{xtype:"toolbar",
enableOverflow:!0,dock:"bottom",buttonAlign:"right",items:[{text:a.localize("Open"),glyph:"xf115@FontAwesome",tooltip:a.localize("SelectExisting"),hidden:void 0!=this.getCorpus(),handler:function(){Ext.create("Ext.window.Window",{title:a.localize("Open"),layout:"fit",modal:!0,items:{xtype:"form",submitEmptyText:!1,margin:"5,5,5,5",items:{xtype:"corpusselector"},buttons:[{text:a.localize("Open"),glyph:"xf00c@FontAwesome",handler:function(b){b.up("form").getForm();var c=b.up("form").getForm().getValues().corpus;
...
!0);Ext.tip.QuickTipManager.register({target:b.getEl(),text:a.localize("UploadLocal")})},change:function(b,c){if(c){var d=b.up("form").getForm();if(d.isValid()){for(var e=b.fileInputEl.dom.files,f=/\.(png|gif|jpe?g|xls|mp[234a]|mpeg|exe|wmv|avi|ppt|mpg|tif|wav|mov|psd|wma|ai|bmp|pps|aif|pub|dwg|indd|swf|asf|mbd|dmg|flv)$/i,g=/\.(txt|pdf|html?|xml|docx?|rtf|pages|odt|zip|jar|tar|gz|ar|cpio|bzip2|bz2|gzip|xlsx?)$/i,h=[],k=[],m=0,l=e.length;m<l;m++){var n=e[m].name;f.test(n)?h.push(n.split("/").pop()):
g.test(n)||k.push(n.split("/").pop())}0<h.length||0<k.length?Ext.Msg.show({title:a.localize("fileTypesWarning"),icon:Ext.MessageBox.ERROR,message:a.localize("fileTypesMessage")+"\x3cul\x3e"+(0<h.length?"\x3cli\x3e"+a.localize("badFiles")+h.slice(0,5).join(", ")+(5<h.length?"\u2026":"")+"\x3c/li\x3e":"")+(0<k.length?"\x3cli\x3e"+a.localize("unknownFiles")+k.slice(0,5).join(", ")+(5<k.length?"\u2026":"")+"\x3c/li\x3e":"")+"\x3c/ul\x3e"+a.localize("sureContinue"),buttons:Ext.Msg.YESNO,fn:function(c){"yes"===
c?a.loadForm(d):(b.reset(),b.fileInputEl.dom.setAttribute("multiple",!0))},scope:d}):a.loadForm(d)}}}}},"-\x3e",{xtype:"button",scale:"large",glyph:"xf00d@FontAwesome",text:this.localize("cancel"),hidden:void 0==this.getCorpus(),handler:function(a){(a=this.up("window"))&&a.isFloating()&&a.close()}},{xtype:"button",scale:"large",glyph:"xf00c@FontAwesome",text:this.localize("reveal"),ui:"default",width:200,handler:function(b){var c=b.up("form").down("#input").getValue();if(""!==c){var d=a.getApiParams();
...
dataIndex:"typesCount-lexical",renderer:Ext.util.Format.numberRenderer("0,000"),width:"autoSize"},{text:this.localize("typeTokenRatioLexical"),dataIndex:"typeTokenRatio-lexical",renderer:function(a){return Ext.util.Format.percent(a)},width:"autoSize"},{text:this.localize("language"),dataIndex:"language",hidden:!0,renderer:function(a,b,c,d,k,m,l){return l.ownerCt.getLanguage(a)},width:"autoSize"}],store:b,selModel:{type:"rowmodel",mode:"MULTI",listeners:{selectionchange:{fn:function(a,b){this.getApplication().dispatchEvent("documentsClicked",
...
a.term&&this.lastClickedItem.index==a.index},setMode:function(a){this.setApiParams({mode:a});this.getApiParam("mode")}});
...
split:{width:5},tabBarHeaderPosition:0,moreTools:["contexts","documentterms"],items:[{xtype:"contexts"},{xtype:"bubblelines"}]}]}],listeners:{boxready:function(){var a=this.getApiParam("panels");a&&Ext.defer(function(){for(var b=a.toLowerCase().split(","),c=this.query("voyanttabpanel"),f=0,g=b.length;f<g;f++){var h=b[f];if(h&&Ext.ClassManager.getByAlias("widget."+h)&&c[f]){var k=c[f];k.getActiveTab().isXType(h)||(k.items.each(function(a,b){if(a.isXType(h))return this.setActiveTab(b),!1},k),k.getActiveTab().isXType(h)||
k.getActiveTab().replacePanel(h))}}},10,this);var b=this.down("cirrus"),c=this;b&&(b=b.down("toolbar"),b.add({xtype:"tbfill"}),b.add({text:" ",handler:function(){c.add({region:"north",width:"100%",html:'\x3cdiv align\x3d"center"\x3e\x3ctable\x3e\x3ctr\x3e\x3ctd\x3e\x3cimg src\x3d"http://stefansinclair.name/wordpress/wp-content/uploads/2011/07/Sinclair_Stefan_small.jpg" style\x3d"height: 60px"\x3e\x3c/td\x3e\x3ctd style\x3d"text-align: center; padding-left: 2em; padding-right: 2em;"\x3eBy Athena, you found us hidden\x3cbr\x3eup here between the panels!\x3c/td\x3e\x3ctd\x3e\x3cimg src\x3d"http://geoffreyrockwell.com/images/home_09.jpg" style\x3d"height: 60px"\x3e\x3c/td\x3e\x3c/tr\x3e\x3c/table\x3e\x3c/div\x3e'})}}).getTargetEl().dom.className=
