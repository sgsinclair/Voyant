...
" ("+Voyant.application.getBuild()+")"];for(var d="",e=0,f,g=a.getEl(),h=0;h<c.length;h++)f=g.getTextWidth(c[h].replace(/<.+?>/g,"")),e+f<b&&(d+=c[h],e+=f);a.update(d)}}});Ext.define("Voyant.panel.VoyantHeader",{extend:"Ext.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.voyantheader",statics:{i18n:{title:{en:"Voyant Tools"},home:{en:"Start Over"},homeTip:{en:"Click to start over from the corpus creation screen."},homeConfirm:{en:"Are you sure you want to start over (and leave the current corpus)?"}}},constructor:function(a){Ext.apply(this,{id:"voyantheader",title:"",layout:"fit",html:'\x3cdiv id\x3d"logo-container"\x3e\x3c/div\x3e',collapseMode:void 0,collapsible:!0,
animCollapse:!1,titleCollapse:!1,floatable:!1,header:!0,hideCollapseTool:!0,listeners:{collapse:this.onCollapse},titleAlign:"center"});this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.call(this,Ext.apply(a,{moreTools:["corpusset","scatterplot","termsradio"],includeTools:{save:!0,plus:!0,help:!0,home:{type:"home",tooltip:this.localize("homeTip"),xtype:"toolmenu",glyph:"xf015@FontAwesome",handler:function(a){var c=this.up("panel");Ext.Msg.confirm(c.localize("home"),c.localize("homeConfirm"),
function(a){"yes"==a&&(document.location.href=c.getBaseUrl())},this)}}}}))},onCollapse:function(a){Ext.defer(function(){this.setTitle(this.localize("title"))},10,a)}});Ext.define("Voyant.panel.CorpusSet",{extend:"Ext.panel.Panel",requires:"Voyant.panel.VoyantTabPanel Voyant.panel.Cirrus Voyant.panel.Summary Voyant.panel.CorpusTerms Voyant.panel.Reader Voyant.panel.Documents Voyant.panel.Trends Voyant.panel.Contexts Voyant.panel.Phrases Voyant.panel.DocumentTerms Voyant.panel.CorpusCollocates Voyant.panel.CollocatesGraph".split(" "),mixins:["Voyant.panel.Panel"],alias:"widget.corpusset",statics:{i18n:{title:{en:"Corpus View"},helpTip:{en:"This is the default, general-purpose corpus view."}},
