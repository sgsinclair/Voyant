...
b=a.getResponse().responseText,a=a.getMsg()):(a.stack&&!b&&(b=a.stack),b&&!1===Ext.isString(b)&&(b=b.toString()));console&&console.error(a);b&&(console&&console.error(b),a="\x3ch3\x3e"+a.toString()+"\x3c/h3\x3e\x3cpre\x3e"+Ext.String.htmlEncode(b)+"\x3c/pre\x3e");show(a);Voyant.notebook.util.Show.MODE=c},TARGET:null,MODE:"info",SINGLE_LINE_MODE:!1}});var show=String.prototype.show=Voyant.notebook.util.Show.show,showError=Voyant.notebook.util.Show.showError;Ext.define("Voyant.notebook.util.Embed",{transferable:["embed"],embed:function(){embed.apply(this,arguments)},config:{embeddedConfigParamName:"embeddedConfig"},constructor:function(a){var b=this;if(this.getApiParam&&(a=this.getApiParam("embeddedConfig"))){var c=Voyant.application.getDeferred(this);Ext.Ajax.request({url:Voyant.application.getTromboneUrl(),params:{tool:"resource.StoredResource",retrieveResourceId:a}}).then(function(a){c.resolve();a=Ext.util.JSON.decode(a.responseText);a=Ext.urlDecode(a.storedResource.resource);
b.setApiParams(a);b.fireEvent("reconfigure")}).otherwise(function(a){b.getTargetEl&&(Voyant.notebook.util.Show.TARGET=b.getTargetEl(),showError(a));Voyant.application.showError(a);c.reject()})}},statics:{i18n:{},api:{embeddedParameters:void 0,embeddedConfig:void 0},embed:function(a,b){if(this.then)this.then(function(c){embed.call(c,a,b)});else if(Ext.isArray(a))Voyant.notebook.util.Show.SINGLE_LINE_MODE=!0,show("\x3ctable\x3e\x3ctr\x3e"),a.forEach(function(a){show("\x3ctd\x3e");Ext.isArray(a)?a[0].embeddable?
a[0].embed.apply(a[0],a.slice(1)):embed.apply(this,a):embed.apply(this,a);show("\x3c/td\x3e")}),show("\x3c/tr\x3e\x3c/table\x3e"),Voyant.notebook.util.Show.SINGLE_LINE_MODE=!1;else{!this.embeddable||a&&!Ext.isObject(a)||(Ext.isObject(a)&&(b=a),a=this.embeddable[0]);Ext.isString(a)&&(a=Ext.ClassManager.getByAlias("widget."+a.toLowerCase())||Ext.ClassManager.get(a));var c=!1;if(Ext.isFunction(a)){var d=a.getName();this.embeddable&&!0===Ext.Array.each(this.embeddable,function(e){if(e==d){b=b||{};e={};
for(key in Ext.ClassManager.get(Ext.getClassName(a)).api)key in b&&(e[key]=b[key]);e.corpus||("Voyant.data.model.Corpus"==Ext.getClassName(this)?e.corpus=this.getId():this.getCorpus&&(e.corpus=this.getCorpus().getId()));Ext.applyIf(b,{style:"width: "+(b.width||"90%")+(Ext.isNumber(b.width)?"px":"")+"; height: "+(b.height||"400px")+(Ext.isNumber(b.height)?"px":"")});delete b.width;delete b.height;Ext.applyIf(e,Voyant.application.getModifiedApiParams());e=Ext.Object.toQueryString(e);var f=Ext.id(),
g=Voyant.application.getRelativeUrl()+"tool/"+d.substring(d.lastIndexOf(".")+1)+"/?";if(1800<e.length){show('\x3ciframe style\x3d"'+b.style+'" id\x3d"'+f+'" name\x3d"'+f+'"\x3e\x3c/iframe\x3e');var h=Voyant.application.getDeferred(this);Ext.Ajax.request({url:Voyant.application.getTromboneUrl(),params:{tool:"resource.StoredResource",storeResource:e}}).then(function(a){a={minimal:!0,embeddedConfig:Ext.util.JSON.decode(a.responseText).storedResource.id};Ext.applyIf(a,Voyant.application.getModifiedApiParams());
document.getElementById(f).setAttribute("src",g+Ext.Object.toQueryString(a));h.resolve()}).otherwise(function(a){showError(a);h.reject()})}else show('\x3ciframe src\x3d"'+g+e+'" style\x3d"'+b.style+'" id\x3d"'+f+'" name\x3d"'+f+'"\x3e\x3c/iframe\x3e');c=!0;return!1}},this)&&Voyant.notebook.util.Embed.showWidgetNotRecognized.call(this);if(!c){debugger;Ext.create(a,b).embed(b)}}c||Voyant.notebook.util.Embed.showWidgetNotRecognized.call(this)}},showWidgetNotRecognized:function(){var a=Voyant.notebook.util.Embed.i18n.widgetNotRecognized;
...
date:d});c+="\x3c/span\x3e";return!1}},this)&&(c+=this.localize("now"));c+=".";c+=""}!0===a&&(c+=" ("+this.getId()+")");return c}});Ext.define("Voyant.widget.CodeEditor",{extend:"Ext.panel.Panel",mixins:["Voyant.util.Localization","Voyant.util.Api","Voyant.notebook.util.Embed"],alias:"widget.codeeditor",statics:{i18n:{},api:{tableJson:void 0,content:"",mode:"ace/mode/text",width:void 0}},constructor:function(a){a=a||{};this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);this.buildFromParams();a.noEmbed||this.mixins["Voyant.notebook.util.Embed"].constructor.apply(this,arguments);Ext.apply(this,{items:{xtype:"notebookcodeeditor",
content:a.content?a.content:this.getApiParam("content"),mode:a.mode?a.mode:this.getApiParam("mode")}});this.callParent(arguments);this.on("reconfigure",function(){this.buildFromParams();this.down("notebookcodeeditor").editor.setValue(this.getApiParam("content"))},this)},initComponent:function(a){a=a||{};this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);this.callParent(arguments)},buildFromParams:function(){var a=this.getApiParam("tableJson");a&&(a=Ext.decode(a),a=a.headers.join("\t")+
...
Ext.Ajax.request({url:c.getTromboneUrl(),params:{tool:"resource.StoredResource",storeResource:b,corpus:d},success:function(b,d){var g=Ext.util.JSON.decode(b.responseText).storedResource.id,h=this.down("combo");h.getStore().add({name:g,value:g});h.setValue(g);h.updateLayout();c.getApplication().addColorPalette(g,a)},scope:this})}});Ext.define("Voyant.widget.VoyantChart",{extend:"Ext.chart.CartesianChart",mixins:["Voyant.util.Localization","Voyant.util.Api","Voyant.notebook.util.Embed"],alias:"widget.voyantchart",statics:{i18n:{},api:{tableJson:void 0}},constructor:function(a){a=a||{};this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);a.noEmbed||this.mixins["Voyant.notebook.util.Embed"].constructor.apply(this,arguments);this.getApiParam("tableJson")&&Ext.apply(a,this.getConfigFromTableJson());this.callParent(arguments);
this.on("reconfigure",function(){if(this.getApiParam("tableJson")){var a=this.getConfigFromTableJson(),a=Ext.create("Voyant.widget.VoyantChart",a),c=this.up("container");c.remove(this);c.add(a)}})},initComponent:function(a){this.callParent(arguments)},getConfigFromTableJson:function(){var a=this.getApiParam("tableJson");if(!a)return{};var b=JSON.parse(a);b.headers=b.headers.map(function(a){return a});1==b.headers.length&&(b.headers.push(1),b.rowKey=1,b.rows.forEach(function(a,b){a&&a.push(b)}));var c=
[];b.rowKey||(b.rowKey=b.headers[0]);b.rows.forEach(function(a,d){if(a){var e={};e[b.rowKey]=d;a=a.forEach(function(a,c){e[b.headers[c]]=a});c.push(e)}});b.config||(b.config={});a={store:{fields:Object.keys(c[0]),data:c},axes:Ext.isArray(b.config.axes)?b.config.axes:[{},{}],series:[]};b.config.axes||(b.config.axes=[{},{}]);a.axes.forEach(function(a,c){Ext.isObject(b.config.axes)?Ext.apply(a,b.config.axes):Ext.isArray(b.config.axes)&&Ext.apply(a,b.config.axes[c]);Ext.applyIf(a,{type:0==c?"numeric":
...
confirmRemove:"Are you sure you want to remove the category?"},api:{stopList:"auto",query:void 0}},config:{corpus:void 0,categoriesManager:void 0,categoryWin:void 0},constructor:function(a){a=a||{};var b=a.categoriesManager?a.categoriesManager:Ext.create("Voyant.util.CategoriesManager");this.setCategoriesManager(b);this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);this.callParent(arguments)},initComponent:function(){Ext.apply(this,{title:this.localize("title"),layout:"border",items:[{title:this.localize("terms"),
split:!0,width:250,region:"west",layout:"fit",items:{itemId:"terms",xtype:"grid",store:Ext.create("Voyant.data.store.CorpusTermsBuffered",{parentPanel:this}),viewConfig:{plugins:{ptype:"gridviewdragdrop",ddGroup:"terms",copy:!0,enableDrop:!1,dragZone:{getDragText:function(){var a="";this.dragData.records.forEach(function(b){a+=b.get("term")+", "});return a.substr(0,a.length-2)}}}},selModel:{mode:"MULTI"},columns:[{text:this.localize("term"),dataIndex:"term",flex:1,sortable:!0},{text:this.localize("rawFreq"),
dataIndex:"rawFreq",width:"autoSize",sortable:!0},{text:this.localize("relativeFreq"),dataIndex:"relativeFreq",renderer:function(a){return Ext.util.Format.number(1E6*a,"0,000")},width:"autoSize",hidden:!0,sortable:!0}],dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"querysearchfield"}]}],listeners:{query:function(a,b){this.setApiParam("query",b);var c=this.queryById("terms").getStore();c.removeAll();c.load()},scope:this}}},{title:this.localize("categories"),itemId:"categories",
region:"center",xtype:"panel",layout:{type:"hbox",align:"stretch"},scrollable:"x",dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{text:this.localize("addCategory"),handler:function(){this.getCategoryWin().show()},scope:this},{text:this.localize("removeTerms"),handler:function(){this.queryById("categories").query("grid").forEach(function(a){a.getStore().remove(a.getSelection())},this)},scope:this}]}],items:[]}]});this.setCategoryWin(Ext.create("Ext.window.Window",{title:this.localize("addCategory"),
modal:!0,closeAction:"hide",layout:"fit",items:{xtype:"form",width:300,defaults:{labelAlign:"right"},items:[{xtype:"textfield",fieldLabel:this.localize("categoryName"),name:"categoryName",allowBlank:!1,validator:function(a){return void 0===this.getCategoriesManager().getCategory(a)?!0:this.localize("exists")}.bind(this),enableKeyEvents:!0,listeners:{keypress:function(a,b){b.getKeyName()},scope:this}}],buttons:[{text:this.localize("cancel"),handler:function(a){a.up("window").close()}},{text:this.localize("add"),
handler:function(a){var b=a.up("form");b.isValid()&&(b=b.getValues().categoryName,this.addCategory(b),a.up("window").close())},scope:this}]},listeners:{show:function(a){a=a.down("form").getForm();a.reset();a.clearInvalid()}}}));this.on("afterrender",function(a){a.on("loadedCorpus",function(a,b){this.setCorpus(b);this.queryById("terms").getStore().load()},a);var b=a.findParentBy(function(a){return a.mixins["Voyant.panel.Panel"]});null==b&&(b=a.up("window").panel);b&&(b.on("loadedCorpus",function(b,
d){a.fireEvent("loadedCorpus",b,d)},a),b.getCorpus&&b.getCorpus()?a.fireEvent("loadedCorpus",a,b.getCorpus()):b.getStore&&b.getStore()&&b.getStore().getCorpus&&b.getStore().getCorpus()&&a.fireEvent("loadedCorpus",a,b.getStore().getCorpus()));this.buildCategories()},this);this.callParent(arguments)},addCategory:function(a){this.getCategoriesManager().addCategory(a);return this.queryById("categories").add({title:a,xtype:"panel",frame:!0,width:150,margin:"10 0 10 10",layout:"fit",tools:[{type:"close",
callback:function(b){Ext.Msg.confirm(this.localize("removeCategory"),this.localize("confirmRemove"),function(c){"yes"===c&&(this.queryById("categories").remove(b),this.getCategoriesManager().removeCategory(a))},this)},scope:this}],items:[{xtype:"grid",category:a,store:Ext.create("Ext.data.JsonStore",{data:[],fields:["term"]}),viewConfig:{plugins:{ptype:"gridviewdragdrop",ddGroup:"terms",dragZone:{getDragText:function(){var a="";this.dragData.records.forEach(function(c){a+=c.get("term")+", "});return a.substr(0,
a.length-2)}}}},selModel:{mode:"MULTI"},columns:[{dataIndex:"term",flex:1,sortable:!0}],listeners:{drop:function(b,c){c.view.getSelectionModel().deselectAll();this.getSelectionModel().deselectAll();for(var d=this.up("categoriesbuilder").getCategoriesManager(),e=[],f=0;f<c.records.length;f++)e.push(c.records[f].get("term"));d.addTerms(a,e);f=c.view.up("grid");f.category&&d.removeTerms(f.category,e)}}}]})},buildCategories:function(){var a=this.getCategoriesManager().getCategories(),b;for(b in a){for(var c=
[],d=a[b],e=0;e<d.length;e++)c.push({term:d[e]});this.addCategory(b).down("grid").getStore().loadRawData(c)}}});Ext.define("Voyant.panel.Panel",{mixins:["Voyant.util.Localization","Voyant.util.Api","Voyant.util.Toolable","Voyant.util.DetailedError"],requires:["Voyant.widget.QuerySearchField","Voyant.widget.StopListOption","Voyant.widget.TotalPropertyStatus"],alias:"widget.voyantpanel",statics:{i18n:{},config:{corpusValidated:!1},api:{corpus:void 0,input:void 0,inputFormat:void 0,subtitle:void 0}},config:{corpus:void 0},constructor:function(a){this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);
...
listeners:{},handleUserSentence:function(a,b){if((a=a.trim())||b){a&&this.addSentence("myMessage",a);this.mask();var c=this,d=this.getComponent("script").down("textarea");Ext.Ajax.request({url:this.getApplication().getTromboneUrl(),params:{corpus:c.getCorpus().getId(),tool:"corpus.Veliza",sentence:a,fromCorpus:b?!0:!1,script:d.isDirty()?d.getValue():this.getApiParam("script"),noCache:Ext.id()},success:function(a,f){c.unmask();a=Ext.decode(a.responseText);a.veliza.id&&(c.setApiParam("script",a.veliza.id),
d.resetOriginalValue());var g=a.veliza.response,h=g.match(/<\!-- (.+?) --\x3e/);if(h){h=Ext.decode(h[1]);for(key in h.params)h.params[key]=h.params[key].trim();g+="\x3cbr/\x3e\x3ciframe width\x3d'"+(h.width?h.width:"100%")+"' height\x3d'"+(h.height?h.height:"350px")+"' src\x3d'"+c.getApplication().getBaseUrl()+"tool/"+h.tool+"/?corpus\x3d"+c.getCorpus().getId()+"\x26minimal\x3dtrue\x26"+Ext.Object.toQueryString(h.params)+"'\x3e\x3c/iframe\x3e"}h=a.veliza.sentence;c.setPrevious(a.veliza.previous);
b?(meta=-1<a.veliza.docIndex?c.getCorpus().getDocument(a.veliza.docIndex).getShortLabel():void 0,c.addSentence("myMessage",h,meta),Ext.Function.defer(function(){this.addSentence("fromThem",g);this.body.scroll("b",Infinity)},500,c)):(c.addSentence("fromThem",g),c.body.scroll("b",Infinity))},failure:function(a,b){c.showResponseError("Unable to get response from Veliza.",a)}})}},addSentence:function(a,b,c){var d=this.getComponent("chat").body;d.down("form").insertHtml("beforeEnd",'\x3cdiv class\x3d"message"\x3e\x3cdiv class\x3d"'+
...
{xtype:"trends",collapsible:!0},{xtype:"morelikethis",collapsible:!0}],flex:6}]});this.callParent(arguments)}});Ext.define("Voyant.VoyantNotebookApp",{extend:"Voyant.VoyantApp",requires:["Voyant.panel.VoyantFooter","Voyant.notebook.Notebook","Voyant.data.model.Corpus","Voyant.notebook.util.Show"],name:"VoyantNotebookApp",launch:function(){Ext.create("Ext.container.Viewport",{layout:"border",items:[{xtype:"notebook",region:"center"},{xtype:"voyantfooter",region:"south"}]});this.callParent(arguments)}});Ext.define("Voyant.VoyantToolApp",{extend:"Voyant.VoyantCorpusApp",name:"VoyantToolApp",statics:{api:{minimal:void 0}},launch:function(){var a=[];this.getApiParam("minimal")||a.push({region:"south",xtype:"voyantfooter"});a.push({region:"center",layout:"fit",items:{xtype:this.getTool()}});Ext.create("Ext.container.Viewport",{layout:"border",items:a});this.callParent(arguments)}});