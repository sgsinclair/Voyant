...
"document"===this.getApiParam("mode")&&this.documentStore.load({params:a});"corpus"===this.getApiParam("mode")&&(delete a.bins,this.corpusStore.load({params:a}))}});Ext.define("Voyant.panel.Trends",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],requires:["Voyant.data.store.Documents"],alias:"widget.trends",config:{options:[{xtype:"stoplistoption"},{xtype:"colorpaletteoption"}]},statics:{i18n:{relativeTitle:"Relative Frequencies",rawTitle:"Raw Frequencies",corpusTitle:"Corpus (Documents)",segmentsTitle:"Document Segments",toggleTip:"Click to toggle the visibility of this series.",reset:"Reset",resetTip:"Reset to initial view.",dblClickItem:"Double-click to drilldown.",
drillTerm:"Terms",drillTermTip:"View the distribution of this term within all documents.",drillDocument:"Document",drillDocumentTip:"View the distribution of all current terms within this document."},api:{limit:5,stopList:"auto",query:void 0,withDistributions:"relative",bins:10,docIndex:void 0,docId:void 0,mode:"corpus"},glyph:"xf201@FontAwesome"},layout:"fit",documentTermsStore:void 0,segments:void 0,constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,
arguments)},initComponent:function(){Ext.apply(this,{title:this.localize("title"),dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"querysearchfield"},{itemId:"reset",text:this.localize("reset"),tooltip:this.localize("resetTip"),handler:function(a){this.setApiParams({docIndex:void 0,mode:void 0,query:void 0});this.loadCorpusTerms()},scope:this},{itemId:"segmentsSlider",xtype:"slider",fieldLabel:this.localize("segmentsSlider"),fieldAlign:"right",labelWidth:70,width:150,
minValue:2,maxValue:100,hidden:!0,listeners:{afterrender:function(a){this.segments=a;a.setValue(parseInt(this.getApiParam("bins")))},changecomplete:function(a,b){this.setApiParams({bins:b});this.loadDocumentTerms()},scope:this}}]}]});this.callParent(arguments)},listeners:{loadedCorpus:function(a,b){this.loadCorpusTerms()},termsClicked:function(a,b){var c=[];b.forEach(function(a){Ext.isString(a)?c.push(a):a.term?c.push(a.term):a.getTerm&&c.push(a.getTerm())});this.setApiParam("query",c&&0<c.length?
c:void 0);this.loadCorpusTerms()},corpusTermsClicked:function(a,b){this.setApiParam("query",b.map(function(a){return a.getTerm()}));this.loadCorpusTerms()},documentSelected:function(a,b){this.setApiParam("docIndex",this.getCorpus().getDocument(b).getIndex());this.loadDocumentTerms()},documentsClicked:function(a,b){1==b.length&&this.fireEvent("documentSelected",this,b[0])},query:function(a,b){this.fireEvent("termsClicked",this,b)}},loadCorpusTerms:function(a){if(2>this.getCorpus().getDocumentsCount()||
"document"==this.getApiParam("mode")||0<Array.from(this.getApiParam("docIndex")||"").length)return this.loadDocumentTerms();if(this.getApiParam("query")){a=a||{};this.segments.hide();this.getApiParam("withDistributions");Ext.applyIf(a,{bins:this.getCorpus().getDocumentsCount(),limit:1E3,stopList:""});var b=this.getCorpus().map(function(a){return a.getTinyTitle()});Ext.applyIf(a,this.getApiParams());this.getCorpus().getCorpusTerms().load({params:a,callback:function(a,d,e){var f=[],g=[];a.forEach(function(a,
c){var d=a.get("term"),e=this.getApplication().getColorForTerm(d,!0);a.get("distributions").forEach(function(a,d){f[d]||(f[d]={index:b[d]});f[d]["_"+c]=a},this);g.push({title:d,xField:"index",yField:"_"+c,term:d,colors:[e],tooltip:{trackMouse:!0,renderer:function(a,b,c){b="\x3cspan class\x3d'x-legend-item-marker' style\x3d'background:"+e+"; left: 2px;'\x3e\x3c/span\x3e \x3cspan style\x3d'padding-left: 1.2em; font-weight: bold;'\x3e"+c.series.term+"\x3c/span\x3e: +"+b.get(c.field);1<this.getCorpus().getDocumentsCount()&&
(b+="\x3cbr/\x3e\x3ci\x3e"+this.getCorpus().getDocument(c.index).getShortTitle()+"\x3c/i\x3e");b+="\x3cdiv style\x3d'font-size: smaller'\x3e"+this.localize("dblClickItem");a.setHtml(b)},scope:this},label:{color:e,renderer:function(a,b,c,e){return d}}})},this);a=Ext.create("Ext.data.JsonStore",{fields:Object.keys(f[0]),data:f});this.buildChart({store:a,series:g,axes:[{type:"numeric",position:"left",increment:1,title:{text:this.localize(this.getApiParam("withDistributions")+"Title")}},{type:"category",
position:"bottom",title:{text:this.localize("corpusTitle")}}]})},scope:this})}else this.getCorpus().getCorpusTerms().load({params:{limit:5,stopList:this.getApiParam("stopList")},callback:function(a,b,e){this.setApiParam("query",a.map(function(a){return a.getTerm()}));this.loadCorpusTerms()},scope:this})},loadDocumentTerms:function(a){if(this.getApiParam("query")){this.segments.show();this.setApiParam("mode","document");a=a||{};this.getApiParam("withDistributions");Ext.applyIf(a,{limit:0,sort:"termasc",
stopList:void 0});this.getCorpus().map(function(a){return a.getTinyTitle()});var b;b=1==this.getCorpus().getDocumentsCount()?this.getCorpus().getDocument(0):this.getCorpus().getDocument(this.getApiParam("docIndex"));Ext.applyIf(a,this.getApiParams());this.getCorpus().getDocumentTerms().load({params:a,callback:function(a,d,e){var f=[],g=[];b||a.sort(function(a,b){return a.getTerm()==b.getTerm()?a.getDocIndex()-b.getDocIndex():a.getTerm().localeCompare(b.getTerm())});a.forEach(function(a,c){var d=a.get("term"),
e=a.get("docIndex"),n=b?this.getApplication().getColorForTerm(d,!0):this.getApplication().getColor(e,!0),e=a.get("docIndex");a.get("distributions").forEach(function(a,b){f[b]||(f[b]={docIndex:e,index:b+1});f[b]["_"+c+"_"+e]=a},this);g.push({title:d+(b?"":" ("+this.getCorpus().getDocument(e).getTinyTitle()+")"),xField:"index",yField:"_"+c+"_"+e,term:d,docIndex:e,colors:[n],tooltip:{trackMouse:!0,renderer:function(a,b,c){b="\x3cspan class\x3d'x-legend-item-marker' style\x3d'background:"+n+"; left: 2px;'\x3e\x3c/span\x3e \x3cspan style\x3d'padding-left: 1.2em; font-weight: bold;'\x3e"+
c.series.term+"\x3c/span\x3e: +"+b.get(c.field)+"\x3cbr/\x3e\x3ci\x3e"+this.getCorpus().getDocument(e).getShortTitle()+"\x3c/i\x3e";a.setHtml(b)},scope:this},label:{color:n,renderer:function(a,b,c,e,f){return d}}})},this);a=Ext.create("Ext.data.JsonStore",{fields:Object.keys(f[0]),data:f});this.buildChart({store:a,series:g,axes:[{type:"numeric",position:"left",title:{text:this.localize(this.getApiParam("withDistributions")+"Title")}},{type:"category",position:"bottom",title:{text:this.localize("segmentsTitle")+
(b?" ("+b.getShortTitle()+")":"")}}]})},scope:this})}else this.getCorpus().getCorpusTerms().load({params:{limit:2>this.getCorpus().getDocumentsCount()?5:2,stopList:this.getApiParam("stopList")},callback:function(a,b,e){this.setApiParam("query",a.map(function(a){return a.getTerm()}));this.loadDocumentTerms()},scope:this})},buildChart:function(a){a.series.forEach(function(a){Ext.applyIf(a,{type:"line",smooth:!0,marker:{type:"circle",radius:2},style:{lineWidth:1,strokeOpacity:.5},highlightCfg:{scaling:2},
label:{},listeners:{itemclick:function(a,b,c,g){this.clickTimer&&clearTimeout(this.clickTimer);if(!this.blockClick)if(this.blockClick=!0,Ext.defer(function(){this.blockClick=!1},1E3,this),"document"==this.getApiParam("mode"))a=b.field.split("_"),c=a[2],c=this.getCorpus().getDocument(c).get("tokensCount-lexical"),c=parseInt(b.index*c/parseInt(this.getApiParam("bins"))),this.dispatchEvent("documentIndexTermsClicked",this,[{term:b.series.term,docIndex:a[2],position:c}]);else{this.clickTimer&&clearTimeout(this.clickTimer);
var h=this;this.clickTimer=setTimeout(function(){h.dispatchEvent("documentIndexTermsClicked",h,[{term:b.series.term,docIndex:b.index}])},300)}},itemdblclick:function(a,b,c,g){this.clickTimer&&clearTimeout(this.clickTimer);this.blockClick=!0;Ext.defer(function(){this.blockClick=!1},1E3,this);"document"!=this.getApiParam("mode")&&Ext.create("Ext.menu.Menu",{items:[{text:this.localize("drillTerm"),tooltip:this.localize("drillTermTip"),handler:function(){this.setApiParams({mode:"document",query:b.series.term});
this.loadDocumentTerms()},scope:this},{text:this.localize("drillDocument"),tooltip:this.localize("drillDocumentTip"),handler:function(){this.setApiParams({mode:"document",docIndex:b.index});this.loadDocumentTerms()},scope:this}],listeners:{hide:function(a){Ext.defer(function(){this.destroy()},200,a)},scope:this}}).showAt(c.pageX,c.pageY)},scope:this}});Ext.applyIf(a.label,{display:"over",field:"index",fontSize:11,translateY:9})},this);Ext.applyIf(a,{animation:!0,plugins:{ptype:"chartitemevents",moveEvents:!0},
legend:{docked:"top"},interactions:["itemhighlight","crosszoom"],listeners:{}});Ext.applyIf(a.listeners,{itemhighlightchange:function(a,b){a.el.dom.style.cursor=b?"pointer":""},afterrender:function(){},scope:this});a.axes.forEach(function(b){Ext.applyIf(b,{title:{},label:{}});Ext.applyIf(b.title,{scaling:.75});Ext.applyIf(b.label,{scaling:.75});if("category"==b.type&&"corpus"==this.getApiParam("mode")){var d="";a.store.each(function(a){d+=a.get("index")});d.length>this.getTargetEl().getWidth()/9&&
Ext.applyIf(b.label,{rotate:{degrees:-30}});Ext.applyIf(b,{labelInSpan:!0})}},this);this.query("chart").forEach(function(a){this.remove(a,!0)},this);var b=Ext.create("Ext.chart.CartesianChart",a);this.add(b)}});Ext.define("Voyant.panel.NoTool",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.notool",statics:{i18n:{},api:{tool:void 0}},config:{html:void 0,notYetImplemented:"Centroid DocumentInputAdd DocumentTypeCollocateFrequenciesGrid EntitiesBrowser Equalizer FeatureClusters Flowerbed KwicsTagger Lava Mandala MicroSearch NetVizApplet PaperDrill RezoViz Sunburst Termometer Ticker TokensViz ToolBrowser ToolBrowserLarge VoyeurTagline WordCloud VoyeurTagline WordCountFountain".split(" ")},
