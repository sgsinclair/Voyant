...
b.trim().length&&-1<a.toLowerCase().indexOf(b.toLowerCase())&&(c=!0)})});f+="\x3cli\x3e"+(r?"":g+": ")+(c?'\x3cspan class\x3d"keyword"\x3e'+a+"\x3c/span\x3e":a)+"\x3c/li\x3e"});r&&(f+="\x3c/ul\x3e\x3c/li\x3e")}}f&&(a+="\x3cul\x3e"+f+"\x3c/ul\x3e")}h+=a+"\x3c/li\x3e"})});h+="\x3c/ul\x3e";c.update(h);this.queryById("status").update(this.localize("queryMatches",[k.length,this.getCorpus().getDocumentsCount()]));this.setMatchingDocIds(Ext.Array.clone(k));debugger;0<k.length&&this.queryById("export").setDisabled(!1);
