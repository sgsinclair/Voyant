...
(d.height=Math.round(b.height*parseInt(d.height)/100));d.items&&1<d.items.length?(d.layout="border",this.addBorderLayouts(d.items)):d.layout="fit"}},initTableLayout:function(){Ext.suspendLayouts();var a=decodeURI(this.getApiParam("tableLayout")),a=Ext.decode(a);if(null!=a.numCols){for(var b=[],c=0;c<a.cells.length;c++){var d=a.cells[c];if(Ext.isObject(d))b.push(d);else if(Ext.isArray(d)){var e=1,f=1;xtype=void 0;d[0]&&Ext.isNumber(d[0])&&(e=d[0],d.shift());d[0]&&Ext.isString(d[0])&&(xtype=d[0],d.shift());
d[0]&&Ext.isNumber(d[0])&&(f=d[0]);xtype&&b.push({colspan:e,rowspan:f,xtype:xtype})}else Ext.isString(d)&&b.push({xtype:d,colspan:1,rowspan:1})}Ext.apply(this,{layout:{type:"table",width:"100%",height:"100%",columns:a.numCols,tableAttrs:{style:{width:"100%",height:"100%"}},tdAttrs:{style:{padding:"0px",verticalAlign:"top"}}},defaults:{width:10,height:10,border:!0},items:b})}Ext.resumeLayouts()},doTableSizing:function(a,b){for(var c={},d=this.getTargetEl().down(".x-table-layout").dom.rows,e=0;e<d.length;e++)for(var f=
d[e].cells,g=0;g<f.length;g++){var h=Ext.get(f[g]),k=h.down(".x-panel"),m=k.id;void 0!==a&&void 0!==b?(h=k.getSize(!1),h.width*=a,h.height*=b):h=h.getSize(!1);c[m]=h}for(var l in c)h=c[l],Ext.getCmp(l).setSize(h);this.updateLayout()}});Ext.define("Voyant.panel.TableSet",{extend:"Ext.panel.Panel",requires:"Voyant.panel.VoyantTabPanel Voyant.panel.Cirrus Voyant.panel.Summary Voyant.panel.CorpusTerms Voyant.panel.Reader Voyant.panel.Documents Voyant.panel.Trends Voyant.panel.Contexts Voyant.panel.Phrases Voyant.panel.DocumentTerms Voyant.panel.CorpusCollocates Voyant.panel.CollocatesGraph Voyant.panel.StreamGraph".split(" "),mixins:["Voyant.panel.Panel"],alias:"widget.tableset",statics:{i18n:{},api:{panels:void 0},glyph:"xf17a@FontAwesome"},
header:!1,constructor:function(){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.on("boxready",function(a){this.doTableSizing()},this);this.on("resize",function(a,b,c,d,e){void 0!==d&&void 0!==e&&this.doTableSizing(b/d,c/e)},this)},initComponent:function(){Ext.suspendLayouts();var a=Ext.urlDecode(window.location.search.substring(1)),a=decodeURI(a.layout),a=Ext.decode(a);if(null!=a.numCols){for(var b=[],c=0;c<a.cells.length;c++)b.push(a.cells[c]);
Ext.apply(this,{layout:{type:"table",width:"100%",height:"100%",columns:a.numCols,tableAttrs:{style:{width:"100%",height:"100%"}},tdAttrs:{style:{padding:"0px",verticalAlign:"top"}}},defaults:{width:10,height:10,border:!0},items:b})}Ext.resumeLayouts();this.callParent()},doTableSizing:function(a,b){for(var c={},d=this.getTargetEl().down(".x-table-layout").dom.rows,e=0;e<d.length;e++)for(var f=d[e].cells,g=0;g<f.length;g++){var h=Ext.get(f[g]),k=h.down(".x-panel"),m=k.id;void 0!==a&&void 0!==b?(h=
k.getSize(!1),h.width*=a,h.height*=b):h=h.getSize(!1);c[m]=h}for(var l in c)h=c[l],Ext.getCmp(l).setSize(h);this.updateLayout()}});Ext.define("Voyant.panel.WordTree",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.wordtree",statics:{i18n:{},api:{query:void 0,docId:void 0,docIndex:void 0,stopList:"auto",context:10,limit:5},glyph:"xf0e8@FontAwesome"},config:{corpus:void 0,tree:void 0,kwicStore:void 0,options:{xtype:"stoplistoption"}},doubleClickDelay:300,lastClick:1,constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(){Ext.apply(this,
