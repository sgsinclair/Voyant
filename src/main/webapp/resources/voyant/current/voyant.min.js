...
void 0!==c&&(this.getNetworkMode()===this.CENTRALIZED_MODE&&(this.resetGraph(),this.setNetworkMode(this.DEFAULT_MODE),this.setApiParam("centralize",void 0),c.start=0,c.limit=this.getApiParam("limit")),this.fetchCollocatesForNode(c))},scope:this},{xtype:"button",text:"Centralize",style:"margin: 5px;",handler:function(a,b){var c=this.getCurrentNode();void 0!==c&&this.doCentralize(c.term);this.getContextMenu().hide()},scope:this},{xtype:"button",text:"Remove",style:"margin: 5px;",handler:function(a,
b){var c=this.getCurrentNode();void 0!==c&&this.removeNode(c.id);a.up("menu").hide()},scope:this}]}));this.on("loadedCorpus",function(a,b){this.isVisible()&&this.initLoad()},this);this.on("activate",function(){this.getCorpus()&&0===this.getNodeData().length&&Ext.Function.defer(this.initLoad,100,this)},this);this.on("query",function(a,b){this.loadFromQuery(b)},this);this.on("resize",function(a,b,c){if(a=Ext.get(this.getVisId()))c=this.body,b=c.getHeight(),c=c.getWidth(),a.el.dom.setAttribute("width",
c),a.el.dom.setAttribute("height",b),this.getVisLayout().force("x",d3.forceX(c/2)).force("y",d3.forceY(b/2)),Ext.Function.defer(this.zoomToFit,100,this)},this);this.callParent(arguments)},initLoad:function(){this.initGraph();this.setNetworkMode(this.DEFAULT_MODE);if(this.getApiParam("centralize")){this.setNetworkMode(this.CENTRALIZED_MODE);var a=this.getApiParam("centralize");this.doCentralize(a)}else{var a=3,b=this.getApiParam("query");void 0!==b&&(a=Ext.isArray(b)?b.length:b.split(",").length);
this.getCorpus().getCorpusTerms({autoLoad:!1}).load({params:{limit:a,query:b,stopList:this.getApiParam("stopList")},callback:function(a,b,e){e&&this.loadFromCorpusTermRecords(a)},scope:this})}},resetGraph:function(){this.setNodeData([]);this.setLinkData([]);this.setNetworkMode(this.DEFAULT_MODE);this.refresh()},loadFromQuery:function(a){if(Ext.isArray(a)&&0==a.length)this.setApiParam("query",void 0),this.resetGraph();else{this.setApiParams({mode:"corpus",query:a});var b=this.getApiParams();(Ext.isString(a)?
[a]:a).forEach(function(a){this.getCorpus().getCorpusCollocates({autoLoad:!1}).load({params:Ext.apply(Ext.clone(b),{query:a}),callback:function(a,b,c){c&&this.loadFromCorpusCollocateRecords(a)},scope:this})},this)}},loadFromCorpusTermRecords:function(a){if(Ext.isArray(a)&&0<a.length){var b=[];a.forEach(function(a){b.push(a.getTerm())});this.loadFromQuery(b)}},loadFromCorpusCollocateRecords:function(a,b){if(Ext.isArray(a)){var c=this.getApiParam("limit"),d=this.getLayout().getRenderTarget(),e=d.getWidth()/
2,f=d.getHeight()/2,g={};this.getNodeData().forEach(function(a){g[a.id]=!0},this);var h=[],k=[];a.forEach(function(a,d){var n=a.getTerm(),q=a.getContextTerm(),r=a.getKeywordRawFreq(),p=a.getContextTermRawFreq(),s=r,u=p;this.getNetworkMode()===this.CENTRALIZED_MODE&&(s=0,u=Math.log(p));var A=void 0,A=void 0;0==d&&(void 0===b&&(b=this.idGet(n)),void 0!==g[b]?this.updateDataForNode(b,{title:n+" ("+r+")",type:"keyword",value:s}):(g[b]=!0,A={id:b,term:n,title:n+" ("+r+")",type:"keyword",value:s,start:c,
fixed:!1,x:e,y:f},h.push(A)));if(n!=q){n=this.idGet(q);void 0===g[n]&&(g[n]=!0,A={id:n,term:q,title:q+" ("+p+")",type:"context",value:u,start:0,fixed:!1,x:e,y:f},h.push(A));q=null;p=this.getLinkData();for(u=0;u<p.length;u++)if(r=p[u],r.source.id==b&&r.target.id==n||r.source.id==n&&r.target.id==b){q=r;break}p=a.getContextTermRawFreq();null===q&&k.push({source:b,target:n,value:p,id:b+"-"+n})}},this);this.setNodeData(this.getNodeData().concat(h));this.setLinkData(this.getLinkData().concat(k));this.refresh()}},
idGet:function(a){return a.replace(/\W/g,"_")},updateDataForNode:function(a,b){for(var c=this.getNodeData(),d=0;d<c.length;d++)if(c[d].id===a){Ext.apply(c[d],b);break}},removeNode:function(a,b){for(var c=this.getNodeData(),d=0;d<c.length;d++)if(c[d].id===a){c.splice(d,1);break}c=this.getLinkData();for(d=c.length-1;0<=d;d--)c[d].source.id!==a&&c[d].target.id!==a||c.splice(d,1);this.setApiParam("query",Ext.Array.remove(Ext.Array.from(this.getApiParam("query")),a));this.refresh()},doCentralize:function(a){this.setApiParam("centralize",
a);this.resetGraph();this.setNetworkMode(this.CENTRALIZED_MODE);a={id:this.idGet(a),term:a,title:a+" (1)",type:"keyword",value:1E3,start:0};this.setNodeData([a]);this.refresh();var b=this.getApiParam("limit");this.setApiParam("limit",150);this.fetchCollocatesForNode(a);this.setApiParam("limit",b)},applyNetworkMode:function(a){if(this.getVisLayout()){if(a===this.DEFAULT_MODE){var b=this.getGraphPhysics().defaultMode;this.getVisLayout().velocityDecay(b.damping).force("link",d3.forceLink().id(function(a){return a.id}).distance(b.springLength).strength(b.springStrength)).force("charge",
d3.forceManyBody().strength(b.nodeGravity)).force("collide",d3.forceCollide(function(a){return Math.sqrt(a.bbox.width*a.bbox.height)*b.collisionScale}))}else b=this.getGraphPhysics().centralizedMode,this.getVisLayout().velocityDecay(b.damping).force("link",d3.forceLink().id(function(a){return a.id}).distance(b.springLength).strength(b.springStrength)).force("charge",d3.forceManyBody().strength(function(a){return"keyword"===a.type?-1E4:0})).force("collide",d3.forceCollide(function(a){return"keyword"===
a.type?a.value:Math.sqrt(a.bbox.width*a.bbox.height)*b.collisionScale}));this.getVisLayout().force("x").strength(b.centralGravity);this.getVisLayout().force("y").strength(b.centralGravity)}return a},initGraph:function(){var a=this.getLayout().getRenderTarget();a.update("");var b=a.getWidth(),c=a.getHeight();this.setVisLayout(d3.forceSimulation().force("x",d3.forceX(b/2)).force("y",d3.forceY(c/2)).on("tick",function(){this.getLinks().attr("x1",function(a){return a.source.x}).attr("y1",function(a){return a.source.y}).attr("x2",
function(a){return a.target.x}).attr("y2",function(a){return a.target.y});this.getNodes().attr("transform",function(a){var b=a.x,c=a.y;if(this.getNetworkMode()===this.DEFAULT_MODE||"keyword"!==a.type)b-=.5*a.bbox.width,c-=.5*a.bbox.height;return"translate("+b+","+c+")"}.bind(this));!this.getDragging()&&.075>this.getVisLayout().alpha()&&this.getVisLayout().alpha(-1)}.bind(this)).on("end",function(){Ext.Function.defer(this.zoomToFit,100,this)}.bind(this)));var a=d3.select(a.dom).append("svg").attr("id",
this.getVisId()).attr("class","linksGraph").attr("width",b).attr("height",c),d=a.append("g"),b=d3.zoom().scaleExtent([.25,4]).on("zoom",function(){d.attr("transform",d3.event.transform)});this.setZoom(b);a.call(b);a.on("click",function(){this.getContextMenu().hide()}.bind(this));this.setLinks(d.append("g").attr("class","links").selectAll(".link"));this.setNodes(d.append("g").attr("class","nodes").selectAll(".node"));this.setVis(d)},resetGraph:function(){this.setNodeData([]);this.setLinkData([]);this.refresh()},
...
a.id).call(this.applyLinkStyle.bind(this),"highlight")},linkMouseOut:function(a){this.getVis().selectAll("line").call(this.applyLinkStyle.bind(this))},nodeMouseOver:function(a){this.setCurrentNode(a);this.getVis().selectAll("rect").call(this.applyNodeStyle.bind(this));this.getLinks().each(function(b){var c;b.source.id==a.id?c=b.target.id:b.target.id==a.id&&(c=b.source.id);void 0!==c&&(this.getVis().select("#"+c+" rect").call(this.applyNodeStyle.bind(this),"highlight"),this.getVis().select("#"+b.id).call(this.applyLinkStyle.bind(this),
"highlight"))}.bind(this));this.getVis().select("#"+a.id+" rect").style("stroke-width",3).call(this.applyNodeStyle.bind(this),"highlight")},nodeMouseOut:function(a){this.getContextMenu().isVisible()||this.setCurrentNode(void 0);this.getVis().selectAll("rect").style("stroke-width",1).call(this.applyNodeStyle.bind(this));this.getVis().selectAll("line").call(this.applyLinkStyle.bind(this))},fetchCollocatesForNode:function(a){var b=this.getApiParam("limit"),c=this.getApiParam("query"),c=Ext.Array.from(this.getApiParam("query"));
Ext.Array.include(c,a.term);console.warn(c);this.setApiParam("query",c);this.getCorpus().getCorpusCollocates({autoLoad:!1}).load({params:Ext.apply(this.getApiParams(),{query:a.term,start:a.start,limit:b}),callback:function(c,e,f){f&&(this.updateDataForNode(a.id,{start:a.start+b}),this.loadFromCorpusCollocateRecords(c,a.id))},scope:this})}});Ext.define("Voyant.panel.Contexts",{extend:"Ext.grid.Panel",mixins:["Voyant.panel.Panel"],requires:["Voyant.data.store.Contexts"],alias:"widget.contexts",isConsumptive:!0,statics:{i18n:{},api:{query:void 0,docId:void 0,docIndex:void 0,stopList:"auto",context:5,expand:50},glyph:"xf0ce@FontAwesome"},constructor:function(){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(){var a=this;Ext.apply(a,{title:this.localize("title"),emptyText:this.localize("emptyText"),
