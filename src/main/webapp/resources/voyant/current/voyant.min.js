...
initComponent:function(a){var b=this;b.on("beforequery",function(a){debugger;if(a.query){a.query=a.query.trim();var c=a.query.toLowerCase();this.setCurrentOriginalRawQueryPlan(a.query);if("@"!=a.query.charAt(0)){"^"==a.query.charAt(0)&&(a.query=a.query.substring(1),a.cancel=0==a.query.length);"*"==a.query.charAt(0)&&(a.query="."+a.query);if("*"==a.query.charAt(a.query.length-1)||"|"==a.query.charAt(a.query.length-1))a.query=a.query.substring(0,a.query.length-1),a.cancel=0==a.query.length;"."==a.query.charAt(0)&&
...
!0}b.on("afterrender",function(a){debugger;!1!==b.hasCorpusLoadedListener||b.getCorpus()||(c=b.findParentBy(function(a){return a.mixins["Voyant.panel.Panel"]}),null==c&&(c=b.up("window").panel),a=c.getApplication().getCorpus(),void 0!==a?b.doSetCorpus(a):(c.on("loadedCorpus",function(a,c){b.doSetCorpus(c)},b),b.hasCorpusLoadedListener=!0));b.triggers&&b.triggers.help&&Ext.tip.QuickTipManager.register({target:b.triggers.help.getEl(),text:b.getIsDocsMode()?b.localize("querySearchDocsModeTip"):b.localize("querySearchTip")});
b.triggers&&b.triggers.count&&Ext.tip.QuickTipManager.register({target:b.triggers.count.getEl(),text:b.localize("aggregateInDocumentsCount")})});b.on("beforedestroy",function(a){debugger;b.triggers&&b.triggers.help&&Ext.tip.QuickTipManager.unregister(b.triggers.help.getEl());b.triggers&&b.triggers.count&&Ext.tip.QuickTipManager.unregister(b.triggers.count.getEl())});b.callParent(arguments)},doSetCorpus:function(a){debugger;if(null!=a){this.setCorpus(a);if(void 0==this.getStopList())if(this.getApiParam)this.setStopList(this.getApiParam("stopList"));
