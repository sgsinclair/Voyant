/* This file created by JSCacher. Last modified: Thu Feb 22 10:10:50 EST 2018 */
...
api:{suppressTools:!1}},constructor:function(a){a=a||{};if(!(this.getApiParam&&"true"==this.getApiParam("suppressTools")||"header"in a&&!1===a.header)){var b=void 0,c=this.up("component");a.moreTools?(b=[],a.moreTools.forEach(function(a){a&&a!=this.xtype&&b.push(this.getMenuItemFromXtype(a))},this)):c&&c.getInitialConfig("moreTools")&&(b=[],c.getInitialConfig("moreTools").forEach(function(a){a&&a!=this.xtype&&b.push(this.getMenuItemFromXtype(a))},this));b&&this.getApplication().getMoreTools&&b.push({xtype:"menuseparator"});
if(this.getApplication().getMoreTools){var b=b||[],d=this.getApplication(),c=d.getMoreTools();c.forEach(function(a){var c=[];a.items.forEach(function(a){c.push(this.getMenuItemFromXtype(a))},this);b.push({text:d.localize(a.i18n),glyph:a.glyph,menu:{items:c}})},this)}var e={save:{glyph:"xf08e@FontAwesome",fn:this.exportToolClick,items:void 0},plus:b?{glyph:"xf17a@FontAwesome",items:b}:void 0,gear:this.showOptionsClick||this.getOptions?{glyph:"xf205@FontAwesome",fn:this.showOptionsClick?this.showOptionsClick:
function(a){a.isXType("voyanttabpanel")&&(a=a.getActiveTab());Ext.create("Ext.window.Window",{title:a.localize("optionsTitle"),modal:!0,panel:a,items:{xtype:"form",items:a.getOptions(),listeners:{afterrender:function(b){var c=a.getApiParams(b.getForm().getFields().collect("name"));b.getForm().setValues(c)}},buttons:[{text:a.localize("reset"),glyph:"xf0e2@FontAwesome",flex:1,panel:a,ui:"default-toolbar",handler:function(a){this.mixins&&this.mixins["Voyant.util.Api"]&&(this.mixins["Voyant.util.Api"].constructor.apply(this),
this.getCorpus&&this.getCorpus()&&this.fireEvent("loadedCorpus",this,this.getCorpus()));a.up("window").close()},scope:a},{xtype:"tbfill"},{text:a.localize("cancelTitle"),ui:"default-toolbar",glyph:"xf00d@FontAwesome",flex:1,handler:function(a){a.up("window").close()}},{text:a.localize("confirmTitle"),glyph:"xf00c@FontAwesome",flex:1,panel:a,handler:function(a){function b(a,c){d.setApiParam&&d.setApiParam(a,c);for(var e=d.getViewport().query("panel,chart"),g=0;g<e.length;g++)e[g].setApiParam&&e[g].setApiParam(a,
c);f=!0}var c=a.up("form").getValues();this.setApiParams(c);var d=this.getApplication(),e=d.getCorpus(),f=!1;void 0!=c.stopList&&void 0!=c.stopListGlobal&&c.stopListGlobal&&b("stopList",c.stopList);void 0!=c.palette&&b("palette",c.palette);f&&(e?d.dispatchEvent("loadedCorpus",this,e):d.dispatchEvent("apiParamsUpdated",this,c));e?this.fireEvent("loadedCorpus",this,e):this.fireEvent("apiParamsUpdated",this,c);a.up("window").close()},scope:a}]},bodyPadding:5}).show()}}:void 0,help:{glyph:"xf128@FontAwesome",
fn:this.helpToolClick}},c=[];if(a.includeTools)for(var f in a.includeTools)"object"==typeof a.includeTools[f]&&c.push(a.includeTools[f]);for(f in e)a.includeTools&&!a.includeTools[f]||!e[f]||c.push({type:f,tooltip:this.localize(f+"Tip"),callback:e[f].fn,xtype:"toolmenu",glyph:e[f].glyph,items:e[f].items});Ext.apply(this,{tools:c});this.on("afterrender",function(){var a=this.getHeader();if(a&&"Desktop"==Ext.os.deviceType&&!this.isXType("corpuscreator")&&!this.isXType("notebook")){var b=a.getEl();b.on("mouseover",
function(){this.getHeader().getTools().forEach(function(a){a.show()})},this);b.on("mouseout",function(){this.getHeader().getTools().forEach(function(a){var b=a.config.type||a.type;b&&"help"!=b&&-1==b.indexOf("collapse")&&a.hide()})},this);a.getTools().forEach(function(a,b){"help"!=a.config.type&&a.hide()})}},this)}},getMenuItemFromXtype:function(a){var b=this.getApplication().getToolConfigFromToolXtype(a);b&&b.tooltip&&delete b.tooltip;return Ext.apply(Ext.clone(b),{xtype:"menuitem",text:b.title,
textAlign:"left",handler:function(){this.replacePanel(b.xtype)},scope:this})},maximizeToolClick:function(a){var b=Ext.getClass(a).getName().split(".");url=a.getBaseUrl()+"tool/"+b[b.length-1]+"/";params=a.getModifiedApiParams();!params.corpus&&a.getCorpus&&a.getCorpus()&&(params.corpus=a.getCorpus().getId());params&&(url+="?"+Ext.Object.toQueryString(params));a.openUrl(url)},exportToolClick:function(a){a.isXType("voyanttabpanel")&&(a=a.getActiveTab());var b="beta.voyant-tools.org"==window.location.hostname?
[{html:"\x3cp class\x3d'keyword' style\x3d'text-align: center; font-weight: bold; padding: 4px;'\x3ePlease note that this is the beta server and you should not count on corpora persisting (for bookmarks, embedding, etc.)."}]:[];b.push({xtype:"radio",name:"export",inputValue:"url",boxLabel:"\x3ca href\x3d'"+a.getExportUrl.call(a)+"' target\x3d'_blank'\x3e"+a.localize("exportViewUrl")+"\x3c/a\x3e",checked:!0,listeners:{afterrender:function(){this.boxLabelEl.on("click",function(){this.up("window").close()},
this)}}},{xtype:"fieldset",collapsible:!0,collapsed:!0,title:a.localize("exportViewFieldset"),items:[{xtype:"radio",name:"export",inputValue:"embed",boxLabel:a.localize("exportViewHtmlEmbed")},{xtype:"radio",name:"export",inputValue:"biblio",boxLabel:a.localize("exportViewBiblio")}]});if(a.isXType("grid")){var c=[{xtype:"radio",name:"export",inputValue:"gridCurrentHtml",boxLabel:a.localize("exportGridCurrentHtml")},{xtype:"radio",name:"export",inputValue:"gridCurrentTsv",boxLabel:a.localize("exportGridCurrentTsv")}];
a.getExportGridAll&&0==a.getExportGridAll()||c.push({xtype:"radio",name:"export",inputValue:"gridAllJson",boxLabel:a.localize("exportGridAllJson")},{xtype:"radio",name:"export",inputValue:"gridAllTsv",boxLabel:a.localize("exportGridAllTsv")});b.push({xtype:"fieldset",collapsible:!0,collapsed:!0,title:a.localize("exportGridCurrent"),items:c})}a.getExportVisualization&&!a.getExportVisualization()||0!=a.isXType("grid")||!(a.down("chart")||a.getTargetEl().dom.querySelector("canvas")||a.getTargetEl().dom.querySelector("svg"))||
(c=[{xtype:"radio",name:"export",inputValue:"png",boxLabel:a.localize("exportPng")}],a.getTargetEl().dom.querySelector("svg")&&c.push({xtype:"radio",name:"export",inputValue:"svg",boxLabel:a.localize("exportSvg")}),b.push({xtype:"fieldset",collapsible:!0,collapsed:!0,title:a.localize("exportVizTitle"),items:c}));Ext.create("Ext.window.Window",{title:a.localize("exportTitle"),modal:!0,items:{xtype:"form",items:b,buttons:[{text:a.localize("exportTitle"),glyph:"xf08e@FontAwesome",flex:1,panel:a,handler:function(b){var c=
b.up("form"),f="export"+Ext.String.capitalize(c.getValues()["export"]);Ext.isFunction(a[f])?a[f].call(a,a,c):Ext.Msg.show({title:a.localize("exportError"),message:a.localize("exportNoFunction"),buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR});b.up("window").close()},scope:a},{text:a.localize("cancelTitle"),glyph:"xf00d@FontAwesome",flex:1,handler:function(a){a.up("window").close()}}]},bodyPadding:5}).show()},exportSvg:function(a){if(a=this.getTargetEl().dom.querySelector("svg"))a=d3.select(a).attr("version",
1.1).attr("xmlns","http://www.w3.org/2000/svg").node().parentNode.innerHTML,Ext.Msg.show({title:this.localize("exportSvgTitle"),message:'\x3cimg src\x3d"data:image/svg+xml;base64,'+btoa(unescape(encodeURIComponent(a)))+'" style\x3d"float: right; max-width: 200px; max-height: 200px; border: thin dotted #ccc;"/\x3e'+this.localize("exportSvgMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:a})},exportPngData:function(a){Ext.Msg.show({title:this.localize("exportPngTitle"),message:'\x3cimg src\x3d"'+
a+'" style\x3d"float: right; max-width: 200px; max-height: 200px; border: thin dotted #ccc;"/\x3e'+this.localize("exportPngMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:'\x3cimg src\x3d"'+a+'" /\x3e'})},exportPng:function(){var a,b=this.down("draw");if(b)return this.exportPngData(b.getImage().data);if(this.down("chart"))return this.exportPngData(this.down("chart").getImage().data);var b=this.getTargetEl().dom,c=b.querySelector("canvas");if(c)return this.exportPngData(c.toDataURL("image/png"));
var d=b.querySelector("svg");if(d){d=d3.select(d).attr("version",1.1).attr("xmlns","http://www.w3.org/2000/svg").node().parentNode.innerHTML;a="data:image/svg+xml;base64,"+btoa(unescape(encodeURIComponent(d)));var c=Ext.DomHelper.createDom({tag:"canvas",width:b.offsetWidth,height:b.offsetHeight}),e=c.getContext("2d"),f=new Image;f.src=a;f.panel=this;f.onload=function(){e.drawImage(f,0,0);a=c.toDataURL("image/png");return this.panel.exportPngData.call(this.panel,a)}}},exportUrl:function(){this.openUrl(this.getExportUrl())},
exportEmbed:function(){var a=0==this.isXType("voyantheader");console.warn(this.xtype,a);Ext.Msg.show({title:this.localize("exportViewEmbedTitle"),message:this.localize("exportViewEmbedMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:"\x3c!--\tExported from Voyant Tools (voyant-tools.org).\nThe iframe src attribute below uses a relative protocol to better function with both\nhttp and https sites, but if you're embedding this into a local web page (file protocol)\nyou should add an explicit protocol (https if you're using voyant-tools.org, otherwise\nit depends on this server.\nFeel free to change the height and width values or other styling below: --\x3e\n\x3ciframe style\x3d'width: "+
...
0,c.gotoCurrent()));null===c.currentIndex&&c.getSelectionModel().deselectAll();a.focus()},privates:{gotoCurrent:function(){var a=this.matches[this.currentIndex];this.getNavigationModel().setPosition(a.record,a.column);this.getSelectionModel().select(a.record)}}});Ext.define("Voyant.widget.VoyantTableTransform",{extend:"Ext.panel.Panel",mixins:["Voyant.util.Localization","Voyant.util.Api","Voyant.notebook.util.Embed"],alias:"widget.voyanttabletransform",statics:{i18n:{},api:{tableHtml:void 0,tableJson:void 0,width:void 0,api:void 0}},html:"",config:{hiddenColumns:void 0},constructor:function(a){a=a||{};this.callParent(arguments)},initComponent:function(a){var b=this;a=a||{};b.mixins["Voyant.util.Api"].constructor.apply(this,arguments);this.config.api&&this.config.api.tableJson&&
...
animations:"Animations",animate:"Animate",add:"Add Filter",allNCitiesShown:"All {0} available cities shown.",citiesMaxCount:"maximum count",citiesMinPopulation:"minimum population",citiesMinFreq:"minimum occurrences",connectionsMaxCount:"maximum count",connectionsMinFreq:"minimum occurrences",millisPerAnimation:"milliseconds per animation"},api:{stopList:"auto",hide:[],author:void 0,title:void 0,keyword:void 0,pubDate:void 0,citiesMaxCount:500,minPopulation:1E4,citiesMinFreq:1,connectionsMaxCount:2500,
connectionsMinFreq:1,millisPerAnimation:2E3},glyph:"xf124@FontAwesome"},config:{map:void 0,overlay:void 0,contentEl:void 0,isOpenLayersLoaded:!1,isArcLoaded:!1,animationDelay:25,filterWidgets:new Ext.util.MixedCollection},html:'\x3cdiv class\x3d"map"\x3e\x3c/div\x3e\x3cdiv class\x3d"ticker"\x3e\x3c/div\x3e',cls:"dreamscape",constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);Ext.Loader.loadScript({url:this.getBaseUrl()+"resources/openlayers/ol.js",
onLoad:function(){void 0===ol.Map.prototype.getLayer&&(ol.Map.prototype.getLayer=function(a){var c=void 0;this.getLayers().forEach(function(d){a===d.get("id")&&(c=d)});return c});this.setIsOpenLayersLoaded(!0)},scope:this});Ext.Loader.loadScript({url:this.getBaseUrl()+"resources/dreamscape/arc.js",onLoad:function(){this.setIsArcLoaded(!0)},scope:this})},initComponent:function(){this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);var a=this.getApiParam("hide");Ext.isString(a)&&(a=a.split(","),
this.setApiParam("hide"));Ext.apply(this,{title:this.localize("title"),bodyBorder:!0,dockedItems:[{dock:"bottom",xtype:"toolbar",itemId:"bottomToolbar",overflowHandler:"scroller",items:[{text:this.localize("show"),tooltip:this.localize("showTip"),menu:{defaults:{xtype:"menucheckitem",checkHandler:function(a,c){var d=this.getMap(),e=a.getItemId();this.getFilterWidgets().each(function(a){d.getLayer(a.getId()+"-"+e).setVisible(c)});var f=Ext.Array.from(this.getApiParam("hide"));c?f=Ext.Array.remove(f,
e):(f.push(e),f=Ext.Array.unique(f));this.setApiParam("hide",f);a.getMenu().setDisabled(0==c)},scope:this,checked:!0},items:[{text:this.localize("cities"),checked:0==Ext.Array.contains(a,"cities"),itemId:"cities",menu:{defaults:{labelAlign:"right",labelWidth:140},items:[{xtype:"numberfield",fieldLabel:this.localize("citiesMaxCount"),minValue:1,value:parseInt(this.getApiParam("citiesMaxCount")),listeners:{change:function(a,c,d){this.getFilterWidgets().each(function(e){this.setApiParam("citiesMaxCount",
...
this.getIsArcLoaded()){var a=this.body.down(".map").setId(Ext.id()),b=this.body.down(".ticker");b.setTop(this.getTargetEl().getHeight()-b.getHeight()-4);var c=this,d=new ol.Map({layers:[new ol.layer.Tile({preload:Infinity,source:new ol.source.Stamen({layer:"watercolor"})}),new ol.layer.Tile({preload:Infinity,source:new ol.source.Stamen({cacheize:2048,layer:"toner-hybrid"})})],target:a.getId(),loadTilesWhileInteracting:!0,view:new ol.View({center:[15E5,6E6],maxResolution:4.007501668557849E7/c.body.dom.offsetWidth,
zoom:0})});d.on("singleclick",function(a){(a=d.getFeaturesAtPixel(a.pixel))&&a.forEach(function(a){"Circle"===a.getGeometry().getType()&&a.get("selected")&&c.dispatchEvent("termsClicked",c,[a.get("forms").join("|")])},this)});var e=new ol.layer.Vector({map:d,source:new ol.source.Vector({wrapX:!1,useSpatialIndex:!1}),zIndex:10,selected:!0,style:function(a){return"Circle"===a.getGeometry().getType()?c.cityStyleFunction(a,d.getView().getResolution()):c.travelStyleFunction(a,d.getView().getResolution())},
updateWhileAnimating:!0,updateWhileInteracting:!0});d.on("pointermove",function(a){e.getSource().clear();var b=a.coordinate;if(a=d.getFeaturesAtPixel(a.pixel)){for(var h=0;a[h].get("selected")&&(h++,h!==a.length););if(h<a.length){var k=a[h];a={font:"12px Calibri,sans-serif",textAlign:"center",offsetY:-15,fill:new ol.style.Fill({color:[0,0,0,1]}),stroke:new ol.style.Stroke({color:[255,255,255,.5],width:4})};a.text=k.get("text");a=new ol.style.Style({text:new ol.style.Text(a),zIndex:1});h=new ol.Feature({text:k.get("text"),
geometry:k.getGeometry(),forms:k.get("forms"),selected:!0,coordinates:k.get("coordinates"),width:k.get("width"),visible:k.get("visible"),color:k.get("color")});e.getSource().addFeature(h);h=k.getGeometry();b=h.getClosestPoint(b);b=new ol.Feature({geometry:new ol.geom.Point(b),selected:!0});b.setStyle(a);e.getSource().addFeature(b);"Circle"===h.getType()&&c.getMap().getLayers().forEach(function(a){var b=a.get("id");b&&-1!==b.indexOf("connections")&&(connections=a.getSource().getFeatures(),connections.forEach(function(a){a.get("target")!==
k.get("cityId")&&a.get("source")!==k.get("cityId")||e.getSource().addFeature(new ol.Feature({geometry:a.getGeometry(),selected:!0,coordinates:a.get("coordinates"),width:a.get("width"),visible:a.get("visible"),color:a.get("color")}))}))})}}});this.setMap(d);this.getDockedComponent("bottomToolbar").getComponent("addFilter").click()}else Ext.defer(this.tryInit,500,this)},travelStyleFunction:function(a,b){var c=new ol.style.Stroke({color:a.get("color"),width:a.get("width")}),d=[new ol.style.Style({stroke:c})],
e=a.getGeometry(),f=e.getLastCoordinate(),e=e.getCoordinateAt(.9),e=Math.atan2(f[1]-e[1],f[0]-e[0]),g=new ol.geom.LineString([f,[f[0]-10*b,f[1]+10*b]]);g.rotate(e,f);var h=new ol.geom.LineString([f,[f[0]-10*b,f[1]-10*b]]);h.rotate(e,f);d.push(new ol.style.Style({geometry:g,stroke:c}));d.push(new ol.style.Style({geometry:h,stroke:c}));return d},cityStyleFunction:function(a,b){return a.get("visible")?new ol.style.Style({stroke:new ol.style.Stroke({color:a.get("color"),width:a.get("width")})}):!1},animationStyleFunction:function(a){return[new ol.style.Style({stroke:new ol.style.Stroke({color:a.get("color"),
width:5})}),new ol.style.Style({geometry:new ol.geom.Circle(a.getGeometry().getFirstCoordinate()),stroke:new ol.style.Stroke({color:"white",width:10})}),new ol.style.Style({geometry:new ol.geom.Circle(a.getGeometry().getLastCoordinate()),stroke:new ol.style.Stroke({color:"white",width:10})})]},showTermInCorpus:function(a,b,c){a=Ext.create("Voyant.data.model.Context",{docIndex:a,position:b,term:c});this.getApplication().dispatchEvent("termLocationClicked",this,[a])},filterUpdate:function(a){a.clearAnimation();
var b=this.getMap(),c=a.getColor(),d=parseInt(this.getApiParam("citiesMaxCount")),e=0;a.getGeonames().eachCity(function(a){a.rawFreq>e&&(e=a.rawFreq)},this,d);var f=b.getLayer(a.getId()+"-cities").getSource(),g=Ext.Array.from(this.getApiParam("hide"));f.clear();var h=parseInt(this.getApiParam("minPopulation")),k=parseInt(this.getApiParam("citiesMinFreq")),l={};a.getGeonames().eachCity(function(a){if((!h||a.population>=h)&&(!k||a.rawFreq>=k)){l[a.id]=!0;var b=[parseFloat(a.longitude),parseFloat(a.latitude)];
a=new ol.Feature({geometry:(new ol.geom.Circle(b)).transform(ol.proj.get("EPSG:4326"),ol.proj.get("EPSG:3857")),text:a.label+" ("+a.rawFreq+")",description:a.label,color:c,selected:!1,width:3+20*Math.sqrt(a.rawFreq/e),visible:!0,coordinates:b,forms:a.forms,cityId:a.id});f.addFeature(a)}},this,d);0<f.getFeatures().length&&b.getView().fit(f.getExtent());b.getLayer(a.getId()+"-cities").setVisible(0==Ext.Array.contains(g,"cities"));f=b.getLayer(a.getId()+"-connections").getSource();f.clear();0==Object.keys(l).length&&
this.toastInfo("No cities available for current criteria.");e=0;a.getGeonames().eachConnection(function(a){a.rawFreq>e&&(e=a.rawFreq)},this);var m=0,n=parseInt(this.getApiParam("connectionsMaxCount")),q=parseInt(this.getApiParam("connectionsMinFreq"));a.getGeonames().eachConnection(function(a){if((!q||a.rawFreq>=q)&&(!n||m<n)&&a.source.id in l&&a.target.id in l&&(!h||a.source.population>=h&&a.target.population>=h)){var b=(new arc.GreatCircle({x:a.source.longitude,y:a.source.latitude},{x:a.target.longitude,
y:a.target.latitude})).Arc(100,{offset:100}),d=a.source.label+" -\x3e "+a.target.label+" ("+a.rawFreq+")";b.geometries.forEach(function(b){b=new ol.geom.LineString(b.coords);b.transform(ol.proj.get("EPSG:4326"),ol.proj.get("EPSG:3857"));b=new ol.Feature({geometry:b,text:d,color:c,width:3+10*Math.sqrt(a.rawFreq/e),source:a.source.id,target:a.target.id});f.addFeature(b)},this);m++}},this);b.getLayer(a.getId()+"-connections").setVisible(0==Ext.Array.contains(g,"connections"))}});
Ext.define("Voyant.widget.GeonamesFilter",{extend:"Ext.Button",xtype:"geonamesfilter",mixins:["Voyant.util.Localization"],statics:{i18n:{filter:"Filter",authorLabel:"authors",titleLabel:"titles",loading:"Loading geographical information\u2026",disclaimer:"This is an experimental tool and the accuracy of the data is variable (\x3ca href\x3d'{url}' target\x3d'_blank'\x3esee help\x3c/a\x3e).",noDataForField:"No data seems to be available for this field so it will be disabled.",close:"Close"}},config:{corpus:void 0,
geonames:void 0,color:"#f00",timeout:void 0,currentConnectionOccurrence:void 0,animationLayer:void 0,millisPerAnimation:2E3,stepByStepMode:!1,keepAnimationInFrame:!0},constructor:function(a){a=a||{};var b=new Voyant.data.util.Geonames({corpus:a.corpus});this.setGeonames(b);var c=this;Ext.applyIf(a,{tooltip:this.localize("filterTip"),style:"background-color: white; color: "+a.color,glyph:"xf0b0@FontAwesome",menu:{defaults:{xtype:"querysearchfield",labelWidth:60,labelAlign:"right",width:250,maxWidth:250,
listeners:{change:function(a,b){c.loadGeonames()},load:function(a,b,f,g){0==b.length&&""==g.getParams().query&&(Ext.Msg.show({buttonText:{ok:c.localize("close")},icon:Ext.MessageBox.INFO,message:c.localize("noDataForField"),buttons:Ext.Msg.OK}),this.disable())}}},items:[{fieldLabel:this.localize("authorLabel"),tokenType:"author",itemId:"author"},{fieldLabel:this.localize("titleLabel"),itemId:"title",tokenType:"title"},{fieldLabel:this.localize("keywordLabel"),hidden:!0},{xtype:"multislider",fieldLabel:this.localize("pubDateLabel"),
itemId:"pubDate",hidden:!0},{xtype:"button",text:"remove",scope:this,handler:function(a){this.fireEvent("removeFilterWidget",this);a.ownerCt.ownerCmp.destroy()}},{xtype:"button",text:"Play",scope:this,handler:function(a){this.animate()}},{xtype:"button",text:"Stop/Reset",scope:this,handler:function(a){this.getAnimationLayer().getSource().clear();this.clearAnimation();this.setCurrentConnectionOccurrence(this.getGeonames().getConnectionOccurrence(0))}},{xtype:"numberfield",fieldLabel:"Connection nb",
minValue:0,value:0,listeners:{change:function(a,b,c){this.setCurrentConnectionOccurrence(this.getGeonames().getConnectionOccurrence(b));this.animate()},scope:this}},{xtype:"button",text:c.getStepByStepMode()?"Continuous Mode":"Step-by-Step Mode",handler:function(a){c.setStepByStepMode(!c.getStepByStepMode());c.animate();this.setText(c.getStepByStepMode()?"Continuous Mode":"Step-by-Step Mode")}},{xtype:"menucheckitem",checked:!0,checkHandler:function(a,b){c.setKeepAnimationInFrame(b)},text:"Keep animation in frame"}]}});
this.callParent([a]);this.on("afterrender",function(a){a.getTargetEl().down(".x-btn-glyph").setStyle("color",this.getColor());var b=a.up("panel");b.mask(a.localize("loading"));a.loadGeonames().then(function(c){b.unmask();if(1==b.getFilterWidgets().getCount()){var g=c.getCitiesCount(),h=c.getTotalCitiesCount(),k=c.getConnectionsCount();c=c.getTotalConnectionsCount();message=a.localize(g==h&&k==c?"loadedAll":"loadedSome")+"\x3cbr\x3e\x3cbr\x3e"+a.localize("disclaimer");b.toastInfo({closable:!0,maxWidth:"90%",
html:(new Ext.Template(a.localize("disclaimer"))).apply({currentCitiesCount:g,totalCitiesCount:h,currentConnectionsCount:k,totalConnectionsCount:c,url:b.getBaseUrl()+"docs/#!/guide/dreamscape"})})}})},this)},loadGeonames:function(a){var b=this;a=a||{};var c=[];this.query("querysearchfield").forEach(function(a){var b=a.getItemId();a.getValue().forEach(function(a){c.push(b+":"+a)})});0<c.length&&!("query"in a)&&(a.query=c);var d=this.up("panel");d&&d.getApiParams&&Ext.applyIf(a,d.getApiParams(["minPopulation",
"connectionsMaxCount","connectionsMinFreq"]));this.mask("\u2026");var e=this.getGeonames();return e.load(a).then(function(){b.unmask();b.fireEvent("filterUpdate",b,e);return e})},clearAnimation:function(){this.getTimeout()&&clearTimeout(this.getTimeout())},animate:function(){this.clearAnimation();var a=this.getCurrentConnectionOccurrence();if(a){var b=this.getAnimationLayer();b||(b=this.up("panel").getMap().getLayer(this.getId()+"-animation"),this.setAnimationLayer(b));if(b){var c=b.getSource().getFeatures();
if(0==c.length){if(c=this.up("panel")){for(var d=c.getMap().getLayer(this.getId()+"-connections").getSource().getFeatures(),e=!1,f=0,g=d.length;f<g;f++)if(a.source.id==d[f].get("source")&&a.target.id==d[f].get("target")){e=!0;break}if(e){var g=(new arc.GreatCircle({x:a.source.longitude,y:a.source.latitude},{x:a.target.longitude,y:a.target.latitude})).Arc(100,{offset:100}),h=a.source.label+" -\x3e "+a.target.label;g.geometries.forEach(function(a){var c=new ol.geom.LineString([]);c.transform(ol.proj.get("EPSG:4326"),
ol.proj.get("EPSG:3857"));a=new ol.Feature({geometry:c,allcoords:a.coords,text:h,color:this.getColor(),width:5,start:(new Date).getTime()});b.getSource().addFeature(a)},this);c.body.down(".ticker");c.body.down(".ticker").setHtml(a.source.left+" \x3cspan class\x3d'keyword'\x3e"+a.source.middle+"\x3c/span\x3e "+a.source.right+" \u2026 "+a.target.left+" \x3cspan class\x3d'keyword'\x3e"+a.target.middle+"\x3c/span\x3e "+a.target.right);return this.setTimeout(setTimeout(this.animate.bind(this),1))}if(this.getGeonames())return a=
this.getGeonames().getConnectionOccurrence(a.index+1),this.setCurrentConnectionOccurrence(a),b.getSource().clear(),this.setTimeout(setTimeout(this.animate.bind(this),1))}}else if(0<c.length){this.getKeepAnimationInFrame()&&(g=this.up("panel").getMap(),d=g.getView().calculateExtent(g.getSize()),ol.extent.containsExtent(d,c[0].getGeometry().getExtent())||g.getView().setZoom(g.getView().getZoom()-1));g=c[0].getGeometry().getCoordinates();d=c[0].get("allcoords");if(g.length<d.length)return g=((new Date).getTime()-
c[0].get("start"))*d.length/this.getMillisPerAnimation(),line=new ol.geom.LineString(d.slice(0,g)),line.transform(ol.proj.get("EPSG:4326"),ol.proj.get("EPSG:3857")),c[0].set("geometry",line),this.setTimeout(setTimeout(this.animate.bind(this),25));a=this.getGeonames().getConnectionOccurrence(a.index+1);this.setCurrentConnectionOccurrence(a);b.getSource().clear();if(!this.getStepByStepMode())return this.setTimeout(setTimeout(this.animate.bind(this),1))}}}else if(this.getGeonames()&&(a=this.getGeonames().getConnectionOccurrence(0)))return this.setCurrentConnectionOccurrence(a),
