...
direction:"desc"}},this);b.sort(function(a,b){for(var f=0,g=c.length;f<g;f++){var h=c[f].index;if(a[h]!=b[h])return"asc"==c[f].direction?a[h]>b[h]?1:-1:a[h]>b[h]?-1:1}});this.reMapRows();return this},loadCorrespondenceAnalysis:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments);a=a||{};var b=Voyant.application.getDeferred(this);Ext.apply(a,{columnHeaders:!0,rowHeaders:!0,tool:"corpus.CA",analysisInput:table.toTsv(),inputFormat:"tsv"});var c=Ext.create("Voyant.data.store.CAAnalysis",
{noCorpus:!0});c.load({params:a,callback:function(a,e,f){f?b.resolve(c,a):b.reject(e.error.response)}});return b.promise},embed:function(a,b){!b&&Ext.isObject(a)&&(b=a,a=this.embeddable[0]);b=b||{};var c=Ext.Array.from(b.headers||this.getHeaders()).map(function(a){return this.getColumnHeader(a)},this),c={rowkey:this.getRowKey(),config:b,headers:c};if("headers"in b){var d=Ext.Array.from(b.headers).map(function(a){return this.getColumnIndex(a)},this),e=[];this.getRows().forEach(function(a){e.push(d.map(function(b){return a[b]}))});
Ext.apply(c,{rows:e})}else Ext.apply(c,{rows:this.getRows()});Ext.apply(b,{tableJson:JSON.stringify(c)});delete b.axes;delete b.series;embed.call(this,a,b)},toTsv:function(a){var b=this.getHeaders().join("\t");this.getRows().forEach(function(c,d){a&&Ext.isNumber(a)&&d>a||(b+="\n"+c.map(function(a){return Ext.isString(a)?a.replace(/(\n|\t)/g,""):a}).join("\t"))});return b},getString:function(a){a=a||{};var b="\x3ctable class\x3d'voyant-table' style\x3d'"+(a.width?" width: "+a.width:"")+"' id\x3d'"+
...
300,scrollable:!0,fieldDefaults:{labelAlign:"right",labelWidth:110,width:350},items:[{xtype:"combo",fieldLabel:a.localize("inputFormat"),labelWidth:90,name:"inputFormat",queryMode:"local",store:[["",a.localize("inputFormatAuto")],["dtoc","DToC: Dynamic Table of Contexts"],["TEI","TEI: Text Encoding Initative"],["TEI","TEI Corpus"],["RSS","Really Simple Syndication: RSS"]],value:"",listeners:{afterrender:{fn:function(a){-1<window.location.pathname.indexOf("/dtoc/")&&a.setValue("dtoc")},scope:a}}},
{xtype:"container",html:"\x3cp\x3e\x3ci\x3e"+(new Ext.Template(a.localize("advancedOptionsText"))).applyTemplate([a.getBaseUrl()+"docs/#!/guide/corpuscreator-section-xml"])+"\x3c/i\x3e\x3c/p\x3e",width:375},{xtype:"fieldset",title:"\x3ca href\x3d'"+a.getBaseUrl()+"docs/#!/guide/corpuscreator-section-titles' target\x3d'voyantdocs'\x3e"+a.localize("corpusOptions")+"\x3c/a\x3e",collapsible:!0,collapsed:!0,defaultType:"textfield",items:[{xtype:"container",html:"\x3cp\x3e\x3ci\x3e\x3c/i\x3e\x3c/p\x3e",
width:375},{fieldLabel:a.localize("corpusTitle"),name:"title"},{fieldLabel:a.localize("corpusSubTitle"),name:"subTitle"}]},{xtype:"fieldset",title:"\x3ca href\x3d'"+a.getBaseUrl()+"docs/#!/guide/corpuscreator-section-text' target\x3d'voyantdocs'\x3e"+a.localize("textOptions")+"\x3c/a\x3e",collapsible:!0,collapsed:!0,defaultType:"textfield",items:[{xtype:"container",html:"\x3cp\x3e\x3ci\x3e"+a.localize("textOptionsText")+"\x3c/i\x3e\x3c/p\x3e",width:375},{fieldLabel:a.localize("inputRemoveUntil"),
name:"inputRemoveUntil"},{fieldLabel:a.localize("inputRemoveUntilAfter"),name:"inputRemoveUntilAfter"},{fieldLabel:a.localize("inputRemoveFrom"),name:"inputRemoveFrom"},{fieldLabel:a.localize("inputRemoveFromAfter"),name:"inputRemoveFromAfter"}]},{xtype:"fieldset",title:"\x3ca href\x3d'"+a.getBaseUrl()+"docs/#!/guide/corpuscreator-section-xml' target\x3d'voyantdocs'\x3e"+a.localize("xmlOptions")+"\x3c/a\x3e",collapsible:!0,collapsed:!0,defaultType:"textfield",items:[{xtype:"container",html:"\x3cp\x3e\x3ci\x3e"+
a.localize("xmlOptionsText")+"\x3c/i\x3e\x3c/p\x3e",width:375},{fieldLabel:a.localize("xpathContent"),name:"xmlContentXpath"},{fieldLabel:a.localize("xpathTitle"),name:"xmlTitleXpath"},{fieldLabel:a.localize("xpathAuthor"),name:"xmlAuthorXpath"},{fieldLabel:a.localize("xpathDocuments"),name:"xmlDocumentsXpath"},{fieldLabel:a.localize("xpathGroupBy"),name:"xmlGroupByXpath"}]},{xtype:"fieldset",title:"\x3ca href\x3d'"+a.getBaseUrl()+"docs/#!/guide/corpuscreator-section-tables' target\x3d'voyantdocs'\x3e"+
...
documentTermsClicked:function(a,b){var e=[];b.forEach(function(a){a.getTerm()&&e.push(a.getTerm())});this.loadQueryTerms(e)},documentSelected:function(a,b){var e=this.getTokensStore().getCorpus().getDocument(b);this.setApiParams({skipToDocId:e.getId(),start:0});this.load(!0)},documentsClicked:function(a,b,e){0<b.length&&(this.setApiParams({skipToDocId:b[0].getId(),start:0}),this.load(!0))},termLocationClicked:function(a,b){if(void 0!==b[0]){var e=b[0],f=e.get("docIndex"),g=e.get("position"),h=g-this.getApiParam("limit")/
2,k=this.getCorpus().getDocument(f);this.setApiParams({skipToDocId:k.getId(),start:0>h?0:h});this.load(!0,{callback:function(){var a=this.body.dom.querySelector("#_"+f+"_"+g);a&&a.scrollIntoView();this.highlightKeywords(e.get("term"),!1)},scope:this})}},documentIndexTermsClicked:function(a,b){if(void 0!==b[0]){var e=Ext.create("Voyant.data.model.Token",b[0]);this.fireEvent("termLocationClicked",this,[e])}},scope:this}});this.callParent(arguments)},loadQueryTerms:function(a){a&&0<a.length&&this.getDocumentTermsStore().load({params:{query:a}})},
...
{type:"customScatter",xField:"x",yField:"y",store:g,label:{font:"14px Helvetica",field:"term",display:"over",color:this.getDefaultDocColor(!0)},tooltip:{trackMouse:!0,style:"background: #fff",renderer:function(a,c,d){a.setHtml(b.docFreqTipTemplate.apply([c.get("title"),c.get("rawFreq")]))}},marker:{type:"diamond"},highlight:{fillStyle:"yellow",strokeStyle:"black"},renderer:function(a,c,e,f){a=e.store.getAt(f);null!==a&&(e=a.get("cluster"),e=-1===e||"docSim"!==b.getApiParam("analysis")?b.getDefaultDocColor():
b.getApplication().getColor(e),f=.65,3===d&&a.get("z")&&(f=b.interpolate(a.get("z"),q,n,0,1)),c.fillStyle="rgba("+e.join(",")+","+f+")",c.strokeStyle="rgba("+e.join(",")+",1)",c.radius=5)},scope:this}],listeners:{itemclick:function(a,b,c){a=b.record.data;"doc"===a.category?(a=this.getCorpus().getDocument(a.docIndex),this.getApplication().dispatchEvent("documentsClicked",this,[a])):"term"===a.category&&(a=Ext.create("Voyant.data.model.CorpusTerm",a),this.getApplication().dispatchEvent("corpusTermsClicked",
this,[a]))},render:function(a){a.body.on("contextmenu",function(a,b){a.preventDefault();var c=a.getXY(),d=Ext.fly(b).getXY(),e=c[0]-d[0],d=c[1]-d[1],f=this.down("#chart").getItemForPoint(e,d);null!=f&&"term"===f.record.get("category")&&(e=this.down("#chart").getSeries(),e[0].disableToolTips(),e[1].disableToolTips(),d=f.record.get("term"),e=(new Ext.Template(this.localize("removeTerm"))).apply([d]),this.getChartMenu().queryById("remove").setText(e),e=(new Ext.Template(this.localize("nearbyTerm"))).apply([d]),
d=this.getChartMenu().queryById("nearby"),d.setText(e),d.setDisabled("tsne"===this.getApiParam("analysis")),this.getChartMenu().on("click",function(a,b){if(void 0!==b){var c=f.record.get("term");"nearby"===b.getItemId()?this.getNearbyForTerm(c):this.removeTerm(c)}},this,{single:!0}),this.getChartMenu().showAt(c))},this)},scope:this}};a=Ext.create("Ext.chart.CartesianChart",a);this.queryById("chartParent").insert(0,a);this.queryById("chartParent").unmask();this.doLabels();null!==this.getNewTerm()&&
(this.selectTerm(this.getNewTerm()[0]),this.setNewTerm(null))},getDefaultDocColor:function(a){return this.getApplication().getColor(6,a)},doLabels:function(){var a=this.queryById("chart"),b=a.getSeries(),a=a.getSurface("chart").getItems()[0],c=this.getApiParam("label");-1<c.indexOf("summary")?a.show():a.hide();-1<c.indexOf("terms")?b[0].getLabel().show():b[0].getLabel().hide();-1<c.indexOf("docs")?b[1].getLabel().show():b[1].getLabel().hide()},selectTerm:function(a,b){var c=this.down("#chart");if(null!==
c)if(void 0===a)c.getSeries()[0].setHighlightItem(null),c.getSeries()[1].setHighlightItem(null);else{var d,e;!0===b?(d=c.getSeries()[1],e=d.getStore().findExact("title",a)):(d=c.getSeries()[0],e=d.getStore().findExact("term",a));if(-1!==e){var f=d.getStore().getAt(e),g=d.getSprites()[0],f={series:d,category:d.getItemInstancing()?"items":"markers",index:e,record:f,field:d.getYField(),sprite:g};d.setHighlightItem(f);b?c.getSeries()[0].setHighlightItem(null):c.getSeries()[1].setHighlightItem(null);c=
this.getPointFromIndex(d,e);this.setHighlightData({x:c[0],y:c[1],r:50});null==this.getHighlightTask()&&this.setHighlightTask(Ext.TaskManager.newTask({run:this.doHighlight,scope:this,interval:25,repeat:this.getHighlightData().r}));this.getHighlightTask().restart()}}},getPointFromIndex:function(a,b){var c=a.getSprites()[0];return null!==c.surfaceMatrix?c.attr.matrix.clone().prependMatrix(c.surfaceMatrix).transformPoint([c.attr.dataX[b],c.attr.dataY[b]]):[0,0]},doHighlight:function(){var a=this.down("#chart");
...
0,b.remove(c,!0)));a.redraw()}},filterChart:function(a){Ext.isString(a)&&(a=[a]);for(var b=[],c=0;c<a.length;c++)b.push(new RegExp(a[c]));a=this.queryById("chart");var c=a.getSeries()[0],d=c.getLabel();c.getStore().each(function(a){var c=!1;if(0==b.length)c=!0;else for(var g=0;g<b.length&&!(c=c||b[g].test(a.get("term")));g++);a.set("disabled",!c);a=a.store.indexOf(a);d.setAttributesFor(a,{hidden:!c})},this);a.redraw()},getCurrentTerms:function(){var a=[];this.getTermStore().each(function(b){"term"===
