...
b){d.setApiParam&&d.setApiParam(a,b);for(var c=d.getViewport().query("panel,chart"),e=0;e<c.length;e++)c[e].setApiParam&&c[e].setApiParam(a,b);f=!0}var c=a.up("form").getValues();this.setApiParams(c);var d=this.getApplication(),e=d.getCorpus(),f=!1;void 0!=c.stopList&&void 0!=c.stopListGlobal&&c.stopListGlobal&&b("stopList",c.stopList);void 0!=c.palette&&b("palette",c.palette);f&&(e?d.dispatchEvent("loadedCorpus",this,e):d.dispatchEvent("apiParamsUpdated",this,c));e?this.fireEvent("loadedCorpus",
...
inputValue:"biblio",boxLabel:a.localize("exportViewBiblio")},{xtype:"radio",name:"export",inputValue:"spyral",boxLabel:a.localize("exportViewSpyral")}];a.getExtraExportItems&&a.getExtraExportItems().forEach(function(a){Ext.applyIf(a,{xtype:"radio",name:"export"});c.push(a)});b.push({xtype:"radio",name:"export",inputValue:"url",boxLabel:"\x3ca href\x3d'"+a.getExportUrl.call(a)+"' target\x3d'_blank'\x3e"+a.localize("exportViewUrl")+"\x3c/a\x3e",checked:!0,listeners:{afterrender:function(){this.boxLabelEl.on("click",
function(){this.up("window").close()},this)}}},{xtype:"fieldset",collapsible:!0,collapsed:!0,title:a.localize("exportViewFieldset"),items:c});if(a.isXType("grid")){var d=[{xtype:"radio",name:"export",inputValue:"gridCurrentHtml",boxLabel:a.localize("exportGridCurrentHtml")},{xtype:"radio",name:"export",inputValue:"gridCurrentTsv",boxLabel:a.localize("exportGridCurrentTsv")}];a.getExportGridAll&&0==a.getExportGridAll()||d.push({xtype:"radio",name:"export",inputValue:"gridAllJson",boxLabel:a.localize("exportGridAllJson")},
{xtype:"radio",name:"export",inputValue:"gridAllTsv",boxLabel:a.localize("exportGridAllTsv")});b.push({xtype:"fieldset",collapsible:!0,collapsed:!0,title:a.localize("exportGridCurrent"),items:d})}a.getExportVisualization&&!a.getExportVisualization()||0!=a.isXType("grid")||!(a.down("chart")||a.getTargetEl().dom.querySelector("canvas")||a.getTargetEl().dom.querySelector("svg"))||(d=[{xtype:"radio",name:"export",inputValue:"png",boxLabel:a.localize("exportPng")},{xtype:"slider",width:200,value:1,minValue:.5,
maxValue:10,increment:.5,labelAlign:"right",decimalPrecision:1,itemId:"scale",fieldLabel:(new Ext.Template(a.localize("scaleLabel"))).apply([1]),listeners:{change:function(b,c){this.setFieldLabel((new Ext.Template(a.localize("scaleLabel"))).apply([c]))},changecomplete:function(a){a.previousSibling().setValue(!0)}}}],a.getTargetEl().dom.querySelector("svg")&&d.push({xtype:"radio",name:"export",inputValue:"svg",boxLabel:a.localize("exportSvg")}),b.push({xtype:"fieldset",collapsible:!0,collapsed:!0,
title:a.localize("exportVizTitle"),items:d}));Ext.create("Ext.window.Window",{title:a.localize("exportTitle"),modal:!0,items:{xtype:"form",items:b,buttons:[{text:a.localize("exportTitle"),glyph:"xf08e@FontAwesome",flex:1,panel:a,handler:function(b){var c=b.up("form"),d="export"+Ext.String.capitalize(c.getValues()["export"]);Ext.isFunction(a[d])?a[d].call(a,a,c):Ext.Msg.show({title:a.localize("exportError"),message:a.localize("exportNoFunction"),buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR});b.up("window").close()},
scope:a},{text:a.localize("cancelTitle"),glyph:"xf00d@FontAwesome",flex:1,handler:function(a){a.up("window").close()}}]},bodyPadding:5}).show()},exportSvg:function(a){if(a=this.getTargetEl().dom.querySelector("svg"))a=d3.select(a).attr("version",1.1).attr("xmlns","http://www.w3.org/2000/svg").node().parentNode.innerHTML,Ext.Msg.show({title:this.localize("exportSvgTitle"),message:'\x3cimg src\x3d"data:image/svg+xml;base64,'+btoa(unescape(encodeURIComponent(a)))+'" style\x3d"float: right; max-width: 200px; max-height: 200px; border: thin dotted #ccc;"/\x3e'+
this.localize("exportSvgMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:a})},exportPngData:function(a){Ext.Msg.show({title:this.localize("exportPngTitle"),message:'\x3cimg class\x3d"thumb" src\x3d"'+a+'" style\x3d"float: right; max-width: 200px; max-height: 200px; border: thin dotted #ccc;"/\x3e'+this.localize("exportPngMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:'\x3cimg src\x3d"'+a+'" /\x3e'})},exportPng:function(a,b){var c=1;b&&(b.mask(a.localize("loading")),
(a=b.queryById("scale"))&&a.getValue&&(c=a.getValue()));var d=this.down("draw")||this.down("chart");if(d&&(d.isChart||d.isCanvas)){var e=d.innerElement.getSize();a=Array.prototype.slice.call(d.items.items);var f=d.surfaceZIndexes,g;for(g=1;g<a.length;g++){var k=a[g];var h=f[k.type];for(d=g-1;0<=d&&f[a[d].type]>h;)a[d+1]=a[d],d--;a[d+1]=k}var l=document.createElement("canvas");f=Ext.getClassName(a[0]);c*=a[0].devicePixelRatio;var m=l.getContext("2d");l.width=Math.ceil(e.width*c);l.height=Math.ceil(e.height*
c);for(d=0;d<a.length;d++)if(k=a[d],Ext.getClassName(k)===f)for(e=k.getRect(),surfaceSize=k.el.getSize(),g=0;g<k.canvases.length;g++){var n=k.canvases[g];h=n.getOffsetsTo(n.getParent());m.drawImage(n.dom,(e[0]+h[0])*c,(e[1]+h[1])*c,surfaceSize.width*c,surfaceSize.height*c)}b&&b.isVisible()&&b.unmask();return this.exportPngData(l.toDataURL())}g=this.getTargetEl().dom;if(n=g.querySelector("canvas")){if(1==c)return c=n.toDataURL("image/png"),b&&b.isVisible()&&b.unmask(),this.exportPngData(c);l=document.createElement("canvas");
m=l.getContext("2d");l.width=Math.ceil(n.width*c);l.height=Math.ceil(n.height*c);var p=new Image;p.src=n.toDataURL("image/png");p.panel=this;p.onload=function(){m.drawImage(p,0,0,l.width,l.height);r=l.toDataURL("image/png");b&&b.isVisible()&&b.unmask();this.panel.exportPngData.call(this.panel,r)}}else if(d=g.querySelector("svg")){a=g.offsetWidth*c;g=g.offsetHeight*c;d=d.cloneNode(!0);d.setAttribute("version",1.1);d.setAttribute("xmlns","http://www.w3.org/2000/svg");d.setAttribute("transform","scale("+
c+")");d.setAttribute("width",a);d.setAttribute("height",g);var r="data:image/svg+xml;base64,"+btoa(unescape(encodeURIComponent(d.outerHTML)));n=Ext.DomHelper.createDom({tag:"canvas",width:a,height:g});var q=n.getContext("2d");p=new Image;p.src=r;p.panel=this;p.onload=function(){q.drawImage(p,0,0);r=n.toDataURL("image/png");b&&b.isVisible()&&b.unmask();return this.panel.exportPngData.call(this.panel,r)}}},exportUrl:function(){this.openUrl(this.getExportUrl())},exportEmbed:function(){var a=0==this.isXType("voyantheader");
Ext.Msg.show({title:this.localize("exportViewEmbedTitle"),message:this.localize("exportViewEmbedMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:"\x3c!--\tExported from Voyant Tools (voyant-tools.org).\nThe iframe src attribute below uses a relative protocol to better function with both\nhttp and https sites, but if you're embedding this into a local web page (file protocol)\nyou should add an explicit protocol (https if you're using voyant-tools.org, otherwise\nit depends on this server.\nFeel free to change the height and width values or other styling below: --\x3e\n\x3ciframe style\x3d'width: "+
...
"":this.localize("title")+". ")+"\x3ci\x3eVoyant Tools\x3c/i\x3e. Retrieved "+Ext.Date.format(a,"F j, Y")+", from http://voyant-tools.org\x3c/fieldset\x3e",buttons:Ext.Msg.OK,icon:Ext.Msg.INFO})},exportSpyral:function(){var a=Ext.getClassName(this).split(".").pop(),b=this.getApplication().getModifiedApiParams();0==this.isXType("voyantheader")&&(delete b.panels,Ext.apply(b,this.getModifiedApiParams()),delete b.corpus);var c=b&&"debug"in b;delete b.view;delete b.debug;a='["'+btoa(encodeURIComponent("\x3ch2\x3eSpyral Notebook Imported from Voyant Tools\x3c/h2\x3e")).replace(/=/g,
"%3D")+'","'+btoa(encodeURIComponent('loadCorpus("'+this.getApplication().getCorpus().getAliasOrId()+'").tool("'+a+'"'+(0<Object.keys(b).length?","+Ext.encode(b):"")+");")).replace(/=/g,"%3D")+'"]';this.openUrl(this.getApplication().getBaseUrl()+"spyral/?run\x3dtrue\x26"+(c?"debug\x3dtrue\x26":"")+"inputJsonArrayOfEncodedBase64\x3d"+a)},exportGridCurrentJson:function(a,b){function c(a){var b={};d.forEach(function(c){b[c.text]=a.get(c.dataIndex)});values.push(b)}b=a.getStore();b.getFields();var d=
a.getColumnManager().headerCt.getVisibleGridColumns();values=[];b.buffered?b.data.forEach(c):b.each(c);Ext.Msg.show({title:this.localize("exportDataTitle"),message:this.localize("exportDataJsonMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:Ext.encode(values)})},exportGridCurrentTsv:function(a,b){function c(a){cells=[];e.forEach(function(b){b=a.get(b.dataIndex);Ext.isString(b)&&(b=b.replace(/\s+/g," "));cells.push(b)});f+=cells.join("\t")+"\n"}b=a.getStore();var d=b.getFields(),
e=a.getColumnManager().headerCt.getVisibleGridColumns();d=[];e.forEach(function(a){d.push(a.text)});var f=d.join("\t")+"\n";b.buffered?b.data.forEach(c):b.each(c);Ext.Msg.show({title:this.localize("exportDataTitle"),message:this.localize("exportDataTsvMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:f})},exportGridCurrentHtml:function(a,b){function c(a){d+="\t\t\x3ctr\x3e\n";e.forEach(function(b){b=a.get(b.dataIndex);Ext.isString(b)&&(b=b.replace(/&/g,"\x26amp;").replace(/</g,
"\x26lt;").replace(/>/g,"\x26lg;"));d+="\t\t\t\x3ctd\x3e"+b+"\x3c/td\x3e\n"});d+="\t\t\x3c/tr\x3e\n"}b=a.getStore();b.getFields();var d="\x3ctable\x3e\n\t\x3cthead\x3e\n\t\t\x3ctr\x3e\n",e=a.getColumnManager().headerCt.getVisibleGridColumns();e.forEach(function(a){d+="\t\t\t\x3ctd\x3e"+a.text+"\x3c/td\x3e\n"});d+="\t\t\x3c/tr\x3e\n\t\x3c/thead\x3e\n\t\x3ctbody\x3e\n";b.buffered?b.data.forEach(c):b.each(c);d+="\t\x3c/tbody\x3e\n\x3c/table\x3e";Ext.Msg.show({title:this.localize("exportDataTitle"),message:this.localize("exportDataHtmlMessage"),
buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:d})},exportGridAllJson:function(a,b){Ext.Msg.confirm(this.localize("exportAllTitle"),this.localize("exportAllJsonWarning"),function(b){"yes"==b&&(b={limit:0,start:0},Ext.applyIf(b,a.getStore().getProxy().getExtraParams()),this.openUrl(this.getTromboneUrl()+"?"+Ext.Object.toQueryString(b)))},this)},exportGridAllTsv:function(a,b){Ext.Msg.confirm(this.localize("exportAllTitle"),this.localize("exportAllTsvWarning"),function(b){"yes"==b&&
(b={limit:0,start:0,template:this.getXType()+"2tsv"},Ext.applyIf(b,a.getStore().getProxy().getExtraParams()),this.openUrl(this.getTromboneUrl()+"?"+Ext.Object.toQueryString(b)))},this)},getExportUrl:function(a){var b=this.getApplication().getModifiedApiParams(),c=Ext.getClassName(this).split(".").pop();0==this.isXType("voyantheader")&&(delete b.panels,Ext.apply(b,this.getModifiedApiParams()),a||(b.view=c));b.corpus||(b.corpus=this.getApplication().getCorpus().getAliasOrId());return this.getApplication().getBaseUrl()+
(a?"tool/"+c+"/":"")+"?"+Ext.Object.toQueryString(b)},helpToolClick:function(a){a.isXType("voyanttabpanel")&&(a=a.getActiveTab());var b=a.localize("help",{"default":!1})||a.localize("helpTip");b==a._localizeClass(Ext.ClassManager.get("Voyant.util.Toolable"),"helpTip")?a.openUrl(a.getBaseUrl()+"docs/#!/guide/"+a.getXType()):Ext.Msg.alert(a.localize("title"),b+"\x3cp\x3e\x3ca href\x3d'"+a.getBaseUrl()+"docs/"+(a.isXType("voyantheader")?"":"#!/guide/"+a.getXType())+"' target\x3d'voyantdocs'\x3e"+a.localize("moreHelp")+
"\x3c/a\x3e\x3c/p\x3e")},replacePanel:function(a){var b=this.getApplication().getCorpus();this.getInitialConfig();if(this.isXType("voyantheader")&&this.getApplication().getViewComponent){var c=this.getApplication().getViewComponent();c.removeAll(!0);c.add({xtype:a});b&&this.getApplication().dispatchEvent("loadedCorpus",c,b);c=Ext.Object.fromQueryString(document.location.search);var d=this.getApplication().getBaseUrl();d+="?corpus\x3d"+b.getAliasOrId();d+="\x26view\x3d"+a;for(var e in c)"corpus"!==
e&&"view"!==e&&(d+="\x26"+e+"\x3d"+c[e]);window.history.pushState({corpus:b.getAliasOrId(),view:a},"",d)}else c=this.isXType("voyantheader")&&this.getApplication().getViewComponent?this.getApplication().getViewComponent():this.up("component"),c.remove(this,!0),a=c.add({xtype:a}),c.isXType("voyanttabpanel")&&c.setActiveTab(a),b&&a.fireEvent("loadedCorpus",a,b);this.getApplication().dispatchEvent("panelChange",this)}});
...
this.localize("querySearchDocsModeTip"):this.localize("querySearchTip"),buttons:Ext.OK,icon:Ext.Msg.INFO})},scope:"this"}}});a.showAggregateInDocumentsCount&&(a.triggers.count={cls:"fa-trigger",handler:"onHelpClick",scope:"this",hidden:!0});a.clearOnQuery&&this.setClearOnQuery(a.clearOnQuery);this.callParent(arguments)},initComponent:function(a){var b=this;b.on("beforequery",function(a){if(a.query){a.query=a.query.trim();var c=b.up("panel").getApplication().getCategories(),d={},g;for(g in c)d.$jscomp$loop$prop$key$0$10=
g,0==d.$jscomp$loop$prop$key$0$10.indexOf(a.query.indexOf(d.$jscomp$loop$prop$key$0$10))?a.query=d.$jscomp$loop$prop$key$0$10+":"+c[d.$jscomp$loop$prop$key$0$10].join("|"):c[d.$jscomp$loop$prop$key$0$10].forEach(function(b){return function(d){d.indexOf(a.query)&&(a.query=b.$jscomp$loop$prop$key$0$10+":"+c[b.$jscomp$loop$prop$key$0$10].join("|"))}}(d)),d={$jscomp$loop$prop$key$0$10:d.$jscomp$loop$prop$key$0$10};"^"==a.query.charAt(0)&&(a.query=a.query.substring(1),a.cancel=0==a.query.length);"*"==
a.query.charAt(0)&&(a.query="."+a.query);if("*"==a.query.charAt(a.query.length-1)||"|"==a.query.charAt(a.query.length-1))a.query=a.query.substring(0,a.query.length-1),a.cancel=0==a.query.length;"."==a.query.charAt(0)&&(a.cancel=a.query.length<(/\W/.test(a.query.charAt(1))?5:4));try{new RegExp(a.query)}catch(k){a.cancel=!0}-1<a.query.indexOf('"')&&(-1==a.query.indexOf(" ")&&(a.cancel=!0),2!=(a.query.match(/"/)||[]).length&&(a.cancel=!0));-1<a.query.indexOf("*")?-1==a.query.indexOf(" ")&&-1==a.query.indexOf("|")&&
...
a,"0,000")},width:"autoSize",hidden:!0,sortable:!0}],dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"querysearchfield"}]}],listeners:{query:function(a,b){this.setApiParam("query",b);a=this.queryById("terms").getStore();a.removeAll();a.load()},scope:this}}},{title:this.localize("categories"),itemId:"categories",region:"center",xtype:"panel",layout:{type:"hbox",align:"stretch"},scrollable:"x",dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",
...
addFeature:function(a){this.app.addFeature(a);this.buildFeatures()},buildFeatures:function(){this.queryById("features").getStore().removeAll();var a=["category"],b=[{sortable:!1,text:this.localize("category"),dataIndex:"category",flex:1}],c=[],d;for(d in this.app.getCategories())c.push({category:d});var e=this.app.getFeatures(),f=Ext.ClassManager.getClass(this).features,g;for(g in e){a.push(g);e=f[g];var k=Ext.applyIf({feature:g,listeners:{change:function(a,b){if(a.rendered){var c=a.up("gridview").indexOf(a.el.up("table")),
...
function(a){var b=a.x,c=a.y;if(this.getNetworkMode()===this.DEFAULT_MODE||"keyword"!==a.type)b-=.5*a.bbox.width,c-=.5*a.bbox.height;return"translate("+b+","+c+")"}.bind(this));!this.getDragging()&&.075>this.getVisLayout().alpha()&&this.getVisLayout().alpha(-1)}.bind(this)).on("end",function(){Ext.Function.defer(this.zoomToFit,100,this)}.bind(this)));a=d3.select(a.dom).append("svg").attr("id",this.getVisId()).attr("class","linksGraph").attr("width",b).attr("height",c);var d=a.append("g");b=d3.zoom().scaleExtent([.25,
4]).on("zoom",function(){d.attr("transform",d3.event.transform)});this.setZoom(b);a.call(b);a.on("click",function(){this.getContextMenu().hide()}.bind(this));this.setLinks(d.append("g").attr("class","links").selectAll(".link"));this.setNodes(d.append("g").attr("class","nodes").selectAll(".node"));this.setVis(d)},resetGraph:function(){this.setNodeData([]);this.setLinkData([]);this.setNetworkMode(this.DEFAULT_MODE);this.refresh()},refresh:function(){var a=this,b=this.getNodeData(),c=this.getLinkData(),
d=this.getLinks().data(c,function(a){return a.id});d.exit().remove();var e=d.enter().append("line").attr("class","link").attr("id",function(a){return a.id}).on("mouseover",a.linkMouseOver.bind(a)).on("mouseout",a.linkMouseOut.bind(a)).on("click",function(a){d3.event.stopImmediatePropagation();d3.event.preventDefault();this.dispatchEvent("termsClicked",this,['"'+a.source.term+" "+a.target.term+'"~'+this.getApiParam("context")])}.bind(a)).style("cursor","pointer").style("stroke-width",function(b){return a.getNetworkMode()===
a.DEFAULT_MODE?Math.max(1,Math.min(15,Math.sqrt(b.value))):1});this.setLinks(e.merge(d));d=this.getNodes().data(b,function(a){return a.id});d.exit().remove();e=d.enter().append("g").attr("class",function(a){return"node "+a.type}).attr("id",function(a){return a.id}).on("mouseover",a.nodeMouseOver.bind(a)).on("mouseout",a.nodeMouseOut.bind(a)).on("click",function(a){d3.event.stopImmediatePropagation();d3.event.preventDefault();this.dispatchEvent("termsClicked",this,[a.term])}.bind(a)).on("dblclick",
function(a){d3.event.stopImmediatePropagation();d3.event.preventDefault();this.fetchCollocatesForNode(a)}.bind(a)).on("contextmenu",function(b,c){d3.event.preventDefault();c=a.getContextMenu();c.queryById("label").setHtml(b.term);c.queryById("fixed").setChecked(b.fixed);c.showAt(d3.event.pageX+10,d3.event.pageY-50)}).call(d3.drag().on("start",function(b){a.setDragging(!0);d3.event.active||a.getVisLayout().alpha(.3).restart();b.fx=b.x;b.fy=b.y;b.fixed=!0}).on("drag",function(b){a.getVisLayout().alpha(.3);
b.fx=d3.event.x;b.fy=d3.event.y;a.isMasked()?a.isOffCanvas(d3.event.x,d3.event.y)||a.unmask():a.isOffCanvas(d3.event.x,d3.event.y)&&a.mask(a.localize("releaseToRemove"))}).on("end",function(b){a.setDragging(!1);1!=b.fixed&&(b.fx=null,b.fy=null);a.isOffCanvas(d3.event.x,d3.event.y)&&(a.unmask(),a.mask(a.localize("cleaning")),a.removeNode(b.id),a.unmask())}));e.append("title").text(function(a){return a.title});this.getNetworkMode()===this.DEFAULT_MODE?e.append("rect").style("stroke-width",1).style("stroke-opacity",
1):e.filter(function(a){return"keyword"===a.type}).append("circle").style("stroke-width",1).style("stroke-opacity",1);e.append("text").attr("font-family",function(b){return a.getApplication().getFeatureForTerm("font",b.term)}).attr("font-size",function(a){return Math.max(10,Math.sqrt(a.value))}).text(function(a){return a.term}).each(function(a){a.bbox=this.getBBox()}).style("cursor","pointer").style("user-select","none").attr("dominant-baseline","middle");this.setNodes(e.merge(d));this.getNetworkMode()===
this.DEFAULT_MODE?(this.getVis().selectAll("rect").attr("width",function(a){return a.bbox.width+16}).attr("height",function(a){return a.bbox.height+8}).attr("rx",function(a){return Math.max(2,.2*a.bbox.height)}).attr("ry",function(a){return Math.max(2,.2*a.bbox.height)}).call(this.applyNodeStyle.bind(this)),this.getVis().selectAll("text").attr("dx",8).attr("dy",function(a){return.5*a.bbox.height+4})):(this.getVis().selectAll("circle").attr("r",function(a){return Math.min(150,a.bbox.width)}).call(this.applyNodeStyle.bind(this)),
this.getVis().selectAll("text").attr("dx",function(a){return"keyword"===a.type?.5*-a.bbox.width:8}).attr("dy",function(a){return"keyword"===a.type?0:.5*a.bbox.height+4}));this.getVis().selectAll("line").call(this.applyLinkStyle.bind(this));this.getVisLayout().nodes(b);this.getVisLayout().force("link").links(c);this.getVisLayout().alpha(1).restart()},isOffCanvas:function(a,b){var c=Ext.get(this.getVisId());return 0>a||0>b||a>c.getWidth()||b>c.getHeight()},zoomToFit:function(a,b){var c=this.getVis().node().getBBox(),
d=c.width,e=c.height,f=c.x+d/2,g=c.y+e/2;c=this.getVis().node().parentElement;var k=c.getBoundingClientRect(),h=k.width;k=k.height;a=(a||.8)/Math.max(d/h,e/k);f=[h/2-a*f,k/2-a*g];1>d||d3.select(c).transition().duration(b||500).call(this.getZoom().transform,d3.zoomIdentity.translate(f[0],f[1]).scale(a))},applyNodeStyle:function(a,b){var c=void 0===b?"normal":b;a.style("fill",function(a){a=a.type+"Node";return this.getGraphStyle()[a][c].fill}.bind(this));a.style("stroke",function(a){a=a.type+"Node";
return this.getGraphStyle()[a][c].stroke}.bind(this))},applyLinkStyle:function(a,b){var c=void 0===b?"normal":b;a.style("stroke",function(a){return this.getGraphStyle().link[c].stroke}.bind(this));a.style("stroke-opacity",function(a){return this.getGraphStyle().link[c].strokeOpacity}.bind(this))},linkMouseOver:function(a){this.getVis().selectAll("line").call(this.applyLinkStyle.bind(this));this.getVis().select("#"+a.id).call(this.applyLinkStyle.bind(this),"highlight")},linkMouseOut:function(a){this.getVis().selectAll("line").call(this.applyLinkStyle.bind(this))},
nodeMouseOver:function(a){this.setCurrentNode(a);this.getVis().selectAll("rect").call(this.applyNodeStyle.bind(this));this.getLinks().each(function(b){if(b.source.id==a.id)var c=b.target.id;else b.target.id==a.id&&(c=b.source.id);void 0!==c&&(this.getVis().select("#"+c+" rect").call(this.applyNodeStyle.bind(this),"highlight"),this.getVis().select("#"+b.id).call(this.applyLinkStyle.bind(this),"highlight"))}.bind(this));this.getVis().select("#"+a.id+" rect").style("stroke-width",3).call(this.applyNodeStyle.bind(this),
"highlight")},nodeMouseOut:function(a){this.getContextMenu().isVisible()||this.setCurrentNode(void 0);this.getVis().selectAll("rect").style("stroke-width",1).call(this.applyNodeStyle.bind(this));this.getVis().selectAll("line").call(this.applyLinkStyle.bind(this))},fetchCollocatesForNode:function(a){var b=this.getApiParam("limit"),c=this.getApiParam("query");c=Ext.Array.from(this.getApiParam("query"));Ext.Array.include(c,a.term);this.setApiParam("query",c);this.getCorpus().getCorpusCollocates({autoLoad:!1}).load({params:Ext.apply(this.getApiParams(),
{query:a.term,start:a.start,limit:b}),callback:function(c,e,f){f&&(this.updateDataForNode(a.id,{start:a.start+b}),this.loadFromCorpusCollocateRecords(c,a.id))},scope:this})}});Ext.define("Voyant.panel.Contexts",{extend:"Ext.grid.Panel",mixins:["Voyant.panel.Panel"],requires:["Voyant.data.store.Contexts"],alias:"widget.contexts",isConsumptive:!0,statics:{i18n:{},api:{query:void 0,docId:void 0,docIndex:void 0,stopList:"auto",context:5,expand:50},glyph:"xf0ce@FontAwesome"},constructor:function(){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(){var a=this;Ext.apply(a,{title:this.localize("title"),emptyText:this.localize("emptyText"),
...
c){var b=[],e=this.getStore().getCorpus();c.forEach(function(a){b.push(e.getDocument(a).getId())},this);this.setApiParams({docId:b,docIndex:void 0});this.getStore().getProxy().setExtraParam("tool","corpus.DocumentTermCorrelations");this.getStore().load()}},dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"querysearchfield"},{xtype:"totalpropertystatus"},{xtype:"tbspacer"},{xtype:"tbtext",itemId:"minInDocumentsCountRatioLabel",text:a.localize("minInDocumentsCountRatioLabel")},
...
this.mask(this.localize("limitedAccess"),"mask-no-spinner"):this.loadFromApis())});a.embedded||a.corpus&&this.fireEvent("loadedCorpus",this,a.corpus);this.on("corpusTermsClicked",function(a,c){if(this.getStore().getCorpus()){var b=[];c.forEach(function(a){b.push(a.get("term"))});this.setApiParams({query:b,docId:void 0,docIndex:void 0});this.isVisible()&&this.getStore().load({params:this.getApiParams()})}});this.on("activate",function(){this.getStore().getCorpus()&&this.loadFromApis()},this);this.on("query",
...
edges:this.getEdgesDataSet()},b);if(this.getIsNetworkBounded())c.on("beforeDrawing",function(a){var b=this.getLayout().getRenderTarget();a=b.getWidth();b=b.getHeight();var d=c.getPositions(),g;for(g in d){var k=c.canvasToDOM(d[g]);k=c.DOMtoCanvas({x:Math.max(0,Math.min(a,k.x)),y:Math.max(0,Math.min(b,k.y))});c.body.nodes[g].x=k.x;c.body.nodes[g].y=k.y}}.bind(this));c.on("selectNode",function(a){this.doNodeSelect(a.nodes[0])}.bind(this));c.on("deselectNode",function(a){c.unselectAll();a=a.nodes[0];
...
LOCATION_UPDATE_FREQ:100,INITIAL_LIMIT:1E3,constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(a){var b=Ext.create("Voyant.data.store.Tokens",{parentTool:this,proxy:{extraParams:{forTool:"reader"}}}),c=this;b.on("beforeload",function(a){return c.hasCorpusAccess(a.getCorpus())});b.on("load",function(a,b,c){if(c){var d="",e=this.localize("documentFrequency"),f=!1,l=-1,m=!1;b.forEach(function(a){0==a.getPosition()&&
(d+="\x3ch3\x3e"+this.getDocumentsStore().getById(a.getDocId()).getFullLabel()+"\x3c/h3\x3e");a.getDocIndex()!=l&&(f=this.getDocumentsStore().getById(a.getDocId()).isPlainText(),l=a.getDocIndex());if(a.isWord())m=!1,d+="\x3cspan class\x3d'word' id\x3d'"+a.getId()+"' data-qtip\x3d'"+e+" "+a.getDocumentRawFreq()+"'\x3e"+a.getTerm()+"\x3c/span\x3e";else{a=a.getTermWithLineSpacing(f);var b=0==a.indexOf("\x3cbr /\x3e");if(!m||!b&&0!=a.trim().length)d+=a,m=b}},this);this.updateText(d);this.down("querysearchfield").getValue()}},
...
b,c,g){a.sort("docIndex","ASC");var d;a.each(function(a){d=a.get("term")},this);this.highlightKeywords(d)},scope:this}}));this.on("afterrender",function(){var a=this.down('panel[region\x3d"center"]');this.setInnerContainer(a.getLayout().getRenderTarget());a.body.on("scroll",function(a,b){a=this.getLastScrollTop()<b.scrollTop?this.SCROLL_DOWN:this.getLastScrollTop()>b.scrollTop?this.SCROLL_UP:this.SCROLL_EQ;if(a==this.SCROLL_UP&&1>b.scrollTop)this.fetchPrevious(!0);else if(a==this.SCROLL_DOWN&&b.scrollHeight-
b.scrollTop<1.5*b.offsetHeight)this.fetchNext(!1);else{var c=0==b.scrollTop?0:b.scrollHeight-b.scrollTop==b.clientHeight?1:(b.scrollTop+.5*b.clientHeight)/b.scrollHeight;(new Date-this.getLastLocationUpdate()>this.LOCATION_UPDATE_FREQ||0==c||1==c)&&this.updateLocationMarker(c,a)}this.setLastScrollTop(b.scrollTop)},this);a.body.on("click",function(a,b){b=Ext.get(b);b.hasCls("word")&&(a=Voyant.data.model.Token.getInfoFromElement(b),b=b.getHtml(),a=[{term:b,docIndex:a.docIndex}],this.loadQueryTerms([b]),
this.getApplication().dispatchEvent("termsClicked",this,a))},this);this.getCorpus()&&(this.load(),(a=this.getApiParam("query"))&&this.loadQueryTerms(Ext.isString(a)?[a]:a));this.on("loadedCorpus",function(){this.load(!0);var a=this.getApiParam("query");a&&this.loadQueryTerms(Ext.isString(a)?[a]:a)},this)},this);Ext.apply(this,{title:this.localize("title"),cls:"voyant-reader",layout:"fit",items:{layout:"border",items:[{bodyPadding:10,region:"center",border:!1,autoScroll:!0,html:'\x3cdiv class\x3d"readerContainer"\x3e\x3c/div\x3e'},
{xtype:"readergraph",region:"south",height:40,split:{size:2},splitterResize:!0,border:!1,listeners:{documentRelativePositionSelected:function(a,b){a=this.getDocumentsStore().getAt(b.docIndex);var c=a.get("tokensCount-lexical");b=Math.floor(c*b.fraction)-this.getApiParam("limit")/2;this.setApiParams({skipToDocId:a.getId(),start:0>b?0:b});this.load(!0)},scope:this}}]},dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{glyph:"xf060@FontAwesome",handler:function(){this.fetchPrevious(!0)},
scope:this},{glyph:"xf061@FontAwesome",handler:function(){this.fetchNext(!0)},scope:this},{xtype:"tbseparator"},{xtype:"querysearchfield"}]}],listeners:{loadedCorpus:function(a,b){this.getTokensStore().setCorpus(b);this.getDocumentTermsStore().getProxy().setExtraParam("corpus",b.getId());a=b.getDocuments();this.setDocumentsStore(a);this.rendered&&(this.load(),0==this.hasCorpusAccess(b)&&this.mask(this.localize("limitedAccess"),"mask-no-spinner"),(b=this.getApiParam("query"))&&this.loadQueryTerms(Ext.isString(b)?
[b]:b))},termsClicked:function(a,b){var c=[];b.forEach(function(a){Ext.isString(a)?c.push(a):a.term?c.push(a.term):a.getTerm&&c.push(a.getTerm())});0<c.length&&this.loadQueryTerms(c)},corpusTermsClicked:function(a,b){var c=[];b.forEach(function(a){a.getTerm()&&c.push(a.getTerm())});this.loadQueryTerms(c)},documentTermsClicked:function(a,b){var c=[];b.forEach(function(a){a.getTerm()&&c.push(a.getTerm())});this.loadQueryTerms(c)},documentSelected:function(a,b){a=this.getTokensStore().getCorpus().getDocument(b);
this.setApiParams({skipToDocId:a.getId(),start:0});this.load(!0)},documentsClicked:function(a,b,c){0<b.length&&(this.setApiParams({skipToDocId:b[0].getId(),start:0}),this.load(!0))},termLocationClicked:function(a,b){if(void 0!==b[0]){var c=b[0],d=c.get("docIndex"),e=c.get("position");a=e-this.getApiParam("limit")/2;b=this.getCorpus().getDocument(d);this.setApiParams({skipToDocId:b.getId(),start:0>a?0:a});this.load(!0,{callback:function(){var a=this.body.dom.querySelector("#_"+d+"_"+e);a&&a.scrollIntoView();
this.highlightKeywords(c.get("term"),!1)},scope:this})}},documentIndexTermsClicked:function(a,b){void 0!==b[0]&&(a=Ext.create("Voyant.data.model.Token",b[0]),this.fireEvent("termLocationClicked",this,[a]))},scope:this}});this.callParent(arguments)},loadQueryTerms:function(a){a&&0<a.length&&(this.getDocumentTermsStore().load({params:{query:a}}),this.down("readergraph").loadQueryTerms(a))},highlightKeywords:function(a,b){Ext.isArray(a)||(a=[a]);this.getInnerContainer().first().select("span[class*\x3dkeyword]").removeCls("keyword");
...
a,!0);c&&this.getScrollIntoView()&&(c.dom.scrollIntoView(),Ext.Function.defer(function(){var a=Ext.get(c.id);a&&a.frame("red")},100));a=this.down('panel[region\x3d"center"]').body.dom;this.updateLocationMarker(0==a.scrollTop?0:a.scrollHeight-a.scrollTop==a.clientHeight?1:(a.scrollTop+.5*a.clientHeight)/a.scrollHeight)},updateLocationMarker:function(a,b){var c=Ext.DomQuery.select(".word",this.getInnerContainer().down(".readerContainer",!0)),d=c[0],e=c[c.length-1];if(void 0!==d&&void 0!==e){c=this.getCorpus();
var f=!1;d=Voyant.data.model.Token.getInfoFromElement(Ext.get(d));e=Voyant.data.model.Token.getInfoFromElement(Ext.get(e));0!==d.position&&(f=!0);for(var g={},k=0,h=d.docIndex;h<=e.docIndex;){var l=c.getDocument(h).get("tokensCount-lexical");h===e.docIndex&&(l=e.position);h===d.docIndex&&(l-=d.position);k+=l;g[h]=l;h++}k=Math.round(k*a);h=a=0;for(l=d.docIndex;l<=e.docIndex&&!(a=l,h+=g[l],h>=k);l++);e=g[a]-(h-k);f&&a===d.docIndex&&(e+=d.position);c=e/c.getDocument(a).get("tokensCount-lexical");this.down("readergraph").moveLocationMarker(a,
...
if(25>c.length)var f=4*c.length;else 50>c.length?f=2*c.length:100<c.length&&(f=b.getWidth()-200,f=f<c.length?c.length:f);var g=this.localize("numberOfTerms");b.add({cls:"section",items:[{layout:"hbox",align:"bottom",items:[{html:this.localize("docsLength"),cls:"header"},{xtype:"sparklineline",values:this.getCorpus().getDocuments().getRange().map(function(a){return a.getLexicalTokensCount()}),tipTpl:new Ext.XTemplate("{[this.getDocumentTitle(values.x,values.y)]}",{getDocumentTitle:function(a,b){return"("+
b+") "+this.panel.getCorpus().getDocument(a).getTitle()},panel:a}),height:16,width:f}]},{html:"\x3cul\x3e\x3cli\x3e"+this.localize("longest")+" "+e.apply(c.slice(0,c.length>d?d:parseInt(c.length/2)).map(function(a){return{id:a.getId(),shortTitle:a.getShortTitle(),title:a.getTitle(),val:a.getLexicalTokensCount(),valTip:g}}))+"\x3c/li\x3e\x3cli\x3e"+this.localize("shortest")+" "+e.apply(c.slice(-(c.length>d?d:parseInt(c.length/2))).reverse().map(function(a){return{id:a.getId(),shortTitle:a.getShortTitle(),
...
this)}},_run:function(){this.results.show();this.results.update(" ");this.results.mask("working\u2026");var a=this.editor.getValue();Voyant.notebook.util.Show.TARGET=this.results.getEl();Voyant.notebook.Notebook.currentBlock=this;Voyant.notebook.Notebook.currentNotebook.setCurrentBlock(this);try{var b=eval.call(window,a)}catch(d){return this.results.unmask(),Voyant.notebook.util.Show.showError(d),this.getTargetEl().fireEvent("resize"),d}this.setIsRun(!0);if(void 0!==b)if(b.then&&b.catch&&b.finally){var c=
this;b.then(function(a){void 0!==a&&c.results.update(a)}).catch(function(a){Voyant.notebook.util.Show.showError(a)}).finally(function(){c.results.unmask();Ext.defer(function(){this.getTargetEl().fireEvent("resize")},50,c)})}else this.results.unmask(),this.results.update(b);else this.results.unmask();return b},clearResults:function(){this.results.show();var a=this.results.el.down(".x-panel");if(a){var b=Ext.getCmp(a.id);b?b.destroy():a.destroy()}else this.results.update(" ");this.getTargetEl().fireEvent("resize")},
...
openMsg:"Paste in Notebook ID, a URL or a Spyral data file (in HTML).",exportHtmlDownload:"HTML (download)"},api:{input:void 0,inputEncodedBase64Json:void 0,run:void 0},currentNotebook:void 0,voyantStorageDialogs:void 0,githubDialogs:void 0},config:{notebookId:void 0,metadata:void 0,isEdited:!1,version:"3.0",currentBlock:void 0,storageSolution:"voyant"},constructor:function(a){Voyant.notebook.Notebook.currentNotebook=this;Ext.apply(a,{title:this.localize("title"),autoScroll:!0,includeTools:{help:!0,
gear:!0,save:!0,saveIt:{tooltip:this.localize("saveItTip"),itemId:"saveItTool",xtype:"toolmenu",glyph:"xf0c2@FontAwesome",disabled:!0,scope:this,items:[{text:"Save",xtype:"menuitem",glyph:"xf0c2@FontAwesome",handler:this.showSaveDialog.bind(this,!1),scope:this},{text:"Save As...",xtype:"menuitem",glyph:"xf0c2@FontAwesome",handler:this.showSaveDialog.bind(this,!0),scope:this}]},"new":{tooltip:this.localize("newTip"),callback:function(){this.clear();this.addNew();var a=this.getBaseUrl()+"spyral/";window.history.pushState({url:a},
"Spyral Notebook",a)},xtype:"toolmenu",glyph:"xf067@FontAwesome",scope:this},open:{tooltip:this.localize("openTip"),xtype:"toolmenu",glyph:"xf115@FontAwesome",callback:function(a,c){a=this.getStorageSolution();void 0!==a&&(setTimeout(function(){c.toolMenu.hide()}),"github"===a?this.githubDialogs.showLoad():Ext.Msg.prompt(this.localize("openTitle"),this.localize("openMsg"),function(a,b){b=b.trim();"ok"==a&&(this.clear(),this.loadFromString(b))},this,!0))},scope:this,items:[{text:"Load",xtype:"menuitem",
glyph:"xf115@FontAwesome",handler:function(){Ext.Msg.prompt(this.localize("openTitle"),this.localize("openMsg"),function(a,c){c=c.trim();"ok"==a&&(this.clear(),this.loadFromString(c))},this,!0)},scope:this},{text:"Load from GitHub",xtype:"menuitem",glyph:"xf115@FontAwesome",handler:function(){this.githubDialogs.showLoad()},scope:this}]},runall:{tooltip:this.localize("runallTip"),callback:this.runAll,xtype:"toolmenu",glyph:"xf04e@FontAwesome",scope:this},metadata:{tooltip:this.localize("metadataTip"),
...
itemId:"cells"},{itemId:"spyralFooter",cls:"spyral-footer",listeners:{afterrender:function(a){Ext.tip.QuickTipManager.register({target:a.getId(),text:this.localize("clickToEdit")});a.getTargetEl().on("click",function(b){this.showMetadataEditor();a.removeCls("editable")},this);a.mon(a.getEl(),"mouseover",function(){a.addCls("editable")});a.mon(a.getEl(),"mouseout",function(){a.removeCls("editable")})},scope:this}}],listeners:{afterrender:this.init,notebookWrapperMoveUp:this.notebookWrapperMoveUp,notebookWrapperMoveDown:this.notebookWrapperMoveDown,
notebookWrapperRemove:this.notebookWrapperRemove,notebookWrapperAdd:this.notebookWrapperAdd,scope:this}});this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);window.Corpus=Spyral.Corpus;window.Table=Spyral.Table;window.loadCorpus=function(){return Spyral.Corpus.load.apply(Spyral.Corpus.load,arguments)};window.createTable=function(){return Spyral.Table.create(arguments)};this.voyantStorageDialogs=new Voyant.notebook.StorageDialogs({listeners:{fileLoaded:function(a){},
fileSaved:function(a,c){this.unmask();null!==c&&((a=this.getNotebookId())&&c==a||this.setNotebookId(c),this.toastInfo({html:this.localize("saved"),anchor:"tr"}),this.setIsEdited(!1))},saveCancelled:function(){this.unmask()},scope:this}});this.githubDialogs=new Voyant.notebook.github.GitHubDialogs({listeners:{fileLoaded:function(a,c){a=c.owner;var b=c.repo,e=c.path;c=c.file;this.githubDialogs.close();this.clear();this.loadFromString(c);c=encodeURIComponent(a+"/"+b+"/"+e);-1===location.search.indexOf(c)&&
(a=this.getBaseUrl()+"spyral/?githubId\x3d"+c,window.history.pushState({url:a},"Spyral Notebook: "+c,a))},fileSaved:function(a,c){a=c.owner;var b=c.repo;c=c.path;this.githubDialogs.close();this.unmask();this.toastInfo({html:this.localize("saved"),anchor:"tr"});this.setIsEdited(!1);c=encodeURIComponent(a+"/"+b+"/"+c);-1===location.search.indexOf(c)&&(a=this.getBaseUrl()+"spyral/?githubId\x3d"+c,window.history.pushState({url:a},"Spyral Notebook: "+c,a))},saveCancelled:function(a){this.unmask()},scope:this}})},
init:function(){var a=Ext.Object.fromQueryString(document.location.search,!0),b=Ext.isDefined(a.run),c=/\/spyral\/([\w-]+)\/?$/.exec(location.pathname),d=Ext.isDefined(a.githubId);"inputJsonArrayOfEncodedBase64"in a?Ext.decode(a.inputJsonArrayOfEncodedBase64).forEach(function(a){a=decodeURIComponent(atob(a));0==a.trim().indexOf("\x3c")?this.addText(a):this.addCode(a)},this):"input"in a?0===a.input.indexOf("http")?this.loadFromUrl(a.input,b):this.loadFromString(a.input):c?(this.loadFromId(c[1]),this.setStorageSolution("voyant")):
d?(this.githubDialogs.loadFileFromId(a.githubId),this.setStorageSolution("github")):this.addNew();if(b){var e=this;Ext.defer(function(){e.runAll()},100)}},getBlock:function(a){a=a||0;var b=this.query("notebookcodeeditorwrapper"),c=this.getCurrentBlock().id,d=b.findIndex(function(a){return a.id==c});if(0>d+a||d+a>b.length-1)Ext.Msg.show({title:this.localize("error"),msg:this.localize("blockDoesNotExist"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR});else return content=b[d+a].getContent(),
content.input},addNew:function(){this.setMetadata(new Spyral.Metadata({title:"\x3ch1\x3eSpyral Notebook\x3c/h1\x3e"}));this.addText("\x3cp\x3eThis is a Spyral Notebook, a dynamic document that combines writing, code and data in service of reading, analyzing and interpreting digital texts.\x3c/p\x3e\x3cp\x3eSpyral Notebooks are composed of text blocks (like this one) and code blocks (like the one below). You can \x3cspan class\x3d'marker'\x3eclick on the blocks to edit\x3c/span\x3e them and add new blocks by clicking add icon that appears in the left column when hovering over a block.\x3c/p\x3e");
var a=this.addCode('loadCorpus("austen")');Ext.defer(function(){a.run()},100,this)},clear:function(){this.setMetadata(new Spyral.Metadata);this.getComponent("cells").removeAll()},showSaveDialog:function(a){var b=this.generateExportHtml();this.mask(this.localize("saving"));this.getMetadata().setDateNow("modified");"github"===this.getStorageSolution()?this.githubDialogs.showSave(b):this.voyantStorageDialogs.showSave(b,a?void 0:this.getNotebookId())},loadFromString:function(a){a=a.trim();if(0==a.indexOf("http"))this.loadFromUrl(a);
else if(0==a.indexOf("{")){try{var b=JSON.parse(a)}catch(c){return Ext.Msg.show({title:this.localize("error"),msg:this.localize("cannotLoadJson")+"\x3cbr\x3e\x3cpre style\x3d'color: red'\x3e"+c+"\x3c/pre\x3e",buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR})}if(!b.metadata||!b.blocks)return Ext.Msg.show({title:this.localize("error"),msg:this.localize("cannotLoadJsonUnrecognized"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR});b.blocks.forEach(function(a){Ext.isString(a)&&""!=a?this.addCode({input:a}):
a.input&&("text"==a.type?this.addText(a):this.addCode(a))},this)}else if(/^[\w-_]+$/.test(a))this.loadFromId(a);else{if(0!==a.indexOf("\x3c")||-1==a.indexOf("spyral"))return Ext.Msg.show({title:this.localize("error"),msg:this.localize("cannotLoadUnrecognized"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR});this.loadFromHtmlString(a)}return!0},loadFromId:function(a){this.mask(this.localize("loading"));var b=this;Spyral.Load.trombone({tool:"notebook.NotebookManager",action:"load",id:a,noCache:1}).then(function(a){b.unmask();
b.loadFromString(a.notebook.data);a.notebook.id&&a.notebook.id!=b.getNotebookId()&&b.setNotebookId(a.notebook.id);b.setIsEdited(!1)}).catch(function(a){b.unmask()})},loadFromHtmlString:function(a){a=(new DOMParser).parseFromString(a,"text/html");this.loadFromDom(a)},loadFromDom:function(a){this.setMetadata(new Spyral.Metadata(a));a.querySelectorAll("section.notebook-editor-wrapper").forEach(function(a){var b=a.classList;if(b.contains("notebooktexteditorwrapper"))b=a.querySelector(".notebook-text-editor").innerHTML,
this.addText(b,void 0,a.id);else if(b.contains("notebookcodeeditorwrapper")){var d=a.querySelector(".notebook-code-editor-raw");b=/\beditor-mode-(\w+)\b/.exec(d.className)[1];d="javascript"==b?d.innerText:d.innerHTML;var e=a.querySelector(".notebook-code-results").innerHTML;this.addCode({input:d,output:e,mode:b},void 0,a.id)}},this)},runUntil:function(a){var b=[];Ext.Array.each(this.query("notebookcodeeditorwrapper"),function(c){b.push(c);c.clearResults();if(a&&a==c)return!1},this);this._run(b)},
runFrom:function(a){var b=[],c=!1;Ext.Array.each(this.query("notebookcodeeditorwrapper"),function(d){a&&a==d&&(c=!0);c&&(b.push(d),d.clearResults())},this);this._run(b)},runAll:function(){var a=[];Ext.Array.each(this.query("notebookcodeeditorwrapper"),function(b){a.push(b);b.clearResults()},this);this._run(a)},_run:function(a){if(0<a.length){var b=a.shift().run(!0);if(void 0!==b&&b.then&&b.catch&&b.finally){var c=this;b.then(function(){Ext.defer(c._run,100,c,[a])})}else Ext.defer(this._run,100,this,
[a])}},loadFromUrl:function(a,b){var c=this;Spyral.Load.text(a).then(function(a){c.loadFromString(a)})},addText:function(a,b,c){return this._add(a,b,"notebooktexteditorwrapper",c)},addCode:function(a,b,c){return this._add(a,b,"notebookcodeeditorwrapper",c)},_add:function(a,b,c,d){Ext.isString(a)&&(a={input:a});d=this.getComponent("cells");b="undefined"===typeof b?d.items.length:b;return d.insert(b,Ext.apply(a,{xtype:c,order:b,name:Spyral.Util.id()}))},updateMetadata:function(){var a=this.getMetadata();
this.getComponent("spyralHeader").update(a.title);this.getComponent("spyralFooter").update(this.getInnerFooterHtml())},notebookWrapperMoveUp:function(a){var b=this.getComponent("cells");a=b.items.findIndex("id",a.id);0==a?Ext.Msg.show({title:this.localize("error"),msg:this.localize("cannotMoveHigher"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.WARNING}):(b.move(a,a-1),this.redoOrder())},notebookWrapperMoveDown:function(a){var b=this.getComponent("cells");a=b.items.findIndex("id",a.id);a==b.items.getCount()-
1?Ext.Msg.show({title:this.localize("error"),msg:this.localize("cannotMoveLower"),buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.WARNING}):(b.move(a,a+1),this.redoOrder())},notebookWrapperRemove:function(a){var b=this.getComponent("cells");b.remove(a);0==b.items.length&&this.addText("(Click to edit).");this.redoOrder()},notebookWrapperAdd:function(a,b){var c=this.getComponent("cells").items.findIndex("id",a.id);a=a.getXType(a);("notebooktexteditorwrapper"==a&&!b.hasModifier()||"notebookcodeeditorwrapper"==
a&&b.hasModifier()?this.addCode("",c+1):this.addText("",c+1)).getTargetEl().scrollIntoView(this.getTargetEl(),null,!0,!0);this.redoOrder()},redoOrder:function(){this.query("notebookwrappercounter").forEach(function(a,b){a.setOrder(b)})},setIsEdited:function(a){this.getHeader()&&(this.getHeader().down("#saveItTool").setDisabled(0==a),a||(this.query("notebookcodeeditor").forEach(function(a){a.setIsChangeRegistered(!1)}),this.query("notebooktexteditor").forEach(function(a){a.setIsEditRegistered(!1)})));
this.callParent(arguments)},setNotebookId:function(a){if(a&&-1===location.pathname.indexOf("/spyral/"+a)){var b=this.getBaseUrl()+"spyral/"+a+"/";window.history.pushState({url:b},"Spyral Notebook: "+a,b)}this.callParent(arguments)},generateExportHtml:function(){var a="\x3c!DOCTYPE HTML\x3e\n\x3chtml\x3e\n\x3chead\x3e\n\t\x3cmeta charset\x3d'UTF-8'\x3e\n"+this.getMetadata().getHeaders(),b=document.getElementById("ace-chrome");b&&(a+=b.outerHTML+"\n");a+=document.getElementById("voyant-notebooks-styles").outerHTML+
...
b+".")}return a},getExtraExportItems:function(){return[{inputValue:"html",boxLabel:this.localize("exportHtml")},{inputValue:"htmlDownload",boxLabel:'\x3ca href\x3d"#"\x3e'+this.localize("exportHtmlDownload")+"\x3c/a\x3e",listeners:{afterrender:function(a){var b=(this.getNotebookId()||"spyral")+".html",c=this.generateExportHtml().split("\n"),d={type:"text/html"};try{var e=new File(c,b,d)}catch(f){e=new Blob(c,d)}e=URL.createObjectURL(e);a=a.boxLabelEl.dom.querySelector("a");a.setAttribute("download",
b);a.setAttribute("href",e)},scope:this},handler:function(a){a.boxLabelEl.dom.querySelector("a").click();a.up("window").close()}}]},exportHtml:function(){var a=this.generateExportHtml(),b=window.open();b.document.write(a);b.document.close();b.focus()},exportHtmlDownload:function(){var a=this.generateExportHtml().split("\n"),b={type:"text/plain"};try{var c=new File(a,"files.txt",b)}catch(d){c=new Blob(a,b)}c=URL.createObjectURL(c);this.getApplication().openUrl(c)},getExportUrl:function(a){return location.href},
...
b.set(c.getValues());a.updateMetadata();this.up("window").close()}}]}).show()},showOptionsClick:function(a){void 0===a.optionsWin&&(a.optionsWin=Ext.create("Ext.window.Window",{title:a.localize("gearWinTitle"),closeAction:"hide",layout:"fit",width:400,height:300,bodyPadding:10,items:{xtype:"form",items:[{xtype:"radiogroup",fieldLabel:"Storage Solution",labelAlign:"left",layout:"vbox",items:[{boxLabel:"Voyant",name:"storageSolution",inputValue:"voyant",checked:"voyant"===a.getStorageSolution()},{boxLabel:"GitHub",
name:"storageSolution",inputValue:"github",checked:"github"===a.getStorageSolution()}]}]},buttons:[{text:a.localize("ok"),handler:function(b,c){b=b.findParentByType("window");c=b.down("form");c.isValid()?(c=c.getValues(),a.setStorageSolution(c.storageSolution),b.hide()):a.showError({message:a.localize("invalidForm")})}},{text:a.localize("cancel"),handler:function(a,c){a.findParentByType("window").hide()}}]}));a.optionsWin.show()}});Ext.define("Voyant.VoyantApp",{extend:"Ext.app.Application",mixins:["Voyant.util.Deferrable","Voyant.util.Localization","Voyant.util.Api","Voyant.util.CategoriesManager"],requires:["Voyant.util.ResponseError"],name:"VoyantApp",statics:{i18n:{},api:{palette:"default",lang:void 0,debug:void 0}},config:{baseUrl:void 0,tromboneUrl:void 0},constructor:function(a){this.setBaseUrl(this.config.baseUrl);this.setTromboneUrl(this.config.baseUrl+"trombone");Voyant.application=this;this.mixins["Voyant.util.Api"].constructor.apply(this,
...
scope:this})},listeners:{loadedCorpus:function(a,b){this.setCorpus(b);this.on("unhandledEvent",function(a,d,e){a=this.getBaseUrl()+"?corpus\x3d"+b.getAliasOrId();var c=this.getModifiedApiParams()||{};delete c.view;if("termsClicked"==d)if(Ext.isArray(e)&&"term"in e[0]&&"docIndex"in e[0]){var g={},k={};e.forEach(function(a){g[a.term]=!0;k[a.docIndex]=!0});c.query=Object.keys(g);c.docIndex=Object.keys(k)}else c.query=e;else if("documentsClicked"==d){var h=[];e.forEach&&e.forEach(function(a){h.push(a.getIndex())});
c.docIndex=h}else if("corpusTermsClicked"==d)e.map&&(c.query=e.map(function(a){return a.getTerm()}));else if("documentTermsClicked"==d)e.map&&(c.query=e.map(function(a){return a.getTerm()}),c.docIndex=e.map(function(a){return a.getDocIndex()}));else{console&&console.warn("Unhandled event: "+d,e);return}c.toolFlow&&(d=Ext.Array.from(c.toolFlow.split(",")),c.view=d.shift(),0<d.length?c.toolFlow=d.join(","):delete c.toolFlow);a+="\x26"+Ext.Object.toQueryString(c);this.openUrl(a)})}}});Ext.define("Voyant.panel.DocumentClusters",{extend:"Ext.panel.Panel",alias:"widget.documentclusters",title:"Document Clusters"});
