...
0;g<=c;g+=this.COARSENESS)if(e[f]&&e[f][g]&&null!=this.grid[f+a]&&null!=this.grid[f+a][g+b])return!0;return!1},f;this.grid=[];l=0;f=function(){var a,f,h,k,n=this.wordsToArrange-1,s=g.canvas.width,q=g.canvas.height,r=.5*s,u=.5*q;do{h=p[l];if(void 0!==h){for(var v=Math.random()*Math.PI,z=.25*Math.random()*h.size,w=.5*(Math.random()-.5),F=.5*h.width,I=.5*h.height;;){a=Math.floor((r+Math.cos(v)*z*this.ratio-F)/this.COARSENESS)*this.COARSENESS;f=Math.floor((u+Math.sin(v)*z-I)/this.COARSENESS)*this.COARSENESS;
k=a+F>=s||f+I>=q?!0:d(a,f,h.height,h.width,h.mask);if(!k)break;v+=w;z+=.05}c(a,f,h);if(g.useFadeEffect)for(a=h.alpha=0;a<l;a++)f=p[a],1>f.alpha&&b(f);else h.alpha=1,h.draw(g.context)}l++;if(l>=p.length){clearTimeout(m);this.doingArrange=!1;this.toggleLoadingText(!1);e();break}}while(n--)}.createDelegate(this);d=d.createDelegate(this);c=c.createDelegate(this);b=b.createDelegate(this);a=a.createDelegate(this);this.doingArrange=!0;m=setInterval(f,50)}else alert("Error: There are no words to arrange.")};
...
s=function(a){return doubletree.fieldText(a,"POS")},u=function(a){return"rgba(255,255,255,1)"},A=function(a){return"rgba(255,255,255,1)"},D=function(a){return"red"},H={node:{fill:"white",stroke:"steelblue","stroke-width":"1.5px"},branch:{stroke:"#aaa","stroke-width":"1.5px"}},I=!1,J=d3.dispatch("idsUpdated");J.on("idsUpdated",function(){this==B?(C.setIds(B.continuationIDs),C.updateContinuations()):this==C&&(B.setIds(C.continuationIDs),B.updateContinuations())});var x,G,B,C,K,E;b.init=function(a){d3.select(d3.selectAll(a)).call(this);
return b};b.redraw=function(){void 0!==x&&void 0!==G&&b.setupFromTries(x,G);return b};b.setupFromTries=function(d,k){x=d.getUniqRoot();G=k.getUniqRoot();var v=x.toTree(l.left),z=G.toTree(l.right),w=!0;0<Object.keys(z.pruned).length&&(a(z,z.pruned,w),a(v,z.pruned,w),w=!1);0<Object.keys(v.pruned).length&&(a(v,v.pruned,w),a(z,v.pruned,w));var w={},F;for(F in z.info)"continuations"!=F&&"ids"!=F&&"count"!=F&&(w[F]=z.info[F]);w["right continuations"]=z.info.continuations;w["left continuations"]=v.info.continuations;
w.ids={};c(w.ids,z.info.ids);c(w.ids,v.info.ids);w.count=Object.keys(w.ids).length;K=Object.keys(w.ids);if(z.info.origIDs||v.info.origIDs)w.origIDs={},c(w.origIDs,z.info.origIDs),c(w.origIDs,v.info.origIDs),w.origCount=Object.keys(w.origIDs).length;z.info=w;v.info=w;F=Math.max(v.maxChildren,z.maxChildren);if(isNaN(F)||0==F)return I=!1,b;q?E=d3.scaleLog().range([8,14]):(E=function(){return 14},E.domain=function(){});F=Math.min(v.minCount,z.minCount);E.domain([F,v.info.count]);var L=g-20-20,M=h-20-
20;f.forEach(function(a,b){var c;c=d3.select(a).select("svg");null==c.node()?(c=d3.select(a).append("svg").attr("width",L+20+20).attr("height",M+20+20).attr("cursor","move").call(d3.zoom().scaleExtent([1,1]).on("zoom",function(){var b=d3.event.transform.x+L/2,c=d3.event.transform.y+M/2;d3.select(a).select("svg \x3e g").attr("transform","translate("+b+","+c+")")})),c.append("g").attr("transform","translate("+L/2+","+M/2+")")):(c.attr("width",L+20+20).attr("height",M+20+20),c.selectAll("g *").remove());
B=new doubletree.Tree(c.select("g"),g,h,v,!0,r,J,E,n,p,s,u,A,D,H);C=new doubletree.Tree(c.select("g"),g,h,z,!1,r,J,E,n,p,s,u,A,D,H)});B.handleAltPress=m.alt;C.handleAltPress=m.alt;B.handleShiftPress=m.shift;C.handleShiftPress=m.shift;B.handleClick=m.click;C.handleClick=m.click;I=!0;return b};b.setupFromArrays=function(a,c,d,f,g,h,l,m){void 0==g&&x&&(g=x.caseSensitive());void 0==h&&x&&(h=x.fieldNames());void 0==l&&x&&(l=x.fieldDelim());void 0==m&&x&&(m=x.distinguishingFieldsArray());x=new doubletree.Trie(g,
h,l,m);G=new doubletree.Trie(g,h,l,m);g=c.length;for(h=0;h<g;h++){l=f?f[h]:h;m=c[h];var n=a[h].slice(),s=d[h].slice();n.push(m);n.reverse();s.unshift(m);k?(G.addNgram(n,l),x.addNgram(s,l)):(x.addNgram(n,l),G.addNgram(s,l))}b.setupFromTries(x,G);return b};b.filteredIDs=function(){return K};b.search=function(a){B.search(a);C.search(a);a=d3.select(f[0]);var b=a.selectAll("text.foundText");if(b.empty())return 0;b=b[0].length;null!=a.selectAll("text.rtNdText.foundText").node()&&b--;return b};b.clearSearch=
function(){B.clearSearch();C.clearSearch();return b};b.updateTokenExtras=function(){B.showTokenExtras(n);C.showTokenExtras(n);var a=d3.select(f[0]).select('.tokenExtra[display\x3d"inline"]');a.empty()||"0px"==a.style("height")&&b.redraw();return b};b.visWidth=function(a){if(!arguments.length)return g;g=a;return b};b.visHeight=function(a){if(!arguments.length)return h;h=a;return b};b.prefixesOnRight=function(a){if(!arguments.length)return k;k=a;return b};b.filters=function(a){if(!arguments.length)return l;
l=a;return b};b.handlers=function(a){if(!arguments.length)return m;m=a;return b};b.showTokenExtra=function(a){if(!arguments.length)return n;n=a;return b};b.scaleLabels=function(a){if(!arguments.length)return q;q=a;return b};b.succeeded=function(){return I};b.sortFun=function(a){if(!arguments.length)return r;r=a;return b};b.nodeText=function(a){if(!arguments.length)return p;p=a;return b};b.tokenExtraText=function(a){if(!arguments.length)return s;s=a;return b};b.rectColor=function(a){if(!arguments.length)return u;
u=a;return b};b.rectBorderColor=function(a){if(!arguments.length)return A;A=a;return b};b.continuationColor=function(a){if(!arguments.length)return D;D=a;return b};b.basicStyles=function(a){if(!arguments.length)return H;Object.keys(H).forEach(function(b){b in a&&Object.keys(H[b]).forEach(function(c){c in a[b]&&(H[b][c]=a[b][c])})});return b};return b};doubletree.Tree=function(a,b,c,d,k,l,m,n,q,r,p,s,u,A,D){function H(a){a.children&&(a._children=a.children,a._children.forEach(H),a.children=null)}function I(a){a.parent&&
a.parent.children.forEach(function(b){b!=a&&H(b)})}function J(a,b){d3.event.altKey?v.handleAltPress(a,b):d3.event.shiftKey?v.handleShiftPress(a,b):(v.handleClick(a,b),a.parent&&(v.continuationIDs!=a.data.info.ids&&(v.setIds(a.data.info.ids),v.clickedNode=a.id,m.call("idsUpdated",v)),I(a),x(a,!0)))}function x(a,b){a.children?(a.children&&1==a.children.length&&x(a.children[0],!0),a._children=a.children,a.children=null):(a.children=a._children,a._children=null,a.children&&1==a.children.length&&x(a.children[0],
!1));b&&v.update(a)}function G(a){return k?-a:a}var B=q,C=s;b=b-20-20;c=c-20-20;var K=0,E;l||(l=doubletree.sortByStrFld("token"));var K=0,O=d3.tree().size([c,b]).nodeSize([40,40]),N=d3.linkHorizontal().x(function(a){return G(a.y)}).y(function(a){return a.x});a=a.append("g").attr("transform","translate(20,20)");this.readJSONTree=function(a){E=d3.hierarchy(a);E.x0=0;E.y0=0;E.children.forEach(H);this.update(E)};this.update=function(b){var c=O(E).descendants();c.forEach(function(a){var b=a.textSize;if(void 0==
b){for(var b=0,c=a.parent;null!=c;)var d=Ext.draw.TextMeasurer.measureText(c.data.name,"arial").width,b=b+d,c=c.parent;a.textSize=b}a.y=25*a.depth+b});var d=a.selectAll("g.node_"+k).data(c,function(a){return a.id||(a.id=++K)}),f=d.enter().append("g").attr("class","node node_"+k).attr("cursor","pointer").attr("transform",function(a){return"translate("+G(b.y0)+","+b.x0+")"}).on("click",J);f.append("title").text(function(a){return doubletree.infoToText(a.data.info)});f.append("circle").attr("r",1E-6).style("fill",
function(a){return a._children?"#fff":D.node.fill}).style("stroke",function(a){return D.node.stroke});var g=f.append("text").attr("class",function(a){return 0==a.depth?"rtNdText":""}).attr("x",function(a){return a.children||a._children?0:k?10:-10}).attr("text-anchor",function(a){return a.parent?a.children||a._children?k?"end":"start":k?"start":"end":"middle"}).style("font-size",function(a){return n(a.data.info.count)+"pt"});g.append("tspan").attr("dy",".35em").attr("class","tokenText").text(function(a){return r(a.data.info,
1>a.depth)}).style("fill-opacity",1E-6);g.append("tspan").attr("dx",".35em").attr("class","tokenExtra").text(function(a){return p(a.data.info,1>a.depth)}).style("fill-opacity",1E-6);this.drawRects();f=f.merge(d);f.transition().duration(200).attr("transform",function(a){return"translate("+G(a.y)+","+a.x+")"});f.select("circle").attr("r",function(a){return a.children||a._children?1E-6:4.5}).style("fill",function(a){return a._children?"#fff":D.node.fill}).style("stroke-width",D.node["stroke-width"]);
f.selectAll("tspan").style("fill-opacity",1);d=d.exit().transition().duration(200).attr("transform",function(a){return"translate("+G(b.y)+","+b.x+")"}).remove();d.select("circle").attr("r",1E-6);d.selectAll("tspan").style("fill-opacity",1E-6);d=a.selectAll("path.link_"+k).data(E.links(),function(a){return a.source.id+"-"+a.target.id});d.enter().insert("path","g").attr("class","link link_"+k).attr("d",function(a){a={x:b.x0,y:b.y0};return N({source:a,target:a})}).style("fill","none").style("stroke",
D.branch.stroke).style("stroke-width",D.branch["stroke-width"]).merge(d).transition().duration(200).attr("d",N);d.exit().transition().duration(200).attr("d",function(a){a={x:b.x0,y:b.y0};return N({source:a,target:a})}).remove();c.forEach(function(a){a.x0=a.x;a.y0=a.y});this.updateContinuations()};this.drawRects=function(){var b=B?"inline":"none";a.selectAll(".tokenExtra").attr("display",b);b=a.selectAll("g.node_"+k);b.selectAll("rect").remove();b.insert("rect","text").attr("class","nodeRect").attr("height",
function(){var a=this.parentElement.getBBox().height;6>a&&(a=6.1);return a-6}).attr("y",function(a){return a.parent?-.5*this.parentElement.getBBox().height/2:-.5*this.parentElement.getBBox().height/2-2}).attr("width",function(){return this.parentElement.getBBox().width}).attr("x",function(a){var b=this.parentElement.getBBox().width;return a.parent?k?-.5*b:0:-.33333*b}).style("stroke-opacity",1).style("stroke-width",1).style("stroke",function(a){return u(a.data.info)}).style("fill",function(a){return C(a.data.info)}).style("fill-opacity",
function(a){return 1})};var v=this;this.setIds=function(a){v.continuationIDs=a};this.updateContinuations=function(){a.selectAll("g.node_"+k+" text").classed("continuation",function(a){var b;a:{a=a.data.info.ids;var c=v.continuationIDs||{};for(b in a)if(b in c){b=!0;break a}b=!1}return b}).style("fill",function(a){return d3.select(this).classed("continuation")?A(a.data.info):"#444"})};this.search=function(b){a.selectAll("g.node text").classed("foundText",function(a){return b.test(r(a.data.info))})};
this.clearSearch=function(){a.selectAll("g.node text").classed("foundText",!1)};this.showTokenExtras=function(a){if(0==arguments.length)return B;B=a;this.drawRects();return this};this.setRectColor=function(a){if(0==arguments.length)return C;C=a;this.drawRects();return this};this.handleAltPress=function(){};this.handleShifttPress=function(){};this.handleClick=function(){};this.readJSONTree(d);return this};doubletree.sortByStrFld=function(a){return function(b,c){var d=void 0==b.data.info[a],k=void 0==
...
(function(){doubletree.Trie=function(a,b,c,d,e){function f(a,b,c){this.id=b;this.count=c;this.info={count:c,ids:{}};if(null==a)this.item=k;else{this.item=a;this.info.ids={};this.info.ids[b]=!0;a=a.split(n);for(var d in a)this.info[m[d]]=[a[d]]}this.nodes={};this.addNgram=function(a,b,c){c||(c=1);var d,e;if(0<a.length){d=a.shift();var g=d.split(n);e=r&&this.item==k?"":g.filter(function(a,b){return-1<q.indexOf(m[b])}).map(function(a){return l?a.toLocaleLowerCase():a}).join(n)}else e=d=h;var s;if(e in
this.nodes&&this.nodes[e]instanceof f){s=this.nodes[e];s.info.count+=c;s.info.ids[b]=!0;for(var p in g)e=g[p],-1==s.info[m[p]].indexOf(e)&&s.info[m[p]].push(e)}else s=new f(d,b,c),this.nodes[e]=s;d!=h&&s.addNgram(a,b,c)};this.getUniqRoot=function(){if(this.item==k){var a=Object.keys(this.nodes);if(1==a.length)return this.nodes[a[0]]}return this};this.toTree=function(a){function b(a,c,d){var e={children:[]};e.name=d.item;e.info={};for(var f in d.info)if("Object"===typeof d.info[f]){e.info[f]={};for(var h in d.info[f])e.info[f][h]=
...
glyph:"xf014@FontAwesome",handler:this.resetGraph,scope:this},this.localize("context"),{xtype:"slider",itemId:"contextSlider",minValue:3,value:5,maxValue:30,increment:2,width:50,listeners:{render:function(a){a.setValue(this.getApiParam("context"))},changecomplete:function(a,b){this.setApiParam("context",a.getValue());if(this.getNetworkMode()===this.DEFAULT_MODE){var c=this.getNodeData().map(function(a){return a.term});0<c.length&&(this.setNodeData([]),this.setLinkData([]),this.refresh(),this.loadFromQuery(c))}},
scope:this}}]}]});this.setContextMenu(Ext.create("Ext.menu.Menu",{renderTo:Ext.getBody(),items:[{xtype:"box",itemId:"label",margin:"5px 0px 5px 5px",html:""},{xtype:"menuseparator"},{xtype:"menucheckitem",text:"Fixed",itemId:"fixed",listeners:{checkchange:function(a,b,c){a=this.getCurrentNode();void 0!==a&&(c={fixed:b},b?(c.fx=a.x,c.fy=a.y):(c.fx=null,c.fy=null),this.updateDataForNode(a.id,c))},scope:this}},{xtype:"button",text:"Fetch Collocates",style:"margin: 5px;",handler:function(a,b){var c=this.getCurrentNode();
void 0!==c&&(this.getNetworkMode()===this.CENTRALIZED_MODE&&(this.resetGraph(),this.setNetworkMode(this.DEFAULT_MODE),c.start=0,c.limit=this.getApiParam("limit")),this.fetchCollocatesForNode(c))},scope:this},{xtype:"button",text:"Centralize",style:"margin: 5px;",handler:function(a,b){var c=this.getCurrentNode();void 0!==c&&this.doCentralize(c.term);this.getContextMenu().hide()},scope:this},{xtype:"button",text:"Remove",style:"margin: 5px;",handler:function(a,b){var c=this.getCurrentNode();void 0!==
...
this.getVisLayout().force("x",d3.forceX(c/2)).force("y",d3.forceY(b/2)),Ext.Function.defer(this.zoomToFit,100,this)},this);this.callParent(arguments)},initLoad:function(){this.initGraph();this.setNetworkMode(this.DEFAULT_MODE);if(this.getApiParam("centralize")){this.setNetworkMode(this.CENTRALIZED_MODE);var a=this.getApiParam("centralize");this.doCentralize(a)}else{var a=3,b=this.getApiParam("query");void 0!==b&&(a=b.split(",").length);this.getCorpus().getCorpusTerms({autoLoad:!1}).load({params:{limit:a,
query:b,stopList:this.getApiParam("stopList")},callback:function(a,b,e){e&&this.loadFromCorpusTermRecords(a)},scope:this})}},resetGraph:function(){this.setNodeData([]);this.setLinkData([]);this.setNetworkMode(this.DEFAULT_MODE);this.refresh()},loadFromQuery:function(a){if(Ext.isArray(a)&&0==a.length)this.setApiParam("query",void 0),this.resetGraph();else{this.setApiParams({mode:"corpus",query:a});var b=this.getApiParams();(Ext.isString(a)?[a]:a).forEach(function(a){this.getCorpus().getCorpusCollocates({autoLoad:!1}).load({params:Ext.apply(Ext.clone(b),
{query:a}),callback:function(a,b,c){c&&this.loadFromCorpusCollocateRecords(a)},scope:this})},this)}},loadFromCorpusTermRecords:function(a){if(Ext.isArray(a)&&0<a.length){var b=[];a.forEach(function(a){b.push(a.getTerm())});this.loadFromQuery(b)}},loadFromCorpusCollocateRecords:function(a,b){if(Ext.isArray(a)){var c=this.getApiParam("limit"),d=this.getLayout().getRenderTarget(),e=d.getWidth()/2,f=d.getHeight()/2,g={};this.getNodeData().forEach(function(a){g[a.id]=!0},this);var h=[],k=[];a.forEach(function(a,
d){var n=a.getTerm(),q=a.getContextTerm(),r=a.getKeywordRawFreq(),p=a.getContextTermRawFreq(),s=r,u=p;this.getNetworkMode()===this.CENTRALIZED_MODE&&(s=0,u=Math.log(p));var A=void 0,A=void 0;0==d&&(void 0===b&&(b=this.idGet(n)),void 0!==g[b]?this.updateDataForNode(b,{title:n+" ("+r+")",type:"keyword",value:s}):(g[b]=!0,A={id:b,term:n,title:n+" ("+r+")",type:"keyword",value:s,start:c,fixed:!1,x:e,y:f},h.push(A)));if(n!=q){n=this.idGet(q);void 0===g[n]&&(g[n]=!0,A={id:n,term:q,title:q+" ("+p+")",type:"context",
value:u,start:0,fixed:!1,x:e,y:f},h.push(A));q=null;p=this.getLinkData();for(u=0;u<p.length;u++)if(r=p[u],r.source.id==b&&r.target.id==n||r.source.id==n&&r.target.id==b){q=r;break}p=a.getContextTermRawFreq();null===q&&k.push({source:b,target:n,value:p,id:b+"-"+n})}},this);this.setNodeData(this.getNodeData().concat(h));this.setLinkData(this.getLinkData().concat(k));this.refresh()}},idGet:function(a){return a.replace(/\W/g,"_")},updateDataForNode:function(a,b){for(var c=this.getNodeData(),d=0;d<c.length;d++)if(c[d].id===
a){Ext.apply(c[d],b);break}},removeNode:function(a,b){for(var c=this.getNodeData(),d=0;d<c.length;d++)if(c[d].id===a){c.splice(d,1);break}c=this.getLinkData();for(d=c.length-1;0<=d;d--)c[d].source.id!==a&&c[d].target.id!==a||c.splice(d,1);this.refresh()},doCentralize:function(a){this.setApiParam("centralize",a);this.resetGraph();this.setNetworkMode(this.CENTRALIZED_MODE);a={id:this.idGet(a),term:a,title:a+" (1)",type:"keyword",value:1E3,start:0};this.setNodeData([a]);this.refresh();var b=this.getApiParam("limit");
this.setApiParam("limit",150);this.fetchCollocatesForNode(a);this.setApiParam("limit",b)},applyNetworkMode:function(a){if(this.getVisLayout()){if(a===this.DEFAULT_MODE){var b=this.getGraphPhysics().defaultMode;this.getVisLayout().velocityDecay(b.damping).force("link",d3.forceLink().id(function(a){return a.id}).distance(b.springLength).strength(b.springStrength)).force("charge",d3.forceManyBody().strength(b.nodeGravity)).force("collide",d3.forceCollide(function(a){return Math.sqrt(a.bbox.width*a.bbox.height)*
b.collisionScale}))}else b=this.getGraphPhysics().centralizedMode,this.getVisLayout().velocityDecay(b.damping).force("link",d3.forceLink().id(function(a){return a.id}).distance(b.springLength).strength(b.springStrength)).force("charge",d3.forceManyBody().strength(function(a){return"keyword"===a.type?-1E4:0})).force("collide",d3.forceCollide(function(a){return"keyword"===a.type?a.value:Math.sqrt(a.bbox.width*a.bbox.height)*b.collisionScale}));this.getVisLayout().force("x").strength(b.centralGravity);
this.getVisLayout().force("y").strength(b.centralGravity)}return a},initGraph:function(){var a=this.getLayout().getRenderTarget();a.update("");var b=a.getWidth(),c=a.getHeight();this.setVisLayout(d3.forceSimulation().force("x",d3.forceX(b/2)).force("y",d3.forceY(c/2)).on("tick",function(){this.getLinks().attr("x1",function(a){return a.source.x}).attr("y1",function(a){return a.source.y}).attr("x2",function(a){return a.target.x}).attr("y2",function(a){return a.target.y});this.getNodes().attr("transform",
function(a){var b=a.x,c=a.y;if(this.getNetworkMode()===this.DEFAULT_MODE||"keyword"!==a.type)b-=.5*a.bbox.width,c-=.5*a.bbox.height;return"translate("+b+","+c+")"}.bind(this));!this.getDragging()&&.075>this.getVisLayout().alpha()&&this.getVisLayout().alpha(-1)}.bind(this)).on("end",function(){Ext.Function.defer(this.zoomToFit,100,this)}.bind(this)));var a=d3.select(a.dom).append("svg").attr("id",this.getVisId()).attr("class","linksGraph").attr("width",b).attr("height",c),d=a.append("g"),b=d3.zoom().scaleExtent([.25,
4]).on("zoom",function(){d.attr("transform",d3.event.transform)});this.setZoom(b);a.call(b);a.on("click",function(){this.getContextMenu().hide()}.bind(this));this.setLinks(d.append("g").attr("class","links").selectAll(".link"));this.setNodes(d.append("g").attr("class","nodes").selectAll(".node"));this.setVis(d)},resetGraph:function(){this.setNodeData([]);this.setLinkData([]);this.refresh()},refresh:function(){var a=this,b=this.getNodeData(),c=this.getLinkData(),d=this.getLinks().data(c,function(a){return a.id});
d.exit().remove();var e=d.enter().append("line").attr("class","link").attr("id",function(a){return a.id}).on("mouseover",a.linkMouseOver.bind(a)).on("mouseout",a.linkMouseOut.bind(a)).on("click",function(a){d3.event.stopImmediatePropagation();d3.event.preventDefault();this.dispatchEvent("termsClicked",this,['"'+a.source.term+" "+a.target.term+'"~'+this.getApiParam("context")])}.bind(a)).style("cursor","pointer").style("stroke-width",function(b){return a.getNetworkMode()===a.DEFAULT_MODE?Math.max(1,
Math.min(15,Math.sqrt(b.value))):1});this.setLinks(e.merge(d));d=this.getNodes().data(b,function(a){return a.id});d.exit().remove();e=d.enter().append("g").attr("class",function(a){return"node "+a.type}).attr("id",function(a){return a.id}).on("mouseover",a.nodeMouseOver.bind(a)).on("mouseout",a.nodeMouseOut.bind(a)).on("click",function(a){d3.event.stopImmediatePropagation();d3.event.preventDefault();this.dispatchEvent("termsClicked",this,[a.term])}.bind(a)).on("dblclick",function(a){d3.event.stopImmediatePropagation();
d3.event.preventDefault();this.fetchCollocatesForNode(a)}.bind(a)).on("contextmenu",function(b,c){d3.event.preventDefault();var d=a.getContextMenu();d.queryById("label").setHtml(b.term);d.queryById("fixed").setChecked(b.fixed);d.showAt(d3.event.pageX+10,d3.event.pageY-50)}).call(d3.drag().on("start",function(b){a.setDragging(!0);d3.event.active||a.getVisLayout().alpha(.3).restart();b.fx=b.x;b.fy=b.y;b.fixed=!0}).on("drag",function(b){a.getVisLayout().alpha(.3);b.fx=d3.event.x;b.fy=d3.event.y;a.isMasked()?
a.isOffCanvas(d3.event.x,d3.event.y)||a.unmask():a.isOffCanvas(d3.event.x,d3.event.y)&&a.mask(a.localize("releaseToRemove"))}).on("end",function(b){a.setDragging(!1);1!=b.fixed&&(b.fx=null,b.fy=null);a.isOffCanvas(d3.event.x,d3.event.y)&&(a.unmask(),a.mask(a.localize("cleaning")),a.removeNode(b.id),a.unmask())}));e.append("title").text(function(a){return a.title});this.getNetworkMode()===this.DEFAULT_MODE?e.append("rect").style("stroke-width",1).style("stroke-opacity",1):e.filter(function(a){return"keyword"===
a.type}).append("circle").style("stroke-width",1).style("stroke-opacity",1);e.append("text").attr("font-family",function(b){return a.getApplication().getFeatureForTerm("font",b.term)}).attr("font-size",function(a){return Math.max(10,Math.sqrt(a.value))}).text(function(a){return a.term}).each(function(a){a.bbox=this.getBBox()}).style("cursor","pointer").style("user-select","none").attr("dominant-baseline","middle");this.setNodes(e.merge(d));this.getNetworkMode()===this.DEFAULT_MODE?(this.getVis().selectAll("rect").attr("width",
function(a){return a.bbox.width+16}).attr("height",function(a){return a.bbox.height+8}).attr("rx",function(a){return Math.max(2,.2*a.bbox.height)}).attr("ry",function(a){return Math.max(2,.2*a.bbox.height)}).call(this.applyNodeStyle.bind(this)),this.getVis().selectAll("text").attr("dx",8).attr("dy",function(a){return.5*a.bbox.height+4})):(this.getVis().selectAll("circle").attr("r",function(a){return Math.min(150,a.bbox.width)}).call(this.applyNodeStyle.bind(this)),this.getVis().selectAll("text").attr("dx",
function(a){return"keyword"===a.type?.5*-a.bbox.width:8}).attr("dy",function(a){return"keyword"===a.type?0:.5*a.bbox.height+4}));this.getVis().selectAll("line").call(this.applyLinkStyle.bind(this));this.getVisLayout().nodes(b);this.getVisLayout().force("link").links(c);this.getVisLayout().alpha(1).restart()},isOffCanvas:function(a,b){var c=Ext.get(this.getVisId());return 0>a||0>b||a>c.getWidth()||b>c.getHeight()},zoomToFit:function(a,b){var c=this.getVis().node().getBBox(),d=c.width,e=c.height,f=
c.x+d/2,g=c.y+e/2,c=this.getVis().node().parentElement,h=c.getBoundingClientRect(),k=h.width,h=h.height,e=(a||.8)/Math.max(d/k,e/h),f=[k/2-e*f,h/2-e*g];1>d||d3.select(c).transition().duration(b||500).call(this.getZoom().transform,d3.zoomIdentity.translate(f[0],f[1]).scale(e))},applyNodeStyle:function(a,b){var c=void 0===b?"normal":b;a.style("fill",function(a){a=a.type+"Node";return this.getGraphStyle()[a][c].fill}.bind(this));a.style("stroke",function(a){a=a.type+"Node";return this.getGraphStyle()[a][c].stroke}.bind(this))},
applyLinkStyle:function(a,b){var c=void 0===b?"normal":b;a.style("stroke",function(a){return this.getGraphStyle().link[c].stroke}.bind(this));a.style("stroke-opacity",function(a){return this.getGraphStyle().link[c].strokeOpacity}.bind(this))},linkMouseOver:function(a){this.getVis().selectAll("line").call(this.applyLinkStyle.bind(this));this.getVis().select("#"+a.id).call(this.applyLinkStyle.bind(this),"highlight")},linkMouseOut:function(a){this.getVis().selectAll("line").call(this.applyLinkStyle.bind(this))},
nodeMouseOver:function(a){this.setCurrentNode(a);this.getVis().selectAll("rect").call(this.applyNodeStyle.bind(this));this.getLinks().each(function(b){var c;b.source.id==a.id?c=b.target.id:b.target.id==a.id&&(c=b.source.id);void 0!==c&&(this.getVis().select("#"+c+" rect").call(this.applyNodeStyle.bind(this),"highlight"),this.getVis().select("#"+b.id).call(this.applyLinkStyle.bind(this),"highlight"))}.bind(this));this.getVis().select("#"+a.id+" rect").style("stroke-width",3).call(this.applyNodeStyle.bind(this),
"highlight")},nodeMouseOut:function(a){this.getContextMenu().isVisible()||this.setCurrentNode(void 0);this.getVis().selectAll("rect").style("stroke-width",1).call(this.applyNodeStyle.bind(this));this.getVis().selectAll("line").call(this.applyLinkStyle.bind(this))},fetchCollocatesForNode:function(a){var b=this.getApiParam("limit");this.getCorpus().getCorpusCollocates({autoLoad:!1}).load({params:Ext.apply(this.getApiParams(),{query:a.term,start:a.start,limit:b}),callback:function(c,d,e){e&&(this.updateDataForNode(a.id,
{start:a.start+b}),this.loadFromCorpusCollocateRecords(c,a.id))},scope:this})}});Ext.define("Voyant.panel.Contexts",{extend:"Ext.grid.Panel",mixins:["Voyant.panel.Panel"],requires:["Voyant.data.store.Contexts"],alias:"widget.contexts",isConsumptive:!0,statics:{i18n:{},api:{query:void 0,docId:void 0,docIndex:void 0,stopList:"auto",context:5,expand:50},glyph:"xf0ce@FontAwesome"},constructor:function(){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(){var a=this;Ext.apply(a,{title:this.localize("title"),emptyText:this.localize("emptyText"),
...
"document"===this.getApiParam("mode")&&this.documentStore.load({params:a});"corpus"===this.getApiParam("mode")&&(delete a.bins,this.corpusStore.load({params:a}))}});Ext.define("Voyant.panel.Trends",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],requires:["Voyant.data.store.Documents"],alias:"widget.trends",config:{options:[{xtype:"stoplistoption"},{name:"bins",xtype:"slider",labelAlign:"right",width:200,minValue:2,maxValue:100,listeners:{afterrender:function(a){var b=a.up("window").panel;a.setFieldLabel(b.localize("segmentsSlider"))}}},{xtype:"radiogroup",labelAlign:"right",columns:3,vertical:!0,name:"withDistributions",items:[{boxLabel:"raw",name:"withDistributions",
inputValue:"raw"},{boxLabel:"relative",name:"withDistributions",inputValue:"relative",style:"margin-left: 1em;"}],listeners:{afterrender:function(a){var b=this.up("window").panel;this.setFieldLabel("frequencies");var c=b.getApiParam("withDistributions");a.getBoxes().forEach(function(a){a.setBoxLabel(b.localize(a.inputValue));a.checked=a.inputValue==c});this.setValue({withDistributions:c})}}},{xtype:"colorpaletteoption"}]},statics:{i18n:{relativeTitle:"Relative Frequencies",rawTitle:"Raw Frequencies",
corpusTitle:"Corpus (Documents)",segmentsTitle:"Document Segments",toggleTip:"Click to toggle the visibility of this series.",reset:"Reset",resetTip:"Reset to initial view.",dblClickItem:"Double-click to drilldown.",drillTerm:"Terms",drillTermTip:"View the distribution of this term within all documents.",drillDocument:"Document",drillDocumentTip:"View the distribution of all current terms within this document.",noResults:"No Results",segment:"segment:",display:"Display",labels:"Show Labels",area:"Area",
bar:"Columns",line:"Line",stacked:"Stacked Bar",barline:"Line + Stacked Bar"},api:{limit:5,stopList:"auto",query:void 0,withDistributions:"relative",bins:10,docIndex:void 0,docId:void 0,mode:"corpus",chartType:"barline",labels:!1},glyph:"xf201@FontAwesome"},layout:"fit",documentTermsStore:void 0,constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(){this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);
Ext.apply(this,{title:this.localize("title"),dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"querysearchfield"},{itemId:"reset",text:this.localize("reset"),tooltip:this.localize("resetTip"),handler:function(a){this.setApiParams({docIndex:void 0,mode:void 0,query:void 0});this.loadCorpusTerms()},scope:this},{text:this.localize("display"),tooltip:this.localize("displayTip"),glyph:"xf013@FontAwesome",menu:{listeners:{afterrender:function(a){var b=this.getApiParam("chartType");
a.items.each(function(a){a.getItemId()==b&&a.addCls(a.activeCls)})},scope:this},defaults:{xtype:"menuitem",handler:function(a,b){"menucheckitem"==a.xtype?this.setApiParam("labels",a.checked):this.setApiParam("chartType",a.getItemId());this.loadCorpusTerms()},scope:this},items:[{xtype:"menucheckitem",text:this.localize("labels"),tooltip:this.localize("labelsTip"),checked:!0===this.getApiParam("labels")||"true"==this.getApiParam("labels")},"-",{itemId:"area",text:this.localize("area"),tooltip:this.localize("areaTip"),
glyph:"xe76b@Sencha-Examples"},{itemId:"bar",text:this.localize("bar"),tooltip:this.localize("barTip"),glyph:"xe768@Sencha-Examples"},{itemId:"line",text:this.localize("line"),tooltip:this.localize("lineTip"),glyph:"xe773@Sencha-Examples"},{itemId:"stacked",text:this.localize("stacked"),tooltip:this.localize("stackedTip"),glyph:"xe6c8@Sencha-Examples"},{itemId:"barline",text:this.localize("barline"),tooltip:this.localize("barlineTip"),glyph:"xe779@Sencha-Examples"}]}}]}]});this.callParent(arguments)},
listeners:{loadedCorpus:function(a,b){this.loadCorpusTerms()},termsClicked:function(a,b){var c=[];b.forEach(function(a){Ext.isString(a)?c.push(a):a.term?c.push(a.term):a.getTerm&&c.push(a.getTerm())});this.setApiParam("query",c&&0<c.length?c:void 0);this.loadCorpusTerms()},corpusTermsClicked:function(a,b){this.setApiParam("query",b.map(function(a){return a.getTerm()}));this.loadCorpusTerms()},documentSelected:function(a,b){this.setApiParam("docIndex",this.getCorpus().getDocument(b).getIndex());this.loadDocumentTerms()},
documentsClicked:function(a,b){1==b.length&&this.fireEvent("documentSelected",this,b[0])},query:function(a,b){this.fireEvent("termsClicked",this,b)}},loadCorpusTerms:function(a){if(2>this.getCorpus().getDocumentsCount()||"document"==this.getApiParam("mode")||0<Array.from(this.getApiParam("docIndex")||"").length)return this.loadDocumentTerms();if(this.getApiParam("query")){a=a||{};this.getApiParam("withDistributions");Ext.applyIf(a,{bins:this.getCorpus().getDocumentsCount(),limit:1E3,stopList:""});
var b=this.getCorpus().map(function(a){return a.getTinyTitle()});Ext.applyIf(a,this.getApiParams());this.getCorpus().getCorpusTerms().load({params:a,callback:function(a,d,e){var f=[],g=[],h=this.getApiParam("chartType");a.forEach(function(a,c){var d=a.get("term");a.get("docIndex");var e=this.getApplication().getColorForTerm(d,!0);a.get("distributions").forEach(function(a,e){f[e]||(f[e]={index:b[e]});f[e]["_"+c]=a;f[e]["term"+c]=d},this);"bar"!=h&&("barline"==h?["bar","line"]:[h]).forEach(function(a){g.push({type:"stacked"==
a?"bar":a,title:d,xField:"index",yField:"_"+c,term:d,colors:[e],label:"barline"==h&&"bar"==a?{display:"none"}:{field:"term"+c}})},this)},this);d=a.map(function(a){return a.getTerm()});e=d.map(function(a){return this.getApplication().getColorForTerm(a,!0)},this);"bar"==h&&g.push({type:"bar",title:d,colors:e,xField:"index",yField:0<f.length?Object.keys(f[0]).filter(function(a){return"_"==a.charAt(0)}):void 0,label:{field:a.map(function(a,b){return"term"+b})}});a=Ext.create("Ext.data.JsonStore",{fields:0<
f.length?Object.keys(f[0]):void 0,data:f});this.buildChart({store:a,series:g,axes:[{type:"numeric",position:"left",increment:1,title:{text:this.localize(this.getApiParam("withDistributions")+"Title")}},{type:"category",position:"bottom",title:{text:this.localize("corpusTitle")}}]})},scope:this})}else this.getCorpus().getCorpusTerms().load({params:{limit:5,stopList:this.getApiParam("stopList")},callback:function(a,b,e){this.setApiParam("query",a.map(function(a){return a.getTerm()}));this.loadCorpusTerms()},
scope:this})},getItemToolTip:function(a,b,c){var d=c.field.split("_"),e=2==d.length?c.index:d[2],d=parseInt(d[1]),f=c.series.getTitle(),f=Ext.isArray(f)?f[d]:f,g=c.series.getColors();b="\x3cspan class\x3d'x-legend-item-marker' style\x3d'background:"+(1==g.length?g[0]:g[d])+"; left: 2px;'\x3e\x3c/span\x3e \x3cspan style\x3d'padding-left: 1.2em; font-weight: bold;'\x3e"+f+"\x3c/span\x3e: +"+b.get(c.field)+"\x3cbr/\x3e\x3ci\x3e"+this.getCorpus().getDocument(e).getShortTitle()+"\x3c/i\x3e";b="corpus"==
this.getApiParam("mode")?b+("\x3cdiv style\x3d'font-size: smaller'\x3e"+this.localize("dblClickItem")):b+("\x3cbr/\x3e"+this.localize("segment")+" "+(c.index+1));a.setHtml(b)},loadDocumentTerms:function(a){if(this.getApiParam("query")){this.setApiParam("mode","document");a=a||{};this.getApiParam("withDistributions");Ext.applyIf(a,{limit:0,sort:"termasc",stopList:void 0});this.getCorpus().map(function(a){return a.getTinyTitle()});var b;b=1==this.getCorpus().getDocumentsCount()?this.getCorpus().getDocument(0):
this.getCorpus().getDocument(this.getApiParam("docIndex"));Ext.applyIf(a,this.getApiParams());this.getCorpus().getDocumentTerms().load({params:a,callback:function(a,d,e){var f=[],g=[],h=this.getApiParam("chartType");b||a.sort(function(a,b){return a.getTerm()==b.getTerm()?a.getDocIndex()-b.getDocIndex():a.getTerm().localeCompare(b.getTerm())});a.forEach(function(a,c){var d=a.get("term"),e=a.get("docIndex"),k=b?this.getApplication().getColorForTerm(d,!0):this.getApplication().getColor(e,!0),e=a.get("docIndex");
a.get("distributions").forEach(function(a,b){f[b]||(f[b]={docIndex:e,index:b+1});f[b]["_"+c+"_"+e]=a;f[b]["term"+c]=d},this);"bar"!=h&&("barline"==h?["bar","line"]:[h]).forEach(function(a){g.push({type:"stacked"==a?"bar":a,title:b?d:e+1+") "+d,xField:"index",yField:"_"+c+"_"+e,term:d,colors:[k],label:"barline"==h&&"bar"==a?{display:"none"}:{field:"term"+c}})},this)},this);if("bar"==h){var k=Ext.Array.unique(a.map(function(a){return a.getTerm()})).length;d=a.map(function(a){return 1+a.get("docIndex")+
") "+a.getTerm()});a=a.map(function(a){return k?this.getApplication().getColor(a.get("docIndex"),!0):this.getApplication().getColorForTerm(a.getTerm(),!0)},this);g.push({type:"bar",title:0<d.length?d:this.localize("noResults"),colors:a,xField:"index",yField:0<f.length?Object.keys(f[0]).filter(function(a){return"_"==a.charAt(0)}):void 0,label:{field:d}})}a=Ext.create("Ext.data.JsonStore",{fields:0<f.length?Object.keys(f[0]):void 0,data:f});this.buildChart({store:a,series:g,axes:[{type:"numeric",position:"left",
title:{text:this.localize(this.getApiParam("withDistributions")+"Title")}},{type:"category",position:"bottom",title:{text:this.localize("segmentsTitle")+(b?" ("+b.getShortTitle()+")":"")}}]})},scope:this})}else this.getCorpus().getCorpusTerms().load({params:{limit:2>this.getCorpus().getDocumentsCount()?5:2,stopList:this.getApiParam("stopList")},callback:function(a,b,e){this.setApiParam("query",a.map(function(a){return a.getTerm()}));this.loadDocumentTerms()},scope:this})},buildChart:function(a){var b=
this.getApiParam("chartType"),c=!1;if(!0===this.getApiParam("labels")||"true"==this.getApiParam("labels"))c=!0;Ext.applyIf(a,{cls:this.getApiParam("mode")});a.series.forEach(function(a){Ext.applyIf(a,{stacked:"bar"==a.type?!1:!0,showInLegend:"barline"==b&&"line"==a.type?!1:!0,smooth:!0,showMarkers:"bar"==a.type?!1:!0,marker:"barline"==b&&"line"==a.type?null:{type:"circle",radius:2},style:{lineWidth:1,fillOpacity:"barline"==b&&"bar"==a.type?.01:1,strokeOpacity:"barline"==b&&"bar"==a.type?.1:1},highlight:!0,
highlightCfg:{scaling:"bar"==a.type?1.1:2},label:{},tooltip:{trackMouse:!0,renderer:this.getItemToolTip,scope:this},listeners:{itemclick:function(a,b,c,d){this.clickTimer&&clearTimeout(this.clickTimer);if(!this.blockClick)if(this.blockClick=!0,Ext.defer(function(){this.blockClick=!1},1E3,this),"document"==this.getApiParam("mode"))a=b.field.split("_"),c=a[2],c=this.getCorpus().getDocument(c).get("tokensCount-lexical"),c=parseInt(b.index*c/parseInt(this.getApiParam("bins"))),this.dispatchEvent("documentIndexTermsClicked",
this,[{term:b.series.term,docIndex:a[2],position:c}]);else{this.clickTimer&&clearTimeout(this.clickTimer);var e=this;this.clickTimer=setTimeout(function(){e.dispatchEvent("documentIndexTermsClicked",e,[{term:b.series.term,docIndex:b.index}])},300)}},itemdblclick:function(a,b,c,d){this.clickTimer&&clearTimeout(this.clickTimer);this.blockClick=!0;Ext.defer(function(){this.blockClick=!1},1E3,this);"document"!=this.getApiParam("mode")&&Ext.create("Ext.menu.Menu",{items:[{text:this.localize("drillTerm"),
tooltip:this.localize("drillTermTip"),handler:function(){this.setApiParams({mode:"document",query:b.series.term});this.loadDocumentTerms()},scope:this},{text:this.localize("drillDocument"),tooltip:this.localize("drillDocumentTip"),handler:function(){this.setApiParams({mode:"document",docIndex:b.index});this.loadDocumentTerms()},scope:this}],listeners:{hide:function(a){Ext.defer(function(){this.destroy()},200,a)},scope:this}}).showAt(c.pageX,c.pageY)},scope:this}});Ext.applyIf(a.label,{display:"over",
field:"index",fontSize:11,translateY:"line"==b?9:void 0});c||(a.label.display="none")},this);Ext.applyIf(a,{animation:!0,plugins:{ptype:"chartitemevents",moveEvents:!0},legend:{docked:"top",listeners:{itemclick:function(a,b,c,d){if(a.getStore().getCount()<a.chart.series.length&&"barline"==this.getApiParam("chartType")){var k=b.get("name"),l=b.get("disabled");a.chart.series.forEach(function(a){a.getTitle()==k&&a.setHidden(l)});a.chart.redraw()}},scope:this}},interactions:["itemhighlight","crosszoom"],
listeners:{}});Ext.applyIf(a.listeners,{itemhighlightchange:function(a,b){a.el.dom.style.cursor=b?"pointer":""},afterrender:function(){},scope:this});a.axes.forEach(function(b){Ext.applyIf(b,{title:{},label:{}});Ext.applyIf(b.title,{scaling:.75});Ext.applyIf(b.label,{scaling:.75});if("category"==b.type){var c="";a.store.each(function(a){c+=a.get("index")});c.length>this.getTargetEl().getWidth()/9&&Ext.applyIf(b.label,{rotate:{degrees:-30}});Ext.applyIf(b,{labelInSpan:!0})}},this);this.query("chart").forEach(function(a){this.remove(a,
!0)},this);var d=Ext.create("Ext.chart.CartesianChart",a);this.add(d)},reloadFromChart:function(){var a=this.down("chart");if(a){var b=[];a.series.forEach(function(a){b.push(a.getTitle())});this.fireEvent("termsClicked",this,b)}}});Ext.define("Voyant.panel.NoTool",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.notool",statics:{i18n:{},api:{tool:void 0}},config:{html:void 0,notYetImplemented:"Centroid DocumentInputAdd DocumentTypeCollocateFrequenciesGrid EntitiesBrowser Equalizer FeatureClusters Flowerbed KwicsTagger Lava Mandala MicroSearch NetVizApplet PaperDrill RezoViz Sunburst Termometer Ticker TokensViz ToolBrowser ToolBrowserLarge VoyeurTagline WordCloud VoyeurTagline WordCountFountain".split(" ")},
