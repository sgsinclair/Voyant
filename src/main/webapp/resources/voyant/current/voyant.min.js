...
changecomplete:function(a,c){this.setApiParams({visible:c});this.loadFromTermsRecords()},scope:this}}]}]});this.callParent(arguments)},listeners:{afterrender:function(){var a=this.getApiParam("inlineData");void 0!==a&&(a=Ext.decode(a,!0),null!==a&&(this.setApiParam("inlineData",a),this.setTerms(a),this.initVisLayout(),this.buildFromTerms()))},resize:function(a,b,c){this.getVisLayout()&&this.getCorpus()&&(this.setAdjustedSizes(),a=this.getLayout().getRenderTarget(),b=a.getWidth(),c=a.getHeight(),a.down("svg").set({width:b,
