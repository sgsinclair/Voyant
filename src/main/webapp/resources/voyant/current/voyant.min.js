...
$.ajax({type:"POST",url:Voyant.application.getTromboneUrl(),data:b,dataType:"json"}).done(function(a){d.set(a.corpus.metadata);a=Ext.create("Voyant.data.store.Documents",{corpus:d});d.setDocumentsStore(a);a.load({params:{limit:1E5},callback:function(a,b,e){d.setDocumentsStore(this);c.resolve(d)},scope:a})}).fail(function(a){Voyant.application.showResponseError(d.localize("failedCreateCorpus"),a);c.reject()});return Voyant.application.getPromiseFromDeferred(c)}},getId:function(){return this.then?Voyant.application.getDeferredNestedPromise(this,
