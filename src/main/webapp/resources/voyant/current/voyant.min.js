...
statics:{i18n:{}},fields:[{name:"documentsCount",type:"int"},{name:"lexicalTokensCount",type:"int"},{name:"lexicalTypesCount",type:"int"},{name:"createdTime",type:"int"},{name:"createdDate",type:"date",dateFormat:"c"},{name:"title",type:"string"},{name:"subTitle",type:"string"}],constructor:function(a){a=a||{};this.callParent([]);if(a){if(Ext.isString(a)||Ext.isArray(a))a=Ext.isString(a)&&0==/\s/.test(a)&&-1==a.indexOf(":")?{corpus:a}:{input:a};Ext.apply(a,{tool:"corpus.CorpusMetadata"});var b=Voyant.application.getDeferred(this),
c=this;Ext.Ajax.request({url:Voyant.application.getTromboneUrl(),params:a}).then(function(b){c.set(Ext.JSON.decode(b.responseText).corpus.metadata);var e="titles-"+c.getId();a.corpusTitle||a.corpusSubTitle?(c.set("title",a.corpusTitle),c.set("subTitle",a.corpusSubTitle),Ext.Ajax.request({url:Voyant.application.getTromboneUrl(),params:{tool:"resource.StoredResource",storeResource:Ext.encode({title:a.corpusTitle,subTitle:a.corpusSubTitle}),resourceId:e}})):Ext.Ajax.request({url:Voyant.application.getTromboneUrl(),
params:{tool:"resource.StoredResource",verifyResourceId:e}}).then(function(a){(a=Ext.util.JSON.decode(a.responseText))&&a.storedResource&&a.storedResource.id&&""!=a.storedResource.id&&Ext.Ajax.request({url:Voyant.application.getTromboneUrl(),params:{tool:"resource.StoredResource",retrieveResourceId:e}}).then(function(a){a=Ext.util.JSON.decode(a.responseText).storedResource.resource;a=Ext.decode(a);c.set(a)})});return c}).otherwise(function(a){Voyant.application.showResponseError(c.localize("failedCreateCorpus"),
a)}).then(function(d){!("docsLimit"in a)||!1!==a.docsLimit&&0<a.docsLimit?c.getDocuments().load({params:{limit:"docsLimit"in a?a.docsLimit:c.getDocumentsCount()},callback:function(a,f,g){g?(c.setDocumentsStore(this),b.resolve(d)):b.reject(f)}}):b.resolve(d)});return b.promise}},getId:function(){return this.then?Voyant.application.getDeferredNestedPromise(this,arguments):this.get("id")},getAliasOrId:function(){return this.then?Voyant.application.getDeferredNestedPromise(this,arguments):this.get("alias")||
this.get("id")},loadCorpusTerms:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments);var b=Voyant.application.getDeferred(this);a=a||{};Ext.isNumber(a)&&(a={limit:a});Ext.applyIf(a,{limit:0});var c=this.getCorpusTerms();c.load({params:a,callback:function(a,e,f){f?b.resolve(c):b.reject(e)}});return b.promise},loadTokens:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments);var b=Voyant.application.getDeferred(this);a=a||{};
Ext.isNumber(a)&&(a={limit:a});Ext.applyIf(a,{limit:0});var c=this.getTokens();c.load({params:a,callback:function(a,e,f){f?b.resolve(c):b.reject(e)}});return b.promise},getCorpusTerms:function(a){return Ext.create("Voyant.data.store.CorpusTerms",Ext.apply(a||{},{corpus:this}))},getTokens:function(a){return Ext.create("Voyant.data.store.Tokens",Ext.apply(a||{},{corpus:this}))},each:function(a){debugger;this.getDocuments().each.call(this,arguments)},getCorpusCollocates:function(a){return Ext.create("Voyant.data.store.CorpusCollocates",
Ext.apply(a||{},{corpus:this}))},getDocumentQueryMatches:function(a){return Ext.create("Voyant.data.store.DocumentQueryMatches",Ext.apply(a||{},{corpus:this}))},getDocumentTerms:function(a){return Ext.create("Voyant.data.store.DocumentTerms",Ext.apply(a||{},{corpus:this}))},getContexts:function(a){return Ext.create("Voyant.data.store.Contexts",Ext.apply(a||{},{corpus:this}))},getDocuments:function(a){return this.getDocumentsStore()?this.getDocumentsStore():Ext.create("Voyant.data.store.Documents",
Ext.apply(a||{},{corpus:this}))},getDocument:function(a){if(this.getDocumentsStore()){if(a instanceof Voyant.data.model.Document)return a;if(Ext.isNumeric(a))return this.getDocumentsStore().getAt(parseInt(a));if(Ext.isString(a))return this.getDocumentsStore().getById(a)}return this.then?Voyant.application.getDeferredNestedPromise(this,arguments):this.getDocumentsStore().getDocument(a)},getDocumentsCount:function(){return this.then?Voyant.application.getDeferredNestedPromise(this,arguments):this.get("documentsCount")},
getWordTokensCount:function(){return this.then?Voyant.application.getDeferredNestedPromise(this,arguments):this.get("lexicalTokensCount")},getWordTypesCount:function(){return this.then?Voyant.application.getDeferredNestedPromise(this,arguments):this.get("lexicalTypesCount")},getCreatedTime:function(){return this.then?Voyant.application.getDeferredNestedPromise(this,arguments):this.get("createdTime")},requiresPassword:function(){var a=this.getNoPasswordAccess();return"NONE"==a||"NONCONSUMPTIVE"==a},
getNoPasswordAccess:function(){return this.then?Voyant.application.getDeferredNestedPromise(this,arguments):this.get("noPasswordAccess")},getTitle:function(){return this.then?Voyant.application.getDeferredNestedPromise(this,arguments):this.get("title")},getSubTitle:function(){return this.then?Voyant.application.getDeferredNestedPromise(this,arguments):this.get("subTitle")},show:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments);show(this.getString(a))},getString:function(a){var b=
this.getDocumentsCount(),c=this.localize("thisCorpus");if(0==b)c+=" "+this.localize("isEmpty")+".";else{var c=c+" ",c=1<b?c+(new Ext.XTemplate(this.localize("hasNdocuments"))).apply({count:Ext.util.Format.number(b,"0,000")}):c+this.localize("has1document"),c=c+(" "+(new Ext.XTemplate(this.localize("widthNwordsAndNTypes"))).apply({words:Ext.util.Format.number(this.getWordTokensCount(),"0,000"),types:Ext.util.Format.number(this.getWordTypesCount(),"0,000")})+"."),c=c+(" "+this.localize("created")+" "),
...
this.stripPunctuation(a));this.getKwicStore().load({params:this.getApiParams()})},reload:function(){var a=this.getApiParam("query");void 0!==a&&this.setRoot(a)},stripPunctuation:function(a){if(Ext.isString(a))return a.replace(/[.,\/#!$%\^&\*;:{}=\-_`~()]/g,"");var b=[];a.forEach(function(a){b.push(a.replace(/[.,\/#!$%\^&\*;:{}=\-_`~()]/g,""))});return b}});Ext.define("Voyant.panel.Topics",{extend:"Ext.grid.Panel",mixins:["Voyant.panel.Panel","Voyant.widget.LiveSearchGrid"],alias:"widget.topics",statics:{i18n:{runningIterationsCount:"Running {0} iterations."},api:{stopList:"auto",numTopics:25,iterations:50,perDocLimit:1E3,query:void 0},glyph:"xf1ea@FontAwesome"},config:{options:[{xtype:"stoplistoption"},{xtype:"numberfield",name:"perDocLimit",fieldLabel:"maximum words per document",labelAlign:"right",value:1E3,minValue:0,step:100,listeners:{afterrender:function(a){var b=
a.up("window");b&&b.panel&&(a.setValue(parseInt(b.panel.getApiParam("perDocLimit"))),a.setFieldLabel(b.panel.localize("perDocLimit")))},change:function(a,b){var c=a.up("window");5E3<b&&c&&c.panel&&c.panel.toastInfo({html:c.panel.localize("perDocLimitHigh"),anchor:c.getTargetEl(),align:"tr",maxWidth:400})}}}],corpus:void 0,documentTopicSmoothing:.1,topicWordSmoothing:.01,vocabularySize:0,vocabularyCounts:{},stopwords:{},docSortSmoothing:10,sumDocSortSmoothing:250,requestedSweeps:0,wordTopicCounts:{},
topicWordCounts:[],tokensPerTopic:[],topicWeights:Array(25),documents:[],progress:void 0},zeros:function(a,b){b=b||0;for(var c=Array(a),d=0;d<a;d++)c[d]=b;return c},constructor:function(a){Ext.apply(this,{title:this.localize("title"),layout:{type:"hbox",pack:"start",align:"stretch"},store:{fields:["topic","scores"],data:[]},columns:[{text:this.localize("topic"),tooltip:this.localize("topicTip"),flex:3,dataIndex:"topic",sortable:!1},{xtype:"widgetcolumn",text:this.localize("scores"),tooltip:this.localize("scoresTip"),
flex:1,dataIndex:"scores",widget:{xtype:"sparklineline",tipTpl:new Ext.XTemplate("{[this.getDocumentTitle(values.x,values.y)]}",{getDocumentTitle:function(a,b){return this.panel.getCorpus().getDocument(a).getTitle()+"\x3cbr\x3ecoverage: "+Ext.util.Format.number(100*b,"0,000.0")+"%"},panel:this})}}],dockedItems:{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:['\x3cspan class\x3d"info-tip" data-qtip\x3d"'+this.localize("searchTip")+'"\x3e'+this.localize("search")+"\x3c/span\x3e",{xtype:"textfield",
name:"searchField",hideLabel:!0,width:100,listeners:{change:{fn:this.onTextFieldChange,scope:this,buffer:500}}},'\x3cspan class\x3d"info-tip" data-qtip\x3d"'+this.localize("numTopicsTip")+'"\x3e'+this.localize("numTopics")+"\x3c/span\x3e",{width:100,hideLabel:!0,xtype:"slider",increment:1,minValue:1,maxValue:200,listeners:{afterrender:function(a){a.setValue(parseInt(this.getApiParam("numTopics")))},changecomplete:function(a,b){this.setApiParams({numTopics:b});this.loadFromExistingDocuments()},scope:this}},
{text:this.localize("run50iterations"),glyph:"xf04b@FontAwesome",tooltip:this.localize("run50iterationsTip"),handler:this.runIterations,scope:this},{xtype:"tbfill"},{xtype:"tbtext",html:this.localize("adaptation")}]}});this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.resetData();var b=parseInt(this.getApiParam("numTopics"));this.setTokensPerTopic(this.zeros(b));this.setTopicWeights(this.zeros(b));this.on("loadedCorpus",function(a,b){this.setCorpus(b);
if(this.rendered)this.initialize();else this.on("afterrender",function(){this.initialize()},this)});this.on("query",function(a,b){this.setApiParam("query",b);this.updateSearchResults()})},loadStopwords:function(){this.mask(this.localize("loadingStopWords"));Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"resource.KeywordsManager",stopList:this.getApiParam("stopList"),corpus:this.getCorpus()?this.getCorpus().getAliasOrId():void 0},success:function(a,b){this.unmask();var c={};Ext.util.JSON.decode(a.responseText).keywords.keywords.forEach(function(a){c[a]=
1});this.setStopwords(c);this.loadDocuments()},scope:this})},loadDocuments:function(){this.mask(this.localize("loadingDocuments"));var a=this.getCorpus();a&&Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"corpus.DocumentTokens",corpus:a.getAliasOrId(),outputFormat:"text",template:"docTokens2text",limit:0,noOthers:!0,perDocLimit:1==a.getDocumentsCount()?void 0:parseInt(this.getApiParam("perDocLimit"))},success:function(b,c){this.unmask();this.mask(this.localize("parsingDocuments"));var d=
b.responseText.trim().split(/(\r\n|\r|\n)/);if(1==d.length){if(d=d[0].split(": "),1<d.length)for(var e=a.getDocument(d[0]),f=d[1].split(" "),e=e.getLexicalTokensCount(),e=10>e?e:1E3>e?10:100,e=10,g=Math.floor(f.length/e),h=0;h<e;h++){var k=f.slice(h*g,h*g+g).join(" ");this.parseLine(d[0]+"-"+h+"\t"+d[0]+"-"+h+"\t"+k)}}else d.forEach(function(b){b=b.split(": ");if(1<b.length){var c=a.getDocument(b[0]);this.parseLine(b[0]+"\t"+c.getTinyLabel()+"\t"+b[1])}},this);this.unmask();this.runIterations()},
scope:this})},resetData:function(){var a=parseInt(this.getApiParam("numTopics"));this.setVocabularyCounts({});this.setSumDocSortSmoothing(this.getDocSortSmoothing()*a);this.setRequestedSweeps(0);this.setWordTopicCounts({});this.setTopicWordCounts([]);this.setTokensPerTopic([]);this.setTopicWeights(Array(a));this.setDocuments([])},loadFromExistingDocuments:function(){var a=this.getDocuments().map(function(a){return a.id+"\t"+a.date+"\t"+a.originalText});this.resetData();a.forEach(function(a){this.parseLine(a)},
this);this.runIterations()},runIterations:function(){var a=this.getRequestedSweeps(),a=a+parseInt(this.getApiParam("iterations"));this.setRequestedSweeps(a);if(!this.getProgress()){var b=Ext.MessageBox.show({title:this.localize("runningIterations"),message:(new Ext.Template(this.localize("runningIterationsCount"))).apply([a]),progress:!0,progressText:"",target:a,customUpdateProgress:function(a){this.updateProgress((this.config.target-a)*this.config.target," iterations")}});this.setProgress(b);this.updateProgress(a)}this.sweep()},
updateProgress:function(a){var b=this.getProgress();a=this.getRequestedSweeps();if(b){var c=b.cfg.target;a=(c-a)/c;b.updateProgress(a,100*parseInt(a)+"% done")}},sweep:function(){Date.now();for(var a=parseInt(this.getApiParam("numTopics")),b=this.getVocabularySize(),c=this.getTopicWordSmoothing(),d=this.getTokensPerTopic(),e=this.getDocuments(),f=this.getWordTopicCounts(),g=this.getTopicWeights(),h=this.getDocumentTopicSmoothing(),k=this.zeros(a),l=0;l<a;l++)k[l]=1/(b*c+d[l]);for(var m=0;m<e.length;m++)for(var n=
e[m],q=n.topicCounts,s=0;s<n.tokens.length;s++){var p=n.tokens[s];if(!p.isStopword){d[p.topic]--;var r=f[p.word];r[p.topic]--;q[p.topic]--;k[p.topic]=1/(b*c+d[p.topic]);for(var w=0,l=0;l<a;l++)g[l]=r[l]?(h+q[l])*(c+r[l])*k[l]:(h+q[l])*c*k[l],w+=g[l];l=w*Math.random();w=0;for(l-=g[w];0<l;)w++,l-=g[w];p.topic=w;d[p.topic]++;r[p.topic]=r[p.topic]?r[p.topic]+1:1;q[p.topic]++;k[p.topic]=1/(b*c+d[p.topic])}}a=this.getRequestedSweeps()-1;this.setRequestedSweeps(a);b=this.getProgress();0<a?(this.updateProgress(a),
Ext.defer(this.sweep,0,this)):(b.close(),this.setProgress(void 0),this.postSweep())},postSweep:function(){this.sortTopicWords();for(var a=this.getStore(),b=parseInt(this.getApiParam("numTopics")),c=this.getTopicWordCounts(),d=[],e=this.getDocuments(),f=this.getDocSortSmoothing(),g=this.getSumDocSortSmoothing(),h=0;h<b;h++){var k=e.map(function(a,b){return(a.topicCounts[h]+f)/(a.tokens.length+g)});d.push({topic:this.topNWords(c[h],10),scores:k})}a.loadData(d)},topNWords:function(a,b){return a.slice(0,
b).map(function(a){return a.word}).join(" ")},displayTopicWords:function(){for(var a=parseInt(this.getApiParam("numTopics")),b=this.getTopicWordCounts(),c=[],d=0;d<a;d++)c.push(this.topNWords(b[d],10));var a=d3.select("#"+this.body.getId()+" div#topics").selectAll("div.topicwords").data(c),e=this;a.enter().append("div").attr("class","topicwords").on("click",function(a,b){e.toggleTopicDocuments(b)});a.transition().text(function(a,b){return"["+b+"] "+a});return b},sortTopicWords:function(){for(var a=
this.getTopicWordCounts(),b=parseInt(this.getApiParam("numTopics")),c=this.getWordTopicCounts(),a=[],d=0;d<b;d++)a[d]=[];for(var e in c)for(d in c[e])a[d].push({word:e,count:c[e][d]});for(d=0;d<b;d++)a[d].sort(this.byCountDescending);this.setTopicWordCounts(a)},byCountDescending:function(a,b){return b.count-a.count},initialize:function(){this.loadStopwords()},parseLine:function(a){var b=this.getStopwords(),c=this.getVocabularyCounts(),d=this.getTokensPerTopic(),e=this.getVocabularySize(),c=this.getVocabularyCounts(),
f=this.getDocuments(),g=parseInt(this.getApiParam("numTopics")),f=this.getDocuments(),h=this.getWordTopicCounts();if(""!=a){var k=f.length,l="",m=a.split("\t");a=m[0];3==m.length&&(k=m[0],l=m[1],a=m[2]);var n=[],m=a.toLowerCase().split(" ");if(null!=m){var q=this.zeros(g);m.forEach(function(a){if(""!==a){var f=Math.floor(Math.random()*g);2>=a.length&&(b[a]=1);var k=b[a];k?c[a]=c[a]?c[a]+1:1:(d[f]++,h[a]||(h[a]={},e++,c[a]=0),h[a][f]||(h[a][f]=0),h[a][f]+=1,c[a]+=1,q[f]+=1);n.push({word:a,topic:f,
isStopword:k})}});this.setVocabularySize(e);f.push({originalOrder:f.length,id:k,date:l,originalText:a,tokens:n,topicCounts:q})}}}});Ext.define("Voyant.VoyantApp",{extend:"Ext.app.Application",mixins:["Voyant.util.Deferrable","Voyant.util.Localization","Voyant.util.Api"],requires:["Voyant.util.ResponseError"],name:"VoyantApp",statics:{i18n:{},api:{palette:"default",lang:void 0,debug:void 0}},config:{baseUrl:void 0,tromboneUrl:void 0},constructor:function(a){this.setBaseUrl(this.config.baseUrl);this.setTromboneUrl(this.config.baseUrl+"trombone");Voyant.application=this;this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);
