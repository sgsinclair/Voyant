...
d&&c.dispatchEvent("loadedCorpus",this,d)}else d&&this.fireEvent("loadedCorpus",this,d);a.up("window").close()},scope:a},{text:a.localize("cancelTitle"),glyph:"xf00d@FontAwesome",flex:1,handler:function(a){a.up("window").close()}}]},bodyPadding:5}).show()}}:void 0,help:{glyph:"xf128@FontAwesome",fn:this.helpToolClick}},c=[];if(a.includeTools)for(var g in a.includeTools)"object"==typeof a.includeTools[g]&&c.push(a.includeTools[g]);for(g in e)a.includeTools&&!a.includeTools[g]||!e[g]||c.push({type:g,
tooltip:this.localize(g+"Tip"),callback:e[g].fn,xtype:"toolmenu",glyph:e[g].glyph,items:e[g].items});Ext.apply(this,{tools:c});this.on("afterrender",function(){var a=this.getHeader();if(a){var b=a.getEl();b.on("mouseover",function(){this.getHeader().getTools().forEach(function(a){a.show()})},this);b.on("mouseout",function(){this.getHeader().getTools().forEach(function(a){"help"!=a.type&&-1==a.type.indexOf("collapse")&&a.hide()})},this);a.getTools().forEach(function(a,b){"help"!=a.type&&a.hide()})}},
