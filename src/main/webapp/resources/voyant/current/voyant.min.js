...
this,b)}},loadCorpusTerms:function(a){if(2>this.getCorpus().getDocumentsCount()||"document"==this.getApiParam("mode")||0<Array.from(this.getApiParam("docIndex")||"").length)return this.loadDocumentTerms();if(this.getApiParam("query")){a=a||{};var b=this.getApiParam("withDistributions");Ext.applyIf(a,{bins:this.getCorpus().getDocumentsCount(),limit:100,stopList:""});var c=this.getCorpus().map(function(a){return a.getTinyTitle()});Ext.Array.unique(c).length<c.length&&(c=c.map(function(a,b){return b+
