...
extend:"Ext.data.Model",config:{documentsStore:void 0},statics:{i18n:{}},fields:[{name:"documentsCount",type:"int"},{name:"lexicalTokensCount",type:"int"},{name:"lexicalTypesCount",type:"int"},{name:"createdTime",type:"int"},{name:"createdDate",type:"date",dateFormat:"c"},{name:"title",type:"string"},{name:"subTitle",type:"string"}],constructor:function(a){a=a||{};this.callParent([]);if(a){if(Ext.isString(a)||Ext.isArray(a))a=Ext.isString(a)&&0==/\s/.test(a)&&-1==a.indexOf(":")?{corpus:a}:{input:a};
Ext.apply(a,{tool:"corpus.CorpusMetadata"});var b=Voyant.application.getDeferred(this),c=this;Ext.Ajax.request({url:Voyant.application.getTromboneUrl(),params:a}).then(function(b){c.set(Ext.JSON.decode(b.responseText).corpus.metadata);var e="titles-"+c.getId();a.corpusTitle||a.corpusSubTitle?(c.set("title",a.corpusTitle),c.set("subTitle",a.corpusSubTitle),Ext.Ajax.request({url:Voyant.application.getTromboneUrl(),params:{tool:"resource.StoredResource",storeResource:Ext.encode({title:a.corpusTitle,
subTitle:a.corpusSubTitle}),resourceId:e}})):Ext.Ajax.request({url:Voyant.application.getTromboneUrl(),params:{tool:"resource.StoredResource",verifyResourceId:e}}).then(function(a){(a=Ext.util.JSON.decode(a.responseText))&&a.storedResource&&a.storedResource.id&&""!=a.storedResource.id&&Ext.Ajax.request({url:Voyant.application.getTromboneUrl(),params:{tool:"resource.StoredResource",retrieveResourceId:e}}).then(function(a){a=Ext.util.JSON.decode(a.responseText).storedResource.resource;a=Ext.decode(a);
c.set(a)})});return c}).otherwise(function(a){Voyant.application.showResponseError(c.localize("failedCreateCorpus"),a)}).then(function(d){!("docsLimit"in a)||!1!==a.docsLimit&&0<a.docsLimit?c.getDocuments().load({params:{limit:"docsLimit"in a?a.docsLimit:c.getDocumentsCount()},callback:function(a,f,g){g?(c.setDocumentsStore(this),b.resolve(d)):b.reject(f)}}):b.resolve(d)});return b.promise}},getId:function(){return this.then?Voyant.application.getDeferredNestedPromise(this,arguments):this.get("id")},
getAliasOrId:function(){return this.then?Voyant.application.getDeferredNestedPromise(this,arguments):this.get("alias")||this.get("id")},loadCorpusTerms:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments);var b=Voyant.application.getDeferred(this);a=a||{};Ext.isNumber(a)&&(a={limit:a});Ext.applyIf(a,{limit:0});var c=this.getCorpusTerms();c.load({params:a,callback:function(a,e,f){f?b.resolve(c):b.reject(e)}});return b.promise},loadTokens:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,
...
arguments);var b=Voyant.application.getDeferred(this);a=a||{};Ext.isNumber(a)?a={limit:a}:Ext.isString(a)&&(a={limit:parseInt(a)});Ext.applyIf(a,{limit:0,outputFormat:"text",template:"docTokens2text"});Ext.apply(a,{tool:"corpus.DocumentTokens",corpus:this.getAliasOrId()});Ext.Ajax.request({url:Voyant.application.getTromboneUrl(),params:a,success:function(a,d){b.resolve(a.responseText)},failure:function(a,d){b.reject(a)},scope:this});return b.promise},getPlainText:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,
arguments);a=a||{};Ext.isNumber(a)?a={limit:a}:Ext.isString(a)&&(a={limit:parseInt(a)});Ext.apply(a,{template:"docTokens2plainText"});return this.getText(a)},getWords:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments);a=a||{};Ext.isNumber(a)?a={limit:a}:Ext.isString(a)&&(a={limit:parseInt(a)});Ext.apply(a,{template:"docTokens2words"});return this.getText(a)},getWordsArray:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments);
a=a||{};Ext.isNumber(a)?a={limit:a}:Ext.isString(a)&&(a={limit:parseInt(a)});Ext.apply(a,{template:"docTokens2words"});var b=this.getWords(),c=Voyant.application.getDeferredNestedPromise(b,arguments);b.then(function(a){c.resolve(a.split(" "))});return c.promise},show:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments);show(this.getString(a))},getString:function(a){var b=this.getDocumentsCount(),c=this.localize("thisCorpus");if(0==b)c+=" "+this.localize("isEmpty")+
...
if(""!=a){var k=f.length,l="",m=a.split("\t");a=m[0];3==m.length&&(k=m[0],l=m[1],a=m[2]);var n=[],m=a.toLowerCase().split(" ");if(null!=m){var q=this.zeros(g);m.forEach(function(a){if(""!==a){var f=Math.floor(Math.random()*g);2>=a.length&&(b[a]=1);var k=b[a];k?c[a]=c[a]?c[a]+1:1:(d[f]++,h[a]||(h[a]={},e++,c[a]=0),h[a][f]||(h[a][f]=0),h[a][f]+=1,c[a]+=1,q[f]+=1);n.push({word:a,topic:f,isStopword:k})}});this.setVocabularySize(e);f.push({originalOrder:f.length,id:k,date:l,originalText:a,tokens:n,topicCounts:q})}}}});Ext.define("Voyant.panel.TermsPack",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.termspack",statics:{i18n:{},api:{stopList:"auto",context:3,query:void 0,docIndex:void 0,docId:void 0},glyph:"xf201@FontAwesome"},config:{options:[{xtype:"stoplistoption"}],mode:void 0,numInitialTerms:50,collocatesLimit:1E6,scalingFactor:3,minRawFreq:1E6,maxRawFreq:-1,maxCollocateValue:-1,currentData:void 0,visLayout:void 0,vis:void 0,visInfo:void 0,visId:void 0,tip:void 0},MODE_CORPUS:"corpus",
MODE_DOCUMENT:"document",MIN_TERMS:5,MAX_TERMS:500,MIN_SCALING:1,MAX_SCALING:5,layout:"fit",constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.setVisId(Ext.id(null,"termspack_"))},initComponent:function(){Ext.apply(this,{title:this.localize("title"),dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{fieldLabel:this.localize("numTerms"),labelWidth:50,width:120,xtype:"slider",increment:1,minValue:this.MIN_TERMS,
maxValue:this.MAX_TERMS,listeners:{afterrender:function(a){a.setValue(this.getNumInitialTerms())},changecomplete:function(a,b){this.resetVis();this.setNumInitialTerms(b);this.loadFromCorpus(this.getCorpus())},scope:this}},{fieldLabel:this.localize("scaling"),labelWidth:50,width:120,xtype:"slider",increment:1,minValue:this.MIN_SCALING,maxValue:this.MAX_SCALING,listeners:{afterrender:function(a){a.setValue(this.getScalingFactor())},changecomplete:function(a,b){var c=Math.abs(b-(this.MAX_SCALING+1));
this.setScalingFactor(c);this.getVisLayout().value(function(a){return Math.pow(a.rawFreq,1/c)});var d=this.processRecordsForVis([]);this.resetVis();this.buildVisFromData(d)},scope:this}}]}]});this.callParent(arguments)},listeners:{boxready:function(){this.initVisLayout()},resize:function(a,b,c){this.getVisLayout()&&this.getCorpus()&&(a=this.getLayout().getRenderTarget(),b=a.getWidth(),c=a.getHeight(),a.down("svg").set({width:b,height:c}),this.getVisLayout().size([b,c]),b=this.processRecordsForVis([]),
this.resetVis(),this.buildVisFromData(b))},loadedCorpus:function(a,b){this.loadFromCorpus(b)}},loadFromCorpus:function(a){this.setApiParams({docId:void 0,docIndex:void 0});a.getCorpusTerms().load({params:{limit:this.getNumInitialTerms(),stopList:this.getApiParam("stopList")},callback:function(a,c,d){d&&(this.setCurrentData({}),this.loadFromRecords(a))},scope:this})},loadFromRecords:function(a){if(Ext.isArray(a)&&0<a.length){var b=this.getMaxRawFreq(),c=this.getMinRawFreq(),d=[];a.forEach(function(a){var f=
a.getTerm(),g=a.getRawFreq();g>b&&(b=g);g<c&&(c=g);this.getCurrentData()[f]={term:f,rawFreq:g,relativeFreq:a.get("relativeFreq"),inDocumentsCount:a.getInDocumentsCount(),collocates:[]};d.push(f)},this);this.setMaxRawFreq(b);this.setMinRawFreq(c);this.loadFromQuery(d)}},loadFromQuery:function(a){this.setApiParams({mode:"corpus"});var b=this.getApiParams();this.getCorpus().getCorpusCollocates().load({params:Ext.apply(Ext.clone(b),{query:a,collocatesWhitelist:a,limit:this.getCollocatesLimit()}),callback:function(a,
b,e){e&&this.buildVisFromData(this.processRecordsForVis(a))},scope:this})},processRecordsForVis:function(a){for(var b=this.getCurrentData(),c=this.getMaxCollocateValue(),d=0;d<a.length;d++){var e=a[d],f=e.getTerm(),g=e.getContextTerm(),e=e.getContextTermRawFreq();e>c&&(c=e);void 0!==b[f]&&f!=g&&b[f].collocates.push({term:g,value:e})}this.setMaxCollocateValue(c);a=[];for(f in b)a.push(b[f]);return a},buildVisFromData:function(a){a=this.getVisLayout().nodes({children:a,collocates:[],term:null,rawFreq:0});
a=this.getVis().selectAll(".node").data(a,function(a){return a.term});a.attr("transform",function(a){return"translate("+a.x+","+a.y+")"});a.selectAll("circle").attr("r",function(a){return a.r});var b=this,c=d3.scale.pow().exponent(1/3).domain([0,this.getMaxCollocateValue()]).range(["#ffffff","#bd3163"]),d=d3.scale.linear().domain([2,this.getCorpus().getDocumentsCount()]).range(["#fff","#ddd"]),e=a[0].length-1,f=d3.scale.pow().exponent(.5).domain([this.MIN_TERMS,this.MAX_TERMS]).range([16,8])(e),e=
d3.scale.pow().exponent(.5).domain([this.MIN_TERMS,this.MAX_TERMS]).range([20,12])(e),g=d3.scale.pow().exponent(.5).domain([this.getMinRawFreq(),this.getMaxRawFreq()]).range([f,e]),f=a.enter().append("g").attr("class","node").style("visibility",function(a){return 0<a.depth?"visible":"hidden"}).attr("transform",function(a){return"translate("+a.x+","+a.y+")"}).on("mouseover",function(a,e){b.getVis().selectAll("circle").style("stroke-width",1).style("stroke","#111").style("fill",function(a){return d(a.inDocumentsCount)});
d3.select(this).select("circle").style("fill","#89e1c2");var f="\x3cb\x3e"+a.term+"\x3c/b\x3e ("+a.rawFreq+")",g=b.getTip();g.update(f);g.show();for(e=0;e<a.collocates.length;e++){var n=a.collocates[e],f=b.getVis().selectAll(".node").filter(function(a){return a.term===n.term});f.select("circle").style("fill",function(a){return c(n.value)}).style("stroke","#314b8b").style("stroke-width",3);f.select("tspan.value").text(function(a){return n.value})}}).on("mousemove",function(){var a=Ext.get(b.getVisId()).dom,
a=d3.mouse(a);a[1]+=20;b.getTip().setPosition(a)}).on("mouseout",function(){b.getVis().selectAll("circle").style("stroke-width",1).style("stroke","#111").style("fill",function(a){return d(a.inDocumentsCount)});b.getVis().selectAll("tspan.value").text("");b.getTip().hide()});f.append("circle").attr("id",function(a){return a.term}).attr("r",function(a){return a.r}).style("fill",function(a){return d(a.inDocumentsCount)}).style("stroke","#111").style("stroke-opacity",.3).style("stroke-width",1);f.append("clipPath").attr("id",
function(a){return"clip-"+a.term}).append("use").attr("xlink:href",function(a){return"#"+a.term});f=f.append("text").attr("clip-path",function(a){return"url(#clip-"+a.term+")"}).style("text-anchor","middle").style("cursor","default");f.append("tspan").attr("class","term").style("font-size",function(a){return g(a.rawFreq)}).attr("x",0).attr("y",0).text(function(a){return a.term});f.append("tspan").attr("class","value").style("font-size",function(a){return g(a.rawFreq)-2}).attr("x",0).attr("y",function(a){return g(a.rawFreq)+
1});a.exit().remove()},resetVis:function(){this.getVis().selectAll(".node").remove()},initVisLayout:function(){var a=this.getLayout().getRenderTarget();a.update("");var b=a.getWidth(),c=a.getHeight(),d=this;this.setVisLayout(d3.layout.pack().sort(function(a,b){return a.rawFreq<b.rawFreq?1:a.rawFreq>b.rawFreq?-1:0}).value(function(a){return Math.pow(a.rawFreq,1/d.getScalingFactor())}).size([b,c]).padding(1.5));a=d3.select(a.dom).append("svg").attr("id",this.getVisId()).attr("width",b).attr("height",
c);this.setVis(a.append("g"));this.setVisInfo(a.append("text").attr("x",10).attr("y",10));void 0===this.getTip()&&this.setTip(Ext.create("Ext.tip.Tip",{}))}});Ext.define("Voyant.VoyantApp",{extend:"Ext.app.Application",mixins:["Voyant.util.Deferrable","Voyant.util.Localization","Voyant.util.Api"],requires:["Voyant.util.ResponseError"],name:"VoyantApp",statics:{i18n:{},api:{palette:"default",lang:void 0,debug:void 0}},config:{baseUrl:void 0,tromboneUrl:void 0},constructor:function(a){this.setBaseUrl(this.config.baseUrl);this.setTromboneUrl(this.config.baseUrl+"trombone");Voyant.application=this;this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);
...
{msg:Ext.isString(a)?a:a.msg,response:b}))},showError:function(a,b){Ext.isString(a)&&(a={message:a});!b&&(a.error||a.responseText||a instanceof Voyant.util.ResponseError)&&(b=a);if(b){a=a||{};a.message=a.message||"";if(b.error){var c="";"string"==typeof b.error?c=b.error:b.error.response.responseText&&"string"==typeof b.error.response.responseText&&(c=b.error.response.responseText);var d=c.split(/(\r\n|\r|\n)/);0<d.length&&(a.message=this.localize("serverResponseError"),a.message+="\x3cpre class\x3d'error'\x3e\n"+
d[0]+"\x3c/p\x3e",1<d.length&&(a.message+="\u2026  \x3ca href\x3d'#' onclick\x3d\"window.open('').document.write(unescape('\x3cpre\x3e"+escape(c)+"\x3c/pre\x3e')); return false;\"\x3emore\x3c/a\x3e\x3c/pre\x3e"),a.message+="\x3c/pre\x3e")}b.responseText&&(a.message+="\x3cpre class\x3d'error'\x3e\n"+b.responseText.substring(0,b.responseText.indexOf("\n\t"))+"\u2026 \x3ca href\x3d'#' onclick\x3d\"window.open('').document.write(unescape('\x3cpre\x3e"+escape(b.responseText)+"\x3c/pre\x3e')); return false;\"\x3emore\x3c/a\x3e\x3c/pre\x3e")}Ext.applyIf(a,
