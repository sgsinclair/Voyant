...
null!=e&&0!=e.length||c():c();h=2*Math.PI;e=0;a.freqCounts={};var l=a.terms,m=null!=this.lastClickedBubbles[b],k=0,n;for(n in l){var r=l[n];if(r){k++;this.SEPARATE_LINES_FOR_TERMS&&c();var p=0,q=r.color.join(",");this.ctx.strokeStyle="rgba("+q+", 1)";this.ctx.fillStyle="rgba("+q+", 0.35)";this.ctx.lineWidth=.25;for(var e=e+r.rawFreq,p=p+r.rawFreq,s=m&&this.lastClickedBubbles[b][n],w=0;w<r.pos.length;w++){var t=r.pos[w];if(0<t.radius){var x=!1;s&&this.lastClickedBubbles[b][n]==t.id&&(this.ctx.strokeStyle=
"rgba(0, 0, 0, 0.75)",this.ctx.fillStyle="rgba("+q+", 0.5)",this.ctx.lineWidth=1,x=!0);this.ctx.beginPath();this.ctx.arc(t.x+g,this.yIndex,t.radius,0,h,!0);this.ctx.closePath();this.ctx.fill();this.ctx.stroke();x&&(this.ctx.strokeStyle="rgba("+q+", 1)",this.ctx.fillStyle="rgba("+q+", 0.35)",this.ctx.lineWidth=.25)}}a.freqCounts[n]=p;this.SEPARATE_LINES_FOR_TERMS&&(this.ctx.fillStyle="rgba(0, 0, 0, 1.0)",this.ctx.font="10px Verdana",this.ctx.fillText(p,g+d+5,this.yIndex-4),this.yIndex+=this.maxRadius)}}this.SEPARATE_LINES_FOR_TERMS&&
...
p[a];b.alpha=1;b.live&&b.draw(f.context)}a=$(f.canvas);if(null!=k){a.css("cursor","pointer");f.context.save();f.context.textBaseline="alphabetic";f.context.font="12px Arial";var b=f.context.measureText(k.text).width,c=f.context.measureText(k.value).width,b=(b>c?b:c)+20,c=n+15,d=r+25,e=a.width(),a=a.height();c+b>=e&&(c-=b);d+40>=a&&(d-=40);f.context.fillStyle="rgba(255,255,255,0.9)";f.context.strokeStyle="rgba(100,100,100,0.9)";f.context.translate(c,d);f.context.fillRect(0,0,b,40);f.context.strokeRect(0,
0,b,40);f.context.fillStyle="rgba(0,0,0,0.9)";f.context.fillText(k.text+":",8,18);f.context.fillText(k.value,8,30);f.context.restore()}else a.css("cursor","default")}var g=this,f=a;this.CIRCLE=0;this.ratio=1;var h=this.CIRCLE;this.getLayout=function(){return h};this.setLayout=function(a){h=a};this.UPDATE_RATE=25;this.COARSENESS=5;this.grid=[];var l=0,m;this.doingArrange=!1;this.wordsToArrange=5;var k=null,n=0,r=0,p=[];this.getWords=function(){return p};this.setWords=function(a){p=a};this.sizeAdjustment=
100;this.minFontSize=12;this.largestWordSize=0;this.smallestWordSize=1E4;var q={};this.addWords=function(a){for(var b=!1,e=0;e<a.length;e++){var h=a[e],l;l=void 0==typeof h.color||null==h.color||""==h.color?f.colors[Math.floor(Math.random()*f.colors.length)]:h.color;var m;m=void 0==typeof h.size||null==h.size||""==h.size?Math.floor(40*Math.random()):parseFloat(h.size);var k=h.word,n=h.label,r=h.value,h=!1;null==q[k]&&(q[k]=!0,m>g.largestWordSize&&(g.largestWordSize=m,h=!0),m<g.smallestWordSize&&(g.smallestWordSize=
.8*m,h=!0),k=new Word(k,m,l,n,r),p.push(k));b=h||b}c();this.setRelativeSizes();this.calculateSizeAdjustment();b?this.resizeWords():d()};this.resetWordCoordinates=function(){f.clear();clearTimeout(m);for(var a=0;a<p.length;a++){var b=p[a];b.x=0;b.y=0;b.tx=0;b.ty=0}};this.calculateSizeAdjustment=function(){this.ratio=f.canvas.width/f.canvas.height;var a=f.canvas.width*f.canvas.height;this.minFontSize=1E5>a?8:12;for(var c=0,d=0;d<p.length;d++)var e=b(p[d]),c=c+e;this.sizeAdjustment=a/c};this.setRelativeSizes=
...
[];a.items.forEach(function(a){b.push(this.getMenuItemFromXtype(a))},this);c.push({text:d.localize(a.i18n),glyph:a.glyph,menu:{items:b}})},this);b.push({text:d.localize(a.i18n),glyph:a.glyph,menu:{items:c}})},this)}var e={save:{glyph:"xf08e@FontAwesome",fn:this.exportToolClick,items:void 0},plus:b?{glyph:"xf17a@FontAwesome",items:b}:void 0,gear:this.showOptionsClick||this.getOptions?{glyph:"xf205@FontAwesome",fn:this.showOptionsClick?this.showOptionsClick:function(a){Ext.create("Ext.window.Window",
{title:a.localize("exportTitle"),modal:!0,panel:a,items:{xtype:"form",items:a.getOptions(),buttons:[{text:a.localize("confirmTitle"),glyph:"xf00c@FontAwesome",flex:1,panel:a,handler:function(a){var b=a.up("form").getValues();this.setApiParams(b);var b=this.getApplication(),c=b.getCorpus();c?b.dispatchEvent("loadedCorpus",this,c):this.fireEvent("apiChange",this);a.up("window").close()},scope:a},{text:a.localize("cancelTitle"),glyph:"xf00d@FontAwesome",flex:1,handler:function(a){a.up("window").close()}}]},
bodyPadding:5}).show()}}:void 0,help:{glyph:"xf128@FontAwesome",fn:this.helpToolClick}},c=[];if(a.includeTools)for(var g in a.includeTools)"object"==typeof a.includeTools[g]&&c.push(a.includeTools[g]);for(g in e)a.includeTools&&!a.includeTools[g]||!e[g]||c.push({type:g,tooltip:this.localize(g+"Tip"),callback:e[g].fn,xtype:"toolmenu",glyph:e[g].glyph,items:e[g].items});Ext.apply(this,{tools:c});this.on("afterrender",function(){var a=this.getHeader();if(a){var b=a.getEl();b.on("mouseover",function(){this.getHeader().getTools().forEach(function(a){a.show()})},
...
Ext.getClass(a).getName().split(".");url=a.getBaseUrl()+"tool/"+b[b.length-1]+"/";params=a.getModifiedApiParams();!params.corpus&&a.getCorpus&&a.getCorpus()&&(params.corpus=a.getCorpus().getId());params&&(url+="?"+Ext.Object.toQueryString(params));a.openUrl(url)},exportToolClick:function(a){var b=[{xtype:"radio",name:"export",inputValue:"url",boxLabel:"\x3ca href\x3d'"+a.getExportUrl.call(a)+"' target\x3d'_blank'\x3e"+a.localize("exportViewUrl")+"\x3c/a\x3e",checked:!0,listeners:{afterrender:function(){this.boxLabelEl.on("click",
...
d.each(c);Ext.Msg.show({title:this.localize("exportDataTitle"),message:this.localize("exportDataJsonMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:Ext.encode(values)})},exportGridCurrentTsv:function(a,b){function c(a){cells=[];g.forEach(function(b){b=a.get(b.dataIndex);Ext.isString(b)&&(b=b.replace(/\s+/g," "));cells.push(b)});f+=cells.join("\t")+"\n"}var d=a.getStore(),e=d.getFields(),g=a.getColumnManager().headerCt.getVisibleGridColumns(),e=[];g.forEach(function(a){e.push(a.text)});
var f=e.join("\t")+"\n";d.buffered?d.data.forEach(c):d.each(c);Ext.Msg.show({title:this.localize("exportDataTitle"),message:this.localize("exportDataTsvMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:f})},exportGridCurrentHtml:function(a,b){function c(a){e+="\t\t\x3ctr\x3e\n";g.forEach(function(b){b=a.get(b.dataIndex);Ext.isString(b)&&(b=b.replace(/&/g,"\x26amp;").replace(/</g,"\x26lt;").replace(/>/g,"\x26lg;"));e+="\t\t\t\x3ctd\x3e"+b+"\x3c/td\x3e\n"});e+="\t\t\x3c/tr\x3e\n"}
...
value:e})},getExportUrl:function(){var a=this.getModifiedApiParams();this.isXType("voyantheader")||(a.view=Ext.getClassName(this).split(".").pop());return this.getApplication().getBaseUrl()+"?corpus\x3d"+this.getApplication().getCorpus().getId()+"\x26"+Ext.Object.toQueryString(a)},helpToolClick:function(a){var b=a.localize("help",{"default":!1})||a.localize("helpTip");b==a._localizeClass(Ext.ClassManager.get("Voyant.util.Toolable"),"helpTip")?a.openUrl("http://docs.voyant-tools.org/"):Ext.Msg.alert(a.localize("title"),
b)},replacePanel:function(a){var b=this.getApplication().getCorpus();this.getInitialConfig();var c;this.isXType("voyantheader")&&this.getApplication().getViewComponent?(c=this.getApplication().getViewComponent(),c.removeAll(!0),a=c.add({xtype:a}),b&&this.getApplication().dispatchEvent("loadedCorpus",c,b)):(c=this.isXType("voyantheader")&&this.getApplication().getViewComponent?this.getApplication().getViewComponent():this.up("component"),c.remove(this,!0),a=c.add({xtype:a}),b&&a.fireEvent("loadedCorpus",
a,b))}});
...
Ext.apply(this,{items:[{xtype:"combo",queryMode:"local",value:b,triggerAction:"all",editable:!0,fieldLabel:this.localize("label"),labelAlign:"right",name:"stopList",displayField:"name",valueField:"value",store:{fields:["name","value"],data:c}},{width:10},{xtype:"tbspacer"},{xtype:"button",text:this.localize("editList"),handler:this.editList,scope:this},{width:10},{xtype:"checkbox",name:"stopListGlobal",boxLabel:this.localize("applyGlobally")}]});this.callParent(arguments)},editList:function(){var a=
...
badFiles:{en:"incompatible (likely error): "},unknownFiles:{en:"unrecognized (possible error): "},sureContinue:{en:"Are you sure you wish to continue?"},reveal:{en:"Reveal"},ok:{en:"OK"},cancel:{en:"Cancel"}},api:{inputFormat:void 0,xmlDocumentsXpath:void 0,xmlContentXpath:void 0,xmlTitleXpath:void 0,xmlAuthorXpath:void 0}},config:{},constructor:function(a){this.callParent(arguments);a=a||{};this.mixins["Voyant.panel.Panel"].constructor.call(this,Ext.apply(a,{includeTools:{gear:!0,help:!0,code:{type:"code",
tooltip:this.localize("codeTip"),callback:function(){alert("code clicked")},xtype:"toolmenu",glyph:"xf121@FontAwesome"}}}))},initComponent:function(){var a=this;Ext.apply(a,{title:this.localize("title"),width:800,frame:!0,border:!0,frameHeader:!0,layout:{type:"vbox",align:"middle"},dockedItems:[{xtype:"toolbar",dock:"bottom",buttonAlign:"right",defaultButtonUI:"default",items:[{text:"Open",glyph:"xf115@FontAwesome",tooltip:"Select an exsting corpus",handler:function(){Ext.create("Ext.window.Window",
{title:"Open an Existing Corpus",layout:"fit",modal:!0,items:{xtype:"form",margin:"5,5,5,5",items:{xtype:"combo",labelWidth:150,fieldLabel:"Choose a corpus:",name:"corpus",queryMode:"local",store:[["shakespeare","Shakespeare's Plays"]],forceSelection:!0},buttons:[{text:"Open",glyph:"xf00c@FontAwesome",handler:function(b){b.up("form").getForm();var c=b.up("form").getForm().getValues().corpus;""!=c?(a.loadCorpus({corpus:c}),b.up("window").close()):Ext.Msg.show({title:"Select a Corpus",message:"Please be sure to select a corpus.",
buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR})},flex:1},{text:"Cancel",glyph:"xf00d@FontAwesome",flex:1,handler:function(a){a.up("window").close()}}]}}).show()}},{xtype:"filefield",glyph:"xf093@FontAwesome",name:"upload",buttonOnly:!0,hideLabel:!0,buttonText:"Upload",tooltip:"test",listeners:{render:function(a){a.fileInputEl.dom.setAttribute("multiple",!0);Ext.QuickTips.register({target:a.getEl(),text:"Upload one or more documents from your computer",enabled:!0,showDelay:20,trackMouse:!0,autoShow:!0})},
change:function(b,c){if(c){var d=b.up("form").getForm();if(d.isValid()){for(var e=b.fileInputEl.dom.files,g=/\.(png|gif|jpe?g|xls|mp[234a]|mpeg|exe|wmv|avi|ppt|mpg|tif|wav|mov|psd|wma|ai|bmp|pps|aif|pub|dwg|indd|swf|asf|mbd|dmg|flv)$/i,f=/\.(txt|pdf|html?|xml|docx?|rtf|pages|odt|zip|jar|tar|gz|ar|cpio|bzip2|bz2|gzip)$/i,h=[],l=[],m=0,k=e.length;m<k;m++){var n=e[m].name;g.test(n)?h.push(n.split("/").pop()):f.test(n)||l.push(n.split("/").pop())}0<h.length||0<l.length?Ext.Msg.show({title:a.localize("fileTypesWarning"),
icon:Ext.MessageBox.ERROR,message:a.localize("fileTypesMessage")+"\x3cul\x3e"+(0<h.length?"\x3cli\x3e"+a.localize("badFiles")+h.slice(0,5).join(", ")+(5<h.length?"\u2026":"")+"\x3c/li\x3e":"")+(0<l.length?"\x3cli\x3e"+a.localize("unknownFiles")+l.slice(0,5).join(", ")+(5<l.length?"\u2026":"")+"\x3c/li\x3e":"")+"\x3c/ul\x3e"+a.localize("sureContinue"),buttons:Ext.Msg.YESNO,fn:function(c){"yes"===c?a.loadForm(d):(b.reset(),b.fileInputEl.dom.setAttribute("multiple",!0))},scope:d}):a.loadForm(d)}}}}},
"-\x3e",{xtype:"button",scale:"large",glyph:"xf00c@FontAwesome",text:this.localize("reveal"),handler:function(b){b=b.up("form").down("#input").getValue();""!==b?a.loadCorpus({input:b}):Ext.Msg.show({title:"No Text Provided",message:"Please provide text in the text box (or choose open or upload).",buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR})}}]}],items:{xtype:"textareafield",width:800,height:100,itemId:"input",emptyText:this.localize("emptyInput")}});a.callParent(arguments)},loadForm:function(a){var b=
{tool:"corpus.CorpusCreator"},c=this.getApiParams();delete c.view;delete c.stopList;Ext.apply(b,c);var d=this.getApplication().getViewport();d.mask(this.localize("uploadingCorpus"));a.submit({url:this.getTromboneUrl(),params:b,failure:function(a,b){d.unmask();b.result&&this.loadCorpus({corpus:b.result.stepEnabledCorpusCreator.storedId})},scope:this})},loadCorpus:function(a){var b=this.getApplication(),c=b.getViewport();c.mask();(new Corpus(a)).then(function(a){c.unmask();b.dispatchEvent("loadedCorpus",
b,a)}).fail(function(a,e){c.unmask();b.showErrorResponse({message:a},e)})},showOptionsClick:function(a){void 0===a.optionsWin&&(a.optionsWin=Ext.create("Ext.window.Window",{title:a.localize("gearWinTitle"),closeAction:"hide",height:225,width:500,layout:"fit",bodyPadding:10,items:[{xtype:"form",defaultType:"textfield",fieldDefaults:{labelAlign:"right",labelWidth:160},items:[{fieldLabel:a.localize("xpathDocuments"),name:"xmlDocumentsXpath"},{fieldLabel:a.localize("xpathContent"),name:"xmlContentXpath"},
{fieldLabel:a.localize("xpathAuthor"),name:"xmlAuthorXpath"},{fieldLabel:a.localize("xpathTitle"),name:"xmlTitleXpath"}]}],buttons:[{text:a.localize("ok"),handler:function(b,c){var d=b.findParentByType("window"),e=d.down("form").getValues();a.setApiParams(e);d.hide()}},{text:a.localize("cancel"),handler:function(a,c){a.findParentByType("window").hide()}}]}));a.optionsWin.show()}});Ext.define("Voyant.panel.CorpusTerms",{extend:"Ext.grid.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.corpusterms",statics:{i18n:{title:{en:"Corpus Terms"},helpTip:{en:"\x3cp\x3eCorpus Terms is a table view of terms that appear in the entire corpus. Features include:\x3c/p\x3e\x3cul\x3e\x3cli\x3ereordering by \x3ci\x3eterm\x3c/i\x3e and \x3ci\x3ecount\x3c/i\x3e (click on the column headers)\x3c/li\x3e\x3cli\x3ea sparkline graph of the term frequency trends across the corpus (if the corpus has multiple documents) or across the document (if the corpus has only one document)\x3c/li\x3e\x3cli\x3eadditional columns available (relative frequency, distribution peakedness and skew) by clicking on the arrow that appears when hovering over a header\x3c/li\x3e\x3cli\x3ea search box for queries (hover over the magnifying icon for help with the syntax)\x3c/li\x3e\x3c/ul\x3e"},
...
autoLoad:!1,remoteSort:!1,corpus:this.getCorpus(),proxy:{type:"ajax",url:Voyant.application.getTromboneUrl(),extraParams:{tool:"corpus.DocumentTerms",corpus:this.getCorpus().getId()},reader:{type:"json",rootProperty:"documentTerms.terms",totalProperty:"documentTerms.total"},simpleSortMode:!0}});if(this.rendered){this.summaryListParent=Ext.dom.Helper.append(this.getLayout().getRenderTarget(),"\x3cul\x3e\x3c/ul\x3e");Ext.dom.Helper.append(this.summaryListParent,"\x3cli\x3e"+c.getShow()+"\x3c/li\x3e");
var d=c.getDocumentsCount();1<d&&this.showLongestDocuments();1<d&&this.showMostDenseDocuments();this.showMostFrequentWords();1<d&&this.showDistinctiveWords();d=Ext.apply({},{limit:null},this.getApiParams());this.docStore.load({params:d});this.addLinksHandler()}else Ext.defer(this.fireEvent,100,this)});this.on("activate",function(){this.getCorpus()&&this.dispatchEvent("ensureCorpusView",this,this.getCorpus())},this);a.embedded&&"Voyant.data.model.Corpus"==Ext.getClass(a.embedded).getName()&&(a.corpus=
a.embedded);a&&a.corpus&&this.fireEvent("loadedCorpus",this,a.corpus)},showLongestDocuments:function(){var a=Ext.dom.Helper.append(this.summaryListParent,"\x3cli\x3e\x3c/li\x3e");this.docStore.on("load",function(b,c,d){c=b.getTotalCount();if(1<c){b.sort("index","ASC");var e=[];b.each(function(a){e.push(a.get("tokensCount-lexical"))});b.sort("tokensCount-lexical","DESC");b={shortest:b.getRange(c-2,c).reverse(),longest:b.getRange(0,1),all:b.getRange(0,c)};for(var g in b)if(g){d=b[g];for(var f=0;f<d.length;f++){var h=
d[f];b[g][f]={title:h.getShortTitle(),id:h.get("id"),totalWordTokens:Ext.util.Format.number(h.get("tokensCount-lexical"),"0,000"),docsLen:d.length}}}g=new Ext.XTemplate(this.localize("docsLength"));d="";5<c?(d+=(new Ext.Template(this.localize("docsLengthLongest"))).applyTemplate([this.getSparkLine(e)])+this.localize("colon")+g.apply({docs:b.longest}),d+=this.localize("docsLengthShortest")+this.localize("colon")+g.apply({docs:b.shortest}),d+="\x3ca href\x3d'#' onclick\x3d'return false' class\x3d'corpus-documents corpus-documents-length'\x3e"+
...
Ext.apply(a,{moreTools:["corpusset"]}))},onCollapse:function(a){a.setTitle(this.localize("title"))}});Ext.define("Voyant.panel.CorpusSet",{extend:"Ext.panel.Panel",requires:"Voyant.panel.Cirrus Voyant.panel.Summary Voyant.panel.CorpusTerms Voyant.panel.Reader Voyant.panel.Documents Voyant.panel.Trends Voyant.panel.Contexts Voyant.panel.DocumentTerms Voyant.panel.CorpusCollocates Voyant.panel.CollocatesGraph".split(" "),mixins:["Voyant.panel.Panel"],alias:"widget.corpusset",statics:{i18n:{title:{en:"Corpus View"},helpTip:{en:"This is the default, general-purpose corpus view."}},glyph:"xf17a@FontAwesome"},
constructor:function(a){this.callParent(arguments)},layout:"border",items:[{region:"center",flex:3,layout:"fit",items:{xtype:"reader"}},{region:"west",flex:3,layout:"fit",moreTools:["cirrus","corpusterms"],split:{width:5},items:{xtype:"cirrus"}},{region:"east",flex:3,layout:"fit",split:{width:5},moreTools:["trends","collocatesgraph","corpuscollocates"],items:{xtype:"trends"}},{region:"south",flex:2,split:{width:5},layout:"border",items:[{layout:"fit",region:"center",flex:1,split:{width:5},moreTools:["summary",
"documents"],items:{xtype:"summary"}},{layout:"fit",region:"east",flex:1,split:{width:5},moreTools:["contexts","documentterms"],items:{xtype:"contexts"}}]}]});Ext.define("Voyant.VoyantApp",{extend:"Ext.app.Application",mixins:["Voyant.util.Deferrable","Voyant.util.Localization"],requires:["Voyant.util.ResponseError"],name:"VoyantApp",statics:{i18n:{error:{en:"Error"},serverResponseError:{en:"The server error reponse:"}}},config:{baseUrl:void 0,tromboneUrl:void 0},constructor:function(a){this.setBaseUrl(this.config.baseUrl);this.setTromboneUrl(this.config.baseUrl+"trombone");Voyant.application=this;this.callParent(arguments)},getTools:function(){return[{type:"maximize"},
