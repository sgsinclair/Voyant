...
0;g<=c;g+=this.COARSENESS)if(e[f]&&e[f][g]&&null!=this.grid[f+a]&&null!=this.grid[f+a][g+b])return!0;return!1},f;this.grid=[];l=0;f=function(){var a,f,h,k,n=this.wordsToArrange-1,u=g.canvas.width,q=g.canvas.height,r=.5*u,v=.5*q;do{h=p[l];if(void 0!==h){for(var B=Math.random()*Math.PI,w=.25*Math.random()*h.size,D=.5*(Math.random()-.5),M=.5*h.width,N=.5*h.height;;){a=Math.floor((r+Math.cos(B)*w*this.ratio-M)/this.COARSENESS)*this.COARSENESS;f=Math.floor((v+Math.sin(B)*w-N)/this.COARSENESS)*this.COARSENESS;
...
h,l,m);H=new doubletree.Trie(g,h,l,m);g=c.length;for(h=0;h<g;h++){l=f?f[h]:h;m=c[h];var n=a[h].slice(),u=d[h].slice();n.push(m);n.reverse();u.unshift(m);k?(H.addNgram(n,l),z.addNgram(u,l)):(z.addNgram(n,l),H.addNgram(u,l))}b.setupFromTries(z,H);return b};b.filteredIDs=function(){return K};b.search=function(a){C.search(a);A.search(a);a=d3.select(f[0]);var b=a.selectAll("text.foundText");if(b.empty())return 0;b=b[0].length;null!=a.selectAll("text.rtNdText.foundText").node()&&b--;return b};b.clearSearch=
...
(function(){doubletree.Trie=function(a,b,c,d,e){function f(a,b,c){this.id=b;this.count=c;this.info={count:c,ids:{}};if(null==a)this.item=k;else{this.item=a;this.info.ids={};this.info.ids[b]=!0;a=a.split(n);for(var d in a)this.info[m[d]]=[a[d]]}this.nodes={};this.addNgram=function(a,b,c){c||(c=1);var d,e;if(0<a.length){d=a.shift();var g=d.split(n);e=r&&this.item==k?"":g.filter(function(a,b){return-1<q.indexOf(m[b])}).map(function(a){return l?a.toLocaleLowerCase():a}).join(n)}else e=d=h;var u;if(e in
this.nodes&&this.nodes[e]instanceof f){u=this.nodes[e];u.info.count+=c;u.info.ids[b]=!0;for(var p in g)e=g[p],-1==u.info[m[p]].indexOf(e)&&u.info[m[p]].push(e)}else u=new f(d,b,c),this.nodes[e]=u;d!=h&&u.addNgram(a,b,c)};this.getUniqRoot=function(){if(this.item==k){var a=Object.keys(this.nodes);if(1==a.length)return this.nodes[a[0]]}return this};this.toTree=function(a){function b(a,c,d){var e={children:[]};e.name=d.item;e.info={};for(var f in d.info)if("Object"===typeof d.info[f]){e.info[f]={};for(var h in d.info[f])e.info[f][h]=
...
{start:c.length,noOverwrite:!0,suppressLocations:!0,suppressConnections:!0});this.load(b).then(function(a){d.setIsIncrementalLoadingOccurrences(!1);d.getData().connectionOccurrences.connectionOccurrences=c.concat(a.dreamscape.connectionOccurrences.connectionOccurrences)})}return c&&c[a]?(b=c[a],b.index=a,Ext.apply(b.source,locations[b.source.location]),Ext.apply(b.target,locations[b.target.location]),b):null}},getAllConnectionOccurrences:function(a,b){debugger;for(var c=[],d=0;d<this.getTotalConnectionsCount();d++){var e=
...
map:"Map",mapTip:"Define base layer and projection",annotationsUpdated:"Annotations have been stored. Please export new URL if you would like to reference it.",annotationsUpdateFailed:"An error occured while trying to store the anntoations.",annotationsLoadFailed:"An error occured while trying to load the anntoations.",editLocationTitle:"Select an alternative location",editLocationNoLocationsFound:"No locations found.",editLocationNoAlternativesFound:"No altenrnative locations found",editLocationServerError:"An error occurred while trying to load alternate locations.",
cancel:"Cancel",editLocation:"Select Alternative Location",removeLocation:"Remove Location",editLocationTip:"If this place name is valid but the location is wrong, you can select an alternate location (this applies to all occurrences).",removeLocationTip:"If this is not a valid place name, you can remove it (this applies to all occurrences).",removeLocationConfirm:"Are you sure you want to remove all occurrences of this location?",occurrences:"Occurrences",viewOccurrences:"View Occurrences",viewOccurrencesTip:"Select this to see a list of occurrences of this location",
openInVoyant:"Open in Voyant",viewOccurrencesTip:"Select this to see the location in Voyant.",editAnnotation:"Edit Annotation",editAnnotationMessage:"Add an annotation. To remove an existing annotation, remove the text and click 'OK'.",viewConnections:"View Connection Occurrences",viewConnectionsTip:"Select this to see a list of occurrences between these two locations."},api:{stopList:"auto",hide:[],author:void 0,title:void 0,keyword:void 0,pubDate:void 0,citiesMaxCount:500,minPopulation:1E4,citiesMinFreq:1,
connectionsMaxCount:2500,connectionsMinFreq:1,millisPerAnimation:2E3,annotationsId:void 0,source:void 0,overridesId:void 0,filterHasLowerCaseForm:!0,filterIsPersonName:!0,preferredCoordinates:void 0},glyph:"xf124@FontAwesome"},config:{map:void 0,overlay:void 0,contentEl:void 0,isOpenLayersLoaded:!1,isArcLoaded:!1,animationDelay:25,isProj4Loaded:!1,projection:void 0,filterWidgets:new Ext.util.MixedCollection,drawInteraction:void 0,drawMode:!1,baseLayers:{},annotations:void 0,annotationsLoadedIfAvailable:!1,
overrides:{}},html:'\x3cdiv class\x3d"map"\x3e\x3c/div\x3e\x3cdiv class\x3d"ticker"\x3e\x3c/div\x3e',cls:"dreamscape",constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);Ext.Loader.loadScript({url:this.getBaseUrl()+"resources/openlayers/ol.js",onLoad:function(){void 0===ol.Map.prototype.getLayer&&(ol.Map.prototype.getLayer=function(a){var b=void 0;this.getLayers().forEach(function(c){a===c.get("id")&&(b=c)});return b});this.setIsOpenLayersLoaded(!0)},
scope:this});Ext.Loader.loadScript({url:this.getBaseUrl()+"resources/dreamscape/arc.js",onLoad:function(){this.setIsArcLoaded(!0)},scope:this});Ext.Loader.loadScript({url:"https://cdnjs.cloudflare.com/ajax/libs/proj4js/2.4.4/proj4.js",onLoad:function(){this.setIsProj4Loaded(!0)},scope:this});var b=this.getApiParam("annotationsId");if(b){var c=this;Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"resource.StoredResource",retrieveResourceId:b},scope:this}).then(function(a){a=Ext.JSON.decode(a.responseText);
a.storedResource.resource&&(a=Ext.JSON.decode(a.storedResource.resource),Ext.isString(a)&&(a=Ext.JSON.decode(a),c.setAnnotations(a)));c.getAnnotations()||c.showError(c.localize("annotationsLoadFailed"));c.setAnnotationsLoadedIfAvailable(!0)},function(a){c.showResponseError(c.localize("annotationsLoadFailed"),a);c.setAnnotationsLoadedIfAvailable(!0)})}else this.setAnnotationsLoadedIfAvailable(!0)},initComponent:function(){this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);var a=this.getApiParam("hide");
Ext.isString(a)&&(a=a.split(","),this.setApiParam("hide"));this.getApplication().getBaseUrl();Ext.apply(this,{title:this.localize("title"),bodyBorder:!0,dockedItems:[{dock:"bottom",xtype:"toolbar",itemId:"bottomToolbar",overflowHandler:"scroller",items:[{text:this.localize("display"),tooltip:this.localize("displayTip"),glyph:"xf013@FontAwesome",menu:{defaults:{xtype:"menucheckitem",checkHandler:function(a,c){var d=this.getMap(),e=a.getItemId();this.getFilterWidgets().each(function(a){d.getLayer(a.getId()+
"-"+e).setVisible(c)});var f=Ext.Array.from(this.getApiParam("hide"));c?f=Ext.Array.remove(f,e):(f.push(e),f=Ext.Array.unique(f));this.setApiParam("hide",f);a.getMenu().setDisabled(0==c)},scope:this,checked:!0},items:[{xtype:"menuitem",text:this.localize("baseLayer"),tooltip:this.localize("baseLayerTip"),glyph:"xf279@FontAwesome",menu:{items:[{xtype:"radiogroup",columns:1,vertical:!0,defaults:{cls:"map-menu-item",handler:function(a,c){if(c){id=a.getItemId();var d=this.getBaseLayers()[id];d&&(d.setOpacity(1),
this.getMap().getLayers().setAt(0,d));"osm"==id||"arcGIS"==id?this.getMap().getLayer("overlayLayer").setVisible(!1):this.getMap().getLayer("overlayLayer").setVisible(!0)}},listeners:{afterrender:function(a){Ext.create("Ext.tip.ToolTip",{target:a,html:'\x3cdiv class\x3d"map-menu-item-tooltip '+a.getItemId()+'"\x3e\x3c/div\x3e',anchor:"right"})}},scope:this},items:[{boxLabel:this.localize("watercolor"),itemId:"watercolor",cls:["map-menu-item","watercolor"],checked:!0},{boxLabel:this.localize("wms4326"),
cls:["map-menu-item","wms4326"],itemId:"wms4326"},{boxLabel:this.localize("osm"),cls:["map-menu-item","osm"],itemId:"osm"},{boxLabel:this.localize("arcGIS"),cls:["map-menu-item","arcGIS"],itemId:"arcGIS"}]}]}},{xtype:"menuitem",text:this.localize("projection"),tooltip:this.localize("projectionTip"),glyph:"xf0ac@FontAwesome",menu:{items:[{xtype:"radiogroup",columns:1,vertical:!0,defaults:{handler:function(a,c){if(c){var d=this;id=a.getItemId();if("webMercatorProjection"===id)this.setProjection(ol.proj.get("EPSG:3857"));
else if("mercatorProjection"===id)this.setProjection(ol.proj.get("EPSG:4326"));else if("gallPetersProjection"===id){proj4.defs("cea","+proj\x3dcea +lon_0\x3d0 +lat_ts\x3d45 +x_0\x3d0 +y_0\x3d0 +ellps\x3dWGS84 +units\x3dm +no_defs");var e=ol.proj.get("cea");this.setProjection(e)}else"sphereMollweideProjection"===id&&(proj4.defs("ESRI:54009","+proj\x3dmoll +lon_0\x3d0 +x_0\x3d0 +y_0\x3d0 +datum\x3dWGS84 +units\x3dm +no_defs"),e=ol.proj.get("ESRI:54009"),e.setExtent([-18E6,-9E6,18E6,9E6]),this.setProjection(e));
var e=this.getProjection().getExtent(),f=this.getProjection()==ol.proj.get("EPSG:4326")?360:4.007501668557849E7,e=new ol.View({projection:this.getProjection(),center:ol.extent.getCenter(e||[0,0,0,0]),maxResolution:f/d.body.dom.offsetWidth,zoom:0}),g=this.getMap();g.getLayers().forEach(function(a){a.getSource().getFeatures&&a.getSource().getFeatures().forEach(function(a){var b=a.getGeometry().transform(g.getView().getProjection(),d.getProjection());a.setGeometry(b)})});g.setView(e)}},listeners:{afterrender:function(a){Ext.create("Ext.tip.ToolTip",
{target:a,html:'\x3cdiv class\x3d"map-menu-item-tooltip '+a.getItemId()+'"\x3e\x3c/div\x3e',anchor:"right"})}},scope:this},items:[{boxLabel:this.localize("webMercatorProjection"),itemId:"webMercatorProjection",cls:["map-menu-item","webMercatorProjection"],checked:!0},{boxLabel:this.localize("mercatorProjection"),cls:["map-menu-item","mercatorProjection"],itemId:"mercatorProjection"},{boxLabel:this.localize("gallPetersProjection"),cls:["map-menu-item","gallPetersProjection"],itemId:"gallPetersProjection"},
{boxLabel:this.localize("sphereMollweideProjection"),cls:["map-menu-item","sphereMollweideProjection"],itemId:"sphereMollweideProjection"}]}]}},"-",{text:this.localize("cities"),checked:0==Ext.Array.contains(a,"cities"),itemId:"cities",menu:{defaults:{labelAlign:"right",labelWidth:140},items:[{xtype:"numberfield",fieldLabel:this.localize("citiesMaxCount"),minValue:1,value:parseInt(this.getApiParam("citiesMaxCount")),listeners:{change:function(a,c,d){this.getFilterWidgets().each(function(e){this.setApiParam("citiesMaxCount",
c);var f=e.getGeonames().getCitiesCount();c<d||c<=f?this.filterUpdate(e):e.getGeonames().hasMoreCities()?e.loadGeonames():(a.setValue(f),this.toastInfo((new Ext.XTemplate(this.localize("allNCitiesShown"))).apply([f])))},this)},scope:this}},{xtype:"numberfield",fieldLabel:this.localize("citiesMinPopulation"),minValue:1,value:parseInt(this.getApiParam("minPopulation")),listeners:{change:function(a,c,d){this.setApiParam("minPopulation",c);this.getFilterWidgets().each(function(a){c>d?this.filterUpdate(a):
a.loadGeonames()},this)},scope:this}},{xtype:"numberfield",fieldLabel:this.localize("citiesMinFreq"),minValue:1,value:parseInt(this.getApiParam("citiesMinFreq")),listeners:{change:function(a,c,d){this.getFilterWidgets().each(function(a){this.setApiParam("citiesMinFreq",c);c>d?this.filterUpdate(a):a.loadGeonames()},this)},scope:this}}]}},{text:this.localize("connections"),checked:0==Ext.Array.contains(a,"connections"),itemId:"connections",menu:{defaults:{labelWidth:140,labelAlign:"right"},items:[{xtype:"numberfield",
fieldLabel:this.localize("connectionsMaxCount"),minValue:1,value:parseInt(this.getApiParam("connectionsMaxCount")),listeners:{change:function(a,c,d){this.getFilterWidgets().each(function(a){this.setApiParam("connectionsMaxCount",c);c>d?this.filterUpdate(a):a.loadGeonames()},this)},scope:this}},{xtype:"numberfield",fieldLabel:this.localize("connectionsMinFreq"),minValue:1,value:parseInt(this.getApiParam("connectionsMinFreq")),listeners:{change:function(a,c,d){this.getFilterWidgets().each(function(a){this.setApiParam("connectionsMinFreq",
...
this.getIsArcLoaded()&&this.getIsProj4Loaded()&&this.getAnnotationsLoadedIfAvailable()){var a=this.body.down(".map").setId(Ext.id()),b=this,c=this.getBaseLayers();c.wms4326=new ol.layer.Tile({preload:Infinity,source:new ol.source.TileWMS({url:"https://ahocevar.com/geoserver/wms",crossOrigin:"",params:{LAYERS:"ne:NE1_HR_LC_SR_W_DR",TILED:!0},projection:"EPSG:4326"})});c.watercolor=new ol.layer.Tile({preload:Infinity,source:new ol.source.Stamen({layer:"watercolor",projection:"EPSG:3857"})});c.osm=new ol.layer.Tile({preload:Infinity,
source:new ol.source.OSM({projection:"EPSG:3857"})});c.arcGIS=new ol.layer.Tile({preload:Infinity,source:new ol.source.TileArcGISRest({url:"https://services.arcgisonline.com/ArcGIS/rest/services/NatGeo_World_Map/MapServer",projection:"EPSG:3857"})});var d=new ol.Map({layers:[c.watercolor,new ol.layer.Tile({preload:Infinity,source:new ol.source.Stamen({cacheize:2048,layer:"toner-hybrid",projection:"EPSG:3857"}),id:"overlayLayer"})],target:a.getId(),loadTilesWhileInteracting:!0,view:new ol.View({center:[0,
0],maxResolution:4.007501668557849E7/b.body.dom.offsetWidth,zoom:0})});d.on("singleclick",this.handleSingleClick,this);d.on("singleclicking",function(a){var c=d.getFeaturesAtPixel(a.pixel);if(c){for(var e=0;e<c.length;e++){var f=c[e];"city"==f.get("type")&&this.handleLocationClick(f)}f=c[0];debugger}if(c){var m=!1;c.forEach(function(c){"city"===c.get("type")&&c.get("selected")?(b.dispatchEvent("termsClicked",b,[c.get("forms").join("|")]),m=!0):"connection"===c.get("type")&&c.get("selected")&&!m&&
(b.getFilterWidgets().each(function(d){d=d.getGeonames();if(null!=d){var e="\x3cul\x3e",f=-1;d.getAllConnectionOccurrences(c.get("source"),c.get("target")).forEach(function(a){a.docIndex!=f&&(f=a.docIndex,e+="\x3ch4\x3e"+b.getCorpus().getDocument(f).getFullLabel()+":\x3c/h4\x3e");e+="\x3cli\x3e"+a.source.left+'\x3ca href\x3d"http://www.geonames.org/'+a.source.id+'" target\x3d"_blank" docIndex\x3d'+a.docIndex+" offset\x3d"+a.source.position+" location\x3d"+a.source.form+" cityId\x3d"+a.source.id+" coordinates\x3d"+
JSON.stringify(sourceCoordinates)+' class\x3d"termLocationLink"\x3e'+a.source.form+"\x3c/a\x3e "+a.source.right+" [...] "+a.target.left+'\x3ca href\x3d"http://www.geonames.org/'+a.target.id+'" target\x3d"_blank" docIndex\x3d'+a.docIndex+" offset\x3d"+a.target.position+" location\x3d"+a.target.form+" cityId\x3d"+a.target.id+" coordinates\x3d"+JSON.stringify(targetCoordinates)+' class\x3d"termLocationLink"\x3e'+a.target.form+"\x3c/a\x3e "+a.target.right+"\x3c/li\x3e"});d=c.get("text");e+="\x3c/ul\x3e";
b.getContentEl().setHtml("\x3ch3\x3e"+d+"\x3c/h3\x3e"+e);b.getOverlay().setPosition(a.coordinate);Ext.select(".termLocationLink").elements.forEach(function(a){a.onmouseover=function(){b.showTermInCorpus(a.getAttribute("docIndex"),a.getAttribute("offset"),a.getAttribute("location"))}})}}),m=!0)},this)}});var e=new ol.layer.Vector({map:d,source:new ol.source.Vector({wrapX:!1,useSpatialIndex:!1}),zIndex:10,selected:!0,style:function(a){if("city"===a.get("type"))return b.cityStyleFunction(a,d.getView().getResolution());
if("connection"===a.get("type"))return b.travelStyleFunction(a,d.getView().getResolution())},updateWhileAnimating:!0,updateWhileInteracting:!0}),a=new ol.layer.Vector({map:d,source:new ol.source.Vector({wrapX:!1,useSpatialIndex:!1}),preview:!0,zIndex:15,id:"preview",style:function(a){if("city"===a.get("type"))return b.cityStyleFunction(a,d.getView().getResolution());if("connection"===a.get("type"))return b.travelStyleFunction(a,d.getView().getResolution())},updateWhileAnimating:!0,updateWhileInteracting:!0});
d.addLayer(a);d.on("pointermove",function(a){var c=d.getEventPixel(a.originalEvent),c=d.hasFeatureAtPixel(c);d.getViewport().style.cursor=c?"pointer":"";if(!b.getDrawMode()&&(e.getSource().clear(),c=a.pixel,c=d.getFeaturesAtPixel(c))){for(var f=0;c[f].get("selected")&&(f++,f!==c.length););if(f<c.length){var l=c[f],c={font:"12px Calibri,sans-serif",textAlign:"center",offsetY:-15,fill:new ol.style.Fill({color:[0,0,0,1]}),stroke:new ol.style.Stroke({color:[255,255,255,.5],width:4})};c.text=l.get("text");
c=new ol.style.Style({text:new ol.style.Text(c),zIndex:1});"annotation"!==l.get("type")&&(f=new ol.Feature({text:l.get("text"),geometry:l.getGeometry(),forms:l.get("forms"),selected:!0,coordinates:l.get("coordinates"),width:l.get("width"),visible:l.get("visible"),color:l.get("color"),type:l.get("type"),confidence:l.get("confidence"),source:l.get("source"),target:l.get("target"),cityId:l.get("cityId")}),e.getSource().addFeature(f));l.getGeometry();a=new ol.Feature({geometry:new ol.geom.Point(a.coordinate),
selected:!0});a.setStyle(c);e.getSource().addFeature(a);"city"===l.get("type")&&b.getMap().getLayers().forEach(function(a){var b=a.get("id");b&&-1!==b.indexOf("connections")&&(connections=a.getSource().getFeatures(),connections.forEach(function(a){a.get("target")!==l.get("cityId")&&a.get("source")!==l.get("cityId")||e.getSource().addFeature(new ol.Feature({geometry:a.getGeometry(),selected:!0,coordinates:a.get("coordinates"),width:a.get("width"),visible:a.get("visible"),color:a.get("color"),type:a.get("type")}))}))})}}});
var a=new ol.source.Vector({wrapX:!1}),c=new ol.layer.Vector({source:a,id:"annotations"}),f=this.getAnnotations();f&&(f=(new ol.format.GeoJSON).readFeatures(f),a.addFeatures(f));d.addLayer(c);this.setDrawInteraction(new ol.interaction.Draw({source:a,type:"Polygon",freehand:!0,alias:"draw"}));this.getDrawInteraction().on("drawend",function(a){a.feature.set("type","annotation");b.editAnnotation(a.feature)});this.setMap(d);this.getTargetEl().down(".ol-zoom");Ext.create("Ext.Button",{glyph:"xf075@FontAwesome",
...
buttons:Ext.Msg.OKCANCEL,multiline:!0,value:b,scope:this,callback:function(b,d){if("ok"==b){""==d?this.getMap().getLayer("annotations").getSource().removeFeature(a):a.set("text",d);var e=new ol.format.GeoJSON,f=this.getMap().getLayer("annotations").getSource().getFeatures(),g=[],h=this.getProjection();f.forEach(function(a){transformedFeature=a.clone();transformedFeature.getGeometry().transform(h?h:"EPSG:3857","EPSG:3857");g.push(transformedFeature)});e=e.writeFeatures(g);this.storeAnnotations(e)}}})},
storeAnnotations:function(a){this.mask("storingAnnotations");var b=this;Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"resource.StoredResource",storeResource:JSON.stringify(a)},scope:this}).then(function(a){b.unmask();a=Ext.JSON.decode(a.responseText);b.setApiParam("annotationsId",a.storedResource.id);b.toastInfo(b.localize("annotationsUpdated"))},function(a){b.unmask();b.showResponseError(b.localize("annotationsUpdateFailed"),a)})},travelStyleFunction:function(a,b){var c=new ol.style.Stroke({color:a.get("color"),
width:a.get("width")}),d=[new ol.style.Style({stroke:c})],e=a.getGeometry(),f=e.getLastCoordinate(),e=e.getCoordinateAt(.9),e=Math.atan2(f[1]-e[1],f[0]-e[0]),g=new ol.geom.LineString([f,[f[0]-10*b,f[1]+10*b]]);g.rotate(e,f);var h=new ol.geom.LineString([f,[f[0]-10*b,f[1]-10*b]]);h.rotate(e,f);d.push(new ol.style.Style({geometry:g,stroke:c}));d.push(new ol.style.Style({geometry:h,stroke:c}));return d},cityStyleFunction:function(a,b){if(a.get("visible")){var c=2*Math.PI*a.get("width"),d=a.get("confidence")?
c*a.get("confidence"):c;return new ol.style.Style({image:new ol.style.Circle({radius:a.get("width"),fill:new ol.style.Fill({color:a.get("color")}),stroke:new ol.style.Stroke({lineDash:[d,c-d],color:"rgb(255, 255, 255)",width:2})})})}return!1},animationStyleFunction:function(a){return[new ol.style.Style({stroke:new ol.style.Stroke({color:a.get("color"),width:5})}),new ol.style.Style({geometry:new ol.geom.Circle(a.getGeometry().getFirstCoordinate()),stroke:new ol.style.Stroke({color:"white",width:10})}),
...
f=0;a.getGeonames().eachCity(function(a){a.rawFreq>f&&(f=a.rawFreq)},this,e);var g=c.getLayer(a.getId()+"-cities").getSource(),h=Ext.Array.from(this.getApiParam("hide"));g.clear();var k=parseInt(this.getApiParam("minPopulation")),l=parseInt(this.getApiParam("citiesMinFreq")),m={};a.getGeonames().eachCity(function(a){if((!k||a.population>=k)&&(!l||a.rawFreq>=l)){m[a.id]=!0;var c=[parseFloat(a.lng),parseFloat(a.lat)];a=new ol.Feature({geometry:(new ol.geom.Point(c)).transform(ol.proj.get("EPSG:4326"),
b.getProjection()?b.getProjection():ol.proj.get("EPSG:3857")),text:a.label+" ("+a.rawFreq+")",description:a.label,color:d,selected:!1,width:3+20*Math.sqrt(a.rawFreq/f),visible:!0,coordinates:c,forms:a.forms,cityId:a.id,type:"city",confidence:a.confidence?100*a.confidence:void 0});g.addFeature(a)}},this,e);0<g.getFeatures().length&&c.getView().fit(g.getExtent());c.getLayer(a.getId()+"-cities").setVisible(0==Ext.Array.contains(h,"cities"));g=c.getLayer(a.getId()+"-connections").getSource();g.clear();
0==Object.keys(m).length&&this.toastInfo("No cities available for current criteria.");f=0;a.getGeonames().eachConnection(function(a){a.rawFreq>f&&(f=a.rawFreq)},this);var n=0,q=parseInt(this.getApiParam("connectionsMaxCount")),r=parseInt(this.getApiParam("connectionsMinFreq"));a.getGeonames().eachConnection(function(a){if((!r||a.rawFreq>=r)&&(!q||n<q)&&a.source.id in m&&a.target.id in m&&(!k||a.source.population>=k&&a.target.population>=k)){var c=(new arc.GreatCircle({x:a.source.lng,y:a.source.lat},
{x:a.target.lng,y:a.target.lat})).Arc(100,{offset:100}),e=a.source.label+" -\x3e "+a.target.label+" ("+a.rawFreq+")";c.geometries.forEach(function(c){c=new ol.geom.LineString(c.coords);c.transform(ol.proj.get("EPSG:4326"),b.getProjection()?b.getProjection():ol.proj.get("EPSG:3857"));c=new ol.Feature({geometry:c,text:e,color:d,width:3+10*Math.sqrt(a.rawFreq/f),source:a.source.id,target:a.target.id,type:"connection"});g.addFeature(c)},this);n++}},this);c.getLayer(a.getId()+"-connections").setVisible(0==
...
glyph:"xf02d@FontAwesome",handler:function(){this.mask("loadingConnections");var b=this;Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"corpus.Dreamscape",corpus:this.getCorpus().getId(),suppressLocations:!0,suppressConnections:!0,sourceId:a.get("source"),targetId:a.get("target"),context:2,limit:25},scope:this}).then(function(a){b.unmask();if((a=Ext.JSON.decode(a.responseText))&&a.dreamscape&&a.dreamscape.connectionOccurrences){var c="\x3ctable style\x3d'font-size:smaller'\x3e";a.dreamscape.connectionOccurrences.connectionOccurrences.forEach(function(a){c+=
"\x3ctr\x3e\x3ctd style\x3d'text-align: right'\x3e"+a.source.left+"\x3c/td\x3e\x3ctd class\x3d'keyword' style\x3d'text-align: center'\x3e"+a.source.term+"\x3c/td\x3e\x3ctd\x3e"+a.source.right+"\x3c/td\x3e\x3ctd\x3e\u2026\x3c/td\x3e\x3ctd style\x3d'text-align: right'\x3e"+a.target.left+"\x3c/td\x3e\x3ctd class\x3d'keyword' style\x3d'text-align: center'\x3e"+a.target.term+"\x3c/td\x3e\x3ctd\x3e"+a.target.right+"\x3c/td\x3e\x3c/tr\x3e"});c+="\x3c/table\x3e";Ext.Msg.alert(b.localize("occurrences"),c)}},
function(a){b.unmask();return b.showError(b.localize("occurrencesNotLoaded"))})},scope:this}]}).showAt(b,c)},handleLocationClick:function(a,b){var c=b.get("cityId");Ext.create("Ext.menu.Menu",{items:[{text:this.localize("viewOccurrences"),tooltip:this.localize("viewOccurrencesTip"),glyph:"xf02d@FontAwesome",handler:function(){this.mask("loadingOccurrences");var a=this;Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"corpus.Dreamscape",corpus:this.getCorpus().getId(),suppressLocations:!0,
suppressConnections:!0,suppressConnectionOccurrences:!0,locationId:c,limit:25},scope:this}).then(function(b){a.unmask();if((b=Ext.JSON.decode(b.responseText))&&b.dreamscape&&b.dreamscape.occurrences){var c="\x3ctable style\x3d'font-size:smaller'\x3e";b.dreamscape.occurrences.occurrences.forEach(function(a){c+="\x3ctr\x3e\x3ctd style\x3d'text-align: right'\x3e"+a.left+"\x3c/td\x3e\x3ctd class\x3d'keyword' style\x3d'text-align: center'\x3e"+a.term+"\x3c/td\x3e\x3ctd\x3e"+a.right+"\x3c/td\x3e\x3c/tr\x3e"});
c+="\x3c/table\x3e";Ext.Msg.alert(a.localize("occurrences"),c)}},function(b){a.unmask();return a.showError(a.localize("occurrencesNotLoaded"))})},scope:this},{text:this.localize("openInVoyant"),tooltip:this.localize("openInVoyantTip"),glyph:"xf08e@FontAwesome",handler:function(){this.dispatchEvent("termsClicked",this,b.get("forms"))},scope:this},{text:this.localize("editLocation"),tooltip:this.localize("editLocationTip"),glyph:"xf124@FontAwesome",handler:function(){this.mask("loadingAlternatives");
var a=this;Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"util.Geonames",query:b.get("forms")},scope:this}).then(function(b){a.unmask();if((b=Ext.JSON.decode(b.responseText))&&b.geonames&&b.geonames.locations){var f=[];Object.values(b.geonames.locations.locations).forEach(function(a){f.push({boxLabel:a.label+" ("+a.population+")",name:"id",inputValue:a.id,checked:a.id==c})});if(0==f.length)return a.showError(a.localize("editLocationNoLocationsFound"));if(1==f.length&&f[0].inputValue==c)return a.showError(a.localize("editLocationNoAlternativesFound"));
Ext.create("Ext.window.Window",{title:a.localize("editLocation"),modal:!0,items:{xtype:"form",items:[{xtype:"radiogroup",columns:1,vertical:!0,items:f}],listeners:{afterrender:function(a){},scope:this},buttons:[{text:a.localize("cancel"),ui:"default-toolbar",glyph:"xf00d@FontAwesome",flex:1,handler:function(a){a.up("window").destroy()}},{text:a.localize("confirmTitle"),glyph:"xf00c@FontAwesome",flex:1,handler:function(b){var e=b.up("form").getValues().id;if(e&&e!=c){var f={};f[c]=e;a.appendOverrides(f)}b.up("window").destroy()}}]}}).show()}},
function(b){a.unmask();a.showResponseError(a.localize("editLocationServerError"),b)})},scope:this},{text:this.localize("removeLocation"),tooltip:this.localize("removeLocationTip"),glyph:"xf00d@FontAwesome",handler:function(){Ext.Msg.confirm(this.localize("removeLocationConfirmTitle"),this.localize("removeLocationConfirm"),function(a){"yes"==a&&(a={},a[c]="",this.appendOverrides(a))},this)},scope:this}],listeners:{focusleave:function(a){a.destroy()}}}).showAt(a.pixel[0],a.pixel[1])},appendOverrides:function(a,
b){if(this.getApiParam("overridesId")&&!b){var c=this;Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"resource.StoredResource",retrieveResourceId:this.getApiParam("overridesId")},scope:this}).then(function(b){var e=Ext.JSON.decode(b.responseText);e&&e.storedResource&&e.storedResource.resource?(b=Ext.decode(e.storedResource.resource),Ext.apply(b,a),c.appendOverrides(b,!0)):c.showResponseError(c.localize("overidesRetrieveError"),b)},function(a){c.showResponseError(c.localize("overidesRetrieveError"),
a)})}else c=this,Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"resource.StoredResource",storeResource:Ext.encode(a)},scope:this}).then(function(a){var b=Ext.JSON.decode(a.responseText);b&&b.storedResource&&b.storedResource.id?(c.setApiParam("overridesId",b.storedResource.id),c.reloadFilters()):c.showResponseError(c.localize("overidesRetrieveError"),a)},function(a){c.showResponseError(c.localize("overidesStorageError"),a)})}});
