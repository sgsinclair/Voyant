...
a});d.info.continuations=d.children.length;f=d3.max(d.children.map(function(a){return a.maxChildren}));d.maxChildren=Math.max(d.children.length,f)}}function b(a,b){if(!a||!b)return!1;for(var c in a)if(!(c in b))return!1;return!0}function c(a,b){for(var c in b)a[c]=b[c]}function d(){}doubletree.DoubleTree=function(){function b(a){a.each(function(a,b){f.push(this[b])})}var f=[],g=600,h=400,k=!1,l={left:[],right:[]},m={alt:d,shift:d},n=!0,q=!0,s=doubletree.sortByStrFld("token"),p=doubletree.tokenText,
r=function(a){return doubletree.fieldText(a,"POS")},y=function(a){return"rgba(255,255,255,0)"},D=function(a){return"rgba(255,255,255,0)"},F=function(a){return"red"},B={node:{fill:"white",stroke:"steelblue","stroke-width":"1.5px"},branch:{stroke:"#aaa","stroke-width":"1.5px"}},C=!1,J=d3.dispatch("idsUpdated");J.on("idsUpdated",function(){this==z?(A.setIds(z.continuationIDs),A.updateContinuations()):this==A&&(z.setIds(A.continuationIDs),z.updateContinuations())});var x,E,z,A,I,K=1.15*14,G;b.init=function(a){d3.select(d3.selectAll(a)).call(this);
...
w.info.ids);c(t.ids,v.info.ids);t.count=Object.keys(t.ids).length;I=Object.keys(t.ids);if(w.info.origIDs||v.info.origIDs)t.origIDs={},c(t.origIDs,w.info.origIDs),c(t.origIDs,v.info.origIDs),t.origCount=Object.keys(t.origIDs).length;w.info=t;v.info=t;u=Math.max(v.maxChildren,w.maxChildren);if(isNaN(u)||0==u)return C=!1,b;q?G=d3.scale.log().range([8,14]):(G=function(){return 14},G.domain=function(){});u=Math.max(v.maxLen,w.maxLen);var L=Math.max(80,.6*u*K);200<L&&(L=200);u=Math.min(v.minCount,w.minCount);
G.domain([u,v.info.count]);var N=g-20-20,O=h-20-20;f[0].forEach(function(a,b){var c;c=d3.select(a).select("svg");null==c[0][0]?(c=d3.select(a).append("svg").attr("width",N+20+20).attr("height",O+20+20).attr("cursor","move").call(d3.behavior.zoom().on("zoom",function(){"mousemove"===d3.event.sourceEvent.type&&d3.select(a).select("svg \x3e g").attr("transform","translate("+d3.event.translate+")")})),c.append("g")):(c.attr("width",N+20+20).attr("height",O+20+20),c.selectAll("g *").remove());z=new doubletree.Tree(c.select("g"),
g,h,L,v,!0,s,J,G,n,p,r,y,D,F,B);A=new doubletree.Tree(c.select("g"),g,h,L,w,!1,s,J,G,n,p,r,y,D,F,B)});z.handleAltPress=m.alt;A.handleAltPress=m.alt;z.handleShiftPress=m.shift;A.handleShiftPress=m.shift;C=!0;return b};b.setupFromArrays=function(a,c,d,f,g,h,l,m){void 0==g&&x&&(g=x.caseSensitive());void 0==h&&x&&(h=x.fieldNames());void 0==l&&x&&(l=x.fieldDelim());void 0==m&&x&&(m=x.distinguishingFieldsArray());x=new doubletree.Trie(g,h,l,m);E=new doubletree.Trie(g,h,l,m);g=c.length;for(h=0;h<g;h++){l=
f?f[h]:h;m=c[h];var r=a[h].slice(),n=d[h].slice();r.push(m);r.reverse();n.unshift(m);k?(E.addNgram(r,l),x.addNgram(n,l)):(x.addNgram(r,l),E.addNgram(n,l))}b.setupFromTries(x,E);return b};b.filteredIDs=function(){return I};b.search=function(a){z.search(a);A.search(a);a=d3.select(f[0][0]);var b=a.selectAll("text.foundText");if(b.empty())return 0;b=b[0].length;null!=a.selectAll("text.rtNdText.foundText")[0][0]&&b--;return b};b.clearSearch=function(){z.clearSearch();A.clearSearch();return b};b.updateTokenExtras=
function(){z.showTokenExtras(n);A.showTokenExtras(n);var a=d3.select(f[0][0]).select('.tokenExtra[display\x3d"inline"]');a.empty()||"0px"==a.style("height")&&b.redraw();return b};b.visWidth=function(a){if(!arguments.length)return g;g=a;return b};b.visHeight=function(a){if(!arguments.length)return h;h=a;return b};b.prefixesOnRight=function(a){if(!arguments.length)return k;k=a;return b};b.filters=function(a){if(!arguments.length)return l;l=a;return b};b.handlers=function(a){if(!arguments.length)return m;
m=a;return b};b.showTokenExtra=function(a){if(!arguments.length)return n;n=a;return b};b.scaleLabels=function(a){if(!arguments.length)return q;q=a;return b};b.succeeded=function(){return C};b.sortFun=function(a){if(!arguments.length)return s;s=a;return b};b.nodeText=function(a){if(!arguments.length)return p;p=a;return b};b.tokenExtraText=function(a){if(!arguments.length)return r;r=a;return b};b.rectColor=function(a){if(!arguments.length)return y;y=a;return b};b.rectBorderColor=function(a){if(!arguments.length)return D;
D=a;return b};b.continuationColor=function(a){if(!arguments.length)return F;F=a;return b};b.basicStyles=function(a){if(!arguments.length)return B;Object.keys(B).forEach(function(b){b in a&&Object.keys(B[b]).forEach(function(c){c in a[b]&&(B[b][c]=a[b][c])})});return b};return b};doubletree.Tree=function(a,c,d,h,k,l,m,n,q,s,p,r,y,D,F,B){function C(a){a.children&&(a._children=a.children,a._children.forEach(C),a.children=null)}function J(a){a.parent&&a.parent.children.forEach(function(b){b!=a&&C(b)})}
function x(a,b){d3.event.altKey?u.handleAltPress(a,b):d3.event.shiftKey?u.handleShiftPress(a,b):a.parent&&(u.continuationIDs!=a.info.ids&&(u.setIds(a.info.ids),u.clickedNode=a.id,n.idsUpdated.apply(u)),J(a),E(a,!0))}function E(a,b){a.children?(a.children&&1==a.children.length&&E(a.children[0],!0),a._children=a.children,a.children=null):(a.children=a._children,a._children=null,a.children&&1==a.children.length&&E(a.children[0],!1));b&&u.update(a)}function z(a){return l?K/2-a:K/2+a}var A=s,I=y,K=c-20-
20,G=d-20-20,M=0,H,v;m||(m=doubletree.sortByStrFld("token"));var w=d3.layout.tree().nodeSize([30,30]).sort(m),t=d3.svg.diagonal().projection(function(a){return[z(a.y),a.x-v]});a=a.append("g").attr("transform","translate(20,20)");this.readJSONTree=function(a){H=a;H.x0=G/2;H.y0=K/2;H.children.forEach(C);this.update(H)};var u=this;this.update=function(c){c||(c=H);var d=w.nodes(H).reverse();v=H.x-G/2;d.forEach(function(a){a.y=a.depth*h});var f=a.selectAll("g.node_"+l).data(d,function(a){return a.id||
(a.id=++M)}),g=f.enter().append("g").attr("class","node node_"+l).attr("cursor","pointer").attr("transform",function(a){return"translate("+z(c.y0)+","+(c.x0-v)+")"}).on("click",x);g.append("title").text(function(a){return doubletree.infoToText(a.info)});g.append("circle").attr("r",1E-6).style("fill",function(a){return a._children?"#fff":B.node.fill}).style("stroke",function(a){return B.node.stroke});g=g.append("text").attr("class",function(a){return 0==a.depth?"rtNdText":""}).attr("x",function(a){return a.children||
a._children?0:l?10:-10}).attr("text-anchor",function(a){return a.parent?a.children||a._children?l?"end":"start":l?"start":"end":"middle"}).style("font-size",function(a){return q(a.info.count)+"pt"});g.append("tspan").attr("dy",".35em").attr("class","tokenText").text(function(a){return p(a.info,1>a.depth)}).style("fill-opacity",1E-6);g.append("tspan").attr("dx",".35em").attr("class","tokenExtra").text(function(a){return r(a.info,1>a.depth)}).style("fill-opacity",1E-6);this.drawRects=function(){var b=
A?"inline":"none";a.selectAll(".tokenExtra").attr("display",b);f.selectAll("rect").remove();f.append("rect").attr("class","nodeRect").attr("height",function(){return this.parentElement.getBBox().height-6}).attr("y",function(a){return a.parent?-.5*this.parentElement.getBBox().height/2:-.5*this.parentElement.getBBox().height/2-2}).attr("width",function(){return this.parentElement.getBBox().width}).attr("x",function(a){var b=this.parentElement.getBBox().width;return a.parent?l?-.5*b:0:-.33333*b}).style("stroke-opacity",
1).style("stroke-width",1).style("stroke",function(a){return D(a.info)}).style("fill",function(a){return I(a.info)}).style("fill-opacity",function(a){return a.parent||l?1:1E-6})};try{this.drawRects()}catch(k){}g=f.transition().duration(200).attr("transform",function(a){return"translate("+z(a.y)+","+(a.x-v)+")"});g.select("circle").attr("r",function(a){return a.children||a._children?1E-6:4.5}).style("fill",function(a){return a._children?"#fff":B.node.fill}).style("stroke-width",B.node["stroke-width"]);
g.select("text").attr("class",function(a){b(u.continuationIDs,a.info.ids)||!a.parent?classListAdd(this,"continuation"):classListRemove(this,"continuation");return classListToString(this)}).style("fill-opacity",1).style("fill",function(a){return classListContains(this,"continuation")?F(a.info):"#444"});g.selectAll("tspan").style("fill-opacity",1);g=f.exit().transition().duration(200).attr("transform",function(a){return"translate("+z(c.y)+","+(c.x-v)+")"}).remove();g.select("circle").attr("r",1E-6);
g.selectAll("tspan").style("fill-opacity",1E-6);g=a.selectAll("path.link_"+l).data(w.links(d),function(a){return a.target.id});g.enter().insert("path","g").attr("class","link link_"+l).attr("d",function(a){a={x:c.x0,y:c.y0};return t({source:a,target:a})}).style("fill","none").style("stroke",B.branch.stroke).style("stroke-width",B.branch["stroke-width"]);g.transition().duration(200).attr("d",t);g.exit().transition().duration(200).attr("d",function(a){a={x:c.x,y:c.y};return t({source:a,target:a})}).remove();
d.forEach(function(a){a.x0=a.x;a.y0=a.y})};this.setIds=function(a){u.continuationIDs=a};this.updateContinuations=function(){a.selectAll("g.node_"+l+" text").classed("continuation",function(a){var b;a:{a=a.info.ids;for(b in a)if(b in u.continuationIDs){b=!0;break a}b=!1}b?classListAdd(this,"continuation"):classListRemove(this,"continuation");return b}).style("fill",function(a){return classListContains(this,"continuation")?F(a.info):"#444"})};this.search=function(b){a.selectAll("g.node text").attr("class",
function(a){b.test(p(a.info))?classListAdd(this,"foundText"):classListRemove(this,"foundText");return classListToString(this)})};this.clearSearch=function(){a.selectAll("g.node text").attr("class",function(a){classListRemove(this,"foundText");return classListToString(this)})};this.showTokenExtras=function(a){if(0==arguments.length)return A;A=a;this.drawRects();return this};this.setRectColor=function(a){if(0==arguments.length)return I;I=a;this.drawRects();return this};this.handleAltPress=function(){};
this.handleShifttPress=function(){};this.readJSONTree(k);return this};doubletree.sortByStrFld=function(a){return function(b,c){var d=void 0==b.info[a],k=void 0==c.info[a];if(d&&k)return 0;if(d)return-1;if(k)return 1;d=b.info[a].join(" ").toLowerCase();k=c.info[a].join(" ").toLowerCase();return d<k?-1:d>k?1:0}};doubletree.sortByCount=function(){return function(a,b){return b.info.count-a.info.count}};doubletree.sortByContinuations=function(){return function(a,b){return b.info.continuations-a.info.continuations}};
doubletree.filterByMinCount=function(a){return function(b){return b.count>=a}};doubletree.filterByMaxCount=function(a){return function(b){return b.count<=a}};doubletree.filterByPOS=function(a){var b=new RegExp(a);return function(a){return a.POS&&0<a.POS.filter(function(a){return-1<a.search(b)}).length}};doubletree.fieldText=function(a,b){return a[b]};doubletree.tokenText=function(a){return doubletree.fieldText(a,"token")};doubletree.infoToText=function(a){var b="",c;for(c in a)b="ids"==c||"origIDs"==
c?b+(c+"\t:\t"+Object.keys(a[c]).join(",")+"\n"):b+(c+"\t:\t"+a[c]+"\n");return b}})();doubletree=doubletree||{};
...
b&&(b.on("loadedCorpus",function(b,d){a.fireEvent("loadedCorpus",b,d)},a),b.getCorpus&&b.getCorpus()?a.fireEvent("loadedCorpus",a,b.getCorpus()):b.getStore&&b.getStore()&&b.getStore().getCorpus&&b.getStore().getCorpus()&&a.fireEvent("loadedCorpus",a,b.getStore().getCorpus()))}}});this.callParent(arguments)}});Ext.define("Voyant.widget.DownloadFilenameBuilder",{extend:"Ext.form.FieldContainer",mixins:["Voyant.util.Localization","Ext.form.field.Field"],alias:"widget.downloadfilenamebuilder",statics:{i18n:{fieldLabel:{en:"Filenames"},titleLabel:{en:"title"},authorLabel:{en:"author"},pubDateLabel:{en:"date"},enabledLabel:{en:"include: "},availableLabel:{en:"exclude: "}}},config:{name:"documentFilename",itemId:"documentFilename",fields:["pubDate","title","author"],value:["pubDate","title"],width:400},initComponent:function(a){a=
a||{};this.initField();this.on("afterrender",function(){this.items.eachKey(function(a){new Ext.dd.DropZone(this.items.get(a).getTargetEl(),{ddGroup:"downloadfilename",getTargetFromEvent:function(a){a=a.getTarget();return a.className&&-1<a.className.indexOf("dragsource")?a.parentNode:a},onNodeDrop:function(a,b,e,f){a.appendChild(b.el.dom);return!0}})},this);this.getFields().map(function(a){a=Ext.isString(a)?{tag:"span",html:this.localize(a+"Label"),value:a}:a;var c=this.queryById(Ext.Array.contains(this.getValue(),
a.value)?"enabled":"available");a=Ext.dom.Helper.append(c.getTargetEl(),Ext.apply(a,{cls:"dragsource"}));Ext.create("Ext.dd.DragSource",a,{ddGroup:"downloadfilename"})},this)},this);this.callParent(arguments)},defaults:{xtype:"container",width:"100%"},items:[{itemId:"enabled",cls:"dropzone dropzone-enabled"},{itemId:"available",cls:"dropzone dropzone-disabled"}],getValue:function(){return this.rendered?this.getTargetEl().query(".dropzone-enabled .dragsource").map(function(a){return a.getAttribute("value")}):
this.value},setValue:function(a){this.rendered?this.getTargetEl().query(".dragsource",!1).forEach(function(a){var c=Ext.Array.contains(this.value,a.getAttribute("value"));c&&a.parent().hasCls("dropzone-disabled")?this.queryById("enabled").getTargetEl().appendChild(a.dom):!c&&a.parent().hasCls("dropzone-enabled")&&this.queryById("available").getTargetEl().appendChild(a.dom)},this):this.value=a}});Ext.define("Voyant.widget.DownloadFileFormat",{extend:"Ext.form.RadioGroup",mixins:["Voyant.util.Localization"],alias:"widget.downloadfileformat",statics:{i18n:{fieldLabel:{en:"File Format"},voyantXml:{en:"Voyant XML"},VOYANTTip:{en:"This is a normalized version of the content: when the source documents are in XML, this will be mostly the original content, and for most other source document formats this will be simple HTML content."},SOURCETip:{en:"This will attempt to provide the source documents in their original formats. In some cases this means that a single archive (such as a ZIP file) might be provided."},
...
zscore:{en:"Z-Score"},zscoreTip:{en:"The Z-Score, or standard score, is a normalized value for the term's raw frequency compared to other term frequencies in the same document.\x3ctable\x3e\x3ctr\x3e\x3ctd style\x3d'text-align: center; font-size: smaller; font-family: mono;'\x3efrequency of term - mean of term frequencies\x3chr/\x3estandard deviation of term frequencies\x3c/td\x3e\x3c/tr\x3e\x3c/table\x3e."}},api:{stopList:"auto",query:void 0,docId:void 0,docIndex:void 0,bins:10},glyph:"xf0ce@FontAwesome"},
constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.on("loadedCorpus",function(a,b){var e=this.getStore();e.setCorpus(b);e.loadPage(1)});if(a.embedded){window.console&&console.warn(a.embedded.then);var b=Ext.getClass(a.embedded).getName();"Voyant.data.store.DocumentTerms"!=b&&"Voyant.data.model.Document"!=b||this.fireEvent("loadedCorpus",this,a.embedded.getCorpus())}else a.corpus&&this.fireEvent("loadedCorpus",this,a.corpus);
...
this.getStore().loadPage(1,{params:this.getApiParams()})});this.on("activate",function(){this.getStore().getCorpus()&&this.getStore().loadPage(1,{params:this.getApiParams()})},this)},initComponent:function(){var a=Ext.create("Voyant.data.store.DocumentTermsBuffered",{parentPanel:this});Ext.apply(this,{title:this.localize("title"),emptyText:this.localize("emptyText"),store:a,selModel:Ext.create("Ext.selection.CheckboxModel",{listeners:{selectionchange:{fn:function(a,c){this.getApplication().dispatchEvent("documentTermsClicked",
this,c)},scope:this}},pruneRemoved:!1,mode:"SIMPLE"}),dockedItems:[{dock:"bottom",xtype:"toolbar",enableOverflow:!0,items:[{xtype:"querysearchfield"},{xtype:"totalpropertystatus"}]}],columns:[{text:"#",width:30,dataIndex:"docIndex",sortable:!0,renderer:function(a){return a+1}},{text:this.localize("term"),dataIndex:"term",tooltip:this.localize("termTip"),sortable:!0,flex:1},{text:this.localize("rawFreq"),dataIndex:"rawFreq",tooltip:this.localize("rawFreqTip"),width:"autoSize",sortable:!0},{text:this.localize("relativeFreq"),
tooltip:this.localize("relativeFreqTip"),dataIndex:"relativeFreq",width:"autoSize",sortable:!0,renderer:Ext.util.Format.numberRenderer("0,000")},{text:this.localize("tfidf"),tooltip:this.localize("tfidfTip"),dataIndex:"tfidf",width:"autoSize",sortable:!0,hidden:!0,renderer:Ext.util.Format.numberRenderer("0,000.000")},{text:this.localize("zscore"),tooltip:this.localize("zscoreTip"),dataIndex:"zscore",width:"autoSize",sortable:!0,hidden:!0,renderer:Ext.util.Format.numberRenderer("0,000.000")},{xtype:"widgetcolumn",
text:this.localize("trend"),tooltip:this.localize("trendTip"),flex:1,dataIndex:"distributions",widget:{xtype:"sparklineline"}}],listeners:{termsClicked:{fn:function(a,c){if(this.getStore().getCorpus()){var d=[];c.forEach(function(a){Ext.isString(a)?d.push(a):a.term?d.push(a.term):a.getTerm&&d.push(a.getTerm())});0<d.length&&(this.setApiParams({docIndex:void 0,docId:void 0,query:d}),this.isVisible()&&this.isVisible()&&this.getStore().loadPage(1,{params:this.getApiParams()}))}},scope:this}}});this.callParent(arguments);
this.getStore().getProxy().setExtraParam("withDistributions",!0)}});Ext.define("Voyant.panel.Documents",{extend:"Ext.grid.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.documents",isConsumptive:!0,statics:{i18n:{title:{en:"Documents"},emptyText:{en:"No matching results."},helpTip:{en:"\x3cp\x3eDocuments is a table view of the documents in the corpus. Features include:\x3c/p\x3e\x3cul\x3e\x3cli\x3ereordering by \x3ci\x3eTitle\x3c/i\x3e, \x3ci\x3eWords\x3c/i\x3e count (tokens), word forms count (\x3ci\x3eTypes\x3c/i\x3e), and \x3ci\x3eRatio\x3c/i\x3e (Types/Tokens Ratio) (click on the column headers)\x3c/li\x3e\x3cli\x3ea search box for queries (by default in the full-text, title and author fields \x26mdash;\u00a0hover over the magnifying icon for help with the syntax)\x3c/li\x3e\x3c/ul\x3e"},
...
a.y})});a=this.body.down("svg").getHeight()-this.graphMargin.top-this.graphMargin.bottom;var l=d3.scale.linear().domain([0,k]).range([a,0]),m=d3.svg.area().x(function(a){return h(a.x)}).y0(function(a){return l(a.y0)}).y1(function(a){return l(a.y0+a.y)}),k=d3.svg.axis().scale(h).orient("bottom");if(this.getMode()===this.MODE_CORPUS){for(var n=[],q=0;q<=f;q++)n.push(q);k.tickValues(n);k.tickFormat("")}n=d3.svg.axis().scale(l).orient("left");c=this.getVis().selectAll("path").data(c,function(a){return a.name});
c.attr("d",function(a){return m(a.values)}).style("fill",function(a,c){return b(c)});c.enter().append("path").attr("d",function(a){return m(a.values)}).style("fill",function(a,c){return b(c)}).append("title").text(function(a){return a.name});c.exit().remove();this.getVis().selectAll("g.axis").remove();this.getVis().append("g").attr("class","axis x").attr("transform","translate(0,"+a+")").call(k);if(this.getMode()===this.MODE_CORPUS){var s=g/f,p=0;this.getCorpus().getDocuments().each(function(a){this.getVis().select("g.x").append("text").attr("text-anchor",
...
listeners:{afterrender:function(a){a.setValue(parseInt(this.getApiParam("bins")))},changecomplete:function(a,b){this.setApiParams({bins:b});this.getApiParam("docId")||this.getApiParam("docIndex")?this.loadFromDocumentTerms():this.loadFromCorpusTerms()},scope:this}}]}]});this.callParent(arguments)},loadFromDocument:function(a){this.setApiParam({docId:this.getCorpus().getDocument(a).getId(),docIndex:void 0});this.isVisible()&&this.loadFromDocumentTerms(this.getApiParam("query")?void 0:this.getCorpus().getDocumentTerms({proxy:{extraParams:{limit:this.getApiParam("limit")}}}))},
loadFromDocumentTerms:function(a){this.getCorpus()&&(a=a||this.getCorpus().getDocumentTerms({}),a.load({callback:function(a,c,d){d?(this.setMode(this.MODE_DOCUMENT),this.loadFromRecords(a)):Voyant.application.showResponseError(this.localize("failedGetDocumentTerms"),c)},scope:this,params:this.getApiParams(["stopList","query","docId","withDistributions","bins"])}))},loadFromCorpus:function(a){a=a||this.getCorpus();this.setCorpus(a);this.getApiParam("docId")?this.loadFromDocumentTerms():1==a.getDocumentsCount()?
this.loadFromDocument(a.getDocument(0)):this.loadFromCorpusTerms(a.getCorpusTerms({proxy:{extraParams:{limit:this.getApiParam("limit")}}}))},loadFromCorpusTerms:function(a){if(this.getCorpus())if(1==this.getCorpus().getDocumentsCount())this.loadFromDocumentTerms();else{a=a||this.getCorpus().getCorpusTerms({autoLoad:!1});var b=this.getApiParams(["stopList","query","withDistributions","bins"]);b.bins&&b.bins>this.getCorpus().getDocumentsCount()&&(b.bins=this.getCorpus().getDocumentsCount());a.load({callback:function(a,
...
items:[{flex:3,height:"100%",xtype:"scatterplot"},{split:{width:5},flex:1,height:"100%",layout:"vbox",defaults:{width:"100%",flex:1},items:[{xtype:"documents",collapsible:!0},{xtype:"trends",collapsible:!0},{xtype:"contexts",collapsible:!0}]}]});Ext.define("Voyant.panel.Subset",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel","Voyant.util.Downloadable"],alias:"widget.subset",statics:{i18n:{title:{en:"Workset Builder"},titleLabel:{en:"Titles"},authorLabel:{en:"Authors"},lexicalLabel:{en:"Full-text"},publisherLabel:{en:"Publishers"},sendToVoyantButton:{en:"New Voyant Corpus"},downloadButton:{en:"Download Zip Archive"},sendToVoyantNoQuery:{en:"There's currently no query specified, but you can \x3ca href\x3d'{0}' target\x3d'_blank'\x3eopen the current corpus in a new window\x3c/a\x3e."},
noMatches:{en:"The current query criteria don't match any documents, please modifying the search first."}},api:{stopList:"auto",documentFilename:["pubDate","title"],documentFormat:"SOURCE"},glyph:"xf0ce@FontAwesome"},config:{options:{xtype:"stoplistoption"},inDocumentsCountOnly:!1,stopList:"auto",store:void 0},constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(a){var b=this;Ext.applyIf(b,{introHtml:"",fieldItems:[{xtype:"querysearchfield",
fieldLabel:this.localize("titleLabel"),tokenType:"title"},{xtype:"querysearchfield",fieldLabel:this.localize("authorLabel"),tokenType:"author"},{xtype:"querysearchfield",fieldLabel:this.localize("termsLabel")}],fieldColumns:2});Ext.applyIf(b,{intro:{margin:"5 0 5 0",layout:"center",items:{itemId:"intro",html:b.introHtml}},fields:{xtype:"container",layout:"center",items:{xtype:"container",maxWidth:1200,layout:{type:"table",columns:b.fieldColumns},items:b.fieldItems.map(function(a){return{xtype:"container",
