...
return b};b.redraw=function(){b.setupFromTries(z,I);return b};b.setupFromTries=function(d,k){z=d.getUniqRoot();I=k.getUniqRoot();var B=z.toTree(m.left),v=I.toTree(m.right),w=!0;0<Object.keys(v.pruned).length&&(a(v,v.pruned,w),a(B,v.pruned,w),w=!1);0<Object.keys(B.pruned).length&&(a(B,B.pruned,w),a(v,B.pruned,w));var w={},F;for(F in v.info)"continuations"!=F&&"ids"!=F&&"count"!=F&&(w[F]=v.info[F]);w["right continuations"]=v.info.continuations;w["left continuations"]=B.info.continuations;w.ids={};c(w.ids,
v.info.ids);c(w.ids,B.info.ids);w.count=Object.keys(w.ids).length;J=Object.keys(w.ids);if(v.info.origIDs||B.info.origIDs)w.origIDs={},c(w.origIDs,v.info.origIDs),c(w.origIDs,B.info.origIDs),w.origCount=Object.keys(w.origIDs).length;v.info=w;B.info=w;F=Math.max(B.maxChildren,v.maxChildren);if(isNaN(F)||0==F)return D=!1,b;q?M=d3.scale.log().range([8,14]):(M=function(){return 14},M.domain=function(){});F=Math.min(B.minCount,v.minCount);M.domain([F,B.info.count]);var N=g-20-20,O=h-20-20;f[0].forEach(function(a,
b){function c(){var a=d3.event.scale,b=d3.event.translate;d3.select(d).select("svg \x3e g").attr("transform","translate("+b+") scale("+a+")")}var d=a,e;e=d3.select(d).select("svg");null==e[0][0]?(e=d3.select(d).append("svg").attr("width",N+20+20).attr("height",O+20+20).attr("cursor","move").call(d3.behavior.zoom().scaleExtent([1,1]).on("zoom",c)),e.append("g")):(e.attr("width",N+20+20).attr("height",O+20+20),e.selectAll("g *").remove());E=new doubletree.Tree(e.select("g"),g,h,B,!0,u,G,M,n,p,r,C,s,
H,L);A=new doubletree.Tree(e.select("g"),g,h,v,!1,u,G,M,n,p,r,C,s,H,L)});E.handleAltPress=l.alt;A.handleAltPress=l.alt;E.handleShiftPress=l.shift;A.handleShiftPress=l.shift;E.handleClick=l.click;A.handleClick=l.click;D=!0;return b};b.setupFromArrays=function(a,c,d,f,g,h,m,l){void 0==g&&z&&(g=z.caseSensitive());void 0==h&&z&&(h=z.fieldNames());void 0==m&&z&&(m=z.fieldDelim());void 0==l&&z&&(l=z.distinguishingFieldsArray());z=new doubletree.Trie(g,h,m,l);I=new doubletree.Trie(g,h,m,l);g=c.length;for(h=
0;h<g;h++){m=f?f[h]:h;l=c[h];var r=a[h].slice(),n=d[h].slice();r.push(l);r.reverse();n.unshift(l);k?(I.addNgram(r,m),z.addNgram(n,m)):(z.addNgram(r,m),I.addNgram(n,m))}b.setupFromTries(z,I);return b};b.filteredIDs=function(){return J};b.search=function(a){E.search(a);A.search(a);a=d3.select(f[0][0]);var b=a.selectAll("text.foundText");if(b.empty())return 0;b=b[0].length;null!=a.selectAll("text.rtNdText.foundText")[0][0]&&b--;return b};b.clearSearch=function(){E.clearSearch();A.clearSearch();return b};
b.updateTokenExtras=function(){E.showTokenExtras(n);A.showTokenExtras(n);var a=d3.select(f[0][0]).select('.tokenExtra[display\x3d"inline"]');a.empty()||"0px"==a.style("height")&&b.redraw();return b};b.visWidth=function(a){if(!arguments.length)return g;g=a;return b};b.visHeight=function(a){if(!arguments.length)return h;h=a;return b};b.prefixesOnRight=function(a){if(!arguments.length)return k;k=a;return b};b.filters=function(a){if(!arguments.length)return m;m=a;return b};b.handlers=function(a){if(!arguments.length)return l;
l=a;return b};b.showTokenExtra=function(a){if(!arguments.length)return n;n=a;return b};b.scaleLabels=function(a){if(!arguments.length)return q;q=a;return b};b.succeeded=function(){return D};b.sortFun=function(a){if(!arguments.length)return u;u=a;return b};b.nodeText=function(a){if(!arguments.length)return p;p=a;return b};b.tokenExtraText=function(a){if(!arguments.length)return r;r=a;return b};b.rectColor=function(a){if(!arguments.length)return C;C=a;return b};b.rectBorderColor=function(a){if(!arguments.length)return s;
s=a;return b};b.continuationColor=function(a){if(!arguments.length)return H;H=a;return b};b.basicStyles=function(a){if(!arguments.length)return L;Object.keys(L).forEach(function(b){b in a&&Object.keys(L[b]).forEach(function(c){c in a[b]&&(L[b][c]=a[b][c])})});return b};return b};doubletree.Tree=function(a,b,c,d,k,m,l,n,q,u,p,r,C,s,H){function L(a){a.children&&(a._children=a.children,a._children.forEach(L),a.children=null)}function D(a){a.parent&&a.parent.children.forEach(function(b){b!=a&&L(b)})}
function G(a,b){d3.event.altKey?F.handleAltPress(a,b):d3.event.shiftKey?F.handleShiftPress(a,b):(F.handleClick(a,b),a.parent&&(F.continuationIDs!=a.info.ids&&(F.setIds(a.info.ids),F.clickedNode=a.id,l.idsUpdated.apply(F)),D(a),z(a,!0)))}function z(a,b){a.children?(a.children&&1==a.children.length&&z(a.children[0],!0),a._children=a.children,a.children=null):(a.children=a._children,a._children=null,a.children&&1==a.children.length&&z(a.children[0],!1));b&&F.update(a)}function I(a){return k?J/2-a:J/
2+a}var E=q,A=r,J=b-20-20,M=c-20-20,K=0,x,B;m||(m=doubletree.sortByStrFld("token"));var v=d3.layout.tree().nodeSize([40,40]).sort(m),w=d3.svg.diagonal().projection(function(a){return[I(a.y),a.x-B]});a=a.append("g").attr("transform","translate(20,20)");this.readJSONTree=function(a){x=a;x.x0=M/2;x.y0=J/2;x.children.forEach(L);this.update(x)};var F=this;this.update=function(b){b||(b=x);var c=v.nodes(x).reverse();B=x.x-M/2;c.forEach(function(a){for(var b=0,c=a.parent;null!=c;)b+=Ext.draw.TextMeasurer.measureText(c.name,
"arial").width,c=c.parent;a.y=25*a.depth+b});var d=a.selectAll("g.node_"+k).data(c,function(a){return a.id||(a.id=++K)}),f=d.enter().append("g").attr("class","node node_"+k).attr("cursor","pointer").attr("transform",function(a){return"translate("+I(b.y0)+","+(b.x0-B)+")"}).on("click",G);f.append("title").text(function(a){return doubletree.infoToText(a.info)});f.append("circle").attr("r",1E-6).style("fill",function(a){return a._children?"#fff":H.node.fill}).style("stroke",function(a){return H.node.stroke});
f=f.append("text").attr("class",function(a){return 0==a.depth?"rtNdText":""}).attr("x",function(a){return a.children||a._children?0:k?10:-10}).attr("text-anchor",function(a){return a.parent?a.children||a._children?k?"end":"start":k?"start":"end":"middle"}).style("font-size",function(a){return n(a.info.count)+"pt"});f.append("tspan").attr("dy",".35em").attr("class","tokenText").text(function(a){return u(a.info,1>a.depth)}).style("fill-opacity",1E-6);f.append("tspan").attr("dx",".35em").attr("class",
...
e=c.getDimensions(),g=0;g<e.length&&!(g>=d);g++)h=parseFloat(e[g].data),a+=this.localize("dimension")+" "+(g+1)+" ("+this.localize(k[g])+"): "+Math.round(100*h)/100+"%\n";var m=0,l=Number.MAX_VALUE,n=0,q=Number.MAX_VALUE;"docSim"!==this.getApiParam("analysis")&&this.termStore.removeAll();var u=[],p=[];c.getTokens().forEach(function(a){var b=a.get("rawFreq"),c=a.get("category");void 0===c&&(c="term");var e="term"===c;e&&(b>m&&(m=b),b<l&&(l=b),this.termStore.findExact("term",-1===a.get("term"))&&this.termStore.addSorted(a));
...
this.setApiParam("limit",c);c=Ext.create("Ext.data.JsonStore",{fields:"term x y z rawFreq relativeFreq cluster category docIndex".split(" "),data:u});g=Ext.create("Ext.data.JsonStore",{fields:"term x y z rawFreq relativeFreq cluster category docIndex".split(" "),data:p});a={itemId:"chart",xtype:"cartesian",interactions:["crosszoom","panzoom","itemhighlight"],plugins:{ptype:"chartitemevents"},axes:[{type:"numeric",position:"bottom",fields:["x"]},{type:"numeric",position:"left",fields:["y"]}],sprites:[{type:"text",
...
!a.corpus&&this.getCorpusId&&this.getCorpusId()&&(a.corpus=this.getCorpusId());this.loadCorpusFromParams(a);if(a.palette)if(-1<a.palette.indexOf(",")){var b=Ext.decode(a.palette);this.addColorPalette(a.palette,b)}else this.loadColorPaletteForCorpus(a.corpus,a.palette)}},loadCorpusFromParams:function(a){var b=this,c=b.getViewport();c.mask(this.localize("fetchingCorpus"));a.archive&&(Ext.isString(a.archive)&&(a.archive=[a.archive]),a.archive=a.archive.map(function(a){return a.replace("/blogs.sub.uni-hamburg.de/hup/lhn/",
...
this.getCorpusId()},loadColorPaletteForCorpus:function(a,b){Ext.Ajax.request({url:this.getTromboneUrl(),params:{tool:"resource.StoredResource",retrieveResourceId:b,corpus:a},success:function(a,d){var e=Ext.util.JSON.decode(a.responseText).storedResource.resource,e=Ext.decode(e);this.addColorPalette(b,e)},failure:function(a){this.setApiParam("palette",void 0)},scope:this})},listeners:{loadedCorpus:function(a,b){this.setCorpus(b);this.colorTermAssociations.clear();this.on("unhandledEvent",function(a,
d,e){a=this.getBaseUrl()+"?corpus\x3d"+b.getAliasOrId();var f=this.getModifiedApiParams()||{};delete f.view;if("termsClicked"==d)f.query=e;else if("documentsClicked"==d){var g=[];e.forEach&&e.forEach(function(a){g.push(a.getIndex())});f.docIndex=g}else if("corpusTermsClicked"==d)e.map&&(f.query=e.map(function(a){return a.getTerm()}));else if("documentTermsClicked"==d)e.map&&(f.query=e.map(function(a){return a.getTerm()}),f.docIndex=e.map(function(a){return a.getDocIndex()}));else{console&&console.warn("Unhandled event: "+
d,e);return}f.toolFlow&&(d=Ext.Array.from(f.toolFlow.split(",")),f.view=d.shift(),0<d.length?f.toolFlow=d.join(","):delete f.toolFlow);a+="\x26"+Ext.Object.toQueryString(f);this.openUrl(a)})}}});Ext.define("Voyant.VoyantDefaultApp",{extend:"Voyant.VoyantCorpusApp",mixins:["Voyant.util.Api"],name:"VoyantDefaultApp",constructor:function(){this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);this.callParent(arguments)},statics:{i18n:{},api:{view:"corpusset",stopList:"auto",panels:void 0,rtl:void 0}},listeners:{loadedCorpus:function(a,b){this.viewport.down("voyantheader").collapse();this.viewport.down("#toolsContainer").setActiveItem(1);var c=this.getCorpusId&&this.getCorpusId()?
