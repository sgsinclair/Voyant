/* This file created by JSCacher. Last modified: Thu Apr 05 15:07:28 EDT 2018 */
...
map:"Map",mapTip:"Define base layer and projection"},api:{stopList:"auto",hide:[],author:void 0,title:void 0,keyword:void 0,pubDate:void 0,citiesMaxCount:500,minPopulation:1E4,citiesMinFreq:1,connectionsMaxCount:2500,connectionsMinFreq:1,millisPerAnimation:2E3},glyph:"xf124@FontAwesome"},config:{map:void 0,overlay:void 0,contentEl:void 0,isOpenLayersLoaded:!1,isArcLoaded:!1,animationDelay:25,isProj4Loaded:!1,projection:void 0,filterWidgets:new Ext.util.MixedCollection,drawInteraction:void 0,drawMode:!1,
currentAnnotation:void 0,baseLayers:{}},html:'\x3cdiv class\x3d"map"\x3e\x3c/div\x3e\x3cdiv class\x3d"ticker"\x3e\x3c/div\x3e\x3cdiv class\x3d"ol-popup"\x3e\x3ca href\x3d"#" class\x3d"ol-popup-closer"\x3e\x3c/a\x3e\x3cdiv class\x3d"popup-content"\x3e\x3c/div\x3e\x3c/div\x3e',cls:"dreamscape",constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);Ext.Loader.loadScript({url:this.getBaseUrl()+"resources/openlayers/ol.js",onLoad:function(){void 0===
ol.Map.prototype.getLayer&&(ol.Map.prototype.getLayer=function(a){var c=void 0;this.getLayers().forEach(function(d){a===d.get("id")&&(c=d)});return c});this.setIsOpenLayersLoaded(!0)},scope:this});Ext.Loader.loadScript({url:this.getBaseUrl()+"resources/dreamscape/arc.js",onLoad:function(){this.setIsArcLoaded(!0)},scope:this});Ext.Loader.loadScript({url:"https://cdnjs.cloudflare.com/ajax/libs/proj4js/2.4.4/proj4.js",onLoad:function(){this.setIsProj4Loaded(!0)},scope:this})},initComponent:function(){this.mixins["Voyant.util.Api"].constructor.apply(this,
arguments);var a=this.getApiParam("hide");Ext.isString(a)&&(a=a.split(","),this.setApiParam("hide"));this.getApplication().getBaseUrl();Ext.apply(this,{title:this.localize("title"),bodyBorder:!0,dockedItems:[{dock:"bottom",xtype:"toolbar",itemId:"bottomToolbar",overflowHandler:"scroller",items:[{text:this.localize("display"),tooltip:this.localize("displayTip"),glyph:"xf013@FontAwesome",menu:{defaults:{xtype:"menucheckitem",checkHandler:function(a,c){var d=this.getMap(),e=a.getItemId();this.getFilterWidgets().each(function(a){d.getLayer(a.getId()+
...
this.getIsArcLoaded()&&this.getIsProj4Loaded()){var a=this.body.down(".map").setId(Ext.id()),b=this.body.down(".ol-popup"),c=new ol.Overlay({element:b.dom,autoPan:!0,autoPanAnimation:{duration:250}});this.setOverlay(c);var d=this,e=b.down(".ol-popup-closer").dom;e.onclick=function(){c.setPosition(void 0);e.blur();return!1};var f=this.getBaseLayers();f.wms4326=new ol.layer.Tile({preload:Infinity,source:new ol.source.TileWMS({url:"https://ahocevar.com/geoserver/wms",crossOrigin:"",params:{LAYERS:"ne:NE1_HR_LC_SR_W_DR",
TILED:!0},projection:"EPSG:4326"})});f.watercolor=new ol.layer.Tile({preload:Infinity,source:new ol.source.Stamen({layer:"watercolor",projection:"EPSG:3857"})});f.osm=new ol.layer.Tile({preload:Infinity,source:new ol.source.OSM({projection:"EPSG:3857"})});f.arcGIS=new ol.layer.Tile({preload:Infinity,source:new ol.source.TileArcGISRest({url:"https://services.arcgisonline.com/ArcGIS/rest/services/NatGeo_World_Map/MapServer",projection:"EPSG:3857"})});this.setContentEl(b.down(".popup-content"));var g=
new ol.Map({layers:[f.watercolor,new ol.layer.Tile({preload:Infinity,source:new ol.source.Stamen({cacheize:2048,layer:"toner-hybrid",projection:"EPSG:3857"}),id:"overlayLayer"})],overlays:[c],target:a.getId(),loadTilesWhileInteracting:!0,view:new ol.View({center:[0,0],maxResolution:4.007501668557849E7/d.body.dom.offsetWidth,zoom:0})});g.on("singleclick",function(a){var b=g.getFeaturesAtPixel(a.pixel);if(b){var c=!1;b.forEach(function(b){"city"===b.get("type")&&b.get("selected")?(d.dispatchEvent("termsClicked",
d,[b.get("forms").join("|")]),c=!0):"connection"===b.get("type")&&b.get("selected")&&!c?(d.getFilterWidgets().each(function(c){c=c.getGeonames();if(null!=c){var e="\x3cul\x3e",f=-1;c.getAllConnectionOccurrences(b.get("source"),b.get("target")).forEach(function(a){a.docIndex!=f&&(f=a.docIndex,e+=d.getCorpus().getDocument(f).getFullLabel()+":\x3cbr\x3e");e+="\x3cli\x3e"+a.source.left+'\x3ca href\x3d"http://www.geonames.org/'+a.source.id+'" target\x3d"_blank" docIndex\x3d'+a.docIndex+" offset\x3d"+a.source.position+
" location\x3d"+a.source.form+' class\x3d"termLocationLink"\x3e'+a.source.form+"\x3c/a\x3e "+a.source.right+" [...] "+a.target.left+'\x3ca href\x3d"http://www.geonames.org/'+a.target.id+'" target\x3d"_blank" docIndex\x3d'+a.docIndex+" offset\x3d"+a.target.position+" location\x3d"+a.target.form+' class\x3d"termLocationLink"\x3e'+a.target.form+"\x3c/a\x3e "+a.target.right+"\x3c/li\x3e"});c=b.get("text");e+="\x3c/ul\x3e";d.getContentEl().setHtml("\x3ch3\x3e"+c+"\x3c/h3\x3e"+e);d.getOverlay().setPosition(a.coordinate);
Ext.select(".termLocationLink").elements.forEach(function(a){a.onmouseover=function(){d.showTermInCorpus(a.getAttribute("docIndex"),a.getAttribute("offset"),a.getAttribute("location"))}})}}),c=!0):"annotation"!==b.get("type")||c||(d.setCurrentAnnotation(b),d.getContentEl().setHtml('\x3ctextarea class\x3d"annotation-text" rows\x3d"5" cols\x3d"60"\x3e'+(b.get("text")?b.get("text"):"")+'\x3c/textarea\x3e\x3cbutton class\x3d"saveAnnotation"\x3eSave\x3c/button\x3e\x3cbutton class\x3d"deleteAnnotation"\x3eDelete\x3c/button\x3e'),
...
b=this.getMap().getLayer("annotations").getSource().getFeatures(),c=[],d=this.getProjection();b.forEach(function(a){transformedFeature=a.clone();transformedFeature.getGeometry().transform(d?d:"EPSG:3857","EPSG:3857");c.push(transformedFeature)});a=a.writeFeatures(c);localStorage.annotations=JSON.stringify(a)},saveAnnotation:function(){this.getCurrentAnnotation().set("text",this.getContentEl().down(".annotation-text").dom.value);this.getOverlay().setPosition(void 0);this.getDrawMode()&&this.getDockedComponent("bottomToolbar").getComponent("annotate").click();
var a=new ol.format.GeoJSON,b=this.getMap().getLayer("annotations").getSource().getFeatures(),c=[],d=this.getProjection();b.forEach(function(a){transformedFeature=a.clone();transformedFeature.getGeometry().transform(d?d:"EPSG:3857","EPSG:3857");c.push(transformedFeature)});a=a.writeFeatures(c);localStorage.annotations=JSON.stringify(a)},travelStyleFunction:function(a,b){var c=new ol.style.Stroke({color:a.get("color"),width:a.get("width")}),d=[new ol.style.Style({stroke:c})],e=a.getGeometry(),f=e.getLastCoordinate(),
e=e.getCoordinateAt(.9),e=Math.atan2(f[1]-e[1],f[0]-e[0]),g=new ol.geom.LineString([f,[f[0]-10*b,f[1]+10*b]]);g.rotate(e,f);var h=new ol.geom.LineString([f,[f[0]-10*b,f[1]-10*b]]);h.rotate(e,f);d.push(new ol.style.Style({geometry:g,stroke:c}));d.push(new ol.style.Style({geometry:h,stroke:c}));return d},cityStyleFunction:function(a,b){if(a.get("visible")){var c=2*Math.PI*a.get("width"),d=a.get("confidence")?c*a.get("confidence"):c;return new ol.style.Style({image:new ol.style.Circle({radius:a.get("width"),
fill:new ol.style.Fill({color:a.get("color")}),stroke:new ol.style.Stroke({lineDash:[d,c-d],color:"rgb(255, 255, 255)",width:2})})})}return!1},animationStyleFunction:function(a){return[new ol.style.Style({stroke:new ol.style.Stroke({color:a.get("color"),width:5})}),new ol.style.Style({geometry:new ol.geom.Circle(a.getGeometry().getFirstCoordinate()),stroke:new ol.style.Stroke({color:"white",width:10})}),new ol.style.Style({geometry:new ol.geom.Circle(a.getGeometry().getLastCoordinate()),stroke:new ol.style.Stroke({color:"white",
width:10})})]},showTermInCorpus:function(a,b,c){a=Ext.create("Voyant.data.model.Context",{docIndex:a,position:b,term:c});this.getApplication().dispatchEvent("termLocationClicked",this,[a])},filterUpdate:function(a){var b=this;a.clearAnimation();var c=this.getMap(),d=a.getColor(),e=parseInt(this.getApiParam("citiesMaxCount")),f=0;a.getGeonames().eachCity(function(a){a.rawFreq>f&&(f=a.rawFreq)},this,e);var g=c.getLayer(a.getId()+"-cities").getSource(),h=Ext.Array.from(this.getApiParam("hide"));g.clear();
var k=parseInt(this.getApiParam("minPopulation")),l=parseInt(this.getApiParam("citiesMinFreq")),m={};a.getGeonames().eachCity(function(a){if((!k||a.population>=k)&&(!l||a.rawFreq>=l)){m[a.id]=!0;var c=[parseFloat(a.longitude),parseFloat(a.latitude)];a=new ol.Feature({geometry:(new ol.geom.Point(c)).transform(ol.proj.get("EPSG:4326"),b.getProjection()?b.getProjection():ol.proj.get("EPSG:3857")),text:a.label+" ("+a.rawFreq+")",description:a.label,color:d,selected:!1,width:3+20*Math.sqrt(a.rawFreq/f),
visible:!0,coordinates:c,forms:a.forms,cityId:a.id,type:"city",confidence:a.confidence?100*a.confidence:void 0});g.addFeature(a)}},this,e);0<g.getFeatures().length&&c.getView().fit(g.getExtent());c.getLayer(a.getId()+"-cities").setVisible(0==Ext.Array.contains(h,"cities"));g=c.getLayer(a.getId()+"-connections").getSource();g.clear();0==Object.keys(m).length&&this.toastInfo("No cities available for current criteria.");f=0;a.getGeonames().eachConnection(function(a){a.rawFreq>f&&(f=a.rawFreq)},this);
var n=0,q=parseInt(this.getApiParam("connectionsMaxCount")),r=parseInt(this.getApiParam("connectionsMinFreq"));a.getGeonames().eachConnection(function(a){if((!r||a.rawFreq>=r)&&(!q||n<q)&&a.source.id in m&&a.target.id in m&&(!k||a.source.population>=k&&a.target.population>=k)){var c=(new arc.GreatCircle({x:a.source.longitude,y:a.source.latitude},{x:a.target.longitude,y:a.target.latitude})).Arc(100,{offset:100}),e=a.source.label+" -\x3e "+a.target.label+" ("+a.rawFreq+")";c.geometries.forEach(function(c){c=
new ol.geom.LineString(c.coords);c.transform(ol.proj.get("EPSG:4326"),b.getProjection()?b.getProjection():ol.proj.get("EPSG:3857"));c=new ol.Feature({geometry:c,text:e,color:d,width:3+10*Math.sqrt(a.rawFreq/f),source:a.source.id,target:a.target.id,type:"connection"});g.addFeature(c)},this);n++}},this);c.getLayer(a.getId()+"-connections").setVisible(0==Ext.Array.contains(h,"connections"));a.animate()}});
