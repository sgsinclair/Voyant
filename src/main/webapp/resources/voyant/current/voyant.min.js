...
layout:"fit",constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.setCirrusId(Ext.id(null,"cirrus_"))},initComponent:function(a){Ext.apply(this,{title:this.localize("title"),dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"corpusdocumentselector",singleSelect:!0},{fieldLabel:this.localize("visibleTerms"),labelWidth:40,width:120,xtype:"slider",increment:25,minValue:25,maxValue:500,listeners:{afterrender:function(a){a.maxValue=
...
e=d.getSize(!1),d=d.dom.rows,f=0;f<d.length;f++)for(var g=d[f].cells,h=0;h<g.length;h++){var k=Ext.get(g[h]),l=k.down(".x-panel"),m=l.id;if(void 0!==a&&void 0!==b)k=l.getSize(!1),k.width*=a,k.height*=b;else{var l=k.getSize(!1),n=Ext.getCmp(m),q=n.initialConfig.cellWidth,n=n.initialConfig.cellHeight;void 0!==q&&(l.width=q/100*e.width,k.setWidth(l.width));void 0!==n&&(l.height=n/100*e.height,k.setHeight(l.height));k=l}c[m]=k}for(var s in c)k=c[s],Ext.getCmp(s).setSize(k);this.updateLayout()}});Ext.define("Voyant.panel.Veliza",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],xtype:"veliza",autoScroll:!0,statics:{i18n:{title:"Veliza",typeAndEnter:"Type text and hit enter.",send:"send",fromCorpus:"from text"},api:{},glyph:"xf0e6@FontAwesome"},config:{previous:[]},initComponent:function(a){var b=this;Ext.apply(this,{title:this.localize("title"),glyph:"xf0e6@FontAwesome",html:"\x3cform class\x3d'chat'\x3e\x3c/form\x3e",dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",
items:[{xtype:"textfield",emptyText:this.localize("typeAndEnter"),flex:1,listeners:{specialkey:function(a,d){d.getKey()==d.ENTER&&b.handleUserSentence(a.getValue())}}},{xtype:"button",text:this.localize("send"),handler:function(){b.handleUserSentence(this.up("toolbar").down("textfield").getValue(),!1)}},{xtype:"button",text:this.localize("fromCorpus"),handler:function(){b.handleUserSentence("",!0)}}]}]});this.callParent();this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.on("boxready",
function(a){a.addSentence("fromThem","Hello, I'm Veliza, and I'm here to talk to you about your texts (you may know my sister \x3ca href\x3d'https://en.wikipedia.org/wiki/ELIZA' target\x3d'_blank'\x3eEliza\x3c/a\x3e she's a famous psychotherapist). I'm just learning to talk about text documents, but please, let me know about any anxieties you're feeling about your texts. Type a message in the box below and hit enter. Or, if you're feeling playful, hit the \x3ci\x3efrom text\x3c/i\x3e bottom in the lower right-hand corner to fetch a sentence from the corpus.")})},
listeners:{},handleUserSentence:function(a,b){if((a=a.trim())||b){a&&this.addSentence("myMessage",a);this.down("textfield").setValue("");this.mask();var c=this;Ext.Ajax.request({url:this.getApplication().getTromboneUrl(),params:{corpus:c.getCorpus().getId(),tool:"corpus.Veliza",sentence:a,previous:this.getPrevious(),fromCorpus:b?!0:!1,noCache:Ext.id()},success:function(a,e){c.unmask();a=Ext.decode(a.responseText);var f=a.veliza.response,g=a.veliza.sentence;c.setPrevious(a.veliza.previous);b?(meta=
-1<a.veliza.docIndex?c.getCorpus().getDocument(a.veliza.docIndex).getShortLabel():void 0,c.addSentence("myMessage",g,meta),Ext.Function.defer(function(){this.addSentence("fromThem",f);this.body.scroll("b",Infinity)},500,c)):(c.addSentence("fromThem",f),c.body.scroll("b",Infinity))},failure:function(a,b){c.showResponseError("Unable to get response from Veliza.",a)}})}},addSentence:function(a,b,c){this.body.down("form").insertHtml("beforeEnd",'\x3cdiv class\x3d"message"\x3e\x3cdiv class\x3d"'+a+'"\x3e\x3cp\x3e'+
b+"\x3c/p\x3e"+(c?"\x3cdate\x3e"+c+"\x3c/date\x3e":"")+"\x3c/div\x3e\x3c/div\x3e",!0);this.body.scroll("b",Infinity)}});Ext.define("Voyant.panel.WordTree",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.wordtree",statics:{i18n:{},api:{query:void 0,docId:void 0,docIndex:void 0,stopList:"auto",context:10,limit:100},glyph:"xf0e8@FontAwesome"},config:{tree:void 0,kwicStore:void 0,options:{xtype:"stoplistoption"},numBranches:5,lastClick:1},doubleClickDelay:300,constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(){Ext.apply(this,
