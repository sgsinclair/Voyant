...
a)}).then(function(a){!("docsLimit"in b)||!1!==b.docsLimit&&0<b.docsLimit?d.getDocuments().load({params:{limit:"docsLimit"in b?b.docsLimit:d.getDocumentsCount()},callback:function(b,g,h){h?(d.setDocumentsStore(this),c.resolve(a)):c.reject(g)}}):c.resolve(a)})}else Voyant.application.showError(this.localize("badDataTypeCorpus")+": ("+typeof b+") "+b),Ext.defer(function(){c.reject(this.localize("badDataTypeCorpus")+": ("+typeof b+") "+b)},50,this);return c.promise},getId:function(){return this.then?
Voyant.application.getDeferredNestedPromise(this,arguments):this.get("id")},getAliasOrId:function(){return this.then?Voyant.application.getDeferredNestedPromise(this,arguments):this.get("alias")||this.get("id")},loadCorpusTerms:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments);var b=Voyant.application.getDeferred(this);a=a||{};Ext.isNumber(a)&&(a={limit:a});Ext.applyIf(a,{limit:0});var c=this.getCorpusTerms();c.load({params:a,callback:function(a,e,f){f?b.resolve(c):
b.reject(e)}});return b.promise},loadTokens:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments);var b=Voyant.application.getDeferred(this);a=a||{};Ext.isNumber(a)&&(a={limit:a});Ext.applyIf(a,{limit:0});var c=this.getTokens();c.load({params:a,callback:function(a,e,f){f?b.resolve(c):b.reject(e)}});return b.promise},getCorpusTerms:function(a){return Ext.create("Voyant.data.store.CorpusTerms",Ext.apply(a||{},{corpus:this}))},getTokens:function(a){return Ext.create("Voyant.data.store.Tokens",
Ext.apply(a||{},{corpus:this}))},each:function(a,b){this.getDocuments().each(function(c,d){a.call(b||c,c,d)})},getCorpusCollocates:function(a){return Ext.create("Voyant.data.store.CorpusCollocates",Ext.apply(a||{},{corpus:this}))},getDocumentQueryMatches:function(a){return Ext.create("Voyant.data.store.DocumentQueryMatches",Ext.apply(a||{},{corpus:this}))},getDocumentTerms:function(a){return Ext.create("Voyant.data.store.DocumentTerms",Ext.apply(a||{},{corpus:this}))},getDocumentEntities:function(a){return Ext.create("Voyant.data.store.DocumentEntities",
Ext.apply(a||{},{corpus:this}))},loadContexts:function(a){if(this.then)return Voyant.application.getDeferredNestedPromise(this,arguments);var b=Voyant.application.getDeferred(this);a=a||{};Ext.isNumber(a)&&(a={limit:a});Ext.applyIf(a,{limit:0});var c=this.getContexts();c.load({params:a,callback:function(a,e,f){f?b.resolve(c):b.reject(e)}});return b.promise},getContexts:function(a){return Ext.create("Voyant.data.store.Contexts",Ext.apply(a||{},{corpus:this}))},getDocuments:function(a){return this.getDocumentsStore()?
...
function(){this.getStore().getCorpus()&&this.getStore().load()},this);a.on("query",function(a,c){this.setApiParam("query",c);this.getStore().load()},a);a.callParent(arguments)}});Ext.define("Voyant.panel.CorpusCreator",{extend:"Ext.form.Panel",requires:["Ext.form.field.File"],requires:["Voyant.data.model.Corpus"],mixins:["Voyant.panel.Panel"],alias:"widget.corpuscreator",isConsumptive:!0,statics:{i18n:{},api:{inputFormat:void 0,xmlDocumentsXpath:void 0,xmlContentXpath:void 0,xmlTitleXpath:void 0,xmlAuthorXpath:void 0,tokenization:void 0,adminPassword:void 0,accessPassword:void 0,noPasswordAccess:void 0,tableDocuments:void 0,tableContent:void 0,tableTitle:void 0,tableAuthor:void 0,
title:void 0,subTitle:void 0,inputRemoveFrom:void 0,inputRemoveFromAfter:void 0,inputRemoveUntil:void 0,inputRemoveUntilAfter:void 0}},constructor:function(a){this.callParent(arguments);a=a||{};this.mixins["Voyant.panel.Panel"].constructor.call(this,Ext.apply(a,{includeTools:{gear:!0,help:!0,language:this.getLanguageToolMenu()}}))},initComponent:function(){var a=this;Ext.apply(a,{title:this.localize("title"),width:800,frame:!0,padding:10,style:{borderColor:"#aaa",borderStyle:"solid"},frameHeader:!0,
layout:{type:"vbox",align:"middle"},dockedItems:[{xtype:"toolbar",overflowHandler:"scroller",dock:"bottom",buttonAlign:"right",items:[{text:a.localize("Open"),glyph:"xf115@FontAwesome",tooltip:a.localize("SelectExisting"),hidden:void 0!=this.getCorpus(),handler:function(){Ext.create("Ext.window.Window",{title:a.localize("Open"),layout:"fit",modal:!0,items:{xtype:"form",submitEmptyText:!1,margin:"5,5,5,5",items:{xtype:"corpusselector"},buttons:[{text:a.localize("Open"),glyph:"xf00c@FontAwesome",handler:function(b){b.up("form").getForm();
var c=b.up("form").getForm().getValues().corpus;""!=c?(a.loadCorpus({corpus:c}),b.up("window").close()):Ext.Msg.show({title:a.localize("SelectExisting"),message:a.localize("PleaseSelectExisting"),buttons:Ext.Msg.OK,icon:Ext.Msg.ERROR})},flex:1},{text:a.localize("cancel"),glyph:"xf00d@FontAwesome",flex:1,handler:function(a){a.up("window").close()}}]}}).show()}},{xtype:"fileuploadfield",glyph:"xf093@FontAwesome",name:"upload",buttonOnly:!0,hideLabel:!0,ui:"default-toolbar",buttonText:a.localize("Upload"),
listeners:{render:function(b){b.fileInputEl.dom.setAttribute("multiple",!0);Ext.tip.QuickTipManager.register({target:b.getEl(),text:a.localize("UploadLocal")})},beforedestroy:function(a){Ext.tip.QuickTipManager.unregister(a.getEl())},change:function(b,c){if(c){var d=b.up("form").getForm();if(d.isValid()){for(var e=b.fileInputEl.dom.files,f=/\.(png|gif|jpe?g|xls|mp[234a]|mpeg|exe|wmv|avi|ppt|mpg|tif|wav|mov|psd|wma|ai|bmp|pps|aif|pub|dwg|indd|swf|asf|mbd|dmg|flv)$/i,g=/\.(txt|pdf|html?|xml|docx?|rtf|pages|epub|odt|zip|jar|tar|gz|ar|cpio|bzip2|bz2|gzip|xlsx?)$/i,
h=[],k=[],l=0,m=e.length;l<m;l++){var n=e[l].name;f.test(n)?h.push(n.split("/").pop()):g.test(n)||k.push(n.split("/").pop())}0<h.length||0<k.length?Ext.Msg.show({title:a.localize("fileTypesWarning"),icon:Ext.MessageBox.ERROR,message:a.localize("fileTypesMessage")+"\x3cul\x3e"+(0<h.length?"\x3cli\x3e"+a.localize("badFiles")+h.slice(0,5).join(", ")+(5<h.length?"\u2026":"")+"\x3c/li\x3e":"")+(0<k.length?"\x3cli\x3e"+a.localize("unknownFiles")+k.slice(0,5).join(", ")+(5<k.length?"\u2026":"")+"\x3c/li\x3e":
"")+"\x3c/ul\x3e"+a.localize("sureContinue"),buttons:Ext.Msg.YESNO,fn:function(c){"yes"===c?a.loadForm(d):(b.reset(),b.fileInputEl.dom.setAttribute("multiple",!0))},scope:d}):a.loadForm(d)}}}}},"-\x3e",{xtype:"button",scale:"large",glyph:"xf00d@FontAwesome",text:this.localize("cancel"),hidden:void 0==this.getCorpus(),handler:function(a){(a=this.up("window"))&&a.isFloating()&&a.close()}},{xtype:"button",scale:"large",glyph:"xf00c@FontAwesome",text:this.localize("reveal"),ui:"default",width:200,handler:function(b){var c=
...
itemId:"input",emptyText:this.localize("emptyInput")}});a.on("boxready",function(a){var c=this.getApplication();c.getAllowInput&&"false"==c.getAllowInput()&&(a.hide(),Ext.create("Ext.window.Window",{layout:"fit",header:!1,modal:!0,bodyPadding:10,items:{html:"\x3cp style\x3d'color: red;'\x3e"+a.localize("noAllowInputMessage")+"\x3c/p\x3e"}}).show())});a.callParent(arguments)},loadForm:function(a){var b={tool:this.getCorpus()?"corpus.CorpusMetadata":"corpus.CorpusCreator"};this.getCorpus()&&Ext.apply(b,
{corpus:this.getCorpus().getId(),addDocuments:!0});var c=this.getApiParams();delete c.view;delete c.stopList;Ext.apply(b,c);var d=this.getApplication().getViewport();d.mask(this.localize("uploadingCorpus"));a.submit({url:this.getTromboneUrl(),params:b,failure:function(a,b){d.unmask();if(b.result&&(b.result.corpus||b.result.stepEnabledCorpusCreator)){var g={corpus:b.result.corpus?b.result.corpus.metadata.id:b.result.stepEnabledCorpusCreator.storedId};Ext.apply(g,c);this.setCorpus(void 0);this.loadCorpus(g)}else this.showResponseError("Unable to load corpus.",
b.response)},scope:this})},loadCorpus:function(a){this.getCorpus()&&Ext.apply(a,{corpus:this.getCorpus().getId(),addDocuments:!0});var b=this.up("window");b&&b.isFloating()&&b.close();this.getApplication().loadCorpusFromParams(a)},showOptionsClick:function(a){void 0===a.optionsWin&&(a.optionsWin=Ext.create("Ext.window.Window",{title:a.localize("gearWinTitle"),closeAction:"hide",layout:"fit",bodyPadding:10,items:[{xtype:"form",defaultType:"textfield",maxHeight:a.getApplication().getViewport().getHeight()-
300,scrollable:!0,fieldDefaults:{labelAlign:"right",labelWidth:110,width:350},items:[{xtype:"combo",fieldLabel:a.localize("inputFormat"),labelWidth:90,name:"inputFormat",queryMode:"local",store:[["",a.localize("inputFormatAuto")],["dtoc","DToC: Dynamic Table of Contexts"],["TEI","TEI: Text Encoding Initative"],["TEI","TEI Corpus"],["RSS","Really Simple Syndication: RSS"]],value:"",listeners:{afterrender:{fn:function(a){var c=this.getApiParam("inputFormat");c&&a.setValue(c)},scope:a}}},{xtype:"container",
html:"\x3cp\x3e\x3ci\x3e"+(new Ext.Template(a.localize("advancedOptionsText"))).applyTemplate([a.getBaseUrl()+"docs/#!/guide/corpuscreator-section-xml"])+"\x3c/i\x3e\x3c/p\x3e",width:375},{xtype:"fieldset",title:"\x3ca href\x3d'"+a.getBaseUrl()+"docs/#!/guide/corpuscreator-section-titles' target\x3d'voyantdocs'\x3e"+a.localize("corpusOptions")+"\x3c/a\x3e",collapsible:!0,collapsed:!0,defaultType:"textfield",items:[{xtype:"container",html:"\x3cp\x3e\x3ci\x3e\x3c/i\x3e\x3c/p\x3e",width:375},{fieldLabel:a.localize("corpusTitle"),
name:"title"},{fieldLabel:a.localize("corpusSubTitle"),name:"subTitle"}]},{xtype:"fieldset",title:"\x3ca href\x3d'"+a.getBaseUrl()+"docs/#!/guide/corpuscreator-section-text' target\x3d'voyantdocs'\x3e"+a.localize("textOptions")+"\x3c/a\x3e",collapsible:!0,collapsed:!0,defaultType:"textfield",items:[{xtype:"container",html:"\x3cp\x3e\x3ci\x3e"+a.localize("textOptionsText")+"\x3c/i\x3e\x3c/p\x3e",width:375},{fieldLabel:a.localize("inputRemoveUntil"),name:"inputRemoveUntil"},{fieldLabel:a.localize("inputRemoveUntilAfter"),
...
this.stripPunctuation(a));this.getKwicStore().load({params:this.getApiParams()})},reload:function(){var a=this.getApiParam("query");void 0!==a&&this.setRoot(a)},stripPunctuation:function(a){if(Ext.isString(a))return a.replace(/[.,\/#!$%\^&\*;:{}=\-_`~()]/g,"");var b=[];a.forEach(function(a){b.push(a.replace(/[.,\/#!$%\^&\*;:{}=\-_`~()]/g,""))});return b}});Ext.define("Voyant.panel.WordWall",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel","Voyant.util.DiacriticsRemover"],alias:"widget.wordwall",statics:{i18n:{title:"Wall of Words",terms:"Terms",scaling:"Scaling",xStrength:"X Strength",yStrength:"Y Strength",chargeStrength:"Charge Strength",chargeDistance:"Charge Distance",delay:"Fetch Delay",transition:"Transition Speed"},api:{limit:500,stopList:"auto"},glyph:"xf1e0@FontAwesome"},config:{visId:void 0,vis:void 0,simulation:void 0,nodes:void 0,
tempNodes:void 0,zoom:void 0,terms:void 0,segments:void 0,currentSegment:void 0,segmentTerms:void 0,segmentTermsQueue:[],segmentDelay:5E3,segmentDelayTimer:void 0,webWorker:void 0,isSimulating:!1,transitionTime:1E3,isTransitioning:!1,minFreq:void 0,maxFreq:void 0,letterDistribution:void 0,frequencyScale:void 0,xForceStrength:.2,yForceStrength:.1,chargeStrength:-75,chargeDistance:100,minFontSize:7,maxFontSize:60},MIN_TERMS:10,MAX_TERMS:2E3,MIN_SCALING:1,MAX_SCALING:20,constructor:function(a){this.mixins["Voyant.util.DiacriticsRemover"].constructor.apply(this,
arguments);this.setVisId(Ext.id(null,"wordwall_"));this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(){Ext.apply(this,{title:this.localize("title"),dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[this.localize("terms"),{width:50,xtype:"slider",minValue:this.MIN_TERMS,maxValue:this.MAX_TERMS,increment:10,listeners:{render:function(a){a.setValue(this.getApiParam("limit"))},changecomplete:function(a,b){this.setApiParam("limit",
a.getValue());this.initLoad()},scope:this}},this.localize("delay"),{width:50,xtype:"slider",minValue:1,maxValue:60,increment:1,listeners:{render:function(a){a.setValue(this.getSegmentDelay()/1E3)},changecomplete:function(a,b){this.setSegmentDelay(1E3*a.getValue());this.restartSegmentTimer()},scope:this}},this.localize("transition"),{width:50,xtype:"slider",minValue:100,maxValue:5E3,increment:1,listeners:{render:function(a){a.setValue(this.getTransitionTime())},changecomplete:function(a,b){this.setTransitionTime(a.getValue())},
scope:this}},this.localize("xStrength"),{width:50,xtype:"slider",minValue:0,maxValue:1E3,increment:10,listeners:{render:function(a){a.setValue(1E3*this.getXForceStrength())},changecomplete:function(a,b){this.setXForceStrength(a.getValue()/1E3)},scope:this}},this.localize("yStrength"),{width:50,xtype:"slider",minValue:0,maxValue:1E3,increment:10,listeners:{render:function(a){a.setValue(1E3*this.getYForceStrength())},changecomplete:function(a,b){this.setYForceStrength(a.getValue()/1E3)},scope:this}},
this.localize("chargeStrength"),{width:50,xtype:"slider",minValue:-1E3,maxValue:0,increment:10,listeners:{render:function(a){a.setValue(this.getChargeStrength())},changecomplete:function(a,b){this.setChargeStrength(a.getValue())},scope:this}},this.localize("chargeDistance"),{width:50,xtype:"slider",minValue:0,maxValue:1E3,increment:10,listeners:{render:function(a){a.setValue(this.getChargeDistance())},changecomplete:function(a,b){this.setChargeDistance(a.getValue())},scope:this}},{itemId:"status",
xtype:"tbtext",text:""}]}]});this.on("loadedCorpus",function(a,b){this.isVisible()&&this.initLoad()},this);this.on("resize",function(a,b,c){if(a=Ext.get(this.getVisId()))c=this.body,b=c.getHeight(),c=c.getWidth(),a.el.dom.setAttribute("width",c),a.el.dom.setAttribute("height",b)},this);this.callParent(arguments)},initVis:function(){var a=this.getLayout().getRenderTarget();a.update("");var b=a.getWidth(),c=a.getHeight(),a=d3.select(a.dom).append("svg").attr("id",this.getVisId()).attr("class","wordWall").attr("width",
b).attr("height",c).append("g");this.setVis(a);this.setNodes(a.append("g").attr("class","nodes").selectAll(".node"));this.setTempNodes(a.append("g").attr("class","tempNodes").selectAll("text"));this.setWebWorker(new Worker(this.getBaseUrl()+"resources/d3/WordWallWorker.js"));this.getWebWorker().onmessage=this.handleWebWorkerMessage.bind(this)},initLoad:function(){this.initVis();var a=this.getApiParams();a.tool="corpus.CorpusSegmentTerms";Ext.Ajax.request({url:this.getTromboneUrl(),params:a,success:function(a){a=
Ext.decode(a.responseText);this.setSegments(a.corpusSegmentTerms.segments);this.setTerms(a.corpusSegmentTerms.terms);this.setCurrentSegment(this.getSegments().length);this.getNextSegment();this.restartSegmentTimer()},failure:function(a){window.console&&console.log("failed",a)},scope:this})},restartSegmentTimer:function(){clearInterval(this.getSegmentDelayTimer());this.setSegmentDelayTimer(setInterval(function(){this.updateNodePositions()}.bind(this),this.getSegmentDelay()))},getNextSegment:function(){var a=
this.getCurrentSegment();a++;a>=this.getSegments().length&&(a=0);this.setCurrentSegment(a);this.processTermsForSegment(this.getCurrentSegment())},processTermsForSegment:function(a){var b=Number.MAX_VALUE,c=Number.MIN_VALUE,d={a:0,b:0,c:0,d:0,e:0,f:0,g:0,h:0,i:0,j:0,k:0,l:0,m:0,n:0,o:0,p:0,q:0,r:0,s:0,t:0,u:0,v:0,w:0,x:0,y:0,z:0};this.getTerms().forEach(function(e){e.id=this.idGet(e.term);e.value=e.rawFreqs[a];if(0<e.value){e.value<b&&(b=e.value);e.value>c&&(c=e.value);e.title=e.term+" ("+e.value+
")";var f=this.removeDiacritics(e.term.charAt(0)).toLowerCase();e.letter=f;void 0===d[f]&&(d[f]=0);d[f]++}},this);this.setSegmentTerms(this.getTerms().filter(function(a){return 0<a.value}));this.setMinFreq(b);this.setMaxFreq(c);var e=[],f;for(f in d){var g=d[f]/this.getTerms().length;e.push({letter:f,percent:g})}e.sort(function(a,b){return a.letter<b.letter?-1:a.letter>b.letter?1:0});this.setLetterDistribution(e);this.calculateNodeSizes(this.getSegmentTerms());this.runSimulation(this.getSegmentTerms())},
calculateNodeSizes:function(a){var b=this.getTempNodes().data(a,function(a){return a.id}),c=function(b){var c=2*Math.min(1,a.length/this.MAX_TERMS)+1;b=this.getFrequencyScale()(b);return d3.scalePow().exponent(c).domain([0,1]).range([this.getMinFontSize(),this.getMaxFontSize()])(b)}.bind(this),d=0;b.enter().append("text").attr("fill-opacity",0).attr("font-family",function(a){return"Arial"}).attr("font-size",function(a){var b=c(a.value);return a.fontSize=b}).text(function(a){return a.term}).each(function(a){var b=
this.getBBox();a.bbox={};a.bbox.x=b.x;a.bbox.y=b.y;a.bbox.width=b.width;a.bbox.height=b.height;d+=b.width*b.height}).remove();var e=this.getLayout().getRenderTarget(),b=e.getWidth(),e=e.getHeight(),b=b*e;d>.6*b?(this.setMaxFontSize(.9*this.getMaxFontSize()),this.setMinFontSize(.9*this.getMinFontSize()),this.calculateNodeSizes(a)):d<.5*b&&(this.setMaxFontSize(1.1*this.getMaxFontSize()),this.setMinFontSize(1.1*this.getMinFontSize()),this.calculateNodeSizes(a))},runSimulation:function(a){this.setIsSimulating(!0);
var b=this.getLayout().getRenderTarget(),c=b.getWidth(),b=b.getHeight();window.console&&console.time("runSim");this.getWebWorker().postMessage({terms:a,width:c,height:b,minFreq:this.getMinFreq(),maxFreq:this.getMaxFreq(),xForceStrength:this.getXForceStrength(),yForceStrength:this.getYForceStrength(),chargeDistance:this.getChargeDistance(),chargeStrength:this.getChargeStrength(),letterDistribution:this.getLetterDistribution()})},handleWebWorkerMessage:function(a){switch(a.data.type){case "progress":a=
parseInt(100*a.data.progress);this.getDockedItems()[1].getComponent("status").update(a+"%");break;case "msg":window.console&&console.log(a.data.msg);break;case "end":window.console&&console.timeEnd("runSim"),this.getDockedItems()[1].getComponent("status").update(""),this.setIsSimulating(!1),this.getSegmentTermsQueue().push(a.data.nodes)}},updateNodePositions:function(){if(this.getIsTransitioning())Ext.Function.defer(this.updateNodePositions,100,this);else{this.setIsTransitioning(!0);var a=this.getSegmentTermsQueue().shift();
0==this.getSegmentTermsQueue().length&&this.getNextSegment();a=this.getNodes().data(a,function(a){return a.id});a.transition().duration(this.getTransitionTime()).attr("transform",function(a){return"translate("+a.x+","+a.y+")"});var b=a.enter().append("g").attr("class","node").attr("id",function(a){return a.id}).attr("transform",function(a){return"translate("+a.x+","+a.y+")"}).attr("fill-opacity",0);b.append("title").text(function(a){return a.title});b.append("text").attr("font-family",function(a){return"Arial"}).attr("font-size",
function(a){return a.fontSize}).attr("fill",function(a){return this.getApplication().getFeatureForTerm("color",a.term)}.bind(this)).style("cursor","pointer").style("user-select","none").attr("alignment-baseline","middle").text(function(a){return a.term});b.transition().duration(this.getTransitionTime()).attr("fill-opacity",1);b=b.merge(a);b.select("text").transition().duration(this.getTransitionTime()).attr("font-size",function(a){return a.fontSize});a.exit().transition().duration(this.getTransitionTime()).attr("fill-opacity",
