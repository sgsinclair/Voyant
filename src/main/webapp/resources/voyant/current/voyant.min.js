...
b=this.getApiParam("visible");b>a.length&&(b=a.length);for(var c=[],d=0;d<b;d++)c.push({text:a[d].get("term"),rawFreq:a[d].get("rawFreq")});console.warn(c);this.setTerms(c);this.buildFromTerms()},initVisLayout:function(){if(void 0==this.getVisLayout()){var a=this.getLayout().getRenderTarget(),b=a.getWidth(),c=a.getHeight();this.setVisLayout(d3.layout.cloud().size([b,c]).padding(1).rotate(function(){return 90*~~(2*Math.random())}).spiral("archimedean").font("Impact").fontSize(function(a){return a.fontSize}.bind(this)).text(function(a){return a.text}).on("end",
