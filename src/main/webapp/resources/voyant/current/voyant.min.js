...
this.setTree(d)},clickHandler:function(a){null==this.clickTimeout?this.clickTimeout=window.setTimeout("",this.doubleClickDelay):(window.clearTimeout(this.clickTimeout),this.clickTimeout=null,this.doubleClickHandler(a))},doubleClickHandler:function(a){debugger;for(var b=[];null!=a;)b.push(a.name),a=a.parent;this.getApplication().dispatchEvent("termsClicked",this,[b.reverse().join(" ")])},setRoot:function(a){this.setApiParam("query",this.stripPunctuation(a));this.getKwicStore().load({params:this.getApiParams()})},
