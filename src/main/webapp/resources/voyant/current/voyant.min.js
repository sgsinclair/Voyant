...
arguments)},initComponent:function(){var a=this,b=Ext.create("Voyant.data.store.CorpusTermsBuffered",{parentPanel:this});Ext.apply(a,{title:this.localize("title"),emptyText:this.localize("emptyText"),store:b,selModel:Ext.create("Ext.selection.CheckboxModel",{pruneRemoved:!1,listeners:{selectionchange:{fn:function(a,b){b&&0<b.length&&this.getApplication().dispatchEvent("corpusTermsClicked",this,b)},scope:this}},mode:"SIMPLE"}),dockedItems:[{dock:"bottom",xtype:"toolbar",enableOverflow:!0,items:[{xtype:"querysearchfield"},
