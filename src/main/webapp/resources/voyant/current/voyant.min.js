...
b&&(b.on("loadedCorpus",function(b,d){a.fireEvent("loadedCorpus",b,d)},a),b.getCorpus&&b.getCorpus()&&a.fireEvent("loadedCorpus",a,b.getCorpus()))}}});this.setDocStore(Ext.create("Ext.data.Store",{model:"Voyant.data.model.Document",autoLoad:!1,remoteSort:!1,proxy:{type:"ajax",url:Voyant.application.getTromboneUrl(),extraParams:{tool:"corpus.DocumentsMetadata"},reader:{type:"json",rootProperty:"documentsMetadata.documents",totalProperty:"documentsMetadata.total"},simpleSortMode:!0},listeners:{load:function(a,
b,c,d){this.populate(b)},scope:this}}))},setCorpus:function(a){a&&(this.getDocStore().getProxy().setExtraParam("corpus",a.getId()),this.getDocStore().load());this.callParent(arguments)},populate:function(a,b){this.setDocs(a);var c=this.getMenu();b&&c.removeAll();var d=this.getSingleSelect(),e="docGroup"+Ext.id();a.forEach(function(a,b){c.add({xtype:"menucheckitem",text:a.getShortTitle(),docId:a.get("id"),checked:d&&0==b||!d,group:d?e:void 0,checkHandler:function(b,c){if(this.getSingleSelect()&&c){var d=
this.findParentBy(function(a){return a.mixins["Voyant.panel.Panel"]});d&&d.fireEvent("documentSelected",this,a)}},scope:this})},this)}});Ext.define("Voyant.widget.DocumentSelectorButton",{extend:"Ext.button.Button",alias:"widget.documentselectorbutton",mixins:["Voyant.widget.DocumentSelectorBase"],initComponent:function(){this.mixins["Voyant.widget.DocumentSelectorBase"].initComponent.apply(this,arguments);this.callParent()}});
