...
this.chartMenu.queryById("nearby").setText(d),this.chartMenu.on("click",function(a,b){if(void 0!==b){var c=f.record.get("term");b.text===this.localize("remove")?this.removeTerm(c):this.getNearbyForTerm(c)}},this,{single:!0}),this.chartMenu.showAt(c))},this)},scope:this}};2>this.labelsMode&&(a.series[0].label={field:"term",display:"over"},a.series[1].label={field:"term",display:"over"});a=Ext.create("Ext.chart.CartesianChart",a);this.queryById("chartParent").insert(0,a);null!==this.newTerm&&(this.selectTerm(this.newTerm),
this.newTerm=null)},doLabels:function(){var a=this.queryById("chart"),b=a.getSeries(),c=a.getSurface("chart").getItems()[0];switch(this.labelsMode){case 0:b[0].getLabel().show();b[1].getLabel().show();c.show();break;case 1:b[0].getLabel().show();b[1].getLabel().show();c.hide();break;case 2:b[0].getLabel().hide(),b[1].getLabel().hide(),c.hide()}a.redraw()},selectTerm:function(a){var b=this.down("#chart").getSeries()[0];a=b.getStore().findExact("term",a);if(-1!==a){var c=b.getStore().getAt(a),d=b.getSprites()[0],
c={series:b,category:b.getItemInstancing()?"items":"markers",index:a,record:c,field:b.getYField(),sprite:d};b.setHighlightItem(c);b=this.getPointFromIndex(b,a);this.highlightData={x:b[0],y:b[1],r:50};null==this.highlightTask&&(this.highlightTask=Ext.TaskManager.newTask({run:this.doHighlight,scope:this,interval:25,repeat:this.highlightData.r}));this.highlightTask.restart()}},getPointFromIndex:function(a,b){var c=a.getSprites()[0];return c.attr.matrix.clone().prependMatrix(c.surfaceMatrix).transformPoint([c.attr.dataX[b],
