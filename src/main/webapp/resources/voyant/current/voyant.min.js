...
params:{limit:10,stopList:this.getApiParam("stopList")}}))},initComponent:function(){var a=Ext.create("Voyant.data.store.CorpusCollocates");a.on("totalcountchange",function(){this.down("#status").update({count:this.getStore().getTotalCount()})},this);Ext.apply(this,{title:this.localize("title"),store:a,selModel:Ext.create("Ext.selection.CheckboxModel",{listeners:{selectionchange:{fn:function(a,c){var d=[],e=this.getApiParam("context");c.forEach(function(a){d.push('"'+a.getKeyword()+" "+a.getContextTerm()+
