...
height:f.getHeight()},"dickinson",a,e,"#"+f.getId());b.Start()}.bind(b))}});Ext.define("Voyant.panel.TermsBerry",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.termsberry",statics:{i18n:{title:"TermsBerry",strategy:"Strategy",topTerms:"Top Terms",distinctTerms:"Distinct Terms",numTerms:"Terms",context:"Context",scaling:"Scaling"},api:{stopList:"auto",context:5,query:void 0,docIndex:void 0,docId:void 0},glyph:"xf201@FontAwesome"},config:{options:[{xtype:"stoplistoption"}],mode:void 0,numInitialTerms:50,collocatesLimit:1E6,scalingFactor:3,minRawFreq:void 0,
maxRawFreq:void 0,maxCollocateValue:void 0,minFillValue:void 0,maxFillValue:void 0,currentData:{},visLayout:void 0,vis:void 0,visInfo:void 0,visId:void 0,tip:void 0},MODE_TOP:"top",MODE_DISTINCT:"distinct",MIN_TERMS:5,MAX_TERMS:500,MIN_SCALING:1,MAX_SCALING:5,MIN_STROKE_OPACITY:.1,MAX_STROKE_OPACITY:.3,layout:"fit",constructor:function(a){this.setMode(this.MODE_TOP);this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.setVisId(Ext.id(null,"termspack_"))},
initComponent:function(){Ext.apply(this,{title:this.localize("title"),dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"button",text:this.localize("strategy"),menu:{items:[{xtype:"menucheckitem",group:"strategy",checked:this.getMode()===this.MODE_TOP,text:this.localize("topTerms"),checkHandler:function(a,b){b&&(this.setMode(this.MODE_TOP),this.doLoad())},scope:this},{xtype:"menucheckitem",group:"strategy",checked:this.getMode()===this.MODE_DISTINCT,text:this.localize("distinctTerms"),
checkHandler:function(a,b){b&&(this.setMode(this.MODE_DISTINCT),this.doLoad())},scope:this}]}},{fieldLabel:this.localize("numTerms"),labelWidth:50,labelAlign:"right",width:120,xtype:"slider",increment:1,minValue:this.MIN_TERMS,maxValue:this.MAX_TERMS,listeners:{afterrender:function(a){a.setValue(this.getNumInitialTerms())},changecomplete:function(a,b){this.setNumInitialTerms(b);this.doLoad()},scope:this}},{fieldLabel:this.localize("context"),labelWidth:50,labelAlign:"right",width:120,xtype:"slider",
increment:1,minValue:1,maxValue:30,listeners:{afterrender:function(a){a.setValue(this.getApiParam("context"))},changecomplete:function(a,b){this.setApiParams({context:b});this.doLoad()},scope:this}},{fieldLabel:this.localize("scaling"),labelWidth:50,labelAlign:"right",width:120,xtype:"slider",increment:1,minValue:this.MIN_SCALING,maxValue:this.MAX_SCALING,listeners:{afterrender:function(a){a.setValue(this.getScalingFactor())},changecomplete:function(a,b){var c=Math.abs(b-(this.MAX_SCALING+1));this.setScalingFactor(c);
this.getVisLayout().value(function(a){return Math.pow(a.rawFreq,1/c)});var d=this.processRecordsForVis([]);this.resetVis();this.buildVisFromData(d)},scope:this}}]}]});this.callParent(arguments)},listeners:{boxready:function(){this.initVisLayout()},resize:function(a,b,c){this.getVisLayout()&&this.getCorpus()&&(a=this.getLayout().getRenderTarget(),b=a.getWidth(),c=a.getHeight(),a.down("svg").set({width:b,height:c}),this.getVisLayout().size([b,c]),b=this.processRecordsForVis([]),0<b.length&&(this.resetVis(),
this.buildVisFromData(b)))},loadedCorpus:function(a,b){this.doLoad()}},doLoad:function(){this.resetVis();this.resetMinMax();this.setCurrentData({});this.getMode()===this.MODE_DISTINCT?this.getDistinctTerms():this.getTopTerms()},resetMinMax:function(){this.setMinRawFreq(void 0);this.setMaxRawFreq(void 0);this.setMaxCollocateValue(void 0);this.setMinFillValue(void 0);this.setMaxFillValue(void 0)},resetVis:function(){this.getVis().selectAll(".node").remove()},getTopTerms:function(){this.setApiParams({docId:void 0,
docIndex:void 0});this.getCorpus().getCorpusTerms().load({params:{limit:this.getNumInitialTerms(),stopList:this.getApiParam("stopList")},callback:function(a,b,c){c&&this.loadFromRecords(a)},scope:this})},getDistinctTerms:function(){var a=Math.ceil(this.getNumInitialTerms()/this.getCorpus().getDocumentsCount());this.getCorpus().getDocumentTerms().load({addRecords:!0,params:{limit:this.getNumInitialTerms(),perDocLimit:a,stopList:this.getApiParam("stopList"),sort:"TFIDF",dir:"DESC"},callback:function(a,
c,d){d&&this.loadFromRecords(a)},scope:this})},loadFromRecords:function(a){if(Ext.isArray(a)&&0<a.length){var b=this.getMaxRawFreq(),c=this.getMinRawFreq(),d=this.getMinFillValue(),e=this.getMaxFillValue(),f=[];a.forEach(function(a){var h=a.getTerm(),k=a.getRawFreq(),l=this.getMode()===this.MODE_DISTINCT?a.get("tfidf"):a.getInDocumentsCount();if(void 0===b||k>b)b=k;if(void 0===c||k<c)c=k;if(void 0===e||l>e)e=l;if(void 0===d||l<d)d=l;this.getCurrentData()[h]={term:h,rawFreq:k,relativeFreq:a.get("relativeFreq"),
fillValue:l,collocates:[]};f.push(h)},this);this.setMaxRawFreq(b);this.setMinRawFreq(c);this.setMinFillValue(d);this.setMaxFillValue(e);this.loadFromQuery(f)}},loadFromQuery:function(a){this.setApiParams({mode:"corpus"});var b=this.getApiParams();this.getCorpus().getCorpusCollocates().load({params:Ext.apply(Ext.clone(b),{query:a,collocatesWhitelist:a,limit:this.getCollocatesLimit()}),callback:function(a,b,e){e&&this.buildVisFromData(this.processRecordsForVis(a))},scope:this})},processRecordsForVis:function(a){for(var b=
this.getCurrentData(),c=this.getMaxCollocateValue(),d=0;d<a.length;d++){var e=a[d],f=e.getTerm(),g=e.getContextTerm(),e=e.getContextTermRawFreq();if(void 0===c||e>c)c=e;void 0!==b[f]&&f!=g&&b[f].collocates.push({term:g,value:e})}this.setMaxCollocateValue(c);a=[];for(f in b)0<b[f].collocates.length&&a.push(b[f]);return a},buildVisFromData:function(a){a=this.getVisLayout().nodes({children:a,collocates:[],term:"",rawFreq:1});a=this.getVis().selectAll(".node").data(a,function(a){return a.term});a.attr("transform",
function(a){return"translate("+a.x+","+a.y+")"});a.selectAll("circle").attr("r",function(a){return a.r});var b=this,c=d3.scale.pow().exponent(1/3).domain([0,this.getMaxCollocateValue()]).range(["#fff","#bd3163"]),d;d=this.getMode()===this.MODE_DISTINCT?d3.scale.pow().exponent(1/3).domain([this.getMinFillValue(),this.getMaxFillValue()]).range(["#fff","#eee"]):d3.scale.linear().domain([this.getMinFillValue(),this.getMaxFillValue()]).range(["#fff","#eee"]);var e=this.getVisLayout().size(),e=Math.min(e[0],
e[1])/2,e=Math.sqrt(Math.PI*e*e/(a[0].length-1)/Math.PI)/3,f=Math.abs(this.getScalingFactor()-(this.MAX_SCALING+1)),f=Math.max(1,f-1),f=e*f,g=d3.scale.linear().domain([this.getMinRawFreq(),this.getMaxRawFreq()]).range([e,f]),e=a.enter().append("g").attr("class","node").style("visibility",function(a){return 0<a.depth?"visible":"hidden"}).attr("transform",function(a){return"translate("+a.x+","+a.y+")"}).on("click",function(a){b.dispatchEvent("termsClicked",b,[a.term])}).on("mouseover",function(a,e){b.getVis().selectAll("circle").style("stroke-width",
1).style("stroke","#111").style("fill",function(a){return d(a.inDocumentsCount)});d3.select(this).select("circle").style("fill","#89e1c2").style("stroke","#26926c").style("stroke-opacity",b.MAX_STROKE_OPACITY);var f="\x3cb\x3e"+a.term+"\x3c/b\x3e ("+a.rawFreq+")\x3cbr/\x3e"+a.fillValue,g=b.getTip();g.update(f);g.show();for(e=0;e<a.collocates.length;e++){var n=a.collocates[e],f=b.getVis().selectAll(".node").filter(function(a){return a.term===n.term});f.select("circle").style("fill",function(a){return c(n.value)}).style("stroke",
