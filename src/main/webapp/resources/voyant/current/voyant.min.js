...
modal:!0,panel:a,items:{xtype:"form",items:a.getOptions(),buttons:[{text:a.localize("reset"),glyph:"xf00c@FontAwesome",flex:1,panel:a,handler:function(a){this.mixins&&this.mixins["Voyant.util.Api"]&&(this.mixins["Voyant.util.Api"].constructor.apply(this),this.getCorpus&&this.getCorpus()&&this.fireEvent("loadedCorpus",this,this.getCorpus()));a.up("window").close()},scope:a},{xtype:"tbfill"},{text:a.localize("confirmTitle"),glyph:"xf00c@FontAwesome",flex:1,panel:a,handler:function(a){var b=a.up("form").getValues();
this.setApiParams(b);var c=this.getApplication(),d=c.getCorpus();if(void 0!=b.stopList&&void 0!=b.stopListGlobal&&b.stopListGlobal){c.setApiParams&&c.setApiParams({stopList:b.stopList});for(var e=c.getViewport().query("panel,chart"),f=0;f<e.length;f++)e[f].setApiParams&&e[f].setApiParams({stopList:b.stopList});d&&(c.dispatchEvent("loadedCorpus",this,d),this.fireEvent("loadedCorpus",this,d))}d&&this.fireEvent("loadedCorpus",this,d);a.up("window").close()},scope:a},{text:a.localize("cancelTitle"),glyph:"xf00d@FontAwesome",
flex:1,handler:function(a){a.up("window").close()}}]},bodyPadding:5}).show()}}:void 0,help:{glyph:"xf128@FontAwesome",fn:this.helpToolClick}},c=[];if(a.includeTools)for(var f in a.includeTools)"object"==typeof a.includeTools[f]&&c.push(a.includeTools[f]);for(f in e)a.includeTools&&!a.includeTools[f]||!e[f]||c.push({type:f,tooltip:this.localize(f+"Tip"),callback:e[f].fn,xtype:"toolmenu",glyph:e[f].glyph,items:e[f].items});Ext.apply(this,{tools:c});this.on("afterrender",function(){var a=this.getHeader();
if(a&&"Desktop"==Ext.os.deviceType){var b=a.getEl();b.on("mouseover",function(){this.getHeader().getTools().forEach(function(a){a.show()})},this);b.on("mouseout",function(){this.getHeader().getTools().forEach(function(a){"help"!=a.type&&-1==a.type.indexOf("collapse")&&a.hide()})},this);a.getTools().forEach(function(a,b){"help"!=a.type&&a.hide()})}},this)},getMenuItemFromXtype:function(a){var b=this.getApplication().getToolConfigFromToolXtype(a);b&&b.tooltip&&delete b.tooltip;return Ext.apply(Ext.clone(b),
{xtype:"menuitem",text:b.title,textAlign:"left",handler:function(){this.replacePanel(b.xtype)},scope:this})},maximizeToolClick:function(a){var b=Ext.getClass(a).getName().split(".");url=a.getBaseUrl()+"tool/"+b[b.length-1]+"/";params=a.getModifiedApiParams();!params.corpus&&a.getCorpus&&a.getCorpus()&&(params.corpus=a.getCorpus().getId());params&&(url+="?"+Ext.Object.toQueryString(params));a.openUrl(url)},exportToolClick:function(a){a.isXType("voyanttabpanel")&&(a=a.getActiveTab());var b=[{xtype:"radio",
