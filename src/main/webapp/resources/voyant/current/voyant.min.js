...
this.addCode(a)},this):a.input?0===a.input.indexOf("http")&&this.loadFromUrl(a.input,b):c?(this.loadFromId(c[1]),this.setStorageSolution("voyant")):d?(this.githubDialogs.loadFileFromId(a.githubId),this.setStorageSolution("github")):this.addNew();if(b){var e=this;Ext.defer(function(){e.runAll()},100)}},scope:this})},getBlock:function(a){a=a||0;var b=this.query("notebookcodeeditorwrapper"),c=this.getCurrentBlock().id,d=b.findIndex(function(a){return a.id==c});if(0>d+a||d+a>b.length-1)Ext.Msg.show({title:this.localize("error"),
