...
"scale":"حجم",
"title":"سيروس",
"helpTip":"</p><p>يقدم سيريس عرض سحابة الكلمات لاكثر الكلمات تواجدا في المكنز او المستند –&nbsp;يقدم هذا نظرة عامة مناسبة (قد تكون مختزلة). تتضمن الميزات</p><ul><li>تظهر تواتر الكلمات عند التحليق على الكلمات</li><li>النقر على الكلمات قد تظهر نتائج في أدوات اخرى اذا عرضت اي منها</li></ul>",
...
"error":"وقع خطأ",
"translatedBy":" الترجمة العربية بقلم <a href=\"http://djwrisley.com\" target=\"_blank\"> ديفيد جوزيف رزلي </a> و نجلاء جركس"});
...
"helpTip":"الكلمات المفتاحية في أداة السياق تظهراي تكرارللكلمة المفتاحية مرفقة ببعض من النص المحيط (السياق). يمكن الاستفادة منه للتحقق عن قرب عن كيفية إستعمال الكلمات في سياقات مختلفة. تتضمن الميزات :<p></p>اعادة ترتيب المستند، بواسطة الكلمة المفتاحية أو بالسياق من اليمين أو اليسار</li><li>للحصول على مربع البحث للاستعلام (يرجى التحليق فوق ايقونة المكبرة للمساعدة في تركيب الجمل)"});
