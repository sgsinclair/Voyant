...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        <xsl:text>DocIndex&#9;Term&#9;RawFrequency&#9;RelativeFrequency&#9;ZScore&#9;ZScoreRatio&#9;TF-IDF&#9;Distributions&#10;</xsl:text>
        <xsl:for-each select="results/documentTerms/terms/term">
            ...
            <xsl:text>&#9;</xsl:text>
            <xsl:value-of select="zscoreRatio"/>
            <xsl:text>&#9;</xsl:text>
            <xsl:value-of select="tfidf"/>
            <xsl:text>&#9;</xsl:text>
