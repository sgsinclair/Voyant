	...
	*/
	...
	var arrayMethodUsesToLength$1 = function (METHOD_NAME, options) {
	  ...
	  return cache$1[METHOD_NAME] = !!method && !fails$1(function () {
	    ...
	    if (ACCESSORS) defineProperty$6(O, 1, { enumerable: true, get: thrower$1 });
	    else O[1] = 1;
	...
	var USES_TO_LENGTH$2 = arrayMethodUsesToLength$1('indexOf', { ACCESSORS: true, 1: 0 });

	// `Array.prototype.indexOf` method
	// https://tc39.github.io/ecma262/#sec-array.prototype.indexof
	_export$1({ target: 'Array', proto: true, forced: NEGATIVE_ZERO || !STRICT_METHOD$2 || !USES_TO_LENGTH$2 }, {
	...
	var setToStringTag$1 = function (it, TAG, STATIC, SET_METHOD) {
	  if (it) {
	    ...
	    if (!has$2(target, TO_STRING_TAG$6)) {
	      defineProperty$7(target, TO_STRING_TAG$6, { configurable: true, value: TAG });
	    }
	...
	var defineIterator$1 = function (Iterable, NAME, IteratorConstructor, next, DEFAULT, IS_SET, FORCED) {
	  ...
	  if (( FORCED) && IterablePrototype[ITERATOR$9] !== defaultIterator) {
	    createNonEnumerableProperty$1(IterablePrototype, ITERATOR$9, defaultIterator);
	  }
	...
	for (var COLLECTION_NAME$2 in domIterables$1) {
	  ...
	  if (CollectionPrototype$2 && classof$1(CollectionPrototype$2) !== TO_STRING_TAG$7) {
	...
	var getInternalState$5 = internalState$1.getterFor(SYMBOL);
	...
	var isArrayIteratorMethod$1 = function (it) {
	  return it !== undefined && (iterators$1.Array === it || ArrayPrototype$4[ITERATOR$c] === it);
	};
	...
	var USES_TO_LENGTH$3 = arrayMethodUsesToLength$1('slice', { ACCESSORS: true, 0: 0, 1: 2 });
	...
	var USES_TO_LENGTH$4 = arrayMethodUsesToLength$1('forEach');

	// `Array.prototype.forEach` method implementation
	// https://tc39.github.io/ecma262/#sec-array.prototype.foreach
	var arrayForEach$1 = (!STRICT_METHOD$3 || !USES_TO_LENGTH$4) ? function forEach(callbackfn /* , thisArg */) {
	...
	var USES_TO_LENGTH$5 = arrayMethodUsesToLength$1('indexOf', { ACCESSORS: true, 1: 0 });
	...
	_export$1({ target: 'Array', proto: true, forced: FORCED$4 }, {
	  sort: function sort(comparefn) {
	    return comparefn === undefined
	      ...
	      : nativeSort.call(toObject$1(this), aFunction$2(comparefn));
	  }
	});
	...
	var flags_1 = function (it) {
	  return regexpFlags$1.call(it);
	};

	var RegExpPrototype$1 = RegExp.prototype;

	var flags_1$1 = function (it) {
	  return (it === RegExpPrototype$1 || it instanceof RegExp) && !('flags' in it) ? flags_1(it) : it.flags;
	};
	...
	defineProperty$5(exports, "__esModule", {
	  value: true
	});
	...
	// FF49- issue
	var USES_TO_LENGTH$6 = arrayMethodUsesToLength$1('map');
	...
	var USES_TO_LENGTH$7 = arrayMethodUsesToLength$1('reduce', { 1: 0 });

	// `Array.prototype.reduce` method
	// https://tc39.github.io/ecma262/#sec-array.prototype.reduce
	_export$1({ target: 'Array', proto: true, forced: !STRICT_METHOD$5 || !USES_TO_LENGTH$7 }, {
	...
	// `Array.prototype.includes` method
	// https://tc39.github.io/ecma262/#sec-array.prototype.includes
	_export({ target: 'Array', proto: true, forced: !USES_TO_LENGTH$b }, {
	  includes: function includes(el /* , fromIndex = 0 */) {
	...
	// `Array.prototype.indexOf` method
	// https://tc39.github.io/ecma262/#sec-array.prototype.indexof
	_export({ target: 'Array', proto: true, forced: NEGATIVE_ZERO$1 || !STRICT_METHOD$7 || !USES_TO_LENGTH$c }, {
	  indexOf: function indexOf(searchElement /* , fromIndex = 0 */) {
	...
	var STRICT_METHOD$8 = arrayMethodIsStrict('reduce');
	var USES_TO_LENGTH$d = arrayMethodUsesToLength('reduce', { 1: 0 });

	// `Array.prototype.reduce` method
	// https://tc39.github.io/ecma262/#sec-array.prototype.reduce
	_export({ target: 'Array', proto: true, forced: !STRICT_METHOD$8 || !USES_TO_LENGTH$d }, {
	  reduce: function reduce(callbackfn /* , initialValue */) {
	...
	_export({ target: 'Array', proto: true, forced: String(test$3) === String(test$3.reverse()) }, {
	...
	var HAS_SPECIES_SUPPORT$4 = arrayMethodHasSpeciesSupport('slice');
	var USES_TO_LENGTH$e = arrayMethodUsesToLength('slice', { ACCESSORS: true, 0: 0, 1: 2 });
	...
	// https://tc39.github.io/ecma262/#sec-array.prototype.slice
	// fallback for not array-like ES3 strings and DOM objects
	_export({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT$4 || !USES_TO_LENGTH$e }, {
	  slice: function slice(start, end) {
	    var O = toIndexedObject(this);
	    var length = toLength(O.length);
	...
	// Old WebKit
	var STRICT_METHOD$9 = arrayMethodIsStrict('sort');

	var FORCED$5 = FAILS_ON_UNDEFINED$1 || !FAILS_ON_NULL$1 || !STRICT_METHOD$9;
	...
	_export({ target: 'Array', proto: true, forced: FORCED$5 }, {
	  sort: function sort(comparefn) {
	    return comparefn === undefined
	      ...
	      : nativeSort$1.call(toObject(this), aFunction$1(comparefn));
	  }
	});

	var HAS_SPECIES_SUPPORT$5 = arrayMethodHasSpeciesSupport('splice');
	var USES_TO_LENGTH$f = arrayMethodUsesToLength('splice', { ACCESSORS: true, 0: 0, 1: 2 });
	...
	// with adding support of @@species
	_export({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT$5 || !USES_TO_LENGTH$f }, {
	  splice: function splice(start, deleteCount /* , ...items */) {
	    ...
	    if (argumentsLength === 0) {
	      ...
	      actualDeleteCount = min$6(max$5(toInteger(deleteCount), 0), len - actualStart);
	    }
	...
	if (isForced_1(NUMBER, !NativeNumber(' 0o1') || !NativeNumber('0b1') || NativeNumber('+0x1'))) {
	  ...
	  for (var keys$2 = descriptors ? getOwnPropertyNames(NativeNumber) : (
	    ...
	    if (has(NativeNumber, key = keys$2[j]) && !has(NumberWrapper, key)) {
	      defineProperty$9(NumberWrapper, key, getOwnPropertyDescriptor$5(NativeNumber, key));
	    }
	  }
